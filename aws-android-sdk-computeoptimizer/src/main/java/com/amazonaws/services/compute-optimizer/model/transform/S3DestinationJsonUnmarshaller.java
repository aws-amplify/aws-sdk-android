...
.unmarshall(context));
                ...
                s3Destination.setKey(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("metadataKey")) {
                s3Destination.setMetadataKey(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static S3DestinationJsonUnmarshaller getInstance() {
        if (instance == null) instance = new S3DestinationJsonUnmarshaller();
        return instance;
    }
}
