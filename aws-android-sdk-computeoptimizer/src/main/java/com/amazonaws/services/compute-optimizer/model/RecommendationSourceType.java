...
public enum RecommendationSourceType {
    ...
    private static final Map<String, RecommendationSourceType> enumMap;
    static {
        enumMap = new HashMap<String, RecommendationSourceType>();
        enumMap.put("Ec2Instance", Ec2Instance);
        enumMap.put("AutoScalingGroup", AutoScalingGroup);
    }
