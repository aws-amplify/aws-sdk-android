...
class SummaryJsonUnmarshaller implements Unmarshaller<Summary, JsonUnmarshallerContext> {
    ...
    public Summary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("name")) {
                summary.setName(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("value")) {
                summary.setValue(DoubleJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static SummaryJsonUnmarshaller getInstance() {
        if (instance == null) instance = new SummaryJsonUnmarshaller();
        return instance;
    }
}
