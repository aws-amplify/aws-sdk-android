...
/**
 * JSON unmarshaller for response DescribeBackupResult
 */
public class DescribeBackupResultJsonUnmarshaller implements
        Unmarshaller<DescribeBackupResult, JsonUnmarshallerContext> {
