...
/**
 * Stream Specification JSON Unmarshaller
 */
public class StreamSpecificationJsonUnmarshaller implements Unmarshaller<StreamSpecification, JsonUnmarshallerContext> {
    ...
    public StreamSpecification unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("StreamEnabled")) {
                streamSpecification.setStreamEnabled(BooleanJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("StreamViewType")) {
                streamSpecification.setStreamViewType(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static StreamSpecificationJsonUnmarshaller getInstance() {
        if (instance == null) instance = new StreamSpecificationJsonUnmarshaller();
        return instance;
    }
}
