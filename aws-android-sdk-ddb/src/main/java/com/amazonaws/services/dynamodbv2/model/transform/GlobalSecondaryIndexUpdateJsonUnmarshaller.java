...
/**
 * JSON unmarshaller for POJO GlobalSecondaryIndexUpdate
 */
class GlobalSecondaryIndexUpdateJsonUnmarshaller implements
        Unmarshaller<GlobalSecondaryIndexUpdate, JsonUnmarshallerContext> {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Update")) {
                globalSecondaryIndexUpdate
                        .setUpdate(UpdateGlobalSecondaryIndexActionJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("Create")) {
                globalSecondaryIndexUpdate
                        .setCreate(CreateGlobalSecondaryIndexActionJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("Delete")) {
                globalSecondaryIndexUpdate
                        .setDelete(DeleteGlobalSecondaryIndexActionJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
            }
