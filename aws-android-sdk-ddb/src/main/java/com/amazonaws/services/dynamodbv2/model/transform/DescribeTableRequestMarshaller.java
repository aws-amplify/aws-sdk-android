...
/**
 * JSON request marshaller for DescribeTableRequest
 */
    ...
    public Request<DescribeTableRequest> marshall(DescribeTableRequest describeTableRequest) {
        if (describeTableRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeTableRequest)");
        }

        Request<DescribeTableRequest> request = new DefaultRequest<DescribeTableRequest>(
                describeTableRequest, "AmazonDynamoDB");
