...
public class KeySchemaElement implements Serializable {
    ...
    /**
     * The role that this key attribute will assume: <ul>
     ...
     * @param keyType The role that this key attribute will assume: <ul>
     * <li><p><code>HASH</code> - partition key </li>
     * <li><p><code>RANGE</code> - sort key</li> </ul> <note> <p>The
     * partition key of an item is also known as its <i>hash attribute</i>.
     * The term "hash attribute" derives from DynamoDB' usage of an internal
     ...
     * <b>Allowed Values: </b>HASH, RANGE
     *
     * @return The role that this key attribute will assume: <ul>
     *         <li><p><code>HASH</code> - partition key </li>
     *         <li><p><code>RANGE</code> - sort key</li> </ul> <note> <p>The
     *         partition key of an item is also known as its <i>hash attribute</i>.
     *         The term "hash attribute" derives from DynamoDB' usage of an internal
