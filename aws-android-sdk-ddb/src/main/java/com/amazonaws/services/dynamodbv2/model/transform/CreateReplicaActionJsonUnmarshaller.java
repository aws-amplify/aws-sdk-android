...
/**
 * JSON unmarshaller for POJO CreateReplicaAction
 */
class CreateReplicaActionJsonUnmarshaller implements
        Unmarshaller<CreateReplicaAction, JsonUnmarshallerContext> {
