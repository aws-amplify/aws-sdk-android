...
/**
 * JSON unmarshaller for response CreateTableResult
 */
public class CreateTableResultJsonUnmarshaller implements
        Unmarshaller<CreateTableResult, JsonUnmarshallerContext> {
