...
/**
 * JSON marshaller for POJO GlobalSecondaryIndexUpdate
 */
class GlobalSecondaryIndexUpdateJsonMarshaller {

    public void marshall(GlobalSecondaryIndexUpdate globalSecondaryIndexUpdate,
        ...
        if (globalSecondaryIndexUpdate.getUpdate() != null) {
            ...
            UpdateGlobalSecondaryIndexActionJsonMarshaller.getInstance().marshall(update,
                    jsonWriter);
        }
        if (globalSecondaryIndexUpdate.getCreate() != null) {
            ...
            CreateGlobalSecondaryIndexActionJsonMarshaller.getInstance().marshall(create,
                    jsonWriter);
        }
        if (globalSecondaryIndexUpdate.getDelete() != null) {
            ...
            DeleteGlobalSecondaryIndexActionJsonMarshaller.getInstance().marshall(delete,
                    jsonWriter);
        }
