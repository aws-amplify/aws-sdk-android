...
/**
 * JSON unmarshaller for response DescribeContinuousBackupsResult
 */
public class DescribeContinuousBackupsResultJsonUnmarshaller implements
        Unmarshaller<DescribeContinuousBackupsResult, JsonUnmarshallerContext> {
