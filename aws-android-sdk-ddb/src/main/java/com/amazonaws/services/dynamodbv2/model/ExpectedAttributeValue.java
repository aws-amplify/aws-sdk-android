...
public class ExpectedAttributeValue implements Serializable {
     ...
     *            operation succeeds. If the value is found, despite the
     ...
     *            <li>
     *            <p>
     *            <i>Exists</i> is <code>true</code> but there is no
     *            <i>Value</i> to check. (You expect a value to exist, but don't
