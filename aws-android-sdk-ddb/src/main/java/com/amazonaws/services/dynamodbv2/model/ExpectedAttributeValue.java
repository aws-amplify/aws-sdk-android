 ...
 * also set <code>Exists</code> to false, indicating that you <i>do not</i>
...
public class ExpectedAttributeValue implements Serializable {
     ...
     * <li>
     * <p>
     * If <code>Exists</code> is <code>true</code>, DynamoDB will check to see
     ...
     * operation fails with a <code>ConditionalCheckFailedException</code>.
     * </p>
     * </li>
     * </ul>
     * <p>
     ...
     * <li>
     * <p>
     * <code>Exists</code> is <code>true</code> but there is no
     * <code>Value</code> to check. (You expect a value to exist, but don't
     ...
     * <code>Value</code>. (You cannot expect an attribute to have a value,
     ...
     *            <li>
     *            <p>
     *            If <code>Exists</code> is <code>true</code>, DynamoDB will
     ...
     *            <li>
     *            <p>
     *            If <code>Exists</code> is <code>false</code>, DynamoDB assumes
     ...
     *            </ul>
     *            <p>
     *            The default setting for <code>Exists</code> is
     *            <code>true</code>. If you supply a <code>Value</code> all by
     *            itself, DynamoDB assumes the attribute exists: You don't have
     *            to set <code>Exists</code> to <code>true</code>, because it is
     *            implied.
     *            </p>
     *            <p>
     *            DynamoDB returns a <code>ValidationException</code> if:
     ...
     *            <p>
     *            <code>Exists</code> is <code>true</code> but there is no
     *            <code>Value</code> to check. (You expect a value to exist, but
     *            don't specify what that value is.)
     *            </p>
     *            </li>
     *            <li>
     *            <p>
     *            <code>Exists</code> is <code>false</code> but you also provide
     *            a <code>Value</code>. (You cannot expect an attribute to have
     ...
     *         <li>
     *         <p>
     *         If <code>Exists</code> is <code>true</code>, DynamoDB will check
     ...
     *         </ul>
     *         <p>
     *         The default setting for <code>Exists</code> is <code>true</code>.
     *         If you supply a <code>Value</code> all by itself, DynamoDB
     *         assumes the attribute exists: You don't have to set
     *         <code>Exists</code> to <code>true</code>, because it is implied.
     *         </p>
     *         <p>
     *         DynamoDB returns a <code>ValidationException</code> if:
     *         </p>
     ...
     *         <p>
     *         <code>Exists</code> is <code>false</code> but you also provide a
     *         <code>Value</code>. (You cannot expect an attribute to have a
     ...
     * @return <p>
     *         A comparator for evaluating attributes in the
     *         <code>AttributeValueList</code>. For example, equals, greater
     *         than, less than, etc.
     *         </p>
     *         <p>
     *         The following comparison operators are available:
