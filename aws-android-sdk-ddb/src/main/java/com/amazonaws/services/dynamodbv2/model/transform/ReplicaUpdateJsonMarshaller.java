...
/**
 * JSON marshaller for POJO ReplicaUpdate
 */
class ReplicaUpdateJsonMarshaller {

    public void marshall(ReplicaUpdate replicaUpdate, AwsJsonWriter jsonWriter) throws Exception {
        jsonWriter.beginObject();
        if (replicaUpdate.getCreate() != null) {
            CreateReplicaAction create = replicaUpdate.getCreate();
            jsonWriter.name("Create");
            CreateReplicaActionJsonMarshaller.getInstance().marshall(create, jsonWriter);
        }
        if (replicaUpdate.getDelete() != null) {
            DeleteReplicaAction delete = replicaUpdate.getDelete();
            jsonWriter.name("Delete");
            DeleteReplicaActionJsonMarshaller.getInstance().marshall(delete, jsonWriter);
        }
