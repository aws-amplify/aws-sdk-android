...
/**
 * JSON unmarshaller for response RestoreTableFromBackupResult
 */
public class RestoreTableFromBackupResultJsonUnmarshaller implements
        Unmarshaller<RestoreTableFromBackupResult, JsonUnmarshallerContext> {
