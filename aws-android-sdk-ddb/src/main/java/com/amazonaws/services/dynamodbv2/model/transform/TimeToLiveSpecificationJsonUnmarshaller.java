...
/**
 * JSON unmarshaller for POJO TimeToLiveSpecification
 */
class TimeToLiveSpecificationJsonUnmarshaller implements
        Unmarshaller<TimeToLiveSpecification, JsonUnmarshallerContext> {
    ...
    public TimeToLiveSpecification unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Enabled")) {
                timeToLiveSpecification.setEnabled(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("AttributeName")) {
                timeToLiveSpecification.setAttributeName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
