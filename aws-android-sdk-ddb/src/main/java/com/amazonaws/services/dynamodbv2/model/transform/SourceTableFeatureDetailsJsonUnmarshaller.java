...
/**
 * JSON unmarshaller for POJO SourceTableFeatureDetails
 */
class SourceTableFeatureDetailsJsonUnmarshaller implements
        Unmarshaller<SourceTableFeatureDetails, JsonUnmarshallerContext> {
