...
/**
 * JSON unmarshaller for response UpdateContinuousBackupsResult
 */
public class UpdateContinuousBackupsResultJsonUnmarshaller implements
        Unmarshaller<UpdateContinuousBackupsResult, JsonUnmarshallerContext> {
