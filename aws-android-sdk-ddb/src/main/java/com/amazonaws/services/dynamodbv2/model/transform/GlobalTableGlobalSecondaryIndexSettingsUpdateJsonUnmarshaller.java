...
/**
 * JSON unmarshaller for POJO GlobalTableGlobalSecondaryIndexSettingsUpdate
 */
class GlobalTableGlobalSecondaryIndexSettingsUpdateJsonUnmarshaller implements
