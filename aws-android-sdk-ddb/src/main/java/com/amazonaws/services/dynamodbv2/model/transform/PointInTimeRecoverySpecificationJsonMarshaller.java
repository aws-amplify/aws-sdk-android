...
/**
 * JSON marshaller for POJO PointInTimeRecoverySpecification
 */
class PointInTimeRecoverySpecificationJsonMarshaller {
    ...
    public void marshall(PointInTimeRecoverySpecification pointInTimeRecoverySpecification,
        ...
        if (pointInTimeRecoverySpecification.getPointInTimeRecoveryEnabled() != null) {
            Boolean pointInTimeRecoveryEnabled = pointInTimeRecoverySpecification
                    .getPointInTimeRecoveryEnabled();
            jsonWriter.name("PointInTimeRecoveryEnabled");
            jsonWriter.value(pointInTimeRecoveryEnabled);
        }
