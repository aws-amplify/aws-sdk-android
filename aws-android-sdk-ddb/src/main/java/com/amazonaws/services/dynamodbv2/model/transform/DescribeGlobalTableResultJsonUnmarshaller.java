...
/**
 * JSON unmarshaller for response DescribeGlobalTableResult
 */
public class DescribeGlobalTableResultJsonUnmarshaller implements
        Unmarshaller<DescribeGlobalTableResult, JsonUnmarshallerContext> {
