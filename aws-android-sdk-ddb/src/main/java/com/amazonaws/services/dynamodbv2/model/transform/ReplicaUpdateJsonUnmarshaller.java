...
/**
 * JSON unmarshaller for POJO ReplicaUpdate
 */
    ...
    public ReplicaUpdate unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Create")) {
                replicaUpdate.setCreate(CreateReplicaActionJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Delete")) {
                replicaUpdate.setDelete(DeleteReplicaActionJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
