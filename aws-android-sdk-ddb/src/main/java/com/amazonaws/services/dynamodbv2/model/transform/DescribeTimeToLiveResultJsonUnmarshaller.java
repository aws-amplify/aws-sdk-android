...
/**
 * JSON unmarshaller for response DescribeTimeToLiveResult
 */
public class DescribeTimeToLiveResultJsonUnmarshaller implements
        Unmarshaller<DescribeTimeToLiveResult, JsonUnmarshallerContext> {
