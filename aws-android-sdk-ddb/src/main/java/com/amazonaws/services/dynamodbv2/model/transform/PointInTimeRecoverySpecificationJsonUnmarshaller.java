...
/**
 * JSON unmarshaller for POJO PointInTimeRecoverySpecification
 */
class PointInTimeRecoverySpecificationJsonUnmarshaller implements
        Unmarshaller<PointInTimeRecoverySpecification, JsonUnmarshallerContext> {
    ...
    public PointInTimeRecoverySpecification unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PointInTimeRecoveryEnabled")) {
                pointInTimeRecoverySpecification
                        .setPointInTimeRecoveryEnabled(BooleanJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
            }
