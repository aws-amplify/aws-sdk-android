...
/**
 * JSON request marshaller for DescribeLimitsRequest
 */
public class DescribeLimitsRequestMarshaller implements
        Marshaller<Request<DescribeLimitsRequest>, DescribeLimitsRequest> {
