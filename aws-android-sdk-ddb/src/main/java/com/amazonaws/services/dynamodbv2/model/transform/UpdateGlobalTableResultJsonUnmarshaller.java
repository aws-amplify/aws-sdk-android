...
/**
 * JSON unmarshaller for response UpdateGlobalTableResult
 */
public class UpdateGlobalTableResultJsonUnmarshaller implements
        Unmarshaller<UpdateGlobalTableResult, JsonUnmarshallerContext> {
