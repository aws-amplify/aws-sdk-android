...
/**
 * JSON unmarshaller for POJO AttributeDefinition
 */
class AttributeDefinitionJsonUnmarshaller implements
    ...
    public AttributeDefinition unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AttributeName")) {
                attributeDefinition.setAttributeName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("AttributeType")) {
                attributeDefinition.setAttributeType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
