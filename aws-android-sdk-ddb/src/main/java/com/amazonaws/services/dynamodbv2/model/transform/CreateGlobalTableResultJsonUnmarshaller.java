...
/**
 * JSON unmarshaller for response CreateGlobalTableResult
 */
public class CreateGlobalTableResultJsonUnmarshaller implements
        Unmarshaller<CreateGlobalTableResult, JsonUnmarshallerContext> {
