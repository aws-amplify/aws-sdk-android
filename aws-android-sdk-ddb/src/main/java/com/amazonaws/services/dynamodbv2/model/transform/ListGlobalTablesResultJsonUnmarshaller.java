...
/**
 * JSON unmarshaller for response ListGlobalTablesResult
 */
public class ListGlobalTablesResultJsonUnmarshaller implements
        Unmarshaller<ListGlobalTablesResult, JsonUnmarshallerContext> {
