...
/**
 * JSON unmarshaller for response ListFleetsResult
 */
public class ListFleetsResultJsonUnmarshaller implements
        Unmarshaller<ListFleetsResult, JsonUnmarshallerContext> {
    ...
    public ListFleetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("FleetSummaryList")) {
                listFleetsResult.setFleetSummaryList(new ListUnmarshaller<FleetSummary>(
                        FleetSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                listFleetsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
