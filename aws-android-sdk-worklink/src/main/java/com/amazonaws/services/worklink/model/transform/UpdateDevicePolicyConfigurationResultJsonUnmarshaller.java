...
/**
 * JSON unmarshaller for response UpdateDevicePolicyConfigurationResult
 */
public class UpdateDevicePolicyConfigurationResultJsonUnmarshaller implements
        Unmarshaller<UpdateDevicePolicyConfigurationResult, JsonUnmarshallerContext> {

    public UpdateDevicePolicyConfigurationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
