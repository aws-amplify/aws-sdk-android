...
/**
 * JSON unmarshaller for response DisassociateWebsiteCertificateAuthorityResult
 */
public class DisassociateWebsiteCertificateAuthorityResultJsonUnmarshaller implements
    ...
    public DisassociateWebsiteCertificateAuthorityResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
