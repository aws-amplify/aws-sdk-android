...
public class CreateFleetRequestMarshaller implements
    ...
    public Request<CreateFleetRequest> marshall(CreateFleetRequest createFleetRequest) {
        ...
        Request<CreateFleetRequest> request = new DefaultRequest<CreateFleetRequest>(
                createFleetRequest, "AmazonWorkLink");
        ...
        try {
            ...
            if (createFleetRequest.getFleetName() != null) {
                String fleetName = createFleetRequest.getFleetName();
                jsonWriter.name("FleetName");
                jsonWriter.value(fleetName);
            }
            if (createFleetRequest.getDisplayName() != null) {
                String displayName = createFleetRequest.getDisplayName();
                jsonWriter.name("DisplayName");
                jsonWriter.value(displayName);
            }
            if (createFleetRequest.getOptimizeForEndUserLocation() != null) {
                Boolean optimizeForEndUserLocation = createFleetRequest
                        .getOptimizeForEndUserLocation();
                jsonWriter.name("OptimizeForEndUserLocation");
                jsonWriter.value(optimizeForEndUserLocation);
            }
            if (createFleetRequest.getTags() != null) {
                java.util.Map<String, String> tags = createFleetRequest.getTags();
