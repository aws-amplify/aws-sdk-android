...
.unmarshall(context));
                ...
                connection.setConnectionArn(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("ProviderType")) {
                connection.setProviderType(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("OwnerAccountId")) {
                connection.setOwnerAccountId(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("ConnectionStatus")) {
                connection.setConnectionStatus(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
