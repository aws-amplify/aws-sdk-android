...
public class UntagResourceRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Length: </b>1 - 1011<br/>
     *
     * @return <p>The Amazon Resource Name (ARN) of the resource to remove tags from.</p>
     */
     ...
     * <b>Length: </b>1 - 1011<br/>
     *
     * @param resourceArn <p>The Amazon Resource Name (ARN) of the resource to remove tags from.</p>
     */
     ...
     * <p>The list of keys for the tags to be removed from the resource.</p>
     *
     * @return <p>The list of keys for the tags to be removed from the resource.</p>
     */
     ...
     * <p>The list of keys for the tags to be removed from the resource.</p>
     *
     * @param tagKeys <p>The list of keys for the tags to be removed from the resource.</p>
     */
