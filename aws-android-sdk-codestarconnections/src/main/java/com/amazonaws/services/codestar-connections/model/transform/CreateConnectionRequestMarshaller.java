...
public class CreateConnectionRequestMarshaller implements Marshaller<Request<CreateConnectionRequest>, CreateConnectionRequest> {
    ...
    public Request<CreateConnectionRequest> marshall(CreateConnectionRequest createConnectionRequest) {
        if (createConnectionRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(CreateConnectionRequest)");
        }

        Request<CreateConnectionRequest> request = new DefaultRequest<CreateConnectionRequest>(createConnectionRequest, "AWSCodeStarconnections");
        ...
        try {
            ...
            if (createConnectionRequest.getProviderType() != null) {
                String providerType = createConnectionRequest.getProviderType();
