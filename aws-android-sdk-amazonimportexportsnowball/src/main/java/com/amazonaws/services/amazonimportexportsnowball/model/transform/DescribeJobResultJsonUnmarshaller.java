...
/**
 * JSON unmarshaller for response DescribeJobResult
 */
public class DescribeJobResultJsonUnmarshaller implements
    ...
    public DescribeJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("JobMetadata")) {
                describeJobResult.setJobMetadata(JobMetadataJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("SubJobMetadata")) {
                describeJobResult.setSubJobMetadata(new ListUnmarshaller<JobMetadata>(
