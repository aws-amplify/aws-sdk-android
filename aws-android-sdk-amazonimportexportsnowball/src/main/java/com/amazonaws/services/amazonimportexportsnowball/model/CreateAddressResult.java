...
public class CreateAddressResult implements Serializable {
     ...
     *
     * @param addressId <p>
     *            The automatically generated ID for a specific address. You'll
     *            use this ID when you create a job to specify which address you
     *            want the Snowball for that job shipped to.
     *            </p>
     */
