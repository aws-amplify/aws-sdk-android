...
/**
 * JSON unmarshaller for response ListCompatibleImagesResult
 */
public class ListCompatibleImagesResultJsonUnmarshaller implements
        Unmarshaller<ListCompatibleImagesResult, JsonUnmarshallerContext> {
    ...
    public ListCompatibleImagesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("CompatibleImages")) {
                listCompatibleImagesResult
                        .setCompatibleImages(new ListUnmarshaller<CompatibleImage>(
                                CompatibleImageJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                listCompatibleImagesResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
