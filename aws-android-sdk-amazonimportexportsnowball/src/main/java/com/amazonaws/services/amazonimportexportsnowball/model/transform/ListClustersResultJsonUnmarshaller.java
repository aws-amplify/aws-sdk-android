...
/**
 * JSON unmarshaller for response ListClustersResult
 */
public class ListClustersResultJsonUnmarshaller implements
    ...
    public ListClustersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ClusterListEntries")) {
                listClustersResult.setClusterListEntries(new ListUnmarshaller<ClusterListEntry>(
                        ClusterListEntryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                listClustersResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
