...
public class CreateDomainRequestMarshaller implements
    ...
    public Request<CreateDomainRequest> marshall(CreateDomainRequest createDomainRequest) {
        ...
        Request<CreateDomainRequest> request = new DefaultRequest<CreateDomainRequest>(
                createDomainRequest, "CodeArtifact");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/v1/domain";
        if (createDomainRequest.getDomain() != null) {
            request.addParameter("domain", StringUtils.fromString(createDomainRequest.getDomain()));
        }
        ...
        try {
            ...
            if (createDomainRequest.getEncryptionKey() != null) {
                String encryptionKey = createDomainRequest.getEncryptionKey();
