 ...
 */
public class ListPackageVersionDependenciesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p> The domain that contains the repository that contains the requested package version dependencies. </p>
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Length: </b>2 - 50<br/>
     ...
     * <b>Pattern: </b>[a-z][a-z0-9\-]{0,48}[a-z0-9]<br/>
     *
     * @return <p> The domain that contains the repository that contains the requested package version dependencies. </p>
     */
     ...
     * <b>Pattern: </b>[a-z][a-z0-9\-]{0,48}[a-z0-9]<br/>
     *
     * @param domain <p> The domain that contains the repository that contains the requested package version dependencies. </p>
     */
     ...
     * <b>Pattern: </b>[A-Za-z0-9][A-Za-z0-9._\-]{1,99}<br/>
     *
     * @return <p> The name of the repository that contains the requested package version. </p>
     */
     ...
     * <b>Pattern: </b>[A-Za-z0-9][A-Za-z0-9._\-]{1,99}<br/>
     *
     * @param repository <p> The name of the repository that contains the requested package version. </p>
     */
     ...
     * <b>Pattern: </b>[^!#/\s]+<br/>
     *
     * @return <p> The name of the package versions' package. </p>
     */
     ...
     * <b>Pattern: </b>[^!#/\s]+<br/>
     *
     * @param package <p> The name of the package versions' package. </p>
     */
     ...
     * @return A reference to this updated object so that method calls can be chained together.
     */
    public ListPackageVersionDependenciesRequest withPackage(String package) {
        this.package = package;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListPackageVersionDependenciesRequest == false) return false;
