 ...
 * </p>
 */
public class PutRepositoryPermissionsPolicyRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         The name of the domain containing the repository to set the
     *         resource policy on.
     *         </p>
     */
     ...
     *
     * @return <p>
     *         Sets the revision of the resource policy that specifies
     ...
     *            Sets the revision of the resource policy that specifies
     *            permissions to access the repository. This revision is used
     *            for optimistic locking, which prevents others from overwriting
