...
/**
 * JSON unmarshaller for response UpdatePackageVersionsStatusResult
 */
public class UpdatePackageVersionsStatusResultJsonUnmarshaller implements
        Unmarshaller<UpdatePackageVersionsStatusResult, JsonUnmarshallerContext> {

    public UpdatePackageVersionsStatusResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
