 ...
 * </p>
 */
public class GetRepositoryPermissionsPolicyRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *
     * @param domain <p>
     *            The name of the domain containing the repository whose
     ...
     *
     * @return <p>
     *         The name of the repository whose associated resource policy is to
     *         be retrieved.
     *         </p>
     */
     ...
     *
     * @param repository <p>
     *            The name of the repository whose associated resource policy is
     *            to be retrieved.
     *            </p>
     */
