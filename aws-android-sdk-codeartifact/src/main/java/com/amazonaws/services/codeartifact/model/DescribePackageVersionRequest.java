...
/**
 * <p> Returns a <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageVersionDescription.html"> <code>PackageVersionDescription</code> </a> object that contains information about the requested package version. </p>
 */
public class DescribePackageVersionRequest extends AmazonWebServiceRequest implements Serializable {
    /**
    ...
    /**
     * <p> A format that specifies the type of the requested package version. The valid values are: </p> <ul> <li> <p> <code>npm</code> </p> </li> <li> <p> <code>pypi</code> </p> </li> <li> <p> <code>maven</code> </p> </li> </ul>
     * <p>
     * <b>Constraints:</b><br/>
     ...
     * <b>Pattern: </b>[a-z][a-z0-9\-]{0,48}[a-z0-9]<br/>
     *
     * @return <p> The name of the domain that contains the repository that contains the package version. </p>
     */
     ...
     * <b>Pattern: </b>[a-z][a-z0-9\-]{0,48}[a-z0-9]<br/>
     *
     * @param domain <p> The name of the domain that contains the repository that contains the package version. </p>
     */
     ...
     * <b>Pattern: </b>[A-Za-z0-9][A-Za-z0-9._\-]{1,99}<br/>
     *
     * @return <p> The name of the repository that contains the package version. </p>
     */
     ...
     * <b>Pattern: </b>[A-Za-z0-9][A-Za-z0-9._\-]{1,99}<br/>
     *
     * @param repository <p> The name of the repository that contains the package version. </p>
     */
     ...
     * <b>Allowed Values: </b>npm, pypi, maven
     *
     * @return <p> A format that specifies the type of the requested package version. The valid values are: </p> <ul> <li> <p> <code>npm</code> </p> </li> <li> <p> <code>pypi</code> </p> </li> <li> <p> <code>maven</code> </p> </li> </ul>
     *
     * @see PackageFormat
     */
     ...
     * <b>Allowed Values: </b>npm, pypi, maven
     *
     * @param format <p> A format that specifies the type of the requested package version. The valid values are: </p> <ul> <li> <p> <code>npm</code> </p> </li> <li> <p> <code>pypi</code> </p> </li> <li> <p> <code>maven</code> </p> </li> </ul>
     *
     * @see PackageFormat
     */
     ...
     * <b>Pattern: </b>[^!#/\s]+<br/>
     *
     * @return <p> The name of the requested package version. </p>
     */
     ...
     * <b>Pattern: </b>[^!#/\s]+<br/>
     *
     * @param package <p> The name of the requested package version. </p>
     */
     ...
     * @return A reference to this updated object so that method calls can be chained together.
     */
    public DescribePackageVersionRequest withPackage(String package) {
        this.package = package;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribePackageVersionRequest == false) return false;
