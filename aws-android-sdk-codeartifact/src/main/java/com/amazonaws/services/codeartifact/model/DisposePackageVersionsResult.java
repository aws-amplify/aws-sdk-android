...
public class DisposePackageVersionsResult implements Serializable {
    /**
     * <p>
     ...
     *            A list of the package versions that were successfully
     *            disposed.
     *            </p>
     */
     ...
     *         chained together.
     */
    public DisposePackageVersionsResult withSuccessfulVersions(
            java.util.Map<String, SuccessfulPackageVersionInfo> successfulVersions) {
        this.successfulVersions = successfulVersions;
        return this;
    }
     ...
     *         chained together.
     */
    public DisposePackageVersionsResult addsuccessfulVersionsEntry(String key,
     ...
     *
     * @return <p>
     *         A <code>PackageVersionError</code> object that contains a map of
     *         errors codes for the disposed package versions that failed. The
     ...
     *            A <code>PackageVersionError</code> object that contains a map
     *            of errors codes for the disposed package versions that failed.
     ...
     *         chained together.
     */
    public DisposePackageVersionsResult withFailedVersions(
