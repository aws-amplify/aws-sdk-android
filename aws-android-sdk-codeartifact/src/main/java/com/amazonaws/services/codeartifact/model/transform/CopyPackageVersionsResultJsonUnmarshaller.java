...
/**
 * JSON unmarshaller for response CopyPackageVersionsResult
 */
public class CopyPackageVersionsResultJsonUnmarshaller implements
        Unmarshaller<CopyPackageVersionsResult, JsonUnmarshallerContext> {
