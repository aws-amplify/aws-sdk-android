 ...
 */
public class DisposePackageVersionsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
    ...
    /**
     * <p> A format that specifies the type of package versions you want to dispose. The valid values are: </p> <ul> <li> <p> <code>npm</code> </p> </li> <li> <p> <code>pypi</code> </p> </li> <li> <p> <code>maven</code> </p> </li> </ul>
     * <p>
     * <b>Constraints:</b><br/>
    ...
    /**
     * <p> The expected status of the package version to dispose. Valid values are: </p> <ul> <li> <p> <code>Published</code> </p> </li> <li> <p> <code>Unfinished</code> </p> </li> <li> <p> <code>Unlisted</code> </p> </li> <li> <p> <code>Archived</code> </p> </li> <li> <p> <code>Disposed</code> </p> </li> </ul>
     * <p>
     * <b>Constraints:</b><br/>
     ...
     * <b>Pattern: </b>[a-z][a-z0-9\-]{0,48}[a-z0-9]<br/>
     *
     * @return <p> The name of the domain that contains the repository you want to dispose. </p>
     */
     ...
     * <b>Pattern: </b>[a-z][a-z0-9\-]{0,48}[a-z0-9]<br/>
     *
     * @param domain <p> The name of the domain that contains the repository you want to dispose. </p>
     */
     ...
     * <b>Pattern: </b>[A-Za-z0-9][A-Za-z0-9._\-]{1,99}<br/>
     *
     * @return <p> The name of the repository that contains the package versions you want to dispose. </p>
     */
     ...
     * <b>Pattern: </b>[A-Za-z0-9][A-Za-z0-9._\-]{1,99}<br/>
     *
     * @param repository <p> The name of the repository that contains the package versions you want to dispose. </p>
     */
     ...
     * <b>Allowed Values: </b>npm, pypi, maven
     *
     * @return <p> A format that specifies the type of package versions you want to dispose. The valid values are: </p> <ul> <li> <p> <code>npm</code> </p> </li> <li> <p> <code>pypi</code> </p> </li> <li> <p> <code>maven</code> </p> </li> </ul>
     *
     * @see PackageFormat
     */
     ...
     * <b>Allowed Values: </b>npm, pypi, maven
     *
     * @param format <p> A format that specifies the type of package versions you want to dispose. The valid values are: </p> <ul> <li> <p> <code>npm</code> </p> </li> <li> <p> <code>pypi</code> </p> </li> <li> <p> <code>maven</code> </p> </li> </ul>
     *
     * @see PackageFormat
     */
     ...
     * <b>Pattern: </b>[^!#/\s]+<br/>
     *
     * @return <p> The name of the package with the versions you want to dispose. </p>
     */
     ...
     * <b>Pattern: </b>[^!#/\s]+<br/>
     *
     * @param package <p> The name of the package with the versions you want to dispose. </p>
     */
     ...
     * @return A reference to this updated object so that method calls can be chained together.
     */
    public DisposePackageVersionsRequest withPackage(String package) {
        this.package = package;
        return this;
    }
     ...
     * <p> The versions of the package you want to dispose. </p>
     *
     * @return <p> The versions of the package you want to dispose. </p>
     */
     ...
     * <p> The versions of the package you want to dispose. </p>
     *
     * @param versions <p> The versions of the package you want to dispose. </p>
     */
     ...
     * <p> The revisions of the package versions you want to dispose. </p>
     *
     * @return <p> The revisions of the package versions you want to dispose. </p>
     */
     ...
     * <p> The revisions of the package versions you want to dispose. </p>
     *
     * @param versionRevisions <p> The revisions of the package versions you want to dispose. </p>
     */
     ...
     * <b>Allowed Values: </b>Published, Unfinished, Unlisted, Archived, Disposed, Deleted
     *
     * @return <p> The expected status of the package version to dispose. Valid values are: </p> <ul> <li> <p> <code>Published</code> </p> </li> <li> <p> <code>Unfinished</code> </p> </li> <li> <p> <code>Unlisted</code> </p> </li> <li> <p> <code>Archived</code> </p> </li> <li> <p> <code>Disposed</code> </p> </li> </ul>
     *
     ...
     * <b>Allowed Values: </b>Published, Unfinished, Unlisted, Archived, Disposed, Deleted
     *
     * @param expectedStatus <p> The expected status of the package version to dispose. Valid values are: </p> <ul> <li> <p> <code>Published</code> </p> </li> <li> <p> <code>Unfinished</code> </p> </li> <li> <p> <code>Unlisted</code> </p> </li> <li> <p> <code>Archived</code> </p> </li> <li> <p> <code>Disposed</code> </p> </li> </ul>
     *
     * @see PackageVersionStatus
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisposePackageVersionsRequest == false) return false;
