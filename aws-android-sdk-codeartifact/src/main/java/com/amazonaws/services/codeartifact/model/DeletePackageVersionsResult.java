...
public class DeletePackageVersionsResult implements Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public DeletePackageVersionsResult withSuccessfulVersions(
            java.util.Map<String, SuccessfulPackageVersionInfo> successfulVersions) {
        this.successfulVersions = successfulVersions;
        return this;
    }
     ...
     *         chained together.
     */
    public DeletePackageVersionsResult addsuccessfulVersionsEntry(String key,
     ...
     *         errors codes for the deleted package that failed. The possible
     *         error codes are:
     *         </p>
     *         <ul>
     *         <li>
     ...
     *            of errors codes for the deleted package that failed. The
     ...
     *         chained together.
     */
    public DeletePackageVersionsResult withFailedVersions(
