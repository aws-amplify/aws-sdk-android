 ...
 * </p>
 */
public class ListLabelingJobsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         If the result of the previous <code>ListLabelingJobs</code>
     *         request was truncated, the response includes a
     *         <code>NextToken</code>. To retrieve the next set of labeling
     ...
     *
     * @return <p>
     *         A string in the labeling job name. This filter returns only
     *         labeling jobs whose name contains the specified string.
     *         </p>
     */
     ...
     *
     * @return <p>
     *         A filter that retrieves only labeling jobs with a specific
     *         status.
     *         </p>
