 ...
 * </p>
 */
public class ListProcessingJobsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * the next set of processing jobs, use the token in the next request.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Length: </b> - 8192<br/>
     ...
     *         chained together.
     */
    public ListProcessingJobsRequest withLastModifiedTimeBefore(
     ...
     *
     * @return <p>
     *         A filter that retrieves only processing jobs with a specific
     *         status.
     *         </p>
     ...
     *
     * @return <p>
     *         If the result of the previous <code>ListProcessingJobs</code>
     *         request was truncated, the response includes a
     *         <code>NextToken</code>. To retrieve the next set of processing
     ...
     *
     * @param maxResults <p>
     *            The maximum number of processing jobs to return in the
     *            response.
     *            </p>
     */
