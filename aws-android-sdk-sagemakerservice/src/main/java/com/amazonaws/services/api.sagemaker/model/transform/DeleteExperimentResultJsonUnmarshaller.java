...
/**
 * JSON unmarshaller for response DeleteExperimentResult
 */
public class DeleteExperimentResultJsonUnmarshaller implements
        Unmarshaller<DeleteExperimentResult, JsonUnmarshallerContext> {
    ...
    public DeleteExperimentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ExperimentArn")) {
                deleteExperimentResult.setExperimentArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
