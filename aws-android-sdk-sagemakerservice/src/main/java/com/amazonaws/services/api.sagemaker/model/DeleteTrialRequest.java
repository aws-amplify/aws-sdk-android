 ...
 * be deleted first. Use the <a>DescribeTrialComponent</a> API to get the list
 * of trial components.
 * </p>
 */
public class DeleteTrialRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
