...
/**
 * JSON unmarshaller for response UpdateNotebookInstanceResult
 */
public class UpdateNotebookInstanceResultJsonUnmarshaller implements
        Unmarshaller<UpdateNotebookInstanceResult, JsonUnmarshallerContext> {

    public UpdateNotebookInstanceResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
