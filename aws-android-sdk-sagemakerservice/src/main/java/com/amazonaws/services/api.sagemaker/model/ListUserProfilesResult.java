...
public class ListUserProfilesResult implements Serializable {
    /**
     * <p>
    ...
    public ListUserProfilesResult withUserProfiles(UserProfileDetails... userProfiles) {
        if (getUserProfiles() == null) {
            this.userProfiles = new java.util.ArrayList<UserProfileDetails>(userProfiles.length);
        }
        for (UserProfileDetails value : userProfiles) {
            this.userProfiles.add(value);
        }
        return this;
    }
     ...
     *         chained together.
     */
    public ListUserProfilesResult withUserProfiles(
            java.util.Collection<UserProfileDetails> userProfiles) {
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getUserProfiles() == null) ? 0 : getUserProfiles().hashCode());
