...
/**
 * JSON unmarshaller for POJO LabelingJobInputConfig
 */
class LabelingJobInputConfigJsonUnmarshaller implements
        Unmarshaller<LabelingJobInputConfig, JsonUnmarshallerContext> {
    ...
    public LabelingJobInputConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("DataSource")) {
                labelingJobInputConfig.setDataSource(LabelingJobDataSourceJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("DataAttributes")) {
                labelingJobInputConfig.setDataAttributes(LabelingJobDataAttributesJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
