...
class NotificationConfigurationJsonMarshaller {
    ...
    public void marshall(NotificationConfiguration notificationConfiguration,
        ...
        if (notificationConfiguration.getNotificationTopicArn() != null) {
            String notificationTopicArn = notificationConfiguration.getNotificationTopicArn();
            jsonWriter.name("NotificationTopicArn");
            jsonWriter.value(notificationTopicArn);
        }
