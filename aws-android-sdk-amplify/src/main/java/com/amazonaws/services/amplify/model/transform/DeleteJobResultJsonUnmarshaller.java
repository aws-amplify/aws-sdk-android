...
/**
 * JSON unmarshaller for response DeleteJobResult
 */
public class DeleteJobResultJsonUnmarshaller implements
        Unmarshaller<DeleteJobResult, JsonUnmarshallerContext> {
    ...
    public DeleteJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("jobSummary")) {
                deleteJobResult.setJobSummary(JobSummaryJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
