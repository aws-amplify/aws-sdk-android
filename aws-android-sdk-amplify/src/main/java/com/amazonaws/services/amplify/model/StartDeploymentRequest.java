...
public class StartDeploymentRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         The job ID for this deployment, generated by the create
     *         deployment request.
     *         </p>
     */
     ...
     *         deployment without create deployment. The source URL can be any
     *         HTTP GET URL that is publicly accessible and downloads a single
     *         .zip file.
     *         </p>
     */
     ...
     * @param sourceUrl <p>
     *            The source URL for this deployment, used when calling start
     *            deployment without create deployment. The source URL can be
     *            any HTTP GET URL that is publicly accessible and downloads a
     *            single .zip file.
     *            </p>
     */
