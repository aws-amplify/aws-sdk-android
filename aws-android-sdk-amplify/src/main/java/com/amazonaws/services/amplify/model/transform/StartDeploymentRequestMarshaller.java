...
public class StartDeploymentRequestMarshaller implements
    ...
    public Request<StartDeploymentRequest> marshall(StartDeploymentRequest startDeploymentRequest) {
        ...
        Request<StartDeploymentRequest> request = new DefaultRequest<StartDeploymentRequest>(
                startDeploymentRequest, "AWSAmplify");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/apps/{appId}/branches/{branchName}/deployments/start";
        uriResourcePath = uriResourcePath.replace(
                "{appId}",
                (startDeploymentRequest.getAppId() == null) ? "" : StringUtils
                        .fromString(startDeploymentRequest.getAppId()));
        uriResourcePath = uriResourcePath.replace(
                "{branchName}",
                (startDeploymentRequest.getBranchName() == null) ? "" : StringUtils
                        .fromString(startDeploymentRequest.getBranchName()));
        ...
        try {
            ...
            if (startDeploymentRequest.getJobId() != null) {
                String jobId = startDeploymentRequest.getJobId();
                jsonWriter.name("jobId");
                jsonWriter.value(jobId);
            }
            if (startDeploymentRequest.getSourceUrl() != null) {
                String sourceUrl = startDeploymentRequest.getSourceUrl();
