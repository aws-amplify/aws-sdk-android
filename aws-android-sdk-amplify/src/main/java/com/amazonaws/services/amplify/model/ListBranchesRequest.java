 ...
 * </p>
 */
public class ListBranchesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         A pagination token. Set to null to start listing branches from
     *         the start. If a non-null pagination token is returned in a
