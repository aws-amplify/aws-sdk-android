...
/**
 * JSON unmarshaller for response StartJobResult
 */
public class StartJobResultJsonUnmarshaller implements
        Unmarshaller<StartJobResult, JsonUnmarshallerContext> {
    ...
    public StartJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("jobSummary")) {
                startJobResult.setJobSummary(JobSummaryJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
