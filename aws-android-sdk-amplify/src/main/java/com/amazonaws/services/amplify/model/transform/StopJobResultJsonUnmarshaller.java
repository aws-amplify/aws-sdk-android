...
/**
 * JSON unmarshaller for response StopJobResult
 */
public class StopJobResultJsonUnmarshaller implements
        Unmarshaller<StopJobResult, JsonUnmarshallerContext> {
    ...
    public StopJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("jobSummary")) {
                stopJobResult.setJobSummary(JobSummaryJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
