...
/**
 * JSON request marshaller for ListBranchesRequest
 */
    ...
    public Request<ListBranchesRequest> marshall(ListBranchesRequest listBranchesRequest) {
        if (listBranchesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListBranchesRequest)");
        }

        Request<ListBranchesRequest> request = new DefaultRequest<ListBranchesRequest>(
                listBranchesRequest, "AWSAmplify");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/apps/{appId}/branches";
        uriResourcePath = uriResourcePath.replace(
                "{appId}",
                (listBranchesRequest.getAppId() == null) ? "" : StringUtils
                        .fromString(listBranchesRequest.getAppId()));
        if (listBranchesRequest.getNextToken() != null) {
            request.addParameter("nextToken",
                    StringUtils.fromString(listBranchesRequest.getNextToken()));
        }
        if (listBranchesRequest.getMaxResults() != null) {
            request.addParameter("maxResults",
                    StringUtils.fromInteger(listBranchesRequest.getMaxResults()));
        }
