...
public class ListJobsRequestMarshaller implements
    ...
    public Request<ListJobsRequest> marshall(ListJobsRequest listJobsRequest) {
        ...
        uriResourcePath = uriResourcePath.replace(
                "{appId}",
                (listJobsRequest.getAppId() == null) ? "" : StringUtils.fromString(listJobsRequest
                        .getAppId()));
        uriResourcePath = uriResourcePath.replace(
                "{branchName}",
                (listJobsRequest.getBranchName() == null) ? "" : StringUtils
                        .fromString(listJobsRequest.getBranchName()));
