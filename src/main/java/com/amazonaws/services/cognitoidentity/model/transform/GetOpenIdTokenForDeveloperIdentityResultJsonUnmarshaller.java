...
/**
 * Get Open Id Token For Developer Identity Result JSON Unmarshaller
 */
public class GetOpenIdTokenForDeveloperIdentityResultJsonUnmarshaller implements Unmarshaller<GetOpenIdTokenForDeveloperIdentityResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IdentityId", targetDepth)) {
                    context.nextToken();
                    getOpenIdTokenForDeveloperIdentityResult.setIdentityId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Token", targetDepth)) {
                    context.nextToken();
                    getOpenIdTokenForDeveloperIdentityResult.setToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static GetOpenIdTokenForDeveloperIdentityResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new GetOpenIdTokenForDeveloperIdentityResultJsonUnmarshaller();
        return instance;
    }
}
