...
/**
 * Merge Developer Identities Result JSON Unmarshaller
 */
public class MergeDeveloperIdentitiesResultJsonUnmarshaller implements Unmarshaller<MergeDeveloperIdentitiesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IdentityId", targetDepth)) {
                    context.nextToken();
                    mergeDeveloperIdentitiesResult.setIdentityId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static MergeDeveloperIdentitiesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new MergeDeveloperIdentitiesResultJsonUnmarshaller();
        return instance;
    }
}
