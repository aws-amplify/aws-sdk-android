    ...
    if (getOpenIdTokenForDeveloperIdentityRequest == null) {
        ...
        try {
            ...
            if (getOpenIdTokenForDeveloperIdentityRequest.getIdentityPoolId() != null) {
                jsonWriter.name("IdentityPoolId").value(getOpenIdTokenForDeveloperIdentityRequest.getIdentityPoolId());
            }
            if (getOpenIdTokenForDeveloperIdentityRequest.getIdentityId() != null) {
                jsonWriter.name("IdentityId").value(getOpenIdTokenForDeveloperIdentityRequest.getIdentityId());
            }
            ...
            if (getOpenIdTokenForDeveloperIdentityRequest.getTokenDuration() != null) {
                jsonWriter.name("TokenDuration").value(getOpenIdTokenForDeveloperIdentityRequest.getTokenDuration());
            }
