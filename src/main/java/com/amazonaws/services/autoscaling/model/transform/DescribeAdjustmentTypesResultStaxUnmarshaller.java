...
public class DescribeAdjustmentTypesResultStaxUnmarshaller implements Unmarshaller<DescribeAdjustmentTypesResult, StaxUnmarshallerContext> {
    ...
    public DescribeAdjustmentTypesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return describeAdjustmentTypesResult;

            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("AdjustmentTypes/member", targetDepth)) {
                    describeAdjustmentTypesResult.getAdjustmentTypes().add(AdjustmentTypeStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeAdjustmentTypesResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeAdjustmentTypesResultStaxUnmarshaller();
        return instance;
    }
}
