 ...
 * application.
 *
 * Each MobileAnalyticsManager instance is associated with a app ID which is used both as a key to
 * get a SharedPreferences object that MobileAnalyticsManager can use, and as a directory
 * name that MobileAnalyticsManager will use to store files about events that you
 * record.  If you are developing a library, you should create a app ID for your library so it
 * does not collide with the app ID of app developer using your library.
 * 
 */
public class MobileAnalyticsManager {
    ...
    private static final Logger logger = Logger.getLogger(MobileAnalyticsManager.class);
     ...
     * @param options
     *            The {@link AnalyticsConfig} to use when creating the
     ...
     *             if any part of constructing the MobileAnalyticsManager instance
     *             failed
     */
    private MobileAnalyticsManager(final Context appContext, final String appId, final Regions region, final AWSCredentialsProvider credentialsProvider, 
            AnalyticsConfig options, final AnalyticsCallback<MobileAnalyticsManager> initCompletionCallback) throws InitializationException {
        ...
        try {
            ...
            AmazonMobileAnalyticsClient ersClient = new AmazonMobileAnalyticsClient(credentialsProvider,
            ...
            this.context = DefaultAnalyticsContext.newInstance(ersClient, appContext, appId, region, sdkInfo, options.getAllowWANDelivery());
