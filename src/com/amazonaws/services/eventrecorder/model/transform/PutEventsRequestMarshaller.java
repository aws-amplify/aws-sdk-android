...
public class PutEventsRequestMarshaller implements Marshaller<Request<PutEventsRequest>, PutEventsRequest> {
    ...
    if (putEventsRequest == null) {
        ...
        Request<PutEventsRequest> request = new DefaultRequest<PutEventsRequest>(putEventsRequest, "AWSEventRecorderService");
        String target = "AWSEventRecorderService.PutEvents";
