...
public class ListIdentityPoolUsageRequestMarshaller implements Marshaller<Request<ListIdentityPoolUsageRequest>, ListIdentityPoolUsageRequest> {
    ...
    if (listIdentityPoolUsageRequest == null) {
        ...
        Request<ListIdentityPoolUsageRequest> request = new DefaultRequest<ListIdentityPoolUsageRequest>(listIdentityPoolUsageRequest, "AmazonCognitoSyncService");
        ...
        uriResourcePath = uriResourcePath.replace("{MaxResults}", (listIdentityPoolUsageRequest.getMaxResults() == null) ? "" : StringUtils.fromString(listIdentityPoolUsageRequest.getMaxResults())); 
