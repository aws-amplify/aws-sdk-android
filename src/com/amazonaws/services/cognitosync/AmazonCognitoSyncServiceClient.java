...
/**
 * Client for accessing AmazonCognitoSyncService.  All service calls made
 * using this client are blocking, and will not return until the service call
 * completes.
 * <p>
 * 
 */
public class AmazonCognitoSyncServiceClient extends AmazonWebServiceClient implements AmazonCognitoSyncService {

    /** Provider for AWS credentials. */
    private AWSCredentialsProvider awsCredentialsProvider;

    private static final Log log = LogFactory.getLog(AmazonCognitoSyncService.class);

    /**
     * List of exception unmarshallers for all AmazonCognitoSyncService exceptions.
     */
     ...
     */
    public AmazonCognitoSyncServiceClient() {
     ...
     * @see DefaultAWSCredentialsProviderChain
     */
    public AmazonCognitoSyncServiceClient(ClientConfiguration clientConfiguration) {
     ...
     */
    public AmazonCognitoSyncServiceClient(AWSCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonCognitoSyncServiceClient(AWSCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AmazonCognitoSyncServiceClient(AWSCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonCognitoSyncServiceClient(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
