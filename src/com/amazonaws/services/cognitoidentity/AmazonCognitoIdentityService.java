...
/**
 * Interface for accessing AmazonCognitoIdentityService.
 * 
 */
public interface AmazonCognitoIdentityService {
    ...
    /**
     * An alternative to {@link AmazonCognitoIdentityService#setEndpoint(String)}, sets the
