...
/**
 * Client for accessing AmazonCognitoIdentityService.  All service calls made
 * using this client are blocking, and will not return until the service call
 * completes.
 * <p>
 * 
 */
public class AmazonCognitoIdentityServiceClient extends AmazonWebServiceClient implements AmazonCognitoIdentityService {

    /** Provider for AWS credentials. */
    private AWSCredentialsProvider awsCredentialsProvider;

    private static final Log log = LogFactory.getLog(AmazonCognitoIdentityService.class);

    /**
     * List of exception unmarshallers for all AmazonCognitoIdentityService exceptions.
     */
    protected List<JsonErrorUnmarshaller> jsonErrorUnmarshallers;

    /**
     * Constructs a new client to invoke service methods on
     * AmazonCognitoIdentityService.  A credentials provider chain will be used
     ...
     */
    public AmazonCognitoIdentityServiceClient() {
     ...
     *                       client connects to AmazonCognitoIdentityService
     *                       (ex: proxy settings, retry counts, etc.).
     *
     * @see DefaultAWSCredentialsProviderChain
     */
    public AmazonCognitoIdentityServiceClient(ClientConfiguration clientConfiguration) {
        this(new DefaultAWSCredentialsProviderChain(), clientConfiguration);
    }

    /**
     * Constructs a new client to invoke service methods on
     * AmazonCognitoIdentityService using the specified AWS account credentials.
     * 
     * <p>
     * All service calls made using this new client object are blocking, and will not
     * return until the service call completes.
     ...
     */
    public AmazonCognitoIdentityServiceClient(AWSCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonCognitoIdentityServiceClient(AWSCredentials awsCredentials, ClientConfiguration clientConfiguration) {
    ...
    /**
     * Constructs a new client to invoke service methods on
     * AmazonCognitoIdentityService using the specified AWS account credentials provider.
     * 
     * <p>
     * All service calls made using this new client object are blocking, and will not
     * return until the service call completes.
     ...
     */
    public AmazonCognitoIdentityServiceClient(AWSCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonCognitoIdentityServiceClient(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
     ...
     *         returned by AmazonCognitoIdentityService.
     * 
     ...
     *           execute the GetOpenIdToken service method on
     *           AmazonCognitoIdentityService.
     * 
     ...
     *           execute the UnlinkIdentity service method on
     *           AmazonCognitoIdentityService.
     * 
     * 
     * @throws ResourceConflictException
     ...
     *           the GetId service method on AmazonCognitoIdentityService.
     * 
     ...
     *           execute the ListIdentities service method on
     *           AmazonCognitoIdentityService.
     * 
