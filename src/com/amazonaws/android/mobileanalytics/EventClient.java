...
/**
 * EventClient is the entry point into the Amazon Mobile Analytics SDK where {@link AnalyticsEvent} objects are created, 
 * recorded, and submitted to the Amazon Mobile Analytics Service.
 * 
 * <h3>Recording Events</h3>
 * Example:
 * <pre class="prettyprint">
 *    // get the event client from your analytics instance
 ...
 * <p>
 * The example below demonstrates how to submit events to the Amazon Mobile Analytics Service.
 * You have direct control over when events are submitted in your app. Events are submitted in a background thread. 
 * </p>
 * Example:
 * <pre class="prettyprint">
 ...
 * </pre>
 * Amazon recommends that you call <code>submitEvents</code> in the onPause method of each Activity object that records events.
...
public interface EventClient {
    ...
    /**
     * Create an event with the specified eventType.  The eventType is a developer defined String that
     * can be used to distinguish between different scenarios within an application.
     * 
     * Note: You can have at most 1,500 different eventTypes per app.
     * 
     ...
     * Note: The maximum allowed attributes and metrics on a single event is 40.  Attempts to add more may be ignored
     ...
     * @param attributeValue the value of the attribute
     */
	public void addGlobalAttribute(final String eventType, final String attributeName, final String attributeValue);
     ...
     * @param metricValue the value of the metric
     */
	public void addGlobalMetric(final String eventType, final String metricName, final Double metricValue);
    ...
    /**
     * Submit all recorded events. If a submission occurred in the last minute, this request is ignored.  If the device is off line, this is a
     * no-op.
     * See {@link com.amazonaws.android.mobileanalytics.AnalyticsOptions} for customizing which Internet connection the SDK can submit on. 
     */
