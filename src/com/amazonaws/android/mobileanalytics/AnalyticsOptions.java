...
public class AnalyticsOptions{
    ...
    /**
     * Create an {@link AnalyticsOptions} object set to defaults.  Which allows event collection and has WAN delivery set to true
     */
    ...
    /**
     * Creates an {@link AnalyticsOptions} object with the specified client configuration configuration
     * @param clientConfiguration
     */
    public AnalyticsOptions(ClientConfiguration clientConfiguration) {
     ...
     * @return AnalyticsOptions the current instance
     */
    public AnalyticsOptions withClientConfiguration(ClientConfiguration clientConfig) {
        this.clientConfiguration = new ClientConfiguration(clientConfig);
        return this;
    }
    
    /**
     * Gets the client configuration this client will use when making requests.  If none was supplied to the constructor this will
     ...
     * @return AnalyticsOptions the current instance
     */
    public AnalyticsOptions withAllowsEventCollection(boolean allowEventCollection){
     ...
     * @return AnalyticsOptions the current instance
     */
    public AnalyticsOptions withAllowsWANDelivery(boolean allowWANDelivery) {
     ...
     *              false indicates events will be delivered via WIFI
     *              network only.
     */
