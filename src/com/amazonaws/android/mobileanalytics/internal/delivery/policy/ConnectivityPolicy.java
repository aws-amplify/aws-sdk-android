...
public class ConnectivityPolicy implements DeliveryPolicy {
    ...
    public boolean isAllowed() {
        ...
        // allow WAN transmission only if both the user and configuration allow it
        boolean canTrasmitOnWAN = context.getConfiguration().optBoolean(ALLOW_WAN_KEY, ALLOW_WAN_DEFAULT) && isWanAllowed;
