...
import com.amazonaws.android.mobileanalytics.internal.event.ClientContext;
...
import com.amazonaws.services.eventrecorder.model.Event;
import com.amazonaws.services.eventrecorder.model.PutEventsRequest;
import com.amazonaws.services.eventrecorder.model.Session;
...
public class ERSRequestBuilder {
    ...
    public static ERSRequestBuilder newBuilder() {
        return new ERSRequestBuilder();
    }

    public ERSRequestBuilder() {
    }
    ...
    public PutEventsRequest createRecordEventsRequest(JSONArray events, String networkType) {
        ...
        for (int i = 0; i < events.length(); i++) {
            ...
            try {
                ...
                logger.e("Stored event was invalid JSON", e);
                continue;
            }
