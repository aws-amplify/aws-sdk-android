 ...
 */
package com.amazonaws.android.mobileanalytics.internal.core.util;
...
public final class StringUtil {
     ...
     * @throws IOException
     *             upon a failure reading the input stream
     */
    ...
    /**
     * Reduces the input string to the number of chars, or its length if
     * the number of chars exceeds the input string's length
     * @param input The string to clip
     * @param numChars the number of leading chars to keep (all others will be removed)
    ...
    /**
     * Trims string to its last X characters.
     * If string is too short, is padded at the front with given char
     * 
