...
public class DateUtil {
     ...
     * @param dateFormatString The date format string to use when formatting a date
    ...
    /**
     * @return A date object taking the devices clock skew into configuration if neccesary
     */
