 ...
 */
package com.amazonaws.android.mobileanalytics.monetization;

import com.amazonaws.android.mobileanalytics.EventClient;
 ...
 * The store attribute must be set by the user. This Builder will return
 * null if the Store, ProductId, Quantity, and either the Formatted Localized Price or Price and Currency are not set.
 * <p>
 * The example below demonstrates how to create a monetization event after you receive a purchase confirmation from the IAP framework you are using. You are responsible for storing and making sure that the bare minimum attributes required to build a Custom Purchase Event are available for use at this time.
 * Note that the builder will maintain the values of its internal variables between builds.
 * </p>
 * Example:
 * <pre class="prettyprint">
 *    // get the event client from your insights instance
...
public class CustomMonetizationEventBuilder extends MonetizationEventBuilder {
     ...
     * 
     * @param store
     *            The store in which the transaction is taking place
     ...
     *            The formatted localized price of the item 
     * @return this for chaining
     */
     ...
     * 
     * @param currency
     *            The currency code of the currency used to purchase this item (i.e. "USD")
     * @return this for chaining
     */
     ...
     * 
     * @param eventClient
     *            The EventClient to use when building the event
     */
    ...
    protected boolean isValid() {
        // we must always have the store, product id, quantity, either formatted localized price or item price and currency
    	if(getStore() == null) {
