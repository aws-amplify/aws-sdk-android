...
/**
 * The {@link AnalyticsCallback} is an abstract class which allows you create subclasses that will handle the completion of certain tasks. On success, the handler's return
