...
public class CreateVpcLinkResultJsonUnmarshaller implements
    ...
    public CreateVpcLinkResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("id")) {
                createVpcLinkResult.setId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("name")) {
                createVpcLinkResult.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("description")) {
                createVpcLinkResult.setDescription(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("targetArns")) {
                createVpcLinkResult.setTargetArns(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("status")) {
                createVpcLinkResult.setStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("statusMessage")) {
                createVpcLinkResult.setStatusMessage(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
