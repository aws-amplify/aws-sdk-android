...
/**
 * JSON request marshaller for GetUsageRequest
 */
public class GetUsageRequestMarshaller implements
    ...
    public Request<GetUsageRequest> marshall(GetUsageRequest getUsageRequest) {
        if (getUsageRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(GetUsageRequest)");
        }

        Request<GetUsageRequest> request = new DefaultRequest<GetUsageRequest>(getUsageRequest,
                "AmazonAPIGateway");
        ...
        uriResourcePath = uriResourcePath.replace(
                "{usageplanId}",
                (getUsageRequest.getUsagePlanId() == null) ? "" : StringUtils
                        .fromString(getUsageRequest.getUsagePlanId()));
