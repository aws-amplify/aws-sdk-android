...
/**
 * JSON unmarshaller for response CreateBasePathMappingResult
 */
    ...
    public CreateBasePathMappingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("basePath")) {
                createBasePathMappingResult.setBasePath(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("restApiId")) {
                createBasePathMappingResult.setRestApiId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("stage")) {
                createBasePathMappingResult.setStage(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
