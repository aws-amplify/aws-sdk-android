...
/**
 * JSON request marshaller for GetApiKeysRequest
 */
    ...
    public Request<GetApiKeysRequest> marshall(GetApiKeysRequest getApiKeysRequest) {
        if (getApiKeysRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetApiKeysRequest)");
        }
        ...
        if (getApiKeysRequest.getCustomerId() != null) {
            request.addParameter("customerId",
                    StringUtils.fromString(getApiKeysRequest.getCustomerId()));
        }
        if (getApiKeysRequest.getIncludeValues() != null) {
            request.addParameter("includeValues",
                    StringUtils.fromBoolean(getApiKeysRequest.getIncludeValues()));
        }
