...
/**
 * JSON request marshaller for UpdateMethodRequest
 */
    ...
    public Request<UpdateMethodRequest> marshall(UpdateMethodRequest updateMethodRequest) {
        if (updateMethodRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateMethodRequest)");
        }
        ...
        uriResourcePath = uriResourcePath.replace(
                "{resource_id}",
                (updateMethodRequest.getResourceId() == null) ? "" : StringUtils
                        .fromString(updateMethodRequest.getResourceId()));
        uriResourcePath = uriResourcePath.replace(
                "{http_method}",
                (updateMethodRequest.getHttpMethod() == null) ? "" : StringUtils
                        .fromString(updateMethodRequest.getHttpMethod()));
        ...
        try {
            ...
            if (updateMethodRequest.getPatchOperations() != null) {
                java.util.List<PatchOperation> patchOperations = updateMethodRequest
                        .getPatchOperations();
