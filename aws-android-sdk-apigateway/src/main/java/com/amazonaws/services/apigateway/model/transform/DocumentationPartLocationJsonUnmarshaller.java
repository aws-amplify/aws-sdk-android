...
/**
 * JSON unmarshaller for POJO DocumentationPartLocation
 */
class DocumentationPartLocationJsonUnmarshaller implements
    ...
    public DocumentationPartLocation unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("type")) {
                documentationPartLocation.setType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("path")) {
                documentationPartLocation.setPath(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("method")) {
                documentationPartLocation.setMethod(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("statusCode")) {
                documentationPartLocation.setStatusCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("name")) {
                documentationPartLocation.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
