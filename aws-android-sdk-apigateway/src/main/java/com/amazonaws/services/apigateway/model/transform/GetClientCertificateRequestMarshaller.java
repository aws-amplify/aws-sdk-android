...
/**
 * JSON request marshaller for GetClientCertificateRequest
 */
public class GetClientCertificateRequestMarshaller implements
    ...
    public Request<GetClientCertificateRequest> marshall(
        ...
        if (getClientCertificateRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetClientCertificateRequest)");
        }
        ...
        uriResourcePath = uriResourcePath.replace(
                ...
                (getClientCertificateRequest.getClientCertificateId() == null) ? "" : StringUtils
                        .fromString(getClientCertificateRequest.getClientCertificateId()));
