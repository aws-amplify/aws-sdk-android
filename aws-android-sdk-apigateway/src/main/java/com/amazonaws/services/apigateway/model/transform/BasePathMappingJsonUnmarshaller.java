...
/**
 * JSON unmarshaller for POJO BasePathMapping
 */
class BasePathMappingJsonUnmarshaller implements
    ...
    public BasePathMapping unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("basePath")) {
                basePathMapping.setBasePath(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("restApiId")) {
                basePathMapping.setRestApiId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("stage")) {
                basePathMapping.setStage(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
