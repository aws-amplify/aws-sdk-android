...
/**
 * JSON unmarshaller for response GetSdkTypesResult
 */
public class GetSdkTypesResultJsonUnmarshaller implements
        Unmarshaller<GetSdkTypesResult, JsonUnmarshallerContext> {
    ...
    public GetSdkTypesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("position")) {
                getSdkTypesResult.setPosition(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("items")) {
                getSdkTypesResult.setItems(new ListUnmarshaller<SdkType>(SdkTypeJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
