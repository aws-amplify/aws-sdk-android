...
public class CreateAuthorizerRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         <code>TOKEN</code> for a Lambda function using a single
     *         authorization token submitted in a custom header,
     *         <code>REQUEST</code> for a Lambda function using incoming request
     *         parameters, and <code>COGNITO_USER_POOLS</code> for using an
     ...
     *            <code>TOKEN</code> for a Lambda function using a single
     *            authorization token submitted in a custom header,
     *            <code>REQUEST</code> for a Lambda function using incoming
     *            request parameters, and <code>COGNITO_USER_POOLS</code> for
