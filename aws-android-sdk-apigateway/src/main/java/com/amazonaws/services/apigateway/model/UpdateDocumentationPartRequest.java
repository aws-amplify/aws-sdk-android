 ...
 * </p>
 */
public class UpdateDocumentationPartRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         [Required] The identifier of the to-be-updated documentation
     *         part.
     *         </p>
     */
     ...
     *         chained together.
     */
    public UpdateDocumentationPartRequest withPatchOperations(
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getDocumentationPartId() == null) ? 0 : getDocumentationPartId().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDocumentationPartId() == null ^ this.getDocumentationPartId() == null)
            return false;
        if (other.getDocumentationPartId() != null
                && other.getDocumentationPartId().equals(this.getDocumentationPartId()) == false)
            return false;
