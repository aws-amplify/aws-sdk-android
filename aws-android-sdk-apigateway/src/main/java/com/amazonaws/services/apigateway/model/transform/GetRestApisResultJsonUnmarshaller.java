...
/**
 * JSON unmarshaller for response GetRestApisResult
 */
public class GetRestApisResultJsonUnmarshaller implements
        Unmarshaller<GetRestApisResult, JsonUnmarshallerContext> {
    ...
    public GetRestApisResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("position")) {
                getRestApisResult.setPosition(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("items")) {
                getRestApisResult.setItems(new ListUnmarshaller<RestApi>(RestApiJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
