 ...
 */
public class GetClientCertificatesResult implements Serializable {
    /**
    ...
    public GetClientCertificatesResult withItems(ClientCertificate... items) {
        if (getItems() == null) {
            this.items = new java.util.ArrayList<ClientCertificate>(items.length);
        }
        for (ClientCertificate value : items) {
