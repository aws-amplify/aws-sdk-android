...
/**
 * JSON request marshaller for GetMethodRequest
 */
public class GetMethodRequestMarshaller implements
    ...
    public Request<GetMethodRequest> marshall(GetMethodRequest getMethodRequest) {
        if (getMethodRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(GetMethodRequest)");
        }

        Request<GetMethodRequest> request = new DefaultRequest<GetMethodRequest>(getMethodRequest,
                "AmazonAPIGateway");
