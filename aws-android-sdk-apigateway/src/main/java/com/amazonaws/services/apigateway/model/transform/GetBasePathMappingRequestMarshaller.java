...
/**
 * JSON request marshaller for GetBasePathMappingRequest
 */
public class GetBasePathMappingRequestMarshaller implements
    ...
    public Request<GetBasePathMappingRequest> marshall(
        ...
        if (getBasePathMappingRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetBasePathMappingRequest)");
        }
        ...
        uriResourcePath = uriResourcePath.replace(
                ...
                (getBasePathMappingRequest.getDomainName() == null) ? "" : StringUtils
                        .fromString(getBasePathMappingRequest.getDomainName()));
        uriResourcePath = uriResourcePath.replace(
                "{base_path}",
