...
public class UpdateIntegrationResult implements Serializable {
     ...
     *         Gateway uses the resource ID as the <code>cacheNamespace</code>.
     *         You can specify the same <code>cacheNamespace</code> across
     *         resources to return the same cached data for requests to
     *         different resources.
     *         </p>
     */
     ...
     *            Specifies a group of related cached parameters. By default,
     *            API Gateway uses the resource ID as the
     *            <code>cacheNamespace</code>. You can specify the same
     *            <code>cacheNamespace</code> across resources to return the
     ...
     *         chained together.
     */
    public UpdateIntegrationResult addintegrationResponsesEntry(String key,
