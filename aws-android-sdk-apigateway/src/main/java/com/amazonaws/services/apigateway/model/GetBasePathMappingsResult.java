 ...
 */
public class GetBasePathMappingsResult implements Serializable {
    /**
    ...
    public GetBasePathMappingsResult withItems(BasePathMapping... items) {
        if (getItems() == null) {
            this.items = new java.util.ArrayList<BasePathMapping>(items.length);
        }
        for (BasePathMapping value : items) {
