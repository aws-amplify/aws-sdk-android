 ...
 */
public class GetRequestValidatorsResult implements Serializable {
    /**
    ...
    public GetRequestValidatorsResult withItems(RequestValidator... items) {
        if (getItems() == null) {
            this.items = new java.util.ArrayList<RequestValidator>(items.length);
        }
        for (RequestValidator value : items) {
