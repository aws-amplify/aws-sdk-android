...
/**
 * JSON request marshaller for GetBasePathMappingsRequest
 */
public class GetBasePathMappingsRequestMarshaller implements
    ...
    public Request<GetBasePathMappingsRequest> marshall(
        ...
        if (getBasePathMappingsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetBasePathMappingsRequest)");
        }
        ...
        uriResourcePath = uriResourcePath.replace(
                ...
                (getBasePathMappingsRequest.getDomainName() == null) ? "" : StringUtils
                        .fromString(getBasePathMappingsRequest.getDomainName()));
