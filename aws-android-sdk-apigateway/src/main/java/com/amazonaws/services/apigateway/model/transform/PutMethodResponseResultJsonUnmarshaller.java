...
/**
 * JSON unmarshaller for response PutMethodResponseResult
 */
    ...
    public PutMethodResponseResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("statusCode")) {
                putMethodResponseResult.setStatusCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("responseParameters")) {
                putMethodResponseResult.setResponseParameters(new MapUnmarshaller<Boolean>(
                        BooleanJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("responseModels")) {
                putMethodResponseResult.setResponseModels(new MapUnmarshaller<String>(
