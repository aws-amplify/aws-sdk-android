 ...
 * >Create an API</a> </div>
 */
public class UpdateResourceResult implements Serializable {
    /**
     * <p>
     ...
     * </div> <div class="seeAlso"> </div>
     *
     * @param resourceMethods <p>
     *            Gets an API resource's method of a given HTTP verb.
     *            </p>
     *            <div class="remarks">
     *            <p>
     *            The resource methods are a map of methods indexed by methods'
     *            HTTP verbs enabled on the resource. This method map is
     *            included in the <code>200 OK</code> response of the
     *            <code>GET /restapis/{restapi_id}/resources/{resource_id}</code>
     *            or
     *            <code>GET /restapis/{restapi_id}/resources/{resource_id}?embed=methods</code>
     *            request.
     ...
     * </pre>
     *            <p>
     *            If the <code>OPTIONS</code> is enabled on the resource, you
     *            can follow the example here to get that method. Just replace
     *            the <code>GET</code> of the last path segment in the request
     ...
     * </div> <div class="seeAlso"> </div>
     * <p>
     * The method adds a new key-value pair into resourceMethods parameter, and
     * returns a reference to this object so that method calls can be chained
     * together.
     *
     * @param key The key of the entry to be added into resourceMethods.
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getResourceMethods() == null) ? 0 : getResourceMethods().hashCode());
        return hashCode;
    }
