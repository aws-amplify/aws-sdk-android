...
/**
 * <p>
 * The collection of the <a>GatewayResponse</a> instances of a <a>RestApi</a> as
 * a <code>responseType</code>-to-<a>GatewayResponse</a> object map of key-value
 * pairs. As such, pagination is not supported for querying this collection.
 * </p>
 ...
 * <h4>Example: Get the collection of gateway responses of an API</h4> <h5>
 * Request</h5>
 * <p>
 ...
 */
public class GetGatewayResponsesResult implements Serializable {
    /**
     ...
     *
     * @param items <p>
     *            Returns the entire collection, because of no pagination
     *            support.
     *            </p>
     */
    ...
    public GetGatewayResponsesResult withItems(GatewayResponse... items) {
        if (getItems() == null) {
            this.items = new java.util.ArrayList<GatewayResponse>(items.length);
        }
        for (GatewayResponse value : items) {
