...
/**
 * JSON unmarshaller for POJO MethodResponse
 */
class MethodResponseJsonUnmarshaller implements
        Unmarshaller<MethodResponse, JsonUnmarshallerContext> {
    ...
    public MethodResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("statusCode")) {
                methodResponse.setStatusCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("responseParameters")) {
                methodResponse.setResponseParameters(new MapUnmarshaller<Boolean>(
                        BooleanJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("responseModels")) {
                methodResponse.setResponseModels(new MapUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
