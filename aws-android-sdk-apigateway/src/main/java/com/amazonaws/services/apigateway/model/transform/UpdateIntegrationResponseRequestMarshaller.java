    ...
    public Request<UpdateIntegrationResponseRequest> marshall(
        ...
        uriResourcePath = uriResourcePath.replace(
                ...
                (updateIntegrationResponseRequest.getRestApiId() == null) ? "" : StringUtils
                        .fromString(updateIntegrationResponseRequest.getRestApiId()));
        uriResourcePath = uriResourcePath.replace(
                "{resource_id}",
                (updateIntegrationResponseRequest.getResourceId() == null) ? "" : StringUtils
                        .fromString(updateIntegrationResponseRequest.getResourceId()));
        uriResourcePath = uriResourcePath.replace(
                "{http_method}",
                (updateIntegrationResponseRequest.getHttpMethod() == null) ? "" : StringUtils
                        .fromString(updateIntegrationResponseRequest.getHttpMethod()));
        uriResourcePath = uriResourcePath.replace(
                "{status_code}",
                (updateIntegrationResponseRequest.getStatusCode() == null) ? "" : StringUtils
                        .fromString(updateIntegrationResponseRequest.getStatusCode()));
        ...
        try {
            ...
            if (updateIntegrationResponseRequest.getPatchOperations() != null) {
                java.util.List<PatchOperation> patchOperations = updateIntegrationResponseRequest
                        .getPatchOperations();
