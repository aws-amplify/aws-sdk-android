...
/**
 * <p>
 * Gets the <a>GatewayResponses</a> collection on the given <a>RestApi</a>. If
 * an API developer has not added any definitions for gateway responses, the
 * result will be the API Gateway-generated default <a>GatewayResponses</a>
 * collection for the supported response types.
 * </p>
 */
public class GetGatewayResponsesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * @return <p>
     *         The current pagination position in the paged result set. The
     *         <a>GatewayResponse</a> collection does not support pagination and
     *         the position does not apply here.
     *         </p>
     */
     ...
     * @param position <p>
     *            The current pagination position in the paged result set. The
     *            <a>GatewayResponse</a> collection does not support pagination
     *            and the position does not apply here.
     *            </p>
     */
     ...
     *         value is 25 and the maximum value is 500. The
     *         <a>GatewayResponses</a> collection does not support pagination
