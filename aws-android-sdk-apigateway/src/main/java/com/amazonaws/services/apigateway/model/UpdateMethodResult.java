 ...
 */
public class UpdateMethodResult implements Serializable {
    /**
     * <p>
     ...
     *            The identifier of an <a>Authorizer</a> to use on this method.
     ...
     *
     * @return <p>
     *         The identifier of a <a>RequestValidator</a> for request
     *         validation.
     *         </p>
     */
     ...
     *            and the value is a <a>MethodResponse</a> resource that
     *            specifies the response returned to the caller from the back
     ...
     *            <h5>Response</h5>
     *            <p>
     *            The successful response returns a <code>200 OK</code> status
     *            code and a payload similar to the following:
     *            </p>
     * 
     *            <pre>
     * <code>{ "_links": { "curies": { "href": "https://docs.aws.amazon.com/apigateway/latest/developerguide/restapi-method-response-{rel}.html", "name": "methodresponse", "templated": true }, "self": { "href": "/restapis/uojnr9hd57/resources/0cjtch/methods/GET/responses/200", "title": "200" }, "methodresponse:delete": { "href": "/restapis/uojnr9hd57/resources/0cjtch/methods/GET/responses/200" }, "methodresponse:update": { "href": "/restapis/uojnr9hd57/resources/0cjtch/methods/GET/responses/200" } }, "responseModels": { "application/json": "Empty" }, "responseParameters": { "method.response.header.operator": false, "method.response.header.operand_2": false, "method.response.header.operand_1": false }, "statusCode": "200" }</code>
     ...
     * >AWS CLI</a> </div>
     * <p>
     * The method adds a new key-value pair into methodResponses parameter, and
     * returns a reference to this object so that method calls can be chained
     * together.
     *
     * @param key The key of the entry to be added into methodResponses.
     * @param value The corresponding value of the entry to be added into
     *            methodResponses.
     * @return A reference to this updated object so that method calls can be
     *         chained together.
     ...
     * >AWS CLI</a> </div>
     *
     * @param methodIntegration <p>
     *            Gets the method's integration responsible for passing the
     *            client-submitted request to the back end and performing
     *            necessary transformations to make the request compliant with
     *            the back end.
     *            </p>
     *            <div class="remarks">
     *            <p/>
     ...
     *         chained together.
     */
    public UpdateMethodResult withAuthorizationScopes(
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getMethodResponses() == null) ? 0 : getMethodResponses().hashCode());
        hashCode = prime * hashCode
                + ((getMethodIntegration() == null) ? 0 : getMethodIntegration().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getMethodIntegration() != null
                && other.getMethodIntegration().equals(this.getMethodIntegration()) == false)
            return false;
