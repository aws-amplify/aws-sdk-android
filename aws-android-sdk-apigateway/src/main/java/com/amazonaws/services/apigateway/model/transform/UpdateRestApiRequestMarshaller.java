...
/**
 * JSON request marshaller for UpdateRestApiRequest
 */
    ...
    public Request<UpdateRestApiRequest> marshall(UpdateRestApiRequest updateRestApiRequest) {
        if (updateRestApiRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateRestApiRequest)");
        }
        ...
        try {
            ...
            if (updateRestApiRequest.getPatchOperations() != null) {
                java.util.List<PatchOperation> patchOperations = updateRestApiRequest
                        .getPatchOperations();
