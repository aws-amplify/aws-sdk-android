 ...
 * and <code>COGNITO_USER_POOLS</code> for using an Amazon Cognito user pool.
 * </p>
 */
public enum AuthorizerType {
    ...
    private static final Map<String, AuthorizerType> enumMap;
    static {
        enumMap = new HashMap<String, AuthorizerType>();
        enumMap.put("TOKEN", TOKEN);
        enumMap.put("REQUEST", REQUEST);
        enumMap.put("COGNITO_USER_POOLS", COGNITO_USER_POOLS);
    }
