...
/**
 * JSON request marshaller for DeleteBasePathMappingRequest
 */
public class DeleteBasePathMappingRequestMarshaller implements
    ...
    public Request<DeleteBasePathMappingRequest> marshall(
        ...
        if (deleteBasePathMappingRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteBasePathMappingRequest)");
        }
        ...
        uriResourcePath = uriResourcePath.replace(
                ...
                (deleteBasePathMappingRequest.getDomainName() == null) ? "" : StringUtils
                        .fromString(deleteBasePathMappingRequest.getDomainName()));
        uriResourcePath = uriResourcePath.replace(
                "{base_path}",
                (deleteBasePathMappingRequest.getBasePath() == null) ? "" : StringUtils
                        .fromString(deleteBasePathMappingRequest.getBasePath()));
