...
/**
 * JSON unmarshaller for POJO MethodSnapshot
 */
class MethodSnapshotJsonUnmarshaller implements
    ...
    public MethodSnapshot unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("authorizationType")) {
                methodSnapshot.setAuthorizationType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("apiKeyRequired")) {
                methodSnapshot.setApiKeyRequired(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
