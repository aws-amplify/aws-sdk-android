...
/**
 * JSON request marshaller for ImportRestApiRequest
 */
    ...
    public Request<ImportRestApiRequest> marshall(ImportRestApiRequest importRestApiRequest) {
        if (importRestApiRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ImportRestApiRequest)");
        }

        Request<ImportRestApiRequest> request = new DefaultRequest<ImportRestApiRequest>(
                importRestApiRequest, "AmazonAPIGateway");
        ...
        if (importRestApiRequest.getFailOnWarnings() != null) {
            request.addParameter("failonwarnings",
                    StringUtils.fromBoolean(importRestApiRequest.getFailOnWarnings()));
        }
        if (importRestApiRequest.getParameters() != null) {
        }
        request.setResourcePath(uriResourcePath);
        request.addHeader("Content-Length",
                Integer.toString(importRestApiRequest.getBody().remaining()));
