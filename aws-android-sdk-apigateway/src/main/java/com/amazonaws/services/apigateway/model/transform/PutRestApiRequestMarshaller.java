...
/**
 * JSON request marshaller for PutRestApiRequest
 */
    ...
    public Request<PutRestApiRequest> marshall(PutRestApiRequest putRestApiRequest) {
        if (putRestApiRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(PutRestApiRequest)");
        }

        Request<PutRestApiRequest> request = new DefaultRequest<PutRestApiRequest>(
                putRestApiRequest, "AmazonAPIGateway");
        ...
        if (putRestApiRequest.getFailOnWarnings() != null) {
            request.addParameter("failonwarnings",
                    StringUtils.fromBoolean(putRestApiRequest.getFailOnWarnings()));
        }
        if (putRestApiRequest.getParameters() != null) {
        }
        request.setResourcePath(uriResourcePath);
        request.addHeader("Content-Length",
                Integer.toString(putRestApiRequest.getBody().remaining()));
