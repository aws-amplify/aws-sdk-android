...
/**
 * JSON request marshaller for DeleteClientCertificateRequest
 */
public class DeleteClientCertificateRequestMarshaller implements
    ...
    public Request<DeleteClientCertificateRequest> marshall(
        ...
        if (deleteClientCertificateRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteClientCertificateRequest)");
        }
        ...
        uriResourcePath = uriResourcePath.replace(
                ...
                (deleteClientCertificateRequest.getClientCertificateId() == null) ? ""
                        : StringUtils.fromString(deleteClientCertificateRequest
