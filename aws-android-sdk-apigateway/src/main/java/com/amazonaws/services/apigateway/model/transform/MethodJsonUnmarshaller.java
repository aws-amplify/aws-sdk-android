...
/**
 * JSON unmarshaller for POJO Method
 */
class MethodJsonUnmarshaller implements Unmarshaller<Method, JsonUnmarshallerContext> {
    ...
    public Method unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("httpMethod")) {
                ...
                method.setAuthorizationType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                method.setApiKeyRequired(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("requestValidatorId")) {
                method.setRequestValidatorId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("operationName")) {
                method.setOperationName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("requestParameters")) {
                method.setRequestParameters(new MapUnmarshaller<Boolean>(BooleanJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("requestModels")) {
                method.setRequestModels(new MapUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("methodResponses")) {
                method.setMethodResponses(new MapUnmarshaller<MethodResponse>(
                        MethodResponseJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("methodIntegration")) {
                method.setMethodIntegration(IntegrationJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("authorizationScopes")) {
                method.setAuthorizationScopes(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
