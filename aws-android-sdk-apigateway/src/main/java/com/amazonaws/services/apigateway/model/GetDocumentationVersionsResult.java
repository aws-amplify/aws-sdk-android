 ...
 * <a>DocumentationVersion</a> </div>
 */
public class GetDocumentationVersionsResult implements Serializable {
    /**
    ...
    public GetDocumentationVersionsResult withItems(DocumentationVersion... items) {
        if (getItems() == null) {
            this.items = new java.util.ArrayList<DocumentationVersion>(items.length);
        }
        for (DocumentationVersion value : items) {
