...
/**
 * JSON unmarshaller for POJO DeploymentCanarySettings
 */
class DeploymentCanarySettingsJsonUnmarshaller implements
        Unmarshaller<DeploymentCanarySettings, JsonUnmarshallerContext> {
    ...
    public DeploymentCanarySettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("percentTraffic")) {
                deploymentCanarySettings.setPercentTraffic(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("stageVariableOverrides")) {
                deploymentCanarySettings.setStageVariableOverrides(new MapUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("useStageCache")) {
                deploymentCanarySettings.setUseStageCache(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
