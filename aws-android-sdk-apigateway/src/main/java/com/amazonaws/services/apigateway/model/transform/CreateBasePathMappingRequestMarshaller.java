...
/**
 * JSON request marshaller for CreateBasePathMappingRequest
 */
public class CreateBasePathMappingRequestMarshaller implements
    ...
    public Request<CreateBasePathMappingRequest> marshall(
        ...
        if (createBasePathMappingRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateBasePathMappingRequest)");
        }

        Request<CreateBasePathMappingRequest> request = new DefaultRequest<CreateBasePathMappingRequest>(
        ...
        uriResourcePath = uriResourcePath.replace(
                ...
                (createBasePathMappingRequest.getDomainName() == null) ? "" : StringUtils
                        .fromString(createBasePathMappingRequest.getDomainName()));
