...
/**
 * JSON request marshaller for UpdateBasePathMappingRequest
 */
public class UpdateBasePathMappingRequestMarshaller implements
    ...
    public Request<UpdateBasePathMappingRequest> marshall(
        ...
        if (updateBasePathMappingRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateBasePathMappingRequest)");
        }
        ...
        uriResourcePath = uriResourcePath.replace(
                ...
                (updateBasePathMappingRequest.getDomainName() == null) ? "" : StringUtils
                        .fromString(updateBasePathMappingRequest.getDomainName()));
        uriResourcePath = uriResourcePath.replace(
                "{base_path}",
                (updateBasePathMappingRequest.getBasePath() == null) ? "" : StringUtils
                        .fromString(updateBasePathMappingRequest.getBasePath()));
        ...
        try {
            ...
            if (updateBasePathMappingRequest.getPatchOperations() != null) {
                java.util.List<PatchOperation> patchOperations = updateBasePathMappingRequest
                        .getPatchOperations();
