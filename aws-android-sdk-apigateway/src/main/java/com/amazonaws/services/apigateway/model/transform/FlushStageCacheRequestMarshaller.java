...
/**
 * JSON request marshaller for FlushStageCacheRequest
 */
    ...
    public Request<FlushStageCacheRequest> marshall(FlushStageCacheRequest flushStageCacheRequest) {
        if (flushStageCacheRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(FlushStageCacheRequest)");
        }
        ...
        uriResourcePath = uriResourcePath.replace(
                ...
                (flushStageCacheRequest.getRestApiId() == null) ? "" : StringUtils
                        .fromString(flushStageCacheRequest.getRestApiId()));
        uriResourcePath = uriResourcePath.replace(
                "{stage_name}",
                (flushStageCacheRequest.getStageName() == null) ? "" : StringUtils
                        .fromString(flushStageCacheRequest.getStageName()));
