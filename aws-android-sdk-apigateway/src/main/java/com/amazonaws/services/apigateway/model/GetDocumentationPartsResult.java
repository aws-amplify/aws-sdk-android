 ...
 * >Documenting an API</a>, <a>DocumentationPart</a> </div>
 */
public class GetDocumentationPartsResult implements Serializable {
    /**
    ...
    public GetDocumentationPartsResult withItems(DocumentationPart... items) {
        if (getItems() == null) {
            this.items = new java.util.ArrayList<DocumentationPart>(items.length);
        }
        for (DocumentationPart value : items) {
