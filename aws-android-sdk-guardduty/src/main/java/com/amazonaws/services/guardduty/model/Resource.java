...
public class Resource implements Serializable {
    ...
    public Resource withS3BucketDetails(S3BucketDetail... s3BucketDetails) {
        if (getS3BucketDetails() == null) {
            this.s3BucketDetails = new java.util.ArrayList<S3BucketDetail>(s3BucketDetails.length);
        }
        for (S3BucketDetail value : s3BucketDetails) {
            this.s3BucketDetails.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        if (getS3BucketDetails() != null)
            sb.append("S3BucketDetails: " + getS3BucketDetails() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getS3BucketDetails() == null) ? 0 : getS3BucketDetails().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getS3BucketDetails() == null ^ this.getS3BucketDetails() == null)
            return false;
        if (other.getS3BucketDetails() != null
                && other.getS3BucketDetails().equals(this.getS3BucketDetails()) == false)
            return false;
