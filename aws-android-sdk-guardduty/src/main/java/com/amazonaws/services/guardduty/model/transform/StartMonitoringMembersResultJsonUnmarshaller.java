...
/**
 * JSON unmarshaller for response StartMonitoringMembersResult
 */
public class StartMonitoringMembersResultJsonUnmarshaller implements
        Unmarshaller<StartMonitoringMembersResult, JsonUnmarshallerContext> {

    public StartMonitoringMembersResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
