...
class OrganizationJsonUnmarshaller implements Unmarshaller<Organization, JsonUnmarshallerContext> {
    ...
    public Organization unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Asn")) {
                organization.setAsn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("AsnOrg")) {
                organization.setAsnOrg(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Isp")) {
                organization.setIsp(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Org")) {
                organization.setOrg(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
