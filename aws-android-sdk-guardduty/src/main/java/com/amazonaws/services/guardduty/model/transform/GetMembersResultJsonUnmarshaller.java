...
/**
 * JSON unmarshaller for response GetMembersResult
 */
public class GetMembersResultJsonUnmarshaller implements
        Unmarshaller<GetMembersResult, JsonUnmarshallerContext> {
    ...
    public GetMembersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Members")) {
                getMembersResult.setMembers(new ListUnmarshaller<Member>(MemberJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("UnprocessedAccounts")) {
                getMembersResult.setUnprocessedAccounts(new ListUnmarshaller<UnprocessedAccount>(
