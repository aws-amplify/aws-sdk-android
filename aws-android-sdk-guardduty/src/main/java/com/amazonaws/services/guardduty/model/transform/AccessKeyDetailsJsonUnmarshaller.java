...
/**
 * JSON unmarshaller for POJO AccessKeyDetails
 */
class AccessKeyDetailsJsonUnmarshaller implements
        Unmarshaller<AccessKeyDetails, JsonUnmarshallerContext> {
    ...
    public AccessKeyDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AccessKeyId")) {
                accessKeyDetails.setAccessKeyId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("PrincipalId")) {
                accessKeyDetails.setPrincipalId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("UserName")) {
                accessKeyDetails.setUserName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("UserType")) {
                accessKeyDetails.setUserType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
