 ...
 * </p>
 */
public class ListThreatIntelSetsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *         Set the value of this parameter to null on your first call to the
     *         list action. For subsequent calls to the action, fill nextToken
     *         in the request with the value of NextToken from the previous
     ...
     *
     * @param nextToken <p>
     *            You can use this parameter to paginate results in the
     *            response. Set the value of this parameter to null on your
     *            first call to the list action. For subsequent calls to the
