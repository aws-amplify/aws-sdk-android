...
/**
 * JSON unmarshaller for POJO PermissionConfiguration
 */
class PermissionConfigurationJsonUnmarshaller implements
        Unmarshaller<PermissionConfiguration, JsonUnmarshallerContext> {
    ...
    public PermissionConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("BucketLevelPermissions")) {
                permissionConfiguration
                        .setBucketLevelPermissions(BucketLevelPermissionsJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else if (name.equals("AccountLevelPermissions")) {
                permissionConfiguration
