...
import com.amazonaws.services.awsiotsitewise.model.transform.*;
...
public class AWSIoTSiteWiseClient extends AmazonWebServiceClient implements AWSIoTSiteWise {
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/awsiotsitewise/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/awsiotsitewise/request.handler2s"));
    }
