...
/**
 * JSON unmarshaller for response ListAssetModelsResult
 */
public class ListAssetModelsResultJsonUnmarshaller implements
        Unmarshaller<ListAssetModelsResult, JsonUnmarshallerContext> {
    ...
    public ListAssetModelsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("assetModelSummaries")) {
                listAssetModelsResult
                        .setAssetModelSummaries(new ListUnmarshaller<AssetModelSummary>(
                                AssetModelSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                listAssetModelsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
