...
public class ListPortalsResult implements Serializable {
    /**
     * <p>
    ...
    public ListPortalsResult withPortalSummaries(PortalSummary... portalSummaries) {
        if (getPortalSummaries() == null) {
            this.portalSummaries = new java.util.ArrayList<PortalSummary>(portalSummaries.length);
        }
        for (PortalSummary value : portalSummaries) {
            this.portalSummaries.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getPortalSummaries() != null)
            sb.append("portalSummaries: " + getPortalSummaries() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getPortalSummaries() == null) ? 0 : getPortalSummaries().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getPortalSummaries() == null ^ this.getPortalSummaries() == null)
            return false;
        if (other.getPortalSummaries() != null
                && other.getPortalSummaries().equals(this.getPortalSummaries()) == false)
            return false;
