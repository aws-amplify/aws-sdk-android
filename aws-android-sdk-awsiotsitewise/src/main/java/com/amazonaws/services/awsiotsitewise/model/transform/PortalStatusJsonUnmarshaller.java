...
/**
 * JSON unmarshaller for POJO PortalStatus
 */
class PortalStatusJsonUnmarshaller implements Unmarshaller<PortalStatus, JsonUnmarshallerContext> {
    ...
    public PortalStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("state")) {
                portalStatus.setState(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("error")) {
                portalStatus.setError(MonitorErrorDetailsJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
