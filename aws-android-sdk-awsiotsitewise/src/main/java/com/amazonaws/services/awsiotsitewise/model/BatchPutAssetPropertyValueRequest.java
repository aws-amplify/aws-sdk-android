...
public class BatchPutAssetPropertyValueRequest extends AmazonWebServiceRequest implements
     ...
     * can specify up to 10 entries per request. For more information, see <a
     * href
     ...
     *         request. You can specify up to 10 entries per request. For more
     ...
     * @param entries <p>
     *            The list of asset property value entries for the batch put
     *            request. You can specify up to 10 entries per request. For
