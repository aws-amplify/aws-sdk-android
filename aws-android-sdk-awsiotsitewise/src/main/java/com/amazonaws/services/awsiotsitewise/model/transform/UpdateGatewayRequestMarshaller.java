...
public class UpdateGatewayRequestMarshaller implements
    ...
    public Request<UpdateGatewayRequest> marshall(UpdateGatewayRequest updateGatewayRequest) {
        ...
        Request<UpdateGatewayRequest> request = new DefaultRequest<UpdateGatewayRequest>(
                updateGatewayRequest, "AWSIoTSiteWise");
        request.setHttpMethod(HttpMethodName.PUT);

        String uriResourcePath = "/20200301/gateways/{gatewayId}";
        uriResourcePath = uriResourcePath.replace(
                "{gatewayId}",
                (updateGatewayRequest.getGatewayId() == null) ? "" : StringUtils
                        .fromString(updateGatewayRequest.getGatewayId()));
        ...
        try {
            ...
            if (updateGatewayRequest.getGatewayName() != null) {
                String gatewayName = updateGatewayRequest.getGatewayName();
