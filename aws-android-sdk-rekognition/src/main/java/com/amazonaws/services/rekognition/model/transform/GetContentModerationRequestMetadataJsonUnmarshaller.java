...
/**
 * JSON unmarshaller for POJO GetContentModerationRequestMetadata
 */
class GetContentModerationRequestMetadataJsonUnmarshaller implements
        Unmarshaller<GetContentModerationRequestMetadata, JsonUnmarshallerContext> {
    ...
    public GetContentModerationRequestMetadata unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SortBy")) {
                getContentModerationRequestMetadata.setSortBy(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("AggregateBy")) {
                getContentModerationRequestMetadata.setAggregateBy(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
