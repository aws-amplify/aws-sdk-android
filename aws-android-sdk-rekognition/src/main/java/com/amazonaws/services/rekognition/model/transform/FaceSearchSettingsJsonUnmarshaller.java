...
/**
 * JSON unmarshaller for POJO FaceSearchSettings
 */
class FaceSearchSettingsJsonUnmarshaller implements
        Unmarshaller<FaceSearchSettings, JsonUnmarshallerContext> {
