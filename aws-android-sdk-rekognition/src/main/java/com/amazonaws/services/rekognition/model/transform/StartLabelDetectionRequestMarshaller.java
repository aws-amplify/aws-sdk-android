 ...
 */
public class StartLabelDetectionRequestMarshaller implements
        Marshaller<Request<StartLabelDetectionRequest>, StartLabelDetectionRequest> {

    public Request<StartLabelDetectionRequest> marshall(
            StartLabelDetectionRequest startLabelDetectionRequest) {
        if (startLabelDetectionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(StartLabelDetectionRequest)");
        }

        Request<StartLabelDetectionRequest> request = new DefaultRequest<StartLabelDetectionRequest>(
                startLabelDetectionRequest, "AmazonRekognition");
        ...
        try {
            ...
            if (startLabelDetectionRequest.getNotificationChannel() != null) {
                NotificationChannel notificationChannel = startLabelDetectionRequest
