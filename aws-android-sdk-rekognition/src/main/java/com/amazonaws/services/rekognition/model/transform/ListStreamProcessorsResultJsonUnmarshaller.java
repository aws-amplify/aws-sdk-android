 ...
 */
public class ListStreamProcessorsResultJsonUnmarshaller implements
        Unmarshaller<ListStreamProcessorsResult, JsonUnmarshallerContext> {
    ...
    public ListStreamProcessorsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NextToken")) {
                listStreamProcessorsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
