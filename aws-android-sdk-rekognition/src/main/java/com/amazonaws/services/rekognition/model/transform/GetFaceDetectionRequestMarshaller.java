 ...
 */
public class GetFaceDetectionRequestMarshaller implements
        Marshaller<Request<GetFaceDetectionRequest>, GetFaceDetectionRequest> {
    ...
    public Request<GetFaceDetectionRequest> marshall(GetFaceDetectionRequest getFaceDetectionRequest) {
        if (getFaceDetectionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetFaceDetectionRequest)");
        }

        Request<GetFaceDetectionRequest> request = new DefaultRequest<GetFaceDetectionRequest>(
                getFaceDetectionRequest, "AmazonRekognition");
