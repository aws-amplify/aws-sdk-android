 ...
 */
public class GetContentModerationRequestMarshaller implements
        Marshaller<Request<GetContentModerationRequest>, GetContentModerationRequest> {

    public Request<GetContentModerationRequest> marshall(
            GetContentModerationRequest getContentModerationRequest) {
        if (getContentModerationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetContentModerationRequest)");
        }

        Request<GetContentModerationRequest> request = new DefaultRequest<GetContentModerationRequest>(
                getContentModerationRequest, "AmazonRekognition");
