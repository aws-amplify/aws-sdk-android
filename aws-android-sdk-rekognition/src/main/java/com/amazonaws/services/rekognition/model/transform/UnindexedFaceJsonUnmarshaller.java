...
/**
 * JSON unmarshaller for POJO UnindexedFace
 */
    ...
    public UnindexedFace unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Reasons")) {
                unindexedFace.setReasons(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("FaceDetail")) {
                unindexedFace.setFaceDetail(FaceDetailJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
