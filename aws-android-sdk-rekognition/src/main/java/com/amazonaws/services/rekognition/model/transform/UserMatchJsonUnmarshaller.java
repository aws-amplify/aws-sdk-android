...
/**
 * JSON unmarshaller for POJO UserMatch
 */
    ...
    public UserMatch unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Similarity")) {
                userMatch.setSimilarity(FloatJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("User")) {
                userMatch.setUser(MatchedUserJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
