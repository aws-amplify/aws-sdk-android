 ...
 */
public class StartContentModerationResultJsonUnmarshaller implements
        Unmarshaller<StartContentModerationResult, JsonUnmarshallerContext> {

    public StartContentModerationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("JobId")) {
                startContentModerationResult.setJobId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
