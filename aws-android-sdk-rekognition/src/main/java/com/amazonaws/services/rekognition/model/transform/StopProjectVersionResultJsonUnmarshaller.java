 ...
 */
public class StopProjectVersionResultJsonUnmarshaller implements
        Unmarshaller<StopProjectVersionResult, JsonUnmarshallerContext> {
    ...
    public StopProjectVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Status")) {
                stopProjectVersionResult.setStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
