...
/**
 * JSON unmarshaller for POJO AuditImage
 */
    ...
    public AuditImage unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Bytes")) {
                auditImage.setBytes(ByteBufferJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("S3Object")) {
                auditImage.setS3Object(S3ObjectJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("BoundingBox")) {
                auditImage.setBoundingBox(BoundingBoxJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
