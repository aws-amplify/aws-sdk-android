...
/**
 * JSON unmarshaller for POJO AudioMetadata
 */
    ...
    public AudioMetadata unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Codec")) {
                audioMetadata.setCodec(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("DurationMillis")) {
                audioMetadata.setDurationMillis(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("SampleRate")) {
                audioMetadata.setSampleRate(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("NumberOfChannels")) {
                audioMetadata.setNumberOfChannels(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
