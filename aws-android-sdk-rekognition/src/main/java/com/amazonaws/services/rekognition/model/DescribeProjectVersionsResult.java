...
public class DescribeProjectVersionsResult implements Serializable {
     ...
     *            </p>
     */
    public void setProjectVersionDescriptions(
            java.util.Collection<ProjectVersionDescription> projectVersionDescriptions) {
        if (projectVersionDescriptions == null) {
            this.projectVersionDescriptions = null;
            return;
        }

        this.projectVersionDescriptions = new java.util.ArrayList<ProjectVersionDescription>(
     ...
     *         chained together.
     */
    public DescribeProjectVersionsResult withProjectVersionDescriptions(
            ProjectVersionDescription... projectVersionDescriptions) {
        if (getProjectVersionDescriptions() == null) {
            this.projectVersionDescriptions = new java.util.ArrayList<ProjectVersionDescription>(
                    projectVersionDescriptions.length);
        }
        for (ProjectVersionDescription value : projectVersionDescriptions) {
            this.projectVersionDescriptions.add(value);
        }
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getProjectVersionDescriptions() == null) ? 0 : getProjectVersionDescriptions()
                        .hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getProjectVersionDescriptions() == null
                ^ this.getProjectVersionDescriptions() == null)
            return false;
        if (other.getProjectVersionDescriptions() != null
                && other.getProjectVersionDescriptions().equals(
                        this.getProjectVersionDescriptions()) == false)
            return false;
