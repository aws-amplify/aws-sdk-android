 ...
 */
public class StartCelebrityRecognitionRequestMarshaller implements
        Marshaller<Request<StartCelebrityRecognitionRequest>, StartCelebrityRecognitionRequest> {

    public Request<StartCelebrityRecognitionRequest> marshall(
            StartCelebrityRecognitionRequest startCelebrityRecognitionRequest) {
        if (startCelebrityRecognitionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(StartCelebrityRecognitionRequest)");
        }

        Request<StartCelebrityRecognitionRequest> request = new DefaultRequest<StartCelebrityRecognitionRequest>(
                startCelebrityRecognitionRequest, "AmazonRekognition");
        ...
        try {
            ...
            if (startCelebrityRecognitionRequest.getClientRequestToken() != null) {
                String clientRequestToken = startCelebrityRecognitionRequest
                        .getClientRequestToken();
                jsonWriter.name("ClientRequestToken");
                jsonWriter.value(clientRequestToken);
            }
            if (startCelebrityRecognitionRequest.getNotificationChannel() != null) {
                NotificationChannel notificationChannel = startCelebrityRecognitionRequest
