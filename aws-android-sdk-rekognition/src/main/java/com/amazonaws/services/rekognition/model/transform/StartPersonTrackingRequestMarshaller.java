 ...
 */
public class StartPersonTrackingRequestMarshaller implements
        Marshaller<Request<StartPersonTrackingRequest>, StartPersonTrackingRequest> {

    public Request<StartPersonTrackingRequest> marshall(
            StartPersonTrackingRequest startPersonTrackingRequest) {
        if (startPersonTrackingRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(StartPersonTrackingRequest)");
        }

        Request<StartPersonTrackingRequest> request = new DefaultRequest<StartPersonTrackingRequest>(
                startPersonTrackingRequest, "AmazonRekognition");
        ...
        try {
            ...
            if (startPersonTrackingRequest.getNotificationChannel() != null) {
                NotificationChannel notificationChannel = startPersonTrackingRequest
