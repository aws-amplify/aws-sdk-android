...
public class ImageTooLargeExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("ImageTooLargeException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        ImageTooLargeException e = (ImageTooLargeException) super.unmarshall(error);
        e.setErrorCode("ImageTooLargeException");
