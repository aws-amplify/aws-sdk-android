...
/**
 * JSON unmarshaller for POJO EyeDirection
 */
class EyeDirectionJsonUnmarshaller implements Unmarshaller<EyeDirection, JsonUnmarshallerContext> {
    ...
    public EyeDirection unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Yaw")) {
                eyeDirection.setYaw(FloatJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Pitch")) {
                eyeDirection.setPitch(FloatJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Confidence")) {
                eyeDirection.setConfidence(FloatJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
