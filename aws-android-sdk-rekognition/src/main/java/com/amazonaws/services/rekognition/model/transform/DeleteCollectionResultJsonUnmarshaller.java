 ...
 */
public class DeleteCollectionResultJsonUnmarshaller implements
        Unmarshaller<DeleteCollectionResult, JsonUnmarshallerContext> {
    ...
    public DeleteCollectionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("StatusCode")) {
                deleteCollectionResult.setStatusCode(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
