...
/**
 * JSON unmarshaller for POJO StreamProcessorNotificationChannel
 */
class StreamProcessorNotificationChannelJsonUnmarshaller implements
        Unmarshaller<StreamProcessorNotificationChannel, JsonUnmarshallerContext> {
    ...
    public StreamProcessorNotificationChannel unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SNSTopicArn")) {
                streamProcessorNotificationChannel.setSNSTopicArn(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
