 ...
 */
public class CreateFaceLivenessSessionResultJsonUnmarshaller implements
        Unmarshaller<CreateFaceLivenessSessionResult, JsonUnmarshallerContext> {

    public CreateFaceLivenessSessionResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SessionId")) {
                createFaceLivenessSessionResult.setSessionId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
