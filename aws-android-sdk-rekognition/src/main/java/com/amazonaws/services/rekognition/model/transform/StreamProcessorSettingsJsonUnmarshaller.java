...
/**
 * JSON unmarshaller for POJO StreamProcessorSettings
 */
class StreamProcessorSettingsJsonUnmarshaller implements
        Unmarshaller<StreamProcessorSettings, JsonUnmarshallerContext> {
