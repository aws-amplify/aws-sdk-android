 ...
 */
public class GetLabelDetectionRequestMarshaller implements
        Marshaller<Request<GetLabelDetectionRequest>, GetLabelDetectionRequest> {

    public Request<GetLabelDetectionRequest> marshall(
            GetLabelDetectionRequest getLabelDetectionRequest) {
        if (getLabelDetectionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetLabelDetectionRequest)");
        }

        Request<GetLabelDetectionRequest> request = new DefaultRequest<GetLabelDetectionRequest>(
                getLabelDetectionRequest, "AmazonRekognition");
