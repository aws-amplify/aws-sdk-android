 ...
 */
public class ListDatasetEntriesRequestMarshaller implements
        Marshaller<Request<ListDatasetEntriesRequest>, ListDatasetEntriesRequest> {

    public Request<ListDatasetEntriesRequest> marshall(
            ListDatasetEntriesRequest listDatasetEntriesRequest) {
        if (listDatasetEntriesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListDatasetEntriesRequest)");
        }

        Request<ListDatasetEntriesRequest> request = new DefaultRequest<ListDatasetEntriesRequest>(
                listDatasetEntriesRequest, "AmazonRekognition");
        ...
        try {
            ...
            if (listDatasetEntriesRequest.getContainsLabels() != null) {
                java.util.List<String> containsLabels = listDatasetEntriesRequest
                        .getContainsLabels();
                jsonWriter.name("ContainsLabels");
                jsonWriter.beginArray();
                for (String containsLabelsItem : containsLabels) {
                    if (containsLabelsItem != null) {
                        jsonWriter.value(containsLabelsItem);
                    }
                }
                jsonWriter.endArray();
            }
