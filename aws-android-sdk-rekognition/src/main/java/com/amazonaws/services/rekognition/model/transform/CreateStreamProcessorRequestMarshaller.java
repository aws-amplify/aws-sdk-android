 ...
 */
public class CreateStreamProcessorRequestMarshaller implements
        Marshaller<Request<CreateStreamProcessorRequest>, CreateStreamProcessorRequest> {

    public Request<CreateStreamProcessorRequest> marshall(
            CreateStreamProcessorRequest createStreamProcessorRequest) {
        if (createStreamProcessorRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateStreamProcessorRequest)");
        }

        Request<CreateStreamProcessorRequest> request = new DefaultRequest<CreateStreamProcessorRequest>(
                createStreamProcessorRequest, "AmazonRekognition");
