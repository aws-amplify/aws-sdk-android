...
/**
 * JSON marshaller for POJO CelebrityRecognition
 */
class CelebrityRecognitionJsonMarshaller {

    public void marshall(CelebrityRecognition celebrityRecognition, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (celebrityRecognition.getCelebrity() != null) {
            ...
            jsonWriter.name("Celebrity");
            CelebrityDetailJsonMarshaller.getInstance().marshall(celebrity, jsonWriter);
        }
