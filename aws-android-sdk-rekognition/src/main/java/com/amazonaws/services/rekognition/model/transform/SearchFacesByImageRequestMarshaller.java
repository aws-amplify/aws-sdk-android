 ...
 */
public class SearchFacesByImageRequestMarshaller implements
        Marshaller<Request<SearchFacesByImageRequest>, SearchFacesByImageRequest> {

    public Request<SearchFacesByImageRequest> marshall(
            SearchFacesByImageRequest searchFacesByImageRequest) {
        if (searchFacesByImageRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(SearchFacesByImageRequest)");
        }

        Request<SearchFacesByImageRequest> request = new DefaultRequest<SearchFacesByImageRequest>(
                searchFacesByImageRequest, "AmazonRekognition");
