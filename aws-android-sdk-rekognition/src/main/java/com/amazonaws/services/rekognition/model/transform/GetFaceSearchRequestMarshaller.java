 ...
 */
public class GetFaceSearchRequestMarshaller implements
        Marshaller<Request<GetFaceSearchRequest>, GetFaceSearchRequest> {

    public Request<GetFaceSearchRequest> marshall(GetFaceSearchRequest getFaceSearchRequest) {
        if (getFaceSearchRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetFaceSearchRequest)");
        }

        Request<GetFaceSearchRequest> request = new DefaultRequest<GetFaceSearchRequest>(
                getFaceSearchRequest, "AmazonRekognition");
