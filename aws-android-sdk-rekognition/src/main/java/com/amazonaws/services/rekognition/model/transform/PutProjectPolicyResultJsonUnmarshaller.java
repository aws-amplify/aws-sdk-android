 ...
 */
public class PutProjectPolicyResultJsonUnmarshaller implements
        Unmarshaller<PutProjectPolicyResult, JsonUnmarshallerContext> {
    ...
    public PutProjectPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PolicyRevisionId")) {
                putProjectPolicyResult.setPolicyRevisionId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
