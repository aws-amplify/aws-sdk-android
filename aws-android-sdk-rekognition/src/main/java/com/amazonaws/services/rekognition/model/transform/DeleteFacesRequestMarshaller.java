 ...
 */
public class DeleteFacesRequestMarshaller implements
        Marshaller<Request<DeleteFacesRequest>, DeleteFacesRequest> {

    public Request<DeleteFacesRequest> marshall(DeleteFacesRequest deleteFacesRequest) {
        if (deleteFacesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteFacesRequest)");
        }

        Request<DeleteFacesRequest> request = new DefaultRequest<DeleteFacesRequest>(
                deleteFacesRequest, "AmazonRekognition");
        ...
        try {
            ...
            if (deleteFacesRequest.getFaceIds() != null) {
                java.util.List<String> faceIds = deleteFacesRequest.getFaceIds();
