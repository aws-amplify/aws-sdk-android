 ...
 */
public class DescribeCollectionResultJsonUnmarshaller implements
        Unmarshaller<DescribeCollectionResult, JsonUnmarshallerContext> {
    ...
    public DescribeCollectionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("FaceCount")) {
                describeCollectionResult.setFaceCount(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("FaceModelVersion")) {
                describeCollectionResult.setFaceModelVersion(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("CollectionARN")) {
                describeCollectionResult.setCollectionARN(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
