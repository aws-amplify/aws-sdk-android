 ...
 */
public class CopyProjectVersionResultJsonUnmarshaller implements
        Unmarshaller<CopyProjectVersionResult, JsonUnmarshallerContext> {
    ...
    public CopyProjectVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ProjectVersionArn")) {
                copyProjectVersionResult.setProjectVersionArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
