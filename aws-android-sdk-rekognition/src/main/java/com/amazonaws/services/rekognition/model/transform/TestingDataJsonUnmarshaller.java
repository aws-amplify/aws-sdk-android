...
/**
 * JSON unmarshaller for POJO TestingData
 */
    ...
    public TestingData unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Assets")) {
                testingData.setAssets(new ListUnmarshaller<Asset>(AssetJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("AutoCreate")) {
                testingData.setAutoCreate(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
