...
/**
 * JSON unmarshaller for POJO ProtectiveEquipmentSummarizationAttributes
 */
class ProtectiveEquipmentSummarizationAttributesJsonUnmarshaller implements
        Unmarshaller<ProtectiveEquipmentSummarizationAttributes, JsonUnmarshallerContext> {

    public ProtectiveEquipmentSummarizationAttributes unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("MinConfidence")) {
                protectiveEquipmentSummarizationAttributes.setMinConfidence(FloatJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("RequiredEquipmentTypes")) {
                protectiveEquipmentSummarizationAttributes
                        .setRequiredEquipmentTypes(new ListUnmarshaller<String>(
