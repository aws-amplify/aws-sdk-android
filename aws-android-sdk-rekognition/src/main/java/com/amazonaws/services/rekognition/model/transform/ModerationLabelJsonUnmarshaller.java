...
/**
 * JSON unmarshaller for POJO ModerationLabel
 */
class ModerationLabelJsonUnmarshaller implements
        Unmarshaller<ModerationLabel, JsonUnmarshallerContext> {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Confidence")) {
                ...
                moderationLabel.setParentName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TaxonomyLevel")) {
                moderationLabel.setTaxonomyLevel(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
