 ...
 */
public class StartFaceSearchRequestMarshaller implements
        Marshaller<Request<StartFaceSearchRequest>, StartFaceSearchRequest> {
    ...
    public Request<StartFaceSearchRequest> marshall(StartFaceSearchRequest startFaceSearchRequest) {
        if (startFaceSearchRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(StartFaceSearchRequest)");
        }

        Request<StartFaceSearchRequest> request = new DefaultRequest<StartFaceSearchRequest>(
                startFaceSearchRequest, "AmazonRekognition");
