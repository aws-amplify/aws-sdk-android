...
/**
 * JSON marshaller for POJO TestingData
 */
class TestingDataJsonMarshaller {

    public void marshall(TestingData testingData, AwsJsonWriter jsonWriter) throws Exception {
        jsonWriter.beginObject();
        if (testingData.getAssets() != null) {
            java.util.List<Asset> assets = testingData.getAssets();
        ...
        if (testingData.getAutoCreate() != null) {
            ...
            jsonWriter.name("AutoCreate");
            jsonWriter.value(autoCreate);
        }
