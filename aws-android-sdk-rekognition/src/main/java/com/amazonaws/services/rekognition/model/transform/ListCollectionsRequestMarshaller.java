 ...
 */
public class ListCollectionsRequestMarshaller implements
        Marshaller<Request<ListCollectionsRequest>, ListCollectionsRequest> {
    ...
    public Request<ListCollectionsRequest> marshall(ListCollectionsRequest listCollectionsRequest) {
        if (listCollectionsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListCollectionsRequest)");
        }

        Request<ListCollectionsRequest> request = new DefaultRequest<ListCollectionsRequest>(
                listCollectionsRequest, "AmazonRekognition");
