 ...
 */
public class StartFaceDetectionRequestMarshaller implements
        Marshaller<Request<StartFaceDetectionRequest>, StartFaceDetectionRequest> {

    public Request<StartFaceDetectionRequest> marshall(
            StartFaceDetectionRequest startFaceDetectionRequest) {
        if (startFaceDetectionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(StartFaceDetectionRequest)");
        }

        Request<StartFaceDetectionRequest> request = new DefaultRequest<StartFaceDetectionRequest>(
                startFaceDetectionRequest, "AmazonRekognition");
        ...
        try {
            ...
            if (startFaceDetectionRequest.getNotificationChannel() != null) {
                NotificationChannel notificationChannel = startFaceDetectionRequest
