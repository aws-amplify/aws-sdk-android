 ...
 */
public class GetSegmentDetectionRequestMarshaller implements
        Marshaller<Request<GetSegmentDetectionRequest>, GetSegmentDetectionRequest> {

    public Request<GetSegmentDetectionRequest> marshall(
            GetSegmentDetectionRequest getSegmentDetectionRequest) {
        if (getSegmentDetectionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetSegmentDetectionRequest)");
        }

        Request<GetSegmentDetectionRequest> request = new DefaultRequest<GetSegmentDetectionRequest>(
                getSegmentDetectionRequest, "AmazonRekognition");
