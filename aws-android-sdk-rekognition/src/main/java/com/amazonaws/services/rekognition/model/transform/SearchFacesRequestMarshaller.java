 ...
 */
public class SearchFacesRequestMarshaller implements
        Marshaller<Request<SearchFacesRequest>, SearchFacesRequest> {

    public Request<SearchFacesRequest> marshall(SearchFacesRequest searchFacesRequest) {
        if (searchFacesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(SearchFacesRequest)");
        }

        Request<SearchFacesRequest> request = new DefaultRequest<SearchFacesRequest>(
                searchFacesRequest, "AmazonRekognition");
