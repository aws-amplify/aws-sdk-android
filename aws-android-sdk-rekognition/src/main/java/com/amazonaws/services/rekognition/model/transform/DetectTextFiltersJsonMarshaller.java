...
/**
 * JSON marshaller for POJO DetectTextFilters
 */
class DetectTextFiltersJsonMarshaller {

    public void marshall(DetectTextFilters detectTextFilters, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (detectTextFilters.getRegionsOfInterest() != null) {
            java.util.List<RegionOfInterest> regionsOfInterest = detectTextFilters
