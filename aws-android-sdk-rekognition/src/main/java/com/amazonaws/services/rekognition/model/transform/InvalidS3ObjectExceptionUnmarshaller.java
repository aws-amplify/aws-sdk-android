...
public class InvalidS3ObjectExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InvalidS3ObjectException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        InvalidS3ObjectException e = (InvalidS3ObjectException) super.unmarshall(error);
        e.setErrorCode("InvalidS3ObjectException");
