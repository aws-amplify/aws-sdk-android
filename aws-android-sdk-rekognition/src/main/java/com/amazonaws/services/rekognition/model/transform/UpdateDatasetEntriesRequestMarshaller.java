 ...
 */
public class UpdateDatasetEntriesRequestMarshaller implements
        Marshaller<Request<UpdateDatasetEntriesRequest>, UpdateDatasetEntriesRequest> {

    public Request<UpdateDatasetEntriesRequest> marshall(
            UpdateDatasetEntriesRequest updateDatasetEntriesRequest) {
        if (updateDatasetEntriesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateDatasetEntriesRequest)");
        }

        Request<UpdateDatasetEntriesRequest> request = new DefaultRequest<UpdateDatasetEntriesRequest>(
                updateDatasetEntriesRequest, "AmazonRekognition");
