...
/**
 * JSON unmarshaller for POJO ContentModerationDetection
 */
class ContentModerationDetectionJsonUnmarshaller implements
        Unmarshaller<ContentModerationDetection, JsonUnmarshallerContext> {
    ...
    public ContentModerationDetection unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Timestamp")) {
                contentModerationDetection.setTimestamp(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                contentModerationDetection.setContentTypes(new ListUnmarshaller<ContentType>(
                        ContentTypeJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
