...
public class InvalidImageFormatExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InvalidImageFormatException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        InvalidImageFormatException e = (InvalidImageFormatException) super.unmarshall(error);
        e.setErrorCode("InvalidImageFormatException");
