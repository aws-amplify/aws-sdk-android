 ...
 */
public class DisassociateFacesResultJsonUnmarshaller implements
        Unmarshaller<DisassociateFacesResult, JsonUnmarshallerContext> {
    ...
    public DisassociateFacesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("DisassociatedFaces")) {
                disassociateFacesResult
                        .setDisassociatedFaces(new ListUnmarshaller<DisassociatedFace>(
                                DisassociatedFaceJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("UnsuccessfulFaceDisassociations")) {
                disassociateFacesResult
                        .setUnsuccessfulFaceDisassociations(new ListUnmarshaller<UnsuccessfulFaceDisassociation>(
                                UnsuccessfulFaceDisassociationJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("UserStatus")) {
                disassociateFacesResult.setUserStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
