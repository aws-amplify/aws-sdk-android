...
/**
 * JSON marshaller for POJO StreamProcessorDataSharingPreference
 */
class StreamProcessorDataSharingPreferenceJsonMarshaller {

    public void marshall(StreamProcessorDataSharingPreference streamProcessorDataSharingPreference,
