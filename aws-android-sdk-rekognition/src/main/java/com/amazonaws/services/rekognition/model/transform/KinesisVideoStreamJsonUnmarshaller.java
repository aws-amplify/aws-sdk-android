...
/**
 * JSON unmarshaller for POJO KinesisVideoStream
 */
class KinesisVideoStreamJsonUnmarshaller implements
        Unmarshaller<KinesisVideoStream, JsonUnmarshallerContext> {
