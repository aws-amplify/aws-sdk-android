 ...
 */
public class DeleteProjectVersionResultJsonUnmarshaller implements
        Unmarshaller<DeleteProjectVersionResult, JsonUnmarshallerContext> {
    ...
    public DeleteProjectVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Status")) {
                deleteProjectVersionResult.setStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
