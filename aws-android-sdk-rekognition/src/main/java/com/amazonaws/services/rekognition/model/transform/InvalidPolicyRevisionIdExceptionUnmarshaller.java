...
public class InvalidPolicyRevisionIdExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InvalidPolicyRevisionIdException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        InvalidPolicyRevisionIdException e = (InvalidPolicyRevisionIdException) super
                .unmarshall(error);
        e.setErrorCode("InvalidPolicyRevisionIdException");
