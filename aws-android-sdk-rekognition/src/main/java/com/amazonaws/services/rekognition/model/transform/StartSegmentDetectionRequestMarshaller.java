 ...
 */
public class StartSegmentDetectionRequestMarshaller implements
        Marshaller<Request<StartSegmentDetectionRequest>, StartSegmentDetectionRequest> {

    public Request<StartSegmentDetectionRequest> marshall(
            StartSegmentDetectionRequest startSegmentDetectionRequest) {
        if (startSegmentDetectionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(StartSegmentDetectionRequest)");
        }

        Request<StartSegmentDetectionRequest> request = new DefaultRequest<StartSegmentDetectionRequest>(
                startSegmentDetectionRequest, "AmazonRekognition");
        ...
        try {
            ...
            if (startSegmentDetectionRequest.getNotificationChannel() != null) {
                NotificationChannel notificationChannel = startSegmentDetectionRequest
            ...
            if (startSegmentDetectionRequest.getFilters() != null) {
                ...
                StartSegmentDetectionFiltersJsonMarshaller.getInstance().marshall(filters,
                        jsonWriter);
            }
            if (startSegmentDetectionRequest.getSegmentTypes() != null) {
                java.util.List<String> segmentTypes = startSegmentDetectionRequest
                        .getSegmentTypes();
