...
/**
 * JSON marshaller for POJO UnsuccessfulFaceDeletion
 */
class UnsuccessfulFaceDeletionJsonMarshaller {

    public void marshall(UnsuccessfulFaceDeletion unsuccessfulFaceDeletion, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (unsuccessfulFaceDeletion.getReasons() != null) {
            java.util.List<String> reasons = unsuccessfulFaceDeletion.getReasons();
