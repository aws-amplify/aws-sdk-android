 ...
 */
public class GetCelebrityRecognitionRequestMarshaller implements
        Marshaller<Request<GetCelebrityRecognitionRequest>, GetCelebrityRecognitionRequest> {

    public Request<GetCelebrityRecognitionRequest> marshall(
            GetCelebrityRecognitionRequest getCelebrityRecognitionRequest) {
        if (getCelebrityRecognitionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetCelebrityRecognitionRequest)");
        }

        Request<GetCelebrityRecognitionRequest> request = new DefaultRequest<GetCelebrityRecognitionRequest>(
                getCelebrityRecognitionRequest, "AmazonRekognition");
