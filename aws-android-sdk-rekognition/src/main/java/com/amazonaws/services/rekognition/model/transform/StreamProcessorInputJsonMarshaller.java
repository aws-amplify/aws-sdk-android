...
/**
 * JSON marshaller for POJO StreamProcessorInput
 */
class StreamProcessorInputJsonMarshaller {

    public void marshall(StreamProcessorInput streamProcessorInput, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (streamProcessorInput.getKinesisVideoStream() != null) {
            ...
            jsonWriter.name("KinesisVideoStream");
            KinesisVideoStreamJsonMarshaller.getInstance().marshall(kinesisVideoStream, jsonWriter);
        }
