 ...
 */
public class GetPersonTrackingRequestMarshaller implements
        Marshaller<Request<GetPersonTrackingRequest>, GetPersonTrackingRequest> {

    public Request<GetPersonTrackingRequest> marshall(
            GetPersonTrackingRequest getPersonTrackingRequest) {
        if (getPersonTrackingRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetPersonTrackingRequest)");
        }

        Request<GetPersonTrackingRequest> request = new DefaultRequest<GetPersonTrackingRequest>(
                getPersonTrackingRequest, "AmazonRekognition");
