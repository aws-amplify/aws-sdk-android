...
/**
 * JSON marshaller for POJO TextDetectionResult
 */
class TextDetectionResultJsonMarshaller {

    public void marshall(TextDetectionResult textDetectionResult, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (textDetectionResult.getTextDetection() != null) {
            ...
            jsonWriter.name("TextDetection");
            TextDetectionJsonMarshaller.getInstance().marshall(textDetection, jsonWriter);
        }
