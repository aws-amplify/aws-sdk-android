 ...
 */
public class DetectLabelsRequestMarshaller implements
        Marshaller<Request<DetectLabelsRequest>, DetectLabelsRequest> {

    public Request<DetectLabelsRequest> marshall(DetectLabelsRequest detectLabelsRequest) {
        if (detectLabelsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DetectLabelsRequest)");
        }

        Request<DetectLabelsRequest> request = new DefaultRequest<DetectLabelsRequest>(
                detectLabelsRequest, "AmazonRekognition");
