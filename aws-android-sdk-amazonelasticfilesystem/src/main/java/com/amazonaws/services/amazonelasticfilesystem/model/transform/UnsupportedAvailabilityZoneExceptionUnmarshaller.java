...
import com.amazonaws.services.amazonelasticfilesystem.model.UnsupportedAvailabilityZoneException;
...
public class UnsupportedAvailabilityZoneExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("UnsupportedAvailabilityZone");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        UnsupportedAvailabilityZoneException e = (UnsupportedAvailabilityZoneException) super
                .unmarshall(error);
