...
import com.amazonaws.services.amazonelasticfilesystem.model.NetworkInterfaceLimitExceededException;
...
public class NetworkInterfaceLimitExceededExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("NetworkInterfaceLimitExceeded");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        NetworkInterfaceLimitExceededException e = (NetworkInterfaceLimitExceededException) super
                .unmarshall(error);
