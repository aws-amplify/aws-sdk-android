...
public class ListTagsForResourceResult implements Serializable {
    ...
    /**
     * <p>
     * <code>NextToken</code> is present if the response payload is paginated.
     ...
     *
     * @return <p>
     *         <code>NextToken</code> is present if the response payload is
     *         paginated. You can use <code>NextToken</code> in a subsequent
