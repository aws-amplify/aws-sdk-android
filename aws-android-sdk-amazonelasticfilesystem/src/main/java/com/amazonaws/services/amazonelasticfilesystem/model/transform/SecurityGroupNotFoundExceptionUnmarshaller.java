...
import com.amazonaws.services.amazonelasticfilesystem.model.SecurityGroupNotFoundException;
...
public class SecurityGroupNotFoundExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("SecurityGroupNotFound");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        SecurityGroupNotFoundException e = (SecurityGroupNotFoundException) super.unmarshall(error);
