    ...
    public DescribeFileSystemsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Marker")) {
                describeFileSystemsResult.setMarker(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("FileSystems")) {
                describeFileSystemsResult
                        .setFileSystems(new ListUnmarshaller<FileSystemDescription>(
                                FileSystemDescriptionJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextMarker")) {
                describeFileSystemsResult.setNextMarker(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
