...
/**
 * JSON unmarshaller for response DescribeAccessPointsResult
 */
public class DescribeAccessPointsResultJsonUnmarshaller implements
        Unmarshaller<DescribeAccessPointsResult, JsonUnmarshallerContext> {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AccessPoints")) {
                describeAccessPointsResult
                        .setAccessPoints(new ListUnmarshaller<AccessPointDescription>(
                                AccessPointDescriptionJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                describeAccessPointsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
