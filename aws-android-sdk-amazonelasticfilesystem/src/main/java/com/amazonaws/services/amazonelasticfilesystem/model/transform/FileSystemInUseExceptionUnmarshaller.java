...
import com.amazonaws.services.amazonelasticfilesystem.model.FileSystemInUseException;
...
public class FileSystemInUseExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("FileSystemInUse");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        FileSystemInUseException e = (FileSystemInUseException) super.unmarshall(error);
