...
import com.amazonaws.services.amazonelasticfilesystem.model.IpAddressInUseException;
...
public class IpAddressInUseExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("IpAddressInUse");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        IpAddressInUseException e = (IpAddressInUseException) super.unmarshall(error);
