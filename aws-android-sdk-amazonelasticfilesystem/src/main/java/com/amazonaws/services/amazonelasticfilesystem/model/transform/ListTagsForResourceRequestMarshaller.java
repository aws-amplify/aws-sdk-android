...
public class ListTagsForResourceRequestMarshaller implements
    ...
    public Request<ListTagsForResourceRequest> marshall(
        ...
        Request<ListTagsForResourceRequest> request = new DefaultRequest<ListTagsForResourceRequest>(
                listTagsForResourceRequest, "AmazonElasticFileSystem");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/2015-02-01/resource-tags/{ResourceId}";
        uriResourcePath = uriResourcePath.replace(
                "{ResourceId}",
                (listTagsForResourceRequest.getResourceId() == null) ? "" : StringUtils
                        .fromString(listTagsForResourceRequest.getResourceId()));
        if (listTagsForResourceRequest.getMaxResults() != null) {
            request.addParameter("MaxResults",
                    StringUtils.fromInteger(listTagsForResourceRequest.getMaxResults()));
        }
