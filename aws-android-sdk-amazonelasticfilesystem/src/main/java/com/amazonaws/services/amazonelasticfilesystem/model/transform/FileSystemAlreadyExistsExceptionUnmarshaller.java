...
import com.amazonaws.services.amazonelasticfilesystem.model.FileSystemAlreadyExistsException;
...
public class FileSystemAlreadyExistsExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("FileSystemAlreadyExists");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        FileSystemAlreadyExistsException e = (FileSystemAlreadyExistsException) super
                .unmarshall(error);
