...
/**
 * JSON unmarshaller for POJO FileSystemSize
 */
class FileSystemSizeJsonUnmarshaller implements
    ...
    public FileSystemSize unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Value")) {
                ...
                fileSystemSize.setTimestamp(DateJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ValueInIA")) {
                fileSystemSize.setValueInIA(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ValueInStandard")) {
                fileSystemSize.setValueInStandard(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
