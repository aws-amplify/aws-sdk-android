...
import com.amazonaws.services.amazonelasticfilesystem.model.IncorrectMountTargetStateException;
...
public class IncorrectMountTargetStateExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("IncorrectMountTargetState");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        IncorrectMountTargetStateException e = (IncorrectMountTargetStateException) super
                .unmarshall(error);
