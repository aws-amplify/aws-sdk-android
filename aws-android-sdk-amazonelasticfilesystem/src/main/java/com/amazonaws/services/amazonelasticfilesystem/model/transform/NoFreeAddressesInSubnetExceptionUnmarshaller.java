...
import com.amazonaws.services.amazonelasticfilesystem.model.NoFreeAddressesInSubnetException;
...
public class NoFreeAddressesInSubnetExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("NoFreeAddressesInSubnet");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        NoFreeAddressesInSubnetException e = (NoFreeAddressesInSubnetException) super
                .unmarshall(error);
