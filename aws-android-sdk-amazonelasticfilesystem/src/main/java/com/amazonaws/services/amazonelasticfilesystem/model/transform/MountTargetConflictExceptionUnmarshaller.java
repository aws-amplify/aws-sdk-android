...
import com.amazonaws.services.amazonelasticfilesystem.model.MountTargetConflictException;
...
public class MountTargetConflictExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("MountTargetConflict");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        MountTargetConflictException e = (MountTargetConflictException) super.unmarshall(error);
