...
/**
 * JSON unmarshaller for response DescribeMountTargetSecurityGroupsResult
 */
public class DescribeMountTargetSecurityGroupsResultJsonUnmarshaller implements
        Unmarshaller<DescribeMountTargetSecurityGroupsResult, JsonUnmarshallerContext> {

    public DescribeMountTargetSecurityGroupsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SecurityGroups")) {
                describeMountTargetSecurityGroupsResult
                        .setSecurityGroups(new ListUnmarshaller<String>(StringJsonUnmarshaller
                                .getInstance()
                        )
                                .unmarshall(context));
            } else {
