...
import com.amazonaws.services.amazonelasticfilesystem.model.TooManyRequestsException;
...
public class TooManyRequestsExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("TooManyRequests");
    }
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        e.setErrorCode("TooManyRequests");
