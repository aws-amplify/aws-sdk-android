...
import com.amazonaws.services.amazonelasticfilesystem.model.SubnetNotFoundException;
...
public class SubnetNotFoundExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("SubnetNotFound");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        SubnetNotFoundException e = (SubnetNotFoundException) super.unmarshall(error);
