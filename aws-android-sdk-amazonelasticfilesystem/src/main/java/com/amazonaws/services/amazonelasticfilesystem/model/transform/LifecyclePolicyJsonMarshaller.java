...
class LifecyclePolicyJsonMarshaller {
    ...
    public void marshall(LifecyclePolicy lifecyclePolicy, AwsJsonWriter jsonWriter)
        ...
        if (lifecyclePolicy.getTransitionToIA() != null) {
            String transitionToIA = lifecyclePolicy.getTransitionToIA();
            jsonWriter.name("TransitionToIA");
            jsonWriter.value(transitionToIA);
        }
