...
import com.amazonaws.services.amazonelasticfilesystem.model.FileSystemLimitExceededException;
...
public class FileSystemLimitExceededExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("FileSystemLimitExceeded");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        FileSystemLimitExceededException e = (FileSystemLimitExceededException) super
                .unmarshall(error);
