...
/**
 * JSON request marshaller for ModifyMountTargetSecurityGroupsRequest
 */
    ...
    public Request<ModifyMountTargetSecurityGroupsRequest> marshall(
        ...
        if (modifyMountTargetSecurityGroupsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ModifyMountTargetSecurityGroupsRequest)");
        }

        Request<ModifyMountTargetSecurityGroupsRequest> request = new DefaultRequest<ModifyMountTargetSecurityGroupsRequest>(
                modifyMountTargetSecurityGroupsRequest, "AmazonElasticFileSystem");
        request.setHttpMethod(HttpMethodName.PUT);

        String uriResourcePath = "/2015-02-01/mount-targets/{MountTargetId}/security-groups";
        uriResourcePath = uriResourcePath.replace(
                "{MountTargetId}",
                (modifyMountTargetSecurityGroupsRequest.getMountTargetId() == null) ? ""
                        : StringUtils.fromString(modifyMountTargetSecurityGroupsRequest
                                .getMountTargetId()));
        ...
        try {
            ...
            if (modifyMountTargetSecurityGroupsRequest.getSecurityGroups() != null) {
                java.util.List<String> securityGroups = modifyMountTargetSecurityGroupsRequest
                        .getSecurityGroups();
