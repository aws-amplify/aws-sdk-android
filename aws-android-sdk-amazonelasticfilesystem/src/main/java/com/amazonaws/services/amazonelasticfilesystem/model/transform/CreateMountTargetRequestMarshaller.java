...
/**
 * JSON request marshaller for CreateMountTargetRequest
 */
    ...
    public Request<CreateMountTargetRequest> marshall(
        ...
        if (createMountTargetRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateMountTargetRequest)");
        }
        ...
        try {
            ...
            if (createMountTargetRequest.getFileSystemId() != null) {
                String fileSystemId = createMountTargetRequest.getFileSystemId();
                jsonWriter.name("FileSystemId");
                jsonWriter.value(fileSystemId);
            }
            if (createMountTargetRequest.getSubnetId() != null) {
                String subnetId = createMountTargetRequest.getSubnetId();
                jsonWriter.name("SubnetId");
                jsonWriter.value(subnetId);
            }
            if (createMountTargetRequest.getIpAddress() != null) {
                String ipAddress = createMountTargetRequest.getIpAddress();
                jsonWriter.name("IpAddress");
                jsonWriter.value(ipAddress);
            }
            if (createMountTargetRequest.getSecurityGroups() != null) {
                java.util.List<String> securityGroups = createMountTargetRequest
                        .getSecurityGroups();
