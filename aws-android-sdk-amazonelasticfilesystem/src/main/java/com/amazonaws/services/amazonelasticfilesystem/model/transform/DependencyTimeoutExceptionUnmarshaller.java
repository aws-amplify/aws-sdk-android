...
import com.amazonaws.services.amazonelasticfilesystem.model.DependencyTimeoutException;
...
public class DependencyTimeoutExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("DependencyTimeout");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        DependencyTimeoutException e = (DependencyTimeoutException) super.unmarshall(error);
