...
/**
 * JSON request marshaller for DescribeMountTargetSecurityGroupsRequest
 */
    ...
    public Request<DescribeMountTargetSecurityGroupsRequest> marshall(
        ...
        if (describeMountTargetSecurityGroupsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeMountTargetSecurityGroupsRequest)");
        }
        ...
        uriResourcePath = uriResourcePath.replace(
                "{MountTargetId}",
                (describeMountTargetSecurityGroupsRequest.getMountTargetId() == null) ? ""
                        : StringUtils.fromString(describeMountTargetSecurityGroupsRequest
                                .getMountTargetId()));
