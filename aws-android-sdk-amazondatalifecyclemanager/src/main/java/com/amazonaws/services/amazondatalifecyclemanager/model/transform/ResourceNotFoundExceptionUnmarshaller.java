...
import com.amazonaws.services.amazondatalifecyclemanager.model.ResourceNotFoundException;
...
e.setResourceType(String.valueOf(error.get("ResourceType")));
        ...
        e.setResourceIds(gson.fromJson(error.get("ResourceIds"),java.util.List&lt;String&gt;.class));
