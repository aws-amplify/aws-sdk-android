 ...
 * </p>
 */
public class ListSchemasRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     *
     * @return <p>
     *         Specifying this limits the results to only those schema names
    ...
    public String toString() {
        ...
        if (getSchemaNamePrefix() != null)
            sb.append("SchemaNamePrefix: " + getSchemaNamePrefix());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getSchemaNamePrefix() == null) ? 0 : getSchemaNamePrefix().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSchemaNamePrefix() == null ^ this.getSchemaNamePrefix() == null)
            return false;
        if (other.getSchemaNamePrefix() != null
                && other.getSchemaNamePrefix().equals(this.getSchemaNamePrefix()) == false)
            return false;
        return true;
    }
}
