...
/**
 * JSON unmarshaller for response PutResourcePolicyResult
 */
public class PutResourcePolicyResultJsonUnmarshaller implements
        Unmarshaller<PutResourcePolicyResult, JsonUnmarshallerContext> {
    ...
    public PutResourcePolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Policy")) {
                putResourcePolicyResult.setPolicy(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("RevisionId")) {
                putResourcePolicyResult.setRevisionId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
