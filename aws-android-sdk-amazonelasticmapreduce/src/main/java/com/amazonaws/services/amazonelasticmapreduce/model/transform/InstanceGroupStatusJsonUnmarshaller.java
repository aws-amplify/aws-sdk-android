...
/**
 * JSON unmarshaller for POJO InstanceGroupStatus
 */
class InstanceGroupStatusJsonUnmarshaller implements
    ...
    public InstanceGroupStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("State")) {
                instanceGroupStatus.setState(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("StateChangeReason")) {
                instanceGroupStatus
                        .setStateChangeReason(InstanceGroupStateChangeReasonJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else if (name.equals("Timeline")) {
                instanceGroupStatus.setTimeline(InstanceGroupTimelineJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
