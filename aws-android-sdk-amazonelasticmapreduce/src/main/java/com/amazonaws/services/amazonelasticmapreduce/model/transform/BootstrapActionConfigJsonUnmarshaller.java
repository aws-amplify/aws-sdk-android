...
/**
 * JSON unmarshaller for POJO BootstrapActionConfig
 */
class BootstrapActionConfigJsonUnmarshaller implements
    ...
    public BootstrapActionConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                bootstrapActionConfig.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ScriptBootstrapAction")) {
