...
/**
 * JSON unmarshaller for response ListInstanceGroupsResult
 */
public class ListInstanceGroupsResultJsonUnmarshaller implements
    ...
    public ListInstanceGroupsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("InstanceGroups")) {
                listInstanceGroupsResult.setInstanceGroups(new ListUnmarshaller<InstanceGroup>(
                        InstanceGroupJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Marker")) {
                listInstanceGroupsResult.setMarker(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
