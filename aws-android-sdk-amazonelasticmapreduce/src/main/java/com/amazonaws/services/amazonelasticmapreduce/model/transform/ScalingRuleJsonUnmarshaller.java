...
/**
 * JSON unmarshaller for POJO ScalingRule
 */
class ScalingRuleJsonUnmarshaller implements Unmarshaller<ScalingRule, JsonUnmarshallerContext> {
    ...
    public ScalingRule unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                scalingRule.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Description")) {
                scalingRule.setDescription(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Action")) {
                scalingRule.setAction(ScalingActionJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Trigger")) {
                scalingRule.setTrigger(ScalingTriggerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
