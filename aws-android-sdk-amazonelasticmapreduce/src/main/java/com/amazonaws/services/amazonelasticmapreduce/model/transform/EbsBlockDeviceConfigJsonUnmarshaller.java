...
/**
 * JSON unmarshaller for POJO EbsBlockDeviceConfig
 */
class EbsBlockDeviceConfigJsonUnmarshaller implements
    ...
    public EbsBlockDeviceConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("VolumeSpecification")) {
                ebsBlockDeviceConfig.setVolumeSpecification(VolumeSpecificationJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("VolumesPerInstance")) {
                ebsBlockDeviceConfig.setVolumesPerInstance(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
