...
/**
 * JSON unmarshaller for POJO StepStatus
 */
class StepStatusJsonUnmarshaller implements Unmarshaller<StepStatus, JsonUnmarshallerContext> {
    ...
    public StepStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("State")) {
                ...
                stepStatus.setStateChangeReason(StepStateChangeReasonJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("FailureDetails")) {
                stepStatus.setFailureDetails(FailureDetailsJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Timeline")) {
                stepStatus.setTimeline(StepTimelineJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
