...
/**
 * JSON marshaller for POJO SupportedProductConfig
 */
class SupportedProductConfigJsonMarshaller {

    public void marshall(SupportedProductConfig supportedProductConfig, AwsJsonWriter jsonWriter)
            throws Exception {
        jsonWriter.beginObject();
        if (supportedProductConfig.getName() != null) {
            String name = supportedProductConfig.getName();
            jsonWriter.name("Name");
            jsonWriter.value(name);
        }
        if (supportedProductConfig.getArgs() != null) {
            java.util.List<String> args = supportedProductConfig.getArgs();
