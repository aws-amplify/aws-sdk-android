...
/**
 * JSON request marshaller for ModifyClusterRequest
 */
public class ModifyClusterRequestMarshaller implements
    ...
    public Request<ModifyClusterRequest> marshall(ModifyClusterRequest modifyClusterRequest) {
        ...
        Request<ModifyClusterRequest> request = new DefaultRequest<ModifyClusterRequest>(
                modifyClusterRequest, "AmazonElasticMapReduce");
        ...
        try {
            ...
            if (modifyClusterRequest.getClusterId() != null) {
                String clusterId = modifyClusterRequest.getClusterId();
                jsonWriter.name("ClusterId");
                jsonWriter.value(clusterId);
            }
            if (modifyClusterRequest.getStepConcurrencyLevel() != null) {
                Integer stepConcurrencyLevel = modifyClusterRequest.getStepConcurrencyLevel();
