...
/**
 * JSON request marshaller for SetTerminationProtectionRequest
 */
public class SetTerminationProtectionRequestMarshaller implements
    ...
    public Request<SetTerminationProtectionRequest> marshall(
        ...
        if (setTerminationProtectionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(SetTerminationProtectionRequest)");
        }
        ...
        try {
            ...
            if (setTerminationProtectionRequest.getJobFlowIds() != null) {
                java.util.List<String> jobFlowIds = setTerminationProtectionRequest.getJobFlowIds();
            ...
            if (setTerminationProtectionRequest.getTerminationProtected() != null) {
                Boolean terminationProtected = setTerminationProtectionRequest
