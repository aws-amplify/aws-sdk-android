...
/**
 * JSON unmarshaller for POJO InstanceFleetModifyConfig
 */
class InstanceFleetModifyConfigJsonUnmarshaller implements
        Unmarshaller<InstanceFleetModifyConfig, JsonUnmarshallerContext> {
    ...
    public InstanceFleetModifyConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("InstanceFleetId")) {
                instanceFleetModifyConfig.setInstanceFleetId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TargetOnDemandCapacity")) {
                instanceFleetModifyConfig.setTargetOnDemandCapacity(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("TargetSpotCapacity")) {
                instanceFleetModifyConfig.setTargetSpotCapacity(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
