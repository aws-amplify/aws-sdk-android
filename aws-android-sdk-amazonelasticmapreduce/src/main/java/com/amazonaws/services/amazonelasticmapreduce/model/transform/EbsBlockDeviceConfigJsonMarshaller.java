...
/**
 * JSON marshaller for POJO EbsBlockDeviceConfig
 */
class EbsBlockDeviceConfigJsonMarshaller {

    public void marshall(EbsBlockDeviceConfig ebsBlockDeviceConfig, AwsJsonWriter jsonWriter)
            throws Exception {
        jsonWriter.beginObject();
        if (ebsBlockDeviceConfig.getVolumeSpecification() != null) {
            VolumeSpecification volumeSpecification = ebsBlockDeviceConfig.getVolumeSpecification();
        ...
        if (ebsBlockDeviceConfig.getVolumesPerInstance() != null) {
            Integer volumesPerInstance = ebsBlockDeviceConfig.getVolumesPerInstance();
            jsonWriter.name("VolumesPerInstance");
            jsonWriter.value(volumesPerInstance);
        }
