...
/**
 * JSON unmarshaller for POJO InstanceGroupConfig
 */
class InstanceGroupConfigJsonUnmarshaller implements
    ...
    public InstanceGroupConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                instanceGroupConfig.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Market")) {
                instanceGroupConfig.setMarket(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("InstanceRole")) {
                instanceGroupConfig.setInstanceRole(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("BidPrice")) {
                instanceGroupConfig.setBidPrice(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("InstanceType")) {
                instanceGroupConfig.setInstanceType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("InstanceCount")) {
                instanceGroupConfig.setInstanceCount(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Configurations")) {
                instanceGroupConfig.setConfigurations(new ListUnmarshaller<Configuration>(
                        ConfigurationJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("EbsConfiguration")) {
                instanceGroupConfig.setEbsConfiguration(EbsConfigurationJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("AutoScalingPolicy")) {
                instanceGroupConfig.setAutoScalingPolicy(AutoScalingPolicyJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
