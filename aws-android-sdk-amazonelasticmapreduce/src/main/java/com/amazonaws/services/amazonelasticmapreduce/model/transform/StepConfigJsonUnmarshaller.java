...
/**
 * JSON unmarshaller for POJO StepConfig
 */
class StepConfigJsonUnmarshaller implements Unmarshaller<StepConfig, JsonUnmarshallerContext> {
    ...
    public StepConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                stepConfig.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ActionOnFailure")) {
                stepConfig.setActionOnFailure(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("HadoopJarStep")) {
                stepConfig.setHadoopJarStep(HadoopJarStepConfigJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
