...
/**
 * JSON request marshaller for DescribeStepRequest
 */
public class DescribeStepRequestMarshaller implements
        Marshaller<Request<DescribeStepRequest>, DescribeStepRequest> {

    public Request<DescribeStepRequest> marshall(DescribeStepRequest describeStepRequest) {
        if (describeStepRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeStepRequest)");
        }

        Request<DescribeStepRequest> request = new DefaultRequest<DescribeStepRequest>(
                describeStepRequest, "AmazonElasticMapReduce");
        ...
        try {
            ...
            if (describeStepRequest.getClusterId() != null) {
                String clusterId = describeStepRequest.getClusterId();
                jsonWriter.name("ClusterId");
                jsonWriter.value(clusterId);
            }
            if (describeStepRequest.getStepId() != null) {
                String stepId = describeStepRequest.getStepId();
