    ...
    public ListClustersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Clusters")) {
                listClustersResult.setClusters(new ListUnmarshaller<ClusterSummary>(
                        ClusterSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Marker")) {
                listClustersResult.setMarker(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
