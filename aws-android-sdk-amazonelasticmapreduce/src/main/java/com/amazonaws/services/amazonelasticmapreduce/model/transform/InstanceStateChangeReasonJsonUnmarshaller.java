...
/**
 * JSON unmarshaller for POJO InstanceStateChangeReason
 */
class InstanceStateChangeReasonJsonUnmarshaller implements
        Unmarshaller<InstanceStateChangeReason, JsonUnmarshallerContext> {
    ...
    public InstanceStateChangeReason unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Code")) {
                instanceStateChangeReason.setCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Message")) {
                instanceStateChangeReason.setMessage(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
