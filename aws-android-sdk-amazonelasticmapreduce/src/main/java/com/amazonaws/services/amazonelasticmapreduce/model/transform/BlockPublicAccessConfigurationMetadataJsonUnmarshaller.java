...
/**
 * JSON unmarshaller for POJO BlockPublicAccessConfigurationMetadata
 */
class BlockPublicAccessConfigurationMetadataJsonUnmarshaller implements
        Unmarshaller<BlockPublicAccessConfigurationMetadata, JsonUnmarshallerContext> {
    ...
    public BlockPublicAccessConfigurationMetadata unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("CreationDateTime")) {
                blockPublicAccessConfigurationMetadata.setCreationDateTime(DateJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("CreatedByArn")) {
                blockPublicAccessConfigurationMetadata.setCreatedByArn(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
