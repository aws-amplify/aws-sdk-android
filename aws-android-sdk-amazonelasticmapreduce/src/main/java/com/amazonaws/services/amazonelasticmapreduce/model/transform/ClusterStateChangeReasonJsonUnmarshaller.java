...
/**
 * JSON unmarshaller for POJO ClusterStateChangeReason
 */
class ClusterStateChangeReasonJsonUnmarshaller implements
    ...
    public ClusterStateChangeReason unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Code")) {
                clusterStateChangeReason.setCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Message")) {
                clusterStateChangeReason.setMessage(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
