...
/**
 * JSON unmarshaller for POJO InstanceGroupStateChangeReason
 */
class InstanceGroupStateChangeReasonJsonUnmarshaller implements
    ...
    public InstanceGroupStateChangeReason unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Code")) {
                instanceGroupStateChangeReason.setCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Message")) {
                instanceGroupStateChangeReason.setMessage(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
