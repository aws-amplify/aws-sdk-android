...
/**
 * JSON unmarshaller for POJO InstanceFleetTimeline
 */
class InstanceFleetTimelineJsonUnmarshaller implements
        Unmarshaller<InstanceFleetTimeline, JsonUnmarshallerContext> {
    ...
    public InstanceFleetTimeline unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("CreationDateTime")) {
                instanceFleetTimeline.setCreationDateTime(DateJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ReadyDateTime")) {
                instanceFleetTimeline.setReadyDateTime(DateJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("EndDateTime")) {
                instanceFleetTimeline.setEndDateTime(DateJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
