...
/**
 * JSON unmarshaller for POJO ClusterStatus
 */
class ClusterStatusJsonUnmarshaller implements Unmarshaller<ClusterStatus, JsonUnmarshallerContext> {
    ...
    public ClusterStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("State")) {
                ...
                clusterStatus.setStateChangeReason(ClusterStateChangeReasonJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Timeline")) {
                clusterStatus.setTimeline(ClusterTimelineJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
