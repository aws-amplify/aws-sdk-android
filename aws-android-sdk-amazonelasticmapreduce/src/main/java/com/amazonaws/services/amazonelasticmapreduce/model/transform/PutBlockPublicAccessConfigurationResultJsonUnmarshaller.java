...
/**
 * JSON unmarshaller for response PutBlockPublicAccessConfigurationResult
 */
public class PutBlockPublicAccessConfigurationResultJsonUnmarshaller implements
        Unmarshaller<PutBlockPublicAccessConfigurationResult, JsonUnmarshallerContext> {
