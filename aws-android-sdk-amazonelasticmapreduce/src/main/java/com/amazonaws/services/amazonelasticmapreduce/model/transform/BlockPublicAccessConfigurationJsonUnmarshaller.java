...
/**
 * JSON unmarshaller for POJO BlockPublicAccessConfiguration
 */
class BlockPublicAccessConfigurationJsonUnmarshaller implements
        Unmarshaller<BlockPublicAccessConfiguration, JsonUnmarshallerContext> {
    ...
    public BlockPublicAccessConfiguration unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("BlockPublicSecurityGroupRules")) {
                blockPublicAccessConfiguration
                        .setBlockPublicSecurityGroupRules(BooleanJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("PermittedPublicSecurityGroupRuleRanges")) {
                blockPublicAccessConfiguration
                        .setPermittedPublicSecurityGroupRuleRanges(new ListUnmarshaller<PortRange>(
                                PortRangeJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
