...
/**
 * JSON unmarshaller for POJO AutoScalingPolicyStateChangeReason
 */
class AutoScalingPolicyStateChangeReasonJsonUnmarshaller implements
        Unmarshaller<AutoScalingPolicyStateChangeReason, JsonUnmarshallerContext> {
    ...
    public AutoScalingPolicyStateChangeReason unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Code")) {
                autoScalingPolicyStateChangeReason.setCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Message")) {
                autoScalingPolicyStateChangeReason.setMessage(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
