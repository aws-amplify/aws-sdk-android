...
public class DetectEntitiesV2Result implements Serializable {
    /**
     * <p>
     ...
     * and the level of confidence in the detection and analysis. Attributes and
    ...
    /**
     * <p>
     * If the result to the <code>DetectEntitiesV2</code> operation was
     ...
     *         text begins and ends, and the level of confidence in the
     *         detection and analysis. Attributes and traits of the entity are
     *         also returned.
     *         </p>
     */
     ...
     *            in the detection and analysis. Attributes and traits of the
     ...
     *            Attributes extracted from the input text that couldn't be
     ...
     *         chained together.
     */
    public DetectEntitiesV2Result withUnmappedAttributes(
     ...
     * @return <p>
     *         If the result to the <code>DetectEntitiesV2</code> operation was
     *         truncated, include the <code>PaginationToken</code> to fetch the
     ...
     *            If the result to the <code>DetectEntitiesV2</code> operation
     *            was truncated, include the <code>PaginationToken</code> to
