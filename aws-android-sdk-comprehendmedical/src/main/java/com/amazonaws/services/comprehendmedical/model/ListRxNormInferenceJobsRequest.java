 ...
 * </p>
 */
public class ListRxNormInferenceJobsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *         their names, status, or the date and time that they were
     ...
     *
     * @param filter <p>
     *            Filters the jobs that are returned. You can filter jobs based
     *            on their names, status, or the date and time that they were
     *            submitted. You can only set one filter at a time.
     *            </p>
     */
