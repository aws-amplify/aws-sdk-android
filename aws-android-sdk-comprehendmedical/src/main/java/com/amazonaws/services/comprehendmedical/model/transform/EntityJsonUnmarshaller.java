...
/**
 * JSON unmarshaller for POJO Entity
 */
class EntityJsonUnmarshaller implements Unmarshaller<Entity, JsonUnmarshallerContext> {
    ...
    public Entity unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Id")) {
                entity.setId(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                entity.setCategory(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                entity.setAttributes(new ListUnmarshaller<Attribute>(AttributeJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
