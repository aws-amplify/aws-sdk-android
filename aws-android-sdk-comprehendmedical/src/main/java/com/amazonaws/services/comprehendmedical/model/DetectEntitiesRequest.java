...
/**
 * <p>
 * The <code>DetectEntities</code> operation is deprecated. You should use the
 * <a>DetectEntitiesV2</a> operation instead.
 * </p>
 * <p>
...
public class DetectEntitiesRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         A UTF-8 text string containing the clinical content being
     *         examined for entities. Each string must contain fewer than 20,000
     *         bytes of characters.
     *         </p>
     */
     ...
     * @param text <p>
     *            A UTF-8 text string containing the clinical content being
     *            examined for entities. Each string must contain fewer than
