    ...
    public ResultSet unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("headers")) {
                resultSet.setHeaders(new ListUnmarshaller<ColumnMetadata>(
                        ColumnMetadataJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("rows")) {
                resultSet.setRows(new ListUnmarshaller<ResultRow>(ResultRowJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
