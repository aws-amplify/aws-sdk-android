...
/**
 * JSON unmarshaller for POJO DataItem
 */
class DataItemJsonUnmarshaller implements Unmarshaller<DataItem, JsonUnmarshallerContext> {
    ...
    public DataItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("overrideFormat")) {
                dataItem.setOverrideFormat(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("rawValue")) {
                dataItem.setRawValue(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("formattedValue")) {
                dataItem.setFormattedValue(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
