...
/**
 * Interface for accessing Amazon Honeycode
 * <p>
...
public interface AmazonHoneycode {
     ...
     * ("https://honeycode.us-east-1.amazonaws.com"). Callers can use this
     * method to control which AWS region they want to work with.
     * <p>
     * Callers can pass in just the endpoint (ex:
     * "honeycode.us-east-1.amazonaws.com") or a full URL, including the
     * protocol (ex: "https://honeycode.us-east-1.amazonaws.com"). If the
     ...
     *
     * @param endpoint The endpoint (ex: "honeycode.us-east-1.amazonaws.com") or
     *            a full URL, including the protocol (ex:
     *            "https://honeycode.us-east-1.amazonaws.com") of the region
    ...
    /**
     * An alternative to {@link AmazonHoneycode#setEndpoint(String)}, sets the
