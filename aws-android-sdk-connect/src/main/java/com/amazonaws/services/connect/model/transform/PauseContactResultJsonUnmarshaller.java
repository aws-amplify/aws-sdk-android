...
/**
 * JSON unmarshaller for response PauseContactResult
 */
public class PauseContactResultJsonUnmarshaller implements
        Unmarshaller<PauseContactResult, JsonUnmarshallerContext> {
