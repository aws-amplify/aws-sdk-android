...
/**
 * JSON unmarshaller for response UpdateContactFlowModuleMetadataResult
 */
public class UpdateContactFlowModuleMetadataResultJsonUnmarshaller implements
        Unmarshaller<UpdateContactFlowModuleMetadataResult, JsonUnmarshallerContext> {

    public UpdateContactFlowModuleMetadataResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
