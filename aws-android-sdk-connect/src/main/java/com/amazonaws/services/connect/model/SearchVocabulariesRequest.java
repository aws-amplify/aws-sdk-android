 ...
 * </p>
 */
public class SearchVocabulariesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
    ...
    public String toString() {
        ...
        if (getNameStartsWith() != null)
            sb.append("NameStartsWith: " + getNameStartsWith() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getNameStartsWith() == null) ? 0 : getNameStartsWith().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getNameStartsWith() == null ^ this.getNameStartsWith() == null)
            return false;
        if (other.getNameStartsWith() != null
                && other.getNameStartsWith().equals(this.getNameStartsWith()) == false)
            return false;
