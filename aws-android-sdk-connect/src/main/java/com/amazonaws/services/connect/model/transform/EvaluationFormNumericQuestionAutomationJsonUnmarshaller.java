...
/**
 * JSON unmarshaller for POJO EvaluationFormNumericQuestionAutomation
 */
class EvaluationFormNumericQuestionAutomationJsonUnmarshaller implements
        Unmarshaller<EvaluationFormNumericQuestionAutomation, JsonUnmarshallerContext> {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PropertyValue")) {
                evaluationFormNumericQuestionAutomation
                        .setPropertyValue(NumericQuestionPropertyValueAutomationJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
