...
/**
 * JSON unmarshaller for response CreatePromptResult
 */
public class CreatePromptResultJsonUnmarshaller implements
        Unmarshaller<CreatePromptResult, JsonUnmarshallerContext> {
    ...
    public CreatePromptResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PromptARN")) {
                createPromptResult.setPromptARN(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("PromptId")) {
                createPromptResult.setPromptId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
