...
/**
 * JSON unmarshaller for response CreateInstanceResult
 */
public class CreateInstanceResultJsonUnmarshaller implements
    ...
    public CreateInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Id")) {
                createInstanceResult.setId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Arn")) {
                createInstanceResult.setArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
