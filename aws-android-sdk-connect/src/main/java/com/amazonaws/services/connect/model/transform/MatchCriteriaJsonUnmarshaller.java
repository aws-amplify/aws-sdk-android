...
/**
 * JSON unmarshaller for POJO MatchCriteria
 */
class MatchCriteriaJsonUnmarshaller implements Unmarshaller<MatchCriteria, JsonUnmarshallerContext> {
    ...
    public MatchCriteria unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AgentsCriteria")) {
                matchCriteria.setAgentsCriteria(AgentsCriteriaJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
