...
/**
 * JSON unmarshaller for POJO UserDataFilters
 */
class UserDataFiltersJsonUnmarshaller implements
        Unmarshaller<UserDataFilters, JsonUnmarshallerContext> {
    ...
    public UserDataFilters unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Queues")) {
                userDataFilters.setQueues(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
