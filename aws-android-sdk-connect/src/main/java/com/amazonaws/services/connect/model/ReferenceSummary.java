...
public class ReferenceSummary implements Serializable {
    /**
     * <p>
     * Information about Url reference if the <code>referenceType</code> is
     ...
     *
     * @return <p>
     *         Information about Url reference if the <code>referenceType</code>
     *         is <code>URL</code>. Otherwise, null.
     *         </p>
     */
     ...
     *
     * @param url <p>
     *            Information about Url reference if the
