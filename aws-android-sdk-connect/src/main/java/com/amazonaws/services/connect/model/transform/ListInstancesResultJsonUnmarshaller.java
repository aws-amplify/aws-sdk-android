...
/**
 * JSON unmarshaller for response ListInstancesResult
 */
public class ListInstancesResultJsonUnmarshaller implements
    ...
    public ListInstancesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("InstanceSummaryList")) {
                listInstancesResult.setInstanceSummaryList(new ListUnmarshaller<InstanceSummary>(
                        InstanceSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                listInstancesResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
