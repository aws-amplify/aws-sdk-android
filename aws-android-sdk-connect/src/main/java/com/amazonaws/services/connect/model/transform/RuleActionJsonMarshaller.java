...
class RuleActionJsonMarshaller {
    ...
    public void marshall(RuleAction ruleAction, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (ruleAction.getSubmitAutoEvaluationAction() != null) {
            SubmitAutoEvaluationActionDefinition submitAutoEvaluationAction = ruleAction
                    .getSubmitAutoEvaluationAction();
            jsonWriter.name("SubmitAutoEvaluationAction");
            SubmitAutoEvaluationActionDefinitionJsonMarshaller.getInstance().marshall(
                    submitAutoEvaluationAction, jsonWriter);
        }
