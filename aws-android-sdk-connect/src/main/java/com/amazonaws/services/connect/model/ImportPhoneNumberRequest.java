 ...
 * release phone numbers using the UI or API during a rolling 180 day cycle that
 * exceeds 200% of your phone number service level quota, you will be blocked
 * from claiming or importing any more numbers until 180 days past the oldest
 ...
 * claim 99, and then release 99, you will have exceeded the 200% limit. At that
 * point you are blocked from claiming any more numbers until you open an Amazon
...
public class ImportPhoneNumberRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         service, such as Amazon Pinpoint. If it is from Amazon Pinpoint,
     *         it looks like the ARN of the phone number to import from Amazon
     *         Pinpoint.
     *         </p>
     */
     ...
     *            The claimed phone number ARN being imported from the external
     *            service, such as Amazon Pinpoint. If it is from Amazon
     *            Pinpoint, it looks like the ARN of the phone number to import
