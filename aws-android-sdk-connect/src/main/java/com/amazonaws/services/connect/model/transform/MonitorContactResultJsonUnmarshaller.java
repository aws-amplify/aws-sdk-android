...
/**
 * JSON unmarshaller for response MonitorContactResult
 */
public class MonitorContactResultJsonUnmarshaller implements
        Unmarshaller<MonitorContactResult, JsonUnmarshallerContext> {
    ...
    public MonitorContactResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ContactId")) {
                monitorContactResult.setContactId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ContactArn")) {
                monitorContactResult.setContactArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
