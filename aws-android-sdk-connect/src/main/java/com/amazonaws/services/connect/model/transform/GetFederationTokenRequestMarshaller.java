...
/**
 * JSON request marshaller for GetFederationTokenRequest
 */
public class GetFederationTokenRequestMarshaller implements
    ...
    public Request<GetFederationTokenRequest> marshall(
        ...
        Request<GetFederationTokenRequest> request = new DefaultRequest<GetFederationTokenRequest>(
                getFederationTokenRequest, "AmazonConnect");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/user/federate/{InstanceId}";
        uriResourcePath = uriResourcePath.replace(
                "{InstanceId}",
                (getFederationTokenRequest.getInstanceId() == null) ? "" : StringUtils
                        .fromString(getFederationTokenRequest.getInstanceId()));
