...
public class DescribeSecurityProfileRequestMarshaller implements
    ...
    public Request<DescribeSecurityProfileRequest> marshall(
        ...
        Request<DescribeSecurityProfileRequest> request = new DefaultRequest<DescribeSecurityProfileRequest>(
                describeSecurityProfileRequest, "AmazonConnect");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/security-profiles/{InstanceId}/{SecurityProfileId}";
        uriResourcePath = uriResourcePath.replace(
                "{SecurityProfileId}",
                (describeSecurityProfileRequest.getSecurityProfileId() == null) ? "" : StringUtils
                        .fromString(describeSecurityProfileRequest.getSecurityProfileId()));
        uriResourcePath = uriResourcePath.replace(
                "{InstanceId}",
                (describeSecurityProfileRequest.getInstanceId() == null) ? "" : StringUtils
                        .fromString(describeSecurityProfileRequest.getInstanceId()));
