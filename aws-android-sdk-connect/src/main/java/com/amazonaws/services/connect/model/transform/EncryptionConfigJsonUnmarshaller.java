...
/**
 * JSON unmarshaller for POJO EncryptionConfig
 */
class EncryptionConfigJsonUnmarshaller implements
        Unmarshaller<EncryptionConfig, JsonUnmarshallerContext> {
    ...
    public EncryptionConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("EncryptionType")) {
                encryptionConfig.setEncryptionType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("KeyId")) {
                encryptionConfig.setKeyId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
