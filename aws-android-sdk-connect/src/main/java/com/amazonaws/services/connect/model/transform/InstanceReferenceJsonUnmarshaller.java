...
/**
 * JSON unmarshaller for POJO InstanceReference
 */
class InstanceReferenceJsonUnmarshaller implements
        Unmarshaller<InstanceReference, JsonUnmarshallerContext> {
    ...
    public InstanceReference unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Id")) {
                instanceReference.setId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Arn")) {
                instanceReference.setArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
