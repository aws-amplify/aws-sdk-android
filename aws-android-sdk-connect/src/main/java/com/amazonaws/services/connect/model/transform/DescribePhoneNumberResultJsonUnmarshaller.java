...
/**
 * JSON unmarshaller for response DescribePhoneNumberResult
 */
public class DescribePhoneNumberResultJsonUnmarshaller implements
        Unmarshaller<DescribePhoneNumberResult, JsonUnmarshallerContext> {
    ...
    public DescribePhoneNumberResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ClaimedPhoneNumberSummary")) {
                describePhoneNumberResult
                        .setClaimedPhoneNumberSummary(ClaimedPhoneNumberSummaryJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
