...
/**
 * JSON unmarshaller for response StopContactStreamingResult
 */
public class StopContactStreamingResultJsonUnmarshaller implements
        Unmarshaller<StopContactStreamingResult, JsonUnmarshallerContext> {
