...
/**
 * JSON unmarshaller for POJO ContactFlowModuleSearchCriteria
 */
class ContactFlowModuleSearchCriteriaJsonUnmarshaller implements
        Unmarshaller<ContactFlowModuleSearchCriteria, JsonUnmarshallerContext> {

    public ContactFlowModuleSearchCriteria unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("OrConditions")) {
                contactFlowModuleSearchCriteria
                        .setOrConditions(new ListUnmarshaller<ContactFlowModuleSearchCriteria>(
                                ContactFlowModuleSearchCriteriaJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("AndConditions")) {
                contactFlowModuleSearchCriteria
                        .setAndConditions(new ListUnmarshaller<ContactFlowModuleSearchCriteria>(
                                ContactFlowModuleSearchCriteriaJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("StringCondition")) {
                contactFlowModuleSearchCriteria.setStringCondition(StringConditionJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
