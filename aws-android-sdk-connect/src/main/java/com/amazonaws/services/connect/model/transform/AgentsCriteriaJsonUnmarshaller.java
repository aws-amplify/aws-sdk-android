...
/**
 * JSON unmarshaller for POJO AgentsCriteria
 */
class AgentsCriteriaJsonUnmarshaller implements
        Unmarshaller<AgentsCriteria, JsonUnmarshallerContext> {
    ...
    public AgentsCriteria unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AgentIds")) {
                agentsCriteria.setAgentIds(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
