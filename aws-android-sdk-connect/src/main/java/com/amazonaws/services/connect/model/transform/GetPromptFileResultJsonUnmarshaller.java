...
/**
 * JSON unmarshaller for response GetPromptFileResult
 */
public class GetPromptFileResultJsonUnmarshaller implements
        Unmarshaller<GetPromptFileResult, JsonUnmarshallerContext> {
