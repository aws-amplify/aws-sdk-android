 ...
 * </p>
 */
public class BatchDisassociateAnalyticsDataSetRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public BatchDisassociateAnalyticsDataSetRequest withDataSetIds(
     ...
     *
     * @return <p>
     *         The identifier of the target account. Use to disassociate a
     *         dataset from a different account than the one containing the
     *         Amazon Connect instance. If not specified, by default this value
     *         is the Amazon Web Services account that has the Amazon Connect
     *         instance.
     *         </p>
     */
