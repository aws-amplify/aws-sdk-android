...
/**
 * JSON unmarshaller for POJO HoursOfOperationTimeSlice
 */
class HoursOfOperationTimeSliceJsonUnmarshaller implements
        Unmarshaller<HoursOfOperationTimeSlice, JsonUnmarshallerContext> {
    ...
    public HoursOfOperationTimeSlice unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Hours")) {
                hoursOfOperationTimeSlice.setHours(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Minutes")) {
                hoursOfOperationTimeSlice.setMinutes(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
