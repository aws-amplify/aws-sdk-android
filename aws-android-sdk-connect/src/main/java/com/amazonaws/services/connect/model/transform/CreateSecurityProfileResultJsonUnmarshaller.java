...
/**
 * JSON unmarshaller for response CreateSecurityProfileResult
 */
public class CreateSecurityProfileResultJsonUnmarshaller implements
        Unmarshaller<CreateSecurityProfileResult, JsonUnmarshallerContext> {
    ...
    public CreateSecurityProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SecurityProfileId")) {
                createSecurityProfileResult.setSecurityProfileId(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
