...
public class ListBotsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * @see LexVersion
     */
    public void setLexVersion(LexVersion lexVersion) {
    ...
    public String toString() {
        ...
        if (getLexVersion() != null)
            sb.append("LexVersion: " + getLexVersion());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getLexVersion() == null ^ this.getLexVersion() == null)
            return false;
        if (other.getLexVersion() != null
                && other.getLexVersion().equals(this.getLexVersion()) == false)
            return false;
        return true;
    }
}
