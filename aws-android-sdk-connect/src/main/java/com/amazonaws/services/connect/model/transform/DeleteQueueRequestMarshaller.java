...
public class DeleteQueueRequestMarshaller implements
    ...
    public Request<DeleteQueueRequest> marshall(DeleteQueueRequest deleteQueueRequest) {
        ...
        Request<DeleteQueueRequest> request = new DefaultRequest<DeleteQueueRequest>(
                deleteQueueRequest, "AmazonConnect");
        request.setHttpMethod(HttpMethodName.DELETE);

        String uriResourcePath = "/queues/{InstanceId}/{QueueId}";
        uriResourcePath = uriResourcePath.replace(
                "{InstanceId}",
                (deleteQueueRequest.getInstanceId() == null) ? "" : StringUtils
                        .fromString(deleteQueueRequest.getInstanceId()));
        uriResourcePath = uriResourcePath.replace(
                "{QueueId}",
                (deleteQueueRequest.getQueueId() == null) ? "" : StringUtils
                        .fromString(deleteQueueRequest.getQueueId()));
