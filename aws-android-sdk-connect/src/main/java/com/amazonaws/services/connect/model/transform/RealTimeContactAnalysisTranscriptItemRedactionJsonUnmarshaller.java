...
/**
 * JSON unmarshaller for POJO RealTimeContactAnalysisTranscriptItemRedaction
 */
class RealTimeContactAnalysisTranscriptItemRedactionJsonUnmarshaller implements
    ...
    public RealTimeContactAnalysisTranscriptItemRedaction unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("CharacterOffsets")) {
                realTimeContactAnalysisTranscriptItemRedaction
                        .setCharacterOffsets(new ListUnmarshaller<RealTimeContactAnalysisCharacterInterval>(
                                RealTimeContactAnalysisCharacterIntervalJsonUnmarshaller
                                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
