...
/**
 * JSON unmarshaller for response StartOutboundVoiceContactResult
 */
public class StartOutboundVoiceContactResultJsonUnmarshaller implements
        Unmarshaller<StartOutboundVoiceContactResult, JsonUnmarshallerContext> {

    public StartOutboundVoiceContactResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ContactId")) {
                startOutboundVoiceContactResult.setContactId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
