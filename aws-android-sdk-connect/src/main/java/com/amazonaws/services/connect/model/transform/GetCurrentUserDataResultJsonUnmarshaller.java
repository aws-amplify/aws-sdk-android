...
/**
 * JSON unmarshaller for response GetCurrentUserDataResult
 */
public class GetCurrentUserDataResultJsonUnmarshaller implements
        Unmarshaller<GetCurrentUserDataResult, JsonUnmarshallerContext> {
    ...
    public GetCurrentUserDataResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NextToken")) {
                getCurrentUserDataResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("UserDataList")) {
                getCurrentUserDataResult.setUserDataList(new ListUnmarshaller<UserData>(
