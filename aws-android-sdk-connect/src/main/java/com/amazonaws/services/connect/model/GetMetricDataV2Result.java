...
public class GetMetricDataV2Result implements Serializable {
    /**
     * <p>
     ...
     *            Information about the metrics requested in the API request If
     *            no grouping is specified, a summary of metric data is
     *            returned.
     *            </p>
     */
    ...
    public GetMetricDataV2Result withMetricResults(MetricResultV2... metricResults) {
        if (getMetricResults() == null) {
            this.metricResults = new java.util.ArrayList<MetricResultV2>(metricResults.length);
        }
        for (MetricResultV2 value : metricResults) {
     ...
     *         chained together.
     */
    public GetMetricDataV2Result withMetricResults(
            java.util.Collection<MetricResultV2> metricResults) {
