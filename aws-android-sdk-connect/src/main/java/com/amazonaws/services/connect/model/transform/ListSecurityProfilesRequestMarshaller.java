...
public class ListSecurityProfilesRequestMarshaller implements
    ...
    public Request<ListSecurityProfilesRequest> marshall(
        ...
        Request<ListSecurityProfilesRequest> request = new DefaultRequest<ListSecurityProfilesRequest>(
                listSecurityProfilesRequest, "AmazonConnect");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/security-profiles-summary/{InstanceId}";
        uriResourcePath = uriResourcePath.replace(
                "{InstanceId}",
                (listSecurityProfilesRequest.getInstanceId() == null) ? "" : StringUtils
                        .fromString(listSecurityProfilesRequest.getInstanceId()));
