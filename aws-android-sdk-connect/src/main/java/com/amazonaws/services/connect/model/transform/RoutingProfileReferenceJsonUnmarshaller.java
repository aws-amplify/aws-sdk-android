...
/**
 * JSON unmarshaller for POJO RoutingProfileReference
 */
class RoutingProfileReferenceJsonUnmarshaller implements
        Unmarshaller<RoutingProfileReference, JsonUnmarshallerContext> {
    ...
    public RoutingProfileReference unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Id")) {
                routingProfileReference.setId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Arn")) {
                routingProfileReference.setArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
