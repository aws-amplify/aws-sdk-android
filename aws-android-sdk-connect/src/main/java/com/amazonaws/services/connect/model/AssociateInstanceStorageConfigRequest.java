...
public class AssociateInstanceStorageConfigRequest extends AmazonWebServiceRequest implements
     ...
     * >enable streaming for real-time analysis of contacts</a>, use the
     * following types:
     * </p>
     * <ul>
     * <li>
     ...
     *         <note>
     *         <p>
     *         <code>REAL_TIME_CONTACT_ANALYSIS_SEGMENTS</code> is deprecated,
     *         but it is still supported and will apply only to VOICE channel
     *         contacts. Use
     *         <code>REAL_TIME_CONTACT_ANALYSIS_VOICE_SEGMENTS</code> for voice
     *         contacts moving forward.
     *         </p>
     *         <p>
     *         If you have previously associated a stream with
     *         <code>REAL_TIME_CONTACT_ANALYSIS_SEGMENTS</code>, no action is
     ...
     *            A valid resource type. To <a href=
     *            "https://docs.aws.amazon.com/connect/latest/adminguide/enable-contact-analysis-segment-streams.html"
     *            >enable streaming for real-time analysis of contacts</a>, use
     *            the following types:
     *            </p>
     *            <ul>
     *            <li>
     ...
     *            <note>
     *            <p>
     *            <code>REAL_TIME_CONTACT_ANALYSIS_SEGMENTS</code> is
     *            deprecated, but it is still supported and will apply only to
     *            VOICE channel contacts. Use
     *            <code>REAL_TIME_CONTACT_ANALYSIS_VOICE_SEGMENTS</code> for
