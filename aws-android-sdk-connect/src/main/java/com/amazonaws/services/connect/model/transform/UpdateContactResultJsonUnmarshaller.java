...
/**
 * JSON unmarshaller for response UpdateContactResult
 */
public class UpdateContactResultJsonUnmarshaller implements
        Unmarshaller<UpdateContactResult, JsonUnmarshallerContext> {
