 ...
 * >PutDialRequestBatch</a> API. It then uses BatchPutContact to create contacts
 * corresponding to those dial requests. If agents are available, the dial
 * requests are dialed out, which results in a voice call. The resulting voice
 * call uses the same contactId that was created by BatchPutContact.
 * </p>
 */
public class BatchPutContactRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * </p>
     *
     * @param contactDataRequestList <p>
     *            List of individual contact requests.
     *            </p>
     */
    public void setContactDataRequestList(
            java.util.Collection<ContactDataRequest> contactDataRequestList) {
        if (contactDataRequestList == null) {
            this.contactDataRequestList = null;
            return;
        }

        this.contactDataRequestList = new java.util.ArrayList<ContactDataRequest>(
     ...
     *         chained together.
     */
    public BatchPutContactRequest withContactDataRequestList(
            ContactDataRequest... contactDataRequestList) {
        if (getContactDataRequestList() == null) {
            this.contactDataRequestList = new java.util.ArrayList<ContactDataRequest>(
                    contactDataRequestList.length);
        }
        for (ContactDataRequest value : contactDataRequestList) {
            this.contactDataRequestList.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        if (getContactDataRequestList() != null)
            sb.append("ContactDataRequestList: " + getContactDataRequestList());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getContactDataRequestList() == null) ? 0 : getContactDataRequestList()
                        .hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getContactDataRequestList() == null ^ this.getContactDataRequestList() == null)
            return false;
        if (other.getContactDataRequestList() != null
                && other.getContactDataRequestList().equals(this.getContactDataRequestList()) == false)
            return false;
        return true;
    }
}
