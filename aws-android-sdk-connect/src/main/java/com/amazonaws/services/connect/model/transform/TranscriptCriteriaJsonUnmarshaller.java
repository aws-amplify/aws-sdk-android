...
/**
 * JSON unmarshaller for POJO TranscriptCriteria
 */
class TranscriptCriteriaJsonUnmarshaller implements
        Unmarshaller<TranscriptCriteria, JsonUnmarshallerContext> {
    ...
    public TranscriptCriteria unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ParticipantRole")) {
                ...
                transcriptCriteria.setSearchText(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("MatchType")) {
                transcriptCriteria.setMatchType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
