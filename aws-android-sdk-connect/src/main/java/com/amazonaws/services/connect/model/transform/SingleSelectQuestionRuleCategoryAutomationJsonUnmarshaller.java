...
/**
 * JSON unmarshaller for POJO SingleSelectQuestionRuleCategoryAutomation
 */
class SingleSelectQuestionRuleCategoryAutomationJsonUnmarshaller implements
    ...
    public SingleSelectQuestionRuleCategoryAutomation unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Category")) {
                singleSelectQuestionRuleCategoryAutomation.setCategory(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Condition")) {
                singleSelectQuestionRuleCategoryAutomation.setCondition(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("OptionRefId")) {
                singleSelectQuestionRuleCategoryAutomation.setOptionRefId(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
