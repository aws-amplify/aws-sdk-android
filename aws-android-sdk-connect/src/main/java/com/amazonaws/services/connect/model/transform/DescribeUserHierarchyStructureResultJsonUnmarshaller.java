...
/**
 * JSON unmarshaller for response DescribeUserHierarchyStructureResult
 */
public class DescribeUserHierarchyStructureResultJsonUnmarshaller implements
        Unmarshaller<DescribeUserHierarchyStructureResult, JsonUnmarshallerContext> {

    public DescribeUserHierarchyStructureResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("HierarchyStructure")) {
                describeUserHierarchyStructureResult
                        .setHierarchyStructure(HierarchyStructureJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
            }
