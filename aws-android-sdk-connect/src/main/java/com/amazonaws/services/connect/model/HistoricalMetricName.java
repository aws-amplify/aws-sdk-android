...
public enum HistoricalMetricName {
    ...
    static {
        ...
        enumMap.put("CONTACTS_TRANSFERRED_IN_BY_AGENT", CONTACTS_TRANSFERRED_IN_BY_AGENT);
        enumMap.put("CONTACTS_TRANSFERRED_OUT_BY_AGENT", CONTACTS_TRANSFERRED_OUT_BY_AGENT);
