...
/**
 * JSON unmarshaller for POJO HistoricalMetricData
 */
class HistoricalMetricDataJsonUnmarshaller implements
        Unmarshaller<HistoricalMetricData, JsonUnmarshallerContext> {
    ...
    public HistoricalMetricData unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Metric")) {
                historicalMetricData.setMetric(HistoricalMetricJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Value")) {
                historicalMetricData.setValue(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
