...
public class DeleteUserRequestMarshaller implements
    ...
    public Request<DeleteUserRequest> marshall(DeleteUserRequest deleteUserRequest) {
        ...
        Request<DeleteUserRequest> request = new DefaultRequest<DeleteUserRequest>(
                deleteUserRequest, "AmazonConnect");
        request.setHttpMethod(HttpMethodName.DELETE);

        String uriResourcePath = "/users/{InstanceId}/{UserId}";
        uriResourcePath = uriResourcePath.replace(
                "{InstanceId}",
                (deleteUserRequest.getInstanceId() == null) ? "" : StringUtils
                        .fromString(deleteUserRequest.getInstanceId()));
        uriResourcePath = uriResourcePath.replace(
                "{UserId}",
                (deleteUserRequest.getUserId() == null) ? "" : StringUtils
                        .fromString(deleteUserRequest.getUserId()));
