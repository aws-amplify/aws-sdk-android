...
/**
 * JSON unmarshaller for response StopContactRecordingResult
 */
public class StopContactRecordingResultJsonUnmarshaller implements
        Unmarshaller<StopContactRecordingResult, JsonUnmarshallerContext> {
