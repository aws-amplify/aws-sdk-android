...
public class RoutingProfile implements Serializable {
    ...
    public RoutingProfile withAssociatedQueueIds(String... associatedQueueIds) {
        if (getAssociatedQueueIds() == null) {
            this.associatedQueueIds = new java.util.ArrayList<String>(associatedQueueIds.length);
        }
        for (String value : associatedQueueIds) {
            this.associatedQueueIds.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        if (getAssociatedQueueIds() != null)
            sb.append("AssociatedQueueIds: " + getAssociatedQueueIds());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getAssociatedQueueIds() == null) ? 0 : getAssociatedQueueIds().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAssociatedQueueIds() == null ^ this.getAssociatedQueueIds() == null)
            return false;
        if (other.getAssociatedQueueIds() != null
                && other.getAssociatedQueueIds().equals(this.getAssociatedQueueIds()) == false)
            return false;
        return true;
    }
}
