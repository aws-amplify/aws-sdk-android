...
class ContactFlowSummaryJsonMarshaller {
    ...
    public void marshall(ContactFlowSummary contactFlowSummary, AwsJsonWriter jsonWriter)
        ...
        if (contactFlowSummary.getContactFlowStatus() != null) {
            String contactFlowStatus = contactFlowSummary.getContactFlowStatus();
            jsonWriter.name("ContactFlowStatus");
            jsonWriter.value(contactFlowStatus);
        }
