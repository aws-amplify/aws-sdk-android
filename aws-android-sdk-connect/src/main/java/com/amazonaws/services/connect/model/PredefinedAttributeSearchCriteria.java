...
public class PredefinedAttributeSearchCriteria implements Serializable {
     ...
     *         chained together.
     */
    public PredefinedAttributeSearchCriteria withOrConditions(
            PredefinedAttributeSearchCriteria... orConditions) {
        if (getOrConditions() == null) {
            this.orConditions = new java.util.ArrayList<PredefinedAttributeSearchCriteria>(
                    orConditions.length);
        }
        for (PredefinedAttributeSearchCriteria value : orConditions) {
     ...
     */
    public PredefinedAttributeSearchCriteria withOrConditions(
            java.util.Collection<PredefinedAttributeSearchCriteria> orConditions) {
     ...
     *            </p>
     */
    public void setAndConditions(
            java.util.Collection<PredefinedAttributeSearchCriteria> andConditions) {
        if (andConditions == null) {
            this.andConditions = null;
            return;
        }

        this.andConditions = new java.util.ArrayList<PredefinedAttributeSearchCriteria>(
                andConditions);
    }
     ...
     *         chained together.
     */
    public PredefinedAttributeSearchCriteria withAndConditions(
            PredefinedAttributeSearchCriteria... andConditions) {
        if (getAndConditions() == null) {
            this.andConditions = new java.util.ArrayList<PredefinedAttributeSearchCriteria>(
                    andConditions.length);
        }
        for (PredefinedAttributeSearchCriteria value : andConditions) {
