...
/**
 * JSON unmarshaller for response AssociateSecurityKeyResult
 */
public class AssociateSecurityKeyResultJsonUnmarshaller implements
        Unmarshaller<AssociateSecurityKeyResult, JsonUnmarshallerContext> {
    ...
    public AssociateSecurityKeyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AssociationId")) {
                associateSecurityKeyResult.setAssociationId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
