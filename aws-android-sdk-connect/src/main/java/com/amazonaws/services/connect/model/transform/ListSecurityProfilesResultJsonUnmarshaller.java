...
/**
 * JSON unmarshaller for response ListSecurityProfilesResult
 */
public class ListSecurityProfilesResultJsonUnmarshaller implements
        Unmarshaller<ListSecurityProfilesResult, JsonUnmarshallerContext> {
    ...
    public ListSecurityProfilesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SecurityProfileSummaryList")) {
                listSecurityProfilesResult
                        .setSecurityProfileSummaryList(new ListUnmarshaller<SecurityProfileSummary>(
