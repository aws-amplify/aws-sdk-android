...
public class ListInstancesResult implements Serializable {
    ...
    public ListInstancesResult withInstanceSummaryList(InstanceSummary... instanceSummaryList) {
        if (getInstanceSummaryList() == null) {
            this.instanceSummaryList = new java.util.ArrayList<InstanceSummary>(
                    instanceSummaryList.length);
        }
        for (InstanceSummary value : instanceSummaryList) {
            this.instanceSummaryList.add(value);
        }
        return this;
    }
     ...
     *         chained together.
     */
    public ListInstancesResult withInstanceSummaryList(
            java.util.Collection<InstanceSummary> instanceSummaryList) {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getInstanceSummaryList() != null)
            sb.append("InstanceSummaryList: " + getInstanceSummaryList() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getInstanceSummaryList() == null) ? 0 : getInstanceSummaryList().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getInstanceSummaryList() == null ^ this.getInstanceSummaryList() == null)
            return false;
        if (other.getInstanceSummaryList() != null
                && other.getInstanceSummaryList().equals(this.getInstanceSummaryList()) == false)
            return false;
