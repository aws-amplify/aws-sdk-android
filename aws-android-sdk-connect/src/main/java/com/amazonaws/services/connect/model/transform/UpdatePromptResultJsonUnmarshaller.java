...
/**
 * JSON unmarshaller for response UpdatePromptResult
 */
public class UpdatePromptResultJsonUnmarshaller implements
        Unmarshaller<UpdatePromptResult, JsonUnmarshallerContext> {
    ...
    public UpdatePromptResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PromptARN")) {
                updatePromptResult.setPromptARN(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("PromptId")) {
                updatePromptResult.setPromptId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
