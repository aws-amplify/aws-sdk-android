...
/**
 * JSON unmarshaller for response StartChatContactResult
 */
public class StartChatContactResultJsonUnmarshaller implements
        Unmarshaller<StartChatContactResult, JsonUnmarshallerContext> {
    ...
    public StartChatContactResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ContactId")) {
                startChatContactResult.setContactId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ParticipantId")) {
                startChatContactResult.setParticipantId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
