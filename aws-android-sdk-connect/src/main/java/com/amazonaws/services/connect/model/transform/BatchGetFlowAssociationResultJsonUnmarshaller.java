...
/**
 * JSON unmarshaller for response BatchGetFlowAssociationResult
 */
public class BatchGetFlowAssociationResultJsonUnmarshaller implements
        Unmarshaller<BatchGetFlowAssociationResult, JsonUnmarshallerContext> {

    public BatchGetFlowAssociationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("FlowAssociationSummaryList")) {
                batchGetFlowAssociationResult
                        .setFlowAssociationSummaryList(new ListUnmarshaller<FlowAssociationSummary>(
