 ...
 * </p>
 */
public class ListAgentStatusesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
    ...
    public ListAgentStatusesRequest withAgentStatusTypes(String... agentStatusTypes) {
        if (getAgentStatusTypes() == null) {
            this.agentStatusTypes = new java.util.ArrayList<String>(agentStatusTypes.length);
        }
        for (String value : agentStatusTypes) {
            this.agentStatusTypes.add(value);
        }
        return this;
    }
     ...
     *         chained together.
     */
    public ListAgentStatusesRequest withAgentStatusTypes(
            java.util.Collection<String> agentStatusTypes) {
    ...
    public String toString() {
        ...
        if (getAgentStatusTypes() != null)
            sb.append("AgentStatusTypes: " + getAgentStatusTypes());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getAgentStatusTypes() == null) ? 0 : getAgentStatusTypes().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAgentStatusTypes() == null ^ this.getAgentStatusTypes() == null)
            return false;
        if (other.getAgentStatusTypes() != null
                && other.getAgentStatusTypes().equals(this.getAgentStatusTypes()) == false)
            return false;
        return true;
    }
}
