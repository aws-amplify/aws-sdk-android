...
/**
 * JSON unmarshaller for response CreateTaskTemplateResult
 */
public class CreateTaskTemplateResultJsonUnmarshaller implements
        Unmarshaller<CreateTaskTemplateResult, JsonUnmarshallerContext> {
    ...
    public CreateTaskTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Id")) {
                createTaskTemplateResult.setId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Arn")) {
                createTaskTemplateResult.setArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
