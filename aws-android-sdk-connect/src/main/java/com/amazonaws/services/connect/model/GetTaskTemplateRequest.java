 ...
 * </p>
 */
public class GetTaskTemplateRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         The system generated version of a task template that is
     *         associated with a task, when the task is created.
     *         </p>
     */
    ...
    public String toString() {
        ...
        if (getSnapshotVersion() != null)
            sb.append("SnapshotVersion: " + getSnapshotVersion());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getSnapshotVersion() == null) ? 0 : getSnapshotVersion().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSnapshotVersion() == null ^ this.getSnapshotVersion() == null)
            return false;
        if (other.getSnapshotVersion() != null
                && other.getSnapshotVersion().equals(this.getSnapshotVersion()) == false)
            return false;
        return true;
    }
}
