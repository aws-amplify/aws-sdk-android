    ...
    public Transcript unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Criteria")) {
                transcript.setCriteria(new ListUnmarshaller<TranscriptCriteria>(
                        TranscriptCriteriaJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("MatchType")) {
                transcript.setMatchType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
