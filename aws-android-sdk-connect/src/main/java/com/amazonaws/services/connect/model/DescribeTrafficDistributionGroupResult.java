...
public class DescribeTrafficDistributionGroupResult implements Serializable {
    /**
     * <p>
     ...
     * </p>
     *
     * @param trafficDistributionGroup <p>
     *            Information about the traffic distribution group.
     *            </p>
     */
     ...
     *         chained together.
     */
    public DescribeTrafficDistributionGroupResult withTrafficDistributionGroup(
    ...
    public String toString() {
        ...
        if (getTrafficDistributionGroup() != null)
            sb.append("TrafficDistributionGroup: " + getTrafficDistributionGroup());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getTrafficDistributionGroup() == null) ? 0 : getTrafficDistributionGroup()
                        .hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTrafficDistributionGroup() == null
                ^ this.getTrafficDistributionGroup() == null)
            return false;
        if (other.getTrafficDistributionGroup() != null
                && other.getTrafficDistributionGroup().equals(this.getTrafficDistributionGroup()) == false)
            return false;
        return true;
    }
}
