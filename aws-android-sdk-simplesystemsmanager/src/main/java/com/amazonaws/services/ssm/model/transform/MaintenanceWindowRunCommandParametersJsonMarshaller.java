...
class MaintenanceWindowRunCommandParametersJsonMarshaller {
    ...
    public void marshall(
        ...
        if (maintenanceWindowRunCommandParameters.getCloudWatchOutputConfig() != null) {
            CloudWatchOutputConfig cloudWatchOutputConfig = maintenanceWindowRunCommandParameters
        ...
        if (maintenanceWindowRunCommandParameters.getNotificationConfig() != null) {
            NotificationConfig notificationConfig = maintenanceWindowRunCommandParameters
        ...
        if (maintenanceWindowRunCommandParameters.getOutputS3BucketName() != null) {
            String outputS3BucketName = maintenanceWindowRunCommandParameters
        ...
        if (maintenanceWindowRunCommandParameters.getParameters() != null) {
            java.util.Map<String, java.util.List<String>> parameters = maintenanceWindowRunCommandParameters
                    .getParameters();
    ...
    public static MaintenanceWindowRunCommandParametersJsonMarshaller getInstance() {
        if (instance == null)
            instance = new MaintenanceWindowRunCommandParametersJsonMarshaller();
        return instance;
    }
}
