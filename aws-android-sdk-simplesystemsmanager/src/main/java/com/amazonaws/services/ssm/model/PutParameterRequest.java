...
public class PutParameterRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         The data type for a String parameter. Supported data types
     ...
     *         parameter value you provide against that data type. The required
     *         format is <code>ami-12345abcdeEXAMPLE</code>. For more
     *         information, see <a href=
     *         "http://docs.aws.amazon.com/systems-manager/latest/userguide/parameter-store-ec2-aliases.html"
     ...
     *            When you create a String parameter and specify
     *            <code>aws:ec2:image</code>, Systems Manager validates the
     *            parameter value you provide against that data type. The
     *            required format is <code>ami-12345abcdeEXAMPLE</code>. For
     *            more information, see <a href=
     *            "http://docs.aws.amazon.com/systems-manager/latest/userguide/parameter-store-ec2-aliases.html"
