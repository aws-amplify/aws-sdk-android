 ...
 */
public class GetInventoryRequestMarshaller implements
        Marshaller<Request<GetInventoryRequest>, GetInventoryRequest> {

    public Request<GetInventoryRequest> marshall(GetInventoryRequest getInventoryRequest) {
        if (getInventoryRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetInventoryRequest)");
        }

        Request<GetInventoryRequest> request = new DefaultRequest<GetInventoryRequest>(
                getInventoryRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (getInventoryRequest.getAggregators() != null) {
                java.util.List<InventoryAggregator> aggregators = getInventoryRequest
                        .getAggregators();
            ...
            if (getInventoryRequest.getResultAttributes() != null) {
                java.util.List<ResultAttribute> resultAttributes = getInventoryRequest
                        .getResultAttributes();
                jsonWriter.name("ResultAttributes");
                jsonWriter.beginArray();
                for (ResultAttribute resultAttributesItem : resultAttributes) {
                    if (resultAttributesItem != null) {
                        ResultAttributeJsonMarshaller.getInstance().marshall(resultAttributesItem,
                                jsonWriter);
                    }
                }
                jsonWriter.endArray();
