 ...
 */
public class CreateOpsItemRequestMarshaller implements
        Marshaller<Request<CreateOpsItemRequest>, CreateOpsItemRequest> {

    public Request<CreateOpsItemRequest> marshall(CreateOpsItemRequest createOpsItemRequest) {
        if (createOpsItemRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateOpsItemRequest)");
        }

        Request<CreateOpsItemRequest> request = new DefaultRequest<CreateOpsItemRequest>(
                createOpsItemRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (createOpsItemRequest.getOperationalData() != null) {
                java.util.Map<String, OpsItemDataValue> operationalData = createOpsItemRequest
                        .getOperationalData();
            ...
            if (createOpsItemRequest.getNotifications() != null) {
                java.util.List<OpsItemNotification> notifications = createOpsItemRequest
                        .getNotifications();
            ...
            if (createOpsItemRequest.getRelatedOpsItems() != null) {
                java.util.List<RelatedOpsItem> relatedOpsItems = createOpsItemRequest
                        .getRelatedOpsItems();
