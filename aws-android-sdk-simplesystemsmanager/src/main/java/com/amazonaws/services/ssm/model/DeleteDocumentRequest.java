...
public class DeleteDocumentRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * flag before you can delete the document. For example, you must specify a
     * <code>Force</code> flag to delete a document of type
     * <code>ApplicationConfigurationSchema</code>. You can restrict access to
     * the <code>Force</code> flag in an AWS Identity and Access Management
     * (IAM) policy.
     * </p>
     */
     ...
     *
     * @param versionName <p>
     *            The version name of the document that you want to delete. If
     ...
     *         <code>Force</code> flag before you can delete the document. For
     *         example, you must specify a <code>Force</code> flag to delete a
     *         document of type <code>ApplicationConfigurationSchema</code>. You
     *         can restrict access to the <code>Force</code> flag in an AWS
     ...
     * @param force <p>
     *            Some SSM document types require that you specify a
     *            <code>Force</code> flag before you can delete the document.
     *            For example, you must specify a <code>Force</code> flag to
     *            delete a document of type
     *            <code>ApplicationConfigurationSchema</code>. You can restrict
     *            access to the <code>Force</code> flag in an AWS Identity and
