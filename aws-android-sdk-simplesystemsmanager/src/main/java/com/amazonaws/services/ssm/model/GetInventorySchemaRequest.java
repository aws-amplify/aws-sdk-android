...
public class GetInventorySchemaRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * call returns the <code>AWS:InstanceInformation</code> type, because it
     * supports aggregation based on the <code>PlatformName</code>,
     ...
     *         this call returns the <code>AWS:InstanceInformation</code> type,
     *         because it supports aggregation based on the
     *         <code>PlatformName</code>, <code>PlatformType</code>, and
     *         <code>PlatformVersion</code> attributes.
     *         </p>
     */
     ...
     *
     * @param aggregator <p>
     *            Returns inventory schemas that support aggregation. For
     *            example, this call returns the
     *            <code>AWS:InstanceInformation</code> type, because it supports
    ...
    public String toString() {
        ...
        if (getAggregator() != null)
            sb.append("Aggregator: " + getAggregator() + ",");
        if (getSubType() != null)
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAggregator() != null
                && other.getAggregator().equals(this.getAggregator()) == false)
            return false;
