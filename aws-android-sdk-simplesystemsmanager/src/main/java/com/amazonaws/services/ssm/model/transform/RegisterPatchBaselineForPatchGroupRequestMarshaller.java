...
public class RegisterPatchBaselineForPatchGroupRequestMarshaller
    ...
    public Request<RegisterPatchBaselineForPatchGroupRequest> marshall(
        ...
        if (registerPatchBaselineForPatchGroupRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RegisterPatchBaselineForPatchGroupRequest)");
        }

        Request<RegisterPatchBaselineForPatchGroupRequest> request = new DefaultRequest<RegisterPatchBaselineForPatchGroupRequest>(
                registerPatchBaselineForPatchGroupRequest, "AmazonSimpleSystemsManager(SSM)");
