 ...
 */
public class GetPatchBaselineResultJsonUnmarshaller implements
        Unmarshaller<GetPatchBaselineResult, JsonUnmarshallerContext> {
    ...
    public GetPatchBaselineResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("BaselineId")) {
                ...
                getPatchBaselineResult.setGlobalFilters(PatchFilterGroupJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("ApprovalRules")) {
                getPatchBaselineResult.setApprovalRules(PatchRuleGroupJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("ApprovedPatches")) {
                getPatchBaselineResult.setApprovedPatches(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("ApprovedPatchesComplianceLevel")) {
                getPatchBaselineResult.setApprovedPatchesComplianceLevel(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("ApprovedPatchesEnableNonSecurity")) {
                getPatchBaselineResult.setApprovedPatchesEnableNonSecurity(BooleanJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("RejectedPatches")) {
                getPatchBaselineResult.setRejectedPatches(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("RejectedPatchesAction")) {
                getPatchBaselineResult.setRejectedPatchesAction(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("PatchGroups")) {
                getPatchBaselineResult.setPatchGroups(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
                ...
                getPatchBaselineResult.setSources(new ListUnmarshaller<PatchSource>(
