    ...
    public Request<DescribeMaintenanceWindowExecutionTasksRequest> marshall(
        ...
        if (describeMaintenanceWindowExecutionTasksRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeMaintenanceWindowExecutionTasksRequest)");
        }
        ...
        Request<DescribeMaintenanceWindowExecutionTasksRequest> request = new DefaultRequest<DescribeMaintenanceWindowExecutionTasksRequest>(
                describeMaintenanceWindowExecutionTasksRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (describeMaintenanceWindowExecutionTasksRequest.getWindowExecutionId() != null) {
                String windowExecutionId = describeMaintenanceWindowExecutionTasksRequest
            ...
            if (describeMaintenanceWindowExecutionTasksRequest.getFilters() != null) {
                java.util.List<MaintenanceWindowFilter> filters = describeMaintenanceWindowExecutionTasksRequest
                        .getFilters();
