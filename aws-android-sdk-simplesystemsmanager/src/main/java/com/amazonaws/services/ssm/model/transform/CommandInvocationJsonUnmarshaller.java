 ...
 */
class CommandInvocationJsonUnmarshaller implements
    ...
    public CommandInvocation unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("CommandId")) {
                ...
                commandInvocation.setCommandPlugins(new ListUnmarshaller<CommandPlugin>(
                ...
                commandInvocation.setNotificationConfig(NotificationConfigJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("CloudWatchOutputConfig")) {
                commandInvocation.setCloudWatchOutputConfig(CloudWatchOutputConfigJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
