...
public class GetCommandInvocationResult implements Serializable {
     ...
     *            not be available because of network issues, because the
     *            instance was stopped, or for similar reasons. The system will
     ...
     *            in Amazon S3. If an S3 bucket was not specified, then this
     *            string is empty.
     *            </p>
     */
