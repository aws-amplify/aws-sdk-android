 ...
 */
class InstanceInformationJsonUnmarshaller implements
    ...
    public InstanceInformation unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("InstanceId")) {
                ...
                instanceInformation.setLastAssociationExecutionDate(DateJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("LastSuccessfulAssociationExecutionDate")) {
                instanceInformation.setLastSuccessfulAssociationExecutionDate(DateJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("AssociationOverview")) {
                instanceInformation
                        .setAssociationOverview(InstanceAggregatedAssociationOverviewJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
