...
public class GetAutomationExecutionResult implements Serializable {
     ...
     *         chained together.
     */
    public GetAutomationExecutionResult withAutomationExecution(
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getAutomationExecution() == null) ? 0 : getAutomationExecution().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAutomationExecution() == null ^ this.getAutomationExecution() == null)
            return false;
        if (other.getAutomationExecution() != null
                && other.getAutomationExecution().equals(this.getAutomationExecution()) == false)
            return false;
        return true;
    }
}
