...
public class InventoryResultEntity implements Serializable {
     ...
     *         instance inventory the result will be the managed instance ID.
     *         For EC2 instance inventory, the result will be the instance ID.
     *         </p>
     */
    public String getId() {
        return id;
     ...
     *            ID of the inventory result entity. For example, for managed
     *            instance inventory the result will be the managed instance ID.
     *            For EC2 instance inventory, the result will be the instance
     *            ID.
     *            </p>
     */
