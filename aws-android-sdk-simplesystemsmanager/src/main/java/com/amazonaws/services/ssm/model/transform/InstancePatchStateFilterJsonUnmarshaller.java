 ...
 */
class InstancePatchStateFilterJsonUnmarshaller implements
        Unmarshaller<InstancePatchStateFilter, JsonUnmarshallerContext> {
    ...
    public InstancePatchStateFilter unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Key")) {
                ...
                instancePatchStateFilter.setValues(new ListUnmarshaller<String>(
