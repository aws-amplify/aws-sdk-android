 ...
 * your instances. If you specify an instance ID that is not valid or an
...
public class DescribeInstanceInformationRequest extends AmazonWebServiceRequest implements
     ...
     *         <code>Filters</code> enables you to return instance information
     ...
     *            This is a legacy method. We recommend that you don't use this
     *            method. Instead, use the <code>Filters</code> data type.
     *            <code>Filters</code> enables you to return instance
     *            information by filtering based on tags applied to managed
     *            instances.
     *            </p>
     *            <note>
     *            <p>
     *            Attempting to use <code>InstanceInformationFilterList</code>
     *            and <code>Filters</code> leads to an exception error.
     *            </p>
     *            </note>
     */
     ...
     *         of instances. You can filter based on tags applied to EC2
     *         instances. Use this <code>Filters</code> data type instead of
     *         <code>InstanceInformationFilterList</code>, which is deprecated.
     *         </p>
     */
     ...
     *            list of instances. You can filter based on tags applied to EC2
     *            instances. Use this <code>Filters</code> data type instead of
