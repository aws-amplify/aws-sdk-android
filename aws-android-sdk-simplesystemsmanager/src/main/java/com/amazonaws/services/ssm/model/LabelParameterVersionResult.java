...
public class LabelParameterVersionResult implements Serializable {
     ...
     * label requirements, see <a href=
     * "https://docs.aws.amazon.com/systems-manager/latest/userguide/sysman-paramstore-labels.html"
     * >Labeling parameters</a> in the <i>AWS Systems Manager User Guide</i>.
     * </p>
     */
     ...
     *         parameter label requirements, see <a href=
     *         "https://docs.aws.amazon.com/systems-manager/latest/userguide/sysman-paramstore-labels.html"
     *         >Labeling parameters</a> in the <i>AWS Systems Manager User
     *         Guide</i>.
     *         </p>
     */
     ...
     * </p>
     *
     * @param invalidLabels <p>
     *            The label does not meet the requirements. For information
     *            about parameter label requirements, see <a href=
     *            "https://docs.aws.amazon.com/systems-manager/latest/userguide/sysman-paramstore-labels.html"
     *            >Labeling parameters</a> in the <i>AWS Systems Manager User
     *            Guide</i>.
     *            </p>
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getInvalidLabels() != null)
            sb.append("InvalidLabels: " + getInvalidLabels() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getInvalidLabels() == null) ? 0 : getInvalidLabels().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getInvalidLabels() == null ^ this.getInvalidLabels() == null)
            return false;
        if (other.getInvalidLabels() != null
                && other.getInvalidLabels().equals(this.getInvalidLabels()) == false)
            return false;
