...
/**
 * StAX unmarshaller for model S3OriginConfig
 */
class S3OriginConfigStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("OriginAccessIdentity", targetDepth)) {
                    s3OriginConfig.setOriginAccessIdentity(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
