 ...
 * invalidation objects. For more information about invalidation, see <a href=
 * "https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Invalidation.html"
 * >Invalidating Objects (Web Distributions Only)</a> in the <i>Amazon
...
public class InvalidationList implements Serializable {
     ...
     * and contains the value that you can use for the <code>Marker</code>
     ...
     *
     * @param marker <p>
     *            The value that you provided for the <code>Marker</code>
     *            request parameter.
     *            </p>
     */
     ...
     *            is present and contains the value that you can use for the
     *            <code>Marker</code> request parameter to continue listing your
     *            invalidation batches where they left off.
     *            </p>
     */
     ...
     *
     * @param maxItems <p>
     *            The value that you provided for the <code>MaxItems</code>
     *            request parameter.
     *            </p>
     */
     ...
     *            <code>InvalidationSummary</code> element for each invalidation
    ...
    public void setItems(java.util.Collection<InvalidationSummary> items) {
        ...
        this.items = new java.util.ArrayList<InvalidationSummary>(items);
    }
    ...
    public InvalidationList withItems(InvalidationSummary... items) {
        if (getItems() == null) {
            this.items = new java.util.ArrayList<InvalidationSummary>(items.length);
        }
