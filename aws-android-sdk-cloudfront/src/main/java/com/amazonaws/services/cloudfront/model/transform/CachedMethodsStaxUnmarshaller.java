...
/**
 * StAX unmarshaller for model CachedMethods
 */
class CachedMethodsStaxUnmarshaller implements Unmarshaller<CachedMethods, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Quantity", targetDepth)) {
                    cachedMethods.setQuantity(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Items", targetDepth)) {
                    cachedMethods.withItems(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
