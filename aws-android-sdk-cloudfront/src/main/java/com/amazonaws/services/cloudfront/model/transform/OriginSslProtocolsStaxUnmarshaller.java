...
/**
 * StAX unmarshaller for model OriginSslProtocols
 */
class OriginSslProtocolsStaxUnmarshaller implements
        Unmarshaller<OriginSslProtocols, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Quantity", targetDepth)) {
                    originSslProtocols.setQuantity(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Items", targetDepth)) {
                    originSslProtocols.withItems(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
