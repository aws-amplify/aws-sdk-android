...
/**
 * StAX unmarshaller for model StreamingDistributionConfigWithTags
 */
class StreamingDistributionConfigWithTagsStaxUnmarshaller implements
        Unmarshaller<StreamingDistributionConfigWithTags, StaxUnmarshallerContext> {

    public StreamingDistributionConfigWithTags unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("Tags", targetDepth)) {
                    streamingDistributionConfigWithTags.setTags(TagsStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
