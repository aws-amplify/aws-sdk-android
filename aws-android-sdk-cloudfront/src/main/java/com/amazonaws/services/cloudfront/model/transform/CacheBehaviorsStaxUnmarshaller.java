...
/**
 * StAX unmarshaller for model CacheBehaviors
 */
class CacheBehaviorsStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Quantity", targetDepth)) {
                    cacheBehaviors.setQuantity(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Items", targetDepth)) {
                    cacheBehaviors.withItems(CacheBehaviorStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
