...
/**
 * StAX unmarshaller for model QueryArgProfiles
 */
class QueryArgProfilesStaxUnmarshaller implements
        Unmarshaller<QueryArgProfiles, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Quantity", targetDepth)) {
                    queryArgProfiles.setQuantity(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Items", targetDepth)) {
                    queryArgProfiles.withItems(QueryArgProfileStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
