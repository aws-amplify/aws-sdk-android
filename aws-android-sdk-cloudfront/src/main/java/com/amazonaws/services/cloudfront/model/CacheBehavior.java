 ...
 * behaviors that you can add to a distribution, see <a href=
 * "https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/cloudfront-limits.html"
 * >Quotas</a> in the <i>Amazon CloudFront Developer Guide</i>.
 * </p>
 * <p>
...
public class CacheBehavior implements Serializable {
     ...
     * <note>
     * <p>
     * You can optionally include a slash (<code>/</code>) at the beginning of
     * the path pattern. For example, <code>/images/*.jpg</code>. CloudFront
     * behavior is the same with or without the leading <code>/</code>.
     * </p>
     * </note>
     * <p>
     * The path pattern for the default cache behavior is <code>*</code> and
     * cannot be changed. If the request for an object does not match the path
     * pattern for any cache behaviors, CloudFront applies the behavior in the
     ...
     * <a href=
     * "https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Expiration.html"
     * > Managing How Long Content Stays in an Edge Cache (Expiration)</a> in
     ...
     *
     * @return <p>
     *         The pattern (for example, <code>images/*.jpg</code>) that
     *         specifies which requests to apply the behavior to. When
     *         CloudFront receives a viewer request, the requested path is
     *         compared with path patterns in the order in which cache behaviors
     *         are listed in the distribution.
     *         </p>
     *         <note>
     *         <p>
     *         You can optionally include a slash (<code>/</code>) at the
     *         beginning of the path pattern. For example,
     *         <code>/images/*.jpg</code>. CloudFront behavior is the same with
     *         or without the leading <code>/</code>.
     *         </p>
     *         </note>
     *         <p>
     ...
     *         For more information, see <a href=
     *         "https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesPathPattern"
     *         >Path Pattern</a> in the <i> Amazon CloudFront Developer
     *         Guide</i>.
     *         </p>
     */
     ...
     *            You can optionally include a slash (<code>/</code>) at the
     *            beginning of the path pattern. For example,
     *            <code>/images/*.jpg</code>. CloudFront behavior is the same
     *            with or without the leading <code>/</code>.
     *            </p>
     *            </note>
     *            <p>
     *            The path pattern for the default cache behavior is
     *            <code>*</code> and cannot be changed. If the request for an
     ...
     *         CloudFront to route requests to when they match this cache
     *         behavior.
     *         </p>
     */
     ...
     *         specify false. For more information, see <a href=
     *         "https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/ServingCompressedFiles.html"
     ...
     *         chained together.
     */
    public CacheBehavior withLambdaFunctionAssociations(
