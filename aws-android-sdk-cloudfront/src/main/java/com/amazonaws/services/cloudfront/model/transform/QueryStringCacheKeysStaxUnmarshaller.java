...
/**
 * StAX unmarshaller for model QueryStringCacheKeys
 */
class QueryStringCacheKeysStaxUnmarshaller implements
        Unmarshaller<QueryStringCacheKeys, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Quantity", targetDepth)) {
                    queryStringCacheKeys.setQuantity(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Items", targetDepth)) {
                    queryStringCacheKeys.withItems(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
