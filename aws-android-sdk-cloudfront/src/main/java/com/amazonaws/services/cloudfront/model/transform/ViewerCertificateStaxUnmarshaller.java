...
/**
 * StAX unmarshaller for model ViewerCertificate
 */
class ViewerCertificateStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("CloudFrontDefaultCertificate", targetDepth)) {
                    viewerCertificate.setCloudFrontDefaultCertificate(BooleanStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("IAMCertificateId", targetDepth)) {
                    viewerCertificate.setIAMCertificateId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ACMCertificateArn", targetDepth)) {
                    viewerCertificate.setACMCertificateArn(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("SSLSupportMethod", targetDepth)) {
                    viewerCertificate.setSSLSupportMethod(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("MinimumProtocolVersion", targetDepth)) {
                    viewerCertificate.setMinimumProtocolVersion(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Certificate", targetDepth)) {
                    viewerCertificate.setCertificate(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("CertificateSource", targetDepth)) {
                    viewerCertificate.setCertificateSource(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
