 ...
 * </p>
 */
public class ListInvalidations2019_03_26Request extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public ListInvalidations2019_03_26Request withDistributionId(String distributionId) {
        this.distributionId = distributionId;
        return this;
    }
     ...
     *         results, set <code>Marker</code> to the value of the
     *         <code>NextMarker</code> from the current page's response. This
     *         value is the same as the ID of the last invalidation batch on
     *         that page.
     *         </p>
     */
     ...
     *
     * @param marker <p>
     *            Use this parameter when paginating results to indicate where
     *            to begin in your list of invalidation batches. Because the
     *            results are returned in decreasing order from most recent to
     *            oldest, the most recent results are on the first page, the
     *            second page will contain earlier results, and so on. To get
     *            the next page of results, set <code>Marker</code> to the value
     *            of the <code>NextMarker</code> from the current page's
     *            response. This value is the same as the ID of the last
     ...
     *         chained together.
     */
    public ListInvalidations2019_03_26Request withMarker(String marker) {
        this.marker = marker;
        return this;
    }
     ...
     *
     * @param maxItems <p>
     *            The maximum number of invalidation batches that you want in
     *            the response body.
     *            </p>
     */
     ...
     *         chained together.
     */
    public ListInvalidations2019_03_26Request withMaxItems(String maxItems) {
        this.maxItems = maxItems;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListInvalidations2019_03_26Request == false)
            return false;
        ListInvalidations2019_03_26Request other = (ListInvalidations2019_03_26Request) obj;
