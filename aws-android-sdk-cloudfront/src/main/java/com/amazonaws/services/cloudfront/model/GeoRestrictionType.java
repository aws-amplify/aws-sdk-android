...
public enum GeoRestrictionType {
    ...
    private static final Map<String, GeoRestrictionType> enumMap;
    static {
        enumMap = new HashMap<String, GeoRestrictionType>();
        enumMap.put("blacklist", Blacklist);
        enumMap.put("whitelist", Whitelist);
