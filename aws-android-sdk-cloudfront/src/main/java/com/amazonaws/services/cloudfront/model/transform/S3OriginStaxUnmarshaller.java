...
/**
 * StAX unmarshaller for model S3Origin
 */
class S3OriginStaxUnmarshaller implements Unmarshaller<S3Origin, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("OriginAccessIdentity", targetDepth)) {
                    s3Origin.setOriginAccessIdentity(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
