...
/**
 * StAX unmarshaller for model Signer
 */
class SignerStaxUnmarshaller implements Unmarshaller<Signer, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("AwsAccountNumber", targetDepth)) {
                    signer.setAwsAccountNumber(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("KeyPairIds", targetDepth)) {
                    signer.setKeyPairIds(KeyPairIdsStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
