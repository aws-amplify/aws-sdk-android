...
public enum EventType {
    ...
    static {
        ...
        enumMap.put("viewer-request", ViewerRequest);
        enumMap.put("viewer-response", ViewerResponse);
        enumMap.put("origin-request", OriginRequest);
        enumMap.put("origin-response", OriginResponse);
    }
