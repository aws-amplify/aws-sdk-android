...
/**
 * StAX unmarshaller for model ContentTypeProfiles
 */
class ContentTypeProfilesStaxUnmarshaller implements
        Unmarshaller<ContentTypeProfiles, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Quantity", targetDepth)) {
                    contentTypeProfiles.setQuantity(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Items", targetDepth)) {
                    contentTypeProfiles.withItems(ContentTypeProfileStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
