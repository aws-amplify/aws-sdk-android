...
/**
 * StAX unmarshaller for model StreamingLoggingConfig
 */
class StreamingLoggingConfigStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Enabled", targetDepth)) {
                    streamingLoggingConfig.setEnabled(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Bucket", targetDepth)) {
                    streamingLoggingConfig.setBucket(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Prefix", targetDepth)) {
                    streamingLoggingConfig.setPrefix(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
