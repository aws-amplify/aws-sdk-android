...
/**
 * StAX unmarshaller for model CloudFrontOriginAccessIdentity
 */
class CloudFrontOriginAccessIdentityStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Id", targetDepth)) {
                    cloudFrontOriginAccessIdentity.setId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("S3CanonicalUserId", targetDepth)) {
                    cloudFrontOriginAccessIdentity.setS3CanonicalUserId(StringStaxUnmarshaller
