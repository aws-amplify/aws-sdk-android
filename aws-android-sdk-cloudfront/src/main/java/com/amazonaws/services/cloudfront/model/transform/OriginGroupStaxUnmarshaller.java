...
/**
 * StAX unmarshaller for model OriginGroup
 */
class OriginGroupStaxUnmarshaller implements Unmarshaller<OriginGroup, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("FailoverCriteria", targetDepth)) {
                    originGroup.setFailoverCriteria(OriginGroupFailoverCriteriaStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Members", targetDepth)) {
                    originGroup.setMembers(OriginGroupMembersStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
