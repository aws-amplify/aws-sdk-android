...
/**
 * StAX unmarshaller for model ForwardedValues
 */
class ForwardedValuesStaxUnmarshaller implements
        Unmarshaller<ForwardedValues, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("QueryString", targetDepth)) {
                    forwardedValues.setQueryString(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Cookies", targetDepth)) {
                    forwardedValues.setCookies(CookiePreferenceStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Headers", targetDepth)) {
                    forwardedValues.setHeaders(HeadersStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("QueryStringCacheKeys", targetDepth)) {
                    forwardedValues.setQueryStringCacheKeys(QueryStringCacheKeysStaxUnmarshaller
