...
public enum ViewerProtocolPolicy {
    ...
    private static final Map<String, ViewerProtocolPolicy> enumMap;
    static {
        enumMap = new HashMap<String, ViewerProtocolPolicy>();
        enumMap.put("allow-all", AllowAll);
        enumMap.put("https-only", HttpsOnly);
        enumMap.put("redirect-to-https", RedirectToHttps);
    }
