...
/**
 * StAX unmarshaller for model FieldLevelEncryptionConfig
 */
class FieldLevelEncryptionConfigStaxUnmarshaller implements
        Unmarshaller<FieldLevelEncryptionConfig, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("CallerReference", targetDepth)) {
                    fieldLevelEncryptionConfig.setCallerReference(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Comment", targetDepth)) {
                    fieldLevelEncryptionConfig.setComment(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
