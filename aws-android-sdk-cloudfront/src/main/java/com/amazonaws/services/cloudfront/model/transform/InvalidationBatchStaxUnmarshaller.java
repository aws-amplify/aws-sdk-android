...
/**
 * StAX unmarshaller for model InvalidationBatch
 */
class InvalidationBatchStaxUnmarshaller implements
        Unmarshaller<InvalidationBatch, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Paths", targetDepth)) {
                    invalidationBatch.setPaths(PathsStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("CallerReference", targetDepth)) {
                    invalidationBatch.setCallerReference(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
