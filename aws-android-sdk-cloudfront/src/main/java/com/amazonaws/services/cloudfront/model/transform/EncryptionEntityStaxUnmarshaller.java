...
/**
 * StAX unmarshaller for model EncryptionEntity
 */
class EncryptionEntityStaxUnmarshaller implements
        Unmarshaller<EncryptionEntity, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PublicKeyId", targetDepth)) {
                    encryptionEntity.setPublicKeyId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ProviderId", targetDepth)) {
                    encryptionEntity.setProviderId(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("FieldPatterns", targetDepth)) {
                    encryptionEntity.setFieldPatterns(FieldPatternsStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
