 ...
 * </p>
 */
public class ListFieldLevelEncryptionProfiles2019_03_26Request extends AmazonWebServiceRequest
        implements Serializable {
    /**
     * <p>
     * Use this when paginating results to indicate where to begin in your list
     * of profiles. The results include profiles in the list that occur after
     * the marker. To get the next page of results, set the <code>Marker</code>
     * to the value of the <code>NextMarker</code> from the current page's
     ...
     *         your list of profiles. The results include profiles in the list
     *         that occur after the marker. To get the next page of results, set
     *         the <code>Marker</code> to the value of the
     ...
     * @param marker <p>
     *            Use this when paginating results to indicate where to begin in
     *            your list of profiles. The results include profiles in the
     ...
     *         chained together.
     */
    public ListFieldLevelEncryptionProfiles2019_03_26Request withMarker(String marker) {
        this.marker = marker;
        return this;
    }
     ...
     *         chained together.
     */
    public ListFieldLevelEncryptionProfiles2019_03_26Request withMaxItems(String maxItems) {
        this.maxItems = maxItems;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFieldLevelEncryptionProfiles2019_03_26Request == false)
            return false;
        ListFieldLevelEncryptionProfiles2019_03_26Request other = (ListFieldLevelEncryptionProfiles2019_03_26Request) obj;
