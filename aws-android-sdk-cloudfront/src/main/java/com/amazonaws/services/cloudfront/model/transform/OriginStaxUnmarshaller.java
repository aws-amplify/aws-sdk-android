...
/**
 * StAX unmarshaller for model Origin
 */
class OriginStaxUnmarshaller implements Unmarshaller<Origin, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("CustomHeaders", targetDepth)) {
                    origin.setCustomHeaders(CustomHeadersStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("S3OriginConfig", targetDepth)) {
                    origin.setS3OriginConfig(S3OriginConfigStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("CustomOriginConfig", targetDepth)) {
                    origin.setCustomOriginConfig(CustomOriginConfigStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ConnectionAttempts", targetDepth)) {
                    origin.setConnectionAttempts(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("ConnectionTimeout", targetDepth)) {
                    origin.setConnectionTimeout(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
