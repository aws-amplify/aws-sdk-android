...
/**
 * StAX unmarshaller for model FieldLevelEncryptionProfile
 */
class FieldLevelEncryptionProfileStaxUnmarshaller implements
        Unmarshaller<FieldLevelEncryptionProfile, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Id", targetDepth)) {
                    fieldLevelEncryptionProfile.setId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("LastModifiedTime", targetDepth)) {
                    fieldLevelEncryptionProfile.setLastModifiedTime(DateStaxUnmarshaller
