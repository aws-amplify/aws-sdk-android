...
/**
 * StAX unmarshaller for model FieldPatterns
 */
class FieldPatternsStaxUnmarshaller implements Unmarshaller<FieldPatterns, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Quantity", targetDepth)) {
                    fieldPatterns.setQuantity(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Items", targetDepth)) {
                    fieldPatterns.withItems(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
