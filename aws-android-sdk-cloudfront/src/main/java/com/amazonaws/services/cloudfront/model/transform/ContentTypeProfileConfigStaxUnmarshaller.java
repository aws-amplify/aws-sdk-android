...
/**
 * StAX unmarshaller for model ContentTypeProfileConfig
 */
class ContentTypeProfileConfigStaxUnmarshaller implements
        Unmarshaller<ContentTypeProfileConfig, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ForwardWhenContentTypeIsUnknown", targetDepth)) {
                    contentTypeProfileConfig
                            .setForwardWhenContentTypeIsUnknown(BooleanStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ContentTypeProfiles", targetDepth)) {
                    contentTypeProfileConfig
                            .setContentTypeProfiles(ContentTypeProfilesStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
