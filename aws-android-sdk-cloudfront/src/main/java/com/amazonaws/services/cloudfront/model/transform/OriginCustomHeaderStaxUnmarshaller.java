...
/**
 * StAX unmarshaller for model OriginCustomHeader
 */
class OriginCustomHeaderStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("HeaderName", targetDepth)) {
                    originCustomHeader.setHeaderName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("HeaderValue", targetDepth)) {
                    originCustomHeader.setHeaderValue(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
