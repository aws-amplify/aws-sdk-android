...
public class DistributionList implements Serializable {
     ...
     *            <code>DistributionSummary</code> element for each distribution
    ...
    public void setItems(java.util.Collection<DistributionSummary> items) {
        ...
        this.items = new java.util.ArrayList<DistributionSummary>(items);
    }
    ...
    public DistributionList withItems(DistributionSummary... items) {
        if (getItems() == null) {
            this.items = new java.util.ArrayList<DistributionSummary>(items.length);
        }
