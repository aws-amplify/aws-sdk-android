...
/**
 * StAX unmarshaller for model OriginGroupMembers
 */
class OriginGroupMembersStaxUnmarshaller implements
        Unmarshaller<OriginGroupMembers, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Quantity", targetDepth)) {
                    originGroupMembers.setQuantity(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Items", targetDepth)) {
                    originGroupMembers.withItems(OriginGroupMemberStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
