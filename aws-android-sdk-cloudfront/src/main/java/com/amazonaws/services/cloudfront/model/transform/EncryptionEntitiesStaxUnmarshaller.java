...
/**
 * StAX unmarshaller for model EncryptionEntities
 */
class EncryptionEntitiesStaxUnmarshaller implements
        Unmarshaller<EncryptionEntities, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Quantity", targetDepth)) {
                    encryptionEntities.setQuantity(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Items", targetDepth)) {
                    encryptionEntities.withItems(EncryptionEntityStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
