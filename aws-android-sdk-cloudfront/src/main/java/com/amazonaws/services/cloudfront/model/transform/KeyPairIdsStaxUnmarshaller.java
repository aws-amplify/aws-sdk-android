...
/**
 * StAX unmarshaller for model KeyPairIds
 */
class KeyPairIdsStaxUnmarshaller implements Unmarshaller<KeyPairIds, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Quantity", targetDepth)) {
                    keyPairIds.setQuantity(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
