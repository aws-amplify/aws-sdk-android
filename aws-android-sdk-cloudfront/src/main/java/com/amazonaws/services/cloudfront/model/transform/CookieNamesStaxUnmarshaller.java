...
/**
 * StAX unmarshaller for model CookieNames
 */
class CookieNamesStaxUnmarshaller implements Unmarshaller<CookieNames, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Quantity", targetDepth)) {
                    cookieNames.setQuantity(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
