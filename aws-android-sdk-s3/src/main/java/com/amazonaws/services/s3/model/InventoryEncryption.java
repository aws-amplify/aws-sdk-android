...
public class InventoryEncryption implements Serializable {
     ...
     *         chained together.
     */
    public InventoryEncryption withSSES3(SSES3 sSES3) {
        this.sSES3 = sSES3;
        return this;
    }
     ...
     *         chained together.
     */
    public InventoryEncryption withSSEKMS(SSEKMS sSEKMS) {
        this.sSEKMS = sSEKMS;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getSSES3() != null)
            sb.append("SSES3: " + getSSES3() + ",");
        if (getSSEKMS() != null)
            sb.append("SSEKMS: " + getSSEKMS());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InventoryEncryption == false)
            return false;
