...
/**
 * StAX unmarshaller for response GetBucketReplicationResult
 */
public class GetBucketReplicationResultStaxUnmarshaller implements
        Unmarshaller<GetBucketReplicationResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ReplicationConfiguration", targetDepth)) {
                    getBucketReplicationResult
                            .setReplicationConfiguration(ReplicationConfigurationStaxUnmarshaller
