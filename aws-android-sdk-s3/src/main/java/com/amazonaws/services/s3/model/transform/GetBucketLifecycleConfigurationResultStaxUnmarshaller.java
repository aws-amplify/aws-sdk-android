...
/**
 * StAX unmarshaller for response GetBucketLifecycleConfigurationResult
 */
public class GetBucketLifecycleConfigurationResultStaxUnmarshaller implements
        Unmarshaller<GetBucketLifecycleConfigurationResult, StaxUnmarshallerContext> {

    public GetBucketLifecycleConfigurationResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Rules/member", targetDepth)) {
                    getBucketLifecycleConfigurationResult.withRules(LifecycleRuleStaxUnmarshaller
