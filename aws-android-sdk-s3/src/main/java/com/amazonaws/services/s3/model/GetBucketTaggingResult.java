...
public class GetBucketTaggingResult implements Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public GetBucketTaggingResult withTagSet(Tag... tagSet) {
        if (getTagSet() == null) {
     ...
     *         chained together.
     */
    public GetBucketTaggingResult withTagSet(java.util.Collection<Tag> tagSet) {
        setTagSet(tagSet);
        return this;
    }
