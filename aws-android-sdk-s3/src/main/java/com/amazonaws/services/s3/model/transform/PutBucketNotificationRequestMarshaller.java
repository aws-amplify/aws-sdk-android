...
/**
 * StAX request marshaller for PutBucketNotificationRequest
 */
public class PutBucketNotificationRequestMarshaller implements
    ...
    public Request<PutBucketNotificationRequest> marshall(
            PutBucketNotificationRequest putBucketNotificationRequest) {
        if (putBucketNotificationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(PutBucketNotificationRequest)");
        }

        Request<PutBucketNotificationRequest> request = new DefaultRequest<PutBucketNotificationRequest>(
                putBucketNotificationRequest, "AmazonSimpleStorageService");
        request.addParameter("Action", "PutBucketNotification");
        request.addParameter("Version", "2006-03-01");

        String prefix;
        if (putBucketNotificationRequest.getBucket() != null) {
            prefix = "Bucket";
            String bucket = putBucketNotificationRequest.getBucket();
            request.addParameter(prefix, StringUtils.fromString(bucket));
        }
        if (putBucketNotificationRequest.getContentMD5() != null) {
            prefix = "Content-MD5";
            String contentMD5 = putBucketNotificationRequest.getContentMD5();
            request.addParameter(prefix, StringUtils.fromString(contentMD5));
        }
        if (putBucketNotificationRequest.getNotificationConfiguration() != null) {
            ...
            NotificationConfigurationDeprecatedStaxMarshaller.getInstance().marshall(
