...
/**
 * StAX unmarshaller for model LifecycleRuleAndOperator
 */
class LifecycleRuleAndOperatorStaxUnmarshaller implements
        Unmarshaller<LifecycleRuleAndOperator, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Prefix", targetDepth)) {
                    lifecycleRuleAndOperator.setPrefix(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Tag", targetDepth)) {
                    lifecycleRuleAndOperator.withTags(TagStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
