...
/**
 * StAX unmarshaller for model LifecycleConfiguration
 */
class LifecycleConfigurationStaxUnmarshaller implements
        Unmarshaller<LifecycleConfiguration, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Rules/member", targetDepth)) {
                    lifecycleConfiguration.withRules(RuleStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
