...
public abstract class AbstractPutObjectRequest extends AmazonWebServiceRequest implements
        SSECustomerKeyProvider, SSEAwsKeyManagementParamsProvider, S3DataSource,
        Serializable {
    /**
    ...
    /**
     * Constructs a new {@link AbstractPutObjectRequest} object to upload a file
     * to the specified bucket and key. After constructing the request, users
    ...
    /**
     * Constructs a new {@link AbstractPutObjectRequest} object with redirect
     * location. After constructing the request, users may optionally specify
     * object metadata or a canned ACL as well.
     *
     * @param bucketName The name of an existing bucket to which the new object
     *            will be uploaded.
     * @param key The key under which to store the new object.
    ...
    /**
     * Constructs a new {@link AbstractPutObjectRequest} object to upload a
     * stream of data to the specified bucket and key. After constructing the
     * request, users may optionally specify object metadata or a canned ACL as
     * well.
     * <p>
    ...
    /**
     * Sets the optional Amazon S3 storage class to use when storing the new
     * object. Returns this {@link AbstractPutObjectRequest}, enabling
     ...
     * this {@link AbstractPutObjectRequest}, enabling additional method calls
     ...
     * Sets the optional metadata instructing Amazon S3 how to handle the
     * uploaded data (e.g. custom user metadata, hooks for specifying content
     * type, etc.). Returns this {@link AbstractPutObjectRequest}, enabling
     ...
     * {@link AbstractPutObjectRequest}, enabling additional method calls to be
     * chained together.
     *
     * @param redirectLocation The redirect location for the new object.
     */
