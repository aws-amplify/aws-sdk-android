...
/**
 * StAX unmarshaller for model ReplicationRuleAndOperator
 */
class ReplicationRuleAndOperatorStaxUnmarshaller implements
        Unmarshaller<ReplicationRuleAndOperator, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Prefix", targetDepth)) {
                    replicationRuleAndOperator.setPrefix(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Tag", targetDepth)) {
                    replicationRuleAndOperator.withTags(TagStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
