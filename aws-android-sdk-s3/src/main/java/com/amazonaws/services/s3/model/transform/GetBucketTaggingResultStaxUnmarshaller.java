...
/**
 * StAX unmarshaller for response GetBucketTaggingResult
 */
public class GetBucketTaggingResultStaxUnmarshaller implements
        Unmarshaller<GetBucketTaggingResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("TagSet", targetDepth)) {
                    getBucketTaggingResult.withTagSet(TagStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
