 ...
 */
public class GetPublicAccessBlockResultStaxUnmarshaller implements
        Unmarshaller<GetPublicAccessBlockResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PublicAccessBlockConfiguration", targetDepth)) {
                    getPublicAccessBlockResult
                            .setPublicAccessBlockConfiguration(PublicAccessBlockConfigurationStaxUnmarshaller
