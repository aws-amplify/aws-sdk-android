...
/**
 * StAX unmarshaller for model Stats
 */
class StatsStaxUnmarshaller implements Unmarshaller<Stats, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("BytesScanned", targetDepth)) {
                    stats.setBytesScanned(LongStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("BytesProcessed", targetDepth)) {
                    stats.setBytesProcessed(LongStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("BytesReturned", targetDepth)) {
                    stats.setBytesReturned(LongStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    private static StatsStaxUnmarshaller instance;

    public static StatsStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new StatsStaxUnmarshaller();
        return instance;
    }
}
