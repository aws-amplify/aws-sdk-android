...
/**
 * StAX unmarshaller for model NoncurrentVersionTransition
 */
class NoncurrentVersionTransitionStaxUnmarshaller implements
        Unmarshaller<NoncurrentVersionTransition, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("NoncurrentDays", targetDepth)) {
                    noncurrentVersionTransition.setNoncurrentDays(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("StorageClass", targetDepth)) {
                    noncurrentVersionTransition.setStorageClass(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
