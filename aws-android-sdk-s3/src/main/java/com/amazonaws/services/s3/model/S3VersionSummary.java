...
/**
 * Contains the summary of a version stored in an Amazon S3 bucket. This object
...
public class S3VersionSummary {
     ...
     *
     * @param bucketName The name of the Amazon S3 bucket in which this version
     *            is stored.
     ...
     *
     * @param key The key under which this version is stored in Amazon S3.
     ...
     *
     * @param isLatest True if this version represents the latest version for
     *            the associated object in S3.
     */
     ...
     * modified.
     *
     * @param lastModified The date according to Amazon S3 at which this version
     *            was last modified.
    ...
    /**
     * Gets the owner of this version. Returns <code>null</code> if the
     * requester doesn't have {@link Permission#ReadAcp} permission for this
     * version or owns the bucket in which it resides.
     *
     ...
     * with them. When deleting a versioned object in Amazon S3 without
     * specifying an explicit version ID, a new delete marker is created as the
     * latest version of that object to mark that the object was deleted. This
     * occurs even though the previous versions still exist in Amazon S3.
     * </p>
     * <p>
    ...
    /**
     * Intended for internal use only in the Amazon S3 client code. Sets the
     * value of the <code>isDeleteMarker</code> property to record if this is a
     * delete marker or not.
     *
     * @param isDeleteMarker Specify
     ...
     *
     * @param storageClass The storage class used by Amazon S3 for this version.
