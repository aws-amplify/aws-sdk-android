...
/**
 * StAX unmarshaller for model AccessControlTranslation
 */
class AccessControlTranslationStaxUnmarshaller implements
        Unmarshaller<AccessControlTranslation, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Owner", targetDepth)) {
                    accessControlTranslation.setOwner(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
