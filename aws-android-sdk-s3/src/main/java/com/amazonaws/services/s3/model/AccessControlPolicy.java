...
public class AccessControlPolicy implements Serializable {
     ...
     *         chained together.
     */
    public AccessControlPolicy withGrants(Grant... grants) {
        if (getGrants() == null) {
     ...
     *         chained together.
     */
    public AccessControlPolicy withGrants(java.util.Collection<Grant> grants) {
        setGrants(grants);
        return this;
    }
     ...
     *         chained together.
     */
    public AccessControlPolicy withOwner(Owner owner) {
        this.owner = owner;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AccessControlPolicy == false)
            return false;
