...
/**
 * StAX request marshaller for DeleteBucketLifecycleRequest
 */
public class DeleteBucketLifecycleRequestMarshaller implements
    ...
    public Request<DeleteBucketLifecycleRequest> marshall(
            DeleteBucketLifecycleRequest deleteBucketLifecycleRequest) {
        if (deleteBucketLifecycleRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteBucketLifecycleRequest)");
        }

        Request<DeleteBucketLifecycleRequest> request = new DefaultRequest<DeleteBucketLifecycleRequest>(
                deleteBucketLifecycleRequest, "AmazonSimpleStorageService");
        request.addParameter("Action", "DeleteBucketLifecycle");
        request.addParameter("Version", "2006-03-01");

        String prefix;
        if (deleteBucketLifecycleRequest.getBucket() != null) {
            prefix = "Bucket";
