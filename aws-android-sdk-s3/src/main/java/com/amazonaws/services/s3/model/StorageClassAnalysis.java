...
public class StorageClassAnalysis implements Serializable {
    ...
    public String toString() {
        ...
        if (getDataExport() != null)
            sb.append("DataExport: " + getDataExport());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StorageClassAnalysis == false)
            return false;
        StorageClassAnalysis other = (StorageClassAnalysis) obj;

        if (other.getDataExport() == null ^ this.getDataExport() == null)
            return false;
        if (other.getDataExport() != null
                && other.getDataExport().equals(this.getDataExport()) == false)
            return false;
        return true;
    }
}
