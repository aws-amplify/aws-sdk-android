...
/**
 * StAX unmarshaller for model Transition
 */
class TransitionStaxUnmarshaller implements Unmarshaller<Transition, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Date", targetDepth)) {
                    transition.setDate(DateStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("StorageClass", targetDepth)) {
                    transition.setStorageClass(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
