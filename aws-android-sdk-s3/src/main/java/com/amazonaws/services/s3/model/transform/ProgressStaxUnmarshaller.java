...
/**
 * StAX unmarshaller for model Progress
 */
class ProgressStaxUnmarshaller implements Unmarshaller<Progress, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("BytesScanned", targetDepth)) {
                    progress.setBytesScanned(LongStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("BytesProcessed", targetDepth)) {
                    progress.setBytesProcessed(LongStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("BytesReturned", targetDepth)) {
                    progress.setBytesReturned(LongStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
    ...
    private static ProgressStaxUnmarshaller instance;

    public static ProgressStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new ProgressStaxUnmarshaller();
        return instance;
    }
}
