...
/**
 * StAX unmarshaller for model NoncurrentVersionExpiration
 */
class NoncurrentVersionExpirationStaxUnmarshaller implements
        Unmarshaller<NoncurrentVersionExpiration, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("NoncurrentDays", targetDepth)) {
                    noncurrentVersionExpiration.setNoncurrentDays(IntegerStaxUnmarshaller
