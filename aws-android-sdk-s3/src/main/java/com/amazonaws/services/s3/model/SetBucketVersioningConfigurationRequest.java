 ...
 * {@link BucketVersioningConfiguration#OFF} state. Once versioning is enabled
 * for a bucket, its status can never be reverted to
 ...
 * </p>
 * <p>
 * Amazon S3 is eventually consistent. It may take time for the versioning
...
public class SetBucketVersioningConfigurationRequest extends AmazonWebServiceRequest {
     ...
     *
     * @param bucketName The name of the bucket whose versioning configuration
     *            is being set.
     * @param configuration The new versioning configuration for the specified
     *            bucket.
     * @see SetBucketVersioningConfigurationRequest#SetBucketVersioningConfigurationRequest(String,
     *      BucketVersioningConfiguration, MultiFactorAuthentication)
     */
     ...
     * @param configuration The new versioning configuration for the specified
     *            bucket.
     * @param mfa The Multi-Factor Authentication information to include in this
     *            request.
     * @see SetBucketVersioningConfigurationRequest#SetBucketVersioningConfigurationRequest(String,
     *      BucketVersioningConfiguration)
     */
     ...
     *
     * @param versioningConfiguration The new versioning configuration for the
     *            specified bucket.
     ...
     * @param mfa The optional Multi-Factor Authentication information to
     *            include with this request.
     * @return The updated SetBucketVersioningConfigurationRequest object so that
