...
/**
 * StAX unmarshaller for model Tagging
 */
class TaggingStaxUnmarshaller implements Unmarshaller<Tagging, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("TagSet", targetDepth)) {
                    tagging.withTagSet(TagStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
