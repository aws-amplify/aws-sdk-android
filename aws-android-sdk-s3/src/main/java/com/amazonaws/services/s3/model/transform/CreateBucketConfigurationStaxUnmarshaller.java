...
/**
 * StAX unmarshaller for model CreateBucketConfiguration
 */
class CreateBucketConfigurationStaxUnmarshaller implements
        Unmarshaller<CreateBucketConfiguration, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("LocationConstraint", targetDepth)) {
                    createBucketConfiguration.setLocationConstraint(StringStaxUnmarshaller
