...
/**
 * StAX unmarshaller for model VersioningConfiguration
 */
class VersioningConfigurationStaxUnmarshaller implements
        Unmarshaller<VersioningConfiguration, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("MfaDelete", targetDepth)) {
                    versioningConfiguration.setMFADelete(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Status", targetDepth)) {
                    versioningConfiguration.setStatus(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
