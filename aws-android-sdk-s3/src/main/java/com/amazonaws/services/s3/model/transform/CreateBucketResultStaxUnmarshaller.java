...
/**
 * StAX unmarshaller for response CreateBucketResult
 */
public class CreateBucketResultStaxUnmarshaller implements
        Unmarshaller<CreateBucketResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Location", targetDepth)) {
                    createBucketResult.setLocation(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
