...
/**
 * Client for accessing Amazon Simple Storage Service. All service calls made
 * using this client are blocking, and will not return until the service call
 * completes.
 * <p>
 * <p/>
 */
public class AmazonSimpleStorageServiceClient extends AmazonWebServiceClient implements
        AmazonSimpleStorageService {
    /** Provider for AWS credentials. */
    private AWSCredentialsProvider awsCredentialsProvider;

    /**
     * List of exception unmarshallers for all Amazon Simple Storage Service
     * exceptions.
     */
     ...
     * AmazonSimpleStorageService. A credentials provider chain will be used
     ...
     */
    @Deprecated
    public AmazonSimpleStorageServiceClient() {
     ...
     *            how this client connects to AmazonSimpleStorageService (ex:
     *            proxy settings, retry counts, etc.).
     * @see DefaultAWSCredentialsProviderChain
     */
    @Deprecated
    public AmazonSimpleStorageServiceClient(ClientConfiguration clientConfiguration) {
        this(new DefaultAWSCredentialsProviderChain(), clientConfiguration);
    }

    /**
     * Constructs a new client to invoke service methods on
     * AmazonSimpleStorageService using the specified AWS account credentials.
     * <p>
     ...
     *         AmazonSimpleStorageServiceClient client = new AmazonSimpleStorageServiceClient(
     ...
     */
    public AmazonSimpleStorageServiceClient(AWSCredentials awsCredentials) {
     ...
     *            services.
     */
    public AmazonSimpleStorageServiceClient(AWSCredentialsProvider awsCredentialsProvider) {
    ...
    private void init() {
        ...
        exceptionUnmarshallers.add(new NoSuchKeyExceptionUnmarshaller());
        exceptionUnmarshallers.add(new NoSuchUploadExceptionUnmarshaller());
        exceptionUnmarshallers.add(new ObjectAlreadyInActiveTierErrorExceptionUnmarshaller());
        exceptionUnmarshallers.add(new ObjectNotInActiveTierErrorExceptionUnmarshaller());
        exceptionUnmarshallers.add(new StandardErrorUnmarshaller());

        // calling this.setEndPoint(...) will also modify the signer accordingly
        this.setEndpoint("s3.us-east-1.amazonaws.com");
    ...
    public AbortMultipartUploadResult abortMultipartUpload(
        ...
        try {
            request = new AbortMultipartUploadRequestMarshaller()
                    .marshall(abortMultipartUploadRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new AbortMultipartUploadResultStaxUnmarshaller(),
                    executionContext);
    ...
    public CompleteMultipartUploadResult completeMultipartUpload(
        ...
        try {
            request = new CompleteMultipartUploadRequestMarshaller()
                    .marshall(completeMultipartUploadRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new CompleteMultipartUploadResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public CopyObjectResult copyObject(CopyObjectRequest copyObjectRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(copyObjectRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<CopyObjectRequest> request = null;
        Response<CopyObjectResult> response = null;
        try {
            request = new CopyObjectRequestMarshaller().marshall(copyObjectRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new CopyObjectResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public CreateBucketResult createBucket(CreateBucketRequest createBucketRequest)
        ...
        try {
            request = new CreateBucketRequestMarshaller().marshall(createBucketRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new CreateBucketResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
     ...
     *             data in the request, or a server side issue.
     */
    public CreateMultipartUploadResult createMultipartUpload(
            CreateMultipartUploadRequest createMultipartUploadRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(createMultipartUploadRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<CreateMultipartUploadRequest> request = null;
        Response<CreateMultipartUploadResult> response = null;
        try {
            request = new CreateMultipartUploadRequestMarshaller()
                    .marshall(createMultipartUploadRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new CreateMultipartUploadResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public void deleteBucket(DeleteBucketRequest deleteBucketRequest)
        ...
        try {
            request = new DeleteBucketRequestMarshaller().marshall(deleteBucketRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
     ...
     *             data in the request, or a server side issue.
     */
    public void deleteBucketAnalyticsConfiguration(
            DeleteBucketAnalyticsConfigurationRequest deleteBucketAnalyticsConfigurationRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(deleteBucketAnalyticsConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<DeleteBucketAnalyticsConfigurationRequest> request = null;
        Response<Void> response = null;
        try {
            request = new DeleteBucketAnalyticsConfigurationRequestMarshaller()
                    .marshall(deleteBucketAnalyticsConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
    ...
    public void deleteBucketCors(DeleteBucketCorsRequest deleteBucketCorsRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(deleteBucketCorsRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<DeleteBucketCorsRequest> request = null;
        Response<Void> response = null;
        try {
            request = new DeleteBucketCorsRequestMarshaller().marshall(deleteBucketCorsRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void deleteBucketEncryption(DeleteBucketEncryptionRequest deleteBucketEncryptionRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(deleteBucketEncryptionRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<DeleteBucketEncryptionRequest> request = null;
        Response<Void> response = null;
        try {
            request = new DeleteBucketEncryptionRequestMarshaller()
                    .marshall(deleteBucketEncryptionRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
    ...
    public void deleteBucketInventoryConfiguration(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(deleteBucketInventoryConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<DeleteBucketInventoryConfigurationRequest> request = null;
        Response<Void> response = null;
        try {
            request = new DeleteBucketInventoryConfigurationRequestMarshaller()
                    .marshall(deleteBucketInventoryConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
    ...
    public void deleteBucketLifecycle(DeleteBucketLifecycleRequest deleteBucketLifecycleRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(deleteBucketLifecycleRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<DeleteBucketLifecycleRequest> request = null;
        Response<Void> response = null;
        try {
            request = new DeleteBucketLifecycleRequestMarshaller()
                    .marshall(deleteBucketLifecycleRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
    ...
    public void deleteBucketMetricsConfiguration(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(deleteBucketMetricsConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<DeleteBucketMetricsConfigurationRequest> request = null;
        Response<Void> response = null;
        try {
            request = new DeleteBucketMetricsConfigurationRequestMarshaller()
                    .marshall(deleteBucketMetricsConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
    ...
    public void deleteBucketPolicy(DeleteBucketPolicyRequest deleteBucketPolicyRequest)
        ...
        Response<Void> response = null;
        try {
            request = new DeleteBucketPolicyRequestMarshaller().marshall(deleteBucketPolicyRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
    ...
    public void deleteBucketReplication(
        ...
        Response<Void> response = null;
        try {
            request = new DeleteBucketReplicationRequestMarshaller()
                    .marshall(deleteBucketReplicationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
    ...
    public void deleteBucketTagging(DeleteBucketTaggingRequest deleteBucketTaggingRequest)
        ...
        Response<Void> response = null;
        try {
            request = new DeleteBucketTaggingRequestMarshaller()
                    .marshall(deleteBucketTaggingRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void deleteBucketWebsite(DeleteBucketWebsiteRequest deleteBucketWebsiteRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(deleteBucketWebsiteRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<DeleteBucketWebsiteRequest> request = null;
        Response<Void> response = null;
        try {
            request = new DeleteBucketWebsiteRequestMarshaller()
                    .marshall(deleteBucketWebsiteRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
    ...
    public DeleteObjectResult deleteObject(DeleteObjectRequest deleteObjectRequest)
        ...
        try {
            request = new DeleteObjectRequestMarshaller().marshall(deleteObjectRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new DeleteObjectResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public DeleteObjectTaggingResult deleteObjectTagging(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(deleteObjectTaggingRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<DeleteObjectTaggingRequest> request = null;
        Response<DeleteObjectTaggingResult> response = null;
        try {
            request = new DeleteObjectTaggingRequestMarshaller()
                    .marshall(deleteObjectTaggingRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new DeleteObjectTaggingResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public DeleteObjectsResult deleteObjects(DeleteObjectsRequest deleteObjectsRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(deleteObjectsRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<DeleteObjectsRequest> request = null;
        Response<DeleteObjectsResult> response = null;
        try {
            request = new DeleteObjectsRequestMarshaller().marshall(deleteObjectsRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new DeleteObjectsResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
     ...
     *             data in the request, or a server side issue.
     */
    public void deletePublicAccessBlock(
        ...
        Response<Void> response = null;
        try {
            request = new DeletePublicAccessBlockRequestMarshaller()
                    .marshall(deletePublicAccessBlockRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public GetBucketAccelerateConfigurationResult getBucketAccelerateConfiguration(
            GetBucketAccelerateConfigurationRequest getBucketAccelerateConfigurationRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketAccelerateConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketAccelerateConfigurationRequest> request = null;
        Response<GetBucketAccelerateConfigurationResult> response = null;
        try {
            request = new GetBucketAccelerateConfigurationRequestMarshaller()
                    .marshall(getBucketAccelerateConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request,
                    new GetBucketAccelerateConfigurationResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public GetBucketAclResult getBucketAcl(GetBucketAclRequest getBucketAclRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketAclRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketAclRequest> request = null;
        Response<GetBucketAclResult> response = null;
        try {
            request = new GetBucketAclRequestMarshaller().marshall(getBucketAclRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketAclResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public GetBucketAnalyticsConfigurationResult getBucketAnalyticsConfiguration(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketAnalyticsConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketAnalyticsConfigurationRequest> request = null;
        Response<GetBucketAnalyticsConfigurationResult> response = null;
        try {
            request = new GetBucketAnalyticsConfigurationRequestMarshaller()
                    .marshall(getBucketAnalyticsConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketAnalyticsConfigurationResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public GetBucketCorsResult getBucketCors(GetBucketCorsRequest getBucketCorsRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketCorsRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketCorsRequest> request = null;
        Response<GetBucketCorsResult> response = null;
        try {
            request = new GetBucketCorsRequestMarshaller().marshall(getBucketCorsRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketCorsResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public GetBucketEncryptionResult getBucketEncryption(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketEncryptionRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketEncryptionRequest> request = null;
        Response<GetBucketEncryptionResult> response = null;
        try {
            request = new GetBucketEncryptionRequestMarshaller()
                    .marshall(getBucketEncryptionRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketEncryptionResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public GetBucketInventoryConfigurationResult getBucketInventoryConfiguration(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketInventoryConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketInventoryConfigurationRequest> request = null;
        Response<GetBucketInventoryConfigurationResult> response = null;
        try {
            request = new GetBucketInventoryConfigurationRequestMarshaller()
                    .marshall(getBucketInventoryConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketInventoryConfigurationResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     */
    @Deprecated
    public GetBucketLifecycleResult getBucketLifecycle(
            GetBucketLifecycleRequest getBucketLifecycleRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketLifecycleRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketLifecycleRequest> request = null;
        Response<GetBucketLifecycleResult> response = null;
        try {
            request = new GetBucketLifecycleRequestMarshaller().marshall(getBucketLifecycleRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketLifecycleResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     *             data in the request, or a server side issue.
     */
    public GetBucketLifecycleConfigurationResult getBucketLifecycleConfiguration(
        ...
        try {
            request = new GetBucketLifecycleConfigurationRequestMarshaller()
                    .marshall(getBucketLifecycleConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketLifecycleConfigurationResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     *             data in the request, or a server side issue.
     */
    public GetBucketLocationResult getBucketLocation(
            GetBucketLocationRequest getBucketLocationRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketLocationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketLocationRequest> request = null;
        Response<GetBucketLocationResult> response = null;
        try {
            request = new GetBucketLocationRequestMarshaller().marshall(getBucketLocationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketLocationResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public GetBucketLoggingResult getBucketLogging(GetBucketLoggingRequest getBucketLoggingRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketLoggingRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketLoggingRequest> request = null;
        Response<GetBucketLoggingResult> response = null;
        try {
            request = new GetBucketLoggingRequestMarshaller().marshall(getBucketLoggingRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketLoggingResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public GetBucketMetricsConfigurationResult getBucketMetricsConfiguration(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketMetricsConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketMetricsConfigurationRequest> request = null;
        Response<GetBucketMetricsConfigurationResult> response = null;
        try {
            request = new GetBucketMetricsConfigurationRequestMarshaller()
                    .marshall(getBucketMetricsConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketMetricsConfigurationResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     */
    @Deprecated
    public GetBucketNotificationResult getBucketNotification(
            GetBucketNotificationRequest getBucketNotificationRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketNotificationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketNotificationRequest> request = null;
        Response<GetBucketNotificationResult> response = null;
        try {
            request = new GetBucketNotificationRequestMarshaller()
                    .marshall(getBucketNotificationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketNotificationResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     *             data in the request, or a server side issue.
     */
    public GetBucketNotificationConfigurationResult getBucketNotificationConfiguration(
            GetBucketNotificationConfigurationRequest getBucketNotificationConfigurationRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketNotificationConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketNotificationConfigurationRequest> request = null;
        Response<GetBucketNotificationConfigurationResult> response = null;
        try {
            request = new GetBucketNotificationConfigurationRequestMarshaller()
                    .marshall(getBucketNotificationConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request,
                    new GetBucketNotificationConfigurationResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public GetBucketPolicyResult getBucketPolicy(GetBucketPolicyRequest getBucketPolicyRequest)
        ...
        try {
            request = new GetBucketPolicyRequestMarshaller().marshall(getBucketPolicyRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketPolicyResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public GetBucketPolicyStatusResult getBucketPolicyStatus(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketPolicyStatusRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketPolicyStatusRequest> request = null;
        Response<GetBucketPolicyStatusResult> response = null;
        try {
            request = new GetBucketPolicyStatusRequestMarshaller()
                    .marshall(getBucketPolicyStatusRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketPolicyStatusResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     *             data in the request, or a server side issue.
     */
    public GetBucketReplicationResult getBucketReplication(
        ...
        try {
            request = new GetBucketReplicationRequestMarshaller()
                    .marshall(getBucketReplicationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketReplicationResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     *             data in the request, or a server side issue.
     */
    public GetBucketRequestPaymentResult getBucketRequestPayment(
            GetBucketRequestPaymentRequest getBucketRequestPaymentRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketRequestPaymentRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketRequestPaymentRequest> request = null;
        Response<GetBucketRequestPaymentResult> response = null;
        try {
            request = new GetBucketRequestPaymentRequestMarshaller()
                    .marshall(getBucketRequestPaymentRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketRequestPaymentResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public GetBucketTaggingResult getBucketTagging(GetBucketTaggingRequest getBucketTaggingRequest)
        ...
        try {
            request = new GetBucketTaggingRequestMarshaller().marshall(getBucketTaggingRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketTaggingResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     *             data in the request, or a server side issue.
     */
    public GetBucketVersioningResult getBucketVersioning(
        ...
        try {
            request = new GetBucketVersioningRequestMarshaller()
                    .marshall(getBucketVersioningRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketVersioningResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public GetBucketWebsiteResult getBucketWebsite(GetBucketWebsiteRequest getBucketWebsiteRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getBucketWebsiteRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetBucketWebsiteRequest> request = null;
        Response<GetBucketWebsiteResult> response = null;
        try {
            request = new GetBucketWebsiteRequestMarshaller().marshall(getBucketWebsiteRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetBucketWebsiteResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public GetObjectResult getObject(GetObjectRequest getObjectRequest)
        ...
        try {
            ...
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetObjectResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public GetObjectAclResult getObjectAcl(GetObjectAclRequest getObjectAclRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getObjectAclRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetObjectAclRequest> request = null;
        Response<GetObjectAclResult> response = null;
        try {
            request = new GetObjectAclRequestMarshaller().marshall(getObjectAclRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetObjectAclResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public GetObjectLegalHoldResult getObjectLegalHold(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getObjectLegalHoldRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetObjectLegalHoldRequest> request = null;
        Response<GetObjectLegalHoldResult> response = null;
        try {
            request = new GetObjectLegalHoldRequestMarshaller().marshall(getObjectLegalHoldRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetObjectLegalHoldResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public GetObjectLockConfigurationResult getObjectLockConfiguration(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getObjectLockConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetObjectLockConfigurationRequest> request = null;
        Response<GetObjectLockConfigurationResult> response = null;
        try {
            request = new GetObjectLockConfigurationRequestMarshaller()
                    .marshall(getObjectLockConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetObjectLockConfigurationResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public GetObjectRetentionResult getObjectRetention(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getObjectRetentionRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetObjectRetentionRequest> request = null;
        Response<GetObjectRetentionResult> response = null;
        try {
            request = new GetObjectRetentionRequestMarshaller().marshall(getObjectRetentionRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetObjectRetentionResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public GetObjectTaggingResult getObjectTagging(GetObjectTaggingRequest getObjectTaggingRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getObjectTaggingRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetObjectTaggingRequest> request = null;
        Response<GetObjectTaggingResult> response = null;
        try {
            request = new GetObjectTaggingRequestMarshaller().marshall(getObjectTaggingRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetObjectTaggingResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     *             data in the request, or a server side issue.
     */
    public GetObjectTorrentResult getObjectTorrent(GetObjectTorrentRequest getObjectTorrentRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(getObjectTorrentRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<GetObjectTorrentRequest> request = null;
        Response<GetObjectTorrentResult> response = null;
        try {
            request = new GetObjectTorrentRequestMarshaller().marshall(getObjectTorrentRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetObjectTorrentResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public GetPublicAccessBlockResult getPublicAccessBlock(
        ...
        try {
            request = new GetPublicAccessBlockRequestMarshaller()
                    .marshall(getPublicAccessBlockRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetPublicAccessBlockResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     *             data in the request, or a server side issue.
     */
    public void headBucket(HeadBucketRequest headBucketRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(headBucketRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<HeadBucketRequest> request = null;
        Response<Void> response = null;
        try {
            request = new HeadBucketRequestMarshaller().marshall(headBucketRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
    ...
    public HeadObjectResult headObject(HeadObjectRequest headObjectRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(headObjectRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<HeadObjectRequest> request = null;
        Response<HeadObjectResult> response = null;
        try {
            request = new HeadObjectRequestMarshaller().marshall(headObjectRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new HeadObjectResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public ListBucketAnalyticsConfigurationsResult listBucketAnalyticsConfigurations(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(listBucketAnalyticsConfigurationsRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<ListBucketAnalyticsConfigurationsRequest> request = null;
        Response<ListBucketAnalyticsConfigurationsResult> response = null;
        try {
            request = new ListBucketAnalyticsConfigurationsRequestMarshaller()
                    .marshall(listBucketAnalyticsConfigurationsRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request,
                    new ListBucketAnalyticsConfigurationsResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public ListBucketInventoryConfigurationsResult listBucketInventoryConfigurations(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(listBucketInventoryConfigurationsRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<ListBucketInventoryConfigurationsRequest> request = null;
        Response<ListBucketInventoryConfigurationsResult> response = null;
        try {
            request = new ListBucketInventoryConfigurationsRequestMarshaller()
                    .marshall(listBucketInventoryConfigurationsRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request,
                    new ListBucketInventoryConfigurationsResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public ListBucketMetricsConfigurationsResult listBucketMetricsConfigurations(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(listBucketMetricsConfigurationsRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<ListBucketMetricsConfigurationsRequest> request = null;
        Response<ListBucketMetricsConfigurationsResult> response = null;
        try {
            request = new ListBucketMetricsConfigurationsRequestMarshaller()
                    .marshall(listBucketMetricsConfigurationsRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new ListBucketMetricsConfigurationsResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public ListBucketsResult listBuckets(ListBucketsRequest listBucketsRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(listBucketsRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<ListBucketsRequest> request = null;
        Response<ListBucketsResult> response = null;
        try {
            request = new ListBucketsRequestMarshaller().marshall(listBucketsRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new ListBucketsResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public ListMultipartUploadsResult listMultipartUploads(
        ...
        try {
            request = new ListMultipartUploadsRequestMarshaller()
                    .marshall(listMultipartUploadsRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new ListMultipartUploadsResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     *             data in the request, or a server side issue.
     */
    public ListObjectVersionsResult listObjectVersions(
            ListObjectVersionsRequest listObjectVersionsRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(listObjectVersionsRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<ListObjectVersionsRequest> request = null;
        Response<ListObjectVersionsResult> response = null;
        try {
            request = new ListObjectVersionsRequestMarshaller().marshall(listObjectVersionsRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new ListObjectVersionsResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public ListObjectsResult listObjects(ListObjectsRequest listObjectsRequest)
        ...
        try {
            request = new ListObjectsRequestMarshaller().marshall(listObjectsRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new ListObjectsResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public ListObjectsV2Result listObjectsV2(ListObjectsV2Request listObjectsV2Request)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(listObjectsV2Request);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<ListObjectsV2Request> request = null;
        Response<ListObjectsV2Result> response = null;
        try {
            request = new ListObjectsV2RequestMarshaller().marshall(listObjectsV2Request);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new ListObjectsV2ResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public ListPartsResult listParts(ListPartsRequest listPartsRequest)
        ...
        try {
            ...
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new ListPartsResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketAccelerateConfiguration(
            PutBucketAccelerateConfigurationRequest putBucketAccelerateConfigurationRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putBucketAccelerateConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutBucketAccelerateConfigurationRequest> request = null;
        Response<Void> response = null;
        try {
            request = new PutBucketAccelerateConfigurationRequestMarshaller()
                    .marshall(putBucketAccelerateConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketAcl(PutBucketAclRequest putBucketAclRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putBucketAclRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutBucketAclRequest> request = null;
        Response<Void> response = null;
        try {
            request = new PutBucketAclRequestMarshaller().marshall(putBucketAclRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketAnalyticsConfiguration(
            PutBucketAnalyticsConfigurationRequest putBucketAnalyticsConfigurationRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putBucketAnalyticsConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutBucketAnalyticsConfigurationRequest> request = null;
        Response<Void> response = null;
        try {
            request = new PutBucketAnalyticsConfigurationRequestMarshaller()
                    .marshall(putBucketAnalyticsConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketCors(PutBucketCorsRequest putBucketCorsRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putBucketCorsRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutBucketCorsRequest> request = null;
        Response<Void> response = null;
        try {
            request = new PutBucketCorsRequestMarshaller().marshall(putBucketCorsRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketEncryption(PutBucketEncryptionRequest putBucketEncryptionRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putBucketEncryptionRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutBucketEncryptionRequest> request = null;
        Response<Void> response = null;
        try {
            request = new PutBucketEncryptionRequestMarshaller()
                    .marshall(putBucketEncryptionRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
    ...
    public void putBucketInventoryConfiguration(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putBucketInventoryConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutBucketInventoryConfigurationRequest> request = null;
        Response<Void> response = null;
        try {
            request = new PutBucketInventoryConfigurationRequestMarshaller()
                    .marshall(putBucketInventoryConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     */
    @Deprecated
    public void putBucketLifecycle(PutBucketLifecycleRequest putBucketLifecycleRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putBucketLifecycleRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutBucketLifecycleRequest> request = null;
        Response<Void> response = null;
        try {
            request = new PutBucketLifecycleRequestMarshaller().marshall(putBucketLifecycleRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketLifecycleConfiguration(
        ...
        Response<Void> response = null;
        try {
            request = new PutBucketLifecycleConfigurationRequestMarshaller()
                    .marshall(putBucketLifecycleConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketLogging(PutBucketLoggingRequest putBucketLoggingRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putBucketLoggingRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutBucketLoggingRequest> request = null;
        Response<Void> response = null;
        try {
            request = new PutBucketLoggingRequestMarshaller().marshall(putBucketLoggingRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketMetricsConfiguration(
            PutBucketMetricsConfigurationRequest putBucketMetricsConfigurationRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putBucketMetricsConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutBucketMetricsConfigurationRequest> request = null;
        Response<Void> response = null;
        try {
            request = new PutBucketMetricsConfigurationRequestMarshaller()
                    .marshall(putBucketMetricsConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     */
    @Deprecated
    public void putBucketNotification(PutBucketNotificationRequest putBucketNotificationRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putBucketNotificationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutBucketNotificationRequest> request = null;
        Response<Void> response = null;
        try {
            request = new PutBucketNotificationRequestMarshaller()
                    .marshall(putBucketNotificationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketNotificationConfiguration(
            PutBucketNotificationConfigurationRequest putBucketNotificationConfigurationRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putBucketNotificationConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutBucketNotificationConfigurationRequest> request = null;
        Response<Void> response = null;
        try {
            request = new PutBucketNotificationConfigurationRequestMarshaller()
                    .marshall(putBucketNotificationConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketPolicy(PutBucketPolicyRequest putBucketPolicyRequest)
            throws AmazonServiceException, AmazonClientException {
        ...
        Response<Void> response = null;
        try {
            request = new PutBucketPolicyRequestMarshaller().marshall(putBucketPolicyRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketReplication(PutBucketReplicationRequest putBucketReplicationRequest)
            throws AmazonServiceException, AmazonClientException {
        ...
        Response<Void> response = null;
        try {
            request = new PutBucketReplicationRequestMarshaller()
                    .marshall(putBucketReplicationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketRequestPayment(
            PutBucketRequestPaymentRequest putBucketRequestPaymentRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putBucketRequestPaymentRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutBucketRequestPaymentRequest> request = null;
        Response<Void> response = null;
        try {
            request = new PutBucketRequestPaymentRequestMarshaller()
                    .marshall(putBucketRequestPaymentRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketTagging(PutBucketTaggingRequest putBucketTaggingRequest)
            throws AmazonServiceException, AmazonClientException {
        ...
        Response<Void> response = null;
        try {
            request = new PutBucketTaggingRequestMarshaller().marshall(putBucketTaggingRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketVersioning(PutBucketVersioningRequest putBucketVersioningRequest)
            throws AmazonServiceException, AmazonClientException {
        ...
        Response<Void> response = null;
        try {
            request = new PutBucketVersioningRequestMarshaller()
                    .marshall(putBucketVersioningRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
     ...
     *             data in the request, or a server side issue.
     */
    public void putBucketWebsite(PutBucketWebsiteRequest putBucketWebsiteRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putBucketWebsiteRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutBucketWebsiteRequest> request = null;
        Response<Void> response = null;
        try {
            request = new PutBucketWebsiteRequestMarshaller().marshall(putBucketWebsiteRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
    ...
    public PutObjectResult putObject(PutObjectRequest putObjectRequest)
        ...
        try {
            ...
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new PutObjectResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public PutObjectAclResult putObjectAcl(PutObjectAclRequest putObjectAclRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putObjectAclRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutObjectAclRequest> request = null;
        Response<PutObjectAclResult> response = null;
        try {
            request = new PutObjectAclRequestMarshaller().marshall(putObjectAclRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new PutObjectAclResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
     ...
     *             data in the request, or a server side issue.
     */
    public PutObjectLegalHoldResult putObjectLegalHold(
            PutObjectLegalHoldRequest putObjectLegalHoldRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putObjectLegalHoldRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutObjectLegalHoldRequest> request = null;
        Response<PutObjectLegalHoldResult> response = null;
        try {
            request = new PutObjectLegalHoldRequestMarshaller().marshall(putObjectLegalHoldRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new PutObjectLegalHoldResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     *             data in the request, or a server side issue.
     */
    public PutObjectLockConfigurationResult putObjectLockConfiguration(
            PutObjectLockConfigurationRequest putObjectLockConfigurationRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putObjectLockConfigurationRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutObjectLockConfigurationRequest> request = null;
        Response<PutObjectLockConfigurationResult> response = null;
        try {
            request = new PutObjectLockConfigurationRequestMarshaller()
                    .marshall(putObjectLockConfigurationRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new PutObjectLockConfigurationResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     *             data in the request, or a server side issue.
     */
    public PutObjectRetentionResult putObjectRetention(
            PutObjectRetentionRequest putObjectRetentionRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putObjectRetentionRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutObjectRetentionRequest> request = null;
        Response<PutObjectRetentionResult> response = null;
        try {
            request = new PutObjectRetentionRequestMarshaller().marshall(putObjectRetentionRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new PutObjectRetentionResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public PutObjectTaggingResult putObjectTagging(PutObjectTaggingRequest putObjectTaggingRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(putObjectTaggingRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<PutObjectTaggingRequest> request = null;
        Response<PutObjectTaggingResult> response = null;
        try {
            request = new PutObjectTaggingRequestMarshaller().marshall(putObjectTaggingRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new PutObjectTaggingResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public void putPublicAccessBlock(PutPublicAccessBlockRequest putPublicAccessBlockRequest)
        ...
        Response<Void> response = null;
        try {
            request = new PutPublicAccessBlockRequestMarshaller()
                    .marshall(putPublicAccessBlockRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            invoke(request, null, executionContext);
        } finally {
    ...
    public RestoreObjectResult restoreObject(RestoreObjectRequest restoreObjectRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(restoreObjectRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<RestoreObjectRequest> request = null;
        Response<RestoreObjectResult> response = null;
        try {
            request = new RestoreObjectRequestMarshaller().marshall(restoreObjectRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new RestoreObjectResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public SelectObjectContentResult selectObjectContent(
            ...
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(selectObjectContentRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<SelectObjectContentRequest> request = null;
        Response<SelectObjectContentResult> response = null;
        try {
            request = new SelectObjectContentRequestMarshaller()
                    .marshall(selectObjectContentRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new SelectObjectContentResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
    ...
    public UploadPartResult uploadPart(UploadPartRequest uploadPartRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(uploadPartRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<UploadPartRequest> request = null;
        Response<UploadPartResult> response = null;
        try {
            request = new UploadPartRequestMarshaller().marshall(uploadPartRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new UploadPartResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
    ...
    public UploadPartCopyResult uploadPartCopy(UploadPartCopyRequest uploadPartCopyRequest)
            throws AmazonServiceException, AmazonClientException {
        ExecutionContext executionContext = createExecutionContext(uploadPartCopyRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        awsRequestMetrics.startEvent(Field.ClientExecuteTime);
        Request<UploadPartCopyRequest> request = null;
        Response<UploadPartCopyResult> response = null;
        try {
            request = new UploadPartCopyRequestMarshaller().marshall(uploadPartCopyRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new UploadPartCopyResultStaxUnmarshaller(), executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
            endClientExecution(awsRequestMetrics, request, response);
