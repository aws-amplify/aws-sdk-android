...
public interface Upload extends Transfer {
     ...
     * be used to resume the upload. Upload cannot be paused in the following
     * cases.
     * <ul>
     ...
     * </ul>
     * In such cases, aborts the uploads and a <code>PauseFailure</code>
     * exception is thrown
     *
     ...
     * that can be used to resume the upload. Upload cannot be paused in the
     * following cases.
     * <ul>
     * <li>The data source is an input stream.</li>
     * <li>Client side encryption is used.</li>
     ...
     * action is taken.
     *
     * @param forceCancelTransfers a boolean to forcefully abort the existing
     *            uploads if pause cannot be done.
