...
public interface ObjectMetadataProvider {
     ...
     * <code>TransferManager</code> and gives an opportunity to specify the
     * metadata for the file.
     * @param file The file being uploaded.
     * @param metadata The default metadata for the file. You can modify this
     * object to specify your own metadata.
     */
