...
/**
 * JSON request marshaller for DeleteAliasRequest
 */
    ...
    public Request<DeleteAliasRequest> marshall(DeleteAliasRequest deleteAliasRequest) {
        if (deleteAliasRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteAliasRequest)");
        }

        Request<DeleteAliasRequest> request = new DefaultRequest<DeleteAliasRequest>(
                deleteAliasRequest, "AmazonWorkMail");
        ...
        try {
            ...
            if (deleteAliasRequest.getOrganizationId() != null) {
                String organizationId = deleteAliasRequest.getOrganizationId();
                jsonWriter.name("OrganizationId");
                jsonWriter.value(organizationId);
            }
            if (deleteAliasRequest.getEntityId() != null) {
                String entityId = deleteAliasRequest.getEntityId();
                jsonWriter.name("EntityId");
                jsonWriter.value(entityId);
            }
            if (deleteAliasRequest.getAlias() != null) {
                String alias = deleteAliasRequest.getAlias();
