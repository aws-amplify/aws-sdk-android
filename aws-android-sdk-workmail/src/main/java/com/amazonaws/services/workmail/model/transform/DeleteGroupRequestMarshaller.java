...
public class DeleteGroupRequestMarshaller implements
    ...
    public Request<DeleteGroupRequest> marshall(DeleteGroupRequest deleteGroupRequest) {
        ...
        Request<DeleteGroupRequest> request = new DefaultRequest<DeleteGroupRequest>(
                deleteGroupRequest, "AmazonWorkMail");
        ...
        try {
            ...
            if (deleteGroupRequest.getOrganizationId() != null) {
                String organizationId = deleteGroupRequest.getOrganizationId();
                jsonWriter.name("OrganizationId");
                jsonWriter.value(organizationId);
            }
            if (deleteGroupRequest.getGroupId() != null) {
                String groupId = deleteGroupRequest.getGroupId();
