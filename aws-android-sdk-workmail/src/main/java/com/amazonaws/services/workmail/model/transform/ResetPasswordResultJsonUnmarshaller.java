...
/**
 * JSON unmarshaller for response ResetPasswordResult
 */
public class ResetPasswordResultJsonUnmarshaller implements
        Unmarshaller<ResetPasswordResult, JsonUnmarshallerContext> {
