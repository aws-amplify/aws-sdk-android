...
/**
 * JSON request marshaller for CreateAliasRequest
 */
    ...
    public Request<CreateAliasRequest> marshall(CreateAliasRequest createAliasRequest) {
        if (createAliasRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateAliasRequest)");
        }

        Request<CreateAliasRequest> request = new DefaultRequest<CreateAliasRequest>(
                createAliasRequest, "AmazonWorkMail");
        ...
        try {
            ...
            if (createAliasRequest.getOrganizationId() != null) {
                String organizationId = createAliasRequest.getOrganizationId();
                jsonWriter.name("OrganizationId");
                jsonWriter.value(organizationId);
            }
            if (createAliasRequest.getEntityId() != null) {
                String entityId = createAliasRequest.getEntityId();
                jsonWriter.name("EntityId");
                jsonWriter.value(entityId);
            }
            if (createAliasRequest.getAlias() != null) {
                String alias = createAliasRequest.getAlias();
