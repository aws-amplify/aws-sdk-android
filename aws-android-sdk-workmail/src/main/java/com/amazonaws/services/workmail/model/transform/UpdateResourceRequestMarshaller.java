...
public class UpdateResourceRequestMarshaller implements
    ...
    public Request<UpdateResourceRequest> marshall(UpdateResourceRequest updateResourceRequest) {
        ...
        Request<UpdateResourceRequest> request = new DefaultRequest<UpdateResourceRequest>(
                updateResourceRequest, "AmazonWorkMail");
        ...
        try {
            ...
            if (updateResourceRequest.getOrganizationId() != null) {
                String organizationId = updateResourceRequest.getOrganizationId();
                jsonWriter.name("OrganizationId");
                jsonWriter.value(organizationId);
            }
            if (updateResourceRequest.getResourceId() != null) {
                String resourceId = updateResourceRequest.getResourceId();
            ...
            if (updateResourceRequest.getBookingOptions() != null) {
                BookingOptions bookingOptions = updateResourceRequest.getBookingOptions();
                jsonWriter.name("BookingOptions");
                BookingOptionsJsonMarshaller.getInstance().marshall(bookingOptions, jsonWriter);
            }
