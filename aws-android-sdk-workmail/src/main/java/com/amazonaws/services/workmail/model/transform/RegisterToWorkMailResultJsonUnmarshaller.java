...
/**
 * JSON unmarshaller for response RegisterToWorkMailResult
 */
public class RegisterToWorkMailResultJsonUnmarshaller implements
        Unmarshaller<RegisterToWorkMailResult, JsonUnmarshallerContext> {
