...
/**
 * JSON request marshaller for ResetPasswordRequest
 */
    ...
    public Request<ResetPasswordRequest> marshall(ResetPasswordRequest resetPasswordRequest) {
        if (resetPasswordRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ResetPasswordRequest)");
        }

        Request<ResetPasswordRequest> request = new DefaultRequest<ResetPasswordRequest>(
                resetPasswordRequest, "AmazonWorkMail");
        ...
        try {
            ...
            if (resetPasswordRequest.getOrganizationId() != null) {
                String organizationId = resetPasswordRequest.getOrganizationId();
