...
/**
 * JSON request marshaller for DeleteResourceRequest
 */
    ...
    public Request<DeleteResourceRequest> marshall(DeleteResourceRequest deleteResourceRequest) {
        if (deleteResourceRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteResourceRequest)");
        }

        Request<DeleteResourceRequest> request = new DefaultRequest<DeleteResourceRequest>(
                deleteResourceRequest, "AmazonWorkMail");
        ...
        try {
            ...
            if (deleteResourceRequest.getOrganizationId() != null) {
                String organizationId = deleteResourceRequest.getOrganizationId();
                jsonWriter.name("OrganizationId");
                jsonWriter.value(organizationId);
            }
            if (deleteResourceRequest.getResourceId() != null) {
                String resourceId = deleteResourceRequest.getResourceId();
