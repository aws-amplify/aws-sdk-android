...
/**
 * JSON unmarshaller for response PutRetentionPolicyResult
 */
public class PutRetentionPolicyResultJsonUnmarshaller implements
        Unmarshaller<PutRetentionPolicyResult, JsonUnmarshallerContext> {
