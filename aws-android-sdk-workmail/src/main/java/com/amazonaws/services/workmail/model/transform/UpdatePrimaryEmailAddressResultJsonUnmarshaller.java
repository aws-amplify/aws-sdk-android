...
/**
 * JSON unmarshaller for response UpdatePrimaryEmailAddressResult
 */
public class UpdatePrimaryEmailAddressResultJsonUnmarshaller implements
        Unmarshaller<UpdatePrimaryEmailAddressResult, JsonUnmarshallerContext> {

    public UpdatePrimaryEmailAddressResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
