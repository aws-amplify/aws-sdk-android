...
public class DescribeGroupRequestMarshaller implements
    ...
    public Request<DescribeGroupRequest> marshall(DescribeGroupRequest describeGroupRequest) {
        ...
        Request<DescribeGroupRequest> request = new DefaultRequest<DescribeGroupRequest>(
                describeGroupRequest, "AmazonWorkMail");
        ...
        try {
            ...
            if (describeGroupRequest.getOrganizationId() != null) {
                String organizationId = describeGroupRequest.getOrganizationId();
                jsonWriter.name("OrganizationId");
                jsonWriter.value(organizationId);
            }
            if (describeGroupRequest.getGroupId() != null) {
                String groupId = describeGroupRequest.getGroupId();
