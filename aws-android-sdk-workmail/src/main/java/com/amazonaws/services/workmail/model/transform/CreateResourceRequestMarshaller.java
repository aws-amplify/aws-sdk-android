...
/**
 * JSON request marshaller for CreateResourceRequest
 */
    ...
    public Request<CreateResourceRequest> marshall(CreateResourceRequest createResourceRequest) {
        if (createResourceRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateResourceRequest)");
        }

        Request<CreateResourceRequest> request = new DefaultRequest<CreateResourceRequest>(
                createResourceRequest, "AmazonWorkMail");
        ...
        try {
            ...
            if (createResourceRequest.getOrganizationId() != null) {
                String organizationId = createResourceRequest.getOrganizationId();
                jsonWriter.name("OrganizationId");
                jsonWriter.value(organizationId);
            }
            if (createResourceRequest.getName() != null) {
                String name = createResourceRequest.getName();
                jsonWriter.name("Name");
                jsonWriter.value(name);
            }
            if (createResourceRequest.getType() != null) {
                String type = createResourceRequest.getType();
