...
/**
 * JSON unmarshaller for response GetSignalingChannelEndpointResult
 */
public class GetSignalingChannelEndpointResultJsonUnmarshaller implements
        Unmarshaller<GetSignalingChannelEndpointResult, JsonUnmarshallerContext> {
    ...
    public GetSignalingChannelEndpointResult unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ResourceEndpointList")) {
                getSignalingChannelEndpointResult
                        .setResourceEndpointList(new ListUnmarshaller<ResourceEndpointListItem>(
