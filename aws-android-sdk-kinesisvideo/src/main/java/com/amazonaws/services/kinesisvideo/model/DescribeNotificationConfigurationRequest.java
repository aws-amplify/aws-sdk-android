 ...
 * </p>
 */
public class DescribeNotificationConfigurationRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *         where you want to retrieve the notification configuration. You
     ...
     *            from where you want to retrieve the notification
     *            configuration. You must specify either the
     *            <code>StreamName</code> or the StreamARN.
     *            </p>
     */
