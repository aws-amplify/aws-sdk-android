...
/**
 * JSON unmarshaller for response UpdateNotificationConfigurationResult
 */
public class UpdateNotificationConfigurationResultJsonUnmarshaller implements
        Unmarshaller<UpdateNotificationConfigurationResult, JsonUnmarshallerContext> {

    public UpdateNotificationConfigurationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
