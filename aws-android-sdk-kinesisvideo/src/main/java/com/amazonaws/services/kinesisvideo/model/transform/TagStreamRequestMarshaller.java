...
/**
 * JSON request marshaller for TagStreamRequest
 */
public class TagStreamRequestMarshaller implements
        Marshaller<Request<TagStreamRequest>, TagStreamRequest> {
    ...
    public Request<TagStreamRequest> marshall(TagStreamRequest tagStreamRequest) {
        ...
        Request<TagStreamRequest> request = new DefaultRequest<TagStreamRequest>(tagStreamRequest,
                "AWSKinesisVideo");
        ...
        try {
            ...
            if (tagStreamRequest.getTags() != null) {
                java.util.Map<String, String> tags = tagStreamRequest.getTags();
