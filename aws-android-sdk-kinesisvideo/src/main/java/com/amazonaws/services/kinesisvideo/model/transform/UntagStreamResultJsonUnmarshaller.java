...
/**
 * JSON unmarshaller for response UntagStreamResult
 */
public class UntagStreamResultJsonUnmarshaller implements
        Unmarshaller<UntagStreamResult, JsonUnmarshallerContext> {
