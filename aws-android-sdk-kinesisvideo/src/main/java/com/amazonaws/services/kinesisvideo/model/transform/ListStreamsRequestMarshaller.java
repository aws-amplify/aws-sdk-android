...
public class ListStreamsRequestMarshaller implements
    ...
    public Request<ListStreamsRequest> marshall(ListStreamsRequest listStreamsRequest) {
        ...
        Request<ListStreamsRequest> request = new DefaultRequest<ListStreamsRequest>(
                listStreamsRequest, "AWSKinesisVideo");
        ...
        try {
            ...
            if (listStreamsRequest.getStreamNameCondition() != null) {
                StreamNameCondition streamNameCondition = listStreamsRequest
                        .getStreamNameCondition();
                jsonWriter.name("StreamNameCondition");
                StreamNameConditionJsonMarshaller.getInstance().marshall(streamNameCondition,
                        jsonWriter);
            }
