...
/**
 * JSON unmarshaller for POJO ChannelNameCondition
 */
class ChannelNameConditionJsonUnmarshaller implements
        Unmarshaller<ChannelNameCondition, JsonUnmarshallerContext> {
    ...
    public ChannelNameCondition unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ComparisonOperator")) {
                channelNameCondition.setComparisonOperator(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ComparisonValue")) {
                channelNameCondition.setComparisonValue(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
