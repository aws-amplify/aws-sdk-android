...
public class StartEdgeConfigurationUpdateResult implements Serializable {
     ...
     * invoke this API, the sync status will be set to the <code>SYNCING</code>
     ...
     *         you invoke this API, the sync status will be set to the
     *         <code>SYNCING</code> state. Use the
     *         <code>DescribeEdgeConfiguration</code> API to get the latest
     ...
     *            When you invoke this API, the sync status will be set to the
     *            <code>SYNCING</code> state. Use the
     *            <code>DescribeEdgeConfiguration</code> API to get the latest
     *            status of the edge configuration.
     *            </p>
