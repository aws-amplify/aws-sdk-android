...
/**
 * JSON unmarshaller for POJO SingleMasterChannelEndpointConfiguration
 */
class SingleMasterChannelEndpointConfigurationJsonUnmarshaller implements
    ...
    public SingleMasterChannelEndpointConfiguration unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Protocols")) {
                singleMasterChannelEndpointConfiguration.setProtocols(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Role")) {
                singleMasterChannelEndpointConfiguration.setRole(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
