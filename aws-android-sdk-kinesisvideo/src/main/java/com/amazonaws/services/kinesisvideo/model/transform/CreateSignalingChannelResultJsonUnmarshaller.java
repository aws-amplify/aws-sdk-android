...
/**
 * JSON unmarshaller for response CreateSignalingChannelResult
 */
public class CreateSignalingChannelResultJsonUnmarshaller implements
        Unmarshaller<CreateSignalingChannelResult, JsonUnmarshallerContext> {
    ...
    public CreateSignalingChannelResult unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ChannelARN")) {
                createSignalingChannelResult.setChannelARN(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
