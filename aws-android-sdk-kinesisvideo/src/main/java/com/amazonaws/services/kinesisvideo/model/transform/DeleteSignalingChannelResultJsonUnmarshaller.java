...
/**
 * JSON unmarshaller for response DeleteSignalingChannelResult
 */
public class DeleteSignalingChannelResultJsonUnmarshaller implements
        Unmarshaller<DeleteSignalingChannelResult, JsonUnmarshallerContext> {
