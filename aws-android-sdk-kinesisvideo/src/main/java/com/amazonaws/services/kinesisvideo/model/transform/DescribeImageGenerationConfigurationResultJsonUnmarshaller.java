...
/**
 * JSON unmarshaller for response DescribeImageGenerationConfigurationResult
 */
public class DescribeImageGenerationConfigurationResultJsonUnmarshaller implements
    ...
    public DescribeImageGenerationConfigurationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ImageGenerationConfiguration")) {
                describeImageGenerationConfigurationResult
                        .setImageGenerationConfiguration(ImageGenerationConfigurationJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
