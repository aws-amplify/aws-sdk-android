...
/**
 * JSON unmarshaller for response UpdateStreamResult
 */
public class UpdateStreamResultJsonUnmarshaller implements
        Unmarshaller<UpdateStreamResult, JsonUnmarshallerContext> {
