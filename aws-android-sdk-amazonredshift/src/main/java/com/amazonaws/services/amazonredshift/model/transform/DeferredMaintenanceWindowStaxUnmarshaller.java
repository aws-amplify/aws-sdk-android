...
/**
 * StAX unmarshaller for model DeferredMaintenanceWindow
 */
class DeferredMaintenanceWindowStaxUnmarshaller implements
        Unmarshaller<DeferredMaintenanceWindow, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DeferMaintenanceIdentifier", targetDepth)) {
                    deferredMaintenanceWindow.setDeferMaintenanceIdentifier(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("DeferMaintenanceStartTime", targetDepth)) {
                    deferredMaintenanceWindow.setDeferMaintenanceStartTime(DateStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("DeferMaintenanceEndTime", targetDepth)) {
                    deferredMaintenanceWindow.setDeferMaintenanceEndTime(DateStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
