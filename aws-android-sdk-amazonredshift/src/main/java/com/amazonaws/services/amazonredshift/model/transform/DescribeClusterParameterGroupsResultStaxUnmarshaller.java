...
/**
 * StAX unmarshaller for response DescribeClusterParameterGroupsResult
 */
public class DescribeClusterParameterGroupsResultStaxUnmarshaller implements
        Unmarshaller<DescribeClusterParameterGroupsResult, StaxUnmarshallerContext> {

    public DescribeClusterParameterGroupsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeClusterParameterGroupsResult.setMarker(StringStaxUnmarshaller
