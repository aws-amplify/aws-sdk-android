...
/**
 * StAX request marshaller for DescribeClusterParameterGroupsRequest
 */
    ...
    public Request<DescribeClusterParameterGroupsRequest> marshall(
        ...
        if (describeClusterParameterGroupsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeClusterParameterGroupsRequest)");
        }
        ...
        if (describeClusterParameterGroupsRequest.getParameterGroupName() != null) {
            ...
            String parameterGroupName = describeClusterParameterGroupsRequest
        ...
        if (describeClusterParameterGroupsRequest.getMaxRecords() != null) {
            prefix = "MaxRecords";
            Integer maxRecords = describeClusterParameterGroupsRequest.getMaxRecords();
            request.addParameter(prefix, StringUtils.fromInteger(maxRecords));
        }
        if (describeClusterParameterGroupsRequest.getMarker() != null) {
            prefix = "Marker";
            String marker = describeClusterParameterGroupsRequest.getMarker();
            request.addParameter(prefix, StringUtils.fromString(marker));
        }
        if (describeClusterParameterGroupsRequest.getTagKeys() != null) {
            prefix = "TagKeys";
            java.util.List<String> tagKeys = describeClusterParameterGroupsRequest.getTagKeys();
            int tagKeysIndex = 1;
        ...
        if (describeClusterParameterGroupsRequest.getTagValues() != null) {
            prefix = "TagValues";
            java.util.List<String> tagValues = describeClusterParameterGroupsRequest.getTagValues();
