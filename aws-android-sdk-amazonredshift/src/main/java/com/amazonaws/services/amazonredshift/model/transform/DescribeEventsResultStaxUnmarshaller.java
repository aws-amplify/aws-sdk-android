        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeEventsResult.setMarker(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Events", targetDepth)) {
                    describeEventsResult.withEvents(EventStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
