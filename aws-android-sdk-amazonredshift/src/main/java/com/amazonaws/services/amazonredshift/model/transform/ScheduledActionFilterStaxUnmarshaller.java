...
/**
 * StAX unmarshaller for model ScheduledActionFilter
 */
class ScheduledActionFilterStaxUnmarshaller implements
        Unmarshaller<ScheduledActionFilter, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Name", targetDepth)) {
                    scheduledActionFilter.setName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Values", targetDepth)) {
                    scheduledActionFilter.withValues(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
