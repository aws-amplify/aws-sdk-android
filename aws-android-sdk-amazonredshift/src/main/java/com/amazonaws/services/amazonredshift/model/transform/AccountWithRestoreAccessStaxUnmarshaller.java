...
/**
 * StAX unmarshaller for model AccountWithRestoreAccess
 */
class AccountWithRestoreAccessStaxUnmarshaller implements
        Unmarshaller<AccountWithRestoreAccess, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("AccountId", targetDepth)) {
                    accountWithRestoreAccess.setAccountId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("AccountAlias", targetDepth)) {
                    accountWithRestoreAccess.setAccountAlias(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
