...
/**
 * StAX unmarshaller for response DescribeStorageResult
 */
public class DescribeStorageResultStaxUnmarshaller implements
        Unmarshaller<DescribeStorageResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("TotalBackupSizeInMegaBytes", targetDepth)) {
                    describeStorageResult.setTotalBackupSizeInMegaBytes(DoubleStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("TotalProvisionedStorageInMegaBytes", targetDepth)) {
                    describeStorageResult
                            .setTotalProvisionedStorageInMegaBytes(DoubleStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
