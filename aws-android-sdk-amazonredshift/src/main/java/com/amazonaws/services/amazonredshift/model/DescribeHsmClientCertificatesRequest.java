 ...
 * <code>test</code> for tag values, all HSM client certificates that have any
 ...
 * </p>
 */
public class DescribeHsmClientCertificatesRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *            The identifier of a specific HSM client certificate for which
     *            you want information. If no identifier is specified,
     *            information is returned for all HSM client certificates owned
     ...
     *            key or keys. For example, suppose that you have HSM client
     *            certificates that are tagged with keys called
     *            <code>owner</code> and <code>environment</code>. If you
     *            specify both of these tag keys in the request, Amazon Redshift
     *            returns a response with the HSM client certificates that have
     ...
     *            matching HSM client certificates that are associated with the
     *            specified tag value or values. For example, suppose that you
     *            have HSM client certificates that are tagged with values
