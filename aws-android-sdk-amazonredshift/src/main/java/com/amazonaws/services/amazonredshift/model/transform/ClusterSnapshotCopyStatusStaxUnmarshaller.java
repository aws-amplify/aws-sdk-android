...
/**
 * StAX unmarshaller for model ClusterSnapshotCopyStatus
 */
class ClusterSnapshotCopyStatusStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DestinationRegion", targetDepth)) {
                    clusterSnapshotCopyStatus.setDestinationRegion(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("RetentionPeriod", targetDepth)) {
                    clusterSnapshotCopyStatus.setRetentionPeriod(LongStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ManualSnapshotRetentionPeriod", targetDepth)) {
                    clusterSnapshotCopyStatus
                            .setManualSnapshotRetentionPeriod(IntegerStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("SnapshotCopyGrantName", targetDepth)) {
                    clusterSnapshotCopyStatus.setSnapshotCopyGrantName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
