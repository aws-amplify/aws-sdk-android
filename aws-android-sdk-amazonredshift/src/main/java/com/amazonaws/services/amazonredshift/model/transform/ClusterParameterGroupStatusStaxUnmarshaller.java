...
/**
 * StAX unmarshaller for model ClusterParameterGroupStatus
 */
class ClusterParameterGroupStatusStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ParameterGroupName", targetDepth)) {
                    clusterParameterGroupStatus.setParameterGroupName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ParameterApplyStatus", targetDepth)) {
                    clusterParameterGroupStatus.setParameterApplyStatus(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
