...
/**
 * StAX unmarshaller for model AvailabilityZone
 */
class AvailabilityZoneStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Name", targetDepth)) {
                    availabilityZone.setName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("SupportedPlatforms", targetDepth)) {
                    availabilityZone.withSupportedPlatforms(SupportedPlatformStaxUnmarshaller
