...
/**
 * StAX unmarshaller for model ScheduledActionType
 */
class ScheduledActionTypeStaxUnmarshaller implements
        Unmarshaller<ScheduledActionType, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ResizeCluster", targetDepth)) {
                    scheduledActionType.setResizeCluster(ResizeClusterMessageStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("PauseCluster", targetDepth)) {
                    scheduledActionType.setPauseCluster(PauseClusterMessageStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ResumeCluster", targetDepth)) {
                    scheduledActionType.setResumeCluster(ResumeClusterMessageStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
