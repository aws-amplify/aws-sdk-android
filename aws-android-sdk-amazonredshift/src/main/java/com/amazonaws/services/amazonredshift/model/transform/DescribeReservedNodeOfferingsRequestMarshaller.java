...
/**
 * StAX request marshaller for DescribeReservedNodeOfferingsRequest
 */
    ...
    public Request<DescribeReservedNodeOfferingsRequest> marshall(
        ...
        if (describeReservedNodeOfferingsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeReservedNodeOfferingsRequest)");
        }
        ...
        if (describeReservedNodeOfferingsRequest.getReservedNodeOfferingId() != null) {
            prefix = "ReservedNodeOfferingId";
            String reservedNodeOfferingId = describeReservedNodeOfferingsRequest
        ...
        if (describeReservedNodeOfferingsRequest.getMaxRecords() != null) {
            prefix = "MaxRecords";
            Integer maxRecords = describeReservedNodeOfferingsRequest.getMaxRecords();
            request.addParameter(prefix, StringUtils.fromInteger(maxRecords));
        }
        if (describeReservedNodeOfferingsRequest.getMarker() != null) {
            prefix = "Marker";
            String marker = describeReservedNodeOfferingsRequest.getMarker();
