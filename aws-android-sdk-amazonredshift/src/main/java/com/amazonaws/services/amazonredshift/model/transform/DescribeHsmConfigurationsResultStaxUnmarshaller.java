...
/**
 * StAX unmarshaller for response DescribeHsmConfigurationsResult
 */
public class DescribeHsmConfigurationsResultStaxUnmarshaller implements
    ...
    public DescribeHsmConfigurationsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeHsmConfigurationsResult.setMarker(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("HsmConfigurations", targetDepth)) {
                    describeHsmConfigurationsResult
                            .withHsmConfigurations(HsmConfigurationStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
