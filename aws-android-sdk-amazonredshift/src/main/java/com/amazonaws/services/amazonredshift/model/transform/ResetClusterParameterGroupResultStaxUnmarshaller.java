...
/**
 * StAX unmarshaller for response ResetClusterParameterGroupResult
 */
public class ResetClusterParameterGroupResultStaxUnmarshaller implements
    ...
    public ResetClusterParameterGroupResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ParameterGroupName", targetDepth)) {
                    resetClusterParameterGroupResult.setParameterGroupName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ParameterGroupStatus", targetDepth)) {
                    resetClusterParameterGroupResult.setParameterGroupStatus(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
