...
/**
 * StAX request marshaller for CreateSnapshotCopyGrantRequest
 */
public class CreateSnapshotCopyGrantRequestMarshaller implements
    ...
    public Request<CreateSnapshotCopyGrantRequest> marshall(
        ...
        if (createSnapshotCopyGrantRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateSnapshotCopyGrantRequest)");
        }
        ...
        if (createSnapshotCopyGrantRequest.getSnapshotCopyGrantName() != null) {
            ...
            String snapshotCopyGrantName = createSnapshotCopyGrantRequest
        ...
        if (createSnapshotCopyGrantRequest.getKmsKeyId() != null) {
            prefix = "KmsKeyId";
            String kmsKeyId = createSnapshotCopyGrantRequest.getKmsKeyId();
            request.addParameter(prefix, StringUtils.fromString(kmsKeyId));
        }
        if (createSnapshotCopyGrantRequest.getTags() != null) {
            prefix = "Tags";
            java.util.List<Tag> tags = createSnapshotCopyGrantRequest.getTags();
            int tagsIndex = 1;
