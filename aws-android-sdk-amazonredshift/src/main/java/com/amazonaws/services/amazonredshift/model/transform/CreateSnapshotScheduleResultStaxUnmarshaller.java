...
/**
 * StAX unmarshaller for response CreateSnapshotScheduleResult
 */
public class CreateSnapshotScheduleResultStaxUnmarshaller implements
        Unmarshaller<CreateSnapshotScheduleResult, StaxUnmarshallerContext> {

    public CreateSnapshotScheduleResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ScheduleDefinitions", targetDepth)) {
                    createSnapshotScheduleResult.withScheduleDefinitions(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ScheduleIdentifier", targetDepth)) {
                    createSnapshotScheduleResult.setScheduleIdentifier(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ScheduleDescription", targetDepth)) {
                    createSnapshotScheduleResult.setScheduleDescription(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Tags", targetDepth)) {
                    createSnapshotScheduleResult.withTags(TagStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextInvocations", targetDepth)) {
                    createSnapshotScheduleResult.withNextInvocations(DateStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("AssociatedClusterCount", targetDepth)) {
                    createSnapshotScheduleResult.setAssociatedClusterCount(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
