...
/**
 * StAX unmarshaller for model UpdateTarget
 */
class UpdateTargetStaxUnmarshaller implements Unmarshaller<UpdateTarget, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("MaintenanceTrackName", targetDepth)) {
                    updateTarget.setMaintenanceTrackName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("DatabaseVersion", targetDepth)) {
                    updateTarget.setDatabaseVersion(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("SupportedOperations", targetDepth)) {
                    updateTarget.withSupportedOperations(SupportedOperationStaxUnmarshaller
