...
/**
 * StAX unmarshaller for model RevisionTarget
 */
class RevisionTargetStaxUnmarshaller implements
        Unmarshaller<RevisionTarget, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DatabaseRevision", targetDepth)) {
                    revisionTarget.setDatabaseRevision(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Description", targetDepth)) {
                    revisionTarget.setDescription(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("DatabaseRevisionReleaseDate", targetDepth)) {
                    revisionTarget.setDatabaseRevisionReleaseDate(DateStaxUnmarshaller
