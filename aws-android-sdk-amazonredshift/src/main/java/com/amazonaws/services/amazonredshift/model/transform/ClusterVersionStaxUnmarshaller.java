...
/**
 * StAX unmarshaller for model ClusterVersion
 */
class ClusterVersionStaxUnmarshaller implements
        Unmarshaller<ClusterVersion, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ClusterVersion", targetDepth)) {
                    clusterVersion.setClusterVersion(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ClusterParameterGroupFamily", targetDepth)) {
                    clusterVersion.setClusterParameterGroupFamily(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Description", targetDepth)) {
                    clusterVersion.setDescription(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
