...
/**
 * StAX unmarshaller for response DescribeReservedNodesResult
 */
public class DescribeReservedNodesResultStaxUnmarshaller implements
        Unmarshaller<DescribeReservedNodesResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeReservedNodesResult.setMarker(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ReservedNodes", targetDepth)) {
                    describeReservedNodesResult.withReservedNodes(ReservedNodeStaxUnmarshaller
