...
/**
 * StAX unmarshaller for model PauseClusterMessage
 */
class PauseClusterMessageStaxUnmarshaller implements
        Unmarshaller<PauseClusterMessage, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ClusterIdentifier", targetDepth)) {
                    pauseClusterMessage.setClusterIdentifier(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
