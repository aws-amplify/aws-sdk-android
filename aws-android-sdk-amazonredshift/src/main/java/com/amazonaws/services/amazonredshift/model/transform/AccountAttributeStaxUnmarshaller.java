...
/**
 * StAX unmarshaller for model AccountAttribute
 */
class AccountAttributeStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("AttributeName", targetDepth)) {
                    accountAttribute.setAttributeName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("AttributeValues", targetDepth)) {
                    accountAttribute.withAttributeValues(AttributeValueTargetStaxUnmarshaller
