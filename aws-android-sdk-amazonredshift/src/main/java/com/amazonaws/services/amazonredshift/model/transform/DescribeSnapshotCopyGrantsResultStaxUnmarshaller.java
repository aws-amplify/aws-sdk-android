...
/**
 * StAX unmarshaller for response DescribeSnapshotCopyGrantsResult
 */
public class DescribeSnapshotCopyGrantsResultStaxUnmarshaller implements
    ...
    public DescribeSnapshotCopyGrantsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeSnapshotCopyGrantsResult.setMarker(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("SnapshotCopyGrants", targetDepth)) {
                    describeSnapshotCopyGrantsResult
                            .withSnapshotCopyGrants(SnapshotCopyGrantStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
