...
/**
 * StAX unmarshaller for response GetReservedNodeExchangeOfferingsResult
 */
public class GetReservedNodeExchangeOfferingsResultStaxUnmarshaller implements
        Unmarshaller<GetReservedNodeExchangeOfferingsResult, StaxUnmarshallerContext> {

    public GetReservedNodeExchangeOfferingsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    getReservedNodeExchangeOfferingsResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ReservedNodeOfferings", targetDepth)) {
                    getReservedNodeExchangeOfferingsResult
                            .withReservedNodeOfferings(ReservedNodeOfferingStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
