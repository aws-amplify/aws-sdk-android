...
/**
 * StAX unmarshaller for model ClusterDbRevision
 */
class ClusterDbRevisionStaxUnmarshaller implements
        Unmarshaller<ClusterDbRevision, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ClusterIdentifier", targetDepth)) {
                    clusterDbRevision.setClusterIdentifier(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("CurrentDatabaseRevision", targetDepth)) {
                    clusterDbRevision.setCurrentDatabaseRevision(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("DatabaseRevisionReleaseDate", targetDepth)) {
                    clusterDbRevision.setDatabaseRevisionReleaseDate(DateStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("RevisionTargets", targetDepth)) {
                    clusterDbRevision.withRevisionTargets(RevisionTargetStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
