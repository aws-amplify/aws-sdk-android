 ...
 * <code>test</code> for tag values, all subnet groups that have any combination
 ...
 * </p>
 */
public class DescribeClusterSubnetGroupsRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *            key or keys. For example, suppose that you have subnet groups
     ...
     *            response with the subnet groups that have either or both of
