 ...
 * </p>
 */
public class DescribeClusterParameterGroupsRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *         key or keys. For example, suppose that you have parameter groups
     ...
     *         parameter groups that have either or both of these tag keys
     *         associated with them.
     *         </p>
     */
     ...
     *            returns a response with the parameter groups that have either
     ...
     *         cluster parameter groups that are associated with the specified
     *         tag value or values. For example, suppose that you have parameter
     ...
     *            matching cluster parameter groups that are associated with the
     ...
     *            response with the parameter groups that have either or both of
     *            these tag values associated with them.
     *            </p>
     */
     ...
     *         chained together.
     */
    public DescribeClusterParameterGroupsRequest withTagValues(
