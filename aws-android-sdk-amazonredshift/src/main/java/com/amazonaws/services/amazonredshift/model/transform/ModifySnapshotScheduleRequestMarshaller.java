...
/**
 * StAX request marshaller for ModifySnapshotScheduleRequest
 */
public class ModifySnapshotScheduleRequestMarshaller implements
        Marshaller<Request<ModifySnapshotScheduleRequest>, ModifySnapshotScheduleRequest> {

    public Request<ModifySnapshotScheduleRequest> marshall(
            ModifySnapshotScheduleRequest modifySnapshotScheduleRequest) {
        if (modifySnapshotScheduleRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ModifySnapshotScheduleRequest)");
        }

        Request<ModifySnapshotScheduleRequest> request = new DefaultRequest<ModifySnapshotScheduleRequest>(
                modifySnapshotScheduleRequest, "AmazonRedshift");
        ...
        if (modifySnapshotScheduleRequest.getScheduleIdentifier() != null) {
            ...
            String scheduleIdentifier = modifySnapshotScheduleRequest.getScheduleIdentifier();
            request.addParameter(prefix, StringUtils.fromString(scheduleIdentifier));
        }
        if (modifySnapshotScheduleRequest.getScheduleDefinitions() != null) {
            prefix = "ScheduleDefinitions";
            java.util.List<String> scheduleDefinitions = modifySnapshotScheduleRequest
