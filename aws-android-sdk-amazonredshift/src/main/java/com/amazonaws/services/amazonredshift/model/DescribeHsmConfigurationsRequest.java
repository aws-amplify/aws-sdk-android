 ...
 * </p>
 */
public class DescribeHsmConfigurationsRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *            The identifier of a specific Amazon Redshift HSM configuration
     *            to be described. If no identifier is specified, information is
     *            returned for all HSM configurations owned by your AWS customer
     *            account.
     *            </p>
     */
     ...
     *         chained together.
     */
    public DescribeHsmConfigurationsRequest withHsmConfigurationIdentifier(
     ...
     *         keys. For example, suppose that you have HSM configurations that
     ...
     *         configurations that have either or both of these tag keys
     ...
     *            HSM configurations that are associated with the specified key
     *            or keys. For example, suppose that you have HSM configurations
     ...
     *            the HSM configurations that have either or both of these tag
     ...
     *         value or values. For example, suppose that you have HSM
     *         configurations that are tagged with values called
     ...
     *            response with the HSM configurations that have either or both
     *            of these tag values associated with them.
     *            </p>
     */
