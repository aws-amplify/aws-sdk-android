...
/**
 * StAX unmarshaller for model TaggedResource
 */
class TaggedResourceStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("ResourceName", targetDepth)) {
                    taggedResource.setResourceName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("ResourceType", targetDepth)) {
                    taggedResource.setResourceType(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
