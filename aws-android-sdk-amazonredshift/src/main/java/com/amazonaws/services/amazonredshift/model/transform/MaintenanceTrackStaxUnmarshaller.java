...
/**
 * StAX unmarshaller for model MaintenanceTrack
 */
class MaintenanceTrackStaxUnmarshaller implements
        Unmarshaller<MaintenanceTrack, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("MaintenanceTrackName", targetDepth)) {
                    maintenanceTrack.setMaintenanceTrackName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("DatabaseVersion", targetDepth)) {
                    maintenanceTrack.setDatabaseVersion(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("UpdateTargets", targetDepth)) {
                    maintenanceTrack.withUpdateTargets(UpdateTargetStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
