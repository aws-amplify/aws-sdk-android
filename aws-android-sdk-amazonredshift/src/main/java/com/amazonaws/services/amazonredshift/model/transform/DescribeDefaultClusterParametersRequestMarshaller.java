...
/**
 * StAX request marshaller for DescribeDefaultClusterParametersRequest
 */
    ...
    public Request<DescribeDefaultClusterParametersRequest> marshall(
        ...
        if (describeDefaultClusterParametersRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeDefaultClusterParametersRequest)");
        }
        ...
        if (describeDefaultClusterParametersRequest.getParameterGroupFamily() != null) {
            ...
            String parameterGroupFamily = describeDefaultClusterParametersRequest
        ...
        if (describeDefaultClusterParametersRequest.getMaxRecords() != null) {
            prefix = "MaxRecords";
            Integer maxRecords = describeDefaultClusterParametersRequest.getMaxRecords();
            request.addParameter(prefix, StringUtils.fromInteger(maxRecords));
        }
        if (describeDefaultClusterParametersRequest.getMarker() != null) {
            prefix = "Marker";
            String marker = describeDefaultClusterParametersRequest.getMarker();
