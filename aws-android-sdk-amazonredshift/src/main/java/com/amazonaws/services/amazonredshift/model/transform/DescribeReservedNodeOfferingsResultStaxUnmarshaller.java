...
/**
 * StAX unmarshaller for response DescribeReservedNodeOfferingsResult
 */
public class DescribeReservedNodeOfferingsResultStaxUnmarshaller implements
        Unmarshaller<DescribeReservedNodeOfferingsResult, StaxUnmarshallerContext> {

    public DescribeReservedNodeOfferingsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeReservedNodeOfferingsResult.setMarker(StringStaxUnmarshaller
