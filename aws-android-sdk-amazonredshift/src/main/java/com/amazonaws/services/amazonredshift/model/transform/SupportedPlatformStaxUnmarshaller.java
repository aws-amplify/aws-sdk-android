...
/**
 * StAX unmarshaller for model SupportedPlatform
 */
class SupportedPlatformStaxUnmarshaller implements
        Unmarshaller<SupportedPlatform, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Name", targetDepth)) {
                    supportedPlatform.setName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
