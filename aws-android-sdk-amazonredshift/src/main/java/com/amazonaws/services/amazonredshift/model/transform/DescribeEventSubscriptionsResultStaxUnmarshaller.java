...
/**
 * StAX unmarshaller for response DescribeEventSubscriptionsResult
 */
public class DescribeEventSubscriptionsResultStaxUnmarshaller implements
    ...
    public DescribeEventSubscriptionsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeEventSubscriptionsResult.setMarker(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
