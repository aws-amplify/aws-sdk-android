...
/**
 * StAX unmarshaller for model ClusterParameterGroup
 */
class ClusterParameterGroupStaxUnmarshaller implements
        Unmarshaller<ClusterParameterGroup, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ParameterGroupName", targetDepth)) {
                    clusterParameterGroup.setParameterGroupName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ParameterGroupFamily", targetDepth)) {
                    clusterParameterGroup.setParameterGroupFamily(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Description", targetDepth)) {
                    clusterParameterGroup.setDescription(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Tags", targetDepth)) {
                    clusterParameterGroup.withTags(TagStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
