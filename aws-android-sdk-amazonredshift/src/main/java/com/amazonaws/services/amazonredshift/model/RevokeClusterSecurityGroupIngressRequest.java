 ...
 * </p>
 */
public class RevokeClusterSecurityGroupIngressRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *            The name of the security Group from which to revoke the
     *            ingress rule.
     *            </p>
     */
     ...
     *            The name of the EC2 Security Group whose access is to be
     ...
     *            The AWS access key ID is not an acceptable value. If
     *            <code>EC2SecurityGroupOwnerId</code> is specified,
     *            <code>EC2SecurityGroupName</code> must also be provided. and
     *            <code>CIDRIP</code> cannot be provided.
     *            </p>
