...
/**
 * StAX unmarshaller for response GetClusterCredentialsResult
 */
public class GetClusterCredentialsResultStaxUnmarshaller implements
        Unmarshaller<GetClusterCredentialsResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DbUser", targetDepth)) {
                    getClusterCredentialsResult.setDbUser(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("DbPassword", targetDepth)) {
                    getClusterCredentialsResult.setDbPassword(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Expiration", targetDepth)) {
                    getClusterCredentialsResult.setExpiration(DateStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
