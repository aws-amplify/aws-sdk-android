...
/**
 * StAX unmarshaller for model HsmClientCertificate
 */
class HsmClientCertificateStaxUnmarshaller implements
        Unmarshaller<HsmClientCertificate, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("HsmClientCertificateIdentifier", targetDepth)) {
                    hsmClientCertificate.setHsmClientCertificateIdentifier(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("HsmClientCertificatePublicKey", targetDepth)) {
                    hsmClientCertificate.setHsmClientCertificatePublicKey(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Tags", targetDepth)) {
                    hsmClientCertificate.withTags(TagStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
