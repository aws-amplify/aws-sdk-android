...
/**
 * StAX unmarshaller for model DefaultClusterParameters
 */
class DefaultClusterParametersStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ParameterGroupFamily", targetDepth)) {
                    defaultClusterParameters.setParameterGroupFamily(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Marker", targetDepth)) {
                    defaultClusterParameters.setMarker(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Parameters", targetDepth)) {
                    defaultClusterParameters.withParameters(ParameterStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
