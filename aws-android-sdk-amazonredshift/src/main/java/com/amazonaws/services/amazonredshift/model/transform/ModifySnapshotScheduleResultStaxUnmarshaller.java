...
/**
 * StAX unmarshaller for response ModifySnapshotScheduleResult
 */
public class ModifySnapshotScheduleResultStaxUnmarshaller implements
        Unmarshaller<ModifySnapshotScheduleResult, StaxUnmarshallerContext> {

    public ModifySnapshotScheduleResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ScheduleDefinitions", targetDepth)) {
                    modifySnapshotScheduleResult.withScheduleDefinitions(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ScheduleIdentifier", targetDepth)) {
                    modifySnapshotScheduleResult.setScheduleIdentifier(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ScheduleDescription", targetDepth)) {
                    modifySnapshotScheduleResult.setScheduleDescription(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Tags", targetDepth)) {
                    modifySnapshotScheduleResult.withTags(TagStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextInvocations", targetDepth)) {
                    modifySnapshotScheduleResult.withNextInvocations(DateStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("AssociatedClusterCount", targetDepth)) {
                    modifySnapshotScheduleResult.setAssociatedClusterCount(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
