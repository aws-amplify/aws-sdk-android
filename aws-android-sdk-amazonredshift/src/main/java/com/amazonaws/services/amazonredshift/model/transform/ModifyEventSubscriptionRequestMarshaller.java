...
public class ModifyEventSubscriptionRequestMarshaller implements
    ...
    public Request<ModifyEventSubscriptionRequest> marshall(
        ...
        Request<ModifyEventSubscriptionRequest> request = new DefaultRequest<ModifyEventSubscriptionRequest>(
                modifyEventSubscriptionRequest, "AmazonRedshift");
        ...
        if (modifyEventSubscriptionRequest.getSourceIds() != null) {
            prefix = "SourceIds";
            java.util.List<String> sourceIds = modifyEventSubscriptionRequest.getSourceIds();
        ...
        if (modifyEventSubscriptionRequest.getSeverity() != null) {
            prefix = "Severity";
            String severity = modifyEventSubscriptionRequest.getSeverity();
