...
/**
 * StAX unmarshaller for model HsmStatus
 */
class HsmStatusStaxUnmarshaller implements Unmarshaller<HsmStatus, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("HsmClientCertificateIdentifier", targetDepth)) {
                    hsmStatus.setHsmClientCertificateIdentifier(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("HsmConfigurationIdentifier", targetDepth)) {
                    hsmStatus.setHsmConfigurationIdentifier(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
