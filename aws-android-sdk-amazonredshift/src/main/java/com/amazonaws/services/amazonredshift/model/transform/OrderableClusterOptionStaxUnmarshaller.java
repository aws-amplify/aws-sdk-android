...
/**
 * StAX unmarshaller for model OrderableClusterOption
 */
class OrderableClusterOptionStaxUnmarshaller implements
        Unmarshaller<OrderableClusterOption, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ClusterVersion", targetDepth)) {
                    orderableClusterOption.setClusterVersion(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ClusterType", targetDepth)) {
                    orderableClusterOption.setClusterType(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("NodeType", targetDepth)) {
                    orderableClusterOption.setNodeType(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("AvailabilityZones", targetDepth)) {
                    orderableClusterOption.withAvailabilityZones(AvailabilityZoneStaxUnmarshaller
