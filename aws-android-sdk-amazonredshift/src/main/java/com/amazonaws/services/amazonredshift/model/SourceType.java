...
public enum SourceType {
    ...
    static {
        ...
        enumMap.put("cluster-parameter-group", ClusterParameterGroup);
        enumMap.put("cluster-security-group", ClusterSecurityGroup);
        enumMap.put("cluster-snapshot", ClusterSnapshot);
        enumMap.put("scheduled-action", ScheduledAction);
    }
