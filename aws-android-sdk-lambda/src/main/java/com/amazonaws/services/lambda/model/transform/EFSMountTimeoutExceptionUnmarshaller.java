...
public class EFSMountTimeoutExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("EFSMountTimeoutException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        EFSMountTimeoutException e = (EFSMountTimeoutException) super.unmarshall(error);
        e.setErrorCode("EFSMountTimeoutException");
