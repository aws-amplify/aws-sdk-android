...
public class EFSMountConnectivityExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("EFSMountConnectivityException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        EFSMountConnectivityException e = (EFSMountConnectivityException) super.unmarshall(error);
        e.setErrorCode("EFSMountConnectivityException");
