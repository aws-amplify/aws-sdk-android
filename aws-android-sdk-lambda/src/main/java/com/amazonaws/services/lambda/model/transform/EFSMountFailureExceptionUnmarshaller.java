...
public class EFSMountFailureExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("EFSMountFailureException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        EFSMountFailureException e = (EFSMountFailureException) super.unmarshall(error);
        e.setErrorCode("EFSMountFailureException");
