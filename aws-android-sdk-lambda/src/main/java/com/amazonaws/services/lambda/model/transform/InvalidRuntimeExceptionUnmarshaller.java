...
public class InvalidRuntimeExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InvalidRuntimeException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        InvalidRuntimeException e = (InvalidRuntimeException) super.unmarshall(error);
        e.setErrorCode("InvalidRuntimeException");
