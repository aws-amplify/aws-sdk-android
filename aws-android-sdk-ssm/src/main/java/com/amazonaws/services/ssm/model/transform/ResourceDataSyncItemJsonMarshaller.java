...
class ResourceDataSyncItemJsonMarshaller {
    ...
    public void marshall(ResourceDataSyncItem resourceDataSyncItem, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (resourceDataSyncItem.getSyncSource() != null) {
            ...
            ResourceDataSyncSourceWithStateJsonMarshaller.getInstance().marshall(syncSource,
                    jsonWriter);
        }
        ...
        if (resourceDataSyncItem.getLastSuccessfulSyncTime() != null) {
            java.util.Date lastSuccessfulSyncTime = resourceDataSyncItem
    ...
    public static ResourceDataSyncItemJsonMarshaller getInstance() {
        if (instance == null)
            instance = new ResourceDataSyncItemJsonMarshaller();
        return instance;
    }
}
