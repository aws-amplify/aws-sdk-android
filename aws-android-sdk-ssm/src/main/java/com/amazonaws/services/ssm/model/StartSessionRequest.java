...
public class StartSessionRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * for the session. For example, <code>SSM-SessionManagerRunShell</code>.
     * You can call the <a>GetDocument</a> API to verify the document exists
     ...
     *         <a>GetDocument</a> API to verify the document exists before
     ...
     *            <code>SSM-SessionManagerRunShell</code>. You can call the
     *            <a>GetDocument</a> API to verify the document exists before
     *            attempting to start a session. If no document name is
