 ...
 */
public class GetAutomationExecutionResultJsonUnmarshaller implements
        Unmarshaller<GetAutomationExecutionResult, JsonUnmarshallerContext> {

    public GetAutomationExecutionResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AutomationExecution")) {
                getAutomationExecutionResult
                        .setAutomationExecution(AutomationExecutionJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
            }
