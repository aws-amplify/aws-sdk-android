...
class ResourceDataSyncOrganizationalUnitJsonMarshaller {
    ...
    public void marshall(ResourceDataSyncOrganizationalUnit resourceDataSyncOrganizationalUnit,
            AwsJsonWriter jsonWriter) throws Exception {
        jsonWriter.beginObject();
        if (resourceDataSyncOrganizationalUnit.getOrganizationalUnitId() != null) {
            String organizationalUnitId = resourceDataSyncOrganizationalUnit
    ...
    public static ResourceDataSyncOrganizationalUnitJsonMarshaller getInstance() {
        if (instance == null)
            instance = new ResourceDataSyncOrganizationalUnitJsonMarshaller();
        return instance;
    }
}
