...
public class DescribeMaintenanceWindowExecutionTasksResult implements Serializable {
     ...
     * </p>
     *
     * @param windowExecutionTaskIdentities <p>
     *            Information about the task executions.
     *            </p>
     */
    public void setWindowExecutionTaskIdentities(
        ...
        this.windowExecutionTaskIdentities = new java.util.ArrayList<MaintenanceWindowExecutionTaskIdentity>(
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getWindowExecutionTaskIdentities() == null) ? 0
                        : getWindowExecutionTaskIdentities().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getWindowExecutionTaskIdentities() == null
                ^ this.getWindowExecutionTaskIdentities() == null)
            return false;
        if (other.getWindowExecutionTaskIdentities() != null
                && other.getWindowExecutionTaskIdentities().equals(
                        this.getWindowExecutionTaskIdentities()) == false)
            return false;
