...
public class PatchBaselineIdentity implements Serializable {
     ...
     *         supports creating multiple default patch baselines. For example,
     *         you can create a default patch baseline for each operating
     *         system.
     *         </p>
     */
     ...
     * </p>
     *
     * @param defaultBaseline <p>
     *            Whether this is the default baseline. Note that Systems
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getBaselineName() == null) ? 0 : getBaselineName().hashCode());
        hashCode = prime * hashCode
                + ((getOperatingSystem() == null) ? 0 : getOperatingSystem().hashCode());
        hashCode = prime * hashCode
                + ((getBaselineDescription() == null) ? 0 : getBaselineDescription().hashCode());
        hashCode = prime * hashCode
                + ((getDefaultBaseline() == null) ? 0 : getDefaultBaseline().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getBaselineName() == null ^ this.getBaselineName() == null)
            return false;
        if (other.getBaselineName() != null
                && other.getBaselineName().equals(this.getBaselineName()) == false)
            return false;
        ...
        if (other.getBaselineDescription() == null ^ this.getBaselineDescription() == null)
            return false;
        if (other.getBaselineDescription() != null
                && other.getBaselineDescription().equals(this.getBaselineDescription()) == false)
            return false;
        if (other.getDefaultBaseline() == null ^ this.getDefaultBaseline() == null)
            return false;
        if (other.getDefaultBaseline() != null
                && other.getDefaultBaseline().equals(this.getDefaultBaseline()) == false)
            return false;
        return true;
    }
}
