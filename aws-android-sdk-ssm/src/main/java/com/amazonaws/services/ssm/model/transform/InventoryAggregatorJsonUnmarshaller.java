 ...
 */
class InventoryAggregatorJsonUnmarshaller implements
        Unmarshaller<InventoryAggregator, JsonUnmarshallerContext> {
    ...
    public InventoryAggregator unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Expression")) {
                ...
                inventoryAggregator.setAggregators(new ListUnmarshaller<InventoryAggregator>(
                        InventoryAggregatorJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Groups")) {
                inventoryAggregator.setGroups(new ListUnmarshaller<InventoryGroup>(
                        InventoryGroupJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
