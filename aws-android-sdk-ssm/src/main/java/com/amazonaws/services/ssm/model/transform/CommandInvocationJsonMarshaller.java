...
class CommandInvocationJsonMarshaller {
    ...
    public void marshall(CommandInvocation commandInvocation, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (commandInvocation.getCommandPlugins() != null) {
            ...
            for (CommandPlugin commandPluginsItem : commandPlugins) {
                if (commandPluginsItem != null) {
                    CommandPluginJsonMarshaller.getInstance().marshall(commandPluginsItem,
                            jsonWriter);
                }
            }
            jsonWriter.endArray();
        ...
        if (commandInvocation.getCloudWatchOutputConfig() != null) {
            CloudWatchOutputConfig cloudWatchOutputConfig = commandInvocation
