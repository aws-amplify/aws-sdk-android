 ...
 */
public class DeleteInventoryResultJsonUnmarshaller implements
        Unmarshaller<DeleteInventoryResult, JsonUnmarshallerContext> {
    ...
    public DeleteInventoryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("DeletionId")) {
                ...
                deleteInventoryResult.setDeletionSummary(InventoryDeletionSummaryJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
