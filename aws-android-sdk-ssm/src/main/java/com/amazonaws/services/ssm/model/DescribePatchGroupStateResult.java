...
public class DescribePatchGroupStateResult implements Serializable {
    ...
    /**
     * <p>
     * The number of instances with <code>NotApplicable</code> patches beyond
     * the supported limit, which are not reported by name to Systems Manager
     * Inventory.
     * </p>
     */
     ...
     * </p>
     *
     * @param instancesWithInstalledPatches <p>
     *            The number of instances with installed patches.
     *            </p>
     */
     ...
     *         chained together.
     */
    public DescribePatchGroupStateResult withInstancesWithInstalledPatches(
     ...
     *
     * @return <p>
     *         The number of instances with patches installed that aren't
     ...
     * </p>
     *
     * @param instancesWithInstalledOtherPatches <p>
     *            The number of instances with patches installed that aren't
     *            defined in the patch baseline.
     *            </p>
     */
     ...
     *         chained together.
     */
    public DescribePatchGroupStateResult withInstancesWithInstalledOtherPatches(
     ...
     *
     * @return <p>
     *         The number of instances with patches installed by Patch Manager
     *         that have not been rebooted after the patch installation. The
     ...
     * </p>
     *
     * @param instancesWithInstalledPendingRebootPatches <p>
     *            The number of instances with patches installed by Patch
     *            Manager that have not been rebooted after the patch
     *            installation. The status of these instances is NON_COMPLIANT.
     *            </p>
     */
    public void setInstancesWithInstalledPendingRebootPatches(
     ...
     *         chained together.
     */
    public DescribePatchGroupStateResult withInstancesWithInstalledPendingRebootPatches(
            Integer instancesWithInstalledPendingRebootPatches) {
        this.instancesWithInstalledPendingRebootPatches = instancesWithInstalledPendingRebootPatches;
        return this;
    }
     ...
     *         <i>INSTALLED_REJECTED</i> were typically installed before they
     ...
     * </note>
     *
     * @param instancesWithInstalledRejectedPatches <p>
     ...
     *            </note>
     */
    public void setInstancesWithInstalledRejectedPatches(
     ...
     *         chained together.
     */
    public DescribePatchGroupStateResult withInstancesWithInstalledRejectedPatches(
            Integer instancesWithInstalledRejectedPatches) {
        this.instancesWithInstalledRejectedPatches = instancesWithInstalledRejectedPatches;
        return this;
    }
     ...
     * </p>
     *
     * @param instancesWithMissingPatches <p>
     *            The number of instances with missing patches from the patch
     *            baseline.
     *            </p>
     */
     ...
     *         chained together.
     */
    public DescribePatchGroupStateResult withInstancesWithMissingPatches(
     ...
     * </p>
     *
     * @param instancesWithFailedPatches <p>
     *            The number of instances with patches from the patch baseline
     ...
     *         chained together.
     */
    public DescribePatchGroupStateResult withInstancesWithFailedPatches(
     ...
     * </p>
     *
     * @param instancesWithNotApplicablePatches <p>
     *            The number of instances with patches that aren't applicable.
     *            </p>
     */
     ...
     *         chained together.
     */
    public DescribePatchGroupStateResult withInstancesWithNotApplicablePatches(
     ...
     *
     * @return <p>
     *         The number of instances with <code>NotApplicable</code> patches
     *         beyond the supported limit, which are not reported by name to
     ...
     * </p>
     *
     * @param instancesWithUnreportedNotApplicablePatches <p>
     *            The number of instances with <code>NotApplicable</code>
     *            patches beyond the supported limit, which are not reported by
     *            name to Systems Manager Inventory.
     *            </p>
     */
    public void setInstancesWithUnreportedNotApplicablePatches(
     ...
     *         chained together.
     */
    public DescribePatchGroupStateResult withInstancesWithUnreportedNotApplicablePatches(
            Integer instancesWithUnreportedNotApplicablePatches) {
        this.instancesWithUnreportedNotApplicablePatches = instancesWithUnreportedNotApplicablePatches;
        return this;
    }
    ...
    public String toString() {
        ...
        if (getInstancesWithNotApplicablePatches() != null)
            sb.append("InstancesWithNotApplicablePatches: "
                    + getInstancesWithNotApplicablePatches() + ",");
        if (getInstancesWithUnreportedNotApplicablePatches() != null)
            sb.append("InstancesWithUnreportedNotApplicablePatches: "
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getInstancesWithInstalledPatches() == null) ? 0
                        : getInstancesWithInstalledPatches().hashCode());
        hashCode = prime
                * hashCode
                + ((getInstancesWithInstalledOtherPatches() == null) ? 0
                        : getInstancesWithInstalledOtherPatches().hashCode());
        hashCode = prime
                * hashCode
                + ((getInstancesWithInstalledPendingRebootPatches() == null) ? 0
                        : getInstancesWithInstalledPendingRebootPatches().hashCode());
        hashCode = prime
                * hashCode
                + ((getInstancesWithInstalledRejectedPatches() == null) ? 0
                        : getInstancesWithInstalledRejectedPatches().hashCode());
        hashCode = prime
                * hashCode
                + ((getInstancesWithMissingPatches() == null) ? 0
                        : getInstancesWithMissingPatches().hashCode());
        hashCode = prime
                * hashCode
                + ((getInstancesWithFailedPatches() == null) ? 0 : getInstancesWithFailedPatches()
                        .hashCode());
        hashCode = prime
                * hashCode
                + ((getInstancesWithNotApplicablePatches() == null) ? 0
                        : getInstancesWithNotApplicablePatches().hashCode());
        hashCode = prime
                * hashCode
                + ((getInstancesWithUnreportedNotApplicablePatches() == null) ? 0
                        : getInstancesWithUnreportedNotApplicablePatches().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getInstancesWithInstalledPatches() == null
                ^ this.getInstancesWithInstalledPatches() == null)
            return false;
        if (other.getInstancesWithInstalledPatches() != null
                && other.getInstancesWithInstalledPatches().equals(
                        this.getInstancesWithInstalledPatches()) == false)
            return false;
        if (other.getInstancesWithInstalledOtherPatches() == null
                ^ this.getInstancesWithInstalledOtherPatches() == null)
            return false;
        if (other.getInstancesWithInstalledOtherPatches() != null
                && other.getInstancesWithInstalledOtherPatches().equals(
                        this.getInstancesWithInstalledOtherPatches()) == false)
            return false;
        if (other.getInstancesWithInstalledPendingRebootPatches() == null
                ^ this.getInstancesWithInstalledPendingRebootPatches() == null)
            return false;
        if (other.getInstancesWithInstalledPendingRebootPatches() != null
                && other.getInstancesWithInstalledPendingRebootPatches().equals(
                        this.getInstancesWithInstalledPendingRebootPatches()) == false)
            return false;
        if (other.getInstancesWithInstalledRejectedPatches() == null
                ^ this.getInstancesWithInstalledRejectedPatches() == null)
            return false;
        if (other.getInstancesWithInstalledRejectedPatches() != null
                && other.getInstancesWithInstalledRejectedPatches().equals(
                        this.getInstancesWithInstalledRejectedPatches()) == false)
            return false;
        if (other.getInstancesWithMissingPatches() == null
                ^ this.getInstancesWithMissingPatches() == null)
            return false;
        if (other.getInstancesWithMissingPatches() != null
                && other.getInstancesWithMissingPatches().equals(
                        this.getInstancesWithMissingPatches()) == false)
            return false;
        if (other.getInstancesWithFailedPatches() == null
                ^ this.getInstancesWithFailedPatches() == null)
            return false;
        if (other.getInstancesWithFailedPatches() != null
                && other.getInstancesWithFailedPatches().equals(
                        this.getInstancesWithFailedPatches()) == false)
            return false;
        if (other.getInstancesWithNotApplicablePatches() == null
                ^ this.getInstancesWithNotApplicablePatches() == null)
            return false;
        if (other.getInstancesWithNotApplicablePatches() != null
                && other.getInstancesWithNotApplicablePatches().equals(
                        this.getInstancesWithNotApplicablePatches()) == false)
            return false;
        if (other.getInstancesWithUnreportedNotApplicablePatches() == null
                ^ this.getInstancesWithUnreportedNotApplicablePatches() == null)
            return false;
        if (other.getInstancesWithUnreportedNotApplicablePatches() != null
                && other.getInstancesWithUnreportedNotApplicablePatches().equals(
                        this.getInstancesWithUnreportedNotApplicablePatches()) == false)
            return false;
        return true;
    }
}
