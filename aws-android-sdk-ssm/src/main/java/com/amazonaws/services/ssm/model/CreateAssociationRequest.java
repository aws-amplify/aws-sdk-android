 ...
 * specified. If you associate a document with an instance that already has an
 * associated document, the system returns the
 * <code>AssociationAlreadyExists</code> exception.
 * </p>
 */
