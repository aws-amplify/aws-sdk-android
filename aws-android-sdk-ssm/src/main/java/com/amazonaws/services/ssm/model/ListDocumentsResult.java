...
public class ListDocumentsResult implements Serializable {
    ...
    public ListDocumentsResult withDocumentIdentifiers(DocumentIdentifier... documentIdentifiers) {
        if (getDocumentIdentifiers() == null) {
            this.documentIdentifiers = new java.util.ArrayList<DocumentIdentifier>(
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getDocumentIdentifiers() == null) ? 0 : getDocumentIdentifiers().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDocumentIdentifiers() != null
                && other.getDocumentIdentifiers().equals(this.getDocumentIdentifiers()) == false)
            return false;
