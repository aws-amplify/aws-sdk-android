...
public class DeregisterTaskFromMaintenanceWindowRequestMarshaller
    ...
    public Request<DeregisterTaskFromMaintenanceWindowRequest> marshall(
        ...
        if (deregisterTaskFromMaintenanceWindowRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeregisterTaskFromMaintenanceWindowRequest)");
        }

        Request<DeregisterTaskFromMaintenanceWindowRequest> request = new DefaultRequest<DeregisterTaskFromMaintenanceWindowRequest>(
                deregisterTaskFromMaintenanceWindowRequest, "AmazonSimpleSystemsManager(SSM)");
