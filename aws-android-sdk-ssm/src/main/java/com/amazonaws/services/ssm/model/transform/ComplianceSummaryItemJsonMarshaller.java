...
class ComplianceSummaryItemJsonMarshaller {
    ...
    public void marshall(ComplianceSummaryItem complianceSummaryItem, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (complianceSummaryItem.getNonCompliantSummary() != null) {
            NonCompliantSummary nonCompliantSummary = complianceSummaryItem
    ...
    public static ComplianceSummaryItemJsonMarshaller getInstance() {
        if (instance == null)
            instance = new ComplianceSummaryItemJsonMarshaller();
        return instance;
    }
}
