 ...
 */
class DocumentIdentifierJsonUnmarshaller implements
    ...
    public DocumentIdentifier unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                ...
                documentIdentifier.setPlatformTypes(new ListUnmarshaller<String>(
                ...
                documentIdentifier.setTags(new ListUnmarshaller<Tag>(TagJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Requires")) {
                documentIdentifier.setRequires(new ListUnmarshaller<DocumentRequires>(
