...
public class SendAutomationSignalRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * </p>
     * <p>
     * For <code>Approve</code> and <code>Reject</code> signal types, the
     ...
     *
     * @return <p>
     *         The unique identifier for an existing Automation execution that
     ...
     *
     * @return <p>
     *         The data sent with the signal. The data schema depends on the
     *         type of signal used in the request.
     *         </p>
     *         <p>
     *         For <code>Approve</code> and <code>Reject</code> signal types,
     *         the payload is an optional comment that you can send with the
     *         signal type. For example:
     *         </p>
     *         <p>
     *         <code>Comment="Looks good"</code>
     *         </p>
     *         <p>
     *         For <code>StartStep</code> and <code>Resume</code> signal types,
     *         you must send the name of the Automation step to start or resume
     ...
     *            </p>
     *            <p>
     *            For <code>StartStep</code> and <code>Resume</code> signal
     *            types, you must send the name of the Automation step to start
     *            or resume as the payload. For example:
     *            </p>
     *            <p>
     *            <code>StepName="step1"</code>
     *            </p>
     *            <p>
     *            For the <code>StopStep</code> signal type, you must send the
     *            step execution ID as the payload. For example:
     *            </p>
     *            <p>
     *            <code>StepExecutionId="97fff367-fc5a-4299-aed8-0123456789ab"</code>
     *            </p>
     ...
     *         chained together.
     */
    public SendAutomationSignalRequest withPayload(
            java.util.Map<String, java.util.List<String>> payload) {
        this.payload = payload;
        return this;
    }
     ...
     * </p>
     * <p>
     * The method adds a new key-value pair into Payload parameter, and returns
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSignalType() == null ^ this.getSignalType() == null)
            return false;
        if (other.getSignalType() != null
                && other.getSignalType().equals(this.getSignalType()) == false)
            return false;
