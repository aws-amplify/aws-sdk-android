 ...
 */
public class GetOpsSummaryResultJsonUnmarshaller implements
        Unmarshaller<GetOpsSummaryResult, JsonUnmarshallerContext> {
    ...
    public GetOpsSummaryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Entities")) {
                getOpsSummaryResult.setEntities(new ListUnmarshaller<OpsEntity>(
                        OpsEntityJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
