 ...
 */
public class CreateMaintenanceWindowRequestMarshaller implements
        Marshaller<Request<CreateMaintenanceWindowRequest>, CreateMaintenanceWindowRequest> {

    public Request<CreateMaintenanceWindowRequest> marshall(
            CreateMaintenanceWindowRequest createMaintenanceWindowRequest) {
        if (createMaintenanceWindowRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateMaintenanceWindowRequest)");
        }

        Request<CreateMaintenanceWindowRequest> request = new DefaultRequest<CreateMaintenanceWindowRequest>(
                createMaintenanceWindowRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (createMaintenanceWindowRequest.getAllowUnassociatedTargets() != null) {
                Boolean allowUnassociatedTargets = createMaintenanceWindowRequest
