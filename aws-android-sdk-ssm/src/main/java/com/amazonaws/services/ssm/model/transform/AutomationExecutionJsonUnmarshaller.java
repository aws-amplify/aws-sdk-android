 ...
 */
class AutomationExecutionJsonUnmarshaller implements
        Unmarshaller<AutomationExecution, JsonUnmarshallerContext> {
    ...
    public AutomationExecution unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AutomationExecutionId")) {
                ...
                automationExecution.setAutomationExecutionStatus(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("StepExecutions")) {
                automationExecution.setStepExecutions(new ListUnmarshaller<StepExecution>(
                        StepExecutionJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("StepExecutionsTruncated")) {
                automationExecution.setStepExecutionsTruncated(BooleanJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Parameters")) {
                automationExecution.setParameters(new MapUnmarshaller<java.util.List<String>>(
                        new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
                        )
                        )
                                .unmarshall(context));
            } else if (name.equals("Outputs")) {
                automationExecution.setOutputs(new MapUnmarshaller<java.util.List<String>>(
                        new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
                        )
                        )
                                .unmarshall(context));
                ...
                automationExecution.setParentAutomationExecutionId(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                automationExecution.setTargets(new ListUnmarshaller<Target>(TargetJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
                ...
                automationExecution.setResolvedTargets(ResolvedTargetsJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                automationExecution.setTargetLocations(new ListUnmarshaller<TargetLocation>(
                        TargetLocationJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("ProgressCounters")) {
                automationExecution.setProgressCounters(ProgressCountersJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
