 ...
 */
public class DescribeAutomationExecutionsResultJsonUnmarshaller implements
        Unmarshaller<DescribeAutomationExecutionsResult, JsonUnmarshallerContext> {

    public DescribeAutomationExecutionsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AutomationExecutionMetadataList")) {
                describeAutomationExecutionsResult
                        .setAutomationExecutionMetadataList(new ListUnmarshaller<AutomationExecutionMetadata>(
                                AutomationExecutionMetadataJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                describeAutomationExecutionsResult.setNextToken(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
