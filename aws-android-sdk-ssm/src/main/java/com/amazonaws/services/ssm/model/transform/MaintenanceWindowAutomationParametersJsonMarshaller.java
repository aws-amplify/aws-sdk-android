...
class MaintenanceWindowAutomationParametersJsonMarshaller {
    ...
    public void marshall(
        ...
        if (maintenanceWindowAutomationParameters.getParameters() != null) {
            java.util.Map<String, java.util.List<String>> parameters = maintenanceWindowAutomationParameters
                    .getParameters();
    ...
    public static MaintenanceWindowAutomationParametersJsonMarshaller getInstance() {
        if (instance == null)
            instance = new MaintenanceWindowAutomationParametersJsonMarshaller();
        return instance;
    }
}
