...
public class CreateDocumentRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * purposes. For more information, see <a href=
     * "https://docs.aws.amazon.com/systems-manager/latest/userguide/appconfig.html"
     * >AWS AppConfig</a> in the <i>AWS Systems Manager User Guide</i>.
     * </p>
     */
     ...
     * >AWS resource and property types reference</a> in the <i>AWS
     ...
     *         recommend storing the contents for your new document in an
     *         external JSON or YAML file and referencing the file in a command.
     *         </p>
     *         <p>
     *         For examples, see the following topics in the <i>AWS Systems
     ...
     *            We recommend storing the contents for your new document in an
     *            external JSON or YAML file and referencing the file in a
     *            command.
     *            </p>
     *            <p>
     *            For examples, see the following topics in the <i>AWS Systems
     ...
     *         used exclusively by AWS AppConfig. When a user creates an
     *         AppConfig configuration in an SSM document, the user must also
     *         specify a required document for validation purposes. In this
     *         case, an <code>ApplicationConfiguration</code> document requires
     *         an <code>ApplicationConfigurationSchema</code> document for
     *         validation purposes. For more information, see <a href=
     *         "https://docs.aws.amazon.com/systems-manager/latest/userguide/appconfig.html"
     *         >AWS AppConfig</a> in the <i>AWS Systems Manager User Guide</i>.
     *         </p>
     */
     ...
     *
     * @param requires <p>
     *            A list of SSM documents required by a document. This parameter
     *            is used exclusively by AWS AppConfig. When a user creates an
     *            AppConfig configuration in an SSM document, the user must also
     *            specify a required document for validation purposes. In this
     *            case, an <code>ApplicationConfiguration</code> document
     *            requires an <code>ApplicationConfigurationSchema</code>
     *            document for validation purposes. For more information, see <a
     *            href=
     *            "https://docs.aws.amazon.com/systems-manager/latest/userguide/appconfig.html"
     *            >AWS AppConfig</a> in the <i>AWS Systems Manager User
     *            Guide</i>.
     *            </p>
     */
