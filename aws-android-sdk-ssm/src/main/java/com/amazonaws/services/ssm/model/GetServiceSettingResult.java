 ...
 * </p>
 */
public class GetServiceSettingResult implements Serializable {
    /**
     * <p>
    ...
    public String toString() {
        ...
        if (getServiceSetting() != null)
            sb.append("ServiceSetting: " + getServiceSetting());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getServiceSetting() == null) ? 0 : getServiceSetting().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getServiceSetting() == null ^ this.getServiceSetting() == null)
            return false;
        if (other.getServiceSetting() != null
                && other.getServiceSetting().equals(this.getServiceSetting()) == false)
            return false;
        return true;
    }
}
