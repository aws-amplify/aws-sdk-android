...
class InstanceInformationJsonMarshaller {
    ...
    public void marshall(InstanceInformation instanceInformation, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (instanceInformation.getLastAssociationExecutionDate() != null) {
            java.util.Date lastAssociationExecutionDate = instanceInformation
        ...
        if (instanceInformation.getLastSuccessfulAssociationExecutionDate() != null) {
            java.util.Date lastSuccessfulAssociationExecutionDate = instanceInformation
        ...
        if (instanceInformation.getAssociationOverview() != null) {
            InstanceAggregatedAssociationOverview associationOverview = instanceInformation
                    .getAssociationOverview();
            jsonWriter.name("AssociationOverview");
            InstanceAggregatedAssociationOverviewJsonMarshaller.getInstance().marshall(
                    associationOverview, jsonWriter);
        }
