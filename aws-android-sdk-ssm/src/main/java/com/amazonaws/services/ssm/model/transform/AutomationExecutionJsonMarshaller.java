...
class AutomationExecutionJsonMarshaller {
    ...
    public void marshall(AutomationExecution automationExecution, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (automationExecution.getStepExecutions() != null) {
            ...
            for (StepExecution stepExecutionsItem : stepExecutions) {
                if (stepExecutionsItem != null) {
                    StepExecutionJsonMarshaller.getInstance().marshall(stepExecutionsItem,
                            jsonWriter);
                }
            }
            jsonWriter.endArray();
        ...
        if (automationExecution.getParameters() != null) {
            java.util.Map<String, java.util.List<String>> parameters = automationExecution
                    .getParameters();
        ...
        if (automationExecution.getOutputs() != null) {
            java.util.Map<String, java.util.List<String>> outputs = automationExecution
                    .getOutputs();
        ...
        if (automationExecution.getParentAutomationExecutionId() != null) {
            String parentAutomationExecutionId = automationExecution
        ...
        if (automationExecution.getTargetMaps() != null) {
            java.util.List<java.util.Map<String, java.util.List<String>>> targetMaps = automationExecution
                    .getTargetMaps();
        ...
        if (automationExecution.getTargetLocations() != null) {
            java.util.List<TargetLocation> targetLocations = automationExecution
                    .getTargetLocations();
