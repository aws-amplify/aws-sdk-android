...
public class RegisterTaskWithMaintenanceWindowRequest extends AmazonWebServiceRequest implements
     ...
     *         chained together.
     */
    public RegisterTaskWithMaintenanceWindowRequest withTaskParameters(
            java.util.Map<String, MaintenanceWindowTaskParameterValueExpression> taskParameters) {
        this.taskParameters = taskParameters;
        return this;
    }
     ...
     *         chained together.
     */
    public RegisterTaskWithMaintenanceWindowRequest addTaskParametersEntry(String key,
     ...
     *         chained together.
     */
    public RegisterTaskWithMaintenanceWindowRequest withTaskInvocationParameters(
            MaintenanceWindowTaskInvocationParameters taskInvocationParameters) {
        this.taskInvocationParameters = taskInvocationParameters;
        return this;
    }
     ...
     *         scheduled in priority order with tasks that have the same
     ...
     *            the number the higher the priority. Tasks in a maintenance
     ...
     *
     * @param loggingInfo <p>
     *            A structure containing information about an Amazon S3 bucket
