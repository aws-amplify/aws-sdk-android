 ...
 */
public class UpdatePatchBaselineRequestMarshaller implements
        Marshaller<Request<UpdatePatchBaselineRequest>, UpdatePatchBaselineRequest> {

    public Request<UpdatePatchBaselineRequest> marshall(
            UpdatePatchBaselineRequest updatePatchBaselineRequest) {
        if (updatePatchBaselineRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdatePatchBaselineRequest)");
        }

        Request<UpdatePatchBaselineRequest> request = new DefaultRequest<UpdatePatchBaselineRequest>(
                updatePatchBaselineRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (updatePatchBaselineRequest.getApprovedPatches() != null) {
                java.util.List<String> approvedPatches = updatePatchBaselineRequest
                        .getApprovedPatches();
            ...
            if (updatePatchBaselineRequest.getApprovedPatchesComplianceLevel() != null) {
                String approvedPatchesComplianceLevel = updatePatchBaselineRequest
            ...
            if (updatePatchBaselineRequest.getApprovedPatchesEnableNonSecurity() != null) {
                Boolean approvedPatchesEnableNonSecurity = updatePatchBaselineRequest
            ...
            if (updatePatchBaselineRequest.getRejectedPatches() != null) {
                java.util.List<String> rejectedPatches = updatePatchBaselineRequest
                        .getRejectedPatches();
            ...
            if (updatePatchBaselineRequest.getRejectedPatchesAction() != null) {
                String rejectedPatchesAction = updatePatchBaselineRequest
