...
public class ProgressCounters implements Serializable {
    ...
    public String toString() {
        ...
        if (getTotalSteps() != null)
            sb.append("TotalSteps: " + getTotalSteps() + ",");
        if (getSuccessSteps() != null)
            sb.append("SuccessSteps: " + getSuccessSteps() + ",");
        if (getFailedSteps() != null)
            sb.append("FailedSteps: " + getFailedSteps() + ",");
        if (getCancelledSteps() != null)
            sb.append("CancelledSteps: " + getCancelledSteps() + ",");
        if (getTimedOutSteps() != null)
            sb.append("TimedOutSteps: " + getTimedOutSteps());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getSuccessSteps() == null) ? 0 : getSuccessSteps().hashCode());
        hashCode = prime * hashCode
                + ((getFailedSteps() == null) ? 0 : getFailedSteps().hashCode());
        hashCode = prime * hashCode
                + ((getCancelledSteps() == null) ? 0 : getCancelledSteps().hashCode());
        hashCode = prime * hashCode
                + ((getTimedOutSteps() == null) ? 0 : getTimedOutSteps().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTotalSteps() == null ^ this.getTotalSteps() == null)
            return false;
        if (other.getTotalSteps() != null
                && other.getTotalSteps().equals(this.getTotalSteps()) == false)
            return false;
        if (other.getSuccessSteps() == null ^ this.getSuccessSteps() == null)
            return false;
        if (other.getSuccessSteps() != null
                && other.getSuccessSteps().equals(this.getSuccessSteps()) == false)
            return false;
        if (other.getFailedSteps() == null ^ this.getFailedSteps() == null)
            return false;
        if (other.getFailedSteps() != null
                && other.getFailedSteps().equals(this.getFailedSteps()) == false)
            return false;
        if (other.getCancelledSteps() == null ^ this.getCancelledSteps() == null)
            return false;
        if (other.getCancelledSteps() != null
                && other.getCancelledSteps().equals(this.getCancelledSteps()) == false)
            return false;
        if (other.getTimedOutSteps() == null ^ this.getTimedOutSteps() == null)
            return false;
        if (other.getTimedOutSteps() != null
                && other.getTimedOutSteps().equals(this.getTimedOutSteps()) == false)
            return false;
        return true;
    }
}
