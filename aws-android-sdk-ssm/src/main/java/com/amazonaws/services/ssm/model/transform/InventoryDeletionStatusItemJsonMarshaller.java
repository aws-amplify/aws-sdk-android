...
class InventoryDeletionStatusItemJsonMarshaller {
    ...
    public void marshall(InventoryDeletionStatusItem inventoryDeletionStatusItem,
        ...
        if (inventoryDeletionStatusItem.getDeletionSummary() != null) {
            InventoryDeletionSummary deletionSummary = inventoryDeletionStatusItem
                    .getDeletionSummary();
            jsonWriter.name("DeletionSummary");
            InventoryDeletionSummaryJsonMarshaller.getInstance().marshall(deletionSummary,
                    jsonWriter);
        }
        if (inventoryDeletionStatusItem.getLastStatusUpdateTime() != null) {
            java.util.Date lastStatusUpdateTime = inventoryDeletionStatusItem
    ...
    public static InventoryDeletionStatusItemJsonMarshaller getInstance() {
        if (instance == null)
            instance = new InventoryDeletionStatusItemJsonMarshaller();
        return instance;
    }
}
