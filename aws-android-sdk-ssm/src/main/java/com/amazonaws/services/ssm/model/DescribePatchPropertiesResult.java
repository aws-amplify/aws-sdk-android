...
public class DescribePatchPropertiesResult implements Serializable {
     ...
     *
     * @param properties <p>
     *            A list of the properties for patches matching the filter
     *            request parameters.
     *            </p>
     */
    ...
    public DescribePatchPropertiesResult withProperties(java.util.Map<String, String>... properties) {
        if (getProperties() == null) {
            this.properties = new java.util.ArrayList<java.util.Map<String, String>>(
                    properties.length);
        }
     ...
     *         chained together.
     */
    public DescribePatchPropertiesResult withProperties(
            java.util.Collection<java.util.Map<String, String>> properties) {
