...
public class DescribeInstanceAssociationsStatusResult implements Serializable {
     ...
     * </p>
     *
     * @param instanceAssociationStatusInfos <p>
     *            Status information about the association.
     *            </p>
     */
    public void setInstanceAssociationStatusInfos(
        ...
        this.instanceAssociationStatusInfos = new java.util.ArrayList<InstanceAssociationStatusInfo>(
    ...
    public DescribeInstanceAssociationsStatusResult withInstanceAssociationStatusInfos(
            InstanceAssociationStatusInfo... instanceAssociationStatusInfos) {
        if (getInstanceAssociationStatusInfos() == null) {
            this.instanceAssociationStatusInfos = new java.util.ArrayList<InstanceAssociationStatusInfo>(
                    instanceAssociationStatusInfos.length);
        }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getInstanceAssociationStatusInfos() == null) ? 0
                        : getInstanceAssociationStatusInfos().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getInstanceAssociationStatusInfos() == null
                ^ this.getInstanceAssociationStatusInfos() == null)
            return false;
        if (other.getInstanceAssociationStatusInfos() != null
                && other.getInstanceAssociationStatusInfos().equals(
                        this.getInstanceAssociationStatusInfos()) == false)
            return false;
