...
public class NonCompliantSummary implements Serializable {
    ...
    public String toString() {
        ...
        if (getNonCompliantCount() != null)
            sb.append("NonCompliantCount: " + getNonCompliantCount() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getNonCompliantCount() == null) ? 0 : getNonCompliantCount().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getNonCompliantCount() == null ^ this.getNonCompliantCount() == null)
            return false;
        if (other.getNonCompliantCount() != null
                && other.getNonCompliantCount().equals(this.getNonCompliantCount()) == false)
            return false;
