 ...
 */
class ResourceDataSyncItemJsonUnmarshaller implements
        Unmarshaller<ResourceDataSyncItem, JsonUnmarshallerContext> {
    ...
    public ResourceDataSyncItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SyncName")) {
                ...
                resourceDataSyncItem.setSyncSource(ResourceDataSyncSourceWithStateJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("S3Destination")) {
                resourceDataSyncItem.setS3Destination(ResourceDataSyncS3DestinationJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
