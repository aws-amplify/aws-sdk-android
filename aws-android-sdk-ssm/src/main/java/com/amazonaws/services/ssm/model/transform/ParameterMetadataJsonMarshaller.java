...
class ParameterMetadataJsonMarshaller {
    ...
    public void marshall(ParameterMetadata parameterMetadata, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (parameterMetadata.getPolicies() != null) {
            ...
            for (ParameterInlinePolicy policiesItem : policies) {
                if (policiesItem != null) {
                    ParameterInlinePolicyJsonMarshaller.getInstance().marshall(policiesItem,
                            jsonWriter);
                }
            }
            jsonWriter.endArray();
