...
public class ResourceDataSyncItem implements Serializable {
     ...
     *         synchronizes data to an S3 bucket. If the <code>SyncType</code>
     *         is <code>SyncFromSource</code> then the resource data sync
     *         synchronizes data from AWS Organizations or from multiple AWS
     *         Regions.
     *         </p>
     */
     ...
     *            The type of resource data sync. If <code>SyncType</code> is
     *            <code>SyncToDestination</code>, then the resource data sync
     *            synchronizes data to an S3 bucket. If the
