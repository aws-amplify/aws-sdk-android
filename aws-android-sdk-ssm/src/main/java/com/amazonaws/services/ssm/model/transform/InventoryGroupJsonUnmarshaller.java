 ...
 */
class InventoryGroupJsonUnmarshaller implements
        Unmarshaller<InventoryGroup, JsonUnmarshallerContext> {
    ...
    public InventoryGroup unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                ...
                inventoryGroup.setFilters(new ListUnmarshaller<InventoryFilter>(
                        InventoryFilterJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
