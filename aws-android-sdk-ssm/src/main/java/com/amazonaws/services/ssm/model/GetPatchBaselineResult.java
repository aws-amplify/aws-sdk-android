...
public class GetPatchBaselineResult implements Serializable {
     ...
     *
     * @return <p>
     *         Returns the specified compliance severity level for approved
     ...
     * @see PatchComplianceLevel
     */
    public GetPatchBaselineResult withApprovedPatchesComplianceLevel(
     ...
     *         chained together.
     */
    public GetPatchBaselineResult withApprovedPatchesEnableNonSecurity(
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getPatchGroups() == null) ? 0 : getPatchGroups().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getPatchGroups() == null ^ this.getPatchGroups() == null)
            return false;
        if (other.getPatchGroups() != null
                && other.getPatchGroups().equals(this.getPatchGroups()) == false)
            return false;
