 ...
 */
public class DescribePatchBaselinesRequestMarshaller implements
        Marshaller<Request<DescribePatchBaselinesRequest>, DescribePatchBaselinesRequest> {

    public Request<DescribePatchBaselinesRequest> marshall(
            DescribePatchBaselinesRequest describePatchBaselinesRequest) {
        if (describePatchBaselinesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribePatchBaselinesRequest)");
        }

        Request<DescribePatchBaselinesRequest> request = new DefaultRequest<DescribePatchBaselinesRequest>(
                describePatchBaselinesRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (describePatchBaselinesRequest.getFilters() != null) {
                java.util.List<PatchOrchestratorFilter> filters = describePatchBaselinesRequest
                        .getFilters();
