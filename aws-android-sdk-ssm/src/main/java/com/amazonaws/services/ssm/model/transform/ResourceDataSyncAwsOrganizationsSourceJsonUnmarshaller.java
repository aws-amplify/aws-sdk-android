 ...
 */
class ResourceDataSyncAwsOrganizationsSourceJsonUnmarshaller implements
        Unmarshaller<ResourceDataSyncAwsOrganizationsSource, JsonUnmarshallerContext> {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("OrganizationSourceType")) {
                resourceDataSyncAwsOrganizationsSource
                        .setOrganizationSourceType(StringJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("OrganizationalUnits")) {
                resourceDataSyncAwsOrganizationsSource
                        .setOrganizationalUnits(new ListUnmarshaller<ResourceDataSyncOrganizationalUnit>(
