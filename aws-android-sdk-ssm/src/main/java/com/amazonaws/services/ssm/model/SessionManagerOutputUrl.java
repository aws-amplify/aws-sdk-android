...
public class SessionManagerOutputUrl implements Serializable {
    ...
    public String toString() {
        ...
        if (getCloudWatchOutputUrl() != null)
            sb.append("CloudWatchOutputUrl: " + getCloudWatchOutputUrl());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getCloudWatchOutputUrl() == null) ? 0 : getCloudWatchOutputUrl().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCloudWatchOutputUrl() == null ^ this.getCloudWatchOutputUrl() == null)
            return false;
        if (other.getCloudWatchOutputUrl() != null
                && other.getCloudWatchOutputUrl().equals(this.getCloudWatchOutputUrl()) == false)
            return false;
        return true;
    }
}
