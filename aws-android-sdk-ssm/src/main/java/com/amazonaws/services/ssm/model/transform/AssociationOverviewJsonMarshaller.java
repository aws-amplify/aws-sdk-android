...
class AssociationOverviewJsonMarshaller {
    ...
    public void marshall(AssociationOverview associationOverview, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (associationOverview.getAssociationStatusAggregatedCount() != null) {
            java.util.Map<String, Integer> associationStatusAggregatedCount = associationOverview
                    .getAssociationStatusAggregatedCount();
            jsonWriter.name("AssociationStatusAggregatedCount");
            jsonWriter.beginObject();
            for (java.util.Map.Entry<String, Integer> associationStatusAggregatedCountEntry : associationStatusAggregatedCount
                    .entrySet()) {
                Integer associationStatusAggregatedCountValue = associationStatusAggregatedCountEntry
                        .getValue();
