 ...
 * Management (IAM) to create a new OpsItem. For more information, see <a href=
...
public class CreateOpsItemRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         chained together.
     */
    public CreateOpsItemRequest withOperationalData(
     ...
     *         chained together.
     */
    public CreateOpsItemRequest withNotifications(
     ...
     *         chained together.
     */
    public CreateOpsItemRequest withRelatedOpsItems(
     ...
     *
     * @param source <p>
     *            The origin of the OpsItem, such as Amazon EC2 or Systems
     *            Manager.
     *            </p>
     *            <note>
     *            <p>
     ...
     *         "https://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html#OpsCenter-getting-started-user-permissions"
     *         >Getting started with OpsCenter</a> in the <i>AWS Systems Manager
     *         User Guide</i>.
     *         </p>
     *         <p>
     *         Tags use a key-value pair. For example:
     ...
     *            restrict access to OpsItems by using an inline IAM policy that
     *            specifies tags. For more information, see <a href=
     *            "https://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html#OpsCenter-getting-started-user-permissions"
