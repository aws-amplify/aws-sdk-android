...
class MaintenanceWindowIdentityForTargetJsonMarshaller {
    ...
    public void marshall(MaintenanceWindowIdentityForTarget maintenanceWindowIdentityForTarget,
    ...
    public static MaintenanceWindowIdentityForTargetJsonMarshaller getInstance() {
        if (instance == null)
            instance = new MaintenanceWindowIdentityForTargetJsonMarshaller();
        return instance;
    }
}
