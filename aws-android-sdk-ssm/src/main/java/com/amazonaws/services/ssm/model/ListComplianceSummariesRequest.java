...
public class ListComplianceSummariesRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         One or more compliance or inventory filters. Use a filter to
     ...
     *         chained together.
     */
    public ListComplianceSummariesRequest withFilters(
     ...
     *         you can specify null or 50. The call also returns a token that
     *         you can specify in a subsequent call to get the next set of
     *         results.
     *         </p>
     */
     ...
     *            Currently, you can specify null or 50. The call also returns a
     *            token that you can specify in a subsequent call to get the
     *            next set of results.
     *            </p>
     */
