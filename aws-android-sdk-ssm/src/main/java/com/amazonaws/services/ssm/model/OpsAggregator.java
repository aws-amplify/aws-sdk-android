...
public class OpsAggregator implements Serializable {
     ...
     *
     * @return <p>
     *         Either a Range or Count aggregator for limiting an OpsItem
     *         summary.
     *         </p>
     */
     ...
     *            The name of an OpsItem attribute on which to limit the count
     *            of OpsItems.
     *            </p>
     */
     ...
     * </p>
     * <p>
     * The method adds a new key-value pair into Values parameter, and returns a
    ...
    public String toString() {
        ...
        if (getAggregatorType() != null)
            sb.append("AggregatorType: " + getAggregatorType() + ",");
        if (getTypeName() != null)
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAggregatorType() != null
                && other.getAggregatorType().equals(this.getAggregatorType()) == false)
            return false;
