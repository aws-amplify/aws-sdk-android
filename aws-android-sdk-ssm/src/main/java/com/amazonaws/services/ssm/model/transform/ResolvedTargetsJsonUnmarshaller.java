 ...
 */
class ResolvedTargetsJsonUnmarshaller implements
        Unmarshaller<ResolvedTargets, JsonUnmarshallerContext> {
    ...
    public ResolvedTargets unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ParameterValues")) {
                resolvedTargets.setParameterValues(new ListUnmarshaller<String>(
