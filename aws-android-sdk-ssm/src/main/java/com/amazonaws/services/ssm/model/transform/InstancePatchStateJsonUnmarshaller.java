 ...
 */
class InstancePatchStateJsonUnmarshaller implements
        Unmarshaller<InstancePatchState, JsonUnmarshallerContext> {
    ...
    public InstancePatchState unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("InstanceId")) {
                ...
                instancePatchState.setInstalledPendingRebootCount(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                instancePatchState.setUnreportedNotApplicableCount(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                instancePatchState.setLastNoRebootInstallOperationTime(DateJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
