...
public class GetCommandInvocationRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         (Required) The ID of the managed instance targeted by the
     *         command. A managed instance can be an Amazon EC2 instance or an
     *         instance in your hybrid environment that is configured for
     *         Systems Manager.
     *         </p>
     */
     ...
     * @param instanceId <p>
     *            (Required) The ID of the managed instance targeted by the
     *            command. A managed instance can be an Amazon EC2 instance or
     *            an instance in your hybrid environment that is configured for
     *            Systems Manager.
     *            </p>
     */
     ...
     *         results. If the document contains only one plugin, the name can
     ...
     * @param pluginName <p>
     *            (Optional) The name of the plugin for which you want detailed
     *            results. If the document contains only one plugin, the name
     *            can be omitted and the details will be returned.
     *            </p>
     */
