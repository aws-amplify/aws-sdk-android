 ...
 * information for those instances. If you do not specify instance IDs, it
 * returns information for all your instances. If you specify an instance ID
 * that is not valid or an instance that you do not own, you receive an error.
 * </p>
 * <note>
 * <p>
 ...
 * </note>
 */
public class DescribeInstanceInformationRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *         method. Instead, use the <a>InstanceInformationFilter</a> action.
     *         The <code>InstanceInformationFilter</code> action enables you to
     *         return instance information by using tags that are specified as a
     *         key-value mapping.
     *         </p>
     *         <p>
     *         If you do use this method, then you can't use the
     *         <code>InstanceInformationFilter</code> action. Using this method
     *         and the <code>InstanceInformationFilter</code> action causes an
     *         exception error.
     *         </p>
     */
     ...
     * </p>
     *
     * @param instanceInformationFilterList <p>
     *            This is a legacy method. We recommend that you don't use this
     *            method. Instead, use the <a>InstanceInformationFilter</a>
     *            action. The <code>InstanceInformationFilter</code> action
     *            enables you to return instance information by using tags that
     *            are specified as a key-value mapping.
     *            </p>
     *            <p>
     *            If you do use this method, then you can't use the
     *            <code>InstanceInformationFilter</code> action. Using this
     *            method and the <code>InstanceInformationFilter</code> action
    ...
    public void setInstanceInformationFilterList(
        ...
        this.instanceInformationFilterList = new java.util.ArrayList<InstanceInformationFilter>(
     ...
     *         of instances. You can filter on Amazon EC2 tag. Specify tags by
     ...
     *            list of instances. You can filter on Amazon EC2 tag. Specify
     ...
     *         chained together.
     */
    public DescribeInstanceInformationRequest withFilters(
            InstanceInformationStringFilter... filters) {
        if (getFilters() == null) {
     ...
     */
    public DescribeInstanceInformationRequest withFilters(
            java.util.Collection<InstanceInformationStringFilter> filters) {
        setFilters(filters);
        return this;
    }
