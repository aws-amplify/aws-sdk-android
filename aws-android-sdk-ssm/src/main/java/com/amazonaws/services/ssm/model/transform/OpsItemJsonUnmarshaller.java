    ...
    public OpsItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("CreatedBy")) {
                ...
                opsItem.setNotifications(new ListUnmarshaller<OpsItemNotification>(
                        OpsItemNotificationJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
                ...
                opsItem.setRelatedOpsItems(new ListUnmarshaller<RelatedOpsItem>(
                        RelatedOpsItemJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
                ...
                opsItem.setOperationalData(new MapUnmarshaller<OpsItemDataValue>(
