 ...
 */
public class GetMaintenanceWindowTaskResultJsonUnmarshaller implements
        Unmarshaller<GetMaintenanceWindowTaskResult, JsonUnmarshallerContext> {

    public GetMaintenanceWindowTaskResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("WindowId")) {
                ...
                getMaintenanceWindowTaskResult.setTargets(new ListUnmarshaller<Target>(
                ...
                getMaintenanceWindowTaskResult.setServiceRoleArn(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                getMaintenanceWindowTaskResult.setMaxConcurrency(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                getMaintenanceWindowTaskResult.setLoggingInfo(LoggingInfoJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
