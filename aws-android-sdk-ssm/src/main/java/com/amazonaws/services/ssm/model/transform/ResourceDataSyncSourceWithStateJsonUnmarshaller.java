 ...
 */
class ResourceDataSyncSourceWithStateJsonUnmarshaller implements
        Unmarshaller<ResourceDataSyncSourceWithState, JsonUnmarshallerContext> {
    ...
    public ResourceDataSyncSourceWithState unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SourceType")) {
                ...
                resourceDataSyncSourceWithState.setSourceRegions(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("IncludeFutureRegions")) {
                resourceDataSyncSourceWithState.setIncludeFutureRegions(BooleanJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
