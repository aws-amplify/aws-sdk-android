    ...
    public Request<DescribeInstancePatchStatesForPatchGroupRequest> marshall(
        ...
        if (describeInstancePatchStatesForPatchGroupRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeInstancePatchStatesForPatchGroupRequest)");
        }
        ...
        Request<DescribeInstancePatchStatesForPatchGroupRequest> request = new DefaultRequest<DescribeInstancePatchStatesForPatchGroupRequest>(
                describeInstancePatchStatesForPatchGroupRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (describeInstancePatchStatesForPatchGroupRequest.getFilters() != null) {
                java.util.List<InstancePatchStateFilter> filters = describeInstancePatchStatesForPatchGroupRequest
                        .getFilters();
                jsonWriter.name("Filters");
                jsonWriter.beginArray();
                for (InstancePatchStateFilter filtersItem : filters) {
                    if (filtersItem != null) {
                        InstancePatchStateFilterJsonMarshaller.getInstance().marshall(filtersItem,
                                jsonWriter);
                    }
                }
                jsonWriter.endArray();
            ...
            if (describeInstancePatchStatesForPatchGroupRequest.getMaxResults() != null) {
                Integer maxResults = describeInstancePatchStatesForPatchGroupRequest
                        .getMaxResults();
