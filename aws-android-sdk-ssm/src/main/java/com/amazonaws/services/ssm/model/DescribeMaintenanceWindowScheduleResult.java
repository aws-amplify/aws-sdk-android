...
public class DescribeMaintenanceWindowScheduleResult implements Serializable {
     ...
     * </p>
     *
     * @param scheduledWindowExecutions <p>
     *            Information about maintenance window executions scheduled for
     *            the specified time range.
     *            </p>
     */
    public void setScheduledWindowExecutions(
            java.util.Collection<ScheduledWindowExecution> scheduledWindowExecutions) {
        if (scheduledWindowExecutions == null) {
            this.scheduledWindowExecutions = null;
            return;
        }

        this.scheduledWindowExecutions = new java.util.ArrayList<ScheduledWindowExecution>(
     ...
     *         chained together.
     */
    public DescribeMaintenanceWindowScheduleResult withScheduledWindowExecutions(
            ScheduledWindowExecution... scheduledWindowExecutions) {
        if (getScheduledWindowExecutions() == null) {
            this.scheduledWindowExecutions = new java.util.ArrayList<ScheduledWindowExecution>(
                    scheduledWindowExecutions.length);
        }
     ...
     *
     * @return <p>
     *         The token for the next set of items to return. (You use this
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getScheduledWindowExecutions() != null)
            sb.append("ScheduledWindowExecutions: " + getScheduledWindowExecutions() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getScheduledWindowExecutions() == null) ? 0 : getScheduledWindowExecutions()
                        .hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getScheduledWindowExecutions() == null
                ^ this.getScheduledWindowExecutions() == null)
            return false;
        if (other.getScheduledWindowExecutions() != null
                && other.getScheduledWindowExecutions().equals(this.getScheduledWindowExecutions()) == false)
            return false;
