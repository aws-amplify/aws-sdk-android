...
public class ResourceDataSyncAwsOrganizationsSource implements Serializable {
     ...
     * @return <p>
     *         If an AWS Organization is present, this is either
     *         <code>OrganizationalUnits</code> or
     *         <code>EntireOrganization</code>. For
     *         <code>OrganizationalUnits</code>, the data is aggregated from a
     *         set of organization units. For <code>EntireOrganization</code>,
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @param organizationSourceType <p>
     *            If an AWS Organization is present, this is either
     *            <code>OrganizationalUnits</code> or
     *            <code>EntireOrganization</code>. For
     *            <code>OrganizationalUnits</code>, the data is aggregated from
     *            a set of organization units. For
     *            <code>EntireOrganization</code>, the data is aggregated from
     ...
     *         chained together.
     */
    public ResourceDataSyncAwsOrganizationsSource withOrganizationSourceType(
    ...
    public void setOrganizationalUnits(
            java.util.Collection<ResourceDataSyncOrganizationalUnit> organizationalUnits) {
        if (organizationalUnits == null) {
            this.organizationalUnits = null;
            return;
        }

        this.organizationalUnits = new java.util.ArrayList<ResourceDataSyncOrganizationalUnit>(
                organizationalUnits);
    }
     ...
     *         chained together.
     */
    public ResourceDataSyncAwsOrganizationsSource withOrganizationalUnits(
    ...
    public String toString() {
        ...
        if (getOrganizationSourceType() != null)
            sb.append("OrganizationSourceType: " + getOrganizationSourceType() + ",");
        if (getOrganizationalUnits() != null)
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getOrganizationSourceType() == null) ? 0 : getOrganizationSourceType()
                        .hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getOrganizationSourceType() == null ^ this.getOrganizationSourceType() == null)
            return false;
        if (other.getOrganizationSourceType() != null
                && other.getOrganizationSourceType().equals(this.getOrganizationSourceType()) == false)
            return false;
