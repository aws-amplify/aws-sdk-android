 ...
 * </p>
 */
public class DescribeMaintenanceWindowTargetsRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         The ID of the maintenance window whose targets should be
     *         retrieved.
     *         </p>
     */
     ...
     *
     * @param filters <p>
     *            Optional filters that can be used to narrow down the scope of
     *            the returned window targets. The supported filter keys are
     *            Type, WindowTargetId and OwnerInformation.
     *            </p>
     */
     ...
     *         chained together.
     */
    public DescribeMaintenanceWindowTargetsRequest withFilters(
