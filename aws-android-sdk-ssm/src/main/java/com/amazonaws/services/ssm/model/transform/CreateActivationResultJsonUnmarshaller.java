...
/**
 * JSON unmarshaller for response CreateActivationResult
 */
public class CreateActivationResultJsonUnmarshaller implements
        Unmarshaller<CreateActivationResult, JsonUnmarshallerContext> {
    ...
    public CreateActivationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ActivationId")) {
                createActivationResult.setActivationId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ActivationCode")) {
                createActivationResult.setActivationCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
