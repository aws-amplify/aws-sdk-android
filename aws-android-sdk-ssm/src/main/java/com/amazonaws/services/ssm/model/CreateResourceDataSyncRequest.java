 ...
 * multiple AWS Regions to a single Amazon S3 bucket. For more information, see
 * <a href=
 ...
 * >Setting Up Explorer to Display Data from Multiple Accounts and Regions</a>
...
public class CreateResourceDataSyncRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * that synchronizes data from multiple AWS Regions to an Amazon S3 bucket.
     ...
     *         sync that synchronizes data from multiple AWS Regions to an
     *         Amazon S3 bucket. Specify <code>SyncFromSource</code> to
     *         synchronize data from multiple AWS accounts and Regions, as
     *         listed in AWS Organizations.
     *         </p>
     */
     ...
     *            data sync that synchronizes data from multiple AWS Regions to
     *            an Amazon S3 bucket. Specify <code>SyncFromSource</code> to
     *            synchronize data from multiple AWS accounts and Regions, as
     *            listed in AWS Organizations.
     *            </p>
     */
