 ...
 * multiple AWS accounts and Regions or <code>EntireOrganization</code> by using
 * AWS Organizations. For more information, see <a href=
 ...
 * and Regions</a> in the <i>AWS Systems Manager User Guide</i>.
 * </p>
 * <p>
 ...
 * data. To check the status of a sync, use the <a>ListResourceDataSync</a>.
 * </p>
 * <note>
 * <p>
...
public class CreateResourceDataSyncRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    /**
     * <p>
     * Specify <code>SyncToDestination</code> to create a resource data sync
     * that synchronizes data to an S3 bucket for Inventory. If you specify
     ...
     *         required if the <code>SyncType</code> value is SyncToDestination.
     *         </p>
     */
     ...
     *            Amazon S3 configuration details for the sync. This parameter
     *            is required if the <code>SyncType</code> value is
     *            SyncToDestination.
     *            </p>
     */
     ...
     *         chained together.
     */
    public CreateResourceDataSyncRequest withS3Destination(
     ...
     *
     * @return <p>
     *         Specify <code>SyncToDestination</code> to create a resource data
     *         sync that synchronizes data to an S3 bucket for Inventory. If you
     *         specify <code>SyncToDestination</code>, you must provide a value
     *         for <code>S3Destination</code>. Specify
     *         <code>SyncFromSource</code> to synchronize data from a single
     *         account and multiple Regions, or multiple AWS accounts and
     *         Regions, as listed in AWS Organizations for Explorer. If you
     *         specify <code>SyncFromSource</code>, you must provide a value for
     *         <code>SyncSource</code>. The default value is
     *         <code>SyncToDestination</code>.
     *         </p>
     */
     ...
     *
     * @param syncType <p>
     *            Specify <code>SyncToDestination</code> to create a resource
     *            data sync that synchronizes data to an S3 bucket for
     *            Inventory. If you specify <code>SyncToDestination</code>, you
     *            must provide a value for <code>S3Destination</code>. Specify
     *            <code>SyncFromSource</code> to synchronize data from a single
     *            account and multiple Regions, or multiple AWS accounts and
     *            Regions, as listed in AWS Organizations for Explorer. If you
     *            specify <code>SyncFromSource</code>, you must provide a value
     ...
     *            This parameter is required if the <code>SyncType</code> value
     *            is SyncFromSource.
     *            </p>
     */
