 ...
 */
class DocumentDefaultVersionDescriptionJsonUnmarshaller implements
        Unmarshaller<DocumentDefaultVersionDescription, JsonUnmarshallerContext> {
    ...
    public DocumentDefaultVersionDescription unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                ...
                documentDefaultVersionDescription.setDefaultVersion(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("DefaultVersionName")) {
                documentDefaultVersionDescription.setDefaultVersionName(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
