 ...
 */
class InventoryDeletionStatusItemJsonUnmarshaller implements
        Unmarshaller<InventoryDeletionStatusItem, JsonUnmarshallerContext> {
    ...
    public InventoryDeletionStatusItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("DeletionId")) {
                ...
                inventoryDeletionStatusItem.setLastStatusMessage(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("DeletionSummary")) {
                inventoryDeletionStatusItem
                        .setDeletionSummary(InventoryDeletionSummaryJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("LastStatusUpdateTime")) {
                inventoryDeletionStatusItem.setLastStatusUpdateTime(DateJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
