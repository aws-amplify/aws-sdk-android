...
public class CreateDocumentResult implements Serializable {
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getDocumentDescription() == null) ? 0 : getDocumentDescription().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDocumentDescription() != null
                && other.getDocumentDescription().equals(this.getDocumentDescription()) == false)
            return false;
        return true;
    }
}
