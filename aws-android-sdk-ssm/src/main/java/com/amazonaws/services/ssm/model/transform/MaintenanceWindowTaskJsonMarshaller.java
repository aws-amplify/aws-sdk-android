...
class MaintenanceWindowTaskJsonMarshaller {
    ...
    public void marshall(MaintenanceWindowTask maintenanceWindowTask, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (maintenanceWindowTask.getTaskParameters() != null) {
            java.util.Map<String, MaintenanceWindowTaskParameterValueExpression> taskParameters = maintenanceWindowTask
                    .getTaskParameters();
