...
public enum CommandFilterKey {
    ...
    private static final Map<String, CommandFilterKey> enumMap;
    static {
        enumMap = new HashMap<String, CommandFilterKey>();
        enumMap.put("InvokedAfter", InvokedAfter);
        enumMap.put("InvokedBefore", InvokedBefore);
        enumMap.put("Status", Status);
        enumMap.put("ExecutionStage", ExecutionStage);
        enumMap.put("DocumentName", DocumentName);
    }
