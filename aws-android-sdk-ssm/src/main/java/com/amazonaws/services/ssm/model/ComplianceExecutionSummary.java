...
public class ComplianceExecutionSummary implements Serializable {
    ...
    /**
     * <p>
     * An ID created by the system when <code>PutComplianceItems</code> was
     * called. For example, <code>CommandID</code> is a valid execution ID. You
     ...
     *            The time the execution ran as a datetime object that is saved
     ...
     *
     * @return <p>
     *         An ID created by the system when <code>PutComplianceItems</code>
     *         was called. For example, <code>CommandID</code> is a valid
     ...
     *            <code>PutComplianceItems</code> was called. For example,
     *            <code>CommandID</code> is a valid execution ID. You can use
     ...
     *
     * @return <p>
     *         The type of execution. For example, <code>Command</code> is a
    ...
    public String toString() {
        ...
        if (getExecutionType() != null)
            sb.append("ExecutionType: " + getExecutionType());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getExecutionType() == null) ? 0 : getExecutionType().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getExecutionType() != null
                && other.getExecutionType().equals(this.getExecutionType()) == false)
            return false;
        return true;
    }
}
