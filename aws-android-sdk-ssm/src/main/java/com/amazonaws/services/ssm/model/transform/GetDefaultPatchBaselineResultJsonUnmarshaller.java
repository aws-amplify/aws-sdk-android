 ...
 */
public class GetDefaultPatchBaselineResultJsonUnmarshaller implements
        Unmarshaller<GetDefaultPatchBaselineResult, JsonUnmarshallerContext> {

    public GetDefaultPatchBaselineResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("BaselineId")) {
                ...
                getDefaultPatchBaselineResult.setOperatingSystem(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
