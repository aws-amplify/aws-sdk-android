 ...
 */
class MaintenanceWindowTaskJsonUnmarshaller implements
        Unmarshaller<MaintenanceWindowTask, JsonUnmarshallerContext> {
    ...
    public MaintenanceWindowTask unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("WindowId")) {
                ...
                maintenanceWindowTask.setTargets(new ListUnmarshaller<Target>(
