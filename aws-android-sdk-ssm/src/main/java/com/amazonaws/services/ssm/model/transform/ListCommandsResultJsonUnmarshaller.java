...
/**
 * JSON unmarshaller for response ListCommandsResult
 */
public class ListCommandsResultJsonUnmarshaller implements
        Unmarshaller<ListCommandsResult, JsonUnmarshallerContext> {
    ...
    public ListCommandsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Commands")) {
                listCommandsResult.setCommands(new ListUnmarshaller<Command>(
                        CommandJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                listCommandsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
