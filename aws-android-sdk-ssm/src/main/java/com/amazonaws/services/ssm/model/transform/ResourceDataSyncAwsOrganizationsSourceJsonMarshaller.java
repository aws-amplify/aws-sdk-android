...
class ResourceDataSyncAwsOrganizationsSourceJsonMarshaller {
    ...
    public void marshall(
        ...
        if (resourceDataSyncAwsOrganizationsSource.getOrganizationSourceType() != null) {
            String organizationSourceType = resourceDataSyncAwsOrganizationsSource
        ...
        if (resourceDataSyncAwsOrganizationsSource.getOrganizationalUnits() != null) {
            java.util.List<ResourceDataSyncOrganizationalUnit> organizationalUnits = resourceDataSyncAwsOrganizationsSource
            ...
            for (ResourceDataSyncOrganizationalUnit organizationalUnitsItem : organizationalUnits) {
                if (organizationalUnitsItem != null) {
                    ResourceDataSyncOrganizationalUnitJsonMarshaller.getInstance().marshall(
                            organizationalUnitsItem, jsonWriter);
                }
            }
            jsonWriter.endArray();
        }
    ...
    public static ResourceDataSyncAwsOrganizationsSourceJsonMarshaller getInstance() {
        if (instance == null)
            instance = new ResourceDataSyncAwsOrganizationsSourceJsonMarshaller();
        return instance;
    }
}
