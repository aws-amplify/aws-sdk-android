 ...
 */
public class StartAutomationExecutionResultJsonUnmarshaller implements
        Unmarshaller<StartAutomationExecutionResult, JsonUnmarshallerContext> {

    public StartAutomationExecutionResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AutomationExecutionId")) {
                startAutomationExecutionResult.setAutomationExecutionId(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
