    ...
    public Request<DescribeMaintenanceWindowExecutionTaskInvocationsRequest> marshall(
        ...
        if (describeMaintenanceWindowExecutionTaskInvocationsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeMaintenanceWindowExecutionTaskInvocationsRequest)");
        }
        ...
        Request<DescribeMaintenanceWindowExecutionTaskInvocationsRequest> request = new DefaultRequest<DescribeMaintenanceWindowExecutionTaskInvocationsRequest>(
                describeMaintenanceWindowExecutionTaskInvocationsRequest, "AmazonSSM");
        ...
        try {
            ...
            if (describeMaintenanceWindowExecutionTaskInvocationsRequest.getWindowExecutionId() != null) {
                String windowExecutionId = describeMaintenanceWindowExecutionTaskInvocationsRequest
            ...
            if (describeMaintenanceWindowExecutionTaskInvocationsRequest.getTaskId() != null) {
                String taskId = describeMaintenanceWindowExecutionTaskInvocationsRequest
                        .getTaskId();
                jsonWriter.name("TaskId");
                jsonWriter.value(taskId);
            }
            if (describeMaintenanceWindowExecutionTaskInvocationsRequest.getFilters() != null) {
                java.util.List<MaintenanceWindowFilter> filters = describeMaintenanceWindowExecutionTaskInvocationsRequest
                        .getFilters();
            ...
            if (describeMaintenanceWindowExecutionTaskInvocationsRequest.getMaxResults() != null) {
                Integer maxResults = describeMaintenanceWindowExecutionTaskInvocationsRequest
                        .getMaxResults();
                jsonWriter.name("MaxResults");
                jsonWriter.value(maxResults);
            }
            if (describeMaintenanceWindowExecutionTaskInvocationsRequest.getNextToken() != null) {
                String nextToken = describeMaintenanceWindowExecutionTaskInvocationsRequest
                        .getNextToken();
