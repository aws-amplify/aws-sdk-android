...
public class GetInventoryRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         Returns counts of inventory types based on one or more
     *         expressions. For example, if you aggregate by using an expression
     *         that uses the <code>AWS:InstanceInformation.PlatformType</code>
     *         type, you can see a count of how many Windows and Linux instances
     *         exist in your inventoried fleet.
     *         </p>
     */
     ...
     * @param aggregators <p>
     *            Returns counts of inventory types based on one or more
     *            expressions. For example, if you aggregate by using an
     *            expression that uses the
     *            <code>AWS:InstanceInformation.PlatformType</code> type, you
     *            can see a count of how many Windows and Linux instances exist
    ...
    public GetInventoryRequest withResultAttributes(ResultAttribute... resultAttributes) {
        if (getResultAttributes() == null) {
            this.resultAttributes = new java.util.ArrayList<ResultAttribute>(
     ...
     *         chained together.
     */
    public GetInventoryRequest withResultAttributes(
            java.util.Collection<ResultAttribute> resultAttributes) {
    ...
    public String toString() {
        ...
        if (getResultAttributes() != null)
            sb.append("ResultAttributes: " + getResultAttributes() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getResultAttributes() == null) ? 0 : getResultAttributes().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getResultAttributes() == null ^ this.getResultAttributes() == null)
            return false;
        if (other.getResultAttributes() != null
                && other.getResultAttributes().equals(this.getResultAttributes()) == false)
            return false;
