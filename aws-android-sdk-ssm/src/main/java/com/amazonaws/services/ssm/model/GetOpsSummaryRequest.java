...
public class GetOpsSummaryRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         Optional aggregators that return counts of OpsItems based on one
     *         or more expressions.
     *         </p>
     */
     ...
     *
     * @param aggregators <p>
     *            Optional aggregators that return counts of OpsItems based on
    ...
    public GetOpsSummaryRequest withResultAttributes(OpsResultAttribute... resultAttributes) {
        if (getResultAttributes() == null) {
            this.resultAttributes = new java.util.ArrayList<OpsResultAttribute>(
     ...
     *         chained together.
     */
    public GetOpsSummaryRequest withResultAttributes(
            java.util.Collection<OpsResultAttribute> resultAttributes) {
