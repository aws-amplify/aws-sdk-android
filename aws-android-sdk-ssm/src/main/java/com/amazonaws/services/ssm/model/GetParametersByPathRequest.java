 ...
 * <code>MaxResults</code> in the request, the response includes information up
 * to the limit specified. The number of items returned, however, can be between
 * zero and the value of <code>MaxResults</code>. If the service reaches an
 * internal limit while processing the results, it stops the operation and
 * returns the matching values up to that point and a <code>NextToken</code>.
...
public class GetParametersByPathRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         hierarchy can have a maximum of 15 levels. Here is an example of
     ...
     *
     * @param path <p>
     *            The hierarchy for the parameter. Hierarchies start with a
     *            forward slash (/) and end with the parameter name. A parameter
     *            name hierarchy can have a maximum of 15 levels. Here is an
     ...
     *         access path <code>/a</code>, then the user can also access
     *         <code>/a/b</code>. Even if a user has explicitly been denied
     *         access in IAM for parameter <code>/a/b</code>, they can still
     *         call the GetParametersByPath API action recursively for
     ...
     *         chained together.
     */
    public GetParametersByPathRequest withParameterFilters(
            ParameterStringFilter... parameterFilters) {
        if (getParameterFilters() == null) {
            this.parameterFilters = new java.util.ArrayList<ParameterStringFilter>(
     ...
     */
    public GetParametersByPathRequest withParameterFilters(
            java.util.Collection<ParameterStringFilter> parameterFilters) {
     ...
     *
     * @return <p>
     *         Retrieve all parameters in a hierarchy with their value
     *         decrypted.
     *         </p>
     */
    ...
    public String toString() {
        ...
        if (getParameterFilters() != null)
            sb.append("ParameterFilters: " + getParameterFilters() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getParameterFilters() == null) ? 0 : getParameterFilters().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getParameterFilters() == null ^ this.getParameterFilters() == null)
            return false;
        if (other.getParameterFilters() != null
                && other.getParameterFilters().equals(this.getParameterFilters()) == false)
            return false;
