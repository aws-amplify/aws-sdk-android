...
public class NotificationConfig implements Serializable {
     ...
     * >Configuring Amazon SNS Notifications for AWS Systems Manager</a> in the
     ...
     * </p>
     *
     * @param notificationArn <p>
     *            An Amazon Resource Name (ARN) for an Amazon Simple
     *            Notification Service (Amazon SNS) topic. Run Command pushes
     ...
     *         events, see <a href=
     *         "http://docs.aws.amazon.com/systems-manager/latest/userguide/monitoring-sns-notifications.html"
     *         >Configuring Amazon SNS Notifications for AWS Systems Manager</a>
     ...
     * </p>
     *
     * @param notificationEvents <p>
     *            The different events for which you can receive notifications.
     *            These events include the following: All (events), InProgress,
     *            Success, TimedOut, Cancelled, Failed. To learn more about
     *            these events, see <a href=
     *            "http://docs.aws.amazon.com/systems-manager/latest/userguide/monitoring-sns-notifications.html"
     *            >Configuring Amazon SNS Notifications for AWS Systems
     *            Manager</a> in the <i>AWS Systems Manager User Guide</i>.
     *            </p>
     */
     ...
     *            Command: Receive notification when the status of a command
     *            changes. Invocation: For commands sent to multiple instances,
     *            receive notification on a per-instance basis when the status
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getNotificationArn() == null) ? 0 : getNotificationArn().hashCode());
        hashCode = prime * hashCode
                + ((getNotificationEvents() == null) ? 0 : getNotificationEvents().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getNotificationEvents() != null
                && other.getNotificationEvents().equals(this.getNotificationEvents()) == false)
            return false;
