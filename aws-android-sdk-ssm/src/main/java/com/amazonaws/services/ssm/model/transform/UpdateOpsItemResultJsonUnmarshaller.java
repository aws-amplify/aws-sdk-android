...
/**
 * JSON unmarshaller for response UpdateOpsItemResult
 */
public class UpdateOpsItemResultJsonUnmarshaller implements
        Unmarshaller<UpdateOpsItemResult, JsonUnmarshallerContext> {
