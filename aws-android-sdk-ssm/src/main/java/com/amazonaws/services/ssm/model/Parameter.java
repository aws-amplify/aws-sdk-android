...
public class Parameter implements Serializable {
     ...
     * <code>String</code>, <code>StringList</code>, and
     ...
     * @param selector <p>
     *            Either the version number or the label used to retrieve the
     *            parameter value. Specify selectors by using one of the
     *            following formats:
     *            </p>
     *            <p>
     *            parameter_name:version
     ...
     *            Date the parameter was last changed or updated and the
     *            parameter version was created.
     *            </p>
     */
    ...
    public String toString() {
        ...
        if (getSourceResult() != null)
            sb.append("SourceResult: " + getSourceResult() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getSourceResult() == null) ? 0 : getSourceResult().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSourceResult() == null ^ this.getSourceResult() == null)
            return false;
        if (other.getSourceResult() != null
                && other.getSourceResult().equals(this.getSourceResult()) == false)
            return false;
