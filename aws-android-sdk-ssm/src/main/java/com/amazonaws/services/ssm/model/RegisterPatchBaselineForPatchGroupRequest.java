 ...
 * </p>
 */
public class RegisterPatchBaselineForPatchGroupRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         The name of the patch group that should be registered with the
     *         patch baseline.
     *         </p>
     */
