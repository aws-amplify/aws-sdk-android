...
public class ComplianceItem implements Serializable {
     ...
     * association), Patch, or Custom:<code>string</code> are all valid
     * compliance types.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
     ...
     *         Manager association), Patch, or Custom:<code>string</code> are
     *         all valid compliance types.
     *         </p>
     */
     ...
     *
     * @return <p>
     *         The type of resource. <code>ManagedInstance</code> is currently
     ...
     *            The type of resource. <code>ManagedInstance</code> is
     ...
     *
     * @return <p>
     *         An ID for the resource. For a managed instance, this is the
     *         instance ID.
     *         </p>
     */
     ...
     *
     * @return <p>
     *         A title for the compliance item. For example, if the compliance
     ...
     *
     * @param title <p>
     *            A title for the compliance item. For example, if the
     ...
     *         execution ID, the execution type (for example, command), and the
     *         execution time.
     *         </p>
     */
