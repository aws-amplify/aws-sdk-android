...
/**
 * JSON unmarshaller for response StartSessionResult
 */
public class StartSessionResultJsonUnmarshaller implements
        Unmarshaller<StartSessionResult, JsonUnmarshallerContext> {
    ...
    public StartSessionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SessionId")) {
                startSessionResult.setSessionId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TokenValue")) {
                startSessionResult.setTokenValue(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("StreamUrl")) {
                startSessionResult.setStreamUrl(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
