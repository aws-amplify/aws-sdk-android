...
public class ResourceComplianceSummaryItem implements Serializable {
     ...
     * UNSPECIFIED
     *
     * @param overallSeverity <p>
     *            The highest severity item found for the resource. The resource
     ...
     *         chained together.
     */
    public ResourceComplianceSummaryItem withExecutionSummary(
     ...
     *         chained together.
     */
    public ResourceComplianceSummaryItem withNonCompliantSummary(
    ...
    public String toString() {
        ...
        if (getOverallSeverity() != null)
            sb.append("OverallSeverity: " + getOverallSeverity() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getOverallSeverity() == null) ? 0 : getOverallSeverity().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getOverallSeverity() == null ^ this.getOverallSeverity() == null)
            return false;
        if (other.getOverallSeverity() != null
                && other.getOverallSeverity().equals(this.getOverallSeverity()) == false)
            return false;
