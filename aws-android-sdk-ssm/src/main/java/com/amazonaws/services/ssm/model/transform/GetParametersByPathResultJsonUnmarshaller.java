...
/**
 * JSON unmarshaller for response GetParametersByPathResult
 */
public class GetParametersByPathResultJsonUnmarshaller implements
        Unmarshaller<GetParametersByPathResult, JsonUnmarshallerContext> {
    ...
    public GetParametersByPathResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Parameters")) {
                getParametersByPathResult.setParameters(new ListUnmarshaller<Parameter>(
                        ParameterJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                getParametersByPathResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
