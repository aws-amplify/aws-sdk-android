...
public class DescribeMaintenanceWindowsForTargetResult implements Serializable {
     ...
     *            </p>
     */
    public void setWindowIdentities(
            java.util.Collection<MaintenanceWindowIdentityForTarget> windowIdentities) {
        if (windowIdentities == null) {
            this.windowIdentities = null;
            return;
        }

        this.windowIdentities = new java.util.ArrayList<MaintenanceWindowIdentityForTarget>(
                windowIdentities);
    }
     ...
     *         chained together.
     */
    public DescribeMaintenanceWindowsForTargetResult withWindowIdentities(
            MaintenanceWindowIdentityForTarget... windowIdentities) {
