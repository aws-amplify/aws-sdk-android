 ...
 */
class AssociationExecutionTargetJsonUnmarshaller implements
        Unmarshaller<AssociationExecutionTarget, JsonUnmarshallerContext> {
    ...
    public AssociationExecutionTarget unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AssociationId")) {
                ...
                associationExecutionTarget.setAssociationVersion(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                associationExecutionTarget.setOutputSource(OutputSourceJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
