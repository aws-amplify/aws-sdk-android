...
public class DescribeEffectiveInstanceAssociationsResultJsonUnmarshaller implements
    ...
    public DescribeEffectiveInstanceAssociationsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Associations")) {
                describeEffectiveInstanceAssociationsResult
                        .setAssociations(new ListUnmarshaller<InstanceAssociation>(
                                InstanceAssociationJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                describeEffectiveInstanceAssociationsResult.setNextToken(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
