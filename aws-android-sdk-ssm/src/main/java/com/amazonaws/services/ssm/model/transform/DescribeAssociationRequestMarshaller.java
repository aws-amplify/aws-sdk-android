 ...
 */
public class DescribeAssociationRequestMarshaller implements
    ...
    public Request<DescribeAssociationRequest> marshall(
        ...
        if (describeAssociationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeAssociationRequest)");
        }

        Request<DescribeAssociationRequest> request = new DefaultRequest<DescribeAssociationRequest>(
                describeAssociationRequest, "AmazonSimpleSystemsManager(SSM)");
