...
class AssociationVersionInfoJsonMarshaller {
    ...
    public void marshall(AssociationVersionInfo associationVersionInfo, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (associationVersionInfo.getParameters() != null) {
            java.util.Map<String, java.util.List<String>> parameters = associationVersionInfo
                    .getParameters();
        ...
        if (associationVersionInfo.getOutputLocation() != null) {
            InstanceAssociationOutputLocation outputLocation = associationVersionInfo
                    .getOutputLocation();
    ...
    public static AssociationVersionInfoJsonMarshaller getInstance() {
        if (instance == null)
            instance = new AssociationVersionInfoJsonMarshaller();
        return instance;
    }
}
