 ...
 * specified time. If you specify a time, <code>GetCalendarState</code> returns
 * the state of the calendar at a specific time, and returns the next time that
 * the Change Calendar state will transition. If you do not specify a time,
 * <code>GetCalendarState</code> assumes the current time. Change Calendar
 * entries have two possible states: <code>OPEN</code> or <code>CLOSED</code>.
 * For more information about Systems Manager Change Calendar, see <a href=
 * "https://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-change-calendar.html"
 * >AWS Systems Manager Change Calendar</a> in the <i>AWS Systems Manager User
 * Guide</i>.
 * </p>
 */
public class GetCalendarStateRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * @return <p>
     *         The names or Amazon Resource Names (ARNs) of the Systems Manager
     *         documents that represent the calendar entries for which you want
     *         to get the state.
     *         </p>
     */
     ...
     * </p>
     *
     * @param calendarNames <p>
     *            The names or Amazon Resource Names (ARNs) of the Systems
     *            Manager documents that represent the calendar entries for
     ...
     *         format. If you do not add <code>AtTime</code>, the current time
     *         is assumed.
     *         </p>
     */
     ...
     *
     * @param atTime <p>
     *            (Optional) The specific time for which you want to get
     *            calendar state information, in <a
     *            href="https://en.wikipedia.org/wiki/ISO_8601">ISO 8601</a>
     *            format. If you do not add <code>AtTime</code>, the current
     *            time is assumed.
     *            </p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getCalendarNames() != null)
            sb.append("CalendarNames: " + getCalendarNames() + ",");
        if (getAtTime() != null)
            sb.append("AtTime: " + getAtTime());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getCalendarNames() == null) ? 0 : getCalendarNames().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCalendarNames() == null ^ this.getCalendarNames() == null)
            return false;
        if (other.getCalendarNames() != null
                && other.getCalendarNames().equals(this.getCalendarNames()) == false)
            return false;
