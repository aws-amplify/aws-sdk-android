...
public class ResourceDataSyncDestinationDataSharing implements Serializable {
     ...
     *
     * @return <p>
     *         The sharing data type. Only <code>Organization</code> is
     *         supported.
     *         </p>
     */
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @param destinationDataSharingType <p>
     *            The sharing data type. Only <code>Organization</code> is
     *            supported.
     *            </p>
     */
     ...
     *         chained together.
     */
    public ResourceDataSyncDestinationDataSharing withDestinationDataSharingType(
    ...
    public String toString() {
        ...
        if (getDestinationDataSharingType() != null)
            sb.append("DestinationDataSharingType: " + getDestinationDataSharingType());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getDestinationDataSharingType() == null) ? 0 : getDestinationDataSharingType()
                        .hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDestinationDataSharingType() == null
                ^ this.getDestinationDataSharingType() == null)
            return false;
        if (other.getDestinationDataSharingType() != null
                && other.getDestinationDataSharingType().equals(
                        this.getDestinationDataSharingType()) == false)
            return false;
        return true;
    }
}
