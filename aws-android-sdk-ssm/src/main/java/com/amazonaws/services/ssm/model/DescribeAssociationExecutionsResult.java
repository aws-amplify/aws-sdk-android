...
public class DescribeAssociationExecutionsResult implements Serializable {
     ...
     * </p>
     *
     * @param associationExecutions <p>
     *            A list of the executions for the specified association ID.
     *            </p>
     */
    public void setAssociationExecutions(
            java.util.Collection<AssociationExecution> associationExecutions) {
        if (associationExecutions == null) {
            this.associationExecutions = null;
            return;
        }

        this.associationExecutions = new java.util.ArrayList<AssociationExecution>(
     ...
     *         chained together.
     */
    public DescribeAssociationExecutionsResult withAssociationExecutions(
            AssociationExecution... associationExecutions) {
        if (getAssociationExecutions() == null) {
            this.associationExecutions = new java.util.ArrayList<AssociationExecution>(
                    associationExecutions.length);
        }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getAssociationExecutions() != null)
            sb.append("AssociationExecutions: " + getAssociationExecutions() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getAssociationExecutions() == null) ? 0 : getAssociationExecutions().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAssociationExecutions() == null ^ this.getAssociationExecutions() == null)
            return false;
        if (other.getAssociationExecutions() != null
                && other.getAssociationExecutions().equals(this.getAssociationExecutions()) == false)
            return false;
