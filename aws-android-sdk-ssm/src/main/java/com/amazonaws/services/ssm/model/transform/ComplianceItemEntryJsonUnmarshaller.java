 ...
 */
class ComplianceItemEntryJsonUnmarshaller implements
        Unmarshaller<ComplianceItemEntry, JsonUnmarshallerContext> {
    ...
    public ComplianceItemEntry unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Id")) {
                ...
                complianceItemEntry.setDetails(new MapUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
