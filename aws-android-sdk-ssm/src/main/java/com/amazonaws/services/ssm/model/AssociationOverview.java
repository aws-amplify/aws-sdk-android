...
public class AssociationOverview implements Serializable {
     ...
     *         example, if you created an association with two instances, and
     *         one of them was successful, this would return the count of
     *         instances by status.
     *         </p>
     */
     ...
     * </p>
     *
     * @param associationStatusAggregatedCount <p>
     *            Returns the number of targets for the association status. For
     *            example, if you created an association with two instances, and
     *            one of them was successful, this would return the count of
     *            instances by status.
     *            </p>
     */
    public void setAssociationStatusAggregatedCount(
            java.util.Map<String, Integer> associationStatusAggregatedCount) {
     ...
     *         chained together.
     */
    public AssociationOverview withAssociationStatusAggregatedCount(
            java.util.Map<String, Integer> associationStatusAggregatedCount) {
        this.associationStatusAggregatedCount = associationStatusAggregatedCount;
        return this;
    }
     ...
     * AssociationStatusAggregatedCount parameter, and returns a reference to
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getAssociationStatusAggregatedCount() == null) ? 0
                        : getAssociationStatusAggregatedCount().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAssociationStatusAggregatedCount() == null
                ^ this.getAssociationStatusAggregatedCount() == null)
            return false;
        if (other.getAssociationStatusAggregatedCount() != null
                && other.getAssociationStatusAggregatedCount().equals(
                        this.getAssociationStatusAggregatedCount()) == false)
            return false;
        return true;
    }
}
