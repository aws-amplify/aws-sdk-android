...
public class GetCalendarStateResult implements Serializable {
     ...
     * actions are allowed to proceed, and a <code>CLOSED</code> calendar
     * indicates that actions are not allowed to proceed.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
     ...
     * 8601</a> string, that you specified in your command. If you did not
     ...
     *
     * @return <p>
     *         The state of the calendar. An <code>OPEN</code> calendar
     *         indicates that actions are allowed to proceed, and a
     *         <code>CLOSED</code> calendar indicates that actions are not
     *         allowed to proceed.
     *         </p>
     * @see CalendarState
     */
     ...
     *         string, that you specified in your command. If you did not
     *         specify a time, <code>GetCalendarState</code> uses the current
     *         time.
     *         </p>
     */
     ...
     *         The time, as an <a
     *         href="https://en.wikipedia.org/wiki/ISO_8601">ISO 8601</a>
     *         string, that the calendar state will change. If the current
     *         calendar state is <code>OPEN</code>,
     *         <code>NextTransitionTime</code> indicates when the calendar state
     *         changes to <code>CLOSED</code>, and vice-versa.
     *         </p>
     */
     ...
     * </p>
     *
     * @param nextTransitionTime <p>
     *            The time, as an <a
     *            href="https://en.wikipedia.org/wiki/ISO_8601">ISO 8601</a>
     *            string, that the calendar state will change. If the current
     *            calendar state is <code>OPEN</code>,
     *            <code>NextTransitionTime</code> indicates when the calendar
     *            state changes to <code>CLOSED</code>, and vice-versa.
     *            </p>
     */
    ...
    public String toString() {
        ...
        if (getNextTransitionTime() != null)
            sb.append("NextTransitionTime: " + getNextTransitionTime());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getNextTransitionTime() == null) ? 0 : getNextTransitionTime().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getNextTransitionTime() == null ^ this.getNextTransitionTime() == null)
            return false;
        if (other.getNextTransitionTime() != null
                && other.getNextTransitionTime().equals(this.getNextTransitionTime()) == false)
            return false;
        return true;
    }
}
