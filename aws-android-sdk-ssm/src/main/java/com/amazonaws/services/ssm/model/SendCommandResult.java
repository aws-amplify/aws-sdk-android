...
public class SendCommandResult implements Serializable {
     ...
     *
     * @return <p>
     *         The request as it was received by Systems Manager. Also provides
     *         the command ID which can be used future references to this
     *         request.
     *         </p>
     */
     ...
     *
     * @param command <p>
     *            The request as it was received by Systems Manager. Also
     *            provides the command ID which can be used future references to
     *            this request.
     *            </p>
     */
