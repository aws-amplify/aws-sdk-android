...
public class PatchStatus implements Serializable {
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>APPROVED, PENDING_APPROVAL, EXPLICIT_APPROVED,
     * EXPLICIT_REJECTED
     */
     ...
     *
     * @return <p>
     *         The date the patch was approved (or will be approved if the
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getApprovalDate() == null) ? 0 : getApprovalDate().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getApprovalDate() == null ^ this.getApprovalDate() == null)
            return false;
        if (other.getApprovalDate() != null
                && other.getApprovalDate().equals(this.getApprovalDate()) == false)
            return false;
        return true;
    }
}
