...
class InstancePatchStateJsonMarshaller {
    ...
    public void marshall(InstancePatchState instancePatchState, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (instancePatchState.getInstalledPendingRebootCount() != null) {
            Integer installedPendingRebootCount = instancePatchState
        ...
        if (instancePatchState.getUnreportedNotApplicableCount() != null) {
            Integer unreportedNotApplicableCount = instancePatchState
        ...
        if (instancePatchState.getLastNoRebootInstallOperationTime() != null) {
            java.util.Date lastNoRebootInstallOperationTime = instancePatchState
