...
class InventoryResultItemJsonMarshaller {
    ...
    public void marshall(InventoryResultItem inventoryResultItem, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (inventoryResultItem.getContent() != null) {
            java.util.List<java.util.Map<String, String>> content = inventoryResultItem
                    .getContent();
