...
public class StartSessionResult implements Serializable {
     ...
     * </p>
     * <p>
     * <b>region</b> represents the Region identifier for an AWS Region
     * supported by AWS Systems Manager, such as <code>us-east-2</code> for the
     * US East (Ohio) Region. For a list of supported <b>region</b> values, see
     * the <b>Region</b> column in <a
     * href="http://docs.aws.amazon.com/general/latest/gr/ssm.html#ssm_region"
     * >Systems Manager Service Endpoints</a> in the <i>AWS General
     * Reference</i>.
     * </p>
     * <p>
     ...
     *
     * @return <p>
     *         An encrypted token value containing session and caller
     *         information. Used to authenticate the connection to the instance.
     *         </p>
     */
     ...
     * @param tokenValue <p>
     *            An encrypted token value containing session and caller
     *            information. Used to authenticate the connection to the
     *            instance.
     *            </p>
     */
     ...
     *         <p>
     *         <b>region</b> represents the Region identifier for an AWS Region
     *         supported by AWS Systems Manager, such as <code>us-east-2</code>
     *         for the US East (Ohio) Region. For a list of supported
     *         <b>region</b> values, see the <b>Region</b> column in <a href=
     *         "http://docs.aws.amazon.com/general/latest/gr/ssm.html#ssm_region"
     *         >Systems Manager Service Endpoints</a> in the <i>AWS General
     *         Reference</i>.
     *         </p>
     *         <p>
     *         <b>session-id</b> represents the ID of a Session Manager session,
     *         such as <code>1a2b3c4dEXAMPLE</code>.
     *         </p>
     */
     ...
     *
     * @param streamUrl <p>
     *            A URL back to SSM Agent on the instance that the Session
     *            Manager client uses to send commands and receive output from
     *            the instance. Format:
     *            <code>wss://ssmmessages.<b>region</b>.amazonaws.com/v1/data-channel/<b>session-id</b>?stream=(input|output)</code>
     *            </p>
     *            <p>
     *            <b>region</b> represents the Region identifier for an AWS
     *            Region supported by AWS Systems Manager, such as
     *            <code>us-east-2</code> for the US East (Ohio) Region. For a
     *            list of supported <b>region</b> values, see the <b>Region</b>
     *            column in <a href=
     *            "http://docs.aws.amazon.com/general/latest/gr/ssm.html#ssm_region"
     *            >Systems Manager Service Endpoints</a> in the <i>AWS General
     *            Reference</i>.
     *            </p>
     *            <p>
     *            <b>session-id</b> represents the ID of a Session Manager
     *            session, such as <code>1a2b3c4dEXAMPLE</code>.
     *            </p>
     */
    ...
    public String toString() {
        ...
        if (getTokenValue() != null)
            sb.append("TokenValue: " + getTokenValue() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTokenValue() != null
                && other.getTokenValue().equals(this.getTokenValue()) == false)
            return false;
        if (other.getStreamUrl() == null ^ this.getStreamUrl() == null)
            return false;
        if (other.getStreamUrl() != null
                && other.getStreamUrl().equals(this.getStreamUrl()) == false)
            return false;
        return true;
    }
}
