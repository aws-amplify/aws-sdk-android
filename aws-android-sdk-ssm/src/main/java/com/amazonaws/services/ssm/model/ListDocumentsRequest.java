...
public class ListDocumentsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         <code>DocumentType</code>, and <code>TargetType</code>. For
     *         example, to return documents you own use
     *         <code>Key=Owner,Values=Self</code>. To specify a custom key-value
     *         pair, use the format
     ...
     *            <code>DocumentType</code>, and <code>TargetType</code>. For
     *            example, to return documents you own use
     *            <code>Key=Owner,Values=Self</code>. To specify a custom
