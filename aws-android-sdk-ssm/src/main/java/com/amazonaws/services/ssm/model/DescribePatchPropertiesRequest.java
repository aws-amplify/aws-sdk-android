 ...
 * family, classification, severity, and other properties of available patches.
 * You can use the reported properties in the filters you specify in requests
 * for actions such as <a>CreatePatchBaseline</a>, <a>UpdatePatchBaseline</a>,
 * <a>DescribeAvailablePatches</a>, and <a>DescribePatchBaselines</a>.
 * </p>
 * <p>
...
public class DescribePatchPropertiesRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>PRODUCT, PRODUCT_FAMILY, CLASSIFICATION,
     * MSRC_SEVERITY, PRIORITY, SEVERITY
     */
     ...
     *
     * @return <p>
     *         Indicates whether to list patches for the Windows operating
     *         system or for Microsoft applications. Not applicable for Linux
     *         operating systems.
     *         </p>
     * @see PatchSet
     */
    ...
    public String toString() {
        ...
        if (getPatchSet() != null)
            sb.append("PatchSet: " + getPatchSet() + ",");
