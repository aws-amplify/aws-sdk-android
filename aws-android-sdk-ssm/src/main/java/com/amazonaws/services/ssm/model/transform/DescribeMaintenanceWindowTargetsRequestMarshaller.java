...
public class DescribeMaintenanceWindowTargetsRequestMarshaller
    ...
    public Request<DescribeMaintenanceWindowTargetsRequest> marshall(
        ...
        if (describeMaintenanceWindowTargetsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeMaintenanceWindowTargetsRequest)");
        }

        Request<DescribeMaintenanceWindowTargetsRequest> request = new DefaultRequest<DescribeMaintenanceWindowTargetsRequest>(
                describeMaintenanceWindowTargetsRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (describeMaintenanceWindowTargetsRequest.getFilters() != null) {
                java.util.List<MaintenanceWindowFilter> filters = describeMaintenanceWindowTargetsRequest
                        .getFilters();
