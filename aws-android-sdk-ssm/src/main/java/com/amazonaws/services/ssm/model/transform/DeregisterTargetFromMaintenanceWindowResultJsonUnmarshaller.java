...
public class DeregisterTargetFromMaintenanceWindowResultJsonUnmarshaller implements
    ...
    public DeregisterTargetFromMaintenanceWindowResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("WindowId")) {
                deregisterTargetFromMaintenanceWindowResult.setWindowId(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
