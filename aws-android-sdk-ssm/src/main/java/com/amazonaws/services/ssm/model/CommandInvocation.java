...
public class CommandInvocation implements Serializable {
     ...
     *         value for the aws:Name tag. For on-premises instances, this is
     ...
     *            The name of the invocation target. For EC2 instances this is
     *            the value for the aws:Name tag. For on-premises instances,
     ...
     *
     * @return <p>
     *         The URL to the plugin's StdOut file in Amazon S3, if the S3
     *         bucket was defined for the parent command. For an invocation,
     *         StandardOutputUrl is populated if there is just one plugin
     *         defined for the command, and the S3 bucket was defined for the
     *         command.
     *         </p>
     */
     ...
     *
     * @return <p>
     *         The URL to the plugin's StdErr file in Amazon S3, if the S3
     *         bucket was defined for the parent command. For an invocation,
     ...
     *            The URL to the plugin's StdErr file in Amazon S3, if the S3
     *            bucket was defined for the parent command. For an invocation,
     *            StandardErrorUrl is populated if there is just one plugin
     *            defined for the command, and the S3 bucket was defined for the
     *            command.
     *            </p>
     */
