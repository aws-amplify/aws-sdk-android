...
public class CommandInvocation implements Serializable {
     ...
     * was defined for the parent command. For an invocation, StandardErrorUrl
     * is populated if there is just one plugin defined for the command, and the
     * Amazon S3 bucket was defined for the command.
     * </p>
     */
     ...
     *
     * @return <p>
     *         The name of the invocation target. For Amazon EC2 instances this
     *         is the value for the aws:Name tag. For on-premises instances,
     ...
     *            The name of the invocation target. For Amazon EC2 instances
     *            this is the value for the aws:Name tag. For on-premises
     ...
     *
     * @param status <p>
     *            Whether or not the invocation succeeded, failed, or is
     *            pending.
     *            </p>
     * @see CommandInvocationStatus
     */
     ...
     *
     * @return <p>
     *         A detailed status of the command execution for each invocation
     *         (each instance targeted by the command). StatusDetails includes
     ...
     *            A detailed status of the command execution for each invocation
     *            (each instance targeted by the command). StatusDetails
     ...
     *
     * @return <p>
     *         The URL to the plugin's StdOut file in Amazon S3, if the Amazon
     *         S3 bucket was defined for the parent command. For an invocation,
     *         StandardOutputUrl is populated if there is just one plugin
     *         defined for the command, and the Amazon S3 bucket was defined for
     *         the command.
     *         </p>
     */
     ...
     *            Amazon S3 bucket was defined for the parent command. For an
     *            invocation, StandardOutputUrl is populated if there is just
     *            one plugin defined for the command, and the Amazon S3 bucket
     ...
     *
     * @return <p>
     *         The URL to the plugin's StdErr file in Amazon S3, if the Amazon
     *         S3 bucket was defined for the parent command. For an invocation,
     ...
     *            Amazon S3 bucket was defined for the parent command. For an
     *            invocation, StandardErrorUrl is populated if there is just one
     *            plugin defined for the command, and the Amazon S3 bucket was
     ...
     *
     * @param commandPlugins The new value for the commandPlugins property for
     *            this object.
     */
     ...
     *         chained together.
     */
    public CommandInvocation withCloudWatchOutputConfig(
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getCommandPlugins() == null) ? 0 : getCommandPlugins().hashCode());
        hashCode = prime * hashCode
