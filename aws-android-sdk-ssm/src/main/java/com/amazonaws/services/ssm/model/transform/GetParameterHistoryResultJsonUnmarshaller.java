...
/**
 * JSON unmarshaller for response GetParameterHistoryResult
 */
public class GetParameterHistoryResultJsonUnmarshaller implements
        Unmarshaller<GetParameterHistoryResult, JsonUnmarshallerContext> {
    ...
    public GetParameterHistoryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Parameters")) {
                getParameterHistoryResult.setParameters(new ListUnmarshaller<ParameterHistory>(
                        ParameterHistoryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                getParameterHistoryResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
