...
public class UpdateAssociationResult implements Serializable {
    /**
     * <p>
     ...
     * </p>
     *
     * @param associationDescription <p>
     *            The description of the association that was updated.
     *            </p>
     */
     ...
     *         chained together.
     */
    public UpdateAssociationResult withAssociationDescription(
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getAssociationDescription() == null) ? 0 : getAssociationDescription()
                        .hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAssociationDescription() != null
                && other.getAssociationDescription().equals(this.getAssociationDescription()) == false)
            return false;
        return true;
    }
}
