...
/**
 * JSON unmarshaller for response ResetServiceSettingResult
 */
public class ResetServiceSettingResultJsonUnmarshaller implements
        Unmarshaller<ResetServiceSettingResult, JsonUnmarshallerContext> {
    ...
    public ResetServiceSettingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ServiceSetting")) {
                resetServiceSettingResult.setServiceSetting(ServiceSettingJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
