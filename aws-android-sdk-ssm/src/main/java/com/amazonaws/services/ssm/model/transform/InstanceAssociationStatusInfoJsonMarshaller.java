...
class InstanceAssociationStatusInfoJsonMarshaller {
    ...
    public void marshall(InstanceAssociationStatusInfo instanceAssociationStatusInfo,
        ...
        if (instanceAssociationStatusInfo.getOutputUrl() != null) {
            ...
            InstanceAssociationOutputUrlJsonMarshaller.getInstance()
                    .marshall(outputUrl, jsonWriter);
        }
