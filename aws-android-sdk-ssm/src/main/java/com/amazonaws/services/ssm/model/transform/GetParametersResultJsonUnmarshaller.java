 ...
 */
public class GetParametersResultJsonUnmarshaller implements
        Unmarshaller<GetParametersResult, JsonUnmarshallerContext> {
    ...
    public GetParametersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Parameters")) {
                getParametersResult.setParameters(new ListUnmarshaller<Parameter>(
                        ParameterJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("InvalidParameters")) {
                getParametersResult.setInvalidParameters(new ListUnmarshaller<String>(
