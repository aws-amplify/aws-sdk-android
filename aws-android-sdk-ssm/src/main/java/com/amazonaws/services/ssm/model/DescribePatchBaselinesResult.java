...
public class DescribePatchBaselinesResult implements Serializable {
     ...
     *         chained together.
     */
    public DescribePatchBaselinesResult withBaselineIdentities(
            PatchBaselineIdentity... baselineIdentities) {
        if (getBaselineIdentities() == null) {
            this.baselineIdentities = new java.util.ArrayList<PatchBaselineIdentity>(
                    baselineIdentities.length);
        }
     ...
     */
    public DescribePatchBaselinesResult withBaselineIdentities(
            java.util.Collection<PatchBaselineIdentity> baselineIdentities) {
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getBaselineIdentities() == null) ? 0 : getBaselineIdentities().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getBaselineIdentities() == null ^ this.getBaselineIdentities() == null)
            return false;
        if (other.getBaselineIdentities() != null
                && other.getBaselineIdentities().equals(this.getBaselineIdentities()) == false)
            return false;
