...
/**
 * JSON unmarshaller for response LabelParameterVersionResult
 */
public class LabelParameterVersionResultJsonUnmarshaller implements
        Unmarshaller<LabelParameterVersionResult, JsonUnmarshallerContext> {
    ...
    public LabelParameterVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("InvalidLabels")) {
                labelParameterVersionResult.setInvalidLabels(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("ParameterVersion")) {
                labelParameterVersionResult.setParameterVersion(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
