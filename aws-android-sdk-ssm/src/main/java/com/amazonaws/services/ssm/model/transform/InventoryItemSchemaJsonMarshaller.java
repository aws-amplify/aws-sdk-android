...
class InventoryItemSchemaJsonMarshaller {
    ...
    public void marshall(InventoryItemSchema inventoryItemSchema, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (inventoryItemSchema.getAttributes() != null) {
            ...
            for (InventoryItemAttribute attributesItem : attributes) {
                if (attributesItem != null) {
                    InventoryItemAttributeJsonMarshaller.getInstance().marshall(attributesItem,
                            jsonWriter);
                }
            }
            jsonWriter.endArray();
