...
class MaintenanceWindowExecutionTaskInvocationIdentityJsonMarshaller {
    ...
    public void marshall(
        ...
        if (maintenanceWindowExecutionTaskInvocationIdentity.getWindowExecutionId() != null) {
            String windowExecutionId = maintenanceWindowExecutionTaskInvocationIdentity
        ...
        if (maintenanceWindowExecutionTaskInvocationIdentity.getTaskExecutionId() != null) {
            String taskExecutionId = maintenanceWindowExecutionTaskInvocationIdentity
                    .getTaskExecutionId();
        ...
        if (maintenanceWindowExecutionTaskInvocationIdentity.getInvocationId() != null) {
            String invocationId = maintenanceWindowExecutionTaskInvocationIdentity
                    .getInvocationId();
        ...
        if (maintenanceWindowExecutionTaskInvocationIdentity.getStatusDetails() != null) {
            String statusDetails = maintenanceWindowExecutionTaskInvocationIdentity
                    .getStatusDetails();
        ...
        if (maintenanceWindowExecutionTaskInvocationIdentity.getStartTime() != null) {
            java.util.Date startTime = maintenanceWindowExecutionTaskInvocationIdentity
                    .getStartTime();
        ...
        if (maintenanceWindowExecutionTaskInvocationIdentity.getOwnerInformation() != null) {
            String ownerInformation = maintenanceWindowExecutionTaskInvocationIdentity
                    .getOwnerInformation();
        ...
        if (maintenanceWindowExecutionTaskInvocationIdentity.getWindowTargetId() != null) {
            String windowTargetId = maintenanceWindowExecutionTaskInvocationIdentity
                    .getWindowTargetId();
