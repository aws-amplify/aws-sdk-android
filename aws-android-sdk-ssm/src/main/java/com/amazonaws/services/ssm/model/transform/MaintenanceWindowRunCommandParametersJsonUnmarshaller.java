 ...
 */
class MaintenanceWindowRunCommandParametersJsonUnmarshaller implements
    ...
    public MaintenanceWindowRunCommandParameters unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Comment")) {
                maintenanceWindowRunCommandParameters.setComment(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                maintenanceWindowRunCommandParameters.setDocumentHash(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("DocumentHashType")) {
                maintenanceWindowRunCommandParameters.setDocumentHashType(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("DocumentVersion")) {
                maintenanceWindowRunCommandParameters.setDocumentVersion(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("NotificationConfig")) {
                maintenanceWindowRunCommandParameters
                        .setNotificationConfig(NotificationConfigJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("OutputS3BucketName")) {
                maintenanceWindowRunCommandParameters.setOutputS3BucketName(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("OutputS3KeyPrefix")) {
                maintenanceWindowRunCommandParameters.setOutputS3KeyPrefix(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                maintenanceWindowRunCommandParameters.setServiceRoleArn(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("TimeoutSeconds")) {
                maintenanceWindowRunCommandParameters.setTimeoutSeconds(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
