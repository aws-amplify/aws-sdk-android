...
public class DeleteInventoryRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * enable this schema again, you must call the <code>PutInventory</code>
     ...
     * without specifying the <code>DryRun</code> option.
     * </p>
     */
     ...
     *
     * @return <p>
     *         The name of the custom inventory type for which you want to
     *         delete either all previously collected data, or the inventory
     *         type itself.
     *         </p>
     */
     ...
     *
     * @return <p>
     *         Use the <code>SchemaDeleteOption</code> to delete a custom
     *         inventory type (schema). If you don't choose this option, the
     *         system only deletes existing inventory data associated with the
     *         custom inventory type. Choose one of the following options:
     *         </p>
     *         <p>
     *         DisableSchema: If you choose this option, the system ignores all
     *         inventory data for the specified version, and any earlier
     *         versions. To enable this schema again, you must call the
     *         <code>PutInventory</code> action for a version greater than the
     *         disabled version.
     *         </p>
     *         <p>
     *         DeleteSchema: This option deletes the specified custom type from
     *         the Inventory service. You can recreate the schema later, if you
     *         want.
     *         </p>
     ...
     * <b>Allowed Values: </b>DisableSchema, DeleteSchema
     *
     * @param schemaDeleteOption <p>
     *            Use the <code>SchemaDeleteOption</code> to delete a custom
     *            inventory type (schema). If you don't choose this option, the
     *            system only deletes existing inventory data associated with
     *            the custom inventory type. Choose one of the following
     *            options:
     *            </p>
     *            <p>
     *            DisableSchema: If you choose this option, the system ignores
     *            all inventory data for the specified version, and any earlier
     *            versions. To enable this schema again, you must call the
     *            <code>PutInventory</code> action for a version greater than
     *            the disabled version.
     *            </p>
     *            <p>
     *            DeleteSchema: This option deletes the specified custom type
     *            from the Inventory service. You can recreate the schema later,
     *            if you want.
     *            </p>
     * @see InventorySchemaDeleteOption
     */
     ...
     * @see InventorySchemaDeleteOption
     */
    public DeleteInventoryRequest withSchemaDeleteOption(
     ...
     * @return <p>
     *         Use this option to view a summary of the deletion request without
     *         deleting any data or the data type. This option is useful when
     *         you only want to understand what will be deleted. Once you
     *         validate that the data to be deleted is what you intend to
     *         delete, you can run the same command without specifying the
     ...
     *            without deleting any data or the data type. This option is
     *            useful when you only want to understand what will be deleted.
     *            Once you validate that the data to be deleted is what you
     *            intend to delete, you can run the same command without
    ...
    public String toString() {
        ...
        if (getSchemaDeleteOption() != null)
            sb.append("SchemaDeleteOption: " + getSchemaDeleteOption() + ",");
        if (getDryRun() != null)
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getSchemaDeleteOption() == null) ? 0 : getSchemaDeleteOption().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSchemaDeleteOption() == null ^ this.getSchemaDeleteOption() == null)
            return false;
        if (other.getSchemaDeleteOption() != null
                && other.getSchemaDeleteOption().equals(this.getSchemaDeleteOption()) == false)
            return false;
