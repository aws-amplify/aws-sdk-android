...
/**
 * JSON unmarshaller for response DeleteParameterResult
 */
public class DeleteParameterResultJsonUnmarshaller implements
        Unmarshaller<DeleteParameterResult, JsonUnmarshallerContext> {
