...
public class ListAssociationsRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public void setAssociationFilterList(
        ...
        this.associationFilterList = new java.util.ArrayList<AssociationFilter>(
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getAssociationFilterList() == null) ? 0 : getAssociationFilterList().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAssociationFilterList() != null
                && other.getAssociationFilterList().equals(this.getAssociationFilterList()) == false)
            return false;
