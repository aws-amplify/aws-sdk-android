...
class ResourceDataSyncSourceWithStateJsonMarshaller {
    ...
    public void marshall(ResourceDataSyncSourceWithState resourceDataSyncSourceWithState,
        ...
        if (resourceDataSyncSourceWithState.getAwsOrganizationsSource() != null) {
            ResourceDataSyncAwsOrganizationsSource awsOrganizationsSource = resourceDataSyncSourceWithState
        ...
        if (resourceDataSyncSourceWithState.getSourceRegions() != null) {
            java.util.List<String> sourceRegions = resourceDataSyncSourceWithState
                    .getSourceRegions();
        ...
        if (resourceDataSyncSourceWithState.getIncludeFutureRegions() != null) {
            Boolean includeFutureRegions = resourceDataSyncSourceWithState
    ...
    public static ResourceDataSyncSourceWithStateJsonMarshaller getInstance() {
        if (instance == null)
            instance = new ResourceDataSyncSourceWithStateJsonMarshaller();
        return instance;
    }
}
