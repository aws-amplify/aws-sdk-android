 ...
 */
public class SendAutomationSignalRequestMarshaller implements
        Marshaller<Request<SendAutomationSignalRequest>, SendAutomationSignalRequest> {

    public Request<SendAutomationSignalRequest> marshall(
            SendAutomationSignalRequest sendAutomationSignalRequest) {
        if (sendAutomationSignalRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(SendAutomationSignalRequest)");
        }

        Request<SendAutomationSignalRequest> request = new DefaultRequest<SendAutomationSignalRequest>(
                sendAutomationSignalRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (sendAutomationSignalRequest.getAutomationExecutionId() != null) {
                String automationExecutionId = sendAutomationSignalRequest
            ...
            if (sendAutomationSignalRequest.getPayload() != null) {
                java.util.Map<String, java.util.List<String>> payload = sendAutomationSignalRequest
                        .getPayload();
                jsonWriter.name("Payload");
                jsonWriter.beginObject();
                for (java.util.Map.Entry<String, java.util.List<String>> payloadEntry : payload
                        .entrySet()) {
