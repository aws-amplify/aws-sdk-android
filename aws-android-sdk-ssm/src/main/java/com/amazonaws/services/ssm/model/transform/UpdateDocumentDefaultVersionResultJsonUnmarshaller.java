 ...
 */
public class UpdateDocumentDefaultVersionResultJsonUnmarshaller implements
        Unmarshaller<UpdateDocumentDefaultVersionResult, JsonUnmarshallerContext> {

    public UpdateDocumentDefaultVersionResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Description")) {
                updateDocumentDefaultVersionResult
                        .setDescription(DocumentDefaultVersionDescriptionJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
