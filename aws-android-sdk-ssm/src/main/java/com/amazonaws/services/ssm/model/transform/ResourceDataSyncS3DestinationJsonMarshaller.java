...
class ResourceDataSyncS3DestinationJsonMarshaller {
    ...
    public void marshall(ResourceDataSyncS3Destination resourceDataSyncS3Destination,
        ...
        if (resourceDataSyncS3Destination.getDestinationDataSharing() != null) {
            ResourceDataSyncDestinationDataSharing destinationDataSharing = resourceDataSyncS3Destination
                    .getDestinationDataSharing();
            jsonWriter.name("DestinationDataSharing");
            ResourceDataSyncDestinationDataSharingJsonMarshaller.getInstance().marshall(
                    destinationDataSharing, jsonWriter);
        }
    ...
    public static ResourceDataSyncS3DestinationJsonMarshaller getInstance() {
        if (instance == null)
            instance = new ResourceDataSyncS3DestinationJsonMarshaller();
        return instance;
    }
}
