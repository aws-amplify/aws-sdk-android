...
public class TargetLocation implements Serializable {
     ...
     * <b>Pattern: </b>^([1-9][0-9]*|[1-9][0-9]%|[1-9]%|100%)$<br/>
     *
     * @param targetLocationMaxConcurrency <p>
     *            The maximum number of AWS accounts and AWS regions allowed to
     *            run the Automation concurrently
     *            </p>
     */
     ...
     * <b>Pattern: </b>^([1-9][0-9]*|[0]|[1-9][0-9]%|[0-9]%|100%)$<br/>
     *
     * @param targetLocationMaxErrors <p>
     *            The maximum number of errors allowed before the system stops
     *            queueing additional Automation executions for the currently
     *            running Automation.
     *            </p>
    ...
    public String toString() {
        ...
        if (getTargetLocationMaxConcurrency() != null)
            sb.append("TargetLocationMaxConcurrency: " + getTargetLocationMaxConcurrency() + ",");
        if (getTargetLocationMaxErrors() != null)
            sb.append("TargetLocationMaxErrors: " + getTargetLocationMaxErrors() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getTargetLocationMaxConcurrency() == null) ? 0
                        : getTargetLocationMaxConcurrency().hashCode());
        hashCode = prime
                * hashCode
                + ((getTargetLocationMaxErrors() == null) ? 0 : getTargetLocationMaxErrors()
                        .hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getRegions() != null && other.getRegions().equals(this.getRegions()) == false)
            return false;
        if (other.getTargetLocationMaxConcurrency() == null
                ^ this.getTargetLocationMaxConcurrency() == null)
            return false;
        if (other.getTargetLocationMaxConcurrency() != null
                && other.getTargetLocationMaxConcurrency().equals(
                        this.getTargetLocationMaxConcurrency()) == false)
            return false;
        if (other.getTargetLocationMaxErrors() == null ^ this.getTargetLocationMaxErrors() == null)
            return false;
        if (other.getTargetLocationMaxErrors() != null
                && other.getTargetLocationMaxErrors().equals(this.getTargetLocationMaxErrors()) == false)
            return false;
