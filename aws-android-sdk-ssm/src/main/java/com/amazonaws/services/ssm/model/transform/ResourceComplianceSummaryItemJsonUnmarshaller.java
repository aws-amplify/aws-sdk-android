 ...
 */
class ResourceComplianceSummaryItemJsonUnmarshaller implements
        Unmarshaller<ResourceComplianceSummaryItem, JsonUnmarshallerContext> {
    ...
    public ResourceComplianceSummaryItem unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ComplianceType")) {
                resourceComplianceSummaryItem.setComplianceType(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                resourceComplianceSummaryItem.setOverallSeverity(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("ExecutionSummary")) {
                resourceComplianceSummaryItem
                        .setExecutionSummary(ComplianceExecutionSummaryJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else if (name.equals("CompliantSummary")) {
                resourceComplianceSummaryItem.setCompliantSummary(CompliantSummaryJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("NonCompliantSummary")) {
                resourceComplianceSummaryItem
                        .setNonCompliantSummary(NonCompliantSummaryJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
            }
