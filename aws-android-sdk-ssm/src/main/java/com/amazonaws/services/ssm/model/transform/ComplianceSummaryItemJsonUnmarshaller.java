 ...
 */
class ComplianceSummaryItemJsonUnmarshaller implements
        Unmarshaller<ComplianceSummaryItem, JsonUnmarshallerContext> {
    ...
    public ComplianceSummaryItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ComplianceType")) {
                ...
                complianceSummaryItem.setCompliantSummary(CompliantSummaryJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("NonCompliantSummary")) {
                complianceSummaryItem.setNonCompliantSummary(NonCompliantSummaryJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
