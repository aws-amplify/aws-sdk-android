...
public class DescribeAutomationExecutionsResult implements Serializable {
     ...
     * </p>
     *
     * @param automationExecutionMetadataList <p>
     *            The list of details about each automation execution which has
     *            occurred which matches the filter specification, if any.
     *            </p>
     */
    public void setAutomationExecutionMetadataList(
        ...
        this.automationExecutionMetadataList = new java.util.ArrayList<AutomationExecutionMetadata>(
    ...
    public DescribeAutomationExecutionsResult withAutomationExecutionMetadataList(
            AutomationExecutionMetadata... automationExecutionMetadataList) {
        if (getAutomationExecutionMetadataList() == null) {
            this.automationExecutionMetadataList = new java.util.ArrayList<AutomationExecutionMetadata>(
                    automationExecutionMetadataList.length);
        }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getAutomationExecutionMetadataList() == null) ? 0
                        : getAutomationExecutionMetadataList().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAutomationExecutionMetadataList() == null
                ^ this.getAutomationExecutionMetadataList() == null)
            return false;
        if (other.getAutomationExecutionMetadataList() != null
                && other.getAutomationExecutionMetadataList().equals(
                        this.getAutomationExecutionMetadataList()) == false)
            return false;
