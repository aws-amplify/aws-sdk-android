...
public class DescribeInstancePatchStatesForPatchGroupRequest extends AmazonWebServiceRequest
     ...
     *
     * @param patchGroup <p>
     *            The name of the patch group for which the patch state
     ...
     *         chained together.
     */
    public DescribeInstancePatchStatesForPatchGroupRequest withFilters(
            InstancePatchStateFilter... filters) {
        if (getFilters() == null) {
     ...
     */
    public DescribeInstancePatchStatesForPatchGroupRequest withFilters(
            java.util.Collection<InstancePatchStateFilter> filters) {
        setFilters(filters);
        return this;
    }
