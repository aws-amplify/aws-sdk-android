...
public class FailureDetails implements Serializable {
     ...
     *         The stages include the following: InputValidation,
     *         PreVerification, Invocation, PostVerification.
     *         </p>
     */
     ...
     * </p>
     *
     * @param failureStage <p>
     *            The stage of the Automation execution when the failure
     *            occurred. The stages include the following: InputValidation,
     *            PreVerification, Invocation, PostVerification.
     *            </p>
     */
    ...
    public String toString() {
        ...
        if (getFailureStage() != null)
            sb.append("FailureStage: " + getFailureStage() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getFailureStage() == null) ? 0 : getFailureStage().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getFailureStage() == null ^ this.getFailureStage() == null)
            return false;
        if (other.getFailureStage() != null
                && other.getFailureStage().equals(this.getFailureStage()) == false)
            return false;
