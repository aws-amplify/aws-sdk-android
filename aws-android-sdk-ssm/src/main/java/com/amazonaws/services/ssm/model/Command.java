...
public class Command implements Serializable {
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>Pending, InProgress, Success, Cancelled, Failed,
     * TimedOut, Cancelling
     */
     ...
     * >Running commands using Systems Manager Run Command</a> in the <i>AWS
     ...
     * For more information about how to use MaxErrors, see <a href=
     * "https://docs.aws.amazon.com/systems-manager/latest/userguide/run-command.html"
     * >Running commands using Systems Manager Run Command</a> in the <i>AWS
     * Systems Manager User Guide</i>.
     * </p>
     ...
     *         running, it will not run. Calculated based on the ExpiresAfter
     ...
     *            started running, it will not run. Calculated based on the
     ...
     *
     * @param parameters <p>
     *            The parameter values to be inserted in the document when
     *            running the command.
     *            </p>
     */
     ...
     *         exceeded the account limit for pending invocations. The system
     *         has canceled the command before running it on any instance. This
     *         is a terminal state.
     *         </p>
     *         </li>
     *         </ul>
     ...
     *            <li>
     *            <p>
     *            Incomplete: The command was attempted on all instances and one
     *            or more invocations does not have a value of Success but not
     *            enough invocations failed for the status to be Failed. This is
     *            a terminal state.
     *            </p>
     *            </li>
     *            <li>
     ...
     *            Rate Exceeded: The number of instances targeted by the command
     *            exceeded the account limit for pending invocations. The system
     *            has canceled the command before running it on any instance.
     *            This is a terminal state.
     *            </p>
     *            </li>
     *            </ul>
     ...
     *
     * @return <p>
     *         The maximum number of instances that are allowed to run the
     *         command at the same time. You can specify a number of instances,
     *         such as 10, or a percentage of instances, such as 10%. The
     *         default value is 50. For more information about how to use
     *         MaxConcurrency, see <a href=
     *         "https://docs.aws.amazon.com/systems-manager/latest/userguide/run-command.html"
     *         >Running commands using Systems Manager Run Command</a> in the
     ...
     *            The maximum number of instances that are allowed to run the
     *            command at the same time. You can specify a number of
     *            instances, such as 10, or a percentage of instances, such as
     ...
     *            as 10%. The default value is 0. For more information about how
     ...
     * </p>
     *
     * @param completedCount <p>
     *            The number of targets for which the command invocation reached
     *            a terminal state. Terminal states include the following:
     *            Success, Failed, Execution Timed Out, Delivery Timed Out,
     ...
     *
     * @param errorCount <p>
     *            The number of targets for which the status is Failed or
     *            Execution Timed Out.
     *            </p>
     */
     ...
     *
     * @param serviceRole <p>
     *            The IAM service role that Run Command uses to act on your
     *            behalf when sending notifications about command status
     *            changes.
     *            </p>
     */
     ...
     *
     * @return <p>
     *         CloudWatch Logs information where you want Systems Manager to
    ...
    public String toString() {
        ...
        if (getDeliveryTimedOutCount() != null)
            sb.append("DeliveryTimedOutCount: " + getDeliveryTimedOutCount() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getRequestedDateTime() == null) ? 0 : getRequestedDateTime().hashCode());
        ...
        hashCode = prime * hashCode
                + ((getTargetCount() == null) ? 0 : getTargetCount().hashCode());
        hashCode = prime * hashCode
                + ((getCompletedCount() == null) ? 0 : getCompletedCount().hashCode());
        hashCode = prime * hashCode + ((getErrorCount() == null) ? 0 : getErrorCount().hashCode());
        hashCode = prime
                * hashCode
                + ((getDeliveryTimedOutCount() == null) ? 0 : getDeliveryTimedOutCount().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getRequestedDateTime() != null
                && other.getRequestedDateTime().equals(this.getRequestedDateTime()) == false)
            return false;
        ...
        if (other.getTargetCount() == null ^ this.getTargetCount() == null)
            return false;
        if (other.getTargetCount() != null
                && other.getTargetCount().equals(this.getTargetCount()) == false)
            return false;
        if (other.getCompletedCount() == null ^ this.getCompletedCount() == null)
            return false;
        if (other.getCompletedCount() != null
                && other.getCompletedCount().equals(this.getCompletedCount()) == false)
            return false;
        ...
        if (other.getDeliveryTimedOutCount() == null ^ this.getDeliveryTimedOutCount() == null)
            return false;
        if (other.getDeliveryTimedOutCount() != null
                && other.getDeliveryTimedOutCount().equals(this.getDeliveryTimedOutCount()) == false)
            return false;
