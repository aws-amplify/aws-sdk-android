...
public class CommandPlugin implements Serializable {
     ...
     * it. Instead, Systems Manager automatically determines the S3 bucket
     * region.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
     ...
     *         Amazon S3. If the S3 bucket for the command was not specified,
     ...
     *            in Amazon S3. If the S3 bucket for the command was not
