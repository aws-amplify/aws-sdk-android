...
public class CreateAssociationRequestMarshaller implements Marshaller<Request<CreateAssociationRequest>, CreateAssociationRequest> {
    ...
    public Request<CreateAssociationRequest> marshall(CreateAssociationRequest createAssociationRequest) {
        if (createAssociationRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(CreateAssociationRequest)");
        }

        Request<CreateAssociationRequest> request = new DefaultRequest<CreateAssociationRequest>(createAssociationRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (createAssociationRequest.getParameters() != null) {
                java.util.Map<String, java.util.List<String>> parameters = createAssociationRequest.getParameters();
            ...
            if (createAssociationRequest.getOutputLocation() != null) {
                InstanceAssociationOutputLocation outputLocation = createAssociationRequest.getOutputLocation();
            ...
            if (createAssociationRequest.getAutomationTargetParameterName() != null) {
                String automationTargetParameterName = createAssociationRequest.getAutomationTargetParameterName();
            ...
            if (createAssociationRequest.getApplyOnlyAtCronInterval() != null) {
                Boolean applyOnlyAtCronInterval = createAssociationRequest.getApplyOnlyAtCronInterval();
