...
public class ListResourceDataSyncRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @return <p>View a list of resource data syncs according to the sync type. Specify <code>SyncToDestination</code> to view resource data syncs that synchronize data to an Amazon S3 buckets. Specify <code>SyncFromSource</code> to view resource data syncs from AWS Organizations or from multiple AWS Regions. </p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListResourceDataSyncRequest == false) return false;
