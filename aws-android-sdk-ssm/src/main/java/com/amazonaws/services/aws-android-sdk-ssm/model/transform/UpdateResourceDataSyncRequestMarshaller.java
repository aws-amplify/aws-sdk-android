 ...
 */
public class UpdateResourceDataSyncRequestMarshaller implements Marshaller<Request<UpdateResourceDataSyncRequest>, UpdateResourceDataSyncRequest> {
    ...
    public Request<UpdateResourceDataSyncRequest> marshall(UpdateResourceDataSyncRequest updateResourceDataSyncRequest) {
        if (updateResourceDataSyncRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(UpdateResourceDataSyncRequest)");
        }

        Request<UpdateResourceDataSyncRequest> request = new DefaultRequest<UpdateResourceDataSyncRequest>(updateResourceDataSyncRequest, "AmazonSimpleSystemsManager(SSM)");
