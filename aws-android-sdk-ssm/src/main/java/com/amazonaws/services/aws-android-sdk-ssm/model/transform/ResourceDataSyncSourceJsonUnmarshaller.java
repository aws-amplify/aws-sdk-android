 ...
 */
class ResourceDataSyncSourceJsonUnmarshaller implements Unmarshaller<ResourceDataSyncSource, JsonUnmarshallerContext> {
...
.unmarshall(context));
                ...
                resourceDataSyncSource.setAwsOrganizationsSource(ResourceDataSyncAwsOrganizationsSourceJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("SourceRegions")) {
                resourceDataSyncSource.setSourceRegions(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
.unmarshall(context));
            } else if (name.equals("IncludeFutureRegions")) {
                resourceDataSyncSource.setIncludeFutureRegions(BooleanJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static ResourceDataSyncSourceJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ResourceDataSyncSourceJsonUnmarshaller();
        return instance;
    }
}
