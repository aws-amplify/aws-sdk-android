 ...
 */
class AttachmentsSourceJsonUnmarshaller implements Unmarshaller<AttachmentsSource, JsonUnmarshallerContext> {
...
.unmarshall(context));
                ...
                attachmentsSource.setValues(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static AttachmentsSourceJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AttachmentsSourceJsonUnmarshaller();
        return instance;
    }
}
