...
.unmarshall(context));
                ...
                updateMaintenanceWindowResult.setScheduleTimezone(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("ScheduleOffset")) {
                updateMaintenanceWindowResult.setScheduleOffset(IntegerJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                updateMaintenanceWindowResult.setAllowUnassociatedTargets(BooleanJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static UpdateMaintenanceWindowResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new UpdateMaintenanceWindowResultJsonUnmarshaller();
        return instance;
    }
}
