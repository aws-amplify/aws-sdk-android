...
class AssociationStatusJsonMarshaller {
    ...
    public void marshall(AssociationStatus associationStatus, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static AssociationStatusJsonMarshaller getInstance() {
        if (instance == null) instance = new AssociationStatusJsonMarshaller();
        return instance;
    }
}
