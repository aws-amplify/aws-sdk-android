...
public class UpdateDocumentDefaultVersionResult implements Serializable {
     ...
     * <p>The description of a custom document that you want to set as the default version.</p>
     *
     * @return <p>The description of a custom document that you want to set as the default version.</p>
     */
     ...
     * <p>The description of a custom document that you want to set as the default version.</p>
     *
     * @param description <p>The description of a custom document that you want to set as the default version.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDocumentDefaultVersionResult == false) return false;
