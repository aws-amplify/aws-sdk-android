    ...
    public ResetServiceSettingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ServiceSetting")) {
                resetServiceSettingResult.setServiceSetting(ServiceSettingJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static ResetServiceSettingResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ResetServiceSettingResultJsonUnmarshaller();
        return instance;
    }
}
