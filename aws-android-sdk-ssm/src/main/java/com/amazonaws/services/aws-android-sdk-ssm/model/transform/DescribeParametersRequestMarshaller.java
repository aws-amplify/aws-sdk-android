...
public class DescribeParametersRequestMarshaller implements Marshaller<Request<DescribeParametersRequest>, DescribeParametersRequest> {
    ...
    public Request<DescribeParametersRequest> marshall(DescribeParametersRequest describeParametersRequest) {
        if (describeParametersRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(DescribeParametersRequest)");
        }

        Request<DescribeParametersRequest> request = new DefaultRequest<DescribeParametersRequest>(describeParametersRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            for (ParametersFilter filtersItem : filters) {
                if (filtersItem != null) {
            ParametersFilterJsonMarshaller.getInstance().marshall(filtersItem, jsonWriter);
                    }
            }
            jsonWriter.endArray();
            }
            if (describeParametersRequest.getParameterFilters() != null) {
                java.util.List<ParameterStringFilter> parameterFilters = describeParametersRequest.getParameterFilters();
