...
.unmarshall(context));
                ...
                describePatchGroupStateResult.setInstancesWithInstalledPatches(IntegerJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("InstancesWithInstalledOtherPatches")) {
                describePatchGroupStateResult.setInstancesWithInstalledOtherPatches(IntegerJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("InstancesWithInstalledPendingRebootPatches")) {
                describePatchGroupStateResult.setInstancesWithInstalledPendingRebootPatches(IntegerJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("InstancesWithInstalledRejectedPatches")) {
                describePatchGroupStateResult.setInstancesWithInstalledRejectedPatches(IntegerJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("InstancesWithMissingPatches")) {
                describePatchGroupStateResult.setInstancesWithMissingPatches(IntegerJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("InstancesWithFailedPatches")) {
                describePatchGroupStateResult.setInstancesWithFailedPatches(IntegerJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("InstancesWithNotApplicablePatches")) {
                describePatchGroupStateResult.setInstancesWithNotApplicablePatches(IntegerJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("InstancesWithUnreportedNotApplicablePatches")) {
                describePatchGroupStateResult.setInstancesWithUnreportedNotApplicablePatches(IntegerJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static DescribePatchGroupStateResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribePatchGroupStateResultJsonUnmarshaller();
        return instance;
    }
}
