...
public class CancelCommandRequestMarshaller implements Marshaller<Request<CancelCommandRequest>, CancelCommandRequest> {
    ...
    public Request<CancelCommandRequest> marshall(CancelCommandRequest cancelCommandRequest) {
        if (cancelCommandRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(CancelCommandRequest)");
        }

        Request<CancelCommandRequest> request = new DefaultRequest<CancelCommandRequest>(cancelCommandRequest, "AmazonSimpleSystemsManager(SSM)");
