...
public class DescribeDocumentRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @return <p>The document version for which you want information. Can be a specific version or the default version.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @param documentVersion <p>The document version for which you want information. Can be a specific version or the default version.</p>
     */
