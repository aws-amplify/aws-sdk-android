...
public class OpsItemSummary implements Serializable {
     ...
     * <p>The Amazon Resource Name (ARN) of the IAM entity that created the OpsItem.</p>
     *
     * @return <p>The Amazon Resource Name (ARN) of the IAM entity that created the OpsItem.</p>
     */
     ...
     * <p>The Amazon Resource Name (ARN) of the IAM entity that created the OpsItem.</p>
     *
     * @param createdBy <p>The Amazon Resource Name (ARN) of the IAM entity that created the OpsItem.</p>
     */
     ...
     * <p>The Amazon Resource Name (ARN) of the IAM entity that created the OpsItem.</p>
     *
     * @param lastModifiedBy <p>The Amazon Resource Name (ARN) of the IAM entity that created the OpsItem.</p>
     */
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @return <p>The impacted AWS resource.</p>
     */
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @param source <p>The impacted AWS resource.</p>
     */
     ...
     * <b>Allowed Values: </b>Open, InProgress, Resolved
     *
     * @return <p>The OpsItem status. Status can be <code>Open</code>, <code>In Progress</code>, or <code>Resolved</code>.</p>
     *
     * @see OpsItemStatus
     */
     ...
     * <b>Allowed Values: </b>Open, InProgress, Resolved
     *
     * @param status <p>The OpsItem status. Status can be <code>Open</code>, <code>In Progress</code>, or <code>Resolved</code>.</p>
     *
     * @see OpsItemStatus
     */
     ...
     * <p>Operational data is custom data that provides useful reference details about the OpsItem. </p>
     *
     * @return <p>Operational data is custom data that provides useful reference details about the OpsItem. </p>
     */
     ...
     * <p>Operational data is custom data that provides useful reference details about the OpsItem. </p>
     *
     * @param operationalData <p>Operational data is custom data that provides useful reference details about the OpsItem. </p>
     */
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @return <p>A list of OpsItems by category.</p>
     */
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @param category <p>A list of OpsItems by category.</p>
     */
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @return <p>A list of OpsItems by severity.</p>
     */
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @param severity <p>A list of OpsItems by severity.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OpsItemSummary == false) return false;
