...
public class DeleteParametersResult implements Serializable {
     ...
     * <p>The names of the deleted parameters.</p>
     *
     * @return <p>The names of the deleted parameters.</p>
     */
     ...
     * <p>The names of the deleted parameters.</p>
     *
     * @param deletedParameters <p>The names of the deleted parameters.</p>
     */
     ...
     * <p>The names of parameters that weren't deleted because the parameters are not valid.</p>
     *
     * @return <p>The names of parameters that weren't deleted because the parameters are not valid.</p>
     */
     ...
     * <p>The names of parameters that weren't deleted because the parameters are not valid.</p>
     *
     * @param invalidParameters <p>The names of parameters that weren't deleted because the parameters are not valid.</p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getDeletedParameters() != null) sb.append("DeletedParameters: " + getDeletedParameters() + ",");
        if (getInvalidParameters() != null) sb.append("InvalidParameters: " + getInvalidParameters());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteParametersResult == false) return false;
        DeleteParametersResult other = (DeleteParametersResult)obj;

        if (other.getDeletedParameters() == null ^ this.getDeletedParameters() == null) return false;
        if (other.getDeletedParameters() != null && other.getDeletedParameters().equals(this.getDeletedParameters()) == false) return false;
        if (other.getInvalidParameters() == null ^ this.getInvalidParameters() == null) return false;
        if (other.getInvalidParameters() != null && other.getInvalidParameters().equals(this.getInvalidParameters()) == false) return false;
        return true;
    }
}
