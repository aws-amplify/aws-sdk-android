 ...
 */
class AssociationExecutionFilterJsonUnmarshaller implements Unmarshaller<AssociationExecutionFilter, JsonUnmarshallerContext> {
...
.unmarshall(context));
    ...
    public static AssociationExecutionFilterJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AssociationExecutionFilterJsonUnmarshaller();
        return instance;
    }
}
