...
class AttachmentsSourceJsonMarshaller {
    ...
    public void marshall(AttachmentsSource attachmentsSource, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static AttachmentsSourceJsonMarshaller getInstance() {
        if (instance == null) instance = new AttachmentsSourceJsonMarshaller();
        return instance;
    }
}
