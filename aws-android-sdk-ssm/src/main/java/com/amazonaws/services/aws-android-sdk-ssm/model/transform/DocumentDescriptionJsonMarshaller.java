...
class DocumentDescriptionJsonMarshaller {
    ...
    public void marshall(DocumentDescription documentDescription, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (documentDescription.getParameters() != null) {
            ...
            DocumentParameterJsonMarshaller.getInstance().marshall(parametersItem, jsonWriter);
                    }
            }
            jsonWriter.endArray();
        }
        ...
        if (documentDescription.getAttachmentsInformation() != null) {
            java.util.List<AttachmentInformation> attachmentsInformation = documentDescription.getAttachmentsInformation();
            ...
            AttachmentInformationJsonMarshaller.getInstance().marshall(attachmentsInformationItem, jsonWriter);
                    }
            }
            jsonWriter.endArray();
        }
    ...
    public static DocumentDescriptionJsonMarshaller getInstance() {
        if (instance == null) instance = new DocumentDescriptionJsonMarshaller();
        return instance;
    }
}
