 ...
 */
class EffectivePatchJsonUnmarshaller implements Unmarshaller<EffectivePatch, JsonUnmarshallerContext> {
...
.unmarshall(context));
    ...
    public static EffectivePatchJsonUnmarshaller getInstance() {
        if (instance == null) instance = new EffectivePatchJsonUnmarshaller();
        return instance;
    }
}
