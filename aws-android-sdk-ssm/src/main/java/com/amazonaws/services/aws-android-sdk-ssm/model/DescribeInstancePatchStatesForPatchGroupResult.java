...
public class DescribeInstancePatchStatesForPatchGroupResult implements Serializable {
    /**
     ...
     * <p>The high-level patch state for the requested instances. </p>
     *
     * @return <p>The high-level patch state for the requested instances. </p>
     */
     ...
     * <p>The high-level patch state for the requested instances. </p>
     *
     * @param instancePatchStates <p>The high-level patch state for the requested instances. </p>
     */
    ...
    public DescribeInstancePatchStatesForPatchGroupResult withInstancePatchStates(InstancePatchState... instancePatchStates) {
        if (getInstancePatchStates() == null) {
            this.instancePatchStates = new java.util.ArrayList<InstancePatchState>(instancePatchStates.length);
        }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getInstancePatchStates() != null) sb.append("InstancePatchStates: " + getInstancePatchStates() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeInstancePatchStatesForPatchGroupResult == false) return false;
        DescribeInstancePatchStatesForPatchGroupResult other = (DescribeInstancePatchStatesForPatchGroupResult)obj;

        if (other.getInstancePatchStates() == null ^ this.getInstancePatchStates() == null) return false;
        if (other.getInstancePatchStates() != null && other.getInstancePatchStates().equals(this.getInstancePatchStates()) == false) return false;
