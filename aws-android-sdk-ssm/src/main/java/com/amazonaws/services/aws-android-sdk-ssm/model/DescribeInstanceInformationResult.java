...
public class DescribeInstanceInformationResult implements Serializable {
     ...
     * <p>The instance information list.</p>
     *
     * @return <p>The instance information list.</p>
     */
     ...
     * <p>The instance information list.</p>
     *
     * @param instanceInformationList <p>The instance information list.</p>
     */
    public void setInstanceInformationList(java.util.Collection<InstanceInformation> instanceInformationList) {
        ...
        this.instanceInformationList = new java.util.ArrayList<InstanceInformation>(instanceInformationList);
    }
    ...
    public DescribeInstanceInformationResult withInstanceInformationList(InstanceInformation... instanceInformationList) {
        if (getInstanceInformationList() == null) {
            this.instanceInformationList = new java.util.ArrayList<InstanceInformation>(instanceInformationList.length);
        }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getInstanceInformationList() != null) sb.append("InstanceInformationList: " + getInstanceInformationList() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeInstanceInformationResult == false) return false;
        DescribeInstanceInformationResult other = (DescribeInstanceInformationResult)obj;

        if (other.getInstanceInformationList() == null ^ this.getInstanceInformationList() == null) return false;
        if (other.getInstanceInformationList() != null && other.getInstanceInformationList().equals(this.getInstanceInformationList()) == false) return false;
