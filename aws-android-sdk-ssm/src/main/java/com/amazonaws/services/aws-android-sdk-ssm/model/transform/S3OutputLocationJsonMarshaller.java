...
class S3OutputLocationJsonMarshaller {
    ...
    public void marshall(S3OutputLocation s3OutputLocation, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static S3OutputLocationJsonMarshaller getInstance() {
        if (instance == null) instance = new S3OutputLocationJsonMarshaller();
        return instance;
    }
}
