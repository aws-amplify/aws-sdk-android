 ...
 */
public class GetParametersByPathRequestMarshaller implements Marshaller<Request<GetParametersByPathRequest>, GetParametersByPathRequest> {
    ...
    public Request<GetParametersByPathRequest> marshall(GetParametersByPathRequest getParametersByPathRequest) {
        if (getParametersByPathRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(GetParametersByPathRequest)");
        }

        Request<GetParametersByPathRequest> request = new DefaultRequest<GetParametersByPathRequest>(getParametersByPathRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (getParametersByPathRequest.getParameterFilters() != null) {
                java.util.List<ParameterStringFilter> parameterFilters = getParametersByPathRequest.getParameterFilters();
            ...
            ParameterStringFilterJsonMarshaller.getInstance().marshall(parameterFiltersItem, jsonWriter);
                    }
            }
            jsonWriter.endArray();
            }
