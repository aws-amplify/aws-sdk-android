...
public class DescribePatchGroupsResult implements Serializable {
     ...
     * <p>Each entry in the array contains:</p> <p>PatchGroup: string (between 1 and 256 characters, Regex: ^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$)</p> <p>PatchBaselineIdentity: A PatchBaselineIdentity element. </p>
     *
     * @return <p>Each entry in the array contains:</p> <p>PatchGroup: string (between 1 and 256 characters, Regex: ^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$)</p> <p>PatchBaselineIdentity: A PatchBaselineIdentity element. </p>
     */
     ...
     * <p>Each entry in the array contains:</p> <p>PatchGroup: string (between 1 and 256 characters, Regex: ^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$)</p> <p>PatchBaselineIdentity: A PatchBaselineIdentity element. </p>
     *
     * @param mappings <p>Each entry in the array contains:</p> <p>PatchGroup: string (between 1 and 256 characters, Regex: ^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$)</p> <p>PatchBaselineIdentity: A PatchBaselineIdentity element. </p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getMappings() != null) sb.append("Mappings: " + getMappings() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribePatchGroupsResult == false) return false;
        DescribePatchGroupsResult other = (DescribePatchGroupsResult)obj;

        if (other.getMappings() == null ^ this.getMappings() == null) return false;
        if (other.getMappings() != null && other.getMappings().equals(this.getMappings()) == false) return false;
