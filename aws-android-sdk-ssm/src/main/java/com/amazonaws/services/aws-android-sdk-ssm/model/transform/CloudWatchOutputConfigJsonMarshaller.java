...
class CloudWatchOutputConfigJsonMarshaller {
    ...
    public void marshall(CloudWatchOutputConfig cloudWatchOutputConfig, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static CloudWatchOutputConfigJsonMarshaller getInstance() {
        if (instance == null) instance = new CloudWatchOutputConfigJsonMarshaller();
        return instance;
    }
}
