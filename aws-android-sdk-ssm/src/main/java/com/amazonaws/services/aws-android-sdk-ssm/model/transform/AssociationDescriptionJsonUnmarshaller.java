 ...
 */
class AssociationDescriptionJsonUnmarshaller implements Unmarshaller<AssociationDescription, JsonUnmarshallerContext> {
...
.unmarshall(context));
                ...
                associationDescription.setLastUpdateAssociationDate(DateJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Status")) {
                associationDescription.setStatus(AssociationStatusJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Overview")) {
                associationDescription.setOverview(AssociationOverviewJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                associationDescription.setAutomationTargetParameterName(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Parameters")) {
                associationDescription.setParameters(new MapUnmarshaller<java.util.List<String>>(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
)
.unmarshall(context));
...
.unmarshall(context));
                ...
                associationDescription.setOutputLocation(InstanceAssociationOutputLocationJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                associationDescription.setLastSuccessfulExecutionDate(DateJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                associationDescription.setApplyOnlyAtCronInterval(BooleanJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
