...
public class ComplianceItemEntry implements Serializable {
     ...
     * <p>The compliance item ID. For example, if the compliance item is a Windows patch, the ID could be the number of the KB article.</p>
     *
     * @return <p>The compliance item ID. For example, if the compliance item is a Windows patch, the ID could be the number of the KB article.</p>
     */
    public String getId() {
        return id;
    }
     ...
     * <p>The compliance item ID. For example, if the compliance item is a Windows patch, the ID could be the number of the KB article.</p>
     *
     * @param id <p>The compliance item ID. For example, if the compliance item is a Windows patch, the ID could be the number of the KB article.</p>
     */
     ...
     * <b>Length: </b> - 500<br/>
     *
     * @return <p>The title of the compliance item. For example, if the compliance item is a Windows patch, the title could be the title of the KB article for the patch; for example: Security Update for Active Directory Federation Services. </p>
     */
     ...
     * <b>Length: </b> - 500<br/>
     *
     * @param title <p>The title of the compliance item. For example, if the compliance item is a Windows patch, the title could be the title of the KB article for the patch; for example: Security Update for Active Directory Federation Services. </p>
     */
     ...
     * <b>Allowed Values: </b>COMPLIANT, NON_COMPLIANT
     *
     * @return <p>The status of the compliance item. An item is either COMPLIANT or NON_COMPLIANT.</p>
     *
     ...
     * <b>Allowed Values: </b>COMPLIANT, NON_COMPLIANT
     *
     * @param status <p>The status of the compliance item. An item is either COMPLIANT or NON_COMPLIANT.</p>
     *
     * @see ComplianceStatus
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ComplianceItemEntry == false) return false;
