...
public class StartAssociationsOnceRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <p>The association IDs that you want to run immediately and only one time.</p>
     *
     * @return <p>The association IDs that you want to run immediately and only one time.</p>
     */
     ...
     * <p>The association IDs that you want to run immediately and only one time.</p>
     *
     * @param associationIds <p>The association IDs that you want to run immediately and only one time.</p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getAssociationIds() != null) sb.append("AssociationIds: " + getAssociationIds());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartAssociationsOnceRequest == false) return false;
        StartAssociationsOnceRequest other = (StartAssociationsOnceRequest)obj;

        if (other.getAssociationIds() == null ^ this.getAssociationIds() == null) return false;
        if (other.getAssociationIds() != null && other.getAssociationIds().equals(this.getAssociationIds()) == false) return false;
        return true;
    }
}
