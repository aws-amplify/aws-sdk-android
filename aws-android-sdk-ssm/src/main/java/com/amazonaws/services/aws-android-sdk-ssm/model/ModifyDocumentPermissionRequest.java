 ...
 */
public class ModifyDocumentPermissionRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.]{3,128}$<br/>
     *
     * @return <p>The name of the document that you want to share.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.]{3,128}$<br/>
     *
     * @param name <p>The name of the document that you want to share.</p>
     */
     ...
     * <b>Allowed Values: </b>Share
     *
     * @return <p>The permission type for the document. The permission type can be <i>Share</i>.</p>
     *
     ...
     * <b>Allowed Values: </b>Share
     *
     * @param permissionType <p>The permission type for the document. The permission type can be <i>Share</i>.</p>
     *
     * @see DocumentPermissionType
     */
     ...
     * <p>The AWS user accounts that should have access to the document. The account IDs can either be a group of account IDs or <i>All</i>.</p>
     *
     * @return <p>The AWS user accounts that should have access to the document. The account IDs can either be a group of account IDs or <i>All</i>.</p>
     */
     ...
     * <p>The AWS user accounts that should have access to the document. The account IDs can either be a group of account IDs or <i>All</i>.</p>
     *
     * @param accountIdsToAdd <p>The AWS user accounts that should have access to the document. The account IDs can either be a group of account IDs or <i>All</i>.</p>
     */
     ...
     * <p>The AWS user accounts that should no longer have access to the document. The AWS user account can either be a group of account IDs or <i>All</i>. This action has a higher priority than <i>AccountIdsToAdd</i>. If you specify an account ID to add and the same ID to remove, the system removes access to the document.</p>
     *
     * @return <p>The AWS user accounts that should no longer have access to the document. The AWS user account can either be a group of account IDs or <i>All</i>. This action has a higher priority than <i>AccountIdsToAdd</i>. If you specify an account ID to add and the same ID to remove, the system removes access to the document.</p>
     */
     ...
     * <p>The AWS user accounts that should no longer have access to the document. The AWS user account can either be a group of account IDs or <i>All</i>. This action has a higher priority than <i>AccountIdsToAdd</i>. If you specify an account ID to add and the same ID to remove, the system removes access to the document.</p>
     *
     * @param accountIdsToRemove <p>The AWS user accounts that should no longer have access to the document. The AWS user account can either be a group of account IDs or <i>All</i>. This action has a higher priority than <i>AccountIdsToAdd</i>. If you specify an account ID to add and the same ID to remove, the system removes access to the document.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|[$]ALL)<br/>
     *
     * @return <p>(Optional) The version of the document to share. If it's not specified, the system choose the <code>Default</code> version to share.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|[$]ALL)<br/>
     *
     * @param sharedDocumentVersion <p>(Optional) The version of the document to share. If it's not specified, the system choose the <code>Default</code> version to share.</p>
     */
    ...
    public String toString() {
        ...
        if (getPermissionType() != null) sb.append("PermissionType: " + getPermissionType() + ",");
        if (getAccountIdsToAdd() != null) sb.append("AccountIdsToAdd: " + getAccountIdsToAdd() + ",");
        if (getAccountIdsToRemove() != null) sb.append("AccountIdsToRemove: " + getAccountIdsToRemove() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyDocumentPermissionRequest == false) return false;
        ModifyDocumentPermissionRequest other = (ModifyDocumentPermissionRequest)obj;

        if (other.getName() == null ^ this.getName() == null) return false;
        if (other.getName() != null && other.getName().equals(this.getName()) == false) return false;
        if (other.getPermissionType() == null ^ this.getPermissionType() == null) return false;
        if (other.getPermissionType() != null && other.getPermissionType().equals(this.getPermissionType()) == false) return false;
        if (other.getAccountIdsToAdd() == null ^ this.getAccountIdsToAdd() == null) return false;
        if (other.getAccountIdsToAdd() != null && other.getAccountIdsToAdd().equals(this.getAccountIdsToAdd()) == false) return false;
        if (other.getAccountIdsToRemove() == null ^ this.getAccountIdsToRemove() == null) return false;
        if (other.getAccountIdsToRemove() != null && other.getAccountIdsToRemove().equals(this.getAccountIdsToRemove()) == false) return false;
