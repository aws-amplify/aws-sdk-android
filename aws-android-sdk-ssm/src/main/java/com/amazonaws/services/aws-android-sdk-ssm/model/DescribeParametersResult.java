...
public class DescribeParametersResult implements Serializable {
     ...
     * <p>Parameters returned by the request.</p>
     *
     * @return <p>Parameters returned by the request.</p>
     */
     ...
     * <p>Parameters returned by the request.</p>
     *
     * @param parameters <p>Parameters returned by the request.</p>
     */
     ...
     * <p>The token to use when requesting the next set of items.</p>
     *
     * @return <p>The token to use when requesting the next set of items.</p>
     */
     ...
     * <p>The token to use when requesting the next set of items.</p>
     *
     * @param nextToken <p>The token to use when requesting the next set of items.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeParametersResult == false) return false;
