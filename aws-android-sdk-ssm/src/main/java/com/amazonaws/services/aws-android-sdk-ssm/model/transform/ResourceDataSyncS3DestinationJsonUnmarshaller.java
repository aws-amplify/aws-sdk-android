 ...
 */
class ResourceDataSyncS3DestinationJsonUnmarshaller implements Unmarshaller<ResourceDataSyncS3Destination, JsonUnmarshallerContext> {
...
.unmarshall(context));
                ...
                resourceDataSyncS3Destination.setDestinationDataSharing(ResourceDataSyncDestinationDataSharingJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static ResourceDataSyncS3DestinationJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ResourceDataSyncS3DestinationJsonUnmarshaller();
        return instance;
    }
}
