...
class InstanceInformationFilterJsonMarshaller {
    ...
    public void marshall(InstanceInformationFilter instanceInformationFilter, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static InstanceInformationFilterJsonMarshaller getInstance() {
        if (instance == null) instance = new InstanceInformationFilterJsonMarshaller();
        return instance;
    }
}
