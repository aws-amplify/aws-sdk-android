...
class AutomationExecutionMetadataJsonMarshaller {
    ...
    public void marshall(AutomationExecutionMetadata automationExecutionMetadata, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (automationExecutionMetadata.getAutomationExecutionStatus() != null) {
            String automationExecutionStatus = automationExecutionMetadata.getAutomationExecutionStatus();
        ...
        if (automationExecutionMetadata.getOutputs() != null) {
            java.util.Map<String, java.util.List<String>> outputs = automationExecutionMetadata.getOutputs();
        ...
        if (automationExecutionMetadata.getParentAutomationExecutionId() != null) {
            String parentAutomationExecutionId = automationExecutionMetadata.getParentAutomationExecutionId();
        ...
        if (automationExecutionMetadata.getTargetMaps() != null) {
            java.util.List<java.util.Map<String, java.util.List<String>>> targetMaps = automationExecutionMetadata.getTargetMaps();
    ...
    public static AutomationExecutionMetadataJsonMarshaller getInstance() {
        if (instance == null) instance = new AutomationExecutionMetadataJsonMarshaller();
        return instance;
    }
}
