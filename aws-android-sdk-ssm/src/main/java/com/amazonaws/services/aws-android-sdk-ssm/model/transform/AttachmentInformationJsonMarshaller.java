...
class AttachmentInformationJsonMarshaller {
    ...
    public void marshall(AttachmentInformation attachmentInformation, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static AttachmentInformationJsonMarshaller getInstance() {
        if (instance == null) instance = new AttachmentInformationJsonMarshaller();
        return instance;
    }
}
