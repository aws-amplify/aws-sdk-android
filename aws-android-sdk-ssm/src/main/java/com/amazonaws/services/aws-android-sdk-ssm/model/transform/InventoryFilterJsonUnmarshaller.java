 ...
 */
class InventoryFilterJsonUnmarshaller implements Unmarshaller<InventoryFilter, JsonUnmarshallerContext> {
...
.unmarshall(context));
                ...
                inventoryFilter.setValues(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static InventoryFilterJsonUnmarshaller getInstance() {
        if (instance == null) instance = new InventoryFilterJsonUnmarshaller();
        return instance;
    }
}
