 ...
 */
public class GetPatchBaselineForPatchGroupRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * <b>Pattern: </b>^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$<br/>
     *
     * @return <p>The name of the patch group whose patch baseline should be retrieved.</p>
     */
     ...
     * <b>Pattern: </b>^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$<br/>
     *
     * @param patchGroup <p>The name of the patch group whose patch baseline should be retrieved.</p>
     */
     ...
     * <b>Allowed Values: </b>WINDOWS, AMAZON_LINUX, AMAZON_LINUX_2, UBUNTU, REDHAT_ENTERPRISE_LINUX, SUSE, CENTOS, ORACLE_LINUX, DEBIAN
     *
     * @return <p>Returns he operating system rule specified for patch groups using the patch baseline.</p>
     *
     * @see OperatingSystem
     */
     ...
     * <b>Allowed Values: </b>WINDOWS, AMAZON_LINUX, AMAZON_LINUX_2, UBUNTU, REDHAT_ENTERPRISE_LINUX, SUSE, CENTOS, ORACLE_LINUX, DEBIAN
     *
     * @param operatingSystem <p>Returns he operating system rule specified for patch groups using the patch baseline.</p>
     *
     * @see OperatingSystem
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPatchBaselineForPatchGroupRequest == false) return false;
