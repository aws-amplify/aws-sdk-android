    ...
    public ListAssociationVersionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AssociationVersions")) {
                listAssociationVersionsResult.setAssociationVersions(new ListUnmarshaller<AssociationVersionInfo>(AssociationVersionInfoJsonUnmarshaller.getInstance()
)
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static ListAssociationVersionsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListAssociationVersionsResultJsonUnmarshaller();
        return instance;
    }
}
