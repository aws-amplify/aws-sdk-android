...
class CreateAssociationBatchRequestEntryJsonMarshaller {
    ...
    public void marshall(CreateAssociationBatchRequestEntry createAssociationBatchRequestEntry, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (createAssociationBatchRequestEntry.getParameters() != null) {
            java.util.Map<String, java.util.List<String>> parameters = createAssociationBatchRequestEntry.getParameters();
        ...
        if (createAssociationBatchRequestEntry.getAutomationTargetParameterName() != null) {
            String automationTargetParameterName = createAssociationBatchRequestEntry.getAutomationTargetParameterName();
        ...
        if (createAssociationBatchRequestEntry.getOutputLocation() != null) {
            InstanceAssociationOutputLocation outputLocation = createAssociationBatchRequestEntry.getOutputLocation();
        ...
        if (createAssociationBatchRequestEntry.getApplyOnlyAtCronInterval() != null) {
            Boolean applyOnlyAtCronInterval = createAssociationBatchRequestEntry.getApplyOnlyAtCronInterval();
    ...
    public static CreateAssociationBatchRequestEntryJsonMarshaller getInstance() {
        if (instance == null) instance = new CreateAssociationBatchRequestEntryJsonMarshaller();
        return instance;
    }
}
