...
public class UpdateAssociationRequestMarshaller implements Marshaller<Request<UpdateAssociationRequest>, UpdateAssociationRequest> {
    ...
    public Request<UpdateAssociationRequest> marshall(UpdateAssociationRequest updateAssociationRequest) {
        if (updateAssociationRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(UpdateAssociationRequest)");
        }

        Request<UpdateAssociationRequest> request = new DefaultRequest<UpdateAssociationRequest>(updateAssociationRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (updateAssociationRequest.getParameters() != null) {
                java.util.Map<String, java.util.List<String>> parameters = updateAssociationRequest.getParameters();
            ...
            if (updateAssociationRequest.getOutputLocation() != null) {
                InstanceAssociationOutputLocation outputLocation = updateAssociationRequest.getOutputLocation();
            ...
            if (updateAssociationRequest.getAutomationTargetParameterName() != null) {
                String automationTargetParameterName = updateAssociationRequest.getAutomationTargetParameterName();
            ...
            if (updateAssociationRequest.getSyncCompliance() != null) {
                String syncCompliance = updateAssociationRequest.getSyncCompliance();
                jsonWriter.name("SyncCompliance");
            jsonWriter.value(syncCompliance);
            }
            if (updateAssociationRequest.getApplyOnlyAtCronInterval() != null) {
                Boolean applyOnlyAtCronInterval = updateAssociationRequest.getApplyOnlyAtCronInterval();
