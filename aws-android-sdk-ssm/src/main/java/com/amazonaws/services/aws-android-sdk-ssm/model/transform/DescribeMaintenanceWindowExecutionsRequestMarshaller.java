 ...
 */
public class DescribeMaintenanceWindowExecutionsRequestMarshaller implements Marshaller<Request<DescribeMaintenanceWindowExecutionsRequest>, DescribeMaintenanceWindowExecutionsRequest> {
    ...
    public Request<DescribeMaintenanceWindowExecutionsRequest> marshall(DescribeMaintenanceWindowExecutionsRequest describeMaintenanceWindowExecutionsRequest) {
        if (describeMaintenanceWindowExecutionsRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(DescribeMaintenanceWindowExecutionsRequest)");
        }

        Request<DescribeMaintenanceWindowExecutionsRequest> request = new DefaultRequest<DescribeMaintenanceWindowExecutionsRequest>(describeMaintenanceWindowExecutionsRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (describeMaintenanceWindowExecutionsRequest.getFilters() != null) {
                java.util.List<MaintenanceWindowFilter> filters = describeMaintenanceWindowExecutionsRequest.getFilters();
