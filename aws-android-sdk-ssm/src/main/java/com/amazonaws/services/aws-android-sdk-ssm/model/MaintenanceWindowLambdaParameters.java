...
public class MaintenanceWindowLambdaParameters implements Serializable {
     ...
     * <b>Length: </b>1 - 8000<br/>
     *
     * @return <p>Pass client-specific information to the Lambda function that you are invoking. You can then process the client information in your Lambda function as you choose through the context variable.</p>
     */
     ...
     * <b>Length: </b>1 - 8000<br/>
     *
     * @param clientContext <p>Pass client-specific information to the Lambda function that you are invoking. You can then process the client information in your Lambda function as you choose through the context variable.</p>
     */
     ...
     * <b>Length: </b>1 - 128<br/>
     *
     * @param qualifier <p>(Optional) Specify a Lambda function version or alias name. If you specify a function version, the action uses the qualified function ARN to invoke a specific Lambda function. If you specify an alias name, the action uses the alias ARN to invoke the Lambda function version to which the alias points.</p>
     */
     ...
     * <b>Length: </b> - 4096<br/>
     *
     * @return <p>JSON to provide to your Lambda function as input.</p>
     */
     ...
     * <b>Length: </b> - 4096<br/>
     *
     * @param payload <p>JSON to provide to your Lambda function as input.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MaintenanceWindowLambdaParameters == false) return false;
