...
public class UpdateDocumentRequestMarshaller implements Marshaller<Request<UpdateDocumentRequest>, UpdateDocumentRequest> {
    ...
    public Request<UpdateDocumentRequest> marshall(UpdateDocumentRequest updateDocumentRequest) {
        if (updateDocumentRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(UpdateDocumentRequest)");
        }

        Request<UpdateDocumentRequest> request = new DefaultRequest<UpdateDocumentRequest>(updateDocumentRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (updateDocumentRequest.getAttachments() != null) {
                java.util.List<AttachmentsSource> attachments = updateDocumentRequest.getAttachments();
