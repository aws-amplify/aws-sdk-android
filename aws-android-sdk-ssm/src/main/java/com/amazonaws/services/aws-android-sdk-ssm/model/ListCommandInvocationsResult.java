...
public class ListCommandInvocationsResult implements Serializable {
     ...
     * <p>(Optional) A list of all invocations. </p>
     *
     * @return <p>(Optional) A list of all invocations. </p>
     */
     ...
     * <p>(Optional) A list of all invocations. </p>
     *
     * @param commandInvocations <p>(Optional) A list of all invocations. </p>
     */
    ...
    public ListCommandInvocationsResult withCommandInvocations(CommandInvocation... commandInvocations) {
        if (getCommandInvocations() == null) {
            this.commandInvocations = new java.util.ArrayList<CommandInvocation>(commandInvocations.length);
        }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getCommandInvocations() != null) sb.append("CommandInvocations: " + getCommandInvocations() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCommandInvocationsResult == false) return false;
        ListCommandInvocationsResult other = (ListCommandInvocationsResult)obj;

        if (other.getCommandInvocations() == null ^ this.getCommandInvocations() == null) return false;
        if (other.getCommandInvocations() != null && other.getCommandInvocations().equals(this.getCommandInvocations()) == false) return false;
