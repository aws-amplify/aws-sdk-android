...
class InventoryDeletionSummaryItemJsonMarshaller {
    ...
    public void marshall(InventoryDeletionSummaryItem inventoryDeletionSummaryItem, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static InventoryDeletionSummaryItemJsonMarshaller getInstance() {
        if (instance == null) instance = new InventoryDeletionSummaryItemJsonMarshaller();
        return instance;
    }
}
