 ...
 */
class NonCompliantSummaryJsonUnmarshaller implements Unmarshaller<NonCompliantSummary, JsonUnmarshallerContext> {
...
.unmarshall(context));
                ...
                nonCompliantSummary.setSeveritySummary(SeveritySummaryJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static NonCompliantSummaryJsonUnmarshaller getInstance() {
        if (instance == null) instance = new NonCompliantSummaryJsonUnmarshaller();
        return instance;
    }
}
