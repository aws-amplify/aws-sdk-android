    ...
    public GetPatchBaselineForPatchGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("BaselineId")) {
                getPatchBaselineForPatchGroupResult.setBaselineId(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("PatchGroup")) {
                getPatchBaselineForPatchGroupResult.setPatchGroup(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("OperatingSystem")) {
                getPatchBaselineForPatchGroupResult.setOperatingSystem(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static GetPatchBaselineForPatchGroupResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new GetPatchBaselineForPatchGroupResultJsonUnmarshaller();
        return instance;
    }
}
