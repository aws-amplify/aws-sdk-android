...
public class PatchComplianceData implements Serializable {
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>INSTALLED, INSTALLED_OTHER, INSTALLED_PENDING_REBOOT, INSTALLED_REJECTED, MISSING, NOT_APPLICABLE, FAILED
     */
     ...
     * <p>The operating system-specific ID of the patch.</p>
     *
     * @return <p>The operating system-specific ID of the patch.</p>
     */
     ...
     * <p>The operating system-specific ID of the patch.</p>
     *
     * @param kBId <p>The operating system-specific ID of the patch.</p>
     */
     ...
     * <p>The severity of the patch (for example, Critical, Important, Moderate).</p>
     *
     * @param severity <p>The severity of the patch (for example, Critical, Important, Moderate).</p>
     */
     ...
     * <b>Allowed Values: </b>INSTALLED, INSTALLED_OTHER, INSTALLED_PENDING_REBOOT, INSTALLED_REJECTED, MISSING, NOT_APPLICABLE, FAILED
     *
     * @return <p>The state of the patch on the instance, such as INSTALLED or FAILED.</p> <p>For descriptions of each patch state, see <a href="https://docs.aws.amazon.com/systems-manager/latest/userguide/sysman-compliance-about.html#sysman-compliance-monitor-patch">About patch compliance</a> in the <i>AWS Systems Manager User Guide</i>.</p>
     *
     ...
     * <b>Allowed Values: </b>INSTALLED, INSTALLED_OTHER, INSTALLED_PENDING_REBOOT, INSTALLED_REJECTED, MISSING, NOT_APPLICABLE, FAILED
     *
     * @param state <p>The state of the patch on the instance, such as INSTALLED or FAILED.</p> <p>For descriptions of each patch state, see <a href="https://docs.aws.amazon.com/systems-manager/latest/userguide/sysman-compliance-about.html#sysman-compliance-monitor-patch">About patch compliance</a> in the <i>AWS Systems Manager User Guide</i>.</p>
     *
     * @see PatchComplianceDataState
     */
     ...
     * <p>The date/time the patch was installed on the instance. Note that not all operating systems provide this level of information.</p>
     *
     * @return <p>The date/time the patch was installed on the instance. Note that not all operating systems provide this level of information.</p>
     */
     ...
     * <p>The date/time the patch was installed on the instance. Note that not all operating systems provide this level of information.</p>
     *
     * @param installedTime <p>The date/time the patch was installed on the instance. Note that not all operating systems provide this level of information.</p>
     */
    ...
    public String toString() {
        ...
        if (getKBId() != null) sb.append("KBId: " + getKBId() + ",");
        ...
        if (getInstalledTime() != null) sb.append("InstalledTime: " + getInstalledTime());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PatchComplianceData == false) return false;
        ...
        if (other.getKBId() == null ^ this.getKBId() == null) return false;
        if (other.getKBId() != null && other.getKBId().equals(this.getKBId()) == false) return false;
        ...
        if (other.getInstalledTime() == null ^ this.getInstalledTime() == null) return false;
        if (other.getInstalledTime() != null && other.getInstalledTime().equals(this.getInstalledTime()) == false) return false;
        return true;
    }
}
