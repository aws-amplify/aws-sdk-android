 ...
 */
public class DescribeMaintenanceWindowsForTargetRequestMarshaller implements Marshaller<Request<DescribeMaintenanceWindowsForTargetRequest>, DescribeMaintenanceWindowsForTargetRequest> {
    ...
    public Request<DescribeMaintenanceWindowsForTargetRequest> marshall(DescribeMaintenanceWindowsForTargetRequest describeMaintenanceWindowsForTargetRequest) {
        if (describeMaintenanceWindowsForTargetRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(DescribeMaintenanceWindowsForTargetRequest)");
        }

        Request<DescribeMaintenanceWindowsForTargetRequest> request = new DefaultRequest<DescribeMaintenanceWindowsForTargetRequest>(describeMaintenanceWindowsForTargetRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (describeMaintenanceWindowsForTargetRequest.getTargets() != null) {
                java.util.List<Target> targets = describeMaintenanceWindowsForTargetRequest.getTargets();
