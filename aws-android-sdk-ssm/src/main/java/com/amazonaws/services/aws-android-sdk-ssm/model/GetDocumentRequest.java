...
public class GetDocumentRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.]{1,128}$<br/>
     *
     * @return <p>An optional field specifying the version of the artifact associated with the document. For example, "Release 12, Update 6". This value is unique across all versions of a document and can't be changed.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.]{1,128}$<br/>
     *
     * @param versionName <p>An optional field specifying the version of the artifact associated with the document. For example, "Release 12, Update 6". This value is unique across all versions of a document and can't be changed.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @return <p>The document version for which you want information.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @param documentVersion <p>The document version for which you want information.</p>
     */
     ...
     * <b>Allowed Values: </b>YAML, JSON, TEXT
     *
     * @return <p>Returns the document in the specified format. The document format can be either JSON or YAML. JSON is the default format.</p>
     *
     * @see DocumentFormat
     */
     ...
     * <b>Allowed Values: </b>YAML, JSON, TEXT
     *
     * @param documentFormat <p>Returns the document in the specified format. The document format can be either JSON or YAML. JSON is the default format.</p>
     *
     * @see DocumentFormat
     */
