 ...
 */
class ParameterHistoryJsonUnmarshaller implements Unmarshaller<ParameterHistory, JsonUnmarshallerContext> {
...
.unmarshall(context));
                ...
                parameterHistory.setLabels(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
.unmarshall(context));
...
.unmarshall(context));
                ...
                parameterHistory.setDataType(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static ParameterHistoryJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ParameterHistoryJsonUnmarshaller();
        return instance;
    }
}
