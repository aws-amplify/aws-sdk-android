...
public class GetParametersRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <p>Names of the parameters for which you want to query information.</p>
     *
     * @return <p>Names of the parameters for which you want to query information.</p>
     */
     ...
     * <p>Names of the parameters for which you want to query information.</p>
     *
     * @param names <p>Names of the parameters for which you want to query information.</p>
     */
     ...
     * <p>Return decrypted secure string value. Return decrypted values for secure string parameters. This flag is ignored for String and StringList parameter types.</p>
     *
     * @return <p>Return decrypted secure string value. Return decrypted values for secure string parameters. This flag is ignored for String and StringList parameter types.</p>
     */
     ...
     * <p>Return decrypted secure string value. Return decrypted values for secure string parameters. This flag is ignored for String and StringList parameter types.</p>
     *
     * @param withDecryption <p>Return decrypted secure string value. Return decrypted values for secure string parameters. This flag is ignored for String and StringList parameter types.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetParametersRequest == false) return false;
