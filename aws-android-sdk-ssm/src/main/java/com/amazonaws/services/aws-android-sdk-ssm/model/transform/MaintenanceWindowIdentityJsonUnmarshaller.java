 ...
 */
class MaintenanceWindowIdentityJsonUnmarshaller implements Unmarshaller<MaintenanceWindowIdentity, JsonUnmarshallerContext> {
...
.unmarshall(context));
    ...
    public static MaintenanceWindowIdentityJsonUnmarshaller getInstance() {
        if (instance == null) instance = new MaintenanceWindowIdentityJsonUnmarshaller();
        return instance;
    }
}
