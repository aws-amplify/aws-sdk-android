 ...
 */
public class DescribeMaintenanceWindowScheduleRequestMarshaller implements Marshaller<Request<DescribeMaintenanceWindowScheduleRequest>, DescribeMaintenanceWindowScheduleRequest> {
    ...
    public Request<DescribeMaintenanceWindowScheduleRequest> marshall(DescribeMaintenanceWindowScheduleRequest describeMaintenanceWindowScheduleRequest) {
        if (describeMaintenanceWindowScheduleRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(DescribeMaintenanceWindowScheduleRequest)");
        }

        Request<DescribeMaintenanceWindowScheduleRequest> request = new DefaultRequest<DescribeMaintenanceWindowScheduleRequest>(describeMaintenanceWindowScheduleRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (describeMaintenanceWindowScheduleRequest.getTargets() != null) {
                java.util.List<Target> targets = describeMaintenanceWindowScheduleRequest.getTargets();
            ...
            if (describeMaintenanceWindowScheduleRequest.getFilters() != null) {
                java.util.List<PatchOrchestratorFilter> filters = describeMaintenanceWindowScheduleRequest.getFilters();
