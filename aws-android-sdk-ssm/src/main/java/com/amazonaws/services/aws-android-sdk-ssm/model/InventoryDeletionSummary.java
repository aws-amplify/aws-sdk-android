...
public class InventoryDeletionSummary implements Serializable {
     ...
     * <p>The total number of items to delete. This count does not change during the delete operation.</p>
     *
     * @return <p>The total number of items to delete. This count does not change during the delete operation.</p>
     */
     ...
     * <p>The total number of items to delete. This count does not change during the delete operation.</p>
     *
     * @param totalCount <p>The total number of items to delete. This count does not change during the delete operation.</p>
     */
     ...
     * <p>Remaining number of items to delete.</p>
     *
     * @return <p>Remaining number of items to delete.</p>
     */
     ...
     * <p>Remaining number of items to delete.</p>
     *
     * @param remainingCount <p>Remaining number of items to delete.</p>
     */
     ...
     * <p>A list of counts and versions for deleted items.</p>
     *
     * @return <p>A list of counts and versions for deleted items.</p>
     */
     ...
     * <p>A list of counts and versions for deleted items.</p>
     *
     * @param summaryItems <p>A list of counts and versions for deleted items.</p>
     */
    ...
    public InventoryDeletionSummary withSummaryItems(InventoryDeletionSummaryItem... summaryItems) {
        if (getSummaryItems() == null) {
            this.summaryItems = new java.util.ArrayList<InventoryDeletionSummaryItem>(summaryItems.length);
        }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getTotalCount() != null) sb.append("TotalCount: " + getTotalCount() + ",");
        if (getRemainingCount() != null) sb.append("RemainingCount: " + getRemainingCount() + ",");
        if (getSummaryItems() != null) sb.append("SummaryItems: " + getSummaryItems());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InventoryDeletionSummary == false) return false;
        InventoryDeletionSummary other = (InventoryDeletionSummary)obj;

        if (other.getTotalCount() == null ^ this.getTotalCount() == null) return false;
        if (other.getTotalCount() != null && other.getTotalCount().equals(this.getTotalCount()) == false) return false;
        ...
        if (other.getSummaryItems() == null ^ this.getSummaryItems() == null) return false;
        if (other.getSummaryItems() != null && other.getSummaryItems().equals(this.getSummaryItems()) == false) return false;
        return true;
    }
}
