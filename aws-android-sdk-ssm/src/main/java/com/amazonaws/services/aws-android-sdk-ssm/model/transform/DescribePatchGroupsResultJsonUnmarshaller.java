    ...
    public DescribePatchGroupsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Mappings")) {
                describePatchGroupsResult.setMappings(new ListUnmarshaller<PatchGroupPatchBaselineMapping>(PatchGroupPatchBaselineMappingJsonUnmarshaller.getInstance()
)
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static DescribePatchGroupsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribePatchGroupsResultJsonUnmarshaller();
        return instance;
    }
}
