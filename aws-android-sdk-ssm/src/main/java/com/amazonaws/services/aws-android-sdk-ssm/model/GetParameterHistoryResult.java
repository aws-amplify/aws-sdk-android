...
public class GetParameterHistoryResult implements Serializable {
    /**
     * <p>A list of parameters returned by the request.</p>
     */
    private java.util.List<ParameterHistory> parameters;
     ...
     * <p>A list of parameters returned by the request.</p>
     *
     * @return <p>A list of parameters returned by the request.</p>
     */
     ...
     * <p>A list of parameters returned by the request.</p>
     *
     * @param parameters <p>A list of parameters returned by the request.</p>
     */
    public void setParameters(java.util.Collection<ParameterHistory> parameters) {
        ...
        this.parameters = new java.util.ArrayList<ParameterHistory>(parameters);
    }
    ...
    public GetParameterHistoryResult withParameters(ParameterHistory... parameters) {
        if (getParameters() == null) {
            this.parameters = new java.util.ArrayList<ParameterHistory>(parameters.length);
        }
        for (ParameterHistory value : parameters) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetParameterHistoryResult == false) return false;
