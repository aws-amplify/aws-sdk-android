...
class AssociationExecutionFilterJsonMarshaller {
    ...
    public void marshall(AssociationExecutionFilter associationExecutionFilter, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static AssociationExecutionFilterJsonMarshaller getInstance() {
        if (instance == null) instance = new AssociationExecutionFilterJsonMarshaller();
        return instance;
    }
}
