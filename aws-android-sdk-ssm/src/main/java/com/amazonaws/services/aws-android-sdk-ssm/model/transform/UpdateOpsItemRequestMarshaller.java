 ...
 */
public class UpdateOpsItemRequestMarshaller implements Marshaller<Request<UpdateOpsItemRequest>, UpdateOpsItemRequest> {

    public Request<UpdateOpsItemRequest> marshall(UpdateOpsItemRequest updateOpsItemRequest) {
        if (updateOpsItemRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(UpdateOpsItemRequest)");
        }

        Request<UpdateOpsItemRequest> request = new DefaultRequest<UpdateOpsItemRequest>(updateOpsItemRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (updateOpsItemRequest.getOperationalData() != null) {
                java.util.Map<String, OpsItemDataValue> operationalData = updateOpsItemRequest.getOperationalData();
            ...
            if (updateOpsItemRequest.getOperationalDataToDelete() != null) {
                java.util.List<String> operationalDataToDelete = updateOpsItemRequest.getOperationalDataToDelete();
            ...
            if (updateOpsItemRequest.getNotifications() != null) {
                java.util.List<OpsItemNotification> notifications = updateOpsItemRequest.getNotifications();
            ...
            if (updateOpsItemRequest.getRelatedOpsItems() != null) {
                java.util.List<RelatedOpsItem> relatedOpsItems = updateOpsItemRequest.getRelatedOpsItems();
