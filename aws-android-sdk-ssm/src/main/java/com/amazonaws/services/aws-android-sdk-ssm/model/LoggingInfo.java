...
public class LoggingInfo implements Serializable {
     ...
     * <b>Length: </b>3 - 63<br/>
     *
     * @return <p>The name of an S3 bucket where execution logs are stored .</p>
     */
     ...
     * <b>Length: </b>3 - 63<br/>
     *
     * @param s3BucketName <p>The name of an S3 bucket where execution logs are stored .</p>
     */
     ...
     * <b>Length: </b> - 500<br/>
     *
     * @return <p>(Optional) The S3 bucket subfolder. </p>
     */
     ...
     * <b>Length: </b> - 500<br/>
     *
     * @param s3KeyPrefix <p>(Optional) The S3 bucket subfolder. </p>
     */
     ...
     * <b>Length: </b>3 - 20<br/>
     *
     * @return <p>The Region where the S3 bucket is located.</p>
     */
     ...
     * <b>Length: </b>3 - 20<br/>
     *
     * @param s3Region <p>The Region where the S3 bucket is located.</p>
     */
    ...
    public String toString() {
        ...
        if (getS3Region() != null) sb.append("S3Region: " + getS3Region());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LoggingInfo == false) return false;
        ...
        if (other.getS3Region() == null ^ this.getS3Region() == null) return false;
        if (other.getS3Region() != null && other.getS3Region().equals(this.getS3Region()) == false) return false;
        return true;
    }
}
