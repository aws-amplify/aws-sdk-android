 ...
 */
public class DeleteMaintenanceWindowRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * <b>Pattern: </b>^mw-[0-9a-f]{17}$<br/>
     *
     * @return <p>The ID of the maintenance window to delete.</p>
     */
     ...
     * <b>Pattern: </b>^mw-[0-9a-f]{17}$<br/>
     *
     * @param windowId <p>The ID of the maintenance window to delete.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteMaintenanceWindowRequest == false) return false;
