...
public class CreatePatchBaselineRequestMarshaller implements Marshaller<Request<CreatePatchBaselineRequest>, CreatePatchBaselineRequest> {
    ...
    public Request<CreatePatchBaselineRequest> marshall(CreatePatchBaselineRequest createPatchBaselineRequest) {
        if (createPatchBaselineRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(CreatePatchBaselineRequest)");
        }

        Request<CreatePatchBaselineRequest> request = new DefaultRequest<CreatePatchBaselineRequest>(createPatchBaselineRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (createPatchBaselineRequest.getApprovedPatches() != null) {
                java.util.List<String> approvedPatches = createPatchBaselineRequest.getApprovedPatches();
            ...
            if (createPatchBaselineRequest.getApprovedPatchesComplianceLevel() != null) {
                String approvedPatchesComplianceLevel = createPatchBaselineRequest.getApprovedPatchesComplianceLevel();
            ...
            if (createPatchBaselineRequest.getApprovedPatchesEnableNonSecurity() != null) {
                Boolean approvedPatchesEnableNonSecurity = createPatchBaselineRequest.getApprovedPatchesEnableNonSecurity();
            ...
            if (createPatchBaselineRequest.getRejectedPatches() != null) {
                java.util.List<String> rejectedPatches = createPatchBaselineRequest.getRejectedPatches();
            ...
            if (createPatchBaselineRequest.getRejectedPatchesAction() != null) {
                String rejectedPatchesAction = createPatchBaselineRequest.getRejectedPatchesAction();
