...
class DocumentIdentifierJsonMarshaller {
    ...
    public void marshall(DocumentIdentifier documentIdentifier, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static DocumentIdentifierJsonMarshaller getInstance() {
        if (instance == null) instance = new DocumentIdentifierJsonMarshaller();
        return instance;
    }
}
