...
public class ListCommandInvocationsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @return <p>(Optional) The invocations for a specific command ID.</p>
     */
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @param commandId <p>(Optional) The invocations for a specific command ID.</p>
     */
     ...
     * <b>Pattern: </b>(^i-(\w{8}|\w{17})$)|(^mi-\w{17}$)<br/>
     *
     * @return <p>(Optional) The command execution details for a specific instance ID.</p>
     */
     ...
     * <b>Pattern: </b>(^i-(\w{8}|\w{17})$)|(^mi-\w{17}$)<br/>
     *
     * @param instanceId <p>(Optional) The command execution details for a specific instance ID.</p>
     */
     ...
     * <p>(Optional) If set this returns the response of the command executions and any command output. By default this is set to False. </p>
     *
     * @return <p>(Optional) If set this returns the response of the command executions and any command output. By default this is set to False. </p>
     */
     ...
     * <p>(Optional) If set this returns the response of the command executions and any command output. By default this is set to False. </p>
     *
     * @param details <p>(Optional) If set this returns the response of the command executions and any command output. By default this is set to False. </p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCommandInvocationsRequest == false) return false;
