 ...
 */
public class DescribePatchBaselinesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * <p>Each element in the array is a structure containing: </p> <p>Key: (string, "NAME_PREFIX" or "OWNER")</p> <p>Value: (array of strings, exactly 1 entry, between 1 and 255 characters)</p>
     *
     * @return <p>Each element in the array is a structure containing: </p> <p>Key: (string, "NAME_PREFIX" or "OWNER")</p> <p>Value: (array of strings, exactly 1 entry, between 1 and 255 characters)</p>
     */
     ...
     * <p>Each element in the array is a structure containing: </p> <p>Key: (string, "NAME_PREFIX" or "OWNER")</p> <p>Value: (array of strings, exactly 1 entry, between 1 and 255 characters)</p>
     *
     * @param filters <p>Each element in the array is a structure containing: </p> <p>Key: (string, "NAME_PREFIX" or "OWNER")</p> <p>Value: (array of strings, exactly 1 entry, between 1 and 255 characters)</p>
     */
     ...
     * <b>Range: </b>1 - 100<br/>
     *
     * @return <p>The maximum number of patch baselines to return (per page).</p>
     */
     ...
     * <b>Range: </b>1 - 100<br/>
     *
     * @param maxResults <p>The maximum number of patch baselines to return (per page).</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribePatchBaselinesRequest == false) return false;
