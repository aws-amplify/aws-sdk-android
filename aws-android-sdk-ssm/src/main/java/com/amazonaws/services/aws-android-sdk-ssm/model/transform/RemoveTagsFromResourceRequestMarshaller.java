...
/**
 * JSON request marshaller for RemoveTagsFromResourceRequest
 */
public class RemoveTagsFromResourceRequestMarshaller implements Marshaller<Request<RemoveTagsFromResourceRequest>, RemoveTagsFromResourceRequest> {
    ...
    public Request<RemoveTagsFromResourceRequest> marshall(RemoveTagsFromResourceRequest removeTagsFromResourceRequest) {
        if (removeTagsFromResourceRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(RemoveTagsFromResourceRequest)");
        }

        Request<RemoveTagsFromResourceRequest> request = new DefaultRequest<RemoveTagsFromResourceRequest>(removeTagsFromResourceRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (removeTagsFromResourceRequest.getResourceType() != null) {
                String resourceType = removeTagsFromResourceRequest.getResourceType();
                jsonWriter.name("ResourceType");
            jsonWriter.value(resourceType);
            }
            if (removeTagsFromResourceRequest.getResourceId() != null) {
                String resourceId = removeTagsFromResourceRequest.getResourceId();
