...
public class ResourceDataSyncItem implements Serializable {
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @return <p>The name of the Resource Data Sync.</p>
     */
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @param syncName <p>The name of the Resource Data Sync.</p>
     */
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @return <p>The type of resource data sync. If <code>SyncType</code> is <code>SyncToDestination</code>, then the resource data sync synchronizes data to an S3 bucket. If the <code>SyncType</code> is <code>SyncFromSource</code> then the resource data sync synchronizes data from AWS Organizations or from multiple AWS Regions.</p>
     */
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @param syncType <p>The type of resource data sync. If <code>SyncType</code> is <code>SyncToDestination</code>, then the resource data sync synchronizes data to an S3 bucket. If the <code>SyncType</code> is <code>SyncFromSource</code> then the resource data sync synchronizes data from AWS Organizations or from multiple AWS Regions.</p>
     */
     ...
     * <p>Information about the source where the data was synchronized. </p>
     *
     * @return <p>Information about the source where the data was synchronized. </p>
     */
     ...
     * <p>Information about the source where the data was synchronized. </p>
     *
     * @param syncSource <p>Information about the source where the data was synchronized. </p>
     */
     ...
     * <p>Configuration information for the target S3 bucket.</p>
     *
     * @return <p>Configuration information for the target S3 bucket.</p>
     */
     ...
     * <p>Configuration information for the target S3 bucket.</p>
     *
     * @param s3Destination <p>Configuration information for the target S3 bucket.</p>
     */
     ...
     * <p>The last time the configuration attempted to sync (UTC).</p>
     *
     * @return <p>The last time the configuration attempted to sync (UTC).</p>
     */
     ...
     * <p>The last time the configuration attempted to sync (UTC).</p>
     *
     * @param lastSyncTime <p>The last time the configuration attempted to sync (UTC).</p>
     */
     ...
     * <p>The last time the sync operations returned a status of <code>SUCCESSFUL</code> (UTC).</p>
     *
     * @return <p>The last time the sync operations returned a status of <code>SUCCESSFUL</code> (UTC).</p>
     */
     ...
     * <p>The last time the sync operations returned a status of <code>SUCCESSFUL</code> (UTC).</p>
     *
     * @param lastSuccessfulSyncTime <p>The last time the sync operations returned a status of <code>SUCCESSFUL</code> (UTC).</p>
     */
     ...
     * <p>The date and time the resource data sync was changed. </p>
     *
     * @return <p>The date and time the resource data sync was changed. </p>
     */
     ...
     * <p>The date and time the resource data sync was changed. </p>
     *
     * @param syncLastModifiedTime <p>The date and time the resource data sync was changed. </p>
     */
     ...
     * <b>Allowed Values: </b>Successful, Failed, InProgress
     *
     * @return <p>The status reported by the last sync.</p>
     *
     ...
     * <b>Allowed Values: </b>Successful, Failed, InProgress
     *
     * @param lastStatus <p>The status reported by the last sync.</p>
     *
     * @see LastResourceDataSyncStatus
     */
     ...
     * <p>The date and time the configuration was created (UTC).</p>
     *
     * @return <p>The date and time the configuration was created (UTC).</p>
     */
     ...
     * <p>The date and time the configuration was created (UTC).</p>
     *
     * @param syncCreatedTime <p>The date and time the configuration was created (UTC).</p>
     */
     ...
     * <p>The status message details reported by the last sync.</p>
     *
     * @return <p>The status message details reported by the last sync.</p>
     */
     ...
     * <p>The status message details reported by the last sync.</p>
     *
     * @param lastSyncStatusMessage <p>The status message details reported by the last sync.</p>
     */
    ...
    public String toString() {
        ...
        if (getLastSyncTime() != null) sb.append("LastSyncTime: " + getLastSyncTime() + ",");
        if (getLastSuccessfulSyncTime() != null) sb.append("LastSuccessfulSyncTime: " + getLastSuccessfulSyncTime() + ",");
        if (getSyncLastModifiedTime() != null) sb.append("SyncLastModifiedTime: " + getSyncLastModifiedTime() + ",");
        if (getLastStatus() != null) sb.append("LastStatus: " + getLastStatus() + ",");
        if (getSyncCreatedTime() != null) sb.append("SyncCreatedTime: " + getSyncCreatedTime() + ",");
        if (getLastSyncStatusMessage() != null) sb.append("LastSyncStatusMessage: " + getLastSyncStatusMessage());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResourceDataSyncItem == false) return false;
        ...
        if (other.getLastSyncTime() == null ^ this.getLastSyncTime() == null) return false;
        if (other.getLastSyncTime() != null && other.getLastSyncTime().equals(this.getLastSyncTime()) == false) return false;
        if (other.getLastSuccessfulSyncTime() == null ^ this.getLastSuccessfulSyncTime() == null) return false;
        if (other.getLastSuccessfulSyncTime() != null && other.getLastSuccessfulSyncTime().equals(this.getLastSuccessfulSyncTime()) == false) return false;
        if (other.getSyncLastModifiedTime() == null ^ this.getSyncLastModifiedTime() == null) return false;
        if (other.getSyncLastModifiedTime() != null && other.getSyncLastModifiedTime().equals(this.getSyncLastModifiedTime()) == false) return false;
        ...
        if (other.getSyncCreatedTime() == null ^ this.getSyncCreatedTime() == null) return false;
        if (other.getSyncCreatedTime() != null && other.getSyncCreatedTime().equals(this.getSyncCreatedTime()) == false) return false;
        if (other.getLastSyncStatusMessage() == null ^ this.getLastSyncStatusMessage() == null) return false;
        if (other.getLastSyncStatusMessage() != null && other.getLastSyncStatusMessage().equals(this.getLastSyncStatusMessage()) == false) return false;
        return true;
    }
}
