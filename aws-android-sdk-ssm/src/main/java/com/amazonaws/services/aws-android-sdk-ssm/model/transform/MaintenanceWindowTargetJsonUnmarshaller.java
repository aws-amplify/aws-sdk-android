 ...
 */
class MaintenanceWindowTargetJsonUnmarshaller implements Unmarshaller<MaintenanceWindowTarget, JsonUnmarshallerContext> {
...
.unmarshall(context));
    ...
    public static MaintenanceWindowTargetJsonUnmarshaller getInstance() {
        if (instance == null) instance = new MaintenanceWindowTargetJsonUnmarshaller();
        return instance;
    }
}
