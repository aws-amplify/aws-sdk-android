...
.unmarshall(context));
                ...
                getCommandInvocationResult.setExecutionStartDateTime(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("ExecutionElapsedTime")) {
                getCommandInvocationResult.setExecutionElapsedTime(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("ExecutionEndDateTime")) {
                getCommandInvocationResult.setExecutionEndDateTime(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                getCommandInvocationResult.setStandardOutputContent(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("StandardOutputUrl")) {
                getCommandInvocationResult.setStandardOutputUrl(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("StandardErrorContent")) {
                getCommandInvocationResult.setStandardErrorContent(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                getCommandInvocationResult.setCloudWatchOutputConfig(CloudWatchOutputConfigJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static GetCommandInvocationResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new GetCommandInvocationResultJsonUnmarshaller();
        return instance;
    }
}
