...
.unmarshall(context));
                ...
                listInventoryEntriesResult.setEntries(new ListUnmarshaller<java.util.Map<String, String>>(new MapUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
)
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static ListInventoryEntriesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListInventoryEntriesResultJsonUnmarshaller();
        return instance;
    }
}
