    ...
    public DescribeInstanceInformationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("InstanceInformationList")) {
                describeInstanceInformationResult.setInstanceInformationList(new ListUnmarshaller<InstanceInformation>(InstanceInformationJsonUnmarshaller.getInstance()
)
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static DescribeInstanceInformationResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeInstanceInformationResultJsonUnmarshaller();
        return instance;
    }
}
