...
public class SendCommandRequestMarshaller implements Marshaller<Request<SendCommandRequest>, SendCommandRequest> {
    ...
    public Request<SendCommandRequest> marshall(SendCommandRequest sendCommandRequest) {
        if (sendCommandRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(SendCommandRequest)");
        }

        Request<SendCommandRequest> request = new DefaultRequest<SendCommandRequest>(sendCommandRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (sendCommandRequest.getParameters() != null) {
                java.util.Map<String, java.util.List<String>> parameters = sendCommandRequest.getParameters();
            ...
            if (sendCommandRequest.getCloudWatchOutputConfig() != null) {
                CloudWatchOutputConfig cloudWatchOutputConfig = sendCommandRequest.getCloudWatchOutputConfig();
