...
public class GetCommandInvocationResult implements Serializable {
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Pattern: </b>^([\-]?\d{4}(?!\d{2}\b))((-?)((0[1-9]|1[0-2])(\3([12]\d|0[1-9]|3[01]))?|W([0-4]\d|5[0-2])(-?[1-7])?|(00[1-9]|0[1-9]\d|[12]\d{2}|3([0-5]\d|6[1-6])))([T\s]((([01]\d|2[0-3])((:?)[0-5]\d)?|24\:?00)([\.,]\d(?!:))?)?(\17[0-5]\d([\.,]\d)?)?([zZ]|([\-])([01]\d|2[0-3]):?([0-5]\d)?)?)?)?$<br/>
     */
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @return <p>The parent command ID of the invocation plugin.</p>
     */
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @param commandId <p>The parent command ID of the invocation plugin.</p>
     */
     ...
     * <b>Pattern: </b>(^i-(\w{8}|\w{17})$)|(^mi-\w{17}$)<br/>
     *
     * @return <p>The ID of the managed instance targeted by the command. A managed instance can be an EC2 instance or an instance in your hybrid environment that is configured for Systems Manager.</p>
     */
     ...
     * <b>Pattern: </b>(^i-(\w{8}|\w{17})$)|(^mi-\w{17}$)<br/>
     *
     * @param instanceId <p>The ID of the managed instance targeted by the command. A managed instance can be an EC2 instance or an instance in your hybrid environment that is configured for Systems Manager.</p>
     */
     ...
     * <b>Length: </b> - 100<br/>
     *
     * @return <p>The comment text for the command.</p>
     */
     ...
     * <b>Length: </b> - 100<br/>
     *
     * @param comment <p>The comment text for the command.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.]{3,128}$<br/>
     *
     * @return <p>The name of the document that was run. For example, AWS-RunShellScript.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.]{3,128}$<br/>
     *
     * @param documentName <p>The name of the document that was run. For example, AWS-RunShellScript.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @return <p>The SSM document version used in the request.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @param documentVersion <p>The SSM document version used in the request.</p>
     */
     ...
     * <b>Length: </b>4 - <br/>
     *
     * @return <p>The name of the plugin for which you want detailed results. For example, aws:RunShellScript is a plugin.</p>
     */
     ...
     * <b>Length: </b>4 - <br/>
     *
     * @param pluginName <p>The name of the plugin for which you want detailed results. For example, aws:RunShellScript is a plugin.</p>
     */
     ...
     * <p>The error level response code for the plugin script. If the response code is -1, then the command has not started running on the instance, or it was not received by the instance.</p>
     *
     * @return <p>The error level response code for the plugin script. If the response code is -1, then the command has not started running on the instance, or it was not received by the instance.</p>
     */
     ...
     * <p>The error level response code for the plugin script. If the response code is -1, then the command has not started running on the instance, or it was not received by the instance.</p>
     *
     * @param responseCode <p>The error level response code for the plugin script. If the response code is -1, then the command has not started running on the instance, or it was not received by the instance.</p>
     */
     ...
     * <b>Pattern: </b>^([\-]?\d{4}(?!\d{2}\b))((-?)((0[1-9]|1[0-2])(\3([12]\d|0[1-9]|3[01]))?|W([0-4]\d|5[0-2])(-?[1-7])?|(00[1-9]|0[1-9]\d|[12]\d{2}|3([0-5]\d|6[1-6])))([T\s]((([01]\d|2[0-3])((:?)[0-5]\d)?|24\:?00)([\.,]\d(?!:))?)?(\17[0-5]\d([\.,]\d)?)?([zZ]|([\-])([01]\d|2[0-3]):?([0-5]\d)?)?)?)?$<br/>
     *
     * @param executionStartDateTime <p>The date and time the plugin started running. Date and time are written in ISO 8601 format. For example, June 7, 2017 is represented as 2017-06-7. The following sample AWS CLI command uses the <code>InvokedBefore</code> filter.</p> <p> <code>aws ssm list-commands --filters key=InvokedBefore,value=2017-06-07T00:00:00Z</code> </p> <p>If the plugin has not started to run, the string is empty.</p>
     */
     ...
     * <b>Pattern: </b>^([\-]?\d{4}(?!\d{2}\b))((-?)((0[1-9]|1[0-2])(\3([12]\d|0[1-9]|3[01]))?|W([0-4]\d|5[0-2])(-?[1-7])?|(00[1-9]|0[1-9]\d|[12]\d{2}|3([0-5]\d|6[1-6])))([T\s]((([01]\d|2[0-3])((:?)[0-5]\d)?|24\:?00)([\.,]\d(?!:))?)?(\17[0-5]\d([\.,]\d)?)?([zZ]|([\-])([01]\d|2[0-3]):?([0-5]\d)?)?)?)?$<br/>
     *
     * @return <p>Duration since ExecutionStartDateTime.</p>
     */
     ...
     * <b>Pattern: </b>^([\-]?\d{4}(?!\d{2}\b))((-?)((0[1-9]|1[0-2])(\3([12]\d|0[1-9]|3[01]))?|W([0-4]\d|5[0-2])(-?[1-7])?|(00[1-9]|0[1-9]\d|[12]\d{2}|3([0-5]\d|6[1-6])))([T\s]((([01]\d|2[0-3])((:?)[0-5]\d)?|24\:?00)([\.,]\d(?!:))?)?(\17[0-5]\d([\.,]\d)?)?([zZ]|([\-])([01]\d|2[0-3]):?([0-5]\d)?)?)?)?$<br/>
     *
     * @param executionElapsedTime <p>Duration since ExecutionStartDateTime.</p>
     */
     ...
     * <b>Allowed Values: </b>Pending, InProgress, Delayed, Success, Cancelled, TimedOut, Failed, Cancelling
     *
     * @return <p>The status of this invocation plugin. This status can be different than StatusDetails.</p>
     *
     ...
     * <b>Allowed Values: </b>Pending, InProgress, Delayed, Success, Cancelled, TimedOut, Failed, Cancelling
     *
     * @param status <p>The status of this invocation plugin. This status can be different than StatusDetails.</p>
     *
     * @see CommandInvocationStatus
     */
     ...
     * <b>Length: </b>0 - 100<br/>
     *
     * @return <p>A detailed status of the command execution for an invocation. StatusDetails includes more information than Status because it includes states resulting from error and concurrency control parameters. StatusDetails can show different results than Status. For more information about these statuses, see <a href="https://docs.aws.amazon.com/systems-manager/latest/userguide/monitor-commands.html">Understanding command statuses</a> in the <i>AWS Systems Manager User Guide</i>. StatusDetails can be one of the following values:</p> <ul> <li> <p>Pending: The command has not been sent to the instance.</p> </li> <li> <p>In Progress: The command has been sent to the instance but has not reached a terminal state.</p> </li> <li> <p>Delayed: The system attempted to send the command to the target, but the target was not available. The instance might not be available because of network issues, because the instance was stopped, or for similar reasons. The system will try to send the command again.</p> </li> <li> <p>Success: The command or plugin ran successfully. This is a terminal state.</p> </li> <li> <p>Delivery Timed Out: The command was not delivered to the instance before the delivery timeout expired. Delivery timeouts do not count against the parent command's MaxErrors limit, but they do contribute to whether the parent command status is Success or Incomplete. This is a terminal state.</p> </li> <li> <p>Execution Timed Out: The command started to run on the instance, but the execution was not complete before the timeout expired. Execution timeouts count against the MaxErrors limit of the parent command. This is a terminal state.</p> </li> <li> <p>Failed: The command wasn't run successfully on the instance. For a plugin, this indicates that the result code was not zero. For a command invocation, this indicates that the result code for one or more plugins was not zero. Invocation failures count against the MaxErrors limit of the parent command. This is a terminal state.</p> </li> <li> <p>Canceled: The command was terminated before it was completed. This is a terminal state.</p> </li> <li> <p>Undeliverable: The command can't be delivered to the instance. The instance might not exist or might not be responding. Undeliverable invocations don't count against the parent command's MaxErrors limit and don't contribute to whether the parent command status is Success or Incomplete. This is a terminal state.</p> </li> <li> <p>Terminated: The parent command exceeded its MaxErrors limit and subsequent command invocations were canceled by the system. This is a terminal state.</p> </li> </ul>
     */
     ...
     * <b>Length: </b>0 - 100<br/>
     *
     * @param statusDetails <p>A detailed status of the command execution for an invocation. StatusDetails includes more information than Status because it includes states resulting from error and concurrency control parameters. StatusDetails can show different results than Status. For more information about these statuses, see <a href="https://docs.aws.amazon.com/systems-manager/latest/userguide/monitor-commands.html">Understanding command statuses</a> in the <i>AWS Systems Manager User Guide</i>. StatusDetails can be one of the following values:</p> <ul> <li> <p>Pending: The command has not been sent to the instance.</p> </li> <li> <p>In Progress: The command has been sent to the instance but has not reached a terminal state.</p> </li> <li> <p>Delayed: The system attempted to send the command to the target, but the target was not available. The instance might not be available because of network issues, because the instance was stopped, or for similar reasons. The system will try to send the command again.</p> </li> <li> <p>Success: The command or plugin ran successfully. This is a terminal state.</p> </li> <li> <p>Delivery Timed Out: The command was not delivered to the instance before the delivery timeout expired. Delivery timeouts do not count against the parent command's MaxErrors limit, but they do contribute to whether the parent command status is Success or Incomplete. This is a terminal state.</p> </li> <li> <p>Execution Timed Out: The command started to run on the instance, but the execution was not complete before the timeout expired. Execution timeouts count against the MaxErrors limit of the parent command. This is a terminal state.</p> </li> <li> <p>Failed: The command wasn't run successfully on the instance. For a plugin, this indicates that the result code was not zero. For a command invocation, this indicates that the result code for one or more plugins was not zero. Invocation failures count against the MaxErrors limit of the parent command. This is a terminal state.</p> </li> <li> <p>Canceled: The command was terminated before it was completed. This is a terminal state.</p> </li> <li> <p>Undeliverable: The command can't be delivered to the instance. The instance might not exist or might not be responding. Undeliverable invocations don't count against the parent command's MaxErrors limit and don't contribute to whether the parent command status is Success or Incomplete. This is a terminal state.</p> </li> <li> <p>Terminated: The parent command exceeded its MaxErrors limit and subsequent command invocations were canceled by the system. This is a terminal state.</p> </li> </ul>
     */
     ...
     * <b>Length: </b> - 24000<br/>
     *
     * @return <p>The first 24,000 characters written by the plugin to stdout. If the command has not finished running, if ExecutionStatus is neither Succeeded nor Failed, then this string is empty.</p>
     */
     ...
     * <b>Length: </b> - 24000<br/>
     *
     * @param standardOutputContent <p>The first 24,000 characters written by the plugin to stdout. If the command has not finished running, if ExecutionStatus is neither Succeeded nor Failed, then this string is empty.</p>
     */
     ...
     * <p>The URL for the complete text written by the plugin to stdout in Amazon S3. If an S3 bucket was not specified, then this string is empty.</p>
     *
     * @return <p>The URL for the complete text written by the plugin to stdout in Amazon S3. If an S3 bucket was not specified, then this string is empty.</p>
     */
     ...
     * <p>The URL for the complete text written by the plugin to stdout in Amazon S3. If an S3 bucket was not specified, then this string is empty.</p>
     *
     * @param standardOutputUrl <p>The URL for the complete text written by the plugin to stdout in Amazon S3. If an S3 bucket was not specified, then this string is empty.</p>
     */
     ...
     * <b>Length: </b> - 8000<br/>
     *
     * @return <p>The first 8,000 characters written by the plugin to stderr. If the command has not finished running, then this string is empty.</p>
     */
     ...
     * <b>Length: </b> - 8000<br/>
     *
     * @param standardErrorContent <p>The first 8,000 characters written by the plugin to stderr. If the command has not finished running, then this string is empty.</p>
     */
     ...
     * <p>The URL for the complete text written by the plugin to stderr. If the command has not finished running, then this string is empty.</p>
     *
     * @return <p>The URL for the complete text written by the plugin to stderr. If the command has not finished running, then this string is empty.</p>
     */
     ...
     * <p>The URL for the complete text written by the plugin to stderr. If the command has not finished running, then this string is empty.</p>
     *
     * @param standardErrorUrl <p>The URL for the complete text written by the plugin to stderr. If the command has not finished running, then this string is empty.</p>
     */
     ...
     * <p>CloudWatch Logs information where Systems Manager sent the command output.</p>
     *
     * @return <p>CloudWatch Logs information where Systems Manager sent the command output.</p>
     */
     ...
     * <p>CloudWatch Logs information where Systems Manager sent the command output.</p>
     *
     * @param cloudWatchOutputConfig <p>CloudWatch Logs information where Systems Manager sent the command output.</p>
     */
    ...
    public String toString() {
        ...
        if (getExecutionStartDateTime() != null) sb.append("ExecutionStartDateTime: " + getExecutionStartDateTime() + ",");
        if (getExecutionElapsedTime() != null) sb.append("ExecutionElapsedTime: " + getExecutionElapsedTime() + ",");
        if (getExecutionEndDateTime() != null) sb.append("ExecutionEndDateTime: " + getExecutionEndDateTime() + ",");
        if (getStatus() != null) sb.append("Status: " + getStatus() + ",");
        if (getStatusDetails() != null) sb.append("StatusDetails: " + getStatusDetails() + ",");
        if (getStandardOutputContent() != null) sb.append("StandardOutputContent: " + getStandardOutputContent() + ",");
        if (getStandardOutputUrl() != null) sb.append("StandardOutputUrl: " + getStandardOutputUrl() + ",");
        if (getStandardErrorContent() != null) sb.append("StandardErrorContent: " + getStandardErrorContent() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCommandInvocationResult == false) return false;
        ...
        if (other.getExecutionStartDateTime() == null ^ this.getExecutionStartDateTime() == null) return false;
        if (other.getExecutionStartDateTime() != null && other.getExecutionStartDateTime().equals(this.getExecutionStartDateTime()) == false) return false;
        if (other.getExecutionElapsedTime() == null ^ this.getExecutionElapsedTime() == null) return false;
        if (other.getExecutionElapsedTime() != null && other.getExecutionElapsedTime().equals(this.getExecutionElapsedTime()) == false) return false;
        if (other.getExecutionEndDateTime() == null ^ this.getExecutionEndDateTime() == null) return false;
        if (other.getExecutionEndDateTime() != null && other.getExecutionEndDateTime().equals(this.getExecutionEndDateTime()) == false) return false;
        ...
        if (other.getStandardOutputContent() == null ^ this.getStandardOutputContent() == null) return false;
        if (other.getStandardOutputContent() != null && other.getStandardOutputContent().equals(this.getStandardOutputContent()) == false) return false;
        ...
        if (other.getStandardErrorContent() == null ^ this.getStandardErrorContent() == null) return false;
        if (other.getStandardErrorContent() != null && other.getStandardErrorContent().equals(this.getStandardErrorContent()) == false) return false;
