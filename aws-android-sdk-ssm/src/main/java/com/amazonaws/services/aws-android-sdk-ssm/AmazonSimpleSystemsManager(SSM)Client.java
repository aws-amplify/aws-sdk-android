 ...
 */
package com.amazonaws.services.aws-android-sdk-ssm;
...
import com.amazonaws.services.aws-android-sdk-ssm.model.transform.*;

/**
 * Client for accessing Amazon Simple Systems Manager (SSM).  All service calls made
 ...
 */
public class AmazonSimpleSystemsManager(SSM)Client extends AmazonWebServiceClient implements AmazonSimpleSystemsManager(SSM) { 
    /** Provider for AWS credentials. */
    private AWSCredentialsProvider awsCredentialsProvider;

    /**
     * List of exception unmarshallers for all Amazon Simple Systems Manager (SSM) exceptions.
     */
    protected List<JsonErrorUnmarshaller> jsonErrorUnmarshallers;

    /**
     * Constructs a new client to invoke service methods on
     * AmazonSimpleSystemsManager(SSM).  A credentials provider chain will be used
     ...
     */
    @Deprecated
    public AmazonSimpleSystemsManager(SSM)Client() {
     ...
     *                       client connects to AmazonSimpleSystemsManager(SSM)
     *                       (ex: proxy settings, retry counts, etc.).
     *
     * @see DefaultAWSCredentialsProviderChain
     */
    @Deprecated
    public AmazonSimpleSystemsManager(SSM)Client(ClientConfiguration clientConfiguration) {
        this(new DefaultAWSCredentialsProviderChain(), clientConfiguration);
    }

    /**
     * Constructs a new client to invoke service methods on
     * AmazonSimpleSystemsManager(SSM) using the specified AWS account credentials.
     * <p>
     ...
     *         AmazonSimpleSystemsManager(SSM)Client client = new AmazonSimpleSystemsManager(SSM)Client(AWSMobileClient.getInstance());
     *     }
     * 
     *     &#64;Override
     ...
     */
    public AmazonSimpleSystemsManager(SSM)Client(AWSCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonSimpleSystemsManager(SSM)Client(AWSCredentials awsCredentials, ClientConfiguration clientConfiguration) {
        this(new StaticCredentialsProvider(awsCredentials), clientConfiguration);
    }

    /**
     * Constructs a new client to invoke service methods on
     * AmazonSimpleSystemsManager(SSM) using the specified AWS account credentials provider.
     * <p>
     * The client requests are authenticated using the {@link AWSCredentials}
     ...
     */
    public AmazonSimpleSystemsManager(SSM)Client(AWSCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonSimpleSystemsManager(SSM)Client(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
    ...
    private void init() {
        ...
        jsonErrorUnmarshallers.add(new InvalidInstanceInformationFilterValueExceptionUnmarshaller());
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/aws-android-sdk-ssm/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/aws-android-sdk-ssm/request.handler2s"));
    }
     ...
     * @return addTagsToResourceResult The response from the AddTagsToResource service method, as returned by Amazon Simple Systems Manager (SSM).
     ...
     *             If an error response is returned by Amazon Simple Systems Manager (SSM) indicating
    ...
    public AddTagsToResourceResult addTagsToResource(AddTagsToResourceRequest addTagsToResourceRequest)
        ...
        try {
            ...
            JsonResponseHandler<AddTagsToResourceResult> responseHandler = new JsonResponseHandler<AddTagsToResourceResult>(unmarshaller);
     ...
     * @return cancelCommandResult The response from the CancelCommand service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
    ...
    public CancelCommandResult cancelCommand(CancelCommandRequest cancelCommandRequest)
        ...
        try {
            ...
            JsonResponseHandler<CancelCommandResult> responseHandler = new JsonResponseHandler<CancelCommandResult>(unmarshaller);
     ...
     * @return cancelMaintenanceWindowExecutionResult The response from the CancelMaintenanceWindowExecution service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
    ...
    public CancelMaintenanceWindowExecutionResult cancelMaintenanceWindowExecution(CancelMaintenanceWindowExecutionRequest cancelMaintenanceWindowExecutionRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new CancelMaintenanceWindowExecutionRequestMarshaller().marshall(cancelMaintenanceWindowExecutionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<CancelMaintenanceWindowExecutionResult> responseHandler = new JsonResponseHandler<CancelMaintenanceWindowExecutionResult>(unmarshaller);
     ...
     * @return createActivationResult The response from the CreateActivation service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
    ...
    public CreateActivationResult createActivation(CreateActivationRequest createActivationRequest)
        ...
        try {
            ...
            JsonResponseHandler<CreateActivationResult> responseHandler = new JsonResponseHandler<CreateActivationResult>(unmarshaller);
     ...
     * @return createAssociationResult The response from the CreateAssociation service method, as returned by Amazon Simple Systems Manager (SSM).
    ...
    public CreateAssociationResult createAssociation(CreateAssociationRequest createAssociationRequest)
        ...
        try {
            ...
            JsonResponseHandler<CreateAssociationResult> responseHandler = new JsonResponseHandler<CreateAssociationResult>(unmarshaller);
     ...
     * @return createAssociationBatchResult The response from the CreateAssociationBatch service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidDocumentException 
     * @throws InvalidDocumentVersionException 
     * @throws InvalidInstanceIdException 
    ...
    public CreateAssociationBatchResult createAssociationBatch(CreateAssociationBatchRequest createAssociationBatchRequest)
        ...
        try {
            ...
            JsonResponseHandler<CreateAssociationBatchResult> responseHandler = new JsonResponseHandler<CreateAssociationBatchResult>(unmarshaller);
     ...
     * @return createDocumentResult The response from the CreateDocument service method, as returned by Amazon Simple Systems Manager (SSM).
    ...
    public CreateDocumentResult createDocument(CreateDocumentRequest createDocumentRequest)
        ...
        try {
            ...
            JsonResponseHandler<CreateDocumentResult> responseHandler = new JsonResponseHandler<CreateDocumentResult>(unmarshaller);
     ...
     * @return createMaintenanceWindowResult The response from the CreateMaintenanceWindow service method, as returned by Amazon Simple Systems Manager (SSM).
    ...
    public CreateMaintenanceWindowResult createMaintenanceWindow(CreateMaintenanceWindowRequest createMaintenanceWindowRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new CreateMaintenanceWindowRequestMarshaller().marshall(createMaintenanceWindowRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<CreateMaintenanceWindowResult> responseHandler = new JsonResponseHandler<CreateMaintenanceWindowResult>(unmarshaller);
     ...
     * @return createOpsItemResult The response from the CreateOpsItem service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
    ...
    public CreateOpsItemResult createOpsItem(CreateOpsItemRequest createOpsItemRequest)
        ...
        try {
            ...
            JsonResponseHandler<CreateOpsItemResult> responseHandler = new JsonResponseHandler<CreateOpsItemResult>(unmarshaller);
     ...
     * @return createPatchBaselineResult The response from the CreatePatchBaseline service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws IdempotentParameterMismatchException 
     * @throws ResourceLimitExceededException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
    ...
    public CreatePatchBaselineResult createPatchBaseline(CreatePatchBaselineRequest createPatchBaselineRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new CreatePatchBaselineRequestMarshaller().marshall(createPatchBaselineRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<CreatePatchBaselineResult> responseHandler = new JsonResponseHandler<CreatePatchBaselineResult>(unmarshaller);
     ...
     * @return createResourceDataSyncResult The response from the CreateResourceDataSync service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
    ...
    public CreateResourceDataSyncResult createResourceDataSync(CreateResourceDataSyncRequest createResourceDataSyncRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new CreateResourceDataSyncRequestMarshaller().marshall(createResourceDataSyncRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<CreateResourceDataSyncResult> responseHandler = new JsonResponseHandler<CreateResourceDataSyncResult>(unmarshaller);
     ...
     * @return deleteActivationResult The response from the DeleteActivation service method, as returned by Amazon Simple Systems Manager (SSM).
    ...
    public DeleteActivationResult deleteActivation(DeleteActivationRequest deleteActivationRequest)
        ...
        try {
            ...
            JsonResponseHandler<DeleteActivationResult> responseHandler = new JsonResponseHandler<DeleteActivationResult>(unmarshaller);
     ...
     * @return deleteAssociationResult The response from the DeleteAssociation service method, as returned by Amazon Simple Systems Manager (SSM).
    ...
    public DeleteAssociationResult deleteAssociation(DeleteAssociationRequest deleteAssociationRequest)
        ...
        try {
            ...
            JsonResponseHandler<DeleteAssociationResult> responseHandler = new JsonResponseHandler<DeleteAssociationResult>(unmarshaller);
     ...
     * @return deleteDocumentResult The response from the DeleteDocument service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidDocumentException 
    ...
    public DeleteDocumentResult deleteDocument(DeleteDocumentRequest deleteDocumentRequest)
        ...
        try {
            ...
            JsonResponseHandler<DeleteDocumentResult> responseHandler = new JsonResponseHandler<DeleteDocumentResult>(unmarshaller);
     ...
     * @return deleteInventoryResult The response from the DeleteInventory service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
    ...
    public DeleteInventoryResult deleteInventory(DeleteInventoryRequest deleteInventoryRequest)
        ...
        try {
            ...
            JsonResponseHandler<DeleteInventoryResult> responseHandler = new JsonResponseHandler<DeleteInventoryResult>(unmarshaller);
     ...
     * @return deleteMaintenanceWindowResult The response from the DeleteMaintenanceWindow service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
    ...
    public DeleteMaintenanceWindowResult deleteMaintenanceWindow(DeleteMaintenanceWindowRequest deleteMaintenanceWindowRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DeleteMaintenanceWindowRequestMarshaller().marshall(deleteMaintenanceWindowRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DeleteMaintenanceWindowResult> responseHandler = new JsonResponseHandler<DeleteMaintenanceWindowResult>(unmarshaller);
     ...
     * @return deleteParameterResult The response from the DeleteParameter service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
    ...
    public DeleteParameterResult deleteParameter(DeleteParameterRequest deleteParameterRequest)
        ...
        try {
            ...
            JsonResponseHandler<DeleteParameterResult> responseHandler = new JsonResponseHandler<DeleteParameterResult>(unmarshaller);
     ...
     * @return deleteParametersResult The response from the DeleteParameters service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
    ...
    public DeleteParametersResult deleteParameters(DeleteParametersRequest deleteParametersRequest)
        ...
        try {
            ...
            JsonResponseHandler<DeleteParametersResult> responseHandler = new JsonResponseHandler<DeleteParametersResult>(unmarshaller);
     ...
     * @return deletePatchBaselineResult The response from the DeletePatchBaseline service method, as returned by Amazon Simple Systems Manager (SSM).
    ...
    public DeletePatchBaselineResult deletePatchBaseline(DeletePatchBaselineRequest deletePatchBaselineRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DeletePatchBaselineRequestMarshaller().marshall(deletePatchBaselineRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DeletePatchBaselineResult> responseHandler = new JsonResponseHandler<DeletePatchBaselineResult>(unmarshaller);
     ...
     * @return deleteResourceDataSyncResult The response from the DeleteResourceDataSync service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
    ...
    public DeleteResourceDataSyncResult deleteResourceDataSync(DeleteResourceDataSyncRequest deleteResourceDataSyncRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DeleteResourceDataSyncRequestMarshaller().marshall(deleteResourceDataSyncRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DeleteResourceDataSyncResult> responseHandler = new JsonResponseHandler<DeleteResourceDataSyncResult>(unmarshaller);
     ...
     * @return deregisterManagedInstanceResult The response from the DeregisterManagedInstance service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InvalidInstanceIdException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public DeregisterManagedInstanceResult deregisterManagedInstance(DeregisterManagedInstanceRequest deregisterManagedInstanceRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DeregisterManagedInstanceRequestMarshaller().marshall(deregisterManagedInstanceRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DeregisterManagedInstanceResult> responseHandler = new JsonResponseHandler<DeregisterManagedInstanceResult>(unmarshaller);
     ...
     * @return deregisterPatchBaselineForPatchGroupResult The response from the DeregisterPatchBaselineForPatchGroup service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InvalidResourceIdException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public DeregisterPatchBaselineForPatchGroupResult deregisterPatchBaselineForPatchGroup(DeregisterPatchBaselineForPatchGroupRequest deregisterPatchBaselineForPatchGroupRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DeregisterPatchBaselineForPatchGroupRequestMarshaller().marshall(deregisterPatchBaselineForPatchGroupRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DeregisterPatchBaselineForPatchGroupResult> responseHandler = new JsonResponseHandler<DeregisterPatchBaselineForPatchGroupResult>(unmarshaller);
     ...
     * @return deregisterTargetFromMaintenanceWindowResult The response from the DeregisterTargetFromMaintenanceWindow service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
    ...
    public DeregisterTargetFromMaintenanceWindowResult deregisterTargetFromMaintenanceWindow(DeregisterTargetFromMaintenanceWindowRequest deregisterTargetFromMaintenanceWindowRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DeregisterTargetFromMaintenanceWindowRequestMarshaller().marshall(deregisterTargetFromMaintenanceWindowRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DeregisterTargetFromMaintenanceWindowResult> responseHandler = new JsonResponseHandler<DeregisterTargetFromMaintenanceWindowResult>(unmarshaller);
     ...
     * @return deregisterTaskFromMaintenanceWindowResult The response from the DeregisterTaskFromMaintenanceWindow service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public DeregisterTaskFromMaintenanceWindowResult deregisterTaskFromMaintenanceWindow(DeregisterTaskFromMaintenanceWindowRequest deregisterTaskFromMaintenanceWindowRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DeregisterTaskFromMaintenanceWindowRequestMarshaller().marshall(deregisterTaskFromMaintenanceWindowRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DeregisterTaskFromMaintenanceWindowResult> responseHandler = new JsonResponseHandler<DeregisterTaskFromMaintenanceWindowResult>(unmarshaller);
     ...
     * @return describeActivationsResult The response from the DescribeActivations service method, as returned by Amazon Simple Systems Manager (SSM).
    ...
    public DescribeActivationsResult describeActivations(DescribeActivationsRequest describeActivationsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeActivationsRequestMarshaller().marshall(describeActivationsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeActivationsResult> responseHandler = new JsonResponseHandler<DescribeActivationsResult>(unmarshaller);
     ...
     * @return describeAssociationResult The response from the DescribeAssociation service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws AssociationDoesNotExistException 
    ...
    public DescribeAssociationResult describeAssociation(DescribeAssociationRequest describeAssociationRequest)
        ...
        try {
            ...
            JsonResponseHandler<DescribeAssociationResult> responseHandler = new JsonResponseHandler<DescribeAssociationResult>(unmarshaller);
     ...
     * @return describeAssociationExecutionTargetsResult The response from the DescribeAssociationExecutionTargets service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AssociationDoesNotExistException 
     * @throws InvalidNextTokenException 
    ...
    public DescribeAssociationExecutionTargetsResult describeAssociationExecutionTargets(DescribeAssociationExecutionTargetsRequest describeAssociationExecutionTargetsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeAssociationExecutionTargetsRequestMarshaller().marshall(describeAssociationExecutionTargetsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeAssociationExecutionTargetsResult> responseHandler = new JsonResponseHandler<DescribeAssociationExecutionTargetsResult>(unmarshaller);
     ...
     * @return describeAssociationExecutionsResult The response from the DescribeAssociationExecutions service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AssociationDoesNotExistException 
     * @throws InvalidNextTokenException 
     * @throws AmazonClientException
    ...
    public DescribeAssociationExecutionsResult describeAssociationExecutions(DescribeAssociationExecutionsRequest describeAssociationExecutionsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeAssociationExecutionsRequestMarshaller().marshall(describeAssociationExecutionsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeAssociationExecutionsResult> responseHandler = new JsonResponseHandler<DescribeAssociationExecutionsResult>(unmarshaller);
     ...
     * @return describeAutomationExecutionsResult The response from the DescribeAutomationExecutions service method, as returned by Amazon Simple Systems Manager (SSM).
    ...
    public DescribeAutomationExecutionsResult describeAutomationExecutions(DescribeAutomationExecutionsRequest describeAutomationExecutionsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeAutomationExecutionsRequestMarshaller().marshall(describeAutomationExecutionsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeAutomationExecutionsResult> responseHandler = new JsonResponseHandler<DescribeAutomationExecutionsResult>(unmarshaller);
     ...
     * @return describeAutomationStepExecutionsResult The response from the DescribeAutomationStepExecutions service method, as returned by Amazon Simple Systems Manager (SSM).
    ...
    public DescribeAutomationStepExecutionsResult describeAutomationStepExecutions(DescribeAutomationStepExecutionsRequest describeAutomationStepExecutionsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeAutomationStepExecutionsRequestMarshaller().marshall(describeAutomationStepExecutionsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeAutomationStepExecutionsResult> responseHandler = new JsonResponseHandler<DescribeAutomationStepExecutionsResult>(unmarshaller);
     ...
     * @return describeAvailablePatchesResult The response from the DescribeAvailablePatches service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
    ...
    public DescribeAvailablePatchesResult describeAvailablePatches(DescribeAvailablePatchesRequest describeAvailablePatchesRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeAvailablePatchesRequestMarshaller().marshall(describeAvailablePatchesRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeAvailablePatchesResult> responseHandler = new JsonResponseHandler<DescribeAvailablePatchesResult>(unmarshaller);
     ...
     * @return describeDocumentResult The response from the DescribeDocument service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidDocumentException 
     * @throws InvalidDocumentVersionException 
     * @throws AmazonClientException
    ...
    public DescribeDocumentResult describeDocument(DescribeDocumentRequest describeDocumentRequest)
        ...
        try {
            ...
            JsonResponseHandler<DescribeDocumentResult> responseHandler = new JsonResponseHandler<DescribeDocumentResult>(unmarshaller);
     ...
     * @return describeDocumentPermissionResult The response from the DescribeDocumentPermission service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidDocumentException 
    ...
    public DescribeDocumentPermissionResult describeDocumentPermission(DescribeDocumentPermissionRequest describeDocumentPermissionRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeDocumentPermissionRequestMarshaller().marshall(describeDocumentPermissionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeDocumentPermissionResult> responseHandler = new JsonResponseHandler<DescribeDocumentPermissionResult>(unmarshaller);
     ...
     * @return describeEffectiveInstanceAssociationsResult The response from the DescribeEffectiveInstanceAssociations service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidInstanceIdException 
     * @throws InvalidNextTokenException 
     * @throws AmazonClientException
    ...
    public DescribeEffectiveInstanceAssociationsResult describeEffectiveInstanceAssociations(DescribeEffectiveInstanceAssociationsRequest describeEffectiveInstanceAssociationsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeEffectiveInstanceAssociationsRequestMarshaller().marshall(describeEffectiveInstanceAssociationsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeEffectiveInstanceAssociationsResult> responseHandler = new JsonResponseHandler<DescribeEffectiveInstanceAssociationsResult>(unmarshaller);
     ...
     * @return describeEffectivePatchesForPatchBaselineResult The response from the DescribeEffectivePatchesForPatchBaseline service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InvalidResourceIdException 
     * @throws DoesNotExistException 
    ...
    public DescribeEffectivePatchesForPatchBaselineResult describeEffectivePatchesForPatchBaseline(DescribeEffectivePatchesForPatchBaselineRequest describeEffectivePatchesForPatchBaselineRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeEffectivePatchesForPatchBaselineRequestMarshaller().marshall(describeEffectivePatchesForPatchBaselineRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeEffectivePatchesForPatchBaselineResult> responseHandler = new JsonResponseHandler<DescribeEffectivePatchesForPatchBaselineResult>(unmarshaller);
     ...
     * @return describeInstanceAssociationsStatusResult The response from the DescribeInstanceAssociationsStatus service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidInstanceIdException 
     * @throws InvalidNextTokenException 
     * @throws AmazonClientException
    ...
    public DescribeInstanceAssociationsStatusResult describeInstanceAssociationsStatus(DescribeInstanceAssociationsStatusRequest describeInstanceAssociationsStatusRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeInstanceAssociationsStatusRequestMarshaller().marshall(describeInstanceAssociationsStatusRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeInstanceAssociationsStatusResult> responseHandler = new JsonResponseHandler<DescribeInstanceAssociationsStatusResult>(unmarshaller);
     ...
     * @return describeInstanceInformationResult The response from the DescribeInstanceInformation service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidInstanceIdException 
     * @throws InvalidNextTokenException 
    ...
    public DescribeInstanceInformationResult describeInstanceInformation(DescribeInstanceInformationRequest describeInstanceInformationRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeInstanceInformationRequestMarshaller().marshall(describeInstanceInformationRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeInstanceInformationResult> responseHandler = new JsonResponseHandler<DescribeInstanceInformationResult>(unmarshaller);
     ...
     * @return describeInstancePatchStatesResult The response from the DescribeInstancePatchStates service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidNextTokenException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public DescribeInstancePatchStatesResult describeInstancePatchStates(DescribeInstancePatchStatesRequest describeInstancePatchStatesRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeInstancePatchStatesRequestMarshaller().marshall(describeInstancePatchStatesRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeInstancePatchStatesResult> responseHandler = new JsonResponseHandler<DescribeInstancePatchStatesResult>(unmarshaller);
     ...
     * @return describeInstancePatchStatesForPatchGroupResult The response from the DescribeInstancePatchStatesForPatchGroup service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidFilterException 
     * @throws InvalidNextTokenException 
     * @throws AmazonClientException
    ...
    public DescribeInstancePatchStatesForPatchGroupResult describeInstancePatchStatesForPatchGroup(DescribeInstancePatchStatesForPatchGroupRequest describeInstancePatchStatesForPatchGroupRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeInstancePatchStatesForPatchGroupRequestMarshaller().marshall(describeInstancePatchStatesForPatchGroupRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeInstancePatchStatesForPatchGroupResult> responseHandler = new JsonResponseHandler<DescribeInstancePatchStatesForPatchGroupResult>(unmarshaller);
     ...
     * @return describeInstancePatchesResult The response from the DescribeInstancePatches service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidInstanceIdException 
     * @throws InvalidFilterException 
     * @throws InvalidNextTokenException 
    ...
    public DescribeInstancePatchesResult describeInstancePatches(DescribeInstancePatchesRequest describeInstancePatchesRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeInstancePatchesRequestMarshaller().marshall(describeInstancePatchesRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeInstancePatchesResult> responseHandler = new JsonResponseHandler<DescribeInstancePatchesResult>(unmarshaller);
     ...
     * @return describeInventoryDeletionsResult The response from the DescribeInventoryDeletions service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
    ...
    public DescribeInventoryDeletionsResult describeInventoryDeletions(DescribeInventoryDeletionsRequest describeInventoryDeletionsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeInventoryDeletionsRequestMarshaller().marshall(describeInventoryDeletionsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeInventoryDeletionsResult> responseHandler = new JsonResponseHandler<DescribeInventoryDeletionsResult>(unmarshaller);
     ...
     * @return describeMaintenanceWindowExecutionTaskInvocationsResult The response from the DescribeMaintenanceWindowExecutionTaskInvocations service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public DescribeMaintenanceWindowExecutionTaskInvocationsResult describeMaintenanceWindowExecutionTaskInvocations(DescribeMaintenanceWindowExecutionTaskInvocationsRequest describeMaintenanceWindowExecutionTaskInvocationsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeMaintenanceWindowExecutionTaskInvocationsRequestMarshaller().marshall(describeMaintenanceWindowExecutionTaskInvocationsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeMaintenanceWindowExecutionTaskInvocationsResult> responseHandler = new JsonResponseHandler<DescribeMaintenanceWindowExecutionTaskInvocationsResult>(unmarshaller);
     ...
     * @return describeMaintenanceWindowExecutionTasksResult The response from the DescribeMaintenanceWindowExecutionTasks service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public DescribeMaintenanceWindowExecutionTasksResult describeMaintenanceWindowExecutionTasks(DescribeMaintenanceWindowExecutionTasksRequest describeMaintenanceWindowExecutionTasksRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeMaintenanceWindowExecutionTasksRequestMarshaller().marshall(describeMaintenanceWindowExecutionTasksRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeMaintenanceWindowExecutionTasksResult> responseHandler = new JsonResponseHandler<DescribeMaintenanceWindowExecutionTasksResult>(unmarshaller);
     ...
     * @return describeMaintenanceWindowExecutionsResult The response from the DescribeMaintenanceWindowExecutions service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
    ...
    public DescribeMaintenanceWindowExecutionsResult describeMaintenanceWindowExecutions(DescribeMaintenanceWindowExecutionsRequest describeMaintenanceWindowExecutionsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeMaintenanceWindowExecutionsRequestMarshaller().marshall(describeMaintenanceWindowExecutionsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeMaintenanceWindowExecutionsResult> responseHandler = new JsonResponseHandler<DescribeMaintenanceWindowExecutionsResult>(unmarshaller);
     ...
     * @return describeMaintenanceWindowScheduleResult The response from the DescribeMaintenanceWindowSchedule service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws DoesNotExistException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public DescribeMaintenanceWindowScheduleResult describeMaintenanceWindowSchedule(DescribeMaintenanceWindowScheduleRequest describeMaintenanceWindowScheduleRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeMaintenanceWindowScheduleRequestMarshaller().marshall(describeMaintenanceWindowScheduleRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeMaintenanceWindowScheduleResult> responseHandler = new JsonResponseHandler<DescribeMaintenanceWindowScheduleResult>(unmarshaller);
     ...
     * @return describeMaintenanceWindowTargetsResult The response from the DescribeMaintenanceWindowTargets service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public DescribeMaintenanceWindowTargetsResult describeMaintenanceWindowTargets(DescribeMaintenanceWindowTargetsRequest describeMaintenanceWindowTargetsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeMaintenanceWindowTargetsRequestMarshaller().marshall(describeMaintenanceWindowTargetsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeMaintenanceWindowTargetsResult> responseHandler = new JsonResponseHandler<DescribeMaintenanceWindowTargetsResult>(unmarshaller);
     ...
     * @return describeMaintenanceWindowTasksResult The response from the DescribeMaintenanceWindowTasks service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public DescribeMaintenanceWindowTasksResult describeMaintenanceWindowTasks(DescribeMaintenanceWindowTasksRequest describeMaintenanceWindowTasksRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeMaintenanceWindowTasksRequestMarshaller().marshall(describeMaintenanceWindowTasksRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeMaintenanceWindowTasksResult> responseHandler = new JsonResponseHandler<DescribeMaintenanceWindowTasksResult>(unmarshaller);
     ...
     * @return describeMaintenanceWindowsResult The response from the DescribeMaintenanceWindows service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
    ...
    public DescribeMaintenanceWindowsResult describeMaintenanceWindows(DescribeMaintenanceWindowsRequest describeMaintenanceWindowsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeMaintenanceWindowsRequestMarshaller().marshall(describeMaintenanceWindowsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeMaintenanceWindowsResult> responseHandler = new JsonResponseHandler<DescribeMaintenanceWindowsResult>(unmarshaller);
     ...
     * @return describeMaintenanceWindowsForTargetResult The response from the DescribeMaintenanceWindowsForTarget service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
    ...
    public DescribeMaintenanceWindowsForTargetResult describeMaintenanceWindowsForTarget(DescribeMaintenanceWindowsForTargetRequest describeMaintenanceWindowsForTargetRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeMaintenanceWindowsForTargetRequestMarshaller().marshall(describeMaintenanceWindowsForTargetRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeMaintenanceWindowsForTargetResult> responseHandler = new JsonResponseHandler<DescribeMaintenanceWindowsForTargetResult>(unmarshaller);
     ...
     * @return describeOpsItemsResult The response from the DescribeOpsItems service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
    ...
    public DescribeOpsItemsResult describeOpsItems(DescribeOpsItemsRequest describeOpsItemsRequest)
        ...
        try {
            ...
            JsonResponseHandler<DescribeOpsItemsResult> responseHandler = new JsonResponseHandler<DescribeOpsItemsResult>(unmarshaller);
     ...
     * @return describeParametersResult The response from the DescribeParameters service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidFilterKeyException 
    ...
    public DescribeParametersResult describeParameters(DescribeParametersRequest describeParametersRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeParametersRequestMarshaller().marshall(describeParametersRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeParametersResult> responseHandler = new JsonResponseHandler<DescribeParametersResult>(unmarshaller);
     ...
     * @return describePatchBaselinesResult The response from the DescribePatchBaselines service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
    ...
    public DescribePatchBaselinesResult describePatchBaselines(DescribePatchBaselinesRequest describePatchBaselinesRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribePatchBaselinesRequestMarshaller().marshall(describePatchBaselinesRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribePatchBaselinesResult> responseHandler = new JsonResponseHandler<DescribePatchBaselinesResult>(unmarshaller);
     ...
     * @return describePatchGroupStateResult The response from the DescribePatchGroupState service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidNextTokenException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public DescribePatchGroupStateResult describePatchGroupState(DescribePatchGroupStateRequest describePatchGroupStateRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribePatchGroupStateRequestMarshaller().marshall(describePatchGroupStateRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribePatchGroupStateResult> responseHandler = new JsonResponseHandler<DescribePatchGroupStateResult>(unmarshaller);
     ...
     * @return describePatchGroupsResult The response from the DescribePatchGroups service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
    ...
    public DescribePatchGroupsResult describePatchGroups(DescribePatchGroupsRequest describePatchGroupsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribePatchGroupsRequestMarshaller().marshall(describePatchGroupsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribePatchGroupsResult> responseHandler = new JsonResponseHandler<DescribePatchGroupsResult>(unmarshaller);
     ...
     * @return describePatchPropertiesResult The response from the DescribePatchProperties service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
    ...
    public DescribePatchPropertiesResult describePatchProperties(DescribePatchPropertiesRequest describePatchPropertiesRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribePatchPropertiesRequestMarshaller().marshall(describePatchPropertiesRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribePatchPropertiesResult> responseHandler = new JsonResponseHandler<DescribePatchPropertiesResult>(unmarshaller);
     ...
     * @return describeSessionsResult The response from the DescribeSessions service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidFilterKeyException 
     * @throws InvalidNextTokenException 
     * @throws AmazonClientException
    ...
    public DescribeSessionsResult describeSessions(DescribeSessionsRequest describeSessionsRequest)
        ...
        try {
            ...
            JsonResponseHandler<DescribeSessionsResult> responseHandler = new JsonResponseHandler<DescribeSessionsResult>(unmarshaller);
     ...
     * @return getAutomationExecutionResult The response from the GetAutomationExecution service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws AutomationExecutionNotFoundException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public GetAutomationExecutionResult getAutomationExecution(GetAutomationExecutionRequest getAutomationExecutionRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetAutomationExecutionRequestMarshaller().marshall(getAutomationExecutionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetAutomationExecutionResult> responseHandler = new JsonResponseHandler<GetAutomationExecutionResult>(unmarshaller);
     ...
     * @return getCalendarStateResult The response from the GetCalendarState service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidDocumentException 
    ...
    public GetCalendarStateResult getCalendarState(GetCalendarStateRequest getCalendarStateRequest)
        ...
        try {
            ...
            JsonResponseHandler<GetCalendarStateResult> responseHandler = new JsonResponseHandler<GetCalendarStateResult>(unmarshaller);
     ...
     * @return getCommandInvocationResult The response from the GetCommandInvocation service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidCommandIdException 
     * @throws InvalidInstanceIdException 
    ...
    public GetCommandInvocationResult getCommandInvocation(GetCommandInvocationRequest getCommandInvocationRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetCommandInvocationRequestMarshaller().marshall(getCommandInvocationRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetCommandInvocationResult> responseHandler = new JsonResponseHandler<GetCommandInvocationResult>(unmarshaller);
     ...
     * @return getConnectionStatusResult The response from the GetConnectionStatus service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
    ...
    public GetConnectionStatusResult getConnectionStatus(GetConnectionStatusRequest getConnectionStatusRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetConnectionStatusRequestMarshaller().marshall(getConnectionStatusRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetConnectionStatusResult> responseHandler = new JsonResponseHandler<GetConnectionStatusResult>(unmarshaller);
     ...
     * @return getDefaultPatchBaselineResult The response from the GetDefaultPatchBaseline service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
    ...
    public GetDefaultPatchBaselineResult getDefaultPatchBaseline(GetDefaultPatchBaselineRequest getDefaultPatchBaselineRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetDefaultPatchBaselineRequestMarshaller().marshall(getDefaultPatchBaselineRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetDefaultPatchBaselineResult> responseHandler = new JsonResponseHandler<GetDefaultPatchBaselineResult>(unmarshaller);
     ...
     * @return getDeployablePatchSnapshotForInstanceResult The response from the GetDeployablePatchSnapshotForInstance service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws UnsupportedOperatingSystemException 
    ...
    public GetDeployablePatchSnapshotForInstanceResult getDeployablePatchSnapshotForInstance(GetDeployablePatchSnapshotForInstanceRequest getDeployablePatchSnapshotForInstanceRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetDeployablePatchSnapshotForInstanceRequestMarshaller().marshall(getDeployablePatchSnapshotForInstanceRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetDeployablePatchSnapshotForInstanceResult> responseHandler = new JsonResponseHandler<GetDeployablePatchSnapshotForInstanceResult>(unmarshaller);
     ...
     * @return getDocumentResult The response from the GetDocument service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidDocumentException 
     * @throws InvalidDocumentVersionException 
     * @throws AmazonClientException
    ...
    public GetDocumentResult getDocument(GetDocumentRequest getDocumentRequest)
        ...
        try {
            ...
            JsonResponseHandler<GetDocumentResult> responseHandler = new JsonResponseHandler<GetDocumentResult>(unmarshaller);
     ...
     * @return getInventoryResult The response from the GetInventory service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidFilterException 
    ...
    public GetInventoryResult getInventory(GetInventoryRequest getInventoryRequest)
        ...
        try {
            ...
            JsonResponseHandler<GetInventoryResult> responseHandler = new JsonResponseHandler<GetInventoryResult>(unmarshaller);
     ...
     * @return getInventorySchemaResult The response from the GetInventorySchema service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidTypeNameException 
     * @throws InvalidNextTokenException 
     * @throws AmazonClientException
    ...
    public GetInventorySchemaResult getInventorySchema(GetInventorySchemaRequest getInventorySchemaRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetInventorySchemaRequestMarshaller().marshall(getInventorySchemaRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetInventorySchemaResult> responseHandler = new JsonResponseHandler<GetInventorySchemaResult>(unmarshaller);
     ...
     * @return getMaintenanceWindowResult The response from the GetMaintenanceWindow service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public GetMaintenanceWindowResult getMaintenanceWindow(GetMaintenanceWindowRequest getMaintenanceWindowRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetMaintenanceWindowRequestMarshaller().marshall(getMaintenanceWindowRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetMaintenanceWindowResult> responseHandler = new JsonResponseHandler<GetMaintenanceWindowResult>(unmarshaller);
     ...
     * @return getMaintenanceWindowExecutionResult The response from the GetMaintenanceWindowExecution service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public GetMaintenanceWindowExecutionResult getMaintenanceWindowExecution(GetMaintenanceWindowExecutionRequest getMaintenanceWindowExecutionRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetMaintenanceWindowExecutionRequestMarshaller().marshall(getMaintenanceWindowExecutionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetMaintenanceWindowExecutionResult> responseHandler = new JsonResponseHandler<GetMaintenanceWindowExecutionResult>(unmarshaller);
     ...
     * @return getMaintenanceWindowExecutionTaskResult The response from the GetMaintenanceWindowExecutionTask service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public GetMaintenanceWindowExecutionTaskResult getMaintenanceWindowExecutionTask(GetMaintenanceWindowExecutionTaskRequest getMaintenanceWindowExecutionTaskRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetMaintenanceWindowExecutionTaskRequestMarshaller().marshall(getMaintenanceWindowExecutionTaskRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetMaintenanceWindowExecutionTaskResult> responseHandler = new JsonResponseHandler<GetMaintenanceWindowExecutionTaskResult>(unmarshaller);
     ...
     * @return getMaintenanceWindowExecutionTaskInvocationResult The response from the GetMaintenanceWindowExecutionTaskInvocation service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public GetMaintenanceWindowExecutionTaskInvocationResult getMaintenanceWindowExecutionTaskInvocation(GetMaintenanceWindowExecutionTaskInvocationRequest getMaintenanceWindowExecutionTaskInvocationRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetMaintenanceWindowExecutionTaskInvocationRequestMarshaller().marshall(getMaintenanceWindowExecutionTaskInvocationRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetMaintenanceWindowExecutionTaskInvocationResult> responseHandler = new JsonResponseHandler<GetMaintenanceWindowExecutionTaskInvocationResult>(unmarshaller);
     ...
     * @return getMaintenanceWindowTaskResult The response from the GetMaintenanceWindowTask service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public GetMaintenanceWindowTaskResult getMaintenanceWindowTask(GetMaintenanceWindowTaskRequest getMaintenanceWindowTaskRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetMaintenanceWindowTaskRequestMarshaller().marshall(getMaintenanceWindowTaskRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetMaintenanceWindowTaskResult> responseHandler = new JsonResponseHandler<GetMaintenanceWindowTaskResult>(unmarshaller);
     ...
     * @return getOpsItemResult The response from the GetOpsItem service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
    ...
    public GetOpsItemResult getOpsItem(GetOpsItemRequest getOpsItemRequest)
        ...
        try {
            ...
            JsonResponseHandler<GetOpsItemResult> responseHandler = new JsonResponseHandler<GetOpsItemResult>(unmarshaller);
     ...
     * @return getOpsSummaryResult The response from the GetOpsSummary service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws ResourceDataSyncNotFoundException 
     * @throws InvalidFilterException 
     * @throws InvalidNextTokenException 
    ...
    public GetOpsSummaryResult getOpsSummary(GetOpsSummaryRequest getOpsSummaryRequest)
        ...
        try {
            ...
            JsonResponseHandler<GetOpsSummaryResult> responseHandler = new JsonResponseHandler<GetOpsSummaryResult>(unmarshaller);
     ...
     * @return getParameterResult The response from the GetParameter service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
    ...
    public GetParameterResult getParameter(GetParameterRequest getParameterRequest)
        ...
        try {
            ...
            JsonResponseHandler<GetParameterResult> responseHandler = new JsonResponseHandler<GetParameterResult>(unmarshaller);
     ...
     * @return getParameterHistoryResult The response from the GetParameterHistory service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws ParameterNotFoundException 
     * @throws InvalidNextTokenException 
     * @throws InvalidKeyIdException 
    ...
    public GetParameterHistoryResult getParameterHistory(GetParameterHistoryRequest getParameterHistoryRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetParameterHistoryRequestMarshaller().marshall(getParameterHistoryRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetParameterHistoryResult> responseHandler = new JsonResponseHandler<GetParameterHistoryResult>(unmarshaller);
     ...
     * @return getParametersResult The response from the GetParameters service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InvalidKeyIdException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public GetParametersResult getParameters(GetParametersRequest getParametersRequest)
        ...
        try {
            ...
            JsonResponseHandler<GetParametersResult> responseHandler = new JsonResponseHandler<GetParametersResult>(unmarshaller);
     ...
     * @return getParametersByPathResult The response from the GetParametersByPath service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidFilterKeyException 
     * @throws InvalidFilterOptionException 
     * @throws InvalidFilterValueException 
    ...
    public GetParametersByPathResult getParametersByPath(GetParametersByPathRequest getParametersByPathRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetParametersByPathRequestMarshaller().marshall(getParametersByPathRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetParametersByPathResult> responseHandler = new JsonResponseHandler<GetParametersByPathResult>(unmarshaller);
     ...
     * @return getPatchBaselineResult The response from the GetPatchBaseline service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InvalidResourceIdException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
    ...
    public GetPatchBaselineResult getPatchBaseline(GetPatchBaselineRequest getPatchBaselineRequest)
        ...
        try {
            ...
            JsonResponseHandler<GetPatchBaselineResult> responseHandler = new JsonResponseHandler<GetPatchBaselineResult>(unmarshaller);
     ...
     * @return getPatchBaselineForPatchGroupResult The response from the GetPatchBaselineForPatchGroup service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
    ...
    public GetPatchBaselineForPatchGroupResult getPatchBaselineForPatchGroup(GetPatchBaselineForPatchGroupRequest getPatchBaselineForPatchGroupRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetPatchBaselineForPatchGroupRequestMarshaller().marshall(getPatchBaselineForPatchGroupRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetPatchBaselineForPatchGroupResult> responseHandler = new JsonResponseHandler<GetPatchBaselineForPatchGroupResult>(unmarshaller);
     ...
     * @param getServiceSettingRequest <p>The request body of the GetServiceSetting API action.</p>
     * @return getServiceSettingResult The response from the GetServiceSetting service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
    ...
    public GetServiceSettingResult getServiceSetting(GetServiceSettingRequest getServiceSettingRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetServiceSettingRequestMarshaller().marshall(getServiceSettingRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<GetServiceSettingResult> responseHandler = new JsonResponseHandler<GetServiceSettingResult>(unmarshaller);
     ...
     * @return labelParameterVersionResult The response from the LabelParameterVersion service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws TooManyUpdatesException 
     * @throws ParameterNotFoundException 
     * @throws ParameterVersionNotFoundException 
    ...
    public LabelParameterVersionResult labelParameterVersion(LabelParameterVersionRequest labelParameterVersionRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new LabelParameterVersionRequestMarshaller().marshall(labelParameterVersionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<LabelParameterVersionResult> responseHandler = new JsonResponseHandler<LabelParameterVersionResult>(unmarshaller);
     ...
     * @return listAssociationVersionsResult The response from the ListAssociationVersions service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidNextTokenException 
     * @throws AssociationDoesNotExistException 
     * @throws AmazonClientException
    ...
    public ListAssociationVersionsResult listAssociationVersions(ListAssociationVersionsRequest listAssociationVersionsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListAssociationVersionsRequestMarshaller().marshall(listAssociationVersionsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ListAssociationVersionsResult> responseHandler = new JsonResponseHandler<ListAssociationVersionsResult>(unmarshaller);
     ...
     * @return listAssociationsResult The response from the ListAssociations service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidNextTokenException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public ListAssociationsResult listAssociations(ListAssociationsRequest listAssociationsRequest)
        ...
        try {
            ...
            JsonResponseHandler<ListAssociationsResult> responseHandler = new JsonResponseHandler<ListAssociationsResult>(unmarshaller);
     ...
     * @return listCommandInvocationsResult The response from the ListCommandInvocations service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidCommandIdException 
     * @throws InvalidInstanceIdException 
     * @throws InvalidFilterKeyException 
    ...
    public ListCommandInvocationsResult listCommandInvocations(ListCommandInvocationsRequest listCommandInvocationsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListCommandInvocationsRequestMarshaller().marshall(listCommandInvocationsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ListCommandInvocationsResult> responseHandler = new JsonResponseHandler<ListCommandInvocationsResult>(unmarshaller);
     ...
     * @return listCommandsResult The response from the ListCommands service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidCommandIdException 
     * @throws InvalidInstanceIdException 
     * @throws InvalidFilterKeyException 
    ...
    public ListCommandsResult listCommands(ListCommandsRequest listCommandsRequest)
        ...
        try {
            ...
            JsonResponseHandler<ListCommandsResult> responseHandler = new JsonResponseHandler<ListCommandsResult>(unmarshaller);
     ...
     * @return listComplianceItemsResult The response from the ListComplianceItems service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InvalidResourceTypeException 
     * @throws InvalidResourceIdException 
     * @throws InternalServerErrorException 
     * @throws InvalidFilterException 
    ...
    public ListComplianceItemsResult listComplianceItems(ListComplianceItemsRequest listComplianceItemsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListComplianceItemsRequestMarshaller().marshall(listComplianceItemsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ListComplianceItemsResult> responseHandler = new JsonResponseHandler<ListComplianceItemsResult>(unmarshaller);
     ...
     * @return listComplianceSummariesResult The response from the ListComplianceSummaries service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InvalidFilterException 
     * @throws InvalidNextTokenException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
    ...
    public ListComplianceSummariesResult listComplianceSummaries(ListComplianceSummariesRequest listComplianceSummariesRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListComplianceSummariesRequestMarshaller().marshall(listComplianceSummariesRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ListComplianceSummariesResult> responseHandler = new JsonResponseHandler<ListComplianceSummariesResult>(unmarshaller);
     ...
     * @return listDocumentVersionsResult The response from the ListDocumentVersions service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidNextTokenException 
     * @throws InvalidDocumentException 
     * @throws AmazonClientException
    ...
    public ListDocumentVersionsResult listDocumentVersions(ListDocumentVersionsRequest listDocumentVersionsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListDocumentVersionsRequestMarshaller().marshall(listDocumentVersionsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ListDocumentVersionsResult> responseHandler = new JsonResponseHandler<ListDocumentVersionsResult>(unmarshaller);
     ...
     * @return listDocumentsResult The response from the ListDocuments service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidNextTokenException 
     * @throws InvalidFilterKeyException 
     * @throws AmazonClientException
    ...
    public ListDocumentsResult listDocuments(ListDocumentsRequest listDocumentsRequest)
        ...
        try {
            ...
            JsonResponseHandler<ListDocumentsResult> responseHandler = new JsonResponseHandler<ListDocumentsResult>(unmarshaller);
     ...
     * @return listInventoryEntriesResult The response from the ListInventoryEntries service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidInstanceIdException 
     * @throws InvalidTypeNameException 
     * @throws InvalidFilterException 
    ...
    public ListInventoryEntriesResult listInventoryEntries(ListInventoryEntriesRequest listInventoryEntriesRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListInventoryEntriesRequestMarshaller().marshall(listInventoryEntriesRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ListInventoryEntriesResult> responseHandler = new JsonResponseHandler<ListInventoryEntriesResult>(unmarshaller);
     ...
     * @return listResourceComplianceSummariesResult The response from the ListResourceComplianceSummaries service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InvalidFilterException 
     * @throws InvalidNextTokenException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
    ...
    public ListResourceComplianceSummariesResult listResourceComplianceSummaries(ListResourceComplianceSummariesRequest listResourceComplianceSummariesRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListResourceComplianceSummariesRequestMarshaller().marshall(listResourceComplianceSummariesRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ListResourceComplianceSummariesResult> responseHandler = new JsonResponseHandler<ListResourceComplianceSummariesResult>(unmarshaller);
     ...
     * @return listResourceDataSyncResult The response from the ListResourceDataSync service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws ResourceDataSyncInvalidConfigurationException 
     * @throws InternalServerErrorException 
     * @throws InvalidNextTokenException 
     * @throws AmazonClientException
    ...
    public ListResourceDataSyncResult listResourceDataSync(ListResourceDataSyncRequest listResourceDataSyncRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListResourceDataSyncRequestMarshaller().marshall(listResourceDataSyncRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ListResourceDataSyncResult> responseHandler = new JsonResponseHandler<ListResourceDataSyncResult>(unmarshaller);
     ...
     * @return listTagsForResourceResult The response from the ListTagsForResource service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InvalidResourceTypeException 
     * @throws InvalidResourceIdException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     ...
     * @return modifyDocumentPermissionResult The response from the ModifyDocumentPermission service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidDocumentException 
     * @throws InvalidPermissionTypeException 
    ...
    public ModifyDocumentPermissionResult modifyDocumentPermission(ModifyDocumentPermissionRequest modifyDocumentPermissionRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ModifyDocumentPermissionRequestMarshaller().marshall(modifyDocumentPermissionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ModifyDocumentPermissionResult> responseHandler = new JsonResponseHandler<ModifyDocumentPermissionResult>(unmarshaller);
     ...
     * @return putComplianceItemsResult The response from the PutComplianceItems service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
    ...
    public PutComplianceItemsResult putComplianceItems(PutComplianceItemsRequest putComplianceItemsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new PutComplianceItemsRequestMarshaller().marshall(putComplianceItemsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<PutComplianceItemsResult> responseHandler = new JsonResponseHandler<PutComplianceItemsResult>(unmarshaller);
     ...
     * @return putInventoryResult The response from the PutInventory service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidInstanceIdException 
     * @throws InvalidTypeNameException 
     * @throws InvalidItemContentException 
    ...
    public PutInventoryResult putInventory(PutInventoryRequest putInventoryRequest)
        ...
        try {
            ...
            JsonResponseHandler<PutInventoryResult> responseHandler = new JsonResponseHandler<PutInventoryResult>(unmarshaller);
     ...
     * @return putParameterResult The response from the PutParameter service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidKeyIdException 
    ...
    public PutParameterResult putParameter(PutParameterRequest putParameterRequest)
        ...
        try {
            ...
            JsonResponseHandler<PutParameterResult> responseHandler = new JsonResponseHandler<PutParameterResult>(unmarshaller);
     ...
     * @return registerDefaultPatchBaselineResult The response from the RegisterDefaultPatchBaseline service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InvalidResourceIdException 
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
    ...
    public RegisterDefaultPatchBaselineResult registerDefaultPatchBaseline(RegisterDefaultPatchBaselineRequest registerDefaultPatchBaselineRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new RegisterDefaultPatchBaselineRequestMarshaller().marshall(registerDefaultPatchBaselineRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<RegisterDefaultPatchBaselineResult> responseHandler = new JsonResponseHandler<RegisterDefaultPatchBaselineResult>(unmarshaller);
     ...
     * @return registerPatchBaselineForPatchGroupResult The response from the RegisterPatchBaselineForPatchGroup service method, as returned by Amazon Simple Systems Manager (SSM).
    ...
    public RegisterPatchBaselineForPatchGroupResult registerPatchBaselineForPatchGroup(RegisterPatchBaselineForPatchGroupRequest registerPatchBaselineForPatchGroupRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new RegisterPatchBaselineForPatchGroupRequestMarshaller().marshall(registerPatchBaselineForPatchGroupRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<RegisterPatchBaselineForPatchGroupResult> responseHandler = new JsonResponseHandler<RegisterPatchBaselineForPatchGroupResult>(unmarshaller);
     ...
     * @return registerTargetWithMaintenanceWindowResult The response from the RegisterTargetWithMaintenanceWindow service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws IdempotentParameterMismatchException 
     * @throws DoesNotExistException 
     * @throws ResourceLimitExceededException 
     * @throws InternalServerErrorException 
    ...
    public RegisterTargetWithMaintenanceWindowResult registerTargetWithMaintenanceWindow(RegisterTargetWithMaintenanceWindowRequest registerTargetWithMaintenanceWindowRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new RegisterTargetWithMaintenanceWindowRequestMarshaller().marshall(registerTargetWithMaintenanceWindowRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<RegisterTargetWithMaintenanceWindowResult> responseHandler = new JsonResponseHandler<RegisterTargetWithMaintenanceWindowResult>(unmarshaller);
     ...
     * @return registerTaskWithMaintenanceWindowResult The response from the RegisterTaskWithMaintenanceWindow service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws IdempotentParameterMismatchException 
     * @throws DoesNotExistException 
     * @throws ResourceLimitExceededException 
    ...
    public RegisterTaskWithMaintenanceWindowResult registerTaskWithMaintenanceWindow(RegisterTaskWithMaintenanceWindowRequest registerTaskWithMaintenanceWindowRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new RegisterTaskWithMaintenanceWindowRequestMarshaller().marshall(registerTaskWithMaintenanceWindowRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<RegisterTaskWithMaintenanceWindowResult> responseHandler = new JsonResponseHandler<RegisterTaskWithMaintenanceWindowResult>(unmarshaller);
     ...
     * @return removeTagsFromResourceResult The response from the RemoveTagsFromResource service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InvalidResourceTypeException 
     * @throws InvalidResourceIdException 
     * @throws InternalServerErrorException 
     * @throws TooManyUpdatesException 
    ...
    public RemoveTagsFromResourceResult removeTagsFromResource(RemoveTagsFromResourceRequest removeTagsFromResourceRequest)
        ...
        try {
            ...
            JsonResponseHandler<RemoveTagsFromResourceResult> responseHandler = new JsonResponseHandler<RemoveTagsFromResourceResult>(unmarshaller);
     ...
     * @param resetServiceSettingRequest <p>The request body of the ResetServiceSetting API action.</p>
     * @return resetServiceSettingResult The response from the ResetServiceSetting service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws ServiceSettingNotFoundException 
     * @throws TooManyUpdatesException 
     * @throws AmazonClientException
    ...
    public ResetServiceSettingResult resetServiceSetting(ResetServiceSettingRequest resetServiceSettingRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ResetServiceSettingRequestMarshaller().marshall(resetServiceSettingRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ResetServiceSettingResult> responseHandler = new JsonResponseHandler<ResetServiceSettingResult>(unmarshaller);
     ...
     * @return resumeSessionResult The response from the ResumeSession service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public ResumeSessionResult resumeSession(ResumeSessionRequest resumeSessionRequest)
        ...
        try {
            ...
            JsonResponseHandler<ResumeSessionResult> responseHandler = new JsonResponseHandler<ResumeSessionResult>(unmarshaller);
     ...
     * @return sendAutomationSignalResult The response from the SendAutomationSignal service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws AutomationExecutionNotFoundException 
    ...
    public SendAutomationSignalResult sendAutomationSignal(SendAutomationSignalRequest sendAutomationSignalRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new SendAutomationSignalRequestMarshaller().marshall(sendAutomationSignalRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<SendAutomationSignalResult> responseHandler = new JsonResponseHandler<SendAutomationSignalResult>(unmarshaller);
     ...
     * @return sendCommandResult The response from the SendCommand service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DuplicateInstanceIdException 
     * @throws InternalServerErrorException 
     * @throws InvalidInstanceIdException 
     * @throws InvalidDocumentException 
    ...
    public SendCommandResult sendCommand(SendCommandRequest sendCommandRequest)
        ...
        try {
            ...
            JsonResponseHandler<SendCommandResult> responseHandler = new JsonResponseHandler<SendCommandResult>(unmarshaller);
     ...
     * @return startAssociationsOnceResult The response from the StartAssociationsOnce service method, as returned by Amazon Simple Systems Manager (SSM).
    ...
    public StartAssociationsOnceResult startAssociationsOnce(StartAssociationsOnceRequest startAssociationsOnceRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new StartAssociationsOnceRequestMarshaller().marshall(startAssociationsOnceRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<StartAssociationsOnceResult> responseHandler = new JsonResponseHandler<StartAssociationsOnceResult>(unmarshaller);
     ...
     * @return startAutomationExecutionResult The response from the StartAutomationExecution service method, as returned by Amazon Simple Systems Manager (SSM).
    ...
    public StartAutomationExecutionResult startAutomationExecution(StartAutomationExecutionRequest startAutomationExecutionRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new StartAutomationExecutionRequestMarshaller().marshall(startAutomationExecutionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<StartAutomationExecutionResult> responseHandler = new JsonResponseHandler<StartAutomationExecutionResult>(unmarshaller);
     ...
     * @return startSessionResult The response from the StartSession service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InvalidDocumentException 
    ...
    public StartSessionResult startSession(StartSessionRequest startSessionRequest)
        ...
        try {
            ...
            JsonResponseHandler<StartSessionResult> responseHandler = new JsonResponseHandler<StartSessionResult>(unmarshaller);
     ...
     * @return stopAutomationExecutionResult The response from the StopAutomationExecution service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws AutomationExecutionNotFoundException 
    ...
    public StopAutomationExecutionResult stopAutomationExecution(StopAutomationExecutionRequest stopAutomationExecutionRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new StopAutomationExecutionRequestMarshaller().marshall(stopAutomationExecutionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<StopAutomationExecutionResult> responseHandler = new JsonResponseHandler<StopAutomationExecutionResult>(unmarshaller);
     ...
     * @return terminateSessionResult The response from the TerminateSession service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public TerminateSessionResult terminateSession(TerminateSessionRequest terminateSessionRequest)
        ...
        try {
            ...
            JsonResponseHandler<TerminateSessionResult> responseHandler = new JsonResponseHandler<TerminateSessionResult>(unmarshaller);
     ...
     * @return updateAssociationResult The response from the UpdateAssociation service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidScheduleException 
     * @throws InvalidParametersException 
     * @throws InvalidOutputLocationException 
    ...
    public UpdateAssociationResult updateAssociation(UpdateAssociationRequest updateAssociationRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new UpdateAssociationRequestMarshaller().marshall(updateAssociationRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<UpdateAssociationResult> responseHandler = new JsonResponseHandler<UpdateAssociationResult>(unmarshaller);
     ...
     * @return updateAssociationStatusResult The response from the UpdateAssociationStatus service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidInstanceIdException 
     * @throws InvalidDocumentException 
     * @throws AssociationDoesNotExistException 
    ...
    public UpdateAssociationStatusResult updateAssociationStatus(UpdateAssociationStatusRequest updateAssociationStatusRequest)
        ...
        try {
            ...
            JsonResponseHandler<UpdateAssociationStatusResult> responseHandler = new JsonResponseHandler<UpdateAssociationStatusResult>(unmarshaller);
     ...
     * @return updateDocumentResult The response from the UpdateDocument service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws MaxDocumentSizeExceededException 
    ...
    public UpdateDocumentResult updateDocument(UpdateDocumentRequest updateDocumentRequest)
        ...
        try {
            ...
            JsonResponseHandler<UpdateDocumentResult> responseHandler = new JsonResponseHandler<UpdateDocumentResult>(unmarshaller);
     ...
     * @return updateDocumentDefaultVersionResult The response from the UpdateDocumentDefaultVersion service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws InvalidDocumentException 
     * @throws InvalidDocumentVersionException 
     * @throws InvalidDocumentSchemaVersionException 
    ...
    public UpdateDocumentDefaultVersionResult updateDocumentDefaultVersion(UpdateDocumentDefaultVersionRequest updateDocumentDefaultVersionRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new UpdateDocumentDefaultVersionRequestMarshaller().marshall(updateDocumentDefaultVersionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<UpdateDocumentDefaultVersionResult> responseHandler = new JsonResponseHandler<UpdateDocumentDefaultVersionResult>(unmarshaller);
     ...
     * @return updateMaintenanceWindowResult The response from the UpdateMaintenanceWindow service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public UpdateMaintenanceWindowResult updateMaintenanceWindow(UpdateMaintenanceWindowRequest updateMaintenanceWindowRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new UpdateMaintenanceWindowRequestMarshaller().marshall(updateMaintenanceWindowRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<UpdateMaintenanceWindowResult> responseHandler = new JsonResponseHandler<UpdateMaintenanceWindowResult>(unmarshaller);
     ...
     * @return updateMaintenanceWindowTargetResult The response from the UpdateMaintenanceWindowTarget service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public UpdateMaintenanceWindowTargetResult updateMaintenanceWindowTarget(UpdateMaintenanceWindowTargetRequest updateMaintenanceWindowTargetRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new UpdateMaintenanceWindowTargetRequestMarshaller().marshall(updateMaintenanceWindowTargetRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<UpdateMaintenanceWindowTargetResult> responseHandler = new JsonResponseHandler<UpdateMaintenanceWindowTargetResult>(unmarshaller);
     ...
     * @return updateMaintenanceWindowTaskResult The response from the UpdateMaintenanceWindowTask service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public UpdateMaintenanceWindowTaskResult updateMaintenanceWindowTask(UpdateMaintenanceWindowTaskRequest updateMaintenanceWindowTaskRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new UpdateMaintenanceWindowTaskRequestMarshaller().marshall(updateMaintenanceWindowTaskRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<UpdateMaintenanceWindowTaskResult> responseHandler = new JsonResponseHandler<UpdateMaintenanceWindowTaskResult>(unmarshaller);
     ...
     * @return updateManagedInstanceRoleResult The response from the UpdateManagedInstanceRole service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InvalidInstanceIdException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public UpdateManagedInstanceRoleResult updateManagedInstanceRole(UpdateManagedInstanceRoleRequest updateManagedInstanceRoleRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new UpdateManagedInstanceRoleRequestMarshaller().marshall(updateManagedInstanceRoleRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<UpdateManagedInstanceRoleResult> responseHandler = new JsonResponseHandler<UpdateManagedInstanceRoleResult>(unmarshaller);
     ...
     * @return updateOpsItemResult The response from the UpdateOpsItem service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws OpsItemNotFoundException 
     * @throws OpsItemAlreadyExistsException 
     * @throws OpsItemLimitExceededException 
    ...
    public UpdateOpsItemResult updateOpsItem(UpdateOpsItemRequest updateOpsItemRequest)
        ...
        try {
            ...
            JsonResponseHandler<UpdateOpsItemResult> responseHandler = new JsonResponseHandler<UpdateOpsItemResult>(unmarshaller);
     ...
     * @return updatePatchBaselineResult The response from the UpdatePatchBaseline service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws DoesNotExistException 
     * @throws InternalServerErrorException 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    public UpdatePatchBaselineResult updatePatchBaseline(UpdatePatchBaselineRequest updatePatchBaselineRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new UpdatePatchBaselineRequestMarshaller().marshall(updatePatchBaselineRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<UpdatePatchBaselineResult> responseHandler = new JsonResponseHandler<UpdatePatchBaselineResult>(unmarshaller);
     ...
     * @return updateResourceDataSyncResult The response from the UpdateResourceDataSync service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws ResourceDataSyncNotFoundException 
     * @throws ResourceDataSyncInvalidConfigurationException 
    ...
    public UpdateResourceDataSyncResult updateResourceDataSync(UpdateResourceDataSyncRequest updateResourceDataSyncRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new UpdateResourceDataSyncRequestMarshaller().marshall(updateResourceDataSyncRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<UpdateResourceDataSyncResult> responseHandler = new JsonResponseHandler<UpdateResourceDataSyncResult>(unmarshaller);
     ...
     * @param updateServiceSettingRequest <p>The request body of the UpdateServiceSetting API action.</p>
     * @return updateServiceSettingResult The response from the UpdateServiceSetting service method, as returned by Amazon Simple Systems Manager (SSM).
     * @throws InternalServerErrorException 
     * @throws ServiceSettingNotFoundException 
     * @throws TooManyUpdatesException 
     * @throws AmazonClientException
    ...
    public UpdateServiceSettingResult updateServiceSetting(UpdateServiceSettingRequest updateServiceSettingRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new UpdateServiceSettingRequestMarshaller().marshall(updateServiceSettingRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<UpdateServiceSettingResult> responseHandler = new JsonResponseHandler<UpdateServiceSettingResult>(unmarshaller);
