...
public class GetMaintenanceWindowResult implements Serializable {
     ...
     * <b>Length: </b>1 - 128<br/>
     *
     * @return <p>The description of the maintenance window.</p>
     */
     ...
     * <b>Length: </b>1 - 128<br/>
     *
     * @param description <p>The description of the maintenance window.</p>
     */
     ...
     * <p>The date the maintenance window was created.</p>
     *
     * @return <p>The date the maintenance window was created.</p>
     */
     ...
     * <p>The date the maintenance window was created.</p>
     *
     * @param createdDate <p>The date the maintenance window was created.</p>
     */
     ...
     * <p>The date the maintenance window was last modified.</p>
     *
     * @return <p>The date the maintenance window was last modified.</p>
     */
     ...
     * <p>The date the maintenance window was last modified.</p>
     *
     * @param modifiedDate <p>The date the maintenance window was last modified.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetMaintenanceWindowResult == false) return false;
