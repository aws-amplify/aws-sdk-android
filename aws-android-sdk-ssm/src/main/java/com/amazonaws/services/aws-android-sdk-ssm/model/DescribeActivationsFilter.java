...
public class DescribeActivationsFilter implements Serializable {
     ...
     * <b>Allowed Values: </b>ActivationIds, DefaultInstanceName, IamRole
     *
     * @param filterKey <p>The name of the filter.</p>
     *
     * @see DescribeActivationsFilterKeys
     */
     ...
     * <p>The filter values.</p>
     *
     * @param filterValues <p>The filter values.</p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getFilterKey() != null) sb.append("FilterKey: " + getFilterKey() + ",");
        if (getFilterValues() != null) sb.append("FilterValues: " + getFilterValues());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeActivationsFilter == false) return false;
        DescribeActivationsFilter other = (DescribeActivationsFilter)obj;

        if (other.getFilterKey() == null ^ this.getFilterKey() == null) return false;
        if (other.getFilterKey() != null && other.getFilterKey().equals(this.getFilterKey()) == false) return false;
        if (other.getFilterValues() == null ^ this.getFilterValues() == null) return false;
        if (other.getFilterValues() != null && other.getFilterValues().equals(this.getFilterValues()) == false) return false;
        return true;
    }
}
