...
class InventoryFilterJsonMarshaller {
    ...
    public void marshall(InventoryFilter inventoryFilter, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static InventoryFilterJsonMarshaller getInstance() {
        if (instance == null) instance = new InventoryFilterJsonMarshaller();
        return instance;
    }
}
