...
public class PatchGroupPatchBaselineMapping implements Serializable {
     ...
     * <b>Pattern: </b>^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$<br/>
     *
     * @return <p>The name of the patch group registered with the patch baseline.</p>
     */
     ...
     * <b>Pattern: </b>^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$<br/>
     *
     * @param patchGroup <p>The name of the patch group registered with the patch baseline.</p>
     */
     ...
     * <p>The patch baseline the patch group is registered with.</p>
     *
     * @return <p>The patch baseline the patch group is registered with.</p>
     */
     ...
     * <p>The patch baseline the patch group is registered with.</p>
     *
     * @param baselineIdentity <p>The patch baseline the patch group is registered with.</p>
     */
    ...
    public String toString() {
        ...
        if (getBaselineIdentity() != null) sb.append("BaselineIdentity: " + getBaselineIdentity());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PatchGroupPatchBaselineMapping == false) return false;
        ...
        if (other.getBaselineIdentity() == null ^ this.getBaselineIdentity() == null) return false;
        if (other.getBaselineIdentity() != null && other.getBaselineIdentity().equals(this.getBaselineIdentity()) == false) return false;
        return true;
    }
}
