...
public class RelatedOpsItem implements Serializable {
     ...
     * <p>The ID of an OpsItem related to the current OpsItem.</p>
     *
     * @return <p>The ID of an OpsItem related to the current OpsItem.</p>
     */
     ...
     * <p>The ID of an OpsItem related to the current OpsItem.</p>
     *
     * @param opsItemId <p>The ID of an OpsItem related to the current OpsItem.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RelatedOpsItem == false) return false;
