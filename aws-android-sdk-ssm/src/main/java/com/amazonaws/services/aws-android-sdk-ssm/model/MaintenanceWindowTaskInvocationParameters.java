...
public class MaintenanceWindowTaskInvocationParameters implements Serializable {
     ...
     * <p>The parameters for a RUN_COMMAND task type.</p>
     *
     * @return <p>The parameters for a RUN_COMMAND task type.</p>
     */
     ...
     * <p>The parameters for a RUN_COMMAND task type.</p>
     *
     * @param runCommand <p>The parameters for a RUN_COMMAND task type.</p>
     */
     ...
     * <p>The parameters for an AUTOMATION task type.</p>
     *
     * @return <p>The parameters for an AUTOMATION task type.</p>
     */
     ...
     * <p>The parameters for an AUTOMATION task type.</p>
     *
     * @param automation <p>The parameters for an AUTOMATION task type.</p>
     */
     ...
     * <p>The parameters for a STEP_FUNCTIONS task type.</p>
     *
     * @return <p>The parameters for a STEP_FUNCTIONS task type.</p>
     */
     ...
     * <p>The parameters for a STEP_FUNCTIONS task type.</p>
     *
     * @param stepFunctions <p>The parameters for a STEP_FUNCTIONS task type.</p>
     */
     ...
     * <p>The parameters for a LAMBDA task type.</p>
     *
     * @return <p>The parameters for a LAMBDA task type.</p>
     */
     ...
     * <p>The parameters for a LAMBDA task type.</p>
     *
     * @param lambda <p>The parameters for a LAMBDA task type.</p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getRunCommand() != null) sb.append("RunCommand: " + getRunCommand() + ",");
        if (getAutomation() != null) sb.append("Automation: " + getAutomation() + ",");
        if (getStepFunctions() != null) sb.append("StepFunctions: " + getStepFunctions() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MaintenanceWindowTaskInvocationParameters == false) return false;
        MaintenanceWindowTaskInvocationParameters other = (MaintenanceWindowTaskInvocationParameters)obj;

        if (other.getRunCommand() == null ^ this.getRunCommand() == null) return false;
        if (other.getRunCommand() != null && other.getRunCommand().equals(this.getRunCommand()) == false) return false;
        if (other.getAutomation() == null ^ this.getAutomation() == null) return false;
        if (other.getAutomation() != null && other.getAutomation().equals(this.getAutomation()) == false) return false;
        if (other.getStepFunctions() == null ^ this.getStepFunctions() == null) return false;
        if (other.getStepFunctions() != null && other.getStepFunctions().equals(this.getStepFunctions()) == false) return false;
