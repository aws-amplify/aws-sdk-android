    ...
    public LabelParameterVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("InvalidLabels")) {
                labelParameterVersionResult.setInvalidLabels(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static LabelParameterVersionResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new LabelParameterVersionResultJsonUnmarshaller();
        return instance;
    }
}
