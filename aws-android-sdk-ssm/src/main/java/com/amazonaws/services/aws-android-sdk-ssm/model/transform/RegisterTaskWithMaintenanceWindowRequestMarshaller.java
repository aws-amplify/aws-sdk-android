...
public class RegisterTaskWithMaintenanceWindowRequestMarshaller implements Marshaller<Request<RegisterTaskWithMaintenanceWindowRequest>, RegisterTaskWithMaintenanceWindowRequest> {
    ...
    public Request<RegisterTaskWithMaintenanceWindowRequest> marshall(RegisterTaskWithMaintenanceWindowRequest registerTaskWithMaintenanceWindowRequest) {
        if (registerTaskWithMaintenanceWindowRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(RegisterTaskWithMaintenanceWindowRequest)");
        }

        Request<RegisterTaskWithMaintenanceWindowRequest> request = new DefaultRequest<RegisterTaskWithMaintenanceWindowRequest>(registerTaskWithMaintenanceWindowRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (registerTaskWithMaintenanceWindowRequest.getTargets() != null) {
                java.util.List<Target> targets = registerTaskWithMaintenanceWindowRequest.getTargets();
            ...
            if (registerTaskWithMaintenanceWindowRequest.getServiceRoleArn() != null) {
                String serviceRoleArn = registerTaskWithMaintenanceWindowRequest.getServiceRoleArn();
            ...
            if (registerTaskWithMaintenanceWindowRequest.getTaskParameters() != null) {
                java.util.Map<String, MaintenanceWindowTaskParameterValueExpression> taskParameters = registerTaskWithMaintenanceWindowRequest.getTaskParameters();
            ...
            if (registerTaskWithMaintenanceWindowRequest.getTaskInvocationParameters() != null) {
                MaintenanceWindowTaskInvocationParameters taskInvocationParameters = registerTaskWithMaintenanceWindowRequest.getTaskInvocationParameters();
                jsonWriter.name("TaskInvocationParameters");
            MaintenanceWindowTaskInvocationParametersJsonMarshaller.getInstance().marshall(taskInvocationParameters, jsonWriter);
            }
            ...
            if (registerTaskWithMaintenanceWindowRequest.getMaxConcurrency() != null) {
                String maxConcurrency = registerTaskWithMaintenanceWindowRequest.getMaxConcurrency();
