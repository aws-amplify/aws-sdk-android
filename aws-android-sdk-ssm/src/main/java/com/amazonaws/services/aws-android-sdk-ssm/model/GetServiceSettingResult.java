...
public class GetServiceSettingResult implements Serializable {
     ...
     * <p>The query result of the current service setting.</p>
     *
     * @return <p>The query result of the current service setting.</p>
     */
     ...
     * <p>The query result of the current service setting.</p>
     *
     * @param serviceSetting <p>The query result of the current service setting.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetServiceSettingResult == false) return false;
