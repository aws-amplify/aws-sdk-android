...
class MaintenanceWindowIdentityJsonMarshaller {
    ...
    public void marshall(MaintenanceWindowIdentity maintenanceWindowIdentity, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (maintenanceWindowIdentity.getScheduleOffset() != null) {
            Integer scheduleOffset = maintenanceWindowIdentity.getScheduleOffset();
    ...
    public static MaintenanceWindowIdentityJsonMarshaller getInstance() {
        if (instance == null) instance = new MaintenanceWindowIdentityJsonMarshaller();
        return instance;
    }
}
