...
public class OpsEntityItem implements Serializable {
     ...
     * <b>Pattern: </b>^(20)[0-9][0-9]-(0[1-9]|1[012])-([12][0-9]|3[01]|0[1-9])(T)(2[0-3]|[0-1][0-9])(:[0-5][0-9])(:[0-5][0-9])(Z)$<br/>
     *
     * @return <p>The time OpsItem data was captured.</p>
     */
     ...
     * <b>Pattern: </b>^(20)[0-9][0-9]-(0[1-9]|1[012])-([12][0-9]|3[01]|0[1-9])(T)(2[0-3]|[0-1][0-9])(:[0-5][0-9])(:[0-5][0-9])(Z)$<br/>
     *
     * @param captureTime <p>The time OpsItem data was captured.</p>
     */
     ...
     * <p>The detailed data content for an OpsItem summaries result item.</p>
     *
     * @return <p>The detailed data content for an OpsItem summaries result item.</p>
     */
     ...
     * <p>The detailed data content for an OpsItem summaries result item.</p>
     *
     * @param content <p>The detailed data content for an OpsItem summaries result item.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OpsEntityItem == false) return false;
