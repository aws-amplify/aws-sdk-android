...
public class ListResourceDataSyncResult implements Serializable {
     ...
     * <p>A list of your current Resource Data Sync configurations and their statuses.</p>
     *
     * @return <p>A list of your current Resource Data Sync configurations and their statuses.</p>
     */
     ...
     * <p>A list of your current Resource Data Sync configurations and their statuses.</p>
     *
     * @param resourceDataSyncItems <p>A list of your current Resource Data Sync configurations and their statuses.</p>
     */
    public void setResourceDataSyncItems(java.util.Collection<ResourceDataSyncItem> resourceDataSyncItems) {
        ...
        this.resourceDataSyncItems = new java.util.ArrayList<ResourceDataSyncItem>(resourceDataSyncItems);
    }
    ...
    public ListResourceDataSyncResult withResourceDataSyncItems(ResourceDataSyncItem... resourceDataSyncItems) {
        if (getResourceDataSyncItems() == null) {
            this.resourceDataSyncItems = new java.util.ArrayList<ResourceDataSyncItem>(resourceDataSyncItems.length);
        }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getResourceDataSyncItems() != null) sb.append("ResourceDataSyncItems: " + getResourceDataSyncItems() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListResourceDataSyncResult == false) return false;
        ListResourceDataSyncResult other = (ListResourceDataSyncResult)obj;

        if (other.getResourceDataSyncItems() == null ^ this.getResourceDataSyncItems() == null) return false;
        if (other.getResourceDataSyncItems() != null && other.getResourceDataSyncItems().equals(this.getResourceDataSyncItems()) == false) return false;
