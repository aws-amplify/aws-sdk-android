...
public class InventoryResultItem implements Serializable {
     ...
     * <b>Pattern: </b>^(AWS|Custom):.*$<br/>
     *
     * @return <p>The name of the inventory result item type.</p>
     */
     ...
     * <b>Pattern: </b>^(AWS|Custom):.*$<br/>
     *
     * @param typeName <p>The name of the inventory result item type.</p>
     */
     ...
     * <b>Pattern: </b>^([0-9]{1,6})(\.[0-9]{1,6})$<br/>
     *
     * @return <p>The schema version for the inventory result item/</p>
     */
     ...
     * <b>Pattern: </b>^([0-9]{1,6})(\.[0-9]{1,6})$<br/>
     *
     * @param schemaVersion <p>The schema version for the inventory result item/</p>
     */
     ...
     * <b>Pattern: </b>^(20)[0-9][0-9]-(0[1-9]|1[012])-([12][0-9]|3[01]|0[1-9])(T)(2[0-3]|[0-1][0-9])(:[0-5][0-9])(:[0-5][0-9])(Z)$<br/>
     *
     * @return <p>The time inventory item data was captured.</p>
     */
     ...
     * <b>Pattern: </b>^(20)[0-9][0-9]-(0[1-9]|1[012])-([12][0-9]|3[01]|0[1-9])(T)(2[0-3]|[0-1][0-9])(:[0-5][0-9])(:[0-5][0-9])(Z)$<br/>
     *
     * @param captureTime <p>The time inventory item data was captured.</p>
     */
     ...
     * <p>Contains all the inventory data of the item type. Results include attribute names and values. </p>
     *
     * @return <p>Contains all the inventory data of the item type. Results include attribute names and values. </p>
     */
     ...
     * <p>Contains all the inventory data of the item type. Results include attribute names and values. </p>
     *
     * @param content <p>Contains all the inventory data of the item type. Results include attribute names and values. </p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InventoryResultItem == false) return false;
