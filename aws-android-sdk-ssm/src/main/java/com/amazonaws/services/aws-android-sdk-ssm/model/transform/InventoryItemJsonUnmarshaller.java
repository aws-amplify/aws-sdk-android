...
.unmarshall(context));
                ...
                inventoryItem.setContent(new ListUnmarshaller<java.util.Map<String, String>>(new MapUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
)
.unmarshall(context));
            } else if (name.equals("Context")) {
                inventoryItem.setContext(new MapUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
.unmarshall(context));
            } else {
                reader.skipValue();
    ...
    public static InventoryItemJsonUnmarshaller getInstance() {
        if (instance == null) instance = new InventoryItemJsonUnmarshaller();
        return instance;
    }
}
