...
/**
 * JSON request marshaller for ListCommandsRequest
 */
public class ListCommandsRequestMarshaller implements Marshaller<Request<ListCommandsRequest>, ListCommandsRequest> {
    ...
    public Request<ListCommandsRequest> marshall(ListCommandsRequest listCommandsRequest) {
        if (listCommandsRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(ListCommandsRequest)");
        }

        Request<ListCommandsRequest> request = new DefaultRequest<ListCommandsRequest>(listCommandsRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (listCommandsRequest.getCommandId() != null) {
                String commandId = listCommandsRequest.getCommandId();
                jsonWriter.name("CommandId");
            jsonWriter.value(commandId);
            }
            if (listCommandsRequest.getInstanceId() != null) {
                String instanceId = listCommandsRequest.getInstanceId();
                jsonWriter.name("InstanceId");
            jsonWriter.value(instanceId);
            }
            if (listCommandsRequest.getMaxResults() != null) {
                Integer maxResults = listCommandsRequest.getMaxResults();
                jsonWriter.name("MaxResults");
            jsonWriter.value(maxResults);
            }
            if (listCommandsRequest.getNextToken() != null) {
                String nextToken = listCommandsRequest.getNextToken();
                jsonWriter.name("NextToken");
            jsonWriter.value(nextToken);
            }
            if (listCommandsRequest.getFilters() != null) {
                java.util.List<CommandFilter> filters = listCommandsRequest.getFilters();
