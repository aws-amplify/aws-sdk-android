...
public class DescribeAssociationExecutionTargetsResult implements Serializable {
     ...
     * <p>Information about the execution.</p>
     *
     * @param associationExecutionTargets <p>Information about the execution.</p>
     */
    public void setAssociationExecutionTargets(java.util.Collection<AssociationExecutionTarget> associationExecutionTargets) {
        ...
        this.associationExecutionTargets = new java.util.ArrayList<AssociationExecutionTarget>(associationExecutionTargets);
    }
    ...
    public DescribeAssociationExecutionTargetsResult withAssociationExecutionTargets(AssociationExecutionTarget... associationExecutionTargets) {
        if (getAssociationExecutionTargets() == null) {
            this.associationExecutionTargets = new java.util.ArrayList<AssociationExecutionTarget>(associationExecutionTargets.length);
        }
     ...
     * @return A reference to this updated object so that method calls can be chained together.
     */
    public DescribeAssociationExecutionTargetsResult withAssociationExecutionTargets(java.util.Collection<AssociationExecutionTarget> associationExecutionTargets) {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getAssociationExecutionTargets() != null) sb.append("AssociationExecutionTargets: " + getAssociationExecutionTargets() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAssociationExecutionTargetsResult == false) return false;
        DescribeAssociationExecutionTargetsResult other = (DescribeAssociationExecutionTargetsResult)obj;

        if (other.getAssociationExecutionTargets() == null ^ this.getAssociationExecutionTargets() == null) return false;
        if (other.getAssociationExecutionTargets() != null && other.getAssociationExecutionTargets().equals(this.getAssociationExecutionTargets()) == false) return false;
