...
class InstanceInformationStringFilterJsonMarshaller {
    ...
    public void marshall(InstanceInformationStringFilter instanceInformationStringFilter, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static InstanceInformationStringFilterJsonMarshaller getInstance() {
        if (instance == null) instance = new InstanceInformationStringFilterJsonMarshaller();
        return instance;
    }
}
