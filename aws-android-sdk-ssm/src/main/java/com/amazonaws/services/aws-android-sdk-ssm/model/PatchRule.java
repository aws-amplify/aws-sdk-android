...
public class PatchRule implements Serializable {
     ...
     * <p>The patch filter group that defines the criteria for the rule.</p>
     *
     * @return <p>The patch filter group that defines the criteria for the rule.</p>
     */
     ...
     * <p>The patch filter group that defines the criteria for the rule.</p>
     *
     * @param patchFilterGroup <p>The patch filter group that defines the criteria for the rule.</p>
     */
     ...
     * <b>Allowed Values: </b>CRITICAL, HIGH, MEDIUM, LOW, INFORMATIONAL, UNSPECIFIED
     *
     * @return <p>A compliance severity level for all approved patches in a patch baseline.</p>
     *
     ...
     * <b>Allowed Values: </b>CRITICAL, HIGH, MEDIUM, LOW, INFORMATIONAL, UNSPECIFIED
     *
     * @param complianceLevel <p>A compliance severity level for all approved patches in a patch baseline.</p>
     *
     * @see PatchComplianceLevel
     */
     ...
     * <b>Range: </b>0 - 100<br/>
     *
     * @return <p>The number of days after the release date of each patch matched by the rule that the patch is marked as approved in the patch baseline. For example, a value of <code>7</code> means that patches are approved seven days after they are released. Not supported on Ubuntu Server.</p>
     */
     ...
     * <b>Range: </b>0 - 100<br/>
     *
     * @param approveAfterDays <p>The number of days after the release date of each patch matched by the rule that the patch is marked as approved in the patch baseline. For example, a value of <code>7</code> means that patches are approved seven days after they are released. Not supported on Ubuntu Server.</p>
     */
     ...
     * <b>Length: </b>1 - 10<br/>
     *
     * @return <p>The cutoff date for auto approval of released patches. Any patches released on or before this date are installed automatically. Not supported on Ubuntu Server.</p> <p>Enter dates in the format <code>YYYY-MM-DD</code>. For example, <code>2020-12-31</code>.</p>
     */
     ...
     * <b>Length: </b>1 - 10<br/>
     *
     * @param approveUntilDate <p>The cutoff date for auto approval of released patches. Any patches released on or before this date are installed automatically. Not supported on Ubuntu Server.</p> <p>Enter dates in the format <code>YYYY-MM-DD</code>. For example, <code>2020-12-31</code>.</p>
     */
     ...
     * <p>For instances identified by the approval rule filters, enables a patch baseline to apply non-security updates available in the specified repository. The default value is 'false'. Applies to Linux instances only.</p>
     *
     * @return <p>For instances identified by the approval rule filters, enables a patch baseline to apply non-security updates available in the specified repository. The default value is 'false'. Applies to Linux instances only.</p>
     */
     ...
     * <p>For instances identified by the approval rule filters, enables a patch baseline to apply non-security updates available in the specified repository. The default value is 'false'. Applies to Linux instances only.</p>
     *
     * @param enableNonSecurity <p>For instances identified by the approval rule filters, enables a patch baseline to apply non-security updates available in the specified repository. The default value is 'false'. Applies to Linux instances only.</p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getPatchFilterGroup() != null) sb.append("PatchFilterGroup: " + getPatchFilterGroup() + ",");
        if (getComplianceLevel() != null) sb.append("ComplianceLevel: " + getComplianceLevel() + ",");
        if (getApproveAfterDays() != null) sb.append("ApproveAfterDays: " + getApproveAfterDays() + ",");
        if (getApproveUntilDate() != null) sb.append("ApproveUntilDate: " + getApproveUntilDate() + ",");
        if (getEnableNonSecurity() != null) sb.append("EnableNonSecurity: " + getEnableNonSecurity());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PatchRule == false) return false;
        PatchRule other = (PatchRule)obj;

        if (other.getPatchFilterGroup() == null ^ this.getPatchFilterGroup() == null) return false;
        if (other.getPatchFilterGroup() != null && other.getPatchFilterGroup().equals(this.getPatchFilterGroup()) == false) return false;
        ...
        if (other.getApproveAfterDays() == null ^ this.getApproveAfterDays() == null) return false;
        if (other.getApproveAfterDays() != null && other.getApproveAfterDays().equals(this.getApproveAfterDays()) == false) return false;
        if (other.getApproveUntilDate() == null ^ this.getApproveUntilDate() == null) return false;
        if (other.getApproveUntilDate() != null && other.getApproveUntilDate().equals(this.getApproveUntilDate()) == false) return false;
        if (other.getEnableNonSecurity() == null ^ this.getEnableNonSecurity() == null) return false;
        if (other.getEnableNonSecurity() != null && other.getEnableNonSecurity().equals(this.getEnableNonSecurity()) == false) return false;
        return true;
    }
}
