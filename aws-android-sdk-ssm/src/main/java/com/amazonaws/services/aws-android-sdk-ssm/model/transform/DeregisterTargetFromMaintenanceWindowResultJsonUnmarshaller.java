...
/**
 * JSON unmarshaller for response DeregisterTargetFromMaintenanceWindowResult
 */
public class DeregisterTargetFromMaintenanceWindowResultJsonUnmarshaller implements Unmarshaller<DeregisterTargetFromMaintenanceWindowResult, JsonUnmarshallerContext> {
    ...
    public DeregisterTargetFromMaintenanceWindowResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("WindowId")) {
                deregisterTargetFromMaintenanceWindowResult.setWindowId(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("WindowTargetId")) {
                deregisterTargetFromMaintenanceWindowResult.setWindowTargetId(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static DeregisterTargetFromMaintenanceWindowResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DeregisterTargetFromMaintenanceWindowResultJsonUnmarshaller();
        return instance;
    }
}
