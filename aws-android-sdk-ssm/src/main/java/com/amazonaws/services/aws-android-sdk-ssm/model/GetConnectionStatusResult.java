...
public class GetConnectionStatusResult implements Serializable {
     ...
     * <b>Length: </b>1 - 400<br/>
     *
     * @return <p>The ID of the instance to check connection status. </p>
     */
     ...
     * <b>Length: </b>1 - 400<br/>
     *
     * @param target <p>The ID of the instance to check connection status. </p>
     */
     ...
     * <b>Allowed Values: </b>Connected, NotConnected
     *
     * @return <p>The status of the connection to the instance. For example, 'Connected' or 'Not Connected'.</p>
     *
     ...
     * <b>Allowed Values: </b>Connected, NotConnected
     *
     * @param status <p>The status of the connection to the instance. For example, 'Connected' or 'Not Connected'.</p>
     *
     * @see ConnectionStatus
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetConnectionStatusResult == false) return false;
