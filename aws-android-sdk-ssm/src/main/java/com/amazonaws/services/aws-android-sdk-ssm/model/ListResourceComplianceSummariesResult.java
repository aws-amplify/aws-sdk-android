...
public class ListResourceComplianceSummariesResult implements Serializable {
     ...
     * <p>A summary count for specified or targeted managed instances. Summary count includes information about compliant and non-compliant State Manager associations, patch status, or custom items according to the filter criteria that you specify. </p>
     *
     * @return <p>A summary count for specified or targeted managed instances. Summary count includes information about compliant and non-compliant State Manager associations, patch status, or custom items according to the filter criteria that you specify. </p>
     */
     ...
     * <p>A summary count for specified or targeted managed instances. Summary count includes information about compliant and non-compliant State Manager associations, patch status, or custom items according to the filter criteria that you specify. </p>
     *
     * @param resourceComplianceSummaryItems <p>A summary count for specified or targeted managed instances. Summary count includes information about compliant and non-compliant State Manager associations, patch status, or custom items according to the filter criteria that you specify. </p>
     */
    public void setResourceComplianceSummaryItems(java.util.Collection<ResourceComplianceSummaryItem> resourceComplianceSummaryItems) {
        ...
        this.resourceComplianceSummaryItems = new java.util.ArrayList<ResourceComplianceSummaryItem>(resourceComplianceSummaryItems);
    }
    ...
    public ListResourceComplianceSummariesResult withResourceComplianceSummaryItems(ResourceComplianceSummaryItem... resourceComplianceSummaryItems) {
        if (getResourceComplianceSummaryItems() == null) {
            this.resourceComplianceSummaryItems = new java.util.ArrayList<ResourceComplianceSummaryItem>(resourceComplianceSummaryItems.length);
        }
     ...
     * @return A reference to this updated object so that method calls can be chained together.
     */
    public ListResourceComplianceSummariesResult withResourceComplianceSummaryItems(java.util.Collection<ResourceComplianceSummaryItem> resourceComplianceSummaryItems) {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getResourceComplianceSummaryItems() != null) sb.append("ResourceComplianceSummaryItems: " + getResourceComplianceSummaryItems() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListResourceComplianceSummariesResult == false) return false;
        ListResourceComplianceSummariesResult other = (ListResourceComplianceSummariesResult)obj;

        if (other.getResourceComplianceSummaryItems() == null ^ this.getResourceComplianceSummaryItems() == null) return false;
        if (other.getResourceComplianceSummaryItems() != null && other.getResourceComplianceSummaryItems().equals(this.getResourceComplianceSummaryItems()) == false) return false;
