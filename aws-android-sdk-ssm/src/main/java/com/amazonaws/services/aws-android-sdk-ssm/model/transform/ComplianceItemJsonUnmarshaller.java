 ...
 */
class ComplianceItemJsonUnmarshaller implements Unmarshaller<ComplianceItem, JsonUnmarshallerContext> {
...
.unmarshall(context));
                ...
                complianceItem.setExecutionSummary(ComplianceExecutionSummaryJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Details")) {
                complianceItem.setDetails(new MapUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
.unmarshall(context));
            } else {
                reader.skipValue();
    ...
    public static ComplianceItemJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ComplianceItemJsonUnmarshaller();
        return instance;
    }
}
