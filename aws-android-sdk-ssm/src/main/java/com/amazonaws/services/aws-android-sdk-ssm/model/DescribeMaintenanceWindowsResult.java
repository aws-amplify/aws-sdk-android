...
public class DescribeMaintenanceWindowsResult implements Serializable {
     ...
     * <p>Information about the maintenance windows.</p>
     *
     * @return <p>Information about the maintenance windows.</p>
     */
     ...
     * <p>Information about the maintenance windows.</p>
     *
     * @param windowIdentities <p>Information about the maintenance windows.</p>
     */
    ...
    public DescribeMaintenanceWindowsResult withWindowIdentities(MaintenanceWindowIdentity... windowIdentities) {
        if (getWindowIdentities() == null) {
            this.windowIdentities = new java.util.ArrayList<MaintenanceWindowIdentity>(windowIdentities.length);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMaintenanceWindowsResult == false) return false;
