 ...
 */
public class RegisterDefaultPatchBaselineRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-:/]{20,128}$<br/>
     *
     * @return <p>The ID of the patch baseline that should be the default patch baseline.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-:/]{20,128}$<br/>
     *
     * @param baselineId <p>The ID of the patch baseline that should be the default patch baseline.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RegisterDefaultPatchBaselineRequest == false) return false;
