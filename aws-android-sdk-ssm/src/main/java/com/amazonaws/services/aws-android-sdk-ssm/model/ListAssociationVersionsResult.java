...
public class ListAssociationVersionsResult implements Serializable {
    /**
     * <p>Information about all versions of the association for the specified association ID.</p>
     */
    private java.util.List<AssociationVersionInfo> associationVersions;
     ...
     * <p>Information about all versions of the association for the specified association ID.</p>
     *
     * @return <p>Information about all versions of the association for the specified association ID.</p>
     */
     ...
     * <p>Information about all versions of the association for the specified association ID.</p>
     *
     * @param associationVersions <p>Information about all versions of the association for the specified association ID.</p>
     */
    public void setAssociationVersions(java.util.Collection<AssociationVersionInfo> associationVersions) {
        ...
        this.associationVersions = new java.util.ArrayList<AssociationVersionInfo>(associationVersions);
    }
    ...
    public ListAssociationVersionsResult withAssociationVersions(AssociationVersionInfo... associationVersions) {
        if (getAssociationVersions() == null) {
            this.associationVersions = new java.util.ArrayList<AssociationVersionInfo>(associationVersions.length);
        }
        for (AssociationVersionInfo value : associationVersions) {
            this.associationVersions.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getAssociationVersions() != null) sb.append("AssociationVersions: " + getAssociationVersions() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAssociationVersionsResult == false) return false;
        ListAssociationVersionsResult other = (ListAssociationVersionsResult)obj;

        if (other.getAssociationVersions() == null ^ this.getAssociationVersions() == null) return false;
        if (other.getAssociationVersions() != null && other.getAssociationVersions().equals(this.getAssociationVersions()) == false) return false;
