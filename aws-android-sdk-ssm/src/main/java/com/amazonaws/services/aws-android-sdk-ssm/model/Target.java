...
public class Target implements Serializable {
     ...
     * <b>Constraints:</b><br/>
     * <b>Length: </b>1 - 163<br/>
     * <b>Pattern: </b>^[\p{L}\p{Z}\p{N}_.:/=\-@]*$|resource-groups:ResourceTypeFilters|resource-groups:Name<br/>
     */
    private String key;
     ...
     * <b>Pattern: </b>^[\p{L}\p{Z}\p{N}_.:/=\-@]*$|resource-groups:ResourceTypeFilters|resource-groups:Name<br/>
     *
     * @return <p>User-defined criteria for sending commands that target instances that meet the criteria.</p>
     */
     ...
     * <b>Pattern: </b>^[\p{L}\p{Z}\p{N}_.:/=\-@]*$|resource-groups:ResourceTypeFilters|resource-groups:Name<br/>
     *
     * @param key <p>User-defined criteria for sending commands that target instances that meet the criteria.</p>
     */
     ...
     * <p>User-defined criteria that maps to <code>Key</code>. For example, if you specified <code>tag:ServerRole</code>, you could specify <code>value:WebServer</code> to run a command on instances that include EC2 tags of <code>ServerRole,WebServer</code>. </p>
     *
     * @return <p>User-defined criteria that maps to <code>Key</code>. For example, if you specified <code>tag:ServerRole</code>, you could specify <code>value:WebServer</code> to run a command on instances that include EC2 tags of <code>ServerRole,WebServer</code>. </p>
     */
     ...
     * <p>User-defined criteria that maps to <code>Key</code>. For example, if you specified <code>tag:ServerRole</code>, you could specify <code>value:WebServer</code> to run a command on instances that include EC2 tags of <code>ServerRole,WebServer</code>. </p>
     *
     * @param values <p>User-defined criteria that maps to <code>Key</code>. For example, if you specified <code>tag:ServerRole</code>, you could specify <code>value:WebServer</code> to run a command on instances that include EC2 tags of <code>ServerRole,WebServer</code>. </p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Target == false) return false;
