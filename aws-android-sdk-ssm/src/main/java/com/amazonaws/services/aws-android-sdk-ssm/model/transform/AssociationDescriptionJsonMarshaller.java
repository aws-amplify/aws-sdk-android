...
class AssociationDescriptionJsonMarshaller {
    ...
    public void marshall(AssociationDescription associationDescription, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (associationDescription.getLastUpdateAssociationDate() != null) {
            java.util.Date lastUpdateAssociationDate = associationDescription.getLastUpdateAssociationDate();
        ...
        if (associationDescription.getAutomationTargetParameterName() != null) {
            String automationTargetParameterName = associationDescription.getAutomationTargetParameterName();
        ...
        if (associationDescription.getParameters() != null) {
            java.util.Map<String, java.util.List<String>> parameters = associationDescription.getParameters();
        ...
        if (associationDescription.getOutputLocation() != null) {
            InstanceAssociationOutputLocation outputLocation = associationDescription.getOutputLocation();
        ...
        if (associationDescription.getLastSuccessfulExecutionDate() != null) {
            java.util.Date lastSuccessfulExecutionDate = associationDescription.getLastSuccessfulExecutionDate();
    ...
    public static AssociationDescriptionJsonMarshaller getInstance() {
        if (instance == null) instance = new AssociationDescriptionJsonMarshaller();
        return instance;
    }
}
