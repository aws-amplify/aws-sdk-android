...
class InstanceAssociationJsonMarshaller {
    ...
    public void marshall(InstanceAssociation instanceAssociation, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static InstanceAssociationJsonMarshaller getInstance() {
        if (instance == null) instance = new InstanceAssociationJsonMarshaller();
        return instance;
    }
}
