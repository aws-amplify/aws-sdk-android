 ...
 */
class AttachmentContentJsonUnmarshaller implements Unmarshaller<AttachmentContent, JsonUnmarshallerContext> {
...
.unmarshall(context));
    ...
    public static AttachmentContentJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AttachmentContentJsonUnmarshaller();
        return instance;
    }
}
