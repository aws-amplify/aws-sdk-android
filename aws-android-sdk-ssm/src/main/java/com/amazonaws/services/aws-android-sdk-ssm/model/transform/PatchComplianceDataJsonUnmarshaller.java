 ...
 */
class PatchComplianceDataJsonUnmarshaller implements Unmarshaller<PatchComplianceData, JsonUnmarshallerContext> {
...
.unmarshall(context));
    ...
    public static PatchComplianceDataJsonUnmarshaller getInstance() {
        if (instance == null) instance = new PatchComplianceDataJsonUnmarshaller();
        return instance;
    }
}
