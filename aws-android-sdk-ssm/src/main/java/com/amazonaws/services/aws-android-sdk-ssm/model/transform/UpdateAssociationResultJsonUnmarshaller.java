    ...
    public UpdateAssociationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AssociationDescription")) {
                updateAssociationResult.setAssociationDescription(AssociationDescriptionJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static UpdateAssociationResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new UpdateAssociationResultJsonUnmarshaller();
        return instance;
    }
}
