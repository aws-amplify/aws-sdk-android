...
class InventoryAggregatorJsonMarshaller {
    ...
    public void marshall(InventoryAggregator inventoryAggregator, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static InventoryAggregatorJsonMarshaller getInstance() {
        if (instance == null) instance = new InventoryAggregatorJsonMarshaller();
        return instance;
    }
}
