...
public class OpsItemLimitExceededExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        e.setErrorCode("OpsItemLimitExceededException");
            ...
            final AwsJsonReader jsonReader = JsonUtils.getJsonReader(new StringReader(error.get("ResourceTypes")));
            e.setResourceTypes(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()).unmarshall(new JsonUnmarshallerContext(jsonReader)));
