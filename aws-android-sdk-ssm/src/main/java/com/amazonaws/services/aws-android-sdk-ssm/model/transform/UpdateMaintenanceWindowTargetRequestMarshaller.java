 ...
 */
public class UpdateMaintenanceWindowTargetRequestMarshaller implements Marshaller<Request<UpdateMaintenanceWindowTargetRequest>, UpdateMaintenanceWindowTargetRequest> {
    ...
    public Request<UpdateMaintenanceWindowTargetRequest> marshall(UpdateMaintenanceWindowTargetRequest updateMaintenanceWindowTargetRequest) {
        if (updateMaintenanceWindowTargetRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(UpdateMaintenanceWindowTargetRequest)");
        }

        Request<UpdateMaintenanceWindowTargetRequest> request = new DefaultRequest<UpdateMaintenanceWindowTargetRequest>(updateMaintenanceWindowTargetRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (updateMaintenanceWindowTargetRequest.getOwnerInformation() != null) {
                String ownerInformation = updateMaintenanceWindowTargetRequest.getOwnerInformation();
