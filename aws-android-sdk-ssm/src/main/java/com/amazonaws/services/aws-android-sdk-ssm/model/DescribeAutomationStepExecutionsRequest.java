 ...
 */
public class DescribeAutomationStepExecutionsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @return <p>The Automation execution ID for which you want step execution descriptions.</p>
     */
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @param automationExecutionId <p>The Automation execution ID for which you want step execution descriptions.</p>
     */
     ...
     * <p>One or more filters to limit the number of step executions returned by the request.</p>
     *
     * @return <p>One or more filters to limit the number of step executions returned by the request.</p>
     */
     ...
     * <p>One or more filters to limit the number of step executions returned by the request.</p>
     *
     * @param filters <p>One or more filters to limit the number of step executions returned by the request.</p>
     */
     ...
     * <p>A boolean that indicates whether to list step executions in reverse order by start time. The default value is false.</p>
     *
     * @return <p>A boolean that indicates whether to list step executions in reverse order by start time. The default value is false.</p>
     */
     ...
     * <p>A boolean that indicates whether to list step executions in reverse order by start time. The default value is false.</p>
     *
     * @param reverseOrder <p>A boolean that indicates whether to list step executions in reverse order by start time. The default value is false.</p>
     */
    ...
    public String toString() {
        ...
        if (getReverseOrder() != null) sb.append("ReverseOrder: " + getReverseOrder());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAutomationStepExecutionsRequest == false) return false;
        ...
        if (other.getReverseOrder() == null ^ this.getReverseOrder() == null) return false;
        if (other.getReverseOrder() != null && other.getReverseOrder().equals(this.getReverseOrder()) == false) return false;
        return true;
    }
}
