 ...
 */
class FailureDetailsJsonUnmarshaller implements Unmarshaller<FailureDetails, JsonUnmarshallerContext> {
...
.unmarshall(context));
                ...
                failureDetails.setDetails(new MapUnmarshaller<java.util.List<String>>(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
)
.unmarshall(context));
            } else {
    ...
    public static FailureDetailsJsonUnmarshaller getInstance() {
        if (instance == null) instance = new FailureDetailsJsonUnmarshaller();
        return instance;
    }
}
