...
public class OutputSource implements Serializable {
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @return <p>The ID of the output source, for example the URL of an S3 bucket.</p>
     */
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @param outputSourceId <p>The ID of the output source, for example the URL of an S3 bucket.</p>
     */
     ...
     * <p>The type of source where the association execution details are stored, for example, Amazon S3.</p>
     *
     * @return <p>The type of source where the association execution details are stored, for example, Amazon S3.</p>
     */
     ...
     * <p>The type of source where the association execution details are stored, for example, Amazon S3.</p>
     *
     * @param outputSourceType <p>The type of source where the association execution details are stored, for example, Amazon S3.</p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getOutputSourceId() != null) sb.append("OutputSourceId: " + getOutputSourceId() + ",");
        if (getOutputSourceType() != null) sb.append("OutputSourceType: " + getOutputSourceType());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OutputSource == false) return false;
        OutputSource other = (OutputSource)obj;

        if (other.getOutputSourceId() == null ^ this.getOutputSourceId() == null) return false;
        if (other.getOutputSourceId() != null && other.getOutputSourceId().equals(this.getOutputSourceId()) == false) return false;
        if (other.getOutputSourceType() == null ^ this.getOutputSourceType() == null) return false;
        if (other.getOutputSourceType() != null && other.getOutputSourceType().equals(this.getOutputSourceType()) == false) return false;
        return true;
    }
}
