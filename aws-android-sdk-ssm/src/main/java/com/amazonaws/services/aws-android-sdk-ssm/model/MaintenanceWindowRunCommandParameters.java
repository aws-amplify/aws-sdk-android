...
public class MaintenanceWindowRunCommandParameters implements Serializable {
     ...
     * <b>Length: </b> - 100<br/>
     *
     * @return <p>Information about the commands to run.</p>
     */
     ...
     * <b>Length: </b> - 100<br/>
     *
     * @param comment <p>Information about the commands to run.</p>
     */
     ...
     * <p>Configuration options for sending command output to CloudWatch Logs.</p>
     *
     * @return <p>Configuration options for sending command output to CloudWatch Logs.</p>
     */
     ...
     * <p>Configuration options for sending command output to CloudWatch Logs.</p>
     *
     * @param cloudWatchOutputConfig <p>Configuration options for sending command output to CloudWatch Logs.</p>
     */
     ...
     * <b>Length: </b> - 256<br/>
     *
     * @return <p>The SHA-256 or SHA-1 hash created by the system when the document was created. SHA-1 hashes have been deprecated.</p>
     */
     ...
     * <b>Length: </b> - 256<br/>
     *
     * @param documentHash <p>The SHA-256 or SHA-1 hash created by the system when the document was created. SHA-1 hashes have been deprecated.</p>
     */
     ...
     * <b>Allowed Values: </b>Sha256, Sha1
     *
     * @return <p>SHA-256 or SHA-1. SHA-1 hashes have been deprecated.</p>
     *
     ...
     * <b>Allowed Values: </b>Sha256, Sha1
     *
     * @param documentHashType <p>SHA-256 or SHA-1. SHA-1 hashes have been deprecated.</p>
     *
     * @see DocumentHashType
     */
     ...
     * <b>Length: </b>3 - 63<br/>
     *
     * @return <p>The name of the S3 bucket.</p>
     */
     ...
     * <b>Length: </b>3 - 63<br/>
     *
     * @param outputS3BucketName <p>The name of the S3 bucket.</p>
     */
     ...
     * <b>Length: </b> - 500<br/>
     *
     * @return <p>The S3 bucket subfolder.</p>
     */
     ...
     * <b>Length: </b> - 500<br/>
     *
     * @param outputS3KeyPrefix <p>The S3 bucket subfolder.</p>
     */
     ...
     * <p>The parameters for the RUN_COMMAND task execution.</p>
     *
     * @return <p>The parameters for the RUN_COMMAND task execution.</p>
     */
     ...
     * <p>The parameters for the RUN_COMMAND task execution.</p>
     *
     * @param parameters <p>The parameters for the RUN_COMMAND task execution.</p>
     */
     ...
     * <b>Range: </b>30 - 2592000<br/>
     *
     * @return <p>If this time is reached and the command has not already started running, it doesn't run.</p>
     */
     ...
     * <b>Range: </b>30 - 2592000<br/>
     *
     * @param timeoutSeconds <p>If this time is reached and the command has not already started running, it doesn't run.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MaintenanceWindowRunCommandParameters == false) return false;
