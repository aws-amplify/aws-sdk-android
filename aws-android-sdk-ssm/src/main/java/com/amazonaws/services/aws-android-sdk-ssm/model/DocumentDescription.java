...
public class DocumentDescription implements Serializable {
     ...
     * <p>The SHA1 hash of the document, which you can use for verification.</p>
     *
     * @return <p>The SHA1 hash of the document, which you can use for verification.</p>
     */
     ...
     * <p>The SHA1 hash of the document, which you can use for verification.</p>
     *
     * @param sha1 <p>The SHA1 hash of the document, which you can use for verification.</p>
     */
     ...
     * <b>Length: </b> - 256<br/>
     *
     * @param hash <p>The Sha256 or Sha1 hash created by the system when the document was created. </p> <note> <p>Sha1 hashes have been deprecated.</p> </note>
     */
     ...
     * <b>Allowed Values: </b>Sha256, Sha1
     *
     * @return <p>The hash type of the document. Valid values include <code>Sha256</code> or <code>Sha1</code>.</p> <note> <p>Sha1 hashes have been deprecated.</p> </note>
     *
     ...
     * <b>Allowed Values: </b>Sha256, Sha1
     *
     * @param hashType <p>The hash type of the document. Valid values include <code>Sha256</code> or <code>Sha1</code>.</p> <note> <p>Sha1 hashes have been deprecated.</p> </note>
     *
     * @see DocumentHashType
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.]{1,128}$<br/>
     *
     * @return <p>The version of the artifact associated with the document.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.]{1,128}$<br/>
     *
     * @param versionName <p>The version of the artifact associated with the document.</p>
     */
     ...
     * <p>The date when the document was created.</p>
     *
     * @return <p>The date when the document was created.</p>
     */
     ...
     * <p>The date when the document was created.</p>
     *
     * @param createdDate <p>The date when the document was created.</p>
     */
     ...
     * <b>Allowed Values: </b>Creating, Active, Updating, Deleting, Failed
     *
     * @return <p>The status of the Systems Manager document.</p>
     *
     * @see DocumentStatus
     */
     ...
     * <b>Allowed Values: </b>Creating, Active, Updating, Deleting, Failed
     *
     * @param status <p>The status of the Systems Manager document.</p>
     *
     * @see DocumentStatus
     */
     ...
     * <p>A description of the document. </p>
     *
     * @return <p>A description of the document. </p>
     */
     ...
     * <p>A description of the document. </p>
     *
     * @param description <p>A description of the document. </p>
     */
     ...
     * <p>The list of OS platforms compatible with this Systems Manager document. </p>
     *
     * @return <p>The list of OS platforms compatible with this Systems Manager document. </p>
     */
     ...
     * <p>The list of OS platforms compatible with this Systems Manager document. </p>
     *
     * @param platformTypes <p>The list of OS platforms compatible with this Systems Manager document. </p>
     */
     ...
     * <b>Allowed Values: </b>Command, Policy, Automation, Session, Package, ApplicationConfiguration, ApplicationConfigurationSchema, DeploymentStrategy, ChangeCalendar
     *
     * @return <p>The type of document.</p>
     *
     * @see DocumentType
     */
     ...
     * <b>Allowed Values: </b>Command, Policy, Automation, Session, Package, ApplicationConfiguration, ApplicationConfigurationSchema, DeploymentStrategy, ChangeCalendar
     *
     * @param documentType <p>The type of document.</p>
     *
     * @see DocumentType
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @return <p>The latest version of the document.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @param latestVersion <p>The latest version of the document.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @return <p>The default version.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @param defaultVersion <p>The default version.</p>
     */
     ...
     * <p>Details about the document attachments, including names, locations, sizes, and so on.</p>
     *
     * @return <p>Details about the document attachments, including names, locations, sizes, and so on.</p>
     */
     ...
     * <p>Details about the document attachments, including names, locations, sizes, and so on.</p>
     *
     * @param attachmentsInformation <p>Details about the document attachments, including names, locations, sizes, and so on.</p>
     */
    public void setAttachmentsInformation(java.util.Collection<AttachmentInformation> attachmentsInformation) {
        ...
        this.attachmentsInformation = new java.util.ArrayList<AttachmentInformation>(attachmentsInformation);
    }
    ...
    public DocumentDescription withAttachmentsInformation(AttachmentInformation... attachmentsInformation) {
        if (getAttachmentsInformation() == null) {
            this.attachmentsInformation = new java.util.ArrayList<AttachmentInformation>(attachmentsInformation.length);
        }
    ...
    public String toString() {
        ...
        if (getHash() != null) sb.append("Hash: " + getHash() + ",");
        if (getHashType() != null) sb.append("HashType: " + getHashType() + ",");
        ...
        if (getAttachmentsInformation() != null) sb.append("AttachmentsInformation: " + getAttachmentsInformation() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getHash() == null ^ this.getHash() == null) return false;
        if (other.getHash() != null && other.getHash().equals(this.getHash()) == false) return false;
        if (other.getHashType() == null ^ this.getHashType() == null) return false;
        if (other.getHashType() != null && other.getHashType().equals(this.getHashType()) == false) return false;
        ...
        if (other.getAttachmentsInformation() == null ^ this.getAttachmentsInformation() == null) return false;
        if (other.getAttachmentsInformation() != null && other.getAttachmentsInformation().equals(this.getAttachmentsInformation()) == false) return false;
