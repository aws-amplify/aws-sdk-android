...
public class GetOpsItemRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Pattern: </b>^(oi)-[0-9a-f]{12}$<br/>
     *
     * @return <p>The ID of the OpsItem that you want to get.</p>
     */
     ...
     * <b>Pattern: </b>^(oi)-[0-9a-f]{12}$<br/>
     *
     * @param opsItemId <p>The ID of the OpsItem that you want to get.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetOpsItemRequest == false) return false;
