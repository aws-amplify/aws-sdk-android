...
public class AutomationExecution implements Serializable {
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>Pending, InProgress, Waiting, Success, TimedOut, Cancelling, Cancelled, Failed
     */
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @param automationExecutionId <p>The execution ID.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.]{3,128}$<br/>
     *
     * @return <p>The name of the Automation document used during the execution.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.]{3,128}$<br/>
     *
     * @param documentName <p>The name of the Automation document used during the execution.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @return <p>The version of the document to use during execution.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @param documentVersion <p>The version of the document to use during execution.</p>
     */
     ...
     * <p>The time the execution started.</p>
     *
     * @return <p>The time the execution started.</p>
     */
     ...
     * <p>The time the execution started.</p>
     *
     * @param executionStartTime <p>The time the execution started.</p>
     */
     ...
     * <p>The time the execution finished.</p>
     *
     * @return <p>The time the execution finished.</p>
     */
     ...
     * <p>The time the execution finished.</p>
     *
     * @param executionEndTime <p>The time the execution finished.</p>
     */
     ...
     * <b>Allowed Values: </b>Pending, InProgress, Waiting, Success, TimedOut, Cancelling, Cancelled, Failed
     *
     * @return <p>The execution status of the Automation.</p>
     *
     ...
     * <b>Allowed Values: </b>Pending, InProgress, Waiting, Success, TimedOut, Cancelling, Cancelled, Failed
     *
     * @param automationExecutionStatus <p>The execution status of the Automation.</p>
     *
     * @see AutomationExecutionStatus
     */
     ...
     * <p>A list of details about the current state of all steps that comprise an execution. An Automation document contains a list of steps that are run in order.</p>
     *
     * @return <p>A list of details about the current state of all steps that comprise an execution. An Automation document contains a list of steps that are run in order.</p>
     */
     ...
     * <p>A list of details about the current state of all steps that comprise an execution. An Automation document contains a list of steps that are run in order.</p>
     *
     * @param stepExecutions <p>A list of details about the current state of all steps that comprise an execution. An Automation document contains a list of steps that are run in order.</p>
     */
     ...
     * <p>A boolean value that indicates if the response contains the full list of the Automation step executions. If true, use the DescribeAutomationStepExecutions API action to get the full list of step executions.</p>
     *
     * @return <p>A boolean value that indicates if the response contains the full list of the Automation step executions. If true, use the DescribeAutomationStepExecutions API action to get the full list of step executions.</p>
     */
     ...
     * <p>A boolean value that indicates if the response contains the full list of the Automation step executions. If true, use the DescribeAutomationStepExecutions API action to get the full list of step executions.</p>
     *
     * @param stepExecutionsTruncated <p>A boolean value that indicates if the response contains the full list of the Automation step executions. If true, use the DescribeAutomationStepExecutions API action to get the full list of step executions.</p>
     */
     ...
     * <p>The key-value map of execution parameters, which were supplied when calling StartAutomationExecution.</p>
     *
     * @return <p>The key-value map of execution parameters, which were supplied when calling StartAutomationExecution.</p>
     */
     ...
     * <p>The key-value map of execution parameters, which were supplied when calling StartAutomationExecution.</p>
     *
     * @param parameters <p>The key-value map of execution parameters, which were supplied when calling StartAutomationExecution.</p>
     */
     ...
     * <p>The list of execution outputs as defined in the automation document.</p>
     *
     * @return <p>The list of execution outputs as defined in the automation document.</p>
     */
     ...
     * <p>The list of execution outputs as defined in the automation document.</p>
     *
     * @param outputs <p>The list of execution outputs as defined in the automation document.</p>
     */
     ...
     * <p>The list of execution outputs as defined in the automation document.</p>
     * <p>
     * The method adds a new key-value pair into Outputs parameter, and returns a reference to this object so that method calls can be chained together.
     *
     * @param key The key of the entry to be added into Outputs.
     * @param value The corresponding value of the entry to be added into Outputs.
     *
     * @return A reference to this updated object so that method calls can be chained together.
     */
     ...
     * <p>A message describing why an execution has failed, if the status is set to Failed.</p>
     *
     * @return <p>A message describing why an execution has failed, if the status is set to Failed.</p>
     */
     ...
     * <p>A message describing why an execution has failed, if the status is set to Failed.</p>
     *
     * @param failureMessage <p>A message describing why an execution has failed, if the status is set to Failed.</p>
     */
     ...
     * <b>Allowed Values: </b>Auto, Interactive
     *
     * @return <p>The automation execution mode.</p>
     *
     * @see ExecutionMode
     */
     ...
     * <b>Allowed Values: </b>Auto, Interactive
     *
     * @param mode <p>The automation execution mode.</p>
     *
     * @see ExecutionMode
     */
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @return <p>The AutomationExecutionId of the parent automation.</p>
     */
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @param parentAutomationExecutionId <p>The AutomationExecutionId of the parent automation.</p>
     */
     ...
     * <p>The Amazon Resource Name (ARN) of the user who ran the automation.</p>
     *
     * @return <p>The Amazon Resource Name (ARN) of the user who ran the automation.</p>
     */
     ...
     * <p>The Amazon Resource Name (ARN) of the user who ran the automation.</p>
     *
     * @param executedBy <p>The Amazon Resource Name (ARN) of the user who ran the automation.</p>
     */
     ...
     * <p>The name of the step that is currently running.</p>
     *
     * @return <p>The name of the step that is currently running.</p>
     */
     ...
     * <p>The name of the step that is currently running.</p>
     *
     * @param currentStepName <p>The name of the step that is currently running.</p>
     */
     ...
     * <p>The action of the step that is currently running.</p>
     *
     * @return <p>The action of the step that is currently running.</p>
     */
     ...
     * <p>The action of the step that is currently running.</p>
     *
     * @param currentAction <p>The action of the step that is currently running.</p>
     */
     ...
     * <b>Length: </b>1 - 50<br/>
     *
     * @param targetParameterName <p>The parameter name.</p>
     */
     ...
     * <p>The specified targets.</p>
     *
     * @return <p>The specified targets.</p>
     */
     ...
     * <p>The specified targets.</p>
     *
     * @param targets <p>The specified targets.</p>
     */
     ...
     * <p>The specified key-value mapping of document parameters to target resources.</p>
     *
     * @return <p>The specified key-value mapping of document parameters to target resources.</p>
     */
     ...
     * <p>The specified key-value mapping of document parameters to target resources.</p>
     *
     * @param targetMaps <p>The specified key-value mapping of document parameters to target resources.</p>
     */
    public void setTargetMaps(java.util.Collection<java.util.Map<String, java.util.List<String>>> targetMaps) {
        ...
        this.targetMaps = new java.util.ArrayList<java.util.Map<String, java.util.List<String>>>(targetMaps);
    }
    ...
    public AutomationExecution withTargetMaps(java.util.Map<String, java.util.List<String>>... targetMaps) {
        if (getTargetMaps() == null) {
            this.targetMaps = new java.util.ArrayList<java.util.Map<String, java.util.List<String>>>(targetMaps.length);
        }
     ...
     * <p>A list of resolved targets in the rate control execution.</p>
     *
     * @return <p>A list of resolved targets in the rate control execution.</p>
     */
     ...
     * <p>A list of resolved targets in the rate control execution.</p>
     *
     * @param resolvedTargets <p>A list of resolved targets in the rate control execution.</p>
     */
     ...
     * <b>Pattern: </b>^([1-9][0-9]*|[1-9][0-9]%|[1-9]%|100%)$<br/>
     *
     * @return <p>The MaxConcurrency value specified by the user when the execution started.</p>
     */
     ...
     * <b>Pattern: </b>^([1-9][0-9]*|[1-9][0-9]%|[1-9]%|100%)$<br/>
     *
     * @param maxConcurrency <p>The MaxConcurrency value specified by the user when the execution started.</p>
     */
     ...
     * <b>Pattern: </b>^([1-9][0-9]*|[0]|[1-9][0-9]%|[0-9]%|100%)$<br/>
     *
     * @return <p>The MaxErrors value specified by the user when the execution started.</p>
     */
     ...
     * <b>Pattern: </b>^([1-9][0-9]*|[0]|[1-9][0-9]%|[0-9]%|100%)$<br/>
     *
     * @param maxErrors <p>The MaxErrors value specified by the user when the execution started.</p>
     */
     ...
     * <p>The target of the execution.</p>
     *
     * @return <p>The target of the execution.</p>
     */
     ...
     * <p>The target of the execution.</p>
     *
     * @param target <p>The target of the execution.</p>
     */
     ...
     * <p>The combination of AWS Regions and/or AWS accounts where you want to run the Automation.</p>
     *
     * @return <p>The combination of AWS Regions and/or AWS accounts where you want to run the Automation.</p>
     */
     ...
     * <p>The combination of AWS Regions and/or AWS accounts where you want to run the Automation.</p>
     *
     * @param targetLocations <p>The combination of AWS Regions and/or AWS accounts where you want to run the Automation.</p>
     */
     ...
     * <p>An aggregate of step execution statuses displayed in the AWS Console for a multi-Region and multi-account Automation execution.</p>
     *
     * @return <p>An aggregate of step execution statuses displayed in the AWS Console for a multi-Region and multi-account Automation execution.</p>
     */
     ...
     * <p>An aggregate of step execution statuses displayed in the AWS Console for a multi-Region and multi-account Automation execution.</p>
     *
     * @param progressCounters <p>An aggregate of step execution statuses displayed in the AWS Console for a multi-Region and multi-account Automation execution.</p>
     */
    ...
    public String toString() {
        ...
        if (getExecutionStartTime() != null) sb.append("ExecutionStartTime: " + getExecutionStartTime() + ",");
        if (getExecutionEndTime() != null) sb.append("ExecutionEndTime: " + getExecutionEndTime() + ",");
        if (getAutomationExecutionStatus() != null) sb.append("AutomationExecutionStatus: " + getAutomationExecutionStatus() + ",");
        if (getStepExecutions() != null) sb.append("StepExecutions: " + getStepExecutions() + ",");
        if (getStepExecutionsTruncated() != null) sb.append("StepExecutionsTruncated: " + getStepExecutionsTruncated() + ",");
        ...
        if (getParentAutomationExecutionId() != null) sb.append("ParentAutomationExecutionId: " + getParentAutomationExecutionId() + ",");
        if (getExecutedBy() != null) sb.append("ExecutedBy: " + getExecutedBy() + ",");
        if (getCurrentStepName() != null) sb.append("CurrentStepName: " + getCurrentStepName() + ",");
        if (getCurrentAction() != null) sb.append("CurrentAction: " + getCurrentAction() + ",");
        if (getTargetParameterName() != null) sb.append("TargetParameterName: " + getTargetParameterName() + ",");
        if (getTargets() != null) sb.append("Targets: " + getTargets() + ",");
        if (getTargetMaps() != null) sb.append("TargetMaps: " + getTargetMaps() + ",");
        if (getResolvedTargets() != null) sb.append("ResolvedTargets: " + getResolvedTargets() + ",");
        ...
        if (getTargetLocations() != null) sb.append("TargetLocations: " + getTargetLocations() + ",");
        if (getProgressCounters() != null) sb.append("ProgressCounters: " + getProgressCounters());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AutomationExecution == false) return false;
        ...
        if (other.getExecutionStartTime() == null ^ this.getExecutionStartTime() == null) return false;
        if (other.getExecutionStartTime() != null && other.getExecutionStartTime().equals(this.getExecutionStartTime()) == false) return false;
        if (other.getExecutionEndTime() == null ^ this.getExecutionEndTime() == null) return false;
        if (other.getExecutionEndTime() != null && other.getExecutionEndTime().equals(this.getExecutionEndTime()) == false) return false;
        if (other.getAutomationExecutionStatus() == null ^ this.getAutomationExecutionStatus() == null) return false;
        if (other.getAutomationExecutionStatus() != null && other.getAutomationExecutionStatus().equals(this.getAutomationExecutionStatus()) == false) return false;
        ...
        if (other.getStepExecutionsTruncated() == null ^ this.getStepExecutionsTruncated() == null) return false;
        if (other.getStepExecutionsTruncated() != null && other.getStepExecutionsTruncated().equals(this.getStepExecutionsTruncated()) == false) return false;
        ...
        if (other.getParentAutomationExecutionId() == null ^ this.getParentAutomationExecutionId() == null) return false;
        if (other.getParentAutomationExecutionId() != null && other.getParentAutomationExecutionId().equals(this.getParentAutomationExecutionId()) == false) return false;
        if (other.getExecutedBy() == null ^ this.getExecutedBy() == null) return false;
        if (other.getExecutedBy() != null && other.getExecutedBy().equals(this.getExecutedBy()) == false) return false;
        if (other.getCurrentStepName() == null ^ this.getCurrentStepName() == null) return false;
        if (other.getCurrentStepName() != null && other.getCurrentStepName().equals(this.getCurrentStepName()) == false) return false;
        if (other.getCurrentAction() == null ^ this.getCurrentAction() == null) return false;
        if (other.getCurrentAction() != null && other.getCurrentAction().equals(this.getCurrentAction()) == false) return false;
        if (other.getTargetParameterName() == null ^ this.getTargetParameterName() == null) return false;
        if (other.getTargetParameterName() != null && other.getTargetParameterName().equals(this.getTargetParameterName()) == false) return false;
        ...
        if (other.getTargetMaps() == null ^ this.getTargetMaps() == null) return false;
        if (other.getTargetMaps() != null && other.getTargetMaps().equals(this.getTargetMaps()) == false) return false;
        if (other.getResolvedTargets() == null ^ this.getResolvedTargets() == null) return false;
        if (other.getResolvedTargets() != null && other.getResolvedTargets().equals(this.getResolvedTargets()) == false) return false;
        ...
        if (other.getTargetLocations() == null ^ this.getTargetLocations() == null) return false;
        if (other.getTargetLocations() != null && other.getTargetLocations().equals(this.getTargetLocations()) == false) return false;
        if (other.getProgressCounters() == null ^ this.getProgressCounters() == null) return false;
        if (other.getProgressCounters() != null && other.getProgressCounters().equals(this.getProgressCounters()) == false) return false;
        return true;
    }
}
