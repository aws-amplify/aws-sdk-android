...
public class GetDocumentResult implements Serializable {
     ...
     * <b>Allowed Values: </b>Creating, Active, Updating, Deleting, Failed
     *
     * @return <p>The status of the Systems Manager document, such as <code>Creating</code>, <code>Active</code>, <code>Updating</code>, <code>Failed</code>, and <code>Deleting</code>.</p>
     *
     * @see DocumentStatus
     */
     ...
     * <b>Allowed Values: </b>Creating, Active, Updating, Deleting, Failed
     *
     * @param status <p>The status of the Systems Manager document, such as <code>Creating</code>, <code>Active</code>, <code>Updating</code>, <code>Failed</code>, and <code>Deleting</code>.</p>
     *
     * @see DocumentStatus
     */
     ...
     * <b>Length: </b>1 - <br/>
     *
     * @return <p>The contents of the Systems Manager document.</p>
     */
     ...
     * <b>Length: </b>1 - <br/>
     *
     * @param content <p>The contents of the Systems Manager document.</p>
     */
     ...
     * <p>A description of the document attachments, including names, locations, sizes, and so on.</p>
     *
     * @return <p>A description of the document attachments, including names, locations, sizes, and so on.</p>
     */
     ...
     * <p>A description of the document attachments, including names, locations, sizes, and so on.</p>
     *
     * @param attachmentsContent <p>A description of the document attachments, including names, locations, sizes, and so on.</p>
     */
    ...
    public GetDocumentResult withAttachmentsContent(AttachmentContent... attachmentsContent) {
        if (getAttachmentsContent() == null) {
            this.attachmentsContent = new java.util.ArrayList<AttachmentContent>(attachmentsContent.length);
        }
    ...
    public String toString() {
        ...
        if (getAttachmentsContent() != null) sb.append("AttachmentsContent: " + getAttachmentsContent());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAttachmentsContent() == null ^ this.getAttachmentsContent() == null) return false;
        if (other.getAttachmentsContent() != null && other.getAttachmentsContent().equals(this.getAttachmentsContent()) == false) return false;
        return true;
    }
}
