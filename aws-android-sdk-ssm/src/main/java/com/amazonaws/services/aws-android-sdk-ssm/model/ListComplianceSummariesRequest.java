 ...
 */
public class ListComplianceSummariesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * <p>One or more compliance or inventory filters. Use a filter to return a more specific list of results.</p>
     *
     * @return <p>One or more compliance or inventory filters. Use a filter to return a more specific list of results.</p>
     */
     ...
     * <p>One or more compliance or inventory filters. Use a filter to return a more specific list of results.</p>
     *
     * @param filters <p>One or more compliance or inventory filters. Use a filter to return a more specific list of results.</p>
     */
     ...
     * <b>Range: </b>1 - 50<br/>
     *
     * @return <p>The maximum number of items to return for this call. Currently, you can specify null or 50. The call also returns a token that you can specify in a subsequent call to get the next set of results.</p>
     */
     ...
     * <b>Range: </b>1 - 50<br/>
     *
     * @param maxResults <p>The maximum number of items to return for this call. Currently, you can specify null or 50. The call also returns a token that you can specify in a subsequent call to get the next set of results.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListComplianceSummariesRequest == false) return false;
