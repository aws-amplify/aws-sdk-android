 ...
 */
class AttachmentInformationJsonUnmarshaller implements Unmarshaller<AttachmentInformation, JsonUnmarshallerContext> {
...
.unmarshall(context));
    ...
    public static AttachmentInformationJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AttachmentInformationJsonUnmarshaller();
        return instance;
    }
}
