...
public class StartAutomationExecutionRequestMarshaller implements Marshaller<Request<StartAutomationExecutionRequest>, StartAutomationExecutionRequest> {
    ...
    public Request<StartAutomationExecutionRequest> marshall(StartAutomationExecutionRequest startAutomationExecutionRequest) {
        if (startAutomationExecutionRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(StartAutomationExecutionRequest)");
        }

        Request<StartAutomationExecutionRequest> request = new DefaultRequest<StartAutomationExecutionRequest>(startAutomationExecutionRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (startAutomationExecutionRequest.getParameters() != null) {
                java.util.Map<String, java.util.List<String>> parameters = startAutomationExecutionRequest.getParameters();
            ...
            if (startAutomationExecutionRequest.getTargetParameterName() != null) {
                String targetParameterName = startAutomationExecutionRequest.getTargetParameterName();
            ...
            if (startAutomationExecutionRequest.getTargetMaps() != null) {
                java.util.List<java.util.Map<String, java.util.List<String>>> targetMaps = startAutomationExecutionRequest.getTargetMaps();
            ...
            if (startAutomationExecutionRequest.getTargetLocations() != null) {
                java.util.List<TargetLocation> targetLocations = startAutomationExecutionRequest.getTargetLocations();
