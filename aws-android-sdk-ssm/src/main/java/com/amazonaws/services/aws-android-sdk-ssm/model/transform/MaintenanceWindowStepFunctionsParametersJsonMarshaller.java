...
class MaintenanceWindowStepFunctionsParametersJsonMarshaller {
    ...
    public void marshall(MaintenanceWindowStepFunctionsParameters maintenanceWindowStepFunctionsParameters, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static MaintenanceWindowStepFunctionsParametersJsonMarshaller getInstance() {
        if (instance == null) instance = new MaintenanceWindowStepFunctionsParametersJsonMarshaller();
        return instance;
    }
}
