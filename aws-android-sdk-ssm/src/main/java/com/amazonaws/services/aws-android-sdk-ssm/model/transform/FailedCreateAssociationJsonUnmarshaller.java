 ...
 */
class FailedCreateAssociationJsonUnmarshaller implements Unmarshaller<FailedCreateAssociation, JsonUnmarshallerContext> {
    ...
    public FailedCreateAssociation unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Entry")) {
                failedCreateAssociation.setEntry(CreateAssociationBatchRequestEntryJsonUnmarshaller.getInstance()
.unmarshall(context));
