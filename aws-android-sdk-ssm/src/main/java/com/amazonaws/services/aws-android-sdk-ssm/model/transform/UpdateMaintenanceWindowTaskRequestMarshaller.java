 ...
 */
public class UpdateMaintenanceWindowTaskRequestMarshaller implements Marshaller<Request<UpdateMaintenanceWindowTaskRequest>, UpdateMaintenanceWindowTaskRequest> {
    ...
    public Request<UpdateMaintenanceWindowTaskRequest> marshall(UpdateMaintenanceWindowTaskRequest updateMaintenanceWindowTaskRequest) {
        if (updateMaintenanceWindowTaskRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(UpdateMaintenanceWindowTaskRequest)");
        }

        Request<UpdateMaintenanceWindowTaskRequest> request = new DefaultRequest<UpdateMaintenanceWindowTaskRequest>(updateMaintenanceWindowTaskRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (updateMaintenanceWindowTaskRequest.getTaskParameters() != null) {
                java.util.Map<String, MaintenanceWindowTaskParameterValueExpression> taskParameters = updateMaintenanceWindowTaskRequest.getTaskParameters();
            ...
            if (updateMaintenanceWindowTaskRequest.getTaskInvocationParameters() != null) {
                MaintenanceWindowTaskInvocationParameters taskInvocationParameters = updateMaintenanceWindowTaskRequest.getTaskInvocationParameters();
