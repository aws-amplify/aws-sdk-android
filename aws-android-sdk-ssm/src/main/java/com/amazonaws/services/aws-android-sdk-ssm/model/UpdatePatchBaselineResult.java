...
public class UpdatePatchBaselineResult implements Serializable {
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-:/]{20,128}$<br/>
     *
     * @return <p>The ID of the deleted patch baseline.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-:/]{20,128}$<br/>
     *
     * @param baselineId <p>The ID of the deleted patch baseline.</p>
     */
     ...
     * <b>Allowed Values: </b>WINDOWS, AMAZON_LINUX, AMAZON_LINUX_2, UBUNTU, REDHAT_ENTERPRISE_LINUX, SUSE, CENTOS, ORACLE_LINUX, DEBIAN
     *
     * @return <p>The operating system rule used by the updated patch baseline.</p>
     *
     * @see OperatingSystem
     */
     ...
     * <b>Allowed Values: </b>WINDOWS, AMAZON_LINUX, AMAZON_LINUX_2, UBUNTU, REDHAT_ENTERPRISE_LINUX, SUSE, CENTOS, ORACLE_LINUX, DEBIAN
     *
     * @param operatingSystem <p>The operating system rule used by the updated patch baseline.</p>
     *
     * @see OperatingSystem
     */
     ...
     * <b>Allowed Values: </b>CRITICAL, HIGH, MEDIUM, LOW, INFORMATIONAL, UNSPECIFIED
     *
     * @return <p>The compliance severity level assigned to the patch baseline after the update completed.</p>
     *
     ...
     * <b>Allowed Values: </b>CRITICAL, HIGH, MEDIUM, LOW, INFORMATIONAL, UNSPECIFIED
     *
     * @param approvedPatchesComplianceLevel <p>The compliance severity level assigned to the patch baseline after the update completed.</p>
     *
     * @see PatchComplianceLevel
     */
     ...
     * <p>The date when the patch baseline was created.</p>
     *
     * @return <p>The date when the patch baseline was created.</p>
     */
     ...
     * <p>The date when the patch baseline was created.</p>
     *
     * @param createdDate <p>The date when the patch baseline was created.</p>
     */
     ...
     * <p>The date when the patch baseline was last modified.</p>
     *
     * @return <p>The date when the patch baseline was last modified.</p>
     */
     ...
     * <p>The date when the patch baseline was last modified.</p>
     *
     * @param modifiedDate <p>The date when the patch baseline was last modified.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePatchBaselineResult == false) return false;
