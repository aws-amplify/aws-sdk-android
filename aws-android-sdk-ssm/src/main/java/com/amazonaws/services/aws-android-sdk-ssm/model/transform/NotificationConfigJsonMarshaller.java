...
class NotificationConfigJsonMarshaller {
    ...
    public void marshall(NotificationConfig notificationConfig, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static NotificationConfigJsonMarshaller getInstance() {
        if (instance == null) instance = new NotificationConfigJsonMarshaller();
        return instance;
    }
}
