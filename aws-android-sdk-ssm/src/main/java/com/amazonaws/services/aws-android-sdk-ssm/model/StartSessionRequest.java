...
public class StartSessionRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Length: </b>1 - 400<br/>
     *
     * @return <p>The instance to connect to for the session.</p>
     */
     ...
     * <b>Length: </b>1 - 400<br/>
     *
     * @param target <p>The instance to connect to for the session.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.:/]{3,128}$<br/>
     *
     * @return <p>The name of the SSM document to define the parameters and plugin settings for the session. For example, <code>SSM-SessionManagerRunShell</code>. You can call the <a>GetDocument</a> API to verify the document exists before attempting to start a session. If no document name is provided, a shell to the instance is launched by default.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.:/]{3,128}$<br/>
     *
     * @param documentName <p>The name of the SSM document to define the parameters and plugin settings for the session. For example, <code>SSM-SessionManagerRunShell</code>. You can call the <a>GetDocument</a> API to verify the document exists before attempting to start a session. If no document name is provided, a shell to the instance is launched by default.</p>
     */
     ...
     * <p>Reserved for future use.</p>
     *
     * @param parameters <p>Reserved for future use.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartSessionRequest == false) return false;
