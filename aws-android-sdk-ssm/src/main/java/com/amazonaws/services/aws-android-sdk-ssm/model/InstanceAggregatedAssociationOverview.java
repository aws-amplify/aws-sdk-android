...
public class InstanceAggregatedAssociationOverview implements Serializable {
     ...
     * <p>Detailed status information about the aggregated associations.</p>
     *
     * @return <p>Detailed status information about the aggregated associations.</p>
     */
     ...
     * <p>Detailed status information about the aggregated associations.</p>
     *
     * @param detailedStatus <p>Detailed status information about the aggregated associations.</p>
     */
     ...
     * <p>The number of associations for the instance(s).</p>
     *
     * @return <p>The number of associations for the instance(s).</p>
     */
     ...
     * <p>The number of associations for the instance(s).</p>
     *
     * @param instanceAssociationStatusAggregatedCount <p>The number of associations for the instance(s).</p>
     */
     ...
     * @return A reference to this updated object so that method calls can be chained together.
     */
    public InstanceAggregatedAssociationOverview withInstanceAssociationStatusAggregatedCount(java.util.Map<String, Integer> instanceAssociationStatusAggregatedCount) {
        this.instanceAssociationStatusAggregatedCount = instanceAssociationStatusAggregatedCount;
        return this;
    }
     ...
     * <p>The number of associations for the instance(s).</p>
     * <p>
     * The method adds a new key-value pair into InstanceAssociationStatusAggregatedCount parameter, and returns a reference to this object so that method calls can be chained together.
     *
     * @param key The key of the entry to be added into InstanceAssociationStatusAggregatedCount.
     * @param value The corresponding value of the entry to be added into InstanceAssociationStatusAggregatedCount.
     *
     * @return A reference to this updated object so that method calls can be chained together.
     */
    ...
    public String toString() {
        ...
        if (getInstanceAssociationStatusAggregatedCount() != null) sb.append("InstanceAssociationStatusAggregatedCount: " + getInstanceAssociationStatusAggregatedCount());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InstanceAggregatedAssociationOverview == false) return false;
        ...
        if (other.getInstanceAssociationStatusAggregatedCount() == null ^ this.getInstanceAssociationStatusAggregatedCount() == null) return false;
        if (other.getInstanceAssociationStatusAggregatedCount() != null && other.getInstanceAssociationStatusAggregatedCount().equals(this.getInstanceAssociationStatusAggregatedCount()) == false) return false;
        return true;
    }
}
