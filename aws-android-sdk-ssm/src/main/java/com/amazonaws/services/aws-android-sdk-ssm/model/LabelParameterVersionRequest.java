...
public class LabelParameterVersionRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Length: </b>1 - 2048<br/>
     *
     * @return <p>The parameter name on which you want to attach one or more labels.</p>
     */
     ...
     * <b>Length: </b>1 - 2048<br/>
     *
     * @param name <p>The parameter name on which you want to attach one or more labels.</p>
     */
     ...
     * <p>The specific version of the parameter on which you want to attach one or more labels. If no version is specified, the system attaches the label to the latest version.</p>
     *
     * @return <p>The specific version of the parameter on which you want to attach one or more labels. If no version is specified, the system attaches the label to the latest version.</p>
     */
     ...
     * <p>The specific version of the parameter on which you want to attach one or more labels. If no version is specified, the system attaches the label to the latest version.</p>
     *
     * @param parameterVersion <p>The specific version of the parameter on which you want to attach one or more labels. If no version is specified, the system attaches the label to the latest version.</p>
     */
     ...
     * <p>One or more labels to attach to the specified parameter version.</p>
     *
     * @return <p>One or more labels to attach to the specified parameter version.</p>
     */
     ...
     * <p>One or more labels to attach to the specified parameter version.</p>
     *
     * @param labels <p>One or more labels to attach to the specified parameter version.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LabelParameterVersionRequest == false) return false;
