...
public class UpdateMaintenanceWindowRequestMarshaller implements Marshaller<Request<UpdateMaintenanceWindowRequest>, UpdateMaintenanceWindowRequest> {
    ...
    public Request<UpdateMaintenanceWindowRequest> marshall(UpdateMaintenanceWindowRequest updateMaintenanceWindowRequest) {
        if (updateMaintenanceWindowRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(UpdateMaintenanceWindowRequest)");
        }

        Request<UpdateMaintenanceWindowRequest> request = new DefaultRequest<UpdateMaintenanceWindowRequest>(updateMaintenanceWindowRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (updateMaintenanceWindowRequest.getScheduleOffset() != null) {
                Integer scheduleOffset = updateMaintenanceWindowRequest.getScheduleOffset();
            ...
            if (updateMaintenanceWindowRequest.getAllowUnassociatedTargets() != null) {
                Boolean allowUnassociatedTargets = updateMaintenanceWindowRequest.getAllowUnassociatedTargets();
