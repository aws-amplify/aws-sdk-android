 ...
 */
class PatchFilterGroupJsonUnmarshaller implements Unmarshaller<PatchFilterGroup, JsonUnmarshallerContext> {
...
.unmarshall(context));
    ...
    public static PatchFilterGroupJsonUnmarshaller getInstance() {
        if (instance == null) instance = new PatchFilterGroupJsonUnmarshaller();
        return instance;
    }
}
