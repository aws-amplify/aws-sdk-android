...
public class ListInventoryEntriesRequestMarshaller implements Marshaller<Request<ListInventoryEntriesRequest>, ListInventoryEntriesRequest> {
    ...
    public Request<ListInventoryEntriesRequest> marshall(ListInventoryEntriesRequest listInventoryEntriesRequest) {
        if (listInventoryEntriesRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(ListInventoryEntriesRequest)");
        }

        Request<ListInventoryEntriesRequest> request = new DefaultRequest<ListInventoryEntriesRequest>(listInventoryEntriesRequest, "AmazonSimpleSystemsManager(SSM)");
