    ...
    public UpdateMaintenanceWindowTargetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("WindowId")) {
                updateMaintenanceWindowTargetResult.setWindowId(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("WindowTargetId")) {
                updateMaintenanceWindowTargetResult.setWindowTargetId(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                updateMaintenanceWindowTargetResult.setOwnerInformation(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Name")) {
                updateMaintenanceWindowTargetResult.setName(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Description")) {
                updateMaintenanceWindowTargetResult.setDescription(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static UpdateMaintenanceWindowTargetResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new UpdateMaintenanceWindowTargetResultJsonUnmarshaller();
        return instance;
    }
}
