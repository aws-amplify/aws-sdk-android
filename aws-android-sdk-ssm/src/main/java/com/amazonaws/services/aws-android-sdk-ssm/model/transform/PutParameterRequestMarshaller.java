...
public class PutParameterRequestMarshaller implements Marshaller<Request<PutParameterRequest>, PutParameterRequest> {
    ...
    public Request<PutParameterRequest> marshall(PutParameterRequest putParameterRequest) {
        if (putParameterRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(PutParameterRequest)");
        }

        Request<PutParameterRequest> request = new DefaultRequest<PutParameterRequest>(putParameterRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (putParameterRequest.getDataType() != null) {
                String dataType = putParameterRequest.getDataType();
