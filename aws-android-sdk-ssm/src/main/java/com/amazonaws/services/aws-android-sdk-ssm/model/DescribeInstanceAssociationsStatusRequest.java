 ...
 */
public class DescribeInstanceAssociationsStatusRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * <b>Pattern: </b>(^i-(\w{8}|\w{17})$)|(^mi-\w{17}$)<br/>
     *
     * @return <p>The instance IDs for which you want association status information.</p>
     */
     ...
     * <b>Pattern: </b>(^i-(\w{8}|\w{17})$)|(^mi-\w{17}$)<br/>
     *
     * @param instanceId <p>The instance IDs for which you want association status information.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeInstanceAssociationsStatusRequest == false) return false;
