...
public class ListDocumentVersionsResult implements Serializable {
     ...
     * <p>The document versions.</p>
     *
     * @return <p>The document versions.</p>
     */
     ...
     * <p>The document versions.</p>
     *
     * @param documentVersions <p>The document versions.</p>
     */
    ...
    public ListDocumentVersionsResult withDocumentVersions(DocumentVersionInfo... documentVersions) {
        if (getDocumentVersions() == null) {
            this.documentVersions = new java.util.ArrayList<DocumentVersionInfo>(documentVersions.length);
        }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getDocumentVersions() != null) sb.append("DocumentVersions: " + getDocumentVersions() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDocumentVersionsResult == false) return false;
        ListDocumentVersionsResult other = (ListDocumentVersionsResult)obj;

        if (other.getDocumentVersions() == null ^ this.getDocumentVersions() == null) return false;
        if (other.getDocumentVersions() != null && other.getDocumentVersions().equals(this.getDocumentVersions()) == false) return false;
