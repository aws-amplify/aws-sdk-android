...
class OpsResultAttributeJsonMarshaller {
    ...
    public void marshall(OpsResultAttribute opsResultAttribute, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static OpsResultAttributeJsonMarshaller getInstance() {
        if (instance == null) instance = new OpsResultAttributeJsonMarshaller();
        return instance;
    }
}
