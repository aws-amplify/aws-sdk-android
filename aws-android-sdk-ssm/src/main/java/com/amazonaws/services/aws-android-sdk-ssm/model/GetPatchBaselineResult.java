...
public class GetPatchBaselineResult implements Serializable {
    /**
     ...
     */
    private java.util.List<String> patchGroups;
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-:/]{20,128}$<br/>
     *
     * @return <p>The ID of the retrieved patch baseline.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-:/]{20,128}$<br/>
     *
     * @param baselineId <p>The ID of the retrieved patch baseline.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.]{3,128}$<br/>
     *
     * @param name <p>The name of the patch baseline.</p>
     */
     ...
     * <b>Allowed Values: </b>WINDOWS, AMAZON_LINUX, AMAZON_LINUX_2, UBUNTU, REDHAT_ENTERPRISE_LINUX, SUSE, CENTOS, ORACLE_LINUX, DEBIAN
     *
     * @return <p>Returns the operating system specified for the patch baseline.</p>
     *
     * @see OperatingSystem
     */
     ...
     * <b>Allowed Values: </b>WINDOWS, AMAZON_LINUX, AMAZON_LINUX_2, UBUNTU, REDHAT_ENTERPRISE_LINUX, SUSE, CENTOS, ORACLE_LINUX, DEBIAN
     *
     * @param operatingSystem <p>Returns the operating system specified for the patch baseline.</p>
     *
     * @see OperatingSystem
     */
     ...
     * <p>A set of global filters used to exclude patches from the baseline.</p>
     *
     * @return <p>A set of global filters used to exclude patches from the baseline.</p>
     */
     ...
     * <p>A set of global filters used to exclude patches from the baseline.</p>
     *
     * @param globalFilters <p>A set of global filters used to exclude patches from the baseline.</p>
     */
     ...
     * <p>A set of rules used to include patches in the baseline.</p>
     *
     * @return <p>A set of rules used to include patches in the baseline.</p>
     */
     ...
     * <p>A set of rules used to include patches in the baseline.</p>
     *
     * @param approvalRules <p>A set of rules used to include patches in the baseline.</p>
     */
     ...
     * <p>A list of explicitly approved patches for the baseline.</p>
     *
     * @return <p>A list of explicitly approved patches for the baseline.</p>
     */
     ...
     * <p>A list of explicitly approved patches for the baseline.</p>
     *
     * @param approvedPatches <p>A list of explicitly approved patches for the baseline.</p>
     */
     ...
     * <b>Allowed Values: </b>CRITICAL, HIGH, MEDIUM, LOW, INFORMATIONAL, UNSPECIFIED
     *
     * @return <p>Returns the specified compliance severity level for approved patches in the patch baseline.</p>
     *
     ...
     * <b>Allowed Values: </b>CRITICAL, HIGH, MEDIUM, LOW, INFORMATIONAL, UNSPECIFIED
     *
     * @param approvedPatchesComplianceLevel <p>Returns the specified compliance severity level for approved patches in the patch baseline.</p>
     *
     * @see PatchComplianceLevel
     */
     ...
     * <p>Indicates whether the list of approved patches includes non-security updates that should be applied to the instances. The default value is 'false'. Applies to Linux instances only.</p>
     *
     * @return <p>Indicates whether the list of approved patches includes non-security updates that should be applied to the instances. The default value is 'false'. Applies to Linux instances only.</p>
     */
     ...
     * <p>Indicates whether the list of approved patches includes non-security updates that should be applied to the instances. The default value is 'false'. Applies to Linux instances only.</p>
     *
     * @param approvedPatchesEnableNonSecurity <p>Indicates whether the list of approved patches includes non-security updates that should be applied to the instances. The default value is 'false'. Applies to Linux instances only.</p>
     */
     ...
     * <p>A list of explicitly rejected patches for the baseline.</p>
     *
     * @return <p>A list of explicitly rejected patches for the baseline.</p>
     */
     ...
     * <p>A list of explicitly rejected patches for the baseline.</p>
     *
     * @param rejectedPatches <p>A list of explicitly rejected patches for the baseline.</p>
     */
     ...
     * <b>Allowed Values: </b>ALLOW_AS_DEPENDENCY, BLOCK
     *
     * @return <p>The action specified to take on patches included in the RejectedPatches list. A patch can be allowed only if it is a dependency of another package, or blocked entirely along with packages that include it as a dependency.</p>
     *
     * @see PatchAction
     */
     ...
     * <b>Allowed Values: </b>ALLOW_AS_DEPENDENCY, BLOCK
     *
     * @param rejectedPatchesAction <p>The action specified to take on patches included in the RejectedPatches list. A patch can be allowed only if it is a dependency of another package, or blocked entirely along with packages that include it as a dependency.</p>
     *
     * @see PatchAction
     */
     ...
     * <p>Patch groups included in the patch baseline.</p>
     *
     * @return <p>Patch groups included in the patch baseline.</p>
     */
     ...
     * <p>Patch groups included in the patch baseline.</p>
     *
     * @param patchGroups <p>Patch groups included in the patch baseline.</p>
     */
    public void setPatchGroups(java.util.Collection<String> patchGroups) {
        ...
        this.patchGroups = new java.util.ArrayList<String>(patchGroups);
    }
    ...
    public GetPatchBaselineResult withPatchGroups(String... patchGroups) {
        if (getPatchGroups() == null) {
            this.patchGroups = new java.util.ArrayList<String>(patchGroups.length);
        }
        for (String value : patchGroups) {
            this.patchGroups.add(value);
        }
        return this;
    }
     ...
     * <p>The date the patch baseline was created.</p>
     *
     * @return <p>The date the patch baseline was created.</p>
     */
     ...
     * <p>The date the patch baseline was created.</p>
     *
     * @param createdDate <p>The date the patch baseline was created.</p>
     */
     ...
     * <p>The date the patch baseline was last modified.</p>
     *
     * @return <p>The date the patch baseline was last modified.</p>
     */
     ...
     * <p>The date the patch baseline was last modified.</p>
     *
     * @param modifiedDate <p>The date the patch baseline was last modified.</p>
     */
     ...
     * <b>Length: </b>1 - 1024<br/>
     *
     * @return <p>A description of the patch baseline.</p>
     */
     ...
     * <b>Length: </b>1 - 1024<br/>
     *
     * @param description <p>A description of the patch baseline.</p>
     */
     ...
     * <p>Information about the patches to use to update the instances, including target operating systems and source repositories. Applies to Linux instances only.</p>
     *
     * @return <p>Information about the patches to use to update the instances, including target operating systems and source repositories. Applies to Linux instances only.</p>
     */
     ...
     * <p>Information about the patches to use to update the instances, including target operating systems and source repositories. Applies to Linux instances only.</p>
     *
     * @param sources <p>Information about the patches to use to update the instances, including target operating systems and source repositories. Applies to Linux instances only.</p>
     */
    ...
    public String toString() {
        ...
        if (getGlobalFilters() != null) sb.append("GlobalFilters: " + getGlobalFilters() + ",");
        if (getApprovalRules() != null) sb.append("ApprovalRules: " + getApprovalRules() + ",");
        if (getApprovedPatches() != null) sb.append("ApprovedPatches: " + getApprovedPatches() + ",");
        if (getApprovedPatchesComplianceLevel() != null) sb.append("ApprovedPatchesComplianceLevel: " + getApprovedPatchesComplianceLevel() + ",");
        if (getApprovedPatchesEnableNonSecurity() != null) sb.append("ApprovedPatchesEnableNonSecurity: " + getApprovedPatchesEnableNonSecurity() + ",");
        if (getRejectedPatches() != null) sb.append("RejectedPatches: " + getRejectedPatches() + ",");
        if (getRejectedPatchesAction() != null) sb.append("RejectedPatchesAction: " + getRejectedPatchesAction() + ",");
        if (getPatchGroups() != null) sb.append("PatchGroups: " + getPatchGroups() + ",");
        if (getCreatedDate() != null) sb.append("CreatedDate: " + getCreatedDate() + ",");
        if (getModifiedDate() != null) sb.append("ModifiedDate: " + getModifiedDate() + ",");
        if (getDescription() != null) sb.append("Description: " + getDescription() + ",");
        if (getSources() != null) sb.append("Sources: " + getSources());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPatchBaselineResult == false) return false;
        ...
        if (other.getGlobalFilters() == null ^ this.getGlobalFilters() == null) return false;
        if (other.getGlobalFilters() != null && other.getGlobalFilters().equals(this.getGlobalFilters()) == false) return false;
        if (other.getApprovalRules() == null ^ this.getApprovalRules() == null) return false;
        if (other.getApprovalRules() != null && other.getApprovalRules().equals(this.getApprovalRules()) == false) return false;
        if (other.getApprovedPatches() == null ^ this.getApprovedPatches() == null) return false;
        if (other.getApprovedPatches() != null && other.getApprovedPatches().equals(this.getApprovedPatches()) == false) return false;
        if (other.getApprovedPatchesComplianceLevel() == null ^ this.getApprovedPatchesComplianceLevel() == null) return false;
        if (other.getApprovedPatchesComplianceLevel() != null && other.getApprovedPatchesComplianceLevel().equals(this.getApprovedPatchesComplianceLevel()) == false) return false;
        if (other.getApprovedPatchesEnableNonSecurity() == null ^ this.getApprovedPatchesEnableNonSecurity() == null) return false;
        if (other.getApprovedPatchesEnableNonSecurity() != null && other.getApprovedPatchesEnableNonSecurity().equals(this.getApprovedPatchesEnableNonSecurity()) == false) return false;
        if (other.getRejectedPatches() == null ^ this.getRejectedPatches() == null) return false;
        if (other.getRejectedPatches() != null && other.getRejectedPatches().equals(this.getRejectedPatches()) == false) return false;
        if (other.getRejectedPatchesAction() == null ^ this.getRejectedPatchesAction() == null) return false;
        if (other.getRejectedPatchesAction() != null && other.getRejectedPatchesAction().equals(this.getRejectedPatchesAction()) == false) return false;
        if (other.getPatchGroups() == null ^ this.getPatchGroups() == null) return false;
        if (other.getPatchGroups() != null && other.getPatchGroups().equals(this.getPatchGroups()) == false) return false;
        ...
        if (other.getModifiedDate() == null ^ this.getModifiedDate() == null) return false;
        if (other.getModifiedDate() != null && other.getModifiedDate().equals(this.getModifiedDate()) == false) return false;
        if (other.getDescription() == null ^ this.getDescription() == null) return false;
        if (other.getDescription() != null && other.getDescription().equals(this.getDescription()) == false) return false;
        if (other.getSources() == null ^ this.getSources() == null) return false;
        if (other.getSources() != null && other.getSources().equals(this.getSources()) == false) return false;
        return true;
    }
}
