 ...
 */
public class GetAutomationExecutionRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @return <p>The unique identifier for an existing automation execution to examine. The execution ID is returned by StartAutomationExecution when the execution of an Automation document is initiated.</p>
     */
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @param automationExecutionId <p>The unique identifier for an existing automation execution to examine. The execution ID is returned by StartAutomationExecution when the execution of an Automation document is initiated.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAutomationExecutionRequest == false) return false;
