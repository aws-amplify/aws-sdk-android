 ...
 */
public class DeregisterManagedInstanceRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * <b>Pattern: </b>^mi-[0-9a-f]{17}$<br/>
     *
     * @return <p>The ID assigned to the managed instance when you registered it using the activation process. </p>
     */
     ...
     * <b>Pattern: </b>^mi-[0-9a-f]{17}$<br/>
     *
     * @param instanceId <p>The ID assigned to the managed instance when you registered it using the activation process. </p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeregisterManagedInstanceRequest == false) return false;
