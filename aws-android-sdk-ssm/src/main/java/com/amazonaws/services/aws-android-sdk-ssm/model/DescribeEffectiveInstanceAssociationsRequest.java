 ...
 */
public class DescribeEffectiveInstanceAssociationsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * <b>Pattern: </b>(^i-(\w{8}|\w{17})$)|(^mi-\w{17}$)<br/>
     *
     * @return <p>The instance ID for which you want to view all associations.</p>
     */
     ...
     * <b>Pattern: </b>(^i-(\w{8}|\w{17})$)|(^mi-\w{17}$)<br/>
     *
     * @param instanceId <p>The instance ID for which you want to view all associations.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeEffectiveInstanceAssociationsRequest == false) return false;
