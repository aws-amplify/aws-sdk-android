    ...
    public ListResourceComplianceSummariesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ResourceComplianceSummaryItems")) {
                listResourceComplianceSummariesResult.setResourceComplianceSummaryItems(new ListUnmarshaller<ResourceComplianceSummaryItem>(ResourceComplianceSummaryItemJsonUnmarshaller.getInstance()
)
.unmarshall(context));
            } else if (name.equals("NextToken")) {
                listResourceComplianceSummariesResult.setNextToken(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static ListResourceComplianceSummariesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListResourceComplianceSummariesResultJsonUnmarshaller();
        return instance;
    }
}
