...
class CompliantSummaryJsonMarshaller {
    ...
    public void marshall(CompliantSummary compliantSummary, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static CompliantSummaryJsonMarshaller getInstance() {
        if (instance == null) instance = new CompliantSummaryJsonMarshaller();
        return instance;
    }
}
