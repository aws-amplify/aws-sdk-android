...
.unmarshall(context));
                ...
                updatePatchBaselineResult.setGlobalFilters(PatchFilterGroupJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("ApprovalRules")) {
                updatePatchBaselineResult.setApprovalRules(PatchRuleGroupJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("ApprovedPatches")) {
                updatePatchBaselineResult.setApprovedPatches(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
.unmarshall(context));
            } else if (name.equals("ApprovedPatchesComplianceLevel")) {
                updatePatchBaselineResult.setApprovedPatchesComplianceLevel(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("ApprovedPatchesEnableNonSecurity")) {
                updatePatchBaselineResult.setApprovedPatchesEnableNonSecurity(BooleanJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("RejectedPatches")) {
                updatePatchBaselineResult.setRejectedPatches(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
.unmarshall(context));
            } else if (name.equals("RejectedPatchesAction")) {
                updatePatchBaselineResult.setRejectedPatchesAction(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static UpdatePatchBaselineResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new UpdatePatchBaselineResultJsonUnmarshaller();
        return instance;
    }
}
