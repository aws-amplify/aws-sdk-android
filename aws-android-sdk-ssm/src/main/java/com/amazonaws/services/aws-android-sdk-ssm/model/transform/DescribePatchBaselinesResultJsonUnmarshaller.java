    ...
    public DescribePatchBaselinesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("BaselineIdentities")) {
                describePatchBaselinesResult.setBaselineIdentities(new ListUnmarshaller<PatchBaselineIdentity>(PatchBaselineIdentityJsonUnmarshaller.getInstance()
)
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static DescribePatchBaselinesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribePatchBaselinesResultJsonUnmarshaller();
        return instance;
    }
}
