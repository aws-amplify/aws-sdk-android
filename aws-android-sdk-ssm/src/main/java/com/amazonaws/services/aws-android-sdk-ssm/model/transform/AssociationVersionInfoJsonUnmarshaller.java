 ...
 */
class AssociationVersionInfoJsonUnmarshaller implements Unmarshaller<AssociationVersionInfo, JsonUnmarshallerContext> {
...
.unmarshall(context));
                ...
                associationVersionInfo.setParameters(new MapUnmarshaller<java.util.List<String>>(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
)
.unmarshall(context));
...
.unmarshall(context));
                ...
                associationVersionInfo.setOutputLocation(InstanceAssociationOutputLocationJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                associationVersionInfo.setApplyOnlyAtCronInterval(BooleanJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static AssociationVersionInfoJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AssociationVersionInfoJsonUnmarshaller();
        return instance;
    }
}
