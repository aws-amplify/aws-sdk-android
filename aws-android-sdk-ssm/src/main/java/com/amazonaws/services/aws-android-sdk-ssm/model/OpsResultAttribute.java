 ...
 */
public class OpsResultAttribute implements Serializable {
    /**
     ...
     * <b>Pattern: </b>^(AWS|Custom):.*$<br/>
     *
     * @return <p>Name of the data type. Valid value: AWS:OpsItem, AWS:EC2InstanceInformation, AWS:OpsItemTrendline, or AWS:ComplianceSummary.</p>
     */
     ...
     * <b>Pattern: </b>^(AWS|Custom):.*$<br/>
     *
     * @param typeName <p>Name of the data type. Valid value: AWS:OpsItem, AWS:EC2InstanceInformation, AWS:OpsItemTrendline, or AWS:ComplianceSummary.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OpsResultAttribute == false) return false;
