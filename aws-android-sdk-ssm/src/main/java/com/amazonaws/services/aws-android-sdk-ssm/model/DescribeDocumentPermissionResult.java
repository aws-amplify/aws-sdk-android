...
public class DescribeDocumentPermissionResult implements Serializable {
     ...
     * <p>The account IDs that have permission to use this document. The ID can be either an AWS account or <i>All</i>.</p>
     *
     * @return <p>The account IDs that have permission to use this document. The ID can be either an AWS account or <i>All</i>.</p>
     */
     ...
     * <p>The account IDs that have permission to use this document. The ID can be either an AWS account or <i>All</i>.</p>
     *
     * @param accountIds <p>The account IDs that have permission to use this document. The ID can be either an AWS account or <i>All</i>.</p>
     */
     ...
     * <p>A list of AWS accounts where the current document is shared and the version shared with each account.</p>
     *
     * @return <p>A list of AWS accounts where the current document is shared and the version shared with each account.</p>
     */
     ...
     * <p>A list of AWS accounts where the current document is shared and the version shared with each account.</p>
     *
     * @param accountSharingInfoList <p>A list of AWS accounts where the current document is shared and the version shared with each account.</p>
     */
    public void setAccountSharingInfoList(java.util.Collection<AccountSharingInfo> accountSharingInfoList) {
        ...
        this.accountSharingInfoList = new java.util.ArrayList<AccountSharingInfo>(accountSharingInfoList);
    }
    ...
    public DescribeDocumentPermissionResult withAccountSharingInfoList(AccountSharingInfo... accountSharingInfoList) {
        if (getAccountSharingInfoList() == null) {
            this.accountSharingInfoList = new java.util.ArrayList<AccountSharingInfo>(accountSharingInfoList.length);
        }
    ...
    public String toString() {
        ...
        if (getAccountSharingInfoList() != null) sb.append("AccountSharingInfoList: " + getAccountSharingInfoList());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeDocumentPermissionResult == false) return false;
        ...
        if (other.getAccountSharingInfoList() == null ^ this.getAccountSharingInfoList() == null) return false;
        if (other.getAccountSharingInfoList() != null && other.getAccountSharingInfoList().equals(this.getAccountSharingInfoList()) == false) return false;
        return true;
    }
}
