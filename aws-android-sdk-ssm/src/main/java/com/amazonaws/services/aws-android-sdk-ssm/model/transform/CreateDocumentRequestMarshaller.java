...
public class CreateDocumentRequestMarshaller implements Marshaller<Request<CreateDocumentRequest>, CreateDocumentRequest> {
    ...
    public Request<CreateDocumentRequest> marshall(CreateDocumentRequest createDocumentRequest) {
        if (createDocumentRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(CreateDocumentRequest)");
        }

        Request<CreateDocumentRequest> request = new DefaultRequest<CreateDocumentRequest>(createDocumentRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (createDocumentRequest.getAttachments() != null) {
                java.util.List<AttachmentsSource> attachments = createDocumentRequest.getAttachments();
                jsonWriter.name("Attachments");
            jsonWriter.beginArray();
            for (AttachmentsSource attachmentsItem : attachments) {
                if (attachmentsItem != null) {
            AttachmentsSourceJsonMarshaller.getInstance().marshall(attachmentsItem, jsonWriter);
                    }
            }
            jsonWriter.endArray();
            }
