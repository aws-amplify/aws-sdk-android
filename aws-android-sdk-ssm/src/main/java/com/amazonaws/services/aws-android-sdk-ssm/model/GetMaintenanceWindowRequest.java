 ...
 */
public class GetMaintenanceWindowRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * <b>Pattern: </b>^mw-[0-9a-f]{17}$<br/>
     *
     * @return <p>The ID of the maintenance window for which you want to retrieve information.</p>
     */
     ...
     * <b>Pattern: </b>^mw-[0-9a-f]{17}$<br/>
     *
     * @param windowId <p>The ID of the maintenance window for which you want to retrieve information.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetMaintenanceWindowRequest == false) return false;
