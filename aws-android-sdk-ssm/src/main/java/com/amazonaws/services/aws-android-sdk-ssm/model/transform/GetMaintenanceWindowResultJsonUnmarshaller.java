...
.unmarshall(context));
                ...
                getMaintenanceWindowResult.setNextExecutionTime(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                getMaintenanceWindowResult.setAllowUnassociatedTargets(BooleanJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static GetMaintenanceWindowResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new GetMaintenanceWindowResultJsonUnmarshaller();
        return instance;
    }
}
