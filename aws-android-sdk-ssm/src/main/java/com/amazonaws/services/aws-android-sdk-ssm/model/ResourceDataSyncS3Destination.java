...
public class ResourceDataSyncS3Destination implements Serializable {
     ...
     * <b>Length: </b>1 - 2048<br/>
     *
     * @return <p>The name of the S3 bucket where the aggregated data is stored.</p>
     */
     ...
     * <b>Length: </b>1 - 2048<br/>
     *
     * @param bucketName <p>The name of the S3 bucket where the aggregated data is stored.</p>
     */
     ...
     * <b>Length: </b>1 - 256<br/>
     *
     * @return <p>An Amazon S3 prefix for the bucket.</p>
     */
     ...
     * <b>Length: </b>1 - 256<br/>
     *
     * @param prefix <p>An Amazon S3 prefix for the bucket.</p>
     */
     ...
     * <b>Allowed Values: </b>JsonSerDe
     *
     * @return <p>A supported sync format. The following format is currently supported: JsonSerDe</p>
     *
     ...
     * <b>Allowed Values: </b>JsonSerDe
     *
     * @param syncFormat <p>A supported sync format. The following format is currently supported: JsonSerDe</p>
     *
     * @see ResourceDataSyncS3Format
     */
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @return <p>The AWS Region with the S3 bucket targeted by the Resource Data Sync.</p>
     */
     ...
     * <b>Length: </b>1 - 64<br/>
     *
     * @param region <p>The AWS Region with the S3 bucket targeted by the Resource Data Sync.</p>
     */
     ...
     * <b>Pattern: </b>arn:.*<br/>
     *
     * @return <p>The ARN of an encryption key for a destination in Amazon S3. Must belong to the same Region as the destination S3 bucket.</p>
     */
     ...
     * <b>Pattern: </b>arn:.*<br/>
     *
     * @param aWSKMSKeyARN <p>The ARN of an encryption key for a destination in Amazon S3. Must belong to the same Region as the destination S3 bucket.</p>
     */
     ...
     * <p>Enables destination data sharing. By default, this field is <code>null</code>.</p>
     *
     * @return <p>Enables destination data sharing. By default, this field is <code>null</code>.</p>
     */
     ...
     * <p>Enables destination data sharing. By default, this field is <code>null</code>.</p>
     *
     * @param destinationDataSharing <p>Enables destination data sharing. By default, this field is <code>null</code>.</p>
     */
    ...
    public String toString() {
        ...
        if (getSyncFormat() != null) sb.append("SyncFormat: " + getSyncFormat() + ",");
        if (getRegion() != null) sb.append("Region: " + getRegion() + ",");
        if (getAWSKMSKeyARN() != null) sb.append("AWSKMSKeyARN: " + getAWSKMSKeyARN() + ",");
        if (getDestinationDataSharing() != null) sb.append("DestinationDataSharing: " + getDestinationDataSharing());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResourceDataSyncS3Destination == false) return false;
        ...
        if (other.getSyncFormat() == null ^ this.getSyncFormat() == null) return false;
        if (other.getSyncFormat() != null && other.getSyncFormat().equals(this.getSyncFormat()) == false) return false;
        ...
        if (other.getDestinationDataSharing() == null ^ this.getDestinationDataSharing() == null) return false;
        if (other.getDestinationDataSharing() != null && other.getDestinationDataSharing().equals(this.getDestinationDataSharing()) == false) return false;
        return true;
    }
}
