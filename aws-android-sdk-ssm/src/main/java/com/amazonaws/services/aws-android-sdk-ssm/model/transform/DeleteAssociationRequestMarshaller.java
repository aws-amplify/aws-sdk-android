...
/**
 * JSON request marshaller for DeleteAssociationRequest
 */
public class DeleteAssociationRequestMarshaller implements Marshaller<Request<DeleteAssociationRequest>, DeleteAssociationRequest> {
    ...
    public Request<DeleteAssociationRequest> marshall(DeleteAssociationRequest deleteAssociationRequest) {
        if (deleteAssociationRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(DeleteAssociationRequest)");
        }

        Request<DeleteAssociationRequest> request = new DefaultRequest<DeleteAssociationRequest>(deleteAssociationRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (deleteAssociationRequest.getName() != null) {
                String name = deleteAssociationRequest.getName();
                jsonWriter.name("Name");
            jsonWriter.value(name);
            }
            if (deleteAssociationRequest.getInstanceId() != null) {
                String instanceId = deleteAssociationRequest.getInstanceId();
                jsonWriter.name("InstanceId");
            jsonWriter.value(instanceId);
            }
            if (deleteAssociationRequest.getAssociationId() != null) {
                String associationId = deleteAssociationRequest.getAssociationId();
