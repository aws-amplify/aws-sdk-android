...
.unmarshall(context));
                ...
                updateMaintenanceWindowTaskResult.setWindowTaskId(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                updateMaintenanceWindowTaskResult.setServiceRoleArn(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("TaskParameters")) {
                updateMaintenanceWindowTaskResult.setTaskParameters(new MapUnmarshaller<MaintenanceWindowTaskParameterValueExpression>(MaintenanceWindowTaskParameterValueExpressionJsonUnmarshaller.getInstance()
)
.unmarshall(context));
...
.unmarshall(context));
                ...
                updateMaintenanceWindowTaskResult.setMaxConcurrency(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                updateMaintenanceWindowTaskResult.setLoggingInfo(LoggingInfoJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Name")) {
                updateMaintenanceWindowTaskResult.setName(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Description")) {
                updateMaintenanceWindowTaskResult.setDescription(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static UpdateMaintenanceWindowTaskResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new UpdateMaintenanceWindowTaskResultJsonUnmarshaller();
        return instance;
    }
}
