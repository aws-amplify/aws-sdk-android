 ...
 */
public class GetOpsSummaryRequestMarshaller implements Marshaller<Request<GetOpsSummaryRequest>, GetOpsSummaryRequest> {

    public Request<GetOpsSummaryRequest> marshall(GetOpsSummaryRequest getOpsSummaryRequest) {
        if (getOpsSummaryRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(GetOpsSummaryRequest)");
        }

        Request<GetOpsSummaryRequest> request = new DefaultRequest<GetOpsSummaryRequest>(getOpsSummaryRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (getOpsSummaryRequest.getResultAttributes() != null) {
                java.util.List<OpsResultAttribute> resultAttributes = getOpsSummaryRequest.getResultAttributes();
                jsonWriter.name("ResultAttributes");
            jsonWriter.beginArray();
            for (OpsResultAttribute resultAttributesItem : resultAttributes) {
                if (resultAttributesItem != null) {
            OpsResultAttributeJsonMarshaller.getInstance().marshall(resultAttributesItem, jsonWriter);
                    }
            }
            jsonWriter.endArray();
            }
