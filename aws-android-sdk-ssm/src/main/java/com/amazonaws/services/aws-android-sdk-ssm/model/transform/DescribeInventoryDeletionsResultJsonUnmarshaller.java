    ...
    public DescribeInventoryDeletionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("InventoryDeletions")) {
                describeInventoryDeletionsResult.setInventoryDeletions(new ListUnmarshaller<InventoryDeletionStatusItem>(InventoryDeletionStatusItemJsonUnmarshaller.getInstance()
)
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static DescribeInventoryDeletionsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeInventoryDeletionsResultJsonUnmarshaller();
        return instance;
    }
}
