 ...
 */
class ServiceSettingJsonUnmarshaller implements Unmarshaller<ServiceSetting, JsonUnmarshallerContext> {
...
.unmarshall(context));
    ...
    public static ServiceSettingJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ServiceSettingJsonUnmarshaller();
        return instance;
    }
}
