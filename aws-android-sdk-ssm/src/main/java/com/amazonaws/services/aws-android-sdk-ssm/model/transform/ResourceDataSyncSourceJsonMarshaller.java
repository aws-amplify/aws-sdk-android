...
class ResourceDataSyncSourceJsonMarshaller {
    ...
    public void marshall(ResourceDataSyncSource resourceDataSyncSource, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (resourceDataSyncSource.getAwsOrganizationsSource() != null) {
            ResourceDataSyncAwsOrganizationsSource awsOrganizationsSource = resourceDataSyncSource.getAwsOrganizationsSource();
    ...
    public static ResourceDataSyncSourceJsonMarshaller getInstance() {
        if (instance == null) instance = new ResourceDataSyncSourceJsonMarshaller();
        return instance;
    }
}
