...
public class ModifyDocumentPermissionRequestMarshaller implements Marshaller<Request<ModifyDocumentPermissionRequest>, ModifyDocumentPermissionRequest> {
    ...
    public Request<ModifyDocumentPermissionRequest> marshall(ModifyDocumentPermissionRequest modifyDocumentPermissionRequest) {
        if (modifyDocumentPermissionRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(ModifyDocumentPermissionRequest)");
        }

        Request<ModifyDocumentPermissionRequest> request = new DefaultRequest<ModifyDocumentPermissionRequest>(modifyDocumentPermissionRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (modifyDocumentPermissionRequest.getAccountIdsToAdd() != null) {
                java.util.List<String> accountIdsToAdd = modifyDocumentPermissionRequest.getAccountIdsToAdd();
            ...
            if (modifyDocumentPermissionRequest.getAccountIdsToRemove() != null) {
                java.util.List<String> accountIdsToRemove = modifyDocumentPermissionRequest.getAccountIdsToRemove();
            ...
            if (modifyDocumentPermissionRequest.getSharedDocumentVersion() != null) {
                String sharedDocumentVersion = modifyDocumentPermissionRequest.getSharedDocumentVersion();
