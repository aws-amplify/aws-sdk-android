...
public class ListComplianceSummariesResult implements Serializable {
     ...
     * <p>A list of compliant and non-compliant summary counts based on compliance types. For example, this call returns State Manager associations, patches, or custom compliance types according to the filter criteria that you specified.</p>
     *
     * @return <p>A list of compliant and non-compliant summary counts based on compliance types. For example, this call returns State Manager associations, patches, or custom compliance types according to the filter criteria that you specified.</p>
     */
     ...
     * <p>A list of compliant and non-compliant summary counts based on compliance types. For example, this call returns State Manager associations, patches, or custom compliance types according to the filter criteria that you specified.</p>
     *
     * @param complianceSummaryItems <p>A list of compliant and non-compliant summary counts based on compliance types. For example, this call returns State Manager associations, patches, or custom compliance types according to the filter criteria that you specified.</p>
     */
    public void setComplianceSummaryItems(java.util.Collection<ComplianceSummaryItem> complianceSummaryItems) {
        ...
        this.complianceSummaryItems = new java.util.ArrayList<ComplianceSummaryItem>(complianceSummaryItems);
    }
    ...
    public ListComplianceSummariesResult withComplianceSummaryItems(ComplianceSummaryItem... complianceSummaryItems) {
        if (getComplianceSummaryItems() == null) {
            this.complianceSummaryItems = new java.util.ArrayList<ComplianceSummaryItem>(complianceSummaryItems.length);
        }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getComplianceSummaryItems() != null) sb.append("ComplianceSummaryItems: " + getComplianceSummaryItems() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListComplianceSummariesResult == false) return false;
        ListComplianceSummariesResult other = (ListComplianceSummariesResult)obj;

        if (other.getComplianceSummaryItems() == null ^ this.getComplianceSummaryItems() == null) return false;
        if (other.getComplianceSummaryItems() != null && other.getComplianceSummaryItems().equals(this.getComplianceSummaryItems()) == false) return false;
