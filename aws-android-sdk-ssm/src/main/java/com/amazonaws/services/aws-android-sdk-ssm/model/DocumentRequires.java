...
public class DocumentRequires implements Serializable {
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.:/]{3,128}$<br/>
     *
     * @return <p>The name of the required SSM document. The name can be an Amazon Resource Name (ARN).</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.:/]{3,128}$<br/>
     *
     * @param name <p>The name of the required SSM document. The name can be an Amazon Resource Name (ARN).</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @return <p>The document version required by the current document.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @param version <p>The document version required by the current document.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DocumentRequires == false) return false;
