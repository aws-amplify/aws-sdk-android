...
public class CompliantSummary implements Serializable {
     ...
     * <p>The total number of resources that are compliant.</p>
     *
     * @return <p>The total number of resources that are compliant.</p>
     */
     ...
     * <p>The total number of resources that are compliant.</p>
     *
     * @param compliantCount <p>The total number of resources that are compliant.</p>
     */
     ...
     * <p>A summary of the compliance severity by compliance type.</p>
     *
     * @return <p>A summary of the compliance severity by compliance type.</p>
     */
     ...
     * <p>A summary of the compliance severity by compliance type.</p>
     *
     * @param severitySummary <p>A summary of the compliance severity by compliance type.</p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getCompliantCount() != null) sb.append("CompliantCount: " + getCompliantCount() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CompliantSummary == false) return false;
        CompliantSummary other = (CompliantSummary)obj;

        if (other.getCompliantCount() == null ^ this.getCompliantCount() == null) return false;
        if (other.getCompliantCount() != null && other.getCompliantCount().equals(this.getCompliantCount()) == false) return false;
