...
class StepExecutionJsonMarshaller {
    ...
    public void marshall(StepExecution stepExecution, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (stepExecution.getOverriddenParameters() != null) {
            java.util.Map<String, java.util.List<String>> overriddenParameters = stepExecution.getOverriddenParameters();
            jsonWriter.name("OverriddenParameters");
            jsonWriter.beginObject();
            for (java.util.Map.Entry<String, java.util.List<String>> overriddenParametersEntry : overriddenParameters.entrySet()) {
                java.util.List<String> overriddenParametersValue = overriddenParametersEntry.getValue();
    ...
    public static StepExecutionJsonMarshaller getInstance() {
        if (instance == null) instance = new StepExecutionJsonMarshaller();
        return instance;
    }
}
