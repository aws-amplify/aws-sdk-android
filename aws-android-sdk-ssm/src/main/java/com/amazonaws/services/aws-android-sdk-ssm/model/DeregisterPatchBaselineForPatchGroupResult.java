...
public class DeregisterPatchBaselineForPatchGroupResult implements Serializable {
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-:/]{20,128}$<br/>
     *
     * @return <p>The ID of the patch baseline the patch group was deregistered from.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-:/]{20,128}$<br/>
     *
     * @param baselineId <p>The ID of the patch baseline the patch group was deregistered from.</p>
     */
     ...
     * <b>Pattern: </b>^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$<br/>
     *
     * @return <p>The name of the patch group deregistered from the patch baseline.</p>
     */
     ...
     * <b>Pattern: </b>^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$<br/>
     *
     * @param patchGroup <p>The name of the patch group deregistered from the patch baseline.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeregisterPatchBaselineForPatchGroupResult == false) return false;
