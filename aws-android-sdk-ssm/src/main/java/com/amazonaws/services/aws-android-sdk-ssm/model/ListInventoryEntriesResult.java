...
public class ListInventoryEntriesResult implements Serializable {
     ...
     * <b>Pattern: </b>^(AWS|Custom):.*$<br/>
     *
     * @return <p>The type of inventory item returned by the request.</p>
     */
     ...
     * <b>Pattern: </b>^(AWS|Custom):.*$<br/>
     *
     * @param typeName <p>The type of inventory item returned by the request.</p>
     */
     ...
     * <b>Pattern: </b>(^i-(\w{8}|\w{17})$)|(^mi-\w{17}$)<br/>
     *
     * @return <p>The instance ID targeted by the request to query inventory information.</p>
     */
     ...
     * <b>Pattern: </b>(^i-(\w{8}|\w{17})$)|(^mi-\w{17}$)<br/>
     *
     * @param instanceId <p>The instance ID targeted by the request to query inventory information.</p>
     */
     ...
     * <b>Pattern: </b>^([0-9]{1,6})(\.[0-9]{1,6})$<br/>
     *
     * @return <p>The inventory schema version used by the instance(s).</p>
     */
     ...
     * <b>Pattern: </b>^([0-9]{1,6})(\.[0-9]{1,6})$<br/>
     *
     * @param schemaVersion <p>The inventory schema version used by the instance(s).</p>
     */
     ...
     * <b>Pattern: </b>^(20)[0-9][0-9]-(0[1-9]|1[012])-([12][0-9]|3[01]|0[1-9])(T)(2[0-3]|[0-1][0-9])(:[0-5][0-9])(:[0-5][0-9])(Z)$<br/>
     *
     * @return <p>The time that inventory information was collected for the instance(s).</p>
     */
     ...
     * <b>Pattern: </b>^(20)[0-9][0-9]-(0[1-9]|1[012])-([12][0-9]|3[01]|0[1-9])(T)(2[0-3]|[0-1][0-9])(:[0-5][0-9])(:[0-5][0-9])(Z)$<br/>
     *
     * @param captureTime <p>The time that inventory information was collected for the instance(s).</p>
     */
     ...
     * <p>A list of inventory items on the instance(s).</p>
     *
     * @return <p>A list of inventory items on the instance(s).</p>
     */
     ...
     * <p>A list of inventory items on the instance(s).</p>
     *
     * @param entries <p>A list of inventory items on the instance(s).</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListInventoryEntriesResult == false) return false;
