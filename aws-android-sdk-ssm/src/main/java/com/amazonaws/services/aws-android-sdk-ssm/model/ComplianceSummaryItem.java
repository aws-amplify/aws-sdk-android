...
public class ComplianceSummaryItem implements Serializable {
     ...
     * <b>Pattern: </b>[A-Za-z0-9_\-]\w+|Custom:[a-zA-Z0-9_\-]\w+<br/>
     *
     * @return <p>The type of compliance item. For example, the compliance type can be Association, Patch, or Custom:string.</p>
     */
     ...
     * <b>Pattern: </b>[A-Za-z0-9_\-]\w+|Custom:[a-zA-Z0-9_\-]\w+<br/>
     *
     * @param complianceType <p>The type of compliance item. For example, the compliance type can be Association, Patch, or Custom:string.</p>
     */
     ...
     * <p>A list of COMPLIANT items for the specified compliance type.</p>
     *
     * @return <p>A list of COMPLIANT items for the specified compliance type.</p>
     */
     ...
     * <p>A list of COMPLIANT items for the specified compliance type.</p>
     *
     * @param compliantSummary <p>A list of COMPLIANT items for the specified compliance type.</p>
     */
     ...
     * <p>A list of NON_COMPLIANT items for the specified compliance type.</p>
     *
     * @return <p>A list of NON_COMPLIANT items for the specified compliance type.</p>
     */
     ...
     * <p>A list of NON_COMPLIANT items for the specified compliance type.</p>
     *
     * @param nonCompliantSummary <p>A list of NON_COMPLIANT items for the specified compliance type.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ComplianceSummaryItem == false) return false;
