...
class PatchBaselineIdentityJsonMarshaller {
    ...
    public void marshall(PatchBaselineIdentity patchBaselineIdentity, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static PatchBaselineIdentityJsonMarshaller getInstance() {
        if (instance == null) instance = new PatchBaselineIdentityJsonMarshaller();
        return instance;
    }
}
