...
public class PutInventoryRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Pattern: </b>(^i-(\w{8}|\w{17})$)|(^mi-\w{17}$)<br/>
     *
     * @return <p>An instance ID where you want to add or update inventory items.</p>
     */
     ...
     * <b>Pattern: </b>(^i-(\w{8}|\w{17})$)|(^mi-\w{17}$)<br/>
     *
     * @param instanceId <p>An instance ID where you want to add or update inventory items.</p>
     */
     ...
     * <p>The inventory items that you want to add or update on instances.</p>
     *
     * @return <p>The inventory items that you want to add or update on instances.</p>
     */
     ...
     * <p>The inventory items that you want to add or update on instances.</p>
     *
     * @param items <p>The inventory items that you want to add or update on instances.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutInventoryRequest == false) return false;
