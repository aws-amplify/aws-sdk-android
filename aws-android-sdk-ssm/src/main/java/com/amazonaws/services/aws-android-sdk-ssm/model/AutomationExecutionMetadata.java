...
public class AutomationExecutionMetadata implements Serializable {
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.]{3,128}$<br/>
     *
     * @return <p>The name of the Automation document used during execution.</p>
     */
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-.]{3,128}$<br/>
     *
     * @param documentName <p>The name of the Automation document used during execution.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @return <p>The document version used during the execution.</p>
     */
     ...
     * <b>Pattern: </b>([$]LATEST|[$]DEFAULT|^[1-9][0-9]*$)<br/>
     *
     * @param documentVersion <p>The document version used during the execution.</p>
     */
     ...
     * <b>Allowed Values: </b>Pending, InProgress, Waiting, Success, TimedOut, Cancelling, Cancelled, Failed
     *
     * @return <p>The status of the execution.</p>
     *
     ...
     * <b>Allowed Values: </b>Pending, InProgress, Waiting, Success, TimedOut, Cancelling, Cancelled, Failed
     *
     * @param automationExecutionStatus <p>The status of the execution.</p>
     *
     * @see AutomationExecutionStatus
     */
     ...
     * <p>The time the execution finished. This is not populated if the execution is still in progress.</p>
     *
     * @return <p>The time the execution finished. This is not populated if the execution is still in progress.</p>
     */
     ...
     * <p>The time the execution finished. This is not populated if the execution is still in progress.</p>
     *
     * @param executionEndTime <p>The time the execution finished. This is not populated if the execution is still in progress.</p>
     */
     ...
     * <p>The IAM role ARN of the user who ran the Automation.</p>
     *
     * @return <p>The IAM role ARN of the user who ran the Automation.</p>
     */
     ...
     * <p>The IAM role ARN of the user who ran the Automation.</p>
     *
     * @param executedBy <p>The IAM role ARN of the user who ran the Automation.</p>
     */
     ...
     * <p>An S3 bucket where execution information is stored.</p>
     *
     * @return <p>An S3 bucket where execution information is stored.</p>
     */
     ...
     * <p>An S3 bucket where execution information is stored.</p>
     *
     * @param logFile <p>An S3 bucket where execution information is stored.</p>
     */
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @return <p>The ExecutionId of the parent Automation.</p>
     */
     ...
     * <b>Length: </b>36 - 36<br/>
     *
     * @param parentAutomationExecutionId <p>The ExecutionId of the parent Automation.</p>
     */
     ...
     * <p>The list of execution outputs as defined in the Automation document.</p>
     *
     * @param failureMessage <p>The list of execution outputs as defined in the Automation document.</p>
     */
     ...
     * <b>Length: </b>1 - 50<br/>
     *
     * @param targetParameterName <p>The list of execution outputs as defined in the Automation document.</p>
     */
     ...
     * <p>The targets defined by the user when starting the Automation.</p>
     *
     * @return <p>The targets defined by the user when starting the Automation.</p>
     */
     ...
     * <p>The targets defined by the user when starting the Automation.</p>
     *
     * @param targets <p>The targets defined by the user when starting the Automation.</p>
     */
     ...
     * <p>A list of targets that resolved during the execution.</p>
     *
     * @return <p>A list of targets that resolved during the execution.</p>
     */
     ...
     * <p>A list of targets that resolved during the execution.</p>
     *
     * @param resolvedTargets <p>A list of targets that resolved during the execution.</p>
     */
     ...
     * <b>Pattern: </b>^([1-9][0-9]*|[1-9][0-9]%|[1-9]%|100%)$<br/>
     *
     * @return <p>The MaxConcurrency value specified by the user when starting the Automation.</p>
     */
     ...
     * <b>Pattern: </b>^([1-9][0-9]*|[1-9][0-9]%|[1-9]%|100%)$<br/>
     *
     * @param maxConcurrency <p>The MaxConcurrency value specified by the user when starting the Automation.</p>
     */
     ...
     * <b>Pattern: </b>^([1-9][0-9]*|[0]|[1-9][0-9]%|[0-9]%|100%)$<br/>
     *
     * @return <p>The MaxErrors value specified by the user when starting the Automation.</p>
     */
     ...
     * <b>Pattern: </b>^([1-9][0-9]*|[0]|[1-9][0-9]%|[0-9]%|100%)$<br/>
     *
     * @param maxErrors <p>The MaxErrors value specified by the user when starting the Automation.</p>
     */
     ...
     * <p>The list of execution outputs as defined in the Automation document.</p>
     *
     * @param target <p>The list of execution outputs as defined in the Automation document.</p>
     */
     ...
     * <b>Allowed Values: </b>CrossAccount, Local
     *
     * @return <p>Use this filter with <a>DescribeAutomationExecutions</a>. Specify either Local or CrossAccount. CrossAccount is an Automation that runs in multiple AWS Regions and accounts. For more information, see <a href="https://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-automation-multiple-accounts-and-regions.html">Running Automation workflows in multiple AWS Regions and accounts</a> in the <i>AWS Systems Manager User Guide</i>. </p>
     *
     * @see AutomationType
     */
     ...
     * <b>Allowed Values: </b>CrossAccount, Local
     *
     * @param automationType <p>Use this filter with <a>DescribeAutomationExecutions</a>. Specify either Local or CrossAccount. CrossAccount is an Automation that runs in multiple AWS Regions and accounts. For more information, see <a href="https://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-automation-multiple-accounts-and-regions.html">Running Automation workflows in multiple AWS Regions and accounts</a> in the <i>AWS Systems Manager User Guide</i>. </p>
     *
     * @see AutomationType
     */
    ...
    public String toString() {
        ...
        if (getLogFile() != null) sb.append("LogFile: " + getLogFile() + ",");
        ...
        if (getAutomationType() != null) sb.append("AutomationType: " + getAutomationType());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AutomationExecutionMetadata == false) return false;
        ...
        if (other.getLogFile() == null ^ this.getLogFile() == null) return false;
        if (other.getLogFile() != null && other.getLogFile().equals(this.getLogFile()) == false) return false;
        ...
        if (other.getAutomationType() == null ^ this.getAutomationType() == null) return false;
        if (other.getAutomationType() != null && other.getAutomationType().equals(this.getAutomationType()) == false) return false;
        return true;
    }
}
