...
public class DescribeEffectivePatchesForPatchBaselineResult implements Serializable {
     ...
     * <p>An array of patches and patch status.</p>
     *
     * @return <p>An array of patches and patch status.</p>
     */
     ...
     * <p>An array of patches and patch status.</p>
     *
     * @param effectivePatches <p>An array of patches and patch status.</p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getEffectivePatches() != null) sb.append("EffectivePatches: " + getEffectivePatches() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeEffectivePatchesForPatchBaselineResult == false) return false;
        DescribeEffectivePatchesForPatchBaselineResult other = (DescribeEffectivePatchesForPatchBaselineResult)obj;

        if (other.getEffectivePatches() == null ^ this.getEffectivePatches() == null) return false;
        if (other.getEffectivePatches() != null && other.getEffectivePatches().equals(this.getEffectivePatches()) == false) return false;
