 ...
 */
class AutomationExecutionMetadataJsonUnmarshaller implements Unmarshaller<AutomationExecutionMetadata, JsonUnmarshallerContext> {
    ...
    public AutomationExecutionMetadata unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AutomationExecutionId")) {
                automationExecutionMetadata.setAutomationExecutionId(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                automationExecutionMetadata.setAutomationExecutionStatus(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("ExecutionStartTime")) {
                automationExecutionMetadata.setExecutionStartTime(DateJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                automationExecutionMetadata.setOutputs(new MapUnmarshaller<java.util.List<String>>(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
)
.unmarshall(context));
...
.unmarshall(context));
                ...
                automationExecutionMetadata.setParentAutomationExecutionId(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                automationExecutionMetadata.setTargetParameterName(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                automationExecutionMetadata.setTargetMaps(new ListUnmarshaller<java.util.Map<String, java.util.List<String>>>(new MapUnmarshaller<java.util.List<String>>(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
)
)
.unmarshall(context));
            } else if (name.equals("ResolvedTargets")) {
                automationExecutionMetadata.setResolvedTargets(ResolvedTargetsJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static AutomationExecutionMetadataJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AutomationExecutionMetadataJsonUnmarshaller();
        return instance;
    }
}
