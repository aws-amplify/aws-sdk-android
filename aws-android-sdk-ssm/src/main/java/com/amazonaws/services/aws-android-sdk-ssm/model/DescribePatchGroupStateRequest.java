 ...
 */
public class DescribePatchGroupStateRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * <b>Pattern: </b>^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$<br/>
     *
     * @return <p>The name of the patch group whose patch snapshot should be retrieved.</p>
     */
     ...
     * <b>Pattern: </b>^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$<br/>
     *
     * @param patchGroup <p>The name of the patch group whose patch snapshot should be retrieved.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribePatchGroupStateRequest == false) return false;
