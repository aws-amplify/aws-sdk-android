 ...
 */
class OpsItemSummaryJsonUnmarshaller implements Unmarshaller<OpsItemSummary, JsonUnmarshallerContext> {
...
.unmarshall(context));
                ...
                opsItemSummary.setOperationalData(new MapUnmarshaller<OpsItemDataValue>(OpsItemDataValueJsonUnmarshaller.getInstance()
)
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static OpsItemSummaryJsonUnmarshaller getInstance() {
        if (instance == null) instance = new OpsItemSummaryJsonUnmarshaller();
        return instance;
    }
}
