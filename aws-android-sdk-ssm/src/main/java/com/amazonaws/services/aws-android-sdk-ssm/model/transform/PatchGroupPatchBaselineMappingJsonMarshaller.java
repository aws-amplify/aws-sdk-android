...
class PatchGroupPatchBaselineMappingJsonMarshaller {
    ...
    public void marshall(PatchGroupPatchBaselineMapping patchGroupPatchBaselineMapping, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (patchGroupPatchBaselineMapping.getBaselineIdentity() != null) {
            PatchBaselineIdentity baselineIdentity = patchGroupPatchBaselineMapping.getBaselineIdentity();
            jsonWriter.name("BaselineIdentity");
            PatchBaselineIdentityJsonMarshaller.getInstance().marshall(baselineIdentity, jsonWriter);
        }
    ...
    public static PatchGroupPatchBaselineMappingJsonMarshaller getInstance() {
        if (instance == null) instance = new PatchGroupPatchBaselineMappingJsonMarshaller();
        return instance;
    }
}
