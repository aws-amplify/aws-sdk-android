...
public class CreateActivationRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Length: </b>0 - 256<br/>
     *
     * @return <p>A user-defined description of the resource that you want to register with Systems Manager. </p> <important> <p>Do not enter personally identifiable information in this field.</p> </important>
     */
     ...
     * <b>Length: </b>0 - 256<br/>
     *
     * @param description <p>A user-defined description of the resource that you want to register with Systems Manager. </p> <important> <p>Do not enter personally identifiable information in this field.</p> </important>
     */
     ...
     * <b>Pattern: </b>^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$<br/>
     *
     * @return <p>The name of the registered, managed instance as it will appear in the Systems Manager console or when you use the AWS command line tools to list Systems Manager resources.</p> <important> <p>Do not enter personally identifiable information in this field.</p> </important>
     */
     ...
     * <b>Pattern: </b>^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$<br/>
     *
     * @param defaultInstanceName <p>The name of the registered, managed instance as it will appear in the Systems Manager console or when you use the AWS command line tools to list Systems Manager resources.</p> <important> <p>Do not enter personally identifiable information in this field.</p> </important>
     */
     ...
     * <b>Length: </b> - 64<br/>
     *
     * @return <p>The Amazon Identity and Access Management (IAM) role that you want to assign to the managed instance. This IAM role must provide AssumeRole permissions for the Systems Manager service principal <code>ssm.amazonaws.com</code>. For more information, see <a href="https://docs.aws.amazon.com/systems-manager/latest/userguide/sysman-service-role.html">Create an IAM service role for a hybrid environment</a> in the <i>AWS Systems Manager User Guide</i>.</p>
     */
     ...
     * <b>Range: </b>1 - 1000<br/>
     *
     * @return <p>Specify the maximum number of managed instances you want to register. The default value is 1 instance.</p>
     */
     ...
     * <b>Range: </b>1 - 1000<br/>
     *
     * @param registrationLimit <p>Specify the maximum number of managed instances you want to register. The default value is 1 instance.</p>
     */
     ...
     * <p>The date by which this activation request should expire. The default value is 24 hours.</p>
     *
     * @return <p>The date by which this activation request should expire. The default value is 24 hours.</p>
     */
     ...
     * <p>The date by which this activation request should expire. The default value is 24 hours.</p>
     *
     * @param expirationDate <p>The date by which this activation request should expire. The default value is 24 hours.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateActivationRequest == false) return false;
