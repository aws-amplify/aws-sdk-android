...
public class RegisterTargetWithMaintenanceWindowRequestMarshaller implements Marshaller<Request<RegisterTargetWithMaintenanceWindowRequest>, RegisterTargetWithMaintenanceWindowRequest> {
    ...
    public Request<RegisterTargetWithMaintenanceWindowRequest> marshall(RegisterTargetWithMaintenanceWindowRequest registerTargetWithMaintenanceWindowRequest) {
        if (registerTargetWithMaintenanceWindowRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(RegisterTargetWithMaintenanceWindowRequest)");
        }

        Request<RegisterTargetWithMaintenanceWindowRequest> request = new DefaultRequest<RegisterTargetWithMaintenanceWindowRequest>(registerTargetWithMaintenanceWindowRequest, "AmazonSimpleSystemsManager(SSM)");
        ...
        try {
            ...
            if (registerTargetWithMaintenanceWindowRequest.getTargets() != null) {
                java.util.List<Target> targets = registerTargetWithMaintenanceWindowRequest.getTargets();
            ...
            if (registerTargetWithMaintenanceWindowRequest.getOwnerInformation() != null) {
                String ownerInformation = registerTargetWithMaintenanceWindowRequest.getOwnerInformation();
