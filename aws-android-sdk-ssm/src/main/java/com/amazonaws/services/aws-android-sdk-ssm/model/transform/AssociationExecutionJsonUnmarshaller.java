 ...
 */
class AssociationExecutionJsonUnmarshaller implements Unmarshaller<AssociationExecution, JsonUnmarshallerContext> {
...
.unmarshall(context));
    ...
    public static AssociationExecutionJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AssociationExecutionJsonUnmarshaller();
        return instance;
    }
}
