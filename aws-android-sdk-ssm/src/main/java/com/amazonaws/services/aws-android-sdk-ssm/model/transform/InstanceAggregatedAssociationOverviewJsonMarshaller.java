...
class InstanceAggregatedAssociationOverviewJsonMarshaller {
    ...
    public void marshall(InstanceAggregatedAssociationOverview instanceAggregatedAssociationOverview, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (instanceAggregatedAssociationOverview.getInstanceAssociationStatusAggregatedCount() != null) {
            java.util.Map<String, Integer> instanceAssociationStatusAggregatedCount = instanceAggregatedAssociationOverview.getInstanceAssociationStatusAggregatedCount();
            jsonWriter.name("InstanceAssociationStatusAggregatedCount");
            jsonWriter.beginObject();
            for (java.util.Map.Entry<String, Integer> instanceAssociationStatusAggregatedCountEntry : instanceAssociationStatusAggregatedCount.entrySet()) {
                Integer instanceAssociationStatusAggregatedCountValue = instanceAssociationStatusAggregatedCountEntry.getValue();
    ...
    public static InstanceAggregatedAssociationOverviewJsonMarshaller getInstance() {
        if (instance == null) instance = new InstanceAggregatedAssociationOverviewJsonMarshaller();
        return instance;
    }
}
