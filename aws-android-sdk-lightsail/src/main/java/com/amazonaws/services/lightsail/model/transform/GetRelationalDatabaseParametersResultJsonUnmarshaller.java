...
/**
 * JSON unmarshaller for response GetRelationalDatabaseParametersResult
 */
public class GetRelationalDatabaseParametersResultJsonUnmarshaller implements
        Unmarshaller<GetRelationalDatabaseParametersResult, JsonUnmarshallerContext> {

    public GetRelationalDatabaseParametersResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("parameters")) {
                getRelationalDatabaseParametersResult
                        .setParameters(new ListUnmarshaller<RelationalDatabaseParameter>(
                                RelationalDatabaseParameterJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextPageToken")) {
                getRelationalDatabaseParametersResult.setNextPageToken(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
