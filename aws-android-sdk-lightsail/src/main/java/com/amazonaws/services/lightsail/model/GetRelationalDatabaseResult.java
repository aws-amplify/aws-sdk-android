...
public class GetRelationalDatabaseResult implements Serializable {
    /**
     * <p>
    ...
    public String toString() {
        ...
        if (getRelationalDatabase() != null)
            sb.append("relationalDatabase: " + getRelationalDatabase());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getRelationalDatabase() == null) ? 0 : getRelationalDatabase().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getRelationalDatabase() == null ^ this.getRelationalDatabase() == null)
            return false;
        if (other.getRelationalDatabase() != null
                && other.getRelationalDatabase().equals(this.getRelationalDatabase()) == false)
            return false;
        return true;
    }
}
