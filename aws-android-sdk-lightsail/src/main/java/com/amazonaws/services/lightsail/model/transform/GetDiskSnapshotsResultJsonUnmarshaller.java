...
/**
 * JSON unmarshaller for response GetDiskSnapshotsResult
 */
public class GetDiskSnapshotsResultJsonUnmarshaller implements
        Unmarshaller<GetDiskSnapshotsResult, JsonUnmarshallerContext> {
    ...
    public GetDiskSnapshotsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("diskSnapshots")) {
                getDiskSnapshotsResult.setDiskSnapshots(new ListUnmarshaller<DiskSnapshot>(
                        DiskSnapshotJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextPageToken")) {
                getDiskSnapshotsResult.setNextPageToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
