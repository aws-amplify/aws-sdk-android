...
public class CopySnapshotRequestMarshaller implements
    ...
    public Request<CopySnapshotRequest> marshall(CopySnapshotRequest copySnapshotRequest) {
        ...
        Request<CopySnapshotRequest> request = new DefaultRequest<CopySnapshotRequest>(
                copySnapshotRequest, "AmazonLightsail");
        ...
        try {
            ...
            if (copySnapshotRequest.getSourceSnapshotName() != null) {
                ...
                jsonWriter.name("sourceSnapshotName");
                jsonWriter.value(sourceSnapshotName);
            }
            if (copySnapshotRequest.getSourceResourceName() != null) {
                String sourceResourceName = copySnapshotRequest.getSourceResourceName();
                jsonWriter.name("sourceResourceName");
                jsonWriter.value(sourceResourceName);
            }
            if (copySnapshotRequest.getRestoreDate() != null) {
                String restoreDate = copySnapshotRequest.getRestoreDate();
                jsonWriter.name("restoreDate");
                jsonWriter.value(restoreDate);
            }
            if (copySnapshotRequest.getUseLatestRestorableAutoSnapshot() != null) {
                Boolean useLatestRestorableAutoSnapshot = copySnapshotRequest
            ...
            if (copySnapshotRequest.getTargetSnapshotName() != null) {
                ...
                jsonWriter.name("targetSnapshotName");
                jsonWriter.value(targetSnapshotName);
            }
