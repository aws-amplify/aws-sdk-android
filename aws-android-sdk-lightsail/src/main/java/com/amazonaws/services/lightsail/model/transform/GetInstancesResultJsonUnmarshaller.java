...
/**
 * JSON unmarshaller for response GetInstancesResult
 */
public class GetInstancesResultJsonUnmarshaller implements
        Unmarshaller<GetInstancesResult, JsonUnmarshallerContext> {
    ...
    public GetInstancesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("instances")) {
                getInstancesResult.setInstances(new ListUnmarshaller<Instance>(
                        InstanceJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextPageToken")) {
                getInstancesResult.setNextPageToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
