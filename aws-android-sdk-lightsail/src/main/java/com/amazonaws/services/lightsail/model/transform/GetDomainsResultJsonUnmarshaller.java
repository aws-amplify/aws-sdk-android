...
/**
 * JSON unmarshaller for response GetDomainsResult
 */
public class GetDomainsResultJsonUnmarshaller implements
        Unmarshaller<GetDomainsResult, JsonUnmarshallerContext> {
    ...
    public GetDomainsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("domains")) {
                getDomainsResult.setDomains(new ListUnmarshaller<Domain>(DomainJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextPageToken")) {
                getDomainsResult.setNextPageToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
