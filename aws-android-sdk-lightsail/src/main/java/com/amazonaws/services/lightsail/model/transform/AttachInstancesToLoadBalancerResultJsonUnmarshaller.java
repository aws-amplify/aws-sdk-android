...
/**
 * JSON unmarshaller for response AttachInstancesToLoadBalancerResult
 */
public class AttachInstancesToLoadBalancerResultJsonUnmarshaller implements
        Unmarshaller<AttachInstancesToLoadBalancerResult, JsonUnmarshallerContext> {

    public AttachInstancesToLoadBalancerResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("operations")) {
                attachInstancesToLoadBalancerResult.setOperations(new ListUnmarshaller<Operation>(
