...
public class AttachLoadBalancerTlsCertificateResult implements Serializable {
    /**
     * <p>
     ...
     *            <p>
     *            These SSL/TLS certificates are only usable by Lightsail load
     *            balancers. You can't get the certificate and use it for
     *            another purpose.
     *            </p>
     */
     ...
     *         chained together.
     */
    public AttachLoadBalancerTlsCertificateResult withOperations(
