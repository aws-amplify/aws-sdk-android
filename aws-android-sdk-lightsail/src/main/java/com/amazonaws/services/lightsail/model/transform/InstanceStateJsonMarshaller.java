...
/**
 * JSON marshaller for POJO InstanceState
 */
class InstanceStateJsonMarshaller {

    public void marshall(InstanceState instanceState, AwsJsonWriter jsonWriter) throws Exception {
