...
/**
 * JSON unmarshaller for response IsVpcPeeredResult
 */
public class IsVpcPeeredResultJsonUnmarshaller implements
        Unmarshaller<IsVpcPeeredResult, JsonUnmarshallerContext> {
    ...
    public IsVpcPeeredResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("isPeered")) {
                isVpcPeeredResult.setIsPeered(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
