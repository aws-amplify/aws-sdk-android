...
/**
 * JSON unmarshaller for response GetDomainResult
 */
public class GetDomainResultJsonUnmarshaller implements
        Unmarshaller<GetDomainResult, JsonUnmarshallerContext> {
    ...
    public GetDomainResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("domain")) {
                getDomainResult.setDomain(DomainJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
