...
/**
 * JSON unmarshaller for response GetLoadBalancerTlsCertificatesResult
 */
public class GetLoadBalancerTlsCertificatesResultJsonUnmarshaller implements
        Unmarshaller<GetLoadBalancerTlsCertificatesResult, JsonUnmarshallerContext> {

    public GetLoadBalancerTlsCertificatesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("tlsCertificates")) {
                getLoadBalancerTlsCertificatesResult
                        .setTlsCertificates(new ListUnmarshaller<LoadBalancerTlsCertificate>(
