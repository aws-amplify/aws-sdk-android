...
/**
 * JSON unmarshaller for POJO InstanceHardware
 */
class InstanceHardwareJsonUnmarshaller implements
        Unmarshaller<InstanceHardware, JsonUnmarshallerContext> {
    ...
    public InstanceHardware unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("cpuCount")) {
                instanceHardware.setCpuCount(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("disks")) {
                instanceHardware.setDisks(new ListUnmarshaller<Disk>(DiskJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("ramSizeInGb")) {
                instanceHardware.setRamSizeInGb(FloatJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
