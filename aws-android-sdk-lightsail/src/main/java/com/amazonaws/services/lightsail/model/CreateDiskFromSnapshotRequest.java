 ...
 * same Availability Zone (e.g., <code>us-east-2a</code>).
 * </p>
 * <p>
 ...
 * identified by <code>disk snapshot name</code>. For more information, see the
 * <a href=
 * "https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags"
 * >Lightsail Dev Guide</a>.
 * </p>
 */
public class CreateDiskFromSnapshotRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * <code>source disk name</code> parameter. The
     * <code>disk snapshot name</code> and <code>source disk name</code>
     ...
     * <p>
     * This parameter cannot be defined together with the
     * <code>disk snapshot name</code> parameter. The
     * <code>source disk name</code> and <code>disk snapshot name</code>
     * parameters are mutually exclusive.
     * </p>
     * </li>
     * <li>
     ...
     *
     * @return <p>
     *         The name of the disk snapshot (e.g., <code>my-snapshot</code>)
     ...
     *            This parameter cannot be defined together with the
     *            <code>source disk name</code> parameter. The
     *            <code>disk snapshot name</code> and
     *            <code>source disk name</code> parameters are mutually
     *            exclusive.
     *            </p>
     *            </li>
     *            </ul>
     ...
     * @return <p>
     *         The Availability Zone where you want to create the disk (e.g.,
     *         <code>us-east-2a</code>). Choose the same Availability Zone as
     *         the Lightsail instance where you want to create the disk.
     *         </p>
     *         <p>
     *         Use the GetRegions operation to list the Availability Zones where
     *         Lightsail is currently available.
     ...
     *            </p>
     *            <p>
     *            Use the GetRegions operation to list the Availability Zones
     ...
     *            This parameter cannot be defined together with the
     *            <code>disk snapshot name</code> parameter. The
     *            <code>source disk name</code> and
     *            <code>disk snapshot name</code> parameters are mutually
     *            exclusive.
     *            </p>
     *            </li>
     *            <li>
     ...
     *
     * @return <p>
     *         The date of the automatic snapshot to use for the new disk. Use
     *         the <code>get auto snapshots</code> operation to identify the
     ...
     *            Use the <code>get auto snapshots</code> operation to identify
     ...
     *         chained together.
     */
    public CreateDiskFromSnapshotRequest withUseLatestRestorableAutoSnapshot(
    ...
    public String toString() {
        ...
        if (getSourceDiskName() != null)
            sb.append("sourceDiskName: " + getSourceDiskName() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getSourceDiskName() == null) ? 0 : getSourceDiskName().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSourceDiskName() == null ^ this.getSourceDiskName() == null)
            return false;
        if (other.getSourceDiskName() != null
                && other.getSourceDiskName().equals(this.getSourceDiskName()) == false)
            return false;
