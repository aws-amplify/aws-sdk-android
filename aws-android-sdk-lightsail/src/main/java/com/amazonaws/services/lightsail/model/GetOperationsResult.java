...
public class GetOperationsResult implements Serializable {
    /**
     * <p>
     ...
     * <code>GetOperations</code> request and specify the next page token using
     ...
     *         <p>
     *         To get the next page of results, perform another
     *         <code>GetOperations</code> request and specify the next page
