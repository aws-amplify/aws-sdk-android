...
/**
 * JSON unmarshaller for response GetBlueprintsResult
 */
public class GetBlueprintsResultJsonUnmarshaller implements
        Unmarshaller<GetBlueprintsResult, JsonUnmarshallerContext> {
    ...
    public GetBlueprintsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("blueprints")) {
                getBlueprintsResult.setBlueprints(new ListUnmarshaller<Blueprint>(
                        BlueprintJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextPageToken")) {
                getBlueprintsResult.setNextPageToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
