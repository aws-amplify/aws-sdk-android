...
/**
 * JSON unmarshaller for response UpdateDomainEntryResult
 */
public class UpdateDomainEntryResultJsonUnmarshaller implements
        Unmarshaller<UpdateDomainEntryResult, JsonUnmarshallerContext> {
    ...
    public UpdateDomainEntryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("operations")) {
                updateDomainEntryResult.setOperations(new ListUnmarshaller<Operation>(
