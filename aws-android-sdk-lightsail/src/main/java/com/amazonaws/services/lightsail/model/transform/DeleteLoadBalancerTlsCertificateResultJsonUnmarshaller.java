...
/**
 * JSON unmarshaller for response DeleteLoadBalancerTlsCertificateResult
 */
public class DeleteLoadBalancerTlsCertificateResultJsonUnmarshaller implements
        Unmarshaller<DeleteLoadBalancerTlsCertificateResult, JsonUnmarshallerContext> {

    public DeleteLoadBalancerTlsCertificateResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
