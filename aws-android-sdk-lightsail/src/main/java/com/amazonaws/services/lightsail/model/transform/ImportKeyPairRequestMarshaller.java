...
public class ImportKeyPairRequestMarshaller implements
    ...
    public Request<ImportKeyPairRequest> marshall(ImportKeyPairRequest importKeyPairRequest) {
        ...
        Request<ImportKeyPairRequest> request = new DefaultRequest<ImportKeyPairRequest>(
                importKeyPairRequest, "AmazonLightsail");
        ...
        try {
            ...
            if (importKeyPairRequest.getKeyPairName() != null) {
                String keyPairName = importKeyPairRequest.getKeyPairName();
                jsonWriter.name("keyPairName");
                jsonWriter.value(keyPairName);
            }
            if (importKeyPairRequest.getPublicKeyBase64() != null) {
                String publicKeyBase64 = importKeyPairRequest.getPublicKeyBase64();
                jsonWriter.name("publicKeyBase64");
                jsonWriter.value(publicKeyBase64);
            }
