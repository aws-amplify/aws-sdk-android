...
/**
 * JSON unmarshaller for response DetachStaticIpResult
 */
public class DetachStaticIpResultJsonUnmarshaller implements
        Unmarshaller<DetachStaticIpResult, JsonUnmarshallerContext> {
    ...
    public DetachStaticIpResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("operations")) {
                detachStaticIpResult.setOperations(new ListUnmarshaller<Operation>(
