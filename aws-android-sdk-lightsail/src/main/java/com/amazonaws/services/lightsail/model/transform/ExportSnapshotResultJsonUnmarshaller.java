...
/**
 * JSON unmarshaller for response ExportSnapshotResult
 */
public class ExportSnapshotResultJsonUnmarshaller implements
        Unmarshaller<ExportSnapshotResult, JsonUnmarshallerContext> {
    ...
    public ExportSnapshotResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("operations")) {
                exportSnapshotResult.setOperations(new ListUnmarshaller<Operation>(
