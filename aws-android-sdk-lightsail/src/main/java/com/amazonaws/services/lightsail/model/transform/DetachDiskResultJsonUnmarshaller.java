...
/**
 * JSON unmarshaller for response DetachDiskResult
 */
public class DetachDiskResultJsonUnmarshaller implements
        Unmarshaller<DetachDiskResult, JsonUnmarshallerContext> {
    ...
    public DetachDiskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("operations")) {
                detachDiskResult.setOperations(new ListUnmarshaller<Operation>(
