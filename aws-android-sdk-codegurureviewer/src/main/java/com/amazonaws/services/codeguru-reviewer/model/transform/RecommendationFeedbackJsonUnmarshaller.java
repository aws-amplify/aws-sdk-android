 ...
 */
class RecommendationFeedbackJsonUnmarshaller implements Unmarshaller<RecommendationFeedback, JsonUnmarshallerContext> {
...
.unmarshall(context));
                ...
                recommendationFeedback.setReactions(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static RecommendationFeedbackJsonUnmarshaller getInstance() {
        if (instance == null) instance = new RecommendationFeedbackJsonUnmarshaller();
        return instance;
    }
}
