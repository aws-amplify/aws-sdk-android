...
class RepositoryAssociationJsonMarshaller {
    ...
    public void marshall(RepositoryAssociation repositoryAssociation, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (repositoryAssociation.getConnectionArn() != null) {
            String connectionArn = repositoryAssociation.getConnectionArn();
    ...
    public static RepositoryAssociationJsonMarshaller getInstance() {
        if (instance == null) instance = new RepositoryAssociationJsonMarshaller();
        return instance;
    }
}
