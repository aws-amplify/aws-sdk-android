 ...
 */
public class PutRecommendationFeedbackRequestMarshaller implements Marshaller<Request<PutRecommendationFeedbackRequest>, PutRecommendationFeedbackRequest> {
    ...
    public Request<PutRecommendationFeedbackRequest> marshall(PutRecommendationFeedbackRequest putRecommendationFeedbackRequest) {
        if (putRecommendationFeedbackRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(PutRecommendationFeedbackRequest)");
        }

        Request<PutRecommendationFeedbackRequest> request = new DefaultRequest<PutRecommendationFeedbackRequest>(putRecommendationFeedbackRequest, "AmazonCodeGuruReviewer");
