...
public class DescribeRecommendationFeedbackResult implements Serializable {
     ...
     * <p> The recommendation feedback given by the user. </p>
     *
     * @return <p> The recommendation feedback given by the user. </p>
     */
     ...
     * <p> The recommendation feedback given by the user. </p>
     *
     * @param recommendationFeedback <p> The recommendation feedback given by the user. </p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getRecommendationFeedback() != null) sb.append("RecommendationFeedback: " + getRecommendationFeedback());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeRecommendationFeedbackResult == false) return false;
        DescribeRecommendationFeedbackResult other = (DescribeRecommendationFeedbackResult)obj;

        if (other.getRecommendationFeedback() == null ^ this.getRecommendationFeedback() == null) return false;
        if (other.getRecommendationFeedback() != null && other.getRecommendationFeedback().equals(this.getRecommendationFeedback()) == false) return false;
        return true;
    }
}
