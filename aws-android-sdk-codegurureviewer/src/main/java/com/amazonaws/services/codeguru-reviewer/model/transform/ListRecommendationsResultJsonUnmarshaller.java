    ...
    public ListRecommendationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RecommendationSummaries")) {
                listRecommendationsResult.setRecommendationSummaries(new ListUnmarshaller<RecommendationSummary>(RecommendationSummaryJsonUnmarshaller.getInstance()
)
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static ListRecommendationsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListRecommendationsResultJsonUnmarshaller();
        return instance;
    }
}
