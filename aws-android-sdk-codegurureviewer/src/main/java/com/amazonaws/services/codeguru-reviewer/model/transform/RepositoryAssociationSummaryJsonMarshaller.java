...
class RepositoryAssociationSummaryJsonMarshaller {
    ...
    public void marshall(RepositoryAssociationSummary repositoryAssociationSummary, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (repositoryAssociationSummary.getConnectionArn() != null) {
            String connectionArn = repositoryAssociationSummary.getConnectionArn();
            jsonWriter.name("ConnectionArn");
            jsonWriter.value(connectionArn);
        }
        if (repositoryAssociationSummary.getLastUpdatedTimeStamp() != null) {
            java.util.Date lastUpdatedTimeStamp = repositoryAssociationSummary.getLastUpdatedTimeStamp();
    ...
    public static RepositoryAssociationSummaryJsonMarshaller getInstance() {
        if (instance == null) instance = new RepositoryAssociationSummaryJsonMarshaller();
        return instance;
    }
}
