...
public class CommitDiffSourceCodeType implements Serializable {
     ...
     * <b>Length: </b>6 - 64<br/>
     *
     * @param sourceCommit <p> Source Commit SHA. </p>
     */
     ...
     * <b>Length: </b>6 - 64<br/>
     *
     * @return <p> Destination Commit SHA </p>
     */
     ...
     * <b>Length: </b>6 - 64<br/>
     *
     * @param destinationCommit <p> Destination Commit SHA </p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getSourceCommit() != null) sb.append("SourceCommit: " + getSourceCommit() + ",");
        if (getDestinationCommit() != null) sb.append("DestinationCommit: " + getDestinationCommit());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CommitDiffSourceCodeType == false) return false;
        CommitDiffSourceCodeType other = (CommitDiffSourceCodeType)obj;

        if (other.getSourceCommit() == null ^ this.getSourceCommit() == null) return false;
        if (other.getSourceCommit() != null && other.getSourceCommit().equals(this.getSourceCommit()) == false) return false;
        if (other.getDestinationCommit() == null ^ this.getDestinationCommit() == null) return false;
        if (other.getDestinationCommit() != null && other.getDestinationCommit().equals(this.getDestinationCommit()) == false) return false;
        return true;
    }
}
