...
public class ListRecommendationFeedbackResult implements Serializable {
     ...
     * <p> Recommendation feedback summaries corresponding to the code reivew ARN. </p>
     *
     * @return <p> Recommendation feedback summaries corresponding to the code reivew ARN. </p>
     */
     ...
     * <p> Recommendation feedback summaries corresponding to the code reivew ARN. </p>
     *
     * @param recommendationFeedbackSummaries <p> Recommendation feedback summaries corresponding to the code reivew ARN. </p>
     */
    ...
    public ListRecommendationFeedbackResult withRecommendationFeedbackSummaries(RecommendationFeedbackSummary... recommendationFeedbackSummaries) {
        if (getRecommendationFeedbackSummaries() == null) {
            this.recommendationFeedbackSummaries = new java.util.ArrayList<RecommendationFeedbackSummary>(recommendationFeedbackSummaries.length);
        }
     ...
     * @return A reference to this updated object so that method calls can be chained together.
     */
    public ListRecommendationFeedbackResult withRecommendationFeedbackSummaries(java.util.Collection<RecommendationFeedbackSummary> recommendationFeedbackSummaries) {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getRecommendationFeedbackSummaries() != null) sb.append("RecommendationFeedbackSummaries: " + getRecommendationFeedbackSummaries() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListRecommendationFeedbackResult == false) return false;
        ListRecommendationFeedbackResult other = (ListRecommendationFeedbackResult)obj;

        if (other.getRecommendationFeedbackSummaries() == null ^ this.getRecommendationFeedbackSummaries() == null) return false;
        if (other.getRecommendationFeedbackSummaries() != null && other.getRecommendationFeedbackSummaries().equals(this.getRecommendationFeedbackSummaries()) == false) return false;
