...
public class Repository implements Serializable {
     ...
     * <p>Information about an AWS CodeCommit repository.</p>
     *
     * @return <p>Information about an AWS CodeCommit repository.</p>
     */
     ...
     * <p>Information about an AWS CodeCommit repository.</p>
     *
     * @param codeCommit <p>Information about an AWS CodeCommit repository.</p>
     */
     ...
     * <p> Information about a Bitbucket Cloud repository. </p>
     *
     * @return <p> Information about a Bitbucket Cloud repository. </p>
     */
     ...
     * <p> Information about a Bitbucket Cloud repository. </p>
     *
     * @param bitbucket <p> Information about a Bitbucket Cloud repository. </p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getCodeCommit() != null) sb.append("CodeCommit: " + getCodeCommit() + ",");
        if (getBitbucket() != null) sb.append("Bitbucket: " + getBitbucket());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCodeCommit() == null ^ this.getCodeCommit() == null) return false;
        if (other.getCodeCommit() != null && other.getCodeCommit().equals(this.getCodeCommit()) == false) return false;
        if (other.getBitbucket() == null ^ this.getBitbucket() == null) return false;
        if (other.getBitbucket() != null && other.getBitbucket().equals(this.getBitbucket()) == false) return false;
        return true;
    }
}
