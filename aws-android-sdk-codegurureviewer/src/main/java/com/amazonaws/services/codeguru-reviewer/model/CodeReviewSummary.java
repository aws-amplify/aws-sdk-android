...
public class CodeReviewSummary implements Serializable {
     ...
     * <b>Allowed Values: </b>PullRequest
     *
     * @return <p> The type of the code review. </p>
     *
     * @see Type
     */
     ...
     * <b>Allowed Values: </b>PullRequest
     *
     * @param type <p> The type of the code review. </p>
     *
     * @see Type
     */
     ...
     * <p> The statistics from the code review. </p>
     *
     * @param metricsSummary <p> The statistics from the code review. </p>
     */
    ...
    public String toString() {
        ...
        if (getMetricsSummary() != null) sb.append("MetricsSummary: " + getMetricsSummary());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CodeReviewSummary == false) return false;
        ...
        if (other.getMetricsSummary() == null ^ this.getMetricsSummary() == null) return false;
        if (other.getMetricsSummary() != null && other.getMetricsSummary().equals(this.getMetricsSummary()) == false) return false;
        return true;
    }
}
