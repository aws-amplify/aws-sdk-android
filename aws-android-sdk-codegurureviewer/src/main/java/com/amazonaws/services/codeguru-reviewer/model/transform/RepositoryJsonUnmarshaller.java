...
class RepositoryJsonUnmarshaller implements Unmarshaller<Repository, JsonUnmarshallerContext> {
    ...
    public Repository unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("CodeCommit")) {
                repository.setCodeCommit(CodeCommitRepositoryJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Bitbucket")) {
                repository.setBitbucket(ThirdPartySourceRepositoryJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static RepositoryJsonUnmarshaller getInstance() {
        if (instance == null) instance = new RepositoryJsonUnmarshaller();
        return instance;
    }
}
