 ...
 */
public class ListRepositoryAssociationsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * <p>List of provider types to use as a filter.</p>
     *
     * @return <p>List of provider types to use as a filter.</p>
     */
     ...
     * <p>List of provider types to use as a filter.</p>
     *
     * @param providerTypes <p>List of provider types to use as a filter.</p>
     */
     ...
     * <p>List of states to use as a filter.</p>
     *
     * @return <p>List of states to use as a filter.</p>
     */
     ...
     * <p>List of states to use as a filter.</p>
     *
     * @param states <p>List of states to use as a filter.</p>
     */
     ...
     * <p>List of repository names to use as a filter.</p>
     *
     * @return <p>List of repository names to use as a filter.</p>
     */
     ...
     * <p>List of repository names to use as a filter.</p>
     *
     * @param names <p>List of repository names to use as a filter.</p>
     */
     ...
     * <p>List of owners to use as a filter. For GitHub, this is name of the GitHub account that was used to associate the repository. For AWS CodeCommit, it is the name of the CodeCommit account that was used to associate the repository.</p>
     *
     * @return <p>List of owners to use as a filter. For GitHub, this is name of the GitHub account that was used to associate the repository. For AWS CodeCommit, it is the name of the CodeCommit account that was used to associate the repository.</p>
     */
     ...
     * <p>List of owners to use as a filter. For GitHub, this is name of the GitHub account that was used to associate the repository. For AWS CodeCommit, it is the name of the CodeCommit account that was used to associate the repository.</p>
     *
     * @param owners <p>List of owners to use as a filter. For GitHub, this is name of the GitHub account that was used to associate the repository. For AWS CodeCommit, it is the name of the CodeCommit account that was used to associate the repository.</p>
     */
     ...
     * <b>Range: </b>1 - 100<br/>
     *
     * @return <p>The maximum number of repository association results returned by <code>ListRepositoryAssociations</code> in paginated output. When this parameter is used, <code>ListRepositoryAssociations</code> only returns <code>maxResults</code> results in a single page with a <code>nextToken</code> response element. The remaining results of the initial request can be seen by sending another <code>ListRepositoryAssociations</code> request with the returned <code>nextToken</code> value. This value can be between 1 and 25. If this parameter is not used, <code>ListRepositoryAssociations</code> returns up to 25 results and a <code>nextToken</code> value if applicable. </p>
     */
     ...
     * <b>Range: </b>1 - 100<br/>
     *
     * @param maxResults <p>The maximum number of repository association results returned by <code>ListRepositoryAssociations</code> in paginated output. When this parameter is used, <code>ListRepositoryAssociations</code> only returns <code>maxResults</code> results in a single page with a <code>nextToken</code> response element. The remaining results of the initial request can be seen by sending another <code>ListRepositoryAssociations</code> request with the returned <code>nextToken</code> value. This value can be between 1 and 25. If this parameter is not used, <code>ListRepositoryAssociations</code> returns up to 25 results and a <code>nextToken</code> value if applicable. </p>
     */
    ...
    public String toString() {
        ...
        if (getNames() != null) sb.append("Names: " + getNames() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListRepositoryAssociationsRequest == false) return false;
        ...
        if (other.getNames() == null ^ this.getNames() == null) return false;
        if (other.getNames() != null && other.getNames().equals(this.getNames()) == false) return false;
