    ...
    public ListRepositoryAssociationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RepositoryAssociationSummaries")) {
                listRepositoryAssociationsResult.setRepositoryAssociationSummaries(new ListUnmarshaller<RepositoryAssociationSummary>(RepositoryAssociationSummaryJsonUnmarshaller.getInstance()
)
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static ListRepositoryAssociationsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListRepositoryAssociationsResultJsonUnmarshaller();
        return instance;
    }
}
