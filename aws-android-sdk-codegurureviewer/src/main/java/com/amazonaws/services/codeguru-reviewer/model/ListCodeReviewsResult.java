...
public class ListCodeReviewsResult implements Serializable {
     ...
     * <p> A list of code reviews that meet the criteria of the request. </p>
     *
     * @return <p> A list of code reviews that meet the criteria of the request. </p>
     */
     ...
     * <p> A list of code reviews that meet the criteria of the request. </p>
     *
     * @param codeReviewSummaries <p> A list of code reviews that meet the criteria of the request. </p>
     */
    ...
    public ListCodeReviewsResult withCodeReviewSummaries(CodeReviewSummary... codeReviewSummaries) {
        if (getCodeReviewSummaries() == null) {
            this.codeReviewSummaries = new java.util.ArrayList<CodeReviewSummary>(codeReviewSummaries.length);
        }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getCodeReviewSummaries() != null) sb.append("CodeReviewSummaries: " + getCodeReviewSummaries() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCodeReviewsResult == false) return false;
        ListCodeReviewsResult other = (ListCodeReviewsResult)obj;

        if (other.getCodeReviewSummaries() == null ^ this.getCodeReviewSummaries() == null) return false;
        if (other.getCodeReviewSummaries() != null && other.getCodeReviewSummaries().equals(this.getCodeReviewSummaries()) == false) return false;
