...
/**
 * JSON unmarshaller for POJO MetricsSummary
 */
class MetricsSummaryJsonUnmarshaller implements Unmarshaller<MetricsSummary, JsonUnmarshallerContext> {
    ...
    public MetricsSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("MeteredLinesOfCodeCount")) {
                metricsSummary.setMeteredLinesOfCodeCount(LongJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("FindingsCount")) {
                metricsSummary.setFindingsCount(LongJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static MetricsSummaryJsonUnmarshaller getInstance() {
        if (instance == null) instance = new MetricsSummaryJsonUnmarshaller();
        return instance;
    }
}
