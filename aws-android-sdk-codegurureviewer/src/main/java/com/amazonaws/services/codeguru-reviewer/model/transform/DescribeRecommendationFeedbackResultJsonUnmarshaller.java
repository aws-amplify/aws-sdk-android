    ...
    public DescribeRecommendationFeedbackResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RecommendationFeedback")) {
                describeRecommendationFeedbackResult.setRecommendationFeedback(RecommendationFeedbackJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static DescribeRecommendationFeedbackResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeRecommendationFeedbackResultJsonUnmarshaller();
        return instance;
    }
}
