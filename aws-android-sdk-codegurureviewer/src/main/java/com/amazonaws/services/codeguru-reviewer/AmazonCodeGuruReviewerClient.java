...
import com.amazonaws.services.codeguru-reviewer.model.transform.*;

/**
 * Client for accessing Amazon CodeGuru Reviewer.  All service calls made
...
public class AmazonCodeGuruReviewerClient extends AmazonWebServiceClient implements AmazonCodeGuruReviewer { 
    ...
    /**
     * List of exception unmarshallers for all Amazon CodeGuru Reviewer exceptions.
     */
    protected List<JsonErrorUnmarshaller> jsonErrorUnmarshallers;

    /**
     * Constructs a new client to invoke service methods on
     * AmazonCodeGuruReviewer.  A credentials provider chain will be used
     ...
     *                       client connects to AmazonCodeGuruReviewer
     ...
     *         AmazonCodeGuruReviewerClient client = new AmazonCodeGuruReviewerClient(AWSMobileClient.getInstance());
     *     }
     * 
     *     &#64;Override
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonCodeGuruReviewerClient(AWSCredentials awsCredentials, ClientConfiguration clientConfiguration) {
        this(new StaticCredentialsProvider(awsCredentials), clientConfiguration);
    }

    /**
     * Constructs a new client to invoke service methods on
     * AmazonCodeGuruReviewer using the specified AWS account credentials provider.
     * <p>
     * The client requests are authenticated using the {@link AWSCredentials}
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonCodeGuruReviewerClient(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/codeguru-reviewer/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/codeguru-reviewer/request.handler2s"));
    }
    ...
    public AssociateRepositoryResult associateRepository(AssociateRepositoryRequest associateRepositoryRequest)
        ...
        try {
            ...
            try {
                request = new AssociateRepositoryRequestMarshaller().marshall(associateRepositoryRequest);
            ...
            JsonResponseHandler<AssociateRepositoryResult> responseHandler = new JsonResponseHandler<AssociateRepositoryResult>(unmarshaller);
    ...
    public DescribeCodeReviewResult describeCodeReview(DescribeCodeReviewRequest describeCodeReviewRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeCodeReviewRequestMarshaller().marshall(describeCodeReviewRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeCodeReviewResult> responseHandler = new JsonResponseHandler<DescribeCodeReviewResult>(unmarshaller);
    ...
    public DescribeRecommendationFeedbackResult describeRecommendationFeedback(DescribeRecommendationFeedbackRequest describeRecommendationFeedbackRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeRecommendationFeedbackRequestMarshaller().marshall(describeRecommendationFeedbackRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeRecommendationFeedbackResult> responseHandler = new JsonResponseHandler<DescribeRecommendationFeedbackResult>(unmarshaller);
    ...
    public DescribeRepositoryAssociationResult describeRepositoryAssociation(DescribeRepositoryAssociationRequest describeRepositoryAssociationRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeRepositoryAssociationRequestMarshaller().marshall(describeRepositoryAssociationRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeRepositoryAssociationResult> responseHandler = new JsonResponseHandler<DescribeRepositoryAssociationResult>(unmarshaller);
    ...
    public DisassociateRepositoryResult disassociateRepository(DisassociateRepositoryRequest disassociateRepositoryRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DisassociateRepositoryRequestMarshaller().marshall(disassociateRepositoryRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DisassociateRepositoryResult> responseHandler = new JsonResponseHandler<DisassociateRepositoryResult>(unmarshaller);
    ...
    public ListCodeReviewsResult listCodeReviews(ListCodeReviewsRequest listCodeReviewsRequest)
        ...
        try {
            ...
            JsonResponseHandler<ListCodeReviewsResult> responseHandler = new JsonResponseHandler<ListCodeReviewsResult>(unmarshaller);
    ...
    public ListRecommendationFeedbackResult listRecommendationFeedback(ListRecommendationFeedbackRequest listRecommendationFeedbackRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListRecommendationFeedbackRequestMarshaller().marshall(listRecommendationFeedbackRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ListRecommendationFeedbackResult> responseHandler = new JsonResponseHandler<ListRecommendationFeedbackResult>(unmarshaller);
    ...
    public ListRecommendationsResult listRecommendations(ListRecommendationsRequest listRecommendationsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListRecommendationsRequestMarshaller().marshall(listRecommendationsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ListRecommendationsResult> responseHandler = new JsonResponseHandler<ListRecommendationsResult>(unmarshaller);
    ...
    public ListRepositoryAssociationsResult listRepositoryAssociations(ListRepositoryAssociationsRequest listRepositoryAssociationsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListRepositoryAssociationsRequestMarshaller().marshall(listRepositoryAssociationsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ListRepositoryAssociationsResult> responseHandler = new JsonResponseHandler<ListRepositoryAssociationsResult>(unmarshaller);
    ...
    public PutRecommendationFeedbackResult putRecommendationFeedback(PutRecommendationFeedbackRequest putRecommendationFeedbackRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new PutRecommendationFeedbackRequestMarshaller().marshall(putRecommendationFeedbackRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<PutRecommendationFeedbackResult> responseHandler = new JsonResponseHandler<PutRecommendationFeedbackResult>(unmarshaller);
