...
class RecommendationFeedbackSummaryJsonMarshaller {
    ...
    public void marshall(RecommendationFeedbackSummary recommendationFeedbackSummary, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static RecommendationFeedbackSummaryJsonMarshaller getInstance() {
        if (instance == null) instance = new RecommendationFeedbackSummaryJsonMarshaller();
        return instance;
    }
}
