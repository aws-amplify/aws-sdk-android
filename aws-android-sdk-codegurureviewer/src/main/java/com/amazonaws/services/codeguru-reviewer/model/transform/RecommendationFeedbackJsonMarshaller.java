...
class RecommendationFeedbackJsonMarshaller {
    ...
    public void marshall(RecommendationFeedback recommendationFeedback, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static RecommendationFeedbackJsonMarshaller getInstance() {
        if (instance == null) instance = new RecommendationFeedbackJsonMarshaller();
        return instance;
    }
}
