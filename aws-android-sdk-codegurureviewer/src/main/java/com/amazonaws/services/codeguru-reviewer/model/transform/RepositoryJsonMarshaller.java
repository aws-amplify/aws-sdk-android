...
class RepositoryJsonMarshaller {
    ...
    public void marshall(Repository repository, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (repository.getBitbucket() != null) {
            ThirdPartySourceRepository bitbucket = repository.getBitbucket();
            jsonWriter.name("Bitbucket");
            ThirdPartySourceRepositoryJsonMarshaller.getInstance().marshall(bitbucket, jsonWriter);
        }
    ...
    public static RepositoryJsonMarshaller getInstance() {
        if (instance == null) instance = new RepositoryJsonMarshaller();
        return instance;
    }
}
