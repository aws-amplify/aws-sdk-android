 ...
 */
class RepositoryAssociationSummaryJsonUnmarshaller implements Unmarshaller<RepositoryAssociationSummary, JsonUnmarshallerContext> {
...
.unmarshall(context));
                ...
                repositoryAssociationSummary.setConnectionArn(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("LastUpdatedTimeStamp")) {
                repositoryAssociationSummary.setLastUpdatedTimeStamp(DateJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static RepositoryAssociationSummaryJsonUnmarshaller getInstance() {
        if (instance == null) instance = new RepositoryAssociationSummaryJsonUnmarshaller();
        return instance;
    }
}
