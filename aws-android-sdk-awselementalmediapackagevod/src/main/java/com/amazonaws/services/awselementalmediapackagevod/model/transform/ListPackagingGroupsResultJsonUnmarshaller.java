 ...
 */
public class ListPackagingGroupsResultJsonUnmarshaller implements
        Unmarshaller<ListPackagingGroupsResult, JsonUnmarshallerContext> {
    ...
    public ListPackagingGroupsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NextToken")) {
                ...
                listPackagingGroupsResult.setPackagingGroups(new ListUnmarshaller<PackagingGroup>(
                        PackagingGroupJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
