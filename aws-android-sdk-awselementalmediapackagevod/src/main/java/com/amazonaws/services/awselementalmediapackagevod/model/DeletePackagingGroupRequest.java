 ...
 */
public class DeletePackagingGroupRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * The ID of the MediaPackage VOD PackagingGroup resource to delete.
     *
     * @param id The ID of the MediaPackage VOD PackagingGroup resource to
     *            delete.
     */
