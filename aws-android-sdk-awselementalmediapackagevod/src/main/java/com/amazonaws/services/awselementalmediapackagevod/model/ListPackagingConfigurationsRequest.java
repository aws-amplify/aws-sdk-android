 ...
 */
public class ListPackagingConfigurationsRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     ...
     * A token used to resume pagination from the end of a previous request.
     *
     * @return A token used to resume pagination from the end of a previous
     *         request.
     */
     ...
     * A token used to resume pagination from the end of a previous request.
     *
     * @param nextToken A token used to resume pagination from the end of a
     *            previous request.
     */
     ...
     * specified PackagingGroup.
     *
     * @return Returns MediaPackage VOD PackagingConfigurations associated with
     ...
     * specified PackagingGroup.
     *
     * @param packagingGroupId Returns MediaPackage VOD PackagingConfigurations
