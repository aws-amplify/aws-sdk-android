 ...
 */
class PackagingConfigurationJsonUnmarshaller implements
        Unmarshaller<PackagingConfiguration, JsonUnmarshallerContext> {
    ...
    public PackagingConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Arn")) {
                ...
                packagingConfiguration.setTags(new MapUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
