...
public class ListPackagingGroupsResult implements Serializable {
     ...
     * A list of MediaPackage VOD PackagingGroup resources.
     *
     * @param packagingGroups A list of MediaPackage VOD PackagingGroup
     *            resources.
     */
     ...
     *         chained together.
     */
    public ListPackagingGroupsResult withPackagingGroups(
            java.util.Collection<PackagingGroup> packagingGroups) {
    ...
    public String toString() {
        ...
        if (getPackagingGroups() != null)
            sb.append("PackagingGroups: " + getPackagingGroups());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getPackagingGroups() == null) ? 0 : getPackagingGroups().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getPackagingGroups() == null ^ this.getPackagingGroups() == null)
            return false;
        if (other.getPackagingGroups() != null
                && other.getPackagingGroups().equals(this.getPackagingGroups()) == false)
            return false;
        return true;
    }
}
