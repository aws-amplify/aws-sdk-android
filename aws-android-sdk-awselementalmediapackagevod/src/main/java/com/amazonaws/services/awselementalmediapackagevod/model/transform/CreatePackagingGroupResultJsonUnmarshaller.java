 ...
 */
public class CreatePackagingGroupResultJsonUnmarshaller implements
        Unmarshaller<CreatePackagingGroupResult, JsonUnmarshallerContext> {
    ...
    public CreatePackagingGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Arn")) {
                ...
                createPackagingGroupResult.setTags(new MapUnmarshaller<String>(
