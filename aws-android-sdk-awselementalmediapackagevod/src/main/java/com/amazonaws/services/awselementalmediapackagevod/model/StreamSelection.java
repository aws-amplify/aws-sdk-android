...
public class StreamSelection implements Serializable {
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>ORIGINAL, VIDEO_BITRATE_ASCENDING,
     ...
     * The maximum video bitrate (bps) to include in output.
     *
     * @param maxVideoBitsPerSecond The maximum video bitrate (bps) to include
     *            in output.
     */
     ...
     * The minimum video bitrate (bps) to include in output.
     *
     * @param minVideoBitsPerSecond The minimum video bitrate (bps) to include
     *            in output.
     */
     ...
     * VIDEO_BITRATE_DESCENDING
     *
     * @param streamOrder A directive that determines the order of streams in
     *            the output.
     * @see StreamOrder
     */
    ...
    public String toString() {
        ...
        if (getMaxVideoBitsPerSecond() != null)
            sb.append("MaxVideoBitsPerSecond: " + getMaxVideoBitsPerSecond() + ",");
        if (getMinVideoBitsPerSecond() != null)
            sb.append("MinVideoBitsPerSecond: " + getMinVideoBitsPerSecond() + ",");
        if (getStreamOrder() != null)
            sb.append("StreamOrder: " + getStreamOrder());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getMaxVideoBitsPerSecond() == null) ? 0 : getMaxVideoBitsPerSecond().hashCode());
        hashCode = prime
                * hashCode
                + ((getMinVideoBitsPerSecond() == null) ? 0 : getMinVideoBitsPerSecond().hashCode());
        hashCode = prime * hashCode
                + ((getStreamOrder() == null) ? 0 : getStreamOrder().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getMaxVideoBitsPerSecond() == null ^ this.getMaxVideoBitsPerSecond() == null)
            return false;
        if (other.getMaxVideoBitsPerSecond() != null
                && other.getMaxVideoBitsPerSecond().equals(this.getMaxVideoBitsPerSecond()) == false)
            return false;
        if (other.getMinVideoBitsPerSecond() == null ^ this.getMinVideoBitsPerSecond() == null)
            return false;
        if (other.getMinVideoBitsPerSecond() != null
                && other.getMinVideoBitsPerSecond().equals(this.getMinVideoBitsPerSecond()) == false)
            return false;
        if (other.getStreamOrder() == null ^ this.getStreamOrder() == null)
            return false;
        if (other.getStreamOrder() != null
                && other.getStreamOrder().equals(this.getStreamOrder()) == false)
            return false;
        return true;
    }
}
