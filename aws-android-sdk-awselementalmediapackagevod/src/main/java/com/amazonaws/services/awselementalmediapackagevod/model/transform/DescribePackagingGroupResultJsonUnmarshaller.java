 ...
 */
public class DescribePackagingGroupResultJsonUnmarshaller implements
        Unmarshaller<DescribePackagingGroupResult, JsonUnmarshallerContext> {

    public DescribePackagingGroupResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Arn")) {
                ...
                describePackagingGroupResult.setTags(new MapUnmarshaller<String>(
