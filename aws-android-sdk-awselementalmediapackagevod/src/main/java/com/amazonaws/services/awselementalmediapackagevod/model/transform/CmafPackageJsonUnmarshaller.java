...
/**
 * JSON unmarshaller for POJO CmafPackage
 */
class CmafPackageJsonUnmarshaller implements Unmarshaller<CmafPackage, JsonUnmarshallerContext> {
    ...
    public CmafPackage unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Encryption")) {
                cmafPackage.setEncryption(CmafEncryptionJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("HlsManifests")) {
                cmafPackage.setHlsManifests(new ListUnmarshaller<HlsManifest>(
                        HlsManifestJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("SegmentDurationSeconds")) {
                cmafPackage.setSegmentDurationSeconds(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
