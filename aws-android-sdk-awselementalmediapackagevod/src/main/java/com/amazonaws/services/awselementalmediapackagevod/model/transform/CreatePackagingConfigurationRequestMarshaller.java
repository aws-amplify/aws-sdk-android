...
public class CreatePackagingConfigurationRequestMarshaller
    ...
    public Request<CreatePackagingConfigurationRequest> marshall(
            CreatePackagingConfigurationRequest createPackagingConfigurationRequest) {
        if (createPackagingConfigurationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreatePackagingConfigurationRequest)");
        }

        Request<CreatePackagingConfigurationRequest> request = new DefaultRequest<CreatePackagingConfigurationRequest>(
                createPackagingConfigurationRequest, "AWSElementalMediaPackageVOD");
