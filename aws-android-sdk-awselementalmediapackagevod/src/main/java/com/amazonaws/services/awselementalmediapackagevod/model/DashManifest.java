...
public class DashManifest implements Serializable {
     ...
     * <b>Allowed Values: </b>FULL, COMPACT
     *
     * @return Determines the position of some tags in the Media Presentation
     *         Description (MPD). When set to FULL, elements like
     *         SegmentTemplate and ContentProtection are included in each
     *         Representation. When set to COMPACT, duplicate elements are
     ...
     * <b>Allowed Values: </b>FULL, COMPACT
     *
     * @param manifestLayout Determines the position of some tags in the Media
     *            Presentation Description (MPD). When set to FULL, elements
     *            like SegmentTemplate and ContentProtection are included in
     *            each Representation. When set to COMPACT, duplicate elements
     ...
     * starting the presentation.
     *
     * @return Minimum duration (in seconds) that a player will buffer media
     ...
     * starting the presentation.
     *
     * @param minBufferTimeSeconds Minimum duration (in seconds) that a player
     ...
     * <b>Allowed Values: </b>NONE, HBBTV_1_5
     *
     * @return The Dynamic Adaptive Streaming over HTTP (DASH) profile type.
     ...
     * <b>Allowed Values: </b>NONE, HBBTV_1_5
     *
     * @param profile The Dynamic Adaptive Streaming over HTTP (DASH) profile
     *            type. When set to "HBBTV_1_5", HbbTV 1.5 compliant output is
     *            enabled.
     * @see Profile
     */
    ...
    public String toString() {
        ...
        if (getManifestLayout() != null)
            sb.append("ManifestLayout: " + getManifestLayout() + ",");
        if (getManifestName() != null)
            sb.append("ManifestName: " + getManifestName() + ",");
        if (getMinBufferTimeSeconds() != null)
            sb.append("MinBufferTimeSeconds: " + getMinBufferTimeSeconds() + ",");
        if (getProfile() != null)
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getManifestLayout() == null) ? 0 : getManifestLayout().hashCode());
        hashCode = prime * hashCode
                + ((getManifestName() == null) ? 0 : getManifestName().hashCode());
        hashCode = prime * hashCode
                + ((getMinBufferTimeSeconds() == null) ? 0 : getMinBufferTimeSeconds().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getManifestLayout() == null ^ this.getManifestLayout() == null)
            return false;
        if (other.getManifestLayout() != null
                && other.getManifestLayout().equals(this.getManifestLayout()) == false)
            return false;
        ...
        if (other.getMinBufferTimeSeconds() == null ^ this.getMinBufferTimeSeconds() == null)
            return false;
        if (other.getMinBufferTimeSeconds() != null
                && other.getMinBufferTimeSeconds().equals(this.getMinBufferTimeSeconds()) == false)
            return false;
