 ...
 */
class PackagingGroupJsonUnmarshaller implements
        Unmarshaller<PackagingGroup, JsonUnmarshallerContext> {
    ...
    public PackagingGroup unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Arn")) {
                ...
                packagingGroup.setTags(new MapUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
