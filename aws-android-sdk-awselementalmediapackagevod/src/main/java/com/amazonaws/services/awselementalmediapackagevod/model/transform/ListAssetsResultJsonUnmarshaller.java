 ...
 */
public class ListAssetsResultJsonUnmarshaller implements
        Unmarshaller<ListAssetsResult, JsonUnmarshallerContext> {
    ...
    public ListAssetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Assets")) {
                listAssetsResult.setAssets(new ListUnmarshaller<AssetShallow>(
                        AssetShallowJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
