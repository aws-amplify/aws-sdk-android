...
/**
 * JSON unmarshaller for response DeletePackagingConfigurationResult
 */
public class DeletePackagingConfigurationResultJsonUnmarshaller implements
        Unmarshaller<DeletePackagingConfigurationResult, JsonUnmarshallerContext> {

    public DeletePackagingConfigurationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
