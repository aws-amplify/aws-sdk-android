 ...
 */
public class DeletePackagingConfigurationRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     ...
     * The ID of the MediaPackage VOD PackagingConfiguration resource to delete.
     *
     * @return The ID of the MediaPackage VOD PackagingConfiguration resource to
     *         delete.
     */
    public String getId() {
        return id;
     ...
     * The ID of the MediaPackage VOD PackagingConfiguration resource to delete.
     *
     * @param id The ID of the MediaPackage VOD PackagingConfiguration resource
     *            to delete.
     */
