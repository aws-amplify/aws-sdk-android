...
public class SpekeKeyProvider implements Serializable {
     ...
     * MediaPackage will assume when accessing the key provider service.
     * 
     * @param roleArn An Amazon Resource Name (ARN) of an IAM role that AWS
     ...
     * @param roleArn An Amazon Resource Name (ARN) of an IAM role that AWS
     *            Elemental MediaPackage will assume when accessing the key
     *            provider service. @return A reference to this updated object so that method calls can be
     *         chained together.
     */
