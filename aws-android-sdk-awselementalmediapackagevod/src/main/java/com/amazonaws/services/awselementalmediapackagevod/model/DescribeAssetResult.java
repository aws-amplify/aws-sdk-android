...
public class DescribeAssetResult implements Serializable {
     ...
     * The list of egress endpoints available for the Asset.
     *
     * @param egressEndpoints The list of egress endpoints available for the
     *            Asset.
     */
     ...
     *         chained together.
     */
    public DescribeAssetResult withEgressEndpoints(
            java.util.Collection<EgressEndpoint> egressEndpoints) {
     ...
     * The IAM role_arn used to access the source S3 bucket.
     *
     * @param sourceRoleArn The IAM role_arn used to access the source S3
     *            bucket.
     */
