...
public class DashPackage implements Serializable {
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>NUMBER_WITH_TIMELINE, TIME_WITH_TIMELINE,
     ...
     * A Dynamic Adaptive Streaming over HTTP (DASH) encryption configuration.
     *
     * @return A Dynamic Adaptive Streaming over HTTP (DASH) encryption
     *         configuration.
     */
     ...
     * A Dynamic Adaptive Streaming over HTTP (DASH) encryption configuration.
     *
     * @param encryption A Dynamic Adaptive Streaming over HTTP (DASH)
     ...
     * periods will be created where the Asset contains SCTE-35 ad markers.
     * 
     * @return A list of triggers that controls when the outgoing Dynamic
     *         Adaptive Streaming over HTTP (DASH) Media Presentation
     *         Description (MPD) will be partitioned into multiple periods. If
     *         empty, the content will not be partitioned into more than one
     *         period. If the list contains "ADS", new periods will be created
     ...
     * periods will be created where the Asset contains SCTE-35 ad markers.
     * 
     * @param periodTriggers A list of triggers that controls when the outgoing
     *            Dynamic Adaptive Streaming over HTTP (DASH) Media Presentation
     *            Description (MPD) will be partitioned into multiple periods.
     *            If empty, the content will not be partitioned into more than
     *            one period. If the list contains "ADS", new periods will be
     ...
     * partitioned into multiple periods. If empty, the content will not be
     * partitioned into more than one period. If the list contains "ADS", new
     * periods will be created where the Asset contains SCTE-35 ad markers. <p>
     * Returns a reference to this object so that method calls can be chained
     * together.
     *
     * @param periodTriggers A list of triggers that controls when the outgoing
     ...
     *            If empty, the content will not be partitioned into more than
     *            one period. If the list contains "ADS", new periods will be
     *            created where the Asset contains SCTE-35 ad markers. @return A reference to this updated object so that method calls can be
     *         chained together.
     */
     ...
     *            Actual segments will be rounded to the nearest multiple of the
    ...
    /**
     * Duration (in seconds) of each segment. Actual segments will be rounded to
     * the nearest multiple of the source segment duration. <p>
     * Returns a reference to this object so that method calls can be chained
     * together.
     *
     * @param segmentDurationSeconds Duration (in seconds) of each segment.
     *            Actual segments will be rounded to the nearest multiple of the
     *            source segment duration. @return A reference to this updated object so that method calls can be
     *         chained together.
     */
     ...
     * NUMBER_WITH_DURATION
     *
     * @return Determines the type of SegmentTemplate included in the Media
     *         Presentation Description (MPD). When set to NUMBER_WITH_TIMELINE,
     *         a full timeline is presented in each SegmentTemplate, with
     ...
     * NUMBER_WITH_DURATION
     *
     * @param segmentTemplateFormat Determines the type of SegmentTemplate
     *            included in the Media Presentation Description (MPD). When set
     *            to NUMBER_WITH_TIMELINE, a full timeline is presented in each
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getDashManifests() != null)
            sb.append("DashManifests: " + getDashManifests() + ",");
        if (getEncryption() != null)
            sb.append("Encryption: " + getEncryption() + ",");
        if (getPeriodTriggers() != null)
            sb.append("PeriodTriggers: " + getPeriodTriggers() + ",");
        ...
        if (getSegmentTemplateFormat() != null)
            sb.append("SegmentTemplateFormat: " + getSegmentTemplateFormat());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getDashManifests() == null) ? 0 : getDashManifests().hashCode());
        hashCode = prime * hashCode + ((getEncryption() == null) ? 0 : getEncryption().hashCode());
        hashCode = prime * hashCode
                + ((getPeriodTriggers() == null) ? 0 : getPeriodTriggers().hashCode());
        hashCode = prime
                * hashCode
        ...
        hashCode = prime
                * hashCode
                + ((getSegmentTemplateFormat() == null) ? 0 : getSegmentTemplateFormat().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDashManifests() == null ^ this.getDashManifests() == null)
            return false;
        if (other.getDashManifests() != null
                && other.getDashManifests().equals(this.getDashManifests()) == false)
            return false;
        ...
        if (other.getPeriodTriggers() == null ^ this.getPeriodTriggers() == null)
            return false;
        if (other.getPeriodTriggers() != null
                && other.getPeriodTriggers().equals(this.getPeriodTriggers()) == false)
            return false;
        ...
        if (other.getSegmentTemplateFormat() == null ^ this.getSegmentTemplateFormat() == null)
            return false;
        if (other.getSegmentTemplateFormat() != null
                && other.getSegmentTemplateFormat().equals(this.getSegmentTemplateFormat()) == false)
            return false;
        return true;
    }
}
