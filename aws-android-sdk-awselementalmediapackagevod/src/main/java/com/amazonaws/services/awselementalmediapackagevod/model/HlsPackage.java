...
public class HlsPackage implements Serializable {
     ...
     *            Actual fragments will be rounded to the nearest multiple of
    ...
    /**
     * Duration (in seconds) of each fragment. Actual fragments will be rounded
     * to the nearest multiple of the source fragment duration. <p>
     * Returns a reference to this object so that method calls can be chained
     * together.
     *
     * @param segmentDurationSeconds Duration (in seconds) of each fragment.
     *            Actual fragments will be rounded to the nearest multiple of
     *            the source fragment duration. @return A reference to this updated object so that method calls can be
     *         chained together.
     */
     ...
     * output.
     *
     * @return When enabled, audio streams will be placed in rendition groups in
     *         the output.
     */
     ...
     * output.
     *
     * @param useAudioRenditionGroup When enabled, audio streams will be placed
    ...
    public String toString() {
        ...
        if (getHlsManifests() != null)
            sb.append("HlsManifests: " + getHlsManifests() + ",");
        ...
        if (getUseAudioRenditionGroup() != null)
            sb.append("UseAudioRenditionGroup: " + getUseAudioRenditionGroup());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getHlsManifests() == null) ? 0 : getHlsManifests().hashCode());
        hashCode = prime
                * hashCode
        ...
        hashCode = prime
                * hashCode
                + ((getUseAudioRenditionGroup() == null) ? 0 : getUseAudioRenditionGroup()
                        .hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getHlsManifests() == null ^ this.getHlsManifests() == null)
            return false;
        if (other.getHlsManifests() != null
                && other.getHlsManifests().equals(this.getHlsManifests()) == false)
            return false;
        ...
        if (other.getUseAudioRenditionGroup() == null ^ this.getUseAudioRenditionGroup() == null)
            return false;
        if (other.getUseAudioRenditionGroup() != null
                && other.getUseAudioRenditionGroup().equals(this.getUseAudioRenditionGroup()) == false)
            return false;
        return true;
    }
}
