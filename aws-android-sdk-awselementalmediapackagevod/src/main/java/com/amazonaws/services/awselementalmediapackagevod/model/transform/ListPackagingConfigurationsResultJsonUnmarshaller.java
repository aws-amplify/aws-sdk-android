 ...
 */
public class ListPackagingConfigurationsResultJsonUnmarshaller implements
        Unmarshaller<ListPackagingConfigurationsResult, JsonUnmarshallerContext> {

    public ListPackagingConfigurationsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NextToken")) {
                ...
                listPackagingConfigurationsResult
                        .setPackagingConfigurations(new ListUnmarshaller<PackagingConfiguration>(
