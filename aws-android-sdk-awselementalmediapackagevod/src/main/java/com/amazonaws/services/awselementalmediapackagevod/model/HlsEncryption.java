...
public class HlsEncryption implements Serializable {
     ...
     * specified the initialization vector will be periodically rotated.
     * 
     * @return A constant initialization vector for encryption (optional). When
     *         not specified the initialization vector will be periodically
     *         rotated.
     */
     ...
     * specified the initialization vector will be periodically rotated.
     * 
     * @param constantInitializationVector A constant initialization vector for
     *            encryption (optional). When not specified the initialization
    ...
    /**
     * A constant initialization vector for encryption (optional). When not
     * specified the initialization vector will be periodically rotated. <p>
     * Returns a reference to this object so that method calls can be chained
     * together.
     *
     * @param constantInitializationVector A constant initialization vector for
     *            encryption (optional). When not specified the initialization
     *            vector will be periodically rotated. @return A reference to this updated object so that method calls can be
     *         chained together.
     */
