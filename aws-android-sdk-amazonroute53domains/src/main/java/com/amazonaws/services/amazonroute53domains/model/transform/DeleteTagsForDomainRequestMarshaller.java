...
/**
 * JSON request marshaller for DeleteTagsForDomainRequest
 */
public class DeleteTagsForDomainRequestMarshaller implements
    ...
    public Request<DeleteTagsForDomainRequest> marshall(
        ...
        if (deleteTagsForDomainRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteTagsForDomainRequest)");
        }
        ...
        try {
            ...
            if (deleteTagsForDomainRequest.getDomainName() != null) {
                String domainName = deleteTagsForDomainRequest.getDomainName();
                jsonWriter.name("DomainName");
                jsonWriter.value(domainName);
            }
            if (deleteTagsForDomainRequest.getTagsToDelete() != null) {
                java.util.List<String> tagsToDelete = deleteTagsForDomainRequest.getTagsToDelete();
                jsonWriter.name("TagsToDelete");
                jsonWriter.beginArray();
                for (String tagsToDeleteItem : tagsToDelete) {
                    if (tagsToDeleteItem != null) {
                        jsonWriter.value(tagsToDeleteItem);
                    }
                }
                jsonWriter.endArray();
            }
