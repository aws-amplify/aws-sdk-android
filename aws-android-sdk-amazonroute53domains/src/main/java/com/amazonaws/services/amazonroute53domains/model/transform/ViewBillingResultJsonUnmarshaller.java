...
/**
 * JSON unmarshaller for response ViewBillingResult
 */
public class ViewBillingResultJsonUnmarshaller implements
    ...
    public ViewBillingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NextPageMarker")) {
                viewBillingResult.setNextPageMarker(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("BillingRecords")) {
                viewBillingResult.setBillingRecords(new ListUnmarshaller<BillingRecord>(
