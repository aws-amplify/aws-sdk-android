...
/**
 * JSON request marshaller for UpdateTagsForDomainRequest
 */
public class UpdateTagsForDomainRequestMarshaller implements
    ...
    public Request<UpdateTagsForDomainRequest> marshall(
        ...
        if (updateTagsForDomainRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateTagsForDomainRequest)");
        }
        ...
        try {
            ...
            if (updateTagsForDomainRequest.getDomainName() != null) {
                String domainName = updateTagsForDomainRequest.getDomainName();
                jsonWriter.name("DomainName");
                jsonWriter.value(domainName);
            }
            if (updateTagsForDomainRequest.getTagsToUpdate() != null) {
                java.util.List<Tag> tagsToUpdate = updateTagsForDomainRequest.getTagsToUpdate();
                jsonWriter.name("TagsToUpdate");
                jsonWriter.beginArray();
                for (Tag tagsToUpdateItem : tagsToUpdate) {
                    if (tagsToUpdateItem != null) {
                        TagJsonMarshaller.getInstance().marshall(tagsToUpdateItem, jsonWriter);
                    }
                }
                jsonWriter.endArray();
            }
