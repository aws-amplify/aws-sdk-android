...
/**
 * JSON request marshaller for DisableDomainAutoRenewRequest
 */
public class DisableDomainAutoRenewRequestMarshaller implements
    ...
    public Request<DisableDomainAutoRenewRequest> marshall(
        ...
        if (disableDomainAutoRenewRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DisableDomainAutoRenewRequest)");
        }
        ...
        try {
            ...
            if (disableDomainAutoRenewRequest.getDomainName() != null) {
                String domainName = disableDomainAutoRenewRequest.getDomainName();
