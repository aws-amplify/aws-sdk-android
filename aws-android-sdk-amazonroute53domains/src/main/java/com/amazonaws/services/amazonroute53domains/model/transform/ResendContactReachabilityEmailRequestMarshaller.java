...
/**
 * JSON request marshaller for ResendContactReachabilityEmailRequest
 */
public class ResendContactReachabilityEmailRequestMarshaller
    ...
    public Request<ResendContactReachabilityEmailRequest> marshall(
        ...
        if (resendContactReachabilityEmailRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ResendContactReachabilityEmailRequest)");
        }
        ...
        try {
            ...
            if (resendContactReachabilityEmailRequest.getDomainName() != null) {
                String domainName = resendContactReachabilityEmailRequest.getDomainName();
