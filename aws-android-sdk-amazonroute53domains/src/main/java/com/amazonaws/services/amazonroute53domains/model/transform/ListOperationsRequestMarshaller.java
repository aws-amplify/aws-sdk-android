...
public class ListOperationsRequestMarshaller implements
    ...
    public Request<ListOperationsRequest> marshall(ListOperationsRequest listOperationsRequest) {
        ...
        try {
            ...
            if (listOperationsRequest.getSubmittedSince() != null) {
                java.util.Date submittedSince = listOperationsRequest.getSubmittedSince();
                jsonWriter.name("SubmittedSince");
                jsonWriter.value(submittedSince);
            }
            if (listOperationsRequest.getMarker() != null) {
                String marker = listOperationsRequest.getMarker();
                jsonWriter.name("Marker");
                jsonWriter.value(marker);
            }
            if (listOperationsRequest.getMaxItems() != null) {
                Integer maxItems = listOperationsRequest.getMaxItems();
