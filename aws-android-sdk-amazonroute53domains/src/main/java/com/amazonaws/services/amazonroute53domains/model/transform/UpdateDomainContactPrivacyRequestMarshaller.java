...
/**
 * JSON request marshaller for UpdateDomainContactPrivacyRequest
 */
public class UpdateDomainContactPrivacyRequestMarshaller implements
    ...
    public Request<UpdateDomainContactPrivacyRequest> marshall(
        ...
        if (updateDomainContactPrivacyRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateDomainContactPrivacyRequest)");
        }
        ...
        try {
            ...
            if (updateDomainContactPrivacyRequest.getDomainName() != null) {
                String domainName = updateDomainContactPrivacyRequest.getDomainName();
                jsonWriter.name("DomainName");
                jsonWriter.value(domainName);
            }
            if (updateDomainContactPrivacyRequest.getAdminPrivacy() != null) {
                Boolean adminPrivacy = updateDomainContactPrivacyRequest.getAdminPrivacy();
                jsonWriter.name("AdminPrivacy");
                jsonWriter.value(adminPrivacy);
            }
            if (updateDomainContactPrivacyRequest.getRegistrantPrivacy() != null) {
                Boolean registrantPrivacy = updateDomainContactPrivacyRequest
                        .getRegistrantPrivacy();
                jsonWriter.name("RegistrantPrivacy");
                jsonWriter.value(registrantPrivacy);
            }
            if (updateDomainContactPrivacyRequest.getTechPrivacy() != null) {
                Boolean techPrivacy = updateDomainContactPrivacyRequest.getTechPrivacy();
                jsonWriter.name("TechPrivacy");
                jsonWriter.value(techPrivacy);
            }
