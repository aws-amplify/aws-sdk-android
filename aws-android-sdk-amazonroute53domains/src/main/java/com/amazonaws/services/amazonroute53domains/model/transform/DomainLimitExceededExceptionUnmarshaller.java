...
import com.amazonaws.services.amazonroute53domains.model.DomainLimitExceededException;
...
public class DomainLimitExceededExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("DomainLimitExceeded");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        DomainLimitExceededException e = (DomainLimitExceededException) super.unmarshall(error);
