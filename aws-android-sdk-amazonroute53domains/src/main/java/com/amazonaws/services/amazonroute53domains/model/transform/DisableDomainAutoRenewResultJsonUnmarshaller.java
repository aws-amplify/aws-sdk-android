...
/**
 * JSON unmarshaller for response DisableDomainAutoRenewResult
 */
public class DisableDomainAutoRenewResultJsonUnmarshaller implements
        Unmarshaller<DisableDomainAutoRenewResult, JsonUnmarshallerContext> {

    public DisableDomainAutoRenewResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
