...
public class ExtraParam implements Serializable {
     ...
     * domain. Here are the top-level domains that require additional parameters
     * and the names of the parameters that they require:
     * </p>
     * <dl>
     ...
     * </p>
     * <p>
     * When <code>ContactType</code> is <code>PERSON</code>, valid values
     ...
     * <li>
     * <p>
     * <code>BIRTH_DEPARTMENT</code>: Specify the INSEE code that corresponds
     * with the department where the contact was born. If the contact was born
     * somewhere other than France or its overseas departments, specify
     * <code>99</code>. For more information, including a list of departments
     * and the corresponding INSEE numbers, see the Wikipedia entry <a
     ...
     * <li>
     * <p>
     * <code>ITALIAN_COMPANIES</code> (Italian companies and one-person
     * companies)
     * </p>
     * </li>
     * <li>
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>DUNS_NUMBER, BRAND_NUMBER, BIRTH_DEPARTMENT,
     ...
     * CA_LEGAL_REPRESENTATIVE, CA_LEGAL_REPRESENTATIVE_CAPACITY,
     * ES_IDENTIFICATION, ES_IDENTIFICATION_TYPE, ES_LEGAL_FORM,
     * FI_BUSINESS_NUMBER, FI_ID_NUMBER, FI_NATIONALITY, FI_ORGANIZATION_TYPE,
     * IT_NATIONALITY, IT_PIN, IT_REGISTRANT_ENTITY_TYPE, RU_PASSPORT_DATA,
     * SE_ID_NUMBER, SG_ID_NUMBER, VAT_NUMBER, UK_CONTACT_TYPE,
     * UK_COMPANY_NUMBER
     */
    private String name;
     ...
     *         additional parameters and the names of the parameters that they
     *         require:
     *         </p>
     *         <dl>
     *         <dt>.com.au and .net.au</dt>
     ...
     *         </p>
     *         <p>
     *         When <code>ContactType</code> is <code>PERSON</code>, valid
     ...
     *         <li>
     *         <p>
     *         <code>LGR</code> (Legal Representative of a Canadian Citizen or
     *         Permanent Resident)
     *         </p>
     *         </li>
     *         <li>
     ...
     *         </ul>
     *         <p>
     *         When <code>ContactType</code> is a value other than
     *         <code>PERSON</code>, valid values include the following:
     *         </p>
     *         <ul>
     *         <li>
     *         <p>
     ...
     *         <li>
     *         <p>
     *         <code>INB</code> (Indian Band recognized by the Indian Act of
     *         Canada)
     *         </p>
     *         </li>
     *         <li>
     ...
     *         <li>
     *         <p>
     *         <b>For contacts outside of Spain:</b> Enter the VAT
     ...
     *         corresponds with the department where the contact was born. If
     *         the contact was born somewhere other than France or its overseas
     *         departments, specify <code>99</code>. For more information,
     *         including a list of departments and the corresponding INSEE
     *         numbers, see the Wikipedia entry <a
     *         href="https://en.wikipedia.org/wiki/Departments_of_France"
     *         >Departments of France</a>.
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     ...
     *         <li>
     *         <p>
     *         <code>FOTHER</code> (Non-UK Entity that does not fit into any
     *         other category)
     *         </p>
     *         </li>
     *         <li>
     ...
     *         <li>
     *         <p>
     *         <code>OTHER</code> (UK Entity that does not fit into any other
     *         category)
     *         </p>
     *         </li>
     *         <li>
     ...
     *            The name of an additional parameter that is required by a
     *            top-level domain. Here are the top-level domains that require
     *            additional parameters and the names of the parameters that
     *            they require:
     *            </p>
     *            <dl>
     *            <dt>.com.au and .net.au</dt>
     ...
     *            <li>
     *            <p>
     *            <code>LGR</code> (Legal Representative of a Canadian Citizen
     ...
     *            <code>BIRTH_DEPARTMENT</code>: Specify the INSEE code that
     *            corresponds with the department where the contact was born. If
     *            the contact was born somewhere other than France or its
     *            overseas departments, specify <code>99</code>. For more
     *            information, including a list of departments and the
     *            corresponding INSEE numbers, see the Wikipedia entry <a
     *            href="https://en.wikipedia.org/wiki/Departments_of_France"
     *            >Departments of France</a>.
     *            </p>
     *            </li>
