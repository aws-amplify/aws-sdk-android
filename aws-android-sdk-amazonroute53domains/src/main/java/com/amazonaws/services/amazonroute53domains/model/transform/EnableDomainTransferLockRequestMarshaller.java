...
/**
 * JSON request marshaller for EnableDomainTransferLockRequest
 */
public class EnableDomainTransferLockRequestMarshaller implements
        Marshaller<Request<EnableDomainTransferLockRequest>, EnableDomainTransferLockRequest> {
    ...
    public Request<EnableDomainTransferLockRequest> marshall(
        ...
        if (enableDomainTransferLockRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(EnableDomainTransferLockRequest)");
        }

        Request<EnableDomainTransferLockRequest> request = new DefaultRequest<EnableDomainTransferLockRequest>(
        ...
        try {
            ...
            if (enableDomainTransferLockRequest.getDomainName() != null) {
                String domainName = enableDomainTransferLockRequest.getDomainName();
