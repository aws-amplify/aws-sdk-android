...
/**
 * JSON unmarshaller for response RetrieveDomainAuthCodeResult
 */
public class RetrieveDomainAuthCodeResultJsonUnmarshaller implements
    ...
    public RetrieveDomainAuthCodeResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AuthCode")) {
                retrieveDomainAuthCodeResult.setAuthCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
