...
/**
 * JSON request marshaller for UpdateDomainContactRequest
 */
public class UpdateDomainContactRequestMarshaller implements
    ...
    public Request<UpdateDomainContactRequest> marshall(
        ...
        if (updateDomainContactRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateDomainContactRequest)");
        }
        ...
        try {
            ...
            if (updateDomainContactRequest.getDomainName() != null) {
                String domainName = updateDomainContactRequest.getDomainName();
