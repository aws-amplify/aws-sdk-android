...
/**
 * JSON request marshaller for RetrieveDomainAuthCodeRequest
 */
public class RetrieveDomainAuthCodeRequestMarshaller implements
    ...
    public Request<RetrieveDomainAuthCodeRequest> marshall(
        ...
        if (retrieveDomainAuthCodeRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RetrieveDomainAuthCodeRequest)");
        }
        ...
        try {
            ...
            if (retrieveDomainAuthCodeRequest.getDomainName() != null) {
                String domainName = retrieveDomainAuthCodeRequest.getDomainName();
