...
/**
 * JSON unmarshaller for response GetUsageTotalsResult
 */
public class GetUsageTotalsResultJsonUnmarshaller implements
        Unmarshaller<GetUsageTotalsResult, JsonUnmarshallerContext> {
    ...
    public GetUsageTotalsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("usageTotals")) {
                getUsageTotalsResult.setUsageTotals(new ListUnmarshaller<UsageTotal>(
                        UsageTotalJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
