...
/**
 * JSON unmarshaller for POJO UserIdentityRoot
 */
class UserIdentityRootJsonUnmarshaller implements
        Unmarshaller<UserIdentityRoot, JsonUnmarshallerContext> {
    ...
    public UserIdentityRoot unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("accountId")) {
                userIdentityRoot.setAccountId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("arn")) {
                userIdentityRoot.setArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("principalId")) {
                userIdentityRoot.setPrincipalId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
