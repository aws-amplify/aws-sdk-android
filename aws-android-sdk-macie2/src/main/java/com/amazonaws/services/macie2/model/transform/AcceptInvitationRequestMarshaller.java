...
public class AcceptInvitationRequestMarshaller implements
    ...
    public Request<AcceptInvitationRequest> marshall(AcceptInvitationRequest acceptInvitationRequest) {
        ...
        Request<AcceptInvitationRequest> request = new DefaultRequest<AcceptInvitationRequest>(
                acceptInvitationRequest, "AmazonMacie2");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/invitations/accept";
        ...
        try {
            ...
            if (acceptInvitationRequest.getMasterAccount() != null) {
                String masterAccount = acceptInvitationRequest.getMasterAccount();
                jsonWriter.name("masterAccount");
                jsonWriter.value(masterAccount);
            }
