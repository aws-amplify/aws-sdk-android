...
/**
 * JSON unmarshaller for response DisassociateMemberResult
 */
public class DisassociateMemberResultJsonUnmarshaller implements
        Unmarshaller<DisassociateMemberResult, JsonUnmarshallerContext> {
