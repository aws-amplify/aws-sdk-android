...
/**
 * JSON unmarshaller for response CreateFindingsFilterResult
 */
public class CreateFindingsFilterResultJsonUnmarshaller implements
        Unmarshaller<CreateFindingsFilterResult, JsonUnmarshallerContext> {
    ...
    public CreateFindingsFilterResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("arn")) {
                createFindingsFilterResult.setArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("id")) {
                createFindingsFilterResult.setId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
