...
/**
 * JSON unmarshaller for response EnableMacieResult
 */
public class EnableMacieResultJsonUnmarshaller implements
        Unmarshaller<EnableMacieResult, JsonUnmarshallerContext> {
