 ...
 * </p>
 */
public class PutClassificationExportConfigurationRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     * The location to export data classification results to, and the encryption
     ...
     *
     * @return <p>
     *         The location to export data classification results to, and the
     ...
     *            The location to export data classification results to, and the
     *            encryption settings to use when storing results in that
     *            location.
     *            </p>
     */
     ...
     *         chained together.
     */
    public PutClassificationExportConfigurationRequest withConfiguration(
