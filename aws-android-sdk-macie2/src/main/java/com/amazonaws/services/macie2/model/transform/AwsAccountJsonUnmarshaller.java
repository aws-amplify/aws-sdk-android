...
/**
 * JSON unmarshaller for POJO AwsAccount
 */
class AwsAccountJsonUnmarshaller implements Unmarshaller<AwsAccount, JsonUnmarshallerContext> {
    ...
    public AwsAccount unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("accountId")) {
                awsAccount.setAccountId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("principalId")) {
                awsAccount.setPrincipalId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
