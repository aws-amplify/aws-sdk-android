...
public class GetMacieSessionResult implements Serializable {
     ...
     * This includes adding findings to AWS Security Hub and exporting finding
     ...
     *
     * @return <p>
     *         The frequency with which Amazon Macie publishes findings for the
     ...
     *            The frequency with which Amazon Macie publishes findings for
     *            the account. This includes adding findings to AWS Security Hub
