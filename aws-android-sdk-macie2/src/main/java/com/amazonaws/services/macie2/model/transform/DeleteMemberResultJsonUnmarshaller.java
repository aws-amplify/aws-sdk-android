...
/**
 * JSON unmarshaller for response DeleteMemberResult
 */
public class DeleteMemberResultJsonUnmarshaller implements
        Unmarshaller<DeleteMemberResult, JsonUnmarshallerContext> {
