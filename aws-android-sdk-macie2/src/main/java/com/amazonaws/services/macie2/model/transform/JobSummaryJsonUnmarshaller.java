    ...
    public JobSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("bucketDefinitions")) {
                jobSummary.setBucketDefinitions(new ListUnmarshaller<S3BucketDefinitionForJob>(
                ...
                jobSummary.setJobStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("jobType")) {
                jobSummary.setJobType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("name")) {
                jobSummary.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
