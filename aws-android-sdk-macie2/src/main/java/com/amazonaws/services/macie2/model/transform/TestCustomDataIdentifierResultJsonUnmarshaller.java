...
/**
 * JSON unmarshaller for response TestCustomDataIdentifierResult
 */
public class TestCustomDataIdentifierResultJsonUnmarshaller implements
        Unmarshaller<TestCustomDataIdentifierResult, JsonUnmarshallerContext> {

    public TestCustomDataIdentifierResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("matchCount")) {
                testCustomDataIdentifierResult.setMatchCount(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
