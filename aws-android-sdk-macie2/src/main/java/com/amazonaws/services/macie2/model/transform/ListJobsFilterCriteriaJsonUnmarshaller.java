...
/**
 * JSON unmarshaller for POJO ListJobsFilterCriteria
 */
class ListJobsFilterCriteriaJsonUnmarshaller implements
        Unmarshaller<ListJobsFilterCriteria, JsonUnmarshallerContext> {
    ...
    public ListJobsFilterCriteria unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("excludes")) {
                listJobsFilterCriteria.setExcludes(new ListUnmarshaller<ListJobsFilterTerm>(
                        ListJobsFilterTermJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("includes")) {
                listJobsFilterCriteria.setIncludes(new ListUnmarshaller<ListJobsFilterTerm>(
                        ListJobsFilterTermJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
