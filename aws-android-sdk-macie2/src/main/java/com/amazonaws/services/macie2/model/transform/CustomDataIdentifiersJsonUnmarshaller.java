...
/**
 * JSON unmarshaller for POJO CustomDataIdentifiers
 */
class CustomDataIdentifiersJsonUnmarshaller implements
        Unmarshaller<CustomDataIdentifiers, JsonUnmarshallerContext> {
    ...
    public CustomDataIdentifiers unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("detections")) {
                customDataIdentifiers.setDetections(new ListUnmarshaller<CustomDetection>(
                        CustomDetectionJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("totalCount")) {
                customDataIdentifiers.setTotalCount(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
