 ...
 * </p>
 */
public class ObjectCountByEncryptionType implements Serializable {
    /**
     * <p>
    ...
    public String toString() {
        ...
        if (getCustomerManaged() != null)
            sb.append("customerManaged: " + getCustomerManaged() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getCustomerManaged() == null) ? 0 : getCustomerManaged().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCustomerManaged() == null ^ this.getCustomerManaged() == null)
            return false;
        if (other.getCustomerManaged() != null
                && other.getCustomerManaged().equals(this.getCustomerManaged()) == false)
            return false;
