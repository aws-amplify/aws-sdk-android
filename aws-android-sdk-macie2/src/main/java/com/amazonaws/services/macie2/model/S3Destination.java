...
public class S3Destination implements Serializable {
    /**
     * <p>
     * The Amazon Resource Name (ARN) of the bucket. This must be the ARN of an
     * existing bucket.
     * </p>
     */
     ...
     * key to use for encryption of the exported results. This must be the ARN
     * of an existing KMS key. In addition, the key must be in the same AWS
     ...
     *
     * @return <p>
     *         The Amazon Resource Name (ARN) of the bucket. This must be the
     *         ARN of an existing bucket.
     *         </p>
     */
     ...
     *         master key to use for encryption of the exported results. This
     *         must be the ARN of an existing KMS key. In addition, the key must
     *         be in the same AWS Region as the bucket.
     *         </p>
     */
     ...
     *            Service master key to use for encryption of the exported
     *            results. This must be the ARN of an existing KMS key. In
     *            addition, the key must be in the same AWS Region as the
     *            bucket.
     *            </p>
     */
