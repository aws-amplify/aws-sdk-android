...
public class DetachVolumeRequestMarshaller implements
    ...
    public Request<DetachVolumeRequest> marshall(DetachVolumeRequest detachVolumeRequest) {
        ...
        Request<DetachVolumeRequest> request = new DefaultRequest<DetachVolumeRequest>(
                detachVolumeRequest, "AWSStorageGateway");
        ...
        try {
            ...
            if (detachVolumeRequest.getVolumeARN() != null) {
                String volumeARN = detachVolumeRequest.getVolumeARN();
                jsonWriter.name("VolumeARN");
                jsonWriter.value(volumeARN);
            }
            if (detachVolumeRequest.getForceDetach() != null) {
                Boolean forceDetach = detachVolumeRequest.getForceDetach();
                jsonWriter.name("ForceDetach");
                jsonWriter.value(forceDetach);
            }
