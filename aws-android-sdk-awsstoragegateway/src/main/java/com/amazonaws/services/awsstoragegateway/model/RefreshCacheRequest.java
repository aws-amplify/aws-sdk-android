...
public class RefreshCacheRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         <code>Recursive</code> is set to "true", the entire S3 bucket
     ...
     *            bucket. If <code>Recursive</code> is set to "true", the entire
     ...
     *         value set to "true", each folder that is listed in
     ...
     *            If this value set to "true", each folder that is listed in
     *            <code>FolderList</code> is recursively updated. Otherwise,
     *            subfolders listed in <code>FolderList</code> are not
     *            refreshed. Only objects that are in folders listed directly
     *            under <code>FolderList</code> are found and used for the
