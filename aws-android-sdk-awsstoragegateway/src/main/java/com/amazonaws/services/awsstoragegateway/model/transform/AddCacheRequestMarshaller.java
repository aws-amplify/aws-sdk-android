...
/**
 * JSON request marshaller for AddCacheRequest
 */
public class AddCacheRequestMarshaller implements
    ...
    public Request<AddCacheRequest> marshall(AddCacheRequest addCacheRequest) {
        if (addCacheRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(AddCacheRequest)");
        }

        Request<AddCacheRequest> request = new DefaultRequest<AddCacheRequest>(addCacheRequest,
                "AWSStorageGateway");
        ...
        try {
            ...
            if (addCacheRequest.getGatewayARN() != null) {
                String gatewayARN = addCacheRequest.getGatewayARN();
                jsonWriter.name("GatewayARN");
                jsonWriter.value(gatewayARN);
            }
            if (addCacheRequest.getDiskIds() != null) {
                java.util.List<String> diskIds = addCacheRequest.getDiskIds();
