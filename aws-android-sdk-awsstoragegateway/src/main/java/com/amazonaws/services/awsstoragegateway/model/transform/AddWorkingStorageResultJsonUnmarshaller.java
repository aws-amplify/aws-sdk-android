...
/**
 * JSON unmarshaller for response AddWorkingStorageResult
 */
public class AddWorkingStorageResultJsonUnmarshaller implements
        Unmarshaller<AddWorkingStorageResult, JsonUnmarshallerContext> {
    ...
    public AddWorkingStorageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("GatewayARN")) {
                addWorkingStorageResult.setGatewayARN(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
