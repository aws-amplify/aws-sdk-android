...
/**
 * JSON unmarshaller for response DescribeTapesResult
 */
public class DescribeTapesResultJsonUnmarshaller implements
    ...
    public DescribeTapesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Tapes")) {
                describeTapesResult.setTapes(new ListUnmarshaller<Tape>(TapeJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Marker")) {
                describeTapesResult.setMarker(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
