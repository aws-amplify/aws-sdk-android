...
public class UpdateSMBFileShareRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <p>
     * Set this value to
     * "true to enable ACL (access control list) on the SMB file share. Set it to "
     * false" to map file and directory permissions to the POSIX permissions.
     * </p>
     * <p>
     * For more information, see
     * https://docs.aws.amazon.com/storagegateway/latest
     * /userguide/smb-acl.htmlin the Storage Gateway User Guide.
     * </p>
     */
     ...
     *         Set this value to
     *         "true to enable ACL (access control list) on the SMB file share. Set it to "
     *         false" to map file and directory permissions to the POSIX
     *         permissions.
     *         </p>
     *         <p>
     *         For more information, see
     *         https://docs.aws.amazon.com/storagegateway
     *         /latest/userguide/smb-acl.htmlin the Storage Gateway User Guide.
     *         </p>
     */
     ...
     *            For more information, see
     *            https://docs.aws.amazon.com/storagegateway
     *            /latest/userguide/smb-acl.htmlin the Storage Gateway User
     *            Guide.
     *            </p>
     */
