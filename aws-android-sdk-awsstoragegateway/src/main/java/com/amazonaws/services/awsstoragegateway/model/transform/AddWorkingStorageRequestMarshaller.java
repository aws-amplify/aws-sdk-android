...
/**
 * JSON request marshaller for AddWorkingStorageRequest
 */
    ...
    public Request<AddWorkingStorageRequest> marshall(
        ...
        if (addWorkingStorageRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AddWorkingStorageRequest)");
        }
        ...
        try {
            ...
            if (addWorkingStorageRequest.getGatewayARN() != null) {
                String gatewayARN = addWorkingStorageRequest.getGatewayARN();
                jsonWriter.name("GatewayARN");
                jsonWriter.value(gatewayARN);
            }
            if (addWorkingStorageRequest.getDiskIds() != null) {
                java.util.List<String> diskIds = addWorkingStorageRequest.getDiskIds();
