 ...
 * create a snapshot or clone a new cached volume from a source volume. To
 * create a snapshot from a volume recovery point use the
 * <a>CreateSnapshotFromVolumeRecoveryPoint</a> operation.
 * </p>
 */
public class ListVolumeRecoveryPointsRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
