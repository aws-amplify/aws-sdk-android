...
/**
 * JSON request marshaller for RetrieveTapeArchiveRequest
 */
public class RetrieveTapeArchiveRequestMarshaller implements
    ...
    public Request<RetrieveTapeArchiveRequest> marshall(
        ...
        if (retrieveTapeArchiveRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RetrieveTapeArchiveRequest)");
        }
        ...
        try {
            ...
            if (retrieveTapeArchiveRequest.getTapeARN() != null) {
                String tapeARN = retrieveTapeArchiveRequest.getTapeARN();
                jsonWriter.name("TapeARN");
                jsonWriter.value(tapeARN);
            }
            if (retrieveTapeArchiveRequest.getGatewayARN() != null) {
                String gatewayARN = retrieveTapeArchiveRequest.getGatewayARN();
