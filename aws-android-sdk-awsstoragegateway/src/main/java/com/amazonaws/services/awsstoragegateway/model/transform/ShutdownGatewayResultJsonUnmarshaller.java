...
/**
 * JSON unmarshaller for response ShutdownGatewayResult
 */
public class ShutdownGatewayResultJsonUnmarshaller implements
        Unmarshaller<ShutdownGatewayResult, JsonUnmarshallerContext> {
    ...
    public ShutdownGatewayResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("GatewayARN")) {
                shutdownGatewayResult.setGatewayARN(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
