...
/**
 * JSON request marshaller for UpdateChapCredentialsRequest
 */
public class UpdateChapCredentialsRequestMarshaller implements
        Marshaller<Request<UpdateChapCredentialsRequest>, UpdateChapCredentialsRequest> {

    public Request<UpdateChapCredentialsRequest> marshall(
            UpdateChapCredentialsRequest updateChapCredentialsRequest) {
        if (updateChapCredentialsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateChapCredentialsRequest)");
        }

        Request<UpdateChapCredentialsRequest> request = new DefaultRequest<UpdateChapCredentialsRequest>(
                updateChapCredentialsRequest, "AWSStorageGateway");
        ...
        try {
            ...
            if (updateChapCredentialsRequest.getTargetARN() != null) {
                String targetARN = updateChapCredentialsRequest.getTargetARN();
                jsonWriter.name("TargetARN");
                jsonWriter.value(targetARN);
            }
            if (updateChapCredentialsRequest.getSecretToAuthenticateInitiator() != null) {
                String secretToAuthenticateInitiator = updateChapCredentialsRequest
            ...
            if (updateChapCredentialsRequest.getInitiatorName() != null) {
                String initiatorName = updateChapCredentialsRequest.getInitiatorName();
            ...
            if (updateChapCredentialsRequest.getSecretToAuthenticateTarget() != null) {
                String secretToAuthenticateTarget = updateChapCredentialsRequest
