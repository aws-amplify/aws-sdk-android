...
/**
 * JSON request marshaller for StartGatewayRequest
 */
    ...
    public Request<StartGatewayRequest> marshall(StartGatewayRequest startGatewayRequest) {
        if (startGatewayRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(StartGatewayRequest)");
        }
        ...
        try {
            ...
            if (startGatewayRequest.getGatewayARN() != null) {
                String gatewayARN = startGatewayRequest.getGatewayARN();
