...
/**
 * JSON unmarshaller for response CreateCachediSCSIVolumeResult
 */
public class CreateCachediSCSIVolumeResultJsonUnmarshaller implements
        Unmarshaller<CreateCachediSCSIVolumeResult, JsonUnmarshallerContext> {
    ...
    public CreateCachediSCSIVolumeResult unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("VolumeARN")) {
                createCachediSCSIVolumeResult.setVolumeARN(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TargetARN")) {
                createCachediSCSIVolumeResult.setTargetARN(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
