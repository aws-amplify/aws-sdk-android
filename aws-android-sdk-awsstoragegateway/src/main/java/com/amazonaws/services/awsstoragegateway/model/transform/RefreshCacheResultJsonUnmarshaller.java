...
/**
 * JSON unmarshaller for response RefreshCacheResult
 */
public class RefreshCacheResultJsonUnmarshaller implements
        Unmarshaller<RefreshCacheResult, JsonUnmarshallerContext> {
    ...
    public RefreshCacheResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("FileShareARN")) {
                refreshCacheResult.setFileShareARN(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("NotificationId")) {
                refreshCacheResult.setNotificationId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
