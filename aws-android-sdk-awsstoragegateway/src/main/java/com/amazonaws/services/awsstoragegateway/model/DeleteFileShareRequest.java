...
public class DeleteFileShareRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * @return <p>
     *         If this value is set to true, the operation deletes a file share
     *         immediately and aborts all data uploads to AWS. Otherwise, the
     *         file share is not deleted until all data is uploaded to AWS. This
     *         process aborts the data upload process, and the file share enters
     ...
     *            share immediately and aborts all data uploads to AWS.
     *            Otherwise, the file share is not deleted until all data is
     *            uploaded to AWS. This process aborts the data upload process,
