...
/**
 * JSON unmarshaller for response DescribeNFSFileSharesResult
 */
public class DescribeNFSFileSharesResultJsonUnmarshaller implements
        Unmarshaller<DescribeNFSFileSharesResult, JsonUnmarshallerContext> {
    ...
    public DescribeNFSFileSharesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NFSFileShareInfoList")) {
                describeNFSFileSharesResult
                        .setNFSFileShareInfoList(new ListUnmarshaller<NFSFileShareInfo>(
                                NFSFileShareInfoJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
