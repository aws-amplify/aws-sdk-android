...
class ComplianceJsonMarshaller {
    ...
    public void marshall(Compliance compliance, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (compliance.getStatusReasons() != null) {
            java.util.List<StatusReason> statusReasons = compliance.getStatusReasons();
            jsonWriter.name("StatusReasons");
            jsonWriter.beginArray();
            for (StatusReason statusReasonsItem : statusReasons) {
                if (statusReasonsItem != null) {
                    StatusReasonJsonMarshaller.getInstance()
                            .marshall(statusReasonsItem, jsonWriter);
                }
            }
            jsonWriter.endArray();
        }
