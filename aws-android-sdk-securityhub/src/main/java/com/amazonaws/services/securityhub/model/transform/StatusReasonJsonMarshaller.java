...
class StatusReasonJsonMarshaller {
    ...
    public void marshall(StatusReason statusReason, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (statusReason.getReasonCode() != null) {
            String reasonCode = statusReason.getReasonCode();
            jsonWriter.name("ReasonCode");
            jsonWriter.value(reasonCode);
        }
        if (statusReason.getDescription() != null) {
            String description = statusReason.getDescription();
