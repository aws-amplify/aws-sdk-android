...
/**
 * JSON unmarshaller for response CompleteAttachmentUploadResult
 */
public class CompleteAttachmentUploadResultJsonUnmarshaller implements
        Unmarshaller<CompleteAttachmentUploadResult, JsonUnmarshallerContext> {

    public CompleteAttachmentUploadResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
