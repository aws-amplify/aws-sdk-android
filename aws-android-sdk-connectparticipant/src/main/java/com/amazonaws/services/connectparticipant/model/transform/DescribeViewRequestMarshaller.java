...
public class DescribeViewRequestMarshaller implements
    ...
    public Request<DescribeViewRequest> marshall(DescribeViewRequest describeViewRequest) {
        ...
        Request<DescribeViewRequest> request = new DefaultRequest<DescribeViewRequest>(
                describeViewRequest, "AmazonConnectParticipant");
        request.setHttpMethod(HttpMethodName.GET);

        if (describeViewRequest.getConnectionToken() != null) {
            request.addHeader("X-Amz-Bearer",
                    StringUtils.fromString(describeViewRequest.getConnectionToken()));
        }
        String uriResourcePath = "/participant/views/{ViewToken}";
        uriResourcePath = uriResourcePath.replace(
                "{ViewToken}",
                (describeViewRequest.getViewToken() == null) ? "" : StringUtils
                        .fromString(describeViewRequest.getViewToken()));
