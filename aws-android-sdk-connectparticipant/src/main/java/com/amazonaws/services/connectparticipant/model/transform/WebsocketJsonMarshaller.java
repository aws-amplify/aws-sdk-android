...
/**
 * JSON marshaller for POJO Websocket
 */
class WebsocketJsonMarshaller {

    public void marshall(Websocket websocket, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (websocket.getConnectionExpiry() != null) {
            ...
            jsonWriter.name("ConnectionExpiry");
            jsonWriter.value(connectionExpiry);
        }
