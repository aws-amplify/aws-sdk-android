...
/**
 * StAX unmarshaller for response ListCustomVerificationEmailTemplatesResult
 */
public class ListCustomVerificationEmailTemplatesResultStaxUnmarshaller implements
    ...
    public ListCustomVerificationEmailTemplatesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("CustomVerificationEmailTemplates/member", targetDepth)) {
                    listCustomVerificationEmailTemplatesResult
                            .withCustomVerificationEmailTemplates(CustomVerificationEmailTemplateStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    listCustomVerificationEmailTemplatesResult.setNextToken(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
