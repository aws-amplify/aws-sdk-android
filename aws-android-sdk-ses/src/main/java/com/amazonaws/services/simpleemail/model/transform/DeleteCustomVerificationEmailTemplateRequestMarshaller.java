...
/**
 * StAX request marshaller for DeleteCustomVerificationEmailTemplateRequest
 */
    ...
    public Request<DeleteCustomVerificationEmailTemplateRequest> marshall(
        ...
        if (deleteCustomVerificationEmailTemplateRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteCustomVerificationEmailTemplateRequest)");
        }
        ...
        if (deleteCustomVerificationEmailTemplateRequest.getTemplateName() != null) {
            prefix = "TemplateName";
            String templateName = deleteCustomVerificationEmailTemplateRequest.getTemplateName();
