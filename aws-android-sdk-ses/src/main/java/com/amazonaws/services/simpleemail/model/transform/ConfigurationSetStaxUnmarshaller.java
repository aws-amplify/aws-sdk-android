...
/**
 * StAX unmarshaller for model ConfigurationSet
 */
class ConfigurationSetStaxUnmarshaller implements
        Unmarshaller<ConfigurationSet, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Name", targetDepth)) {
                    configurationSet.setName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
