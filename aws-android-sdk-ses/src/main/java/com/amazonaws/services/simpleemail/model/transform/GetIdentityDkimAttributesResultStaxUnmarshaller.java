...
/**
 * StAX unmarshaller for response GetIdentityDkimAttributesResult
 */
public class GetIdentityDkimAttributesResultStaxUnmarshaller implements
    ...
    private static class DkimAttributesMapEntryUnmarshaller implements
        ...
        @Override
        public Entry<String, IdentityDkimAttributes> unmarshall(StaxUnmarshallerContext context)
                throws Exception {
            ...
            while (true) {
                ...
                if (xmlEvent == XmlPullParser.START_TAG) {
                    ...
                    if (context.testExpression("value", targetDepth)) {
                        entry.setValue(IdentityDkimAttributesStaxUnmarshaller.getInstance()
                                .unmarshall(context));
                        continue;
                    }
    ...
    public GetIdentityDkimAttributesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
