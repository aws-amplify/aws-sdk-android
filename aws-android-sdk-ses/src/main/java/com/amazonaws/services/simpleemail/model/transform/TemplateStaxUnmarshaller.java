...
/**
 * StAX unmarshaller for model Template
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("TemplateName", targetDepth)) {
                    template.setTemplateName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("SubjectPart", targetDepth)) {
                    template.setSubjectPart(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
