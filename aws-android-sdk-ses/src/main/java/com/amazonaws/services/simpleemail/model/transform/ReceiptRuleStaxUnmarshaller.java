...
/**
 * StAX unmarshaller for model ReceiptRule
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("Enabled", targetDepth)) {
                    receiptRule.setEnabled(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("TlsPolicy", targetDepth)) {
                    receiptRule.setTlsPolicy(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                ...
                if (context.testExpression("ScanEnabled", targetDepth)) {
                    receiptRule.setScanEnabled(BooleanStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
