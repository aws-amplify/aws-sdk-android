...
/**
 * StAX unmarshaller for response DeleteConfigurationSetTrackingOptionsResult
 */
public class DeleteConfigurationSetTrackingOptionsResultStaxUnmarshaller implements
    ...
    public DeleteConfigurationSetTrackingOptionsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
