...
public enum BehaviorOnMXFailure {
    ...
    private static final Map<String, BehaviorOnMXFailure> enumMap;
    static {
        enumMap = new HashMap<String, BehaviorOnMXFailure>();
        enumMap.put("UseDefaultValue", UseDefaultValue);
        enumMap.put("RejectMessage", RejectMessage);
    }
