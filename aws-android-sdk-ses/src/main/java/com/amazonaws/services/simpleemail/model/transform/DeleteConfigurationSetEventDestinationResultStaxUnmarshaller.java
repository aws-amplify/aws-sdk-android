...
/**
 * StAX unmarshaller for response DeleteConfigurationSetEventDestinationResult
 */
public class DeleteConfigurationSetEventDestinationResultStaxUnmarshaller implements
    ...
    public DeleteConfigurationSetEventDestinationResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
