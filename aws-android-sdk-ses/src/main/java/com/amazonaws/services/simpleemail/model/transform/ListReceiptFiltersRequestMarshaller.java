...
/**
 * StAX request marshaller for ListReceiptFiltersRequest
 */
public class ListReceiptFiltersRequestMarshaller implements
    ...
    public Request<ListReceiptFiltersRequest> marshall(
        ...
        if (listReceiptFiltersRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListReceiptFiltersRequest)");
        }
