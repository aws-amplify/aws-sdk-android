...
/**
 * StAX unmarshaller for model CloudWatchDestination
 */
class CloudWatchDestinationStaxUnmarshaller implements
        Unmarshaller<CloudWatchDestination, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DimensionConfigurations/member", targetDepth)) {
                    cloudWatchDestination
                            .withDimensionConfigurations(CloudWatchDimensionConfigurationStaxUnmarshaller
