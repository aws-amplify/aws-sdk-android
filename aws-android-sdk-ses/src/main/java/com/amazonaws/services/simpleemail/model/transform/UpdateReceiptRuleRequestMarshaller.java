...
/**
 * StAX request marshaller for UpdateReceiptRuleRequest
 */
public class UpdateReceiptRuleRequestMarshaller implements
    ...
    public Request<UpdateReceiptRuleRequest> marshall(
            UpdateReceiptRuleRequest updateReceiptRuleRequest) {
        if (updateReceiptRuleRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateReceiptRuleRequest)");
        }

        Request<UpdateReceiptRuleRequest> request = new DefaultRequest<UpdateReceiptRuleRequest>(
                updateReceiptRuleRequest, "AmazonSimpleEmailService");
        ...
        if (updateReceiptRuleRequest.getRuleSetName() != null) {
            prefix = "RuleSetName";
            String ruleSetName = updateReceiptRuleRequest.getRuleSetName();
