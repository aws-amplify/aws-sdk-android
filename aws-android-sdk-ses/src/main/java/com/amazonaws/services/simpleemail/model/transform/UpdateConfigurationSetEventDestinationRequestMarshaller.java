...
/**
 * StAX request marshaller for UpdateConfigurationSetEventDestinationRequest
 */
    ...
    public Request<UpdateConfigurationSetEventDestinationRequest> marshall(
        ...
        if (updateConfigurationSetEventDestinationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateConfigurationSetEventDestinationRequest)");
        }
        ...
        if (updateConfigurationSetEventDestinationRequest.getConfigurationSetName() != null) {
            ...
            String configurationSetName = updateConfigurationSetEventDestinationRequest
