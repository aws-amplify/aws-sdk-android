...
/**
 * StAX unmarshaller for model IdentityDkimAttributes
 */
class IdentityDkimAttributesStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DkimEnabled", targetDepth)) {
                    identityDkimAttributes.setDkimEnabled(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("DkimVerificationStatus", targetDepth)) {
                    identityDkimAttributes.setDkimVerificationStatus(StringStaxUnmarshaller
