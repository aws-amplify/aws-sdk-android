...
/**
 * Set Identity Mail From Domain Result StAX Unmarshaller
 */
public class SetIdentityMailFromDomainResultStaxUnmarshaller implements Unmarshaller<SetIdentityMailFromDomainResult, StaxUnmarshallerContext> {
    ...
    public SetIdentityMailFromDomainResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return setIdentityMailFromDomainResult;
    ...
    public static SetIdentityMailFromDomainResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new SetIdentityMailFromDomainResultStaxUnmarshaller();
        return instance;
    }
}
