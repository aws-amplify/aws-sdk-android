...
/**
 * StAX unmarshaller for response VerifyDomainIdentityResult
 */
public class VerifyDomainIdentityResultStaxUnmarshaller implements
        Unmarshaller<VerifyDomainIdentityResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("VerificationToken", targetDepth)) {
                    verifyDomainIdentityResult.setVerificationToken(StringStaxUnmarshaller
