...
/**
 * StAX unmarshaller for response SetIdentityFeedbackForwardingEnabledResult
 */
public class SetIdentityFeedbackForwardingEnabledResultStaxUnmarshaller implements
    ...
    public SetIdentityFeedbackForwardingEnabledResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
