...
/**
 * StAX unmarshaller for model MessageDsn
 */
class MessageDsnStaxUnmarshaller implements Unmarshaller<MessageDsn, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ReportingMta", targetDepth)) {
                    messageDsn.setReportingMta(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("ArrivalDate", targetDepth)) {
                    messageDsn.setArrivalDate(DateStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
