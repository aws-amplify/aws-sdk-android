...
/**
 * StAX unmarshaller for response UpdateTemplateResult
 */
public class UpdateTemplateResultStaxUnmarshaller implements
        Unmarshaller<UpdateTemplateResult, StaxUnmarshallerContext> {
