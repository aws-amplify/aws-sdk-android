...
/**
 * StAX unmarshaller for response DescribeReceiptRuleSetResult
 */
public class DescribeReceiptRuleSetResultStaxUnmarshaller implements
    ...
    public DescribeReceiptRuleSetResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Metadata", targetDepth)) {
                    describeReceiptRuleSetResult.setMetadata(ReceiptRuleSetMetadataStaxUnmarshaller
