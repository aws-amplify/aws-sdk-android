...
/**
 * StAX request marshaller for SetReceiptRulePositionRequest
 */
public class SetReceiptRulePositionRequestMarshaller implements
    ...
    public Request<SetReceiptRulePositionRequest> marshall(
        ...
        if (setReceiptRulePositionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(SetReceiptRulePositionRequest)");
        }
