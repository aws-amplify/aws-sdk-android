...
/**
 * Get Identity Mail From Domain Attributes Result StAX Unmarshaller
 */
public class GetIdentityMailFromDomainAttributesResultStaxUnmarshaller implements Unmarshaller<GetIdentityMailFromDomainAttributesResult, StaxUnmarshallerContext> {
    private static class MailFromDomainAttributesMapEntryUnmarshaller implements Unmarshaller<Map.Entry<String, IdentityMailFromDomainAttributes>, StaxUnmarshallerContext> {
        @Override
        public Entry<String, IdentityMailFromDomainAttributes> unmarshall(StaxUnmarshallerContext context) throws Exception {
            ...
            MapEntry<String, IdentityMailFromDomainAttributes> entry
                = new MapEntry<String, IdentityMailFromDomainAttributes>();
        ...
        public static MailFromDomainAttributesMapEntryUnmarshaller getInstance() {
            if (instance == null) instance = new MailFromDomainAttributesMapEntryUnmarshaller();
            return instance;
        }
    ...
    public GetIdentityMailFromDomainAttributesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            int xmlEvent = context.nextEvent();
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return getIdentityMailFromDomainAttributesResult;
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("MailFromDomainAttributes/entry", targetDepth)) {
                    ...
                    getIdentityMailFromDomainAttributesResult.getMailFromDomainAttributes().put(entry.getKey(), entry.getValue());
                    continue;
                }
            } else if (xmlEvent == XmlPullParser.END_TAG) {
    ...
    public static GetIdentityMailFromDomainAttributesResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new GetIdentityMailFromDomainAttributesResultStaxUnmarshaller();
        return instance;
    }
}
