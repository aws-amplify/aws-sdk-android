...
/**
 * StAX unmarshaller for model BouncedRecipientInfo
 */
class BouncedRecipientInfoStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Recipient", targetDepth)) {
                    bouncedRecipientInfo.setRecipient(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("RecipientArn", targetDepth)) {
                    bouncedRecipientInfo.setRecipientArn(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("BounceType", targetDepth)) {
                    bouncedRecipientInfo.setBounceType(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("RecipientDsnFields", targetDepth)) {
                    bouncedRecipientInfo.setRecipientDsnFields(RecipientDsnFieldsStaxUnmarshaller
