...
/**
 * StAX unmarshaller for model IdentityMailFromDomainAttributes
 */
class IdentityMailFromDomainAttributesStaxUnmarshaller implements
        Unmarshaller<IdentityMailFromDomainAttributes, StaxUnmarshallerContext> {

    public IdentityMailFromDomainAttributes unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("MailFromDomain", targetDepth)) {
                    identityMailFromDomainAttributes.setMailFromDomain(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("MailFromDomainStatus", targetDepth)) {
                    identityMailFromDomainAttributes.setMailFromDomainStatus(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("BehaviorOnMXFailure", targetDepth)) {
                    identityMailFromDomainAttributes.setBehaviorOnMXFailure(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
