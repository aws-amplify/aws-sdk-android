...
/**
 * StAX unmarshaller for model IdentityVerificationAttributes
 */
class IdentityVerificationAttributesStaxUnmarshaller implements
        Unmarshaller<IdentityVerificationAttributes, StaxUnmarshallerContext> {

    public IdentityVerificationAttributes unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("VerificationStatus", targetDepth)) {
                    identityVerificationAttributes.setVerificationStatus(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("VerificationToken", targetDepth)) {
                    identityVerificationAttributes.setVerificationToken(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
