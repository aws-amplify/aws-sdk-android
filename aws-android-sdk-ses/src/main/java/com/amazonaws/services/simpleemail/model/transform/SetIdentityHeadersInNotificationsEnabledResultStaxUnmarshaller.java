...
/**
 * StAX unmarshaller for response SetIdentityHeadersInNotificationsEnabledResult
 */
public class SetIdentityHeadersInNotificationsEnabledResultStaxUnmarshaller implements
    ...
    public SetIdentityHeadersInNotificationsEnabledResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
