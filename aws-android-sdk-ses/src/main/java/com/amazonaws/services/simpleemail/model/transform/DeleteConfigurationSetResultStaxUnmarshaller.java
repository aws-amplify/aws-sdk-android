...
/**
 * StAX unmarshaller for response DeleteConfigurationSetResult
 */
public class DeleteConfigurationSetResultStaxUnmarshaller implements
        Unmarshaller<DeleteConfigurationSetResult, StaxUnmarshallerContext> {

    public DeleteConfigurationSetResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
