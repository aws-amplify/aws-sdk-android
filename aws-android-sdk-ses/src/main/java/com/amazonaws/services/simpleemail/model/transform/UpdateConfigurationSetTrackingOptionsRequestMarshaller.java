...
/**
 * StAX request marshaller for UpdateConfigurationSetTrackingOptionsRequest
 */
    ...
    public Request<UpdateConfigurationSetTrackingOptionsRequest> marshall(
        ...
        if (updateConfigurationSetTrackingOptionsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateConfigurationSetTrackingOptionsRequest)");
        }
        ...
        if (updateConfigurationSetTrackingOptionsRequest.getConfigurationSetName() != null) {
            ...
            String configurationSetName = updateConfigurationSetTrackingOptionsRequest
        ...
        if (updateConfigurationSetTrackingOptionsRequest.getTrackingOptions() != null) {
            prefix = "TrackingOptions";
            TrackingOptions trackingOptions = updateConfigurationSetTrackingOptionsRequest
                    .getTrackingOptions();
            TrackingOptionsStaxMarshaller.getInstance().marshall(trackingOptions, request,
                    prefix + ".");
        }
