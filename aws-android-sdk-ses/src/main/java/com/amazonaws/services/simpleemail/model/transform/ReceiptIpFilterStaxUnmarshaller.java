...
/**
 * StAX unmarshaller for model ReceiptIpFilter
 */
class ReceiptIpFilterStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Policy", targetDepth)) {
                    receiptIpFilter.setPolicy(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Cidr", targetDepth)) {
                    receiptIpFilter.setCidr(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
