...
/**
 * StAX request marshaller for GetIdentityVerificationAttributesRequest
 */
    ...
    public Request<GetIdentityVerificationAttributesRequest> marshall(
        ...
        if (getIdentityVerificationAttributesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetIdentityVerificationAttributesRequest)");
        }
        ...
        if (getIdentityVerificationAttributesRequest.getIdentities() != null) {
            prefix = "Identities";
            java.util.List<String> identities = getIdentityVerificationAttributesRequest
                    .getIdentities();
