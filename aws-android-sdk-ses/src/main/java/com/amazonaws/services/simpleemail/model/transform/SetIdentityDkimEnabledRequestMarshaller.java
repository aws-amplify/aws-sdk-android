...
/**
 * StAX request marshaller for SetIdentityDkimEnabledRequest
 */
public class SetIdentityDkimEnabledRequestMarshaller implements
    ...
    public Request<SetIdentityDkimEnabledRequest> marshall(
        ...
        if (setIdentityDkimEnabledRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(SetIdentityDkimEnabledRequest)");
        }
        ...
        if (setIdentityDkimEnabledRequest.getIdentity() != null) {
            prefix = "Identity";
            String identity = setIdentityDkimEnabledRequest.getIdentity();
            request.addParameter(prefix, StringUtils.fromString(identity));
        }
        if (setIdentityDkimEnabledRequest.getDkimEnabled() != null) {
            prefix = "DkimEnabled";
            Boolean dkimEnabled = setIdentityDkimEnabledRequest.getDkimEnabled();
