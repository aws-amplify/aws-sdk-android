...
/**
 * StAX unmarshaller for response GetCustomVerificationEmailTemplateResult
 */
public class GetCustomVerificationEmailTemplateResultStaxUnmarshaller implements
    ...
    public GetCustomVerificationEmailTemplateResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("TemplateName", targetDepth)) {
                    getCustomVerificationEmailTemplateResult.setTemplateName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("FromEmailAddress", targetDepth)) {
                    getCustomVerificationEmailTemplateResult
                            .setFromEmailAddress(StringStaxUnmarshaller.getInstance().unmarshall(
                                    context));
                    continue;
                }
                if (context.testExpression("TemplateSubject", targetDepth)) {
                    getCustomVerificationEmailTemplateResult
                            .setTemplateSubject(StringStaxUnmarshaller.getInstance().unmarshall(
                                    context));
                    continue;
                }
                if (context.testExpression("TemplateContent", targetDepth)) {
                    getCustomVerificationEmailTemplateResult
                            .setTemplateContent(StringStaxUnmarshaller.getInstance().unmarshall(
                                    context));
                    continue;
                }
                if (context.testExpression("SuccessRedirectionURL", targetDepth)) {
                    getCustomVerificationEmailTemplateResult
                            .setSuccessRedirectionURL(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("FailureRedirectionURL", targetDepth)) {
                    getCustomVerificationEmailTemplateResult
                            .setFailureRedirectionURL(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
