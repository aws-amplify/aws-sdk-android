...
/**
 * StAX request marshaller for CreateConfigurationSetEventDestinationRequest
 */
    ...
    public Request<CreateConfigurationSetEventDestinationRequest> marshall(
        ...
        if (createConfigurationSetEventDestinationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateConfigurationSetEventDestinationRequest)");
        }
        ...
        if (createConfigurationSetEventDestinationRequest.getConfigurationSetName() != null) {
            ...
            String configurationSetName = createConfigurationSetEventDestinationRequest
        ...
        if (createConfigurationSetEventDestinationRequest.getEventDestination() != null) {
            prefix = "EventDestination";
            EventDestination eventDestination = createConfigurationSetEventDestinationRequest
                    .getEventDestination();
            EventDestinationStaxMarshaller.getInstance().marshall(eventDestination, request,
                    prefix + ".");
        }
