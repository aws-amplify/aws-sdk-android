...
/**
 * Delete Identity Policy Result StAX Unmarshaller
 */
public class DeleteIdentityPolicyResultStaxUnmarshaller implements Unmarshaller<DeleteIdentityPolicyResult, StaxUnmarshallerContext> {
    ...
    public DeleteIdentityPolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return deleteIdentityPolicyResult;
    ...
    public static DeleteIdentityPolicyResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DeleteIdentityPolicyResultStaxUnmarshaller();
        return instance;
    }
}
