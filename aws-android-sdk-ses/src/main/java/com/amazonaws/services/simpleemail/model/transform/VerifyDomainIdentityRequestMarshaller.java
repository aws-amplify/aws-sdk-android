...
/**
 * StAX request marshaller for VerifyDomainIdentityRequest
 */
public class VerifyDomainIdentityRequestMarshaller implements
    ...
    public Request<VerifyDomainIdentityRequest> marshall(
        ...
        if (verifyDomainIdentityRequest.getDomain() != null) {
            prefix = "Domain";
            String domain = verifyDomainIdentityRequest.getDomain();
