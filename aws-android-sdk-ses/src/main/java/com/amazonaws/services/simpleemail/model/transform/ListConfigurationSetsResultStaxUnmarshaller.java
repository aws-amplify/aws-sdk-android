...
/**
 * StAX unmarshaller for response ListConfigurationSetsResult
 */
public class ListConfigurationSetsResultStaxUnmarshaller implements
        Unmarshaller<ListConfigurationSetsResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ConfigurationSets/member", targetDepth)) {
                    listConfigurationSetsResult
                            .withConfigurationSets(ConfigurationSetStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    listConfigurationSetsResult.setNextToken(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
