...
/**
 * StAX unmarshaller for response ListIdentityPoliciesResult
 */
public class ListIdentityPoliciesResultStaxUnmarshaller implements
        Unmarshaller<ListIdentityPoliciesResult, StaxUnmarshallerContext> {
