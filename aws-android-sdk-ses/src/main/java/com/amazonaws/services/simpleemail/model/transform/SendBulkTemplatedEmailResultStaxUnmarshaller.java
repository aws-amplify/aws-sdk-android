...
/**
 * StAX unmarshaller for response SendBulkTemplatedEmailResult
 */
public class SendBulkTemplatedEmailResultStaxUnmarshaller implements
        Unmarshaller<SendBulkTemplatedEmailResult, StaxUnmarshallerContext> {

    public SendBulkTemplatedEmailResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Status/member", targetDepth)) {
                    sendBulkTemplatedEmailResult
                            .withStatus(BulkEmailDestinationStatusStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
