...
/**
 * StAX unmarshaller for response GetSendStatisticsResult
 */
public class GetSendStatisticsResultStaxUnmarshaller implements
        Unmarshaller<GetSendStatisticsResult, StaxUnmarshallerContext> {
