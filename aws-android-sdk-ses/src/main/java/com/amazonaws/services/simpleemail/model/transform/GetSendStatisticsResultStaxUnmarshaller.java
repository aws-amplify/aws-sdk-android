...
public class GetSendStatisticsResultStaxUnmarshaller implements Unmarshaller<GetSendStatisticsResult, StaxUnmarshallerContext> {
    ...
    public GetSendStatisticsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return getSendStatisticsResult;

            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("SendDataPoints/member", targetDepth)) {
                    getSendStatisticsResult.getSendDataPoints().add(SendDataPointStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static GetSendStatisticsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new GetSendStatisticsResultStaxUnmarshaller();
        return instance;
    }
}
