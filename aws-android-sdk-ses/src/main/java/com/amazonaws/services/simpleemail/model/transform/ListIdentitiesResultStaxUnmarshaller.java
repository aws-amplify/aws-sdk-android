...
/**
 * StAX unmarshaller for response ListIdentitiesResult
 */
public class ListIdentitiesResultStaxUnmarshaller implements
        Unmarshaller<ListIdentitiesResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    listIdentitiesResult.setNextToken(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
