...
/**
 * StAX request marshaller for CreateReceiptFilterRequest
 */
    ...
    public Request<CreateReceiptFilterRequest> marshall(
        ...
        if (createReceiptFilterRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateReceiptFilterRequest)");
        }
        ...
        String prefix;
        if (createReceiptFilterRequest.getFilter() != null) {
            prefix = "Filter";
            ReceiptFilter filter = createReceiptFilterRequest.getFilter();
            ReceiptFilterStaxMarshaller.getInstance().marshall(filter, request, prefix + ".");
        }
