...
/**
 * StAX unmarshaller for response DeleteReceiptRuleSetResult
 */
public class DeleteReceiptRuleSetResultStaxUnmarshaller implements
        Unmarshaller<DeleteReceiptRuleSetResult, StaxUnmarshallerContext> {
