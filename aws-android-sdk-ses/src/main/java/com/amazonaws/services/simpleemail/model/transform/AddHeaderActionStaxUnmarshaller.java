...
/**
 * StAX unmarshaller for model AddHeaderAction
 */
class AddHeaderActionStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("HeaderName", targetDepth)) {
                    addHeaderAction.setHeaderName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("HeaderValue", targetDepth)) {
                    addHeaderAction.setHeaderValue(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
