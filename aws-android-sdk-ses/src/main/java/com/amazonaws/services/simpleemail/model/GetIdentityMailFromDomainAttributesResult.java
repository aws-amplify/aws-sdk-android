...
public class GetIdentityMailFromDomainAttributesResult implements Serializable {
     ...
     */
    private java.util.Map<String,IdentityMailFromDomainAttributes> mailFromDomainAttributes;
    ...
    public java.util.Map<String,IdentityMailFromDomainAttributes> getMailFromDomainAttributes() {
        ...
        if (mailFromDomainAttributes == null) {
            mailFromDomainAttributes = new java.util.HashMap<String,IdentityMailFromDomainAttributes>();
        }
     ...
     *         together.
     */
    public GetIdentityMailFromDomainAttributesResult withMailFromDomainAttributes(java.util.Map<String,IdentityMailFromDomainAttributes> mailFromDomainAttributes) {
     ...
     *
     * @param key The key of the entry to be added into MailFromDomainAttributes.
     * @param value The corresponding value of the entry to be added into MailFromDomainAttributes.
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getMailFromDomainAttributes() != null) sb.append("MailFromDomainAttributes: " + getMailFromDomainAttributes() );
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetIdentityMailFromDomainAttributesResult == false) return false;
        GetIdentityMailFromDomainAttributesResult other = (GetIdentityMailFromDomainAttributesResult)obj;
        
        if (other.getMailFromDomainAttributes() == null ^ this.getMailFromDomainAttributes() == null) return false;
        if (other.getMailFromDomainAttributes() != null && other.getMailFromDomainAttributes().equals(this.getMailFromDomainAttributes()) == false) return false; 
        return true;
    }
