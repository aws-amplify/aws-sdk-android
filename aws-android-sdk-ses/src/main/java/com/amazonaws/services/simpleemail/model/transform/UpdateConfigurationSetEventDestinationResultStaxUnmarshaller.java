...
/**
 * StAX unmarshaller for response UpdateConfigurationSetEventDestinationResult
 */
public class UpdateConfigurationSetEventDestinationResultStaxUnmarshaller implements
    ...
    public UpdateConfigurationSetEventDestinationResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
