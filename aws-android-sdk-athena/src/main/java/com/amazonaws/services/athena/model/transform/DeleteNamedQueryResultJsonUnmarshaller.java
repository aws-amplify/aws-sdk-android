...
/**
 * JSON unmarshaller for response DeleteNamedQueryResult
 */
public class DeleteNamedQueryResultJsonUnmarshaller implements
        Unmarshaller<DeleteNamedQueryResult, JsonUnmarshallerContext> {
