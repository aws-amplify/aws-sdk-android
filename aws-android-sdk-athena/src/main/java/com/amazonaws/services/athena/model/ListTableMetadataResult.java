...
public class ListTableMetadataResult implements Serializable {
    /**
     * <p>
    ...
    public ListTableMetadataResult withTableMetadataList(TableMetadata... tableMetadataList) {
        if (getTableMetadataList() == null) {
            this.tableMetadataList = new java.util.ArrayList<TableMetadata>(
                    tableMetadataList.length);
        }
        for (TableMetadata value : tableMetadataList) {
            this.tableMetadataList.add(value);
        }
        return this;
    }
     ...
     *         chained together.
     */
    public ListTableMetadataResult withTableMetadataList(
            java.util.Collection<TableMetadata> tableMetadataList) {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getTableMetadataList() != null)
            sb.append("TableMetadataList: " + getTableMetadataList() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getTableMetadataList() == null) ? 0 : getTableMetadataList().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTableMetadataList() == null ^ this.getTableMetadataList() == null)
            return false;
        if (other.getTableMetadataList() != null
                && other.getTableMetadataList().equals(this.getTableMetadataList()) == false)
            return false;
