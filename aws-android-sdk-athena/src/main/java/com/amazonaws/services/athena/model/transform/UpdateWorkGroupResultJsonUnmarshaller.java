...
/**
 * JSON unmarshaller for response UpdateWorkGroupResult
 */
public class UpdateWorkGroupResultJsonUnmarshaller implements
        Unmarshaller<UpdateWorkGroupResult, JsonUnmarshallerContext> {
