...
/**
 * JSON unmarshaller for response DeleteDataCatalogResult
 */
public class DeleteDataCatalogResultJsonUnmarshaller implements
        Unmarshaller<DeleteDataCatalogResult, JsonUnmarshallerContext> {
