...
/**
 * JSON unmarshaller for response ListQueryExecutionsResult
 */
public class ListQueryExecutionsResultJsonUnmarshaller implements
        Unmarshaller<ListQueryExecutionsResult, JsonUnmarshallerContext> {
    ...
    public ListQueryExecutionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("QueryExecutionIds")) {
                listQueryExecutionsResult.setQueryExecutionIds(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                listQueryExecutionsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
