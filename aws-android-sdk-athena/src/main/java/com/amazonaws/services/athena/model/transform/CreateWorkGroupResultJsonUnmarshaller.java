...
/**
 * JSON unmarshaller for response CreateWorkGroupResult
 */
public class CreateWorkGroupResultJsonUnmarshaller implements
        Unmarshaller<CreateWorkGroupResult, JsonUnmarshallerContext> {
