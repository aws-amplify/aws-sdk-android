    ...
    public GetQueryResultsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("UpdateCount")) {
                getQueryResultsResult.setUpdateCount(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ResultSet")) {
                getQueryResultsResult.setResultSet(ResultSetJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("NextToken")) {
                getQueryResultsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
