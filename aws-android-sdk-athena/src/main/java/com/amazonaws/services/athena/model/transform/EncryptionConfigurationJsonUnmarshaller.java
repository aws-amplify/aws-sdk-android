...
class EncryptionConfigurationJsonUnmarshaller implements
    ...
    public EncryptionConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("EncryptionOption")) {
                encryptionConfiguration.setEncryptionOption(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("KmsKey")) {
                encryptionConfiguration.setKmsKey(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
