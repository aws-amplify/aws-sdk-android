...
/**
 * JSON unmarshaller for POJO Datum
 */
class DatumJsonUnmarshaller implements Unmarshaller<Datum, JsonUnmarshallerContext> {
    ...
    public Datum unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("VarCharValue")) {
                datum.setVarCharValue(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
