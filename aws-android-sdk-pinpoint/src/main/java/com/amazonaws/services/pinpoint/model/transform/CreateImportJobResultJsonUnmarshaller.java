...
/**
 * JSON unmarshaller for response CreateImportJobResult
 */
public class CreateImportJobResultJsonUnmarshaller implements
        Unmarshaller<CreateImportJobResult, JsonUnmarshallerContext> {
    ...
    public CreateImportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ImportJobResponse")) {
                createImportJobResult.setImportJobResponse(ImportJobResponseJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
