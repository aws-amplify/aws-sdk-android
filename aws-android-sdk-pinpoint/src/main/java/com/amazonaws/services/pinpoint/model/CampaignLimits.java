...
public class CampaignLimits implements Serializable {
     ...
     * specifies the default limit for the number of messages that campaigns and
     * journeys can send to a single endpoint during a 24-hour period. The
     ...
     * messages that campaigns and journeys can send each second. The minimum
     ...
     *         single endpoint during a 24-hour period. For an application, this
     *         value specifies the default limit for the number of messages that
     ...
     *            this value specifies the default limit for the number of
     *            messages that campaigns and journeys can send to a single
     ...
     *         limit for the number of messages that campaigns and journeys can
     *         send each second. The minimum value is 50. The maximum value is
     *         20,000.
     *         </p>
     */
     ...
     *            The maximum number of messages that a campaign can send each
     *            second. For an application, this value specifies the default
     *            limit for the number of messages that campaigns and journeys
     *            can send each second. The minimum value is 50. The maximum
     *            value is 20,000.
     *            </p>
     */
     ...
     * @return <p>
     *         The maximum number of messages that a campaign can send to a
     *         single endpoint during the course of the campaign. If a campaign
     *         recurs, this setting applies to all runs of the campaign. The
     *         maximum value is 100.
     *         </p>
     */
     ...
     * @param total <p>
     *            The maximum number of messages that a campaign can send to a
     *            single endpoint during the course of the campaign. If a
