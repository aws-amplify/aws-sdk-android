...
/**
 * JSON unmarshaller for response DeleteApnsVoipChannelResult
 */
public class DeleteApnsVoipChannelResultJsonUnmarshaller implements
        Unmarshaller<DeleteApnsVoipChannelResult, JsonUnmarshallerContext> {
