...
/**
 * JSON unmarshaller for response UpdateApplicationSettingsResult
 */
public class UpdateApplicationSettingsResultJsonUnmarshaller implements
        Unmarshaller<UpdateApplicationSettingsResult, JsonUnmarshallerContext> {

    public UpdateApplicationSettingsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
