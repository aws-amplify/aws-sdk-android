 ...
 * </p>
 */
public class PushMessageActivity implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         Specifies the time to live (TTL) value for push notifications
     ...
     *
     * @return <p>
     *         The name of the push notification template to use for the
     ...
     *         template to use for the message. If specified, this value must
     *         match the identifier for an existing template version. To
     *         retrieve a list of versions and version identifiers for a
