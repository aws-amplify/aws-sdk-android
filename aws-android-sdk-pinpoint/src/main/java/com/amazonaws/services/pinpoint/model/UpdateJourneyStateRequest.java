 ...
 * </p>
 */
public class UpdateJourneyStateRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
    ...
    public String toString() {
        ...
        if (getJourneyStateRequest() != null)
            sb.append("JourneyStateRequest: " + getJourneyStateRequest());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getJourneyStateRequest() == null) ? 0 : getJourneyStateRequest().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getJourneyStateRequest() == null ^ this.getJourneyStateRequest() == null)
            return false;
        if (other.getJourneyStateRequest() != null
                && other.getJourneyStateRequest().equals(this.getJourneyStateRequest()) == false)
            return false;
        return true;
    }
}
