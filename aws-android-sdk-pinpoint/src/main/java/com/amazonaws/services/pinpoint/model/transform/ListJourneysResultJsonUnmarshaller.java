...
/**
 * JSON unmarshaller for response ListJourneysResult
 */
public class ListJourneysResultJsonUnmarshaller implements
        Unmarshaller<ListJourneysResult, JsonUnmarshallerContext> {
