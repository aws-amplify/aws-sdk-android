...
/**
 * JSON unmarshaller for POJO APNSVoipChannelRequest
 */
class APNSVoipChannelRequestJsonUnmarshaller implements
        Unmarshaller<APNSVoipChannelRequest, JsonUnmarshallerContext> {
