...
public class TemplateConfiguration implements Serializable {
    ...
    public String toString() {
        ...
        if (getVoiceTemplate() != null)
            sb.append("VoiceTemplate: " + getVoiceTemplate());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getVoiceTemplate() == null) ? 0 : getVoiceTemplate().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getVoiceTemplate() == null ^ this.getVoiceTemplate() == null)
            return false;
        if (other.getVoiceTemplate() != null
                && other.getVoiceTemplate().equals(this.getVoiceTemplate()) == false)
            return false;
        return true;
    }
}
