...
/**
 * JSON unmarshaller for response GetImportJobResult
 */
public class GetImportJobResultJsonUnmarshaller implements
        Unmarshaller<GetImportJobResult, JsonUnmarshallerContext> {
    ...
    public GetImportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ImportJobResponse")) {
                getImportJobResult.setImportJobResponse(ImportJobResponseJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
