...
/**
 * JSON unmarshaller for POJO WriteApplicationSettingsRequest
 */
class WriteApplicationSettingsRequestJsonUnmarshaller implements
        Unmarshaller<WriteApplicationSettingsRequest, JsonUnmarshallerContext> {

    public WriteApplicationSettingsRequest unmarshall(JsonUnmarshallerContext context)
            throws Exception {
