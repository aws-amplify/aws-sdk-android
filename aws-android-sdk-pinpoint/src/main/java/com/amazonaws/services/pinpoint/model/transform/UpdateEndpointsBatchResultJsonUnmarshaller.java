...
/**
 * JSON unmarshaller for response UpdateEndpointsBatchResult
 */
public class UpdateEndpointsBatchResultJsonUnmarshaller implements
        Unmarshaller<UpdateEndpointsBatchResult, JsonUnmarshallerContext> {
