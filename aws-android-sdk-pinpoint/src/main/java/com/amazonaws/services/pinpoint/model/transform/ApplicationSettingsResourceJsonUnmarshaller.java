...
/**
 * JSON unmarshaller for POJO ApplicationSettingsResource
 */
class ApplicationSettingsResourceJsonUnmarshaller implements
        Unmarshaller<ApplicationSettingsResource, JsonUnmarshallerContext> {
    ...
    public ApplicationSettingsResource unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ApplicationId")) {
                ...
                applicationSettingsResource.setQuietTime(QuietTimeJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
