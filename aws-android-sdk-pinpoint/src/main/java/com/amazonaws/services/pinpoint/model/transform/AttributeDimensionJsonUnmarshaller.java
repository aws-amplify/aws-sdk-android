...
/**
 * JSON unmarshaller for POJO AttributeDimension
 */
class AttributeDimensionJsonUnmarshaller implements
    ...
    public AttributeDimension unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AttributeType")) {
                attributeDimension.setAttributeType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
