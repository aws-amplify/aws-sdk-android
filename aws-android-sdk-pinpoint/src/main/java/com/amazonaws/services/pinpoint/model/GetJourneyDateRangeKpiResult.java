...
public class GetJourneyDateRangeKpiResult implements Serializable {
    /**
     * <p>
     ...
     *         standard engagement metric that applies to a journey, and
     ...
     * </p>
     *
     * @param journeyDateRangeKpiResponse <p>
     *            Provides the results of a query that retrieved the data for a
     *            standard engagement metric that applies to a journey, and
     *            provides information about that query.
     *            </p>
     */
    public void setJourneyDateRangeKpiResponse(
     ...
     *         chained together.
     */
    public GetJourneyDateRangeKpiResult withJourneyDateRangeKpiResponse(
            JourneyDateRangeKpiResponse journeyDateRangeKpiResponse) {
        this.journeyDateRangeKpiResponse = journeyDateRangeKpiResponse;
        return this;
    }
    ...
    public String toString() {
        ...
        if (getJourneyDateRangeKpiResponse() != null)
            sb.append("JourneyDateRangeKpiResponse: " + getJourneyDateRangeKpiResponse());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getJourneyDateRangeKpiResponse() == null) ? 0
                        : getJourneyDateRangeKpiResponse().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getJourneyDateRangeKpiResponse() == null
                ^ this.getJourneyDateRangeKpiResponse() == null)
            return false;
        if (other.getJourneyDateRangeKpiResponse() != null
                && other.getJourneyDateRangeKpiResponse().equals(
                        this.getJourneyDateRangeKpiResponse()) == false)
            return false;
        return true;
    }
}
