...
/**
 * JSON unmarshaller for response GetCampaignResult
 */
public class GetCampaignResultJsonUnmarshaller implements
        Unmarshaller<GetCampaignResult, JsonUnmarshallerContext> {
