...
/**
 * JSON unmarshaller for response UpdateSegmentResult
 */
public class UpdateSegmentResultJsonUnmarshaller implements
        Unmarshaller<UpdateSegmentResult, JsonUnmarshallerContext> {
    ...
    public UpdateSegmentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SegmentResponse")) {
                updateSegmentResult.setSegmentResponse(SegmentResponseJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
