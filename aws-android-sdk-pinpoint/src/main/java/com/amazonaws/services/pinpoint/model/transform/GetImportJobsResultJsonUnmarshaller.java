...
/**
 * JSON unmarshaller for response GetImportJobsResult
 */
public class GetImportJobsResultJsonUnmarshaller implements
        Unmarshaller<GetImportJobsResult, JsonUnmarshallerContext> {
