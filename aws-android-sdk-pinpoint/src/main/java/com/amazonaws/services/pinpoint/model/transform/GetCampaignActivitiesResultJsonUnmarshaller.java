...
/**
 * JSON unmarshaller for response GetCampaignActivitiesResult
 */
public class GetCampaignActivitiesResultJsonUnmarshaller implements
        Unmarshaller<GetCampaignActivitiesResult, JsonUnmarshallerContext> {
    ...
    public GetCampaignActivitiesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ActivitiesResponse")) {
                getCampaignActivitiesResult
                        .setActivitiesResponse(ActivitiesResponseJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
            }
