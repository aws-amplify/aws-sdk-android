...
/**
 * JSON unmarshaller for POJO ActivitiesResponse
 */
class ActivitiesResponseJsonUnmarshaller implements
        Unmarshaller<ActivitiesResponse, JsonUnmarshallerContext> {
