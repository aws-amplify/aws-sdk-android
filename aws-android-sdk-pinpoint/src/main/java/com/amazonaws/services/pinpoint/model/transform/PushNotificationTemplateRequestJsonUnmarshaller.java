    ...
    public PushNotificationTemplateRequest unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ADM")) {
                ...
                pushNotificationTemplateRequest.setDefaultSubstitutions(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                pushNotificationTemplateRequest.setRecommenderId(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                pushNotificationTemplateRequest.setTemplateDescription(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
