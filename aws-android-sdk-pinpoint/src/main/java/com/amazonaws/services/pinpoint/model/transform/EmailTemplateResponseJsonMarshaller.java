...
class EmailTemplateResponseJsonMarshaller {
    ...
    public void marshall(EmailTemplateResponse emailTemplateResponse, AwsJsonWriter jsonWriter)
        ...
        if (emailTemplateResponse.getDefaultSubstitutions() != null) {
            String defaultSubstitutions = emailTemplateResponse.getDefaultSubstitutions();
        ...
        if (emailTemplateResponse.getRecommenderId() != null) {
            String recommenderId = emailTemplateResponse.getRecommenderId();
        ...
        if (emailTemplateResponse.getTemplateDescription() != null) {
            String templateDescription = emailTemplateResponse.getTemplateDescription();
        ...
        if (emailTemplateResponse.getVersion() != null) {
            String version = emailTemplateResponse.getVersion();
