...
/**
 * JSON unmarshaller for response GetSegmentVersionsResult
 */
public class GetSegmentVersionsResultJsonUnmarshaller implements
        Unmarshaller<GetSegmentVersionsResult, JsonUnmarshallerContext> {
    ...
    public GetSegmentVersionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SegmentsResponse")) {
                getSegmentVersionsResult.setSegmentsResponse(SegmentsResponseJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
