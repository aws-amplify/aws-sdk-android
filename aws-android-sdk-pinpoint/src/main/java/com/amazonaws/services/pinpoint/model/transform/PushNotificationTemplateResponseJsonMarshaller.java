...
class PushNotificationTemplateResponseJsonMarshaller {
    ...
    public void marshall(PushNotificationTemplateResponse pushNotificationTemplateResponse,
        ...
        if (pushNotificationTemplateResponse.getDefaultSubstitutions() != null) {
            String defaultSubstitutions = pushNotificationTemplateResponse
        ...
        if (pushNotificationTemplateResponse.getRecommenderId() != null) {
            String recommenderId = pushNotificationTemplateResponse.getRecommenderId();
        ...
        if (pushNotificationTemplateResponse.getTemplateDescription() != null) {
            String templateDescription = pushNotificationTemplateResponse.getTemplateDescription();
        ...
        if (pushNotificationTemplateResponse.getVersion() != null) {
            String version = pushNotificationTemplateResponse.getVersion();
