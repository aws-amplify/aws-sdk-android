...
class PushNotificationTemplateResponseJsonMarshaller {
    ...
    public void marshall(PushNotificationTemplateResponse pushNotificationTemplateResponse, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (pushNotificationTemplateResponse.getDefault() != null) {
            DefaultPushNotificationTemplate default = pushNotificationTemplateResponse.getDefault();
            jsonWriter.name("Default");
            DefaultPushNotificationTemplateJsonMarshaller.getInstance().marshall(default, jsonWriter);
        }
