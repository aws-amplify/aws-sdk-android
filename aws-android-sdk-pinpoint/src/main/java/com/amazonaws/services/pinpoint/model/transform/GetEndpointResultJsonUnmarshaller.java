...
/**
 * JSON unmarshaller for response GetEndpointResult
 */
public class GetEndpointResultJsonUnmarshaller implements
        Unmarshaller<GetEndpointResult, JsonUnmarshallerContext> {
