...
class TemplateConfigurationJsonMarshaller {
    ...
    public void marshall(TemplateConfiguration templateConfiguration, AwsJsonWriter jsonWriter)
        ...
        if (templateConfiguration.getVoiceTemplate() != null) {
            Template voiceTemplate = templateConfiguration.getVoiceTemplate();
            jsonWriter.name("VoiceTemplate");
            TemplateJsonMarshaller.getInstance().marshall(voiceTemplate, jsonWriter);
        }
