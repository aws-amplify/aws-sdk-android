...
public class PushNotificationTemplateResponse implements Serializable {
     ...
     */
    private DefaultPushNotificationTemplate default;
     ...
     * <p>The message template that's used for the ADM (Amazon Device Messaging) channel. This message template overrides the default template for push notification channels (DefaultPushNotificationTemplate).</p>
     *
     * @return <p>The message template that's used for the ADM (Amazon Device Messaging) channel. This message template overrides the default template for push notification channels (DefaultPushNotificationTemplate).</p>
     */
     ...
     * <p>The message template that's used for the ADM (Amazon Device Messaging) channel. This message template overrides the default template for push notification channels (DefaultPushNotificationTemplate).</p>
     *
     * @param aDM <p>The message template that's used for the ADM (Amazon Device Messaging) channel. This message template overrides the default template for push notification channels (DefaultPushNotificationTemplate).</p>
     */
     ...
     * <p>The message template that's used for the APNs (Apple Push Notification service) channel. This message template overrides the default template for push notification channels (DefaultPushNotificationTemplate).</p>
     *
     * @return <p>The message template that's used for the APNs (Apple Push Notification service) channel. This message template overrides the default template for push notification channels (DefaultPushNotificationTemplate).</p>
     */
     ...
     * <p>The message template that's used for the APNs (Apple Push Notification service) channel. This message template overrides the default template for push notification channels (DefaultPushNotificationTemplate).</p>
     *
     * @param aPNS <p>The message template that's used for the APNs (Apple Push Notification service) channel. This message template overrides the default template for push notification channels (DefaultPushNotificationTemplate).</p>
     */
     ...
     * <p>The Amazon Resource Name (ARN) of the message template.</p>
     *
     * @return <p>The Amazon Resource Name (ARN) of the message template.</p>
     */
     ...
     * <p>The Amazon Resource Name (ARN) of the message template.</p>
     *
     * @param arn <p>The Amazon Resource Name (ARN) of the message template.</p>
     */
     ...
     * <p>The message template that's used for the Baidu (Baidu Cloud Push) channel. This message template overrides the default template for push notification channels (DefaultPushNotificationTemplate).</p>
     *
     * @return <p>The message template that's used for the Baidu (Baidu Cloud Push) channel. This message template overrides the default template for push notification channels (DefaultPushNotificationTemplate).</p>
     */
     ...
     * <p>The message template that's used for the Baidu (Baidu Cloud Push) channel. This message template overrides the default template for push notification channels (DefaultPushNotificationTemplate).</p>
     *
     * @param baidu <p>The message template that's used for the Baidu (Baidu Cloud Push) channel. This message template overrides the default template for push notification channels (DefaultPushNotificationTemplate).</p>
     */
     ...
     * <p>The date when the message template was created.</p>
     *
     * @return <p>The date when the message template was created.</p>
     */
     ...
     * <p>The date when the message template was created.</p>
     *
     * @param creationDate <p>The date when the message template was created.</p>
     */
     ...
     * <p>The default message template that's used for push notification channels.</p>
     *
     * @return <p>The default message template that's used for push notification channels.</p>
     */
     ...
     * <p>The default message template that's used for push notification channels.</p>
     *
     * @param default <p>The default message template that's used for push notification channels.</p>
     */
    public void setDefault(DefaultPushNotificationTemplate default) {
     ...
     * @return A reference to this updated object so that method calls can be chained together.
     */
    public PushNotificationTemplateResponse withDefault(DefaultPushNotificationTemplate default) {
        this.default = default;
        return this;
    }
     ...
     * <p>The message template that's used for the GCM channel, which is used to send notifications through the Firebase Cloud Messaging (FCM), formerly Google Cloud Messaging (GCM), service. This message template overrides the default template for push notification channels (DefaultPushNotificationTemplate).</p>
     *
     * @return <p>The message template that's used for the GCM channel, which is used to send notifications through the Firebase Cloud Messaging (FCM), formerly Google Cloud Messaging (GCM), service. This message template overrides the default template for push notification channels (DefaultPushNotificationTemplate).</p>
     */
     ...
     * <p>The date when the message template was last modified.</p>
     *
     * @return <p>The date when the message template was last modified.</p>
     */
     ...
     * <p>The date when the message template was last modified.</p>
     *
     * @param lastModifiedDate <p>The date when the message template was last modified.</p>
     */
     ...
     * <p>A string-to-string map of key-value pairs that identifies the tags that are associated with the message template. Each tag consists of a required tag key and an associated tag value.</p>
     *
     * @return <p>A string-to-string map of key-value pairs that identifies the tags that are associated with the message template. Each tag consists of a required tag key and an associated tag value.</p>
     */
     ...
     * <p>A string-to-string map of key-value pairs that identifies the tags that are associated with the message template. Each tag consists of a required tag key and an associated tag value.</p>
     *
     * @param tags <p>A string-to-string map of key-value pairs that identifies the tags that are associated with the message template. Each tag consists of a required tag key and an associated tag value.</p>
     */
     ...
     * <p>The name of the message template.</p>
     *
     * @return <p>The name of the message template.</p>
     */
     ...
     * <p>The name of the message template.</p>
     *
     * @param templateName <p>The name of the message template.</p>
     */
     ...
     * <b>Allowed Values: </b>EMAIL, SMS, PUSH
     *
     * @return <p>The type of channel that the message template is designed for. For a push notification template, this value is PUSH.</p>
     *
     * @see TemplateType
     */
     ...
     * <b>Allowed Values: </b>EMAIL, SMS, PUSH
     *
     * @param templateType <p>The type of channel that the message template is designed for. For a push notification template, this value is PUSH.</p>
     *
     * @see TemplateType
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getADM() != null) sb.append("ADM: " + getADM() + ",");
        if (getAPNS() != null) sb.append("APNS: " + getAPNS() + ",");
        if (getArn() != null) sb.append("Arn: " + getArn() + ",");
        if (getBaidu() != null) sb.append("Baidu: " + getBaidu() + ",");
        if (getCreationDate() != null) sb.append("CreationDate: " + getCreationDate() + ",");
        if (getDefault() != null) sb.append("Default: " + getDefault() + ",");
        if (getGCM() != null) sb.append("GCM: " + getGCM() + ",");
        ...
        if (getTemplateType() != null) sb.append("TemplateType: " + getTemplateType());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PushNotificationTemplateResponse == false) return false;
        PushNotificationTemplateResponse other = (PushNotificationTemplateResponse)obj;

        if (other.getADM() == null ^ this.getADM() == null) return false;
        if (other.getADM() != null && other.getADM().equals(this.getADM()) == false) return false;
        if (other.getAPNS() == null ^ this.getAPNS() == null) return false;
        if (other.getAPNS() != null && other.getAPNS().equals(this.getAPNS()) == false) return false;
        if (other.getArn() == null ^ this.getArn() == null) return false;
        if (other.getArn() != null && other.getArn().equals(this.getArn()) == false) return false;
        if (other.getBaidu() == null ^ this.getBaidu() == null) return false;
        if (other.getBaidu() != null && other.getBaidu().equals(this.getBaidu()) == false) return false;
        ...
        if (other.getDefault() == null ^ this.getDefault() == null) return false;
        if (other.getDefault() != null && other.getDefault().equals(this.getDefault()) == false) return false;
        if (other.getGCM() == null ^ this.getGCM() == null) return false;
        if (other.getGCM() != null && other.getGCM().equals(this.getGCM()) == false) return false;
        ...
        if (other.getTemplateType() == null ^ this.getTemplateType() == null) return false;
        if (other.getTemplateType() != null && other.getTemplateType().equals(this.getTemplateType()) == false) return false;
        return true;
    }
}
