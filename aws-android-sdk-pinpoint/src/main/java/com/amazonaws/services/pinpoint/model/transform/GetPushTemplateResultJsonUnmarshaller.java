...
/**
 * JSON unmarshaller for response GetPushTemplateResult
 */
public class GetPushTemplateResultJsonUnmarshaller implements
        Unmarshaller<GetPushTemplateResult, JsonUnmarshallerContext> {
