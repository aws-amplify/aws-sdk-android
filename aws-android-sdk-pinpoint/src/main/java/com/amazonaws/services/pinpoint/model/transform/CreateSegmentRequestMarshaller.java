...
/**
 * JSON request marshaller for CreateSegmentRequest
 */
public class CreateSegmentRequestMarshaller implements
        Marshaller<Request<CreateSegmentRequest>, CreateSegmentRequest> {

    public Request<CreateSegmentRequest> marshall(CreateSegmentRequest createSegmentRequest) {
        if (createSegmentRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateSegmentRequest)");
        }

        Request<CreateSegmentRequest> request = new DefaultRequest<CreateSegmentRequest>(
        ...
        uriResourcePath = uriResourcePath.replace(
                "{application-id}",
                (createSegmentRequest.getApplicationId() == null) ? "" : StringUtils
                        .fromString(createSegmentRequest.getApplicationId()));
