...
/**
 * JSON unmarshaller for response DeleteEmailTemplateResult
 */
public class DeleteEmailTemplateResultJsonUnmarshaller implements
        Unmarshaller<DeleteEmailTemplateResult, JsonUnmarshallerContext> {
