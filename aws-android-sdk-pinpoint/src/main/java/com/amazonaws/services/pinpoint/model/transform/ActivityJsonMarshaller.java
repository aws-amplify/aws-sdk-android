...
class ActivityJsonMarshaller {
    ...
    public void marshall(Activity activity, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (activity.getCUSTOM() != null) {
            CustomMessageActivity cUSTOM = activity.getCUSTOM();
            jsonWriter.name("CUSTOM");
            CustomMessageActivityJsonMarshaller.getInstance().marshall(cUSTOM, jsonWriter);
        }
        ...
        if (activity.getPUSH() != null) {
            PushMessageActivity pUSH = activity.getPUSH();
            jsonWriter.name("PUSH");
            PushMessageActivityJsonMarshaller.getInstance().marshall(pUSH, jsonWriter);
        }
        ...
        if (activity.getSMS() != null) {
            SMSMessageActivity sMS = activity.getSMS();
            jsonWriter.name("SMS");
            SMSMessageActivityJsonMarshaller.getInstance().marshall(sMS, jsonWriter);
        }
