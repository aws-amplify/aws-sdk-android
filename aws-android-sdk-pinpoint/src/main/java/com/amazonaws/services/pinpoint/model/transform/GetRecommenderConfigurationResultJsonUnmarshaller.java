...
/**
 * JSON unmarshaller for response GetRecommenderConfigurationResult
 */
public class GetRecommenderConfigurationResultJsonUnmarshaller implements
        Unmarshaller<GetRecommenderConfigurationResult, JsonUnmarshallerContext> {

    public GetRecommenderConfigurationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
