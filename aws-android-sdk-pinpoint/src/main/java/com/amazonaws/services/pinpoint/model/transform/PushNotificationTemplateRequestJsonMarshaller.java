...
class PushNotificationTemplateRequestJsonMarshaller {
    ...
    public void marshall(PushNotificationTemplateRequest pushNotificationTemplateRequest,
        ...
        if (pushNotificationTemplateRequest.getDefaultSubstitutions() != null) {
            String defaultSubstitutions = pushNotificationTemplateRequest.getDefaultSubstitutions();
        ...
        if (pushNotificationTemplateRequest.getRecommenderId() != null) {
            String recommenderId = pushNotificationTemplateRequest.getRecommenderId();
        ...
        if (pushNotificationTemplateRequest.getTemplateDescription() != null) {
            String templateDescription = pushNotificationTemplateRequest.getTemplateDescription();
