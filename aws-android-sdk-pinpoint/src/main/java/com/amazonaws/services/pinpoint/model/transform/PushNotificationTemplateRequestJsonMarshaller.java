...
class PushNotificationTemplateRequestJsonMarshaller {
    ...
    public void marshall(PushNotificationTemplateRequest pushNotificationTemplateRequest, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (pushNotificationTemplateRequest.getDefault() != null) {
            DefaultPushNotificationTemplate default = pushNotificationTemplateRequest.getDefault();
