...
/**
 * JSON unmarshaller for response UpdateEmailTemplateResult
 */
public class UpdateEmailTemplateResultJsonUnmarshaller implements
        Unmarshaller<UpdateEmailTemplateResult, JsonUnmarshallerContext> {
    ...
    public UpdateEmailTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("MessageBody")) {
                updateEmailTemplateResult.setMessageBody(MessageBodyJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
