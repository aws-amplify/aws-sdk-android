...
/**
 * JSON unmarshaller for response DeleteApnsChannelResult
 */
public class DeleteApnsChannelResultJsonUnmarshaller implements
        Unmarshaller<DeleteApnsChannelResult, JsonUnmarshallerContext> {
    ...
    public DeleteApnsChannelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("APNSChannelResponse")) {
                deleteApnsChannelResult.setAPNSChannelResponse(APNSChannelResponseJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
