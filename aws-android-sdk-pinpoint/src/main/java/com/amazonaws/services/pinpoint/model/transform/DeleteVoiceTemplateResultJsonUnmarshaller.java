...
/**
 * JSON unmarshaller for response DeleteVoiceTemplateResult
 */
public class DeleteVoiceTemplateResultJsonUnmarshaller implements
        Unmarshaller<DeleteVoiceTemplateResult, JsonUnmarshallerContext> {
