...
/**
 * JSON unmarshaller for response GetApnsVoipChannelResult
 */
public class GetApnsVoipChannelResultJsonUnmarshaller implements
        Unmarshaller<GetApnsVoipChannelResult, JsonUnmarshallerContext> {
