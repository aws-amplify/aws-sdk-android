...
/**
 * JSON unmarshaller for response GetJourneyResult
 */
public class GetJourneyResultJsonUnmarshaller implements
        Unmarshaller<GetJourneyResult, JsonUnmarshallerContext> {
