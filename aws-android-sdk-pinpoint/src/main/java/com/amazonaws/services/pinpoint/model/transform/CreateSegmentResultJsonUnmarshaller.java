...
/**
 * JSON unmarshaller for response CreateSegmentResult
 */
public class CreateSegmentResultJsonUnmarshaller implements
        Unmarshaller<CreateSegmentResult, JsonUnmarshallerContext> {
    ...
    public CreateSegmentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SegmentResponse")) {
                createSegmentResult.setSegmentResponse(SegmentResponseJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
