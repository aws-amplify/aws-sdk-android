...
public class EmailChannelResponse implements Serializable {
     ...
     * >Amazon SES configuration set</a> that's applied to messages that are
     ...
     *         The <a href=
     *         "https://docs.aws.amazon.com/ses/latest/APIReference/API_ConfigurationSet.html"
     *         >Amazon SES configuration set</a> that's applied to messages that
     ...
     *            The <a href=
     *            "https://docs.aws.amazon.com/ses/latest/APIReference/API_ConfigurationSet.html"
     *            >Amazon SES configuration set</a> that's applied to messages
     ...
     *
     * @param fromAddress <p>
     *            The verified email address that email is sent from when you
     ...
     *            The maximum number of emails that can be sent through the
     *            channel each second.
     *            </p>
     */
