    ...
    public Condition unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Conditions")) {
                condition.setConditions(new ListUnmarshaller<SimpleCondition>(
                        SimpleConditionJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Operator")) {
                condition.setOperator(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
