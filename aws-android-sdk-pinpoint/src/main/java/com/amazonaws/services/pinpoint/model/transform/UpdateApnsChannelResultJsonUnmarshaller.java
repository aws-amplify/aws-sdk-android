...
/**
 * JSON unmarshaller for response UpdateApnsChannelResult
 */
public class UpdateApnsChannelResultJsonUnmarshaller implements
        Unmarshaller<UpdateApnsChannelResult, JsonUnmarshallerContext> {
    ...
    public UpdateApnsChannelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("APNSChannelResponse")) {
                updateApnsChannelResult.setAPNSChannelResponse(APNSChannelResponseJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
