...
/**
 * JSON unmarshaller for response GetSegmentVersionResult
 */
public class GetSegmentVersionResultJsonUnmarshaller implements
        Unmarshaller<GetSegmentVersionResult, JsonUnmarshallerContext> {
    ...
    public GetSegmentVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SegmentResponse")) {
                getSegmentVersionResult.setSegmentResponse(SegmentResponseJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
