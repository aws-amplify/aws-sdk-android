...
/**
 * JSON unmarshaller for POJO EndpointBatchRequest
 */
class EndpointBatchRequestJsonUnmarshaller implements
        Unmarshaller<EndpointBatchRequest, JsonUnmarshallerContext> {
