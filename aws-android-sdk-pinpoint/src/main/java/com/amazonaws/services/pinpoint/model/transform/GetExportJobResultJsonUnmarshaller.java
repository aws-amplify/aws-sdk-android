...
/**
 * JSON unmarshaller for response GetExportJobResult
 */
public class GetExportJobResultJsonUnmarshaller implements
        Unmarshaller<GetExportJobResult, JsonUnmarshallerContext> {
    ...
    public GetExportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ExportJobResponse")) {
                getExportJobResult.setExportJobResponse(ExportJobResponseJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
