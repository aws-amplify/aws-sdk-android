 ...
 * </p>
 */
public class CreatePushTemplateRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         Creates a message template that you can use in messages that are
     ...
     *            Creates a message template that you can use in messages that
     ...
     *         chained together.
     */
    public CreatePushTemplateRequest withPushNotificationTemplateRequest(
            PushNotificationTemplateRequest pushNotificationTemplateRequest) {
        this.pushNotificationTemplateRequest = pushNotificationTemplateRequest;
        return this;
    }
