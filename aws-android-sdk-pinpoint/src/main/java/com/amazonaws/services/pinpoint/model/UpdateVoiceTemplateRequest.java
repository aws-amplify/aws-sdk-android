 ...
 * </p>
 */
public class UpdateVoiceTemplateRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         Specifies whether to save the updates as a new version of the
     *         message template. Valid values are: true, save the updates as a
     *         new version; and, false, save the updates to (overwrite) the
     *         latest existing version of the template.
     *         </p>
     *         <p>
     *         If you don't specify a value for this parameter, Amazon Pinpoint
     *         saves the updates to (overwrites) the latest existing version of
     *         the template. If you specify a value of true for this parameter,
     *         don't specify a value for the version parameter. Otherwise, an
     *         error will occur.
     *         </p>
     */
     ...
     *            Specifies whether to save the updates as a new version of the
     *            message template. Valid values are: true, save the updates as
     *            a new version; and, false, save the updates to (overwrite) the
     *            latest existing version of the template.
     *            </p>
     *            <p>
     *            If you don't specify a value for this parameter, Amazon
     *            Pinpoint saves the updates to (overwrites) the latest existing
     *            version of the template. If you specify a value of true for
     *            this parameter, don't specify a value for the version
     ...
     * </p>
     *
     * @param voiceTemplateRequest <p>
     *            Specifies the content and settings for a message template that
     *            can be used in messages that are sent through the voice
     *            channel.
     *            </p>
     */
     ...
     *         chained together.
     */
    public UpdateVoiceTemplateRequest withVoiceTemplateRequest(
    ...
    public String toString() {
        ...
        if (getVoiceTemplateRequest() != null)
            sb.append("VoiceTemplateRequest: " + getVoiceTemplateRequest());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getVoiceTemplateRequest() == null) ? 0 : getVoiceTemplateRequest().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getVoiceTemplateRequest() == null ^ this.getVoiceTemplateRequest() == null)
            return false;
        if (other.getVoiceTemplateRequest() != null
                && other.getVoiceTemplateRequest().equals(this.getVoiceTemplateRequest()) == false)
            return false;
        return true;
    }
}
