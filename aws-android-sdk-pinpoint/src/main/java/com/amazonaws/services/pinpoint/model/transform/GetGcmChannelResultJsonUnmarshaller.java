...
/**
 * JSON unmarshaller for response GetGcmChannelResult
 */
public class GetGcmChannelResultJsonUnmarshaller implements
        Unmarshaller<GetGcmChannelResult, JsonUnmarshallerContext> {
