...
/**
 * JSON unmarshaller for response UpdateApnsVoipChannelResult
 */
public class UpdateApnsVoipChannelResultJsonUnmarshaller implements
        Unmarshaller<UpdateApnsVoipChannelResult, JsonUnmarshallerContext> {
