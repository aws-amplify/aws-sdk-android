...
public class UpdateEndpointRequestMarshaller implements
    ...
    public Request<UpdateEndpointRequest> marshall(UpdateEndpointRequest updateEndpointRequest) {
        ...
        uriResourcePath = uriResourcePath.replace(
                "{application-id}",
                (updateEndpointRequest.getApplicationId() == null) ? "" : StringUtils
                        .fromString(updateEndpointRequest.getApplicationId()));
        uriResourcePath = uriResourcePath.replace(
                "{endpoint-id}",
                (updateEndpointRequest.getEndpointId() == null) ? "" : StringUtils
                        .fromString(updateEndpointRequest.getEndpointId()));
        ...
        try {
            ...
            if (updateEndpointRequest.getEndpointRequest() != null) {
                ...
                jsonWriter.name("EndpointRequest");
