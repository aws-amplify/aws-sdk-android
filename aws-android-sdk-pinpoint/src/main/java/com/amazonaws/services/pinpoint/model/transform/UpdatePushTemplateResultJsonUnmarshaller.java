...
/**
 * JSON unmarshaller for response UpdatePushTemplateResult
 */
public class UpdatePushTemplateResultJsonUnmarshaller implements
        Unmarshaller<UpdatePushTemplateResult, JsonUnmarshallerContext> {
    ...
    public UpdatePushTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("MessageBody")) {
                updatePushTemplateResult.setMessageBody(MessageBodyJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
