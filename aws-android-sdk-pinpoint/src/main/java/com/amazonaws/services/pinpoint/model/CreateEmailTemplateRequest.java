 ...
 * </p>
 */
public class CreateEmailTemplateRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     * Creates a new message template that you can use in messages that are sent
     ...
     *
     * @return <p>
     *         Creates a new message template that you can use in messages that
     ...
     *            Creates a new message template that you can use in messages
     ...
     *         chained together.
     */
    public CreateEmailTemplateRequest withEmailTemplateRequest(
