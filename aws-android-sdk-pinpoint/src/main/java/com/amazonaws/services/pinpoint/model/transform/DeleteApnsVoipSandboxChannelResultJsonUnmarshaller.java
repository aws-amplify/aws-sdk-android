...
/**
 * JSON unmarshaller for response DeleteApnsVoipSandboxChannelResult
 */
public class DeleteApnsVoipSandboxChannelResultJsonUnmarshaller implements
        Unmarshaller<DeleteApnsVoipSandboxChannelResult, JsonUnmarshallerContext> {

    public DeleteApnsVoipSandboxChannelResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
