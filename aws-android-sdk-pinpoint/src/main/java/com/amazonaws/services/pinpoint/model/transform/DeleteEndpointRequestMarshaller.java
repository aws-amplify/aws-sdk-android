...
/**
 * JSON request marshaller for DeleteEndpointRequest
 */
public class DeleteEndpointRequestMarshaller implements
    ...
    public Request<DeleteEndpointRequest> marshall(DeleteEndpointRequest deleteEndpointRequest) {
        ...
        Request<DeleteEndpointRequest> request = new DefaultRequest<DeleteEndpointRequest>(
                deleteEndpointRequest, "AmazonPinpoint");
        request.setHttpMethod(HttpMethodName.DELETE);

        String uriResourcePath = "/v1/apps/{application-id}/endpoints/{endpoint-id}";
        uriResourcePath = uriResourcePath.replace(
                "{application-id}",
                (deleteEndpointRequest.getApplicationId() == null) ? "" : StringUtils
                        .fromString(deleteEndpointRequest.getApplicationId()));
        uriResourcePath = uriResourcePath.replace(
                "{endpoint-id}",
                (deleteEndpointRequest.getEndpointId() == null) ? "" : StringUtils
                        .fromString(deleteEndpointRequest.getEndpointId()));
