...
public class GooglePlayMonetizationEventBuilderTest extends MobileAnalyticsTestBase {
    ...
    public void build_productIdNotSet_returnsNull() {
        GooglePlayMonetizationEventBuilder builder = new GooglePlayMonetizationEventBuilder(
                mockEventClient);
        verifyMonetizationEvent(builder, false, null, "USD", 1.0, "abc123", 1.0);
    }
    ...
    public void build_quantityNotSet_returnsNull() {
        GooglePlayMonetizationEventBuilder builder = new GooglePlayMonetizationEventBuilder(
                mockEventClient);
        verifyMonetizationEvent(builder, false, "com.amazon.item", "USD", null, "abc123", 1.0);
    }
    ...
    public void build_eventClientNotSet_returnsNull() {
        ...
        verifyMonetizationEvent(builder, false, "com.amazon.item", "USD", 1.0, "abc123", 1.0);
    }
    ...
    public void build_noFormattedPriceSet_returnsNull() {
        GooglePlayMonetizationEventBuilder builder = new GooglePlayMonetizationEventBuilder(
                mockEventClient);
        verifyMonetizationEvent(builder, false, "com.amazon.item", null, 1.0, "abc123", 1.0);
    }
    ...
    public void build_emptyFormattedPriceSet_returnsNull() {
        GooglePlayMonetizationEventBuilder builder = new GooglePlayMonetizationEventBuilder(
                mockEventClient);
        verifyMonetizationEvent(builder, false, "com.amazon.item", "", 1.0, "abc123", 1.0);
    }
    ...
    public void build_noTransactionIdSet_returnsNull() {
        GooglePlayMonetizationEventBuilder builder = new GooglePlayMonetizationEventBuilder(
                mockEventClient);
        verifyMonetizationEvent(builder, false, "com.amazon.item", null, 1.0, null, 1.0);
    }
    ...
    public void build_emptyTransactionIdSet_returnsNull() {
        GooglePlayMonetizationEventBuilder builder = new GooglePlayMonetizationEventBuilder(
                mockEventClient);
        verifyMonetizationEvent(builder, false, "com.amazon.item", "", 1.0, "", 1.0);
    }
    ...
    public void build_allValuesSet_returnsEvent() {
        GooglePlayMonetizationEventBuilder builder = new GooglePlayMonetizationEventBuilder(
                mockEventClient);
        verifyMonetizationEvent(builder, true, "com.amazon.item", "USD", 1.0, "abc123", 1.0);
    }
    ...
    public void build_NoPrice_returnsNull() {
        GooglePlayMonetizationEventBuilder builder = new GooglePlayMonetizationEventBuilder(
                mockEventClient);
        verifyMonetizationEvent(builder, false, "com.amazon.item", "USD", 1.0, "abc123", null);
    }

    private static void verifyMonetizationEvent(GooglePlayMonetizationEventBuilder builder,
            boolean successfulBuild, String productId, String currency,
            Double quantity, String transactionId, Double itemPrice) {
