...
public class StreamJournalToKinesisRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * keep this parameter blank, the stream runs indefinitely until you cancel
     * it.
     * </p>
     * <p>
     ...
     *         If you keep this parameter blank, the stream runs indefinitely
     *         until you cancel it.
     *         </p>
     *         <p>
     ...
     *            ends. If you keep this parameter blank, the stream runs
     ...
     *         for a given ledger. If you try to create a stream with the same
     *         name and configuration of an active, existing stream for the same
     *         ledger, QLDB simply returns the existing stream. Stream names
     ...
     *            streams for a given ledger. If you try to create a stream with
     *            the same name and configuration of an active, existing stream
     *            for the same ledger, QLDB simply returns the existing stream.
     *            Stream names have the same naming constraints as ledger names,
