 ...
 * </p>
 */
public class ListJournalS3ExportsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * @param maxResults <p>
     *            The maximum number of results to return in a single
     *            <code>ListJournalS3Exports</code> request. (The actual number
     ...
     *         <code>ListJournalS3Exports</code> call, then you should use that
     *         value as input here.
     *         </p>
     */
     ...
     *            <code>NextToken</code> in the response from a previous
     *            <code>ListJournalS3Exports</code> call, then you should use
