...
/**
 * JSON unmarshaller for POJO LedgerSummary
 */
class LedgerSummaryJsonUnmarshaller implements Unmarshaller<LedgerSummary, JsonUnmarshallerContext> {
    ...
    public LedgerSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                ledgerSummary.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("State")) {
                ledgerSummary.setState(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("CreationDateTime")) {
                ledgerSummary.setCreationDateTime(DateJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
