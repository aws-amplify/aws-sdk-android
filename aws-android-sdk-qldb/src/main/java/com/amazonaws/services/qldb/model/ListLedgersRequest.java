 ...
 * retrieve all the items by calling <code>ListLedgers</code> multiple times.
 * </p>
 */
public class ListLedgersRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * @param maxResults <p>
     *            The maximum number of results to return in a single
     *            <code>ListLedgers</code> request. (The actual number of
     ...
     *         <code>ListLedgers</code> call, then you should use that value as
     *         input here.
     *         </p>
     */
     ...
     *            <code>NextToken</code> in the response from a previous
     *            <code>ListLedgers</code> call, then you should use that value
     *            as input here.
     *            </p>
     */
