...
/**
 * JSON unmarshaller for response ListJournalS3ExportsResult
 */
public class ListJournalS3ExportsResultJsonUnmarshaller implements
        Unmarshaller<ListJournalS3ExportsResult, JsonUnmarshallerContext> {
    ...
    public ListJournalS3ExportsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("JournalS3Exports")) {
                ...
                listJournalS3ExportsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
