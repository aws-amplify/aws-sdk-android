...
/**
 * JSON unmarshaller for POJO LogPublishingOptionsStatus
 */
class LogPublishingOptionsStatusJsonUnmarshaller implements
        Unmarshaller<LogPublishingOptionsStatus, JsonUnmarshallerContext> {
    ...
    public LogPublishingOptionsStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Options")) {
                logPublishingOptionsStatus.setOptions(new MapUnmarshaller<LogPublishingOption>(
                        LogPublishingOptionJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Status")) {
                logPublishingOptionsStatus.setStatus(OptionStatusJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
