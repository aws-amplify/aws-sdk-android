...
/**
 * JSON request marshaller for DeleteElasticsearchDomainRequest
 */
public class DeleteElasticsearchDomainRequestMarshaller implements
    ...
    public Request<DeleteElasticsearchDomainRequest> marshall(
        ...
        if (deleteElasticsearchDomainRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteElasticsearchDomainRequest)");
        }

        Request<DeleteElasticsearchDomainRequest> request = new DefaultRequest<DeleteElasticsearchDomainRequest>(
                deleteElasticsearchDomainRequest, "AmazonElasticsearchService");
        ...
        uriResourcePath = uriResourcePath.replace(
                ...
                (deleteElasticsearchDomainRequest.getDomainName() == null) ? "" : StringUtils
                        .fromString(deleteElasticsearchDomainRequest.getDomainName()));
