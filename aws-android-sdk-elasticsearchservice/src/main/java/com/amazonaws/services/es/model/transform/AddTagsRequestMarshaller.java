...
/**
 * JSON request marshaller for AddTagsRequest
 */
    ...
    public Request<AddTagsRequest> marshall(AddTagsRequest addTagsRequest) {
        ...
        try {
            ...
            if (addTagsRequest.getARN() != null) {
                String aRN = addTagsRequest.getARN();
                jsonWriter.name("ARN");
                jsonWriter.value(aRN);
            }
            if (addTagsRequest.getTagList() != null) {
                java.util.List<Tag> tagList = addTagsRequest.getTagList();
