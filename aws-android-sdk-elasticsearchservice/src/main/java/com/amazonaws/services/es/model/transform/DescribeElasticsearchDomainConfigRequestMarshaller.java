...
/**
 * JSON request marshaller for DescribeElasticsearchDomainConfigRequest
 */
    ...
    public Request<DescribeElasticsearchDomainConfigRequest> marshall(
        ...
        if (describeElasticsearchDomainConfigRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeElasticsearchDomainConfigRequest)");
        }

        Request<DescribeElasticsearchDomainConfigRequest> request = new DefaultRequest<DescribeElasticsearchDomainConfigRequest>(
                describeElasticsearchDomainConfigRequest, "AmazonElasticsearchService");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/2015-01-01/es/domain/{DomainName}/config";
        uriResourcePath = uriResourcePath.replace(
                "{DomainName}",
                (describeElasticsearchDomainConfigRequest.getDomainName() == null) ? ""
                        : StringUtils.fromString(describeElasticsearchDomainConfigRequest
                                .getDomainName()));
