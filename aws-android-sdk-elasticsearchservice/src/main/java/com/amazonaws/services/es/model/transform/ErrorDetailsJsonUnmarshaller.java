...
/**
 * JSON unmarshaller for POJO ErrorDetails
 */
class ErrorDetailsJsonUnmarshaller implements Unmarshaller<ErrorDetails, JsonUnmarshallerContext> {
    ...
    public ErrorDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ErrorType")) {
                errorDetails.setErrorType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ErrorMessage")) {
                errorDetails.setErrorMessage(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
