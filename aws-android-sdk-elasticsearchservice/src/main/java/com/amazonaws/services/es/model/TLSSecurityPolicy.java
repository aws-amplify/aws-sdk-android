...
public enum TLSSecurityPolicy {
    ...
    private static final Map<String, TLSSecurityPolicy> enumMap;
    static {
        enumMap = new HashMap<String, TLSSecurityPolicy>();
        enumMap.put("Policy-Min-TLS-1-0-2019-07", PolicyMinTLS10201907);
        enumMap.put("Policy-Min-TLS-1-2-2019-07", PolicyMinTLS12201907);
    }
