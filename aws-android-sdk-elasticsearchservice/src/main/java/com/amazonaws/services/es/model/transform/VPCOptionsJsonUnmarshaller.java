...
/**
 * JSON unmarshaller for POJO VPCOptions
 */
class VPCOptionsJsonUnmarshaller implements Unmarshaller<VPCOptions, JsonUnmarshallerContext> {
    ...
    public VPCOptions unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SubnetIds")) {
                vPCOptions.setSubnetIds(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("SecurityGroupIds")) {
                vPCOptions.setSecurityGroupIds(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
