...
/**
 * JSON unmarshaller for POJO DomainEndpointOptions
 */
class DomainEndpointOptionsJsonUnmarshaller implements
        Unmarshaller<DomainEndpointOptions, JsonUnmarshallerContext> {
    ...
    public DomainEndpointOptions unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("EnforceHTTPS")) {
                domainEndpointOptions.setEnforceHTTPS(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TLSSecurityPolicy")) {
                domainEndpointOptions.setTLSSecurityPolicy(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
