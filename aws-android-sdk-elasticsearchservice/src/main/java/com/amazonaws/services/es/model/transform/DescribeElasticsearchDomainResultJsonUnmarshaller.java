...
/**
 * JSON unmarshaller for response DescribeElasticsearchDomainResult
 */
public class DescribeElasticsearchDomainResultJsonUnmarshaller implements
        Unmarshaller<DescribeElasticsearchDomainResult, JsonUnmarshallerContext> {

    public DescribeElasticsearchDomainResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
