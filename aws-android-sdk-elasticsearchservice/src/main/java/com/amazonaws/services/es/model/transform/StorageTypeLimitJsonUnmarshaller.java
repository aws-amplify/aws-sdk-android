...
/**
 * JSON unmarshaller for POJO StorageTypeLimit
 */
class StorageTypeLimitJsonUnmarshaller implements
        Unmarshaller<StorageTypeLimit, JsonUnmarshallerContext> {
    ...
    public StorageTypeLimit unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("LimitName")) {
                storageTypeLimit.setLimitName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("LimitValues")) {
                storageTypeLimit.setLimitValues(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
