...
/**
 * JSON unmarshaller for POJO DomainInfo
 */
class DomainInfoJsonUnmarshaller implements Unmarshaller<DomainInfo, JsonUnmarshallerContext> {
    ...
    public DomainInfo unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("DomainName")) {
                domainInfo.setDomainName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
