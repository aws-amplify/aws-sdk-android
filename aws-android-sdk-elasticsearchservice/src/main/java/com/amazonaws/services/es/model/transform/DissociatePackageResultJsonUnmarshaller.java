...
/**
 * JSON unmarshaller for response DissociatePackageResult
 */
public class DissociatePackageResultJsonUnmarshaller implements
        Unmarshaller<DissociatePackageResult, JsonUnmarshallerContext> {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("DomainPackageDetails")) {
                dissociatePackageResult
                        .setDomainPackageDetails(DomainPackageDetailsJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
            }
