...
/**
 * JSON unmarshaller for POJO S3ResourceClassification
 */
class S3ResourceClassificationJsonUnmarshaller implements
        Unmarshaller<S3ResourceClassification, JsonUnmarshallerContext> {
    ...
    public S3ResourceClassification unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("bucketName")) {
                s3ResourceClassification.setBucketName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("prefix")) {
                s3ResourceClassification.setPrefix(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("classificationType")) {
                s3ResourceClassification.setClassificationType(ClassificationTypeJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
