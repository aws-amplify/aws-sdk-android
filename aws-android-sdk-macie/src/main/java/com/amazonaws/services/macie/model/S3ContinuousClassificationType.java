...
/**
 * S3Continuous Classification Type
 */
public enum S3ContinuousClassificationType {
    ...
    private static final Map<String, S3ContinuousClassificationType> enumMap;
    static {
        enumMap = new HashMap<String, S3ContinuousClassificationType>();
