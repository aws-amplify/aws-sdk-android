 ...
 * with Amazon Macie Classic for the current master account. If memberAccountId
 * is specified, the action lists the S3 resources associated with Amazon Macie
 * Classic for the specified member account.
 * </p>
 */
public class ListS3ResourcesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         Use this parameter when paginating results. Set its value to null
     *         on your first call to the ListS3Resources action. Subsequent
     *         calls to the action fill nextToken in the request with the value
     ...
     *
     * @param nextToken <p>
     *            Use this parameter when paginating results. Set its value to
     *            null on your first call to the ListS3Resources action.
