...
/**
 * S3One Time Classification Type
 */
public enum S3OneTimeClassificationType {
    ...
    private static final Map<String, S3OneTimeClassificationType> enumMap;
    static {
        enumMap = new HashMap<String, S3OneTimeClassificationType>();
