...
public enum GroupByAttribute {
    ...
    private static final Map<String, GroupByAttribute> enumMap;
    static {
        enumMap = new HashMap<String, GroupByAttribute>();
        enumMap.put("TARGET_ID", TARGET_ID);
        enumMap.put("REGION", REGION);
        enumMap.put("RESOURCE_TYPE", RESOURCE_TYPE);
    }
