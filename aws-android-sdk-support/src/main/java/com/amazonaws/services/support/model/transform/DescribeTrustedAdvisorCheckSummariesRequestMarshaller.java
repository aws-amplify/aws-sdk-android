...
/**
 * JSON request marshaller for DescribeTrustedAdvisorCheckSummariesRequest
 */
public class DescribeTrustedAdvisorCheckSummariesRequestMarshaller
    ...
    public Request<DescribeTrustedAdvisorCheckSummariesRequest> marshall(
        ...
        if (describeTrustedAdvisorCheckSummariesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeTrustedAdvisorCheckSummariesRequest)");
        }
        ...
        try {
            ...
            if (describeTrustedAdvisorCheckSummariesRequest.getCheckIds() != null) {
                java.util.List<String> checkIds = describeTrustedAdvisorCheckSummariesRequest
                        .getCheckIds();
