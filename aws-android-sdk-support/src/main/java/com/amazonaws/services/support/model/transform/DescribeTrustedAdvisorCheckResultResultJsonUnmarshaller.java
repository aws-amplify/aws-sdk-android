...
/**
 * JSON unmarshaller for response DescribeTrustedAdvisorCheckResultResult
 */
public class DescribeTrustedAdvisorCheckResultResultJsonUnmarshaller implements
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("result")) {
                describeTrustedAdvisorCheckResultResult
                        .setResult(TrustedAdvisorCheckResultJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
            }
