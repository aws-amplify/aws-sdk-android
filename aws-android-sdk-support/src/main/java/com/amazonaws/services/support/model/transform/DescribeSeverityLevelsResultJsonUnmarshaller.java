...
/**
 * JSON unmarshaller for response DescribeSeverityLevelsResult
 */
public class DescribeSeverityLevelsResultJsonUnmarshaller implements
    ...
    public DescribeSeverityLevelsResult unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("severityLevels")) {
                describeSeverityLevelsResult.setSeverityLevels(new ListUnmarshaller<SeverityLevel>(
