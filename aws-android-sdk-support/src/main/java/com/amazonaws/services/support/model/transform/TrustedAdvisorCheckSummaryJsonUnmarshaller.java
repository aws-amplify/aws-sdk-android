...
/**
 * JSON unmarshaller for POJO TrustedAdvisorCheckSummary
 */
class TrustedAdvisorCheckSummaryJsonUnmarshaller implements
    ...
    public TrustedAdvisorCheckSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("checkId")) {
                trustedAdvisorCheckSummary.setCheckId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("timestamp")) {
                trustedAdvisorCheckSummary.setTimestamp(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("status")) {
                trustedAdvisorCheckSummary.setStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("hasFlaggedResources")) {
                trustedAdvisorCheckSummary.setHasFlaggedResources(BooleanJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("resourcesSummary")) {
                trustedAdvisorCheckSummary
                        .setResourcesSummary(TrustedAdvisorResourcesSummaryJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else if (name.equals("categorySpecificSummary")) {
                trustedAdvisorCheckSummary
