...
/**
 * JSON unmarshaller for response CreateCaseResult
 */
public class CreateCaseResultJsonUnmarshaller implements
        Unmarshaller<CreateCaseResult, JsonUnmarshallerContext> {
    ...
    public CreateCaseResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("caseId")) {
                createCaseResult.setCaseId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
