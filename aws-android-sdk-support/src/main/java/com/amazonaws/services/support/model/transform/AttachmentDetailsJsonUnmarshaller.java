...
/**
 * JSON unmarshaller for POJO AttachmentDetails
 */
class AttachmentDetailsJsonUnmarshaller implements
    ...
    public AttachmentDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("attachmentId")) {
                attachmentDetails.setAttachmentId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("fileName")) {
                attachmentDetails.setFileName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
