...
/**
 * JSON request marshaller for AddAttachmentsToSetRequest
 */
public class AddAttachmentsToSetRequestMarshaller implements
    ...
    public Request<AddAttachmentsToSetRequest> marshall(
        ...
        if (addAttachmentsToSetRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AddAttachmentsToSetRequest)");
        }
        ...
        try {
            ...
            if (addAttachmentsToSetRequest.getAttachmentSetId() != null) {
                String attachmentSetId = addAttachmentsToSetRequest.getAttachmentSetId();
                jsonWriter.name("attachmentSetId");
                jsonWriter.value(attachmentSetId);
            }
            if (addAttachmentsToSetRequest.getAttachments() != null) {
                java.util.List<Attachment> attachments = addAttachmentsToSetRequest
                        .getAttachments();
                jsonWriter.name("attachments");
                jsonWriter.beginArray();
                for (Attachment attachmentsItem : attachments) {
                    if (attachmentsItem != null) {
                        AttachmentJsonMarshaller.getInstance()
