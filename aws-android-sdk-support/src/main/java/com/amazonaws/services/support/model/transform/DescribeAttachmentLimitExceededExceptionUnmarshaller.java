...
public class DescribeAttachmentLimitExceededExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("DescribeAttachmentLimitExceeded");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        DescribeAttachmentLimitExceededException e = (DescribeAttachmentLimitExceededException) super
                .unmarshall(error);
