...
public class AttachmentSetSizeLimitExceededExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("AttachmentSetSizeLimitExceeded");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        AttachmentSetSizeLimitExceededException e = (AttachmentSetSizeLimitExceededException) super
                .unmarshall(error);
