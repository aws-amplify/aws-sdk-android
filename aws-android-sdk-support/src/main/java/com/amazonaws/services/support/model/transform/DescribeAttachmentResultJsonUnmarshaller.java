...
/**
 * JSON unmarshaller for response DescribeAttachmentResult
 */
public class DescribeAttachmentResultJsonUnmarshaller implements
        Unmarshaller<DescribeAttachmentResult, JsonUnmarshallerContext> {
    ...
    public DescribeAttachmentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("attachment")) {
                describeAttachmentResult.setAttachment(AttachmentJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
