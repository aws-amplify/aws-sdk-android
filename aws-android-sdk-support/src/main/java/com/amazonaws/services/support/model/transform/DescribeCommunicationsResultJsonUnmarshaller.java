...
/**
 * JSON unmarshaller for response DescribeCommunicationsResult
 */
    ...
    public DescribeCommunicationsResult unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("communications")) {
                describeCommunicationsResult.setCommunications(new ListUnmarshaller<Communication>(
                        CommunicationJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                describeCommunicationsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
