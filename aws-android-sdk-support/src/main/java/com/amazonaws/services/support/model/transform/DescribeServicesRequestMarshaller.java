...
public class DescribeServicesRequestMarshaller implements
    ...
    public Request<DescribeServicesRequest> marshall(DescribeServicesRequest describeServicesRequest) {
        ...
        try {
            ...
            if (describeServicesRequest.getServiceCodeList() != null) {
                java.util.List<String> serviceCodeList = describeServicesRequest
                        .getServiceCodeList();
                jsonWriter.name("serviceCodeList");
                jsonWriter.beginArray();
                for (String serviceCodeListItem : serviceCodeList) {
                    if (serviceCodeListItem != null) {
                        jsonWriter.value(serviceCodeListItem);
                    }
                }
                jsonWriter.endArray();
            }
            if (describeServicesRequest.getLanguage() != null) {
                String language = describeServicesRequest.getLanguage();
