...
/**
 * JSON request marshaller for DescribeAttachmentRequest
 */
public class DescribeAttachmentRequestMarshaller implements
    ...
    public Request<DescribeAttachmentRequest> marshall(
        ...
        if (describeAttachmentRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeAttachmentRequest)");
        }
        ...
        try {
            ...
            if (describeAttachmentRequest.getAttachmentId() != null) {
                String attachmentId = describeAttachmentRequest.getAttachmentId();
