 ...
 * Case</a> page. The values in those fields don't necessarily match the service
 * codes and categories returned by the <code>DescribeServices</code> operation.
 * Always use the service codes and categories that the
