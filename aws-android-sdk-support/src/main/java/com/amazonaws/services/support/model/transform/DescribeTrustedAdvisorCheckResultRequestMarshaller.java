...
/**
 * JSON request marshaller for DescribeTrustedAdvisorCheckResultRequest
 */
public class DescribeTrustedAdvisorCheckResultRequestMarshaller
    ...
    public Request<DescribeTrustedAdvisorCheckResultRequest> marshall(
        ...
        if (describeTrustedAdvisorCheckResultRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeTrustedAdvisorCheckResultRequest)");
        }
        ...
        try {
            ...
            if (describeTrustedAdvisorCheckResultRequest.getCheckId() != null) {
                String checkId = describeTrustedAdvisorCheckResultRequest.getCheckId();
                jsonWriter.name("checkId");
                jsonWriter.value(checkId);
            }
            if (describeTrustedAdvisorCheckResultRequest.getLanguage() != null) {
                String language = describeTrustedAdvisorCheckResultRequest.getLanguage();
