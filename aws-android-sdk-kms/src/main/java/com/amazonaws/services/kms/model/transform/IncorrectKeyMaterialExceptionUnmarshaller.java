...
public class IncorrectKeyMaterialExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("IncorrectKeyMaterialException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        IncorrectKeyMaterialException e = (IncorrectKeyMaterialException) super.unmarshall(error);
        e.setErrorCode("IncorrectKeyMaterialException");
