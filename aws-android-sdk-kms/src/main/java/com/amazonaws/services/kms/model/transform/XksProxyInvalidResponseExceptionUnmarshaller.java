...
public class XksProxyInvalidResponseExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("XksProxyInvalidResponseException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        XksProxyInvalidResponseException e = (XksProxyInvalidResponseException) super
                .unmarshall(error);
        e.setErrorCode("XksProxyInvalidResponseException");
