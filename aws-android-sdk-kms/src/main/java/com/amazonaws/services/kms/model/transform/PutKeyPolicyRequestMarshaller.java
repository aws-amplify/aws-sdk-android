...
/**
 * JSON request marshaller for PutKeyPolicyRequest
 */
public class PutKeyPolicyRequestMarshaller implements
        Marshaller<Request<PutKeyPolicyRequest>, PutKeyPolicyRequest> {

    public Request<PutKeyPolicyRequest> marshall(PutKeyPolicyRequest putKeyPolicyRequest) {
        if (putKeyPolicyRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(PutKeyPolicyRequest)");
        }

        Request<PutKeyPolicyRequest> request = new DefaultRequest<PutKeyPolicyRequest>(
                putKeyPolicyRequest, "AWSKMS");
        ...
        try {
            ...
            if (putKeyPolicyRequest.getBypassPolicyLockoutSafetyCheck() != null) {
                Boolean bypassPolicyLockoutSafetyCheck = putKeyPolicyRequest
