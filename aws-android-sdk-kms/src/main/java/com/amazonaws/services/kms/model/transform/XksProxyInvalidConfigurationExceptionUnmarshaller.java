...
public class XksProxyInvalidConfigurationExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("XksProxyInvalidConfigurationException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        XksProxyInvalidConfigurationException e = (XksProxyInvalidConfigurationException) super
                .unmarshall(error);
        e.setErrorCode("XksProxyInvalidConfigurationException");
