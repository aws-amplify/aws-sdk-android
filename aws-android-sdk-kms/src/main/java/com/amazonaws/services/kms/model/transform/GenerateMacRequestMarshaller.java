...
/**
 * JSON request marshaller for GenerateMacRequest
 */
public class GenerateMacRequestMarshaller implements
        Marshaller<Request<GenerateMacRequest>, GenerateMacRequest> {

    public Request<GenerateMacRequest> marshall(GenerateMacRequest generateMacRequest) {
        if (generateMacRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GenerateMacRequest)");
        }

        Request<GenerateMacRequest> request = new DefaultRequest<GenerateMacRequest>(
                generateMacRequest, "AWSKMS");
        ...
        try {
            ...
            if (generateMacRequest.getMessage() != null) {
                java.nio.ByteBuffer message = generateMacRequest.getMessage();
            ...
            if (generateMacRequest.getGrantTokens() != null) {
                java.util.List<String> grantTokens = generateMacRequest.getGrantTokens();
