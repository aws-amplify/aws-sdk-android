...
/**
 * JSON request marshaller for ListResourceTagsRequest
 */
public class ListResourceTagsRequestMarshaller implements
        Marshaller<Request<ListResourceTagsRequest>, ListResourceTagsRequest> {
    ...
    public Request<ListResourceTagsRequest> marshall(ListResourceTagsRequest listResourceTagsRequest) {
        if (listResourceTagsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListResourceTagsRequest)");
        }

        Request<ListResourceTagsRequest> request = new DefaultRequest<ListResourceTagsRequest>(
                listResourceTagsRequest, "AWSKMS");
