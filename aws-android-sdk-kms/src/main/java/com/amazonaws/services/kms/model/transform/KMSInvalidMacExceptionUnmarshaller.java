...
public class KMSInvalidMacExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("KMSInvalidMacException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        KMSInvalidMacException e = (KMSInvalidMacException) super.unmarshall(error);
        e.setErrorCode("KMSInvalidMacException");
