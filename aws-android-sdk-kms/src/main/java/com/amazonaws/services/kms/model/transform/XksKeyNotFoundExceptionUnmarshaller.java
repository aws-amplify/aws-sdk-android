...
public class XksKeyNotFoundExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("XksKeyNotFoundException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        XksKeyNotFoundException e = (XksKeyNotFoundException) super.unmarshall(error);
        e.setErrorCode("XksKeyNotFoundException");
