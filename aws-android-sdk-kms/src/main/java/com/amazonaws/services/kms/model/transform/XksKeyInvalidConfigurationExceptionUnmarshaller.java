...
public class XksKeyInvalidConfigurationExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("XksKeyInvalidConfigurationException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        XksKeyInvalidConfigurationException e = (XksKeyInvalidConfigurationException) super
                .unmarshall(error);
        e.setErrorCode("XksKeyInvalidConfigurationException");
