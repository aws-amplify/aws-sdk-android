...
public class XksProxyUriEndpointInUseExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("XksProxyUriEndpointInUseException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        XksProxyUriEndpointInUseException e = (XksProxyUriEndpointInUseException) super
                .unmarshall(error);
        e.setErrorCode("XksProxyUriEndpointInUseException");
