...
/**
 * JSON request marshaller for ListKeyRotationsRequest
 */
public class ListKeyRotationsRequestMarshaller implements
        Marshaller<Request<ListKeyRotationsRequest>, ListKeyRotationsRequest> {
    ...
    public Request<ListKeyRotationsRequest> marshall(ListKeyRotationsRequest listKeyRotationsRequest) {
        if (listKeyRotationsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListKeyRotationsRequest)");
        }

        Request<ListKeyRotationsRequest> request = new DefaultRequest<ListKeyRotationsRequest>(
                listKeyRotationsRequest, "AWSKMS");
