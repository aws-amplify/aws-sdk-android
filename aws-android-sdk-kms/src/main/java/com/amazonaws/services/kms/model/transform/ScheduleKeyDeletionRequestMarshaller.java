...
/**
 * JSON request marshaller for ScheduleKeyDeletionRequest
 */
public class ScheduleKeyDeletionRequestMarshaller implements
    ...
    public Request<ScheduleKeyDeletionRequest> marshall(
        ...
        if (scheduleKeyDeletionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ScheduleKeyDeletionRequest)");
        }
