    ...
    if (scheduleKeyDeletionRequest == null) {
        ...
        try {
            ...
            if (scheduleKeyDeletionRequest.getKeyId() != null) {
                jsonWriter.name("KeyId").value(scheduleKeyDeletionRequest.getKeyId());
            }
            if (scheduleKeyDeletionRequest.getPendingWindowInDays() != null) {
                jsonWriter.name("PendingWindowInDays").value(scheduleKeyDeletionRequest.getPendingWindowInDays());
            }
