    ...
    if (retireGrantRequest == null) {
        ...
        try {
            ...
            if (retireGrantRequest.getGrantToken() != null) {
                jsonWriter.name("GrantToken").value(retireGrantRequest.getGrantToken());
            }
            if (retireGrantRequest.getKeyId() != null) {
                jsonWriter.name("KeyId").value(retireGrantRequest.getKeyId());
            }
            if (retireGrantRequest.getGrantId() != null) {
                jsonWriter.name("GrantId").value(retireGrantRequest.getGrantId());
            }
