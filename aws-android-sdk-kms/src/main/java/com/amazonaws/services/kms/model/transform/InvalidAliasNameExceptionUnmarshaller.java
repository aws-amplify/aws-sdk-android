...
public class InvalidAliasNameExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InvalidAliasNameException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        InvalidAliasNameException e = (InvalidAliasNameException) super.unmarshall(error);
        e.setErrorCode("InvalidAliasNameException");
