 ...
 * can use an alias to identify a CMK in <a href=
 * "https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations"
 * >cryptographic operations</a>, such as <a>Encrypt</a> and
 * <a>GenerateDataKey</a>. You can change the CMK associated with the alias at
 * any time.
 * </p>
 * <p>
 ...
 * <li>
 * <p>
 * You can use an alias name or alias ARN to identify a CMK in AWS KMS <a href=
 * "https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations"
 ...
 * information about the valid CMK identifiers for each AWS KMS API operation,
 * see the descriptions of the <code>KeyId</code> parameter in the API operation
 * documentation.
 * </p>
 * </li>
 * </ul>
