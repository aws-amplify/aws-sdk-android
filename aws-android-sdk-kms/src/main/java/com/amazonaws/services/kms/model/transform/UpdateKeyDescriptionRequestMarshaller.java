...
/**
 * JSON request marshaller for UpdateKeyDescriptionRequest
 */
public class UpdateKeyDescriptionRequestMarshaller implements
    ...
    public Request<UpdateKeyDescriptionRequest> marshall(
        ...
        if (updateKeyDescriptionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateKeyDescriptionRequest)");
        }
