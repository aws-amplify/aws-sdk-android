...
public class IncorrectKeyExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("IncorrectKeyException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        IncorrectKeyException e = (IncorrectKeyException) super.unmarshall(error);
        e.setErrorCode("IncorrectKeyException");
