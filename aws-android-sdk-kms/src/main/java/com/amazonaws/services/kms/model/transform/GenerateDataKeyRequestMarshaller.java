    ...
    if (generateDataKeyRequest == null) {
        ...
        try {
            ...
            if (generateDataKeyRequest.getKeyId() != null) {
                jsonWriter.name("KeyId").value(generateDataKeyRequest.getKeyId());
            }
            ...
            if (generateDataKeyRequest.getNumberOfBytes() != null) {
                jsonWriter.name("NumberOfBytes").value(generateDataKeyRequest.getNumberOfBytes());
            }
            if (generateDataKeyRequest.getKeySpec() != null) {
                jsonWriter.name("KeySpec").value(generateDataKeyRequest.getKeySpec());
            }
