...
public class XksProxyVpcEndpointServiceNotFoundExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("XksProxyVpcEndpointServiceNotFoundException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        XksProxyVpcEndpointServiceNotFoundException e = (XksProxyVpcEndpointServiceNotFoundException) super
                .unmarshall(error);
        e.setErrorCode("XksProxyVpcEndpointServiceNotFoundException");
