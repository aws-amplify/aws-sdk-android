...
public class InvalidImportTokenExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InvalidImportTokenException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        InvalidImportTokenException e = (InvalidImportTokenException) super.unmarshall(error);
        e.setErrorCode("InvalidImportTokenException");
