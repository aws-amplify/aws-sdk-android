...
public class XksProxyUriInUseExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("XksProxyUriInUseException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        XksProxyUriInUseException e = (XksProxyUriInUseException) super.unmarshall(error);
        e.setErrorCode("XksProxyUriInUseException");
