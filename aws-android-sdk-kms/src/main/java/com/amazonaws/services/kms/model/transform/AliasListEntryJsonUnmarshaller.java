...
/**
 * Alias List Entry JSON Unmarshaller
 */
public class AliasListEntryJsonUnmarshaller implements Unmarshaller<AliasListEntry, JsonUnmarshallerContext> {
    ...
    public AliasListEntry unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AliasName")) {
                aliasListEntry.setAliasName(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("AliasArn")) {
                aliasListEntry.setAliasArn(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("TargetKeyId")) {
                aliasListEntry.setTargetKeyId(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static AliasListEntryJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AliasListEntryJsonUnmarshaller();
        return instance;
    }
}
