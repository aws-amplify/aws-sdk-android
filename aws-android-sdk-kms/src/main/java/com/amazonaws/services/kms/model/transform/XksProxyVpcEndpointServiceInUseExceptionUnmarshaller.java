...
public class XksProxyVpcEndpointServiceInUseExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("XksProxyVpcEndpointServiceInUseException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        XksProxyVpcEndpointServiceInUseException e = (XksProxyVpcEndpointServiceInUseException) super
                .unmarshall(error);
        e.setErrorCode("XksProxyVpcEndpointServiceInUseException");
