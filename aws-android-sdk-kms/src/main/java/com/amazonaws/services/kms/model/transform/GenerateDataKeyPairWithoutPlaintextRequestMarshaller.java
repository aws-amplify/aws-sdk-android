...
/**
 * JSON request marshaller for GenerateDataKeyPairWithoutPlaintextRequest
 */
public class GenerateDataKeyPairWithoutPlaintextRequestMarshaller
    ...
    public Request<GenerateDataKeyPairWithoutPlaintextRequest> marshall(
        ...
        if (generateDataKeyPairWithoutPlaintextRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GenerateDataKeyPairWithoutPlaintextRequest)");
        }

        Request<GenerateDataKeyPairWithoutPlaintextRequest> request = new DefaultRequest<GenerateDataKeyPairWithoutPlaintextRequest>(
                generateDataKeyPairWithoutPlaintextRequest, "AWSKMS");
        ...
        try {
            ...
            if (generateDataKeyPairWithoutPlaintextRequest.getEncryptionContext() != null) {
                java.util.Map<String, String> encryptionContext = generateDataKeyPairWithoutPlaintextRequest
            ...
            if (generateDataKeyPairWithoutPlaintextRequest.getGrantTokens() != null) {
                java.util.List<String> grantTokens = generateDataKeyPairWithoutPlaintextRequest
                        .getGrantTokens();
