...
/**
 * JSON unmarshaller for response GetParametersForImportResult
 */
public class GetParametersForImportResultJsonUnmarshaller implements
        Unmarshaller<GetParametersForImportResult, JsonUnmarshallerContext> {
    ...
    public GetParametersForImportResult unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("KeyId")) {
                getParametersForImportResult.setKeyId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
