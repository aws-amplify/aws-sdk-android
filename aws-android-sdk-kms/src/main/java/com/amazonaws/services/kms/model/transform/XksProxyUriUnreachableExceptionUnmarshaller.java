...
public class XksProxyUriUnreachableExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("XksProxyUriUnreachableException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        XksProxyUriUnreachableException e = (XksProxyUriUnreachableException) super
                .unmarshall(error);
        e.setErrorCode("XksProxyUriUnreachableException");
