...
public class KMSInvalidSignatureExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("KMSInvalidSignatureException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        KMSInvalidSignatureException e = (KMSInvalidSignatureException) super.unmarshall(error);
        e.setErrorCode("KMSInvalidSignatureException");
