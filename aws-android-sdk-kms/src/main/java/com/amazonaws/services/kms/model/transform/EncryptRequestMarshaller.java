...
/**
 * JSON request marshaller for EncryptRequest
 */
public class EncryptRequestMarshaller implements
    ...
    public Request<EncryptRequest> marshall(EncryptRequest encryptRequest) {
        ...
        Request<EncryptRequest> request = new DefaultRequest<EncryptRequest>(encryptRequest,
                "AWSKMS");
        ...
        try {
            ...
            if (encryptRequest.getPlaintext() != null) {
                java.nio.ByteBuffer plaintext = encryptRequest.getPlaintext();
                jsonWriter.name("Plaintext");
                jsonWriter.value(plaintext);
            }
            if (encryptRequest.getEncryptionContext() != null) {
                java.util.Map<String, String> encryptionContext = encryptRequest
            ...
            if (encryptRequest.getGrantTokens() != null) {
                java.util.List<String> grantTokens = encryptRequest.getGrantTokens();
