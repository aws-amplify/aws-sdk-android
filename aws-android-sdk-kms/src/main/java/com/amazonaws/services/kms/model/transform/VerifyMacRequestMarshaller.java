...
/**
 * JSON request marshaller for VerifyMacRequest
 */
public class VerifyMacRequestMarshaller implements
        Marshaller<Request<VerifyMacRequest>, VerifyMacRequest> {
    ...
    public Request<VerifyMacRequest> marshall(VerifyMacRequest verifyMacRequest) {
        ...
        Request<VerifyMacRequest> request = new DefaultRequest<VerifyMacRequest>(verifyMacRequest,
                "AWSKMS");
        ...
        try {
            ...
            if (verifyMacRequest.getMessage() != null) {
                java.nio.ByteBuffer message = verifyMacRequest.getMessage();
            ...
            if (verifyMacRequest.getMac() != null) {
                java.nio.ByteBuffer mac = verifyMacRequest.getMac();
                jsonWriter.name("Mac");
                jsonWriter.value(mac);
            }
            if (verifyMacRequest.getGrantTokens() != null) {
                java.util.List<String> grantTokens = verifyMacRequest.getGrantTokens();
