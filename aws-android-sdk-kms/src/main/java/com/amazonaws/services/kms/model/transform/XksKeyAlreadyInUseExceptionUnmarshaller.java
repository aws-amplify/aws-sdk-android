...
public class XksKeyAlreadyInUseExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("XksKeyAlreadyInUseException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        XksKeyAlreadyInUseException e = (XksKeyAlreadyInUseException) super.unmarshall(error);
        e.setErrorCode("XksKeyAlreadyInUseException");
