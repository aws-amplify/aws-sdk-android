...
/**
 * JSON request marshaller for GenerateDataKeyPairRequest
 */
public class GenerateDataKeyPairRequestMarshaller implements
        Marshaller<Request<GenerateDataKeyPairRequest>, GenerateDataKeyPairRequest> {

    public Request<GenerateDataKeyPairRequest> marshall(
            GenerateDataKeyPairRequest generateDataKeyPairRequest) {
        if (generateDataKeyPairRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GenerateDataKeyPairRequest)");
        }

        Request<GenerateDataKeyPairRequest> request = new DefaultRequest<GenerateDataKeyPairRequest>(
                generateDataKeyPairRequest, "AWSKMS");
        ...
        try {
            ...
            if (generateDataKeyPairRequest.getEncryptionContext() != null) {
                java.util.Map<String, String> encryptionContext = generateDataKeyPairRequest
            ...
            if (generateDataKeyPairRequest.getGrantTokens() != null) {
                java.util.List<String> grantTokens = generateDataKeyPairRequest.getGrantTokens();
