    ...
    if (createKeyRequest == null) {
        ...
        try {
            ...
            if (createKeyRequest.getPolicy() != null) {
                jsonWriter.name("Policy").value(createKeyRequest.getPolicy());
            }
            if (createKeyRequest.getDescription() != null) {
                jsonWriter.name("Description").value(createKeyRequest.getDescription());
            }
            if (createKeyRequest.getKeyUsage() != null) {
                jsonWriter.name("KeyUsage").value(createKeyRequest.getKeyUsage());
            }
