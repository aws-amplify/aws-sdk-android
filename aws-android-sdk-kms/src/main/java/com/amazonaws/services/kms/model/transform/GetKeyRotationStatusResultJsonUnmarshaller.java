    ...
    public GetKeyRotationStatusResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("KeyRotationEnabled")) {
                ...
                getKeyRotationStatusResult.setKeyId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("RotationPeriodInDays")) {
                getKeyRotationStatusResult.setRotationPeriodInDays(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("NextRotationDate")) {
                getKeyRotationStatusResult.setNextRotationDate(DateJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("OnDemandRotationStartDate")) {
                getKeyRotationStatusResult.setOnDemandRotationStartDate(DateJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
