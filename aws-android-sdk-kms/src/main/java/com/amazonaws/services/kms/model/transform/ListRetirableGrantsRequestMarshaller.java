    ...
    if (listRetirableGrantsRequest == null) {
        ...
        try {
            ...
            if (listRetirableGrantsRequest.getLimit() != null) {
                jsonWriter.name("Limit").value(listRetirableGrantsRequest.getLimit());
            }
            if (listRetirableGrantsRequest.getMarker() != null) {
                jsonWriter.name("Marker").value(listRetirableGrantsRequest.getMarker());
            }
            if (listRetirableGrantsRequest.getRetiringPrincipal() != null) {
                jsonWriter.name("RetiringPrincipal").value(listRetirableGrantsRequest.getRetiringPrincipal());
            }
