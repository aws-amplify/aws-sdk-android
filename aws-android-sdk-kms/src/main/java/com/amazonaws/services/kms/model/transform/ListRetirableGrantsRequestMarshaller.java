...
/**
 * JSON request marshaller for ListRetirableGrantsRequest
 */
public class ListRetirableGrantsRequestMarshaller implements
    ...
    public Request<ListRetirableGrantsRequest> marshall(
        ...
        if (listRetirableGrantsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListRetirableGrantsRequest)");
        }
