...
/**
 * JSON request marshaller for GetParametersForImportRequest
 */
public class GetParametersForImportRequestMarshaller implements
        Marshaller<Request<GetParametersForImportRequest>, GetParametersForImportRequest> {

    public Request<GetParametersForImportRequest> marshall(
            GetParametersForImportRequest getParametersForImportRequest) {
        if (getParametersForImportRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetParametersForImportRequest)");
        }

        Request<GetParametersForImportRequest> request = new DefaultRequest<GetParametersForImportRequest>(
                getParametersForImportRequest, "AWSKMS");
