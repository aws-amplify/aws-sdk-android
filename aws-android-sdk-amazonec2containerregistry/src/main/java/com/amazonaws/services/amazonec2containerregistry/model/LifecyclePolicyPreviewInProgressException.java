 ...
 * </p>
 */
public class LifecyclePolicyPreviewInProgressException extends AmazonServiceException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new LifecyclePolicyPreviewInProgressException with the
