...
/**
 * JSON unmarshaller for response BatchCheckLayerAvailabilityResult
 */
public class BatchCheckLayerAvailabilityResultJsonUnmarshaller implements
        Unmarshaller<BatchCheckLayerAvailabilityResult, JsonUnmarshallerContext> {

    public BatchCheckLayerAvailabilityResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("layers")) {
                batchCheckLayerAvailabilityResult.setLayers(new ListUnmarshaller<Layer>(
                        LayerJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("failures")) {
                batchCheckLayerAvailabilityResult.setFailures(new ListUnmarshaller<LayerFailure>(
