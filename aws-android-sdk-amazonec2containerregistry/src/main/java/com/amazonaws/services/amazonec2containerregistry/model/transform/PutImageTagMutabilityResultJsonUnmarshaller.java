...
/**
 * JSON unmarshaller for response PutImageTagMutabilityResult
 */
public class PutImageTagMutabilityResultJsonUnmarshaller implements
        Unmarshaller<PutImageTagMutabilityResult, JsonUnmarshallerContext> {
    ...
    public PutImageTagMutabilityResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("registryId")) {
                putImageTagMutabilityResult.setRegistryId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("repositoryName")) {
                putImageTagMutabilityResult.setRepositoryName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("imageTagMutability")) {
                putImageTagMutabilityResult.setImageTagMutability(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
