...
/**
 * JSON unmarshaller for response DescribeImagesResult
 */
public class DescribeImagesResultJsonUnmarshaller implements
        Unmarshaller<DescribeImagesResult, JsonUnmarshallerContext> {
    ...
    public DescribeImagesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("imageDetails")) {
                describeImagesResult.setImageDetails(new ListUnmarshaller<ImageDetail>(
                        ImageDetailJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                describeImagesResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
