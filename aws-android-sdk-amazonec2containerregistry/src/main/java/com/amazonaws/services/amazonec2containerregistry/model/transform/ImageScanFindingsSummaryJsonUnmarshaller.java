...
/**
 * JSON unmarshaller for POJO ImageScanFindingsSummary
 */
class ImageScanFindingsSummaryJsonUnmarshaller implements
        Unmarshaller<ImageScanFindingsSummary, JsonUnmarshallerContext> {
    ...
    public ImageScanFindingsSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("imageScanCompletedAt")) {
                imageScanFindingsSummary.setImageScanCompletedAt(DateJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("vulnerabilitySourceUpdatedAt")) {
                imageScanFindingsSummary.setVulnerabilitySourceUpdatedAt(DateJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("findingSeverityCounts")) {
                imageScanFindingsSummary.setFindingSeverityCounts(new MapUnmarshaller<Integer>(
