...
public class DescribeRepositoriesResult implements Serializable {
    /**
     * <p>
     ...
     *            A list of repository objects corresponding to valid
     *            repositories.
     *            </p>
     */
    ...
    public DescribeRepositoriesResult withRepositories(Repository... repositories) {
        if (getRepositories() == null) {
            this.repositories = new java.util.ArrayList<Repository>(repositories.length);
        }
     ...
     * @param nextToken <p>
     *            The <code>nextToken</code> value to include in a future
     *            <code>DescribeRepositories</code> request. When the results of
     *            a <code>DescribeRepositories</code> request exceed
