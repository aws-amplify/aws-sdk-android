...
public class TagResourceRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         The Amazon Resource Name (ARN) of the the resource to which to
     *         add tags. Currently, the only supported resource is an Amazon ECR
     *         repository.
     *         </p>
     */
     ...
     * @param resourceArn <p>
     *            The Amazon Resource Name (ARN) of the the resource to which to
     *            add tags. Currently, the only supported resource is an Amazon
     *            ECR repository.
     *            </p>
     */
