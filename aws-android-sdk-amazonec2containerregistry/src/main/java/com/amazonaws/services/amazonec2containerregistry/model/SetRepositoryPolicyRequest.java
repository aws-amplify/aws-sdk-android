...
public class SetRepositoryPolicyRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Length: </b>0 - 10240<br/>
     *
     * @return <p>The JSON repository policy text to apply to the repository. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/RepositoryPolicyExamples.html">Amazon ECR Repository Policy Examples</a> in the <i>Amazon Elastic Container Registry User Guide</i>.</p>
     */
     ...
     * <b>Length: </b>0 - 10240<br/>
     *
     * @param policyText <p>The JSON repository policy text to apply to the repository. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/RepositoryPolicyExamples.html">Amazon ECR Repository Policy Examples</a> in the <i>Amazon Elastic Container Registry User Guide</i>.</p>
     */
