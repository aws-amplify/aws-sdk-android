...
/**
 * JSON unmarshaller for response BatchDeleteImageResult
 */
public class BatchDeleteImageResultJsonUnmarshaller implements
        Unmarshaller<BatchDeleteImageResult, JsonUnmarshallerContext> {
    ...
    public BatchDeleteImageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("imageIds")) {
                batchDeleteImageResult.setImageIds(new ListUnmarshaller<ImageIdentifier>(
                        ImageIdentifierJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("failures")) {
                batchDeleteImageResult.setFailures(new ListUnmarshaller<ImageFailure>(
