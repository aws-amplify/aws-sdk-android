...
/**
 * JSON request marshaller for SetRepositoryPolicyRequest
 */
public class SetRepositoryPolicyRequestMarshaller implements
    ...
    public Request<SetRepositoryPolicyRequest> marshall(
        ...
        if (setRepositoryPolicyRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(SetRepositoryPolicyRequest)");
        }

        Request<SetRepositoryPolicyRequest> request = new DefaultRequest<SetRepositoryPolicyRequest>(
                setRepositoryPolicyRequest, "AmazonEC2ContainerRegistry");
