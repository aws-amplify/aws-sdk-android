...
public class CreateRepositoryRequestMarshaller implements
    ...
    public Request<CreateRepositoryRequest> marshall(CreateRepositoryRequest createRepositoryRequest) {
        ...
        Request<CreateRepositoryRequest> request = new DefaultRequest<CreateRepositoryRequest>(
                createRepositoryRequest, "AmazonEC2ContainerRegistry");
        ...
        try {
            ...
            if (createRepositoryRequest.getRepositoryName() != null) {
                String repositoryName = createRepositoryRequest.getRepositoryName();
                jsonWriter.name("repositoryName");
                jsonWriter.value(repositoryName);
            }
            if (createRepositoryRequest.getTags() != null) {
                java.util.List<Tag> tags = createRepositoryRequest.getTags();
            ...
            if (createRepositoryRequest.getImageTagMutability() != null) {
                String imageTagMutability = createRepositoryRequest.getImageTagMutability();
                jsonWriter.name("imageTagMutability");
                jsonWriter.value(imageTagMutability);
            }
            if (createRepositoryRequest.getImageScanningConfiguration() != null) {
                ImageScanningConfiguration imageScanningConfiguration = createRepositoryRequest
