...
/**
 * StAX unmarshaller for model LBCookieStickinessPolicy
 */
class LBCookieStickinessPolicyStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PolicyName", targetDepth)) {
                    lBCookieStickinessPolicy.setPolicyName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("CookieExpirationPeriod", targetDepth)) {
                    lBCookieStickinessPolicy.setCookieExpirationPeriod(LongStaxUnmarshaller
