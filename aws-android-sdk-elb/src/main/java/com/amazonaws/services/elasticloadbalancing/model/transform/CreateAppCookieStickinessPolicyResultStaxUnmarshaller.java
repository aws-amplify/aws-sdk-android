...
/**
 * StAX unmarshaller for response CreateAppCookieStickinessPolicyResult
 */
public class CreateAppCookieStickinessPolicyResultStaxUnmarshaller implements
        Unmarshaller<CreateAppCookieStickinessPolicyResult, StaxUnmarshallerContext> {

    public CreateAppCookieStickinessPolicyResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
