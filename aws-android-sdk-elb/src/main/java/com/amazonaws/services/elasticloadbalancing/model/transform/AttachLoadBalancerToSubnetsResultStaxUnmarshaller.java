...
/**
 * StAX unmarshaller for response AttachLoadBalancerToSubnetsResult
 */
public class AttachLoadBalancerToSubnetsResultStaxUnmarshaller implements
        Unmarshaller<AttachLoadBalancerToSubnetsResult, StaxUnmarshallerContext> {

    public AttachLoadBalancerToSubnetsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Subnets/member", targetDepth)) {
                    attachLoadBalancerToSubnetsResult.withSubnets(StringStaxUnmarshaller
