...
/**
 * StAX unmarshaller for response DeregisterInstancesFromLoadBalancerResult
 */
public class DeregisterInstancesFromLoadBalancerResultStaxUnmarshaller implements
    ...
    public DeregisterInstancesFromLoadBalancerResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
