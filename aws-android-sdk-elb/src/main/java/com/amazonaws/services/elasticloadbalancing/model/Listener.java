...
public class Listener implements Serializable {
     ...
     *         </p>
     *         <p>
     *         If the front-end protocol is TCP or SSL, the back-end protocol
     *         must be TCP or SSL. If the front-end protocol is HTTP or HTTPS,
     *         the back-end protocol must be HTTP or HTTPS.
     *         </p>
     *         <p>
     ...
     *            <p>
     *            If the front-end protocol is TCP or SSL, the back-end protocol
     *            must be TCP or SSL. If the front-end protocol is HTTP or
