...
/**
 * StAX unmarshaller for model Listener
 */
class ListenerStaxUnmarshaller implements Unmarshaller<Listener, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("LoadBalancerPort", targetDepth)) {
                    listener.setLoadBalancerPort(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("InstanceProtocol", targetDepth)) {
                    listener.setInstanceProtocol(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("InstancePort", targetDepth)) {
                    listener.setInstancePort(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("SSLCertificateId", targetDepth)) {
                    listener.setSSLCertificateId(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
