...
/**
 * Remove Tags Result StAX Unmarshaller
 */
public class RemoveTagsResultStaxUnmarshaller implements Unmarshaller<RemoveTagsResult, StaxUnmarshallerContext> {
    ...
    public RemoveTagsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return removeTagsResult;
    ...
    public static RemoveTagsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new RemoveTagsResultStaxUnmarshaller();
        return instance;
    }
}
