...
/**
 * StAX unmarshaller for response RegisterInstancesWithLoadBalancerResult
 */
public class RegisterInstancesWithLoadBalancerResultStaxUnmarshaller implements
        Unmarshaller<RegisterInstancesWithLoadBalancerResult, StaxUnmarshallerContext> {

    public RegisterInstancesWithLoadBalancerResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Instances/member", targetDepth)) {
                    registerInstancesWithLoadBalancerResult.withInstances(InstanceStaxUnmarshaller
