...
/**
 * StAX unmarshaller for response DetachLoadBalancerFromSubnetsResult
 */
public class DetachLoadBalancerFromSubnetsResultStaxUnmarshaller implements
        Unmarshaller<DetachLoadBalancerFromSubnetsResult, StaxUnmarshallerContext> {

    public DetachLoadBalancerFromSubnetsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
