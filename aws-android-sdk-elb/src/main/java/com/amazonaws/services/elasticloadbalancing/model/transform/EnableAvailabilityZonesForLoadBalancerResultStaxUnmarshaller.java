...
/**
 * StAX unmarshaller for response EnableAvailabilityZonesForLoadBalancerResult
 */
public class EnableAvailabilityZonesForLoadBalancerResultStaxUnmarshaller implements
    ...
    public EnableAvailabilityZonesForLoadBalancerResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
