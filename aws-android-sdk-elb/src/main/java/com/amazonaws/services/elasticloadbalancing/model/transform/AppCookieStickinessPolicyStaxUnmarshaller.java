...
/**
 * StAX unmarshaller for model AppCookieStickinessPolicy
 */
class AppCookieStickinessPolicyStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PolicyName", targetDepth)) {
                    appCookieStickinessPolicy.setPolicyName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("CookieName", targetDepth)) {
                    appCookieStickinessPolicy.setCookieName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
