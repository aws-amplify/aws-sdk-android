...
/**
 * StAX unmarshaller for response DescribeLoadBalancerPolicyTypesResult
 */
public class DescribeLoadBalancerPolicyTypesResultStaxUnmarshaller implements
        Unmarshaller<DescribeLoadBalancerPolicyTypesResult, StaxUnmarshallerContext> {

    public DescribeLoadBalancerPolicyTypesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
