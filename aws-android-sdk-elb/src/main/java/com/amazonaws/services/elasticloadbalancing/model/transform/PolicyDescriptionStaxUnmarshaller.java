...
/**
 * StAX unmarshaller for model PolicyDescription
 */
class PolicyDescriptionStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PolicyName", targetDepth)) {
                    policyDescription.setPolicyName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("PolicyTypeName", targetDepth)) {
                    policyDescription.setPolicyTypeName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
