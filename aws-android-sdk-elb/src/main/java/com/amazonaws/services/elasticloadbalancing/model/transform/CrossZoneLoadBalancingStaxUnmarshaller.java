...
/**
 * StAX unmarshaller for model CrossZoneLoadBalancing
 */
class CrossZoneLoadBalancingStaxUnmarshaller implements
        Unmarshaller<CrossZoneLoadBalancing, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Enabled", targetDepth)) {
                    crossZoneLoadBalancing.setEnabled(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
