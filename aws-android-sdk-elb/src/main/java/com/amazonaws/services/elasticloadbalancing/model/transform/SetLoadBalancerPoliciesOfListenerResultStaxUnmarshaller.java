...
/**
 * StAX unmarshaller for response SetLoadBalancerPoliciesOfListenerResult
 */
public class SetLoadBalancerPoliciesOfListenerResultStaxUnmarshaller implements
        Unmarshaller<SetLoadBalancerPoliciesOfListenerResult, StaxUnmarshallerContext> {

    public SetLoadBalancerPoliciesOfListenerResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
