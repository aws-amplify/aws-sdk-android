...
/**
 * StAX unmarshaller for response DeleteLoadBalancerPolicyResult
 */
public class DeleteLoadBalancerPolicyResultStaxUnmarshaller implements
        Unmarshaller<DeleteLoadBalancerPolicyResult, StaxUnmarshallerContext> {

    public DeleteLoadBalancerPolicyResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
