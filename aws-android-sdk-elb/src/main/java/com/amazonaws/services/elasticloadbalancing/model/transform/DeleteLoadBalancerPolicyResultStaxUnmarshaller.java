...
public class DeleteLoadBalancerPolicyResultStaxUnmarshaller implements Unmarshaller<DeleteLoadBalancerPolicyResult, StaxUnmarshallerContext> {
    ...
    public DeleteLoadBalancerPolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return deleteLoadBalancerPolicyResult;
    ...
    public static DeleteLoadBalancerPolicyResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DeleteLoadBalancerPolicyResultStaxUnmarshaller();
        return instance;
    }
}
