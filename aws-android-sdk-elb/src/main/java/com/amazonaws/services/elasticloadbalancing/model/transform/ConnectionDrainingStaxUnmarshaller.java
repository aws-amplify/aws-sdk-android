...
/**
 * StAX unmarshaller for model ConnectionDraining
 */
class ConnectionDrainingStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Enabled", targetDepth)) {
                    connectionDraining.setEnabled(BooleanStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Timeout", targetDepth)) {
                    connectionDraining.setTimeout(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
