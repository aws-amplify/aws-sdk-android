...
/**
 * StAX unmarshaller for model PolicyAttribute
 */
class PolicyAttributeStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("AttributeName", targetDepth)) {
                    policyAttribute.setAttributeName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("AttributeValue", targetDepth)) {
                    policyAttribute.setAttributeValue(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
