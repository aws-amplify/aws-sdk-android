...
/**
 * StAX unmarshaller for response ModifyLoadBalancerAttributesResult
 */
public class ModifyLoadBalancerAttributesResultStaxUnmarshaller implements
        Unmarshaller<ModifyLoadBalancerAttributesResult, StaxUnmarshallerContext> {

    public ModifyLoadBalancerAttributesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("LoadBalancerName", targetDepth)) {
                    modifyLoadBalancerAttributesResult.setLoadBalancerName(StringStaxUnmarshaller
