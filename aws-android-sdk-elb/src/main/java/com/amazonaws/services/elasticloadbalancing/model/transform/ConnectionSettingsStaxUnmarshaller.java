...
/**
 * StAX unmarshaller for model ConnectionSettings
 */
class ConnectionSettingsStaxUnmarshaller implements
        Unmarshaller<ConnectionSettings, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("IdleTimeout", targetDepth)) {
                    connectionSettings.setIdleTimeout(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
