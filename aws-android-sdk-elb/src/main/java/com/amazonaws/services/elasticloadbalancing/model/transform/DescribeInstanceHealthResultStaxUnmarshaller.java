...
/**
 * StAX unmarshaller for response DescribeInstanceHealthResult
 */
public class DescribeInstanceHealthResultStaxUnmarshaller implements
    ...
    public DescribeInstanceHealthResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("InstanceStates/member", targetDepth)) {
                    describeInstanceHealthResult.withInstanceStates(InstanceStateStaxUnmarshaller
