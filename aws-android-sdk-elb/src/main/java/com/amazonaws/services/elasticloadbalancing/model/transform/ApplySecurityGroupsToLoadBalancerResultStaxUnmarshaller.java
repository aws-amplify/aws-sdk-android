...
/**
 * StAX unmarshaller for response ApplySecurityGroupsToLoadBalancerResult
 */
public class ApplySecurityGroupsToLoadBalancerResultStaxUnmarshaller implements
        Unmarshaller<ApplySecurityGroupsToLoadBalancerResult, StaxUnmarshallerContext> {

    public ApplySecurityGroupsToLoadBalancerResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
