...
/**
 * StAX unmarshaller for model PolicyTypeDescription
 */
class PolicyTypeDescriptionStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PolicyTypeName", targetDepth)) {
                    policyTypeDescription.setPolicyTypeName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Description", targetDepth)) {
                    policyTypeDescription.setDescription(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("PolicyAttributeTypeDescriptions/member", targetDepth)) {
                    policyTypeDescription.getPolicyAttributeTypeDescriptions().add(
                            PolicyAttributeTypeDescriptionStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
