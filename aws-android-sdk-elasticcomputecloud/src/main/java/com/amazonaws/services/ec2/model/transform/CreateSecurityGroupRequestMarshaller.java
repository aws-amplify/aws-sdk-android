...
/**
 * JSON request marshaller for CreateSecurityGroupRequest
 */
    ...
    public Request<CreateSecurityGroupRequest> marshall(
        ...
        if (createSecurityGroupRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateSecurityGroupRequest)");
        }

        Request<CreateSecurityGroupRequest> request = new DefaultRequest<CreateSecurityGroupRequest>(
                createSecurityGroupRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (createSecurityGroupRequest.getDryRun() != null) {
                Boolean dryRun = createSecurityGroupRequest.getDryRun();
