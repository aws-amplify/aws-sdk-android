...
/**
 * JSON request marshaller for DescribeExportTasksRequest
 */
public class DescribeExportTasksRequestMarshaller implements
    ...
    public Request<DescribeExportTasksRequest> marshall(
        ...
        Request<DescribeExportTasksRequest> request = new DefaultRequest<DescribeExportTasksRequest>(
                describeExportTasksRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeExportTasksRequest.getExportTaskIds() != null) {
                java.util.List<String> exportTaskIds = describeExportTasksRequest
                        .getExportTaskIds();
                jsonWriter.name("ExportTaskIds");
                jsonWriter.beginArray();
                for (String exportTaskIdsItem : exportTaskIds) {
                    if (exportTaskIdsItem != null) {
                        jsonWriter.value(exportTaskIdsItem);
                    }
                }
                jsonWriter.endArray();
            }
