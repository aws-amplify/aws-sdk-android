 ...
 * memory, or I/O. If the request type is <code>maintain</code>, you can specify
 * a target capacity of 0 and add capacity later.
 * </p>
 * <p>
 ...
 * request, EC2 Fleet will launch instances until it reaches the maximum amount
 * that you're willing to pay. When the maximum amount you're willing to pay is
 * reached, the fleet stops launching instances even if it hasn’t met the target
 * capacity. The <code>MaxTotalPrice</code> parameters are located in <a href=
 * "https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_OnDemandOptionsRequest"
 * >OnDemandOptionsRequest</a> and <a href=
 * "https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_SpotOptionsRequest"
 * >SpotOptionsRequest</a>.
 * </p>
 */
public class TargetCapacitySpecificationRequest implements Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public TargetCapacitySpecificationRequest withOnDemandTargetCapacity(
     ...
     * @see DefaultTargetCapacityType
     */
    public TargetCapacitySpecificationRequest withDefaultTargetCapacityType(
