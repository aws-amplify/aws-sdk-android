...
/**
 * JSON request marshaller for AssociateTransitGatewayMulticastDomainRequest
 */
public class AssociateTransitGatewayMulticastDomainRequestMarshaller
        implements
    ...
    public Request<AssociateTransitGatewayMulticastDomainRequest> marshall(
        ...
        if (associateTransitGatewayMulticastDomainRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AssociateTransitGatewayMulticastDomainRequest)");
        }
        ...
        Request<AssociateTransitGatewayMulticastDomainRequest> request = new DefaultRequest<AssociateTransitGatewayMulticastDomainRequest>(
                associateTransitGatewayMulticastDomainRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (associateTransitGatewayMulticastDomainRequest.getTransitGatewayMulticastDomainId() != null) {
                String transitGatewayMulticastDomainId = associateTransitGatewayMulticastDomainRequest
            ...
            if (associateTransitGatewayMulticastDomainRequest.getTransitGatewayAttachmentId() != null) {
                String transitGatewayAttachmentId = associateTransitGatewayMulticastDomainRequest
                        .getTransitGatewayAttachmentId();
                jsonWriter.name("TransitGatewayAttachmentId");
                jsonWriter.value(transitGatewayAttachmentId);
            }
            if (associateTransitGatewayMulticastDomainRequest.getSubnetIds() != null) {
                java.util.List<String> subnetIds = associateTransitGatewayMulticastDomainRequest
                        .getSubnetIds();
            ...
            if (associateTransitGatewayMulticastDomainRequest.getDryRun() != null) {
                Boolean dryRun = associateTransitGatewayMulticastDomainRequest.getDryRun();
