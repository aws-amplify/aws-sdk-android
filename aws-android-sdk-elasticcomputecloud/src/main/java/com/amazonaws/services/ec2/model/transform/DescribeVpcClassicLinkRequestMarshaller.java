...
/**
 * JSON request marshaller for DescribeVpcClassicLinkRequest
 */
    ...
    public Request<DescribeVpcClassicLinkRequest> marshall(
        ...
        if (describeVpcClassicLinkRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeVpcClassicLinkRequest)");
        }

        Request<DescribeVpcClassicLinkRequest> request = new DefaultRequest<DescribeVpcClassicLinkRequest>(
                describeVpcClassicLinkRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeVpcClassicLinkRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeVpcClassicLinkRequest.getFilters();
            ...
            if (describeVpcClassicLinkRequest.getDryRun() != null) {
                Boolean dryRun = describeVpcClassicLinkRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeVpcClassicLinkRequest.getVpcIds() != null) {
                java.util.List<String> vpcIds = describeVpcClassicLinkRequest.getVpcIds();
