...
/**
 * JSON request marshaller for DeleteNetworkAclRequest
 */
    ...
    public Request<DeleteNetworkAclRequest> marshall(DeleteNetworkAclRequest deleteNetworkAclRequest) {
        if (deleteNetworkAclRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteNetworkAclRequest)");
        }

        Request<DeleteNetworkAclRequest> request = new DefaultRequest<DeleteNetworkAclRequest>(
                deleteNetworkAclRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (deleteNetworkAclRequest.getDryRun() != null) {
                Boolean dryRun = deleteNetworkAclRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (deleteNetworkAclRequest.getNetworkAclId() != null) {
                String networkAclId = deleteNetworkAclRequest.getNetworkAclId();
