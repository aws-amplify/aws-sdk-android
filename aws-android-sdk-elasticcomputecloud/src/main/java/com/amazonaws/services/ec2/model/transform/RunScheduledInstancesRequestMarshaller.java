...
/**
 * JSON request marshaller for RunScheduledInstancesRequest
 */
    ...
    public Request<RunScheduledInstancesRequest> marshall(
        ...
        if (runScheduledInstancesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RunScheduledInstancesRequest)");
        }

        Request<RunScheduledInstancesRequest> request = new DefaultRequest<RunScheduledInstancesRequest>(
                runScheduledInstancesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (runScheduledInstancesRequest.getDryRun() != null) {
                Boolean dryRun = runScheduledInstancesRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (runScheduledInstancesRequest.getInstanceCount() != null) {
                Integer instanceCount = runScheduledInstancesRequest.getInstanceCount();
                jsonWriter.name("InstanceCount");
                jsonWriter.value(instanceCount);
            }
            if (runScheduledInstancesRequest.getLaunchSpecification() != null) {
                ...
                ScheduledInstancesLaunchSpecificationJsonMarshaller.getInstance().marshall(
