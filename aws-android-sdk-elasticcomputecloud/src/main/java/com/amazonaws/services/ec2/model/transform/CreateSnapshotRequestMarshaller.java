...
/**
 * JSON request marshaller for CreateSnapshotRequest
 */
public class CreateSnapshotRequestMarshaller implements
    ...
    public Request<CreateSnapshotRequest> marshall(CreateSnapshotRequest createSnapshotRequest) {
        ...
        Request<CreateSnapshotRequest> request = new DefaultRequest<CreateSnapshotRequest>(
                createSnapshotRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (createSnapshotRequest.getDescription() != null) {
                String description = createSnapshotRequest.getDescription();
                jsonWriter.name("Description");
                jsonWriter.value(description);
            }
            if (createSnapshotRequest.getVolumeId() != null) {
                String volumeId = createSnapshotRequest.getVolumeId();
                jsonWriter.name("VolumeId");
                jsonWriter.value(volumeId);
            }
            if (createSnapshotRequest.getTagSpecifications() != null) {
                java.util.List<TagSpecification> tagSpecifications = createSnapshotRequest
            ...
            if (createSnapshotRequest.getDryRun() != null) {
                Boolean dryRun = createSnapshotRequest.getDryRun();
