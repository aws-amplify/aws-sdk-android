...
public class ClientVpnAuthenticationRequest implements Serializable {
     ...
     *         The type of client authentication to be used. Specify
     *         <code>certificate-authentication</code> to use certificate-based
     *         authentication, or <code>directory-service-authentication</code>
     ...
     * @param type <p>
     *            The type of client authentication to be used. Specify
     *            <code>certificate-authentication</code> to use
     *            certificate-based authentication, or
     *            <code>directory-service-authentication</code> to use Active
