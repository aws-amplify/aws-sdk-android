...
/**
 * JSON request marshaller for DescribeImportImageTasksRequest
 */
    ...
    public Request<DescribeImportImageTasksRequest> marshall(
        ...
        if (describeImportImageTasksRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeImportImageTasksRequest)");
        }

        Request<DescribeImportImageTasksRequest> request = new DefaultRequest<DescribeImportImageTasksRequest>(
                describeImportImageTasksRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeImportImageTasksRequest.getDryRun() != null) {
                Boolean dryRun = describeImportImageTasksRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeImportImageTasksRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeImportImageTasksRequest.getFilters();
            ...
            if (describeImportImageTasksRequest.getImportTaskIds() != null) {
                java.util.List<String> importTaskIds = describeImportImageTasksRequest
                        .getImportTaskIds();
            ...
            if (describeImportImageTasksRequest.getMaxResults() != null) {
                Integer maxResults = describeImportImageTasksRequest.getMaxResults();
                jsonWriter.name("MaxResults");
                jsonWriter.value(maxResults);
            }
            if (describeImportImageTasksRequest.getNextToken() != null) {
                String nextToken = describeImportImageTasksRequest.getNextToken();
