...
public class DescribeCustomerGatewaysResult implements Serializable {
    ...
    public void setCustomerGateways(java.util.Collection<CustomerGateway> customerGateways) {
        ...
        this.customerGateways = new java.util.ArrayList<CustomerGateway>(customerGateways);
    }
    ...
    public DescribeCustomerGatewaysResult withCustomerGateways(CustomerGateway... customerGateways) {
        if (getCustomerGateways() == null) {
            this.customerGateways = new java.util.ArrayList<CustomerGateway>(
                    customerGateways.length);
        }
        for (CustomerGateway value : customerGateways) {
            this.customerGateways.add(value);
        }
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getCustomerGateways() == null) ? 0 : getCustomerGateways().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCustomerGateways() != null
                && other.getCustomerGateways().equals(this.getCustomerGateways()) == false)
            return false;
        return true;
    }
}
