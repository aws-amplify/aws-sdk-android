...
/**
 * JSON request marshaller for DisassociateAddressRequest
 */
    ...
    public Request<DisassociateAddressRequest> marshall(
        ...
        if (disassociateAddressRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DisassociateAddressRequest)");
        }

        Request<DisassociateAddressRequest> request = new DefaultRequest<DisassociateAddressRequest>(
                disassociateAddressRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (disassociateAddressRequest.getAssociationId() != null) {
                String associationId = disassociateAddressRequest.getAssociationId();
                jsonWriter.name("AssociationId");
                jsonWriter.value(associationId);
            }
            if (disassociateAddressRequest.getPublicIp() != null) {
                String publicIp = disassociateAddressRequest.getPublicIp();
                jsonWriter.name("PublicIp");
                jsonWriter.value(publicIp);
            }
            if (disassociateAddressRequest.getDryRun() != null) {
                Boolean dryRun = disassociateAddressRequest.getDryRun();
