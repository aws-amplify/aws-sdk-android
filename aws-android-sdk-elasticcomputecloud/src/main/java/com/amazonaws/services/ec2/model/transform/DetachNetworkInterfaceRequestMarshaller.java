...
/**
 * JSON request marshaller for DetachNetworkInterfaceRequest
 */
    ...
    public Request<DetachNetworkInterfaceRequest> marshall(
        ...
        if (detachNetworkInterfaceRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DetachNetworkInterfaceRequest)");
        }

        Request<DetachNetworkInterfaceRequest> request = new DefaultRequest<DetachNetworkInterfaceRequest>(
                detachNetworkInterfaceRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (detachNetworkInterfaceRequest.getAttachmentId() != null) {
                String attachmentId = detachNetworkInterfaceRequest.getAttachmentId();
                jsonWriter.name("AttachmentId");
                jsonWriter.value(attachmentId);
            }
            if (detachNetworkInterfaceRequest.getDryRun() != null) {
                Boolean dryRun = detachNetworkInterfaceRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (detachNetworkInterfaceRequest.getForce() != null) {
                Boolean force = detachNetworkInterfaceRequest.getForce();
