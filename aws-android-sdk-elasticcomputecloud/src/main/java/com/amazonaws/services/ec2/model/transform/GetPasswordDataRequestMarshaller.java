...
/**
 * JSON request marshaller for GetPasswordDataRequest
 */
    ...
    public Request<GetPasswordDataRequest> marshall(GetPasswordDataRequest getPasswordDataRequest) {
        if (getPasswordDataRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetPasswordDataRequest)");
        }

        Request<GetPasswordDataRequest> request = new DefaultRequest<GetPasswordDataRequest>(
                getPasswordDataRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (getPasswordDataRequest.getInstanceId() != null) {
                String instanceId = getPasswordDataRequest.getInstanceId();
                jsonWriter.name("InstanceId");
                jsonWriter.value(instanceId);
            }
            if (getPasswordDataRequest.getDryRun() != null) {
                Boolean dryRun = getPasswordDataRequest.getDryRun();
