...
/**
 * JSON request marshaller for CancelReservedInstancesListingRequest
 */
    ...
    public Request<CancelReservedInstancesListingRequest> marshall(
        ...
        if (cancelReservedInstancesListingRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CancelReservedInstancesListingRequest)");
        }

        Request<CancelReservedInstancesListingRequest> request = new DefaultRequest<CancelReservedInstancesListingRequest>(
                cancelReservedInstancesListingRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (cancelReservedInstancesListingRequest.getReservedInstancesListingId() != null) {
                String reservedInstancesListingId = cancelReservedInstancesListingRequest
