...
/**
 * Network Interface Creation Type
 */
public enum NetworkInterfaceCreationType {
    ...
    private static final Map<String, NetworkInterfaceCreationType> enumMap;
    static {
        enumMap = new HashMap<String, NetworkInterfaceCreationType>();
        enumMap.put("efa", Efa);
    }
