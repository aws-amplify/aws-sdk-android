...
/**
 * JSON request marshaller for DescribeClassicLinkInstancesRequest
 */
    ...
    public Request<DescribeClassicLinkInstancesRequest> marshall(
        ...
        if (describeClassicLinkInstancesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeClassicLinkInstancesRequest)");
        }

        Request<DescribeClassicLinkInstancesRequest> request = new DefaultRequest<DescribeClassicLinkInstancesRequest>(
                describeClassicLinkInstancesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeClassicLinkInstancesRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeClassicLinkInstancesRequest.getFilters();
            ...
            if (describeClassicLinkInstancesRequest.getDryRun() != null) {
                Boolean dryRun = describeClassicLinkInstancesRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeClassicLinkInstancesRequest.getInstanceIds() != null) {
                java.util.List<String> instanceIds = describeClassicLinkInstancesRequest
                        .getInstanceIds();
            ...
            if (describeClassicLinkInstancesRequest.getMaxResults() != null) {
                Integer maxResults = describeClassicLinkInstancesRequest.getMaxResults();
                jsonWriter.name("MaxResults");
                jsonWriter.value(maxResults);
            }
            if (describeClassicLinkInstancesRequest.getNextToken() != null) {
                String nextToken = describeClassicLinkInstancesRequest.getNextToken();
