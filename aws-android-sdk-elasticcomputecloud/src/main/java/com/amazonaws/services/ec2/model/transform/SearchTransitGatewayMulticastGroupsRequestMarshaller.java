...
/**
 * JSON request marshaller for SearchTransitGatewayMulticastGroupsRequest
 */
public class SearchTransitGatewayMulticastGroupsRequestMarshaller
    ...
    public Request<SearchTransitGatewayMulticastGroupsRequest> marshall(
        ...
        if (searchTransitGatewayMulticastGroupsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(SearchTransitGatewayMulticastGroupsRequest)");
        }

        Request<SearchTransitGatewayMulticastGroupsRequest> request = new DefaultRequest<SearchTransitGatewayMulticastGroupsRequest>(
                searchTransitGatewayMulticastGroupsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (searchTransitGatewayMulticastGroupsRequest.getTransitGatewayMulticastDomainId() != null) {
                String transitGatewayMulticastDomainId = searchTransitGatewayMulticastGroupsRequest
            ...
            if (searchTransitGatewayMulticastGroupsRequest.getFilters() != null) {
                java.util.List<Filter> filters = searchTransitGatewayMulticastGroupsRequest
                        .getFilters();
            ...
            if (searchTransitGatewayMulticastGroupsRequest.getMaxResults() != null) {
                Integer maxResults = searchTransitGatewayMulticastGroupsRequest.getMaxResults();
                jsonWriter.name("MaxResults");
                jsonWriter.value(maxResults);
            }
            if (searchTransitGatewayMulticastGroupsRequest.getNextToken() != null) {
                String nextToken = searchTransitGatewayMulticastGroupsRequest.getNextToken();
                jsonWriter.name("NextToken");
                jsonWriter.value(nextToken);
            }
            if (searchTransitGatewayMulticastGroupsRequest.getDryRun() != null) {
                Boolean dryRun = searchTransitGatewayMulticastGroupsRequest.getDryRun();
