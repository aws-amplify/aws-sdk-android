...
/**
 * JSON request marshaller for CreateSubnetRequest
 */
    ...
    public Request<CreateSubnetRequest> marshall(CreateSubnetRequest createSubnetRequest) {
        if (createSubnetRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateSubnetRequest)");
        }

        Request<CreateSubnetRequest> request = new DefaultRequest<CreateSubnetRequest>(
                createSubnetRequest, "AmazonElasticComputeCloud");
