...
/**
 * JSON unmarshaller for POJO Monitoring
 */
class MonitoringJsonUnmarshaller implements Unmarshaller<Monitoring, JsonUnmarshallerContext> {
    ...
    public Monitoring unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("State")) {
                monitoring.setState(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
