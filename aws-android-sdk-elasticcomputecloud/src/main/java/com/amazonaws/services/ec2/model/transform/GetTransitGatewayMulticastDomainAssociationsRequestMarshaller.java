 ...
 */
public class GetTransitGatewayMulticastDomainAssociationsRequestMarshaller
        implements
    ...
    public Request<GetTransitGatewayMulticastDomainAssociationsRequest> marshall(
        ...
        if (getTransitGatewayMulticastDomainAssociationsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetTransitGatewayMulticastDomainAssociationsRequest)");
        }
        ...
        Request<GetTransitGatewayMulticastDomainAssociationsRequest> request = new DefaultRequest<GetTransitGatewayMulticastDomainAssociationsRequest>(
                getTransitGatewayMulticastDomainAssociationsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (getTransitGatewayMulticastDomainAssociationsRequest
                    .getTransitGatewayMulticastDomainId() != null) {
                String transitGatewayMulticastDomainId = getTransitGatewayMulticastDomainAssociationsRequest
            ...
            if (getTransitGatewayMulticastDomainAssociationsRequest.getFilters() != null) {
                java.util.List<Filter> filters = getTransitGatewayMulticastDomainAssociationsRequest
                        .getFilters();
            ...
            if (getTransitGatewayMulticastDomainAssociationsRequest.getMaxResults() != null) {
                Integer maxResults = getTransitGatewayMulticastDomainAssociationsRequest
                        .getMaxResults();
                jsonWriter.name("MaxResults");
                jsonWriter.value(maxResults);
            }
            if (getTransitGatewayMulticastDomainAssociationsRequest.getNextToken() != null) {
                String nextToken = getTransitGatewayMulticastDomainAssociationsRequest
                        .getNextToken();
                jsonWriter.name("NextToken");
                jsonWriter.value(nextToken);
            }
            if (getTransitGatewayMulticastDomainAssociationsRequest.getDryRun() != null) {
                Boolean dryRun = getTransitGatewayMulticastDomainAssociationsRequest.getDryRun();
