...
public class AcceptVpcPeeringConnectionResult implements Serializable {
     ...
     *         chained together.
     */
    public AcceptVpcPeeringConnectionResult withVpcPeeringConnection(
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getVpcPeeringConnection() == null) ? 0 : getVpcPeeringConnection().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getVpcPeeringConnection() == null ^ this.getVpcPeeringConnection() == null)
            return false;
        if (other.getVpcPeeringConnection() != null
                && other.getVpcPeeringConnection().equals(this.getVpcPeeringConnection()) == false)
            return false;
        return true;
    }
}
