...
/**
 * JSON unmarshaller for POJO LaunchTemplateSpecification
 */
class LaunchTemplateSpecificationJsonUnmarshaller implements
        Unmarshaller<LaunchTemplateSpecification, JsonUnmarshallerContext> {
    ...
    public LaunchTemplateSpecification unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("LaunchTemplateId")) {
                launchTemplateSpecification.setLaunchTemplateId(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("LaunchTemplateName")) {
                launchTemplateSpecification.setLaunchTemplateName(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Version")) {
                launchTemplateSpecification.setVersion(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
