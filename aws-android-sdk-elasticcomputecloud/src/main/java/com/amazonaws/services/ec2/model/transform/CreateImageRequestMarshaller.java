...
public class CreateImageRequestMarshaller implements
    ...
    public Request<CreateImageRequest> marshall(CreateImageRequest createImageRequest) {
        ...
        Request<CreateImageRequest> request = new DefaultRequest<CreateImageRequest>(
                createImageRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (createImageRequest.getBlockDeviceMappings() != null) {
                java.util.List<BlockDeviceMapping> blockDeviceMappings = createImageRequest
            ...
            if (createImageRequest.getDescription() != null) {
                String description = createImageRequest.getDescription();
                jsonWriter.name("Description");
                jsonWriter.value(description);
            }
            if (createImageRequest.getDryRun() != null) {
                Boolean dryRun = createImageRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (createImageRequest.getInstanceId() != null) {
                String instanceId = createImageRequest.getInstanceId();
                jsonWriter.name("InstanceId");
                jsonWriter.value(instanceId);
            }
            if (createImageRequest.getName() != null) {
                String name = createImageRequest.getName();
                jsonWriter.name("Name");
                jsonWriter.value(name);
            }
            if (createImageRequest.getNoReboot() != null) {
                Boolean noReboot = createImageRequest.getNoReboot();
                jsonWriter.name("NoReboot");
                jsonWriter.value(noReboot);
            }
