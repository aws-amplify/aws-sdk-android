...
/**
 * JSON request marshaller for DescribeTagsRequest
 */
public class DescribeTagsRequestMarshaller implements
    ...
    public Request<DescribeTagsRequest> marshall(DescribeTagsRequest describeTagsRequest) {
        ...
        Request<DescribeTagsRequest> request = new DefaultRequest<DescribeTagsRequest>(
                describeTagsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeTagsRequest.getDryRun() != null) {
                Boolean dryRun = describeTagsRequest.getDryRun();
            ...
            if (describeTagsRequest.getMaxResults() != null) {
                Integer maxResults = describeTagsRequest.getMaxResults();
