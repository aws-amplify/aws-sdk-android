...
/**
 * JSON request marshaller for CreateVpcEndpointServiceConfigurationRequest
 */
    ...
    public Request<CreateVpcEndpointServiceConfigurationRequest> marshall(
        ...
        if (createVpcEndpointServiceConfigurationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateVpcEndpointServiceConfigurationRequest)");
        }
        ...
        Request<CreateVpcEndpointServiceConfigurationRequest> request = new DefaultRequest<CreateVpcEndpointServiceConfigurationRequest>(
                createVpcEndpointServiceConfigurationRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (createVpcEndpointServiceConfigurationRequest.getDryRun() != null) {
                Boolean dryRun = createVpcEndpointServiceConfigurationRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (createVpcEndpointServiceConfigurationRequest.getAcceptanceRequired() != null) {
                Boolean acceptanceRequired = createVpcEndpointServiceConfigurationRequest
            ...
            if (createVpcEndpointServiceConfigurationRequest.getPrivateDnsName() != null) {
                String privateDnsName = createVpcEndpointServiceConfigurationRequest
                        .getPrivateDnsName();
                jsonWriter.name("PrivateDnsName");
                jsonWriter.value(privateDnsName);
            }
            if (createVpcEndpointServiceConfigurationRequest.getNetworkLoadBalancerArns() != null) {
                java.util.List<String> networkLoadBalancerArns = createVpcEndpointServiceConfigurationRequest
            ...
            if (createVpcEndpointServiceConfigurationRequest.getClientToken() != null) {
                String clientToken = createVpcEndpointServiceConfigurationRequest.getClientToken();
                jsonWriter.name("ClientToken");
                jsonWriter.value(clientToken);
            }
            if (createVpcEndpointServiceConfigurationRequest.getTagSpecifications() != null) {
                java.util.List<TagSpecification> tagSpecifications = createVpcEndpointServiceConfigurationRequest
