...
/**
 * JSON request marshaller for AcceptVpcPeeringConnectionRequest
 */
    ...
    public Request<AcceptVpcPeeringConnectionRequest> marshall(
        ...
        if (acceptVpcPeeringConnectionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AcceptVpcPeeringConnectionRequest)");
        }

        Request<AcceptVpcPeeringConnectionRequest> request = new DefaultRequest<AcceptVpcPeeringConnectionRequest>(
                acceptVpcPeeringConnectionRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (acceptVpcPeeringConnectionRequest.getDryRun() != null) {
                Boolean dryRun = acceptVpcPeeringConnectionRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (acceptVpcPeeringConnectionRequest.getVpcPeeringConnectionId() != null) {
                String vpcPeeringConnectionId = acceptVpcPeeringConnectionRequest
