...
/**
 * JSON request marshaller for DisassociateClientVpnTargetNetworkRequest
 */
public class DisassociateClientVpnTargetNetworkRequestMarshaller
        implements
        Marshaller<Request<DisassociateClientVpnTargetNetworkRequest>, DisassociateClientVpnTargetNetworkRequest> {

    public Request<DisassociateClientVpnTargetNetworkRequest> marshall(
        ...
        if (disassociateClientVpnTargetNetworkRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DisassociateClientVpnTargetNetworkRequest)");
        }

        Request<DisassociateClientVpnTargetNetworkRequest> request = new DefaultRequest<DisassociateClientVpnTargetNetworkRequest>(
                disassociateClientVpnTargetNetworkRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (disassociateClientVpnTargetNetworkRequest.getClientVpnEndpointId() != null) {
                String clientVpnEndpointId = disassociateClientVpnTargetNetworkRequest
            ...
            if (disassociateClientVpnTargetNetworkRequest.getAssociationId() != null) {
                String associationId = disassociateClientVpnTargetNetworkRequest.getAssociationId();
                jsonWriter.name("AssociationId");
                jsonWriter.value(associationId);
            }
            if (disassociateClientVpnTargetNetworkRequest.getDryRun() != null) {
                Boolean dryRun = disassociateClientVpnTargetNetworkRequest.getDryRun();
