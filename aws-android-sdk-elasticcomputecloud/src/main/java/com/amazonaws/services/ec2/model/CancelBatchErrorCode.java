...
public enum CancelBatchErrorCode {
    ...
    private static final Map<String, CancelBatchErrorCode> enumMap;
    static {
        enumMap = new HashMap<String, CancelBatchErrorCode>();
        enumMap.put("fleetRequestIdDoesNotExist", FleetRequestIdDoesNotExist);
        enumMap.put("fleetRequestIdMalformed", FleetRequestIdMalformed);
        enumMap.put("fleetRequestNotInCancellableState", FleetRequestNotInCancellableState);
