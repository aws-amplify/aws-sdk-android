...
/**
 * JSON request marshaller for DeleteVpcPeeringConnectionRequest
 */
    ...
    public Request<DeleteVpcPeeringConnectionRequest> marshall(
        ...
        if (deleteVpcPeeringConnectionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteVpcPeeringConnectionRequest)");
        }

        Request<DeleteVpcPeeringConnectionRequest> request = new DefaultRequest<DeleteVpcPeeringConnectionRequest>(
                deleteVpcPeeringConnectionRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (deleteVpcPeeringConnectionRequest.getDryRun() != null) {
                Boolean dryRun = deleteVpcPeeringConnectionRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (deleteVpcPeeringConnectionRequest.getVpcPeeringConnectionId() != null) {
                String vpcPeeringConnectionId = deleteVpcPeeringConnectionRequest
