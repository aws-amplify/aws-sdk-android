    ...
    public Request<RegisterTransitGatewayMulticastGroupSourcesRequest> marshall(
        ...
        if (registerTransitGatewayMulticastGroupSourcesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RegisterTransitGatewayMulticastGroupSourcesRequest)");
        }
        ...
        Request<RegisterTransitGatewayMulticastGroupSourcesRequest> request = new DefaultRequest<RegisterTransitGatewayMulticastGroupSourcesRequest>(
                registerTransitGatewayMulticastGroupSourcesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (registerTransitGatewayMulticastGroupSourcesRequest
                    .getTransitGatewayMulticastDomainId() != null) {
                String transitGatewayMulticastDomainId = registerTransitGatewayMulticastGroupSourcesRequest
            ...
            if (registerTransitGatewayMulticastGroupSourcesRequest.getGroupIpAddress() != null) {
                String groupIpAddress = registerTransitGatewayMulticastGroupSourcesRequest
                        .getGroupIpAddress();
                jsonWriter.name("GroupIpAddress");
                jsonWriter.value(groupIpAddress);
            }
            if (registerTransitGatewayMulticastGroupSourcesRequest.getNetworkInterfaceIds() != null) {
                java.util.List<String> networkInterfaceIds = registerTransitGatewayMulticastGroupSourcesRequest
            ...
            if (registerTransitGatewayMulticastGroupSourcesRequest.getDryRun() != null) {
                Boolean dryRun = registerTransitGatewayMulticastGroupSourcesRequest.getDryRun();
