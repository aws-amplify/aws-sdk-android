...
/**
 * JSON request marshaller for EnableVpcClassicLinkDnsSupportRequest
 */
    ...
    public Request<EnableVpcClassicLinkDnsSupportRequest> marshall(
        ...
        if (enableVpcClassicLinkDnsSupportRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(EnableVpcClassicLinkDnsSupportRequest)");
        }

        Request<EnableVpcClassicLinkDnsSupportRequest> request = new DefaultRequest<EnableVpcClassicLinkDnsSupportRequest>(
                enableVpcClassicLinkDnsSupportRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (enableVpcClassicLinkDnsSupportRequest.getVpcId() != null) {
                String vpcId = enableVpcClassicLinkDnsSupportRequest.getVpcId();
