...
/**
 * JSON request marshaller for DescribeVpcEndpointsRequest
 */
    ...
    public Request<DescribeVpcEndpointsRequest> marshall(
        ...
        if (describeVpcEndpointsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeVpcEndpointsRequest)");
        }

        Request<DescribeVpcEndpointsRequest> request = new DefaultRequest<DescribeVpcEndpointsRequest>(
                describeVpcEndpointsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeVpcEndpointsRequest.getDryRun() != null) {
                Boolean dryRun = describeVpcEndpointsRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeVpcEndpointsRequest.getVpcEndpointIds() != null) {
                java.util.List<String> vpcEndpointIds = describeVpcEndpointsRequest
                        .getVpcEndpointIds();
            ...
            if (describeVpcEndpointsRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeVpcEndpointsRequest.getFilters();
            ...
            if (describeVpcEndpointsRequest.getMaxResults() != null) {
                Integer maxResults = describeVpcEndpointsRequest.getMaxResults();
                jsonWriter.name("MaxResults");
                jsonWriter.value(maxResults);
            }
            if (describeVpcEndpointsRequest.getNextToken() != null) {
                String nextToken = describeVpcEndpointsRequest.getNextToken();
