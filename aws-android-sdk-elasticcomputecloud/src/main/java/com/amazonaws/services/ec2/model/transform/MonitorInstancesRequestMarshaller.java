...
/**
 * JSON request marshaller for MonitorInstancesRequest
 */
    ...
    public Request<MonitorInstancesRequest> marshall(MonitorInstancesRequest monitorInstancesRequest) {
        if (monitorInstancesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(MonitorInstancesRequest)");
        }

        Request<MonitorInstancesRequest> request = new DefaultRequest<MonitorInstancesRequest>(
                monitorInstancesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (monitorInstancesRequest.getInstanceIds() != null) {
                java.util.List<String> instanceIds = monitorInstancesRequest.getInstanceIds();
            ...
            if (monitorInstancesRequest.getDryRun() != null) {
                Boolean dryRun = monitorInstancesRequest.getDryRun();
