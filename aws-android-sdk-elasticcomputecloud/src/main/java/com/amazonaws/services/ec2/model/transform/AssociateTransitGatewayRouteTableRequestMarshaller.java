...
/**
 * JSON request marshaller for AssociateTransitGatewayRouteTableRequest
 */
public class AssociateTransitGatewayRouteTableRequestMarshaller
        implements
        Marshaller<Request<AssociateTransitGatewayRouteTableRequest>, AssociateTransitGatewayRouteTableRequest> {

    public Request<AssociateTransitGatewayRouteTableRequest> marshall(
        ...
        if (associateTransitGatewayRouteTableRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AssociateTransitGatewayRouteTableRequest)");
        }

        Request<AssociateTransitGatewayRouteTableRequest> request = new DefaultRequest<AssociateTransitGatewayRouteTableRequest>(
                associateTransitGatewayRouteTableRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (associateTransitGatewayRouteTableRequest.getTransitGatewayRouteTableId() != null) {
                String transitGatewayRouteTableId = associateTransitGatewayRouteTableRequest
            ...
            if (associateTransitGatewayRouteTableRequest.getTransitGatewayAttachmentId() != null) {
                String transitGatewayAttachmentId = associateTransitGatewayRouteTableRequest
                        .getTransitGatewayAttachmentId();
                jsonWriter.name("TransitGatewayAttachmentId");
                jsonWriter.value(transitGatewayAttachmentId);
            }
            if (associateTransitGatewayRouteTableRequest.getDryRun() != null) {
                Boolean dryRun = associateTransitGatewayRouteTableRequest.getDryRun();
