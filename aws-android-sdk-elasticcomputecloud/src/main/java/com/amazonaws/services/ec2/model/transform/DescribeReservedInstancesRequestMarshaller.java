...
/**
 * JSON request marshaller for DescribeReservedInstancesRequest
 */
public class DescribeReservedInstancesRequestMarshaller implements
    ...
    public Request<DescribeReservedInstancesRequest> marshall(
        ...
        if (describeReservedInstancesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeReservedInstancesRequest)");
        }

        Request<DescribeReservedInstancesRequest> request = new DefaultRequest<DescribeReservedInstancesRequest>(
                describeReservedInstancesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeReservedInstancesRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeReservedInstancesRequest.getFilters();
            ...
            if (describeReservedInstancesRequest.getOfferingClass() != null) {
                String offeringClass = describeReservedInstancesRequest.getOfferingClass();
                jsonWriter.name("OfferingClass");
                jsonWriter.value(offeringClass);
            }
            if (describeReservedInstancesRequest.getReservedInstancesIds() != null) {
                java.util.List<String> reservedInstancesIds = describeReservedInstancesRequest
            ...
            if (describeReservedInstancesRequest.getDryRun() != null) {
                Boolean dryRun = describeReservedInstancesRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeReservedInstancesRequest.getOfferingType() != null) {
                String offeringType = describeReservedInstancesRequest.getOfferingType();
