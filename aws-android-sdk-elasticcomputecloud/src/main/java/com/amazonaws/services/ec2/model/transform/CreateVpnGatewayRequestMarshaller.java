...
/**
 * JSON request marshaller for CreateVpnGatewayRequest
 */
    ...
    public Request<CreateVpnGatewayRequest> marshall(CreateVpnGatewayRequest createVpnGatewayRequest) {
        if (createVpnGatewayRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateVpnGatewayRequest)");
        }

        Request<CreateVpnGatewayRequest> request = new DefaultRequest<CreateVpnGatewayRequest>(
                createVpnGatewayRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (createVpnGatewayRequest.getAvailabilityZone() != null) {
                String availabilityZone = createVpnGatewayRequest.getAvailabilityZone();
                jsonWriter.name("AvailabilityZone");
                jsonWriter.value(availabilityZone);
            }
            if (createVpnGatewayRequest.getType() != null) {
                String type = createVpnGatewayRequest.getType();
                jsonWriter.name("Type");
                jsonWriter.value(type);
            }
            if (createVpnGatewayRequest.getAmazonSideAsn() != null) {
                Long amazonSideAsn = createVpnGatewayRequest.getAmazonSideAsn();
                jsonWriter.name("AmazonSideAsn");
                jsonWriter.value(amazonSideAsn);
            }
            if (createVpnGatewayRequest.getDryRun() != null) {
                Boolean dryRun = createVpnGatewayRequest.getDryRun();
