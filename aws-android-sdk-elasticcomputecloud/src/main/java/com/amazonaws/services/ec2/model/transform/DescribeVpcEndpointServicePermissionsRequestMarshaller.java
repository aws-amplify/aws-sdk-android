...
/**
 * JSON request marshaller for DescribeVpcEndpointServicePermissionsRequest
 */
    ...
    public Request<DescribeVpcEndpointServicePermissionsRequest> marshall(
        ...
        if (describeVpcEndpointServicePermissionsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeVpcEndpointServicePermissionsRequest)");
        }
        ...
        Request<DescribeVpcEndpointServicePermissionsRequest> request = new DefaultRequest<DescribeVpcEndpointServicePermissionsRequest>(
                describeVpcEndpointServicePermissionsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeVpcEndpointServicePermissionsRequest.getDryRun() != null) {
                Boolean dryRun = describeVpcEndpointServicePermissionsRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeVpcEndpointServicePermissionsRequest.getServiceId() != null) {
                String serviceId = describeVpcEndpointServicePermissionsRequest.getServiceId();
                jsonWriter.name("ServiceId");
                jsonWriter.value(serviceId);
            }
            if (describeVpcEndpointServicePermissionsRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeVpcEndpointServicePermissionsRequest
                        .getFilters();
            ...
            if (describeVpcEndpointServicePermissionsRequest.getMaxResults() != null) {
                Integer maxResults = describeVpcEndpointServicePermissionsRequest.getMaxResults();
                jsonWriter.name("MaxResults");
                jsonWriter.value(maxResults);
            }
            if (describeVpcEndpointServicePermissionsRequest.getNextToken() != null) {
                String nextToken = describeVpcEndpointServicePermissionsRequest.getNextToken();
