...
/**
 * JSON request marshaller for CreateTransitGatewayRouteTableRequest
 */
public class CreateTransitGatewayRouteTableRequestMarshaller
        implements
        Marshaller<Request<CreateTransitGatewayRouteTableRequest>, CreateTransitGatewayRouteTableRequest> {

    public Request<CreateTransitGatewayRouteTableRequest> marshall(
        ...
        if (createTransitGatewayRouteTableRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateTransitGatewayRouteTableRequest)");
        }

        Request<CreateTransitGatewayRouteTableRequest> request = new DefaultRequest<CreateTransitGatewayRouteTableRequest>(
                createTransitGatewayRouteTableRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (createTransitGatewayRouteTableRequest.getTransitGatewayId() != null) {
                String transitGatewayId = createTransitGatewayRouteTableRequest
                        .getTransitGatewayId();
                jsonWriter.name("TransitGatewayId");
                jsonWriter.value(transitGatewayId);
            }
            if (createTransitGatewayRouteTableRequest.getTagSpecifications() != null) {
                java.util.List<TagSpecification> tagSpecifications = createTransitGatewayRouteTableRequest
            ...
            if (createTransitGatewayRouteTableRequest.getDryRun() != null) {
                Boolean dryRun = createTransitGatewayRouteTableRequest.getDryRun();
