...
/**
 * JSON request marshaller for RejectVpcPeeringConnectionRequest
 */
    ...
    public Request<RejectVpcPeeringConnectionRequest> marshall(
        ...
        if (rejectVpcPeeringConnectionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RejectVpcPeeringConnectionRequest)");
        }

        Request<RejectVpcPeeringConnectionRequest> request = new DefaultRequest<RejectVpcPeeringConnectionRequest>(
                rejectVpcPeeringConnectionRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (rejectVpcPeeringConnectionRequest.getDryRun() != null) {
                Boolean dryRun = rejectVpcPeeringConnectionRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (rejectVpcPeeringConnectionRequest.getVpcPeeringConnectionId() != null) {
                String vpcPeeringConnectionId = rejectVpcPeeringConnectionRequest
