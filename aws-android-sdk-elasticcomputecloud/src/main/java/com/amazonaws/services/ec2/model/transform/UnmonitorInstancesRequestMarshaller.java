...
/**
 * JSON request marshaller for UnmonitorInstancesRequest
 */
    ...
    public Request<UnmonitorInstancesRequest> marshall(
        ...
        if (unmonitorInstancesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UnmonitorInstancesRequest)");
        }

        Request<UnmonitorInstancesRequest> request = new DefaultRequest<UnmonitorInstancesRequest>(
                unmonitorInstancesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (unmonitorInstancesRequest.getInstanceIds() != null) {
                java.util.List<String> instanceIds = unmonitorInstancesRequest.getInstanceIds();
            ...
            if (unmonitorInstancesRequest.getDryRun() != null) {
                Boolean dryRun = unmonitorInstancesRequest.getDryRun();
