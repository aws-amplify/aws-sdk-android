...
/**
 * JSON unmarshaller for POJO EbsInstanceBlockDevice
 */
class EbsInstanceBlockDeviceJsonUnmarshaller implements
        Unmarshaller<EbsInstanceBlockDevice, JsonUnmarshallerContext> {
    ...
    public EbsInstanceBlockDevice unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AttachTime")) {
                ebsInstanceBlockDevice.setAttachTime(DateJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("DeleteOnTermination")) {
                ebsInstanceBlockDevice.setDeleteOnTermination(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Status")) {
                ebsInstanceBlockDevice.setStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("VolumeId")) {
                ebsInstanceBlockDevice.setVolumeId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
