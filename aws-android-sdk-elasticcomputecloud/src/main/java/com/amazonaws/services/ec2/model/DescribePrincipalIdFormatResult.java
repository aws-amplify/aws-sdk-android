...
public class DescribePrincipalIdFormatResult implements Serializable {
    /**
     * <p>
     * Information about the ID format settings for the ARN.
     * </p>
     */
    private java.util.List<PrincipalIdFormat> principals;
    ...
    public void setPrincipals(java.util.Collection<PrincipalIdFormat> principals) {
        ...
        this.principals = new java.util.ArrayList<PrincipalIdFormat>(principals);
    }
    ...
    public DescribePrincipalIdFormatResult withPrincipals(PrincipalIdFormat... principals) {
        if (getPrincipals() == null) {
            this.principals = new java.util.ArrayList<PrincipalIdFormat>(principals.length);
        }
        for (PrincipalIdFormat value : principals) {
     ...
     *         chained together.
     */
    public DescribePrincipalIdFormatResult withPrincipals(
            java.util.Collection<PrincipalIdFormat> principals) {
