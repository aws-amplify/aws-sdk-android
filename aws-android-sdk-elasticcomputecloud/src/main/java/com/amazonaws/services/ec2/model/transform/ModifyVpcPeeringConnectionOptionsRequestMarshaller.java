...
/**
 * JSON request marshaller for ModifyVpcPeeringConnectionOptionsRequest
 */
    ...
    public Request<ModifyVpcPeeringConnectionOptionsRequest> marshall(
        ...
        if (modifyVpcPeeringConnectionOptionsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ModifyVpcPeeringConnectionOptionsRequest)");
        }

        Request<ModifyVpcPeeringConnectionOptionsRequest> request = new DefaultRequest<ModifyVpcPeeringConnectionOptionsRequest>(
                modifyVpcPeeringConnectionOptionsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (modifyVpcPeeringConnectionOptionsRequest.getAccepterPeeringConnectionOptions() != null) {
                ...
                jsonWriter.name("AccepterPeeringConnectionOptions");
                PeeringConnectionOptionsRequestJsonMarshaller.getInstance().marshall(
                        accepterPeeringConnectionOptions, jsonWriter);
            }
            if (modifyVpcPeeringConnectionOptionsRequest.getDryRun() != null) {
                Boolean dryRun = modifyVpcPeeringConnectionOptionsRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (modifyVpcPeeringConnectionOptionsRequest.getRequesterPeeringConnectionOptions() != null) {
                ...
                jsonWriter.name("RequesterPeeringConnectionOptions");
                PeeringConnectionOptionsRequestJsonMarshaller.getInstance().marshall(
                        requesterPeeringConnectionOptions, jsonWriter);
            }
            if (modifyVpcPeeringConnectionOptionsRequest.getVpcPeeringConnectionId() != null) {
                String vpcPeeringConnectionId = modifyVpcPeeringConnectionOptionsRequest
