...
public class LaunchTemplateOverrides implements Serializable {
     ...
     * <b>OnDemandAllocationStrategy</b> is set to <code>prioritized</code>,
     * Spot Fleet uses priority to determine which launch template override to
     * use first in fulfilling On-Demand capacity. The highest priority is
     * launched first. Valid values are whole numbers starting at <code>0</code>
     ...
     * @return <p>
     *         The priority for the launch template override. If
     *         <b>OnDemandAllocationStrategy</b> is set to
     *         <code>prioritized</code>, Spot Fleet uses priority to determine
     *         which launch template override to use first in fulfilling
     *         On-Demand capacity. The highest priority is launched first. Valid
     *         values are whole numbers starting at <code>0</code>. The lower
     *         the number, the higher the priority. If no number is set, the
     *         launch template override has the lowest priority.
     *         </p>
     */
     ...
     *            The priority for the launch template override. If
     *            <b>OnDemandAllocationStrategy</b> is set to
     *            <code>prioritized</code>, Spot Fleet uses priority to
     *            determine which launch template override to use first in
     *            fulfilling On-Demand capacity. The highest priority is
     *            launched first. Valid values are whole numbers starting at
     *            <code>0</code>. The lower the number, the higher the priority.
     *            If no number is set, the launch template override has the
     *            lowest priority.
     *            </p>
     */
