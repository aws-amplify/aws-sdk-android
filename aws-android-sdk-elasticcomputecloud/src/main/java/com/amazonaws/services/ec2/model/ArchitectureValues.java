...
public enum ArchitectureValues {
    ...
    private static final Map<String, ArchitectureValues> enumMap;
    static {
        enumMap = new HashMap<String, ArchitectureValues>();
        enumMap.put("i386", I386);
        enumMap.put("x86_64", X86_64);
        enumMap.put("arm64", Arm64);
    }
