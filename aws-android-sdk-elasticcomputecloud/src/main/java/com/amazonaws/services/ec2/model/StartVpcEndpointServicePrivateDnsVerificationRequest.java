 ...
 * DNS server. For more information, see <a href=
 * "https://docs.aws.amazon.com/vpc/latest/userguide/ndpoint-services-dns-validation.html#add-dns-txt-record"
 * >Adding a TXT Record to Your Domain's DNS Server </a> in the <i>Amazon VPC
 * User Guide</i>.
 * </p>
 */
public class StartVpcEndpointServicePrivateDnsVerificationRequest extends AmazonWebServiceRequest
