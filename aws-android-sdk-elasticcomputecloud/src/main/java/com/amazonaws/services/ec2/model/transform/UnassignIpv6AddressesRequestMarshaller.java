...
/**
 * JSON request marshaller for UnassignIpv6AddressesRequest
 */
public class UnassignIpv6AddressesRequestMarshaller implements
    ...
    public Request<UnassignIpv6AddressesRequest> marshall(
        ...
        try {
            ...
            if (unassignIpv6AddressesRequest.getIpv6Addresses() != null) {
                java.util.List<String> ipv6Addresses = unassignIpv6AddressesRequest
                        .getIpv6Addresses();
            ...
            if (unassignIpv6AddressesRequest.getNetworkInterfaceId() != null) {
                String networkInterfaceId = unassignIpv6AddressesRequest.getNetworkInterfaceId();
