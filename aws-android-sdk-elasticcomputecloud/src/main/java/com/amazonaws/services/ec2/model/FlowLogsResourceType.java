...
public enum FlowLogsResourceType {
    ...
    private static final Map<String, FlowLogsResourceType> enumMap;
    static {
        enumMap = new HashMap<String, FlowLogsResourceType>();
        enumMap.put("VPC", VPC);
        enumMap.put("Subnet", Subnet);
        enumMap.put("NetworkInterface", NetworkInterface);
    }
