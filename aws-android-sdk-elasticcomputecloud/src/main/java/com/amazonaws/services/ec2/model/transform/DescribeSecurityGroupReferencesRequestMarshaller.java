...
/**
 * JSON request marshaller for DescribeSecurityGroupReferencesRequest
 */
    ...
    public Request<DescribeSecurityGroupReferencesRequest> marshall(
        ...
        if (describeSecurityGroupReferencesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeSecurityGroupReferencesRequest)");
        }

        Request<DescribeSecurityGroupReferencesRequest> request = new DefaultRequest<DescribeSecurityGroupReferencesRequest>(
                describeSecurityGroupReferencesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeSecurityGroupReferencesRequest.getDryRun() != null) {
                Boolean dryRun = describeSecurityGroupReferencesRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeSecurityGroupReferencesRequest.getGroupId() != null) {
                java.util.List<String> groupId = describeSecurityGroupReferencesRequest
                        .getGroupId();
                jsonWriter.name("GroupId");
                jsonWriter.beginArray();
                for (String groupIdItem : groupId) {
                    if (groupIdItem != null) {
                        jsonWriter.value(groupIdItem);
                    }
                }
                jsonWriter.endArray();
            }
