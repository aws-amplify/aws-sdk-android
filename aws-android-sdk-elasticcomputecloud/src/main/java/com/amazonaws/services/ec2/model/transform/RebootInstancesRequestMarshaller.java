...
/**
 * JSON request marshaller for RebootInstancesRequest
 */
    ...
    public Request<RebootInstancesRequest> marshall(RebootInstancesRequest rebootInstancesRequest) {
        if (rebootInstancesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RebootInstancesRequest)");
        }

        Request<RebootInstancesRequest> request = new DefaultRequest<RebootInstancesRequest>(
                rebootInstancesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (rebootInstancesRequest.getInstanceIds() != null) {
                java.util.List<String> instanceIds = rebootInstancesRequest.getInstanceIds();
            ...
            if (rebootInstancesRequest.getDryRun() != null) {
                Boolean dryRun = rebootInstancesRequest.getDryRun();
