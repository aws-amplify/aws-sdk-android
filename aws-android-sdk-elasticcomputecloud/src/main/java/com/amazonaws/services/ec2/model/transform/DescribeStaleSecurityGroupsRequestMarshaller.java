...
/**
 * JSON request marshaller for DescribeStaleSecurityGroupsRequest
 */
    ...
    public Request<DescribeStaleSecurityGroupsRequest> marshall(
        ...
        if (describeStaleSecurityGroupsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeStaleSecurityGroupsRequest)");
        }

        Request<DescribeStaleSecurityGroupsRequest> request = new DefaultRequest<DescribeStaleSecurityGroupsRequest>(
                describeStaleSecurityGroupsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeStaleSecurityGroupsRequest.getDryRun() != null) {
                Boolean dryRun = describeStaleSecurityGroupsRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeStaleSecurityGroupsRequest.getMaxResults() != null) {
                Integer maxResults = describeStaleSecurityGroupsRequest.getMaxResults();
                jsonWriter.name("MaxResults");
                jsonWriter.value(maxResults);
            }
            if (describeStaleSecurityGroupsRequest.getNextToken() != null) {
                String nextToken = describeStaleSecurityGroupsRequest.getNextToken();
                jsonWriter.name("NextToken");
                jsonWriter.value(nextToken);
            }
            if (describeStaleSecurityGroupsRequest.getVpcId() != null) {
                String vpcId = describeStaleSecurityGroupsRequest.getVpcId();
