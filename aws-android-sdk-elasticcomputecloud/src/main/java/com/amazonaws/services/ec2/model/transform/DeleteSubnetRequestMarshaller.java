...
/**
 * JSON request marshaller for DeleteSubnetRequest
 */
    ...
    public Request<DeleteSubnetRequest> marshall(DeleteSubnetRequest deleteSubnetRequest) {
        if (deleteSubnetRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteSubnetRequest)");
        }

        Request<DeleteSubnetRequest> request = new DefaultRequest<DeleteSubnetRequest>(
                deleteSubnetRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (deleteSubnetRequest.getSubnetId() != null) {
                String subnetId = deleteSubnetRequest.getSubnetId();
                jsonWriter.name("SubnetId");
                jsonWriter.value(subnetId);
            }
            if (deleteSubnetRequest.getDryRun() != null) {
                Boolean dryRun = deleteSubnetRequest.getDryRun();
