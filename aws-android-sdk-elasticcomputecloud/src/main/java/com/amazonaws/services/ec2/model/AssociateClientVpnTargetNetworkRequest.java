 ...
 * VPC. To specify a subnet that's in a different VPC, you must first modify the
 * Client VPN endpoint (<a>ModifyClientVpnEndpoint</a>) and change the VPC
 * that's associated with it.
 * </p>
 */
public class AssociateClientVpnTargetNetworkRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *
     * @param subnetId <p>
     *            The ID of the subnet to associate with the Client VPN
     *            endpoint.
     *            </p>
     */
