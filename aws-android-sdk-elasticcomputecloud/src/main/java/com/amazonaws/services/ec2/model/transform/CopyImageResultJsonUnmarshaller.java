...
/**
 * JSON unmarshaller for response CopyImageResult
 */
public class CopyImageResultJsonUnmarshaller implements
        Unmarshaller<CopyImageResult, JsonUnmarshallerContext> {
    ...
    public CopyImageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ImageId")) {
                copyImageResult.setImageId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
