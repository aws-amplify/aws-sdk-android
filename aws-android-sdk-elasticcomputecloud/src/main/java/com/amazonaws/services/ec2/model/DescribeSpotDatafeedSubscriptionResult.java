...
public class DescribeSpotDatafeedSubscriptionResult implements Serializable {
     ...
     * </p>
     *
     * @param spotDatafeedSubscription <p>
     *            The Spot Instance data feed subscription.
     *            </p>
     */
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getSpotDatafeedSubscription() == null) ? 0 : getSpotDatafeedSubscription()
                        .hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSpotDatafeedSubscription() == null
            ...
            return false;
        if (other.getSpotDatafeedSubscription() != null
                && other.getSpotDatafeedSubscription().equals(this.getSpotDatafeedSubscription()) == false)
            return false;
        return true;
    }
}
