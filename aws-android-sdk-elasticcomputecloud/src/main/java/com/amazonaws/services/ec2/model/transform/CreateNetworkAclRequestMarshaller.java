...
/**
 * JSON request marshaller for CreateNetworkAclRequest
 */
    ...
    public Request<CreateNetworkAclRequest> marshall(CreateNetworkAclRequest createNetworkAclRequest) {
        if (createNetworkAclRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateNetworkAclRequest)");
        }

        Request<CreateNetworkAclRequest> request = new DefaultRequest<CreateNetworkAclRequest>(
                createNetworkAclRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (createNetworkAclRequest.getDryRun() != null) {
                Boolean dryRun = createNetworkAclRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (createNetworkAclRequest.getVpcId() != null) {
                String vpcId = createNetworkAclRequest.getVpcId();
