...
/**
 * JSON request marshaller for DescribeReservedInstancesListingsRequest
 */
    ...
    public Request<DescribeReservedInstancesListingsRequest> marshall(
        ...
        if (describeReservedInstancesListingsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeReservedInstancesListingsRequest)");
        }

        Request<DescribeReservedInstancesListingsRequest> request = new DefaultRequest<DescribeReservedInstancesListingsRequest>(
                describeReservedInstancesListingsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeReservedInstancesListingsRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeReservedInstancesListingsRequest
                        .getFilters();
            ...
            if (describeReservedInstancesListingsRequest.getReservedInstancesId() != null) {
                String reservedInstancesId = describeReservedInstancesListingsRequest
            ...
            if (describeReservedInstancesListingsRequest.getReservedInstancesListingId() != null) {
                String reservedInstancesListingId = describeReservedInstancesListingsRequest
