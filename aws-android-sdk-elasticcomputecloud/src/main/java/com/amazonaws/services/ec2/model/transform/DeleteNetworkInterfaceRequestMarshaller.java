...
/**
 * JSON request marshaller for DeleteNetworkInterfaceRequest
 */
    ...
    public Request<DeleteNetworkInterfaceRequest> marshall(
        ...
        if (deleteNetworkInterfaceRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteNetworkInterfaceRequest)");
        }

        Request<DeleteNetworkInterfaceRequest> request = new DefaultRequest<DeleteNetworkInterfaceRequest>(
                deleteNetworkInterfaceRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (deleteNetworkInterfaceRequest.getDryRun() != null) {
                Boolean dryRun = deleteNetworkInterfaceRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (deleteNetworkInterfaceRequest.getNetworkInterfaceId() != null) {
                String networkInterfaceId = deleteNetworkInterfaceRequest.getNetworkInterfaceId();
