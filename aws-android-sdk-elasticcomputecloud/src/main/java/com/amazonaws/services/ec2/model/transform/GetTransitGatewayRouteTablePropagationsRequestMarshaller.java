...
/**
 * JSON request marshaller for GetTransitGatewayRouteTablePropagationsRequest
 */
    ...
    public Request<GetTransitGatewayRouteTablePropagationsRequest> marshall(
        ...
        if (getTransitGatewayRouteTablePropagationsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetTransitGatewayRouteTablePropagationsRequest)");
        }
        ...
        Request<GetTransitGatewayRouteTablePropagationsRequest> request = new DefaultRequest<GetTransitGatewayRouteTablePropagationsRequest>(
                getTransitGatewayRouteTablePropagationsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (getTransitGatewayRouteTablePropagationsRequest.getTransitGatewayRouteTableId() != null) {
                String transitGatewayRouteTableId = getTransitGatewayRouteTablePropagationsRequest
                        .getTransitGatewayRouteTableId();
                jsonWriter.name("TransitGatewayRouteTableId");
                jsonWriter.value(transitGatewayRouteTableId);
            }
            if (getTransitGatewayRouteTablePropagationsRequest.getFilters() != null) {
                java.util.List<Filter> filters = getTransitGatewayRouteTablePropagationsRequest
                        .getFilters();
            ...
            if (getTransitGatewayRouteTablePropagationsRequest.getMaxResults() != null) {
                Integer maxResults = getTransitGatewayRouteTablePropagationsRequest.getMaxResults();
                jsonWriter.name("MaxResults");
                jsonWriter.value(maxResults);
            }
            if (getTransitGatewayRouteTablePropagationsRequest.getNextToken() != null) {
                String nextToken = getTransitGatewayRouteTablePropagationsRequest.getNextToken();
                jsonWriter.name("NextToken");
                jsonWriter.value(nextToken);
            }
            if (getTransitGatewayRouteTablePropagationsRequest.getDryRun() != null) {
                Boolean dryRun = getTransitGatewayRouteTablePropagationsRequest.getDryRun();
