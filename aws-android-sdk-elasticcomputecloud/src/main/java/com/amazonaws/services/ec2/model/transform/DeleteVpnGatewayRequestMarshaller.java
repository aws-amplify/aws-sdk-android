...
/**
 * JSON request marshaller for DeleteVpnGatewayRequest
 */
    ...
    public Request<DeleteVpnGatewayRequest> marshall(DeleteVpnGatewayRequest deleteVpnGatewayRequest) {
        if (deleteVpnGatewayRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteVpnGatewayRequest)");
        }

        Request<DeleteVpnGatewayRequest> request = new DefaultRequest<DeleteVpnGatewayRequest>(
                deleteVpnGatewayRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (deleteVpnGatewayRequest.getVpnGatewayId() != null) {
                String vpnGatewayId = deleteVpnGatewayRequest.getVpnGatewayId();
                jsonWriter.name("VpnGatewayId");
                jsonWriter.value(vpnGatewayId);
            }
            if (deleteVpnGatewayRequest.getDryRun() != null) {
                Boolean dryRun = deleteVpnGatewayRequest.getDryRun();
