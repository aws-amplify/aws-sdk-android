...
/**
 * JSON request marshaller for CancelConversionTaskRequest
 */
public class CancelConversionTaskRequestMarshaller implements
    ...
    public Request<CancelConversionTaskRequest> marshall(
        ...
        if (cancelConversionTaskRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CancelConversionTaskRequest)");
        }

        Request<CancelConversionTaskRequest> request = new DefaultRequest<CancelConversionTaskRequest>(
                cancelConversionTaskRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (cancelConversionTaskRequest.getDryRun() != null) {
                Boolean dryRun = cancelConversionTaskRequest.getDryRun();
            ...
            if (cancelConversionTaskRequest.getReasonMessage() != null) {
                ...
                jsonWriter.value(reasonMessage);
            }
