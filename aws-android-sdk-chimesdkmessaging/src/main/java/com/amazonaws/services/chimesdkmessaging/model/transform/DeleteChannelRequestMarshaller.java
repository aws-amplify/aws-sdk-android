...
public class DeleteChannelRequestMarshaller implements
    ...
    public Request<DeleteChannelRequest> marshall(DeleteChannelRequest deleteChannelRequest) {
        ...
        Request<DeleteChannelRequest> request = new DefaultRequest<DeleteChannelRequest>(
                deleteChannelRequest, "AmazonChimeSDKMessaging");
        request.setHttpMethod(HttpMethodName.DELETE);

        if (deleteChannelRequest.getChimeBearer() != null) {
            request.addHeader("x-amz-chime-bearer",
                    StringUtils.fromString(deleteChannelRequest.getChimeBearer()));
        }
        ...
        encodedUriResourcePath = encodedUriResourcePath.replace(
                "{channelArn}",
                (deleteChannelRequest.getChannelArn() == null) ? "" : Uri.encode(StringUtils
                        .fromString(deleteChannelRequest.getChannelArn())));
