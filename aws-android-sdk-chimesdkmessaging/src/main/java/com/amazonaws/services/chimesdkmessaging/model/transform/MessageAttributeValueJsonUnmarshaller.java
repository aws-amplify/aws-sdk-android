...
/**
 * JSON unmarshaller for POJO MessageAttributeValue
 */
class MessageAttributeValueJsonUnmarshaller implements
        Unmarshaller<MessageAttributeValue, JsonUnmarshallerContext> {
    ...
    public MessageAttributeValue unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("StringValues")) {
                messageAttributeValue.setStringValues(new ListUnmarshaller<String>(
