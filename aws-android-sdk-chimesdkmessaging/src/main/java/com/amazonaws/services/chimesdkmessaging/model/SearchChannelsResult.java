...
public class SearchChannelsResult implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         The token returned from previous API responses until the number
     ...
     *
     * @param nextToken <p>
     *            The token returned from previous API responses until the
