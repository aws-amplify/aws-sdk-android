...
public class ListChannelsAssociatedWithChannelFlowResult implements Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public ListChannelsAssociatedWithChannelFlowResult withChannels(
            ChannelAssociatedWithFlowSummary... channels) {
        if (getChannels() == null) {
            this.channels = new java.util.ArrayList<ChannelAssociatedWithFlowSummary>(
                    channels.length);
        }
        for (ChannelAssociatedWithFlowSummary value : channels) {
     ...
     */
    public ListChannelsAssociatedWithChannelFlowResult withChannels(
            java.util.Collection<ChannelAssociatedWithFlowSummary> channels) {
