...
public class Processor implements Serializable {
     ...
     *
     * @return <p>
     *         Determines whether to continue or stop processing if
     *         communication with processor fails. If the last processor in a
     *         channel flow sequence has a fallback action of CONTINUE, and
     *         communication with the processor fails, the message is considered
     ...
     *            communication with processor fails. If the last processor in a
     *            channel flow sequence has a fallback action of CONTINUE, and
     *            communication with the processor fails, the message is
     *            considered processed and sent to the recipients in the
     *            channel.
     *            </p>
     * @see FallbackAction
     */
