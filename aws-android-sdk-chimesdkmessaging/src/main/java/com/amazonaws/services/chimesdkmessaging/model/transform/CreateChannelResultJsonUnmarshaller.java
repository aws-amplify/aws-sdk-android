...
/**
 * JSON unmarshaller for response CreateChannelResult
 */
public class CreateChannelResultJsonUnmarshaller implements
        Unmarshaller<CreateChannelResult, JsonUnmarshallerContext> {
    ...
    public CreateChannelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ChannelArn")) {
                createChannelResult.setChannelArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
