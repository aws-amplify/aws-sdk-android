...
/**
 * JSON unmarshaller for response UpdateChannelResult
 */
public class UpdateChannelResultJsonUnmarshaller implements
        Unmarshaller<UpdateChannelResult, JsonUnmarshallerContext> {
    ...
    public UpdateChannelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ChannelArn")) {
                updateChannelResult.setChannelArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
