...
/**
 * JSON unmarshaller for POJO ChannelMessageStatusStructure
 */
class ChannelMessageStatusStructureJsonUnmarshaller implements
        Unmarshaller<ChannelMessageStatusStructure, JsonUnmarshallerContext> {
    ...
    public ChannelMessageStatusStructure unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Value")) {
                channelMessageStatusStructure.setValue(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Detail")) {
                channelMessageStatusStructure.setDetail(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
