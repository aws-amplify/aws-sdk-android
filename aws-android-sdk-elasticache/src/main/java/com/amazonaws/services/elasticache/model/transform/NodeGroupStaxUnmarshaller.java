...
/**
 * StAX unmarshaller for model NodeGroup
 */
class NodeGroupStaxUnmarshaller implements Unmarshaller<NodeGroup, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("NodeGroupId", targetDepth)) {
                    nodeGroup.setNodeGroupId(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                ...
                if (context.testExpression("PrimaryEndpoint", targetDepth)) {
                    nodeGroup.setPrimaryEndpoint(EndpointStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("ReaderEndpoint", targetDepth)) {
                    nodeGroup.setReaderEndpoint(EndpointStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                ...
                if (context.testExpression("NodeGroupMembers", targetDepth)) {
                    nodeGroup.withNodeGroupMembers(NodeGroupMemberStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
