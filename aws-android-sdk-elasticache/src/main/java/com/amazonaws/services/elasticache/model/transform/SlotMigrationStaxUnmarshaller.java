...
/**
 * StAX unmarshaller for model SlotMigration
 */
class SlotMigrationStaxUnmarshaller implements Unmarshaller<SlotMigration, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ProgressPercentage", targetDepth)) {
                    slotMigration.setProgressPercentage(DoubleStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
