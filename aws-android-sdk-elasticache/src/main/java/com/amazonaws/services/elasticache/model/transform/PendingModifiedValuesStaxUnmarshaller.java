        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("NumCacheNodes", targetDepth)) {
                    pendingModifiedValues.setNumCacheNodes(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("CacheNodeIdsToRemove", targetDepth)) {
                    pendingModifiedValues.withCacheNodeIdsToRemove(StringStaxUnmarshaller
                ...
                if (context.testExpression("CacheNodeType", targetDepth)) {
                    pendingModifiedValues.setCacheNodeType(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("AuthTokenStatus", targetDepth)) {
                    pendingModifiedValues.setAuthTokenStatus(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
