...
/**
 * StAX request marshaller for DescribeCacheParameterGroupsRequest
 */
    ...
    public Request<DescribeCacheParameterGroupsRequest> marshall(
        ...
        if (describeCacheParameterGroupsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeCacheParameterGroupsRequest)");
        }
        ...
        if (describeCacheParameterGroupsRequest.getCacheParameterGroupName() != null) {
            ...
            String cacheParameterGroupName = describeCacheParameterGroupsRequest
        ...
        if (describeCacheParameterGroupsRequest.getMaxRecords() != null) {
            prefix = "MaxRecords";
            Integer maxRecords = describeCacheParameterGroupsRequest.getMaxRecords();
            request.addParameter(prefix, StringUtils.fromInteger(maxRecords));
        }
        if (describeCacheParameterGroupsRequest.getMarker() != null) {
            prefix = "Marker";
            String marker = describeCacheParameterGroupsRequest.getMarker();
