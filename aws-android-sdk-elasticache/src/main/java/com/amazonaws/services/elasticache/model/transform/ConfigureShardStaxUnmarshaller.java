...
/**
 * StAX unmarshaller for model ConfigureShard
 */
class ConfigureShardStaxUnmarshaller implements
        Unmarshaller<ConfigureShard, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("NodeGroupId", targetDepth)) {
                    configureShard.setNodeGroupId(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("NewReplicaCount", targetDepth)) {
                    configureShard.setNewReplicaCount(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("PreferredAvailabilityZones", targetDepth)) {
                    configureShard.withPreferredAvailabilityZones(StringStaxUnmarshaller
