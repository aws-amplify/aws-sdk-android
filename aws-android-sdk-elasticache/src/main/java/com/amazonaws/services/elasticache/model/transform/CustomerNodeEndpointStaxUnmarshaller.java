...
/**
 * StAX unmarshaller for model CustomerNodeEndpoint
 */
class CustomerNodeEndpointStaxUnmarshaller implements
        Unmarshaller<CustomerNodeEndpoint, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Address", targetDepth)) {
                    customerNodeEndpoint.setAddress(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Port", targetDepth)) {
                    customerNodeEndpoint.setPort(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
