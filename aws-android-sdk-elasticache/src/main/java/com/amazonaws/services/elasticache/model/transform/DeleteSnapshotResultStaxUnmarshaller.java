...
/**
 * StAX unmarshaller for response DeleteSnapshotResult
 */
public class DeleteSnapshotResultStaxUnmarshaller implements
        Unmarshaller<DeleteSnapshotResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Snapshot", targetDepth)) {
                    deleteSnapshotResult.setSnapshot(SnapshotStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
