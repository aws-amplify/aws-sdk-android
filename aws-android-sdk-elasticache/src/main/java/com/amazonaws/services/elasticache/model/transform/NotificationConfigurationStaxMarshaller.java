...
class NotificationConfigurationStaxMarshaller {
    ...
    public void marshall(NotificationConfiguration _notificationConfiguration, Request<?> request,
        ...
        if (_notificationConfiguration.getTopicStatus() != null) {
            prefix = _prefix + "TopicStatus";
            String topicStatus = _notificationConfiguration.getTopicStatus();
            request.addParameter(prefix, StringUtils.fromString(topicStatus));
        }
    }
