...
/**
 * StAX unmarshaller for response DescribeGlobalReplicationGroupsResult
 */
public class DescribeGlobalReplicationGroupsResultStaxUnmarshaller implements
        Unmarshaller<DescribeGlobalReplicationGroupsResult, StaxUnmarshallerContext> {

    public DescribeGlobalReplicationGroupsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeGlobalReplicationGroupsResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("GlobalReplicationGroups", targetDepth)) {
                    describeGlobalReplicationGroupsResult
                            .withGlobalReplicationGroups(GlobalReplicationGroupStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
