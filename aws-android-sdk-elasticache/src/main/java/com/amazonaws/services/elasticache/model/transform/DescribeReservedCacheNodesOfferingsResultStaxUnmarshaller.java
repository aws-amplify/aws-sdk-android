...
/**
 * StAX unmarshaller for response DescribeReservedCacheNodesOfferingsResult
 */
public class DescribeReservedCacheNodesOfferingsResultStaxUnmarshaller implements
    ...
    public DescribeReservedCacheNodesOfferingsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeReservedCacheNodesOfferingsResult.setMarker(StringStaxUnmarshaller
