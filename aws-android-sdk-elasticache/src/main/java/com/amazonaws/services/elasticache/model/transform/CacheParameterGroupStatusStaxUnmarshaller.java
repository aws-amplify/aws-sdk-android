...
/**
 * StAX unmarshaller for model CacheParameterGroupStatus
 */
class CacheParameterGroupStatusStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("CacheParameterGroupName", targetDepth)) {
                    cacheParameterGroupStatus.setCacheParameterGroupName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ParameterApplyStatus", targetDepth)) {
                    cacheParameterGroupStatus.setParameterApplyStatus(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("CacheNodeIdsToReboot", targetDepth)) {
                    cacheParameterGroupStatus.withCacheNodeIdsToReboot(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
