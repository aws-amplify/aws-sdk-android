...
/**
 * StAX unmarshaller for response BatchApplyUpdateActionResult
 */
public class BatchApplyUpdateActionResultStaxUnmarshaller implements
        Unmarshaller<BatchApplyUpdateActionResult, StaxUnmarshallerContext> {

    public BatchApplyUpdateActionResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ProcessedUpdateActions", targetDepth)) {
                    batchApplyUpdateActionResult
                            .withProcessedUpdateActions(ProcessedUpdateActionStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("UnprocessedUpdateActions", targetDepth)) {
                    batchApplyUpdateActionResult
                            .withUnprocessedUpdateActions(UnprocessedUpdateActionStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
