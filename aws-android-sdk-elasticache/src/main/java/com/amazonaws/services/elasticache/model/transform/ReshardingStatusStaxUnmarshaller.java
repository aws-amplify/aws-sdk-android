...
/**
 * StAX unmarshaller for model ReshardingStatus
 */
class ReshardingStatusStaxUnmarshaller implements
        Unmarshaller<ReshardingStatus, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("SlotMigration", targetDepth)) {
                    reshardingStatus.setSlotMigration(SlotMigrationStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
