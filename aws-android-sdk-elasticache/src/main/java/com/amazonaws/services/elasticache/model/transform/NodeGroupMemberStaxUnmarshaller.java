...
/**
 * StAX unmarshaller for model NodeGroupMember
 */
class NodeGroupMemberStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("CacheClusterId", targetDepth)) {
                    nodeGroupMember.setCacheClusterId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("CacheNodeId", targetDepth)) {
                    nodeGroupMember.setCacheNodeId(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("ReadEndpoint", targetDepth)) {
                    nodeGroupMember.setReadEndpoint(EndpointStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("PreferredAvailabilityZone", targetDepth)) {
                    nodeGroupMember.setPreferredAvailabilityZone(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("CurrentRole", targetDepth)) {
                    nodeGroupMember.setCurrentRole(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
