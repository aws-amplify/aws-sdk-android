...
public enum SourceType {
    ...
    static {
        ...
        enumMap.put("cache-cluster", CacheCluster);
        enumMap.put("cache-parameter-group", CacheParameterGroup);
        enumMap.put("cache-security-group", CacheSecurityGroup);
        enumMap.put("cache-subnet-group", CacheSubnetGroup);
        enumMap.put("replication-group", ReplicationGroup);
    }
