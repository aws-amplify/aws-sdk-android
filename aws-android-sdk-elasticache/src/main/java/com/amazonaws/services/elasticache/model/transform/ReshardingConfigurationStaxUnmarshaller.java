...
/**
 * StAX unmarshaller for model ReshardingConfiguration
 */
class ReshardingConfigurationStaxUnmarshaller implements
        Unmarshaller<ReshardingConfiguration, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("NodeGroupId", targetDepth)) {
                    reshardingConfiguration.setNodeGroupId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("PreferredAvailabilityZones", targetDepth)) {
                    reshardingConfiguration.withPreferredAvailabilityZones(StringStaxUnmarshaller
