...
/**
 * JSON request marshaller for DeleteLogGroupRequest
 */
    ...
    public Request<DeleteLogGroupRequest> marshall(DeleteLogGroupRequest deleteLogGroupRequest) {
        if (deleteLogGroupRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteLogGroupRequest)");
        }

        Request<DeleteLogGroupRequest> request = new DefaultRequest<DeleteLogGroupRequest>(
                deleteLogGroupRequest, "AmazonCloudWatchLogs");
        ...
        try {
            ...
            if (deleteLogGroupRequest.getLogGroupName() != null) {
                String logGroupName = deleteLogGroupRequest.getLogGroupName();
