...
/**
 * JSON unmarshaller for response DescribeSubscriptionFiltersResult
 */
public class DescribeSubscriptionFiltersResultJsonUnmarshaller implements
        Unmarshaller<DescribeSubscriptionFiltersResult, JsonUnmarshallerContext> {

    public DescribeSubscriptionFiltersResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
