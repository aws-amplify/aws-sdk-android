...
/**
 * JSON request marshaller for PutMetricFilterRequest
 */
    ...
    public Request<PutMetricFilterRequest> marshall(PutMetricFilterRequest putMetricFilterRequest) {
        if (putMetricFilterRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(PutMetricFilterRequest)");
        }

        Request<PutMetricFilterRequest> request = new DefaultRequest<PutMetricFilterRequest>(
                putMetricFilterRequest, "AmazonCloudWatchLogs");
        ...
        try {
            ...
            if (putMetricFilterRequest.getMetricTransformations() != null) {
                java.util.List<MetricTransformation> metricTransformations = putMetricFilterRequest
