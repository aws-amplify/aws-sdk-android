...
/**
 * JSON unmarshaller for POJO MetricFilterMatchRecord
 */
class MetricFilterMatchRecordJsonUnmarshaller implements
    ...
    public MetricFilterMatchRecord unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("eventNumber")) {
                metricFilterMatchRecord.setEventNumber(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("eventMessage")) {
                metricFilterMatchRecord.setEventMessage(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
