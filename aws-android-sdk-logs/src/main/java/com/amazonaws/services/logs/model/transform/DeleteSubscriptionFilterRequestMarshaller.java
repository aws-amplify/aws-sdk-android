...
/**
 * JSON request marshaller for DeleteSubscriptionFilterRequest
 */
public class DeleteSubscriptionFilterRequestMarshaller implements
    ...
    public Request<DeleteSubscriptionFilterRequest> marshall(
        ...
        if (deleteSubscriptionFilterRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteSubscriptionFilterRequest)");
        }

        Request<DeleteSubscriptionFilterRequest> request = new DefaultRequest<DeleteSubscriptionFilterRequest>(
                deleteSubscriptionFilterRequest, "AmazonCloudWatchLogs");
