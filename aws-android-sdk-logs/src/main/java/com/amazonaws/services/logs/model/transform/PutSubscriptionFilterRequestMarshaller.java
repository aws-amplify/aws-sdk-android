...
/**
 * JSON request marshaller for PutSubscriptionFilterRequest
 */
public class PutSubscriptionFilterRequestMarshaller implements
    ...
    public Request<PutSubscriptionFilterRequest> marshall(
        ...
        if (putSubscriptionFilterRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(PutSubscriptionFilterRequest)");
        }

        Request<PutSubscriptionFilterRequest> request = new DefaultRequest<PutSubscriptionFilterRequest>(
                putSubscriptionFilterRequest, "AmazonCloudWatchLogs");
