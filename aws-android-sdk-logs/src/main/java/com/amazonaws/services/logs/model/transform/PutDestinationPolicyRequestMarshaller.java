...
/**
 * JSON request marshaller for PutDestinationPolicyRequest
 */
public class PutDestinationPolicyRequestMarshaller implements
    ...
    public Request<PutDestinationPolicyRequest> marshall(
        ...
        if (putDestinationPolicyRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(PutDestinationPolicyRequest)");
        }

        Request<PutDestinationPolicyRequest> request = new DefaultRequest<PutDestinationPolicyRequest>(
                putDestinationPolicyRequest, "AmazonCloudWatchLogs");
        ...
        try {
            ...
            if (putDestinationPolicyRequest.getDestinationName() != null) {
                String destinationName = putDestinationPolicyRequest.getDestinationName();
                jsonWriter.name("destinationName");
                jsonWriter.value(destinationName);
            }
            if (putDestinationPolicyRequest.getAccessPolicy() != null) {
                String accessPolicy = putDestinationPolicyRequest.getAccessPolicy();
