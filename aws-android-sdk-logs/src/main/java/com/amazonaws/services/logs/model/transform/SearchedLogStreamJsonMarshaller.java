...
/**
 * JSON marshaller for POJO SearchedLogStream
 */
class SearchedLogStreamJsonMarshaller {

    public void marshall(SearchedLogStream searchedLogStream, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (searchedLogStream.getSearchedCompletely() != null) {
            ...
            jsonWriter.name("searchedCompletely");
            jsonWriter.value(searchedCompletely);
        }
