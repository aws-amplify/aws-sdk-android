...
/**
 * JSON unmarshaller for response DescribeLogGroupsResult
 */
public class DescribeLogGroupsResultJsonUnmarshaller implements
        Unmarshaller<DescribeLogGroupsResult, JsonUnmarshallerContext> {
