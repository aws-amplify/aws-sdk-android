...
/**
 * JSON request marshaller for AssociateKmsKeyRequest
 */
public class AssociateKmsKeyRequestMarshaller implements
        Marshaller<Request<AssociateKmsKeyRequest>, AssociateKmsKeyRequest> {
    ...
    public Request<AssociateKmsKeyRequest> marshall(AssociateKmsKeyRequest associateKmsKeyRequest) {
        if (associateKmsKeyRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AssociateKmsKeyRequest)");
        }

        Request<AssociateKmsKeyRequest> request = new DefaultRequest<AssociateKmsKeyRequest>(
                associateKmsKeyRequest, "AmazonCloudWatchLogs");
