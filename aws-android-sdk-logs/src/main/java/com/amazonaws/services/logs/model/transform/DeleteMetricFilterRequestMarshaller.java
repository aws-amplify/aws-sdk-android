...
/**
 * JSON request marshaller for DeleteMetricFilterRequest
 */
public class DeleteMetricFilterRequestMarshaller implements
    ...
    public Request<DeleteMetricFilterRequest> marshall(
        ...
        if (deleteMetricFilterRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteMetricFilterRequest)");
        }

        Request<DeleteMetricFilterRequest> request = new DefaultRequest<DeleteMetricFilterRequest>(
                deleteMetricFilterRequest, "AmazonCloudWatchLogs");
