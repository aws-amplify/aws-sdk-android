...
/**
 * JSON unmarshaller for POJO SipAddress
 */
class SipAddressJsonUnmarshaller implements Unmarshaller<SipAddress, JsonUnmarshallerContext> {
    ...
    public SipAddress unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Uri")) {
                sipAddress.setUri(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Type")) {
                sipAddress.setType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
