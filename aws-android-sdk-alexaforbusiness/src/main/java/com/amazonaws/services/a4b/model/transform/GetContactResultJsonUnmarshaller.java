...
/**
 * JSON unmarshaller for response GetContactResult
 */
public class GetContactResultJsonUnmarshaller implements
        Unmarshaller<GetContactResult, JsonUnmarshallerContext> {
    ...
    public GetContactResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Contact")) {
                getContactResult.setContact(ContactJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
