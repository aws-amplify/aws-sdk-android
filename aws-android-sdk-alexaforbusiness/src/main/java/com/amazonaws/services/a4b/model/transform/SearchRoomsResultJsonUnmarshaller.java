...
/**
 * JSON unmarshaller for response SearchRoomsResult
 */
public class SearchRoomsResultJsonUnmarshaller implements
        Unmarshaller<SearchRoomsResult, JsonUnmarshallerContext> {
    ...
    public SearchRoomsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Rooms")) {
                searchRoomsResult.setRooms(new ListUnmarshaller<RoomData>(RoomDataJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                searchRoomsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TotalCount")) {
                searchRoomsResult.setTotalCount(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
