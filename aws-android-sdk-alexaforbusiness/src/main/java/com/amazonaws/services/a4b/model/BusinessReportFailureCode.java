...
public enum BusinessReportFailureCode {
    ...
    private static final Map<String, BusinessReportFailureCode> enumMap;
    static {
        enumMap = new HashMap<String, BusinessReportFailureCode>();
        enumMap.put("ACCESS_DENIED", ACCESS_DENIED);
        enumMap.put("NO_SUCH_BUCKET", NO_SUCH_BUCKET);
