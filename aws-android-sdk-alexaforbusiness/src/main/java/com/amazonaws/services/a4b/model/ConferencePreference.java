 ...
 * </p>
 */
public class ConferencePreference implements Serializable {
    /**
     * <p>
     ...
     * [a-z0-9-\.]{0,63}:[^/].{0,1023}<br/>
     *
     * @param defaultConferenceProviderArn <p>
     *            The ARN of the default conference provider.
     *            </p>
     */
    ...
    public String toString() {
        ...
        if (getDefaultConferenceProviderArn() != null)
            sb.append("DefaultConferenceProviderArn: " + getDefaultConferenceProviderArn());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getDefaultConferenceProviderArn() == null) ? 0
                        : getDefaultConferenceProviderArn().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDefaultConferenceProviderArn() == null
                ^ this.getDefaultConferenceProviderArn() == null)
            return false;
        if (other.getDefaultConferenceProviderArn() != null
                && other.getDefaultConferenceProviderArn().equals(
                        this.getDefaultConferenceProviderArn()) == false)
            return false;
        return true;
    }
}
