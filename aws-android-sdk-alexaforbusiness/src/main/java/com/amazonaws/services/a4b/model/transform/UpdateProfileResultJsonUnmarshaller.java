...
/**
 * JSON unmarshaller for response UpdateProfileResult
 */
public class UpdateProfileResultJsonUnmarshaller implements
        Unmarshaller<UpdateProfileResult, JsonUnmarshallerContext> {
