 ...
 * </p>
 */
public class SearchNetworkProfilesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *
     * @param filters <p>
     *            The filters to use to list a specified set of network
     *            profiles. Valid filters are NetworkProfileName, Ssid, and
     *            SecurityType.
     *            </p>
     */
     ...
     *
     * @return <p>
     *         The sort order to use to list the specified set of network
     *         profiles. Valid sort criteria includes NetworkProfileName, Ssid,
     *         and SecurityType.
     *         </p>
     */
     ...
     *            The sort order to use to list the specified set of network
     *            profiles. Valid sort criteria includes NetworkProfileName,
