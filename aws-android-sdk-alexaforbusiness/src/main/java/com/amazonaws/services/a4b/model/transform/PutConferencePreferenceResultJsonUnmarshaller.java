...
/**
 * JSON unmarshaller for response PutConferencePreferenceResult
 */
public class PutConferencePreferenceResultJsonUnmarshaller implements
        Unmarshaller<PutConferencePreferenceResult, JsonUnmarshallerContext> {

    public PutConferencePreferenceResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
