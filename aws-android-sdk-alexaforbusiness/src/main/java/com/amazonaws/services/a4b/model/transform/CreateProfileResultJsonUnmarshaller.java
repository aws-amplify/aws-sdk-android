...
/**
 * JSON unmarshaller for response CreateProfileResult
 */
public class CreateProfileResultJsonUnmarshaller implements
        Unmarshaller<CreateProfileResult, JsonUnmarshallerContext> {
    ...
    public CreateProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ProfileArn")) {
                createProfileResult.setProfileArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
