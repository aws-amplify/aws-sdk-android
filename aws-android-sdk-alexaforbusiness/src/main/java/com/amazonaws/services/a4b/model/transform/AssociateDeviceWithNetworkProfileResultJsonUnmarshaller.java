...
/**
 * JSON unmarshaller for response AssociateDeviceWithNetworkProfileResult
 */
public class AssociateDeviceWithNetworkProfileResultJsonUnmarshaller implements
        Unmarshaller<AssociateDeviceWithNetworkProfileResult, JsonUnmarshallerContext> {

    public AssociateDeviceWithNetworkProfileResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
