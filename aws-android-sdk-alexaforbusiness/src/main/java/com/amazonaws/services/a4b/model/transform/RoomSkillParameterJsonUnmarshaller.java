...
/**
 * JSON unmarshaller for POJO RoomSkillParameter
 */
class RoomSkillParameterJsonUnmarshaller implements
        Unmarshaller<RoomSkillParameter, JsonUnmarshallerContext> {
    ...
    public RoomSkillParameter unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ParameterKey")) {
                roomSkillParameter.setParameterKey(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ParameterValue")) {
                roomSkillParameter.setParameterValue(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
