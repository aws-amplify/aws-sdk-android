...
/**
 * JSON unmarshaller for response GetConferenceProviderResult
 */
public class GetConferenceProviderResultJsonUnmarshaller implements
        Unmarshaller<GetConferenceProviderResult, JsonUnmarshallerContext> {
    ...
    public GetConferenceProviderResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ConferenceProvider")) {
                getConferenceProviderResult
                        .setConferenceProvider(ConferenceProviderJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
            }
