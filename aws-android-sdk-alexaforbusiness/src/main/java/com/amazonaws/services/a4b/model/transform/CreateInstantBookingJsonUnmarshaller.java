...
/**
 * JSON unmarshaller for POJO CreateInstantBooking
 */
class CreateInstantBookingJsonUnmarshaller implements
        Unmarshaller<CreateInstantBooking, JsonUnmarshallerContext> {
    ...
    public CreateInstantBooking unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("DurationInMinutes")) {
                createInstantBooking.setDurationInMinutes(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Enabled")) {
                createInstantBooking.setEnabled(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
