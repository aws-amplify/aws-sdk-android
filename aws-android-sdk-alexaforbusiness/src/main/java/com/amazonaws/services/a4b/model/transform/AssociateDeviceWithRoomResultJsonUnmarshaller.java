...
/**
 * JSON unmarshaller for response AssociateDeviceWithRoomResult
 */
public class AssociateDeviceWithRoomResultJsonUnmarshaller implements
        Unmarshaller<AssociateDeviceWithRoomResult, JsonUnmarshallerContext> {

    public AssociateDeviceWithRoomResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
