...
/**
 * JSON unmarshaller for response GetProfileResult
 */
public class GetProfileResultJsonUnmarshaller implements
        Unmarshaller<GetProfileResult, JsonUnmarshallerContext> {
    ...
    public GetProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Profile")) {
                getProfileResult.setProfile(ProfileJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
