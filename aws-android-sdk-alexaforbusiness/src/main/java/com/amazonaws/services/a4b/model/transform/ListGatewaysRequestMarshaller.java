...
public class ListGatewaysRequestMarshaller implements
    ...
    public Request<ListGatewaysRequest> marshall(ListGatewaysRequest listGatewaysRequest) {
        ...
        Request<ListGatewaysRequest> request = new DefaultRequest<ListGatewaysRequest>(
                listGatewaysRequest, "AlexaForBusiness");
        ...
        try {
            ...
            if (listGatewaysRequest.getGatewayGroupArn() != null) {
                String gatewayGroupArn = listGatewaysRequest.getGatewayGroupArn();
                jsonWriter.name("GatewayGroupArn");
                jsonWriter.value(gatewayGroupArn);
            }
            if (listGatewaysRequest.getNextToken() != null) {
                String nextToken = listGatewaysRequest.getNextToken();
                jsonWriter.name("NextToken");
                jsonWriter.value(nextToken);
            }
            if (listGatewaysRequest.getMaxResults() != null) {
                Integer maxResults = listGatewaysRequest.getMaxResults();
