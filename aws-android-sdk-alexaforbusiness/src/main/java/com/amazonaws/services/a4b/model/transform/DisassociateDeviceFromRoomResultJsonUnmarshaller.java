...
/**
 * JSON unmarshaller for response DisassociateDeviceFromRoomResult
 */
public class DisassociateDeviceFromRoomResultJsonUnmarshaller implements
        Unmarshaller<DisassociateDeviceFromRoomResult, JsonUnmarshallerContext> {

    public DisassociateDeviceFromRoomResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
