...
public class DeleteUserRequestMarshaller implements
    ...
    public Request<DeleteUserRequest> marshall(DeleteUserRequest deleteUserRequest) {
        ...
        Request<DeleteUserRequest> request = new DefaultRequest<DeleteUserRequest>(
                deleteUserRequest, "AlexaForBusiness");
        ...
        try {
            ...
            if (deleteUserRequest.getUserArn() != null) {
                String userArn = deleteUserRequest.getUserArn();
                jsonWriter.name("UserArn");
                jsonWriter.value(userArn);
            }
            if (deleteUserRequest.getEnrollmentId() != null) {
                String enrollmentId = deleteUserRequest.getEnrollmentId();
