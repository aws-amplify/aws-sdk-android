...
/**
 * JSON unmarshaller for POJO DeviceNetworkProfileInfo
 */
class DeviceNetworkProfileInfoJsonUnmarshaller implements
        Unmarshaller<DeviceNetworkProfileInfo, JsonUnmarshallerContext> {
    ...
    public DeviceNetworkProfileInfo unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NetworkProfileArn")) {
                deviceNetworkProfileInfo.setNetworkProfileArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("CertificateArn")) {
                deviceNetworkProfileInfo.setCertificateArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("CertificateExpirationTime")) {
                deviceNetworkProfileInfo.setCertificateExpirationTime(DateJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
