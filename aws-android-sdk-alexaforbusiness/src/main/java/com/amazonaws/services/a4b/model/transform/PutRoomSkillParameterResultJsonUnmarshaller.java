...
/**
 * JSON unmarshaller for response PutRoomSkillParameterResult
 */
public class PutRoomSkillParameterResultJsonUnmarshaller implements
        Unmarshaller<PutRoomSkillParameterResult, JsonUnmarshallerContext> {
