...
/**
 * JSON unmarshaller for response PutInvitationConfigurationResult
 */
public class PutInvitationConfigurationResultJsonUnmarshaller implements
        Unmarshaller<PutInvitationConfigurationResult, JsonUnmarshallerContext> {

    public PutInvitationConfigurationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
