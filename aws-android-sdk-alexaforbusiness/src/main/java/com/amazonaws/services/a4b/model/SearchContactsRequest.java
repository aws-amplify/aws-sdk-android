...
public class SearchContactsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *            The supported filter keys are DisplayName, FirstName,
     *            LastName, and AddressBookArns.
     *            </p>
     */
     ...
     *            The sort order to use in listing the specified set of
     *            contacts. The supported sort keys are DisplayName, FirstName,
     *            and LastName.
     *            </p>
     */
