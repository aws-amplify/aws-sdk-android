...
/**
 * JSON unmarshaller for POJO MeetingRoomConfiguration
 */
class MeetingRoomConfigurationJsonUnmarshaller implements
        Unmarshaller<MeetingRoomConfiguration, JsonUnmarshallerContext> {
    ...
    public MeetingRoomConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RoomUtilizationMetricsEnabled")) {
                meetingRoomConfiguration.setRoomUtilizationMetricsEnabled(BooleanJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("EndOfMeetingReminder")) {
                meetingRoomConfiguration
                        .setEndOfMeetingReminder(EndOfMeetingReminderJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("InstantBooking")) {
                meetingRoomConfiguration.setInstantBooking(InstantBookingJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("RequireCheckIn")) {
                meetingRoomConfiguration.setRequireCheckIn(RequireCheckInJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
