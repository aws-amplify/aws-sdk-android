 ...
 * Require check in allows a meeting room’s Alexa or AVS device to prompt the
 * user to check in; otherwise, the room will be released.
 * </p>
 */
public class RequireCheckIn implements Serializable {
    /**
     * <p>
