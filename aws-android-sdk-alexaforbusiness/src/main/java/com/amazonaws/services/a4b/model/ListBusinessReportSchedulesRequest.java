 ...
 * the report associated with each schedule is returned every time this action
 * is called. A new download URL is returned each time, and is valid for 24
 * hours.
 * </p>
 */
public class ListBusinessReportSchedulesRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
