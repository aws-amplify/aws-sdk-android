...
/**
 * JSON unmarshaller for response RejectSkillResult
 */
public class RejectSkillResultJsonUnmarshaller implements
        Unmarshaller<RejectSkillResult, JsonUnmarshallerContext> {
