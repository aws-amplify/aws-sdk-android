 ...
 * room profile to the device, and all the skills in any skill groups added to
 * that room. This operation requires the device to be online, or else a manual
 * sync is required.
 * </p>
 */
public class AssociateDeviceWithRoomRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
