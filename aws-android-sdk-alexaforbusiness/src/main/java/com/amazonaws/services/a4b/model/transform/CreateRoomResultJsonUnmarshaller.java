...
/**
 * JSON unmarshaller for response CreateRoomResult
 */
public class CreateRoomResultJsonUnmarshaller implements
        Unmarshaller<CreateRoomResult, JsonUnmarshallerContext> {
    ...
    public CreateRoomResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RoomArn")) {
                createRoomResult.setRoomArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
