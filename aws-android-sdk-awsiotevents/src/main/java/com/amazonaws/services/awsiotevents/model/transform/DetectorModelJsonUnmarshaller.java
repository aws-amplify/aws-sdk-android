...
/**
 * JSON unmarshaller for POJO DetectorModel
 */
class DetectorModelJsonUnmarshaller implements Unmarshaller<DetectorModel, JsonUnmarshallerContext> {
    ...
    public DetectorModel unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("detectorModelDefinition")) {
                detectorModel.setDetectorModelDefinition(DetectorModelDefinitionJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("detectorModelConfiguration")) {
                detectorModel
                        .setDetectorModelConfiguration(DetectorModelConfigurationJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
