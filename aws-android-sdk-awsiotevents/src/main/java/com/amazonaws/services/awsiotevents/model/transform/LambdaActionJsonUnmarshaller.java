...
/**
 * JSON unmarshaller for POJO LambdaAction
 */
    ...
    public LambdaAction unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("functionArn")) {
                lambdaAction.setFunctionArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("payload")) {
                lambdaAction.setPayload(PayloadJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
