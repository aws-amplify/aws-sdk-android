    ...
    public IotSiteWiseAction unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("entryId")) {
                iotSiteWiseAction.setEntryId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("assetId")) {
                iotSiteWiseAction.setAssetId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("propertyId")) {
                iotSiteWiseAction.setPropertyId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("propertyAlias")) {
                iotSiteWiseAction.setPropertyAlias(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("propertyValue")) {
                iotSiteWiseAction.setPropertyValue(AssetPropertyValueJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
