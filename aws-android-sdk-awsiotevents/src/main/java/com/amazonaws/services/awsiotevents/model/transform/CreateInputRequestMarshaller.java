...
public class CreateInputRequestMarshaller implements
    ...
    public Request<CreateInputRequest> marshall(CreateInputRequest createInputRequest) {
        ...
        Request<CreateInputRequest> request = new DefaultRequest<CreateInputRequest>(
                createInputRequest, "AWSIoTEvents");
        ...
        try {
            ...
            if (createInputRequest.getInputName() != null) {
                String inputName = createInputRequest.getInputName();
                jsonWriter.name("inputName");
                jsonWriter.value(inputName);
            }
            if (createInputRequest.getInputDescription() != null) {
                String inputDescription = createInputRequest.getInputDescription();
                jsonWriter.name("inputDescription");
                jsonWriter.value(inputDescription);
            }
            if (createInputRequest.getInputDefinition() != null) {
                InputDefinition inputDefinition = createInputRequest.getInputDefinition();
                jsonWriter.name("inputDefinition");
                InputDefinitionJsonMarshaller.getInstance().marshall(inputDefinition, jsonWriter);
            }
            if (createInputRequest.getTags() != null) {
                java.util.List<Tag> tags = createInputRequest.getTags();
