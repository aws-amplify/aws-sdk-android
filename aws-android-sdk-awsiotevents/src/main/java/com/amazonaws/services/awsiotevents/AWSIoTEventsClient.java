...
public class AWSIoTEventsClient extends AmazonWebServiceClient implements AWSIoTEvents {
    ...
    private void init() {
        ...
        jsonErrorUnmarshallers.add(new TagrisAccessDeniedExceptionUnmarshaller());
        jsonErrorUnmarshallers.add(new TagrisInternalServiceExceptionUnmarshaller());
        jsonErrorUnmarshallers.add(new TagrisInvalidArnExceptionUnmarshaller());
        jsonErrorUnmarshallers.add(new TagrisInvalidParameterExceptionUnmarshaller());
        jsonErrorUnmarshallers.add(new TagrisPartialResourcesExistResultsExceptionUnmarshaller());
        jsonErrorUnmarshallers.add(new TagrisThrottledExceptionUnmarshaller());
     ...
     * @return verifyResourcesExistForTagrisResult The response from the
     *         VerifyResourcesExistForTagris service method, as returned by AWS
     *         IoT Events.
     ...
     *             request, or a server side issue.
     */
    public VerifyResourcesExistForTagrisResult verifyResourcesExistForTagris(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new VerifyResourcesExistForTagrisRequestMarshaller()
                        .marshall(verifyResourcesExistForTagrisRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<VerifyResourcesExistForTagrisResult, JsonUnmarshallerContext> unmarshaller = new VerifyResourcesExistForTagrisResultJsonUnmarshaller();
            JsonResponseHandler<VerifyResourcesExistForTagrisResult> responseHandler = new JsonResponseHandler<VerifyResourcesExistForTagrisResult>(
                    unmarshaller);
