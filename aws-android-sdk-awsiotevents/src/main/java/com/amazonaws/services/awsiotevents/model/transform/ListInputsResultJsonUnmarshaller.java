...
/**
 * JSON unmarshaller for response ListInputsResult
 */
public class ListInputsResultJsonUnmarshaller implements
        Unmarshaller<ListInputsResult, JsonUnmarshallerContext> {
    ...
    public ListInputsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("inputSummaries")) {
                listInputsResult.setInputSummaries(new ListUnmarshaller<InputSummary>(
                        InputSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                listInputsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
