...
public class UpdateInputRequestMarshaller implements
    ...
    public Request<UpdateInputRequest> marshall(UpdateInputRequest updateInputRequest) {
        ...
        Request<UpdateInputRequest> request = new DefaultRequest<UpdateInputRequest>(
                updateInputRequest, "AWSIoTEvents");
        request.setHttpMethod(HttpMethodName.PUT);

        String uriResourcePath = "/inputs/{inputName}";
        uriResourcePath = uriResourcePath.replace(
                "{inputName}",
                (updateInputRequest.getInputName() == null) ? "" : StringUtils
                        .fromString(updateInputRequest.getInputName()));
        ...
        try {
            ...
            if (updateInputRequest.getInputDescription() != null) {
                String inputDescription = updateInputRequest.getInputDescription();
                jsonWriter.name("inputDescription");
                jsonWriter.value(inputDescription);
            }
            if (updateInputRequest.getInputDefinition() != null) {
                InputDefinition inputDefinition = updateInputRequest.getInputDefinition();
