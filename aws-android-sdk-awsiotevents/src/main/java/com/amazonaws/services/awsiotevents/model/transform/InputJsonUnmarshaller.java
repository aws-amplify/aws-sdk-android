    ...
    public Input unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("inputConfiguration")) {
                input.setInputConfiguration(InputConfigurationJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("inputDefinition")) {
                input.setInputDefinition(InputDefinitionJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
