...
public class ListDetectorModelVersionsResult implements Serializable {
    /**
     * <p>
     ...
     * </p>
     *
     * @param detectorModelVersionSummaries <p>
     *            Summary information about the detector model versions.
     *            </p>
     */
    public void setDetectorModelVersionSummaries(
            java.util.Collection<DetectorModelVersionSummary> detectorModelVersionSummaries) {
        if (detectorModelVersionSummaries == null) {
            this.detectorModelVersionSummaries = null;
            return;
        }

        this.detectorModelVersionSummaries = new java.util.ArrayList<DetectorModelVersionSummary>(
     ...
     *         chained together.
     */
    public ListDetectorModelVersionsResult withDetectorModelVersionSummaries(
            DetectorModelVersionSummary... detectorModelVersionSummaries) {
        if (getDetectorModelVersionSummaries() == null) {
            this.detectorModelVersionSummaries = new java.util.ArrayList<DetectorModelVersionSummary>(
                    detectorModelVersionSummaries.length);
        }
        for (DetectorModelVersionSummary value : detectorModelVersionSummaries) {
            this.detectorModelVersionSummaries.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getDetectorModelVersionSummaries() != null)
            sb.append("detectorModelVersionSummaries: " + getDetectorModelVersionSummaries() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getDetectorModelVersionSummaries() == null) ? 0
                        : getDetectorModelVersionSummaries().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDetectorModelVersionSummaries() == null
                ^ this.getDetectorModelVersionSummaries() == null)
            return false;
        if (other.getDetectorModelVersionSummaries() != null
                && other.getDetectorModelVersionSummaries().equals(
                        this.getDetectorModelVersionSummaries()) == false)
            return false;
