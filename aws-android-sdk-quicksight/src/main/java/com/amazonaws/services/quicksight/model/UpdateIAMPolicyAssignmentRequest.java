 ...
 * </p>
 */
public class UpdateIAMPolicyAssignmentRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         The ID of the AWS account that contains the IAM policy
     *         assignment.
     *         </p>
     */
     ...
     *
     * @return <p>
     *         The name of the assignment. This name must be unique within an
     *         AWS account.
     *         </p>
     */
     ...
     *         chained together.
     */
    public UpdateIAMPolicyAssignmentRequest withIdentities(
     ...
     *         chained together.
     */
    public UpdateIAMPolicyAssignmentRequest addIdentitiesEntry(String key,
