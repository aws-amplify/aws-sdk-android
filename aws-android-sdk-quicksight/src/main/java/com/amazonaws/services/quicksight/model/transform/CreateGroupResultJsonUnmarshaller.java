...
/**
 * JSON unmarshaller for response CreateGroupResult
 */
public class CreateGroupResultJsonUnmarshaller implements
        Unmarshaller<CreateGroupResult, JsonUnmarshallerContext> {
    ...
    public CreateGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Group")) {
                createGroupResult.setGroup(GroupJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("RequestId")) {
                createGroupResult.setRequestId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Status")) {
                createGroupResult.setStatus(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
