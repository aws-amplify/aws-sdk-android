...
public class CreateTemplateRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         The Amazon Resource Name (ARN) of the source entity from which
     *         this template is being created. Currently, you can create a
     *         template from an analysis or another template. If the ARN is for
     *         an analysis, include its dataset references.
     *         </p>
     */
     ...
     *            The Amazon Resource Name (ARN) of the source entity from which
     *            this template is being created. Currently, you can create a
     *            template from an analysis or another template. If the ARN is
     *            for an analysis, include its dataset references.
     *            </p>
     */
