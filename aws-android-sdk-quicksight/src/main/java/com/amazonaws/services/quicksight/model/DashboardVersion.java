 ...
 * </p>
 */
public class DashboardVersion implements Serializable {
    /**
     * <p>
     ...
     * with a version of the dashboard.
     * </p>
     */
    ...
    public DashboardVersion withErrors(DashboardError... errors) {
        if (getErrors() == null) {
            this.errors = new java.util.ArrayList<DashboardError>(errors.length);
        }
        for (DashboardError value : errors) {
    ...
    public DashboardVersion withDataSetArns(String... dataSetArns) {
        if (getDataSetArns() == null) {
            this.dataSetArns = new java.util.ArrayList<String>(dataSetArns.length);
        }
        for (String value : dataSetArns) {
            this.dataSetArns.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        if (getDataSetArns() != null)
            sb.append("DataSetArns: " + getDataSetArns() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getDataSetArns() == null) ? 0 : getDataSetArns().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDataSetArns() == null ^ this.getDataSetArns() == null)
            return false;
        if (other.getDataSetArns() != null
                && other.getDataSetArns().equals(this.getDataSetArns()) == false)
            return false;
