...
public class DescribeIAMPolicyAssignmentResult implements Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public DescribeIAMPolicyAssignmentResult withIAMPolicyAssignment(
    ...
    public String toString() {
        ...
        if (getIAMPolicyAssignment() != null)
            sb.append("IAMPolicyAssignment: " + getIAMPolicyAssignment() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getIAMPolicyAssignment() == null) ? 0 : getIAMPolicyAssignment().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getIAMPolicyAssignment() == null ^ this.getIAMPolicyAssignment() == null)
            return false;
        if (other.getIAMPolicyAssignment() != null
                && other.getIAMPolicyAssignment().equals(this.getIAMPolicyAssignment()) == false)
            return false;
