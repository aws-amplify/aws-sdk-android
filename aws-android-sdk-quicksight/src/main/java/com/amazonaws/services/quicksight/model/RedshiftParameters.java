 ...
 * and <code>Port</code> fields can be blank if the <code>ClusterId</code> field
 * is set.
 * </p>
 */
public class RedshiftParameters implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         Host. This field can be blank if <code>ClusterId</code> is
     *         provided.
     *         </p>
     */
     ...
     *
     * @return <p>
     *         Port. This field can be blank if the <code>ClusterId</code> is
     *         provided.
     *         </p>
     */
     ...
     *
     * @param clusterId <p>
     *            Cluster ID. This field can be blank if the <code>Host</code>
     *            and <code>Port</code> are provided.
     *            </p>
     */
