...
public class UpdateGroupRequestMarshaller implements
    ...
    public Request<UpdateGroupRequest> marshall(UpdateGroupRequest updateGroupRequest) {
        ...
        Request<UpdateGroupRequest> request = new DefaultRequest<UpdateGroupRequest>(
                updateGroupRequest, "AmazonQuickSight");
        request.setHttpMethod(HttpMethodName.PUT);

        String uriResourcePath = "/accounts/{AwsAccountId}/namespaces/{Namespace}/groups/{GroupName}";
        uriResourcePath = uriResourcePath.replace(
                "{GroupName}",
                (updateGroupRequest.getGroupName() == null) ? "" : StringUtils
                        .fromString(updateGroupRequest.getGroupName()));
        uriResourcePath = uriResourcePath.replace(
                "{AwsAccountId}",
                (updateGroupRequest.getAwsAccountId() == null) ? "" : StringUtils
                        .fromString(updateGroupRequest.getAwsAccountId()));
        uriResourcePath = uriResourcePath.replace(
                "{Namespace}",
                (updateGroupRequest.getNamespace() == null) ? "" : StringUtils
                        .fromString(updateGroupRequest.getNamespace()));
