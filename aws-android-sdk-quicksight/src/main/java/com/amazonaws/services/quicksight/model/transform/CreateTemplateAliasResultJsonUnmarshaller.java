...
/**
 * JSON unmarshaller for response CreateTemplateAliasResult
 */
public class CreateTemplateAliasResultJsonUnmarshaller implements
        Unmarshaller<CreateTemplateAliasResult, JsonUnmarshallerContext> {
    ...
    public CreateTemplateAliasResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("TemplateAlias")) {
                createTemplateAliasResult.setTemplateAlias(TemplateAliasJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Status")) {
                createTemplateAliasResult.setStatus(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("RequestId")) {
                createTemplateAliasResult.setRequestId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
