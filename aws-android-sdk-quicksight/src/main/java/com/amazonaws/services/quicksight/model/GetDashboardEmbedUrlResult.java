...
public class GetDashboardEmbedUrlResult implements Serializable {
    /**
     * <p>
     ...
     * with an <code>auth_code</code> value that enables one (and only one)
     ...
     *
     * @return <p>
     *         A single-use URL that you can put into your server-side webpage
     *         to embed your dashboard. This URL is valid for 5 minutes. The API
     *         provides the URL with an <code>auth_code</code> value that
     *         enables one (and only one) sign-on to a user session that is
     *         valid for 10 hours.
     *         </p>
     */
     ...
     *
     * @param embedUrl <p>
     *            A single-use URL that you can put into your server-side
     *            webpage to embed your dashboard. This URL is valid for 5
     *            minutes. The API provides the URL with an
     *            <code>auth_code</code> value that enables one (and only one)
     *            sign-on to a user session that is valid for 10 hours.
     *            </p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getEmbedUrl() != null)
            sb.append("EmbedUrl: " + getEmbedUrl() + ",");
        if (getStatus() != null)
