...
public class UpdateDashboardRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * @return <p>
     *         The template or analysis from which the dashboard is created. The
     *         <code>SouceTemplate</code> entity accepts the Amazon Resource
     *         Name (ARN) of the template and also references to replacement
     *         datasets for the placeholders set when creating the template. The
     ...
     *            The <code>SouceTemplate</code> entity accepts the Amazon
     *            Resource Name (ARN) of the template and also references to
