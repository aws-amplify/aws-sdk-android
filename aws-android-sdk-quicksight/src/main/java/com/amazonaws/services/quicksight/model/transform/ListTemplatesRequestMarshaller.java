...
public class ListTemplatesRequestMarshaller implements
    ...
    public Request<ListTemplatesRequest> marshall(ListTemplatesRequest listTemplatesRequest) {
        ...
        Request<ListTemplatesRequest> request = new DefaultRequest<ListTemplatesRequest>(
                listTemplatesRequest, "AmazonQuickSight");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/accounts/{AwsAccountId}/templates";
        uriResourcePath = uriResourcePath.replace(
                "{AwsAccountId}",
                (listTemplatesRequest.getAwsAccountId() == null) ? "" : StringUtils
                        .fromString(listTemplatesRequest.getAwsAccountId()));
        ...
        if (listTemplatesRequest.getMaxResults() != null) {
            request.addParameter("max-result",
                    StringUtils.fromInteger(listTemplatesRequest.getMaxResults()));
        }
