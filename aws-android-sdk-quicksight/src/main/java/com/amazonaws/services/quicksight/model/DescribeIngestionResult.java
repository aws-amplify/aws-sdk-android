...
public class DescribeIngestionResult implements Serializable {
    /**
     * <p>
    ...
    public String toString() {
        ...
        if (getIngestion() != null)
            sb.append("Ingestion: " + getIngestion() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getIngestion() == null ^ this.getIngestion() == null)
            return false;
        if (other.getIngestion() != null
                && other.getIngestion().equals(this.getIngestion()) == false)
            return false;
