...
/**
 * JSON unmarshaller for POJO GroupMember
 */
class GroupMemberJsonUnmarshaller implements Unmarshaller<GroupMember, JsonUnmarshallerContext> {
    ...
    public GroupMember unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Arn")) {
                groupMember.setArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("MemberName")) {
                groupMember.setMemberName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
