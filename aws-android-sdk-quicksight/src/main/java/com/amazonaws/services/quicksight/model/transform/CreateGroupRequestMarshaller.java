...
/**
 * JSON request marshaller for CreateGroupRequest
 */
public class CreateGroupRequestMarshaller implements
    ...
    public Request<CreateGroupRequest> marshall(CreateGroupRequest createGroupRequest) {
        ...
        Request<CreateGroupRequest> request = new DefaultRequest<CreateGroupRequest>(
                createGroupRequest, "AmazonQuickSight");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/accounts/{AwsAccountId}/namespaces/{Namespace}/groups";
        uriResourcePath = uriResourcePath.replace(
                "{AwsAccountId}",
                (createGroupRequest.getAwsAccountId() == null) ? "" : StringUtils
                        .fromString(createGroupRequest.getAwsAccountId()));
        uriResourcePath = uriResourcePath.replace(
                "{Namespace}",
                (createGroupRequest.getNamespace() == null) ? "" : StringUtils
                        .fromString(createGroupRequest.getNamespace()));
