...
/**
 * JSON unmarshaller for response DeleteGroupResult
 */
public class DeleteGroupResultJsonUnmarshaller implements
        Unmarshaller<DeleteGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RequestId")) {
                deleteGroupResult.setRequestId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Status")) {
                deleteGroupResult.setStatus(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
