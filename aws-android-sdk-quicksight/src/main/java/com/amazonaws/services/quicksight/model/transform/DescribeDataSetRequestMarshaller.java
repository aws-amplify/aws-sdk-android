...
public class DescribeDataSetRequestMarshaller implements
    ...
    public Request<DescribeDataSetRequest> marshall(DescribeDataSetRequest describeDataSetRequest) {
        ...
        Request<DescribeDataSetRequest> request = new DefaultRequest<DescribeDataSetRequest>(
                describeDataSetRequest, "AmazonQuickSight");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/accounts/{AwsAccountId}/data-sets/{DataSetId}";
        uriResourcePath = uriResourcePath.replace(
                "{AwsAccountId}",
                (describeDataSetRequest.getAwsAccountId() == null) ? "" : StringUtils
                        .fromString(describeDataSetRequest.getAwsAccountId()));
        uriResourcePath = uriResourcePath.replace(
                "{DataSetId}",
                (describeDataSetRequest.getDataSetId() == null) ? "" : StringUtils
                        .fromString(describeDataSetRequest.getDataSetId()));
