...
public class ListGroupMembershipsResult implements Serializable {
    /**
     * <p>
    ...
    public ListGroupMembershipsResult withGroupMemberList(GroupMember... groupMemberList) {
        if (getGroupMemberList() == null) {
            this.groupMemberList = new java.util.ArrayList<GroupMember>(groupMemberList.length);
        }
        for (GroupMember value : groupMemberList) {
            this.groupMemberList.add(value);
        }
        return this;
    }
     ...
     *         chained together.
     */
    public ListGroupMembershipsResult withGroupMemberList(
            java.util.Collection<GroupMember> groupMemberList) {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getGroupMemberList() != null)
            sb.append("GroupMemberList: " + getGroupMemberList() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getGroupMemberList() == null) ? 0 : getGroupMemberList().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getGroupMemberList() == null ^ this.getGroupMemberList() == null)
            return false;
        if (other.getGroupMemberList() != null
                && other.getGroupMemberList().equals(this.getGroupMemberList()) == false)
            return false;
