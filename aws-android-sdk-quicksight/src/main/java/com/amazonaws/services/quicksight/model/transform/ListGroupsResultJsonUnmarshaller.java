    ...
    public ListGroupsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("GroupList")) {
                listGroupsResult.setGroupList(new ListUnmarshaller<Group>(GroupJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
                ...
                listGroupsResult.setRequestId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Status")) {
                listGroupsResult.setStatus(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
