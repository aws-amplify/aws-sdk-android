...
public class ListUsersRequestMarshaller implements
    ...
    public Request<ListUsersRequest> marshall(ListUsersRequest listUsersRequest) {
        ...
        uriResourcePath = uriResourcePath.replace(
                "{AwsAccountId}",
                (listUsersRequest.getAwsAccountId() == null) ? "" : StringUtils
                        .fromString(listUsersRequest.getAwsAccountId()));
        ...
        uriResourcePath = uriResourcePath.replace(
                "{Namespace}",
                (listUsersRequest.getNamespace() == null) ? "" : StringUtils
                        .fromString(listUsersRequest.getNamespace()));
