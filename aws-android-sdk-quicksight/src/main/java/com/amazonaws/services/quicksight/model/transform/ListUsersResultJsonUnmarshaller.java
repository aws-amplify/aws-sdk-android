    ...
    public ListUsersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("UserList")) {
                listUsersResult.setUserList(new ListUnmarshaller<User>(UserJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
                ...
                listUsersResult.setRequestId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Status")) {
                listUsersResult.setStatus(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
