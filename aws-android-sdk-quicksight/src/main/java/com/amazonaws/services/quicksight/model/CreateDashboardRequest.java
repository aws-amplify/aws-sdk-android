...
public class CreateDashboardRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * and also references the replacement datasets for the placeholders set
     * when creating the template. The replacement datasets need to follow the
     ...
     *         values. You can use the dashboard permissions structure described
     *         following to override two string parameters that accept multiple
     *         values.
     *         </p>
     */
     ...
     *            multiple values. You can use the dashboard permissions
     *            structure described following to override two string
     ...
     *         entity accepts the Amazon Resource Name (ARN) of the source
     *         template or analysis and also references the replacement datasets
     *         for the placeholders set when creating the template. The
     *         replacement datasets need to follow the same schema as the
     *         datasets for which placeholders were created when creating the
     *         template.
     *         </p>
     *         <p>
     *         If you are creating a dashboard from a source entity in a
     *         different AWS account, use the ARN of the source template.
     *         </p>
     */
     ...
     *            The source entity from which the dashboard is created. The
     *            source entity accepts the Amazon Resource Name (ARN) of the
     *            source template or analysis and also references the
     *            replacement datasets for the placeholders set when creating
     *            the template. The replacement datasets need to follow the same
     *            schema as the datasets for which placeholders were created
     ...
     *         <code>EXPANDED</code>. The sheet controls pane is collapsed by
     *         default when set to true. This option is <code>COLLAPSED</code>
     *         by default.
     *         </p>
     *         </li>
     *         </ul>
     ...
     *            be either <code>COLLAPSED</code> or <code>EXPANDED</code>. The
     *            sheet controls pane is collapsed by default when set to true.
