...
public class DataSource implements Serializable {
     ...
     * using a create or update request. The API compares the
     * <code>DataSourceParameters</code> structure that's in the request with
     * the structures in the <code>AlternateDataSourceParameters</code>
     * allowlist. If the structures are an exact match, the request is allowed
     ...
     *         for the credentials stored with this data source. The credentials
     *         are applied in tandem with the data source parameters when you
     *         copy a data source by using a create or update request. The API
     *         compares the <code>DataSourceParameters</code> structure that's
     *         in the request with the structures in the
     ...
     *            parameters when you copy a data source by using a create or
     *            update request. The API compares the
     *            <code>DataSourceParameters</code> structure that's in the
     ...
     *         chained together.
     */
    public DataSource withAlternateDataSourceParameters(
