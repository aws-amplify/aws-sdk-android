...
package com.amazonaws.services.data.iot;
...
import com.amazonaws.services.data.iot.model.*;
import com.amazonaws.services.data.iot.model.transform.*;
 ...
 * </p>
 */
public class AWSIoTDataPlaneClient extends AmazonWebServiceClient implements AWSIoTDataPlane {
    ...
    /**
     * Constructs a new client to invoke service methods on AWSIoTDataPlane. A
     ...
     *            how this client connects to AWSIoTDataPlane (ex: proxy
     *            settings, retry counts, etc.).
     * @see DefaultAWSCredentialsProviderChain
     */
    @Deprecated
    public AWSIoTDataPlaneClient(ClientConfiguration clientConfiguration) {
        this(new DefaultAWSCredentialsProviderChain(), clientConfiguration);
    }

    /**
     * Constructs a new client to invoke service methods on AWSIoTDataPlane
     ...
     *         AWSIoTDataPlaneClient client = new AWSIoTDataPlaneClient(AWSMobileClient.getInstance());
     *     }
     * 
     *     &#064;Override
     ...
     */
    public AWSIoTDataPlaneClient(AWSCredentials awsCredentials) {
     ...
     *            services.
     */
    public AWSIoTDataPlaneClient(AWSCredentialsProvider awsCredentialsProvider) {
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/data.iot/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/data.iot/request.handler2s"));
    }
     ...
     *         service method, as returned by AWS IoT Data Plane.
     ...
     *             IoT Data Plane indicating either a problem with the data in
     ...
     *         method, as returned by AWS IoT Data Plane.
     * @throws InvalidRequestException
     * @throws ResourceNotFoundException
     * @throws ThrottlingException
     * @throws UnauthorizedException
