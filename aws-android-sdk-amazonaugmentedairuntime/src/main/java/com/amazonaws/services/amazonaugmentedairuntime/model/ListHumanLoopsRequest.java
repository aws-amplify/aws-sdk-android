 ...
 * </p>
 */
public class ListHumanLoopsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * loops to begin in ISO 8601 format. For example, <code>2020-02-24</code>.
     * </p>
     */
     ...
     *
     * @return <p>
     *         (Optional) The timestamp of the date when you want the human
     ...
     *
     * @return <p>
     *         (Optional) The timestamp of the date before which you want the
     ...
     *         <code>MaxResults</code>, then a <code>NextToken</code> is
     *         returned in the output. You can use this token to display the
