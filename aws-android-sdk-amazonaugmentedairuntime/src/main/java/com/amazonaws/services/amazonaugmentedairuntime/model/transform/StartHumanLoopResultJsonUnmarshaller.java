...
/**
 * JSON unmarshaller for response StartHumanLoopResult
 */
public class StartHumanLoopResultJsonUnmarshaller implements
        Unmarshaller<StartHumanLoopResult, JsonUnmarshallerContext> {
    ...
    public StartHumanLoopResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("HumanLoopArn")) {
                startHumanLoopResult.setHumanLoopArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
