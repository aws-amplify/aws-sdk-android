...
/**
 * JSON unmarshaller for response DeleteHumanLoopResult
 */
public class DeleteHumanLoopResultJsonUnmarshaller implements
        Unmarshaller<DeleteHumanLoopResult, JsonUnmarshallerContext> {
