...
/**
 * JSON unmarshaller for POJO HumanLoopOutput
 */
class HumanLoopOutputJsonUnmarshaller implements
        Unmarshaller<HumanLoopOutput, JsonUnmarshallerContext> {
    ...
    public HumanLoopOutput unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("OutputS3Uri")) {
                humanLoopOutput.setOutputS3Uri(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
