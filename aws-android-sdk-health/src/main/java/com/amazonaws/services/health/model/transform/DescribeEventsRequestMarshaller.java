...
/**
 * JSON request marshaller for DescribeEventsRequest
 */
public class DescribeEventsRequestMarshaller implements
    ...
    public Request<DescribeEventsRequest> marshall(DescribeEventsRequest describeEventsRequest) {
        ...
        Request<DescribeEventsRequest> request = new DefaultRequest<DescribeEventsRequest>(
                describeEventsRequest, "AWSHealthAPIsandNotifications");
        ...
        try {
            ...
            if (describeEventsRequest.getFilter() != null) {
                EventFilter filter = describeEventsRequest.getFilter();
            ...
            if (describeEventsRequest.getMaxResults() != null) {
                Integer maxResults = describeEventsRequest.getMaxResults();
                jsonWriter.name("maxResults");
                jsonWriter.value(maxResults);
            }
            if (describeEventsRequest.getLocale() != null) {
                String locale = describeEventsRequest.getLocale();
