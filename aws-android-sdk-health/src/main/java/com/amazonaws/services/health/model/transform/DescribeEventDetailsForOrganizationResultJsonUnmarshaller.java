...
/**
 * JSON unmarshaller for response DescribeEventDetailsForOrganizationResult
 */
public class DescribeEventDetailsForOrganizationResultJsonUnmarshaller implements
    ...
    public DescribeEventDetailsForOrganizationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("successfulSet")) {
                describeEventDetailsForOrganizationResult
                        .setSuccessfulSet(new ListUnmarshaller<OrganizationEventDetails>(
                                OrganizationEventDetailsJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("failedSet")) {
                describeEventDetailsForOrganizationResult
                        .setFailedSet(new ListUnmarshaller<OrganizationEventDetailsErrorItem>(
