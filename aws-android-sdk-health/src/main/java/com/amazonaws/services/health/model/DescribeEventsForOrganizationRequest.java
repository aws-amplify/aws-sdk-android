 ...
 * Organizations, meeting the specified filter criteria. Events are returned in
 * a summary form and do not include the accounts impacted, detailed
 ...
 * </p>
 * <p>
 * If no filter criteria are specified, all events across your organization are
 * returned. Results are sorted by <code>lastModifiedTime</code>, starting with
 * the most recent.
 * </p>
 * <p>
 * Before you can call this operation, you must first enable Health to work with
 * AWS Organizations. To do this, call the
 * <a>EnableHealthServiceAccessForOrganization</a> operation from your
 * organization's master account.
 * </p>
 */
public class DescribeEventsForOrganizationRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
