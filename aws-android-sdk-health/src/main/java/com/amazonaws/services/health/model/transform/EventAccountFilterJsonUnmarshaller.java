...
/**
 * JSON unmarshaller for POJO EventAccountFilter
 */
class EventAccountFilterJsonUnmarshaller implements
        Unmarshaller<EventAccountFilter, JsonUnmarshallerContext> {
    ...
    public EventAccountFilter unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("eventArn")) {
                eventAccountFilter.setEventArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("awsAccountId")) {
                eventAccountFilter.setAwsAccountId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
