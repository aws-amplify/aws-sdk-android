...
public class CreateServiceRequestMarshaller implements
    ...
    public Request<CreateServiceRequest> marshall(CreateServiceRequest createServiceRequest) {
        ...
        Request<CreateServiceRequest> request = new DefaultRequest<CreateServiceRequest>(
                createServiceRequest, "AWSCloudMap");
        ...
        try {
            ...
            if (createServiceRequest.getName() != null) {
                String name = createServiceRequest.getName();
                jsonWriter.name("Name");
                jsonWriter.value(name);
            }
            if (createServiceRequest.getNamespaceId() != null) {
                String namespaceId = createServiceRequest.getNamespaceId();
                jsonWriter.name("NamespaceId");
                jsonWriter.value(namespaceId);
            }
            if (createServiceRequest.getCreatorRequestId() != null) {
                String creatorRequestId = createServiceRequest.getCreatorRequestId();
                jsonWriter.name("CreatorRequestId");
                jsonWriter.value(creatorRequestId);
            }
            if (createServiceRequest.getDescription() != null) {
                String description = createServiceRequest.getDescription();
                jsonWriter.name("Description");
                jsonWriter.value(description);
            }
            if (createServiceRequest.getDnsConfig() != null) {
                DnsConfig dnsConfig = createServiceRequest.getDnsConfig();
                jsonWriter.name("DnsConfig");
                DnsConfigJsonMarshaller.getInstance().marshall(dnsConfig, jsonWriter);
            }
            if (createServiceRequest.getHealthCheckConfig() != null) {
                HealthCheckConfig healthCheckConfig = createServiceRequest.getHealthCheckConfig();
                jsonWriter.name("HealthCheckConfig");
                HealthCheckConfigJsonMarshaller.getInstance().marshall(healthCheckConfig,
                        jsonWriter);
            }
            if (createServiceRequest.getHealthCheckCustomConfig() != null) {
                HealthCheckCustomConfig healthCheckCustomConfig = createServiceRequest
                        .getHealthCheckCustomConfig();
                jsonWriter.name("HealthCheckCustomConfig");
                HealthCheckCustomConfigJsonMarshaller.getInstance().marshall(
                        healthCheckCustomConfig, jsonWriter);
            }
