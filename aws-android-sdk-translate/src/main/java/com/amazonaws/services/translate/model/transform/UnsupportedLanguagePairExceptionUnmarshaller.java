...
public class UnsupportedLanguagePairExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public UnsupportedLanguagePairExceptionUnmarshaller() {
        super(UnsupportedLanguagePairException.class);
    }

    @Override
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("UnsupportedLanguagePairException");
    }
