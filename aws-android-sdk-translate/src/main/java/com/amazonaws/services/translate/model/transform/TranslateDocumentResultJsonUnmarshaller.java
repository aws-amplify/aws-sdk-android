...
/**
 * JSON unmarshaller for response TranslateDocumentResult
 */
public class TranslateDocumentResultJsonUnmarshaller implements
        Unmarshaller<TranslateDocumentResult, JsonUnmarshallerContext> {
    ...
    public TranslateDocumentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("TranslatedDocument")) {
                translateDocumentResult.setTranslatedDocument(TranslatedDocumentJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("SourceLanguageCode")) {
                translateDocumentResult.setSourceLanguageCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TargetLanguageCode")) {
                translateDocumentResult.setTargetLanguageCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                translateDocumentResult.setAppliedSettings(TranslationSettingsJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
