...
/**
 * JSON unmarshaller for response UpdateParallelDataResult
 */
public class UpdateParallelDataResultJsonUnmarshaller implements
        Unmarshaller<UpdateParallelDataResult, JsonUnmarshallerContext> {
    ...
    public UpdateParallelDataResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                updateParallelDataResult.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Status")) {
                updateParallelDataResult.setStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("LatestUpdateAttemptStatus")) {
                updateParallelDataResult.setLatestUpdateAttemptStatus(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("LatestUpdateAttemptAt")) {
                updateParallelDataResult.setLatestUpdateAttemptAt(DateJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
