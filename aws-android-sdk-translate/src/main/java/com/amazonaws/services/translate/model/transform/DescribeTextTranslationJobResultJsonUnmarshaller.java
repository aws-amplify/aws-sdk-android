...
/**
 * JSON unmarshaller for response DescribeTextTranslationJobResult
 */
public class DescribeTextTranslationJobResultJsonUnmarshaller implements
        Unmarshaller<DescribeTextTranslationJobResult, JsonUnmarshallerContext> {

    public DescribeTextTranslationJobResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("TextTranslationJobProperties")) {
                describeTextTranslationJobResult
                        .setTextTranslationJobProperties(TextTranslationJobPropertiesJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
