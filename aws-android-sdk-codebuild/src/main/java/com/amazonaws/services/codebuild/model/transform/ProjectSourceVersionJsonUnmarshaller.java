...
/**
 * JSON unmarshaller for POJO ProjectSourceVersion
 */
class ProjectSourceVersionJsonUnmarshaller implements
        Unmarshaller<ProjectSourceVersion, JsonUnmarshallerContext> {
    ...
    public ProjectSourceVersion unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("sourceIdentifier")) {
                projectSourceVersion.setSourceIdentifier(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("sourceVersion")) {
                projectSourceVersion.setSourceVersion(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
