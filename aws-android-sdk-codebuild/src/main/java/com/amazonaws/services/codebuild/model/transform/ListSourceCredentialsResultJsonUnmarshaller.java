...
/**
 * JSON unmarshaller for response ListSourceCredentialsResult
 */
public class ListSourceCredentialsResultJsonUnmarshaller implements
        Unmarshaller<ListSourceCredentialsResult, JsonUnmarshallerContext> {
    ...
    public ListSourceCredentialsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("sourceCredentialsInfos")) {
                listSourceCredentialsResult
                        .setSourceCredentialsInfos(new ListUnmarshaller<SourceCredentialsInfo>(
                                SourceCredentialsInfoJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
