 ...
 * </p>
 */
public class ListSharedProjectsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *         the shared project was last changed.
     *         </p>
     *         </li>
     *         </ul>
     ...
     *
     * @param sortBy <p>
     *            The criterion to be used to list build projects shared with
     *            the current AWS account or user. Valid values include:
     *            </p>
     *            <ul>
     *            <li>
     *            <p>
     ...
     *            about the shared project was last changed.
     *            </p>
     *            </li>
     *            </ul>
     * @see SharedResourceSortByType
     ...
     *
     * @return <p>
     *         The maximum number of paginated shared build projects returned
     *         per response. Use <code>nextToken</code> to iterate pages in the
     *         list of returned <code>Project</code> objects. The default value
     *         is 100.
     *         </p>
     */
     ...
     * @param maxResults <p>
     *            The maximum number of paginated shared build projects returned
     *            per response. Use <code>nextToken</code> to iterate pages in
     *            the list of returned <code>Project</code> objects. The default
     *            value is 100.
     *            </p>
     */
