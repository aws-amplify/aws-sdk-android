 ...
 * </p>
 */
public class BatchGetProjectsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         The names or ARNs of the build projects. To get information about
     *         a project shared with your AWS account, its ARN must be
     ...
     *
     * @param names <p>
     *            The names or ARNs of the build projects. To get information
     *            about a project shared with your AWS account, its ARN must be
     *            specified. You cannot specify a shared project using its name.
     *            </p>
     */
