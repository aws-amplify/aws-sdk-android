...
/**
 * JSON unmarshaller for POJO CloudWatchLogsConfig
 */
class CloudWatchLogsConfigJsonUnmarshaller implements
        Unmarshaller<CloudWatchLogsConfig, JsonUnmarshallerContext> {
    ...
    public CloudWatchLogsConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("status")) {
                cloudWatchLogsConfig.setStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("groupName")) {
                cloudWatchLogsConfig.setGroupName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("streamName")) {
                cloudWatchLogsConfig.setStreamName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
