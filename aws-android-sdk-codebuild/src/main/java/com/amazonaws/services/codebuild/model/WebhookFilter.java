...
public class WebhookFilter implements Serializable {
     ...
     *         <code>HEAD_REF</code>, <code>BASE_REF</code>,
     *         <code>FILE_PATH</code>, and <code>COMMIT_MESSAGE</code>.
     *         </p>
     *         <dl>
     *         <dt>EVENT</dt>
     *         <dd>
     ...
     *         the regular expression <code>pattern</code>.
     *         </p>
     *         <note>
     *         <p>
     *         Works with GitHub and Bitbucket events push and pull requests
     ...
     *            <p>
     *            Works with GitHub and Bitbucket events push and pull requests
     *            events. Also works with GitHub Enterprise push events, but
     *            does not work with GitHub Enterprise pull request events.
     *            </p>
     *            </note></dd>
     *            <dt>COMMIT_MESSAGE</dt>
     *            <dd>
