...
/**
 * JSON unmarshaller for POJO EnvironmentLanguage
 */
class EnvironmentLanguageJsonUnmarshaller implements
        Unmarshaller<EnvironmentLanguage, JsonUnmarshallerContext> {
    ...
    public EnvironmentLanguage unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("language")) {
                environmentLanguage.setLanguage(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("images")) {
                environmentLanguage.setImages(new ListUnmarshaller<EnvironmentImage>(
                        EnvironmentImageJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
