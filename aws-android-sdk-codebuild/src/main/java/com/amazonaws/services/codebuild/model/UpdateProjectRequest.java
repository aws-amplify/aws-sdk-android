...
public class UpdateProjectRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         Information to be changed about the build input source code for
     *         the build project.
     *         </p>
     */
     ...
     *
     * @param source <p>
     *            Information to be changed about the build input source code
     ...
     *         chained together.
     */
    public UpdateProjectRequest withSecondarySources(
     ...
     *         chained together.
     */
    public UpdateProjectRequest withSecondarySourceVersions(
     ...
     *
     * @return <p>
     *         Information to be changed about the build output artifacts for
     *         the build project.
     *         </p>
     */
     ...
     *         chained together.
     */
    public UpdateProjectRequest withSecondaryArtifacts(
     ...
     *
     * @return <p>
     *         Information to be changed about the build environment for the
     *         build project.
     *         </p>
     */
     ...
     *
     * @return <p>
     *         The replacement ARN of the AWS Identity and Access Management
     *         (IAM) role that enables AWS CodeBuild to interact with dependent
     ...
     * @param serviceRole <p>
     *            The replacement ARN of the AWS Identity and Access Management
     *            (IAM) role that enables AWS CodeBuild to interact with
     ...
     *         AWS CodeBuild to wait before timing out any related build that
     ...
     *
     * @param tags <p>
     *            An updated list of tag key and value pairs associated with
     *            this build project.
     *            </p>
     *            <p>
     ...
     *         create logs in Amazon CloudWatch Logs, logs in an S3 bucket, or
     *         both.
     *         </p>
     */
     ...
     * @param logsConfig <p>
     *            Information about logs for the build project. A project can
     *            create logs in Amazon CloudWatch Logs, logs in an S3 bucket,
     *            or both.
     *            </p>
     */
     ...
     *         chained together.
     */
    public UpdateProjectRequest withFileSystemLocations(
