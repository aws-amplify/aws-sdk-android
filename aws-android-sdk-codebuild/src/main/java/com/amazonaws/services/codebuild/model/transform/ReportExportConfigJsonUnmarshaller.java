...
/**
 * JSON unmarshaller for POJO ReportExportConfig
 */
class ReportExportConfigJsonUnmarshaller implements
        Unmarshaller<ReportExportConfig, JsonUnmarshallerContext> {
    ...
    public ReportExportConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("exportConfigType")) {
                reportExportConfig.setExportConfigType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("s3Destination")) {
                reportExportConfig.setS3Destination(S3ReportExportConfigJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
