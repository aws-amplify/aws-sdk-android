...
/**
 * JSON unmarshaller for POJO PhaseContext
 */
class PhaseContextJsonUnmarshaller implements Unmarshaller<PhaseContext, JsonUnmarshallerContext> {
    ...
    public PhaseContext unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("statusCode")) {
                phaseContext.setStatusCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("message")) {
                phaseContext.setMessage(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
