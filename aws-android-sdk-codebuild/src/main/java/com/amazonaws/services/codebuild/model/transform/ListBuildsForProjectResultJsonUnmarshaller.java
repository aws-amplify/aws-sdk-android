...
/**
 * JSON unmarshaller for response ListBuildsForProjectResult
 */
public class ListBuildsForProjectResultJsonUnmarshaller implements
        Unmarshaller<ListBuildsForProjectResult, JsonUnmarshallerContext> {
    ...
    public ListBuildsForProjectResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ids")) {
                listBuildsForProjectResult.setIds(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                listBuildsForProjectResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
