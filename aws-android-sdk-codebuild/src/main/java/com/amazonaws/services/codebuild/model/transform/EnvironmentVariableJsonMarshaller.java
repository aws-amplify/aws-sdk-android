...
/**
 * JSON marshaller for POJO EnvironmentVariable
 */
class EnvironmentVariableJsonMarshaller {

    public void marshall(EnvironmentVariable environmentVariable, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (environmentVariable.getType() != null) {
