...
/**
 * JSON unmarshaller for response ListBuildsResult
 */
public class ListBuildsResultJsonUnmarshaller implements
    ...
    public ListBuildsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ids")) {
                listBuildsResult.setIds(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                listBuildsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
