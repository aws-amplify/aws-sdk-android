...
/**
 * JSON unmarshaller for response BatchGetProjectsResult
 */
public class BatchGetProjectsResultJsonUnmarshaller implements
        Unmarshaller<BatchGetProjectsResult, JsonUnmarshallerContext> {
    ...
    public BatchGetProjectsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("projects")) {
                batchGetProjectsResult.setProjects(new ListUnmarshaller<Project>(
                        ProjectJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("projectsNotFound")) {
                batchGetProjectsResult.setProjectsNotFound(new ListUnmarshaller<String>(
