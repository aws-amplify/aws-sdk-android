...
public class Backup implements Serializable {
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p>The ARN of the backup. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param backupArn <p>The ARN of the backup. </p>
     */
     ...
     * <b>Pattern: </b>[a-zA-Z][a-zA-Z0-9\-\.\:]*<br/>
     *
     * @return <p> The generated ID of the backup. Example: <code>myServerName-yyyyMMddHHmmssSSS</code> </p>
     */
     ...
     * <b>Pattern: </b>[a-zA-Z][a-zA-Z0-9\-\.\:]*<br/>
     *
     * @param backupId <p> The generated ID of the backup. Example: <code>myServerName-yyyyMMddHHmmssSSS</code> </p>
     */
     ...
     * <b>Allowed Values: </b>AUTOMATED, MANUAL
     *
     * @return <p> The backup type. Valid values are <code>automated</code> or <code>manual</code>. </p>
     *
     * @see BackupType
     */
     ...
     * <b>Allowed Values: </b>AUTOMATED, MANUAL
     *
     * @param backupType <p> The backup type. Valid values are <code>automated</code> or <code>manual</code>. </p>
     *
     * @see BackupType
     */
     ...
     * <p> The time stamp when the backup was created in the database. Example: <code>2016-07-29T13:38:47.520Z</code> </p>
     *
     * @return <p> The time stamp when the backup was created in the database. Example: <code>2016-07-29T13:38:47.520Z</code> </p>
     */
     ...
     * <p> The time stamp when the backup was created in the database. Example: <code>2016-07-29T13:38:47.520Z</code> </p>
     *
     * @param createdAt <p> The time stamp when the backup was created in the database. Example: <code>2016-07-29T13:38:47.520Z</code> </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> A user-provided description for a manual backup. This field is empty for automated backups. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param description <p> A user-provided description for a manual backup. This field is empty for automated backups. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> The engine type that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param engine <p> The engine type that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> The engine model that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param engineModel <p> The engine model that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> The engine version that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param engineVersion <p> The engine version that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> The EC2 instance profile ARN that is obtained from the server when the backup is created. Because this value is stored, you are not required to provide the InstanceProfileArn again if you restore a backup. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param instanceProfileArn <p> The EC2 instance profile ARN that is obtained from the server when the backup is created. Because this value is stored, you are not required to provide the InstanceProfileArn again if you restore a backup. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> The instance type that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param instanceType <p> The instance type that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> The key pair that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param keyPair <p> The key pair that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>^((Mon|Tue|Wed|Thu|Fri|Sat|Sun):)?([0-1][0-9]|2[0-3]):[0-5][0-9]$<br/>
     *
     * @return <p> The preferred backup period that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>^((Mon|Tue|Wed|Thu|Fri|Sat|Sun):)?([0-1][0-9]|2[0-3]):[0-5][0-9]$<br/>
     *
     * @param preferredBackupWindow <p> The preferred backup period that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>^((Mon|Tue|Wed|Thu|Fri|Sat|Sun):)?([0-1][0-9]|2[0-3]):[0-5][0-9]$<br/>
     *
     * @return <p> The preferred maintenance period that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>^((Mon|Tue|Wed|Thu|Fri|Sat|Sun):)?([0-1][0-9]|2[0-3]):[0-5][0-9]$<br/>
     *
     * @param preferredMaintenanceWindow <p> The preferred maintenance period that is obtained from the server when the backup is created. </p>
     */
     ...
     * <p> This field is deprecated and is no longer used. </p>
     *
     * @return <p> This field is deprecated and is no longer used. </p>
     */
     ...
     * <p> This field is deprecated and is no longer used. </p>
     *
     * @param s3DataSize <p> This field is deprecated and is no longer used. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param s3DataUrl <p> This field is deprecated and is no longer used. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> The Amazon S3 URL of the backup's log file. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param s3LogUrl <p> The Amazon S3 URL of the backup's log file. </p>
     */
     ...
     * <p> The security group IDs that are obtained from the server when the backup is created. </p>
     *
     * @return <p> The security group IDs that are obtained from the server when the backup is created. </p>
     */
     ...
     * <p> The security group IDs that are obtained from the server when the backup is created. </p>
     *
     * @param securityGroupIds <p> The security group IDs that are obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>[a-zA-Z][a-zA-Z0-9\-]*<br/>
     *
     * @return <p> The name of the server from which the backup was made. </p>
     */
     ...
     * <b>Pattern: </b>[a-zA-Z][a-zA-Z0-9\-]*<br/>
     *
     * @param serverName <p> The name of the server from which the backup was made. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> The service role ARN that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param serviceRoleArn <p> The service role ARN that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Allowed Values: </b>IN_PROGRESS, OK, FAILED, DELETING
     *
     * @return <p>The status of a backup while in progress. </p>
     *
     * @see BackupStatus
     */
     ...
     * <b>Allowed Values: </b>IN_PROGRESS, OK, FAILED, DELETING
     *
     * @param status <p>The status of a backup while in progress. </p>
     *
     * @see BackupStatus
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> An informational message about backup status. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param statusDescription <p> An informational message about backup status. </p>
     */
     ...
     * <p> The subnet IDs that are obtained from the server when the backup is created. </p>
     *
     * @return <p> The subnet IDs that are obtained from the server when the backup is created. </p>
     */
     ...
     * <p> The subnet IDs that are obtained from the server when the backup is created. </p>
     *
     * @param subnetIds <p> The subnet IDs that are obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> The version of AWS OpsWorks CM-specific tools that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param toolsVersion <p> The version of AWS OpsWorks CM-specific tools that is obtained from the server when the backup is created. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> The IAM user ARN of the requester for manual backups. This field is empty for automated backups. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param userArn <p> The IAM user ARN of the requester for manual backups. This field is empty for automated backups. </p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getBackupArn() != null) sb.append("BackupArn: " + getBackupArn() + ",");
        if (getBackupId() != null) sb.append("BackupId: " + getBackupId() + ",");
        if (getBackupType() != null) sb.append("BackupType: " + getBackupType() + ",");
        ...
        if (getS3DataSize() != null) sb.append("S3DataSize: " + getS3DataSize() + ",");
        if (getS3DataUrl() != null) sb.append("S3DataUrl: " + getS3DataUrl() + ",");
        if (getS3LogUrl() != null) sb.append("S3LogUrl: " + getS3LogUrl() + ",");
        ...
        if (getStatusDescription() != null) sb.append("StatusDescription: " + getStatusDescription() + ",");
        if (getSubnetIds() != null) sb.append("SubnetIds: " + getSubnetIds() + ",");
        if (getToolsVersion() != null) sb.append("ToolsVersion: " + getToolsVersion() + ",");
        if (getUserArn() != null) sb.append("UserArn: " + getUserArn());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Backup == false) return false;
        Backup other = (Backup)obj;

        if (other.getBackupArn() == null ^ this.getBackupArn() == null) return false;
        if (other.getBackupArn() != null && other.getBackupArn().equals(this.getBackupArn()) == false) return false;
        ...
        if (other.getBackupType() == null ^ this.getBackupType() == null) return false;
        if (other.getBackupType() != null && other.getBackupType().equals(this.getBackupType()) == false) return false;
        ...
        if (other.getS3DataSize() == null ^ this.getS3DataSize() == null) return false;
        if (other.getS3DataSize() != null && other.getS3DataSize().equals(this.getS3DataSize()) == false) return false;
        if (other.getS3DataUrl() == null ^ this.getS3DataUrl() == null) return false;
        if (other.getS3DataUrl() != null && other.getS3DataUrl().equals(this.getS3DataUrl()) == false) return false;
        if (other.getS3LogUrl() == null ^ this.getS3LogUrl() == null) return false;
        if (other.getS3LogUrl() != null && other.getS3LogUrl().equals(this.getS3LogUrl()) == false) return false;
        ...
        if (other.getStatusDescription() == null ^ this.getStatusDescription() == null) return false;
        if (other.getStatusDescription() != null && other.getStatusDescription().equals(this.getStatusDescription()) == false) return false;
        ...
        if (other.getToolsVersion() == null ^ this.getToolsVersion() == null) return false;
        if (other.getToolsVersion() != null && other.getToolsVersion().equals(this.getToolsVersion()) == false) return false;
        if (other.getUserArn() == null ^ this.getUserArn() == null) return false;
        if (other.getUserArn() != null && other.getUserArn().equals(this.getUserArn()) == false) return false;
        return true;
    }
}
