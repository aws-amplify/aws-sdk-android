...
public class AssociateNodeResult implements Serializable {
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p>Contains a token which can be passed to the <code>DescribeNodeAssociationStatus</code> API call to get the status of the association request. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param nodeAssociationStatusToken <p>Contains a token which can be passed to the <code>DescribeNodeAssociationStatus</code> API call to get the status of the association request. </p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateNodeResult == false) return false;
