...
public class DescribeAccountAttributesResult implements Serializable {
     ...
     * <p> The attributes that are currently set for the account. </p>
     *
     * @return <p> The attributes that are currently set for the account. </p>
     */
     ...
     * <p> The attributes that are currently set for the account. </p>
     *
     * @param attributes <p> The attributes that are currently set for the account. </p>
     */
    ...
    public DescribeAccountAttributesResult withAttributes(AccountAttribute... attributes) {
        if (getAttributes() == null) {
            this.attributes = new java.util.ArrayList<AccountAttribute>(attributes.length);
        }
        for (AccountAttribute value : attributes) {
