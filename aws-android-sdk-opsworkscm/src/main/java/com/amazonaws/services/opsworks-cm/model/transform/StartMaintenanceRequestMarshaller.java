...
public class StartMaintenanceRequestMarshaller implements Marshaller<Request<StartMaintenanceRequest>, StartMaintenanceRequest> {
    ...
    public Request<StartMaintenanceRequest> marshall(StartMaintenanceRequest startMaintenanceRequest) {
        if (startMaintenanceRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(StartMaintenanceRequest)");
        }
        ...
        try {
            ...
            if (startMaintenanceRequest.getEngineAttributes() != null) {
                java.util.List<EngineAttribute> engineAttributes = startMaintenanceRequest.getEngineAttributes();
