...
public class CreateBackupRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Pattern: </b>[a-zA-Z][a-zA-Z0-9\-]*<br/>
     *
     * @return <p>The name of the server that you want to back up. </p>
     */
     ...
     * <b>Pattern: </b>[a-zA-Z][a-zA-Z0-9\-]*<br/>
     *
     * @param serverName <p>The name of the server that you want to back up. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> A user-defined description of the backup. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param description <p> A user-defined description of the backup. </p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateBackupRequest == false) return false;
