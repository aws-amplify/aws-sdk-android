...
/**
 * Interface for accessing AWS OpsWorks CM
 *
...
public interface AWSOpsWorksCM {
    ...
    /**
     * Overrides the default endpoint for this client ("https://opsworks-cm.us-east-1.amazonaws.com").
     * Callers can use this method to control which AWS region they want to work with.
     * <p>
     * Callers can pass in just the endpoint (ex: "opsworks-cm.us-east-1.amazonaws.com") or a full
     * URL, including the protocol (ex: "https://opsworks-cm.us-east-1.amazonaws.com"). If the
     ...
     *
     * @param endpoint
     *            The endpoint (ex: "opsworks-cm.us-east-1.amazonaws.com") or a full URL,
     *            including the protocol (ex: "https://opsworks-cm.us-east-1.amazonaws.com") of
     ...
     */
    AssociateNodeResult associateNode(AssociateNodeRequest associateNodeRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    CreateServerResult createServer(CreateServerRequest createServerRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DeleteServerResult deleteServer(DeleteServerRequest deleteServerRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DescribeAccountAttributesResult describeAccountAttributes(DescribeAccountAttributesRequest describeAccountAttributesRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DescribeBackupsResult describeBackups(DescribeBackupsRequest describeBackupsRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DescribeEventsResult describeEvents(DescribeEventsRequest describeEventsRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DescribeNodeAssociationStatusResult describeNodeAssociationStatus(DescribeNodeAssociationStatusRequest describeNodeAssociationStatusRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DescribeServersResult describeServers(DescribeServersRequest describeServersRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DisassociateNodeResult disassociateNode(DisassociateNodeRequest disassociateNodeRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    ExportServerEngineAttributeResult exportServerEngineAttribute(ExportServerEngineAttributeRequest exportServerEngineAttributeRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    RestoreServerResult restoreServer(RestoreServerRequest restoreServerRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    StartMaintenanceResult startMaintenance(StartMaintenanceRequest startMaintenanceRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    UpdateServerResult updateServer(UpdateServerRequest updateServerRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    UpdateServerEngineAttributesResult updateServerEngineAttributes(UpdateServerEngineAttributesRequest updateServerEngineAttributesRequest) throws AmazonClientException, AmazonServiceException;
