 ...
 */
class EngineAttributeJsonUnmarshaller implements Unmarshaller<EngineAttribute, JsonUnmarshallerContext> {
...
.unmarshall(context));
    ...
    public static EngineAttributeJsonUnmarshaller getInstance() {
        if (instance == null) instance = new EngineAttributeJsonUnmarshaller();
        return instance;
    }
}
