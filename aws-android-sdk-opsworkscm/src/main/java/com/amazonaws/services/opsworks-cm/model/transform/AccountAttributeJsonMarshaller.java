...
class AccountAttributeJsonMarshaller {
    ...
    public void marshall(AccountAttribute accountAttribute, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static AccountAttributeJsonMarshaller getInstance() {
        if (instance == null) instance = new AccountAttributeJsonMarshaller();
        return instance;
    }
}
