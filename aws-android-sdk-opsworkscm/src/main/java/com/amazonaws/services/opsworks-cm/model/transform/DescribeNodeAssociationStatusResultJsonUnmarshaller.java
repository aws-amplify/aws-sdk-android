    ...
    public DescribeNodeAssociationStatusResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NodeAssociationStatus")) {
                describeNodeAssociationStatusResult.setNodeAssociationStatus(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("EngineAttributes")) {
                describeNodeAssociationStatusResult.setEngineAttributes(new ListUnmarshaller<EngineAttribute>(EngineAttributeJsonUnmarshaller.getInstance()
)
.unmarshall(context));
            } else {
                reader.skipValue();
    ...
    public static DescribeNodeAssociationStatusResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeNodeAssociationStatusResultJsonUnmarshaller();
        return instance;
    }
}
