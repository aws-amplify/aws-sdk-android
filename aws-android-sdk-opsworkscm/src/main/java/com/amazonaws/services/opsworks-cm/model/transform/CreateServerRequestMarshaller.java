...
public class CreateServerRequestMarshaller implements Marshaller<Request<CreateServerRequest>, CreateServerRequest> {
    ...
    public Request<CreateServerRequest> marshall(CreateServerRequest createServerRequest) {
        if (createServerRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(CreateServerRequest)");
        }
        ...
        try {
            ...
            if (createServerRequest.getAssociatePublicIpAddress() != null) {
                Boolean associatePublicIpAddress = createServerRequest.getAssociatePublicIpAddress();
            ...
            if (createServerRequest.getEngineAttributes() != null) {
                java.util.List<EngineAttribute> engineAttributes = createServerRequest.getEngineAttributes();
            ...
            if (createServerRequest.getPreferredMaintenanceWindow() != null) {
                String preferredMaintenanceWindow = createServerRequest.getPreferredMaintenanceWindow();
