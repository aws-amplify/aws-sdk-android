...
public class Server implements Serializable {
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>BACKING_UP, CONNECTION_LOST, CREATING, DELETING, MODIFYING, FAILED, HEALTHY, RUNNING, RESTORING, SETUP, UNDER_MAINTENANCE, UNHEALTHY, TERMINATED
     */
     ...
     * <p>Associate a public IP address with a server that you are launching. </p>
     *
     * @return <p>Associate a public IP address with a server that you are launching. </p>
     */
     ...
     * <p>Associate a public IP address with a server that you are launching. </p>
     *
     * @param associatePublicIpAddress <p>Associate a public IP address with a server that you are launching. </p>
     */
     ...
     * <p>The number of automated backups to keep. </p>
     *
     * @return <p>The number of automated backups to keep. </p>
     */
     ...
     * <p>The number of automated backups to keep. </p>
     *
     * @param backupRetentionCount <p>The number of automated backups to keep. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param serverName <p>The name of the server. </p>
     */
     ...
     * <p>Time stamp of server creation. Example <code>2016-07-29T13:38:47.520Z</code> </p>
     *
     * @return <p>Time stamp of server creation. Example <code>2016-07-29T13:38:47.520Z</code> </p>
     */
     ...
     * <p>Time stamp of server creation. Example <code>2016-07-29T13:38:47.520Z</code> </p>
     *
     * @param createdAt <p>Time stamp of server creation. Example <code>2016-07-29T13:38:47.520Z</code> </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p>The ARN of the CloudFormation stack that was used to create the server. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param cloudFormationStackArn <p>The ARN of the CloudFormation stack that was used to create the server. </p>
     */
     ...
     * <b>Pattern: </b>^(((?!-)[A-Za-z0-9-]{0,62}[A-Za-z0-9])\.)+((?!-)[A-Za-z0-9-]{1,62}[A-Za-z0-9])$<br/>
     *
     * @return <p>An optional public endpoint of a server, such as <code>https://aws.my-company.com</code>. You cannot access the server by using the <code>Endpoint</code> value if the server has a <code>CustomDomain</code> specified.</p>
     */
     ...
     * <b>Pattern: </b>^(((?!-)[A-Za-z0-9-]{0,62}[A-Za-z0-9])\.)+((?!-)[A-Za-z0-9-]{1,62}[A-Za-z0-9])$<br/>
     *
     * @param customDomain <p>An optional public endpoint of a server, such as <code>https://aws.my-company.com</code>. You cannot access the server by using the <code>Endpoint</code> value if the server has a <code>CustomDomain</code> specified.</p>
     */
     ...
     * <p>Disables automated backups. The number of stored backups is dependent on the value of PreferredBackupCount. </p>
     *
     * @return <p>Disables automated backups. The number of stored backups is dependent on the value of PreferredBackupCount. </p>
     */
     ...
     * <p>Disables automated backups. The number of stored backups is dependent on the value of PreferredBackupCount. </p>
     *
     * @param disableAutomatedBackup <p>Disables automated backups. The number of stored backups is dependent on the value of PreferredBackupCount. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> A DNS name that can be used to access the engine. Example: <code>myserver-asdfghjkl.us-east-1.opsworks.io</code>. You cannot access the server by using the <code>Endpoint</code> value if the server has a <code>CustomDomain</code> specified. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param endpoint <p> A DNS name that can be used to access the engine. Example: <code>myserver-asdfghjkl.us-east-1.opsworks.io</code>. You cannot access the server by using the <code>Endpoint</code> value if the server has a <code>CustomDomain</code> specified. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p>The engine type of the server. Valid values in this release include <code>ChefAutomate</code> and <code>Puppet</code>. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param engine <p>The engine type of the server. Valid values in this release include <code>ChefAutomate</code> and <code>Puppet</code>. </p>
     */
     ...
     * <p>The response of a createServer() request returns the master credential to access the server in EngineAttributes. These credentials are not stored by AWS OpsWorks CM; they are returned only as part of the result of createServer(). </p> <p class="title"> <b>Attributes returned in a createServer response for Chef</b> </p> <ul> <li> <p> <code>CHEF_AUTOMATE_PIVOTAL_KEY</code>: A base64-encoded RSA private key that is generated by AWS OpsWorks for Chef Automate. This private key is required to access the Chef API.</p> </li> <li> <p> <code>CHEF_STARTER_KIT</code>: A base64-encoded ZIP file. The ZIP file contains a Chef starter kit, which includes a README, a configuration file, and the required RSA private key. Save this file, unzip it, and then change to the directory where you've unzipped the file contents. From this directory, you can run Knife commands.</p> </li> </ul> <p class="title"> <b>Attributes returned in a createServer response for Puppet</b> </p> <ul> <li> <p> <code>PUPPET_STARTER_KIT</code>: A base64-encoded ZIP file. The ZIP file contains a Puppet starter kit, including a README and a required private key. Save this file, unzip it, and then change to the directory where you've unzipped the file contents.</p> </li> <li> <p> <code>PUPPET_ADMIN_PASSWORD</code>: An administrator password that you can use to sign in to the Puppet Enterprise console after the server is online.</p> </li> </ul>
     *
     * @return <p>The response of a createServer() request returns the master credential to access the server in EngineAttributes. These credentials are not stored by AWS OpsWorks CM; they are returned only as part of the result of createServer(). </p> <p class="title"> <b>Attributes returned in a createServer response for Chef</b> </p> <ul> <li> <p> <code>CHEF_AUTOMATE_PIVOTAL_KEY</code>: A base64-encoded RSA private key that is generated by AWS OpsWorks for Chef Automate. This private key is required to access the Chef API.</p> </li> <li> <p> <code>CHEF_STARTER_KIT</code>: A base64-encoded ZIP file. The ZIP file contains a Chef starter kit, which includes a README, a configuration file, and the required RSA private key. Save this file, unzip it, and then change to the directory where you've unzipped the file contents. From this directory, you can run Knife commands.</p> </li> </ul> <p class="title"> <b>Attributes returned in a createServer response for Puppet</b> </p> <ul> <li> <p> <code>PUPPET_STARTER_KIT</code>: A base64-encoded ZIP file. The ZIP file contains a Puppet starter kit, including a README and a required private key. Save this file, unzip it, and then change to the directory where you've unzipped the file contents.</p> </li> <li> <p> <code>PUPPET_ADMIN_PASSWORD</code>: An administrator password that you can use to sign in to the Puppet Enterprise console after the server is online.</p> </li> </ul>
     */
     ...
     * <p>The response of a createServer() request returns the master credential to access the server in EngineAttributes. These credentials are not stored by AWS OpsWorks CM; they are returned only as part of the result of createServer(). </p> <p class="title"> <b>Attributes returned in a createServer response for Chef</b> </p> <ul> <li> <p> <code>CHEF_AUTOMATE_PIVOTAL_KEY</code>: A base64-encoded RSA private key that is generated by AWS OpsWorks for Chef Automate. This private key is required to access the Chef API.</p> </li> <li> <p> <code>CHEF_STARTER_KIT</code>: A base64-encoded ZIP file. The ZIP file contains a Chef starter kit, which includes a README, a configuration file, and the required RSA private key. Save this file, unzip it, and then change to the directory where you've unzipped the file contents. From this directory, you can run Knife commands.</p> </li> </ul> <p class="title"> <b>Attributes returned in a createServer response for Puppet</b> </p> <ul> <li> <p> <code>PUPPET_STARTER_KIT</code>: A base64-encoded ZIP file. The ZIP file contains a Puppet starter kit, including a README and a required private key. Save this file, unzip it, and then change to the directory where you've unzipped the file contents.</p> </li> <li> <p> <code>PUPPET_ADMIN_PASSWORD</code>: An administrator password that you can use to sign in to the Puppet Enterprise console after the server is online.</p> </li> </ul>
     *
     * @param engineAttributes <p>The response of a createServer() request returns the master credential to access the server in EngineAttributes. These credentials are not stored by AWS OpsWorks CM; they are returned only as part of the result of createServer(). </p> <p class="title"> <b>Attributes returned in a createServer response for Chef</b> </p> <ul> <li> <p> <code>CHEF_AUTOMATE_PIVOTAL_KEY</code>: A base64-encoded RSA private key that is generated by AWS OpsWorks for Chef Automate. This private key is required to access the Chef API.</p> </li> <li> <p> <code>CHEF_STARTER_KIT</code>: A base64-encoded ZIP file. The ZIP file contains a Chef starter kit, which includes a README, a configuration file, and the required RSA private key. Save this file, unzip it, and then change to the directory where you've unzipped the file contents. From this directory, you can run Knife commands.</p> </li> </ul> <p class="title"> <b>Attributes returned in a createServer response for Puppet</b> </p> <ul> <li> <p> <code>PUPPET_STARTER_KIT</code>: A base64-encoded ZIP file. The ZIP file contains a Puppet starter kit, including a README and a required private key. Save this file, unzip it, and then change to the directory where you've unzipped the file contents.</p> </li> <li> <p> <code>PUPPET_ADMIN_PASSWORD</code>: An administrator password that you can use to sign in to the Puppet Enterprise console after the server is online.</p> </li> </ul>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p>The engine version of the server. For a Chef server, the valid value for EngineVersion is currently <code>2</code>. For a Puppet server, the valid value is <code>2017</code>. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param engineVersion <p>The engine version of the server. For a Chef server, the valid value for EngineVersion is currently <code>2</code>. For a Puppet server, the valid value is <code>2017</code>. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p>The instance profile ARN of the server. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param instanceProfileArn <p>The instance profile ARN of the server. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> The instance type for the server, as specified in the CloudFormation stack. This might not be the same instance type that is shown in the EC2 console. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param instanceType <p> The instance type for the server, as specified in the CloudFormation stack. This might not be the same instance type that is shown in the EC2 console. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p>The key pair associated with the server. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param keyPair <p>The key pair associated with the server. </p>
     */
     ...
     * <b>Allowed Values: </b>SUCCESS, FAILED
     *
     * @return <p>The status of the most recent server maintenance run. Shows <code>SUCCESS</code> or <code>FAILED</code>. </p>
     *
     ...
     * <b>Allowed Values: </b>SUCCESS, FAILED
     *
     * @param maintenanceStatus <p>The status of the most recent server maintenance run. Shows <code>SUCCESS</code> or <code>FAILED</code>. </p>
     *
     * @see MaintenanceStatus
     */
     ...
     * <b>Pattern: </b>^((Mon|Tue|Wed|Thu|Fri|Sat|Sun):)?([0-1][0-9]|2[0-3]):[0-5][0-9]$<br/>
     *
     * @return <p>The preferred maintenance period specified for the server. </p>
     */
     ...
     * <b>Pattern: </b>^((Mon|Tue|Wed|Thu|Fri|Sat|Sun):)?([0-1][0-9]|2[0-3]):[0-5][0-9]$<br/>
     *
     * @param preferredMaintenanceWindow <p>The preferred maintenance period specified for the server. </p>
     */
     ...
     * <b>Pattern: </b>^((Mon|Tue|Wed|Thu|Fri|Sat|Sun):)?([0-1][0-9]|2[0-3]):[0-5][0-9]$<br/>
     *
     * @return <p>The preferred backup period specified for the server. </p>
     */
     ...
     * <b>Pattern: </b>^((Mon|Tue|Wed|Thu|Fri|Sat|Sun):)?([0-1][0-9]|2[0-3]):[0-5][0-9]$<br/>
     *
     * @param preferredBackupWindow <p>The preferred backup period specified for the server. </p>
     */
     ...
     * <p> The security group IDs for the server, as specified in the CloudFormation stack. These might not be the same security groups that are shown in the EC2 console. </p>
     *
     * @return <p> The security group IDs for the server, as specified in the CloudFormation stack. These might not be the same security groups that are shown in the EC2 console. </p>
     */
     ...
     * <p> The security group IDs for the server, as specified in the CloudFormation stack. These might not be the same security groups that are shown in the EC2 console. </p>
     *
     * @param securityGroupIds <p> The security group IDs for the server, as specified in the CloudFormation stack. These might not be the same security groups that are shown in the EC2 console. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p>The service role ARN used to create the server. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param serviceRoleArn <p>The service role ARN used to create the server. </p>
     */
     ...
     * <b>Allowed Values: </b>BACKING_UP, CONNECTION_LOST, CREATING, DELETING, MODIFYING, FAILED, HEALTHY, RUNNING, RESTORING, SETUP, UNDER_MAINTENANCE, UNHEALTHY, TERMINATED
     *
     * @return <p> The server's status. This field displays the states of actions in progress, such as creating, running, or backing up the server, as well as the server's health state. </p>
     *
     * @see ServerStatus
     */
     ...
     * <b>Allowed Values: </b>BACKING_UP, CONNECTION_LOST, CREATING, DELETING, MODIFYING, FAILED, HEALTHY, RUNNING, RESTORING, SETUP, UNDER_MAINTENANCE, UNHEALTHY, TERMINATED
     *
     * @param status <p> The server's status. This field displays the states of actions in progress, such as creating, running, or backing up the server, as well as the server's health state. </p>
     *
     * @see ServerStatus
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p> Depending on the server status, this field has either a human-readable message (such as a create or backup error), or an escaped block of JSON (used for health check results). </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param statusReason <p> Depending on the server status, this field has either a human-readable message (such as a create or backup error), or an escaped block of JSON (used for health check results). </p>
     */
     ...
     * <p> The subnet IDs specified in a CreateServer request. </p>
     *
     * @return <p> The subnet IDs specified in a CreateServer request. </p>
     */
     ...
     * <p> The subnet IDs specified in a CreateServer request. </p>
     *
     * @param subnetIds <p> The subnet IDs specified in a CreateServer request. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p>The ARN of the server. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param serverArn <p>The ARN of the server. </p>
     */
    ...
    public String toString() {
        ...
        if (getCloudFormationStackArn() != null) sb.append("CloudFormationStackArn: " + getCloudFormationStackArn() + ",");
        ...
        if (getMaintenanceStatus() != null) sb.append("MaintenanceStatus: " + getMaintenanceStatus() + ",");
        ...
        if (getServerArn() != null) sb.append("ServerArn: " + getServerArn());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Server == false) return false;
        ...
        if (other.getCloudFormationStackArn() == null ^ this.getCloudFormationStackArn() == null) return false;
        if (other.getCloudFormationStackArn() != null && other.getCloudFormationStackArn().equals(this.getCloudFormationStackArn()) == false) return false;
        ...
        if (other.getMaintenanceStatus() == null ^ this.getMaintenanceStatus() == null) return false;
        if (other.getMaintenanceStatus() != null && other.getMaintenanceStatus().equals(this.getMaintenanceStatus()) == false) return false;
        ...
        if (other.getServerArn() == null ^ this.getServerArn() == null) return false;
        if (other.getServerArn() != null && other.getServerArn().equals(this.getServerArn()) == false) return false;
        return true;
    }
}
