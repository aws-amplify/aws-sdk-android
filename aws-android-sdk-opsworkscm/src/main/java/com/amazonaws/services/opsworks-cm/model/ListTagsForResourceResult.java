...
public class ListTagsForResourceResult implements Serializable {
     ...
     * <p>Tags that have been applied to the resource.</p>
     *
     * @return <p>Tags that have been applied to the resource.</p>
     */
     ...
     * <p>Tags that have been applied to the resource.</p>
     *
     * @param tags <p>Tags that have been applied to the resource.</p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p>A token that you can use as the value of <code>NextToken</code> in subsequent calls to the API to show more results.</p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param nextToken <p>A token that you can use as the value of <code>NextToken</code> in subsequent calls to the API to show more results.</p>
     */
