...
public class UpdateServerResult implements Serializable {
    /**
     ...
     * <p>Contains the response to a <code>UpdateServer</code> request. </p>
     *
     * @return <p>Contains the response to a <code>UpdateServer</code> request. </p>
     */
     ...
     * <p>Contains the response to a <code>UpdateServer</code> request. </p>
     *
     * @param server <p>Contains the response to a <code>UpdateServer</code> request. </p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateServerResult == false) return false;
