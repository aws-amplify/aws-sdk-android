...
public class DescribeBackupsResult implements Serializable {
     ...
     * <p>Contains the response to a <code>DescribeBackups</code> request. </p>
     *
     * @return <p>Contains the response to a <code>DescribeBackups</code> request. </p>
     */
     ...
     * <p>Contains the response to a <code>DescribeBackups</code> request. </p>
     *
     * @param backups <p>Contains the response to a <code>DescribeBackups</code> request. </p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getBackups() != null) sb.append("Backups: " + getBackups() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeBackupsResult == false) return false;
        DescribeBackupsResult other = (DescribeBackupsResult)obj;

        if (other.getBackups() == null ^ this.getBackups() == null) return false;
        if (other.getBackups() != null && other.getBackups().equals(this.getBackups()) == false) return false;
