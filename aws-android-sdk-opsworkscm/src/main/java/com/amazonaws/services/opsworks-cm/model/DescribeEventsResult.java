...
public class DescribeEventsResult implements Serializable {
     ...
     * <p>Contains the response to a <code>DescribeEvents</code> request. </p>
     *
     * @return <p>Contains the response to a <code>DescribeEvents</code> request. </p>
     */
     ...
     * <p>Contains the response to a <code>DescribeEvents</code> request. </p>
     *
     * @param serverEvents <p>Contains the response to a <code>DescribeEvents</code> request. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @return <p>NextToken is a string that is returned in some command responses. It indicates that not all entries have been returned, and that you must run at least one more request to get remaining items. To get remaining results, call <code>DescribeEvents</code> again, and assign the token from the previous results as the value of the <code>nextToken</code> parameter. If there are no more results, the response object's <code>nextToken</code> parameter value is <code>null</code>. Setting a <code>nextToken</code> value that was not returned in your previous results causes an <code>InvalidNextTokenException</code> to occur. </p>
     */
     ...
     * <b>Pattern: </b>(?s).*<br/>
     *
     * @param nextToken <p>NextToken is a string that is returned in some command responses. It indicates that not all entries have been returned, and that you must run at least one more request to get remaining items. To get remaining results, call <code>DescribeEvents</code> again, and assign the token from the previous results as the value of the <code>nextToken</code> parameter. If there are no more results, the response object's <code>nextToken</code> parameter value is <code>null</code>. Setting a <code>nextToken</code> value that was not returned in your previous results causes an <code>InvalidNextTokenException</code> to occur. </p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getServerEvents() != null) sb.append("ServerEvents: " + getServerEvents() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getServerEvents() == null ^ this.getServerEvents() == null) return false;
        if (other.getServerEvents() != null && other.getServerEvents().equals(this.getServerEvents()) == false) return false;
