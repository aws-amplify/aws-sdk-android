...
public class UpdateServerEngineAttributesResult implements Serializable {
    /**
     ...
     * <p>Contains the response to an <code>UpdateServerEngineAttributes</code> request. </p>
     *
     * @return <p>Contains the response to an <code>UpdateServerEngineAttributes</code> request. </p>
     */
     ...
     * <p>Contains the response to an <code>UpdateServerEngineAttributes</code> request. </p>
     *
     * @param server <p>Contains the response to an <code>UpdateServerEngineAttributes</code> request. </p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateServerEngineAttributesResult == false) return false;
