    ...
    public DisassociateNodeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NodeAssociationStatusToken")) {
                disassociateNodeResult.setNodeAssociationStatusToken(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static DisassociateNodeResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DisassociateNodeResultJsonUnmarshaller();
        return instance;
    }
}
