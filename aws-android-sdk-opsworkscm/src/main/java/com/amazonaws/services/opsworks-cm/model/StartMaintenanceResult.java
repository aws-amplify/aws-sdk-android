...
public class StartMaintenanceResult implements Serializable {
     ...
     * <p>Contains the response to a <code>StartMaintenance</code> request. </p>
     *
     * @return <p>Contains the response to a <code>StartMaintenance</code> request. </p>
     */
     ...
     * <p>Contains the response to a <code>StartMaintenance</code> request. </p>
     *
     * @param server <p>Contains the response to a <code>StartMaintenance</code> request. </p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartMaintenanceResult == false) return false;
