 ...
 * has been resolved. The server is in an <code>UNDER_MAINTENANCE</code> state
...
public class StartMaintenanceRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <li>
     * <p>
     * <code>CHEF_MAJOR_UPGRADE</code>: If a Chef Automate server is eligible
     ...
     * >Upgrade an AWS OpsWorks for Chef Automate Server to Chef Automate 2</a>.
     * </p>
     * </li>
     * </ul>
     */
     ...
     *
     * @return <p>
     *         Engine attributes that are specific to the server on which you
     *         want to run maintenance.
     *         </p>
     *         <p class="title">
     *         <b>Attributes accepted in a StartMaintenance request for Chef</b>
     *         </p>
     ...
     *         <li>
     *         <p>
     *         <code>CHEF_MAJOR_UPGRADE</code>: If a Chef Automate server is
     *         eligible for upgrade to Chef Automate 2, add this engine
     *         attribute to a <code>StartMaintenance</code> request and set the
     *         value to <code>true</code> to upgrade the server to Chef Automate
     *         2. For more information, see <a href=
     *         "https://docs.aws.amazon.com/opsworks/latest/userguide/opscm-a2upgrade.html"
     *         >Upgrade an AWS OpsWorks for Chef Automate Server to Chef
     *         Automate 2</a>.
     *         </p>
     *         </li>
     *         </ul>
     ...
     *            </p>
     *            <p class="title">
     *            <b>Attributes accepted in a StartMaintenance request for
     *            Chef</b>
     *            </p>
     *            <ul>
     *            <li>
     ...
     *            <code>CHEF_MAJOR_UPGRADE</code>: If a Chef Automate server is
     *            eligible for upgrade to Chef Automate 2, add this engine
     *            attribute to a <code>StartMaintenance</code> request and set
     *            the value to <code>true</code> to upgrade the server to Chef
     *            Automate 2. For more information, see <a href=
     *            "https://docs.aws.amazon.com/opsworks/latest/userguide/opscm-a2upgrade.html"
     *            >Upgrade an AWS OpsWorks for Chef Automate Server to Chef
     *            Automate 2</a>.
     *            </p>
     ...
     *         chained together.
     */
    public StartMaintenanceRequest withEngineAttributes(
