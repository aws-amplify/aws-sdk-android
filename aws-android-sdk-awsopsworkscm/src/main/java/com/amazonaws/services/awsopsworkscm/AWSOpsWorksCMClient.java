...
import com.amazonaws.services.awsopsworkscm.model.transform.*;

/**
 * Client for accessing AWS OpsWorks CM. All service calls made using this
...
public class AWSOpsWorksCMClient extends AmazonWebServiceClient implements AWSOpsWorksCM {
    ...
    /**
     * Constructs a new client to invoke service methods on AWSOpsWorksCM. A
     ...
     *            how this client connects to AWSOpsWorksCM (ex: proxy settings,
     *            retry counts, etc.).
     * @see DefaultAWSCredentialsProviderChain
     */
    @Deprecated
    ...
    /**
     * Constructs a new client to invoke service methods on AWSOpsWorksCM using
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/awsopsworkscm/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/awsopsworkscm/request.handler2s"));
    }
    ...
    public AssociateNodeResult associateNode(AssociateNodeRequest associateNodeRequest)
        ...
        try {
            ...
            JsonResponseHandler<AssociateNodeResult> responseHandler = new JsonResponseHandler<AssociateNodeResult>(
                    unmarshaller);
    ...
    public DeleteServerResult deleteServer(DeleteServerRequest deleteServerRequest)
        ...
        try {
            ...
            JsonResponseHandler<DeleteServerResult> responseHandler = new JsonResponseHandler<DeleteServerResult>(
                    unmarshaller);
     ...
     *             request, or a server side issue.
     */
    public DescribeNodeAssociationStatusResult describeNodeAssociationStatus(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeNodeAssociationStatusRequestMarshaller()
                        .marshall(describeNodeAssociationStatusRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeNodeAssociationStatusResult> responseHandler = new JsonResponseHandler<DescribeNodeAssociationStatusResult>(
                    unmarshaller);
    ...
    public DescribeServersResult describeServers(DescribeServersRequest describeServersRequest)
        ...
        try {
            ...
            JsonResponseHandler<DescribeServersResult> responseHandler = new JsonResponseHandler<DescribeServersResult>(
                    unmarshaller);
    ...
    public DisassociateNodeResult disassociateNode(DisassociateNodeRequest disassociateNodeRequest)
        ...
        try {
            ...
            JsonResponseHandler<DisassociateNodeResult> responseHandler = new JsonResponseHandler<DisassociateNodeResult>(
                    unmarshaller);
     ...
     *             request, or a server side issue.
     */
    public ExportServerEngineAttributeResult exportServerEngineAttribute(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ExportServerEngineAttributeRequestMarshaller()
                        .marshall(exportServerEngineAttributeRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ExportServerEngineAttributeResult> responseHandler = new JsonResponseHandler<ExportServerEngineAttributeResult>(
                    unmarshaller);
    ...
    public RestoreServerResult restoreServer(RestoreServerRequest restoreServerRequest)
        ...
        try {
            ...
            JsonResponseHandler<RestoreServerResult> responseHandler = new JsonResponseHandler<RestoreServerResult>(
                    unmarshaller);
    ...
    public StartMaintenanceResult startMaintenance(StartMaintenanceRequest startMaintenanceRequest)
        ...
        try {
            ...
            JsonResponseHandler<StartMaintenanceResult> responseHandler = new JsonResponseHandler<StartMaintenanceResult>(
                    unmarshaller);
     ...
     *             request, or a server side issue.
     */
    public UpdateServerEngineAttributesResult updateServerEngineAttributes(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new UpdateServerEngineAttributesRequestMarshaller()
            ...
            JsonResponseHandler<UpdateServerEngineAttributesResult> responseHandler = new JsonResponseHandler<UpdateServerEngineAttributesResult>(
                    unmarshaller);
