 ...
 * restoration is successful, and the server is in a <code>HEALTHY</code> state,
 * AWS OpsWorks CM switches traffic over to the new instance. After restoration
 * is finished, the old EC2 instance is maintained in a <code>Running</code> or
 * <code>Stopped</code> state, but is eventually terminated.
 * </p>
 * <p>
 * This operation is asynchronous.
 * </p>
 * <p>
 * An <code>InvalidStateException</code> is thrown when the server is not in a
 * valid state. A <code>ResourceNotFoundException</code> is thrown when the
...
public class RestoreServerRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         The type of instance to restore. Valid values must be specified
     *         in the following format: <code>^([cm][34]|t2).*</code> For
     *         example, <code>m5.large</code>. Valid values are
     *         <code>m5.large</code>, <code>r5.xlarge</code>, and
     *         <code>r5.2xlarge</code>. If you do not specify this parameter,
     ...
     *            The type of instance to restore. Valid values must be
     *            specified in the following format:
     *            <code>^([cm][34]|t2).*</code> For example,
     *            <code>m5.large</code>. Valid values are <code>m5.large</code>,
     *            <code>r5.xlarge</code>, and <code>r5.2xlarge</code>. If you do
     *            not specify this parameter, RestoreServer uses the instance
     ...
     *
     * @return <p>
     *         The name of the key pair to set on the new EC2 instance. This can
     *         be helpful if the administrator no longer has the SSH key.
     *         </p>
     */
     ...
     *
     * @param keyPair <p>
     *            The name of the key pair to set on the new EC2 instance. This
