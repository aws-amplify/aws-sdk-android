...
public class UpdateServerEngineAttributesRequestMarshaller
    ...
    public Request<UpdateServerEngineAttributesRequest> marshall(
            UpdateServerEngineAttributesRequest updateServerEngineAttributesRequest) {
        if (updateServerEngineAttributesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateServerEngineAttributesRequest)");
        }

        Request<UpdateServerEngineAttributesRequest> request = new DefaultRequest<UpdateServerEngineAttributesRequest>(
                updateServerEngineAttributesRequest, "AWSOpsWorksCM");
