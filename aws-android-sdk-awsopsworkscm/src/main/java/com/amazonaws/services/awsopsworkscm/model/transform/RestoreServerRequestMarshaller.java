...
/**
 * JSON request marshaller for RestoreServerRequest
 */
public class RestoreServerRequestMarshaller implements
        Marshaller<Request<RestoreServerRequest>, RestoreServerRequest> {

    public Request<RestoreServerRequest> marshall(RestoreServerRequest restoreServerRequest) {
        if (restoreServerRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RestoreServerRequest)");
        }

        Request<RestoreServerRequest> request = new DefaultRequest<RestoreServerRequest>(
                restoreServerRequest, "AWSOpsWorksCM");
