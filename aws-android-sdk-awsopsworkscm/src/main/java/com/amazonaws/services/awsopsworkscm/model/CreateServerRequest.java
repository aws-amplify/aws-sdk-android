 ...
 * it is in the <code>HEALTHY</code> state. By default, you can create a maximum
 * of 10 servers.
 * </p>
 * <p>
 ...
 * maximum number of servers (10). A <code>ResourceAlreadyExistsException</code>
 ...
 * </p>
 * <p>
 * <i>Chef Automate:</i> The default security group opens the Chef server to the
 ...
 * CA-signed certificate and private key, specify values for
...
public class CreateServerRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * server by using the generated <code>Endpoint</code> value if the server
     * is using a custom domain. If you specify a custom domain, you must also
     ...
     * <b>Pattern: </b>(?s)\s*-----BEGIN CERTIFICATE-----.+-----END
     * CERTIFICATE-----\s*<br/>
     */
     ...
     * <b>Constraints:</b><br/>
     * <b>Length: </b> - 4096<br/>
     * <b>Pattern: </b>(?ms)\s*^-----BEGIN (?-s:.*)PRIVATE KEY-----$.*?^-----END
     * (?-s:.*)PRIVATE KEY-----$\s*<br/>
     */
    ...
    /**
     * <p>
     * Enable or disable scheduled backups. Valid values are <code>true</code>
     ...
     * https://s3.amazonaws.com/opsworks-cm-us-east-1-prod-default-assets/misc/
     * opsworks-cm-roles.yaml. This template creates a CloudFormation stack that
     ...
     * in the following format: <code>DDD:HH:MM</code>. The specified time is in
     ...
     * </p>
     * <p>
     * <b>Example:</b> <code>08:00</code>, which represents a daily start time
     * of 08:00 UTC.
     * </p>
     * <p>
     * <b>Example:</b> <code>Mon:08:00</code>, which represents a start time of
     ...
     * located at
     * https://s3.amazonaws.com/opsworks-cm-us-east-1-prod-default-assets
     * /misc/opsworks-cm-roles.yaml. This template creates a CloudFormation
     ...
     * by Amazon EC2. If you specify subnet IDs, the VPC must have
     ...
     *         launching. Valid values are <code>true</code> or
     ...
     * @return <p>
     *         An optional public endpoint of a server, such as
     *         <code>https://aws.my-company.com</code>. To access the server,
     *         create a CNAME DNS record in your preferred DNS service that
     *         points the custom domain to the endpoint that is generated when
     ...
     *         <code>Endpoint</code> value if the server is using a custom
     *         domain. If you specify a custom domain, you must also specify
     *         values for <code>CustomCertificate</code> and
     *         <code>CustomPrivateKey</code>.
     *         </p>
     */
     ...
     *            <code>https://aws.my-company.com</code>. To access the server,
     *            create a CNAME DNS record in your preferred DNS service that
     *            points the custom domain to the endpoint that is generated
     *            when the server is created (the value of the CreateServer
     *            Endpoint attribute). You cannot access the server by using the
     *            generated <code>Endpoint</code> value if the server is using a
     *            custom domain. If you specify a custom domain, you must also
     *            specify values for <code>CustomCertificate</code> and
     *            <code>CustomPrivateKey</code>.
     *            </p>
     */
     ...
     *         <code>CustomDomain</code> and <code>CustomPrivateKey</code>. The
     *         following are requirements for the <code>CustomCertificate</code>
     *         value:
     *         </p>
     *         <ul>
     *         <li>
     ...
     *         <li>
     *         <p>
     *         The certificate must be a valid X509 certificate, or a
     ...
     *         certificate's <code>NotBefore</code> date), or after it expires
     ...
     * CERTIFICATE-----\s*<br/>
     *
     * @param customCertificate <p>
     *            A PEM-formatted HTTPS certificate. The value can be be a
     *            single, self-signed certificate, or a certificate chain. If
     *            you specify a custom certificate, you must also specify values
     *            for <code>CustomDomain</code> and
     *            <code>CustomPrivateKey</code>. The following are requirements
     *            for the <code>CustomCertificate</code> value:
     *            </p>
     *            <ul>
     *            <li>
     *            <p>
     *            You can provide either a self-signed, custom certificate, or
     ...
     *            <p>
     *            The certificate must be valid at the time of upload. A
     *            certificate can't be used before its validity period begins
     *            (the certificate's <code>NotBefore</code> date), or after it
     *            expires (the certificate's <code>NotAfter</code> date).
     *            </p>
     *            </li>
     *            <li>
     *            <p>
     ...
     *         HTTPS. The private key must not be encrypted; it cannot be
     *         protected by a password or passphrase. If you specify a custom
     *         private key, you must also specify values for
     ...
     * (?-s:.*)PRIVATE KEY-----$\s*<br/>
     *
     * @param customPrivateKey <p>
     *            A private key in PEM format for connecting to the server by
     *            using HTTPS. The private key must not be encrypted; it cannot
     *            be protected by a password or passphrase. If you specify a
     *            custom private key, you must also specify values for
     *            <code>CustomDomain</code> and <code>CustomCertificate</code>.
     *            </p>
     */
     ...
     *
     * @param engine <p>
     *            The configuration management engine to use. Valid values
     ...
     *         <code>12</code>. For a Puppet server, the valid value is
     *         <code>2017</code>.
     *         </p>
     */
     ...
     *            For a Chef server, the valid value for EngineVersion is
     *            currently <code>12</code>. For a Puppet server, the valid
     ...
     *         public key. The corresponding private key is required to access
     *         the Chef API. When no CHEF_AUTOMATE_PIVOTAL_KEY is set, a private
     *         key is generated and returned in the response.
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     *         <code>CHEF_AUTOMATE_ADMIN_PASSWORD</code>: The password for the
     *         administrative user in the Chef Automate web-based dashboard. The
     *         password length is a minimum of eight characters, and a maximum
     *         of 32. The password can contain letters, numbers, and special
     *         characters (!/@#$%^&amp;+=_). The password must contain at least
     *         one lower case letter, one upper case letter, one number, and one
     *         special character. When no CHEF_AUTOMATE_ADMIN_PASSWORD is set,
     ...
     *         <li>
     *         <p>
     *         <code>PUPPET_ADMIN_PASSWORD</code>: To work with the Puppet
     *         Enterprise console, a password must use ASCII characters.
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     *         <code>PUPPET_R10K_REMOTE</code>: The r10k remote is the URL of
     ...
     *         <li>
     *         <p>
     *         <code>PUPPET_R10K_PRIVATE_KEY</code>: If you are using a private
     *         Git repository, add PUPPET_R10K_PRIVATE_KEY to specify a
     ...
     *            <p>
     *            <code>CHEF_AUTOMATE_PIVOTAL_KEY</code>: A base64-encoded RSA
     *            public key. The corresponding private key is required to
     *            access the Chef API. When no CHEF_AUTOMATE_PIVOTAL_KEY is set,
     *            a private key is generated and returned in the response.
     *            </p>
     *            </li>
     *            <li>
     *            <p>
     *            <code>CHEF_AUTOMATE_ADMIN_PASSWORD</code>: The password for
     *            the administrative user in the Chef Automate web-based
     *            dashboard. The password length is a minimum of eight
     *            characters, and a maximum of 32. The password can contain
     *            letters, numbers, and special characters (!/@#$%^&amp;+=_).
     *            The password must contain at least one lower case letter, one
     *            upper case letter, one number, and one special character. When
     *            no CHEF_AUTOMATE_ADMIN_PASSWORD is set, one is generated and
     *            returned in the response.
     *            </p>
     *            </li>
     *            </ul>
     ...
     *            <li>
     *            <p>
     *            <code>PUPPET_R10K_PRIVATE_KEY</code>: If you are using a
     *            private Git repository, add PUPPET_R10K_PRIVATE_KEY to specify
     ...
     *         chained together.
     */
    public CreateServerRequest withEngineAttributes(
     ...
     *         new backup is created, AWS OpsWorks CM deletes the oldest backups
     *         if this number is exceeded. The default value is <code>1</code>.
     *         </p>
     */
     ...
     *            Whenever a new backup is created, AWS OpsWorks CM deletes the
     *            oldest backups if this number is exceeded. The default value
     *            is <code>1</code>.
     *            </p>
     */
     ...
     *
     * @return <p>
     *         The name of the server. The server name must be unique within
     *         your AWS account, within each region. Server names must start
     *         with a letter; then letters, numbers, or hyphens (-) are allowed,
     ...
     *            The name of the server. The server name must be unique within
     *            your AWS account, within each region. Server names must start
     *            with a letter; then letters, numbers, or hyphens (-) are
     ...
     *
     * @return <p>
     *         The ARN of the instance profile that your Amazon EC2 instances
     *         use. Although the AWS OpsWorks console typically creates the
     *         instance profile for you, if you are using API commands instead,
     *         run the service-role-creation.yaml AWS CloudFormation template,
     *         located at
     *         https://s3.amazonaws.com/opsworks-cm-us-east-1-prod-default
     *         -assets/misc/opsworks-cm-roles.yaml. This template creates a
     *         CloudFormation stack that includes the instance profile you need.
     *         </p>
     */
     ...
     *            The ARN of the instance profile that your Amazon EC2 instances
     *            use. Although the AWS OpsWorks console typically creates the
     *            instance profile for you, if you are using API commands
     *            instead, run the service-role-creation.yaml AWS CloudFormation
     *            template, located at
     *            https://s3.amazonaws.com/opsworks-cm-us-east
     *            -1-prod-default-assets/misc/opsworks-cm-roles.yaml. This
     *            template creates a CloudFormation stack that includes the
     ...
     *
     * @return <p>
     *         The Amazon EC2 key pair to set for the instance. This parameter
     *         is optional; if desired, you may specify this parameter to
     ...
     *
     * @param keyPair <p>
     *            The Amazon EC2 key pair to set for the instance. This
     *            parameter is optional; if desired, you may specify this
     ...
     *         OpsWorks CM performs maintenance on the instance. Valid values
     *         must be specified in the following format: <code>DDD:HH:MM</code>
     *         . The specified time is in coordinated universal time (UTC). The
     *         default value is a random one-hour period on Tuesday, Wednesday,
     *         or Friday. See <code>TimeWindowDefinition</code> for more
     *         information.
     *         </p>
     *         <p>
     *         <b>Example:</b> <code>Mon:08:00</code>, which represents a start
     *         time of every Monday at 08:00 UTC. (8:00 a.m.)
     *         </p>
     */
     ...
     *            AWS OpsWorks CM performs maintenance on the instance. Valid
     *            values must be specified in the following format:
     *            <code>DDD:HH:MM</code>. The specified time is in coordinated
     *            universal time (UTC). The default value is a random one-hour
     *            period on Tuesday, Wednesday, or Friday. See
     *            <code>TimeWindowDefinition</code> for more information.
     *            </p>
     *            <p>
     *            <b>Example:</b> <code>Mon:08:00</code>, which represents a
     *            start time of every Monday at 08:00 UTC. (8:00 a.m.)
     *            </p>
     */
     ...
     *         backs up application-level data on your server if automated
     ...
     *         </p>
     *         <p>
     *         <b>Example:</b> <code>08:00</code>, which represents a daily
     *         start time of 08:00 UTC.
     *         </p>
     *         <p>
     *         <b>Example:</b> <code>Mon:08:00</code>, which represents a start
     *         time of every Monday at 08:00 UTC. (8:00 a.m.)
     ...
     *            CM backs up application-level data on your server if automated
     *            backups are enabled. Valid values must be specified in one of
     ...
     *         instance. If you add this parameter, the specified security
     *         groups must be within the VPC that is specified by
     *         <code>SubnetIds</code>.
     *         </p>
     *         <p>
     *         If you do not specify this parameter, AWS OpsWorks CM creates one
     *         new security group that uses TCP ports 22 and 443, open to
     *         0.0.0.0/0 (everyone).
     *         </p>
     */
     ...
     *            </p>
     *            <p>
     *            If you do not specify this parameter, AWS OpsWorks CM creates
     *            one new security group that uses TCP ports 22 and 443, open to
     *            0.0.0.0/0 (everyone).
     *            </p>
     */
     ...
     *         work with your account. Although the AWS OpsWorks management
     *         console typically creates the service role for you, if you are
     *         using the AWS CLI or API commands, run the
     *         service-role-creation.yaml AWS CloudFormation template, located
     *         at https://s3.amazonaws.com/opsworks-cm-us-east-1-prod-default-
     *         assets/misc/opsworks-cm-roles.yaml. This template creates a
     *         CloudFormation stack that includes the service role and instance
     ...
     *            The service role that the AWS OpsWorks CM service backend uses
     *            to work with your account. Although the AWS OpsWorks
     *            management console typically creates the service role for you,
     *            if you are using the AWS CLI or API commands, run the
     *            service-role-creation.yaml AWS CloudFormation template,
     *            located at
     *            https://s3.amazonaws.com/opsworks-cm-us-east-1-prod-
     *            default-assets/misc/opsworks-cm-roles.yaml. This template
     *            creates a CloudFormation stack that includes the service role
     ...
     *         subnet IDs, your EC2 instances are created in a default subnet
     *         that is selected by Amazon EC2. If you specify subnet IDs, the
     ...
     *            </p>
     *            <p>
     *            Amazon EC2-Classic customers: This field is required. All
     *            servers must run within a VPC. The VPC must have
     *            "Auto Assign Public IP" enabled.
     *            </p>
     *            <p>
     *            EC2-VPC customers: This field is optional. If you do not
     *            specify subnet IDs, your EC2 instances are created in a
     *            default subnet that is selected by Amazon EC2. If you specify
     ...
     *            AWS OpsWorks for Chef Automate or AWS OpsWorks for Puppet
     *            Enterprise server.
     *            </p>
     *            <ul>
     *            <li>
     ...
     *
     * @param backupId <p>
     *            If you specify this field, AWS OpsWorks CM creates the server
    ...
    public String toString() {
        ...
        if (getCustomCertificate() != null)
            sb.append("CustomCertificate: " + getCustomCertificate() + ",");
        if (getCustomPrivateKey() != null)
            sb.append("CustomPrivateKey: " + getCustomPrivateKey() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getCustomCertificate() == null) ? 0 : getCustomCertificate().hashCode());
        hashCode = prime * hashCode
                + ((getCustomPrivateKey() == null) ? 0 : getCustomPrivateKey().hashCode());
        hashCode = prime
                * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCustomCertificate() == null ^ this.getCustomCertificate() == null)
            return false;
        if (other.getCustomCertificate() != null
                && other.getCustomCertificate().equals(this.getCustomCertificate()) == false)
            return false;
        if (other.getCustomPrivateKey() == null ^ this.getCustomPrivateKey() == null)
            return false;
        if (other.getCustomPrivateKey() != null
                && other.getCustomPrivateKey().equals(this.getCustomPrivateKey()) == false)
            return false;
