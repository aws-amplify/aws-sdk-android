...
/**
 * JSON unmarshaller for response DeleteServerResult
 */
public class DeleteServerResultJsonUnmarshaller implements
        Unmarshaller<DeleteServerResult, JsonUnmarshallerContext> {
