...
/**
 * JSON unmarshaller for response DescribeNodeAssociationStatusResult
 */
public class DescribeNodeAssociationStatusResultJsonUnmarshaller implements
        Unmarshaller<DescribeNodeAssociationStatusResult, JsonUnmarshallerContext> {

    public DescribeNodeAssociationStatusResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NodeAssociationStatus")) {
                describeNodeAssociationStatusResult.setNodeAssociationStatus(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("EngineAttributes")) {
                describeNodeAssociationStatusResult
                        .setEngineAttributes(new ListUnmarshaller<EngineAttribute>(
                                EngineAttributeJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
