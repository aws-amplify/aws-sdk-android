    ...
    public Server unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AssociatePublicIpAddress")) {
                ...
                server.setEngineAttributes(new ListUnmarshaller<EngineAttribute>(
                ...
                server.setSecurityGroupIds(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
                ...
                server.setSubnetIds(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
