 ...
 * </p>
 * <p>
 * A <code>ResourceNotFoundException</code> is thrown when no recent association
 * or disassociation request with the specified token is found, or when the
 * server does not exist. A <code>ValidationException</code> is raised when
 * parameters of the request are not valid.
 * </p>
 */
public class DescribeNodeAssociationStatusRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public DescribeNodeAssociationStatusRequest withNodeAssociationStatusToken(
