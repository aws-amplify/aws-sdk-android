...
/**
 * JSON request marshaller for DisassociateNodeRequest
 */
public class DisassociateNodeRequestMarshaller implements
        Marshaller<Request<DisassociateNodeRequest>, DisassociateNodeRequest> {
    ...
    public Request<DisassociateNodeRequest> marshall(DisassociateNodeRequest disassociateNodeRequest) {
        if (disassociateNodeRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DisassociateNodeRequest)");
        }

        Request<DisassociateNodeRequest> request = new DefaultRequest<DisassociateNodeRequest>(
                disassociateNodeRequest, "AWSOpsWorksCM");
        ...
        try {
            ...
            if (disassociateNodeRequest.getServerName() != null) {
                String serverName = disassociateNodeRequest.getServerName();
                jsonWriter.name("ServerName");
                jsonWriter.value(serverName);
            }
            if (disassociateNodeRequest.getNodeName() != null) {
                String nodeName = disassociateNodeRequest.getNodeName();
                jsonWriter.name("NodeName");
                jsonWriter.value(nodeName);
            }
            if (disassociateNodeRequest.getEngineAttributes() != null) {
                java.util.List<EngineAttribute> engineAttributes = disassociateNodeRequest
                        .getEngineAttributes();
