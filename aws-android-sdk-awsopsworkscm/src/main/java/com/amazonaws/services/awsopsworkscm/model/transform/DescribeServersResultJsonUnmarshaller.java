 ...
 */
public class DescribeServersResultJsonUnmarshaller implements
        Unmarshaller<DescribeServersResult, JsonUnmarshallerContext> {
    ...
    public DescribeServersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Servers")) {
                describeServersResult.setServers(new ListUnmarshaller<Server>(
                        ServerJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
