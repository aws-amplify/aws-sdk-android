...
/**
 * JSON unmarshaller for response DisassociateNodeResult
 */
public class DisassociateNodeResultJsonUnmarshaller implements
        Unmarshaller<DisassociateNodeResult, JsonUnmarshallerContext> {
    ...
    public DisassociateNodeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NodeAssociationStatusToken")) {
                disassociateNodeResult.setNodeAssociationStatusToken(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
