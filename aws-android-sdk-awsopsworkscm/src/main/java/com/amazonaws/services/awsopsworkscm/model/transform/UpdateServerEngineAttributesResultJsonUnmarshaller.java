...
/**
 * JSON unmarshaller for response UpdateServerEngineAttributesResult
 */
public class UpdateServerEngineAttributesResultJsonUnmarshaller implements
        Unmarshaller<UpdateServerEngineAttributesResult, JsonUnmarshallerContext> {

    public UpdateServerEngineAttributesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Server")) {
                updateServerEngineAttributesResult.setServer(ServerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
