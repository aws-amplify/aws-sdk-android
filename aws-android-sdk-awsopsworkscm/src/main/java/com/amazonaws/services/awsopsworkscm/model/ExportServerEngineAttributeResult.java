...
public class ExportServerEngineAttributeResult implements Serializable {
     ...
     *
     * @return <p>
     *         The requested engine attribute pair with attribute name and
     *         value.
     *         </p>
     */
    ...
    public String toString() {
        ...
        if (getEngineAttribute() != null)
            sb.append("EngineAttribute: " + getEngineAttribute() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getEngineAttribute() == null) ? 0 : getEngineAttribute().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getEngineAttribute() == null ^ this.getEngineAttribute() == null)
            return false;
        if (other.getEngineAttribute() != null
                && other.getEngineAttribute().equals(this.getEngineAttribute()) == false)
            return false;
