 ...
 * </p>
 */
public class GetReusableDelegationSetRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         The ID of the reusable delegation set that you want to get a list
     *         of name servers for.
     *         </p>
     */
    public String getId() {
     ...
     *
     * @param id <p>
     *            The ID of the reusable delegation set that you want to get a
