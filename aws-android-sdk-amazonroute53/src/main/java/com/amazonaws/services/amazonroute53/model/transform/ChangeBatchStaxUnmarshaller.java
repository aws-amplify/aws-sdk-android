...
/**
 * StAX unmarshaller for model ChangeBatch
 */
class ChangeBatchStaxUnmarshaller implements Unmarshaller<ChangeBatch, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Comment", targetDepth)) {
                    changeBatch
                            .setComment(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Changes", targetDepth)) {
                    changeBatch.withChanges(ChangeStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
