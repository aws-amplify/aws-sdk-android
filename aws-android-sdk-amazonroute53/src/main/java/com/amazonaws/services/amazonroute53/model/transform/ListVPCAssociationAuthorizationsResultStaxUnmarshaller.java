...
/**
 * StAX unmarshaller for response ListVPCAssociationAuthorizationsResult
 */
public class ListVPCAssociationAuthorizationsResultStaxUnmarshaller implements
        Unmarshaller<ListVPCAssociationAuthorizationsResult, StaxUnmarshallerContext> {

    public ListVPCAssociationAuthorizationsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("HostedZoneId", targetDepth)) {
                    listVPCAssociationAuthorizationsResult.setHostedZoneId(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    listVPCAssociationAuthorizationsResult.setNextToken(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("VPCs", targetDepth)) {
                    listVPCAssociationAuthorizationsResult.withVPCs(VPCStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
