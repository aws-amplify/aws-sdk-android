...
/**
 * StAX unmarshaller for response DeleteTrafficPolicyInstanceResult
 */
public class DeleteTrafficPolicyInstanceResultStaxUnmarshaller implements
        Unmarshaller<DeleteTrafficPolicyInstanceResult, StaxUnmarshallerContext> {

    public DeleteTrafficPolicyInstanceResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
