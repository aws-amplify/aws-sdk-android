...
/**
 * StAX unmarshaller for response ChangeResourceRecordSetsResult
 */
public class ChangeResourceRecordSetsResultStaxUnmarshaller implements
        Unmarshaller<ChangeResourceRecordSetsResult, StaxUnmarshallerContext> {

    public ChangeResourceRecordSetsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ChangeInfo", targetDepth)) {
                    changeResourceRecordSetsResult.setChangeInfo(ChangeInfoStaxUnmarshaller
