...
/**
 * StAX unmarshaller for model DelegationSet
 */
class DelegationSetStaxUnmarshaller implements Unmarshaller<DelegationSet, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("CallerReference", targetDepth)) {
                    delegationSet.setCallerReference(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("NameServers", targetDepth)) {
                    delegationSet.withNameServers(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
