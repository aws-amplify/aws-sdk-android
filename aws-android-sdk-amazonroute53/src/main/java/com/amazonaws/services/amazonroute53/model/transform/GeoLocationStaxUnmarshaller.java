...
/**
 * StAX unmarshaller for model GeoLocation
 */
class GeoLocationStaxUnmarshaller implements Unmarshaller<GeoLocation, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ContinentCode", targetDepth)) {
                    geoLocation.setContinentCode(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("CountryCode", targetDepth)) {
                    geoLocation.setCountryCode(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("SubdivisionCode", targetDepth)) {
                    geoLocation.setSubdivisionCode(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
