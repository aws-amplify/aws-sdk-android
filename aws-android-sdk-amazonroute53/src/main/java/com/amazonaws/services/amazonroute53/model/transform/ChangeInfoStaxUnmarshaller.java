...
/**
 * StAX unmarshaller for model ChangeInfo
 */
class ChangeInfoStaxUnmarshaller implements Unmarshaller<ChangeInfo, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("SubmittedAt", targetDepth)) {
                    changeInfo.setSubmittedAt(DateStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
