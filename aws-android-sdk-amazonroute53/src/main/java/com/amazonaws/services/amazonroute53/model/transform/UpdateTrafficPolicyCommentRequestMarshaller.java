...
/**
 * StAX request marshaller for UpdateTrafficPolicyCommentRequest
 */
public class UpdateTrafficPolicyCommentRequestMarshaller implements
    ...
    public Request<UpdateTrafficPolicyCommentRequest> marshall(
        ...
        if (updateTrafficPolicyCommentRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateTrafficPolicyCommentRequest)");
        }
        ...
        request.addParameter("Action", "UpdateTrafficPolicyComment");
        request.addParameter("Version", "2013-04-01");

        String prefix;
        if (updateTrafficPolicyCommentRequest.getId() != null) {
            prefix = "Id";
            String id = updateTrafficPolicyCommentRequest.getId();
            request.addParameter(prefix, StringUtils.fromString(id));
        }
        if (updateTrafficPolicyCommentRequest.getVersion() != null) {
            prefix = "Version";
            Integer version = updateTrafficPolicyCommentRequest.getVersion();
            request.addParameter(prefix, StringUtils.fromInteger(version));
        }
        if (updateTrafficPolicyCommentRequest.getComment() != null) {
            prefix = "Comment";
            String comment = updateTrafficPolicyCommentRequest.getComment();
