...
/**
 * StAX unmarshaller for response GetTrafficPolicyInstanceCountResult
 */
public class GetTrafficPolicyInstanceCountResultStaxUnmarshaller implements
        Unmarshaller<GetTrafficPolicyInstanceCountResult, StaxUnmarshallerContext> {

    public GetTrafficPolicyInstanceCountResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("TrafficPolicyInstanceCount", targetDepth)) {
                    getTrafficPolicyInstanceCountResult
                            .setTrafficPolicyInstanceCount(IntegerStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
