...
/**
 * StAX unmarshaller for response GetAccountLimitResult
 */
public class GetAccountLimitResultStaxUnmarshaller implements
        Unmarshaller<GetAccountLimitResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Limit", targetDepth)) {
                    getAccountLimitResult.setLimit(AccountLimitStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Count", targetDepth)) {
                    getAccountLimitResult.setCount(LongStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
