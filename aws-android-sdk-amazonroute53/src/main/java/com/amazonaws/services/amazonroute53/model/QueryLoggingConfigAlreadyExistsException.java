 ...
 * </p>
 */
public class QueryLoggingConfigAlreadyExistsException extends AmazonServiceException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new QueryLoggingConfigAlreadyExistsException with the
