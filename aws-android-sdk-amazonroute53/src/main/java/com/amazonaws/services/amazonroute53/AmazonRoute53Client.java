...
package com.amazonaws.services.amazonroute53;
...
import com.amazonaws.services.amazonroute53.model.transform.*;
...
public class AmazonRoute53Client extends AmazonWebServiceClient implements AmazonRoute53 {
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/amazonroute53/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/amazonroute53/request.handler2s"));
    }
