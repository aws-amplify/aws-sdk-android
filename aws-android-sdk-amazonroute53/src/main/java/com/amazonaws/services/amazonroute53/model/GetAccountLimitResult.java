 ...
 * </p>
 */
public class GetAccountLimitResult implements Serializable {
    /**
     * <p>
     * The current setting for the specified limit. For example, if you
     * specified <code>MAX_HEALTH_CHECKS_BY_OWNER</code> for the value of
     ...
     * <code>MAX_HEALTH_CHECKS_BY_OWNER</code> for the value of
     * <code>Type</code> in the request, the value of <code>Count</code> is the
     ...
     * @return <p>
     *         The current setting for the specified limit. For example, if you
     *         specified <code>MAX_HEALTH_CHECKS_BY_OWNER</code> for the value
     *         of <code>Type</code> in the request, the value of
     *         <code>Limit</code> is the maximum number of health checks that
     ...
     *            you specified <code>MAX_HEALTH_CHECKS_BY_OWNER</code> for the
     *            value of <code>Type</code> in the request, the value of
     *            <code>Limit</code> is the maximum number of health checks that
     *            you can create using the current account.
     *            </p>
     */
     ...
     *         is the current number of health checks that you have created
     ...
     *            <code>Count</code> is the current number of health checks that
