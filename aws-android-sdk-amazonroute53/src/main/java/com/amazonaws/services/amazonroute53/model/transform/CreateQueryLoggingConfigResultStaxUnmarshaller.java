...
/**
 * StAX unmarshaller for response CreateQueryLoggingConfigResult
 */
public class CreateQueryLoggingConfigResultStaxUnmarshaller implements
        Unmarshaller<CreateQueryLoggingConfigResult, StaxUnmarshallerContext> {

    public CreateQueryLoggingConfigResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("QueryLoggingConfig", targetDepth)) {
                    createQueryLoggingConfigResult
                            .setQueryLoggingConfig(QueryLoggingConfigStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Location", targetDepth)) {
                    createQueryLoggingConfigResult.setLocation(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
