...
/**
 * StAX request marshaller for GetHealthCheckCountRequest
 */
public class GetHealthCheckCountRequestMarshaller implements
    ...
    public Request<GetHealthCheckCountRequest> marshall(
        ...
        if (getHealthCheckCountRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetHealthCheckCountRequest)");
        }
        ...
        request.addParameter("Action", "GetHealthCheckCount");
