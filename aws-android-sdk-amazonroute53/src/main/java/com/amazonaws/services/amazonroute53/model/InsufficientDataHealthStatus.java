...
public enum InsufficientDataHealthStatus {
    ...
    private static final Map<String, InsufficientDataHealthStatus> enumMap;
    static {
        enumMap = new HashMap<String, InsufficientDataHealthStatus>();
        enumMap.put("Healthy", Healthy);
        enumMap.put("Unhealthy", Unhealthy);
        enumMap.put("LastKnownStatus", LastKnownStatus);
    }
