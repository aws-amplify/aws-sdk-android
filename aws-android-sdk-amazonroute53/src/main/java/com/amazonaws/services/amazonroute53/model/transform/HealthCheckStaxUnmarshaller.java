        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("CallerReference", targetDepth)) {
                    healthCheck.setCallerReference(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("LinkedService", targetDepth)) {
                    healthCheck.setLinkedService(LinkedServiceStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("HealthCheckConfig", targetDepth)) {
                    healthCheck.setHealthCheckConfig(HealthCheckConfigStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("HealthCheckVersion", targetDepth)) {
                    healthCheck.setHealthCheckVersion(LongStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
