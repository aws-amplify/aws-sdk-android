...
/**
 * StAX unmarshaller for model GeoLocationDetails
 */
class GeoLocationDetailsStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ContinentCode", targetDepth)) {
                    geoLocationDetails.setContinentCode(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ContinentName", targetDepth)) {
                    geoLocationDetails.setContinentName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("CountryCode", targetDepth)) {
                    geoLocationDetails.setCountryCode(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("CountryName", targetDepth)) {
                    geoLocationDetails.setCountryName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("SubdivisionCode", targetDepth)) {
                    geoLocationDetails.setSubdivisionCode(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("SubdivisionName", targetDepth)) {
                    geoLocationDetails.setSubdivisionName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
