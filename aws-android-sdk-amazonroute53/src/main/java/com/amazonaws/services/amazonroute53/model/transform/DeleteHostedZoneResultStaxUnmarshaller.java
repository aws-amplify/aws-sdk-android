...
/**
 * StAX unmarshaller for response DeleteHostedZoneResult
 */
public class DeleteHostedZoneResultStaxUnmarshaller implements
        Unmarshaller<DeleteHostedZoneResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ChangeInfo", targetDepth)) {
                    deleteHostedZoneResult.setChangeInfo(ChangeInfoStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
