...
/**
 * StAX unmarshaller for response CreateHealthCheckResult
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("HealthCheck", targetDepth)) {
                    createHealthCheckResult.setHealthCheck(HealthCheckStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Location", targetDepth)) {
                    createHealthCheckResult.setLocation(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
