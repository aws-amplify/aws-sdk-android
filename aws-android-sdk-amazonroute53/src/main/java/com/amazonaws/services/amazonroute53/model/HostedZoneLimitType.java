...
public enum HostedZoneLimitType {
    ...
    private static final Map<String, HostedZoneLimitType> enumMap;
    static {
        enumMap = new HashMap<String, HostedZoneLimitType>();
        enumMap.put("MAX_RRSETS_BY_ZONE", MAX_RRSETS_BY_ZONE);
        enumMap.put("MAX_VPCS_ASSOCIATED_BY_ZONE", MAX_VPCS_ASSOCIATED_BY_ZONE);
    }
