 ...
 * with a private hosted zone. To get the current limit on the number of
 * reusable delegation sets, see <a href=
 * "https://docs.aws.amazon.com/Route53/latest/APIReference/API_GetAccountLimit.html"
 * >GetAccountLimit</a>. To get the current limit on the number of Amazon VPCs
 * that you can associate with a private hosted zone, see <a href=
