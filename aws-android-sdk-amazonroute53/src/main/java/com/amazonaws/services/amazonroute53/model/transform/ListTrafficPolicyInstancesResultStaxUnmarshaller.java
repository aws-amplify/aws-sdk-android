...
/**
 * StAX unmarshaller for response ListTrafficPolicyInstancesResult
 */
public class ListTrafficPolicyInstancesResultStaxUnmarshaller implements
        Unmarshaller<ListTrafficPolicyInstancesResult, StaxUnmarshallerContext> {

    public ListTrafficPolicyInstancesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("HostedZoneIdMarker", targetDepth)) {
                    listTrafficPolicyInstancesResult.setHostedZoneIdMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("IsTruncated", targetDepth)) {
                    listTrafficPolicyInstancesResult.setIsTruncated(BooleanStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("MaxItems", targetDepth)) {
                    listTrafficPolicyInstancesResult.setMaxItems(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
