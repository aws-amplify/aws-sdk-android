...
package com.amazonaws.services.api.mediatailor;
...
import com.amazonaws.services.api.mediatailor.model.transform.*;

/**
 * Client for accessing AWS MediaTailor. All service calls made using this
...
public class AWSMediaTailorClient extends AmazonWebServiceClient implements AWSMediaTailor {
    ...
    /**
     * List of exception unmarshallers for all AWS MediaTailor exceptions.
     */
    protected List<JsonErrorUnmarshaller> jsonErrorUnmarshallers;

    /**
     * Constructs a new client to invoke service methods on AWSMediaTailor. A
     ...
     *            how this client connects to AWSMediaTailor (ex: proxy
     *            settings, retry counts, etc.).
     * @see DefaultAWSCredentialsProviderChain
     */
    @Deprecated
    public AWSMediaTailorClient(ClientConfiguration clientConfiguration) {
        this(new DefaultAWSCredentialsProviderChain(), clientConfiguration);
    }

    /**
     * Constructs a new client to invoke service methods on AWSMediaTailor using
     ...
     *         AWSMediaTailorClient client = new AWSMediaTailorClient(AWSMobileClient.getInstance());
     *     }
     * 
     *     &#064;Override
     ...
     */
    public AWSMediaTailorClient(AWSCredentials awsCredentials) {
     ...
     *            services.
     */
    public AWSMediaTailorClient(AWSCredentialsProvider awsCredentialsProvider) {
    ...
    private void init() {
        ...
        this.endpointPrefix = "api.mediatailor";

        HandlerChainFactory chainFactory = new HandlerChainFactory();
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/api.mediatailor/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/api.mediatailor/request.handler2s"));
    }
     ...
     */
    public DeletePlaybackConfigurationResult deletePlaybackConfiguration(
        ...
        try {
            ...
            try {
                request = new DeletePlaybackConfigurationRequestMarshaller()
                        .marshall(deletePlaybackConfigurationRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<DeletePlaybackConfigurationResult, JsonUnmarshallerContext> unmarshaller = new DeletePlaybackConfigurationResultJsonUnmarshaller();
            JsonResponseHandler<DeletePlaybackConfigurationResult> responseHandler = new JsonResponseHandler<DeletePlaybackConfigurationResult>(
                    unmarshaller);
     ...
     *             request, or a server side issue.
     */
    public GetPlaybackConfigurationResult getPlaybackConfiguration(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetPlaybackConfigurationRequestMarshaller()
                        .marshall(getPlaybackConfigurationRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<GetPlaybackConfigurationResult, JsonUnmarshallerContext> unmarshaller = new GetPlaybackConfigurationResultJsonUnmarshaller();
            JsonResponseHandler<GetPlaybackConfigurationResult> responseHandler = new JsonResponseHandler<GetPlaybackConfigurationResult>(
                    unmarshaller);
     ...
     *             request, or a server side issue.
     */
    public ListPlaybackConfigurationsResult listPlaybackConfigurations(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListPlaybackConfigurationsRequestMarshaller()
                        .marshall(listPlaybackConfigurationsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<ListPlaybackConfigurationsResult, JsonUnmarshallerContext> unmarshaller = new ListPlaybackConfigurationsResultJsonUnmarshaller();
            JsonResponseHandler<ListPlaybackConfigurationsResult> responseHandler = new JsonResponseHandler<ListPlaybackConfigurationsResult>(
                    unmarshaller);
     ...
     *             request, or a server side issue.
     */
    public PutPlaybackConfigurationResult putPlaybackConfiguration(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new PutPlaybackConfigurationRequestMarshaller()
                        .marshall(putPlaybackConfigurationRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<PutPlaybackConfigurationResult, JsonUnmarshallerContext> unmarshaller = new PutPlaybackConfigurationResultJsonUnmarshaller();
            JsonResponseHandler<PutPlaybackConfigurationResult> responseHandler = new JsonResponseHandler<PutPlaybackConfigurationResult>(
                    unmarshaller);
