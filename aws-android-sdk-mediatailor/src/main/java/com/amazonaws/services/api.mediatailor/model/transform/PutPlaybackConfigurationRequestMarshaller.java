...
public class PutPlaybackConfigurationRequestMarshaller implements
    ...
    public Request<PutPlaybackConfigurationRequest> marshall(
        ...
        try {
            ...
            if (putPlaybackConfigurationRequest.getBumper() != null) {
                Bumper bumper = putPlaybackConfigurationRequest.getBumper();
                jsonWriter.name("Bumper");
                BumperJsonMarshaller.getInstance().marshall(bumper, jsonWriter);
            }
