...
/**
 * JSON unmarshaller for POJO AvailSuppression
 */
class AvailSuppressionJsonUnmarshaller implements
        Unmarshaller<AvailSuppression, JsonUnmarshallerContext> {
    ...
    public AvailSuppression unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Mode")) {
                availSuppression.setMode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Value")) {
                availSuppression.setValue(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
