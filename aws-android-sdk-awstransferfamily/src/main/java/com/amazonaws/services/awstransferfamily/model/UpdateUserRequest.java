...
public class UpdateUserRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         is. You will need to also make sure that your AWS IAM Role
     *         provides access to paths in <code>Target</code>. The following is
     *         an example.
     *         </p>
     *         <p>
     *         <code>'[ "/bucket2/documentation", { "Entry": "your-personal-report.pdf", "Target": "/bucket3/customized-reports/${transfer:UserName}.pdf" } ]'</code>
     ...
     *            in <code>Target</code>. The following is an example.
     *            </p>
     *            <p>
     *            <code>'[ "/bucket2/documentation", { "Entry": "your-personal-report.pdf", "Target": "/bucket3/customized-reports/${transfer:UserName}.pdf" } ]'</code>
     *            </p>
     ...
     *            can use the same AWS Identity and Access Management (IAM) role
     *            across multiple users. The policy scopes down user access to
     *            portions of your Amazon S3 bucket. Variables you can use
