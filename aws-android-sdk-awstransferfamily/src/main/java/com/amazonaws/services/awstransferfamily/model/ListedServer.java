...
public class ListedServer implements Serializable {
     ...
     * authentication method. Valid values include <code>SERVICE_MANAGED</code>
    ...
    /**
     * <p>
     * Describes the condition of a file transfer protocol-enabled server for
     ...
     *         include Secure Shell (SSH), user name and password combinations,
     *         or your own custom authentication method. Valid values include
     ...
     *            The authentication method used to validate a user for a file
     *            transfer protocol-enabled server that was specified. This can
     *            include Secure Shell (SSH), user name and password
     ...
     *            The type of VPC endpoint that your file transfer
     ...
     *
     * @param loggingRole <p>
     *            The AWS Identity and Access Management (IAM) entity that
     *            allows a file transfer protocol-enabled server to turn on
     ...
     *
     * @return <p>
     *         Describes the condition of a file transfer protocol-enabled
     ...
     *
     * @return <p>
     *         A numeric value that indicates the number of users that are
     *         assigned to a file transfer protocol-enabled server you specified
     ...
     * @param userCount <p>
     *            A numeric value that indicates the number of users that are
     *            assigned to a file transfer protocol-enabled server you
