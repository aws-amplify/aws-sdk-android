...
/**
 * JSON unmarshaller for response ImportSshPublicKeyResult
 */
public class ImportSshPublicKeyResultJsonUnmarshaller implements
        Unmarshaller<ImportSshPublicKeyResult, JsonUnmarshallerContext> {
    ...
    public ImportSshPublicKeyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ServerId")) {
                importSshPublicKeyResult.setServerId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("SshPublicKeyId")) {
                importSshPublicKeyResult.setSshPublicKeyId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("UserName")) {
                importSshPublicKeyResult.setUserName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
