...
/**
 * JSON unmarshaller for POJO EndpointDetails
 */
class EndpointDetailsJsonUnmarshaller implements
        Unmarshaller<EndpointDetails, JsonUnmarshallerContext> {
    ...
    public EndpointDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AddressAllocationIds")) {
                endpointDetails.setAddressAllocationIds(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("SubnetIds")) {
                endpointDetails.setSubnetIds(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("VpcEndpointId")) {
                endpointDetails.setVpcEndpointId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("VpcId")) {
                endpointDetails.setVpcId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
