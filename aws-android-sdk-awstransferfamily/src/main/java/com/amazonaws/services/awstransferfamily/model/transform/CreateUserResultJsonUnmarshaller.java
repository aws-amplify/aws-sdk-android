 ...
 */
public class CreateUserResultJsonUnmarshaller implements
        Unmarshaller<CreateUserResult, JsonUnmarshallerContext> {
    ...
    public CreateUserResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ServerId")) {
                createUserResult.setServerId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("UserName")) {
                createUserResult.setUserName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
