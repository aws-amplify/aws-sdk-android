    ...
    public ListUsersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NextToken")) {
                ...
                listUsersResult.setServerId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Users")) {
                listUsersResult.setUsers(new ListUnmarshaller<ListedUser>(
                        ListedUserJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
