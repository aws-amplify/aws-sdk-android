...
/**
 * JSON request marshaller for DeleteSshPublicKeyRequest
 */
public class DeleteSshPublicKeyRequestMarshaller implements
    ...
    public Request<DeleteSshPublicKeyRequest> marshall(
        ...
        Request<DeleteSshPublicKeyRequest> request = new DefaultRequest<DeleteSshPublicKeyRequest>(
                deleteSshPublicKeyRequest, "AWSTransferFamily");
        ...
        try {
            ...
            if (deleteSshPublicKeyRequest.getServerId() != null) {
                String serverId = deleteSshPublicKeyRequest.getServerId();
