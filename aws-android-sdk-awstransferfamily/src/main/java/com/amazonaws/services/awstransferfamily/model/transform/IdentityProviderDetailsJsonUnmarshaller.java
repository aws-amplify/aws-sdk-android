...
/**
 * JSON unmarshaller for POJO IdentityProviderDetails
 */
class IdentityProviderDetailsJsonUnmarshaller implements
        Unmarshaller<IdentityProviderDetails, JsonUnmarshallerContext> {
    ...
    public IdentityProviderDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Url")) {
                identityProviderDetails.setUrl(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("InvocationRole")) {
                identityProviderDetails.setInvocationRole(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
