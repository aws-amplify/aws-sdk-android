...
/**
 * JSON unmarshaller for response DescribeCertificatesResult
 */
    ...
    public DescribeCertificatesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Marker")) {
                describeCertificatesResult.setMarker(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Certificates")) {
                describeCertificatesResult.setCertificates(new ListUnmarshaller<Certificate>(
