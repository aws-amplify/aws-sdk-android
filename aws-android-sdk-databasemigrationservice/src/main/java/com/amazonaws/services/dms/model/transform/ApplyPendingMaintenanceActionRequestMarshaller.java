...
/**
 * JSON request marshaller for ApplyPendingMaintenanceActionRequest
 */
public class ApplyPendingMaintenanceActionRequestMarshaller
    ...
    public Request<ApplyPendingMaintenanceActionRequest> marshall(
        ...
        Request<ApplyPendingMaintenanceActionRequest> request = new DefaultRequest<ApplyPendingMaintenanceActionRequest>(
                applyPendingMaintenanceActionRequest, "AWSDatabaseMigrationService");
        ...
        try {
            ...
            if (applyPendingMaintenanceActionRequest.getReplicationInstanceArn() != null) {
                String replicationInstanceArn = applyPendingMaintenanceActionRequest
            ...
            if (applyPendingMaintenanceActionRequest.getApplyAction() != null) {
                ...
                jsonWriter.name("ApplyAction");
                jsonWriter.value(applyAction);
            }
