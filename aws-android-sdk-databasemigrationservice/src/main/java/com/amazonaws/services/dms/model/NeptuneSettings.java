...
public class NeptuneSettings implements Serializable {
     ...
     * the Neptune target endpoint. For more information, see <a href=
     * "https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.Neptune.html#CHAP_Target.Neptune.ServiceRole"
     * >Creating an IAM Service Role for Accessing Amazon Neptune as a
     * Target</a> in the <i>AWS Database Migration Service User Guide. </i>
     * </p>
     */
     ...
     * enabled for this endpoint, set this parameter to <code>true</code>. Then
     * attach the appropriate IAM policy document to your service role specified
     * by <code>ServiceAccessRoleArn</code>. The default is <code>false</code>.
     * </p>
     */
     ...
     *
     * @return <p>
     *         The Amazon Resource Name (ARN) of the service role that you
     *         created for the Neptune target endpoint. For more information,
     *         see <a href=
     *         "https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.Neptune.html#CHAP_Target.Neptune.ServiceRole"
     *         >Creating an IAM Service Role for Accessing Amazon Neptune as a
     *         Target</a> in the <i>AWS Database Migration Service User Guide.
     *         </i>
     *         </p>
     */
     ...
     *            see <a href=
     *            "https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.Neptune.html#CHAP_Target.Neptune.ServiceRole"
     *            >Creating an IAM Service Role for Accessing Amazon Neptune as
     *            a Target</a> in the <i>AWS Database Migration Service User
     *            Guide. </i>
     *            </p>
     */
     ...
     *
     * @return <p>
     *         The name of the Amazon S3 bucket where AWS DMS can temporarily
     *         store migrated graph data in .csv files before bulk-loading it to
     *         the Neptune target database. AWS DMS maps the SQL source data to
     ...
     *            The name of the Amazon S3 bucket where AWS DMS can temporarily
     *            store migrated graph data in .csv files before bulk-loading it
     *            to the Neptune target database. AWS DMS maps the SQL source
     ...
     *
     * @return <p>
     *         A folder path where you want AWS DMS to store migrated graph data
     ...
     *            A folder path where you want AWS DMS to store migrated graph
     ...
     *         .csv file before AWS DMS bulk-loads the data to the Neptune
     *         target database. The default is 1,048,576 KB. If the bulk load is
     *         successful, AWS DMS clears the bucket, ready to store the next
     ...
     *
     * @param maxFileSize <p>
     *            The maximum size in kilobytes of migrated graph data stored in
     *            a .csv file before AWS DMS bulk-loads the data to the Neptune
     *            target database. The default is 1,048,576 KB. If the bulk load
     *            is successful, AWS DMS clears the bucket, ready to store the
     ...
     *
     * @return <p>
     *         If you want AWS Identity and Access Management (IAM)
     *         authorization enabled for this endpoint, set this parameter to
     *         <code>true</code>. Then attach the appropriate IAM policy
