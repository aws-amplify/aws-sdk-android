...
/**
 * JSON unmarshaller for response DescribeEventCategoriesResult
 */
public class DescribeEventCategoriesResultJsonUnmarshaller implements
        Unmarshaller<DescribeEventCategoriesResult, JsonUnmarshallerContext> {
    ...
    public DescribeEventCategoriesResult unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("EventCategoryGroupList")) {
                describeEventCategoriesResult
                        .setEventCategoryGroupList(new ListUnmarshaller<EventCategoryGroup>(
                                EventCategoryGroupJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
