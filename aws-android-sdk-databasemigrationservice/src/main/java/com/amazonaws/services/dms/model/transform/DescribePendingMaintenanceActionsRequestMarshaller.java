...
/**
 * JSON request marshaller for DescribePendingMaintenanceActionsRequest
 */
public class DescribePendingMaintenanceActionsRequestMarshaller
    ...
    public Request<DescribePendingMaintenanceActionsRequest> marshall(
        ...
        Request<DescribePendingMaintenanceActionsRequest> request = new DefaultRequest<DescribePendingMaintenanceActionsRequest>(
                describePendingMaintenanceActionsRequest, "AWSDatabaseMigrationService");
        ...
        try {
            ...
            if (describePendingMaintenanceActionsRequest.getReplicationInstanceArn() != null) {
                String replicationInstanceArn = describePendingMaintenanceActionsRequest
            ...
            if (describePendingMaintenanceActionsRequest.getFilters() != null) {
                java.util.List<Filter> filters = describePendingMaintenanceActionsRequest
                        .getFilters();
