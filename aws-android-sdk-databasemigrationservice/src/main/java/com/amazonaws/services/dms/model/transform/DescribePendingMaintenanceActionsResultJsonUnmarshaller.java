...
/**
 * JSON unmarshaller for response DescribePendingMaintenanceActionsResult
 */
public class DescribePendingMaintenanceActionsResultJsonUnmarshaller implements
        Unmarshaller<DescribePendingMaintenanceActionsResult, JsonUnmarshallerContext> {

    public DescribePendingMaintenanceActionsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PendingMaintenanceActions")) {
                describePendingMaintenanceActionsResult
                        .setPendingMaintenanceActions(new ListUnmarshaller<ResourcePendingMaintenanceActions>(
                                ResourcePendingMaintenanceActionsJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Marker")) {
                describePendingMaintenanceActionsResult.setMarker(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
