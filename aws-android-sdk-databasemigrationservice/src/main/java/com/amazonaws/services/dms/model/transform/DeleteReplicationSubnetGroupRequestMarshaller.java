...
/**
 * JSON request marshaller for DeleteReplicationSubnetGroupRequest
 */
public class DeleteReplicationSubnetGroupRequestMarshaller
    ...
    public Request<DeleteReplicationSubnetGroupRequest> marshall(
            DeleteReplicationSubnetGroupRequest deleteReplicationSubnetGroupRequest) {
        if (deleteReplicationSubnetGroupRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteReplicationSubnetGroupRequest)");
        }

        Request<DeleteReplicationSubnetGroupRequest> request = new DefaultRequest<DeleteReplicationSubnetGroupRequest>(
                deleteReplicationSubnetGroupRequest, "AWSDatabaseMigrationService");
        ...
        try {
            ...
            if (deleteReplicationSubnetGroupRequest.getReplicationSubnetGroupIdentifier() != null) {
                String replicationSubnetGroupIdentifier = deleteReplicationSubnetGroupRequest
