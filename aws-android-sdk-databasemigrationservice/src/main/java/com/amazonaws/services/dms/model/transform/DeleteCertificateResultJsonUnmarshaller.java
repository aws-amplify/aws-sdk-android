...
/**
 * JSON unmarshaller for response DeleteCertificateResult
 */
public class DeleteCertificateResultJsonUnmarshaller implements
        Unmarshaller<DeleteCertificateResult, JsonUnmarshallerContext> {
    ...
    public DeleteCertificateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Certificate")) {
                deleteCertificateResult.setCertificate(CertificateJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
