...
public enum StartReplicationTaskTypeValue {
    ...
    private static final Map<String, StartReplicationTaskTypeValue> enumMap;
    static {
        enumMap = new HashMap<String, StartReplicationTaskTypeValue>();
        enumMap.put("start-replication", StartReplication);
        enumMap.put("resume-processing", ResumeProcessing);
        enumMap.put("reload-target", ReloadTarget);
    }
