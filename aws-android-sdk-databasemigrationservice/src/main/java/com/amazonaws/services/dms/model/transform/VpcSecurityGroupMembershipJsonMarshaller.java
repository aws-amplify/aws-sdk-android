...
/**
 * JSON marshaller for POJO VpcSecurityGroupMembership
 */
class VpcSecurityGroupMembershipJsonMarshaller {
    ...
    public void marshall(VpcSecurityGroupMembership vpcSecurityGroupMembership,
        ...
        if (vpcSecurityGroupMembership.getVpcSecurityGroupId() != null) {
            String vpcSecurityGroupId = vpcSecurityGroupMembership.getVpcSecurityGroupId();
            jsonWriter.name("VpcSecurityGroupId");
            jsonWriter.value(vpcSecurityGroupId);
        }
        if (vpcSecurityGroupMembership.getStatus() != null) {
            String status = vpcSecurityGroupMembership.getStatus();
