...
/**
 * JSON request marshaller for ModifyReplicationSubnetGroupRequest
 */
    ...
    public Request<ModifyReplicationSubnetGroupRequest> marshall(
        ...
        if (modifyReplicationSubnetGroupRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ModifyReplicationSubnetGroupRequest)");
        }

        Request<ModifyReplicationSubnetGroupRequest> request = new DefaultRequest<ModifyReplicationSubnetGroupRequest>(
                modifyReplicationSubnetGroupRequest, "AWSDatabaseMigrationService");
        ...
        try {
            ...
            if (modifyReplicationSubnetGroupRequest.getReplicationSubnetGroupIdentifier() != null) {
                String replicationSubnetGroupIdentifier = modifyReplicationSubnetGroupRequest
            ...
            if (modifyReplicationSubnetGroupRequest.getReplicationSubnetGroupDescription() != null) {
                String replicationSubnetGroupDescription = modifyReplicationSubnetGroupRequest
            ...
            if (modifyReplicationSubnetGroupRequest.getSubnetIds() != null) {
                java.util.List<String> subnetIds = modifyReplicationSubnetGroupRequest
                        .getSubnetIds();
