...
/**
 * JSON unmarshaller for response CreateVirtualServiceResult
 */
public class CreateVirtualServiceResultJsonUnmarshaller implements
        Unmarshaller<CreateVirtualServiceResult, JsonUnmarshallerContext> {
