...
/**
 * JSON unmarshaller for response UpdateVirtualNodeResult
 */
public class UpdateVirtualNodeResultJsonUnmarshaller implements
        Unmarshaller<UpdateVirtualNodeResult, JsonUnmarshallerContext> {
