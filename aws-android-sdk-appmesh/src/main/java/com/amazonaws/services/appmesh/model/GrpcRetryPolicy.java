 ...
 * </p>
 */
public class GrpcRetryPolicy implements Serializable {
    /**
     * <p>
    ...
    public GrpcRetryPolicy withGrpcRetryEvents(String... grpcRetryEvents) {
        if (getGrpcRetryEvents() == null) {
            this.grpcRetryEvents = new java.util.ArrayList<String>(grpcRetryEvents.length);
        }
        for (String value : grpcRetryEvents) {
            this.grpcRetryEvents.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getGrpcRetryEvents() != null)
            sb.append("grpcRetryEvents: " + getGrpcRetryEvents() + ",");
        if (getHttpRetryEvents() != null)
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getGrpcRetryEvents() == null) ? 0 : getGrpcRetryEvents().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getGrpcRetryEvents() == null ^ this.getGrpcRetryEvents() == null)
            return false;
        if (other.getGrpcRetryEvents() != null
                && other.getGrpcRetryEvents().equals(this.getGrpcRetryEvents()) == false)
            return false;
