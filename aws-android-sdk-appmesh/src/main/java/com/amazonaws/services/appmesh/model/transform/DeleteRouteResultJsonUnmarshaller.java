...
/**
 * JSON unmarshaller for response DeleteRouteResult
 */
public class DeleteRouteResultJsonUnmarshaller implements
        Unmarshaller<DeleteRouteResult, JsonUnmarshallerContext> {
