...
/**
 * JSON unmarshaller for POJO WeightedTarget
 */
class WeightedTargetJsonUnmarshaller implements
        Unmarshaller<WeightedTarget, JsonUnmarshallerContext> {
    ...
    public WeightedTarget unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("virtualNode")) {
                weightedTarget.setVirtualNode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("weight")) {
                weightedTarget.setWeight(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
