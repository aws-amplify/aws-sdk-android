...
public class ServiceDiscovery implements Serializable {
    ...
    public String toString() {
        ...
        if (getAwsCloudMap() != null)
            sb.append("awsCloudMap: " + getAwsCloudMap() + ",");
        if (getDns() != null)
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getAwsCloudMap() == null) ? 0 : getAwsCloudMap().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAwsCloudMap() == null ^ this.getAwsCloudMap() == null)
            return false;
        if (other.getAwsCloudMap() != null
                && other.getAwsCloudMap().equals(this.getAwsCloudMap()) == false)
            return false;
