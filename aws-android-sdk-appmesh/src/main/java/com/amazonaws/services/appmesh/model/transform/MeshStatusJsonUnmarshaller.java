...
/**
 * JSON unmarshaller for POJO MeshStatus
 */
class MeshStatusJsonUnmarshaller implements Unmarshaller<MeshStatus, JsonUnmarshallerContext> {
    ...
    public MeshStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("status")) {
                meshStatus.setStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
