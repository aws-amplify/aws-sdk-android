...
/**
 * JSON unmarshaller for response DescribeVirtualNodeResult
 */
public class DescribeVirtualNodeResultJsonUnmarshaller implements
        Unmarshaller<DescribeVirtualNodeResult, JsonUnmarshallerContext> {
