 ...
 * </p>
 */
public class ListVirtualNodesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     * The maximum number of results returned by <code>ListVirtualNodes</code>
     * in paginated output. When you use this parameter,
     * <code>ListVirtualNodes</code> returns only <code>limit</code> results in
     ...
     *         <code>ListVirtualNodes</code> in paginated output. When you use
     *         this parameter, <code>ListVirtualNodes</code> returns only
     ...
     * @param limit <p>
     *            The maximum number of results returned by
     *            <code>ListVirtualNodes</code> in paginated output. When you
     *            use this parameter, <code>ListVirtualNodes</code> returns only
     *            <code>limit</code> results in a single page along with a
     *            <code>nextToken</code> response element. You can see the
     *            remaining results of the initial request by sending another
     *            <code>ListVirtualNodes</code> request with the returned
     ...
     *         paginated <code>ListVirtualNodes</code> request where
