...
/**
 * JSON unmarshaller for POJO MeshSpec
 */
class MeshSpecJsonUnmarshaller implements Unmarshaller<MeshSpec, JsonUnmarshallerContext> {
    ...
    public MeshSpec unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("egressFilter")) {
                meshSpec.setEgressFilter(EgressFilterJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
