 ...
 * router receives. Create a virtual router for each protocol and port that you
 * need to route. Virtual routers handle traffic for one or more virtual
 * services within your mesh. After you create your virtual router, create and
 ...
 * </p>
 */
public class CreateVirtualRouterRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         Optional metadata that you can apply to the virtual router to
