...
/**
 * JSON unmarshaller for response DescribeVirtualRouterResult
 */
public class DescribeVirtualRouterResultJsonUnmarshaller implements
        Unmarshaller<DescribeVirtualRouterResult, JsonUnmarshallerContext> {
