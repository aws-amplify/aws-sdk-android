...
/**
 * JSON unmarshaller for response UpdateVirtualRouterResult
 */
public class UpdateVirtualRouterResultJsonUnmarshaller implements
        Unmarshaller<UpdateVirtualRouterResult, JsonUnmarshallerContext> {
