...
/**
 * JSON unmarshaller for response DescribeVirtualServiceResult
 */
public class DescribeVirtualServiceResultJsonUnmarshaller implements
        Unmarshaller<DescribeVirtualServiceResult, JsonUnmarshallerContext> {

    public DescribeVirtualServiceResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
