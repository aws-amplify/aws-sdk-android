...
/**
 * JSON unmarshaller for response CreateVirtualRouterResult
 */
public class CreateVirtualRouterResultJsonUnmarshaller implements
        Unmarshaller<CreateVirtualRouterResult, JsonUnmarshallerContext> {
