...
public class ListEndpointsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         If the result of a <code>ListEndpoints</code> request was
     *         truncated, the response includes a <code>NextToken</code>. To
     *         retrieve the next set of endpoints, use the token in the next
     *         request.
     *         </p>
     */
     ...
     *
     * @return <p>
     *         A string in endpoint names. This filter returns only endpoints
     ...
     *            A filter that returns only endpoints that were created before
     ...
     *            A filter that returns only endpoints with a creation time
     ...
     *
     * @return <p>
     *         A filter that returns only endpoints that were modified before
     ...
     *            A filter that returns only endpoints that were modified after
     *            the specified timestamp.
     *            </p>
     */
     ...
     *            A filter that returns only endpoints with the specified
     *            status.
     *            </p>
     * @see EndpointStatus
     */
