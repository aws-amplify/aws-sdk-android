...
/**
 * JSON unmarshaller for response CreateCompilationJobResult
 */
public class CreateCompilationJobResultJsonUnmarshaller implements
        Unmarshaller<CreateCompilationJobResult, JsonUnmarshallerContext> {
    ...
    public CreateCompilationJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("CompilationJobArn")) {
                createCompilationJobResult.setCompilationJobArn(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
