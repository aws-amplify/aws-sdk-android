...
/**
 * JSON unmarshaller for response ListTrialComponentsResult
 */
public class ListTrialComponentsResultJsonUnmarshaller implements
        Unmarshaller<ListTrialComponentsResult, JsonUnmarshallerContext> {
    ...
    public ListTrialComponentsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("TrialComponentSummaries")) {
                listTrialComponentsResult
                        .setTrialComponentSummaries(new ListUnmarshaller<TrialComponentSummary>(
                                TrialComponentSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                listTrialComponentsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
