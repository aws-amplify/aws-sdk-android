 ...
 * associated with that Amazon Elastic File System (EFS). This operation can
 * only be called when AuthMode equals IAM.
 * </p>
 */
public class CreatePresignedDomainUrlRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     * The domain ID.
     ...
     *         chained together.
     */
    public CreatePresignedDomainUrlRequest withSessionExpirationDurationInSeconds(
