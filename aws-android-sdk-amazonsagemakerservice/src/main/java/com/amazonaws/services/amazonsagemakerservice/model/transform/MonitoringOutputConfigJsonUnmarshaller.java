...
/**
 * JSON unmarshaller for POJO MonitoringOutputConfig
 */
class MonitoringOutputConfigJsonUnmarshaller implements
        Unmarshaller<MonitoringOutputConfig, JsonUnmarshallerContext> {
    ...
    public MonitoringOutputConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("MonitoringOutputs")) {
                monitoringOutputConfig.setMonitoringOutputs(new ListUnmarshaller<MonitoringOutput>(
                        MonitoringOutputJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("KmsKeyId")) {
                monitoringOutputConfig.setKmsKeyId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
