 ...
 * to the <code>Stopped</code> state, it releases all reserved resources for the
 * tuning job.
 * </p>
 */
public class StopHyperParameterTuningJobRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public StopHyperParameterTuningJobRequest withHyperParameterTuningJobName(
