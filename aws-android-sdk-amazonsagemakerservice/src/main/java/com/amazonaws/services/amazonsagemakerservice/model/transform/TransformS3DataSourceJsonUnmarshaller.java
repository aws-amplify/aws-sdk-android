...
/**
 * JSON unmarshaller for POJO TransformS3DataSource
 */
class TransformS3DataSourceJsonUnmarshaller implements
        Unmarshaller<TransformS3DataSource, JsonUnmarshallerContext> {
    ...
    public TransformS3DataSource unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("S3DataType")) {
                transformS3DataSource.setS3DataType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("S3Uri")) {
                transformS3DataSource.setS3Uri(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
