...
public class CreateAppRequestMarshaller implements
    ...
    public Request<CreateAppRequest> marshall(CreateAppRequest createAppRequest) {
        ...
        try {
            ...
            if (createAppRequest.getDomainId() != null) {
                String domainId = createAppRequest.getDomainId();
                jsonWriter.name("DomainId");
                jsonWriter.value(domainId);
            }
            if (createAppRequest.getUserProfileName() != null) {
                String userProfileName = createAppRequest.getUserProfileName();
                jsonWriter.name("UserProfileName");
                jsonWriter.value(userProfileName);
            }
            if (createAppRequest.getAppType() != null) {
                String appType = createAppRequest.getAppType();
                jsonWriter.name("AppType");
                jsonWriter.value(appType);
            }
            if (createAppRequest.getAppName() != null) {
                String appName = createAppRequest.getAppName();
                jsonWriter.name("AppName");
                jsonWriter.value(appName);
            }
            if (createAppRequest.getTags() != null) {
                java.util.List<Tag> tags = createAppRequest.getTags();
            ...
            if (createAppRequest.getResourceSpec() != null) {
                ResourceSpec resourceSpec = createAppRequest.getResourceSpec();
                jsonWriter.name("ResourceSpec");
                ResourceSpecJsonMarshaller.getInstance().marshall(resourceSpec, jsonWriter);
            }
