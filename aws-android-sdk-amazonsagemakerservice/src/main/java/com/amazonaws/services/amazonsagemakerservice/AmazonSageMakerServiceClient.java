...
import com.amazonaws.services.amazonsagemakerservice.model.transform.*;
...
public class AmazonSageMakerServiceClient extends AmazonWebServiceClient implements
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/amazonsagemakerservice/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/amazonsagemakerservice/request.handler2s"));
    }
