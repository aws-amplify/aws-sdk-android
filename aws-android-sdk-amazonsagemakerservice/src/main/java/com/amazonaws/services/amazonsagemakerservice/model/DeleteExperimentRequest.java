 ...
 * experiment must be deleted first. Use the <a>ListTrials</a> API to get a list
 * of the trials associated with the experiment.
 * </p>
 */
public class DeleteExperimentRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
