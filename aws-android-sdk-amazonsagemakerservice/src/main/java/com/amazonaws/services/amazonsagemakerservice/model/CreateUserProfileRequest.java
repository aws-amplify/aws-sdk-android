...
/**
 * <p>
 * Creates a new user profile. A user profile represents a single user within a
 ...
 * them from SSO, a new UserProfile is automatically created. This entity is the
 * primary holder of settings for an individual user and has a reference to the
