...
import com.amazonaws.services.amazonsagemakerservice.model.ResourceInUseException;
...
public class ResourceInUseExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("ResourceInUse");
    }
