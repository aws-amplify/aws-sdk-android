...
public enum ResourceType {
    ...
    static {
        ...
        enumMap.put("TrainingJob", TrainingJob);
        enumMap.put("Experiment", Experiment);
        enumMap.put("ExperimentTrial", ExperimentTrial);
        enumMap.put("ExperimentTrialComponent", ExperimentTrialComponent);
    }
