 ...
 * </p>
 */
public class ListFlowDefinitionsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *            A filter that returns only flow definitions with a creation
     ...
     *
     * @return <p>
     *         A filter that returns only flow definitions that were created
