    ...
    public Reservation unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Groups")) {
                reservation.setGroups(new ListUnmarshaller<GroupIdentifier>(
                        GroupIdentifierJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Instances")) {
                reservation.setInstances(new ListUnmarshaller<Instance>(InstanceJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("OwnerId")) {
                reservation.setOwnerId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("RequesterId")) {
                reservation.setRequesterId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
