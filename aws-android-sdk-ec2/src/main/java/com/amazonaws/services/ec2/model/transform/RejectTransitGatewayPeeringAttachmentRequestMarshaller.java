...
/**
 * JSON request marshaller for RejectTransitGatewayPeeringAttachmentRequest
 */
public class RejectTransitGatewayPeeringAttachmentRequestMarshaller
        implements
    ...
    public Request<RejectTransitGatewayPeeringAttachmentRequest> marshall(
        ...
        if (rejectTransitGatewayPeeringAttachmentRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RejectTransitGatewayPeeringAttachmentRequest)");
        }
        ...
        Request<RejectTransitGatewayPeeringAttachmentRequest> request = new DefaultRequest<RejectTransitGatewayPeeringAttachmentRequest>(
                rejectTransitGatewayPeeringAttachmentRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (rejectTransitGatewayPeeringAttachmentRequest.getTransitGatewayAttachmentId() != null) {
                String transitGatewayAttachmentId = rejectTransitGatewayPeeringAttachmentRequest
                        .getTransitGatewayAttachmentId();
                jsonWriter.name("TransitGatewayAttachmentId");
                jsonWriter.value(transitGatewayAttachmentId);
            }
            if (rejectTransitGatewayPeeringAttachmentRequest.getDryRun() != null) {
                Boolean dryRun = rejectTransitGatewayPeeringAttachmentRequest.getDryRun();
