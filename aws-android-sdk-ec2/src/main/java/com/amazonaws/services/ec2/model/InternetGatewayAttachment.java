...
public class InternetGatewayAttachment implements Serializable {
     ...
     * is <code>available</code> when attached to a VPC; otherwise, this value
     * is not returned.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
     ...
     *         state is <code>available</code> when attached to a VPC;
     ...
     *
     * @param state <p>
     *            The current state of the attachment. For an internet gateway,
     *            the state is <code>available</code> when attached to a VPC;
     *            otherwise, this value is not returned.
     *            </p>
     * @see AttachmentStatus
     */
