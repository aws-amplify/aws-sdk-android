...
public class UnmonitorInstancesResultStaxUnmarshaller implements Unmarshaller<UnmonitorInstancesResult, StaxUnmarshallerContext> {
    ...
    public UnmonitorInstancesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return unmonitorInstancesResult;

            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("instancesSet/item", targetDepth)) {
                    unmonitorInstancesResult.getInstanceMonitorings().add(InstanceMonitoringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static UnmonitorInstancesResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new UnmonitorInstancesResultStaxUnmarshaller();
        return instance;
    }
}
