...
/**
 * JSON request marshaller for DisableTransitGatewayRouteTablePropagationRequest
 */
public class DisableTransitGatewayRouteTablePropagationRequestMarshaller
        implements
    ...
    public Request<DisableTransitGatewayRouteTablePropagationRequest> marshall(
        ...
        if (disableTransitGatewayRouteTablePropagationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DisableTransitGatewayRouteTablePropagationRequest)");
        }
        ...
        Request<DisableTransitGatewayRouteTablePropagationRequest> request = new DefaultRequest<DisableTransitGatewayRouteTablePropagationRequest>(
                disableTransitGatewayRouteTablePropagationRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (disableTransitGatewayRouteTablePropagationRequest.getTransitGatewayRouteTableId() != null) {
                String transitGatewayRouteTableId = disableTransitGatewayRouteTablePropagationRequest
            ...
            if (disableTransitGatewayRouteTablePropagationRequest.getTransitGatewayAttachmentId() != null) {
                String transitGatewayAttachmentId = disableTransitGatewayRouteTablePropagationRequest
                        .getTransitGatewayAttachmentId();
                jsonWriter.name("TransitGatewayAttachmentId");
                jsonWriter.value(transitGatewayAttachmentId);
            }
            if (disableTransitGatewayRouteTablePropagationRequest.getDryRun() != null) {
                Boolean dryRun = disableTransitGatewayRouteTablePropagationRequest.getDryRun();
