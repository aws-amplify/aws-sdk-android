...
/**
 * JSON request marshaller for DescribeSubnetsRequest
 */
    ...
    public Request<DescribeSubnetsRequest> marshall(DescribeSubnetsRequest describeSubnetsRequest) {
        if (describeSubnetsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeSubnetsRequest)");
        }

        Request<DescribeSubnetsRequest> request = new DefaultRequest<DescribeSubnetsRequest>(
                describeSubnetsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeSubnetsRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeSubnetsRequest.getFilters();
            ...
            if (describeSubnetsRequest.getSubnetIds() != null) {
                java.util.List<String> subnetIds = describeSubnetsRequest.getSubnetIds();
            ...
            if (describeSubnetsRequest.getDryRun() != null) {
                Boolean dryRun = describeSubnetsRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeSubnetsRequest.getNextToken() != null) {
                String nextToken = describeSubnetsRequest.getNextToken();
                jsonWriter.name("NextToken");
                jsonWriter.value(nextToken);
            }
            if (describeSubnetsRequest.getMaxResults() != null) {
                Integer maxResults = describeSubnetsRequest.getMaxResults();
