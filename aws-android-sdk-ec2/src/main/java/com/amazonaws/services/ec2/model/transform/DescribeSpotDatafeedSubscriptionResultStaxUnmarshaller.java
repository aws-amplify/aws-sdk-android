...
public class DescribeSpotDatafeedSubscriptionResultStaxUnmarshaller implements Unmarshaller<DescribeSpotDatafeedSubscriptionResult, StaxUnmarshallerContext> {
    ...
    public DescribeSpotDatafeedSubscriptionResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return describeSpotDatafeedSubscriptionResult;
    ...
    public static DescribeSpotDatafeedSubscriptionResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeSpotDatafeedSubscriptionResultStaxUnmarshaller();
        return instance;
    }
}
