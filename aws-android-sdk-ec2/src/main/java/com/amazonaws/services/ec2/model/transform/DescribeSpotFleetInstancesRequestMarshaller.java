...
/**
 * JSON request marshaller for DescribeSpotFleetInstancesRequest
 */
public class DescribeSpotFleetInstancesRequestMarshaller implements
    ...
    public Request<DescribeSpotFleetInstancesRequest> marshall(
        ...
        if (describeSpotFleetInstancesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeSpotFleetInstancesRequest)");
        }

        Request<DescribeSpotFleetInstancesRequest> request = new DefaultRequest<DescribeSpotFleetInstancesRequest>(
                describeSpotFleetInstancesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeSpotFleetInstancesRequest.getDryRun() != null) {
                Boolean dryRun = describeSpotFleetInstancesRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeSpotFleetInstancesRequest.getMaxResults() != null) {
                Integer maxResults = describeSpotFleetInstancesRequest.getMaxResults();
                jsonWriter.name("MaxResults");
                jsonWriter.value(maxResults);
            }
            if (describeSpotFleetInstancesRequest.getNextToken() != null) {
                String nextToken = describeSpotFleetInstancesRequest.getNextToken();
                jsonWriter.name("NextToken");
                jsonWriter.value(nextToken);
            }
            if (describeSpotFleetInstancesRequest.getSpotFleetRequestId() != null) {
                String spotFleetRequestId = describeSpotFleetInstancesRequest
