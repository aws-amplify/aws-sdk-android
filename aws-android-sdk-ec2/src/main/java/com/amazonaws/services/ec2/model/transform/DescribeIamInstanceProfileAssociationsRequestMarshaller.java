...
/**
 * JSON request marshaller for DescribeIamInstanceProfileAssociationsRequest
 */
    ...
    public Request<DescribeIamInstanceProfileAssociationsRequest> marshall(
        ...
        if (describeIamInstanceProfileAssociationsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeIamInstanceProfileAssociationsRequest)");
        }
        ...
        Request<DescribeIamInstanceProfileAssociationsRequest> request = new DefaultRequest<DescribeIamInstanceProfileAssociationsRequest>(
                describeIamInstanceProfileAssociationsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeIamInstanceProfileAssociationsRequest.getAssociationIds() != null) {
                java.util.List<String> associationIds = describeIamInstanceProfileAssociationsRequest
                        .getAssociationIds();
            ...
            if (describeIamInstanceProfileAssociationsRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeIamInstanceProfileAssociationsRequest
                        .getFilters();
            ...
            if (describeIamInstanceProfileAssociationsRequest.getMaxResults() != null) {
                Integer maxResults = describeIamInstanceProfileAssociationsRequest.getMaxResults();
                jsonWriter.name("MaxResults");
                jsonWriter.value(maxResults);
            }
            if (describeIamInstanceProfileAssociationsRequest.getNextToken() != null) {
                String nextToken = describeIamInstanceProfileAssociationsRequest.getNextToken();
