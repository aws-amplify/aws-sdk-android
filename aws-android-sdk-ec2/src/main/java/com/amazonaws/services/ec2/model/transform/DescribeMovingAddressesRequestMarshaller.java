...
/**
 * JSON request marshaller for DescribeMovingAddressesRequest
 */
    ...
    public Request<DescribeMovingAddressesRequest> marshall(
        ...
        if (describeMovingAddressesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeMovingAddressesRequest)");
        }

        Request<DescribeMovingAddressesRequest> request = new DefaultRequest<DescribeMovingAddressesRequest>(
                describeMovingAddressesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeMovingAddressesRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeMovingAddressesRequest.getFilters();
            ...
            if (describeMovingAddressesRequest.getDryRun() != null) {
                Boolean dryRun = describeMovingAddressesRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeMovingAddressesRequest.getMaxResults() != null) {
                Integer maxResults = describeMovingAddressesRequest.getMaxResults();
                jsonWriter.name("MaxResults");
                jsonWriter.value(maxResults);
            }
            if (describeMovingAddressesRequest.getNextToken() != null) {
                String nextToken = describeMovingAddressesRequest.getNextToken();
                jsonWriter.name("NextToken");
                jsonWriter.value(nextToken);
            }
            if (describeMovingAddressesRequest.getPublicIps() != null) {
                java.util.List<String> publicIps = describeMovingAddressesRequest.getPublicIps();
