 ...
 * </p>
 */
public class DescribeReservedInstancesModificationsRequest extends AmazonWebServiceRequest
     ...
     * </p>
     */
    private java.util.List<String> reservedInstancesModificationIds;
     ...
     *            <li>
     *            <p>
     *            <code>create-date</code> - The time when the modification
     *            request was created.
     *            </p>
     *            </li>
     *            <li>
     ...
     *            <li>
     *            <p>
     *            <code>modification-result.reserved-instances-id</code> - The
     *            ID for the Reserved Instances created as part of the
     *            modification request. This ID is only available when the
     *            status of the modification is <code>fulfilled</code>.
     *            </p>
     *            </li>
     *            <li>
     *            <p>
     ...
     *            <li>
     *            <p>
     *            <code>reserved-instances-modification-id</code> - The ID of
     ...
     *            <li>
     *            <p>
     *            <code>update-date</code> - The time when the modification
     ...
     * </p>
     *
     * @param reservedInstancesModificationIds <p>
     *            IDs for the submitted modification request.
     *            </p>
     */
    public void setReservedInstancesModificationIds(
        ...
        this.reservedInstancesModificationIds = new java.util.ArrayList<String>(
    ...
    public DescribeReservedInstancesModificationsRequest withReservedInstancesModificationIds(
        ...
        for (String value : reservedInstancesModificationIds) {
            this.reservedInstancesModificationIds.add(value);
        }
        return this;
    }
