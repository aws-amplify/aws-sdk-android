 ...
 * </p>
 */
public class DescribeTrafficMirrorFiltersRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     * </p>
     *
     * @param trafficMirrorFilterIds <p>
     *            The ID of the Traffic Mirror filter.
     *            </p>
     */
    public void setTrafficMirrorFilterIds(java.util.Collection<String> trafficMirrorFilterIds) {
        ...
        this.trafficMirrorFilterIds = new java.util.ArrayList<String>(trafficMirrorFilterIds);
    }
     ...
     *         chained together.
     */
    public DescribeTrafficMirrorFiltersRequest withTrafficMirrorFilterIds(
            String... trafficMirrorFilterIds) {
        if (getTrafficMirrorFilterIds() == null) {
            this.trafficMirrorFilterIds = new java.util.ArrayList<String>(
                    trafficMirrorFilterIds.length);
        }
        for (String value : trafficMirrorFilterIds) {
            this.trafficMirrorFilterIds.add(value);
        }
        return this;
    }
     ...
     */
    public DescribeTrafficMirrorFiltersRequest withTrafficMirrorFilterIds(
            java.util.Collection<String> trafficMirrorFilterIds) {
     ...
     *            <li>
     *            <p>
     *            <code>description</code>: The Traffic Mirror filter
     *            description.
     *            </p>
     *            </li>
     *            <li>
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getTrafficMirrorFilterIds() != null)
            sb.append("TrafficMirrorFilterIds: " + getTrafficMirrorFilterIds() + ",");
        if (getDryRun() != null)
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getTrafficMirrorFilterIds() == null) ? 0 : getTrafficMirrorFilterIds()
                        .hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTrafficMirrorFilterIds() == null ^ this.getTrafficMirrorFilterIds() == null)
            return false;
        if (other.getTrafficMirrorFilterIds() != null
                && other.getTrafficMirrorFilterIds().equals(this.getTrafficMirrorFilterIds()) == false)
            return false;
