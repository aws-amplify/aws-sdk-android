...
/**
 * JSON request marshaller for EnableTransitGatewayRouteTablePropagationRequest
 */
    ...
    public Request<EnableTransitGatewayRouteTablePropagationRequest> marshall(
        ...
        if (enableTransitGatewayRouteTablePropagationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(EnableTransitGatewayRouteTablePropagationRequest)");
        }
        ...
        Request<EnableTransitGatewayRouteTablePropagationRequest> request = new DefaultRequest<EnableTransitGatewayRouteTablePropagationRequest>(
                enableTransitGatewayRouteTablePropagationRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (enableTransitGatewayRouteTablePropagationRequest.getTransitGatewayRouteTableId() != null) {
                String transitGatewayRouteTableId = enableTransitGatewayRouteTablePropagationRequest
            ...
            if (enableTransitGatewayRouteTablePropagationRequest.getTransitGatewayAttachmentId() != null) {
                String transitGatewayAttachmentId = enableTransitGatewayRouteTablePropagationRequest
                        .getTransitGatewayAttachmentId();
                jsonWriter.name("TransitGatewayAttachmentId");
                jsonWriter.value(transitGatewayAttachmentId);
            }
            if (enableTransitGatewayRouteTablePropagationRequest.getDryRun() != null) {
                Boolean dryRun = enableTransitGatewayRouteTablePropagationRequest.getDryRun();
