...
public class DescribeByoipCidrsResult implements Serializable {
    /**
     * <p>
    ...
    public DescribeByoipCidrsResult withByoipCidrs(ByoipCidr... byoipCidrs) {
        if (getByoipCidrs() == null) {
            this.byoipCidrs = new java.util.ArrayList<ByoipCidr>(byoipCidrs.length);
        }
        for (ByoipCidr value : byoipCidrs) {
            this.byoipCidrs.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getByoipCidrs() != null)
            sb.append("ByoipCidrs: " + getByoipCidrs() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getByoipCidrs() == null ^ this.getByoipCidrs() == null)
            return false;
        if (other.getByoipCidrs() != null
                && other.getByoipCidrs().equals(this.getByoipCidrs()) == false)
            return false;
