...
/**
 * Get Console Screenshot Result StAX Unmarshaller
 */
public class GetConsoleScreenshotResultStaxUnmarshaller implements Unmarshaller<GetConsoleScreenshotResult, StaxUnmarshallerContext> {
    ...
    public GetConsoleScreenshotResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return getConsoleScreenshotResult;
    ...
    public static GetConsoleScreenshotResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new GetConsoleScreenshotResultStaxUnmarshaller();
        return instance;
    }
}
