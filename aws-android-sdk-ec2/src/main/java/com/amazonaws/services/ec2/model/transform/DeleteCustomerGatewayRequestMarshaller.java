...
/**
 * JSON request marshaller for DeleteCustomerGatewayRequest
 */
    ...
    public Request<DeleteCustomerGatewayRequest> marshall(
        ...
        if (deleteCustomerGatewayRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteCustomerGatewayRequest)");
        }

        Request<DeleteCustomerGatewayRequest> request = new DefaultRequest<DeleteCustomerGatewayRequest>(
                deleteCustomerGatewayRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (deleteCustomerGatewayRequest.getCustomerGatewayId() != null) {
                String customerGatewayId = deleteCustomerGatewayRequest.getCustomerGatewayId();
                jsonWriter.name("CustomerGatewayId");
                jsonWriter.value(customerGatewayId);
            }
            if (deleteCustomerGatewayRequest.getDryRun() != null) {
                Boolean dryRun = deleteCustomerGatewayRequest.getDryRun();
