    ...
    public Request<ModifyInstanceCapacityReservationAttributesRequest> marshall(
        ...
        if (modifyInstanceCapacityReservationAttributesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ModifyInstanceCapacityReservationAttributesRequest)");
        }
        ...
        Request<ModifyInstanceCapacityReservationAttributesRequest> request = new DefaultRequest<ModifyInstanceCapacityReservationAttributesRequest>(
                modifyInstanceCapacityReservationAttributesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (modifyInstanceCapacityReservationAttributesRequest.getInstanceId() != null) {
                String instanceId = modifyInstanceCapacityReservationAttributesRequest
                        .getInstanceId();
                jsonWriter.name("InstanceId");
                jsonWriter.value(instanceId);
            }
            if (modifyInstanceCapacityReservationAttributesRequest
                    .getCapacityReservationSpecification() != null) {
            ...
            if (modifyInstanceCapacityReservationAttributesRequest.getDryRun() != null) {
                Boolean dryRun = modifyInstanceCapacityReservationAttributesRequest.getDryRun();
