 ...
 * </p>
 */
public class ApplySecurityGroupsToClientVpnTargetNetworkRequest extends AmazonWebServiceRequest
     ...
     *         chained together.
     */
    public ApplySecurityGroupsToClientVpnTargetNetworkRequest withClientVpnEndpointId(
     ...
     *
     * @return <p>
     *         The ID of the VPC in which the associated target network is
     *         located.
     *         </p>
     */
     ...
     *            The IDs of the security groups to apply to the associated
     *            target network. Up to 5 security groups can be applied to an
     ...
     *         chained together.
     */
    public ApplySecurityGroupsToClientVpnTargetNetworkRequest withSecurityGroupIds(
