...
public class DescribeTagsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         <code>resource-type</code> - The resource type (
     *         <code>customer-gateway</code> | <code>dedicated-host</code> |
     *         <code>dhcp-options</code> | <code>elastic-ip</code> |
     ...
     *         <li>
     *         <p>
     *         <code>tag</code>:&lt;key&gt; - The key/value combination of the
     *         tag. For example, specify "tag:Owner" for the filter name and
     *         "TeamA" for the filter value to find resources with the tag
     *         "Owner=TeamA".
     *         </p>
     *         </li>
     *         <li>
     ...
     *            <li>
     *            <p>
     *            <code>tag</code>:&lt;key&gt; - The key/value combination of
     *            the tag. For example, specify "tag:Owner" for the filter name
     *            and "TeamA" for the filter value to find resources with the
     *            tag "Owner=TeamA".
     *            </p>
     *            </li>
     *            <li>
