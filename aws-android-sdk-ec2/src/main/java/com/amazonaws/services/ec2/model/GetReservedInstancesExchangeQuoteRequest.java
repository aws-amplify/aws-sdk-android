 ...
 * the exchange cannot be performed, the reason is returned in the response. Use
 * <a>AcceptReservedInstancesExchangeQuote</a> to perform the exchange.
 * </p>
 */
public class GetReservedInstancesExchangeQuoteRequest extends AmazonWebServiceRequest implements
     ...
     *         chained together.
     */
    public GetReservedInstancesExchangeQuoteRequest withReservedInstanceIds(
     ...
     *         chained together.
     */
    public GetReservedInstancesExchangeQuoteRequest withTargetConfigurations(
