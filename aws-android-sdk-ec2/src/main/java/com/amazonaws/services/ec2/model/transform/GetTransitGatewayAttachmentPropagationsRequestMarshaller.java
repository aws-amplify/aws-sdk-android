...
/**
 * JSON request marshaller for GetTransitGatewayAttachmentPropagationsRequest
 */
    ...
    public Request<GetTransitGatewayAttachmentPropagationsRequest> marshall(
        ...
        if (getTransitGatewayAttachmentPropagationsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetTransitGatewayAttachmentPropagationsRequest)");
        }
        ...
        Request<GetTransitGatewayAttachmentPropagationsRequest> request = new DefaultRequest<GetTransitGatewayAttachmentPropagationsRequest>(
                getTransitGatewayAttachmentPropagationsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (getTransitGatewayAttachmentPropagationsRequest.getTransitGatewayAttachmentId() != null) {
                String transitGatewayAttachmentId = getTransitGatewayAttachmentPropagationsRequest
                        .getTransitGatewayAttachmentId();
                jsonWriter.name("TransitGatewayAttachmentId");
                jsonWriter.value(transitGatewayAttachmentId);
            }
            if (getTransitGatewayAttachmentPropagationsRequest.getFilters() != null) {
                java.util.List<Filter> filters = getTransitGatewayAttachmentPropagationsRequest
                        .getFilters();
            ...
            if (getTransitGatewayAttachmentPropagationsRequest.getMaxResults() != null) {
                Integer maxResults = getTransitGatewayAttachmentPropagationsRequest.getMaxResults();
                jsonWriter.name("MaxResults");
                jsonWriter.value(maxResults);
            }
            if (getTransitGatewayAttachmentPropagationsRequest.getNextToken() != null) {
                String nextToken = getTransitGatewayAttachmentPropagationsRequest.getNextToken();
                jsonWriter.name("NextToken");
                jsonWriter.value(nextToken);
            }
            if (getTransitGatewayAttachmentPropagationsRequest.getDryRun() != null) {
                Boolean dryRun = getTransitGatewayAttachmentPropagationsRequest.getDryRun();
