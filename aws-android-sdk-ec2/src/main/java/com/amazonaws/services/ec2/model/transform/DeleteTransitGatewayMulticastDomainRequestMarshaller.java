...
/**
 * JSON request marshaller for DeleteTransitGatewayMulticastDomainRequest
 */
public class DeleteTransitGatewayMulticastDomainRequestMarshaller
        implements
        Marshaller<Request<DeleteTransitGatewayMulticastDomainRequest>, DeleteTransitGatewayMulticastDomainRequest> {

    public Request<DeleteTransitGatewayMulticastDomainRequest> marshall(
        ...
        if (deleteTransitGatewayMulticastDomainRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteTransitGatewayMulticastDomainRequest)");
        }

        Request<DeleteTransitGatewayMulticastDomainRequest> request = new DefaultRequest<DeleteTransitGatewayMulticastDomainRequest>(
                deleteTransitGatewayMulticastDomainRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (deleteTransitGatewayMulticastDomainRequest.getTransitGatewayMulticastDomainId() != null) {
                String transitGatewayMulticastDomainId = deleteTransitGatewayMulticastDomainRequest
            ...
            if (deleteTransitGatewayMulticastDomainRequest.getDryRun() != null) {
                Boolean dryRun = deleteTransitGatewayMulticastDomainRequest.getDryRun();
