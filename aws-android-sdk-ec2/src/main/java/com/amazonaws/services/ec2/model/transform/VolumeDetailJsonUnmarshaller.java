...
/**
 * JSON unmarshaller for POJO VolumeDetail
 */
class VolumeDetailJsonUnmarshaller implements Unmarshaller<VolumeDetail, JsonUnmarshallerContext> {
    ...
    public VolumeDetail unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Size")) {
                volumeDetail.setSize(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
