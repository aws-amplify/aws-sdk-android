...
public class DisassociateVpcCidrBlockResult implements Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public DisassociateVpcCidrBlockResult withIpv6CidrBlockAssociation(
     ...
     *         chained together.
     */
    public DisassociateVpcCidrBlockResult withCidrBlockAssociation(
    ...
    public String toString() {
        ...
        if (getCidrBlockAssociation() != null)
            sb.append("CidrBlockAssociation: " + getCidrBlockAssociation() + ",");
        if (getVpcId() != null)
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getCidrBlockAssociation() == null) ? 0 : getCidrBlockAssociation().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCidrBlockAssociation() == null ^ this.getCidrBlockAssociation() == null)
            return false;
        if (other.getCidrBlockAssociation() != null
                && other.getCidrBlockAssociation().equals(this.getCidrBlockAssociation()) == false)
            return false;
