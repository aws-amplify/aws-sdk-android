 ...
 * </p>
 */
public class SpotOptionsRequest implements Serializable {
    /**
     * <p>
     ...
     * @see SpotInstanceInterruptionBehavior
     */
    public SpotOptionsRequest withInstanceInterruptionBehavior(
            SpotInstanceInterruptionBehavior instanceInterruptionBehavior) {
        this.instanceInterruptionBehavior = instanceInterruptionBehavior.toString();
        return this;
    }
     ...
     *         set to <code>lowest-price</code>. EC2 Fleet selects the cheapest
     ...
     *            is set to <code>lowest-price</code>. EC2 Fleet selects the
