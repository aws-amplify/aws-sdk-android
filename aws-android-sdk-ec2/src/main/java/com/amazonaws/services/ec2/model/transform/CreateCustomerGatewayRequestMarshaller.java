...
/**
 * JSON request marshaller for CreateCustomerGatewayRequest
 */
    ...
    public Request<CreateCustomerGatewayRequest> marshall(
        ...
        if (createCustomerGatewayRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateCustomerGatewayRequest)");
        }

        Request<CreateCustomerGatewayRequest> request = new DefaultRequest<CreateCustomerGatewayRequest>(
                createCustomerGatewayRequest, "AmazonElasticComputeCloud");
