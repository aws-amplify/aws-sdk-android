 ...
 * </p>
 */
public class VolumeStatusAttachmentStatus implements Serializable {
    /**
     * <p>
    ...
    public String toString() {
        ...
        if (getIoPerformance() != null)
            sb.append("IoPerformance: " + getIoPerformance() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getIoPerformance() == null) ? 0 : getIoPerformance().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getIoPerformance() == null ^ this.getIoPerformance() == null)
            return false;
        if (other.getIoPerformance() != null
                && other.getIoPerformance().equals(this.getIoPerformance()) == false)
            return false;
