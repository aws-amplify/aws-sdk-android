 ...
 * </p>
 */
public class CreateNetworkInterfacePermissionResult implements Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public CreateNetworkInterfacePermissionResult withInterfacePermission(
    ...
    public String toString() {
        ...
        if (getInterfacePermission() != null)
            sb.append("InterfacePermission: " + getInterfacePermission());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getInterfacePermission() == null) ? 0 : getInterfacePermission().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getInterfacePermission() == null ^ this.getInterfacePermission() == null)
            return false;
        if (other.getInterfacePermission() != null
                && other.getInterfacePermission().equals(this.getInterfacePermission()) == false)
            return false;
        return true;
    }
}
