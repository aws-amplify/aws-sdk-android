...
/**
 * JSON request marshaller for DisassociateIamInstanceProfileRequest
 */
public class DisassociateIamInstanceProfileRequestMarshaller
    ...
    public Request<DisassociateIamInstanceProfileRequest> marshall(
        ...
        if (disassociateIamInstanceProfileRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DisassociateIamInstanceProfileRequest)");
        }

        Request<DisassociateIamInstanceProfileRequest> request = new DefaultRequest<DisassociateIamInstanceProfileRequest>(
                disassociateIamInstanceProfileRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (disassociateIamInstanceProfileRequest.getAssociationId() != null) {
                String associationId = disassociateIamInstanceProfileRequest.getAssociationId();
