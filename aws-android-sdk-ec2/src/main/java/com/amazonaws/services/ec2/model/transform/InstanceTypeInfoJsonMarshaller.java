...
class InstanceTypeInfoJsonMarshaller {
    ...
    public void marshall(InstanceTypeInfo instanceTypeInfo, AwsJsonWriter jsonWriter)
        ...
        if (instanceTypeInfo.getSupportedVirtualizationTypes() != null) {
            java.util.List<String> supportedVirtualizationTypes = instanceTypeInfo
                    .getSupportedVirtualizationTypes();
            jsonWriter.name("SupportedVirtualizationTypes");
            jsonWriter.beginArray();
            for (String supportedVirtualizationTypesItem : supportedVirtualizationTypes) {
                if (supportedVirtualizationTypesItem != null) {
                    jsonWriter.value(supportedVirtualizationTypesItem);
                }
            }
            jsonWriter.endArray();
        }
