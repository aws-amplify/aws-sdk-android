...
/**
 * JSON request marshaller for AttachNetworkInterfaceRequest
 */
    ...
    public Request<AttachNetworkInterfaceRequest> marshall(
        ...
        if (attachNetworkInterfaceRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AttachNetworkInterfaceRequest)");
        }

        Request<AttachNetworkInterfaceRequest> request = new DefaultRequest<AttachNetworkInterfaceRequest>(
                attachNetworkInterfaceRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (attachNetworkInterfaceRequest.getDeviceIndex() != null) {
                Integer deviceIndex = attachNetworkInterfaceRequest.getDeviceIndex();
                jsonWriter.name("DeviceIndex");
                jsonWriter.value(deviceIndex);
            }
            if (attachNetworkInterfaceRequest.getDryRun() != null) {
                Boolean dryRun = attachNetworkInterfaceRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (attachNetworkInterfaceRequest.getInstanceId() != null) {
                String instanceId = attachNetworkInterfaceRequest.getInstanceId();
                jsonWriter.name("InstanceId");
                jsonWriter.value(instanceId);
            }
            if (attachNetworkInterfaceRequest.getNetworkInterfaceId() != null) {
                String networkInterfaceId = attachNetworkInterfaceRequest.getNetworkInterfaceId();
