...
/**
 * JSON request marshaller for CreateVpcEndpointConnectionNotificationRequest
 */
    ...
    public Request<CreateVpcEndpointConnectionNotificationRequest> marshall(
        ...
        if (createVpcEndpointConnectionNotificationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateVpcEndpointConnectionNotificationRequest)");
        }
        ...
        Request<CreateVpcEndpointConnectionNotificationRequest> request = new DefaultRequest<CreateVpcEndpointConnectionNotificationRequest>(
                createVpcEndpointConnectionNotificationRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (createVpcEndpointConnectionNotificationRequest.getDryRun() != null) {
                Boolean dryRun = createVpcEndpointConnectionNotificationRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (createVpcEndpointConnectionNotificationRequest.getServiceId() != null) {
                String serviceId = createVpcEndpointConnectionNotificationRequest.getServiceId();
            ...
            if (createVpcEndpointConnectionNotificationRequest.getVpcEndpointId() != null) {
                String vpcEndpointId = createVpcEndpointConnectionNotificationRequest
                        .getVpcEndpointId();
            ...
            if (createVpcEndpointConnectionNotificationRequest.getConnectionNotificationArn() != null) {
                String connectionNotificationArn = createVpcEndpointConnectionNotificationRequest
                        .getConnectionNotificationArn();
                jsonWriter.name("ConnectionNotificationArn");
                jsonWriter.value(connectionNotificationArn);
            }
            if (createVpcEndpointConnectionNotificationRequest.getConnectionEvents() != null) {
                java.util.List<String> connectionEvents = createVpcEndpointConnectionNotificationRequest
                        .getConnectionEvents();
            ...
            if (createVpcEndpointConnectionNotificationRequest.getClientToken() != null) {
                String clientToken = createVpcEndpointConnectionNotificationRequest
                        .getClientToken();
