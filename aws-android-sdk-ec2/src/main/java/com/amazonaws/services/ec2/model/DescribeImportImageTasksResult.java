...
public class DescribeImportImageTasksResult implements Serializable {
     ...
     * </p>
     */
    private java.util.List<ImportImageTask> importImageTasks;
    ...
    public void setImportImageTasks(java.util.Collection<ImportImageTask> importImageTasks) {
        ...
        this.importImageTasks = new java.util.ArrayList<ImportImageTask>(importImageTasks);
    }
    ...
    public DescribeImportImageTasksResult withImportImageTasks(ImportImageTask... importImageTasks) {
        if (getImportImageTasks() == null) {
            this.importImageTasks = new java.util.ArrayList<ImportImageTask>(
                    importImageTasks.length);
        }
        for (ImportImageTask value : importImageTasks) {
            this.importImageTasks.add(value);
        }
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getImportImageTasks() == null) ? 0 : getImportImageTasks().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getImportImageTasks() == null ^ this.getImportImageTasks() == null)
            return false;
        if (other.getImportImageTasks() != null
                && other.getImportImageTasks().equals(this.getImportImageTasks()) == false)
            return false;
