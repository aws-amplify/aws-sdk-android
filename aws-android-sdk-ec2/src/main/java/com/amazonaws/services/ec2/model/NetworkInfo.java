...
public class NetworkInfo implements Serializable {
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getEfaSupported() == null) ? 0 : getEfaSupported().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getEfaSupported() == null ^ this.getEfaSupported() == null)
            return false;
        if (other.getEfaSupported() != null
                && other.getEfaSupported().equals(this.getEfaSupported()) == false)
            return false;
        return true;
    }
}
