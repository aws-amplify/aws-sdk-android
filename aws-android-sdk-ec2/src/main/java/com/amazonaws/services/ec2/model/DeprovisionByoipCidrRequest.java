 ...
 * <a>WithdrawByoipCidr</a> and you must not have any IP addresses allocated
 * from its address range.
 * </p>
 */
public class DeprovisionByoipCidrRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *
     * @param cidr <p>
     *            The address range, in CIDR notation. The prefix must be the
     *            same prefix that you specified when you provisioned the
     *            address range.
     *            </p>
     */
