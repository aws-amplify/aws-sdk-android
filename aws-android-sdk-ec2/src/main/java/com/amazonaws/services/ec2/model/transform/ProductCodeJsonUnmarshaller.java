...
class ProductCodeJsonUnmarshaller implements Unmarshaller<ProductCode, JsonUnmarshallerContext> {
    ...
    public ProductCode unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ProductCodeId")) {
                productCode.setProductCodeId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ProductCodeType")) {
                productCode.setProductCodeType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
