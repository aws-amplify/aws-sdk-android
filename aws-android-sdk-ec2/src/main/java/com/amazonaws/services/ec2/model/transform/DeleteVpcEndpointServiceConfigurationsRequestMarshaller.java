...
/**
 * JSON request marshaller for DeleteVpcEndpointServiceConfigurationsRequest
 */
    ...
    public Request<DeleteVpcEndpointServiceConfigurationsRequest> marshall(
        ...
        if (deleteVpcEndpointServiceConfigurationsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteVpcEndpointServiceConfigurationsRequest)");
        }
        ...
        Request<DeleteVpcEndpointServiceConfigurationsRequest> request = new DefaultRequest<DeleteVpcEndpointServiceConfigurationsRequest>(
                deleteVpcEndpointServiceConfigurationsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (deleteVpcEndpointServiceConfigurationsRequest.getDryRun() != null) {
                Boolean dryRun = deleteVpcEndpointServiceConfigurationsRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (deleteVpcEndpointServiceConfigurationsRequest.getServiceIds() != null) {
                java.util.List<String> serviceIds = deleteVpcEndpointServiceConfigurationsRequest
                        .getServiceIds();
