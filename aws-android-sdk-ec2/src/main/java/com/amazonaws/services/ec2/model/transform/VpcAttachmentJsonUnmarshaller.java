...
/**
 * JSON unmarshaller for POJO VpcAttachment
 */
class VpcAttachmentJsonUnmarshaller implements Unmarshaller<VpcAttachment, JsonUnmarshallerContext> {
    ...
    public VpcAttachment unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("State")) {
                vpcAttachment.setState(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("VpcId")) {
                vpcAttachment.setVpcId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
