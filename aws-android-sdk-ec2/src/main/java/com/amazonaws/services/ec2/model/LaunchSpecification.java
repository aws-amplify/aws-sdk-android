...
public class LaunchSpecification implements Serializable {
     ...
     *         chained together.
     */
    public LaunchSpecification withSecurityGroups(GroupIdentifier... securityGroups) {
     ...
     *         chained together.
     */
    public LaunchSpecification withMonitoring(RunInstancesMonitoringEnabled monitoring) {
        this.monitoring = monitoring;
        return this;
    }
