...
public class LaunchSpecification implements Serializable {
    ...
    /**
     * One or more block device mapping entries. <p>Although you can specify
     ...
     * Instances, these volumes are not encrypted.
     *
     * @return One or more block device mapping entries. <p>Although you can specify
     *         encrypted EBS volumes in this block device mapping for your Spot
     *         Instances, these volumes are not encrypted.
     */
     ...
     * Instances, these volumes are not encrypted.
     *
     * @param blockDeviceMappings One or more block device mapping entries. <p>Although you can specify
     *         encrypted EBS volumes in this block device mapping for your Spot
     *         Instances, these volumes are not encrypted.
     */
