...
/**
 * JSON request marshaller for CreateTagsRequest
 */
public class CreateTagsRequestMarshaller implements
    ...
    public Request<CreateTagsRequest> marshall(CreateTagsRequest createTagsRequest) {
        ...
        Request<CreateTagsRequest> request = new DefaultRequest<CreateTagsRequest>(
                createTagsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (createTagsRequest.getDryRun() != null) {
                Boolean dryRun = createTagsRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (createTagsRequest.getResources() != null) {
                java.util.List<String> resources = createTagsRequest.getResources();
