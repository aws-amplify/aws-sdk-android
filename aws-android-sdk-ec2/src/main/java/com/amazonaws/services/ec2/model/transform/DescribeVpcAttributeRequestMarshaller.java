...
/**
 * JSON request marshaller for DescribeVpcAttributeRequest
 */
public class DescribeVpcAttributeRequestMarshaller implements
    ...
    public Request<DescribeVpcAttributeRequest> marshall(
        ...
        if (describeVpcAttributeRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeVpcAttributeRequest)");
        }

        Request<DescribeVpcAttributeRequest> request = new DefaultRequest<DescribeVpcAttributeRequest>(
                describeVpcAttributeRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeVpcAttributeRequest.getAttribute() != null) {
                String attribute = describeVpcAttributeRequest.getAttribute();
                jsonWriter.name("Attribute");
                jsonWriter.value(attribute);
            }
            if (describeVpcAttributeRequest.getVpcId() != null) {
                String vpcId = describeVpcAttributeRequest.getVpcId();
                jsonWriter.name("VpcId");
                jsonWriter.value(vpcId);
            }
            if (describeVpcAttributeRequest.getDryRun() != null) {
                Boolean dryRun = describeVpcAttributeRequest.getDryRun();
