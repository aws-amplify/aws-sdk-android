...
/**
 * Transit Gateway Route Table State
 */
public enum TransitGatewayRouteTableState {
    ...
    private static final Map<String, TransitGatewayRouteTableState> enumMap;
    static {
        enumMap = new HashMap<String, TransitGatewayRouteTableState>();
