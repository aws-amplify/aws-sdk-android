...
/**
 * JSON unmarshaller for response CopySnapshotResult
 */
public class CopySnapshotResultJsonUnmarshaller implements
        Unmarshaller<CopySnapshotResult, JsonUnmarshallerContext> {
    ...
    public CopySnapshotResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SnapshotId")) {
                copySnapshotResult.setSnapshotId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Tags")) {
                copySnapshotResult.setTags(new ListUnmarshaller<Tag>(TagJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
