...
/**
 * JSON request marshaller for DisassociateTransitGatewayMulticastDomainRequest
 */
public class DisassociateTransitGatewayMulticastDomainRequestMarshaller
        implements
    ...
    public Request<DisassociateTransitGatewayMulticastDomainRequest> marshall(
        ...
        if (disassociateTransitGatewayMulticastDomainRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DisassociateTransitGatewayMulticastDomainRequest)");
        }
        ...
        Request<DisassociateTransitGatewayMulticastDomainRequest> request = new DefaultRequest<DisassociateTransitGatewayMulticastDomainRequest>(
                disassociateTransitGatewayMulticastDomainRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (disassociateTransitGatewayMulticastDomainRequest
                    .getTransitGatewayMulticastDomainId() != null) {
                String transitGatewayMulticastDomainId = disassociateTransitGatewayMulticastDomainRequest
            ...
            if (disassociateTransitGatewayMulticastDomainRequest.getTransitGatewayAttachmentId() != null) {
                String transitGatewayAttachmentId = disassociateTransitGatewayMulticastDomainRequest
                        .getTransitGatewayAttachmentId();
                jsonWriter.name("TransitGatewayAttachmentId");
                jsonWriter.value(transitGatewayAttachmentId);
            }
            if (disassociateTransitGatewayMulticastDomainRequest.getSubnetIds() != null) {
                java.util.List<String> subnetIds = disassociateTransitGatewayMulticastDomainRequest
                        .getSubnetIds();
            ...
            if (disassociateTransitGatewayMulticastDomainRequest.getDryRun() != null) {
                Boolean dryRun = disassociateTransitGatewayMulticastDomainRequest.getDryRun();
