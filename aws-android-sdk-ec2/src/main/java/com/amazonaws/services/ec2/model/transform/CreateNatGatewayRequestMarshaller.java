...
/**
 * JSON request marshaller for CreateNatGatewayRequest
 */
    ...
    public Request<CreateNatGatewayRequest> marshall(CreateNatGatewayRequest createNatGatewayRequest) {
        if (createNatGatewayRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateNatGatewayRequest)");
        }

        Request<CreateNatGatewayRequest> request = new DefaultRequest<CreateNatGatewayRequest>(
                createNatGatewayRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (createNatGatewayRequest.getDryRun() != null) {
                Boolean dryRun = createNatGatewayRequest.getDryRun();
            ...
            if (createNatGatewayRequest.getTagSpecifications() != null) {
                java.util.List<TagSpecification> tagSpecifications = createNatGatewayRequest
