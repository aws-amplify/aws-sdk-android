...
/**
 * Provisioned Bandwidth StAX Unmarshaller
 */
public class ProvisionedBandwidthStaxUnmarshaller implements Unmarshaller<ProvisionedBandwidth, StaxUnmarshallerContext> {
    ...
    public ProvisionedBandwidth unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return provisionedBandwidth;
    ...
    public static ProvisionedBandwidthStaxUnmarshaller getInstance() {
        if (instance == null) instance = new ProvisionedBandwidthStaxUnmarshaller();
        return instance;
    }
}
