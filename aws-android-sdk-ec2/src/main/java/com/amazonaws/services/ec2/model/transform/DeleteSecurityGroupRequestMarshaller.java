...
/**
 * JSON request marshaller for DeleteSecurityGroupRequest
 */
    ...
    public Request<DeleteSecurityGroupRequest> marshall(
        ...
        if (deleteSecurityGroupRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteSecurityGroupRequest)");
        }

        Request<DeleteSecurityGroupRequest> request = new DefaultRequest<DeleteSecurityGroupRequest>(
                deleteSecurityGroupRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (deleteSecurityGroupRequest.getGroupName() != null) {
                String groupName = deleteSecurityGroupRequest.getGroupName();
                jsonWriter.name("GroupName");
                jsonWriter.value(groupName);
            }
            if (deleteSecurityGroupRequest.getDryRun() != null) {
                Boolean dryRun = deleteSecurityGroupRequest.getDryRun();
