...
public class DescribeReservedInstancesOfferingsResult implements Serializable {
     ...
     * </p>
     *
     * @param reservedInstancesOfferings <p>
     *            A list of Reserved Instances offerings.
     *            </p>
     */
    public void setReservedInstancesOfferings(
        ...
        this.reservedInstancesOfferings = new java.util.ArrayList<ReservedInstancesOffering>(
    ...
    public DescribeReservedInstancesOfferingsResult withReservedInstancesOfferings(
        ...
        for (ReservedInstancesOffering value : reservedInstancesOfferings) {
            this.reservedInstancesOfferings.add(value);
        }
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getReservedInstancesOfferings() == null) ? 0 : getReservedInstancesOfferings()
                        .hashCode());
