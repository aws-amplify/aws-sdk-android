...
public enum VolumeStatusInfoStatus {
    ...
    private static final Map<String, VolumeStatusInfoStatus> enumMap;
    static {
        enumMap = new HashMap<String, VolumeStatusInfoStatus>();
        enumMap.put("ok", Ok);
        enumMap.put("impaired", Impaired);
        enumMap.put("insufficient-data", InsufficientData);
    }
