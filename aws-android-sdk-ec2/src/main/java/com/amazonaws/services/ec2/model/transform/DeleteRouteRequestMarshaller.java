...
public class DeleteRouteRequestMarshaller implements
    ...
    public Request<DeleteRouteRequest> marshall(DeleteRouteRequest deleteRouteRequest) {
        ...
        Request<DeleteRouteRequest> request = new DefaultRequest<DeleteRouteRequest>(
                deleteRouteRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (deleteRouteRequest.getDestinationCidrBlock() != null) {
                String destinationCidrBlock = deleteRouteRequest.getDestinationCidrBlock();
            ...
            if (deleteRouteRequest.getDestinationIpv6CidrBlock() != null) {
                String destinationIpv6CidrBlock = deleteRouteRequest.getDestinationIpv6CidrBlock();
                jsonWriter.name("DestinationIpv6CidrBlock");
                jsonWriter.value(destinationIpv6CidrBlock);
            }
            if (deleteRouteRequest.getDryRun() != null) {
                Boolean dryRun = deleteRouteRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (deleteRouteRequest.getRouteTableId() != null) {
                String routeTableId = deleteRouteRequest.getRouteTableId();
