...
/**
 * JSON request marshaller for AssignIpv6AddressesRequest
 */
public class AssignIpv6AddressesRequestMarshaller implements
    ...
    public Request<AssignIpv6AddressesRequest> marshall(
            AssignIpv6AddressesRequest assignIpv6AddressesRequest) {
        if (assignIpv6AddressesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AssignIpv6AddressesRequest)");
        }

        Request<AssignIpv6AddressesRequest> request = new DefaultRequest<AssignIpv6AddressesRequest>(
                assignIpv6AddressesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (assignIpv6AddressesRequest.getIpv6AddressCount() != null) {
                Integer ipv6AddressCount = assignIpv6AddressesRequest.getIpv6AddressCount();
                jsonWriter.name("Ipv6AddressCount");
                jsonWriter.value(ipv6AddressCount);
            }
            if (assignIpv6AddressesRequest.getIpv6Addresses() != null) {
                java.util.List<String> ipv6Addresses = assignIpv6AddressesRequest
                        .getIpv6Addresses();
            ...
            if (assignIpv6AddressesRequest.getNetworkInterfaceId() != null) {
                String networkInterfaceId = assignIpv6AddressesRequest.getNetworkInterfaceId();
