...
/**
 * JSON request marshaller for ReplaceIamInstanceProfileAssociationRequest
 */
    ...
    public Request<ReplaceIamInstanceProfileAssociationRequest> marshall(
        ...
        if (replaceIamInstanceProfileAssociationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ReplaceIamInstanceProfileAssociationRequest)");
        }
        ...
        Request<ReplaceIamInstanceProfileAssociationRequest> request = new DefaultRequest<ReplaceIamInstanceProfileAssociationRequest>(
                replaceIamInstanceProfileAssociationRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (replaceIamInstanceProfileAssociationRequest.getIamInstanceProfile() != null) {
                IamInstanceProfileSpecification iamInstanceProfile = replaceIamInstanceProfileAssociationRequest
            ...
            if (replaceIamInstanceProfileAssociationRequest.getAssociationId() != null) {
                String associationId = replaceIamInstanceProfileAssociationRequest
                        .getAssociationId();
