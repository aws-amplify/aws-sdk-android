...
public class DescribeClientVpnRoutesResult implements Serializable {
    /**
     * <p>
     * Information about the Client VPN endpoint routes.
     * </p>
     */
    private java.util.List<ClientVpnRoute> routes;
    ...
    public void setRoutes(java.util.Collection<ClientVpnRoute> routes) {
        ...
        this.routes = new java.util.ArrayList<ClientVpnRoute>(routes);
    }
    ...
    public DescribeClientVpnRoutesResult withRoutes(ClientVpnRoute... routes) {
        if (getRoutes() == null) {
            this.routes = new java.util.ArrayList<ClientVpnRoute>(routes.length);
        }
        for (ClientVpnRoute value : routes) {
