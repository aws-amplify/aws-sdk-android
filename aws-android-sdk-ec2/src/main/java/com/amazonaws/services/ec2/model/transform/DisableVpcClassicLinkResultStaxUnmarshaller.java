...
/**
 * Disable Vpc Classic Link Result StAX Unmarshaller
 */
public class DisableVpcClassicLinkResultStaxUnmarshaller implements Unmarshaller<DisableVpcClassicLinkResult, StaxUnmarshallerContext> {
    ...
    public DisableVpcClassicLinkResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return disableVpcClassicLinkResult;
    ...
    public static DisableVpcClassicLinkResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DisableVpcClassicLinkResultStaxUnmarshaller();
        return instance;
    }
}
