...
public class GetTransitGatewayRouteTablePropagationsResult implements Serializable {
    /**
     * <p>
     * Information about the route table propagations.
     * </p>
     */
    private java.util.List<TransitGatewayRouteTablePropagation> transitGatewayRouteTablePropagations;
     ...
     * </p>
     *
     * @param transitGatewayRouteTablePropagations <p>
     *            Information about the route table propagations.
     *            </p>
     */
    public void setTransitGatewayRouteTablePropagations(
        ...
        this.transitGatewayRouteTablePropagations = new java.util.ArrayList<TransitGatewayRouteTablePropagation>(
    ...
    public GetTransitGatewayRouteTablePropagationsResult withTransitGatewayRouteTablePropagations(
        ...
        for (TransitGatewayRouteTablePropagation value : transitGatewayRouteTablePropagations) {
            this.transitGatewayRouteTablePropagations.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getTransitGatewayRouteTablePropagations() != null)
            sb.append("TransitGatewayRouteTablePropagations: "
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getTransitGatewayRouteTablePropagations() == null) ? 0
                        : getTransitGatewayRouteTablePropagations().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTransitGatewayRouteTablePropagations() == null
                ^ this.getTransitGatewayRouteTablePropagations() == null)
            return false;
        if (other.getTransitGatewayRouteTablePropagations() != null
                && other.getTransitGatewayRouteTablePropagations().equals(
                        this.getTransitGatewayRouteTablePropagations()) == false)
            return false;
