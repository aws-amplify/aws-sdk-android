...
/**
 * JSON request marshaller for DisassociateRouteTableRequest
 */
public class DisassociateRouteTableRequestMarshaller implements
    ...
    public Request<DisassociateRouteTableRequest> marshall(
        ...
        if (disassociateRouteTableRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DisassociateRouteTableRequest)");
        }

        Request<DisassociateRouteTableRequest> request = new DefaultRequest<DisassociateRouteTableRequest>(
                disassociateRouteTableRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (disassociateRouteTableRequest.getAssociationId() != null) {
                String associationId = disassociateRouteTableRequest.getAssociationId();
                jsonWriter.name("AssociationId");
                jsonWriter.value(associationId);
            }
            if (disassociateRouteTableRequest.getDryRun() != null) {
                Boolean dryRun = disassociateRouteTableRequest.getDryRun();
