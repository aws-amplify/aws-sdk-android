 ...
 * </p>
 */
public class DescribeLocalGatewayVirtualInterfaceGroupsRequest extends AmazonWebServiceRequest
     ...
     * </p>
     */
    private java.util.List<String> localGatewayVirtualInterfaceGroupIds;
     ...
     * </p>
     *
     * @param localGatewayVirtualInterfaceGroupIds <p>
     *            The IDs of the virtual interface groups.
     *            </p>
     */
    public void setLocalGatewayVirtualInterfaceGroupIds(
        ...
        this.localGatewayVirtualInterfaceGroupIds = new java.util.ArrayList<String>(
    ...
    public DescribeLocalGatewayVirtualInterfaceGroupsRequest withLocalGatewayVirtualInterfaceGroupIds(
            String... localGatewayVirtualInterfaceGroupIds) {
        if (getLocalGatewayVirtualInterfaceGroupIds() == null) {
            this.localGatewayVirtualInterfaceGroupIds = new java.util.ArrayList<String>(
                    localGatewayVirtualInterfaceGroupIds.length);
        }
        for (String value : localGatewayVirtualInterfaceGroupIds) {
            this.localGatewayVirtualInterfaceGroupIds.add(value);
        }
        return this;
    }
     ...
     *         <li>
     *         <p>
     *         <code>local-gateway-virtual-interface-id</code> - The ID of the
     *         virtual interface.
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     *         <code>local-gateway-virtual-interface-group-id</code> - The ID of
     ...
     *            <li>
     *            <p>
     *            <code>local-gateway-virtual-interface-id</code> - The ID of
     *            the virtual interface.
     *            </p>
     *            </li>
     *            <li>
     *            <p>
     *            <code>local-gateway-virtual-interface-group-id</code> - The ID
     ...
     *         chained together.
     */
    public DescribeLocalGatewayVirtualInterfaceGroupsRequest withFilters(
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getLocalGatewayVirtualInterfaceGroupIds() != null)
            sb.append("LocalGatewayVirtualInterfaceGroupIds: "
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getLocalGatewayVirtualInterfaceGroupIds() == null) ? 0
                        : getLocalGatewayVirtualInterfaceGroupIds().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getLocalGatewayVirtualInterfaceGroupIds() == null
                ^ this.getLocalGatewayVirtualInterfaceGroupIds() == null)
            return false;
        if (other.getLocalGatewayVirtualInterfaceGroupIds() != null
                && other.getLocalGatewayVirtualInterfaceGroupIds().equals(
                        this.getLocalGatewayVirtualInterfaceGroupIds()) == false)
            return false;
