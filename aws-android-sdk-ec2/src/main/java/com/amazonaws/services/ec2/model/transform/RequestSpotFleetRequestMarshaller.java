...
/**
 * JSON request marshaller for RequestSpotFleetRequest
 */
    ...
    public Request<RequestSpotFleetRequest> marshall(RequestSpotFleetRequest requestSpotFleetRequest) {
        if (requestSpotFleetRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RequestSpotFleetRequest)");
        }

        Request<RequestSpotFleetRequest> request = new DefaultRequest<RequestSpotFleetRequest>(
                requestSpotFleetRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (requestSpotFleetRequest.getDryRun() != null) {
                Boolean dryRun = requestSpotFleetRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (requestSpotFleetRequest.getSpotFleetRequestConfig() != null) {
                ...
                SpotFleetRequestConfigDataJsonMarshaller.getInstance().marshall(
                        spotFleetRequestConfig, jsonWriter);
            }
