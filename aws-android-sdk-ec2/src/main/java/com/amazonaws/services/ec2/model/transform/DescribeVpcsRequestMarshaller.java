...
/**
 * JSON request marshaller for DescribeVpcsRequest
 */
    ...
    public Request<DescribeVpcsRequest> marshall(DescribeVpcsRequest describeVpcsRequest) {
        if (describeVpcsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeVpcsRequest)");
        }

        Request<DescribeVpcsRequest> request = new DefaultRequest<DescribeVpcsRequest>(
                describeVpcsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeVpcsRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeVpcsRequest.getFilters();
            ...
            if (describeVpcsRequest.getVpcIds() != null) {
                java.util.List<String> vpcIds = describeVpcsRequest.getVpcIds();
            ...
            if (describeVpcsRequest.getDryRun() != null) {
                Boolean dryRun = describeVpcsRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeVpcsRequest.getNextToken() != null) {
                String nextToken = describeVpcsRequest.getNextToken();
                jsonWriter.name("NextToken");
                jsonWriter.value(nextToken);
            }
            if (describeVpcsRequest.getMaxResults() != null) {
                Integer maxResults = describeVpcsRequest.getMaxResults();
