...
/**
 * JSON request marshaller for CreatePlacementGroupRequest
 */
public class CreatePlacementGroupRequestMarshaller implements
    ...
    public Request<CreatePlacementGroupRequest> marshall(
        ...
        if (createPlacementGroupRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreatePlacementGroupRequest)");
        }

        Request<CreatePlacementGroupRequest> request = new DefaultRequest<CreatePlacementGroupRequest>(
                createPlacementGroupRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (createPlacementGroupRequest.getDryRun() != null) {
                Boolean dryRun = createPlacementGroupRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (createPlacementGroupRequest.getGroupName() != null) {
                String groupName = createPlacementGroupRequest.getGroupName();
                jsonWriter.name("GroupName");
                jsonWriter.value(groupName);
            }
            if (createPlacementGroupRequest.getStrategy() != null) {
                String strategy = createPlacementGroupRequest.getStrategy();
                jsonWriter.name("Strategy");
                jsonWriter.value(strategy);
            }
            if (createPlacementGroupRequest.getPartitionCount() != null) {
                Integer partitionCount = createPlacementGroupRequest.getPartitionCount();
                jsonWriter.name("PartitionCount");
                jsonWriter.value(partitionCount);
            }
            if (createPlacementGroupRequest.getTagSpecifications() != null) {
                java.util.List<TagSpecification> tagSpecifications = createPlacementGroupRequest
