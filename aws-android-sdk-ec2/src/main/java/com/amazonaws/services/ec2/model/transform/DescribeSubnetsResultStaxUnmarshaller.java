...
public class DescribeSubnetsResultStaxUnmarshaller implements Unmarshaller<DescribeSubnetsResult, StaxUnmarshallerContext> {
    ...
    public DescribeSubnetsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return describeSubnetsResult;

            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("subnetSet/item", targetDepth)) {
                    describeSubnetsResult.getSubnets().add(SubnetStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeSubnetsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeSubnetsResultStaxUnmarshaller();
        return instance;
    }
}
