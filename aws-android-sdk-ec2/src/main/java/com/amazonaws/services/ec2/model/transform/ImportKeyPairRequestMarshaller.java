...
/**
 * JSON request marshaller for ImportKeyPairRequest
 */
    ...
    public Request<ImportKeyPairRequest> marshall(ImportKeyPairRequest importKeyPairRequest) {
        if (importKeyPairRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ImportKeyPairRequest)");
        }

        Request<ImportKeyPairRequest> request = new DefaultRequest<ImportKeyPairRequest>(
                importKeyPairRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (importKeyPairRequest.getDryRun() != null) {
                Boolean dryRun = importKeyPairRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (importKeyPairRequest.getKeyName() != null) {
                String keyName = importKeyPairRequest.getKeyName();
                jsonWriter.name("KeyName");
                jsonWriter.value(keyName);
            }
            if (importKeyPairRequest.getPublicKeyMaterial() != null) {
                java.nio.ByteBuffer publicKeyMaterial = importKeyPairRequest.getPublicKeyMaterial();
                jsonWriter.name("PublicKeyMaterial");
                jsonWriter.value(publicKeyMaterial);
            }
            if (importKeyPairRequest.getTagSpecifications() != null) {
                java.util.List<TagSpecification> tagSpecifications = importKeyPairRequest
