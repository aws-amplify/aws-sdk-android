 ...
 * </p>
 */
public class SpotMarketOptions implements Serializable {
    /**
     * <p>
    ...
    /**
     * <p>
     * The Spot Instance request type. For <a href=
     * "https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RunInstances"
     * >RunInstances</a>, persistent Spot Instance requests are only supported
     * when <b>InstanceInterruptionBehavior</b> is set to either
     ...
     *         The Spot Instance request type. For <a href=
     *         "https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RunInstances"
     *         >RunInstances</a>, persistent Spot Instance requests are only
     *         supported when <b>InstanceInterruptionBehavior</b> is set to
     ...
     *            date and time is reached. The default end date is 7 days from
     *            the current date.
     *            </p>
     */
     ...
     * @see InstanceInterruptionBehavior
     */
    public SpotMarketOptions withInstanceInterruptionBehavior(
            InstanceInterruptionBehavior instanceInterruptionBehavior) {
        this.instanceInterruptionBehavior = instanceInterruptionBehavior.toString();
        return this;
    }
