...
public class AttachVolumeResult implements Serializable {
     ...
     *         chained together.
     */
    public AttachVolumeResult withAttachTime(java.util.Date attachTime) {
        this.attachTime = attachTime;
        return this;
    }
     ...
     *         chained together.
     */
    public AttachVolumeResult withDevice(String device) {
        this.device = device;
        return this;
    }
     ...
     *         chained together.
     */
    public AttachVolumeResult withInstanceId(String instanceId) {
        this.instanceId = instanceId;
        return this;
    }
     ...
     * @see VolumeAttachmentState
     */
    public AttachVolumeResult withState(String state) {
        this.state = state;
        return this;
    }
     ...
     * @see VolumeAttachmentState
     */
    public AttachVolumeResult withState(VolumeAttachmentState state) {
        this.state = state.toString();
        return this;
    }
     ...
     *         chained together.
     */
    public AttachVolumeResult withVolumeId(String volumeId) {
        this.volumeId = volumeId;
        return this;
    }
     ...
     *         chained together.
     */
    public AttachVolumeResult withDeleteOnTermination(Boolean deleteOnTermination) {
        this.deleteOnTermination = deleteOnTermination;
        return this;
    }
