...
class SubnetJsonMarshaller {
    ...
    public void marshall(Subnet subnet, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (subnet.getMapCustomerOwnedIpOnLaunch() != null) {
            Boolean mapCustomerOwnedIpOnLaunch = subnet.getMapCustomerOwnedIpOnLaunch();
            jsonWriter.name("MapCustomerOwnedIpOnLaunch");
            jsonWriter.value(mapCustomerOwnedIpOnLaunch);
        }
        if (subnet.getCustomerOwnedIpv4Pool() != null) {
            String customerOwnedIpv4Pool = subnet.getCustomerOwnedIpv4Pool();
