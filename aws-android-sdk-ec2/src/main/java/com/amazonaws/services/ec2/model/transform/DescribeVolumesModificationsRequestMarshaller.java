...
/**
 * JSON request marshaller for DescribeVolumesModificationsRequest
 */
    ...
    public Request<DescribeVolumesModificationsRequest> marshall(
        ...
        if (describeVolumesModificationsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeVolumesModificationsRequest)");
        }

        Request<DescribeVolumesModificationsRequest> request = new DefaultRequest<DescribeVolumesModificationsRequest>(
                describeVolumesModificationsRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeVolumesModificationsRequest.getDryRun() != null) {
                Boolean dryRun = describeVolumesModificationsRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeVolumesModificationsRequest.getVolumeIds() != null) {
                java.util.List<String> volumeIds = describeVolumesModificationsRequest
                        .getVolumeIds();
            ...
            if (describeVolumesModificationsRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeVolumesModificationsRequest.getFilters();
            ...
            if (describeVolumesModificationsRequest.getNextToken() != null) {
                String nextToken = describeVolumesModificationsRequest.getNextToken();
                jsonWriter.name("NextToken");
                jsonWriter.value(nextToken);
            }
            if (describeVolumesModificationsRequest.getMaxResults() != null) {
                Integer maxResults = describeVolumesModificationsRequest.getMaxResults();
