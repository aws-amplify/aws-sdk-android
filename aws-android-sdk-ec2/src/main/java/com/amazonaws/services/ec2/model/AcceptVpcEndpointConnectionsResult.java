...
public class AcceptVpcEndpointConnectionsResult implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         Information about the interface endpoints that were not accepted,
     *         if applicable.
     *         </p>
     */
     ...
     *            Information about the interface endpoints that were not
     ...
     *         chained together.
     */
    public AcceptVpcEndpointConnectionsResult withUnsuccessful(
