...
/**
 * JSON request marshaller for DetachInternetGatewayRequest
 */
public class DetachInternetGatewayRequestMarshaller implements
    ...
    public Request<DetachInternetGatewayRequest> marshall(
        ...
        if (detachInternetGatewayRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DetachInternetGatewayRequest)");
        }

        Request<DetachInternetGatewayRequest> request = new DefaultRequest<DetachInternetGatewayRequest>(
                detachInternetGatewayRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (detachInternetGatewayRequest.getDryRun() != null) {
                Boolean dryRun = detachInternetGatewayRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (detachInternetGatewayRequest.getInternetGatewayId() != null) {
                String internetGatewayId = detachInternetGatewayRequest.getInternetGatewayId();
                jsonWriter.name("InternetGatewayId");
                jsonWriter.value(internetGatewayId);
            }
            if (detachInternetGatewayRequest.getVpcId() != null) {
                String vpcId = detachInternetGatewayRequest.getVpcId();
