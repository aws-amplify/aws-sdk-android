...
/**
 * JSON request marshaller for DeleteEgressOnlyInternetGatewayRequest
 */
public class DeleteEgressOnlyInternetGatewayRequestMarshaller
        implements
        Marshaller<Request<DeleteEgressOnlyInternetGatewayRequest>, DeleteEgressOnlyInternetGatewayRequest> {

    public Request<DeleteEgressOnlyInternetGatewayRequest> marshall(
        ...
        if (deleteEgressOnlyInternetGatewayRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteEgressOnlyInternetGatewayRequest)");
        }

        Request<DeleteEgressOnlyInternetGatewayRequest> request = new DefaultRequest<DeleteEgressOnlyInternetGatewayRequest>(
                deleteEgressOnlyInternetGatewayRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (deleteEgressOnlyInternetGatewayRequest.getDryRun() != null) {
                Boolean dryRun = deleteEgressOnlyInternetGatewayRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (deleteEgressOnlyInternetGatewayRequest.getEgressOnlyInternetGatewayId() != null) {
                String egressOnlyInternetGatewayId = deleteEgressOnlyInternetGatewayRequest
