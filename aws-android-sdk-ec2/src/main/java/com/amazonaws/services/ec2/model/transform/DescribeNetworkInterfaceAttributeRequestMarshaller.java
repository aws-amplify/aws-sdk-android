...
/**
 * JSON request marshaller for DescribeNetworkInterfaceAttributeRequest
 */
    ...
    public Request<DescribeNetworkInterfaceAttributeRequest> marshall(
        ...
        if (describeNetworkInterfaceAttributeRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeNetworkInterfaceAttributeRequest)");
        }

        Request<DescribeNetworkInterfaceAttributeRequest> request = new DefaultRequest<DescribeNetworkInterfaceAttributeRequest>(
                describeNetworkInterfaceAttributeRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeNetworkInterfaceAttributeRequest.getAttribute() != null) {
                String attribute = describeNetworkInterfaceAttributeRequest.getAttribute();
                jsonWriter.name("Attribute");
                jsonWriter.value(attribute);
            }
            if (describeNetworkInterfaceAttributeRequest.getDryRun() != null) {
                Boolean dryRun = describeNetworkInterfaceAttributeRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeNetworkInterfaceAttributeRequest.getNetworkInterfaceId() != null) {
                String networkInterfaceId = describeNetworkInterfaceAttributeRequest
