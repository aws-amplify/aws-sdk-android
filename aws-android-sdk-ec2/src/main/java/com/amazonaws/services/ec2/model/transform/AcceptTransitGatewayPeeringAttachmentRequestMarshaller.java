...
/**
 * JSON request marshaller for AcceptTransitGatewayPeeringAttachmentRequest
 */
public class AcceptTransitGatewayPeeringAttachmentRequestMarshaller
        implements
    ...
    public Request<AcceptTransitGatewayPeeringAttachmentRequest> marshall(
        ...
        if (acceptTransitGatewayPeeringAttachmentRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AcceptTransitGatewayPeeringAttachmentRequest)");
        }
        ...
        Request<AcceptTransitGatewayPeeringAttachmentRequest> request = new DefaultRequest<AcceptTransitGatewayPeeringAttachmentRequest>(
                acceptTransitGatewayPeeringAttachmentRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (acceptTransitGatewayPeeringAttachmentRequest.getTransitGatewayAttachmentId() != null) {
                String transitGatewayAttachmentId = acceptTransitGatewayPeeringAttachmentRequest
                        .getTransitGatewayAttachmentId();
                jsonWriter.name("TransitGatewayAttachmentId");
                jsonWriter.value(transitGatewayAttachmentId);
            }
            if (acceptTransitGatewayPeeringAttachmentRequest.getDryRun() != null) {
                Boolean dryRun = acceptTransitGatewayPeeringAttachmentRequest.getDryRun();
