...
/**
 * Create Flow Logs Result StAX Unmarshaller
 */
public class CreateFlowLogsResultStaxUnmarshaller implements Unmarshaller<CreateFlowLogsResult, StaxUnmarshallerContext> {
    ...
    public CreateFlowLogsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return createFlowLogsResult;

            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("flowLogIdSet/item", targetDepth)) {
                    createFlowLogsResult.getFlowLogIds().add(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("unsuccessful/item", targetDepth)) {
                    createFlowLogsResult.getUnsuccessful().add(UnsuccessfulItemStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CreateFlowLogsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateFlowLogsResultStaxUnmarshaller();
        return instance;
    }
}
