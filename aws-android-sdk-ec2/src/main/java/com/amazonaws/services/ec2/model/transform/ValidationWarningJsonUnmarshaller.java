...
/**
 * JSON unmarshaller for POJO ValidationWarning
 */
class ValidationWarningJsonUnmarshaller implements
        Unmarshaller<ValidationWarning, JsonUnmarshallerContext> {
    ...
    public ValidationWarning unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Errors")) {
                validationWarning.setErrors(new ListUnmarshaller<ValidationError>(
