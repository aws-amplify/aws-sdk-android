...
public class DescribeVpcEndpointsResult implements Serializable {
    ...
    public DescribeVpcEndpointsResult withVpcEndpoints(VpcEndpoint... vpcEndpoints) {
        if (getVpcEndpoints() == null) {
            this.vpcEndpoints = new java.util.ArrayList<VpcEndpoint>(vpcEndpoints.length);
        }
        for (VpcEndpoint value : vpcEndpoints) {
            this.vpcEndpoints.add(value);
        }
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getVpcEndpoints() == null) ? 0 : getVpcEndpoints().hashCode());
