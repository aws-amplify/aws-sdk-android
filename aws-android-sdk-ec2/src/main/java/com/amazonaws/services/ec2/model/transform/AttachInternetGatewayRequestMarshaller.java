...
/**
 * JSON request marshaller for AttachInternetGatewayRequest
 */
public class AttachInternetGatewayRequestMarshaller implements
    ...
    public Request<AttachInternetGatewayRequest> marshall(
        ...
        if (attachInternetGatewayRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AttachInternetGatewayRequest)");
        }

        Request<AttachInternetGatewayRequest> request = new DefaultRequest<AttachInternetGatewayRequest>(
                attachInternetGatewayRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (attachInternetGatewayRequest.getDryRun() != null) {
                Boolean dryRun = attachInternetGatewayRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (attachInternetGatewayRequest.getInternetGatewayId() != null) {
                String internetGatewayId = attachInternetGatewayRequest.getInternetGatewayId();
                jsonWriter.name("InternetGatewayId");
                jsonWriter.value(internetGatewayId);
            }
            if (attachInternetGatewayRequest.getVpcId() != null) {
                String vpcId = attachInternetGatewayRequest.getVpcId();
