...
/**
 * JSON request marshaller for TerminateInstancesRequest
 */
    ...
    public Request<TerminateInstancesRequest> marshall(
        ...
        if (terminateInstancesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(TerminateInstancesRequest)");
        }

        Request<TerminateInstancesRequest> request = new DefaultRequest<TerminateInstancesRequest>(
                terminateInstancesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (terminateInstancesRequest.getInstanceIds() != null) {
                java.util.List<String> instanceIds = terminateInstancesRequest.getInstanceIds();
            ...
            if (terminateInstancesRequest.getDryRun() != null) {
                Boolean dryRun = terminateInstancesRequest.getDryRun();
