...
public class DescribeSpotFleetRequestsResult implements Serializable {
     ...
     */
    private com.amazonaws.internal.ListWithAutoConstructFlag<SpotFleetRequestConfig> spotFleetRequestConfigs;
    ...
    public java.util.List<SpotFleetRequestConfig> getSpotFleetRequestConfigs() {
        if (spotFleetRequestConfigs == null) {
              spotFleetRequestConfigs = new com.amazonaws.internal.ListWithAutoConstructFlag<SpotFleetRequestConfig>();
    ...
    public void setSpotFleetRequestConfigs(java.util.Collection<SpotFleetRequestConfig> spotFleetRequestConfigs) {
        ...
        com.amazonaws.internal.ListWithAutoConstructFlag<SpotFleetRequestConfig> spotFleetRequestConfigsCopy = new com.amazonaws.internal.ListWithAutoConstructFlag<SpotFleetRequestConfig>(spotFleetRequestConfigs.size());
    ...
    public DescribeSpotFleetRequestsResult withSpotFleetRequestConfigs(SpotFleetRequestConfig... spotFleetRequestConfigs) {
        if (getSpotFleetRequestConfigs() == null) setSpotFleetRequestConfigs(new java.util.ArrayList<SpotFleetRequestConfig>(spotFleetRequestConfigs.length));
