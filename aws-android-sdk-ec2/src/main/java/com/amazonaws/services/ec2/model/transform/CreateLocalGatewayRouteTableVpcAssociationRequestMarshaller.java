...
/**
 * JSON request marshaller for CreateLocalGatewayRouteTableVpcAssociationRequest
 */
    ...
    public Request<CreateLocalGatewayRouteTableVpcAssociationRequest> marshall(
        ...
        if (createLocalGatewayRouteTableVpcAssociationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateLocalGatewayRouteTableVpcAssociationRequest)");
        }
        ...
        Request<CreateLocalGatewayRouteTableVpcAssociationRequest> request = new DefaultRequest<CreateLocalGatewayRouteTableVpcAssociationRequest>(
                createLocalGatewayRouteTableVpcAssociationRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (createLocalGatewayRouteTableVpcAssociationRequest.getLocalGatewayRouteTableId() != null) {
                String localGatewayRouteTableId = createLocalGatewayRouteTableVpcAssociationRequest
            ...
            if (createLocalGatewayRouteTableVpcAssociationRequest.getVpcId() != null) {
                String vpcId = createLocalGatewayRouteTableVpcAssociationRequest.getVpcId();
                jsonWriter.name("VpcId");
                jsonWriter.value(vpcId);
            }
            if (createLocalGatewayRouteTableVpcAssociationRequest.getTagSpecifications() != null) {
                java.util.List<TagSpecification> tagSpecifications = createLocalGatewayRouteTableVpcAssociationRequest
            ...
            if (createLocalGatewayRouteTableVpcAssociationRequest.getDryRun() != null) {
                Boolean dryRun = createLocalGatewayRouteTableVpcAssociationRequest.getDryRun();
