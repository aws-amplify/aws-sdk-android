...
/**
 * JSON request marshaller for UpdateSecurityGroupRuleDescriptionsEgressRequest
 */
    ...
    public Request<UpdateSecurityGroupRuleDescriptionsEgressRequest> marshall(
        ...
        if (updateSecurityGroupRuleDescriptionsEgressRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateSecurityGroupRuleDescriptionsEgressRequest)");
        }
        ...
        Request<UpdateSecurityGroupRuleDescriptionsEgressRequest> request = new DefaultRequest<UpdateSecurityGroupRuleDescriptionsEgressRequest>(
                updateSecurityGroupRuleDescriptionsEgressRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (updateSecurityGroupRuleDescriptionsEgressRequest.getDryRun() != null) {
                Boolean dryRun = updateSecurityGroupRuleDescriptionsEgressRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (updateSecurityGroupRuleDescriptionsEgressRequest.getGroupId() != null) {
                String groupId = updateSecurityGroupRuleDescriptionsEgressRequest.getGroupId();
                jsonWriter.name("GroupId");
                jsonWriter.value(groupId);
            }
            if (updateSecurityGroupRuleDescriptionsEgressRequest.getGroupName() != null) {
                String groupName = updateSecurityGroupRuleDescriptionsEgressRequest.getGroupName();
                jsonWriter.name("GroupName");
                jsonWriter.value(groupName);
            }
            if (updateSecurityGroupRuleDescriptionsEgressRequest.getIpPermissions() != null) {
                java.util.List<IpPermission> ipPermissions = updateSecurityGroupRuleDescriptionsEgressRequest
                        .getIpPermissions();
