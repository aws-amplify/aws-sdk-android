...
/**
 * JSON request marshaller for UpdateSecurityGroupRuleDescriptionsIngressRequest
 */
    ...
    public Request<UpdateSecurityGroupRuleDescriptionsIngressRequest> marshall(
        ...
        if (updateSecurityGroupRuleDescriptionsIngressRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateSecurityGroupRuleDescriptionsIngressRequest)");
        }
        ...
        Request<UpdateSecurityGroupRuleDescriptionsIngressRequest> request = new DefaultRequest<UpdateSecurityGroupRuleDescriptionsIngressRequest>(
                updateSecurityGroupRuleDescriptionsIngressRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (updateSecurityGroupRuleDescriptionsIngressRequest.getDryRun() != null) {
                Boolean dryRun = updateSecurityGroupRuleDescriptionsIngressRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (updateSecurityGroupRuleDescriptionsIngressRequest.getGroupId() != null) {
                String groupId = updateSecurityGroupRuleDescriptionsIngressRequest.getGroupId();
                jsonWriter.name("GroupId");
                jsonWriter.value(groupId);
            }
            if (updateSecurityGroupRuleDescriptionsIngressRequest.getGroupName() != null) {
                String groupName = updateSecurityGroupRuleDescriptionsIngressRequest.getGroupName();
                jsonWriter.name("GroupName");
                jsonWriter.value(groupName);
            }
            if (updateSecurityGroupRuleDescriptionsIngressRequest.getIpPermissions() != null) {
                java.util.List<IpPermission> ipPermissions = updateSecurityGroupRuleDescriptionsIngressRequest
                        .getIpPermissions();
