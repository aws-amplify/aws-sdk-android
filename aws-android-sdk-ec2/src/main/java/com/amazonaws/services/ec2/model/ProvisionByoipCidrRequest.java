...
public class ProvisionByoipCidrRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * </p>
     */
    private java.util.List<TagSpecification> poolTagSpecifications;
     ...
     * </p>
     *
     * @param poolTagSpecifications <p>
     *            The tags to apply to the address pool.
     *            </p>
     */
    public void setPoolTagSpecifications(
            java.util.Collection<TagSpecification> poolTagSpecifications) {
        if (poolTagSpecifications == null) {
            this.poolTagSpecifications = null;
            return;
        }

        this.poolTagSpecifications = new java.util.ArrayList<TagSpecification>(
     ...
     *         chained together.
     */
    public ProvisionByoipCidrRequest withPoolTagSpecifications(
            TagSpecification... poolTagSpecifications) {
        if (getPoolTagSpecifications() == null) {
            this.poolTagSpecifications = new java.util.ArrayList<TagSpecification>(
                    poolTagSpecifications.length);
        }
        for (TagSpecification value : poolTagSpecifications) {
            this.poolTagSpecifications.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        if (getPoolTagSpecifications() != null)
            sb.append("PoolTagSpecifications: " + getPoolTagSpecifications());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getPoolTagSpecifications() == null) ? 0 : getPoolTagSpecifications().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getPoolTagSpecifications() == null ^ this.getPoolTagSpecifications() == null)
            return false;
        if (other.getPoolTagSpecifications() != null
                && other.getPoolTagSpecifications().equals(this.getPoolTagSpecifications()) == false)
            return false;
        return true;
    }
}
