...
/**
 * JSON request marshaller for DescribeVolumesRequest
 */
    ...
    public Request<DescribeVolumesRequest> marshall(DescribeVolumesRequest describeVolumesRequest) {
        if (describeVolumesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeVolumesRequest)");
        }

        Request<DescribeVolumesRequest> request = new DefaultRequest<DescribeVolumesRequest>(
                describeVolumesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (describeVolumesRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeVolumesRequest.getFilters();
            ...
            if (describeVolumesRequest.getVolumeIds() != null) {
                java.util.List<String> volumeIds = describeVolumesRequest.getVolumeIds();
            ...
            if (describeVolumesRequest.getDryRun() != null) {
                Boolean dryRun = describeVolumesRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (describeVolumesRequest.getMaxResults() != null) {
                Integer maxResults = describeVolumesRequest.getMaxResults();
                jsonWriter.name("MaxResults");
                jsonWriter.value(maxResults);
            }
            if (describeVolumesRequest.getNextToken() != null) {
                String nextToken = describeVolumesRequest.getNextToken();
