 ...
 * </p>
 * <p>
 * Use the <code>CapacityReservationPreference</code> parameter to configure the
 * instance to run as an On-Demand Instance or to run in any <code>open</code>
...
public class CapacityReservationSpecification implements Serializable {
     ...
     *         Reservation even if one is available. The instance runs as an
     *         On-Demand Instance.
     *         </p>
     *         </li>
     *         </ul>
     ...
     * @see CapacityReservationPreference
     */
    public CapacityReservationSpecification withCapacityReservationPreference(
     ...
     *         chained together.
     */
    public CapacityReservationSpecification withCapacityReservationTarget(
