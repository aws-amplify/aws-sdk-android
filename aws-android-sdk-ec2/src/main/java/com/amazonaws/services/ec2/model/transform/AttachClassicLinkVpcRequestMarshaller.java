...
/**
 * JSON request marshaller for AttachClassicLinkVpcRequest
 */
    ...
    public Request<AttachClassicLinkVpcRequest> marshall(
        ...
        if (attachClassicLinkVpcRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AttachClassicLinkVpcRequest)");
        }

        Request<AttachClassicLinkVpcRequest> request = new DefaultRequest<AttachClassicLinkVpcRequest>(
                attachClassicLinkVpcRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (attachClassicLinkVpcRequest.getDryRun() != null) {
                Boolean dryRun = attachClassicLinkVpcRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (attachClassicLinkVpcRequest.getGroups() != null) {
                java.util.List<String> groups = attachClassicLinkVpcRequest.getGroups();
            ...
            if (attachClassicLinkVpcRequest.getInstanceId() != null) {
                String instanceId = attachClassicLinkVpcRequest.getInstanceId();
                jsonWriter.name("InstanceId");
                jsonWriter.value(instanceId);
            }
            if (attachClassicLinkVpcRequest.getVpcId() != null) {
                String vpcId = attachClassicLinkVpcRequest.getVpcId();
