...
/**
 * JSON request marshaller for ModifyFleetRequest
 */
public class ModifyFleetRequestMarshaller implements
        Marshaller<Request<ModifyFleetRequest>, ModifyFleetRequest> {

    public Request<ModifyFleetRequest> marshall(ModifyFleetRequest modifyFleetRequest) {
        if (modifyFleetRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ModifyFleetRequest)");
        }

        Request<ModifyFleetRequest> request = new DefaultRequest<ModifyFleetRequest>(
                modifyFleetRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (modifyFleetRequest.getTargetCapacitySpecification() != null) {
                TargetCapacitySpecificationRequest targetCapacitySpecification = modifyFleetRequest
