...
/**
 * JSON request marshaller for GetReservedInstancesExchangeQuoteRequest
 */
    ...
    public Request<GetReservedInstancesExchangeQuoteRequest> marshall(
        ...
        if (getReservedInstancesExchangeQuoteRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetReservedInstancesExchangeQuoteRequest)");
        }

        Request<GetReservedInstancesExchangeQuoteRequest> request = new DefaultRequest<GetReservedInstancesExchangeQuoteRequest>(
                getReservedInstancesExchangeQuoteRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (getReservedInstancesExchangeQuoteRequest.getDryRun() != null) {
                Boolean dryRun = getReservedInstancesExchangeQuoteRequest.getDryRun();
                jsonWriter.name("DryRun");
                jsonWriter.value(dryRun);
            }
            if (getReservedInstancesExchangeQuoteRequest.getReservedInstanceIds() != null) {
                java.util.List<String> reservedInstanceIds = getReservedInstancesExchangeQuoteRequest
            ...
            if (getReservedInstancesExchangeQuoteRequest.getTargetConfigurations() != null) {
                java.util.List<TargetConfigurationRequest> targetConfigurations = getReservedInstancesExchangeQuoteRequest
