...
/**
 * JSON unmarshaller for response DescribeFleetsResult
 */
public class DescribeFleetsResultJsonUnmarshaller implements
        Unmarshaller<DescribeFleetsResult, JsonUnmarshallerContext> {
    ...
    public DescribeFleetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NextToken")) {
                describeFleetsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Fleets")) {
                describeFleetsResult.setFleets(new ListUnmarshaller<FleetData>(
                        FleetDataJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
