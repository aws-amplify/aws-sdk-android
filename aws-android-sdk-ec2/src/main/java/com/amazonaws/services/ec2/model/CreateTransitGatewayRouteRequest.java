 ...
 * </p>
 */
public class CreateTransitGatewayRouteRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public CreateTransitGatewayRouteRequest withTransitGatewayRouteTableId(
     ...
     *         chained together.
     */
    public CreateTransitGatewayRouteRequest withTransitGatewayAttachmentId(
    ...
    public String toString() {
        ...
        if (getBlackhole() != null)
            sb.append("Blackhole: " + getBlackhole() + ",");
        if (getDryRun() != null)
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getBlackhole() == null ^ this.getBlackhole() == null)
            return false;
        if (other.getBlackhole() != null
                && other.getBlackhole().equals(this.getBlackhole()) == false)
            return false;
