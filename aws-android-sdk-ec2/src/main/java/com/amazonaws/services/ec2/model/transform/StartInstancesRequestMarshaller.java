...
/**
 * JSON request marshaller for StartInstancesRequest
 */
    ...
    public Request<StartInstancesRequest> marshall(StartInstancesRequest startInstancesRequest) {
        if (startInstancesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(StartInstancesRequest)");
        }

        Request<StartInstancesRequest> request = new DefaultRequest<StartInstancesRequest>(
                startInstancesRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (startInstancesRequest.getInstanceIds() != null) {
                java.util.List<String> instanceIds = startInstancesRequest.getInstanceIds();
            ...
            if (startInstancesRequest.getAdditionalInfo() != null) {
                String additionalInfo = startInstancesRequest.getAdditionalInfo();
                jsonWriter.name("AdditionalInfo");
                jsonWriter.value(additionalInfo);
            }
            if (startInstancesRequest.getDryRun() != null) {
                Boolean dryRun = startInstancesRequest.getDryRun();
