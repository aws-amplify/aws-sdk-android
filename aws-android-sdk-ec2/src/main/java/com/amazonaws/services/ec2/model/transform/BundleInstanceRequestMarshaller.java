...
/**
 * JSON request marshaller for BundleInstanceRequest
 */
    ...
    public Request<BundleInstanceRequest> marshall(BundleInstanceRequest bundleInstanceRequest) {
        if (bundleInstanceRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(BundleInstanceRequest)");
        }

        Request<BundleInstanceRequest> request = new DefaultRequest<BundleInstanceRequest>(
                bundleInstanceRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (bundleInstanceRequest.getInstanceId() != null) {
                String instanceId = bundleInstanceRequest.getInstanceId();
                jsonWriter.name("InstanceId");
                jsonWriter.value(instanceId);
            }
            if (bundleInstanceRequest.getStorage() != null) {
            ...
            if (bundleInstanceRequest.getDryRun() != null) {
                Boolean dryRun = bundleInstanceRequest.getDryRun();
