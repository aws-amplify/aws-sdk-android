...
public class DescribeClassicLinkInstancesResult implements Serializable {
     ...
     * </p>
     */
    private java.util.List<ClassicLinkInstance> instances;
    ...
    public void setInstances(java.util.Collection<ClassicLinkInstance> instances) {
        ...
        this.instances = new java.util.ArrayList<ClassicLinkInstance>(instances);
    }
    ...
    public DescribeClassicLinkInstancesResult withInstances(ClassicLinkInstance... instances) {
        if (getInstances() == null) {
            this.instances = new java.util.ArrayList<ClassicLinkInstance>(instances.length);
        }
