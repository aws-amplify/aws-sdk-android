 ...
 * in the <code>active</code> state. The owner of the requester VPC can delete a
 * VPC peering connection in the <code>pending-acceptance</code> state. You
 * cannot delete a VPC peering connection that's in the <code>failed</code>
 * state.
 * </p>
 */
public class DeleteVpcPeeringConnectionRequest extends AmazonWebServiceRequest implements
     ...
     *         chained together.
     */
    public DeleteVpcPeeringConnectionRequest withVpcPeeringConnectionId(
