...
/**
 * JSON request marshaller for CreateVolumeRequest
 */
    ...
    public Request<CreateVolumeRequest> marshall(CreateVolumeRequest createVolumeRequest) {
        if (createVolumeRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateVolumeRequest)");
        }

        Request<CreateVolumeRequest> request = new DefaultRequest<CreateVolumeRequest>(
                createVolumeRequest, "AmazonElasticComputeCloud");
        ...
        try {
            ...
            if (createVolumeRequest.getMultiAttachEnabled() != null) {
                Boolean multiAttachEnabled = createVolumeRequest.getMultiAttachEnabled();
