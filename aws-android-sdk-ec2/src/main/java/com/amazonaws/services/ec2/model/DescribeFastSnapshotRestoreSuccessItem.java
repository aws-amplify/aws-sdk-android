 ...
 * </p>
 */
public class DescribeFastSnapshotRestoreSuccessItem implements Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public DescribeFastSnapshotRestoreSuccessItem withStateTransitionReason(
     ...
     *
     * @return <p>
     *         The ID of the AWS account that enabled fast snapshot restores on
     *         the snapshot.
     *         </p>
     */
     ...
     *
     * @param ownerId <p>
     *            The ID of the AWS account that enabled fast snapshot restores
     *            on the snapshot.
     *            </p>
     */
