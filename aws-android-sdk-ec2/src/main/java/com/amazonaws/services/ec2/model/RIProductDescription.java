...
public enum RIProductDescription {
    ...
    private static final Map<String, RIProductDescription> enumMap;
    static {
        enumMap = new HashMap<String, RIProductDescription>();
        enumMap.put("Linux/UNIX", LinuxUNIX);
        enumMap.put("Linux/UNIX (Amazon VPC)", LinuxUNIXAmazonVPC);
        enumMap.put("Windows", Windows);
        enumMap.put("Windows (Amazon VPC)", WindowsAmazonVPC);
    }
