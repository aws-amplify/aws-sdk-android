...
/**
 * JSON unmarshaller for response SendAlexaOfferToMasterResult
 */
public class SendAlexaOfferToMasterResultJsonUnmarshaller implements
        Unmarshaller<SendAlexaOfferToMasterResult, JsonUnmarshallerContext> {
    ...
    public SendAlexaOfferToMasterResult unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Answer")) {
                sendAlexaOfferToMasterResult.setAnswer(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
