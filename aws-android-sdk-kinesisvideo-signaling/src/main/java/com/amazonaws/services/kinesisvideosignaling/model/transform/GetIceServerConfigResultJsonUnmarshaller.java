...
/**
 * JSON unmarshaller for response GetIceServerConfigResult
 */
public class GetIceServerConfigResultJsonUnmarshaller implements
        Unmarshaller<GetIceServerConfigResult, JsonUnmarshallerContext> {
    ...
    public GetIceServerConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("IceServerList")) {
                getIceServerConfigResult.setIceServerList(new ListUnmarshaller<IceServer>(
                        IceServerJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
