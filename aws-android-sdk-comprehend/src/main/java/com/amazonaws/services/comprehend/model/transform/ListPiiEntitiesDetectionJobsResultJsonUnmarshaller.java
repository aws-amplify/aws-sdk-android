...
/**
 * JSON unmarshaller for response ListPiiEntitiesDetectionJobsResult
 */
public class ListPiiEntitiesDetectionJobsResultJsonUnmarshaller implements
        Unmarshaller<ListPiiEntitiesDetectionJobsResult, JsonUnmarshallerContext> {

    public ListPiiEntitiesDetectionJobsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PiiEntitiesDetectionJobPropertiesList")) {
                ...
                listPiiEntitiesDetectionJobsResult.setNextToken(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
