...
public class BatchDetectDominantLanguageResult implements Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public BatchDetectDominantLanguageResult withResultList(
            BatchDetectDominantLanguageItemResult... resultList) {
        if (getResultList() == null) {
            this.resultList = new java.util.ArrayList<BatchDetectDominantLanguageItemResult>(
                    resultList.length);
        }
        for (BatchDetectDominantLanguageItemResult value : resultList) {
     ...
     */
    public BatchDetectDominantLanguageResult withResultList(
            java.util.Collection<BatchDetectDominantLanguageItemResult> resultList) {
     ...
     *         chained together.
     */
    public BatchDetectDominantLanguageResult withErrorList(
