 ...
 * input. The analysis uses the order of strings in the list to determine
 * context when predicting toxicity. The API response contains a results list
 * that matches the size of the input list. For more information about toxicity
...
public class DetectToxicContentRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         A list of up to 10 text strings. The maximum size for the list is
     *         10 KB.
     *         </p>
     */
     ...
     *            A list of up to 10 text strings. The maximum size for the list
     *            is 10 KB.
     *            </p>
     */
