        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Pages")) {
                documentMetadata.setPages(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ExtractedCharacters")) {
                documentMetadata
                        .setExtractedCharacters(new ListUnmarshaller<ExtractedCharactersListItem>(
                                ExtractedCharactersListItemJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
