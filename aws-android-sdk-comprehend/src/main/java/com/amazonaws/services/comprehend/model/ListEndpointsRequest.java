...
public class ListEndpointsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         Filters the endpoints that are returned. You can filter endpoints
     ...
     *
     * @param filter <p>
     *            Filters the endpoints that are returned. You can filter
     *            endpoints on their name, model, status, or the date and time
     *            that they were created. You can only set one filter at a time.
     *            </p>
     */
