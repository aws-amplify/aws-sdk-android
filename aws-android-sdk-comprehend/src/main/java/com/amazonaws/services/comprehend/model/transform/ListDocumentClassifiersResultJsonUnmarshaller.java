...
/**
 * JSON unmarshaller for response ListDocumentClassifiersResult
 */
public class ListDocumentClassifiersResultJsonUnmarshaller implements
        Unmarshaller<ListDocumentClassifiersResult, JsonUnmarshallerContext> {

    public ListDocumentClassifiersResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
