...
public class BatchDetectKeyPhrasesResult implements Serializable {
    ...
    public BatchDetectKeyPhrasesResult withResultList(BatchDetectKeyPhrasesItemResult... resultList) {
        if (getResultList() == null) {
            this.resultList = new java.util.ArrayList<BatchDetectKeyPhrasesItemResult>(
                    resultList.length);
        }
        for (BatchDetectKeyPhrasesItemResult value : resultList) {
     ...
     *         chained together.
     */
    public BatchDetectKeyPhrasesResult withResultList(
            java.util.Collection<BatchDetectKeyPhrasesItemResult> resultList) {
