...
public class CreateFlywheelRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * (IAM) role that grants Amazon Comprehend the permissions required to
     ...
     *         Management (IAM) role that grants Amazon Comprehend the
     *         permissions required to access the flywheel data in the data
     *         lake.
     *         </p>
     */
