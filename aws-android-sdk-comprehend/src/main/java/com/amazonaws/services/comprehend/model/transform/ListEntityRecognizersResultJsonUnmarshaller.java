...
/**
 * JSON unmarshaller for response ListEntityRecognizersResult
 */
public class ListEntityRecognizersResultJsonUnmarshaller implements
        Unmarshaller<ListEntityRecognizersResult, JsonUnmarshallerContext> {
