...
public class BatchDetectEntitiesResult implements Serializable {
    /**
     * <p>
    ...
    public BatchDetectEntitiesResult withResultList(BatchDetectEntitiesItemResult... resultList) {
        if (getResultList() == null) {
            this.resultList = new java.util.ArrayList<BatchDetectEntitiesItemResult>(
                    resultList.length);
        }
        for (BatchDetectEntitiesItemResult value : resultList) {
     ...
     *         chained together.
     */
    public BatchDetectEntitiesResult withResultList(
            java.util.Collection<BatchDetectEntitiesItemResult> resultList) {
