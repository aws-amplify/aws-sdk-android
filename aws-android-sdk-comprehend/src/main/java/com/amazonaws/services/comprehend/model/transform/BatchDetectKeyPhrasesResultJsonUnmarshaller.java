...
/**
 * JSON unmarshaller for response BatchDetectKeyPhrasesResult
 */
public class BatchDetectKeyPhrasesResultJsonUnmarshaller implements
        Unmarshaller<BatchDetectKeyPhrasesResult, JsonUnmarshallerContext> {
