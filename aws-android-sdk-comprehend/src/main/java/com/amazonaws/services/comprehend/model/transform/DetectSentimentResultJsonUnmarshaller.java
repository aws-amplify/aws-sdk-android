...
/**
 * JSON unmarshaller for response DetectSentimentResult
 */
public class DetectSentimentResultJsonUnmarshaller implements
        Unmarshaller<DetectSentimentResult, JsonUnmarshallerContext> {
