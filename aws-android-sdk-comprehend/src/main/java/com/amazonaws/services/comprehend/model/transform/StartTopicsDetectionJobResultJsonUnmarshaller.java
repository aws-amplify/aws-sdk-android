...
/**
 * JSON unmarshaller for response StartTopicsDetectionJobResult
 */
public class StartTopicsDetectionJobResultJsonUnmarshaller implements
        Unmarshaller<StartTopicsDetectionJobResult, JsonUnmarshallerContext> {

    public StartTopicsDetectionJobResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
