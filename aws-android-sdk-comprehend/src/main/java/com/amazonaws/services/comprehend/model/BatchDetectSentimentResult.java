...
public class BatchDetectSentimentResult implements Serializable {
    ...
    public BatchDetectSentimentResult withResultList(BatchDetectSentimentItemResult... resultList) {
        if (getResultList() == null) {
            this.resultList = new java.util.ArrayList<BatchDetectSentimentItemResult>(
                    resultList.length);
        }
        for (BatchDetectSentimentItemResult value : resultList) {
     ...
     *         chained together.
     */
    public BatchDetectSentimentResult withResultList(
            java.util.Collection<BatchDetectSentimentItemResult> resultList) {
