 ...
 * </p>
 */
public class TopicsDetectionJobFilter implements Serializable {
    /**
     * <p/>
     * <p>
     * <b>Constraints:</b><br/>
     ...
     * <p>
     * Filters the list of jobs based on the time that the job was submitted for
     * processing. Only returns jobs submitted after the specified time. Jobs
     ...
     *            Filters the list of jobs based on the time that the job was
     *            submitted for processing. Only returns jobs submitted before
     ...
     *            Filters the list of jobs based on the time that the job was
     *            submitted for processing. Only returns jobs submitted after
