...
/**
 * JSON unmarshaller for POJO EntityRecognizerMetadata
 */
class EntityRecognizerMetadataJsonUnmarshaller implements
        Unmarshaller<EntityRecognizerMetadata, JsonUnmarshallerContext> {
