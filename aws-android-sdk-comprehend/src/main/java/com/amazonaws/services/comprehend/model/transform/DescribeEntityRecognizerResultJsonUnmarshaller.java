...
/**
 * JSON unmarshaller for response DescribeEntityRecognizerResult
 */
public class DescribeEntityRecognizerResultJsonUnmarshaller implements
        Unmarshaller<DescribeEntityRecognizerResult, JsonUnmarshallerContext> {

    public DescribeEntityRecognizerResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
