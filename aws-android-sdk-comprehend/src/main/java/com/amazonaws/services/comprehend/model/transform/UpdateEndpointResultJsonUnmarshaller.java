...
/**
 * JSON unmarshaller for response UpdateEndpointResult
 */
public class UpdateEndpointResultJsonUnmarshaller implements
        Unmarshaller<UpdateEndpointResult, JsonUnmarshallerContext> {
    ...
    public UpdateEndpointResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("DesiredModelArn")) {
                updateEndpointResult.setDesiredModelArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
