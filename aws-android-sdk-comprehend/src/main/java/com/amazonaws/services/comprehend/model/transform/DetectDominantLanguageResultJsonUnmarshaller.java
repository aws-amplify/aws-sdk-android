...
/**
 * JSON unmarshaller for response DetectDominantLanguageResult
 */
public class DetectDominantLanguageResultJsonUnmarshaller implements
        Unmarshaller<DetectDominantLanguageResult, JsonUnmarshallerContext> {

    public DetectDominantLanguageResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
