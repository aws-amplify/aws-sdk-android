...
public class KmsKeyValidationExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("KmsKeyValidationException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        KmsKeyValidationException e = (KmsKeyValidationException) super.unmarshall(error);
        e.setErrorCode("KmsKeyValidationException");
