...
/**
 * JSON unmarshaller for POJO DocumentClassifierInputDataConfig
 */
class DocumentClassifierInputDataConfigJsonUnmarshaller implements
        Unmarshaller<DocumentClassifierInputDataConfig, JsonUnmarshallerContext> {
