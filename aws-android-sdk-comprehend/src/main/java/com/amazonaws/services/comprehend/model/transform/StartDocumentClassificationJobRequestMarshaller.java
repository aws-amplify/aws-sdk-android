...
public class StartDocumentClassificationJobRequestMarshaller
    ...
    public Request<StartDocumentClassificationJobRequest> marshall(
        ...
        try {
            ...
            if (startDocumentClassificationJobRequest.getVpcConfig() != null) {
                VpcConfig vpcConfig = startDocumentClassificationJobRequest.getVpcConfig();
                jsonWriter.name("VpcConfig");
                VpcConfigJsonMarshaller.getInstance().marshall(vpcConfig, jsonWriter);
            }
            if (startDocumentClassificationJobRequest.getTags() != null) {
                java.util.List<Tag> tags = startDocumentClassificationJobRequest.getTags();
            ...
            if (startDocumentClassificationJobRequest.getFlywheelArn() != null) {
                String flywheelArn = startDocumentClassificationJobRequest.getFlywheelArn();
