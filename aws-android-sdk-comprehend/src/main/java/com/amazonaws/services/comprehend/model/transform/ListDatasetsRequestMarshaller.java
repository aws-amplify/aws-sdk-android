...
public class ListDatasetsRequestMarshaller implements
    ...
    public Request<ListDatasetsRequest> marshall(ListDatasetsRequest listDatasetsRequest) {
        ...
        Request<ListDatasetsRequest> request = new DefaultRequest<ListDatasetsRequest>(
                listDatasetsRequest, "AmazonComprehend");
        ...
        try {
            ...
            if (listDatasetsRequest.getFlywheelArn() != null) {
                String flywheelArn = listDatasetsRequest.getFlywheelArn();
                jsonWriter.name("FlywheelArn");
                jsonWriter.value(flywheelArn);
            }
            if (listDatasetsRequest.getFilter() != null) {
                DatasetFilter filter = listDatasetsRequest.getFilter();
                jsonWriter.name("Filter");
                DatasetFilterJsonMarshaller.getInstance().marshall(filter, jsonWriter);
            }
            if (listDatasetsRequest.getNextToken() != null) {
                String nextToken = listDatasetsRequest.getNextToken();
                jsonWriter.name("NextToken");
                jsonWriter.value(nextToken);
            }
            if (listDatasetsRequest.getMaxResults() != null) {
                Integer maxResults = listDatasetsRequest.getMaxResults();
