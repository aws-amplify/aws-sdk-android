...
public class TagResourceRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * and value. You can set the value of a tag to an empty string, but you
     ...
     *
     * @param tags <p>
     *            The tag to add to the specified resource. You must specify
     *            both a tag key and value. You can set the value of a tag to an
