 ...
 * </p>
 */
public class ListDelegatedAdministratorsRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         Specifies a service principal name. If specified, then the
     *         operation lists the delegated administrators only for the
     *         specified service.
     *         </p>
     *         <p>
     *         If you don't specify a service principal, the operation lists all
     ...
     *            </p>
     *            <p>
     *            If you don't specify a service principal, the operation lists
     *            all delegated administrators for all services in your
     *            organization.
     *            </p>
     */
