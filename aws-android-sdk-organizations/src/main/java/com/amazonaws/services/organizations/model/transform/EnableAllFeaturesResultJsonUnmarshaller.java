...
/**
 * JSON unmarshaller for response EnableAllFeaturesResult
 */
public class EnableAllFeaturesResultJsonUnmarshaller implements
        Unmarshaller<EnableAllFeaturesResult, JsonUnmarshallerContext> {
    ...
    public EnableAllFeaturesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Handshake")) {
                enableAllFeaturesResult.setHandshake(HandshakeJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
