 ...
 * to replace the default <code>FullAWSAccess</code> policy with an SCP that
 * limits the permissions that can be delegated, you must attach the replacement
 * SCP before you can remove the default SCP. This is the authorization strategy
 * of an "<a href="https://docs.aws.amazon.com/organizations/latest/userguide/
 * SCP_strategies.html#orgs_policies_allowlist">allow list</a>". If you instead
 ...
 * policy (or any other attached SCP), you're using the authorization strategy
 * of a "<a href="https://docs.aws.amazon.com/organizations/latest/userguide/
