...
public class CreatePolicyRequestMarshaller implements
    ...
    public Request<CreatePolicyRequest> marshall(CreatePolicyRequest createPolicyRequest) {
        ...
        Request<CreatePolicyRequest> request = new DefaultRequest<CreatePolicyRequest>(
                createPolicyRequest, "AWSOrganizations");
        ...
        try {
            ...
            if (createPolicyRequest.getContent() != null) {
                String content = createPolicyRequest.getContent();
            ...
            if (createPolicyRequest.getName() != null) {
                String name = createPolicyRequest.getName();
                jsonWriter.name("Name");
                jsonWriter.value(name);
            }
            if (createPolicyRequest.getType() != null) {
                String type = createPolicyRequest.getType();
