...
public class DescribeCreateAccountStatusResult implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         A structure that contains the current status of an account
     *         creation request.
     *         </p>
     */
     ...
     *         chained together.
     */
    public DescribeCreateAccountStatusResult withCreateAccountStatus(
