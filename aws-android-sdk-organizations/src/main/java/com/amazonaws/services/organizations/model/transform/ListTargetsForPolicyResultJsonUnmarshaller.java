    ...
    public ListTargetsForPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Targets")) {
                listTargetsForPolicyResult.setTargets(new ListUnmarshaller<PolicyTargetSummary>(
                        PolicyTargetSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                listTargetsForPolicyResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
