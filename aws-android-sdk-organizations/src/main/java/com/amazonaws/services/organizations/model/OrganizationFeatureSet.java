...
public enum OrganizationFeatureSet {
    ...
    private static final Map<String, OrganizationFeatureSet> enumMap;
    static {
        enumMap = new HashMap<String, OrganizationFeatureSet>();
        enumMap.put("ALL", ALL);
        enumMap.put("CONSOLIDATED_BILLING", CONSOLIDATED_BILLING);
    }
