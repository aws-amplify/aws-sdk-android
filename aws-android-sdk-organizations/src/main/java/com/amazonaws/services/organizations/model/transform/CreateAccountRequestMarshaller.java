...
/**
 * JSON request marshaller for CreateAccountRequest
 */
    ...
    public Request<CreateAccountRequest> marshall(CreateAccountRequest createAccountRequest) {
        if (createAccountRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateAccountRequest)");
        }

        Request<CreateAccountRequest> request = new DefaultRequest<CreateAccountRequest>(
                createAccountRequest, "AWSOrganizations");
        ...
        try {
            ...
            if (createAccountRequest.getRoleName() != null) {
                String roleName = createAccountRequest.getRoleName();
                jsonWriter.name("RoleName");
                jsonWriter.value(roleName);
            }
            if (createAccountRequest.getIamUserAccessToBilling() != null) {
                String iamUserAccessToBilling = createAccountRequest.getIamUserAccessToBilling();
