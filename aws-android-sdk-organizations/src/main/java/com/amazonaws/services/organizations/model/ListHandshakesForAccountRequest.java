 ...
 * </p>
 */
public class ListHandshakesForAccountRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *         The default is all types. Use the <code>ActionType</code> element
     *         to limit the output to only a specified type, such as
     *         <code>INVITE</code>, <code>ENABLE_ALL_FEATURES</code>, or
     *         <code>APPROVE_ALL_FEATURES</code>. Alternatively, for the
     *         <code>ENABLE_ALL_FEATURES</code> handshake that generates a
     *         separate child handshake for each member account, you can specify
     *         <code>ParentHandshakeId</code> to see only the handshakes that
     *         were generated by that parent request.
     *         </p>
     */
