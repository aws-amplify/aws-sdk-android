...
/**
 * JSON unmarshaller for response ListPoliciesForTargetResult
 */
public class ListPoliciesForTargetResultJsonUnmarshaller implements
        Unmarshaller<ListPoliciesForTargetResult, JsonUnmarshallerContext> {
    ...
    public ListPoliciesForTargetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Policies")) {
                listPoliciesForTargetResult.setPolicies(new ListUnmarshaller<PolicySummary>(
                        PolicySummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                listPoliciesForTargetResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
