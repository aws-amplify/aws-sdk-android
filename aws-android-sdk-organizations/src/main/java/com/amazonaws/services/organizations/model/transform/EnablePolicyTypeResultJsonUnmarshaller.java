...
/**
 * JSON unmarshaller for response EnablePolicyTypeResult
 */
public class EnablePolicyTypeResultJsonUnmarshaller implements
        Unmarshaller<EnablePolicyTypeResult, JsonUnmarshallerContext> {
    ...
    public EnablePolicyTypeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Root")) {
                enablePolicyTypeResult.setRoot(RootJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
