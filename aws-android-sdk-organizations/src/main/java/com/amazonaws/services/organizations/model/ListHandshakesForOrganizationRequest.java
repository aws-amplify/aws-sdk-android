 ...
 * </p>
 */
public class ListHandshakesForOrganizationRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     * A filter of the handshakes that you want included in the response. The
     * default is all types. Use the <code>ActionType</code> element to limit
     * the output to only a specified type, such as <code>INVITE</code>,
     ...
     * specify the <code>ParentHandshakeId</code> to see only the handshakes
     ...
     *
     * @return <p>
     *         A filter of the handshakes that you want included in the
     *         response. The default is all types. Use the
     *         <code>ActionType</code> element to limit the output to only a
     *         specified type, such as <code>INVITE</code>,
     *         <code>ENABLE-ALL-FEATURES</code>, or
     *         <code>APPROVE-ALL-FEATURES</code>. Alternatively, for the
     *         <code>ENABLE-ALL-FEATURES</code> handshake that generates a
     *         separate child handshake for each member account, you can specify
     *         the <code>ParentHandshakeId</code> to see only the handshakes
     *         that were generated by that parent request.
     *         </p>
     */
     ...
     *            <code>APPROVE-ALL-FEATURES</code>. Alternatively, for the
     *            <code>ENABLE-ALL-FEATURES</code> handshake that generates a
     *            separate child handshake for each member account, you can
     *            specify the <code>ParentHandshakeId</code> to see only the
