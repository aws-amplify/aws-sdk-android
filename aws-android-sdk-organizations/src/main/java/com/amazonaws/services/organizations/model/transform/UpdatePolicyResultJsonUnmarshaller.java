...
/**
 * JSON unmarshaller for response UpdatePolicyResult
 */
public class UpdatePolicyResultJsonUnmarshaller implements
        Unmarshaller<UpdatePolicyResult, JsonUnmarshallerContext> {
    ...
    public UpdatePolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Policy")) {
                updatePolicyResult.setPolicy(PolicyJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
