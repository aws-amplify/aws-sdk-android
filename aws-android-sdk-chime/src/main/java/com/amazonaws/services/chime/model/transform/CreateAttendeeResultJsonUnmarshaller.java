...
/**
 * JSON unmarshaller for response CreateAttendeeResult
 */
public class CreateAttendeeResultJsonUnmarshaller implements
        Unmarshaller<CreateAttendeeResult, JsonUnmarshallerContext> {
    ...
    public CreateAttendeeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Attendee")) {
                createAttendeeResult.setAttendee(AttendeeJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
