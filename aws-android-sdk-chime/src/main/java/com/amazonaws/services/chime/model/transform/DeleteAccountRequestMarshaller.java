...
/**
 * JSON request marshaller for DeleteAccountRequest
 */
    ...
    public Request<DeleteAccountRequest> marshall(DeleteAccountRequest deleteAccountRequest) {
        if (deleteAccountRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteAccountRequest)");
        }

        Request<DeleteAccountRequest> request = new DefaultRequest<DeleteAccountRequest>(
                deleteAccountRequest, "AmazonChime");
        request.setHttpMethod(HttpMethodName.DELETE);

        String uriResourcePath = "/accounts/{accountId}";
        uriResourcePath = uriResourcePath.replace(
                "{accountId}",
                (deleteAccountRequest.getAccountId() == null) ? "" : StringUtils
                        .fromString(deleteAccountRequest.getAccountId()));
