...
/**
 * JSON unmarshaller for POJO Origination
 */
class OriginationJsonUnmarshaller implements Unmarshaller<Origination, JsonUnmarshallerContext> {
    ...
    public Origination unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Routes")) {
                origination.setRoutes(new ListUnmarshaller<OriginationRoute>(
                        OriginationRouteJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Disabled")) {
                origination.setDisabled(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
