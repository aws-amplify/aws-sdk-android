...
/**
 * JSON unmarshaller for response GetVoiceConnectorOriginationResult
 */
public class GetVoiceConnectorOriginationResultJsonUnmarshaller implements
        Unmarshaller<GetVoiceConnectorOriginationResult, JsonUnmarshallerContext> {

    public GetVoiceConnectorOriginationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Origination")) {
                getVoiceConnectorOriginationResult.setOrigination(OriginationJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
