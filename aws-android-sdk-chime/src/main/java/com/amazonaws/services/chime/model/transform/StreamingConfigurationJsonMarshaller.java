...
class StreamingConfigurationJsonMarshaller {
    ...
    public void marshall(StreamingConfiguration streamingConfiguration, AwsJsonWriter jsonWriter)
        ...
        if (streamingConfiguration.getStreamingNotificationTargets() != null) {
            java.util.List<StreamingNotificationTarget> streamingNotificationTargets = streamingConfiguration
                    .getStreamingNotificationTargets();
            jsonWriter.name("StreamingNotificationTargets");
            jsonWriter.beginArray();
            for (StreamingNotificationTarget streamingNotificationTargetsItem : streamingNotificationTargets) {
                if (streamingNotificationTargetsItem != null) {
                    StreamingNotificationTargetJsonMarshaller.getInstance().marshall(
                            streamingNotificationTargetsItem, jsonWriter);
                }
            }
            jsonWriter.endArray();
        }
