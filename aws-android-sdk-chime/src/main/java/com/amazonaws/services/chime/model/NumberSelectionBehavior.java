...
public enum NumberSelectionBehavior {
    ...
    private static final Map<String, NumberSelectionBehavior> enumMap;
    static {
        enumMap = new HashMap<String, NumberSelectionBehavior>();
        enumMap.put("PreferSticky", PreferSticky);
        enumMap.put("AvoidSticky", AvoidSticky);
    }
