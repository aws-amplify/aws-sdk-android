...
/**
 * JSON unmarshaller for POJO GeoMatchParams
 */
class GeoMatchParamsJsonUnmarshaller implements
        Unmarshaller<GeoMatchParams, JsonUnmarshallerContext> {
    ...
    public GeoMatchParams unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Country")) {
                geoMatchParams.setCountry(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("AreaCode")) {
                geoMatchParams.setAreaCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
