...
public class BatchSuspendUserResult implements Serializable {
    /**
     * <p>
     * If the <a>BatchSuspendUser</a> action fails for one or more of the user
     ...
     *
     * @return <p>
     *         If the <a>BatchSuspendUser</a> action fails for one or more of
