 ...
 * </p>
 */
public class PutVoiceConnectorTerminationCredentialsRequest extends AmazonWebServiceRequest
     ...
     *         chained together.
     */
    public PutVoiceConnectorTerminationCredentialsRequest withVoiceConnectorId(
    ...
    public PutVoiceConnectorTerminationCredentialsRequest withCredentials(Credential... credentials) {
        if (getCredentials() == null) {
            this.credentials = new java.util.ArrayList<Credential>(credentials.length);
        }
        for (Credential value : credentials) {
     ...
     *         chained together.
     */
    public PutVoiceConnectorTerminationCredentialsRequest withCredentials(
