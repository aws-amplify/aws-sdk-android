...
public class UpdateRoomRequestMarshaller implements
    ...
    public Request<UpdateRoomRequest> marshall(UpdateRoomRequest updateRoomRequest) {
        ...
        Request<UpdateRoomRequest> request = new DefaultRequest<UpdateRoomRequest>(
                updateRoomRequest, "AmazonChime");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/accounts/{accountId}/rooms/{roomId}";
        uriResourcePath = uriResourcePath.replace(
                "{accountId}",
                (updateRoomRequest.getAccountId() == null) ? "" : StringUtils
                        .fromString(updateRoomRequest.getAccountId()));
        uriResourcePath = uriResourcePath.replace(
                "{roomId}",
                (updateRoomRequest.getRoomId() == null) ? "" : StringUtils
                        .fromString(updateRoomRequest.getRoomId()));
        ...
        try {
            ...
            if (updateRoomRequest.getName() != null) {
                String name = updateRoomRequest.getName();
