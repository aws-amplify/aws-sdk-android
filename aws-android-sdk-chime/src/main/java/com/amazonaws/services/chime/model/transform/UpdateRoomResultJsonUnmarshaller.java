...
/**
 * JSON unmarshaller for response UpdateRoomResult
 */
public class UpdateRoomResultJsonUnmarshaller implements
        Unmarshaller<UpdateRoomResult, JsonUnmarshallerContext> {
    ...
    public UpdateRoomResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Room")) {
                updateRoomResult.setRoom(RoomJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
