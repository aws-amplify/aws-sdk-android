...
public class CreateUserRequestMarshaller implements
    ...
    public Request<CreateUserRequest> marshall(CreateUserRequest createUserRequest) {
        ...
        Request<CreateUserRequest> request = new DefaultRequest<CreateUserRequest>(
                createUserRequest, "AmazonChime");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/accounts/{accountId}/users?operation&#x3D;create";
        uriResourcePath = uriResourcePath.replace(
                "{accountId}",
                (createUserRequest.getAccountId() == null) ? "" : StringUtils
                        .fromString(createUserRequest.getAccountId()));
        ...
        try {
            ...
            if (createUserRequest.getUserType() != null) {
