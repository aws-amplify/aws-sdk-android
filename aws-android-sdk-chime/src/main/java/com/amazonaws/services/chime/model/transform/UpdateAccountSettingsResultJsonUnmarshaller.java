...
/**
 * JSON unmarshaller for response UpdateAccountSettingsResult
 */
public class UpdateAccountSettingsResultJsonUnmarshaller implements
        Unmarshaller<UpdateAccountSettingsResult, JsonUnmarshallerContext> {
