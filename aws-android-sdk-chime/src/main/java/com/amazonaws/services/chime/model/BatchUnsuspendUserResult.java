...
public class BatchUnsuspendUserResult implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         If the <a>BatchUnsuspendUser</a> action fails for one or more of
     *         the user IDs in the request, a list of the user IDs is returned,
     ...
     *
     * @param userErrors <p>
     *            If the <a>BatchUnsuspendUser</a> action fails for one or more
     *            of the user IDs in the request, a list of the user IDs is
