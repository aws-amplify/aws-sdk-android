...
/**
 * JSON unmarshaller for response CreateProxySessionResult
 */
public class CreateProxySessionResultJsonUnmarshaller implements
        Unmarshaller<CreateProxySessionResult, JsonUnmarshallerContext> {
    ...
    public CreateProxySessionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ProxySession")) {
                createProxySessionResult.setProxySession(ProxySessionJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
