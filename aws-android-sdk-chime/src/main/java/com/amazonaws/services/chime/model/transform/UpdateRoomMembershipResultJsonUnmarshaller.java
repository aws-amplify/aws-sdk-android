...
/**
 * JSON unmarshaller for response UpdateRoomMembershipResult
 */
public class UpdateRoomMembershipResultJsonUnmarshaller implements
        Unmarshaller<UpdateRoomMembershipResult, JsonUnmarshallerContext> {
    ...
    public UpdateRoomMembershipResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RoomMembership")) {
                updateRoomMembershipResult.setRoomMembership(RoomMembershipJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
