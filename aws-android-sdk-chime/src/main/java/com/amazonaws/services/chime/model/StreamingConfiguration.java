...
public class StreamingConfiguration implements Serializable {
     ...
     * </p>
     *
     * @param streamingNotificationTargets <p>
     *            The streaming notification targets.
     *            </p>
     */
    public void setStreamingNotificationTargets(
            java.util.Collection<StreamingNotificationTarget> streamingNotificationTargets) {
        if (streamingNotificationTargets == null) {
            this.streamingNotificationTargets = null;
            return;
        }

        this.streamingNotificationTargets = new java.util.ArrayList<StreamingNotificationTarget>(
     ...
     *         chained together.
     */
    public StreamingConfiguration withStreamingNotificationTargets(
            StreamingNotificationTarget... streamingNotificationTargets) {
        if (getStreamingNotificationTargets() == null) {
            this.streamingNotificationTargets = new java.util.ArrayList<StreamingNotificationTarget>(
                    streamingNotificationTargets.length);
        }
        for (StreamingNotificationTarget value : streamingNotificationTargets) {
            this.streamingNotificationTargets.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        if (getStreamingNotificationTargets() != null)
            sb.append("StreamingNotificationTargets: " + getStreamingNotificationTargets());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getStreamingNotificationTargets() == null) ? 0
                        : getStreamingNotificationTargets().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDisabled() != null && other.getDisabled().equals(this.getDisabled()) == false)
            return false;
        if (other.getStreamingNotificationTargets() == null
                ^ this.getStreamingNotificationTargets() == null)
            return false;
        if (other.getStreamingNotificationTargets() != null
                && other.getStreamingNotificationTargets().equals(
                        this.getStreamingNotificationTargets()) == false)
            return false;
        return true;
    }
}
