    ...
    public Member unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("MemberId")) {
                member.setMemberId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("MemberType")) {
                member.setMemberType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Email")) {
                member.setEmail(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("FullName")) {
                member.setFullName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
