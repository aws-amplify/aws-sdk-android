...
/**
 * JSON unmarshaller for response UpdateBotResult
 */
public class UpdateBotResultJsonUnmarshaller implements
        Unmarshaller<UpdateBotResult, JsonUnmarshallerContext> {
    ...
    public UpdateBotResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Bot")) {
                updateBotResult.setBot(BotJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
