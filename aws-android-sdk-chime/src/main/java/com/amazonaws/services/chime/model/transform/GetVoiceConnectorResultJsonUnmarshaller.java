...
/**
 * JSON unmarshaller for response GetVoiceConnectorResult
 */
public class GetVoiceConnectorResultJsonUnmarshaller implements
        Unmarshaller<GetVoiceConnectorResult, JsonUnmarshallerContext> {
    ...
    public GetVoiceConnectorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("VoiceConnector")) {
                getVoiceConnectorResult.setVoiceConnector(VoiceConnectorJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
