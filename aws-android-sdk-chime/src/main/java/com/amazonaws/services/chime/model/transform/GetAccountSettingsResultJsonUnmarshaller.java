...
/**
 * JSON unmarshaller for response GetAccountSettingsResult
 */
public class GetAccountSettingsResultJsonUnmarshaller implements
        Unmarshaller<GetAccountSettingsResult, JsonUnmarshallerContext> {
    ...
    public GetAccountSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AccountSettings")) {
                getAccountSettingsResult.setAccountSettings(AccountSettingsJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
