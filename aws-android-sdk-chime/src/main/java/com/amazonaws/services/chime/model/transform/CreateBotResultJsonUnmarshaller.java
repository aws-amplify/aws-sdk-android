...
/**
 * JSON unmarshaller for response CreateBotResult
 */
public class CreateBotResultJsonUnmarshaller implements
        Unmarshaller<CreateBotResult, JsonUnmarshallerContext> {
    ...
    public CreateBotResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Bot")) {
                createBotResult.setBot(BotJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
