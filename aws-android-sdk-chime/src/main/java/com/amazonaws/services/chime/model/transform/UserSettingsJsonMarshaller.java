...
class UserSettingsJsonMarshaller {
    ...
    public void marshall(UserSettings userSettings, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (userSettings.getTelephony() != null) {
            TelephonySettings telephony = userSettings.getTelephony();
            jsonWriter.name("Telephony");
            TelephonySettingsJsonMarshaller.getInstance().marshall(telephony, jsonWriter);
        }
