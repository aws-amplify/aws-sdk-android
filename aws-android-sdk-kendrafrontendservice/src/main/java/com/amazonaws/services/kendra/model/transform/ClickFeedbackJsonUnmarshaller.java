...
/**
 * JSON unmarshaller for POJO ClickFeedback
 */
class ClickFeedbackJsonUnmarshaller implements Unmarshaller<ClickFeedback, JsonUnmarshallerContext> {
    ...
    public ClickFeedback unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ResultId")) {
                clickFeedback.setResultId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ClickTime")) {
                clickFeedback.setClickTime(DateJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
