 ...
 * </p>
 */
public class ListFaqsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         If the result of the previous request to <code>ListFaqs</code>
     *         was truncated, include the <code>NextToken</code> to fetch the
     *         next set of FAQs.
     *         </p>
     */
     ...
     *
     * @return <p>
     *         The maximum number of FAQs to return in the response. If there
