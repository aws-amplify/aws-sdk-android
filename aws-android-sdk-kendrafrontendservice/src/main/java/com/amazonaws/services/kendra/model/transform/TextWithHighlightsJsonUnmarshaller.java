...
/**
 * JSON unmarshaller for POJO TextWithHighlights
 */
class TextWithHighlightsJsonUnmarshaller implements
        Unmarshaller<TextWithHighlights, JsonUnmarshallerContext> {
    ...
    public TextWithHighlights unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Text")) {
                textWithHighlights.setText(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Highlights")) {
                textWithHighlights.setHighlights(new ListUnmarshaller<Highlight>(
                        HighlightJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
