...
/**
 * StAX unmarshaller for response DescribeAdjustmentTypesResult
 */
public class DescribeAdjustmentTypesResultStaxUnmarshaller implements
        Unmarshaller<DescribeAdjustmentTypesResult, StaxUnmarshallerContext> {

    public DescribeAdjustmentTypesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
