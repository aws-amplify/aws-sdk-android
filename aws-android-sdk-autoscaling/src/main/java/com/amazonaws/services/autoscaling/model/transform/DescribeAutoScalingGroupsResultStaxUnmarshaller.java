...
/**
 * StAX unmarshaller for response DescribeAutoScalingGroupsResult
 */
public class DescribeAutoScalingGroupsResultStaxUnmarshaller implements
    ...
    public DescribeAutoScalingGroupsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    describeAutoScalingGroupsResult.setNextToken(StringStaxUnmarshaller
