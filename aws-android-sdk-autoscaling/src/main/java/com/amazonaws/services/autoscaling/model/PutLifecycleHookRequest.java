...
public class PutLifecycleHookRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <p>The notification messages sent to the target include the following
     * information: <ul> <li><b>AutoScalingGroupName</b>. The name of the
     * Auto Scaling group.</li> <li><b>AccountId</b>. The AWS account
     ...
     * <li><b>NotificationMetadata</b>. User-defined information.</li> </ul>
     ...
     * notifications to an Amazon SNS topic. <p>When you specify a
     * notification target, Auto Scaling sends it a test message. Test
     * messages contains the following additional key/value pair:
     ...
     * timing out by calling <a>RecordLifecycleActionHeartbeat</a>. The
     ...
     * This parameter can be either <code>CONTINUE</code> or
