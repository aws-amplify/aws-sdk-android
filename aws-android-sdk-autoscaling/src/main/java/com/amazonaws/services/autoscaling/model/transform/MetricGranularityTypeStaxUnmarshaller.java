...
/**
 * StAX unmarshaller for model MetricGranularityType
 */
class MetricGranularityTypeStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Granularity", targetDepth)) {
                    metricGranularityType.setGranularity(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
