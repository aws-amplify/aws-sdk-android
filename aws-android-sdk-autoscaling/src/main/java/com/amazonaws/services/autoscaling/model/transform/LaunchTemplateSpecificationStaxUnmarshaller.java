...
/**
 * StAX unmarshaller for model LaunchTemplateSpecification
 */
class LaunchTemplateSpecificationStaxUnmarshaller implements
        Unmarshaller<LaunchTemplateSpecification, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("LaunchTemplateId", targetDepth)) {
                    launchTemplateSpecification.setLaunchTemplateId(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("LaunchTemplateName", targetDepth)) {
                    launchTemplateSpecification.setLaunchTemplateName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Version", targetDepth)) {
                    launchTemplateSpecification.setVersion(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
