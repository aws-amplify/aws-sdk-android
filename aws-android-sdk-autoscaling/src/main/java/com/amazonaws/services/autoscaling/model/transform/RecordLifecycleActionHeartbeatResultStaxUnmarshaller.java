...
/**
 * StAX unmarshaller for response RecordLifecycleActionHeartbeatResult
 */
public class RecordLifecycleActionHeartbeatResultStaxUnmarshaller implements
        Unmarshaller<RecordLifecycleActionHeartbeatResult, StaxUnmarshallerContext> {

    public RecordLifecycleActionHeartbeatResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
