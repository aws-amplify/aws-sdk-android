...
/**
 * StAX marshaller for POJO ProcessType
 */
class ProcessTypeStaxMarshaller {

    public void marshall(ProcessType _processType, Request<?> request, String _prefix) {
        String prefix;
        if (_processType.getProcessName() != null) {
            prefix = _prefix + "ProcessName";
            String processName = _processType.getProcessName();
