...
/**
 * StAX unmarshaller for response DescribeAutoScalingNotificationTypesResult
 */
public class DescribeAutoScalingNotificationTypesResultStaxUnmarshaller implements
    ...
    public DescribeAutoScalingNotificationTypesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
