...
/**
 * StAX unmarshaller for model TagDescription
 */
class TagDescriptionStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ResourceId", targetDepth)) {
                    tagDescription.setResourceId(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("ResourceType", targetDepth)) {
                    tagDescription.setResourceType(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                ...
                if (context.testExpression("PropagateAtLaunch", targetDepth)) {
                    tagDescription.setPropagateAtLaunch(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
