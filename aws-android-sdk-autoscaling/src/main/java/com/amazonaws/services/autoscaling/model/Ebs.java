...
public class Ebs implements Serializable {
     ...
     * <code>VolumeSize</code>, the volume size must be equal or greater than
     ...
     * Amazon EC2 Auto Scaling, the default value is <code>true</code>.
     * </p>
     */
     ...
     * >Supported Instance Types</a>. If your AMI uses encrypted volumes, you
     ...
     * >encryption by default</a> results in all EBS volumes being encrypted
     * with the AWS managed CMK or a customer managed CMK, whether or not the
     ...
     * >Using Encryption with EBS-Backed AMIs</a> in the <i>Amazon EC2 User
     * Guide for Linux Instances</i> and <a href=
     * "https://docs.aws.amazon.com/autoscaling/ec2/userguide/key-policy-requirements-EBS-encryption.html"
     * >Required CMK Key Policy for Use with Encrypted Volumes</a> in the
     ...
     *         </p>
     *         <p>
     *         This can be a number from 1-1,024 for <code>standard</code>,
     *         4-16,384 for <code>io1</code>, 1-16,384 for <code>gp2</code>, and
     ...
     *         <p>
     *         You must specify either a <code>VolumeSize</code> or a
     *         <code>SnapshotId</code>. If you specify both
     ...
     *            <p>
     *            This can be a number from 1-1,024 for <code>standard</code>,
     *            4-16,384 for <code>io1</code>, 1-16,384 for <code>gp2</code>,
     *            and 500-16,384 for <code>st1</code> and <code>sc1</code>. If
     *            you specify a snapshot, the volume size must be equal to or
     ...
     *            You must specify either a <code>VolumeSize</code> or a
     *            <code>SnapshotId</code>. If you specify both
     *            <code>SnapshotId</code> and <code>VolumeSize</code>, the
     *            volume size must be equal or greater than the size of the
     *            snapshot.
     *            </p>
     */
     ...
     *            termination. For Amazon EC2 Auto Scaling, the default value is
     *            <code>true</code>.
     *            </p>
     */
     ...
     *         the volume. The maximum ratio of IOPS to volume size (in GiB) is
     *         50:1. For more information, see <a href=
     *         "https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html"
     *         >Amazon EBS Volume Types</a> in the <i>Amazon EC2 User Guide for
     *         Linux Instances</i>.
     *         </p>
     ...
     *            for the volume. The maximum ratio of IOPS to volume size (in
     *            GiB) is 50:1. For more information, see <a href=
     *            "https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html"
     *            >Amazon EBS Volume Types</a> in the <i>Amazon EC2 User Guide
     *            for Linux Instances</i>.
     *            </p>
     ...
     *         "https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html#EBSEncryption_supported_instances"
     *         >Supported Instance Types</a>. If your AMI uses encrypted
     *         volumes, you can also only launch it on supported instance types.
     *         </p>
     *         <note>
     *         <p>
     *         If you are creating a volume from a snapshot, you cannot specify
     *         an encryption value. Volumes that are created from encrypted
     *         snapshots are automatically encrypted, and volumes that are
     *         created from unencrypted snapshots are automatically unencrypted.
     *         By default, encrypted snapshots use the AWS managed CMK that is
     *         used for EBS encryption, but you can specify a custom CMK when
     *         you create the snapshot. The ability to encrypt a snapshot during
     *         copying also allows you to apply a new CMK to an
     *         already-encrypted snapshot. Volumes restored from the resulting
     *         copy are only accessible using the new CMK.
     *         </p>
     *         <p>
     *         Enabling <a href=
     *         "https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html#encryption-by-default"
     *         >encryption by default</a> results in all EBS volumes being
     ...
     *         For more information, see <a href=
     *         "https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/AMIEncryption.html"
     *         >Using Encryption with EBS-Backed AMIs</a> in the <i>Amazon EC2
     *         User Guide for Linux Instances</i> and <a href=
     *         "https://docs.aws.amazon.com/autoscaling/ec2/userguide/key-policy-requirements-EBS-encryption.html"
     *         >Required CMK Key Policy for Use with Encrypted Volumes</a> in
     ...
     *            EBS volumes can only be attached to instances that support
     *            Amazon EBS encryption. For more information, see <a href=
     *            "https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html#EBSEncryption_supported_instances"
     *            >Supported Instance Types</a>. If your AMI uses encrypted
     *            volumes, you can also only launch it on supported instance
     *            types.
     *            </p>
     *            <note>
     *            <p>
     *            If you are creating a volume from a snapshot, you cannot
     *            specify an encryption value. Volumes that are created from
     *            encrypted snapshots are automatically encrypted, and volumes
     *            that are created from unencrypted snapshots are automatically
     *            unencrypted. By default, encrypted snapshots use the AWS
     *            managed CMK that is used for EBS encryption, but you can
     *            specify a custom CMK when you create the snapshot. The ability
     *            to encrypt a snapshot during copying also allows you to apply
     *            a new CMK to an already-encrypted snapshot. Volumes restored
     ...
     *            For more information, see <a href=
     *            "https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/AMIEncryption.html"
     *            >Using Encryption with EBS-Backed AMIs</a> in the <i>Amazon
     *            EC2 User Guide for Linux Instances</i> and <a href=
     *            "https://docs.aws.amazon.com/autoscaling/ec2/userguide/key-policy-requirements-EBS-encryption.html"
     *            >Required CMK Key Policy for Use with Encrypted Volumes</a> in
     *            the <i>Amazon EC2 Auto Scaling User Guide</i>.
     *            </p>
