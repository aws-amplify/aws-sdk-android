...
/**
 * StAX unmarshaller for model StepAdjustment
 */
class StepAdjustmentStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("MetricIntervalLowerBound", targetDepth)) {
                    stepAdjustment.setMetricIntervalLowerBound(DoubleStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("MetricIntervalUpperBound", targetDepth)) {
                    stepAdjustment.setMetricIntervalUpperBound(DoubleStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ScalingAdjustment", targetDepth)) {
                    stepAdjustment.setScalingAdjustment(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
