...
/**
 * StAX unmarshaller for model LaunchTemplate
 */
class LaunchTemplateStaxUnmarshaller implements
        Unmarshaller<LaunchTemplate, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("LaunchTemplateSpecification", targetDepth)) {
                    launchTemplate
                            .setLaunchTemplateSpecification(LaunchTemplateSpecificationStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Overrides/member", targetDepth)) {
                    launchTemplate.withOverrides(LaunchTemplateOverridesStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
