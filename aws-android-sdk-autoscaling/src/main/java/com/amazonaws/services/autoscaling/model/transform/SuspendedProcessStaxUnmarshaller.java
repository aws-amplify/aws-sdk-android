...
/**
 * StAX unmarshaller for model SuspendedProcess
 */
class SuspendedProcessStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ProcessName", targetDepth)) {
                    suspendedProcess.setProcessName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("SuspensionReason", targetDepth)) {
                    suspendedProcess.setSuspensionReason(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
