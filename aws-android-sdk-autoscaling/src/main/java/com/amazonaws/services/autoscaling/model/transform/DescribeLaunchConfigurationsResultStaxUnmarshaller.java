...
/**
 * StAX unmarshaller for response DescribeLaunchConfigurationsResult
 */
public class DescribeLaunchConfigurationsResultStaxUnmarshaller implements
        Unmarshaller<DescribeLaunchConfigurationsResult, StaxUnmarshallerContext> {

    public DescribeLaunchConfigurationsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    describeLaunchConfigurationsResult.setNextToken(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
