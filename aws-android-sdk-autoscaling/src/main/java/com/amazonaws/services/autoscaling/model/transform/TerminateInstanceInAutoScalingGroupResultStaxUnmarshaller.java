...
/**
 * StAX unmarshaller for response TerminateInstanceInAutoScalingGroupResult
 */
public class TerminateInstanceInAutoScalingGroupResultStaxUnmarshaller implements
    ...
    public TerminateInstanceInAutoScalingGroupResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Activity", targetDepth)) {
                    terminateInstanceInAutoScalingGroupResult.setActivity(ActivityStaxUnmarshaller
