...
/**
 * StAX unmarshaller for model InstancesDistribution
 */
class InstancesDistributionStaxUnmarshaller implements
        Unmarshaller<InstancesDistribution, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("OnDemandAllocationStrategy", targetDepth)) {
                    instancesDistribution.setOnDemandAllocationStrategy(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("OnDemandBaseCapacity", targetDepth)) {
                    instancesDistribution.setOnDemandBaseCapacity(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("OnDemandPercentageAboveBaseCapacity", targetDepth)) {
                    instancesDistribution
                            .setOnDemandPercentageAboveBaseCapacity(IntegerStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("SpotAllocationStrategy", targetDepth)) {
                    instancesDistribution.setSpotAllocationStrategy(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("SpotInstancePools", targetDepth)) {
                    instancesDistribution.setSpotInstancePools(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("SpotMaxPrice", targetDepth)) {
                    instancesDistribution.setSpotMaxPrice(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
