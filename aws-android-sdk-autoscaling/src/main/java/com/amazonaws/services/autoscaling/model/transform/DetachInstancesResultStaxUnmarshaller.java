...
/**
 * StAX unmarshaller for response DetachInstancesResult
 */
public class DetachInstancesResultStaxUnmarshaller implements
        Unmarshaller<DetachInstancesResult, StaxUnmarshallerContext> {
