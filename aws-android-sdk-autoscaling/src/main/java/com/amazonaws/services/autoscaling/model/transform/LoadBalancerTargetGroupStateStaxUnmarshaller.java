...
/**
 * StAX unmarshaller for model LoadBalancerTargetGroupState
 */
class LoadBalancerTargetGroupStateStaxUnmarshaller implements
        Unmarshaller<LoadBalancerTargetGroupState, StaxUnmarshallerContext> {

    public LoadBalancerTargetGroupState unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("LoadBalancerTargetGroupARN", targetDepth)) {
                    loadBalancerTargetGroupState
                            .setLoadBalancerTargetGroupARN(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("State", targetDepth)) {
                    loadBalancerTargetGroupState.setState(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
