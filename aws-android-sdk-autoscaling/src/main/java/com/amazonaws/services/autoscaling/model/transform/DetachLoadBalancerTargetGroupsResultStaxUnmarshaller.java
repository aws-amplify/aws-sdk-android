...
/**
 * StAX unmarshaller for response DetachLoadBalancerTargetGroupsResult
 */
public class DetachLoadBalancerTargetGroupsResultStaxUnmarshaller implements
        Unmarshaller<DetachLoadBalancerTargetGroupsResult, StaxUnmarshallerContext> {

    public DetachLoadBalancerTargetGroupsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
