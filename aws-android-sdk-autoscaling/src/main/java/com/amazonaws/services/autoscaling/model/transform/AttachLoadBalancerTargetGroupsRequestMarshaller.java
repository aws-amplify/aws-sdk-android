...
/**
 * Attach Load Balancer Target Groups Request Marshaller
 */
public class AttachLoadBalancerTargetGroupsRequestMarshaller implements Marshaller<Request<AttachLoadBalancerTargetGroupsRequest>, AttachLoadBalancerTargetGroupsRequest> {
    ...
    public Request<AttachLoadBalancerTargetGroupsRequest> marshall(AttachLoadBalancerTargetGroupsRequest attachLoadBalancerTargetGroupsRequest) {
        ...
        Request<AttachLoadBalancerTargetGroupsRequest> request = new DefaultRequest<AttachLoadBalancerTargetGroupsRequest>(attachLoadBalancerTargetGroupsRequest, "AmazonAutoScaling");
        ...
        java.util.List<String> targetGroupARNsList = attachLoadBalancerTargetGroupsRequest.getTargetGroupARNs();
