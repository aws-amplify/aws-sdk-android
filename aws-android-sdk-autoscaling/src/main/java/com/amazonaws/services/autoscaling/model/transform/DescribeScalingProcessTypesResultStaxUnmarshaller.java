...
/**
 * StAX unmarshaller for response DescribeScalingProcessTypesResult
 */
public class DescribeScalingProcessTypesResultStaxUnmarshaller implements
        Unmarshaller<DescribeScalingProcessTypesResult, StaxUnmarshallerContext> {

    public DescribeScalingProcessTypesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
