...
public class CreateLaunchConfigurationRequestMarshaller implements
    ...
    public Request<CreateLaunchConfigurationRequest> marshall(
        ...
        if (createLaunchConfigurationRequest.getMetadataOptions() != null) {
            prefix = "MetadataOptions";
            InstanceMetadataOptions metadataOptions = createLaunchConfigurationRequest
                    .getMetadataOptions();
