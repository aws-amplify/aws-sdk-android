...
/**
 * StAX unmarshaller for response DescribeScalingActivitiesResult
 */
public class DescribeScalingActivitiesResultStaxUnmarshaller implements
    ...
    public DescribeScalingActivitiesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    describeScalingActivitiesResult.setNextToken(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
