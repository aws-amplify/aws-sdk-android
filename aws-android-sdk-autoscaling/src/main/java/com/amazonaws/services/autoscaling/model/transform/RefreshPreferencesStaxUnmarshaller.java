...
/**
 * StAX unmarshaller for model RefreshPreferences
 */
class RefreshPreferencesStaxUnmarshaller implements
        Unmarshaller<RefreshPreferences, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("MinHealthyPercentage", targetDepth)) {
                    refreshPreferences.setMinHealthyPercentage(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("InstanceWarmup", targetDepth)) {
                    refreshPreferences.setInstanceWarmup(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
