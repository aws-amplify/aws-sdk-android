...
/**
 * StAX unmarshaller for response DescribeNotificationConfigurationsResult
 */
public class DescribeNotificationConfigurationsResultStaxUnmarshaller implements
    ...
    public DescribeNotificationConfigurationsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    describeNotificationConfigurationsResult.setNextToken(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
