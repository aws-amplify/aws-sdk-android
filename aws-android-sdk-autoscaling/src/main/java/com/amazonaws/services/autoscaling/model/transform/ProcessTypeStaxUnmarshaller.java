...
/**
 * StAX unmarshaller for model ProcessType
 */
class ProcessTypeStaxUnmarshaller implements Unmarshaller<ProcessType, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ProcessName", targetDepth)) {
                    processType.setProcessName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
