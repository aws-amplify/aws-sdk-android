...
/**
 * StAX unmarshaller for model TargetTrackingConfiguration
 */
class TargetTrackingConfigurationStaxUnmarshaller implements
        Unmarshaller<TargetTrackingConfiguration, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PredefinedMetricSpecification", targetDepth)) {
                    targetTrackingConfiguration
                            .setPredefinedMetricSpecification(PredefinedMetricSpecificationStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("CustomizedMetricSpecification", targetDepth)) {
                    targetTrackingConfiguration
                            .setCustomizedMetricSpecification(CustomizedMetricSpecificationStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("TargetValue", targetDepth)) {
                    targetTrackingConfiguration.setTargetValue(DoubleStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("DisableScaleIn", targetDepth)) {
                    targetTrackingConfiguration.setDisableScaleIn(BooleanStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
