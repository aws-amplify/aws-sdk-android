...
/**
 * StAX unmarshaller for response EnterStandbyResult
 */
public class EnterStandbyResultStaxUnmarshaller implements
        Unmarshaller<EnterStandbyResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Activities/member", targetDepth)) {
                    enterStandbyResult.withActivities(ActivityStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
