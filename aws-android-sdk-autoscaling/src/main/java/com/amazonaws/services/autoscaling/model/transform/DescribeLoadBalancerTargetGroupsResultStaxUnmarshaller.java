...
/**
 * StAX unmarshaller for response DescribeLoadBalancerTargetGroupsResult
 */
public class DescribeLoadBalancerTargetGroupsResultStaxUnmarshaller implements
        Unmarshaller<DescribeLoadBalancerTargetGroupsResult, StaxUnmarshallerContext> {

    public DescribeLoadBalancerTargetGroupsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("LoadBalancerTargetGroups/member", targetDepth)) {
                    describeLoadBalancerTargetGroupsResult
                            .withLoadBalancerTargetGroups(LoadBalancerTargetGroupStateStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    describeLoadBalancerTargetGroupsResult.setNextToken(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
