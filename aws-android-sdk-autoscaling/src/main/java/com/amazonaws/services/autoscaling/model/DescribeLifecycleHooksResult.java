...
public class DescribeLifecycleHooksResult implements Serializable {
     ...
     * </p>
     */
    private java.util.List<LifecycleHook> lifecycleHooks = new java.util.ArrayList<LifecycleHook>();
    ...
    public void setLifecycleHooks(java.util.Collection<LifecycleHook> lifecycleHooks) {
        ...
        this.lifecycleHooks = new java.util.ArrayList<LifecycleHook>(lifecycleHooks);
    }
    ...
    public DescribeLifecycleHooksResult withLifecycleHooks(LifecycleHook... lifecycleHooks) {
        if (getLifecycleHooks() == null) {
            this.lifecycleHooks = new java.util.ArrayList<LifecycleHook>(lifecycleHooks.length);
        }
        for (LifecycleHook value : lifecycleHooks) {
            this.lifecycleHooks.add(value);
        }
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getLifecycleHooks() == null) ? 0 : getLifecycleHooks().hashCode());
        return hashCode;
    }
