...
/**
 * StAX unmarshaller for model LoadBalancerState
 */
class LoadBalancerStateStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("LoadBalancerName", targetDepth)) {
                    loadBalancerState.setLoadBalancerName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("State", targetDepth)) {
                    loadBalancerState.setState(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
