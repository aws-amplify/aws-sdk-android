...
/**
 * StAX unmarshaller for response ExitStandbyResult
 */
public class ExitStandbyResultStaxUnmarshaller implements
        Unmarshaller<ExitStandbyResult, StaxUnmarshallerContext> {
