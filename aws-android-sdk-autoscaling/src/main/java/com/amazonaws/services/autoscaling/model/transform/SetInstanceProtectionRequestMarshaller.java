...
/**
 * Set Instance Protection Request Marshaller
 */
public class SetInstanceProtectionRequestMarshaller implements Marshaller<Request<SetInstanceProtectionRequest>, SetInstanceProtectionRequest> {
    ...
    public Request<SetInstanceProtectionRequest> marshall(SetInstanceProtectionRequest setInstanceProtectionRequest) {
        ...
        java.util.List<String> instanceIdsList = setInstanceProtectionRequest.getInstanceIds();
        ...
        if (setInstanceProtectionRequest.isProtectedFromScaleIn() != null) {
            request.addParameter("ProtectedFromScaleIn", StringUtils.fromBoolean(setInstanceProtectionRequest.isProtectedFromScaleIn()));
        }
