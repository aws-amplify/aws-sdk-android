...
public enum MetricType {
    ...
    static {
        ...
        enumMap.put("ASGAverageCPUUtilization", ASGAverageCPUUtilization);
        enumMap.put("ASGAverageNetworkIn", ASGAverageNetworkIn);
        enumMap.put("ASGAverageNetworkOut", ASGAverageNetworkOut);
