...
public class AmazonAutoScalingClient extends AmazonWebServiceClient implements AmazonAutoScaling {
     ...
     * @return cancelInstanceRefreshResult The response from the
     ...
     *             request, or a server side issue.
     */
    public CancelInstanceRefreshResult cancelInstanceRefresh(
        ...
        try {
            request = new CancelInstanceRefreshRequestMarshaller()
                    .marshall(cancelInstanceRefreshRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new CancelInstanceRefreshResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     * @return describeInstanceRefreshesResult The response from the
     ...
     *             request, or a server side issue.
     */
    public DescribeInstanceRefreshesResult describeInstanceRefreshes(
        ...
        try {
            request = new DescribeInstanceRefreshesRequestMarshaller()
                    .marshall(describeInstanceRefreshesRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new DescribeInstanceRefreshesResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
     ...
     * @return startInstanceRefreshResult The response from the
    ...
    public StartInstanceRefreshResult startInstanceRefresh(
        ...
        try {
            request = new StartInstanceRefreshRequestMarshaller()
                    .marshall(startInstanceRefreshRequest);
            // Binds the request metrics to the current request.
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new StartInstanceRefreshResultStaxUnmarshaller(),
                    executionContext);
            return response.getAwsResponse();
        } finally {
            awsRequestMetrics.endEvent(Field.ClientExecuteTime);
