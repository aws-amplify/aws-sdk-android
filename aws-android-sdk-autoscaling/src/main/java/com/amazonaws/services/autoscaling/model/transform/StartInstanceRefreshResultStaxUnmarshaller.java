...
/**
 * StAX unmarshaller for response StartInstanceRefreshResult
 */
public class StartInstanceRefreshResultStaxUnmarshaller implements
        Unmarshaller<StartInstanceRefreshResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("InstanceRefreshId", targetDepth)) {
                    startInstanceRefreshResult.setInstanceRefreshId(StringStaxUnmarshaller
