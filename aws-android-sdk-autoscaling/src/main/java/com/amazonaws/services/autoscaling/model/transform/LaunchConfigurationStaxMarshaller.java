...
class LaunchConfigurationStaxMarshaller {
    ...
    public void marshall(LaunchConfiguration _launchConfiguration, Request<?> request,
        ...
        if (_launchConfiguration.getMetadataOptions() != null) {
            prefix = _prefix + "MetadataOptions";
            InstanceMetadataOptions metadataOptions = _launchConfiguration.getMetadataOptions();
            InstanceMetadataOptionsStaxMarshaller.getInstance().marshall(metadataOptions, request,
                    prefix + ".");
        }
    }
