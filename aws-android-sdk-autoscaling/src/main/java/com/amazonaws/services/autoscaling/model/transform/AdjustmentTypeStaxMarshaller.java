...
/**
 * StAX marshaller for POJO AdjustmentType
 */
class AdjustmentTypeStaxMarshaller {

    public void marshall(AdjustmentType _adjustmentType, Request<?> request, String _prefix) {
        String prefix;
        if (_adjustmentType.getAdjustmentType() != null) {
            prefix = _prefix + "AdjustmentType";
            String adjustmentType = _adjustmentType.getAdjustmentType();
