...
/**
 * StAX unmarshaller for response AttachLoadBalancerTargetGroupsResult
 */
public class AttachLoadBalancerTargetGroupsResultStaxUnmarshaller implements
        Unmarshaller<AttachLoadBalancerTargetGroupsResult, StaxUnmarshallerContext> {

    public AttachLoadBalancerTargetGroupsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
