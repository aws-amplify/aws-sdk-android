...
/**
 * Put Record Batch Result JSON Unmarshaller
 */
public class PutRecordBatchResultJsonUnmarshaller implements Unmarshaller<PutRecordBatchResult, JsonUnmarshallerContext> {
    ...
    public PutRecordBatchResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("FailedPutCount")) {
                putRecordBatchResult.setFailedPutCount(IntegerJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("RequestResponses")) {
                putRecordBatchResult.setRequestResponses(new ListUnmarshaller<PutRecordBatchResponseEntry>(PutRecordBatchResponseEntryJsonUnmarshaller.getInstance()).unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static PutRecordBatchResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new PutRecordBatchResultJsonUnmarshaller();
        return instance;
    }
}
