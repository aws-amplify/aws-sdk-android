...
public class PutRecordBatchResponseEntry implements Serializable {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getRecordId() != null) sb.append("RecordId: " + getRecordId() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutRecordBatchResponseEntry == false) return false;
        ...
        if (other.getRecordId() != null && other.getRecordId().equals(this.getRecordId()) == false) return false; 
