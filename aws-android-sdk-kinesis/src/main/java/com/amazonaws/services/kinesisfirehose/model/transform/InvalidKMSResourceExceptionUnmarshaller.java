...
public class InvalidKMSResourceExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InvalidKMSResourceException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        InvalidKMSResourceException e = (InvalidKMSResourceException) super.unmarshall(error);
        e.setErrorCode("InvalidKMSResourceException");
