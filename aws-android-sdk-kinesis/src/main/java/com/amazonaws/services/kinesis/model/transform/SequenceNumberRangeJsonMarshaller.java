...
/**
 * JSON marshaller for POJO SequenceNumberRange
 */
class SequenceNumberRangeJsonMarshaller {

    public void marshall(SequenceNumberRange sequenceNumberRange, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (sequenceNumberRange.getEndingSequenceNumber() != null) {
            ...
            jsonWriter.name("EndingSequenceNumber");
            jsonWriter.value(endingSequenceNumber);
        }
