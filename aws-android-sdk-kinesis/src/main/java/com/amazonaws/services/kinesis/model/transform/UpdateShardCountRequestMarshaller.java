...
/**
 * JSON request marshaller for UpdateShardCountRequest
 */
public class UpdateShardCountRequestMarshaller implements
        Marshaller<Request<UpdateShardCountRequest>, UpdateShardCountRequest> {
    ...
    public Request<UpdateShardCountRequest> marshall(UpdateShardCountRequest updateShardCountRequest) {
        if (updateShardCountRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateShardCountRequest)");
        }

        Request<UpdateShardCountRequest> request = new DefaultRequest<UpdateShardCountRequest>(
                updateShardCountRequest, "AmazonKinesis");
