...
/**
 * JSON unmarshaller for POJO SequenceNumberRange
 */
class SequenceNumberRangeJsonUnmarshaller implements
    ...
    public SequenceNumberRange unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("StartingSequenceNumber")) {
                sequenceNumberRange.setStartingSequenceNumber(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("EndingSequenceNumber")) {
                sequenceNumberRange.setEndingSequenceNumber(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
