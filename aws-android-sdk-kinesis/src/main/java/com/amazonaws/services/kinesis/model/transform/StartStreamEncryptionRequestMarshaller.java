...
/**
 * JSON request marshaller for StartStreamEncryptionRequest
 */
public class StartStreamEncryptionRequestMarshaller implements
        Marshaller<Request<StartStreamEncryptionRequest>, StartStreamEncryptionRequest> {

    public Request<StartStreamEncryptionRequest> marshall(
            StartStreamEncryptionRequest startStreamEncryptionRequest) {
        if (startStreamEncryptionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(StartStreamEncryptionRequest)");
        }

        Request<StartStreamEncryptionRequest> request = new DefaultRequest<StartStreamEncryptionRequest>(
                startStreamEncryptionRequest, "AmazonKinesis");
