...
/**
 * JSON request marshaller for ListShardsRequest
 */
public class ListShardsRequestMarshaller implements
        Marshaller<Request<ListShardsRequest>, ListShardsRequest> {

    public Request<ListShardsRequest> marshall(ListShardsRequest listShardsRequest) {
        if (listShardsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListShardsRequest)");
        }

        Request<ListShardsRequest> request = new DefaultRequest<ListShardsRequest>(
                listShardsRequest, "AmazonKinesis");
        ...
        try {
            ...
            if (listShardsRequest.getStreamCreationTimestamp() != null) {
                java.util.Date streamCreationTimestamp = listShardsRequest
