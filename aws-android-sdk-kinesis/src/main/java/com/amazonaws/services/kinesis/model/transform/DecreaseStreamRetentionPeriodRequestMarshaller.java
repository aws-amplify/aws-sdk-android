...
/**
 * JSON request marshaller for DecreaseStreamRetentionPeriodRequest
 */
    ...
    public Request<DecreaseStreamRetentionPeriodRequest> marshall(
        ...
        if (decreaseStreamRetentionPeriodRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DecreaseStreamRetentionPeriodRequest)");
        }
        ...
        try {
            ...
            if (decreaseStreamRetentionPeriodRequest.getRetentionPeriodHours() != null) {
                Integer retentionPeriodHours = decreaseStreamRetentionPeriodRequest
