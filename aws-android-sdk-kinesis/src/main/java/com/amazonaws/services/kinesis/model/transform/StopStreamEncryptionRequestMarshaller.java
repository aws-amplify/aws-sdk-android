...
/**
 * JSON request marshaller for StopStreamEncryptionRequest
 */
public class StopStreamEncryptionRequestMarshaller implements
        Marshaller<Request<StopStreamEncryptionRequest>, StopStreamEncryptionRequest> {

    public Request<StopStreamEncryptionRequest> marshall(
            StopStreamEncryptionRequest stopStreamEncryptionRequest) {
        if (stopStreamEncryptionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(StopStreamEncryptionRequest)");
        }

        Request<StopStreamEncryptionRequest> request = new DefaultRequest<StopStreamEncryptionRequest>(
                stopStreamEncryptionRequest, "AmazonKinesis");
