...
/**
 * JSON unmarshaller for response DisableEnhancedMonitoringResult
 */
public class DisableEnhancedMonitoringResultJsonUnmarshaller implements
        Unmarshaller<DisableEnhancedMonitoringResult, JsonUnmarshallerContext> {

    public DisableEnhancedMonitoringResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("StreamName")) {
                disableEnhancedMonitoringResult.setStreamName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
