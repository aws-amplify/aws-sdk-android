    ...
    if (listTagsForStreamRequest == null) {
        ...
        try {
            ...
            if (listTagsForStreamRequest.getStreamName() != null) {
                jsonWriter.name("StreamName").value(listTagsForStreamRequest.getStreamName());
            }
            if (listTagsForStreamRequest.getExclusiveStartTagKey() != null) {
                jsonWriter.name("ExclusiveStartTagKey").value(listTagsForStreamRequest.getExclusiveStartTagKey());
            }
            if (listTagsForStreamRequest.getLimit() != null) {
                jsonWriter.name("Limit").value(listTagsForStreamRequest.getLimit());
            }
