...
/**
 * JSON request marshaller for IncreaseStreamRetentionPeriodRequest
 */
    ...
    public Request<IncreaseStreamRetentionPeriodRequest> marshall(
        ...
        if (increaseStreamRetentionPeriodRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(IncreaseStreamRetentionPeriodRequest)");
        }
        ...
        try {
            ...
            if (increaseStreamRetentionPeriodRequest.getRetentionPeriodHours() != null) {
                Integer retentionPeriodHours = increaseStreamRetentionPeriodRequest
