...
public class KMSOptInRequiredExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("KMSOptInRequired");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        KMSOptInRequiredException e = (KMSOptInRequiredException) super.unmarshall(error);
        e.setErrorCode("KMSOptInRequired");
