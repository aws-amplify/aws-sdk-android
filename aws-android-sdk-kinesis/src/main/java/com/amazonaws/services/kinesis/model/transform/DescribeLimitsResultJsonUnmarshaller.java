...
public class DescribeLimitsResultJsonUnmarshaller implements
    ...
    public DescribeLimitsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ShardLimit")) {
                describeLimitsResult.setShardLimit(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("OpenShardCount")) {
                describeLimitsResult.setOpenShardCount(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
