...
public class ExpiredNextTokenExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("ExpiredNextTokenException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        ExpiredNextTokenException e = (ExpiredNextTokenException) super.unmarshall(error);
        e.setErrorCode("ExpiredNextTokenException");
