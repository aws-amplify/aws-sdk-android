...
/**
 * JSON unmarshaller for POJO PutRecordsRequestEntry
 */
class PutRecordsRequestEntryJsonUnmarshaller implements
    ...
    public PutRecordsRequestEntry unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Data")) {
                ...
                putRecordsRequestEntry.setPartitionKey(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
