 ...
 * from its stream. To read from a stream continually, call <a>GetRecords</a> in
 * a loop. Use <a>GetShardIterator</a> to get the shard iterator to specify in
 * the first <a>GetRecords</a> call. <a>GetRecords</a> returns a new shard
 ...
 * <a>GetRecords</a>. Note that if the shard has been closed, the shard iterator
 * can't return more data and <a>GetRecords</a> returns <code>null</code> in
