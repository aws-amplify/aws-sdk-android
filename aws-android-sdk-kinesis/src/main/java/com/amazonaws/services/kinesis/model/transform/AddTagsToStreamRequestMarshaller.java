...
/**
 * JSON request marshaller for AddTagsToStreamRequest
 */
    ...
    public Request<AddTagsToStreamRequest> marshall(AddTagsToStreamRequest addTagsToStreamRequest) {
        if (addTagsToStreamRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AddTagsToStreamRequest)");
        }
        ...
        try {
            ...
            if (addTagsToStreamRequest.getTags() != null) {
                java.util.Map<String, String> tags = addTagsToStreamRequest.getTags();
