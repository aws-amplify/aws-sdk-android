...
/**
 * JSON unmarshaller for POJO XssMatchSetSummary
 */
class XssMatchSetSummaryJsonUnmarshaller implements
    ...
    public XssMatchSetSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("XssMatchSetId")) {
                xssMatchSetSummary.setXssMatchSetId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Name")) {
                xssMatchSetSummary.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
