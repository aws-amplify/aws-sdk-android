    ...
    public ListTagsForResourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NextMarker")) {
                listTagsForResourceResult.setNextMarker(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TagInfoForResource")) {
                listTagsForResourceResult.setTagInfoForResource(TagInfoForResourceJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
