...
/**
 * JSON unmarshaller for POJO SizeConstraintSetSummary
 */
class SizeConstraintSetSummaryJsonUnmarshaller implements
        Unmarshaller<SizeConstraintSetSummary, JsonUnmarshallerContext> {
    ...
    public SizeConstraintSetSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SizeConstraintSetId")) {
                sizeConstraintSetSummary.setSizeConstraintSetId(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Name")) {
                sizeConstraintSetSummary.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
