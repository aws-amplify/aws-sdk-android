...
public class DeleteRuleGroupResult implements Serializable {
    /**
     * <p>
     * The <code>ChangeToken</code> that you used to submit the
     * <code>DeleteRuleGroup</code> request. You can also use this value to
     ...
     * @return <p>
     *         The <code>ChangeToken</code> that you used to submit the
     *         <code>DeleteRuleGroup</code> request. You can also use this value
     ...
     * @param changeToken <p>
     *            The <code>ChangeToken</code> that you used to submit the
     *            <code>DeleteRuleGroup</code> request. You can also use this
