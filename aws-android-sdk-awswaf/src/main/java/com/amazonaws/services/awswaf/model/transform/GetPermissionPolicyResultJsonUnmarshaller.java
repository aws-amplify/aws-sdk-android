...
/**
 * JSON unmarshaller for response GetPermissionPolicyResult
 */
public class GetPermissionPolicyResultJsonUnmarshaller implements
        Unmarshaller<GetPermissionPolicyResult, JsonUnmarshallerContext> {
    ...
    public GetPermissionPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Policy")) {
                getPermissionPolicyResult.setPolicy(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
