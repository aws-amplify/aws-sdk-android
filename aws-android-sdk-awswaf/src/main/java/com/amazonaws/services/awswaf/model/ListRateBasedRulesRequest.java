 ...
 * </p>
 */
public class ListRateBasedRulesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
    ...
    /**
     * <p>
     * Specifies the number of <code>Rules</code> that you want AWS WAF to
     * return for this request. If you have more <code>Rules</code> than the
     ...
     * @return <p>
     *         If you specify a value for <code>Limit</code> and you have more
     *         <code>Rules</code> than the value of <code>Limit</code>, AWS WAF
     *         returns a <code>NextMarker</code> value in the response that
     *         allows you to list another group of <code>Rules</code>. For the
     *         second and subsequent <code>ListRateBasedRules</code> requests,
     ...
     *            more <code>Rules</code> than the value of <code>Limit</code>,
     *            AWS WAF returns a <code>NextMarker</code> value in the
     *            response that allows you to list another group of
     *            <code>Rules</code>. For the second and subsequent
     *            <code>ListRateBasedRules</code> requests, specify the value of
     ...
     *
     * @return <p>
     *         Specifies the number of <code>Rules</code> that you want AWS WAF
     *         to return for this request. If you have more <code>Rules</code>
     *         than the number that you specify for <code>Limit</code>, the
     ...
     *
     * @param limit <p>
     *            Specifies the number of <code>Rules</code> that you want AWS
     *            WAF to return for this request. If you have more
     *            <code>Rules</code> than the number that you specify for
