...
public class UpdateWebACLResult implements Serializable {
    /**
     * <p>
     * The <code>ChangeToken</code> that you used to submit the
     * <code>UpdateWebACL</code> request. You can also use this value to query
     ...
     * @return <p>
     *         The <code>ChangeToken</code> that you used to submit the
     *         <code>UpdateWebACL</code> request. You can also use this value to
     ...
     * @param changeToken <p>
     *            The <code>ChangeToken</code> that you used to submit the
     *            <code>UpdateWebACL</code> request. You can also use this value
