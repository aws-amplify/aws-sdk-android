...
/**
 * JSON unmarshaller for response GetSampledRequestsResult
 */
public class GetSampledRequestsResultJsonUnmarshaller implements
    ...
    public GetSampledRequestsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SampledRequests")) {
                getSampledRequestsResult
                        .setSampledRequests(new ListUnmarshaller<SampledHTTPRequest>(
                                SampledHTTPRequestJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("PopulationSize")) {
                getSampledRequestsResult.setPopulationSize(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TimeWindow")) {
                getSampledRequestsResult.setTimeWindow(TimeWindowJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
