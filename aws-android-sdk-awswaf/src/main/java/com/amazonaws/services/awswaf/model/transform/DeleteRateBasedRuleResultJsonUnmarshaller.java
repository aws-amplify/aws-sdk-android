...
/**
 * JSON unmarshaller for response DeleteRateBasedRuleResult
 */
public class DeleteRateBasedRuleResultJsonUnmarshaller implements
        Unmarshaller<DeleteRateBasedRuleResult, JsonUnmarshallerContext> {
    ...
    public DeleteRateBasedRuleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ChangeToken")) {
                deleteRateBasedRuleResult.setChangeToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
