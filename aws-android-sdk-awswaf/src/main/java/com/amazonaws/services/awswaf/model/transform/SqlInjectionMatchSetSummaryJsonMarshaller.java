...
/**
 * JSON marshaller for POJO SqlInjectionMatchSetSummary
 */
class SqlInjectionMatchSetSummaryJsonMarshaller {

    public void marshall(SqlInjectionMatchSetSummary sqlInjectionMatchSetSummary,
            AwsJsonWriter jsonWriter) throws Exception {
        jsonWriter.beginObject();
        if (sqlInjectionMatchSetSummary.getSqlInjectionMatchSetId() != null) {
            String sqlInjectionMatchSetId = sqlInjectionMatchSetSummary.getSqlInjectionMatchSetId();
            jsonWriter.name("SqlInjectionMatchSetId");
            jsonWriter.value(sqlInjectionMatchSetId);
        }
        if (sqlInjectionMatchSetSummary.getName() != null) {
            String name = sqlInjectionMatchSetSummary.getName();
