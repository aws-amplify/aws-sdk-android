...
/**
 * JSON unmarshaller for response GetRuleResult
 */
public class GetRuleResultJsonUnmarshaller implements
        Unmarshaller<GetRuleResult, JsonUnmarshallerContext> {
    ...
    public GetRuleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Rule")) {
                getRuleResult.setRule(RuleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
