...
import com.amazonaws.services.awswaf.model.transform.*;

/**
 * Client for accessing AWS WAF. All service calls made using this client are
...
public class AWSWAFClient extends AmazonWebServiceClient implements AWSWAF {
    ...
    /**
     * List of exception unmarshallers for all AWS WAF exceptions.
     */
    protected List<JsonErrorUnmarshaller> jsonErrorUnmarshallers;

    /**
     * Constructs a new client to invoke service methods on AWSWAF. A
     ...
     *            how this client connects to AWSWAF (ex: proxy settings, retry
     *            counts, etc.).
     * @see DefaultAWSCredentialsProviderChain
     */
    @Deprecated
    ...
    /**
     * Constructs a new client to invoke service methods on AWSWAF using the
     ...
     *         AWSWAFClient client = new AWSWAFClient(AWSMobileClient.getInstance());
     *     }
     * 
     *     &#064;Override
    ...
    private void init() {
        ...
        this.setEndpoint("waf.us-east-1.amazonaws.com");
        this.endpointPrefix = "waf";

        HandlerChainFactory chainFactory = new HandlerChainFactory();
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/awswaf/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/awswaf/request.handler2s"));
    }
