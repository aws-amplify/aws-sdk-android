 ...
 * </note>
 * <p>
 * Permanently deletes a <a>RateBasedRule</a>. You can't delete a rule if it's
 * still used in any <code>WebACL</code> objects or if it still includes any
 * predicates, such as <code>ByteMatchSet</code> objects.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * To permanently delete a <code>RateBasedRule</code> from AWS WAF, perform the
 * following steps:
 * </p>
 * <ol>
 * <li>
 * <p>
 * Update the <code>RateBasedRule</code> to remove predicates, if any. For more
 * information, see <a>UpdateRateBasedRule</a>.
 * </p>
 * </li>
 * <li>
 * <p>
 ...
 * </ol>
 */
public class DeleteRateBasedRuleRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *         to delete. <code>RuleId</code> is returned by
