...
/**
 * JSON unmarshaller for response PutPermissionPolicyResult
 */
public class PutPermissionPolicyResultJsonUnmarshaller implements
        Unmarshaller<PutPermissionPolicyResult, JsonUnmarshallerContext> {
