...
/**
 * JSON unmarshaller for response PutModelResult
 */
public class PutModelResultJsonUnmarshaller implements
        Unmarshaller<PutModelResult, JsonUnmarshallerContext> {
