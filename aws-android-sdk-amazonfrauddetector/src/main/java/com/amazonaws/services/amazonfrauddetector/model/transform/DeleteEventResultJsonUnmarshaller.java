...
/**
 * JSON unmarshaller for response DeleteEventResult
 */
public class DeleteEventResultJsonUnmarshaller implements
        Unmarshaller<DeleteEventResult, JsonUnmarshallerContext> {
