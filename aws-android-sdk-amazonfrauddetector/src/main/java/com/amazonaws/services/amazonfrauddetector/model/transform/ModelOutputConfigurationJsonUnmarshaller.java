...
/**
 * JSON unmarshaller for POJO ModelOutputConfiguration
 */
class ModelOutputConfigurationJsonUnmarshaller implements
        Unmarshaller<ModelOutputConfiguration, JsonUnmarshallerContext> {
    ...
    public ModelOutputConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("format")) {
                modelOutputConfiguration.setFormat(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("jsonKeyToVariableMap")) {
                modelOutputConfiguration.setJsonKeyToVariableMap(new MapUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("csvIndexToVariableMap")) {
                modelOutputConfiguration.setCsvIndexToVariableMap(new MapUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
