...
/**
 * JSON unmarshaller for response GetModelVersionResult
 */
public class GetModelVersionResultJsonUnmarshaller implements
        Unmarshaller<GetModelVersionResult, JsonUnmarshallerContext> {
    ...
    public GetModelVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("modelId")) {
                getModelVersionResult.setModelId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("modelType")) {
                getModelVersionResult.setModelType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("modelVersionNumber")) {
                getModelVersionResult.setModelVersionNumber(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("description")) {
                getModelVersionResult.setDescription(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("status")) {
                getModelVersionResult.setStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
