...
/**
 * JSON unmarshaller for response UpdateModelVersionResult
 */
public class UpdateModelVersionResultJsonUnmarshaller implements
        Unmarshaller<UpdateModelVersionResult, JsonUnmarshallerContext> {
