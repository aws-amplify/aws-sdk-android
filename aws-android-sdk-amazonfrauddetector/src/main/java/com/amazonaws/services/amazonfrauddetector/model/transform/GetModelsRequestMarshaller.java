...
public class GetModelsRequestMarshaller implements
    ...
    public Request<GetModelsRequest> marshall(GetModelsRequest getModelsRequest) {
        ...
        try {
            ...
            if (getModelsRequest.getModelType() != null) {
                String modelType = getModelsRequest.getModelType();
                jsonWriter.name("modelType");
                jsonWriter.value(modelType);
            }
            if (getModelsRequest.getModelId() != null) {
                String modelId = getModelsRequest.getModelId();
                jsonWriter.name("modelId");
                jsonWriter.value(modelId);
            }
            if (getModelsRequest.getNextToken() != null) {
                String nextToken = getModelsRequest.getNextToken();
                jsonWriter.name("nextToken");
                jsonWriter.value(nextToken);
            }
            if (getModelsRequest.getMaxResults() != null) {
                Integer maxResults = getModelsRequest.getMaxResults();
