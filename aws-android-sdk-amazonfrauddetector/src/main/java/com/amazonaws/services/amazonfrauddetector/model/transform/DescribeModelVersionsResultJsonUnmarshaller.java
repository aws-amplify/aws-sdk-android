...
/**
 * JSON unmarshaller for response DescribeModelVersionsResult
 */
public class DescribeModelVersionsResultJsonUnmarshaller implements
        Unmarshaller<DescribeModelVersionsResult, JsonUnmarshallerContext> {
    ...
    public DescribeModelVersionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("modelVersionDetails")) {
                describeModelVersionsResult
                        .setModelVersionDetails(new ListUnmarshaller<ModelVersionDetail>(
                                ModelVersionDetailJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                describeModelVersionsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
