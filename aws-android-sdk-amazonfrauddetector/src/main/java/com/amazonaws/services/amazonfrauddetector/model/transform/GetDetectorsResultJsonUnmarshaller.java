...
/**
 * JSON unmarshaller for response GetDetectorsResult
 */
public class GetDetectorsResultJsonUnmarshaller implements
        Unmarshaller<GetDetectorsResult, JsonUnmarshallerContext> {
    ...
    public GetDetectorsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("detectors")) {
                getDetectorsResult.setDetectors(new ListUnmarshaller<Detector>(
                        DetectorJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                getDetectorsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
