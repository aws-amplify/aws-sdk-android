...
/**
 * JSON unmarshaller for response BatchGetVariableResult
 */
public class BatchGetVariableResultJsonUnmarshaller implements
        Unmarshaller<BatchGetVariableResult, JsonUnmarshallerContext> {
    ...
    public BatchGetVariableResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("variables")) {
                batchGetVariableResult.setVariables(new ListUnmarshaller<Variable>(
                        VariableJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("errors")) {
                batchGetVariableResult.setErrors(new ListUnmarshaller<BatchGetVariableError>(
                        BatchGetVariableErrorJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
