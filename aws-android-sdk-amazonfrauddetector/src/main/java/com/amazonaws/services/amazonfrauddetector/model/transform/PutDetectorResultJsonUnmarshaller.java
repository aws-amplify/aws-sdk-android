...
/**
 * JSON unmarshaller for response PutDetectorResult
 */
public class PutDetectorResultJsonUnmarshaller implements
        Unmarshaller<PutDetectorResult, JsonUnmarshallerContext> {
