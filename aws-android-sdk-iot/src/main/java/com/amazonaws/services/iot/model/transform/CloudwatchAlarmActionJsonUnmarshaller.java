...
/**
 * JSON unmarshaller for POJO CloudwatchAlarmAction
 */
class CloudwatchAlarmActionJsonUnmarshaller implements
    ...
    public CloudwatchAlarmAction unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("roleArn")) {
                ...
                cloudwatchAlarmAction.setStateValue(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
