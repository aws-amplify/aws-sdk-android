...
/**
 * JSON unmarshaller for POJO AwsJobRateIncreaseCriteria
 */
class AwsJobRateIncreaseCriteriaJsonUnmarshaller implements
        Unmarshaller<AwsJobRateIncreaseCriteria, JsonUnmarshallerContext> {
    ...
    public AwsJobRateIncreaseCriteria unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("numberOfNotifiedThings")) {
                awsJobRateIncreaseCriteria.setNumberOfNotifiedThings(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("numberOfSucceededThings")) {
                awsJobRateIncreaseCriteria.setNumberOfSucceededThings(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
