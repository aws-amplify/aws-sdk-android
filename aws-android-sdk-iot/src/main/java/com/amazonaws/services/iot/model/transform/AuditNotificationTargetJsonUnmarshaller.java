...
/**
 * JSON unmarshaller for POJO AuditNotificationTarget
 */
class AuditNotificationTargetJsonUnmarshaller implements
        Unmarshaller<AuditNotificationTarget, JsonUnmarshallerContext> {
