...
/**
 * JSON marshaller for POJO ProvisioningHook
 */
class ProvisioningHookJsonMarshaller {

    public void marshall(ProvisioningHook provisioningHook, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (provisioningHook.getPayloadVersion() != null) {
            ...
            jsonWriter.value(payloadVersion);
        }
