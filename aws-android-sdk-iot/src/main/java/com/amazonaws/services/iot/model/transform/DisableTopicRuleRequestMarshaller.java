...
/**
 * JSON request marshaller for DisableTopicRuleRequest
 */
    ...
    public Request<DisableTopicRuleRequest> marshall(DisableTopicRuleRequest disableTopicRuleRequest) {
        if (disableTopicRuleRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DisableTopicRuleRequest)");
        }

        Request<DisableTopicRuleRequest> request = new DefaultRequest<DisableTopicRuleRequest>(
                disableTopicRuleRequest, "AWSIot");
        ...
        uriResourcePath = uriResourcePath.replace(
                ...
                (disableTopicRuleRequest.getRuleName() == null) ? "" : StringUtils
                        .fromString(disableTopicRuleRequest.getRuleName()));
