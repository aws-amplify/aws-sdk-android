...
/**
 * JSON unmarshaller for response ListThingGroupsResult
 */
public class ListThingGroupsResultJsonUnmarshaller implements
        Unmarshaller<ListThingGroupsResult, JsonUnmarshallerContext> {
