...
/**
 * JSON unmarshaller for response ListRoleAliasesResult
 */
public class ListRoleAliasesResultJsonUnmarshaller implements
        Unmarshaller<ListRoleAliasesResult, JsonUnmarshallerContext> {
