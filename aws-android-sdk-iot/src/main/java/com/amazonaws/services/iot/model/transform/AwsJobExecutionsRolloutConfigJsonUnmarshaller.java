...
/**
 * JSON unmarshaller for POJO AwsJobExecutionsRolloutConfig
 */
class AwsJobExecutionsRolloutConfigJsonUnmarshaller implements
        Unmarshaller<AwsJobExecutionsRolloutConfig, JsonUnmarshallerContext> {
