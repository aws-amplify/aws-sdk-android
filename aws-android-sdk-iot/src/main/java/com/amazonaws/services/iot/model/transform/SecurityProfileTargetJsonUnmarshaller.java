...
/**
 * JSON unmarshaller for POJO SecurityProfileTarget
 */
class SecurityProfileTargetJsonUnmarshaller implements
        Unmarshaller<SecurityProfileTarget, JsonUnmarshallerContext> {
