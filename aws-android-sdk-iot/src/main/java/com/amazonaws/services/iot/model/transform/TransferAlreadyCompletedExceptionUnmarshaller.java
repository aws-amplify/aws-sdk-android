...
public class TransferAlreadyCompletedExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("TransferAlreadyCompletedException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        TransferAlreadyCompletedException e = (TransferAlreadyCompletedException)super.unmarshall(error);
