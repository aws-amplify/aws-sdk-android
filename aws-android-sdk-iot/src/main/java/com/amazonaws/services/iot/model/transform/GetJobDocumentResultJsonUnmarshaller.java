...
/**
 * JSON unmarshaller for response GetJobDocumentResult
 */
public class GetJobDocumentResultJsonUnmarshaller implements
        Unmarshaller<GetJobDocumentResult, JsonUnmarshallerContext> {
