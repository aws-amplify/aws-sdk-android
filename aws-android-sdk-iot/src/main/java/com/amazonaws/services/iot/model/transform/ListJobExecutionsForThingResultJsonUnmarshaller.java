...
/**
 * JSON unmarshaller for response ListJobExecutionsForThingResult
 */
public class ListJobExecutionsForThingResultJsonUnmarshaller implements
        Unmarshaller<ListJobExecutionsForThingResult, JsonUnmarshallerContext> {

    public ListJobExecutionsForThingResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
