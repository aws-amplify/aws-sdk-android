...
/**
 * JSON unmarshaller for POJO JobExecutionsRolloutConfig
 */
class JobExecutionsRolloutConfigJsonUnmarshaller implements
        Unmarshaller<JobExecutionsRolloutConfig, JsonUnmarshallerContext> {
