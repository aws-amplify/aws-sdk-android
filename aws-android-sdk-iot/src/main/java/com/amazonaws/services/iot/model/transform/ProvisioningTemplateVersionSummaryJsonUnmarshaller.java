...
/**
 * JSON unmarshaller for POJO ProvisioningTemplateVersionSummary
 */
class ProvisioningTemplateVersionSummaryJsonUnmarshaller implements
        Unmarshaller<ProvisioningTemplateVersionSummary, JsonUnmarshallerContext> {
    ...
    public ProvisioningTemplateVersionSummary unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("versionId")) {
                provisioningTemplateVersionSummary.setVersionId(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("creationDate")) {
                provisioningTemplateVersionSummary.setCreationDate(DateJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("isDefaultVersion")) {
                provisioningTemplateVersionSummary.setIsDefaultVersion(BooleanJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
