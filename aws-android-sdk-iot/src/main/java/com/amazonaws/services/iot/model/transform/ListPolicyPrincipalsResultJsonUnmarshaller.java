...
/**
 * JSON unmarshaller for response ListPolicyPrincipalsResult
 */
public class ListPolicyPrincipalsResultJsonUnmarshaller implements
        Unmarshaller<ListPolicyPrincipalsResult, JsonUnmarshallerContext> {
