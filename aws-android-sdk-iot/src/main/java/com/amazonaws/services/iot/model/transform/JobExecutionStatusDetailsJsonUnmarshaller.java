...
/**
 * JSON unmarshaller for POJO JobExecutionStatusDetails
 */
class JobExecutionStatusDetailsJsonUnmarshaller implements
        Unmarshaller<JobExecutionStatusDetails, JsonUnmarshallerContext> {
