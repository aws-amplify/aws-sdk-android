...
/**
 * JSON unmarshaller for response ListAuthorizersResult
 */
public class ListAuthorizersResultJsonUnmarshaller implements
        Unmarshaller<ListAuthorizersResult, JsonUnmarshallerContext> {
