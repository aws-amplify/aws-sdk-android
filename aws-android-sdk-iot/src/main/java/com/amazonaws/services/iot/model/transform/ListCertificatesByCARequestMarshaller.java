...
/**
 * JSON request marshaller for ListCertificatesByCARequest
 */
public class ListCertificatesByCARequestMarshaller implements
    ...
    public Request<ListCertificatesByCARequest> marshall(
        ...
        if (listCertificatesByCARequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListCertificatesByCARequest)");
        }
        ...
        uriResourcePath = uriResourcePath.replace(
                ...
                (listCertificatesByCARequest.getCaCertificateId() == null) ? "" : StringUtils
                        .fromString(listCertificatesByCARequest.getCaCertificateId()));
        if (listCertificatesByCARequest.getPageSize() != null) {
            request.addParameter("pageSize",
                    StringUtils.fromInteger(listCertificatesByCARequest.getPageSize()));
        }
        if (listCertificatesByCARequest.getMarker() != null) {
            request.addParameter("marker",
                    StringUtils.fromString(listCertificatesByCARequest.getMarker()));
        }
        if (listCertificatesByCARequest.getAscendingOrder() != null) {
            request.addParameter("isAscendingOrder",
                    StringUtils.fromBoolean(listCertificatesByCARequest.getAscendingOrder()));
        }
