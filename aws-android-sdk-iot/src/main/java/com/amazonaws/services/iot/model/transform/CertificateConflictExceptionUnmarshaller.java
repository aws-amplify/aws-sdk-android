...
public class CertificateConflictExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("CertificateConflictException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        CertificateConflictException e = (CertificateConflictException) super.unmarshall(error);
        e.setErrorCode("CertificateConflictException");
