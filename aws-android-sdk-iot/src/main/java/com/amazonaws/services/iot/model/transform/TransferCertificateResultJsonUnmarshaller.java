...
/**
 * Transfer Certificate Result JSON Unmarshaller
 */
public class TransferCertificateResultJsonUnmarshaller implements Unmarshaller<TransferCertificateResult, JsonUnmarshallerContext> {
    ...
    public TransferCertificateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("transferredCertificateArn")) {
                transferCertificateResult.setTransferredCertificateArn(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static TransferCertificateResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new TransferCertificateResultJsonUnmarshaller();
        return instance;
    }
}
