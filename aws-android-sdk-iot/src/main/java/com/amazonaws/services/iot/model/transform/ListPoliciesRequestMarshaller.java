...
public class ListPoliciesRequestMarshaller implements Marshaller<Request<ListPoliciesRequest>, ListPoliciesRequest> {
    ...
    if (listPoliciesRequest == null) {
        ...
        uriResourcePath = uriResourcePath.replace("{marker}", (listPoliciesRequest.getMarker() == null) ? "" : StringUtils.fromString(listPoliciesRequest.getMarker())); 
        uriResourcePath = uriResourcePath.replace("{pageSize}", (listPoliciesRequest.getPageSize() == null) ? "" : StringUtils.fromInteger(listPoliciesRequest.getPageSize())); 
        uriResourcePath = uriResourcePath.replace("{ascendingOrder}", (listPoliciesRequest.isAscendingOrder() == null) ? "" : StringUtils.fromBoolean(listPoliciesRequest.isAscendingOrder())); 
