...
/**
 * Container for the parameters to the {@link com.amazonaws.services.iot.AWSIot#updateCertificate(UpdateCertificateRequest) UpdateCertificate operation}.
 * <p>
 ...
 * </p>
 *
 * @see com.amazonaws.services.iot.AWSIot#updateCertificate(UpdateCertificateRequest)
 */
public class UpdateCertificateRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    /**
     * The new status. <p>Note: setting the status to PENDING_TRANSFER will
     ...
     * <b>Allowed Values: </b>ACTIVE, INACTIVE, REVOKED, PENDING_TRANSFER
     *
     * @return The new status. <p>Note: setting the status to PENDING_TRANSFER will
     *         result in an exception being thrown. PENDING_TRANSFER is a status used
     *         internally by AWS IoT and is not meant to be used by developers.
     *
     ...
     * <b>Allowed Values: </b>ACTIVE, INACTIVE, REVOKED, PENDING_TRANSFER
     *
     * @param newStatus The new status. <p>Note: setting the status to PENDING_TRANSFER will
     *         result in an exception being thrown. PENDING_TRANSFER is a status used
     *         internally by AWS IoT and is not meant to be used by developers.
     *
     * @see CertificateStatus
    ...
    public String toString() {
        ...
        if (getNewStatus() != null) sb.append("NewStatus: " + getNewStatus() );
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateCertificateRequest == false) return false;
        ...
        if (other.getNewStatus() == null ^ this.getNewStatus() == null) return false;
        if (other.getNewStatus() != null && other.getNewStatus().equals(this.getNewStatus()) == false) return false; 
        return true;
    }
