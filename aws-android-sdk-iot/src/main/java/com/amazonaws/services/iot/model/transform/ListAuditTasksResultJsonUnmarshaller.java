...
/**
 * JSON unmarshaller for response ListAuditTasksResult
 */
public class ListAuditTasksResultJsonUnmarshaller implements
        Unmarshaller<ListAuditTasksResult, JsonUnmarshallerContext> {
