...
/**
 * JSON unmarshaller for response ListActiveViolationsResult
 */
public class ListActiveViolationsResultJsonUnmarshaller implements
        Unmarshaller<ListActiveViolationsResult, JsonUnmarshallerContext> {
