...
public class RegistrationCodeValidationExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("RegistrationCodeValidationException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        RegistrationCodeValidationException e = (RegistrationCodeValidationException) super
                .unmarshall(error);
        e.setErrorCode("RegistrationCodeValidationException");
