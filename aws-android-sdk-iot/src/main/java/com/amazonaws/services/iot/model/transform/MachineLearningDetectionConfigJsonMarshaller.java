...
/**
 * JSON marshaller for POJO MachineLearningDetectionConfig
 */
class MachineLearningDetectionConfigJsonMarshaller {

    public void marshall(MachineLearningDetectionConfig machineLearningDetectionConfig,
        ...
        if (machineLearningDetectionConfig.getConfidenceLevel() != null) {
            ...
            jsonWriter.name("confidenceLevel");
            jsonWriter.value(confidenceLevel);
        }
