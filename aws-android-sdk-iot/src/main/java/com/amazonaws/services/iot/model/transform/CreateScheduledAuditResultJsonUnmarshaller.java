...
/**
 * JSON unmarshaller for response CreateScheduledAuditResult
 */
public class CreateScheduledAuditResultJsonUnmarshaller implements
        Unmarshaller<CreateScheduledAuditResult, JsonUnmarshallerContext> {
