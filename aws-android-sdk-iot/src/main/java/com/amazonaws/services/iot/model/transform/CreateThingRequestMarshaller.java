...
/**
 * Create Thing Request Marshaller
 */
public class CreateThingRequestMarshaller implements Marshaller<Request<CreateThingRequest>, CreateThingRequest> {
    ...
    if (createThingRequest == null) {
        ...
        String target = "AWSIotService.CreateThing";
        request.addHeader("X-Amz-Target", target);

        request.setHttpMethod(HttpMethodName.POST);
        String uriResourcePath = "/things/{thingName}"; 
        uriResourcePath = uriResourcePath.replace("{thingName}", (createThingRequest.getThingName() == null) ? "" : StringUtils.fromString(createThingRequest.getThingName())); 
