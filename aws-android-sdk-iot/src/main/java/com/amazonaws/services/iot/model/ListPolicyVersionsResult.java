...
public class ListPolicyVersionsResult implements Serializable {
     ...
     * The policy versions.
     */
    private com.amazonaws.internal.ListWithAutoConstructFlag<PolicyVersion> policyVersions;
    ...
    public java.util.List<PolicyVersion> getPolicyVersions() {
        if (policyVersions == null) {
              policyVersions = new com.amazonaws.internal.ListWithAutoConstructFlag<PolicyVersion>();
              policyVersions.setAutoConstruct(true);
        }
    ...
    public void setPolicyVersions(java.util.Collection<PolicyVersion> policyVersions) {
        ...
        com.amazonaws.internal.ListWithAutoConstructFlag<PolicyVersion> policyVersionsCopy = new com.amazonaws.internal.ListWithAutoConstructFlag<PolicyVersion>(policyVersions.size());
        policyVersionsCopy.addAll(policyVersions);
        this.policyVersions = policyVersionsCopy;
    }
    ...
    public ListPolicyVersionsResult withPolicyVersions(PolicyVersion... policyVersions) {
        if (getPolicyVersions() == null) setPolicyVersions(new java.util.ArrayList<PolicyVersion>(policyVersions.length));
        for (PolicyVersion value : policyVersions) {
            getPolicyVersions().add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getPolicyVersions() != null) sb.append("PolicyVersions: " + getPolicyVersions() );
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getPolicyVersions() != null && other.getPolicyVersions().equals(this.getPolicyVersions()) == false) return false; 
        return true;
    }
