...
/**
 * JSON unmarshaller for response ValidateSecurityProfileBehaviorsResult
 */
public class ValidateSecurityProfileBehaviorsResultJsonUnmarshaller implements
        Unmarshaller<ValidateSecurityProfileBehaviorsResult, JsonUnmarshallerContext> {

    public ValidateSecurityProfileBehaviorsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
