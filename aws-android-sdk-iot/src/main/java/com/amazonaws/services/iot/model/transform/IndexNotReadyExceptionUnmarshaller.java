...
public class IndexNotReadyExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("IndexNotReadyException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        IndexNotReadyException e = (IndexNotReadyException) super.unmarshall(error);
        e.setErrorCode("IndexNotReadyException");
