...
/**
 * JSON unmarshaller for POJO SecurityProfileIdentifier
 */
class SecurityProfileIdentifierJsonUnmarshaller implements
        Unmarshaller<SecurityProfileIdentifier, JsonUnmarshallerContext> {
