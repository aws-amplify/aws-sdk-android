...
/**
 * JSON unmarshaller for response ListAttachedPoliciesResult
 */
public class ListAttachedPoliciesResultJsonUnmarshaller implements
        Unmarshaller<ListAttachedPoliciesResult, JsonUnmarshallerContext> {
