...
/**
 * Delete Policy Version Request Marshaller
 */
public class DeletePolicyVersionRequestMarshaller implements Marshaller<Request<DeletePolicyVersionRequest>, DeletePolicyVersionRequest> {
    ...
    if (deletePolicyVersionRequest == null) {
        ...
        String target = "AWSIotService.DeletePolicyVersion";
        request.addHeader("X-Amz-Target", target);

        request.setHttpMethod(HttpMethodName.DELETE);
        String uriResourcePath = "/policies/{policyName}/version/{policyVersionId}"; 
        uriResourcePath = uriResourcePath.replace("{policyName}", (deletePolicyVersionRequest.getPolicyName() == null) ? "" : StringUtils.fromString(deletePolicyVersionRequest.getPolicyName())); 
        uriResourcePath = uriResourcePath.replace("{policyVersionId}", (deletePolicyVersionRequest.getPolicyVersionId() == null) ? "" : StringUtils.fromString(deletePolicyVersionRequest.getPolicyVersionId())); 
