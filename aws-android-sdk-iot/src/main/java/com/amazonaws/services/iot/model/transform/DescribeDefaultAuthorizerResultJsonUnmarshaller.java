...
/**
 * JSON unmarshaller for response DescribeDefaultAuthorizerResult
 */
public class DescribeDefaultAuthorizerResultJsonUnmarshaller implements
        Unmarshaller<DescribeDefaultAuthorizerResult, JsonUnmarshallerContext> {

    public DescribeDefaultAuthorizerResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
