...
/**
 * JSON unmarshaller for response UpdateRoleAliasResult
 */
public class UpdateRoleAliasResultJsonUnmarshaller implements
        Unmarshaller<UpdateRoleAliasResult, JsonUnmarshallerContext> {
