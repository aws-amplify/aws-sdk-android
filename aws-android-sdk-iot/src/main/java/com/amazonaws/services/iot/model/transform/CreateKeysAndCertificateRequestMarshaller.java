...
/**
 * Create Keys And Certificate Request Marshaller
 */
public class CreateKeysAndCertificateRequestMarshaller implements Marshaller<Request<CreateKeysAndCertificateRequest>, CreateKeysAndCertificateRequest> {
    ...
    if (createKeysAndCertificateRequest == null) {
        ...
        String target = "AWSIotService.CreateKeysAndCertificate";
        request.addHeader("X-Amz-Target", target);

        request.setHttpMethod(HttpMethodName.POST);
        String uriResourcePath = "/keys-and-certificate?setAsActive={setAsActive}"; 
        uriResourcePath = uriResourcePath.replace("{setAsActive}", (createKeysAndCertificateRequest.isSetAsActive() == null) ? "" : StringUtils.fromBoolean(createKeysAndCertificateRequest.isSetAsActive())); 
