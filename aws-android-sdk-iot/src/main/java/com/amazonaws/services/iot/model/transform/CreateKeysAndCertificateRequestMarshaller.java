...
/**
 * JSON request marshaller for CreateKeysAndCertificateRequest
 */
public class CreateKeysAndCertificateRequestMarshaller implements
    ...
    public Request<CreateKeysAndCertificateRequest> marshall(
        ...
        if (createKeysAndCertificateRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateKeysAndCertificateRequest)");
        }
        ...
        if (createKeysAndCertificateRequest.getSetAsActive() != null) {
            request.addParameter("setAsActive",
                    StringUtils.fromBoolean(createKeysAndCertificateRequest.getSetAsActive()));
        }
