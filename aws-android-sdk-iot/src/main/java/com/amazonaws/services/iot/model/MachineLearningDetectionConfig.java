...
public class MachineLearningDetectionConfig implements Serializable {
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getConfidenceLevel() == null) ? 0 : getConfidenceLevel().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getConfidenceLevel() == null ^ this.getConfidenceLevel() == null)
            return false;
        if (other.getConfidenceLevel() != null
                && other.getConfidenceLevel().equals(this.getConfidenceLevel()) == false)
            return false;
        return true;
    }
}
