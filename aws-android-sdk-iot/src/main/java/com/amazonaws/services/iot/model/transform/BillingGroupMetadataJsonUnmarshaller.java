...
/**
 * JSON unmarshaller for POJO BillingGroupMetadata
 */
class BillingGroupMetadataJsonUnmarshaller implements
        Unmarshaller<BillingGroupMetadata, JsonUnmarshallerContext> {
