...
/**
 * JSON request marshaller for SearchIndexRequest
 */
public class SearchIndexRequestMarshaller implements
        Marshaller<Request<SearchIndexRequest>, SearchIndexRequest> {

    public Request<SearchIndexRequest> marshall(SearchIndexRequest searchIndexRequest) {
        if (searchIndexRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(SearchIndexRequest)");
        }

        Request<SearchIndexRequest> request = new DefaultRequest<SearchIndexRequest>(
                searchIndexRequest, "AWSIot");
