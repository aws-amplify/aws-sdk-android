...
/**
 * Delete Topic Rule Request Marshaller
 */
public class DeleteTopicRuleRequestMarshaller implements Marshaller<Request<DeleteTopicRuleRequest>, DeleteTopicRuleRequest> {
    ...
    if (deleteTopicRuleRequest == null) {
        ...
        String target = "AWSIotService.DeleteTopicRule";
        request.addHeader("X-Amz-Target", target);

        request.setHttpMethod(HttpMethodName.DELETE);
        String uriResourcePath = "/rules/{ruleName}"; 
        uriResourcePath = uriResourcePath.replace("{ruleName}", (deleteTopicRuleRequest.getRuleName() == null) ? "" : StringUtils.fromString(deleteTopicRuleRequest.getRuleName())); 
