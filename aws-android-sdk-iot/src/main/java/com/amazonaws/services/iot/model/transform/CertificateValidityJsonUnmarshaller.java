...
/**
 * JSON unmarshaller for POJO CertificateValidity
 */
class CertificateValidityJsonUnmarshaller implements
        Unmarshaller<CertificateValidity, JsonUnmarshallerContext> {
