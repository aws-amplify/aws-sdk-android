...
/**
 * Delete Certificate Request Marshaller
 */
public class DeleteCertificateRequestMarshaller implements Marshaller<Request<DeleteCertificateRequest>, DeleteCertificateRequest> {
    ...
    if (deleteCertificateRequest == null) {
        ...
        String target = "AWSIotService.DeleteCertificate";
        request.addHeader("X-Amz-Target", target);

        request.setHttpMethod(HttpMethodName.DELETE);
        String uriResourcePath = "/certificates/{certificateId}"; 
        uriResourcePath = uriResourcePath.replace("{certificateId}", (deleteCertificateRequest.getCertificateId() == null) ? "" : StringUtils.fromString(deleteCertificateRequest.getCertificateId())); 
