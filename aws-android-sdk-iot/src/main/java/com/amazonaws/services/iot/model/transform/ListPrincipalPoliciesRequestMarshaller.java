...
/**
 * JSON request marshaller for ListPrincipalPoliciesRequest
 */
public class ListPrincipalPoliciesRequestMarshaller implements
    ...
    public Request<ListPrincipalPoliciesRequest> marshall(
        ...
        if (listPrincipalPoliciesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListPrincipalPoliciesRequest)");
        }
