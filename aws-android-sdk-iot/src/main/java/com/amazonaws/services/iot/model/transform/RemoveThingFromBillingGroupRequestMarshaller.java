...
/**
 * JSON request marshaller for RemoveThingFromBillingGroupRequest
 */
public class RemoveThingFromBillingGroupRequestMarshaller implements
        Marshaller<Request<RemoveThingFromBillingGroupRequest>, RemoveThingFromBillingGroupRequest> {

    public Request<RemoveThingFromBillingGroupRequest> marshall(
            RemoveThingFromBillingGroupRequest removeThingFromBillingGroupRequest) {
        if (removeThingFromBillingGroupRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RemoveThingFromBillingGroupRequest)");
        }

        Request<RemoveThingFromBillingGroupRequest> request = new DefaultRequest<RemoveThingFromBillingGroupRequest>(
                removeThingFromBillingGroupRequest, "AWSIot");
        request.setHttpMethod(HttpMethodName.PUT);

        String uriResourcePath = "/billing-groups/removeThingFromBillingGroup";
