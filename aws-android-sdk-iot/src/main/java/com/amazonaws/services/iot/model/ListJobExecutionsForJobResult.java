...
public class ListJobExecutionsForJobResult implements Serializable {
    ...
    public void setExecutionSummaries(
            java.util.Collection<JobExecutionSummaryForJob> executionSummaries) {
        if (executionSummaries == null) {
            this.executionSummaries = null;
            return;
        }

        this.executionSummaries = new java.util.ArrayList<JobExecutionSummaryForJob>(
                executionSummaries);
    }
     ...
     *         chained together.
     */
    public ListJobExecutionsForJobResult withExecutionSummaries(
            JobExecutionSummaryForJob... executionSummaries) {
        if (getExecutionSummaries() == null) {
            this.executionSummaries = new java.util.ArrayList<JobExecutionSummaryForJob>(
                    executionSummaries.length);
        }
        for (JobExecutionSummaryForJob value : executionSummaries) {
