...
/**
 * JSON marshaller for POJO TermsAggregation
 */
class TermsAggregationJsonMarshaller {

    public void marshall(TermsAggregation termsAggregation, AwsJsonWriter jsonWriter)
            throws Exception {
        jsonWriter.beginObject();
        if (termsAggregation.getMaxBuckets() != null) {
            Integer maxBuckets = termsAggregation.getMaxBuckets();
            jsonWriter.name("maxBuckets");
            jsonWriter.value(maxBuckets);
        }
