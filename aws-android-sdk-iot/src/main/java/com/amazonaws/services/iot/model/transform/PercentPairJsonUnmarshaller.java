...
/**
 * JSON unmarshaller for POJO PercentPair
 */
    ...
    public PercentPair unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("percent")) {
                percentPair.setPercent(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("value")) {
                percentPair.setValue(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
