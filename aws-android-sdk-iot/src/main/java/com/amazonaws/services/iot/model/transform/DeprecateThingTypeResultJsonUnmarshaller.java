...
/**
 * JSON unmarshaller for response DeprecateThingTypeResult
 */
public class DeprecateThingTypeResultJsonUnmarshaller implements
        Unmarshaller<DeprecateThingTypeResult, JsonUnmarshallerContext> {
