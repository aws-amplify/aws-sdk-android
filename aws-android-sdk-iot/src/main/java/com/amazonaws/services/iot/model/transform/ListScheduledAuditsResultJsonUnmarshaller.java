...
/**
 * JSON unmarshaller for response ListScheduledAuditsResult
 */
public class ListScheduledAuditsResultJsonUnmarshaller implements
        Unmarshaller<ListScheduledAuditsResult, JsonUnmarshallerContext> {
