...
/**
 * Dynamo D B Action JSON Unmarshaller
 */
public class DynamoDBActionJsonUnmarshaller implements Unmarshaller<DynamoDBAction, JsonUnmarshallerContext> {
    ...
    public DynamoDBAction unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("tableName")) {
                dynamoDBAction.setTableName(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            ...
            if (name.equals("hashKeyField")) {
                dynamoDBAction.setHashKeyField(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("hashKeyValue")) {
                dynamoDBAction.setHashKeyValue(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("rangeKeyField")) {
                dynamoDBAction.setRangeKeyField(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("rangeKeyValue")) {
                dynamoDBAction.setRangeKeyValue(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("payloadField")) {
                dynamoDBAction.setPayloadField(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static DynamoDBActionJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DynamoDBActionJsonUnmarshaller();
        return instance;
    }
}
