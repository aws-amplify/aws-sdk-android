...
/**
 * Create Certificate From Csr Request Marshaller
 */
public class CreateCertificateFromCsrRequestMarshaller implements Marshaller<Request<CreateCertificateFromCsrRequest>, CreateCertificateFromCsrRequest> {
    ...
    if (createCertificateFromCsrRequest == null) {
        ...
        String target = "AWSIotService.CreateCertificateFromCsr";
        request.addHeader("X-Amz-Target", target);

        request.setHttpMethod(HttpMethodName.POST);
        String uriResourcePath = "/certificates?setAsActive={setAsActive}"; 
        uriResourcePath = uriResourcePath.replace("{setAsActive}", (createCertificateFromCsrRequest.isSetAsActive() == null) ? "" : StringUtils.fromBoolean(createCertificateFromCsrRequest.isSetAsActive())); 
        ...
        try {
            ...
            if (createCertificateFromCsrRequest.getCertificateSigningRequest() != null) {
                jsonWriter.name("certificateSigningRequest").value(createCertificateFromCsrRequest.getCertificateSigningRequest());
            }
