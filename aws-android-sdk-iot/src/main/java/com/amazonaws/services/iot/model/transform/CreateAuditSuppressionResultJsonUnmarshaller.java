...
/**
 * JSON unmarshaller for response CreateAuditSuppressionResult
 */
public class CreateAuditSuppressionResultJsonUnmarshaller implements
        Unmarshaller<CreateAuditSuppressionResult, JsonUnmarshallerContext> {

    public CreateAuditSuppressionResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
