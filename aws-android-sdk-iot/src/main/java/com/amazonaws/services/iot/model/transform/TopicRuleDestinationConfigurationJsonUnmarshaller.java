...
/**
 * JSON unmarshaller for POJO TopicRuleDestinationConfiguration
 */
class TopicRuleDestinationConfigurationJsonUnmarshaller implements
        Unmarshaller<TopicRuleDestinationConfiguration, JsonUnmarshallerContext> {

    public TopicRuleDestinationConfiguration unmarshall(JsonUnmarshallerContext context)
            throws Exception {
