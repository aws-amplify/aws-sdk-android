...
/**
 * JSON unmarshaller for response AddThingToThingGroupResult
 */
public class AddThingToThingGroupResultJsonUnmarshaller implements
        Unmarshaller<AddThingToThingGroupResult, JsonUnmarshallerContext> {
