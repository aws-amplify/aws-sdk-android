...
/**
 * JSON unmarshaller for POJO ThingGroupIndexingConfiguration
 */
class ThingGroupIndexingConfigurationJsonUnmarshaller implements
        Unmarshaller<ThingGroupIndexingConfiguration, JsonUnmarshallerContext> {
