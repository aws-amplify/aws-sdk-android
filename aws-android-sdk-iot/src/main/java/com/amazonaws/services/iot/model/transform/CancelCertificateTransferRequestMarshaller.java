...
/**
 * Cancel Certificate Transfer Request Marshaller
 */
public class CancelCertificateTransferRequestMarshaller implements Marshaller<Request<CancelCertificateTransferRequest>, CancelCertificateTransferRequest> {
    ...
    if (cancelCertificateTransferRequest == null) {
        ...
        String target = "AWSIotService.CancelCertificateTransfer";
        request.addHeader("X-Amz-Target", target);

        request.setHttpMethod(HttpMethodName.PATCH);
        String uriResourcePath = "/cancel-certificate-transfer/{certificateId}"; 
        uriResourcePath = uriResourcePath.replace("{certificateId}", (cancelCertificateTransferRequest.getCertificateId() == null) ? "" : StringUtils.fromString(cancelCertificateTransferRequest.getCertificateId())); 
