...
/**
 * JSON unmarshaller for POJO JobExecutionSummaryForThing
 */
class JobExecutionSummaryForThingJsonUnmarshaller implements
        Unmarshaller<JobExecutionSummaryForThing, JsonUnmarshallerContext> {
    ...
    public JobExecutionSummaryForThing unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("jobId")) {
                jobExecutionSummaryForThing.setJobId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
