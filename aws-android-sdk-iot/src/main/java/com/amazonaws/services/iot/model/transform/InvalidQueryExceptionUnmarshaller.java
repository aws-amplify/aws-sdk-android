...
public class InvalidQueryExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InvalidQueryException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        InvalidQueryException e = (InvalidQueryException) super.unmarshall(error);
        e.setErrorCode("InvalidQueryException");
