...
/**
 * JSON marshaller for POJO MqttContext
 */
class MqttContextJsonMarshaller {

    public void marshall(MqttContext mqttContext, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (mqttContext.getPassword() != null) {
            java.nio.ByteBuffer password = mqttContext.getPassword();
