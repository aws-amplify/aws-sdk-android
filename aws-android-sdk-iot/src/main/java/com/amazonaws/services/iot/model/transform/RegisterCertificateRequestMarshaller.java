...
/**
 * JSON request marshaller for RegisterCertificateRequest
 */
public class RegisterCertificateRequestMarshaller implements
    ...
    public Request<RegisterCertificateRequest> marshall(
        ...
        if (registerCertificateRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RegisterCertificateRequest)");
        }
        ...
        if (registerCertificateRequest.getSetAsActive() != null) {
            request.addParameter("setAsActive",
                    StringUtils.fromBoolean(registerCertificateRequest.getSetAsActive()));
        }
