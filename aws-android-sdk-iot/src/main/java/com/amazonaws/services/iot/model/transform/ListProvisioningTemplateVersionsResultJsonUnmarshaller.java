...
/**
 * JSON unmarshaller for response ListProvisioningTemplateVersionsResult
 */
public class ListProvisioningTemplateVersionsResultJsonUnmarshaller implements
        Unmarshaller<ListProvisioningTemplateVersionsResult, JsonUnmarshallerContext> {

    public ListProvisioningTemplateVersionsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("versions")) {
                listProvisioningTemplateVersionsResult
                        .setVersions(new ListUnmarshaller<ProvisioningTemplateVersionSummary>(
                                ProvisioningTemplateVersionSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                listProvisioningTemplateVersionsResult.setNextToken(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
