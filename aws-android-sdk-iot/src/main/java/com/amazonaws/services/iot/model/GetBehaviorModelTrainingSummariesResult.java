...
public class GetBehaviorModelTrainingSummariesResult implements Serializable {
     ...
     *
     * @return <p>
     *         A list of all ML Detect behaviors and their model status for a
     ...
     *         chained together.
     */
    public GetBehaviorModelTrainingSummariesResult withSummaries(
            BehaviorModelTrainingSummary... summaries) {
        if (getSummaries() == null) {
            this.summaries = new java.util.ArrayList<BehaviorModelTrainingSummary>(summaries.length);
        }
        for (BehaviorModelTrainingSummary value : summaries) {
     ...
     */
    public GetBehaviorModelTrainingSummariesResult withSummaries(
            java.util.Collection<BehaviorModelTrainingSummary> summaries) {
