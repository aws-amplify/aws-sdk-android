...
/**
 * List Things Result JSON Unmarshaller
 */
public class ListThingsResultJsonUnmarshaller implements Unmarshaller<ListThingsResult, JsonUnmarshallerContext> {
    ...
    public ListThingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("things")) {
                listThingsResult.setThings(new ListUnmarshaller<ThingAttribute>(ThingAttributeJsonUnmarshaller.getInstance()).unmarshall(context));
            } else 
            if (name.equals("nextToken")) {
                listThingsResult.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static ListThingsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListThingsResultJsonUnmarshaller();
        return instance;
    }
}
