...
public class ListPrincipalThingsResult implements Serializable {
     ...
     * The things.
     */
    private com.amazonaws.internal.ListWithAutoConstructFlag<String> things;
    ...
    public java.util.List<String> getThings() {
        if (things == null) {
              things = new com.amazonaws.internal.ListWithAutoConstructFlag<String>();
    ...
    public void setThings(java.util.Collection<String> things) {
        ...
        com.amazonaws.internal.ListWithAutoConstructFlag<String> thingsCopy = new com.amazonaws.internal.ListWithAutoConstructFlag<String>(things.size());
    ...
    public ListPrincipalThingsResult withThings(String... things) {
        if (getThings() == null) setThings(new java.util.ArrayList<String>(things.length));
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListPrincipalThingsResult == false) return false;
