...
/**
 * JSON unmarshaller for response ListJobExecutionsForJobResult
 */
public class ListJobExecutionsForJobResultJsonUnmarshaller implements
        Unmarshaller<ListJobExecutionsForJobResult, JsonUnmarshallerContext> {

    public ListJobExecutionsForJobResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
