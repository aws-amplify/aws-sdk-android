...
public class CreateAuthorizerRequestMarshaller implements
    ...
    public Request<CreateAuthorizerRequest> marshall(CreateAuthorizerRequest createAuthorizerRequest) {
        ...
        Request<CreateAuthorizerRequest> request = new DefaultRequest<CreateAuthorizerRequest>(
                createAuthorizerRequest, "AWSIot");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/authorizer/{authorizerName}";
        uriResourcePath = uriResourcePath.replace(
                "{authorizerName}",
                (createAuthorizerRequest.getAuthorizerName() == null) ? "" : StringUtils
                        .fromString(createAuthorizerRequest.getAuthorizerName()));
        ...
        try {
            ...
            if (createAuthorizerRequest.getTokenSigningPublicKeys() != null) {
                java.util.Map<String, String> tokenSigningPublicKeys = createAuthorizerRequest
