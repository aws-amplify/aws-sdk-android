...
/**
 * JSON request marshaller for ClearDefaultAuthorizerRequest
 */
public class ClearDefaultAuthorizerRequestMarshaller implements
        Marshaller<Request<ClearDefaultAuthorizerRequest>, ClearDefaultAuthorizerRequest> {
