...
public class MetricToRetain implements Serializable {
     ...
     *         indicate if Device Defender Detect should export the
     ...
     *            Value added in both Behavior and AdditionalMetricsToRetainV2
     *            to indicate if Device Defender Detect should export the
     *            corresponding metrics.
     *            </p>
     */
