...
public class ConflictingResourceUpdateExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("ConflictingResourceUpdateException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        ConflictingResourceUpdateException e = (ConflictingResourceUpdateException) super
                .unmarshall(error);
        e.setErrorCode("ConflictingResourceUpdateException");
