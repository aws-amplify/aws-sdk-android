...
/**
 * JSON unmarshaller for response DeleteRegistrationCodeResult
 */
public class DeleteRegistrationCodeResultJsonUnmarshaller implements
        Unmarshaller<DeleteRegistrationCodeResult, JsonUnmarshallerContext> {

    public DeleteRegistrationCodeResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
