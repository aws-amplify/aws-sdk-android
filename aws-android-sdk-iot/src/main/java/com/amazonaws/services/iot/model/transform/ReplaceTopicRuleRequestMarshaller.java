...
/**
 * Replace Topic Rule Request Marshaller
 */
public class ReplaceTopicRuleRequestMarshaller implements Marshaller<Request<ReplaceTopicRuleRequest>, ReplaceTopicRuleRequest> {
    ...
    if (replaceTopicRuleRequest == null) {
        ...
        String target = "AWSIotService.ReplaceTopicRule";
        request.addHeader("X-Amz-Target", target);

        request.setHttpMethod(HttpMethodName.PATCH);
        String uriResourcePath = "/rules/{ruleName}"; 
        uriResourcePath = uriResourcePath.replace("{ruleName}", (replaceTopicRuleRequest.getRuleName() == null) ? "" : StringUtils.fromString(replaceTopicRuleRequest.getRuleName())); 
