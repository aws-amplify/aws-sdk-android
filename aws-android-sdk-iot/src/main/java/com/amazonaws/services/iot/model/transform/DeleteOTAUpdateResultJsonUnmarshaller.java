...
/**
 * JSON unmarshaller for response DeleteOTAUpdateResult
 */
public class DeleteOTAUpdateResultJsonUnmarshaller implements
        Unmarshaller<DeleteOTAUpdateResult, JsonUnmarshallerContext> {
