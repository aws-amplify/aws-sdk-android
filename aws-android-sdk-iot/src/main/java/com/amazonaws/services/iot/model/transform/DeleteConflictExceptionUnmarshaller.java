...
public class DeleteConflictExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("DeleteConflictException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        DeleteConflictException e = (DeleteConflictException) super.unmarshall(error);
        e.setErrorCode("DeleteConflictException");
