...
/**
 * JSON marshaller for POJO RetryCriteria
 */
class RetryCriteriaJsonMarshaller {

    public void marshall(RetryCriteria retryCriteria, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (retryCriteria.getNumberOfRetries() != null) {
            ...
            jsonWriter.name("numberOfRetries");
            jsonWriter.value(numberOfRetries);
        }
