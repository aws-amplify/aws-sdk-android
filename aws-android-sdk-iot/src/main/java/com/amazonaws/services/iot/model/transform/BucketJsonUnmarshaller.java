...
/**
 * JSON unmarshaller for POJO Bucket
 */
class BucketJsonUnmarshaller implements Unmarshaller<Bucket, JsonUnmarshallerContext> {
    ...
    public Bucket unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("keyValue")) {
                bucket.setKeyValue(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("count")) {
                bucket.setCount(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
