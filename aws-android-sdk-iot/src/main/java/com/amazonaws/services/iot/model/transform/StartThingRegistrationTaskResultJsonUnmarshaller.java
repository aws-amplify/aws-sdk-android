...
/**
 * JSON unmarshaller for response StartThingRegistrationTaskResult
 */
public class StartThingRegistrationTaskResultJsonUnmarshaller implements
        Unmarshaller<StartThingRegistrationTaskResult, JsonUnmarshallerContext> {

    public StartThingRegistrationTaskResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("taskId")) {
                startThingRegistrationTaskResult.setTaskId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
