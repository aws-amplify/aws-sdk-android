...
/**
 * JSON request marshaller for CreateFleetMetricRequest
 */
public class CreateFleetMetricRequestMarshaller implements
        Marshaller<Request<CreateFleetMetricRequest>, CreateFleetMetricRequest> {

    public Request<CreateFleetMetricRequest> marshall(
            CreateFleetMetricRequest createFleetMetricRequest) {
        if (createFleetMetricRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateFleetMetricRequest)");
        }

        Request<CreateFleetMetricRequest> request = new DefaultRequest<CreateFleetMetricRequest>(
                createFleetMetricRequest, "AWSIot");
        request.setHttpMethod(HttpMethodName.PUT);

        String uriResourcePath = "/fleet-metric/{metricName}";
        uriResourcePath = uriResourcePath.replace(
                "{metricName}",
                (createFleetMetricRequest.getMetricName() == null) ? "" : StringUtils
                        .fromString(createFleetMetricRequest.getMetricName()));
        ...
        try {
            ...
            if (createFleetMetricRequest.getTags() != null) {
                java.util.List<Tag> tags = createFleetMetricRequest.getTags();
