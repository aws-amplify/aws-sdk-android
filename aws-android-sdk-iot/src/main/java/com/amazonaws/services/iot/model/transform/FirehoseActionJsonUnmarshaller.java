...
/**
 * Firehose Action JSON Unmarshaller
 */
public class FirehoseActionJsonUnmarshaller implements Unmarshaller<FirehoseAction, JsonUnmarshallerContext> {
    ...
    public FirehoseAction unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("deliveryStreamName")) {
                firehoseAction.setDeliveryStreamName(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static FirehoseActionJsonUnmarshaller getInstance() {
        if (instance == null) instance = new FirehoseActionJsonUnmarshaller();
        return instance;
    }
}
