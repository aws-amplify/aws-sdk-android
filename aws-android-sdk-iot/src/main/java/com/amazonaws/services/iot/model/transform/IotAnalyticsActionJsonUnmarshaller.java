...
/**
 * JSON unmarshaller for POJO IotAnalyticsAction
 */
class IotAnalyticsActionJsonUnmarshaller implements
        Unmarshaller<IotAnalyticsAction, JsonUnmarshallerContext> {
