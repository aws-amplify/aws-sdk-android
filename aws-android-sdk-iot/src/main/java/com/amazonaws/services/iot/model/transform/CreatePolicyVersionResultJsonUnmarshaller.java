...
/**
 * Create Policy Version Result JSON Unmarshaller
 */
public class CreatePolicyVersionResultJsonUnmarshaller implements Unmarshaller<CreatePolicyVersionResult, JsonUnmarshallerContext> {
    ...
    public CreatePolicyVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("policyArn")) {
                createPolicyVersionResult.setPolicyArn(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("policyDocument")) {
                createPolicyVersionResult.setPolicyDocument(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("policyVersionId")) {
                createPolicyVersionResult.setPolicyVersionId(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("isDefaultVersion")) {
                createPolicyVersionResult.setIsDefaultVersion(BooleanJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static CreatePolicyVersionResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CreatePolicyVersionResultJsonUnmarshaller();
        return instance;
    }
}
