...
/**
 * JSON request marshaller for CreateDynamicThingGroupRequest
 */
public class CreateDynamicThingGroupRequestMarshaller implements
        Marshaller<Request<CreateDynamicThingGroupRequest>, CreateDynamicThingGroupRequest> {

    public Request<CreateDynamicThingGroupRequest> marshall(
            CreateDynamicThingGroupRequest createDynamicThingGroupRequest) {
        if (createDynamicThingGroupRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateDynamicThingGroupRequest)");
        }

        Request<CreateDynamicThingGroupRequest> request = new DefaultRequest<CreateDynamicThingGroupRequest>(
                createDynamicThingGroupRequest, "AWSIot");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/dynamic-thing-groups/{thingGroupName}";
        uriResourcePath = uriResourcePath.replace(
                "{thingGroupName}",
                (createDynamicThingGroupRequest.getThingGroupName() == null) ? "" : StringUtils
                        .fromString(createDynamicThingGroupRequest.getThingGroupName()));
        ...
        try {
            ...
            if (createDynamicThingGroupRequest.getThingGroupProperties() != null) {
                ThingGroupProperties thingGroupProperties = createDynamicThingGroupRequest
            ...
            if (createDynamicThingGroupRequest.getTags() != null) {
                java.util.List<Tag> tags = createDynamicThingGroupRequest.getTags();
