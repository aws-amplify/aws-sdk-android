...
/**
 * Create Thing Result JSON Unmarshaller
 */
public class CreateThingResultJsonUnmarshaller implements Unmarshaller<CreateThingResult, JsonUnmarshallerContext> {
    ...
    public CreateThingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("thingName")) {
                createThingResult.setThingName(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("thingArn")) {
                createThingResult.setThingArn(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static CreateThingResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CreateThingResultJsonUnmarshaller();
        return instance;
    }
}
