...
/**
 * Container for the parameters to the {@link com.amazonaws.services.iot.AWSIot#setLoggingOptions(SetLoggingOptionsRequest) SetLoggingOptions operation}.
 * <p>
 * Sets the logging options.
 * </p>
 *
 * @see com.amazonaws.services.iot.AWSIot#setLoggingOptions(SetLoggingOptionsRequest)
 */
public class SetLoggingOptionsRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getLoggingOptionsPayload() != null) sb.append("LoggingOptionsPayload: " + getLoggingOptionsPayload() );
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SetLoggingOptionsRequest == false) return false;
        SetLoggingOptionsRequest other = (SetLoggingOptionsRequest)obj;
        
        if (other.getLoggingOptionsPayload() == null ^ this.getLoggingOptionsPayload() == null) return false;
        if (other.getLoggingOptionsPayload() != null && other.getLoggingOptionsPayload().equals(this.getLoggingOptionsPayload()) == false) return false; 
        return true;
    }
