...
public class DescribeEndpointResult implements Serializable {
     ...
     * <i>identifier</i>.iot.<i>region</i>.amazonaws.com.
     *
     * @param endpointAddress The endpoint. The format of the endpoint is as follows:
     *         <i>identifier</i>.iot.<i>region</i>.amazonaws.com.
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getEndpointAddress() != null) sb.append("EndpointAddress: " + getEndpointAddress() );
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeEndpointResult == false) return false;
        DescribeEndpointResult other = (DescribeEndpointResult)obj;
        
        if (other.getEndpointAddress() == null ^ this.getEndpointAddress() == null) return false;
        if (other.getEndpointAddress() != null && other.getEndpointAddress().equals(this.getEndpointAddress()) == false) return false; 
        return true;
    }
