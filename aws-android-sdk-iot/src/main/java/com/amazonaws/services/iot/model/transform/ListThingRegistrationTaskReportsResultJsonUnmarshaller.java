...
/**
 * JSON unmarshaller for response ListThingRegistrationTaskReportsResult
 */
public class ListThingRegistrationTaskReportsResultJsonUnmarshaller implements
        Unmarshaller<ListThingRegistrationTaskReportsResult, JsonUnmarshallerContext> {

    public ListThingRegistrationTaskReportsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
