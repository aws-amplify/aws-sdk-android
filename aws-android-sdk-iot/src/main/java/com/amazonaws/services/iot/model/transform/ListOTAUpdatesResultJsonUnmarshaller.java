...
/**
 * JSON unmarshaller for response ListOTAUpdatesResult
 */
public class ListOTAUpdatesResultJsonUnmarshaller implements
        Unmarshaller<ListOTAUpdatesResult, JsonUnmarshallerContext> {
