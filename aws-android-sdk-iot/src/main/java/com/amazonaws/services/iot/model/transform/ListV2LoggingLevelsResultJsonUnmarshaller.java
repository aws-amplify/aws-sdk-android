...
/**
 * JSON unmarshaller for response ListV2LoggingLevelsResult
 */
public class ListV2LoggingLevelsResultJsonUnmarshaller implements
        Unmarshaller<ListV2LoggingLevelsResult, JsonUnmarshallerContext> {
