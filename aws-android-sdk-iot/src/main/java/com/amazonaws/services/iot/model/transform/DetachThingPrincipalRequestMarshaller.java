...
/**
 * Detach Thing Principal Request Marshaller
 */
public class DetachThingPrincipalRequestMarshaller implements Marshaller<Request<DetachThingPrincipalRequest>, DetachThingPrincipalRequest> {
    ...
    if (detachThingPrincipalRequest == null) {
        ...
        String target = "AWSIotService.DetachThingPrincipal";
        ...
        uriResourcePath = uriResourcePath.replace("{thingName}", (detachThingPrincipalRequest.getThingName() == null) ? "" : StringUtils.fromString(detachThingPrincipalRequest.getThingName())); 
