...
/**
 * JSON unmarshaller for response DescribeAuthorizerResult
 */
public class DescribeAuthorizerResultJsonUnmarshaller implements
        Unmarshaller<DescribeAuthorizerResult, JsonUnmarshallerContext> {
