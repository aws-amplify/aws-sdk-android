...
/**
 * List Principal Things Result JSON Unmarshaller
 */
public class ListPrincipalThingsResultJsonUnmarshaller implements Unmarshaller<ListPrincipalThingsResult, JsonUnmarshallerContext> {
    ...
    public ListPrincipalThingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("things")) {
                listPrincipalThingsResult.setThings(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()).unmarshall(context));
            } else 
            if (name.equals("nextToken")) {
                listPrincipalThingsResult.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static ListPrincipalThingsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListPrincipalThingsResultJsonUnmarshaller();
        return instance;
    }
}
