...
/**
 * JSON unmarshaller for response DescribeDetectMitigationActionsTaskResult
 */
public class DescribeDetectMitigationActionsTaskResultJsonUnmarshaller implements
    ...
    public DescribeDetectMitigationActionsTaskResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("taskSummary")) {
                describeDetectMitigationActionsTaskResult
                        .setTaskSummary(DetectMitigationActionsTaskSummaryJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
