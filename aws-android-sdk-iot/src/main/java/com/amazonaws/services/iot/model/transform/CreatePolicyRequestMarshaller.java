...
public class CreatePolicyRequestMarshaller implements Marshaller<Request<CreatePolicyRequest>, CreatePolicyRequest> {
    ...
    if (createPolicyRequest == null) {
        ...
        String target = "AWSIotService.CreatePolicy";
        request.addHeader("X-Amz-Target", target);

        request.setHttpMethod(HttpMethodName.POST);
        String uriResourcePath = "/policies/{policyName}"; 
        uriResourcePath = uriResourcePath.replace("{policyName}", (createPolicyRequest.getPolicyName() == null) ? "" : StringUtils.fromString(createPolicyRequest.getPolicyName())); 
        ...
        try {
            ...
            if (createPolicyRequest.getPolicyDocument() != null) {
                jsonWriter.name("policyDocument").value(createPolicyRequest.getPolicyDocument());
            }
