...
/**
 * JSON unmarshaller for POJO RetryCriteria
 */
    ...
    public RetryCriteria unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("failureType")) {
                retryCriteria.setFailureType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("numberOfRetries")) {
                retryCriteria.setNumberOfRetries(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
