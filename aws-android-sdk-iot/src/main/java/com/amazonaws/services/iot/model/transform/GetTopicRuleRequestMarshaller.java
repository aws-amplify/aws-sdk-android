...
/**
 * Get Topic Rule Request Marshaller
 */
public class GetTopicRuleRequestMarshaller implements Marshaller<Request<GetTopicRuleRequest>, GetTopicRuleRequest> {
    ...
    if (getTopicRuleRequest == null) {
        ...
        String target = "AWSIotService.GetTopicRule";
        request.addHeader("X-Amz-Target", target);

        request.setHttpMethod(HttpMethodName.GET);
        String uriResourcePath = "/rules/{ruleName}"; 
        uriResourcePath = uriResourcePath.replace("{ruleName}", (getTopicRuleRequest.getRuleName() == null) ? "" : StringUtils.fromString(getTopicRuleRequest.getRuleName())); 
