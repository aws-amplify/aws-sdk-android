...
/**
 * JSON request marshaller for StartThingRegistrationTaskRequest
 */
public class StartThingRegistrationTaskRequestMarshaller implements
        Marshaller<Request<StartThingRegistrationTaskRequest>, StartThingRegistrationTaskRequest> {

    public Request<StartThingRegistrationTaskRequest> marshall(
            StartThingRegistrationTaskRequest startThingRegistrationTaskRequest) {
        if (startThingRegistrationTaskRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(StartThingRegistrationTaskRequest)");
        }

        Request<StartThingRegistrationTaskRequest> request = new DefaultRequest<StartThingRegistrationTaskRequest>(
                startThingRegistrationTaskRequest, "AWSIot");
