...
/**
 * Republish Action JSON Unmarshaller
 */
public class RepublishActionJsonUnmarshaller implements Unmarshaller<RepublishAction, JsonUnmarshallerContext> {
    ...
    public RepublishAction unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("roleArn")) {
                republishAction.setRoleArn(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
    ...
    public static RepublishActionJsonUnmarshaller getInstance() {
        if (instance == null) instance = new RepublishActionJsonUnmarshaller();
        return instance;
    }
}
