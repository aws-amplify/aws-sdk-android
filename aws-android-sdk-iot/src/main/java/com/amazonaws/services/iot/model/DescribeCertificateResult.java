...
public class DescribeCertificateResult implements Serializable {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getCertificateDescription() != null) sb.append("CertificateDescription: " + getCertificateDescription() );
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeCertificateResult == false) return false;
        DescribeCertificateResult other = (DescribeCertificateResult)obj;
        
        if (other.getCertificateDescription() == null ^ this.getCertificateDescription() == null) return false;
        if (other.getCertificateDescription() != null && other.getCertificateDescription().equals(this.getCertificateDescription()) == false) return false; 
        return true;
    }
