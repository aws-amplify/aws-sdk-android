...
/**
 * JSON request marshaller for UpdateIndexingConfigurationRequest
 */
public class UpdateIndexingConfigurationRequestMarshaller implements
        Marshaller<Request<UpdateIndexingConfigurationRequest>, UpdateIndexingConfigurationRequest> {

    public Request<UpdateIndexingConfigurationRequest> marshall(
            UpdateIndexingConfigurationRequest updateIndexingConfigurationRequest) {
        if (updateIndexingConfigurationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateIndexingConfigurationRequest)");
        }

        Request<UpdateIndexingConfigurationRequest> request = new DefaultRequest<UpdateIndexingConfigurationRequest>(
                updateIndexingConfigurationRequest, "AWSIot");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/indexing/config";
        ...
        try {
            ...
            if (updateIndexingConfigurationRequest.getThingIndexingConfiguration() != null) {
                ThingIndexingConfiguration thingIndexingConfiguration = updateIndexingConfigurationRequest
