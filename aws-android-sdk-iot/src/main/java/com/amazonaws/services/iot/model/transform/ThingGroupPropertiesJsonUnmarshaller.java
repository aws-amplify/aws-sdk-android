...
/**
 * JSON unmarshaller for POJO ThingGroupProperties
 */
class ThingGroupPropertiesJsonUnmarshaller implements
        Unmarshaller<ThingGroupProperties, JsonUnmarshallerContext> {
    ...
    public ThingGroupProperties unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("thingGroupDescription")) {
                thingGroupProperties.setThingGroupDescription(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
