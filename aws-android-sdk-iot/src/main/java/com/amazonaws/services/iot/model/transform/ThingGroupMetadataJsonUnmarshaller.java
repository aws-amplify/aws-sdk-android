...
/**
 * JSON unmarshaller for POJO ThingGroupMetadata
 */
class ThingGroupMetadataJsonUnmarshaller implements
        Unmarshaller<ThingGroupMetadata, JsonUnmarshallerContext> {
    ...
    public ThingGroupMetadata unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("parentGroupName")) {
                thingGroupMetadata.setParentGroupName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
