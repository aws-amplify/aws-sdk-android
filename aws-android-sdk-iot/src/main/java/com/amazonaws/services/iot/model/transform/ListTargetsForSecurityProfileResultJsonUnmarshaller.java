...
/**
 * JSON unmarshaller for response ListTargetsForSecurityProfileResult
 */
public class ListTargetsForSecurityProfileResultJsonUnmarshaller implements
        Unmarshaller<ListTargetsForSecurityProfileResult, JsonUnmarshallerContext> {

    public ListTargetsForSecurityProfileResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
