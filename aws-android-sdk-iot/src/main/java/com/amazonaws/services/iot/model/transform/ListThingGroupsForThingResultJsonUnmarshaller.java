...
/**
 * JSON unmarshaller for response ListThingGroupsForThingResult
 */
public class ListThingGroupsForThingResultJsonUnmarshaller implements
        Unmarshaller<ListThingGroupsForThingResult, JsonUnmarshallerContext> {

    public ListThingGroupsForThingResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
