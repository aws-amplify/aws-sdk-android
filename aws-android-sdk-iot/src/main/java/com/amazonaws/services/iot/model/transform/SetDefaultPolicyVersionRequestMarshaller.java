...
/**
 * JSON request marshaller for SetDefaultPolicyVersionRequest
 */
public class SetDefaultPolicyVersionRequestMarshaller implements
    ...
    public Request<SetDefaultPolicyVersionRequest> marshall(
        ...
        uriResourcePath = uriResourcePath.replace(
                "{policyName}",
                (setDefaultPolicyVersionRequest.getPolicyName() == null) ? "" : StringUtils
                        .fromString(setDefaultPolicyVersionRequest.getPolicyName()));
        uriResourcePath = uriResourcePath.replace(
                "{policyVersionId}",
                (setDefaultPolicyVersionRequest.getPolicyVersionId() == null) ? "" : StringUtils
                        .fromString(setDefaultPolicyVersionRequest.getPolicyVersionId()));
