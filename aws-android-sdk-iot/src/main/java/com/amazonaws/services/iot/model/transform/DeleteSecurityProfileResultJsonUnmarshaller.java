...
/**
 * JSON unmarshaller for response DeleteSecurityProfileResult
 */
public class DeleteSecurityProfileResultJsonUnmarshaller implements
        Unmarshaller<DeleteSecurityProfileResult, JsonUnmarshallerContext> {
