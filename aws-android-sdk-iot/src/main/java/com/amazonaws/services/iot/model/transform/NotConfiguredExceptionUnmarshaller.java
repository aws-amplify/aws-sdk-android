...
public class NotConfiguredExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("NotConfiguredException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        NotConfiguredException e = (NotConfiguredException) super.unmarshall(error);
        e.setErrorCode("NotConfiguredException");
