...
/**
 * JSON request marshaller for UpdateProvisioningTemplateRequest
 */
public class UpdateProvisioningTemplateRequestMarshaller implements
        Marshaller<Request<UpdateProvisioningTemplateRequest>, UpdateProvisioningTemplateRequest> {

    public Request<UpdateProvisioningTemplateRequest> marshall(
            UpdateProvisioningTemplateRequest updateProvisioningTemplateRequest) {
        if (updateProvisioningTemplateRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateProvisioningTemplateRequest)");
        }

        Request<UpdateProvisioningTemplateRequest> request = new DefaultRequest<UpdateProvisioningTemplateRequest>(
                updateProvisioningTemplateRequest, "AWSIot");
        request.setHttpMethod(HttpMethodName.PATCH);

        String uriResourcePath = "/provisioning-templates/{templateName}";
        uriResourcePath = uriResourcePath.replace(
                "{templateName}",
                (updateProvisioningTemplateRequest.getTemplateName() == null) ? "" : StringUtils
                        .fromString(updateProvisioningTemplateRequest.getTemplateName()));
        ...
        try {
            ...
            if (updateProvisioningTemplateRequest.getDefaultVersionId() != null) {
                ...
                jsonWriter.name("defaultVersionId");
                jsonWriter.value(defaultVersionId);
            }
            if (updateProvisioningTemplateRequest.getProvisioningRoleArn() != null) {
                String provisioningRoleArn = updateProvisioningTemplateRequest
