 ...
 * </p>
 */
public class VpcDestinationSummary implements Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public VpcDestinationSummary withSubnetIds(java.util.Collection<String> subnetIds) {
     ...
     *         chained together.
     */
    public VpcDestinationSummary withSecurityGroups(java.util.Collection<String> securityGroups) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VpcDestinationSummary == false)
            return false;
        VpcDestinationSummary other = (VpcDestinationSummary) obj;
