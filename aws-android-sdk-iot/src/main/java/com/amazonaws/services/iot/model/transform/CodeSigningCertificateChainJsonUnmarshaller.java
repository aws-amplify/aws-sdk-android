...
/**
 * JSON unmarshaller for POJO CodeSigningCertificateChain
 */
class CodeSigningCertificateChainJsonUnmarshaller implements
        Unmarshaller<CodeSigningCertificateChain, JsonUnmarshallerContext> {
    ...
    public CodeSigningCertificateChain unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("certificateName")) {
                ...
                codeSigningCertificateChain.setInlineDocument(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
