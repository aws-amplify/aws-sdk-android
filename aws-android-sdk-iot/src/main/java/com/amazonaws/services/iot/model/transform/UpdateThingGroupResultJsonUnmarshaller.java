...
/**
 * JSON unmarshaller for response UpdateThingGroupResult
 */
public class UpdateThingGroupResultJsonUnmarshaller implements
        Unmarshaller<UpdateThingGroupResult, JsonUnmarshallerContext> {
