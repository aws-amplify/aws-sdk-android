...
/**
 * List Principal Policies Result JSON Unmarshaller
 */
public class ListPrincipalPoliciesResultJsonUnmarshaller implements Unmarshaller<ListPrincipalPoliciesResult, JsonUnmarshallerContext> {
    ...
    public ListPrincipalPoliciesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("nextMarker")) {
                listPrincipalPoliciesResult.setNextMarker(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static ListPrincipalPoliciesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListPrincipalPoliciesResultJsonUnmarshaller();
        return instance;
    }
}
