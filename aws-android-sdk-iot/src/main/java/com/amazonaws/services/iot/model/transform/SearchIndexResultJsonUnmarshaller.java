...
/**
 * JSON unmarshaller for response SearchIndexResult
 */
public class SearchIndexResultJsonUnmarshaller implements
        Unmarshaller<SearchIndexResult, JsonUnmarshallerContext> {
