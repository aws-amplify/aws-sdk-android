...
/**
 * JSON unmarshaller for POJO OpenSearchAction
 */
class OpenSearchActionJsonUnmarshaller implements
        Unmarshaller<OpenSearchAction, JsonUnmarshallerContext> {
    ...
    public OpenSearchAction unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("roleArn")) {
                openSearchAction.setRoleArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("endpoint")) {
                openSearchAction.setEndpoint(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("index")) {
                openSearchAction.setIndex(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("type")) {
                openSearchAction.setType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("id")) {
                openSearchAction.setId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
