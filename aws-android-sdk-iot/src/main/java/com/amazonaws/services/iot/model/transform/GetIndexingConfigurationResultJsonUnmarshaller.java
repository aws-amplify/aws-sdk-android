...
/**
 * JSON unmarshaller for response GetIndexingConfigurationResult
 */
public class GetIndexingConfigurationResultJsonUnmarshaller implements
        Unmarshaller<GetIndexingConfigurationResult, JsonUnmarshallerContext> {

    public GetIndexingConfigurationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
