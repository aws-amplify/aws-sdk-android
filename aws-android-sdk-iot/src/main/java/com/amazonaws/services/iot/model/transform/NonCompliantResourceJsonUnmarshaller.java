...
/**
 * JSON unmarshaller for POJO NonCompliantResource
 */
class NonCompliantResourceJsonUnmarshaller implements
        Unmarshaller<NonCompliantResource, JsonUnmarshallerContext> {
    ...
    public NonCompliantResource unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("resourceType")) {
                nonCompliantResource.setResourceType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
