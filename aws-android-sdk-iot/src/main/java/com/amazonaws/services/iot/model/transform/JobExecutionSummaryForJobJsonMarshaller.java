...
/**
 * JSON marshaller for POJO JobExecutionSummaryForJob
 */
class JobExecutionSummaryForJobJsonMarshaller {

    public void marshall(JobExecutionSummaryForJob jobExecutionSummaryForJob,
        ...
        if (jobExecutionSummaryForJob.getJobExecutionSummary() != null) {
            JobExecutionSummary jobExecutionSummary = jobExecutionSummaryForJob
