...
/**
 * JSON unmarshaller for POJO AwsJobExponentialRolloutRate
 */
class AwsJobExponentialRolloutRateJsonUnmarshaller implements
        Unmarshaller<AwsJobExponentialRolloutRate, JsonUnmarshallerContext> {
    ...
    public AwsJobExponentialRolloutRate unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("baseRatePerMinute")) {
                awsJobExponentialRolloutRate.setBaseRatePerMinute(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("incrementFactor")) {
                awsJobExponentialRolloutRate.setIncrementFactor(DoubleJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("rateIncreaseCriteria")) {
                awsJobExponentialRolloutRate
                        .setRateIncreaseCriteria(AwsJobRateIncreaseCriteriaJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
