...
/**
 * JSON request marshaller for RejectCertificateTransferRequest
 */
public class RejectCertificateTransferRequestMarshaller implements
    ...
    public Request<RejectCertificateTransferRequest> marshall(
        ...
        if (rejectCertificateTransferRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RejectCertificateTransferRequest)");
        }
        ...
        uriResourcePath = uriResourcePath.replace(
                ...
                (rejectCertificateTransferRequest.getCertificateId() == null) ? "" : StringUtils
                        .fromString(rejectCertificateTransferRequest.getCertificateId()));
