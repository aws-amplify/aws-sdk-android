...
public class GetPolicyVersionRequestMarshaller implements Marshaller<Request<GetPolicyVersionRequest>, GetPolicyVersionRequest> {
    ...
    if (getPolicyVersionRequest == null) {
        ...
        String target = "AWSIotService.GetPolicyVersion";
        request.addHeader("X-Amz-Target", target);

        request.setHttpMethod(HttpMethodName.GET);
        String uriResourcePath = "/policies/{policyName}/version/{policyVersionId}"; 
        uriResourcePath = uriResourcePath.replace("{policyName}", (getPolicyVersionRequest.getPolicyName() == null) ? "" : StringUtils.fromString(getPolicyVersionRequest.getPolicyName())); 
        uriResourcePath = uriResourcePath.replace("{policyVersionId}", (getPolicyVersionRequest.getPolicyVersionId() == null) ? "" : StringUtils.fromString(getPolicyVersionRequest.getPolicyVersionId())); 
