...
/**
 * JSON unmarshaller for POJO JobExecutionSummary
 */
class JobExecutionSummaryJsonUnmarshaller implements
        Unmarshaller<JobExecutionSummary, JsonUnmarshallerContext> {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("status")) {
                ...
                jobExecutionSummary.setExecutionNumber(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("retryAttempt")) {
                jobExecutionSummary.setRetryAttempt(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
