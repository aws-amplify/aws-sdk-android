...
/**
 * Thing Attribute JSON Unmarshaller
 */
public class ThingAttributeJsonUnmarshaller implements Unmarshaller<ThingAttribute, JsonUnmarshallerContext> {
    ...
    public ThingAttribute unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("attributes")) {
                thingAttribute.setAttributes(new MapUnmarshaller<String>(StringJsonUnmarshaller.getInstance()).unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static ThingAttributeJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ThingAttributeJsonUnmarshaller();
        return instance;
    }
}
