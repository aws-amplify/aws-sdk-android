...
/**
 * JSON unmarshaller for POJO CodeSigningSignature
 */
class CodeSigningSignatureJsonUnmarshaller implements
        Unmarshaller<CodeSigningSignature, JsonUnmarshallerContext> {
