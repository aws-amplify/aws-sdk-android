...
/**
 * List Thing Principals Result JSON Unmarshaller
 */
public class ListThingPrincipalsResultJsonUnmarshaller implements Unmarshaller<ListThingPrincipalsResult, JsonUnmarshallerContext> {
    ...
    public ListThingPrincipalsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("principals")) {
                listThingPrincipalsResult.setPrincipals(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()).unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static ListThingPrincipalsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListThingPrincipalsResultJsonUnmarshaller();
        return instance;
    }
}
