...
/**
 * Enable Topic Rule Request Marshaller
 */
public class EnableTopicRuleRequestMarshaller implements Marshaller<Request<EnableTopicRuleRequest>, EnableTopicRuleRequest> {
    ...
    if (enableTopicRuleRequest == null) {
        ...
        String target = "AWSIotService.EnableTopicRule";
        request.addHeader("X-Amz-Target", target);

        request.setHttpMethod(HttpMethodName.POST);
        String uriResourcePath = "/rules/{ruleName}/enable"; 
        uriResourcePath = uriResourcePath.replace("{ruleName}", (enableTopicRuleRequest.getRuleName() == null) ? "" : StringUtils.fromString(enableTopicRuleRequest.getRuleName())); 
