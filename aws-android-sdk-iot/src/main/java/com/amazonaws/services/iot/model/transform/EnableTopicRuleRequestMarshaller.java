...
/**
 * JSON request marshaller for EnableTopicRuleRequest
 */
    ...
    public Request<EnableTopicRuleRequest> marshall(EnableTopicRuleRequest enableTopicRuleRequest) {
        if (enableTopicRuleRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(EnableTopicRuleRequest)");
        }

        Request<EnableTopicRuleRequest> request = new DefaultRequest<EnableTopicRuleRequest>(
                enableTopicRuleRequest, "AWSIot");
