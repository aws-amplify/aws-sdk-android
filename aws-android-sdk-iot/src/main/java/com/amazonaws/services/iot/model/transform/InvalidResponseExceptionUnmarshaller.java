...
public class InvalidResponseExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InvalidResponseException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        InvalidResponseException e = (InvalidResponseException) super.unmarshall(error);
        e.setErrorCode("InvalidResponseException");
