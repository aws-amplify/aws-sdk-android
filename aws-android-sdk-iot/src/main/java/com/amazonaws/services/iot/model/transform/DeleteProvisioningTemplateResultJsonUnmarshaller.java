...
/**
 * JSON unmarshaller for response DeleteProvisioningTemplateResult
 */
public class DeleteProvisioningTemplateResultJsonUnmarshaller implements
        Unmarshaller<DeleteProvisioningTemplateResult, JsonUnmarshallerContext> {

    public DeleteProvisioningTemplateResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
