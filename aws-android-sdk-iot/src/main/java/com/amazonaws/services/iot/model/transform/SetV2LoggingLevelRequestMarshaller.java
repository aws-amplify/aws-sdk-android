...
/**
 * JSON request marshaller for SetV2LoggingLevelRequest
 */
public class SetV2LoggingLevelRequestMarshaller implements
        Marshaller<Request<SetV2LoggingLevelRequest>, SetV2LoggingLevelRequest> {

    public Request<SetV2LoggingLevelRequest> marshall(
            SetV2LoggingLevelRequest setV2LoggingLevelRequest) {
        if (setV2LoggingLevelRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(SetV2LoggingLevelRequest)");
        }

        Request<SetV2LoggingLevelRequest> request = new DefaultRequest<SetV2LoggingLevelRequest>(
                setV2LoggingLevelRequest, "AWSIot");
