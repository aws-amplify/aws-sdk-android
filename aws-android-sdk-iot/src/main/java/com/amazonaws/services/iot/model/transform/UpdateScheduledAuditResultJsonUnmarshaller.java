...
/**
 * JSON unmarshaller for response UpdateScheduledAuditResult
 */
public class UpdateScheduledAuditResultJsonUnmarshaller implements
        Unmarshaller<UpdateScheduledAuditResult, JsonUnmarshallerContext> {
