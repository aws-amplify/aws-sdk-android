...
/**
 * Describe Thing Result JSON Unmarshaller
 */
public class DescribeThingResultJsonUnmarshaller implements Unmarshaller<DescribeThingResult, JsonUnmarshallerContext> {
    ...
    public DescribeThingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("defaultClientId")) {
                describeThingResult.setDefaultClientId(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("thingName")) {
                describeThingResult.setThingName(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("attributes")) {
                describeThingResult.setAttributes(new MapUnmarshaller<String>(StringJsonUnmarshaller.getInstance()).unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static DescribeThingResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeThingResultJsonUnmarshaller();
        return instance;
    }
}
