...
/**
 * List Policies Result JSON Unmarshaller
 */
public class ListPoliciesResultJsonUnmarshaller implements Unmarshaller<ListPoliciesResult, JsonUnmarshallerContext> {
    ...
    public ListPoliciesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("nextMarker")) {
                listPoliciesResult.setNextMarker(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static ListPoliciesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListPoliciesResultJsonUnmarshaller();
        return instance;
    }
}
