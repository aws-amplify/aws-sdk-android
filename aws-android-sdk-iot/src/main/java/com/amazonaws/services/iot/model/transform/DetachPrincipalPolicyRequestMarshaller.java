...
/**
 * JSON request marshaller for DetachPrincipalPolicyRequest
 */
public class DetachPrincipalPolicyRequestMarshaller implements
    ...
    public Request<DetachPrincipalPolicyRequest> marshall(
        ...
        if (detachPrincipalPolicyRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DetachPrincipalPolicyRequest)");
        }
        ...
        uriResourcePath = uriResourcePath.replace(
                ...
                (detachPrincipalPolicyRequest.getPolicyName() == null) ? "" : StringUtils
                        .fromString(detachPrincipalPolicyRequest.getPolicyName()));
