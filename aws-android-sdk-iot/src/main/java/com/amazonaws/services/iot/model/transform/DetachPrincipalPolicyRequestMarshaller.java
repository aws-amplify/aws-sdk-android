...
/**
 * Detach Principal Policy Request Marshaller
 */
public class DetachPrincipalPolicyRequestMarshaller implements Marshaller<Request<DetachPrincipalPolicyRequest>, DetachPrincipalPolicyRequest> {
    ...
    if (detachPrincipalPolicyRequest == null) {
        ...
        String target = "AWSIotService.DetachPrincipalPolicy";
        ...
        uriResourcePath = uriResourcePath.replace("{policyName}", (detachPrincipalPolicyRequest.getPolicyName() == null) ? "" : StringUtils.fromString(detachPrincipalPolicyRequest.getPolicyName())); 
