...
/**
 * JSON unmarshaller for POJO SigningProfileParameter
 */
class SigningProfileParameterJsonUnmarshaller implements
        Unmarshaller<SigningProfileParameter, JsonUnmarshallerContext> {
    ...
    public SigningProfileParameter unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("certificateArn")) {
                signingProfileParameter.setCertificateArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("platform")) {
                signingProfileParameter.setPlatform(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
