...
/**
 * JSON request marshaller for UpdateThingGroupRequest
 */
public class UpdateThingGroupRequestMarshaller implements
        Marshaller<Request<UpdateThingGroupRequest>, UpdateThingGroupRequest> {
    ...
    public Request<UpdateThingGroupRequest> marshall(UpdateThingGroupRequest updateThingGroupRequest) {
        if (updateThingGroupRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateThingGroupRequest)");
        }

        Request<UpdateThingGroupRequest> request = new DefaultRequest<UpdateThingGroupRequest>(
                updateThingGroupRequest, "AWSIot");
        request.setHttpMethod(HttpMethodName.PATCH);

        String uriResourcePath = "/thing-groups/{thingGroupName}";
        uriResourcePath = uriResourcePath.replace(
                "{thingGroupName}",
                (updateThingGroupRequest.getThingGroupName() == null) ? "" : StringUtils
                        .fromString(updateThingGroupRequest.getThingGroupName()));
        ...
        try {
            ...
            if (updateThingGroupRequest.getThingGroupProperties() != null) {
                ThingGroupProperties thingGroupProperties = updateThingGroupRequest
