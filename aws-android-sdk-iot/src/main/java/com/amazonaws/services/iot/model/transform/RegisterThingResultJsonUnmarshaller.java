...
/**
 * JSON unmarshaller for response RegisterThingResult
 */
public class RegisterThingResultJsonUnmarshaller implements
        Unmarshaller<RegisterThingResult, JsonUnmarshallerContext> {
    ...
    public RegisterThingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("certificatePem")) {
                registerThingResult.setCertificatePem(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
