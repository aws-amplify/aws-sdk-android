...
/**
 * Delete Thing Shadow Request Marshaller
 */
public class DeleteThingShadowRequestMarshaller implements Marshaller<Request<DeleteThingShadowRequest>, DeleteThingShadowRequest> {
    ...
    if (deleteThingShadowRequest == null) {
        ...
        String target = "IotMoonrakerService.DeleteThingShadow";
        request.addHeader("X-Amz-Target", target);

        request.setHttpMethod(HttpMethodName.DELETE);
        String uriResourcePath = "/things/{thingName}/shadow"; 
        uriResourcePath = uriResourcePath.replace("{thingName}", (deleteThingShadowRequest.getThingName() == null) ? "" : StringUtils.fromString(deleteThingShadowRequest.getThingName())); 
