...
/**
 * Update Thing Shadow Request Marshaller
 */
public class UpdateThingShadowRequestMarshaller implements Marshaller<Request<UpdateThingShadowRequest>, UpdateThingShadowRequest> {
    ...
    if (updateThingShadowRequest == null) {
        ...
        String target = "IotMoonrakerService.UpdateThingShadow";
        request.addHeader("X-Amz-Target", target);

        request.setHttpMethod(HttpMethodName.POST);
        String uriResourcePath = "/things/{thingName}/shadow"; 
        uriResourcePath = uriResourcePath.replace("{thingName}", (updateThingShadowRequest.getThingName() == null) ? "" : StringUtils.fromString(updateThingShadowRequest.getThingName())); 
        ...
        request.addHeader("Content-Length", Integer.toString(updateThingShadowRequest.getPayload().remaining()));
