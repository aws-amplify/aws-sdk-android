...
/**
 * JSON unmarshaller for response SetRepositoryPolicyResult
 */
    ...
    public SetRepositoryPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("registryId")) {
                setRepositoryPolicyResult.setRegistryId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("repositoryName")) {
                setRepositoryPolicyResult.setRepositoryName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("policyText")) {
                setRepositoryPolicyResult.setPolicyText(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
