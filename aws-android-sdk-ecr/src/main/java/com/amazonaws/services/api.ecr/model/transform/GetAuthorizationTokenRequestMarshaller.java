...
public class GetAuthorizationTokenRequestMarshaller implements
    ...
    public Request<GetAuthorizationTokenRequest> marshall(
        ...
        Request<GetAuthorizationTokenRequest> request = new DefaultRequest<GetAuthorizationTokenRequest>(
                getAuthorizationTokenRequest, "AmazonEC2ContainerRegistry");
        ...
        try {
            ...
            if (getAuthorizationTokenRequest.getRegistryIds() != null) {
                java.util.List<String> registryIds = getAuthorizationTokenRequest.getRegistryIds();
                jsonWriter.name("registryIds");
                jsonWriter.beginArray();
                for (String registryIdsItem : registryIds) {
                    if (registryIdsItem != null) {
                        jsonWriter.value(registryIdsItem);
                    }
                }
                jsonWriter.endArray();
            }
