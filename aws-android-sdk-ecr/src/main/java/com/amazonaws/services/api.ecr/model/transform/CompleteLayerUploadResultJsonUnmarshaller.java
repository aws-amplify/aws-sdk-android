...
/**
 * JSON unmarshaller for response CompleteLayerUploadResult
 */
    ...
    public CompleteLayerUploadResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("registryId")) {
                completeLayerUploadResult.setRegistryId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("repositoryName")) {
                completeLayerUploadResult.setRepositoryName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("uploadId")) {
                completeLayerUploadResult.setUploadId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("layerDigest")) {
                completeLayerUploadResult.setLayerDigest(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
