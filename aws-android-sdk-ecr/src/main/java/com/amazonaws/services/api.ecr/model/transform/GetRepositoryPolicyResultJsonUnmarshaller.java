...
/**
 * JSON unmarshaller for response GetRepositoryPolicyResult
 */
public class GetRepositoryPolicyResultJsonUnmarshaller implements
        Unmarshaller<GetRepositoryPolicyResult, JsonUnmarshallerContext> {
    ...
    public GetRepositoryPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("registryId")) {
                getRepositoryPolicyResult.setRegistryId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("repositoryName")) {
                getRepositoryPolicyResult.setRepositoryName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("policyText")) {
                getRepositoryPolicyResult.setPolicyText(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
