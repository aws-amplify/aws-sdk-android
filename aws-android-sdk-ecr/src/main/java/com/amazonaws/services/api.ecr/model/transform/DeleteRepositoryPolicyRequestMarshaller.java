...
/**
 * JSON request marshaller for DeleteRepositoryPolicyRequest
 */
public class DeleteRepositoryPolicyRequestMarshaller implements
    ...
    public Request<DeleteRepositoryPolicyRequest> marshall(
        ...
        if (deleteRepositoryPolicyRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteRepositoryPolicyRequest)");
        }

        Request<DeleteRepositoryPolicyRequest> request = new DefaultRequest<DeleteRepositoryPolicyRequest>(
                deleteRepositoryPolicyRequest, "AmazonEC2ContainerRegistry");
        ...
        try {
            ...
            if (deleteRepositoryPolicyRequest.getRegistryId() != null) {
                String registryId = deleteRepositoryPolicyRequest.getRegistryId();
                jsonWriter.name("registryId");
                jsonWriter.value(registryId);
            }
            if (deleteRepositoryPolicyRequest.getRepositoryName() != null) {
                String repositoryName = deleteRepositoryPolicyRequest.getRepositoryName();
