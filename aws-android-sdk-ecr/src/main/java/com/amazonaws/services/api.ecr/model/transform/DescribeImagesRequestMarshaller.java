...
public class DescribeImagesRequestMarshaller implements
    ...
    public Request<DescribeImagesRequest> marshall(DescribeImagesRequest describeImagesRequest) {
        ...
        Request<DescribeImagesRequest> request = new DefaultRequest<DescribeImagesRequest>(
                describeImagesRequest, "AmazonEC2ContainerRegistry");
        ...
        try {
            ...
            if (describeImagesRequest.getNextToken() != null) {
                String nextToken = describeImagesRequest.getNextToken();
                jsonWriter.name("nextToken");
                jsonWriter.value(nextToken);
            }
            if (describeImagesRequest.getMaxResults() != null) {
                Integer maxResults = describeImagesRequest.getMaxResults();
                jsonWriter.name("maxResults");
                jsonWriter.value(maxResults);
            }
            if (describeImagesRequest.getFilter() != null) {
                DescribeImagesFilter filter = describeImagesRequest.getFilter();
                jsonWriter.name("filter");
                DescribeImagesFilterJsonMarshaller.getInstance().marshall(filter, jsonWriter);
            }
