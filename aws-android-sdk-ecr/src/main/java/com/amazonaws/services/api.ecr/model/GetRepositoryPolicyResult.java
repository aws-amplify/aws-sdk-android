...
public class GetRepositoryPolicyResult implements Serializable {
    /**
     ...
     * <b>Length: </b>0 - 10240<br/>
     *
     * @return <p>The JSON repository policy text associated with the repository.</p>
     */
     ...
     * <b>Length: </b>0 - 10240<br/>
     *
     * @param policyText <p>The JSON repository policy text associated with the repository.</p>
     */
