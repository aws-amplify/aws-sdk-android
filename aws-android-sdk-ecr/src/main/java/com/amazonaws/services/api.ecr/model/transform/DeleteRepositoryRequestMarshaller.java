...
public class DeleteRepositoryRequestMarshaller implements
    ...
    public Request<DeleteRepositoryRequest> marshall(DeleteRepositoryRequest deleteRepositoryRequest) {
        ...
        Request<DeleteRepositoryRequest> request = new DefaultRequest<DeleteRepositoryRequest>(
                deleteRepositoryRequest, "AmazonEC2ContainerRegistry");
