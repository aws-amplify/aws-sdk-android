...
/**
 * JSON unmarshaller for POJO Layer
 */
class LayerJsonUnmarshaller implements Unmarshaller<Layer, JsonUnmarshallerContext> {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("layerDigest")) {
                layer.setLayerDigest(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("layerAvailability")) {
                layer.setLayerAvailability(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("layerSize")) {
                layer.setLayerSize(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("mediaType")) {
                layer.setMediaType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
