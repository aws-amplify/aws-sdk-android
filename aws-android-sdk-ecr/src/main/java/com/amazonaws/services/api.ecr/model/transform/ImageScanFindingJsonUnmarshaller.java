...
/**
 * JSON unmarshaller for POJO ImageScanFinding
 */
class ImageScanFindingJsonUnmarshaller implements
        Unmarshaller<ImageScanFinding, JsonUnmarshallerContext> {
    ...
    public ImageScanFinding unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("name")) {
                imageScanFinding.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("description")) {
                imageScanFinding.setDescription(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("uri")) {
                imageScanFinding.setUri(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("severity")) {
                imageScanFinding.setSeverity(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("attributes")) {
                imageScanFinding.setAttributes(new ListUnmarshaller<Attribute>(
