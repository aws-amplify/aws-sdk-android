...
/**
 * JSON unmarshaller for response DescribeRepositoriesResult
 */
public class DescribeRepositoriesResultJsonUnmarshaller implements
        Unmarshaller<DescribeRepositoriesResult, JsonUnmarshallerContext> {
    ...
    public DescribeRepositoriesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("repositories")) {
                describeRepositoriesResult.setRepositories(new ListUnmarshaller<Repository>(
                        RepositoryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                describeRepositoriesResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
