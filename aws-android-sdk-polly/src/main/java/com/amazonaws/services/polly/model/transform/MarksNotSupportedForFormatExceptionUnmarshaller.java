...
public class MarksNotSupportedForFormatExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("MarksNotSupportedForFormatException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        MarksNotSupportedForFormatException e = (MarksNotSupportedForFormatException) super
                .unmarshall(error);
        e.setErrorCode("MarksNotSupportedForFormatException");
