...
/**
 * JSON unmarshaller for response ListLexiconsResult
 */
public class ListLexiconsResultJsonUnmarshaller implements
        Unmarshaller<ListLexiconsResult, JsonUnmarshallerContext> {
