...
/**
 * JSON unmarshaller for response DeleteLexiconResult
 */
public class DeleteLexiconResultJsonUnmarshaller implements
        Unmarshaller<DeleteLexiconResult, JsonUnmarshallerContext> {
