...
/**
 * JSON unmarshaller for POJO VpcConfigOutput
 */
class VpcConfigOutputJsonUnmarshaller implements
        Unmarshaller<VpcConfigOutput, JsonUnmarshallerContext> {
    ...
    public VpcConfigOutput unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("VpcId")) {
                vpcConfigOutput.setVpcId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("SubnetIds")) {
                vpcConfigOutput.setSubnetIds(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("SecurityGroupIds")) {
                vpcConfigOutput.setSecurityGroupIds(new ListUnmarshaller<String>(
