...
/**
 * JSON unmarshaller for POJO CanaryLastRun
 */
class CanaryLastRunJsonUnmarshaller implements Unmarshaller<CanaryLastRun, JsonUnmarshallerContext> {
    ...
    public CanaryLastRun unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("CanaryName")) {
                canaryLastRun.setCanaryName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("LastRun")) {
                canaryLastRun.setLastRun(CanaryRunJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
