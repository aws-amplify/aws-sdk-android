 ...
 * </p>
 */
public class CanaryScheduleInput implements Serializable {
    /**
     * <p>
     ...
     * frequency between <code>rate(1 minute)</code> and
     ...
     *         You can specify a frequency between <code>rate(1 minute)</code>
     ...
     *            hour. You can specify a frequency between
     ...
     *         runs according to the schedule in the <code>Expression</code>
     *         value. If you specify 0, the canary continues making runs until
     *         you stop it. If you omit this field, the default of 0 is used.
     *         </p>
     */
     ...
     *            regular runs according to the schedule in the
     *            <code>Expression</code> value. If you specify 0, the canary
     *            continues making runs until you stop it. If you omit this
