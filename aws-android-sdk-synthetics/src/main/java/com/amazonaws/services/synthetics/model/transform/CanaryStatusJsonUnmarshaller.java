...
/**
 * JSON unmarshaller for POJO CanaryStatus
 */
class CanaryStatusJsonUnmarshaller implements Unmarshaller<CanaryStatus, JsonUnmarshallerContext> {
    ...
    public CanaryStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("State")) {
                canaryStatus.setState(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("StateReason")) {
                canaryStatus.setStateReason(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("StateReasonCode")) {
                canaryStatus.setStateReasonCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
