...
public enum CanaryStateReasonCode {
    ...
    private static final Map<String, CanaryStateReasonCode> enumMap;
    static {
        enumMap = new HashMap<String, CanaryStateReasonCode>();
        enumMap.put("INVALID_PERMISSIONS", INVALID_PERMISSIONS);
    }
