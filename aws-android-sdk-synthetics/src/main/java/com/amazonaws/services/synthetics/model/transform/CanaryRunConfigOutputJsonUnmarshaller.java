...
/**
 * JSON unmarshaller for POJO CanaryRunConfigOutput
 */
class CanaryRunConfigOutputJsonUnmarshaller implements
        Unmarshaller<CanaryRunConfigOutput, JsonUnmarshallerContext> {
    ...
    public CanaryRunConfigOutput unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("TimeoutInSeconds")) {
                canaryRunConfigOutput.setTimeoutInSeconds(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("MemoryInMB")) {
                canaryRunConfigOutput.setMemoryInMB(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
