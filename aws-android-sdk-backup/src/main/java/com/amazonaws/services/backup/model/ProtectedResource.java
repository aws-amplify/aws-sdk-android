...
public class ProtectedResource implements Serializable {
     ...
     *
     * @return <p>
     *         The type of AWS resource; for example, an Amazon Elastic Block
     *         Store (Amazon EBS) volume or an Amazon Relational Database
     ...
     *            The date and time a resource was last backed up, in Unix
