...
class RestoreJobsListMemberJsonMarshaller {
    ...
    public void marshall(RestoreJobsListMember restoreJobsListMember, AwsJsonWriter jsonWriter)
        ...
        if (restoreJobsListMember.getAccountId() != null) {
            String accountId = restoreJobsListMember.getAccountId();
        ...
        if (restoreJobsListMember.getResourceType() != null) {
            String resourceType = restoreJobsListMember.getResourceType();
