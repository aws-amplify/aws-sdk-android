...
public class ListRecoveryPointsByBackupVaultResult implements Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public ListRecoveryPointsByBackupVaultResult withRecoveryPoints(
            RecoveryPointByBackupVault... recoveryPoints) {
        if (getRecoveryPoints() == null) {
            this.recoveryPoints = new java.util.ArrayList<RecoveryPointByBackupVault>(
                    recoveryPoints.length);
        }
        for (RecoveryPointByBackupVault value : recoveryPoints) {
     ...
     */
    public ListRecoveryPointsByBackupVaultResult withRecoveryPoints(
            java.util.Collection<RecoveryPointByBackupVault> recoveryPoints) {
