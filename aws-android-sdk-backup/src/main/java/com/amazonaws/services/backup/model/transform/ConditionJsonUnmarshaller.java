    ...
    public Condition unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ConditionType")) {
                condition.setConditionType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ConditionKey")) {
                condition.setConditionKey(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ConditionValue")) {
                condition.setConditionValue(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
