...
import com.amazonaws.services.backup.model.AlreadyExistsException;
...
public class AlreadyExistsExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("AlreadyExistsException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        AlreadyExistsException e = (AlreadyExistsException) super.unmarshall(error);
        ...
        e.setArn(String.valueOf(error.get("Arn")));
