...
public interface AWSBackup {
     ...
     * service has a value set to true, AWS Backup will attempt to protect that
     * service's resources in this region, when included in an on-demand backup
     * or scheduled backup plan. If the value is set to false for a service, AWS
     * Backup will not attempt to protect that service's resources in this
     * region.
     * </p>
     * 
