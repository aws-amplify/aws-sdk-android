...
public class ListBackupSelectionsResult implements Serializable {
    /**
     * <p>
     ...
     * </p>
     *
     * @param backupSelectionsList <p>
     *            An array of backup selection list items containing metadata
     *            about each resource in the list.
     *            </p>
     */
    public void setBackupSelectionsList(
            java.util.Collection<BackupSelectionsListMember> backupSelectionsList) {
        if (backupSelectionsList == null) {
            this.backupSelectionsList = null;
            return;
        }

        this.backupSelectionsList = new java.util.ArrayList<BackupSelectionsListMember>(
     ...
     *         chained together.
     */
    public ListBackupSelectionsResult withBackupSelectionsList(
            BackupSelectionsListMember... backupSelectionsList) {
        if (getBackupSelectionsList() == null) {
            this.backupSelectionsList = new java.util.ArrayList<BackupSelectionsListMember>(
                    backupSelectionsList.length);
        }
        for (BackupSelectionsListMember value : backupSelectionsList) {
            this.backupSelectionsList.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        if (getBackupSelectionsList() != null)
            sb.append("BackupSelectionsList: " + getBackupSelectionsList());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getBackupSelectionsList() == null) ? 0 : getBackupSelectionsList().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getBackupSelectionsList() == null ^ this.getBackupSelectionsList() == null)
            return false;
        if (other.getBackupSelectionsList() != null
                && other.getBackupSelectionsList().equals(this.getBackupSelectionsList()) == false)
            return false;
        return true;
    }
}
