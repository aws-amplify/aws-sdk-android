...
public class DescribeRegionSettingsResult implements Serializable {
    /**
     * <p>
     ...
     *            Returns a list of all services along with the opt-in
     ...
     *         chained together.
     */
    public DescribeRegionSettingsResult withResourceTypeOptInPreference(
            java.util.Map<String, Boolean> resourceTypeOptInPreference) {
        this.resourceTypeOptInPreference = resourceTypeOptInPreference;
        return this;
    }
     ...
     *         chained together.
     */
    public DescribeRegionSettingsResult addResourceTypeOptInPreferenceEntry(String key,
            Boolean value) {
