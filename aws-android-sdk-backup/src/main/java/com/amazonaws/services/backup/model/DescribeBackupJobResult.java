...
public class DescribeBackupJobResult implements Serializable {
    /**
     * <p>
     ...
     * of <code>ExpectedCompletionDate</code> is accurate to milliseconds. For
     ...
     *
     * @return <p>
     *         The date and time that a backup job is created, in Unix format
     ...
     *            The date and time that a job to create a backup job is
     *            completed, in Unix format and Coordinated Universal Time
     *            (UTC). The value of <code>CreationDate</code> is accurate to
     ...
     *            The date and time that a job to back up resources is expected
     *            to be completed, in Unix format and Coordinated Universal Time
     *            (UTC). The value of <code>ExpectedCompletionDate</code> is
