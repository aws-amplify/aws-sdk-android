...
public class ListBackupVaultsResult implements Serializable {
    /**
     * <p>
     ...
     * @return <p>
     *         An array of backup vault list members containing vault metadata,
     *         including Amazon Resource Name (ARN), display name, creation
     *         date, number of saved recovery points, and encryption information
     ...
     * </p>
     *
     * @param backupVaultList <p>
     *            An array of backup vault list members containing vault
     *            metadata, including Amazon Resource Name (ARN), display name,
     *            creation date, number of saved recovery points, and encryption
     *            information if the resources saved in the backup vault are
     *            encrypted.
     *            </p>
     */
    ...
    public ListBackupVaultsResult withBackupVaultList(BackupVaultListMember... backupVaultList) {
        if (getBackupVaultList() == null) {
            this.backupVaultList = new java.util.ArrayList<BackupVaultListMember>(
                    backupVaultList.length);
        }
        for (BackupVaultListMember value : backupVaultList) {
            this.backupVaultList.add(value);
        }
        return this;
    }
     ...
     *         chained together.
     */
    public ListBackupVaultsResult withBackupVaultList(
            java.util.Collection<BackupVaultListMember> backupVaultList) {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getBackupVaultList() != null)
            sb.append("BackupVaultList: " + getBackupVaultList() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getBackupVaultList() == null) ? 0 : getBackupVaultList().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getBackupVaultList() == null ^ this.getBackupVaultList() == null)
            return false;
        if (other.getBackupVaultList() != null
                && other.getBackupVaultList().equals(this.getBackupVaultList()) == false)
            return false;
