...
public class ListBackupPlanTemplatesResult implements Serializable {
    /**
     * <p>
     ...
     * </p>
     *
     * @param backupPlanTemplatesList <p>
     *            An array of template list items containing metadata about your
     *            saved templates.
     *            </p>
     */
    public void setBackupPlanTemplatesList(
            java.util.Collection<BackupPlanTemplatesListMember> backupPlanTemplatesList) {
        if (backupPlanTemplatesList == null) {
            this.backupPlanTemplatesList = null;
            return;
        }

        this.backupPlanTemplatesList = new java.util.ArrayList<BackupPlanTemplatesListMember>(
     ...
     *         chained together.
     */
    public ListBackupPlanTemplatesResult withBackupPlanTemplatesList(
            BackupPlanTemplatesListMember... backupPlanTemplatesList) {
        if (getBackupPlanTemplatesList() == null) {
            this.backupPlanTemplatesList = new java.util.ArrayList<BackupPlanTemplatesListMember>(
                    backupPlanTemplatesList.length);
        }
        for (BackupPlanTemplatesListMember value : backupPlanTemplatesList) {
            this.backupPlanTemplatesList.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        if (getBackupPlanTemplatesList() != null)
            sb.append("BackupPlanTemplatesList: " + getBackupPlanTemplatesList());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getBackupPlanTemplatesList() == null) ? 0 : getBackupPlanTemplatesList()
                        .hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getBackupPlanTemplatesList() == null ^ this.getBackupPlanTemplatesList() == null)
            return false;
        if (other.getBackupPlanTemplatesList() != null
                && other.getBackupPlanTemplatesList().equals(this.getBackupPlanTemplatesList()) == false)
            return false;
        return true;
    }
}
