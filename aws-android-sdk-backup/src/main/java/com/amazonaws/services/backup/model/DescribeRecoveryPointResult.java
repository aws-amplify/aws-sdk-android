...
public class DescribeRecoveryPointResult implements Serializable {
    /**
     * <p>
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>WARM, COLD, DELETED
     */
     ...
     *
     * @param resourceArn <p>
     *            An ARN that uniquely identifies a saved resource. The format
     ...
     *
     * @return <p>
     *         The type of AWS resource to save as a recovery point; for
     ...
     *         <note>
     *         <p>
     *         A partial status indicates that the recovery point was not
     ...
     *
     * @return <p>
     *         The date and time that a recovery point is created, in Unix
     ...
     *         chained together.
     */
    public DescribeRecoveryPointResult withCalculatedLifecycle(
     ...
     *         </p>
     *         <p>
     *         Backups that are transitioned to cold storage must be stored in
     *         cold storage for a minimum of 90 days. Therefore, the “expire
     *         after days” setting must be 90 days greater than the “transition
     *         to cold after days” setting. The “transition to cold after days”
     ...
     *            </p>
     *            <p>
     *            Backups that are transitioned to cold storage must be stored
     *            in cold storage for a minimum of 90 days. Therefore, the
     ...
     *            The server-side encryption key used to protect your backups;
     *            for example,
     *            <code>arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab</code>
     *            .
     *            </p>
     ...
     *            Specifies the storage class of the recovery point. Valid
     ...
     *
     * @return <p>
     *         The date and time that a recovery point was last restored, in
     *         Unix format and Coordinated Universal Time (UTC). The value of
