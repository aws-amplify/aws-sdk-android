...
/**
 * JSON unmarshaller for response DeleteDatabaseResult
 */
public class DeleteDatabaseResultJsonUnmarshaller implements
        Unmarshaller<DeleteDatabaseResult, JsonUnmarshallerContext> {
