...
/**
 * JSON unmarshaller for response GetColumnStatisticsForTableResult
 */
public class GetColumnStatisticsForTableResultJsonUnmarshaller implements
        Unmarshaller<GetColumnStatisticsForTableResult, JsonUnmarshallerContext> {

    public GetColumnStatisticsForTableResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ColumnStatisticsList")) {
                ...
                getColumnStatisticsForTableResult.setErrors(new ListUnmarshaller<ColumnError>(
