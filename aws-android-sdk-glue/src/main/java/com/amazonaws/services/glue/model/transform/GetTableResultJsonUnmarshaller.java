...
/**
 * JSON unmarshaller for response GetTableResult
 */
public class GetTableResultJsonUnmarshaller implements
        Unmarshaller<GetTableResult, JsonUnmarshallerContext> {
    ...
    public GetTableResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Table")) {
                getTableResult.setTable(TableJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
