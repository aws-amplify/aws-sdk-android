...
/**
 * JSON unmarshaller for response StopCrawlerResult
 */
public class StopCrawlerResultJsonUnmarshaller implements
        Unmarshaller<StopCrawlerResult, JsonUnmarshallerContext> {
