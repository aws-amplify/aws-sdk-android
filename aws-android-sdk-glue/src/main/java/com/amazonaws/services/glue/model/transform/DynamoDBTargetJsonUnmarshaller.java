        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Path")) {
                dynamoDBTarget.setPath(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("scanAll")) {
                dynamoDBTarget.setScanAll(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("scanRate")) {
                dynamoDBTarget.setScanRate(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
