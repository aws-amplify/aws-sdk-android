...
/**
 * JSON unmarshaller for response UpdateDevEndpointResult
 */
public class UpdateDevEndpointResultJsonUnmarshaller implements
        Unmarshaller<UpdateDevEndpointResult, JsonUnmarshallerContext> {
