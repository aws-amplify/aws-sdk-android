...
public class UntagResourceRequestMarshaller implements
    ...
    public Request<UntagResourceRequest> marshall(UntagResourceRequest untagResourceRequest) {
        ...
        try {
            ...
            if (untagResourceRequest.getTagsToRemove() != null) {
                java.util.List<String> tagsToRemove = untagResourceRequest.getTagsToRemove();
                jsonWriter.name("TagsToRemove");
                jsonWriter.beginArray();
                for (String tagsToRemoveItem : tagsToRemove) {
                    if (tagsToRemoveItem != null) {
                        jsonWriter.value(tagsToRemoveItem);
                    }
                }
                jsonWriter.endArray();
            }
