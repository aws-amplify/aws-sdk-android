...
public class TagResourceRequestMarshaller implements
    ...
    public Request<TagResourceRequest> marshall(TagResourceRequest tagResourceRequest) {
        ...
        try {
            ...
            if (tagResourceRequest.getTagsToAdd() != null) {
                java.util.Map<String, String> tagsToAdd = tagResourceRequest.getTagsToAdd();
                jsonWriter.name("TagsToAdd");
                jsonWriter.beginObject();
                for (java.util.Map.Entry<String, String> tagsToAddEntry : tagsToAdd.entrySet()) {
                    String tagsToAddValue = tagsToAddEntry.getValue();
                    if (tagsToAddValue != null) {
                        jsonWriter.name(tagsToAddEntry.getKey());
                        jsonWriter.value(tagsToAddValue);
                    }
                }
