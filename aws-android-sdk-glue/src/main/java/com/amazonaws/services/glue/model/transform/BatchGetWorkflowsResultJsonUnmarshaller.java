...
/**
 * JSON unmarshaller for response BatchGetWorkflowsResult
 */
public class BatchGetWorkflowsResultJsonUnmarshaller implements
        Unmarshaller<BatchGetWorkflowsResult, JsonUnmarshallerContext> {
    ...
    public BatchGetWorkflowsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Workflows")) {
                batchGetWorkflowsResult.setWorkflows(new ListUnmarshaller<Workflow>(
                        WorkflowJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("MissingWorkflows")) {
                batchGetWorkflowsResult.setMissingWorkflows(new ListUnmarshaller<String>(
