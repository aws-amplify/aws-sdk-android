...
/**
 * JSON unmarshaller for response StartWorkflowRunResult
 */
public class StartWorkflowRunResultJsonUnmarshaller implements
        Unmarshaller<StartWorkflowRunResult, JsonUnmarshallerContext> {
    ...
    public StartWorkflowRunResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RunId")) {
                startWorkflowRunResult.setRunId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
