...
/**
 * JSON unmarshaller for response StartJobRunResult
 */
public class StartJobRunResultJsonUnmarshaller implements
        Unmarshaller<StartJobRunResult, JsonUnmarshallerContext> {
    ...
    public StartJobRunResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("JobRunId")) {
                startJobRunResult.setJobRunId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
