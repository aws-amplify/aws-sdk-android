...
public class UpdateJobRequestMarshaller implements
    ...
    public Request<UpdateJobRequest> marshall(UpdateJobRequest updateJobRequest) {
        ...
        try {
            ...
            if (updateJobRequest.getJobName() != null) {
                String jobName = updateJobRequest.getJobName();
                jsonWriter.name("JobName");
                jsonWriter.value(jobName);
            }
            if (updateJobRequest.getJobUpdate() != null) {
                JobUpdate jobUpdate = updateJobRequest.getJobUpdate();
                jsonWriter.name("JobUpdate");
                JobUpdateJsonMarshaller.getInstance().marshall(jobUpdate, jsonWriter);
            }
