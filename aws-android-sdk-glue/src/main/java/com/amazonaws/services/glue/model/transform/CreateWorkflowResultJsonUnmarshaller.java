...
/**
 * JSON unmarshaller for response CreateWorkflowResult
 */
public class CreateWorkflowResultJsonUnmarshaller implements
        Unmarshaller<CreateWorkflowResult, JsonUnmarshallerContext> {
    ...
    public CreateWorkflowResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                createWorkflowResult.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
