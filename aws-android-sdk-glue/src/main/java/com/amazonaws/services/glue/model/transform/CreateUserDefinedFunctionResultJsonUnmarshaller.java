...
/**
 * JSON unmarshaller for response CreateUserDefinedFunctionResult
 */
public class CreateUserDefinedFunctionResultJsonUnmarshaller implements
        Unmarshaller<CreateUserDefinedFunctionResult, JsonUnmarshallerContext> {

    public CreateUserDefinedFunctionResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
