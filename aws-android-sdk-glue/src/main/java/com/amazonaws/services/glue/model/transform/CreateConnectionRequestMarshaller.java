...
public class CreateConnectionRequestMarshaller implements
    ...
    public Request<CreateConnectionRequest> marshall(CreateConnectionRequest createConnectionRequest) {
        ...
        Request<CreateConnectionRequest> request = new DefaultRequest<CreateConnectionRequest>(
                createConnectionRequest, "AWSGlue");
        ...
        try {
            ...
            if (createConnectionRequest.getCatalogId() != null) {
                String catalogId = createConnectionRequest.getCatalogId();
                jsonWriter.name("CatalogId");
                jsonWriter.value(catalogId);
            }
            if (createConnectionRequest.getConnectionInput() != null) {
                ConnectionInput connectionInput = createConnectionRequest.getConnectionInput();
