...
/**
 * JSON unmarshaller for response GetWorkflowResult
 */
public class GetWorkflowResultJsonUnmarshaller implements
        Unmarshaller<GetWorkflowResult, JsonUnmarshallerContext> {
    ...
    public GetWorkflowResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Workflow")) {
                getWorkflowResult.setWorkflow(WorkflowJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
