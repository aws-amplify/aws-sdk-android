...
/**
 * JSON unmarshaller for POJO UpdateXMLClassifierRequest
 */
class UpdateXMLClassifierRequestJsonUnmarshaller implements
        Unmarshaller<UpdateXMLClassifierRequest, JsonUnmarshallerContext> {
    ...
    public UpdateXMLClassifierRequest unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                updateXMLClassifierRequest.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Classification")) {
                updateXMLClassifierRequest.setClassification(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("RowTag")) {
                updateXMLClassifierRequest.setRowTag(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
