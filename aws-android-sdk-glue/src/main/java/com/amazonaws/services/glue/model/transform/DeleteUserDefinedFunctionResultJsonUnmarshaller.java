...
/**
 * JSON unmarshaller for response DeleteUserDefinedFunctionResult
 */
public class DeleteUserDefinedFunctionResultJsonUnmarshaller implements
        Unmarshaller<DeleteUserDefinedFunctionResult, JsonUnmarshallerContext> {

    public DeleteUserDefinedFunctionResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
