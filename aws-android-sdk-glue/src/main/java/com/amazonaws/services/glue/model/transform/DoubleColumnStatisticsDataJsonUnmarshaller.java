...
/**
 * JSON unmarshaller for POJO DoubleColumnStatisticsData
 */
class DoubleColumnStatisticsDataJsonUnmarshaller implements
        Unmarshaller<DoubleColumnStatisticsData, JsonUnmarshallerContext> {
    ...
    public DoubleColumnStatisticsData unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("MinimumValue")) {
                doubleColumnStatisticsData.setMinimumValue(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("MaximumValue")) {
                doubleColumnStatisticsData.setMaximumValue(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("NumberOfNulls")) {
                doubleColumnStatisticsData.setNumberOfNulls(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("NumberOfDistinctValues")) {
                doubleColumnStatisticsData.setNumberOfDistinctValues(LongJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
