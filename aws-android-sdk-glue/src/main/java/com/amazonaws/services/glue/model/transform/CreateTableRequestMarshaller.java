    ...
    public Request<CreateTableRequest> marshall(CreateTableRequest createTableRequest) {
        ...
        try {
            ...
            if (createTableRequest.getCatalogId() != null) {
                String catalogId = createTableRequest.getCatalogId();
                jsonWriter.name("CatalogId");
                jsonWriter.value(catalogId);
            }
            if (createTableRequest.getDatabaseName() != null) {
                String databaseName = createTableRequest.getDatabaseName();
                jsonWriter.name("DatabaseName");
                jsonWriter.value(databaseName);
            }
            if (createTableRequest.getTableInput() != null) {
