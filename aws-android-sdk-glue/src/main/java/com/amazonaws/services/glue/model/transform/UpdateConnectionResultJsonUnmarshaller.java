...
/**
 * JSON unmarshaller for response UpdateConnectionResult
 */
public class UpdateConnectionResultJsonUnmarshaller implements
        Unmarshaller<UpdateConnectionResult, JsonUnmarshallerContext> {
