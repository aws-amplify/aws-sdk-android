...
/**
 * JSON unmarshaller for response CreateSecurityConfigurationResult
 */
public class CreateSecurityConfigurationResultJsonUnmarshaller implements
        Unmarshaller<CreateSecurityConfigurationResult, JsonUnmarshallerContext> {
    ...
    public CreateSecurityConfigurationResult unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                createSecurityConfigurationResult.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("CreatedTimestamp")) {
                createSecurityConfigurationResult.setCreatedTimestamp(DateJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
