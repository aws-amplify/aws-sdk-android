...
public class GetCrawlersResult implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         A continuation token, if the returned list has not reached the
     *         end of those defined in this customer account.
     *         </p>
     */
