...
/**
 * JSON unmarshaller for response GetConnectionResult
 */
public class GetConnectionResultJsonUnmarshaller implements
        Unmarshaller<GetConnectionResult, JsonUnmarshallerContext> {
    ...
    public GetConnectionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Connection")) {
                getConnectionResult.setConnection(ConnectionJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
