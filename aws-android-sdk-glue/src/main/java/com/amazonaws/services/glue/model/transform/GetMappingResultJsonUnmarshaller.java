...
/**
 * JSON unmarshaller for response GetMappingResult
 */
public class GetMappingResultJsonUnmarshaller implements
        Unmarshaller<GetMappingResult, JsonUnmarshallerContext> {
    ...
    public GetMappingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Mapping")) {
                getMappingResult.setMapping(new ListUnmarshaller<MappingEntry>(
                        MappingEntryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
