 ...
 * </p>
 */
public class GetColumnStatisticsForPartitionRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public GetColumnStatisticsForPartitionRequest withPartitionValues(
    ...
    public GetColumnStatisticsForPartitionRequest withColumnNames(String... columnNames) {
        if (getColumnNames() == null) {
            this.columnNames = new java.util.ArrayList<String>(columnNames.length);
        }
     ...
     *         chained together.
     */
    public GetColumnStatisticsForPartitionRequest withColumnNames(
    ...
    public String toString() {
        ...
        if (getColumnNames() != null)
            sb.append("ColumnNames: " + getColumnNames());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getColumnNames() == null) ? 0 : getColumnNames().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getColumnNames() == null ^ this.getColumnNames() == null)
            return false;
        if (other.getColumnNames() != null
                && other.getColumnNames().equals(this.getColumnNames()) == false)
            return false;
        return true;
    }
}
