...
public class GetMLTaskRunsResult implements Serializable {
    /**
     * <p>
    ...
    public GetMLTaskRunsResult withTaskRuns(TaskRun... taskRuns) {
        if (getTaskRuns() == null) {
            this.taskRuns = new java.util.ArrayList<TaskRun>(taskRuns.length);
        }
        for (TaskRun value : taskRuns) {
            this.taskRuns.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getTaskRuns() != null)
            sb.append("TaskRuns: " + getTaskRuns() + ",");
