 ...
 * </p>
 */
public class AwsS3BucketServerSideEncryptionConfiguration implements Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public AwsS3BucketServerSideEncryptionConfiguration withRules(
            AwsS3BucketServerSideEncryptionRule... rules) {
        if (getRules() == null) {
            this.rules = new java.util.ArrayList<AwsS3BucketServerSideEncryptionRule>(rules.length);
        }
        for (AwsS3BucketServerSideEncryptionRule value : rules) {
     ...
     */
    public AwsS3BucketServerSideEncryptionConfiguration withRules(
            java.util.Collection<AwsS3BucketServerSideEncryptionRule> rules) {
        setRules(rules);
        return this;
    }
