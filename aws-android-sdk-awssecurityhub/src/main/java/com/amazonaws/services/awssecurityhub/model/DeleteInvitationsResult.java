...
public class DeleteInvitationsResult implements Serializable {
     ...
     *
     * @return <p>
     *         The list of AWS accounts for which the invitations were not
     *         deleted. For each account, the list includes the account ID and
     *         the email address.
     *         </p>
     */
     ...
     *            The list of AWS accounts for which the invitations were not
     *            deleted. For each account, the list includes the account ID
