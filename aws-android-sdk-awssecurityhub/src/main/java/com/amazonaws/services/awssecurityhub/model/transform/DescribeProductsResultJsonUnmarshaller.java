...
/**
 * JSON unmarshaller for response DescribeProductsResult
 */
public class DescribeProductsResultJsonUnmarshaller implements
        Unmarshaller<DescribeProductsResult, JsonUnmarshallerContext> {
    ...
    public DescribeProductsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Products")) {
                describeProductsResult.setProducts(new ListUnmarshaller<Product>(
                        ProductJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                describeProductsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
