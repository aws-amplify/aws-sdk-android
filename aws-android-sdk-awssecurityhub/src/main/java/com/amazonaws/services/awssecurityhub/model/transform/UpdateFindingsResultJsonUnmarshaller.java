...
/**
 * JSON unmarshaller for response UpdateFindingsResult
 */
public class UpdateFindingsResultJsonUnmarshaller implements
        Unmarshaller<UpdateFindingsResult, JsonUnmarshallerContext> {
