...
public class DeleteMembersResult implements Serializable {
    /**
     * <p>
     ...
     *            The list of AWS accounts that were not deleted. For each
     ...
     *         chained together.
     */
    public DeleteMembersResult withUnprocessedAccounts(
