...
/**
 * JSON unmarshaller for response CreateMembersResult
 */
public class CreateMembersResultJsonUnmarshaller implements
        Unmarshaller<CreateMembersResult, JsonUnmarshallerContext> {
    ...
    public CreateMembersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("UnprocessedAccounts")) {
                createMembersResult.setUnprocessedAccounts(new ListUnmarshaller<Result>(
