...
public class DescribeStandardsResult implements Serializable {
    /**
     * <p>
    ...
    public DescribeStandardsResult withStandards(Standard... standards) {
        if (getStandards() == null) {
            this.standards = new java.util.ArrayList<Standard>(standards.length);
        }
        for (Standard value : standards) {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getStandards() != null)
            sb.append("Standards: " + getStandards() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getStandards() != null
                && other.getStandards().equals(this.getStandards()) == false)
            return false;
