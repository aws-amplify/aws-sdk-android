...
public class UpdateFindingsRequestMarshaller implements
    ...
    public Request<UpdateFindingsRequest> marshall(UpdateFindingsRequest updateFindingsRequest) {
        ...
        Request<UpdateFindingsRequest> request = new DefaultRequest<UpdateFindingsRequest>(
                updateFindingsRequest, "AWSSecurityHub");
        ...
        try {
            ...
            if (updateFindingsRequest.getFilters() != null) {
                AwsSecurityFindingFilters filters = updateFindingsRequest.getFilters();
                jsonWriter.name("Filters");
                AwsSecurityFindingFiltersJsonMarshaller.getInstance().marshall(filters, jsonWriter);
            }
            if (updateFindingsRequest.getNote() != null) {
                NoteUpdate note = updateFindingsRequest.getNote();
                jsonWriter.name("Note");
                NoteUpdateJsonMarshaller.getInstance().marshall(note, jsonWriter);
            }
            if (updateFindingsRequest.getRecordState() != null) {
                String recordState = updateFindingsRequest.getRecordState();
