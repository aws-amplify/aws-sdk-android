...
/**
 * JSON unmarshaller for response EnableSecurityHubResult
 */
public class EnableSecurityHubResultJsonUnmarshaller implements
        Unmarshaller<EnableSecurityHubResult, JsonUnmarshallerContext> {
