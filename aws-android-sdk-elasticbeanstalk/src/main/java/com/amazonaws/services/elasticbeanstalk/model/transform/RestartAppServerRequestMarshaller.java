...
/**
 * StAX request marshaller for RestartAppServerRequest
 */
    ...
    public Request<RestartAppServerRequest> marshall(RestartAppServerRequest restartAppServerRequest) {
        if (restartAppServerRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RestartAppServerRequest)");
        }
        ...
        if (restartAppServerRequest.getEnvironmentId() != null) {
            ...
            String environmentId = restartAppServerRequest.getEnvironmentId();
        ...
        if (restartAppServerRequest.getEnvironmentName() != null) {
            ...
            String environmentName = restartAppServerRequest.getEnvironmentName();
