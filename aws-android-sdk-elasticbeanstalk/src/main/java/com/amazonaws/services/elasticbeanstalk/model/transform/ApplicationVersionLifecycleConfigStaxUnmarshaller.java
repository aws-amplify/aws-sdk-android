...
/**
 * StAX unmarshaller for model ApplicationVersionLifecycleConfig
 */
class ApplicationVersionLifecycleConfigStaxUnmarshaller implements
        Unmarshaller<ApplicationVersionLifecycleConfig, StaxUnmarshallerContext> {

    public ApplicationVersionLifecycleConfig unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("MaxCountRule", targetDepth)) {
                    applicationVersionLifecycleConfig.setMaxCountRule(MaxCountRuleStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("MaxAgeRule", targetDepth)) {
                    applicationVersionLifecycleConfig.setMaxAgeRule(MaxAgeRuleStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
