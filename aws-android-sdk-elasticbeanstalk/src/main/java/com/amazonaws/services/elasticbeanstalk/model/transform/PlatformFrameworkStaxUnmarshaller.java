...
/**
 * StAX unmarshaller for model PlatformFramework
 */
class PlatformFrameworkStaxUnmarshaller implements
        Unmarshaller<PlatformFramework, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Name", targetDepth)) {
                    platformFramework.setName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Version", targetDepth)) {
                    platformFramework.setVersion(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
