...
/**
 * StAX unmarshaller for response CreateApplicationVersionResult
 */
public class CreateApplicationVersionResultStaxUnmarshaller implements
        Unmarshaller<CreateApplicationVersionResult, StaxUnmarshallerContext> {

    public CreateApplicationVersionResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
