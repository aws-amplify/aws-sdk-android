...
/**
 * StAX unmarshaller for model StatusCodes
 */
class StatusCodesStaxUnmarshaller implements Unmarshaller<StatusCodes, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Status2xx", targetDepth)) {
                    statusCodes.setStatus2xx(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Status3xx", targetDepth)) {
                    statusCodes.setStatus3xx(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Status4xx", targetDepth)) {
                    statusCodes.setStatus4xx(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Status5xx", targetDepth)) {
                    statusCodes.setStatus5xx(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
