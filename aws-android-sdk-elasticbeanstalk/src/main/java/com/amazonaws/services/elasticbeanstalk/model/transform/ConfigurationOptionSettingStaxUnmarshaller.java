...
/**
 * StAX unmarshaller for model ConfigurationOptionSetting
 */
class ConfigurationOptionSettingStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ResourceName", targetDepth)) {
                    configurationOptionSetting.setResourceName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Namespace", targetDepth)) {
                    configurationOptionSetting.setNamespace(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("OptionName", targetDepth)) {
                    configurationOptionSetting.setOptionName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Value", targetDepth)) {
                    configurationOptionSetting.setValue(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
