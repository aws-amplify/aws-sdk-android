...
public enum EnvironmentHealthAttribute {
    ...
    private static final Map<String, EnvironmentHealthAttribute> enumMap;
    static {
        enumMap = new HashMap<String, EnvironmentHealthAttribute>();
        ...
        enumMap.put("InstancesHealth", InstancesHealth);
        enumMap.put("All", All);
