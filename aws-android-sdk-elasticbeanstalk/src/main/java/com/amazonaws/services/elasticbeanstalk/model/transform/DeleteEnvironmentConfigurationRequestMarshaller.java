...
/**
 * StAX request marshaller for DeleteEnvironmentConfigurationRequest
 */
    ...
    public Request<DeleteEnvironmentConfigurationRequest> marshall(
        ...
        if (deleteEnvironmentConfigurationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteEnvironmentConfigurationRequest)");
        }
        ...
        if (deleteEnvironmentConfigurationRequest.getApplicationName() != null) {
            ...
            String applicationName = deleteEnvironmentConfigurationRequest.getApplicationName();
        ...
        if (deleteEnvironmentConfigurationRequest.getEnvironmentName() != null) {
            ...
            String environmentName = deleteEnvironmentConfigurationRequest.getEnvironmentName();
