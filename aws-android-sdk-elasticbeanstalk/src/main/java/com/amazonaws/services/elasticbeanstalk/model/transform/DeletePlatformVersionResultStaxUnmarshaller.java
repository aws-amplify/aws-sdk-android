...
/**
 * StAX unmarshaller for response DeletePlatformVersionResult
 */
public class DeletePlatformVersionResultStaxUnmarshaller implements
        Unmarshaller<DeletePlatformVersionResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PlatformSummary", targetDepth)) {
                    deletePlatformVersionResult.setPlatformSummary(PlatformSummaryStaxUnmarshaller
