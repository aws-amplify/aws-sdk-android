...
/**
 * StAX unmarshaller for response DescribeEnvironmentsResult
 */
public class DescribeEnvironmentsResultStaxUnmarshaller implements
        Unmarshaller<DescribeEnvironmentsResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    describeEnvironmentsResult.setNextToken(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
