...
/**
 * StAX unmarshaller for response DescribeApplicationVersionsResult
 */
public class DescribeApplicationVersionsResultStaxUnmarshaller implements
        Unmarshaller<DescribeApplicationVersionsResult, StaxUnmarshallerContext> {

    public DescribeApplicationVersionsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    describeApplicationVersionsResult.setNextToken(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
