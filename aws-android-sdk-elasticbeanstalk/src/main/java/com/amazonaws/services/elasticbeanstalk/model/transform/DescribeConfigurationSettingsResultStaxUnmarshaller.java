...
/**
 * StAX unmarshaller for response DescribeConfigurationSettingsResult
 */
public class DescribeConfigurationSettingsResultStaxUnmarshaller implements
        Unmarshaller<DescribeConfigurationSettingsResult, StaxUnmarshallerContext> {

    public DescribeConfigurationSettingsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ConfigurationSettings/member", targetDepth)) {
                    describeConfigurationSettingsResult
                            .withConfigurationSettings(ConfigurationSettingsDescriptionStaxUnmarshaller
