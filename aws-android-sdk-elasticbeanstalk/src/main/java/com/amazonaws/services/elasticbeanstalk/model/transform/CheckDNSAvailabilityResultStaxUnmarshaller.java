...
/**
 * StAX unmarshaller for response CheckDNSAvailabilityResult
 */
public class CheckDNSAvailabilityResultStaxUnmarshaller implements
        Unmarshaller<CheckDNSAvailabilityResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Available", targetDepth)) {
                    checkDNSAvailabilityResult.setAvailable(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("FullyQualifiedCNAME", targetDepth)) {
                    checkDNSAvailabilityResult.setFullyQualifiedCNAME(StringStaxUnmarshaller
