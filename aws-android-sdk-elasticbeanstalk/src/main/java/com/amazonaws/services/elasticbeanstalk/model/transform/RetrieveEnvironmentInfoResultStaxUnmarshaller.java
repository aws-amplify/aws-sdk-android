...
/**
 * StAX unmarshaller for response RetrieveEnvironmentInfoResult
 */
public class RetrieveEnvironmentInfoResultStaxUnmarshaller implements
        Unmarshaller<RetrieveEnvironmentInfoResult, StaxUnmarshallerContext> {

    public RetrieveEnvironmentInfoResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
