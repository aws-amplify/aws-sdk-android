...
/**
 * StAX request marshaller for UpdateApplicationResourceLifecycleRequest
 */
public class UpdateApplicationResourceLifecycleRequestMarshaller
    ...
    public Request<UpdateApplicationResourceLifecycleRequest> marshall(
        ...
        if (updateApplicationResourceLifecycleRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateApplicationResourceLifecycleRequest)");
        }
        ...
        if (updateApplicationResourceLifecycleRequest.getApplicationName() != null) {
            ...
            String applicationName = updateApplicationResourceLifecycleRequest.getApplicationName();
            request.addParameter(prefix, StringUtils.fromString(applicationName));
        }
        if (updateApplicationResourceLifecycleRequest.getResourceLifecycleConfig() != null) {
            prefix = "ResourceLifecycleConfig";
            ApplicationResourceLifecycleConfig resourceLifecycleConfig = updateApplicationResourceLifecycleRequest
