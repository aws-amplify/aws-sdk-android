...
/**
 * StAX unmarshaller for model CustomAmi
 */
class CustomAmiStaxUnmarshaller implements Unmarshaller<CustomAmi, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("VirtualizationType", targetDepth)) {
                    customAmi.setVirtualizationType(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
