...
/**
 * StAX unmarshaller for model OptionRestrictionRegex
 */
class OptionRestrictionRegexStaxUnmarshaller implements
        Unmarshaller<OptionRestrictionRegex, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Pattern", targetDepth)) {
                    optionRestrictionRegex.setPattern(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Label", targetDepth)) {
                    optionRestrictionRegex.setLabel(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
