...
/**
 * StAX unmarshaller for model ManagedAction
 */
class ManagedActionStaxUnmarshaller implements Unmarshaller<ManagedAction, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ActionId", targetDepth)) {
                    managedAction.setActionId(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("ActionDescription", targetDepth)) {
                    managedAction.setActionDescription(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ActionType", targetDepth)) {
                    managedAction.setActionType(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Status", targetDepth)) {
                    managedAction.setStatus(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("WindowStartTime", targetDepth)) {
                    managedAction.setWindowStartTime(DateStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
