...
/**
 * StAX unmarshaller for response ListAvailableSolutionStacksResult
 */
public class ListAvailableSolutionStacksResultStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("SolutionStacks/member", targetDepth)) {
                    listAvailableSolutionStacksResult.withSolutionStacks(StringStaxUnmarshaller
