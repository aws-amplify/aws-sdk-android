...
/**
 * StAX unmarshaller for response DescribePlatformVersionResult
 */
public class DescribePlatformVersionResultStaxUnmarshaller implements
        Unmarshaller<DescribePlatformVersionResult, StaxUnmarshallerContext> {

    public DescribePlatformVersionResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PlatformDescription", targetDepth)) {
                    describePlatformVersionResult
                            .setPlatformDescription(PlatformDescriptionStaxUnmarshaller
