...
/**
 * StAX unmarshaller for model EnvironmentResourceDescription
 */
class EnvironmentResourceDescriptionStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("EnvironmentName", targetDepth)) {
                    environmentResourceDescription.setEnvironmentName(StringStaxUnmarshaller
                ...
                if (context.testExpression("Instances/member", targetDepth)) {
                    environmentResourceDescription.withInstances(InstanceStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("LaunchTemplates/member", targetDepth)) {
                    environmentResourceDescription
                            .withLaunchTemplates(LaunchTemplateStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("LoadBalancers/member", targetDepth)) {
                    environmentResourceDescription.withLoadBalancers(LoadBalancerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Triggers/member", targetDepth)) {
                    environmentResourceDescription.withTriggers(TriggerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Queues/member", targetDepth)) {
                    environmentResourceDescription.withQueues(QueueStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
