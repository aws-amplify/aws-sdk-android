...
/**
 * StAX request marshaller for DisassociateEnvironmentOperationsRoleRequest
 */
public class DisassociateEnvironmentOperationsRoleRequestMarshaller
        implements
    ...
    public Request<DisassociateEnvironmentOperationsRoleRequest> marshall(
        ...
        if (disassociateEnvironmentOperationsRoleRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DisassociateEnvironmentOperationsRoleRequest)");
        }
        ...
        if (disassociateEnvironmentOperationsRoleRequest.getEnvironmentName() != null) {
            ...
            String environmentName = disassociateEnvironmentOperationsRoleRequest
                    .getEnvironmentName();
