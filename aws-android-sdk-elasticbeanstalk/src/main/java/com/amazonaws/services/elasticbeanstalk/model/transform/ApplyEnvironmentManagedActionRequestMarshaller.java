...
/**
 * StAX request marshaller for ApplyEnvironmentManagedActionRequest
 */
    ...
    public Request<ApplyEnvironmentManagedActionRequest> marshall(
        ...
        if (applyEnvironmentManagedActionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ApplyEnvironmentManagedActionRequest)");
        }
        ...
        if (applyEnvironmentManagedActionRequest.getEnvironmentName() != null) {
            ...
            String environmentName = applyEnvironmentManagedActionRequest.getEnvironmentName();
        ...
        if (applyEnvironmentManagedActionRequest.getEnvironmentId() != null) {
            ...
            String environmentId = applyEnvironmentManagedActionRequest.getEnvironmentId();
            request.addParameter(prefix, StringUtils.fromString(environmentId));
        }
        if (applyEnvironmentManagedActionRequest.getActionId() != null) {
            prefix = "ActionId";
            String actionId = applyEnvironmentManagedActionRequest.getActionId();
