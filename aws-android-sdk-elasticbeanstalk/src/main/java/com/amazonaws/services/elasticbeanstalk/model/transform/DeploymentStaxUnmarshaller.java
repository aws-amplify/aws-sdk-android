...
/**
 * StAX unmarshaller for model Deployment
 */
class DeploymentStaxUnmarshaller implements Unmarshaller<Deployment, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("VersionLabel", targetDepth)) {
                    deployment.setVersionLabel(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("DeploymentId", targetDepth)) {
                    deployment.setDeploymentId(LongStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                ...
                if (context.testExpression("DeploymentTime", targetDepth)) {
                    deployment.setDeploymentTime(DateStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
