...
/**
 * StAX unmarshaller for model ResourceQuotas
 */
class ResourceQuotasStaxUnmarshaller implements
        Unmarshaller<ResourceQuotas, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ApplicationQuota", targetDepth)) {
                    resourceQuotas.setApplicationQuota(ResourceQuotaStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ApplicationVersionQuota", targetDepth)) {
                    resourceQuotas.setApplicationVersionQuota(ResourceQuotaStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("EnvironmentQuota", targetDepth)) {
                    resourceQuotas.setEnvironmentQuota(ResourceQuotaStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ConfigurationTemplateQuota", targetDepth)) {
                    resourceQuotas.setConfigurationTemplateQuota(ResourceQuotaStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("CustomPlatformQuota", targetDepth)) {
                    resourceQuotas.setCustomPlatformQuota(ResourceQuotaStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
