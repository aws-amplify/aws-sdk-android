...
/**
 * StAX unmarshaller for model EnvironmentResourcesDescription
 */
class EnvironmentResourcesDescriptionStaxUnmarshaller implements
        Unmarshaller<EnvironmentResourcesDescription, StaxUnmarshallerContext> {

    public EnvironmentResourcesDescription unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("LoadBalancer", targetDepth)) {
                    environmentResourcesDescription
                            .setLoadBalancer(LoadBalancerDescriptionStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
