...
/**
 * StAX unmarshaller for model ApplicationMetrics
 */
class ApplicationMetricsStaxUnmarshaller implements
        Unmarshaller<ApplicationMetrics, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Duration", targetDepth)) {
                    applicationMetrics.setDuration(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("RequestCount", targetDepth)) {
                    applicationMetrics.setRequestCount(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("StatusCodes", targetDepth)) {
                    applicationMetrics.setStatusCodes(StatusCodesStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Latency", targetDepth)) {
                    applicationMetrics.setLatency(LatencyStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
