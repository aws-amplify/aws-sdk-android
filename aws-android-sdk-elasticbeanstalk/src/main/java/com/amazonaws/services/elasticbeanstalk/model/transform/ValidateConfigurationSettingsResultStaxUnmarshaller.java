...
/**
 * StAX unmarshaller for response ValidateConfigurationSettingsResult
 */
public class ValidateConfigurationSettingsResultStaxUnmarshaller implements
        Unmarshaller<ValidateConfigurationSettingsResult, StaxUnmarshallerContext> {

    public ValidateConfigurationSettingsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Messages/member", targetDepth)) {
                    validateConfigurationSettingsResult
                            .withMessages(ValidationMessageStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
