...
/**
 * StAX unmarshaller for response ListPlatformBranchesResult
 */
public class ListPlatformBranchesResultStaxUnmarshaller implements
        Unmarshaller<ListPlatformBranchesResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PlatformBranchSummaryList/member", targetDepth)) {
                    listPlatformBranchesResult
                            .withPlatformBranchSummaryList(PlatformBranchSummaryStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    listPlatformBranchesResult.setNextToken(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
