...
/**
 * StAX unmarshaller for response ListPlatformVersionsResult
 */
public class ListPlatformVersionsResultStaxUnmarshaller implements
        Unmarshaller<ListPlatformVersionsResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PlatformSummaryList/member", targetDepth)) {
                    listPlatformVersionsResult
                            .withPlatformSummaryList(PlatformSummaryStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    listPlatformVersionsResult.setNextToken(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
