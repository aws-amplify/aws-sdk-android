...
/**
 * StAX unmarshaller for model MaxCountRule
 */
class MaxCountRuleStaxUnmarshaller implements Unmarshaller<MaxCountRule, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Enabled", targetDepth)) {
                    maxCountRule.setEnabled(BooleanStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("MaxCount", targetDepth)) {
                    maxCountRule.setMaxCount(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("DeleteSourceFromS3", targetDepth)) {
                    maxCountRule.setDeleteSourceFromS3(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
