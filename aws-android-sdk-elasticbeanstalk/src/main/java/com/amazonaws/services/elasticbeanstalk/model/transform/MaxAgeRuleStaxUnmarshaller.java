...
/**
 * StAX unmarshaller for model MaxAgeRule
 */
class MaxAgeRuleStaxUnmarshaller implements Unmarshaller<MaxAgeRule, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Enabled", targetDepth)) {
                    maxAgeRule
                            .setEnabled(BooleanStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("MaxAgeInDays", targetDepth)) {
                    maxAgeRule.setMaxAgeInDays(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("DeleteSourceFromS3", targetDepth)) {
                    maxAgeRule.setDeleteSourceFromS3(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
