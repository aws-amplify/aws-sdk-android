...
/**
 * StAX unmarshaller for model ResourceQuota
 */
class ResourceQuotaStaxUnmarshaller implements Unmarshaller<ResourceQuota, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Maximum", targetDepth)) {
                    resourceQuota.setMaximum(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
