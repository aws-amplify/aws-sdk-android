...
/**
 * StAX unmarshaller for response DescribeEnvironmentResourcesResult
 */
public class DescribeEnvironmentResourcesResultStaxUnmarshaller implements
        Unmarshaller<DescribeEnvironmentResourcesResult, StaxUnmarshallerContext> {

    public DescribeEnvironmentResourcesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("EnvironmentResources", targetDepth)) {
                    describeEnvironmentResourcesResult
                            .setEnvironmentResources(EnvironmentResourceDescriptionStaxUnmarshaller
