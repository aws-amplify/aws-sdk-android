...
/**
 * StAX request marshaller for DeleteConfigurationTemplateRequest
 */
    ...
    public Request<DeleteConfigurationTemplateRequest> marshall(
        ...
        if (deleteConfigurationTemplateRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteConfigurationTemplateRequest)");
        }
        ...
        if (deleteConfigurationTemplateRequest.getApplicationName() != null) {
            ...
            String applicationName = deleteConfigurationTemplateRequest.getApplicationName();
        ...
        if (deleteConfigurationTemplateRequest.getTemplateName() != null) {
            prefix = "TemplateName";
            String templateName = deleteConfigurationTemplateRequest.getTemplateName();
