...
/**
 * StAX unmarshaller for model SolutionStackDescription
 */
class SolutionStackDescriptionStaxUnmarshaller implements
        Unmarshaller<SolutionStackDescription, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("SolutionStackName", targetDepth)) {
                    solutionStackDescription.setSolutionStackName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("PermittedFileTypes/member", targetDepth)) {
                    solutionStackDescription.withPermittedFileTypes(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
