...
/**
 * StAX unmarshaller for model EnvironmentInfoDescription
 */
class EnvironmentInfoDescriptionStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("InfoType", targetDepth)) {
                    environmentInfoDescription.setInfoType(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Ec2InstanceId", targetDepth)) {
                    environmentInfoDescription.setEc2InstanceId(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("SampleTimestamp", targetDepth)) {
                    environmentInfoDescription.setSampleTimestamp(DateStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Message", targetDepth)) {
                    environmentInfoDescription.setMessage(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
