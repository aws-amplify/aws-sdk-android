...
/**
 * StAX unmarshaller for response DescribeEnvironmentManagedActionsResult
 */
public class DescribeEnvironmentManagedActionsResultStaxUnmarshaller implements
        Unmarshaller<DescribeEnvironmentManagedActionsResult, StaxUnmarshallerContext> {

    public DescribeEnvironmentManagedActionsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ManagedActions/member", targetDepth)) {
                    describeEnvironmentManagedActionsResult
                            .withManagedActions(ManagedActionStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
