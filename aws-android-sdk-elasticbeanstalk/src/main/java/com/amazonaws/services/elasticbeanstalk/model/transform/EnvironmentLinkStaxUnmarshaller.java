...
/**
 * StAX unmarshaller for model EnvironmentLink
 */
class EnvironmentLinkStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("LinkName", targetDepth)) {
                    environmentLink.setLinkName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("EnvironmentName", targetDepth)) {
                    environmentLink.setEnvironmentName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
