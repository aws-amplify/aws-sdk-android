...
/**
 * StAX unmarshaller for response CreatePlatformVersionResult
 */
public class CreatePlatformVersionResultStaxUnmarshaller implements
        Unmarshaller<CreatePlatformVersionResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PlatformSummary", targetDepth)) {
                    createPlatformVersionResult.setPlatformSummary(PlatformSummaryStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Builder", targetDepth)) {
                    createPlatformVersionResult.setBuilder(BuilderStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
