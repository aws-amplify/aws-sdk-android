...
/**
 * StAX unmarshaller for model EnvironmentTier
 */
class EnvironmentTierStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Name", targetDepth)) {
                    environmentTier.setName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Type", targetDepth)) {
                    environmentTier.setType(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Version", targetDepth)) {
                    environmentTier.setVersion(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
