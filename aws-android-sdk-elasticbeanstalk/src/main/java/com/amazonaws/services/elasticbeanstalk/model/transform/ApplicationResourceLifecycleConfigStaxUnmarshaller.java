...
/**
 * StAX unmarshaller for model ApplicationResourceLifecycleConfig
 */
class ApplicationResourceLifecycleConfigStaxUnmarshaller implements
        Unmarshaller<ApplicationResourceLifecycleConfig, StaxUnmarshallerContext> {

    public ApplicationResourceLifecycleConfig unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ServiceRole", targetDepth)) {
                    applicationResourceLifecycleConfig.setServiceRole(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("VersionLifecycleConfig", targetDepth)) {
                    applicationResourceLifecycleConfig
                            .setVersionLifecycleConfig(ApplicationVersionLifecycleConfigStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
