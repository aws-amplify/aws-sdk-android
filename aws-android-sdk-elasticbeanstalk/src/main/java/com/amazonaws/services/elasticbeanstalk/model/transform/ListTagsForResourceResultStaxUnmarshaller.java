...
/**
 * StAX unmarshaller for response ListTagsForResourceResult
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ResourceArn", targetDepth)) {
                    listTagsForResourceResult.setResourceArn(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ResourceTags/member", targetDepth)) {
                    listTagsForResourceResult.withResourceTags(TagStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
