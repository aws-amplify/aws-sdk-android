...
/**
 * StAX unmarshaller for model PlatformFilter
 */
class PlatformFilterStaxUnmarshaller implements
        Unmarshaller<PlatformFilter, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("Operator", targetDepth)) {
                    platformFilter.setOperator(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Values/member", targetDepth)) {
                    platformFilter.withValues(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
