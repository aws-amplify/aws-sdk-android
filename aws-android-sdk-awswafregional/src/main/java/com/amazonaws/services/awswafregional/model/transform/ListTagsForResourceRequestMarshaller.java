...
public class ListTagsForResourceRequestMarshaller implements
    ...
    public Request<ListTagsForResourceRequest> marshall(
        ...
        Request<ListTagsForResourceRequest> request = new DefaultRequest<ListTagsForResourceRequest>(
                listTagsForResourceRequest, "AWSWAFRegional");
        ...
        try {
            ...
            if (listTagsForResourceRequest.getNextMarker() != null) {
                String nextMarker = listTagsForResourceRequest.getNextMarker();
                jsonWriter.name("NextMarker");
                jsonWriter.value(nextMarker);
            }
            if (listTagsForResourceRequest.getLimit() != null) {
                Integer limit = listTagsForResourceRequest.getLimit();
