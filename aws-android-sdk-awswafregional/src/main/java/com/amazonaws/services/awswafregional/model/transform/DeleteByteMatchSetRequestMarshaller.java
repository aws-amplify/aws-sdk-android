...
/**
 * JSON request marshaller for DeleteByteMatchSetRequest
 */
public class DeleteByteMatchSetRequestMarshaller implements
    ...
    public Request<DeleteByteMatchSetRequest> marshall(
        ...
        if (deleteByteMatchSetRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteByteMatchSetRequest)");
        }

        Request<DeleteByteMatchSetRequest> request = new DefaultRequest<DeleteByteMatchSetRequest>(
                deleteByteMatchSetRequest, "AWSWAFRegional");
        ...
        try {
            ...
            if (deleteByteMatchSetRequest.getByteMatchSetId() != null) {
                String byteMatchSetId = deleteByteMatchSetRequest.getByteMatchSetId();
                jsonWriter.name("ByteMatchSetId");
                jsonWriter.value(byteMatchSetId);
            }
            if (deleteByteMatchSetRequest.getChangeToken() != null) {
                String changeToken = deleteByteMatchSetRequest.getChangeToken();
