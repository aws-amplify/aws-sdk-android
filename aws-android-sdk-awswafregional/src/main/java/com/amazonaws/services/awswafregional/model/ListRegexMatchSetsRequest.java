 ...
 * </p>
 */
public class ListRegexMatchSetsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * @return <p>
     *         If you specify a value for <code>Limit</code> and you have more
     *         <code>RegexMatchSet</code> objects than the value of
     ...
     *         information about another batch of <code>RegexMatchSet</code>
     *         objects.
     *         </p>
     */
     ...
     *            more <code>RegexMatchSet</code> objects than the value of
     *            <code>Limit</code>, AWS WAF returns a <code>NextMarker</code>
     *            value in the response that allows you to list another group of
     *            <code>ByteMatchSets</code>. For the second and subsequent
     *            <code>ListRegexMatchSets</code> requests, specify the value of
     ...
     *
     * @return <p>
     *         Specifies the number of <code>RegexMatchSet</code> objects that
     *         you want AWS WAF to return for this request. If you have more
     *         <code>RegexMatchSet</code> objects than the number you specify
     ...
     *
     * @param limit <p>
     *            Specifies the number of <code>RegexMatchSet</code> objects
     *            that you want AWS WAF to return for this request. If you have
     *            more <code>RegexMatchSet</code> objects than the number you
