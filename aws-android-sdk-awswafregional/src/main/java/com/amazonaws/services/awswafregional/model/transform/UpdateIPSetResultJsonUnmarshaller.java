...
/**
 * JSON unmarshaller for response UpdateIPSetResult
 */
public class UpdateIPSetResultJsonUnmarshaller implements
        Unmarshaller<UpdateIPSetResult, JsonUnmarshallerContext> {
    ...
    public UpdateIPSetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ChangeToken")) {
                updateIPSetResult.setChangeToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
