...
/**
 * JSON request marshaller for ListSqlInjectionMatchSetsRequest
 */
public class ListSqlInjectionMatchSetsRequestMarshaller implements
    ...
    public Request<ListSqlInjectionMatchSetsRequest> marshall(
        ...
        if (listSqlInjectionMatchSetsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListSqlInjectionMatchSetsRequest)");
        }

        Request<ListSqlInjectionMatchSetsRequest> request = new DefaultRequest<ListSqlInjectionMatchSetsRequest>(
                listSqlInjectionMatchSetsRequest, "AWSWAFRegional");
        ...
        try {
            ...
            if (listSqlInjectionMatchSetsRequest.getNextMarker() != null) {
                String nextMarker = listSqlInjectionMatchSetsRequest.getNextMarker();
                jsonWriter.name("NextMarker");
                jsonWriter.value(nextMarker);
            }
            if (listSqlInjectionMatchSetsRequest.getLimit() != null) {
                Integer limit = listSqlInjectionMatchSetsRequest.getLimit();
