...
public class UpdateRuleRequestMarshaller implements
    ...
    public Request<UpdateRuleRequest> marshall(UpdateRuleRequest updateRuleRequest) {
        ...
        Request<UpdateRuleRequest> request = new DefaultRequest<UpdateRuleRequest>(
                updateRuleRequest, "AWSWAFRegional");
        ...
        try {
            ...
            if (updateRuleRequest.getRuleId() != null) {
                String ruleId = updateRuleRequest.getRuleId();
                jsonWriter.name("RuleId");
                jsonWriter.value(ruleId);
            }
            if (updateRuleRequest.getChangeToken() != null) {
                String changeToken = updateRuleRequest.getChangeToken();
                jsonWriter.name("ChangeToken");
                jsonWriter.value(changeToken);
            }
            if (updateRuleRequest.getUpdates() != null) {
                java.util.List<RuleUpdate> updates = updateRuleRequest.getUpdates();
