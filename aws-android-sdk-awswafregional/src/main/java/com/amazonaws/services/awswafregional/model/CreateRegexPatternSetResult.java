...
public class CreateRegexPatternSetResult implements Serializable {
    /**
     * <p>
     ...
     * <code>CreateRegexPatternSet</code> request. You can also use this value
     ...
     * @return <p>
     *         The <code>ChangeToken</code> that you used to submit the
     *         <code>CreateRegexPatternSet</code> request. You can also use this
     ...
     * @param changeToken <p>
     *            The <code>ChangeToken</code> that you used to submit the
     *            <code>CreateRegexPatternSet</code> request. You can also use
