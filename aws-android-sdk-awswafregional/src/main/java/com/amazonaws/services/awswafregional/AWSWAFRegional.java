...
/**
 * Interface for accessing AWS WAF Regional <note>
 * <p>
...
public interface AWSWAFRegional {
     ...
     * ("https://waf-regional.us-east-1.amazonaws.com"). Callers can use this
     * method to control which AWS region they want to work with.
     * <p>
     * Callers can pass in just the endpoint (ex:
     * "waf-regional.us-east-1.amazonaws.com") or a full URL, including the
     * protocol (ex: "https://waf-regional.us-east-1.amazonaws.com"). If the
     ...
     *
     * @param endpoint The endpoint (ex: "waf-regional.us-east-1.amazonaws.com")
     *            or a full URL, including the protocol (ex:
     *            "https://waf-regional.us-east-1.amazonaws.com") of the region
    ...
    /**
     * An alternative to {@link AWSWAFRegional#setEndpoint(String)}, sets the
     ...
     *             request, or a server side issue.
     */
    GetWebACLForResourceResult getWebACLForResource(
            GetWebACLForResourceRequest getWebACLForResourceRequest) throws AmazonClientException,
            AmazonServiceException;
     ...
     *             request, or a server side issue.
     */
    ListResourcesForWebACLResult listResourcesForWebACL(
