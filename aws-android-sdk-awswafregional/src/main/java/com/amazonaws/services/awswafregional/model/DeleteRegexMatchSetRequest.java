 ...
 * <code>RegexMatchSet</code> if it's still used in any <code>Rules</code> or if
 * it still includes any <code>RegexMatchTuples</code> objects (any filters).
 * </p>
 * <p>
 ...
 * </ol>
 */
public class DeleteRegexMatchSetRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     * The <code>RegexMatchSetId</code> of the <a>RegexMatchSet</a> that you
     * want to delete. <code>RegexMatchSetId</code> is returned by
     ...
     *         you want to delete. <code>RegexMatchSetId</code> is returned by
     *         <a>CreateRegexMatchSet</a> and by <a>ListRegexMatchSets</a>.
     *         </p>
     */
     ...
     *            that you want to delete. <code>RegexMatchSetId</code> is
