...
/**
 * JSON unmarshaller for response ListGeoMatchSetsResult
 */
public class ListGeoMatchSetsResultJsonUnmarshaller implements
        Unmarshaller<ListGeoMatchSetsResult, JsonUnmarshallerContext> {
    ...
    public ListGeoMatchSetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NextMarker")) {
                listGeoMatchSetsResult.setNextMarker(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("GeoMatchSets")) {
                listGeoMatchSetsResult.setGeoMatchSets(new ListUnmarshaller<GeoMatchSetSummary>(
                        GeoMatchSetSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
