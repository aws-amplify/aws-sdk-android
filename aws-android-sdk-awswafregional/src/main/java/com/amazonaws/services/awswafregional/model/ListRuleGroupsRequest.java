 ...
 * </p>
 */
public class ListRuleGroupsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * return for this request. If you have more <code>RuleGroups</code> than
     * the number that you specify for <code>Limit</code>, the response includes
     ...
     * @return <p>
     *         If you specify a value for <code>Limit</code> and you have more
     *         <code>RuleGroups</code> than the value of <code>Limit</code>, AWS
     *         WAF returns a <code>NextMarker</code> value in the response that
     *         allows you to list another group of <code>RuleGroups</code>. For
     *         the second and subsequent <code>ListRuleGroups</code> requests,
     ...
     *
     * @return <p>
     *         Specifies the number of <code>RuleGroups</code> that you want AWS
     *         WAF to return for this request. If you have more
     *         <code>RuleGroups</code> than the number that you specify for
     ...
     *
     * @param limit <p>
     *            Specifies the number of <code>RuleGroups</code> that you want
