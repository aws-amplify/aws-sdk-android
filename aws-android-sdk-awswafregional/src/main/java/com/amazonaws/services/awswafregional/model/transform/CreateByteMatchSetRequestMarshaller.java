...
/**
 * JSON request marshaller for CreateByteMatchSetRequest
 */
public class CreateByteMatchSetRequestMarshaller implements
    ...
    public Request<CreateByteMatchSetRequest> marshall(
        ...
        if (createByteMatchSetRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateByteMatchSetRequest)");
        }

        Request<CreateByteMatchSetRequest> request = new DefaultRequest<CreateByteMatchSetRequest>(
                createByteMatchSetRequest, "AWSWAFRegional");
        ...
        try {
            ...
            if (createByteMatchSetRequest.getName() != null) {
                String name = createByteMatchSetRequest.getName();
                jsonWriter.name("Name");
                jsonWriter.value(name);
            }
            if (createByteMatchSetRequest.getChangeToken() != null) {
                String changeToken = createByteMatchSetRequest.getChangeToken();
