...
/**
 * JSON marshaller for POJO SizeConstraintSetSummary
 */
class SizeConstraintSetSummaryJsonMarshaller {

    public void marshall(SizeConstraintSetSummary sizeConstraintSetSummary, AwsJsonWriter jsonWriter)
            throws Exception {
        jsonWriter.beginObject();
        if (sizeConstraintSetSummary.getSizeConstraintSetId() != null) {
            String sizeConstraintSetId = sizeConstraintSetSummary.getSizeConstraintSetId();
            jsonWriter.name("SizeConstraintSetId");
            jsonWriter.value(sizeConstraintSetId);
        }
        if (sizeConstraintSetSummary.getName() != null) {
            String name = sizeConstraintSetSummary.getName();
