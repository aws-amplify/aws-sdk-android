...
/**
 * JSON unmarshaller for POJO ByteMatchSet
 */
class ByteMatchSetJsonUnmarshaller implements Unmarshaller<ByteMatchSet, JsonUnmarshallerContext> {
    ...
    public ByteMatchSet unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ByteMatchSetId")) {
                byteMatchSet.setByteMatchSetId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Name")) {
                byteMatchSet.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ByteMatchTuples")) {
                byteMatchSet.setByteMatchTuples(new ListUnmarshaller<ByteMatchTuple>(
                        ByteMatchTupleJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
