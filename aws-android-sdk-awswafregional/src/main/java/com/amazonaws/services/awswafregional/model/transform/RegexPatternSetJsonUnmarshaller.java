...
/**
 * JSON unmarshaller for POJO RegexPatternSet
 */
class RegexPatternSetJsonUnmarshaller implements
        Unmarshaller<RegexPatternSet, JsonUnmarshallerContext> {
    ...
    public RegexPatternSet unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RegexPatternSetId")) {
                regexPatternSet.setRegexPatternSetId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Name")) {
                regexPatternSet.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("RegexPatternStrings")) {
                regexPatternSet.setRegexPatternStrings(new ListUnmarshaller<String>(
