...
/**
 * JSON unmarshaller for response GetRateBasedRuleManagedKeysResult
 */
public class GetRateBasedRuleManagedKeysResultJsonUnmarshaller implements
        Unmarshaller<GetRateBasedRuleManagedKeysResult, JsonUnmarshallerContext> {

    public GetRateBasedRuleManagedKeysResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ManagedKeys")) {
                getRateBasedRuleManagedKeysResult.setManagedKeys(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextMarker")) {
                getRateBasedRuleManagedKeysResult.setNextMarker(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
