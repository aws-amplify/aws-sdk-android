...
/**
 * JSON request marshaller for ListXssMatchSetsRequest
 */
    ...
    public Request<ListXssMatchSetsRequest> marshall(ListXssMatchSetsRequest listXssMatchSetsRequest) {
        if (listXssMatchSetsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListXssMatchSetsRequest)");
        }

        Request<ListXssMatchSetsRequest> request = new DefaultRequest<ListXssMatchSetsRequest>(
                listXssMatchSetsRequest, "AWSWAFRegional");
        ...
        try {
            ...
            if (listXssMatchSetsRequest.getNextMarker() != null) {
                String nextMarker = listXssMatchSetsRequest.getNextMarker();
                jsonWriter.name("NextMarker");
                jsonWriter.value(nextMarker);
            }
            if (listXssMatchSetsRequest.getLimit() != null) {
                Integer limit = listXssMatchSetsRequest.getLimit();
