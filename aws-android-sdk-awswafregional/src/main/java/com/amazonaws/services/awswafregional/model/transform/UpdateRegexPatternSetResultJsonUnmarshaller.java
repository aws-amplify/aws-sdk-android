...
/**
 * JSON unmarshaller for response UpdateRegexPatternSetResult
 */
public class UpdateRegexPatternSetResultJsonUnmarshaller implements
        Unmarshaller<UpdateRegexPatternSetResult, JsonUnmarshallerContext> {
    ...
    public UpdateRegexPatternSetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ChangeToken")) {
                updateRegexPatternSetResult.setChangeToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
