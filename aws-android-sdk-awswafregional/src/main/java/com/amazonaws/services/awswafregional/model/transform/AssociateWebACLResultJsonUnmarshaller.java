...
/**
 * JSON unmarshaller for response AssociateWebACLResult
 */
public class AssociateWebACLResultJsonUnmarshaller implements
        Unmarshaller<AssociateWebACLResult, JsonUnmarshallerContext> {
