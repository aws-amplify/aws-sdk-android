 ...
 * </p>
 */
public class ListWebACLsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *            more <code>WebACL</code> objects than the number that you
     *            specify for <code>Limit</code>, AWS WAF returns a
     *            <code>NextMarker</code> value in the response that allows you
     *            to list another group of <code>WebACL</code> objects. For the
     *            second and subsequent <code>ListWebACLs</code> requests,
     ...
     *
     * @param limit <p>
     *            Specifies the number of <code>WebACL</code> objects that you
     *            want AWS WAF to return for this request. If you have more
     *            <code>WebACL</code> objects than the number that you specify
