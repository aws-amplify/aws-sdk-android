 ...
 * </p>
 */
public class ByteMatchTuple implements Serializable {
    /**
     * <p>
     ...
     * request header that you specified in <a>FieldToMatch</a>, for example,
     * the value of the <code>User-Agent</code> or <code>Referer</code> header.
     * </p>
     * </li>
     * <li>
     * <p>
     * <code>METHOD</code>: The HTTP method, which indicates the type of
     ...
     * <li>
     * <p>
     * <code>QUERY_STRING</code>: The value that you want AWS WAF to search for
     ...
     * <li>
     * <p>
     * <code>URI</code>: The value that you want AWS WAF to search for in the
     ...
     * but instead of inspecting a single parameter, AWS WAF inspects all
     * parameters within the query string for the value or regex pattern that
     ...
     * <li>
     * <p>
     * <code>TargetString</code> exactly matches the value of the specified part
     * of the web request, such as the value of a header.
     * </p>
     * </li>
     * <li>
     * <p>
     * <code>TargetString</code> is at the beginning of the specified part of
     * the web request and is followed by a character other than an alphanumeric
     ...
     * <li>
     * <p>
     * <code>TargetString</code> is in the middle of the specified part of the
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>EXACTLY, STARTS_WITH, ENDS_WITH, CONTAINS,
     * CONTAINS_WORD
     */
     ...
     *
     * @return <p>
     *         The part of a web request that you want AWS WAF to search, such
     ...
     *            The part of a web request that you want AWS WAF to search,
     *            such as a specified header or a query string. For more
     ...
     *         <li>
     *         <p>
     *         <code>HEADER</code>: The value that you want AWS WAF to search
     *         for in the request header that you specified in
     *         <a>FieldToMatch</a>, for example, the value of the
     *         <code>User-Agent</code> or <code>Referer</code> header.
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     *         <code>METHOD</code>: The HTTP method, which indicates the type of
     *         operation specified in the request. CloudFront supports the
     ...
     *         <li>
     *         <p>
     *         <code>QUERY_STRING</code>: The value that you want AWS WAF to
     *         search for in the query string, which is the part of a URL that
     *         appears after a <code>?</code> character.
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     *         <code>URI</code>: The value that you want AWS WAF to search for
     *         in the part of a URL that identifies a resource, for example,
     *         <code>/images/daily-ad.jpg</code>.
     *         </p>
     *         </li>
     *         <li>
     ...
     *         <code>SINGLE_QUERY_ARG</code>, but instead of inspecting a single
     *         parameter, AWS WAF inspects all parameters within the query
     ...
     * </p>
     *
     * @param targetString <p>
     *            The value that you want AWS WAF to search for. AWS WAF
     *            searches for the specified string in the part of web requests
     *            that you specified in <code>FieldToMatch</code>. The maximum
     ...
     *            <li>
     *            <p>
     *            <code>METHOD</code>: The HTTP method, which indicates the type
     ...
     *            <p>
     *            <code>QUERY_STRING</code>: The value that you want AWS WAF to
     *            search for in the query string, which is the part of a URL
     *            that appears after a <code>?</code> character.
     *            </p>
     *            </li>
     *            <li>
     *            <p>
     *            <code>URI</code>: The value that you want AWS WAF to search
     *            for in the part of a URL that identifies a resource, for
     ...
     *            <p>
     *            <code>ALL_QUERY_ARGS</code>: Similar to
     *            <code>SINGLE_QUERY_ARG</code>, but instead of inspecting a
     *            single parameter, AWS WAF inspects all parameters within the
     *            query string for the value or regex pattern that you specify
     *            in <code>TargetString</code>.
     *            </p>
     *            </li>
     *            </ul>
     *            <p>
     *            If <code>TargetString</code> includes alphabetic characters
     ...
     *            </p>
     *            <p>
     *            Specify a base64-encoded version of the value. The maximum
     *            length of the value before you base64-encode it is 50 bytes.
     *            </p>
     *            <p>
     *            For example, suppose the value of <code>Type</code> is
     *            <code>HEADER</code> and the value of <code>Data</code> is
     *            <code>User-Agent</code>. If you want to search the
     *            <code>User-Agent</code> header for the value
     *            <code>BadBot</code>, you base64-encode <code>BadBot</code>
     *            using MIME base64-encoding and include the resulting value,
     *            <code>QmFkQm90</code>, in the value of
     *            <code>TargetString</code>.
     *            </p>
     *            <p>
     *            <b>If you're using the AWS CLI or one of the AWS SDKs</b>
     ...
     *         <li>
     *         <p>
     *         <code>TargetString</code> exactly matches the value of the
     *         specified part of the web request, such as the value of a header.
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     *         <code>TargetString</code> is at the beginning of the specified
     ...
     *         <li>
     *         <p>
     *         <code>TargetString</code> is at the end of the specified part of
     *         the web request and is preceded by a character other than an
     ...
     *         <li>
     *         <p>
     *         <code>TargetString</code> is in the middle of the specified part
     *         of the web request and is preceded and followed by characters
     *         other than alphanumeric characters or underscore (_), for
     *         example, <code>-BadBot;</code>.
     *         </p>
     *         </li>
     *         </ul>
     *         <p>
     ...
     * CONTAINS_WORD
     *
     * @param positionalConstraint <p>
     *            Within the portion of a web request that you want to search
     *            (for example, in the query string, if any), specify where you
     *            want AWS WAF to search. Valid values include the following:
     *            </p>
     *            <p>
     *            <b>CONTAINS</b>
     *            </p>
     *            <p>
     *            The specified part of the web request must include the value
     *            of <code>TargetString</code>, but the location doesn't matter.
     *            </p>
     *            <p>
     *            <b>CONTAINS_WORD</b>
     *            </p>
     *            <p>
     *            The specified part of the web request must include the value
     *            of <code>TargetString</code>, and <code>TargetString</code>
     *            must contain only alphanumeric characters or underscore (A-Z,
     *            a-z, 0-9, or _). In addition, <code>TargetString</code> must
     *            be a word, which means one of the following:
     *            </p>
     *            <ul>
     *            <li>
     *            <p>
     *            <code>TargetString</code> exactly matches the value of the
     *            specified part of the web request, such as the value of a
     *            header.
     *            </p>
     *            </li>
     *            <li>
     *            <p>
     *            <code>TargetString</code> is at the beginning of the specified
     *            part of the web request and is followed by a character other
     ...
     *            <li>
     *            <p>
     *            <code>TargetString</code> is at the end of the specified part
     *            of the web request and is preceded by a character other than
     *            an alphanumeric character or underscore (_), for example,
     *            <code>;BadBot</code>.
     *            </p>
     *            </li>
     *            <li>
     *            <p>
     *            <code>TargetString</code> is in the middle of the specified
     *            part of the web request and is preceded and followed by
     *            characters other than alphanumeric characters or underscore
     ...
     *            exactly match the value of <code>TargetString</code>.
     *            </p>
     *            <p>
     *            <b>STARTS_WITH</b>
     *            </p>
     ...
     *            </p>
     *            <p>
     *            The value of <code>TargetString</code> must appear at the end
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getTargetString() == null) ? 0 : getTargetString().hashCode());
        hashCode = prime * hashCode
                + ((getTextTransformation() == null) ? 0 : getTextTransformation().hashCode());
        hashCode = prime * hashCode
                + ((getPositionalConstraint() == null) ? 0 : getPositionalConstraint().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getPositionalConstraint() != null
                && other.getPositionalConstraint().equals(this.getPositionalConstraint()) == false)
            return false;
        return true;
    }
}
