...
/**
 * JSON unmarshaller for response ListRegexMatchSetsResult
 */
public class ListRegexMatchSetsResultJsonUnmarshaller implements
        Unmarshaller<ListRegexMatchSetsResult, JsonUnmarshallerContext> {
    ...
    public ListRegexMatchSetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NextMarker")) {
                listRegexMatchSetsResult.setNextMarker(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("RegexMatchSets")) {
                listRegexMatchSetsResult
                        .setRegexMatchSets(new ListUnmarshaller<RegexMatchSetSummary>(
                                RegexMatchSetSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
