...
/**
 * JSON request marshaller for CreateSizeConstraintSetRequest
 */
public class CreateSizeConstraintSetRequestMarshaller implements
    ...
    public Request<CreateSizeConstraintSetRequest> marshall(
        ...
        if (createSizeConstraintSetRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateSizeConstraintSetRequest)");
        }

        Request<CreateSizeConstraintSetRequest> request = new DefaultRequest<CreateSizeConstraintSetRequest>(
                createSizeConstraintSetRequest, "AWSWAFRegional");
        ...
        try {
            ...
            if (createSizeConstraintSetRequest.getName() != null) {
                String name = createSizeConstraintSetRequest.getName();
                jsonWriter.name("Name");
                jsonWriter.value(name);
            }
            if (createSizeConstraintSetRequest.getChangeToken() != null) {
                String changeToken = createSizeConstraintSetRequest.getChangeToken();
