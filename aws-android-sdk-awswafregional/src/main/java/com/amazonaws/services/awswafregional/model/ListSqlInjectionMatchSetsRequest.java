 ...
 * </p>
 */
public class ListSqlInjectionMatchSetsRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *            more <a>SqlInjectionMatchSet</a> objects than the value of
     *            <code>Limit</code>, AWS WAF returns a <code>NextMarker</code>
     *            value in the response that allows you to list another group of
     *            <code>SqlInjectionMatchSets</code>. For the second and
     *            subsequent <code>ListSqlInjectionMatchSets</code> requests,
     ...
     *
     * @param limit <p>
     *            Specifies the number of <a>SqlInjectionMatchSet</a> objects
     *            that you want AWS WAF to return for this request. If you have
     *            more <code>SqlInjectionMatchSet</code> objects than the number
