...
/**
 * JSON unmarshaller for POJO RuleGroupUpdate
 */
class RuleGroupUpdateJsonUnmarshaller implements
        Unmarshaller<RuleGroupUpdate, JsonUnmarshallerContext> {
    ...
    public RuleGroupUpdate unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Action")) {
                ruleGroupUpdate.setAction(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ActivatedRule")) {
                ruleGroupUpdate.setActivatedRule(ActivatedRuleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
