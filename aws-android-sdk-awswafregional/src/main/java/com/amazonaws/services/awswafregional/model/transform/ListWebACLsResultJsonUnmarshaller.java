...
/**
 * JSON unmarshaller for response ListWebACLsResult
 */
public class ListWebACLsResultJsonUnmarshaller implements
        Unmarshaller<ListWebACLsResult, JsonUnmarshallerContext> {
    ...
    public ListWebACLsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NextMarker")) {
                listWebACLsResult.setNextMarker(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("WebACLs")) {
                listWebACLsResult.setWebACLs(new ListUnmarshaller<WebACLSummary>(
                        WebACLSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
