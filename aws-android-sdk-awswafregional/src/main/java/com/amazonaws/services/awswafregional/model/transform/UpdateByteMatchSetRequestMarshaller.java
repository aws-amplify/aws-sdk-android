...
/**
 * JSON request marshaller for UpdateByteMatchSetRequest
 */
public class UpdateByteMatchSetRequestMarshaller implements
    ...
    public Request<UpdateByteMatchSetRequest> marshall(
        ...
        if (updateByteMatchSetRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateByteMatchSetRequest)");
        }

        Request<UpdateByteMatchSetRequest> request = new DefaultRequest<UpdateByteMatchSetRequest>(
                updateByteMatchSetRequest, "AWSWAFRegional");
        ...
        try {
            ...
            if (updateByteMatchSetRequest.getByteMatchSetId() != null) {
                String byteMatchSetId = updateByteMatchSetRequest.getByteMatchSetId();
                jsonWriter.name("ByteMatchSetId");
                jsonWriter.value(byteMatchSetId);
            }
            if (updateByteMatchSetRequest.getChangeToken() != null) {
                String changeToken = updateByteMatchSetRequest.getChangeToken();
                jsonWriter.name("ChangeToken");
                jsonWriter.value(changeToken);
            }
            if (updateByteMatchSetRequest.getUpdates() != null) {
                java.util.List<ByteMatchSetUpdate> updates = updateByteMatchSetRequest.getUpdates();
                jsonWriter.name("Updates");
                jsonWriter.beginArray();
                for (ByteMatchSetUpdate updatesItem : updates) {
                    if (updatesItem != null) {
                        ByteMatchSetUpdateJsonMarshaller.getInstance().marshall(updatesItem,
                                jsonWriter);
                    }
                }
                jsonWriter.endArray();
