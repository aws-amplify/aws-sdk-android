...
/**
 * JSON unmarshaller for POJO ByteMatchTuple
 */
class ByteMatchTupleJsonUnmarshaller implements
    ...
    public ByteMatchTuple unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("FieldToMatch")) {
                byteMatchTuple.setFieldToMatch(FieldToMatchJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TargetString")) {
                byteMatchTuple.setTargetString(ByteBufferJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TextTransformation")) {
                byteMatchTuple.setTextTransformation(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("PositionalConstraint")) {
                byteMatchTuple.setPositionalConstraint(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
