 ...
 * </p>
 */
public class ListActivatedRulesInRuleGroupRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     * The <code>RuleGroupId</code> of the <a>RuleGroup</a> for which you want
     * to get a list of <a>ActivatedRule</a> objects.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Length: </b>1 - 128<br/>
     ...
     * to list another group of <code>ActivatedRules</code>. For the second and
     ...
     *
     * @return <p>
     *         The <code>RuleGroupId</code> of the <a>RuleGroup</a> for which
     *         you want to get a list of <a>ActivatedRule</a> objects.
     *         </p>
     */
     ...
     * @return <p>
     *         If you specify a value for <code>Limit</code> and you have more
     *         <code>ActivatedRules</code> than the value of <code>Limit</code>,
     *         AWS WAF returns a <code>NextMarker</code> value in the response
     *         that allows you to list another group of
     *         <code>ActivatedRules</code>. For the second and subsequent
     *         <code>ListActivatedRulesInRuleGroup</code> requests, specify the
     ...
     *
     * @return <p>
     *         Specifies the number of <code>ActivatedRules</code> that you want
     ...
     *
     * @param limit <p>
     *            Specifies the number of <code>ActivatedRules</code> that you
     *            want AWS WAF to return for this request. If you have more
     *            <code>ActivatedRules</code> than the number that you specify
