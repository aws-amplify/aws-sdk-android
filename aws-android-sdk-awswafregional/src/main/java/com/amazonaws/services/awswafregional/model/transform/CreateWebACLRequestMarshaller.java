...
/**
 * JSON request marshaller for CreateWebACLRequest
 */
    ...
    public Request<CreateWebACLRequest> marshall(CreateWebACLRequest createWebACLRequest) {
        if (createWebACLRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateWebACLRequest)");
        }

        Request<CreateWebACLRequest> request = new DefaultRequest<CreateWebACLRequest>(
                createWebACLRequest, "AWSWAFRegional");
        ...
        try {
            ...
            if (createWebACLRequest.getName() != null) {
                String name = createWebACLRequest.getName();
                jsonWriter.name("Name");
                jsonWriter.value(name);
            }
            if (createWebACLRequest.getMetricName() != null) {
                String metricName = createWebACLRequest.getMetricName();
                jsonWriter.name("MetricName");
                jsonWriter.value(metricName);
            }
            if (createWebACLRequest.getDefaultAction() != null) {
                WafAction defaultAction = createWebACLRequest.getDefaultAction();
            ...
            if (createWebACLRequest.getChangeToken() != null) {
                String changeToken = createWebACLRequest.getChangeToken();
                jsonWriter.name("ChangeToken");
                jsonWriter.value(changeToken);
            }
            if (createWebACLRequest.getTags() != null) {
                java.util.List<Tag> tags = createWebACLRequest.getTags();
