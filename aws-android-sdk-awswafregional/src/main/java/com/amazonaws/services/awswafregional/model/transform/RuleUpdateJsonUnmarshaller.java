...
/**
 * JSON unmarshaller for POJO RuleUpdate
 */
class RuleUpdateJsonUnmarshaller implements Unmarshaller<RuleUpdate, JsonUnmarshallerContext> {
    ...
    public RuleUpdate unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Action")) {
                ...
                ruleUpdate.setPredicate(PredicateJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
