...
public class UpdateRegexPatternSetResult implements Serializable {
    /**
     * <p>
     * The <code>ChangeToken</code> that you used to submit the
     * <code>UpdateRegexPatternSet</code> request. You can also use this value
     ...
     * @return <p>
     *         The <code>ChangeToken</code> that you used to submit the
     *         <code>UpdateRegexPatternSet</code> request. You can also use this
     ...
     * @param changeToken <p>
     *            The <code>ChangeToken</code> that you used to submit the
     *            <code>UpdateRegexPatternSet</code> request. You can also use
