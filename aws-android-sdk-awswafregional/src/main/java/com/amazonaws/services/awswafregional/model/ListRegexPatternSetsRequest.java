 ...
 * </p>
 */
public class ListRegexPatternSetsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * to get information about another batch of <code>RegexPatternSet</code>
     * objects.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
    ...
    /**
     * <p>
     * Specifies the number of <code>RegexPatternSet</code> objects that you
     ...
     *         <code>RegexPatternSet</code> objects. For the second and
     *         subsequent <code>ListRegexPatternSets</code> requests, specify
     ...
     *            more <code>RegexPatternSet</code> objects than the value of
     *            <code>Limit</code>, AWS WAF returns a <code>NextMarker</code>
     *            value in the response that allows you to list another group of
     *            <code>RegexPatternSet</code> objects. For the second and
     *            subsequent <code>ListRegexPatternSets</code> requests, specify
     ...
     *
     * @return <p>
     *         Specifies the number of <code>RegexPatternSet</code> objects that
     *         you want AWS WAF to return for this request. If you have more
     *         <code>RegexPatternSet</code> objects than the number you specify
     ...
     *
     * @param limit <p>
     *            Specifies the number of <code>RegexPatternSet</code> objects
     *            that you want AWS WAF to return for this request. If you have
     *            more <code>RegexPatternSet</code> objects than the number you
