...
/**
 * JSON unmarshaller for response CreateSizeConstraintSetResult
 */
public class CreateSizeConstraintSetResultJsonUnmarshaller implements
    ...
    public CreateSizeConstraintSetResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SizeConstraintSet")) {
                createSizeConstraintSetResult
                        .setSizeConstraintSet(SizeConstraintSetJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("ChangeToken")) {
                createSizeConstraintSetResult.setChangeToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
