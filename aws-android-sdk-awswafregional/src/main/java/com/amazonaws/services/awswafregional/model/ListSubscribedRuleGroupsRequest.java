 ...
 * </p>
 */
public class ListSubscribedRuleGroupsRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     * @return <p>
     *         If you specify a value for <code>Limit</code> and you have more
     *         <code>ByteMatchSets</code>subscribed rule groups than the value
     *         of <code>Limit</code>, AWS WAF returns a <code>NextMarker</code>
     *         value in the response that allows you to list another group of
     *         subscribed rule groups. For the second and subsequent
     *         <code>ListSubscribedRuleGroupsRequest</code> requests, specify
     *         the value of <code>NextMarker</code> from the previous response
     *         to get information about another batch of subscribed rule groups.
     *         </p>
     */
     ...
     *            more <code>ByteMatchSets</code>subscribed rule groups than the
     *            value of <code>Limit</code>, AWS WAF returns a
     *            <code>NextMarker</code> value in the response that allows you
     *            to list another group of subscribed rule groups. For the
     *            second and subsequent
     *            <code>ListSubscribedRuleGroupsRequest</code> requests, specify
     *            the value of <code>NextMarker</code> from the previous
     *            response to get information about another batch of subscribed
     *            rule groups.
     *            </p>
     */
     ...
     *
     * @return <p>
     *         Specifies the number of subscribed rule groups that you want AWS
     *         WAF to return for this request. If you have more objects than the
     *         number you specify for <code>Limit</code>, the response includes
     *         a <code>NextMarker</code> value that you can use to get another
     *         batch of objects.
     *         </p>
     */
     ...
     *
     * @param limit <p>
     *            Specifies the number of subscribed rule groups that you want
     *            AWS WAF to return for this request. If you have more objects
     *            than the number you specify for <code>Limit</code>, the
