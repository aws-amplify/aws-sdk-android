...
/**
 * JSON unmarshaller for response CreateWebACLResult
 */
public class CreateWebACLResultJsonUnmarshaller implements
    ...
    public CreateWebACLResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("WebACL")) {
                createWebACLResult.setWebACL(WebACLJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ChangeToken")) {
                createWebACLResult.setChangeToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
