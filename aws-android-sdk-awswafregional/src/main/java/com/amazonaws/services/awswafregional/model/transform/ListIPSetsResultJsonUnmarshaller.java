...
/**
 * JSON unmarshaller for response ListIPSetsResult
 */
public class ListIPSetsResultJsonUnmarshaller implements
        Unmarshaller<ListIPSetsResult, JsonUnmarshallerContext> {
    ...
    public ListIPSetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NextMarker")) {
                listIPSetsResult.setNextMarker(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("IPSets")) {
                listIPSetsResult.setIPSets(new ListUnmarshaller<IPSetSummary>(
                        IPSetSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
