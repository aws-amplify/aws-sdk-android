...
/**
 * JSON unmarshaller for POJO SizeConstraintSetUpdate
 */
class SizeConstraintSetUpdateJsonUnmarshaller implements
    ...
    public SizeConstraintSetUpdate unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Action")) {
                sizeConstraintSetUpdate.setAction(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("SizeConstraint")) {
                sizeConstraintSetUpdate.setSizeConstraint(SizeConstraintJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
