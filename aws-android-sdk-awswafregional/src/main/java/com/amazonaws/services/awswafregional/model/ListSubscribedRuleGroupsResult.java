...
public class ListSubscribedRuleGroupsResult implements Serializable {
    /**
     * <p>
     ...
     *         If you have more objects than the number that you specified for
     *         <code>Limit</code> in the request, the response includes a
     *         <code>NextMarker</code> value. To list more objects, submit
     *         another <code>ListSubscribedRuleGroups</code> request, and
    ...
    public ListSubscribedRuleGroupsResult withRuleGroups(SubscribedRuleGroupSummary... ruleGroups) {
        if (getRuleGroups() == null) {
            this.ruleGroups = new java.util.ArrayList<SubscribedRuleGroupSummary>(ruleGroups.length);
        }
        for (SubscribedRuleGroupSummary value : ruleGroups) {
     ...
     *         chained together.
     */
    public ListSubscribedRuleGroupsResult withRuleGroups(
            java.util.Collection<SubscribedRuleGroupSummary> ruleGroups) {
