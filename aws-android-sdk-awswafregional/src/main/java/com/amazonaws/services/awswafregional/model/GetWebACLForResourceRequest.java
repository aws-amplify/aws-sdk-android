 ...
 * </p>
 */
public class GetWebACLForResourceRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         The ARN (Amazon Resource Name) of the resource for which to get
     *         the web ACL, either an application load balancer or Amazon API
     *         Gateway stage.
     *         </p>
     *         <p>
     *         The ARN should be in one of the following formats:
     ...
     *
     * @param resourceArn <p>
     *            The ARN (Amazon Resource Name) of the resource for which to
     *            get the web ACL, either an application load balancer or Amazon
     *            API Gateway stage.
     *            </p>
     *            <p>
     *            The ARN should be in one of the following formats:
