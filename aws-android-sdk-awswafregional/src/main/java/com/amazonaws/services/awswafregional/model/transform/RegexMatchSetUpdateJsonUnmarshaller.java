...
/**
 * JSON unmarshaller for POJO RegexMatchSetUpdate
 */
class RegexMatchSetUpdateJsonUnmarshaller implements
        Unmarshaller<RegexMatchSetUpdate, JsonUnmarshallerContext> {
    ...
    public RegexMatchSetUpdate unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Action")) {
                regexMatchSetUpdate.setAction(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("RegexMatchTuple")) {
                regexMatchSetUpdate.setRegexMatchTuple(RegexMatchTupleJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
