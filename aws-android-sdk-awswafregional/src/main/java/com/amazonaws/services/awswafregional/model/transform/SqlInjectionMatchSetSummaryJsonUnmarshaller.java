...
/**
 * JSON unmarshaller for POJO SqlInjectionMatchSetSummary
 */
class SqlInjectionMatchSetSummaryJsonUnmarshaller implements
        Unmarshaller<SqlInjectionMatchSetSummary, JsonUnmarshallerContext> {
    ...
    public SqlInjectionMatchSetSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SqlInjectionMatchSetId")) {
                sqlInjectionMatchSetSummary.setSqlInjectionMatchSetId(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Name")) {
                sqlInjectionMatchSetSummary.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
