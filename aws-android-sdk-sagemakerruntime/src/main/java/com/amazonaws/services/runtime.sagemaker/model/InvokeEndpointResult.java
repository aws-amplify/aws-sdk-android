...
public class InvokeEndpointResult implements Serializable {
     ...
     * <code>CustomAttributes</code> header of a request or other metadata that
     * a service endpoint was programmed to produce. The value must consist of
     ...
     * If the customer wants the custom attribute returned, the model must set
     * the custom attribute to be included on the way back.
     * </p>
     * <p>
     ...
     *
     * @return <p>
     *         Provides additional information in the response about the
     *         inference returned by a model hosted at an Amazon SageMaker
     *         endpoint. The information is an opaque value that is forwarded
     *         verbatim. You could use this value, for example, to return an ID
     *         received in the <code>CustomAttributes</code> header of a request
     *         or other metadata that a service endpoint was programmed to
     *         produce. The value must consist of no more than 1024 visible
     ...
     *         returned, the model must set the custom attribute to be included
     *         on the way back.
     *         </p>
     *         <p>
     *         This feature is currently supported in the AWS SDKs but not in
     ...
     *            inference returned by a model hosted at an Amazon SageMaker
     *            endpoint. The information is an opaque value that is forwarded
     *            verbatim. You could use this value, for example, to return an
     *            ID received in the <code>CustomAttributes</code> header of a
     *            request or other metadata that a service endpoint was
     *            programmed to produce. The value must consist of no more than
     ...
     *            attribute returned, the model must set the custom attribute to
