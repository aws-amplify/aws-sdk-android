...
import com.amazonaws.services.runtime.sagemaker.model.InternalFailureException;
...
public class InternalFailureExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InternalFailure");
    }
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        e.setErrorCode("InternalFailure");
