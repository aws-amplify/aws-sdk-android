...
package com.amazonaws.services.runtime.sagemaker;
...
import com.amazonaws.services.runtime.sagemaker.model.transform.*;

/**
 * Client for accessing Amazon SageMaker Runtime. All service calls made using
...
public class AmazonSageMakerRuntimeClient extends AmazonWebServiceClient implements
    ...
    /**
     * List of exception unmarshallers for all Amazon SageMaker Runtime
     * exceptions.
     */
     ...
     *         AmazonSageMakerRuntimeClient client = new AmazonSageMakerRuntimeClient(AWSMobileClient
     *                 .getInstance());
     *     }
     * 
     *     &#064;Override
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/runtime.sagemaker/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/runtime.sagemaker/request.handler2s"));
    }
     ...
     * </p>
     * <p>
     * For an overview of Amazon SageMaker, see <a href=
     ...
     *         method, as returned by Amazon SageMaker Runtime.
     ...
     *             SageMaker Runtime indicating either a problem with the data
