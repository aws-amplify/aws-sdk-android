...
public class BatchDeleteDevicePositionHistoryResult implements Serializable {
     ...
     *         chained together.
     */
    public BatchDeleteDevicePositionHistoryResult withErrors(
            BatchDeleteDevicePositionHistoryError... errors) {
        if (getErrors() == null) {
            this.errors = new java.util.ArrayList<BatchDeleteDevicePositionHistoryError>(
                    errors.length);
        }
        for (BatchDeleteDevicePositionHistoryError value : errors) {
     ...
     */
    public BatchDeleteDevicePositionHistoryResult withErrors(
            java.util.Collection<BatchDeleteDevicePositionHistoryError> errors) {
        setErrors(errors);
        return this;
    }
