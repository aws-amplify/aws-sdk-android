...
public class ListGeofenceCollectionsResult implements Serializable {
     ...
     *         chained together.
     */
    public ListGeofenceCollectionsResult withEntries(
            ListGeofenceCollectionsResponseEntry... entries) {
        if (getEntries() == null) {
            this.entries = new java.util.ArrayList<ListGeofenceCollectionsResponseEntry>(
                    entries.length);
        }
        for (ListGeofenceCollectionsResponseEntry value : entries) {
     ...
     */
    public ListGeofenceCollectionsResult withEntries(
            java.util.Collection<ListGeofenceCollectionsResponseEntry> entries) {
        setEntries(entries);
        return this;
    }
