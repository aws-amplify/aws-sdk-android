...
public class ListPlaceIndexesResult implements Serializable {
    ...
    public ListPlaceIndexesResult withEntries(ListPlaceIndexesResponseEntry... entries) {
        if (getEntries() == null) {
            this.entries = new java.util.ArrayList<ListPlaceIndexesResponseEntry>(entries.length);
        }
        for (ListPlaceIndexesResponseEntry value : entries) {
     ...
     *         chained together.
     */
    public ListPlaceIndexesResult withEntries(
            java.util.Collection<ListPlaceIndexesResponseEntry> entries) {
        setEntries(entries);
        return this;
    }
