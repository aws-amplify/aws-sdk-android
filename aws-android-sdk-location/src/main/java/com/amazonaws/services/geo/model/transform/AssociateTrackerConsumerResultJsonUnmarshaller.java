...
/**
 * JSON unmarshaller for response AssociateTrackerConsumerResult
 */
public class AssociateTrackerConsumerResultJsonUnmarshaller implements
        Unmarshaller<AssociateTrackerConsumerResult, JsonUnmarshallerContext> {

    public AssociateTrackerConsumerResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
