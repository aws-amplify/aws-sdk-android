...
public class ListKeysResult implements Serializable {
     ...
     *
     * @param entries <p>
     *            Contains API key resources in your Amazon Web Services
     *            account. Details include API key name, allowed referers and
     *            timestamp for when the API key will expire.
     *            </p>
     */
    ...
    public ListKeysResult withEntries(ListKeysResponseEntry... entries) {
        if (getEntries() == null) {
            this.entries = new java.util.ArrayList<ListKeysResponseEntry>(entries.length);
        }
        for (ListKeysResponseEntry value : entries) {
