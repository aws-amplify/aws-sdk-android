...
/**
 * StAX unmarshaller for response DescribeAlarmsResult
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("MetricAlarms/member", targetDepth)) {
                    describeAlarmsResult.withMetricAlarms(MetricAlarmStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    describeAlarmsResult.setNextToken(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
