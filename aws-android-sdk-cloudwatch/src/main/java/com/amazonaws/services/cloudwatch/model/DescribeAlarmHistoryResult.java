...
public class DescribeAlarmHistoryResult implements Serializable {
     ...
     * </p>
     */
    private java.util.List<AlarmHistoryItem> alarmHistoryItems = new java.util.ArrayList<AlarmHistoryItem>();
    ...
    public void setAlarmHistoryItems(java.util.Collection<AlarmHistoryItem> alarmHistoryItems) {
        ...
        this.alarmHistoryItems = new java.util.ArrayList<AlarmHistoryItem>(alarmHistoryItems);
    }
    ...
    public DescribeAlarmHistoryResult withAlarmHistoryItems(AlarmHistoryItem... alarmHistoryItems) {
        if (getAlarmHistoryItems() == null) {
            this.alarmHistoryItems = new java.util.ArrayList<AlarmHistoryItem>(
                    alarmHistoryItems.length);
        }
        for (AlarmHistoryItem value : alarmHistoryItems) {
            this.alarmHistoryItems.add(value);
        }
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getAlarmHistoryItems() == null) ? 0 : getAlarmHistoryItems().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAlarmHistoryItems() != null
                && other.getAlarmHistoryItems().equals(this.getAlarmHistoryItems()) == false)
            return false;
