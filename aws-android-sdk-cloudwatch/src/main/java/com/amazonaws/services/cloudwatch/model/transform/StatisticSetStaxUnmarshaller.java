...
/**
 * StAX unmarshaller for model StatisticSet
 */
class StatisticSetStaxUnmarshaller implements Unmarshaller<StatisticSet, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("SampleCount", targetDepth)) {
                    statisticSet.setSampleCount(DoubleStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                ...
                if (context.testExpression("Minimum", targetDepth)) {
                    statisticSet.setMinimum(DoubleStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Maximum", targetDepth)) {
                    statisticSet.setMaximum(DoubleStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
