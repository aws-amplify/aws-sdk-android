...
/**
 * StAX unmarshaller for model AlarmHistoryItem
 */
class AlarmHistoryItemStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("AlarmName", targetDepth)) {
                    alarmHistoryItem.setAlarmName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Timestamp", targetDepth)) {
                    alarmHistoryItem.setTimestamp(DateStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("HistoryItemType", targetDepth)) {
                    alarmHistoryItem.setHistoryItemType(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("HistorySummary", targetDepth)) {
                    alarmHistoryItem.setHistorySummary(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("HistoryData", targetDepth)) {
                    alarmHistoryItem.setHistoryData(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
