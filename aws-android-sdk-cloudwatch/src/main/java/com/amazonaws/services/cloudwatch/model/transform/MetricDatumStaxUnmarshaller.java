...
/**
 * StAX unmarshaller for model MetricDatum
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("MetricName", targetDepth)) {
                    metricDatum.setMetricName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                ...
                if (context.testExpression("Timestamp", targetDepth)) {
                    metricDatum
                            .setTimestamp(DateStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("StatisticValues", targetDepth)) {
                    metricDatum.setStatisticValues(StatisticSetStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
