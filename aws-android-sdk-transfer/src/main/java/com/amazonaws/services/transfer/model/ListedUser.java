...
public class ListedUser implements Serializable {
     ...
     * users' home directory. If you set it to <code>PATH</code>, the user will
     * see the absolute Amazon S3 bucket paths as is in their file transfer
     * protocol clients. If you set it <code>LOGICAL</code>, you will need to
     * provide mappings in the <code>HomeDirectoryMappings</code> for how you
     ...
     * file transfer protocol-enabled server to act on a user's behalf. It
     ...
     *
     * @return <p>
     *         Provides the unique Amazon Resource Name (ARN) for the user that
     ...
     *
     * @return <p>
     *         Specifies the type of landing directory (folder) you mapped for
     *         your users' home directory. If you set it to <code>PATH</code>,
     ...
     *            Specifies the type of landing directory (folder) you mapped
     *            for your users' home directory. If you set it to
     *            <code>PATH</code>, the user will see the absolute Amazon S3
     *            bucket paths as is in their file transfer protocol clients. If
     *            you set it <code>LOGICAL</code>, you will need to provide
     *            mappings in the <code>HomeDirectoryMappings</code> for how you
     *            want to make Amazon S3 paths visible to your users.
     *            </p>
     * @see HomeDirectoryType
     */
     ...
     *
     * @return <p>
     *         Specifies the role that is in use by this user. A <i>role</i> is
     *         an AWS Identity and Access Management (IAM) entity that, in this
     *         case, allows a file transfer protocol-enabled server to act on a
     *         user's behalf. It allows the server to inherit the trust
     ...
     *
     * @param role <p>
     *            Specifies the role that is in use by this user. A <i>role</i>
     *            is an AWS Identity and Access Management (IAM) entity that, in
     *            this case, allows a file transfer protocol-enabled server to
     *            act on a user's behalf. It allows the server to inherit the
     *            trust relationship that enables that user to perform file
