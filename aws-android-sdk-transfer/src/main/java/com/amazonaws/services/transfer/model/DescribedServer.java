 ...
 * logging role, the file transfer protocol or protocols, the server ID and
...
public class DescribedServer implements Serializable {
    ...
    /**
     * <p>
     * Defines the type of endpoint that your file transfer protocol-enabled
     * server is connected to. If your server is connected to a VPC endpoint,
     ...
     * <code>ssh-keygen -l -f my-new-server-key</code> command.
     * </p>
     */
     ...
     * logging for Amazon S3 events. When set, user activity can be viewed in
     ...
     *
     * @return <p>
     *         Specifies the ARN of the AWS Certificate Manager (ACM)
     ...
     *
     * @return <p>
     *         Specifies the virtual private cloud (VPC) endpoint settings that
     *         you configured for your file transfer protocol-enabled server.
     *         </p>
     */
     ...
     *            Specifies the virtual private cloud (VPC) endpoint settings
     *            that you configured for your file transfer protocol-enabled
     *            server.
     *            </p>
     */
     ...
     *         host key. This value is equivalent to the output of the
     *         <code>ssh-keygen -l -f my-new-server-key</code> command.
     *         </p>
     */
     ...
     *            Specifies the Base64-encoded SHA256 fingerprint of the
     *            server's host key. This value is equivalent to the output of
     *            the <code>ssh-keygen -l -f my-new-server-key</code> command.
     *            </p>
     */
     ...
     *            Amazon CloudWatch logging for Amazon S3 events. When set, user
     ...
     *         transfer protocol-enabled server that you instantiate.
     *         </p>
     */
     ...
     *
     * @param tags <p>
     *            Specifies the key-value pairs that you can use to search for
