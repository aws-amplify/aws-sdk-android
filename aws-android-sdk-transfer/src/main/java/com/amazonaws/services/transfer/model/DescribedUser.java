...
public class DescribedUser implements Serializable {
     ...
     * them visible. You will need to specify the "<code>Entry</code>" and "
     ...
     * make sure that your AWS Identity and Access Management (IAM) role
     ...
     *         bucket, for the described user. An example is <i>
     *         <code>your-Amazon-S3-bucket-name&gt;/home/username</code> </i>.
     *         </p>
     */
     ...
     *            S3 bucket, for the described user. An example is <i>
     ...
     *
     * @return <p>
     *         Specifies the logical directory mappings that specify what Amazon
     *         S3 paths and keys should be visible to your user and how you want
     *         to make them visible. You will need to specify the "
     ...
     *            Specifies the logical directory mappings that specify what
     *            Amazon S3 paths and keys should be visible to your user and
     *            how you want to make them visible. You will need to specify
     *            the "<code>Entry</code>" and "<code>Target</code>" pair, where
     *            <code>Entry</code> shows how the path is made visible and
     *            <code>Target</code> is the actual Amazon S3 path. If you only
     *            specify a target, it will be displayed as is. You will need to
     *            also make sure that your AWS Identity and Access Management
     ...
     *         your users to see when they log into the file transfer
     ...
     *            for your users to see when they log into the file transfer
     ...
     *            Specifies the public key portion of the Secure Shell (SSH)
     ...
     *
     * @param tags <p>
     *            Specifies the key-value pairs for the user requested. Tag can
     ...
     * @param userName <p>
     *            Specifies the name of the user that was requested to be
     *            described. User names are used for authentication purposes.
     *            This is the string that will be used by your user when they
     *            log in to your file transfer protocol-enabled server.
     *            </p>
     */
