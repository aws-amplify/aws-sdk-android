 ...
 * length. Each <code>ClusterListEntry</code> object contains a cluster's state,
 * a cluster's ID, and other important status information.
 * </p>
 */
public class ListClustersRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         in the list of <code>ClusterListEntry</code> objects, you have
     *         the option of specifying <code>NextToken</code> as the starting
     ...
     *            "next" in the list of <code>ClusterListEntry</code> objects,
     *            you have the option of specifying <code>NextToken</code> as
