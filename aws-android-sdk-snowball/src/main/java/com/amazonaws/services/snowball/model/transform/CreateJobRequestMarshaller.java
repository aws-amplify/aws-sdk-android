...
public class CreateJobRequestMarshaller implements
    ...
    public Request<CreateJobRequest> marshall(CreateJobRequest createJobRequest) {
        ...
        try {
            ...
            if (createJobRequest.getDeviceConfiguration() != null) {
                DeviceConfiguration deviceConfiguration = createJobRequest.getDeviceConfiguration();
                jsonWriter.name("DeviceConfiguration");
                DeviceConfigurationJsonMarshaller.getInstance().marshall(deviceConfiguration,
                        jsonWriter);
            }
