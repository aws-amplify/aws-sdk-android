...
public class StartStreamTranscriptionResultJsonUnmarshaller implements
    ...
    public StartStreamTranscriptionResult unmarshall(JsonUnmarshallerContext context)
        ...
        if (context.getHeader("x-amzn-transcribe-vocabulary-filter-name") != null)
            startStreamTranscriptionResult.setVocabularyFilterName(context
                    .getHeader("x-amzn-transcribe-vocabulary-filter-name"));
        if (context.getHeader("x-amzn-transcribe-vocabulary-filter-method") != null)
            startStreamTranscriptionResult.setVocabularyFilterMethod(context
                    .getHeader("x-amzn-transcribe-vocabulary-filter-method"));
