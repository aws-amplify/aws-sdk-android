...
public class Item implements Serializable {
     ...
     * filter you've chosen for your real-time stream. If <code>true</code> then
     * a word in the item matches your vocabulary filter.
     * </p>
     */
     ...
     *         <code>true</code> then a word in the item matches your vocabulary
     *         filter.
     *         </p>
     */
    public Boolean isVocabularyFilterMatch() {
     ...
     * </p>
     *
     * @param vocabularyFilterMatch <p>
     *            Indicates whether a word in the item matches a word in the
     *            vocabulary filter you've chosen for your real-time stream. If
     *            <code>true</code> then a word in the item matches your
     *            vocabulary filter.
     *            </p>
     */
    public void setVocabularyFilterMatch(Boolean vocabularyFilterMatch) {
     ...
     *         chained together.
     */
    public Item withVocabularyFilterMatch(Boolean vocabularyFilterMatch) {
        this.vocabularyFilterMatch = vocabularyFilterMatch;
        return this;
    }
    ...
    public String toString() {
        ...
        if (getVocabularyFilterMatch() != null)
            sb.append("VocabularyFilterMatch: " + getVocabularyFilterMatch());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getVocabularyFilterMatch() == null) ? 0 : getVocabularyFilterMatch().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getContent() != null && other.getContent().equals(this.getContent()) == false)
            return false;
        if (other.getVocabularyFilterMatch() == null ^ this.getVocabularyFilterMatch() == null)
            return false;
        if (other.getVocabularyFilterMatch() != null
                && other.getVocabularyFilterMatch().equals(this.getVocabularyFilterMatch()) == false)
            return false;
        return true;
    }
}
