    ...
    public Item unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("StartTime")) {
                item.setStartTime(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("EndTime")) {
                item.setEndTime(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                item.setContent(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("VocabularyFilterMatch")) {
                item.setVocabularyFilterMatch(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
