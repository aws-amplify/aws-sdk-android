...
public enum H264EntropyEncoding {
    ...
    private static final Map<String, H264EntropyEncoding> enumMap;
    static {
        enumMap = new HashMap<String, H264EntropyEncoding>();
        enumMap.put("CABAC", CABAC);
        enumMap.put("CAVLC", CAVLC);
    }
