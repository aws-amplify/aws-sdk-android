...
public class VideoDescription implements Serializable {
     ...
     * FRAME_CAPTURE codec) includes the values in the output. PASSTHROUGH (does
     * not apply to FRAME_CAPTURE codec) ignores the AFD values and includes the
     ...
     *         ratio, and (except for FRAME_CAPTURE codec) includes the values
     *         in the output. PASSTHROUGH (does not apply to FRAME_CAPTURE
     *         codec) ignores the AFD values and includes the values in the
     *         output, so input video is not clipped. NONE ignores the AFD
     *         values and does not include the values through to the output, so
     *         input video is not clipped.
     ...
     *            output display aspect ratio, and (except for FRAME_CAPTURE
     *            codec) includes the values in the output. PASSTHROUGH (does
     *            not apply to FRAME_CAPTURE codec) ignores the AFD values and
     ...
     * <b>Allowed Values: </b>DEFAULT, STRETCH_TO_OUTPUT
     *
     * @return STRETCH_TO_OUTPUT configures the output position to stretch the
     ...
     * <b>Allowed Values: </b>DEFAULT, STRETCH_TO_OUTPUT
     *
     * @param scalingBehavior STRETCH_TO_OUTPUT configures the output position
     *            to stretch the video to the specified output resolution
     *            (height and width). This option will override any position
     *            value. DEFAULT may insert black boxes (pillar boxes or letter
     *            boxes) around the video to provide the specified output
     *            resolution.
     * @see VideoDescriptionScalingBehavior
     */
