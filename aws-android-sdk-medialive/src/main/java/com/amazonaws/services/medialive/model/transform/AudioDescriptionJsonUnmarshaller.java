            ...
            if (name.equals("AudioNormalizationSettings")) {
                audioDescription
                        .setAudioNormalizationSettings(AudioNormalizationSettingsJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else if (name.equals("AudioSelectorName")) {
                audioDescription.setAudioSelectorName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("AudioType")) {
                audioDescription.setAudioType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                audioDescription.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
