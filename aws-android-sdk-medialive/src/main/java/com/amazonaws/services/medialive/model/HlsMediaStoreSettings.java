 ...
 */
public class HlsMediaStoreSettings implements Serializable {
    /**
     ...
     * <b>Allowed Values: </b>TEMPORAL
     *
     * @return When set to temporal, output files are stored in non-persistent
     ...
     * <b>Allowed Values: </b>TEMPORAL
     *
     * @param mediaStoreStorageClass When set to temporal, output files are
     *            stored in non-persistent memory for faster reading and
     *            writing.
     * @see HlsMediaStoreStorageClass
     */
     ...
     * @see HlsMediaStoreStorageClass
     */
    public HlsMediaStoreSettings withMediaStoreStorageClass(
    ...
    public String toString() {
        ...
        if (getMediaStoreStorageClass() != null)
            sb.append("MediaStoreStorageClass: " + getMediaStoreStorageClass() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getMediaStoreStorageClass() == null) ? 0 : getMediaStoreStorageClass()
                        .hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getMediaStoreStorageClass() == null ^ this.getMediaStoreStorageClass() == null)
            return false;
        if (other.getMediaStoreStorageClass() != null
                && other.getMediaStoreStorageClass().equals(this.getMediaStoreStorageClass()) == false)
            return false;
