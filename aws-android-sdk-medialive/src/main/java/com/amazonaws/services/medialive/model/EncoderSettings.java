...
public class EncoderSettings implements Serializable {
     ...
     * Feature Activations
     *
     * @param featureActivations Feature Activations
     */
    ...
    public String toString() {
        ...
        if (getFeatureActivations() != null)
            sb.append("FeatureActivations: " + getFeatureActivations() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getFeatureActivations() == null) ? 0 : getFeatureActivations().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getFeatureActivations() == null ^ this.getFeatureActivations() == null)
            return false;
        if (other.getFeatureActivations() != null
                && other.getFeatureActivations().equals(this.getFeatureActivations()) == false)
            return false;
