...
class NielsenConfigurationJsonMarshaller {
    ...
    public void marshall(NielsenConfiguration nielsenConfiguration, AwsJsonWriter jsonWriter)
        ...
        if (nielsenConfiguration.getNielsenPcmToId3Tagging() != null) {
            String nielsenPcmToId3Tagging = nielsenConfiguration.getNielsenPcmToId3Tagging();
            jsonWriter.name("NielsenPcmToId3Tagging");
            jsonWriter.value(nielsenPcmToId3Tagging);
        }
