...
public enum Scte35WebDeliveryAllowedFlag {
    ...
    private static final Map<String, Scte35WebDeliveryAllowedFlag> enumMap;
    static {
        enumMap = new HashMap<String, Scte35WebDeliveryAllowedFlag>();
        enumMap.put("WEB_DELIVERY_NOT_ALLOWED", WEB_DELIVERY_NOT_ALLOWED);
        enumMap.put("WEB_DELIVERY_ALLOWED", WEB_DELIVERY_ALLOWED);
    }
