...
public enum Scte35ArchiveAllowedFlag {
    ...
    private static final Map<String, Scte35ArchiveAllowedFlag> enumMap;
    static {
        enumMap = new HashMap<String, Scte35ArchiveAllowedFlag>();
        enumMap.put("ARCHIVE_NOT_ALLOWED", ARCHIVE_NOT_ALLOWED);
        enumMap.put("ARCHIVE_ALLOWED", ARCHIVE_ALLOWED);
    }
