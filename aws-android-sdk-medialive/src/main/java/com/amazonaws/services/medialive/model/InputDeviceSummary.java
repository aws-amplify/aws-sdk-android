 ...
 */
public class InputDeviceSummary implements Serializable {
    /**
     ...
     * @see DeviceSettingsSyncState
     */
    public InputDeviceSummary withDeviceSettingsSyncState(
     ...
     * Network settings for the input device.
     *
     * @param networkSettings Network settings for the input device.
     */
