...
public class InputSettings implements Serializable {
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>IGNORE, PREFER
     */
     ...
     * <b>Allowed Values: </b>IGNORE, PREFER
     *
     * @return Specifies whether to extract applicable ancillary data from a
     *         SMPTE-2038 source in this input. Applicable data types are
     *         captions, timecode, AFD, and SCTE-104 messages. - PREFER: Extract
     *         from SMPTE-2038 if present in this input, otherwise extract from
     *         another source (if any). - IGNORE: Never extract any ancillary
     ...
     * <b>Allowed Values: </b>IGNORE, PREFER
     *
     * @param smpte2038DataPreference Specifies whether to extract applicable
     *            ancillary data from a SMPTE-2038 source in this input.
     *            Applicable data types are captions, timecode, AFD, and
     *            SCTE-104 messages. - PREFER: Extract from SMPTE-2038 if
     *            present in this input, otherwise extract from another source
     *            (if any). - IGNORE: Never extract any ancillary data from
     *            SMPTE-2038.
     * @see Smpte2038DataPreference
     */
    ...
    public String toString() {
        ...
        if (getSmpte2038DataPreference() != null)
            sb.append("Smpte2038DataPreference: " + getSmpte2038DataPreference() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getSmpte2038DataPreference() == null) ? 0 : getSmpte2038DataPreference()
                        .hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSmpte2038DataPreference() == null ^ this.getSmpte2038DataPreference() == null)
            return false;
        if (other.getSmpte2038DataPreference() != null
                && other.getSmpte2038DataPreference().equals(this.getSmpte2038DataPreference()) == false)
            return false;
