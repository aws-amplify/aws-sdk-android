...
public class MsSmoothGroupSettings implements Serializable {
     ...
     * sparseTrackType is NONE.
     *
     * @return The ID to include in each message in the sparse track. Ignored if
     *         sparseTrackType is NONE.
     */
     ...
     * sparseTrackType is NONE.
     *
     * @param acquisitionPointId The ID to include in each message in the sparse
     *            track. Ignored if sparseTrackType is NONE.
     */
     ...
     * <b>Allowed Values: </b>NONE, SCTE_35, SCTE_35_WITHOUT_SEGMENTATION
     *
     * @return Identifies the type of data to place in the sparse track: -
     *         SCTE35: Insert SCTE-35 messages from the source content. With
     *         each message, insert an IDR frame to start a new segment. -
     *         SCTE35_WITHOUT_SEGMENTATION: Insert SCTE-35 messages from the
     *         source content. With each message, insert an IDR frame but don't
     *         start a new segment. - NONE: Don't generate a sparse track for
     *         any outputs in this output group.
     ...
     * <b>Allowed Values: </b>NONE, SCTE_35, SCTE_35_WITHOUT_SEGMENTATION
     *
     * @param sparseTrackType Identifies the type of data to place in the sparse
     *            track: - SCTE35: Insert SCTE-35 messages from the source
     *            content. With each message, insert an IDR frame to start a new
     *            segment. - SCTE35_WITHOUT_SEGMENTATION: Insert SCTE-35
     *            messages from the source content. With each message, insert an
     *            IDR frame but don't start a new segment. - NONE: Don't
