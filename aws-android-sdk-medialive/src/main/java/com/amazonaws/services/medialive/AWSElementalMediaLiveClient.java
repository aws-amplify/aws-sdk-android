...
public class AWSElementalMediaLiveClient extends AmazonWebServiceClient implements
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/medialive/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/medialive/request.handler2s"));
    }
     ...
     *             in the request, or a server side issue.
     */
    public DescribeInputDeviceResult describeInputDevice(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeInputDeviceRequestMarshaller()
                        .marshall(describeInputDeviceRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<DescribeInputDeviceResult, JsonUnmarshallerContext> unmarshaller = new DescribeInputDeviceResultJsonUnmarshaller();
            JsonResponseHandler<DescribeInputDeviceResult> responseHandler = new JsonResponseHandler<DescribeInputDeviceResult>(
                    unmarshaller);
     ...
     *             in the request, or a server side issue.
     */
    public ListInputDevicesResult listInputDevices(ListInputDevicesRequest listInputDevicesRequest)
            throws AmazonServiceException, AmazonClientException {
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListInputDevicesRequestMarshaller().marshall(listInputDevicesRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<ListInputDevicesResult, JsonUnmarshallerContext> unmarshaller = new ListInputDevicesResultJsonUnmarshaller();
            JsonResponseHandler<ListInputDevicesResult> responseHandler = new JsonResponseHandler<ListInputDevicesResult>(
                    unmarshaller);
     ...
     *             in the request, or a server side issue.
     */
    public UpdateInputDeviceResult updateInputDevice(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new UpdateInputDeviceRequestMarshaller()
                        .marshall(updateInputDeviceRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<UpdateInputDeviceResult, JsonUnmarshallerContext> unmarshaller = new UpdateInputDeviceResultJsonUnmarshaller();
            JsonResponseHandler<UpdateInputDeviceResult> responseHandler = new JsonResponseHandler<UpdateInputDeviceResult>(
                    unmarshaller);
