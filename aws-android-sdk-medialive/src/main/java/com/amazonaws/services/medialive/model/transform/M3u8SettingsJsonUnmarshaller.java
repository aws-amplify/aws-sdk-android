    ...
    public M3u8Settings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AudioFramesPerPes")) {
                ...
                m3u8Settings.setAudioPids(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("EcmPid")) {
                m3u8Settings.setEcmPid(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("NielsenId3Behavior")) {
                m3u8Settings.setNielsenId3Behavior(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                m3u8Settings.setPcrPeriod(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("PcrPid")) {
                m3u8Settings.setPcrPid(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("PmtInterval")) {
                m3u8Settings.setPmtInterval(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("PmtPid")) {
                m3u8Settings.setPmtPid(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ProgramNum")) {
                m3u8Settings.setProgramNum(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Scte35Behavior")) {
                m3u8Settings.setScte35Behavior(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Scte35Pid")) {
                m3u8Settings.setScte35Pid(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TimedMetadataBehavior")) {
                m3u8Settings.setTimedMetadataBehavior(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TimedMetadataPid")) {
                m3u8Settings.setTimedMetadataPid(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                m3u8Settings.setVideoPid(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
