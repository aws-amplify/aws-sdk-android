...
public class DvbSubDestinationSettings implements Serializable {
     ...
     * subtitles. This option is not valid for source captions that are STL or
     * 608/embedded. These source settings are already pre-defined by the
     ...
     *         subtitles. This option is not valid for source captions that are
     *         STL or 608/embedded. These source settings are already
     ...
     *            center-justify pre-recorded subtitles. This option is not
     *            valid for source captions that are STL or 608/embedded. These
     ...
     * @see DvbSubDestinationBackgroundColor
     */
    public DvbSubDestinationSettings withBackgroundColor(
            DvbSubDestinationBackgroundColor backgroundColor) {
        this.backgroundColor = backgroundColor.toString();
        return this;
    }
     ...
     * burn-in and DVB-Sub font settings must match.
     *
     * @return When set to auto fontSize will scale depending on the size of the
     *         output. Giving a positive integer will specify the exact font
     ...
     * @see DvbSubDestinationTeletextGridControl
     */
    public DvbSubDestinationSettings withTeletextGridControl(
            DvbSubDestinationTeletextGridControl teletextGridControl) {
        this.teletextGridControl = teletextGridControl.toString();
        return this;
    }
