...
public class ScheduleActionSettings implements Serializable {
     ...
     * Action to prepare an input for a future immediate input switch
     *
     * @param inputPrepareSettings Action to prepare an input for a future
     ...
     *         chained together.
     */
    public ScheduleActionSettings withInputPrepareSettings(
            InputPrepareScheduleActionSettings inputPrepareSettings) {
        this.inputPrepareSettings = inputPrepareSettings;
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getInputPrepareSettings() == null) ? 0 : getInputPrepareSettings().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getInputPrepareSettings() == null ^ this.getInputPrepareSettings() == null)
            return false;
        if (other.getInputPrepareSettings() != null
                && other.getInputPrepareSettings().equals(this.getInputPrepareSettings()) == false)
            return false;
