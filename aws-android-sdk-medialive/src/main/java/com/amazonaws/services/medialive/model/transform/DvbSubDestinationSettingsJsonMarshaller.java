...
class DvbSubDestinationSettingsJsonMarshaller {
    ...
    public void marshall(DvbSubDestinationSettings dvbSubDestinationSettings,
        ...
        if (dvbSubDestinationSettings.getFont() != null) {
            InputLocation font = dvbSubDestinationSettings.getFont();
        ...
        if (dvbSubDestinationSettings.getFontSize() != null) {
            String fontSize = dvbSubDestinationSettings.getFontSize();
        ...
        if (dvbSubDestinationSettings.getTeletextGridControl() != null) {
            String teletextGridControl = dvbSubDestinationSettings.getTeletextGridControl();
