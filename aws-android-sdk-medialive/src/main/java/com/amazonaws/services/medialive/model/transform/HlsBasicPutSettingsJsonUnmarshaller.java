...
/**
 * JSON unmarshaller for POJO HlsBasicPutSettings
 */
class HlsBasicPutSettingsJsonUnmarshaller implements
        Unmarshaller<HlsBasicPutSettings, JsonUnmarshallerContext> {
    ...
    public HlsBasicPutSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ConnectionRetryInterval")) {
                hlsBasicPutSettings.setConnectionRetryInterval(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("FilecacheDuration")) {
                hlsBasicPutSettings.setFilecacheDuration(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("NumRetries")) {
                hlsBasicPutSettings.setNumRetries(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("RestartDelay")) {
                hlsBasicPutSettings.setRestartDelay(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
