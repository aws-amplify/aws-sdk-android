 ...
 * Avail Configuration
 */
public class AvailConfiguration implements Serializable {
    /**
     * Ad avail settings.
     */
     ...
     * Ad avail settings.
     *
     * @param availSettings Ad avail settings.
     */
    ...
    public String toString() {
        ...
        if (getAvailSettings() != null)
            sb.append("AvailSettings: " + getAvailSettings());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getAvailSettings() == null) ? 0 : getAvailSettings().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAvailSettings() == null ^ this.getAvailSettings() == null)
            return false;
        if (other.getAvailSettings() != null
                && other.getAvailSettings().equals(this.getAvailSettings()) == false)
            return false;
        return true;
    }
}
