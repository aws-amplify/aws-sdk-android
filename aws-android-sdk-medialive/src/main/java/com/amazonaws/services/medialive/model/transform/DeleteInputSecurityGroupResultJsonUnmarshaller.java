...
/**
 * JSON unmarshaller for response DeleteInputSecurityGroupResult
 */
public class DeleteInputSecurityGroupResultJsonUnmarshaller implements
        Unmarshaller<DeleteInputSecurityGroupResult, JsonUnmarshallerContext> {

    public DeleteInputSecurityGroupResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
