 ...
 */
public class InputPrepareScheduleActionSettings implements Serializable {
    /**
     ...
     * any) when activated.
     *
     * @return The name of the input attachment that should be prepared by this
     *         action. If no name is provided, the action will stop the most
     *         recent prepare (if any) when activated.
     */
     ...
     * any) when activated.
     *
     * @param inputAttachmentNameReference The name of the input attachment that
     *            should be prepared by this action. If no name is provided, the
     *            action will stop the most recent prepare (if any) when
     *            activated.
     */
     ...
     *         chained together.
     */
    public InputPrepareScheduleActionSettings withInputAttachmentNameReference(
     ...
     *         chained together.
     */
    public InputPrepareScheduleActionSettings withInputClippingSettings(
