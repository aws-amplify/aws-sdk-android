...
public class CreateTagsRequestMarshaller implements
    ...
    public Request<CreateTagsRequest> marshall(CreateTagsRequest createTagsRequest) {
        ...
        Request<CreateTagsRequest> request = new DefaultRequest<CreateTagsRequest>(
                createTagsRequest, "AWSElementalMediaLive");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/prod/tags/{resource-arn}";
        uriResourcePath = uriResourcePath.replace(
                "{resource-arn}",
                (createTagsRequest.getResourceArn() == null) ? "" : StringUtils
                        .fromString(createTagsRequest.getResourceArn()));
        ...
        try {
            ...
            if (createTagsRequest.getTags() != null) {
                java.util.Map<String, String> tags = createTagsRequest.getTags();
