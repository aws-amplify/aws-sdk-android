...
class InputSettingsJsonMarshaller {
    ...
    public void marshall(InputSettings inputSettings, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (inputSettings.getSmpte2038DataPreference() != null) {
            String smpte2038DataPreference = inputSettings.getSmpte2038DataPreference();
            jsonWriter.name("Smpte2038DataPreference");
            jsonWriter.value(smpte2038DataPreference);
        }
