...
/**
 * JSON unmarshaller for POJO Scte35SpliceInsert
 */
class Scte35SpliceInsertJsonUnmarshaller implements
        Unmarshaller<Scte35SpliceInsert, JsonUnmarshallerContext> {
    ...
    public Scte35SpliceInsert unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AdAvailOffset")) {
                scte35SpliceInsert.setAdAvailOffset(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("NoRegionalBlackoutFlag")) {
                scte35SpliceInsert.setNoRegionalBlackoutFlag(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("WebDeliveryAllowedFlag")) {
                scte35SpliceInsert.setWebDeliveryAllowedFlag(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
