...
class Eac3SettingsJsonMarshaller {
    ...
    public void marshall(Eac3Settings eac3Settings, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (eac3Settings.getBitrate() != null) {
            Double bitrate = eac3Settings.getBitrate();
        ...
        if (eac3Settings.getDrcLine() != null) {
            String drcLine = eac3Settings.getDrcLine();
            jsonWriter.name("DrcLine");
            jsonWriter.value(drcLine);
        }
        if (eac3Settings.getDrcRf() != null) {
            String drcRf = eac3Settings.getDrcRf();
            jsonWriter.name("DrcRf");
            jsonWriter.value(drcRf);
        }
