...
public enum JobErrorLimitName {
    ...
    private static final Map<String, JobErrorLimitName> enumMap;
    static {
        enumMap = new HashMap<String, JobErrorLimitName>();
        enumMap.put("Assets per revision", AssetsPerRevision);
        enumMap.put("Asset size in GB", AssetSizeInGB);
    }
