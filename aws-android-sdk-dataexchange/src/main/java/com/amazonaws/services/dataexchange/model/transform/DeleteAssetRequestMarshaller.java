...
public class DeleteAssetRequestMarshaller implements
    ...
    public Request<DeleteAssetRequest> marshall(DeleteAssetRequest deleteAssetRequest) {
        ...
        Request<DeleteAssetRequest> request = new DefaultRequest<DeleteAssetRequest>(
                deleteAssetRequest, "AWSDataExchange");
        ...
        uriResourcePath = uriResourcePath.replace(
                "{DataSetId}",
                (deleteAssetRequest.getDataSetId() == null) ? "" : StringUtils
                        .fromString(deleteAssetRequest.getDataSetId()));
        uriResourcePath = uriResourcePath.replace(
                "{RevisionId}",
                (deleteAssetRequest.getRevisionId() == null) ? "" : StringUtils
                        .fromString(deleteAssetRequest.getRevisionId()));
