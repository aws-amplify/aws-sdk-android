...
/**
 * JSON request marshaller for UpdateRepositoryDescriptionRequest
 */
public class UpdateRepositoryDescriptionRequestMarshaller implements
    ...
    public Request<UpdateRepositoryDescriptionRequest> marshall(
        ...
        if (updateRepositoryDescriptionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateRepositoryDescriptionRequest)");
        }
        ...
        try {
            ...
            if (updateRepositoryDescriptionRequest.getRepositoryName() != null) {
                String repositoryName = updateRepositoryDescriptionRequest.getRepositoryName();
            ...
            if (updateRepositoryDescriptionRequest.getRepositoryDescription() != null) {
                String repositoryDescription = updateRepositoryDescriptionRequest
