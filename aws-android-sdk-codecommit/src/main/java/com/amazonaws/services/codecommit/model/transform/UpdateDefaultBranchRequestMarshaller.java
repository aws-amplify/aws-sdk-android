...
/**
 * JSON request marshaller for UpdateDefaultBranchRequest
 */
public class UpdateDefaultBranchRequestMarshaller implements
    ...
    public Request<UpdateDefaultBranchRequest> marshall(
        ...
        if (updateDefaultBranchRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateDefaultBranchRequest)");
        }
        ...
        try {
            ...
            if (updateDefaultBranchRequest.getRepositoryName() != null) {
                String repositoryName = updateDefaultBranchRequest.getRepositoryName();
                jsonWriter.name("repositoryName");
                jsonWriter.value(repositoryName);
            }
            if (updateDefaultBranchRequest.getDefaultBranchName() != null) {
                String defaultBranchName = updateDefaultBranchRequest.getDefaultBranchName();
                jsonWriter.name("defaultBranchName");
                jsonWriter.value(defaultBranchName);
            }
