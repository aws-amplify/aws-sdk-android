...
/**
 * JSON unmarshaller for response ListRepositoriesResult
 */
    ...
    public ListRepositoriesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("repositories")) {
                listRepositoriesResult.setRepositories(new ListUnmarshaller<RepositoryNameIdPair>(
                        RepositoryNameIdPairJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                listRepositoriesResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
