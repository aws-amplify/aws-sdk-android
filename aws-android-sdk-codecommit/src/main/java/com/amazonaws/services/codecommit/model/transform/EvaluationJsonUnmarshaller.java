    ...
    public Evaluation unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("approved")) {
                evaluation.setApproved(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("overridden")) {
                evaluation.setOverridden(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("approvalRulesSatisfied")) {
                evaluation.setApprovalRulesSatisfied(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("approvalRulesNotSatisfied")) {
                evaluation.setApprovalRulesNotSatisfied(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
