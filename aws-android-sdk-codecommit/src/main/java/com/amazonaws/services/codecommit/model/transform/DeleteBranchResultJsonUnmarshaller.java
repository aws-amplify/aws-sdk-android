...
/**
 * JSON unmarshaller for response DeleteBranchResult
 */
public class DeleteBranchResultJsonUnmarshaller implements
        Unmarshaller<DeleteBranchResult, JsonUnmarshallerContext> {
    ...
    public DeleteBranchResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("deletedBranch")) {
                deleteBranchResult.setDeletedBranch(BranchInfoJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
