...
/**
 * JSON unmarshaller for POJO PullRequestSourceReferenceUpdatedEventMetadata
 */
class PullRequestSourceReferenceUpdatedEventMetadataJsonUnmarshaller implements
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("repositoryName")) {
                pullRequestSourceReferenceUpdatedEventMetadata
                        .setRepositoryName(StringJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("beforeCommitId")) {
                pullRequestSourceReferenceUpdatedEventMetadata
                        .setBeforeCommitId(StringJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("afterCommitId")) {
                pullRequestSourceReferenceUpdatedEventMetadata
                        .setAfterCommitId(StringJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("mergeBase")) {
                pullRequestSourceReferenceUpdatedEventMetadata.setMergeBase(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
