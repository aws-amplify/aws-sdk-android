 ...
 * </p>
 */
public class BatchDescribeMergeConflictsRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *            The name of the repository that contains the merge conflicts
     *            you want to review.
     *            </p>
     */
     ...
     *         chained together.
     */
    public BatchDescribeMergeConflictsRequest withDestinationCommitSpecifier(
     ...
     *
     * @return <p>
     *         The path of the target files used to describe the conflicts. If
     *         not specified, the default is all conflict files.
     *         </p>
     */
    ...
    public BatchDescribeMergeConflictsRequest withFilePaths(String... filePaths) {
        if (getFilePaths() == null) {
            this.filePaths = new java.util.ArrayList<String>(filePaths.length);
        }
     ...
     * @see ConflictDetailLevelTypeEnum
     */
    public BatchDescribeMergeConflictsRequest withConflictDetailLevel(
     ...
     * @see ConflictResolutionStrategyTypeEnum
     */
    public BatchDescribeMergeConflictsRequest withConflictResolutionStrategy(
    ...
    public String toString() {
        ...
        if (getFilePaths() != null)
            sb.append("filePaths: " + getFilePaths() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getFilePaths() == null ^ this.getFilePaths() == null)
            return false;
        if (other.getFilePaths() != null
                && other.getFilePaths().equals(this.getFilePaths()) == false)
            return false;
