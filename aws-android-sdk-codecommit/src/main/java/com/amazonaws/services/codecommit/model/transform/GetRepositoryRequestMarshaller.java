...
/**
 * JSON request marshaller for GetRepositoryRequest
 */
    ...
    public Request<GetRepositoryRequest> marshall(GetRepositoryRequest getRepositoryRequest) {
        if (getRepositoryRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetRepositoryRequest)");
        }
        ...
        try {
            ...
            if (getRepositoryRequest.getRepositoryName() != null) {
                String repositoryName = getRepositoryRequest.getRepositoryName();
