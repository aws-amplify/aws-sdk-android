 ...
 * </p>
 */
public class GetMergeCommitRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *            The name of the repository that contains the merge commit
     ...
     * @see ConflictDetailLevelTypeEnum
     */
    public GetMergeCommitRequest withConflictDetailLevel(
     ...
     * @see ConflictResolutionStrategyTypeEnum
     */
    public GetMergeCommitRequest withConflictResolutionStrategy(
            ConflictResolutionStrategyTypeEnum conflictResolutionStrategy) {
        this.conflictResolutionStrategy = conflictResolutionStrategy.toString();
        return this;
    }
