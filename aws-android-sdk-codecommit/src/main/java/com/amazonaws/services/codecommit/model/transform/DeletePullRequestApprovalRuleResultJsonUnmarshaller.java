...
/**
 * JSON unmarshaller for response DeletePullRequestApprovalRuleResult
 */
public class DeletePullRequestApprovalRuleResultJsonUnmarshaller implements
        Unmarshaller<DeletePullRequestApprovalRuleResult, JsonUnmarshallerContext> {

    public DeletePullRequestApprovalRuleResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("approvalRuleId")) {
                deletePullRequestApprovalRuleResult.setApprovalRuleId(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
