...
/**
 * JSON unmarshaller for POJO RepositoryNameIdPair
 */
class RepositoryNameIdPairJsonUnmarshaller implements
    ...
    public RepositoryNameIdPair unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("repositoryName")) {
                repositoryNameIdPair.setRepositoryName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("repositoryId")) {
                repositoryNameIdPair.setRepositoryId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
