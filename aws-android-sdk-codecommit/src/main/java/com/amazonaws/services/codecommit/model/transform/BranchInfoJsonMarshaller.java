...
/**
 * JSON marshaller for POJO BranchInfo
 */
class BranchInfoJsonMarshaller {

    public void marshall(BranchInfo branchInfo, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (branchInfo.getCommitId() != null) {
            String commitId = branchInfo.getCommitId();
