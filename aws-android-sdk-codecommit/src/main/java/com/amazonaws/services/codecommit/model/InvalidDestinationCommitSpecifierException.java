 ...
 * </p>
 */
public class InvalidDestinationCommitSpecifierException extends AmazonServiceException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new InvalidDestinationCommitSpecifierException with the
