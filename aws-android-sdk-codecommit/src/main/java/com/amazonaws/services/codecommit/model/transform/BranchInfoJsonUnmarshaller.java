...
/**
 * JSON unmarshaller for POJO BranchInfo
 */
class BranchInfoJsonUnmarshaller implements Unmarshaller<BranchInfo, JsonUnmarshallerContext> {
    ...
    public BranchInfo unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("branchName")) {
                branchInfo.setBranchName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
