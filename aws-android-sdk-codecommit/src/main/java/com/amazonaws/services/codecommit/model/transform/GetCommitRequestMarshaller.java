...
/**
 * JSON request marshaller for GetCommitRequest
 */
public class GetCommitRequestMarshaller implements
    ...
    public Request<GetCommitRequest> marshall(GetCommitRequest getCommitRequest) {
        if (getCommitRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(GetCommitRequest)");
        }

        Request<GetCommitRequest> request = new DefaultRequest<GetCommitRequest>(getCommitRequest,
                "AWSCodeCommit");
        ...
        try {
            ...
            if (getCommitRequest.getRepositoryName() != null) {
                String repositoryName = getCommitRequest.getRepositoryName();
                jsonWriter.name("repositoryName");
                jsonWriter.value(repositoryName);
            }
            if (getCommitRequest.getCommitId() != null) {
                String commitId = getCommitRequest.getCommitId();
