...
/**
 * JSON unmarshaller for response GetApprovalRuleTemplateResult
 */
public class GetApprovalRuleTemplateResultJsonUnmarshaller implements
        Unmarshaller<GetApprovalRuleTemplateResult, JsonUnmarshallerContext> {

    public GetApprovalRuleTemplateResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
