...
/**
 * JSON request marshaller for UpdateRepositoryNameRequest
 */
public class UpdateRepositoryNameRequestMarshaller implements
    ...
    public Request<UpdateRepositoryNameRequest> marshall(
        ...
        if (updateRepositoryNameRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateRepositoryNameRequest)");
        }
        ...
        try {
            ...
            if (updateRepositoryNameRequest.getOldName() != null) {
                String oldName = updateRepositoryNameRequest.getOldName();
                jsonWriter.name("oldName");
                jsonWriter.value(oldName);
            }
            if (updateRepositoryNameRequest.getNewName() != null) {
                String newName = updateRepositoryNameRequest.getNewName();
                jsonWriter.name("newName");
                jsonWriter.value(newName);
            }
