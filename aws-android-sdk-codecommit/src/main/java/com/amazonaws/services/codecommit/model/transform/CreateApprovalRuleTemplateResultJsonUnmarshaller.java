...
/**
 * JSON unmarshaller for response CreateApprovalRuleTemplateResult
 */
public class CreateApprovalRuleTemplateResultJsonUnmarshaller implements
        Unmarshaller<CreateApprovalRuleTemplateResult, JsonUnmarshallerContext> {

    public CreateApprovalRuleTemplateResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
