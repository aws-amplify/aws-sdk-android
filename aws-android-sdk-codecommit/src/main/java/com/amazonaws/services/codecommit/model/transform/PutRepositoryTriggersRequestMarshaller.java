...
/**
 * JSON request marshaller for PutRepositoryTriggersRequest
 */
public class PutRepositoryTriggersRequestMarshaller implements
    ...
    public Request<PutRepositoryTriggersRequest> marshall(
        ...
        if (putRepositoryTriggersRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(PutRepositoryTriggersRequest)");
        }
        ...
        try {
            ...
            if (putRepositoryTriggersRequest.getRepositoryName() != null) {
                String repositoryName = putRepositoryTriggersRequest.getRepositoryName();
                jsonWriter.name("repositoryName");
                jsonWriter.value(repositoryName);
            }
            if (putRepositoryTriggersRequest.getTriggers() != null) {
                java.util.List<RepositoryTrigger> triggers = putRepositoryTriggersRequest
                        .getTriggers();
