...
/**
 * JSON unmarshaller for response CreateRepositoryResult
 */
public class CreateRepositoryResultJsonUnmarshaller implements
    ...
    public CreateRepositoryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("repositoryMetadata")) {
                createRepositoryResult.setRepositoryMetadata(RepositoryMetadataJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
