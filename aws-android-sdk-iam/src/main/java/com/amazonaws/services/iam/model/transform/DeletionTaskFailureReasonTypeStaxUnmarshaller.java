...
/**
 * StAX unmarshaller for model DeletionTaskFailureReasonType
 */
class DeletionTaskFailureReasonTypeStaxUnmarshaller implements
        Unmarshaller<DeletionTaskFailureReasonType, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Reason", targetDepth)) {
                    deletionTaskFailureReasonType.setReason(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("RoleUsageList/member", targetDepth)) {
                    deletionTaskFailureReasonType.withRoleUsageList(RoleUsageTypeStaxUnmarshaller
