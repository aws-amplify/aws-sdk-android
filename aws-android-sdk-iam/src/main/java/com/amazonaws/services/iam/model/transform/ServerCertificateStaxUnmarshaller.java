...
/**
 * StAX unmarshaller for model ServerCertificate
 */
class ServerCertificateStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("CertificateBody", targetDepth)) {
                    serverCertificate.setCertificateBody(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("CertificateChain", targetDepth)) {
                    serverCertificate.setCertificateChain(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
