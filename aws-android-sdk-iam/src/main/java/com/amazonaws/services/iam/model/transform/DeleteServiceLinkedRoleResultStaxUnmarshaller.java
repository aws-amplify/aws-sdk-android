...
/**
 * StAX unmarshaller for response DeleteServiceLinkedRoleResult
 */
public class DeleteServiceLinkedRoleResultStaxUnmarshaller implements
        Unmarshaller<DeleteServiceLinkedRoleResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DeletionTaskId", targetDepth)) {
                    deleteServiceLinkedRoleResult.setDeletionTaskId(StringStaxUnmarshaller
