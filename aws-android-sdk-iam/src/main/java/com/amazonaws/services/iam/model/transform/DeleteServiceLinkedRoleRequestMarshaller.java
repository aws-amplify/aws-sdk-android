...
/**
 * StAX request marshaller for DeleteServiceLinkedRoleRequest
 */
public class DeleteServiceLinkedRoleRequestMarshaller implements
    ...
    public Request<DeleteServiceLinkedRoleRequest> marshall(
        ...
        if (deleteServiceLinkedRoleRequest.getRoleName() != null) {
            prefix = "RoleName";
            String roleName = deleteServiceLinkedRoleRequest.getRoleName();
