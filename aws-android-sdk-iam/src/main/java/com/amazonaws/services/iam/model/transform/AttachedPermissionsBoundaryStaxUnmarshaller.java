...
/**
 * StAX unmarshaller for model AttachedPermissionsBoundary
 */
class AttachedPermissionsBoundaryStaxUnmarshaller implements
        Unmarshaller<AttachedPermissionsBoundary, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PermissionsBoundaryType", targetDepth)) {
                    attachedPermissionsBoundary.setPermissionsBoundaryType(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("PermissionsBoundaryArn", targetDepth)) {
                    attachedPermissionsBoundary.setPermissionsBoundaryArn(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
