...
/**
 * StAX unmarshaller for model ListPoliciesGrantingServiceAccessEntry
 */
class ListPoliciesGrantingServiceAccessEntryStaxUnmarshaller implements
        Unmarshaller<ListPoliciesGrantingServiceAccessEntry, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ServiceNamespace", targetDepth)) {
                    listPoliciesGrantingServiceAccessEntry
                            .setServiceNamespace(StringStaxUnmarshaller.getInstance().unmarshall(
                                    context));
                    continue;
                }
                if (context.testExpression("Policies/member", targetDepth)) {
                    listPoliciesGrantingServiceAccessEntry
                            .withPolicies(PolicyGrantingServiceAccessStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
