...
/**
 * StAX unmarshaller for response GetServerCertificateResult
 */
public class GetServerCertificateResultStaxUnmarshaller implements
        Unmarshaller<GetServerCertificateResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ServerCertificate", targetDepth)) {
                    getServerCertificateResult
                            .setServerCertificate(ServerCertificateStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
