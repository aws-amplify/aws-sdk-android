...
/**
 * StAX unmarshaller for model OrganizationsDecisionDetail
 */
class OrganizationsDecisionDetailStaxUnmarshaller implements
        Unmarshaller<OrganizationsDecisionDetail, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("AllowedByOrganizations", targetDepth)) {
                    organizationsDecisionDetail.setAllowedByOrganizations(BooleanStaxUnmarshaller
