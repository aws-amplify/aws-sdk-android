...
/**
 * StAX request marshaller for DetachGroupPolicyRequest
 */
    ...
    public Request<DetachGroupPolicyRequest> marshall(
        ...
        if (detachGroupPolicyRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DetachGroupPolicyRequest)");
        }

        Request<DetachGroupPolicyRequest> request = new DefaultRequest<DetachGroupPolicyRequest>(
                detachGroupPolicyRequest, "AWSIdentityandAccessManagement");
        ...
        if (detachGroupPolicyRequest.getGroupName() != null) {
            prefix = "GroupName";
            String groupName = detachGroupPolicyRequest.getGroupName();
            request.addParameter(prefix, StringUtils.fromString(groupName));
        }
        if (detachGroupPolicyRequest.getPolicyArn() != null) {
            prefix = "PolicyArn";
            String policyArn = detachGroupPolicyRequest.getPolicyArn();
