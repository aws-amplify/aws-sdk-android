 ...
 * </p>
 */
public class ListRoleTagsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * beyond the maximum that you specify, the <code>IsTruncated</code>
     ...
     *
     * @return <p>
     *         The name of the IAM role for which you want to see the list of
     *         tags.
     *         </p>
     *         <p>
     *         This parameter accepts (through its <a
     ...
     *         maximum number of items that you want in the response. If
     ...
     *         available. In that case, the <code>IsTruncated</code> response
     *         element returns <code>true</code>, and <code>Marker</code>
     ...
     *
     * @param maxItems <p>
     *            (Optional) Use this only when paginating results to indicate
     *            the maximum number of items that you want in the response. If
     *            additional items exist beyond the maximum that you specify,
     *            the <code>IsTruncated</code> response element is
     *            <code>true</code>.
     *            </p>
     *            <p>
     *            If you do not include this parameter, it defaults to 100. Note
     *            that IAM might return fewer results, even when more results
     *            are available. In that case, the <code>IsTruncated</code>
     *            response element returns <code>true</code>, and
     *            <code>Marker</code> contains a value to include in the
