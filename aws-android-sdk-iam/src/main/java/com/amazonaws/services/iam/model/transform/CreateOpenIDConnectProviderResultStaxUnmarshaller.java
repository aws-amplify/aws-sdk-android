...
/**
 * StAX unmarshaller for response CreateOpenIDConnectProviderResult
 */
public class CreateOpenIDConnectProviderResultStaxUnmarshaller implements
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("OpenIDConnectProviderArn", targetDepth)) {
                    createOpenIDConnectProviderResult
                            .setOpenIDConnectProviderArn(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
