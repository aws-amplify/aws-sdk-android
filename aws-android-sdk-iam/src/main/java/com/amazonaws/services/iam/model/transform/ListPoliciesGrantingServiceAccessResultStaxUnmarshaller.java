...
/**
 * StAX unmarshaller for response ListPoliciesGrantingServiceAccessResult
 */
public class ListPoliciesGrantingServiceAccessResultStaxUnmarshaller implements
        Unmarshaller<ListPoliciesGrantingServiceAccessResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PoliciesGrantingServiceAccess/member", targetDepth)) {
                    listPoliciesGrantingServiceAccessResult
                            .withPoliciesGrantingServiceAccess(ListPoliciesGrantingServiceAccessEntryStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("IsTruncated", targetDepth)) {
                    listPoliciesGrantingServiceAccessResult.setIsTruncated(BooleanStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Marker", targetDepth)) {
                    listPoliciesGrantingServiceAccessResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
