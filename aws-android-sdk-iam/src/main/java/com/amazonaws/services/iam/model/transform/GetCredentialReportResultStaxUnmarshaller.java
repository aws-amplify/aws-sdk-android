...
/**
 * StAX unmarshaller for response GetCredentialReportResult
 */
public class GetCredentialReportResultStaxUnmarshaller implements
        Unmarshaller<GetCredentialReportResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Content", targetDepth)) {
                    getCredentialReportResult.setContent(ByteBufferStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ReportFormat", targetDepth)) {
                    getCredentialReportResult.setReportFormat(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("GeneratedTime", targetDepth)) {
                    getCredentialReportResult.setGeneratedTime(DateStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
