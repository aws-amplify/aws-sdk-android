...
/**
 * StAX unmarshaller for response GetGroupResult
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Group", targetDepth)) {
                    getGroupResult
                            .setGroup(GroupStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Users/member", targetDepth)) {
                    getGroupResult
                            .withUsers(UserStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("IsTruncated", targetDepth)) {
                    getGroupResult.setIsTruncated(BooleanStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Marker", targetDepth)) {
                    getGroupResult.setMarker(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
