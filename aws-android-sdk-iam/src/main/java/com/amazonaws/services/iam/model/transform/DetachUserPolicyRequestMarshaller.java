...
/**
 * StAX request marshaller for DetachUserPolicyRequest
 */
    ...
    public Request<DetachUserPolicyRequest> marshall(DetachUserPolicyRequest detachUserPolicyRequest) {
        if (detachUserPolicyRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DetachUserPolicyRequest)");
        }

        Request<DetachUserPolicyRequest> request = new DefaultRequest<DetachUserPolicyRequest>(
                detachUserPolicyRequest, "AWSIdentityandAccessManagement");
        ...
        if (detachUserPolicyRequest.getUserName() != null) {
            prefix = "UserName";
            String userName = detachUserPolicyRequest.getUserName();
            request.addParameter(prefix, StringUtils.fromString(userName));
        }
        if (detachUserPolicyRequest.getPolicyArn() != null) {
            prefix = "PolicyArn";
            String policyArn = detachUserPolicyRequest.getPolicyArn();
