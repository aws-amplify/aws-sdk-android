...
/**
 * StAX unmarshaller for model Statement
 */
class StatementStaxUnmarshaller implements Unmarshaller<Statement, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("SourcePolicyId", targetDepth)) {
                    statement.setSourcePolicyId(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("SourcePolicyType", targetDepth)) {
                    statement.setSourcePolicyType(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("StartPosition", targetDepth)) {
                    statement.setStartPosition(PositionStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("EndPosition", targetDepth)) {
                    statement.setEndPosition(PositionStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
