...
/**
 * StAX request marshaller for RemoveClientIDFromOpenIDConnectProviderRequest
 */
    ...
    public Request<RemoveClientIDFromOpenIDConnectProviderRequest> marshall(
        ...
        if (removeClientIDFromOpenIDConnectProviderRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RemoveClientIDFromOpenIDConnectProviderRequest)");
        }
        ...
        Request<RemoveClientIDFromOpenIDConnectProviderRequest> request = new DefaultRequest<RemoveClientIDFromOpenIDConnectProviderRequest>(
                removeClientIDFromOpenIDConnectProviderRequest, "AWSIdentityandAccessManagement");
        ...
        if (removeClientIDFromOpenIDConnectProviderRequest.getOpenIDConnectProviderArn() != null) {
            ...
            String openIDConnectProviderArn = removeClientIDFromOpenIDConnectProviderRequest
        ...
        if (removeClientIDFromOpenIDConnectProviderRequest.getClientID() != null) {
            prefix = "ClientID";
            String clientID = removeClientIDFromOpenIDConnectProviderRequest.getClientID();
            request.addParameter(prefix, StringUtils.fromString(clientID));
        }
