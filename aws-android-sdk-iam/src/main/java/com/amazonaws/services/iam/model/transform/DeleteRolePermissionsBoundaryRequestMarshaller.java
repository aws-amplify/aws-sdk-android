...
/**
 * StAX request marshaller for DeleteRolePermissionsBoundaryRequest
 */
public class DeleteRolePermissionsBoundaryRequestMarshaller
    ...
    public Request<DeleteRolePermissionsBoundaryRequest> marshall(
        ...
        if (deleteRolePermissionsBoundaryRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteRolePermissionsBoundaryRequest)");
        }

        Request<DeleteRolePermissionsBoundaryRequest> request = new DefaultRequest<DeleteRolePermissionsBoundaryRequest>(
                deleteRolePermissionsBoundaryRequest, "AWSIdentityandAccessManagement");
        ...
        if (deleteRolePermissionsBoundaryRequest.getRoleName() != null) {
            prefix = "RoleName";
            String roleName = deleteRolePermissionsBoundaryRequest.getRoleName();
