...
public class ListSigningCertificatesResult implements Serializable {
    ...
    public void setCertificates(java.util.Collection<SigningCertificate> certificates) {
        ...
        this.certificates = new java.util.ArrayList<SigningCertificate>(certificates);
    }
    ...
    public ListSigningCertificatesResult withCertificates(SigningCertificate... certificates) {
        if (getCertificates() == null) {
            this.certificates = new java.util.ArrayList<SigningCertificate>(certificates.length);
        }
     ...
     *         chained together.
     */
    public ListSigningCertificatesResult withCertificates(
            java.util.Collection<SigningCertificate> certificates) {
