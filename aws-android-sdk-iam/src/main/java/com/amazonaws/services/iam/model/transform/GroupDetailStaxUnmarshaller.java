...
/**
 * StAX unmarshaller for model GroupDetail
 */
class GroupDetailStaxUnmarshaller implements Unmarshaller<GroupDetail, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("GroupName", targetDepth)) {
                    groupDetail.setGroupName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                ...
                if (context.testExpression("CreateDate", targetDepth)) {
                    groupDetail.setCreateDate(DateStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("GroupPolicyList/member", targetDepth)) {
                    groupDetail.withGroupPolicyList(PolicyDetailStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("AttachedManagedPolicies/member", targetDepth)) {
                    groupDetail.withAttachedManagedPolicies(AttachedPolicyStaxUnmarshaller
