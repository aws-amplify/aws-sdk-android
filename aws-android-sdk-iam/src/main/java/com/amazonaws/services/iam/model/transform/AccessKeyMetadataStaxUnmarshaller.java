...
/**
 * StAX unmarshaller for model AccessKeyMetadata
 */
class AccessKeyMetadataStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("UserName", targetDepth)) {
                    accessKeyMetadata.setUserName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("AccessKeyId", targetDepth)) {
                    accessKeyMetadata.setAccessKeyId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Status", targetDepth)) {
                    accessKeyMetadata.setStatus(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("CreateDate", targetDepth)) {
                    accessKeyMetadata.setCreateDate(DateStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
