...
/**
 * StAX request marshaller for GetPolicyVersionRequest
 */
    ...
    public Request<GetPolicyVersionRequest> marshall(GetPolicyVersionRequest getPolicyVersionRequest) {
        if (getPolicyVersionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetPolicyVersionRequest)");
        }

        Request<GetPolicyVersionRequest> request = new DefaultRequest<GetPolicyVersionRequest>(
                getPolicyVersionRequest, "AWSIdentityandAccessManagement");
        ...
        if (getPolicyVersionRequest.getPolicyArn() != null) {
            prefix = "PolicyArn";
            String policyArn = getPolicyVersionRequest.getPolicyArn();
            request.addParameter(prefix, StringUtils.fromString(policyArn));
        }
        if (getPolicyVersionRequest.getVersionId() != null) {
            prefix = "VersionId";
            String versionId = getPolicyVersionRequest.getVersionId();
