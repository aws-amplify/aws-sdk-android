...
/**
 * StAX request marshaller for GenerateCredentialReportRequest
 */
public class GenerateCredentialReportRequestMarshaller implements
    ...
    public Request<GenerateCredentialReportRequest> marshall(
        ...
        if (generateCredentialReportRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GenerateCredentialReportRequest)");
        }

        Request<GenerateCredentialReportRequest> request = new DefaultRequest<GenerateCredentialReportRequest>(
                generateCredentialReportRequest, "AWSIdentityandAccessManagement");
