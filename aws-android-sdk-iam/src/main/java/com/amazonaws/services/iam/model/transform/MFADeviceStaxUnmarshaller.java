...
/**
 * StAX unmarshaller for model MFADevice
 */
class MFADeviceStaxUnmarshaller implements Unmarshaller<MFADevice, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("SerialNumber", targetDepth)) {
                    mFADevice.setSerialNumber(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
