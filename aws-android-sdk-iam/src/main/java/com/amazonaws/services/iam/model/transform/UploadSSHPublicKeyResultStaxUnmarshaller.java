...
/**
 * StAX unmarshaller for response UploadSSHPublicKeyResult
 */
public class UploadSSHPublicKeyResultStaxUnmarshaller implements
        Unmarshaller<UploadSSHPublicKeyResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("SSHPublicKey", targetDepth)) {
                    uploadSSHPublicKeyResult.setSSHPublicKey(SSHPublicKeyStaxUnmarshaller
