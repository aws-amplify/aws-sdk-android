...
/**
 * StAX unmarshaller for response GenerateCredentialReportResult
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("State", targetDepth)) {
                    generateCredentialReportResult.setState(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Description", targetDepth)) {
                    generateCredentialReportResult.setDescription(StringStaxUnmarshaller
