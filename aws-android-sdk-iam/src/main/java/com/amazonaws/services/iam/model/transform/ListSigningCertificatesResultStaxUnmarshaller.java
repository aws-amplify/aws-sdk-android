...
/**
 * StAX unmarshaller for response ListSigningCertificatesResult
 */
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Certificates/member", targetDepth)) {
                    listSigningCertificatesResult
                            .withCertificates(SigningCertificateStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("IsTruncated", targetDepth)) {
                    listSigningCertificatesResult.setIsTruncated(BooleanStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Marker", targetDepth)) {
                    listSigningCertificatesResult.setMarker(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
