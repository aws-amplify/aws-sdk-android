...
/**
 * StAX request marshaller for UpdateRoleRequest
 */
public class UpdateRoleRequestMarshaller implements
        Marshaller<Request<UpdateRoleRequest>, UpdateRoleRequest> {

    public Request<UpdateRoleRequest> marshall(UpdateRoleRequest updateRoleRequest) {
        if (updateRoleRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateRoleRequest)");
        }

        Request<UpdateRoleRequest> request = new DefaultRequest<UpdateRoleRequest>(
                updateRoleRequest, "AWSIdentityandAccessManagement");
        ...
        if (updateRoleRequest.getMaxSessionDuration() != null) {
            ...
            Integer maxSessionDuration = updateRoleRequest.getMaxSessionDuration();
