...
/**
 * StAX unmarshaller for response UpdateRoleDescriptionResult
 */
public class UpdateRoleDescriptionResultStaxUnmarshaller implements
        Unmarshaller<UpdateRoleDescriptionResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Role", targetDepth)) {
                    updateRoleDescriptionResult.setRole(RoleStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
