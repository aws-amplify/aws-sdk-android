...
/**
 * StAX unmarshaller for response ListVirtualMFADevicesResult
 */
public class ListVirtualMFADevicesResultStaxUnmarshaller implements
        Unmarshaller<ListVirtualMFADevicesResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("VirtualMFADevices/member", targetDepth)) {
                    listVirtualMFADevicesResult
                            .withVirtualMFADevices(VirtualMFADeviceStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("IsTruncated", targetDepth)) {
                    listVirtualMFADevicesResult.setIsTruncated(BooleanStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Marker", targetDepth)) {
                    listVirtualMFADevicesResult.setMarker(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
