...
/**
 * StAX request marshaller for ListSSHPublicKeysRequest
 */
    ...
    public Request<ListSSHPublicKeysRequest> marshall(
        ...
        if (listSSHPublicKeysRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListSSHPublicKeysRequest)");
        }

        Request<ListSSHPublicKeysRequest> request = new DefaultRequest<ListSSHPublicKeysRequest>(
                listSSHPublicKeysRequest, "AWSIdentityandAccessManagement");
