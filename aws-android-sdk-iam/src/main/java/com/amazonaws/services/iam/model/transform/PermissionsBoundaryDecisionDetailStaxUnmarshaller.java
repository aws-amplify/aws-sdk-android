...
/**
 * StAX unmarshaller for model PermissionsBoundaryDecisionDetail
 */
class PermissionsBoundaryDecisionDetailStaxUnmarshaller implements
        Unmarshaller<PermissionsBoundaryDecisionDetail, StaxUnmarshallerContext> {

    public PermissionsBoundaryDecisionDetail unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("AllowedByPermissionsBoundary", targetDepth)) {
                    permissionsBoundaryDecisionDetail
                            .setAllowedByPermissionsBoundary(BooleanStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
