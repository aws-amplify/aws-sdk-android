...
public class ListUsersRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         <code>/division_abc/subdivision_xyz/</code>.
     *         </p>
     *         <p>
     *         This parameter is optional. If it is not included, it defaults to
     *         a slash (/), listing all user names. This parameter allows
     ...
     * @param pathPrefix <p>
     *            The path prefix for filtering the results. For example:
     *            <code>/division_abc/subdivision_xyz/</code>, which would get
     *            all user names whose path starts with
     *            <code>/division_abc/subdivision_xyz/</code>.
     *            </p>
     *            <p>
     *            This parameter is optional. If it is not included, it defaults
     *            to a slash (/), listing all user names. This parameter allows
     *            (through its <a href="http://wikipedia.org/wiki/regex">regex
     *            pattern</a>) a string of characters consisting of either a
     *            forward slash (/) by itself or a string that must begin and
     *            end with forward slashes. In addition, it can contain any
     *            ASCII character from the ! (<code>\u0021</code>) through the
     *            DEL character (<code>\u007F</code>), including most
