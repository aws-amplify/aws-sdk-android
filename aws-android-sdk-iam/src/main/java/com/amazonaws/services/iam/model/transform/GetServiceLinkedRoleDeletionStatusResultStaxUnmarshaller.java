...
/**
 * StAX unmarshaller for response GetServiceLinkedRoleDeletionStatusResult
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Status", targetDepth)) {
                    getServiceLinkedRoleDeletionStatusResult.setStatus(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Reason", targetDepth)) {
                    getServiceLinkedRoleDeletionStatusResult
                            .setReason(DeletionTaskFailureReasonTypeStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
