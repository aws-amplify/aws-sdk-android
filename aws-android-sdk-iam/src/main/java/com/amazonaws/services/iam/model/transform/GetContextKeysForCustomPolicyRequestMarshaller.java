...
/**
 * StAX request marshaller for GetContextKeysForCustomPolicyRequest
 */
    ...
    public Request<GetContextKeysForCustomPolicyRequest> marshall(
        ...
        if (getContextKeysForCustomPolicyRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetContextKeysForCustomPolicyRequest)");
        }

        Request<GetContextKeysForCustomPolicyRequest> request = new DefaultRequest<GetContextKeysForCustomPolicyRequest>(
                getContextKeysForCustomPolicyRequest, "AWSIdentityandAccessManagement");
        request.addParameter("Action", "GetContextKeysForCustomPolicy");
        request.addParameter("Version", "2010-05-08");

        String prefix;
        if (getContextKeysForCustomPolicyRequest.getPolicyInputList() != null) {
            prefix = "PolicyInputList";
            java.util.List<String> policyInputList = getContextKeysForCustomPolicyRequest
                    .getPolicyInputList();
