...
/**
 * StAX request marshaller for DeleteAccountAliasRequest
 */
public class DeleteAccountAliasRequestMarshaller implements
    ...
    public Request<DeleteAccountAliasRequest> marshall(
        ...
        if (deleteAccountAliasRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteAccountAliasRequest)");
        }

        Request<DeleteAccountAliasRequest> request = new DefaultRequest<DeleteAccountAliasRequest>(
                deleteAccountAliasRequest, "AWSIdentityandAccessManagement");
        ...
        if (deleteAccountAliasRequest.getAccountAlias() != null) {
            prefix = "AccountAlias";
            String accountAlias = deleteAccountAliasRequest.getAccountAlias();
