...
/**
 * StAX unmarshaller for response CreateRoleResult
 */
public class CreateRoleResultStaxUnmarshaller implements
        Unmarshaller<CreateRoleResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Role", targetDepth)) {
                    createRoleResult
                            .setRole(RoleStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
