...
/**
 * StAX unmarshaller for response ListSSHPublicKeysResult
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("SSHPublicKeys/member", targetDepth)) {
                    listSSHPublicKeysResult.withSSHPublicKeys(SSHPublicKeyMetadataStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("IsTruncated", targetDepth)) {
                    listSSHPublicKeysResult.setIsTruncated(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Marker", targetDepth)) {
                    listSSHPublicKeysResult.setMarker(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
