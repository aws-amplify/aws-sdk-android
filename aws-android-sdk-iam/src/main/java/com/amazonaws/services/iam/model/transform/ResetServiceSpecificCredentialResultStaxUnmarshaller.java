...
/**
 * StAX unmarshaller for response ResetServiceSpecificCredentialResult
 */
public class ResetServiceSpecificCredentialResultStaxUnmarshaller implements
        Unmarshaller<ResetServiceSpecificCredentialResult, StaxUnmarshallerContext> {
