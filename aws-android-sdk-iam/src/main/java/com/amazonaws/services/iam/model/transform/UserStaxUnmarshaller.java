...
/**
 * StAX unmarshaller for model User
 */
class UserStaxUnmarshaller implements Unmarshaller<User, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("PermissionsBoundary", targetDepth)) {
                    user.setPermissionsBoundary(AttachedPermissionsBoundaryStaxUnmarshaller
