...
/**
 * StAX unmarshaller for response CreatePolicyVersionResult
 */
public class CreatePolicyVersionResultStaxUnmarshaller implements
        Unmarshaller<CreatePolicyVersionResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PolicyVersion", targetDepth)) {
                    createPolicyVersionResult.setPolicyVersion(PolicyVersionStaxUnmarshaller
