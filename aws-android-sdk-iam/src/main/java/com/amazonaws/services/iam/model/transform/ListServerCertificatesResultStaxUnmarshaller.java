...
/**
 * StAX unmarshaller for response ListServerCertificatesResult
 */
public class ListServerCertificatesResultStaxUnmarshaller implements
        Unmarshaller<ListServerCertificatesResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("IsTruncated", targetDepth)) {
                    listServerCertificatesResult.setIsTruncated(BooleanStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Marker", targetDepth)) {
                    listServerCertificatesResult.setMarker(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
