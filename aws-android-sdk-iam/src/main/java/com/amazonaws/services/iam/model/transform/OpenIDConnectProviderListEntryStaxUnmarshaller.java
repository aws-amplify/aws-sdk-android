...
/**
 * StAX unmarshaller for model OpenIDConnectProviderListEntry
 */
class OpenIDConnectProviderListEntryStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Arn", targetDepth)) {
                    openIDConnectProviderListEntry.setArn(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
