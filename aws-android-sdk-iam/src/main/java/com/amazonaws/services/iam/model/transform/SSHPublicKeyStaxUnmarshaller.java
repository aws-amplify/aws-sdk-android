...
/**
 * StAX unmarshaller for model SSHPublicKey
 */
class SSHPublicKeyStaxUnmarshaller implements Unmarshaller<SSHPublicKey, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("UserName", targetDepth)) {
                    sSHPublicKey.setUserName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("SSHPublicKeyId", targetDepth)) {
                    sSHPublicKey.setSSHPublicKeyId(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Fingerprint", targetDepth)) {
                    sSHPublicKey.setFingerprint(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("SSHPublicKeyBody", targetDepth)) {
                    sSHPublicKey.setSSHPublicKeyBody(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("UploadDate", targetDepth)) {
                    sSHPublicKey.setUploadDate(DateStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
