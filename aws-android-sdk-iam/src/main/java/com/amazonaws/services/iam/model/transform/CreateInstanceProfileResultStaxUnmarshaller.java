...
/**
 * StAX unmarshaller for response CreateInstanceProfileResult
 */
public class CreateInstanceProfileResultStaxUnmarshaller implements
        Unmarshaller<CreateInstanceProfileResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("InstanceProfile", targetDepth)) {
                    createInstanceProfileResult.setInstanceProfile(InstanceProfileStaxUnmarshaller
