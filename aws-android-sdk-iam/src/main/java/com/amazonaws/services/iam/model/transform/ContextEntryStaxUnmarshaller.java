...
/**
 * StAX unmarshaller for model ContextEntry
 */
class ContextEntryStaxUnmarshaller implements Unmarshaller<ContextEntry, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ContextKeyName", targetDepth)) {
                    contextEntry.setContextKeyName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("ContextKeyValues/member", targetDepth)) {
                    contextEntry.withContextKeyValues(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ContextKeyType", targetDepth)) {
                    contextEntry.setContextKeyType(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
