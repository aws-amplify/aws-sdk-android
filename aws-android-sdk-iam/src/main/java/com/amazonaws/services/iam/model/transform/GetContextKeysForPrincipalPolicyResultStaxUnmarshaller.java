...
/**
 * StAX unmarshaller for response GetContextKeysForPrincipalPolicyResult
 */
public class GetContextKeysForPrincipalPolicyResultStaxUnmarshaller implements
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ContextKeyNames/member", targetDepth)) {
                    getContextKeysForPrincipalPolicyResult
                            .withContextKeyNames(StringStaxUnmarshaller.getInstance().unmarshall(
                                    context));
                    continue;
                }
