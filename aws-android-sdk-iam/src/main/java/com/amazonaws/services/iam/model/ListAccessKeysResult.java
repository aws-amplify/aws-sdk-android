...
public class ListAccessKeysResult implements Serializable {
    ...
    public void setAccessKeyMetadata(java.util.Collection<AccessKeyMetadata> accessKeyMetadata) {
        ...
        this.accessKeyMetadata = new java.util.ArrayList<AccessKeyMetadata>(accessKeyMetadata);
    }
    ...
    public ListAccessKeysResult withAccessKeyMetadata(AccessKeyMetadata... accessKeyMetadata) {
        if (getAccessKeyMetadata() == null) {
            this.accessKeyMetadata = new java.util.ArrayList<AccessKeyMetadata>(
                    accessKeyMetadata.length);
        }
        for (AccessKeyMetadata value : accessKeyMetadata) {
            this.accessKeyMetadata.add(value);
        }
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getAccessKeyMetadata() == null) ? 0 : getAccessKeyMetadata().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAccessKeyMetadata() != null
                && other.getAccessKeyMetadata().equals(this.getAccessKeyMetadata()) == false)
            return false;
