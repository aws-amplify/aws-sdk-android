...
/**
 * StAX unmarshaller for model RoleUsageType
 */
class RoleUsageTypeStaxUnmarshaller implements Unmarshaller<RoleUsageType, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Region", targetDepth)) {
                    roleUsageType.setRegion(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Resources/member", targetDepth)) {
                    roleUsageType.withResources(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
