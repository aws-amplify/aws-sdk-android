...
public class ListInstanceProfilesForRoleResult implements Serializable {
    ...
    public ListInstanceProfilesForRoleResult withInstanceProfiles(
        ...
        if (getInstanceProfiles() == null) {
            this.instanceProfiles = new java.util.ArrayList<InstanceProfile>(
                    instanceProfiles.length);
        }
        for (InstanceProfile value : instanceProfiles) {
            this.instanceProfiles.add(value);
        }
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getInstanceProfiles() == null) ? 0 : getInstanceProfiles().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getInstanceProfiles() != null
                && other.getInstanceProfiles().equals(this.getInstanceProfiles()) == false)
            return false;
