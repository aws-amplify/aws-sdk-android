...
/**
 * StAX request marshaller for ListInstanceProfilesForRoleRequest
 */
    ...
    public Request<ListInstanceProfilesForRoleRequest> marshall(
        ...
        if (listInstanceProfilesForRoleRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListInstanceProfilesForRoleRequest)");
        }

        Request<ListInstanceProfilesForRoleRequest> request = new DefaultRequest<ListInstanceProfilesForRoleRequest>(
                listInstanceProfilesForRoleRequest, "AWSIdentityandAccessManagement");
        ...
        if (listInstanceProfilesForRoleRequest.getRoleName() != null) {
            prefix = "RoleName";
            String roleName = listInstanceProfilesForRoleRequest.getRoleName();
            request.addParameter(prefix, StringUtils.fromString(roleName));
        }
        if (listInstanceProfilesForRoleRequest.getMarker() != null) {
            prefix = "Marker";
            String marker = listInstanceProfilesForRoleRequest.getMarker();
            request.addParameter(prefix, StringUtils.fromString(marker));
        }
        if (listInstanceProfilesForRoleRequest.getMaxItems() != null) {
            prefix = "MaxItems";
            Integer maxItems = listInstanceProfilesForRoleRequest.getMaxItems();
