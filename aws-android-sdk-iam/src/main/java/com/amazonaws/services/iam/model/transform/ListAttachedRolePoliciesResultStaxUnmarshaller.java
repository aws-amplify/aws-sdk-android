...
/**
 * StAX unmarshaller for response ListAttachedRolePoliciesResult
 */
public class ListAttachedRolePoliciesResultStaxUnmarshaller implements
        Unmarshaller<ListAttachedRolePoliciesResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("AttachedPolicies/member", targetDepth)) {
                    listAttachedRolePoliciesResult
                            .withAttachedPolicies(AttachedPolicyStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("IsTruncated", targetDepth)) {
                    listAttachedRolePoliciesResult.setIsTruncated(BooleanStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Marker", targetDepth)) {
                    listAttachedRolePoliciesResult.setMarker(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
