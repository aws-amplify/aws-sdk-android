 ...
 * the operation returns an empty list. For more information about roles, go to
 * <a href=
...
public class ListRolesRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         a slash (/), listing all roles. This parameter allows (through
     ...
     *            to a slash (/), listing all roles. This parameter allows
