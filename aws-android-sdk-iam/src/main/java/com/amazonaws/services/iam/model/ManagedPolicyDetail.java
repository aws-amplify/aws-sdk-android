 ...
 * </p>
 */
public class ManagedPolicyDetail implements Serializable {
    /**
     * <p>
     ...
     * </p>
     */
    private java.util.List<PolicyVersion> policyVersionList;
     ...
     *            The number of principal entities (users, groups, and roles)
     *            that the policy is attached to.
     *            </p>
     */
     ...
     *            is used as the permissions boundary.
     *            </p>
     *            <p>
     ...
     *         chained together.
     */
    public ManagedPolicyDetail withPermissionsBoundaryUsageCount(
     ...
     * </p>
     *
     * @param policyVersionList <p>
     *            A list containing information about the versions of the
     *            policy.
     *            </p>
     */
    public void setPolicyVersionList(java.util.Collection<PolicyVersion> policyVersionList) {
        ...
        this.policyVersionList = new java.util.ArrayList<PolicyVersion>(policyVersionList);
    }
    ...
    public ManagedPolicyDetail withPolicyVersionList(PolicyVersion... policyVersionList) {
        if (getPolicyVersionList() == null) {
            this.policyVersionList = new java.util.ArrayList<PolicyVersion>(
                    policyVersionList.length);
        }
        for (PolicyVersion value : policyVersionList) {
            this.policyVersionList.add(value);
        }
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getPolicyVersionList() == null) ? 0 : getPolicyVersionList().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getPolicyVersionList() != null
                && other.getPolicyVersionList().equals(this.getPolicyVersionList()) == false)
            return false;
        return true;
    }
}
