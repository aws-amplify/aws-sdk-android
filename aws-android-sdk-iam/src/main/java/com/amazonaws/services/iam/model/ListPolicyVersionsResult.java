...
public class ListPolicyVersionsResult implements Serializable {
     ...
     * </p>
     */
    private java.util.List<PolicyVersion> versions;
    ...
    public void setVersions(java.util.Collection<PolicyVersion> versions) {
        ...
        this.versions = new java.util.ArrayList<PolicyVersion>(versions);
    }
    ...
    public ListPolicyVersionsResult withVersions(PolicyVersion... versions) {
        if (getVersions() == null) {
            this.versions = new java.util.ArrayList<PolicyVersion>(versions.length);
        }
