...
/**
 * StAX unmarshaller for response GetSAMLProviderResult
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("SAMLMetadataDocument", targetDepth)) {
                    getSAMLProviderResult.setSAMLMetadataDocument(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("CreateDate", targetDepth)) {
                    getSAMLProviderResult.setCreateDate(DateStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ValidUntil", targetDepth)) {
                    getSAMLProviderResult.setValidUntil(DateStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
