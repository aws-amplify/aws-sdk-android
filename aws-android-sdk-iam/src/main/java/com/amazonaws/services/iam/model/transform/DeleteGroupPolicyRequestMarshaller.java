...
/**
 * StAX request marshaller for DeleteGroupPolicyRequest
 */
    ...
    public Request<DeleteGroupPolicyRequest> marshall(
        ...
        if (deleteGroupPolicyRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteGroupPolicyRequest)");
        }

        Request<DeleteGroupPolicyRequest> request = new DefaultRequest<DeleteGroupPolicyRequest>(
                deleteGroupPolicyRequest, "AWSIdentityandAccessManagement");
        ...
        if (deleteGroupPolicyRequest.getGroupName() != null) {
            prefix = "GroupName";
            String groupName = deleteGroupPolicyRequest.getGroupName();
            request.addParameter(prefix, StringUtils.fromString(groupName));
        }
        if (deleteGroupPolicyRequest.getPolicyName() != null) {
            prefix = "PolicyName";
            String policyName = deleteGroupPolicyRequest.getPolicyName();
