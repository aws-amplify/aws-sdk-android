...
/**
 * StAX unmarshaller for response GenerateOrganizationsAccessReportResult
 */
public class GenerateOrganizationsAccessReportResultStaxUnmarshaller implements
        Unmarshaller<GenerateOrganizationsAccessReportResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("JobId", targetDepth)) {
                    generateOrganizationsAccessReportResult.setJobId(StringStaxUnmarshaller
