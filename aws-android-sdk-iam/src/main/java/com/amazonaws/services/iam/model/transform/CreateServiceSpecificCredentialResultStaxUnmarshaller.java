...
/**
 * StAX unmarshaller for response CreateServiceSpecificCredentialResult
 */
public class CreateServiceSpecificCredentialResultStaxUnmarshaller implements
        Unmarshaller<CreateServiceSpecificCredentialResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ServiceSpecificCredential", targetDepth)) {
                    createServiceSpecificCredentialResult
                            .setServiceSpecificCredential(ServiceSpecificCredentialStaxUnmarshaller
