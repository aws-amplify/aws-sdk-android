...
/**
 * StAX unmarshaller for response UploadServerCertificateResult
 */
public class UploadServerCertificateResultStaxUnmarshaller implements
        Unmarshaller<UploadServerCertificateResult, StaxUnmarshallerContext> {
