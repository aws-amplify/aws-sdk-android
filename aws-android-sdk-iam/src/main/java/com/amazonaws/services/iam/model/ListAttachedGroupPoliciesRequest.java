 ...
 * path prefix. If there are no policies attached to the specified group (or
 * none that match the specified path prefix), the operation returns an empty
 * list.
 * </p>
 */
public class ListAttachedGroupPoliciesRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *
     * @param groupName <p>
     *            The name (friendly name, not ARN) of the group to list
