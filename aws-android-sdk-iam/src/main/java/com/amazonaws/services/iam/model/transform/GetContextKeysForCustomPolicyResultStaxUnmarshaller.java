...
/**
 * StAX unmarshaller for response GetContextKeysForCustomPolicyResult
 */
public class GetContextKeysForCustomPolicyResultStaxUnmarshaller implements
        Unmarshaller<GetContextKeysForCustomPolicyResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ContextKeyNames/member", targetDepth)) {
                    getContextKeysForCustomPolicyResult.withContextKeyNames(StringStaxUnmarshaller
