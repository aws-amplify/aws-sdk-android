...
/**
 * StAX unmarshaller for response GetOpenIDConnectProviderResult
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Url", targetDepth)) {
                    getOpenIDConnectProviderResult.setUrl(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ClientIDList/member", targetDepth)) {
                    getOpenIDConnectProviderResult.withClientIDList(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ThumbprintList/member", targetDepth)) {
                    getOpenIDConnectProviderResult.withThumbprintList(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("CreateDate", targetDepth)) {
                    getOpenIDConnectProviderResult.setCreateDate(DateStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
