...
/**
 * StAX request marshaller for CreateServiceSpecificCredentialRequest
 */
public class CreateServiceSpecificCredentialRequestMarshaller
    ...
    public Request<CreateServiceSpecificCredentialRequest> marshall(
        ...
        if (createServiceSpecificCredentialRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateServiceSpecificCredentialRequest)");
        }

        Request<CreateServiceSpecificCredentialRequest> request = new DefaultRequest<CreateServiceSpecificCredentialRequest>(
                createServiceSpecificCredentialRequest, "AWSIdentityandAccessManagement");
        ...
        if (createServiceSpecificCredentialRequest.getUserName() != null) {
            prefix = "UserName";
            String userName = createServiceSpecificCredentialRequest.getUserName();
            request.addParameter(prefix, StringUtils.fromString(userName));
        }
        if (createServiceSpecificCredentialRequest.getServiceName() != null) {
            prefix = "ServiceName";
            String serviceName = createServiceSpecificCredentialRequest.getServiceName();
