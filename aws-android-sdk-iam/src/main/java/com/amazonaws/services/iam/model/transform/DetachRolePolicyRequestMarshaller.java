...
/**
 * StAX request marshaller for DetachRolePolicyRequest
 */
    ...
    public Request<DetachRolePolicyRequest> marshall(DetachRolePolicyRequest detachRolePolicyRequest) {
        if (detachRolePolicyRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DetachRolePolicyRequest)");
        }

        Request<DetachRolePolicyRequest> request = new DefaultRequest<DetachRolePolicyRequest>(
                detachRolePolicyRequest, "AWSIdentityandAccessManagement");
