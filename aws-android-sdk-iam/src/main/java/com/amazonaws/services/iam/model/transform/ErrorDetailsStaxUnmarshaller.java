...
/**
 * StAX unmarshaller for model ErrorDetails
 */
class ErrorDetailsStaxUnmarshaller implements Unmarshaller<ErrorDetails, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Message", targetDepth)) {
                    errorDetails.setMessage(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
