...
/**
 * StAX unmarshaller for response ListServiceSpecificCredentialsResult
 */
public class ListServiceSpecificCredentialsResultStaxUnmarshaller implements
        Unmarshaller<ListServiceSpecificCredentialsResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ServiceSpecificCredentials/member", targetDepth)) {
                    listServiceSpecificCredentialsResult
                            .withServiceSpecificCredentials(ServiceSpecificCredentialMetadataStaxUnmarshaller
