...
/**
 * StAX request marshaller for DeleteLoginProfileRequest
 */
public class DeleteLoginProfileRequestMarshaller implements
    ...
    public Request<DeleteLoginProfileRequest> marshall(
        ...
        if (deleteLoginProfileRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteLoginProfileRequest)");
        }

        Request<DeleteLoginProfileRequest> request = new DefaultRequest<DeleteLoginProfileRequest>(
                deleteLoginProfileRequest, "AWSIdentityandAccessManagement");
        ...
        if (deleteLoginProfileRequest.getUserName() != null) {
            prefix = "UserName";
            String userName = deleteLoginProfileRequest.getUserName();
