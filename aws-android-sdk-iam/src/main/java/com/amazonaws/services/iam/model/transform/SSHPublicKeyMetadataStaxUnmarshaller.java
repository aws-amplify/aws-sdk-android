...
/**
 * StAX unmarshaller for model SSHPublicKeyMetadata
 */
class SSHPublicKeyMetadataStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("UserName", targetDepth)) {
                    sSHPublicKeyMetadata.setUserName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("SSHPublicKeyId", targetDepth)) {
                    sSHPublicKeyMetadata.setSSHPublicKeyId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Status", targetDepth)) {
                    sSHPublicKeyMetadata.setStatus(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("UploadDate", targetDepth)) {
                    sSHPublicKeyMetadata.setUploadDate(DateStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
