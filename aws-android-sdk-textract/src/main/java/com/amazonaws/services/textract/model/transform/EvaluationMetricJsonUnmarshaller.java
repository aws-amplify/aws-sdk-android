...
/**
 * JSON unmarshaller for POJO EvaluationMetric
 */
class EvaluationMetricJsonUnmarshaller implements
        Unmarshaller<EvaluationMetric, JsonUnmarshallerContext> {
    ...
    public EvaluationMetric unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("F1Score")) {
                evaluationMetric.setF1Score(FloatJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Precision")) {
                evaluationMetric.setPrecision(FloatJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Recall")) {
                evaluationMetric.setRecall(FloatJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
