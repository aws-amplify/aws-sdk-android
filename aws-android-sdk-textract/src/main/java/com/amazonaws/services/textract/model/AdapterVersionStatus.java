...
public enum AdapterVersionStatus {
    ...
    private static final Map<String, AdapterVersionStatus> enumMap;
    static {
        enumMap = new HashMap<String, AdapterVersionStatus>();
        enumMap.put("ACTIVE", ACTIVE);
        enumMap.put("AT_RISK", AT_RISK);
        enumMap.put("DEPRECATED", DEPRECATED);
        enumMap.put("CREATION_ERROR", CREATION_ERROR);
