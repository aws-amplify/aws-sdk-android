...
public class NotificationChannel implements Serializable {
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Length: </b>20 - 1024<br/>
     * <b>Pattern: </b>(^arn:([a-z\d-]+):sns:[a-zA-Z\d-]{1,20}:\w{12}:.+$)<br/>
     */
     ...
     *
     * @param roleArn <p>
     *            The Amazon Resource Name (ARN) of an IAM role that gives
     *            Amazon Textract publishing permissions to the Amazon SNS
     *            topic.
     *            </p>
     */
