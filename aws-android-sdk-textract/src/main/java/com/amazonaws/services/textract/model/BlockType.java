...
public enum BlockType {
    ...
    static {
        ...
        enumMap.put("LAYOUT_TEXT", LAYOUT_TEXT);
        enumMap.put("LAYOUT_TITLE", LAYOUT_TITLE);
        enumMap.put("LAYOUT_HEADER", LAYOUT_HEADER);
        enumMap.put("LAYOUT_FOOTER", LAYOUT_FOOTER);
        enumMap.put("LAYOUT_SECTION_HEADER", LAYOUT_SECTION_HEADER);
        enumMap.put("LAYOUT_PAGE_NUMBER", LAYOUT_PAGE_NUMBER);
        enumMap.put("LAYOUT_LIST", LAYOUT_LIST);
        enumMap.put("LAYOUT_FIGURE", LAYOUT_FIGURE);
        enumMap.put("LAYOUT_TABLE", LAYOUT_TABLE);
        enumMap.put("LAYOUT_KEY_VALUE", LAYOUT_KEY_VALUE);
    }
