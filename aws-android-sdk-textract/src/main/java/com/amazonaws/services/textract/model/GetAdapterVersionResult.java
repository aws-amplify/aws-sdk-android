...
public class GetAdapterVersionResult implements Serializable {
    /**
     * <p>
    ...
    public void setEvaluationMetrics(
            java.util.Collection<AdapterVersionEvaluationMetric> evaluationMetrics) {
        if (evaluationMetrics == null) {
            this.evaluationMetrics = null;
            return;
        }

        this.evaluationMetrics = new java.util.ArrayList<AdapterVersionEvaluationMetric>(
                evaluationMetrics);
    }
     ...
     *         chained together.
     */
    public GetAdapterVersionResult withEvaluationMetrics(
            AdapterVersionEvaluationMetric... evaluationMetrics) {
        if (getEvaluationMetrics() == null) {
            this.evaluationMetrics = new java.util.ArrayList<AdapterVersionEvaluationMetric>(
                    evaluationMetrics.length);
        }
        for (AdapterVersionEvaluationMetric value : evaluationMetrics) {
            this.evaluationMetrics.add(value);
        }
        return this;
    }
