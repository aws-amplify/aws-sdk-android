...
/**
 * JSON unmarshaller for POJO LineItemFields
 */
class LineItemFieldsJsonUnmarshaller implements
        Unmarshaller<LineItemFields, JsonUnmarshallerContext> {
    ...
    public LineItemFields unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("LineItemExpenseFields")) {
                lineItemFields.setLineItemExpenseFields(new ListUnmarshaller<ExpenseField>(
