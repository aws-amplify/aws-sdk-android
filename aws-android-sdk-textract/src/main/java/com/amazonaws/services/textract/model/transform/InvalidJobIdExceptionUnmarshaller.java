...
public class InvalidJobIdExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InvalidJobIdException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        InvalidJobIdException e = (InvalidJobIdException) super.unmarshall(error);
        e.setErrorCode("InvalidJobIdException");
