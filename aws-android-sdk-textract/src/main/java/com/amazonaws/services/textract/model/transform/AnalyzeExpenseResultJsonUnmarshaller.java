...
/**
 * JSON unmarshaller for response AnalyzeExpenseResult
 */
public class AnalyzeExpenseResultJsonUnmarshaller implements
        Unmarshaller<AnalyzeExpenseResult, JsonUnmarshallerContext> {
    ...
    public AnalyzeExpenseResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("DocumentMetadata")) {
                analyzeExpenseResult.setDocumentMetadata(DocumentMetadataJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("ExpenseDocuments")) {
                analyzeExpenseResult.setExpenseDocuments(new ListUnmarshaller<ExpenseDocument>(
