...
/**
 * JSON unmarshaller for POJO AnalyzeIDDetections
 */
class AnalyzeIDDetectionsJsonUnmarshaller implements
        Unmarshaller<AnalyzeIDDetections, JsonUnmarshallerContext> {
    ...
    public AnalyzeIDDetections unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Text")) {
                analyzeIDDetections.setText(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("NormalizedValue")) {
                analyzeIDDetections.setNormalizedValue(NormalizedValueJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Confidence")) {
                analyzeIDDetections.setConfidence(FloatJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
