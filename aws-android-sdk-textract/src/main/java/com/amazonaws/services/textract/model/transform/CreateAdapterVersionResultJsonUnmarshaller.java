...
/**
 * JSON unmarshaller for response CreateAdapterVersionResult
 */
public class CreateAdapterVersionResultJsonUnmarshaller implements
        Unmarshaller<CreateAdapterVersionResult, JsonUnmarshallerContext> {
    ...
    public CreateAdapterVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AdapterId")) {
                createAdapterVersionResult.setAdapterId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("AdapterVersion")) {
                createAdapterVersionResult.setAdapterVersion(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
