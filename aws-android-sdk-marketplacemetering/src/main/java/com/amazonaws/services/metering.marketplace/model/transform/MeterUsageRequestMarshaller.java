...
/**
 * JSON request marshaller for MeterUsageRequest
 */
    ...
    public Request<MeterUsageRequest> marshall(MeterUsageRequest meterUsageRequest) {
        if (meterUsageRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(MeterUsageRequest)");
        }
        ...
        try {
            ...
            if (meterUsageRequest.getProductCode() != null) {
                String productCode = meterUsageRequest.getProductCode();
                jsonWriter.name("ProductCode");
                jsonWriter.value(productCode);
            }
            if (meterUsageRequest.getTimestamp() != null) {
                java.util.Date timestamp = meterUsageRequest.getTimestamp();
                jsonWriter.name("Timestamp");
                jsonWriter.value(timestamp);
            }
            if (meterUsageRequest.getUsageDimension() != null) {
                String usageDimension = meterUsageRequest.getUsageDimension();
                jsonWriter.name("UsageDimension");
                jsonWriter.value(usageDimension);
            }
            if (meterUsageRequest.getUsageQuantity() != null) {
                Integer usageQuantity = meterUsageRequest.getUsageQuantity();
                jsonWriter.name("UsageQuantity");
                jsonWriter.value(usageQuantity);
            }
            if (meterUsageRequest.getDryRun() != null) {
                Boolean dryRun = meterUsageRequest.getDryRun();
