...
/**
 * JSON unmarshaller for POJO Scte20SourceSettings
 */
class Scte20SourceSettingsJsonUnmarshaller implements
        Unmarshaller<Scte20SourceSettings, JsonUnmarshallerContext> {
    ...
    public Scte20SourceSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Convert608To708")) {
                scte20SourceSettings.setConvert608To708(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Source608ChannelNumber")) {
                scte20SourceSettings.setSource608ChannelNumber(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
