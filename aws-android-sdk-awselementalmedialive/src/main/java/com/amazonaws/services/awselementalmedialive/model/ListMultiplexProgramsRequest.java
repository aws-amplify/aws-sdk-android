 ...
 */
public class ListMultiplexProgramsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * The ID of the multiplex that the programs belong to.
     *
     * @param multiplexId The ID of the multiplex that the programs belong to.
     */
