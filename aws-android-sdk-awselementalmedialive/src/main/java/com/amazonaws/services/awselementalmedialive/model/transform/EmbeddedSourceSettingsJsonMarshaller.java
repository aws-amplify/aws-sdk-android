...
class EmbeddedSourceSettingsJsonMarshaller {
    ...
    public void marshall(EmbeddedSourceSettings embeddedSourceSettings, AwsJsonWriter jsonWriter)
        ...
        if (embeddedSourceSettings.getScte20Detection() != null) {
            String scte20Detection = embeddedSourceSettings.getScte20Detection();
            jsonWriter.name("Scte20Detection");
            jsonWriter.value(scte20Detection);
        }
