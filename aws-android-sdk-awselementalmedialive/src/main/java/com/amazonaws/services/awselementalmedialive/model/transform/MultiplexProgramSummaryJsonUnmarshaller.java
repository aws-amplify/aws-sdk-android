...
/**
 * JSON unmarshaller for POJO MultiplexProgramSummary
 */
class MultiplexProgramSummaryJsonUnmarshaller implements
        Unmarshaller<MultiplexProgramSummary, JsonUnmarshallerContext> {
    ...
    public MultiplexProgramSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ChannelId")) {
                multiplexProgramSummary.setChannelId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ProgramName")) {
                multiplexProgramSummary.setProgramName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
