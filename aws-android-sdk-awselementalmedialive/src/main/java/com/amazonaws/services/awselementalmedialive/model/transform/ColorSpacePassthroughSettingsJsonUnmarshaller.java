...
/**
 * JSON unmarshaller for POJO ColorSpacePassthroughSettings
 */
class ColorSpacePassthroughSettingsJsonUnmarshaller implements Unmarshaller<ColorSpacePassthroughSettings, JsonUnmarshallerContext> {
    ...
    public static ColorSpacePassthroughSettingsJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ColorSpacePassthroughSettingsJsonUnmarshaller();
        return instance;
    }
}
