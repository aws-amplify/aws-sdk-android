...
public enum SmoothGroupSparseTrackType {
    ...
    private static final Map<String, SmoothGroupSparseTrackType> enumMap;
    static {
        enumMap = new HashMap<String, SmoothGroupSparseTrackType>();
        enumMap.put("NONE", NONE);
        enumMap.put("SCTE_35", SCTE_35);
        enumMap.put("SCTE_35_WITHOUT_SEGMENTATION", SCTE_35_WITHOUT_SEGMENTATION);
    }
