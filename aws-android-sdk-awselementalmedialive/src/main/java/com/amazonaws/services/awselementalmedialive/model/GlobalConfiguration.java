...
public class GlobalConfiguration implements Serializable {
     ...
     *         PIPELINELOCKING - MediaLive will attempt to synchronize the
     *         output of each pipeline to the other. EPOCHLOCKING - MediaLive
     ...
     *            synchronized. PIPELINELOCKING - MediaLive will attempt to
     *            synchronize the output of each pipeline to the other.
     *            EPOCHLOCKING - MediaLive will attempt to synchronize the
