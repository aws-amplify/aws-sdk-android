...
/**
 * JSON unmarshaller for POJO AudioLanguageSelection
 */
class AudioLanguageSelectionJsonUnmarshaller implements
        Unmarshaller<AudioLanguageSelection, JsonUnmarshallerContext> {
    ...
    public AudioLanguageSelection unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("LanguageCode")) {
                audioLanguageSelection.setLanguageCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("LanguageSelectionPolicy")) {
                audioLanguageSelection.setLanguageSelectionPolicy(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
