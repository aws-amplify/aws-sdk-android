...
/**
 * JSON unmarshaller for POJO MediaPackageOutputSettings
 */
class MediaPackageOutputSettingsJsonUnmarshaller implements Unmarshaller<MediaPackageOutputSettings, JsonUnmarshallerContext> {
    ...
    public static MediaPackageOutputSettingsJsonUnmarshaller getInstance() {
        if (instance == null) instance = new MediaPackageOutputSettingsJsonUnmarshaller();
        return instance;
    }
}
