 ...
 */
public class DescribeInputSecurityGroupRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     ...
     * The id of the Input Security Group to describe
     *
     * @param inputSecurityGroupId The id of the Input Security Group to
     *            describe
     */
    ...
    public String toString() {
        ...
        if (getInputSecurityGroupId() != null)
            sb.append("InputSecurityGroupId: " + getInputSecurityGroupId());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getInputSecurityGroupId() == null) ? 0 : getInputSecurityGroupId().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getInputSecurityGroupId() == null ^ this.getInputSecurityGroupId() == null)
            return false;
        if (other.getInputSecurityGroupId() != null
                && other.getInputSecurityGroupId().equals(this.getInputSecurityGroupId()) == false)
            return false;
        return true;
    }
}
