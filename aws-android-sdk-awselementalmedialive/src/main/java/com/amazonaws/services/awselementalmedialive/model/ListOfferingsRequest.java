 ...
 */
public class ListOfferingsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * e.g. '2345678' (a channel ID)
     * 
     * @return Filter to offerings that match the configuration of an existing
     ...
     * e.g. '2345678' (a channel ID)
     * 
     * @param channelConfiguration Filter to offerings that match the
     *            configuration of an existing channel, e.g. '2345678' (a
     *            channel ID)
     */
    ...
    /**
     * Filter to offerings that match the configuration of an existing channel,
     * e.g. '2345678' (a channel ID) <p>
     * Returns a reference to this object so that method calls can be chained
     * together.
     *
     * @param channelConfiguration Filter to offerings that match the
     *            configuration of an existing channel, e.g. '2345678' (a
     *            channel ID) @return A reference to this updated object so that method calls can be
     *         chained together.
     */
