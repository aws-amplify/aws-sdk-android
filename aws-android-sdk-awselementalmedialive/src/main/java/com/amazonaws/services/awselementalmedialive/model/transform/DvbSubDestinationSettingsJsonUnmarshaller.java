    ...
    public DvbSubDestinationSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Alignment")) {
                ...
                dvbSubDestinationSettings.setFont(InputLocationJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                dvbSubDestinationSettings.setFontSize(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                dvbSubDestinationSettings.setTeletextGridControl(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
