...
class AudioCodecSettingsJsonMarshaller {
    ...
    public void marshall(AudioCodecSettings audioCodecSettings, AwsJsonWriter jsonWriter)
        ...
        if (audioCodecSettings.getPassThroughSettings() != null) {
            PassThroughSettings passThroughSettings = audioCodecSettings.getPassThroughSettings();
            jsonWriter.name("PassThroughSettings");
            PassThroughSettingsJsonMarshaller.getInstance().marshall(passThroughSettings,
                    jsonWriter);
        }
