...
/**
 * JSON unmarshaller for POJO ArchiveGroupSettings
 */
class ArchiveGroupSettingsJsonUnmarshaller implements
        Unmarshaller<ArchiveGroupSettings, JsonUnmarshallerContext> {
    ...
    public ArchiveGroupSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Destination")) {
                archiveGroupSettings.setDestination(OutputLocationRefJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("RolloverInterval")) {
                archiveGroupSettings.setRolloverInterval(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
