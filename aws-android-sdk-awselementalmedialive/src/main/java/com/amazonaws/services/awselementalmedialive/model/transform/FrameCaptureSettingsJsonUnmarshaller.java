...
class FrameCaptureSettingsJsonUnmarshaller implements
    ...
    public FrameCaptureSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("CaptureInterval")) {
                frameCaptureSettings.setCaptureInterval(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("CaptureIntervalUnits")) {
                frameCaptureSettings.setCaptureIntervalUnits(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
