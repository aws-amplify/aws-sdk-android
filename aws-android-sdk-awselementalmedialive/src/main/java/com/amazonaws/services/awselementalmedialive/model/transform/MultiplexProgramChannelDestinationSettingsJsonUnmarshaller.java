...
/**
 * JSON unmarshaller for POJO MultiplexProgramChannelDestinationSettings
 */
class MultiplexProgramChannelDestinationSettingsJsonUnmarshaller implements
    ...
    public MultiplexProgramChannelDestinationSettings unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("MultiplexId")) {
                multiplexProgramChannelDestinationSettings.setMultiplexId(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("ProgramName")) {
                multiplexProgramChannelDestinationSettings.setProgramName(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
