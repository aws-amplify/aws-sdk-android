...
public class HlsGroupSettings implements Serializable {
     ...
     * VARIANTMANIFESTSANDSEGMENTS: Generates media manifests for this output
     * group, but not a master manifest. SEGMENTSONLY: Does not generate any
     ...
     * <b>Allowed Values: </b>MANIFESTS_AND_SEGMENTS, SEGMENTS_ONLY
     *
     * @return MANIFESTSANDSEGMENTS: Generates manifests (master manifest, if
     *         applicable, and media manifests) for this output group.
     ...
     * <b>Allowed Values: </b>MANIFESTS_AND_SEGMENTS, SEGMENTS_ONLY
     *
     * @param outputSelection MANIFESTSANDSEGMENTS: Generates manifests (master
     *            manifest, if applicable, and media manifests) for this output
     *            group. VARIANTMANIFESTSANDSEGMENTS: Generates media manifests
     *            for this output group, but not a master manifest.
     *            SEGMENTSONLY: Does not generate any manifests for this output
     *            group.
     * @see HlsOutputSelection
     */
     ...
     * <b>Allowed Values: </b>SEGMENTED_FILES, SINGLE_FILE
     *
     * @return SEGMENTEDFILES: Emit the program as segments - multiple .ts media
     *         files. SINGLEFILE: Applies only if Mode field is VOD. Emit the
     *         program as a single .ts media file. The media manifest includes
     *         #EXT-X-BYTERANGE tags to index segments for playback. A typical
     *         use for this value is when sending the output to AWS Elemental
     ...
     * <b>Allowed Values: </b>SEGMENTED_FILES, SINGLE_FILE
     *
     * @param tsFileMode SEGMENTEDFILES: Emit the program as segments - multiple
     *            .ts media files. SINGLEFILE: Applies only if Mode field is
     *            VOD. Emit the program as a single .ts media file. The media
     *            manifest includes #EXT-X-BYTERANGE tags to index segments for
     *            playback. A typical use for this value is when sending the
     *            output to AWS Elemental MediaConvert, which can accept only a
     *            single media file. Playback while the channel is running is
     *            not guaranteed due to HTTP server caching.
     * @see HlsTsFileMode
     */
