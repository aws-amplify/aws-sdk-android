...
/**
 * JSON unmarshaller for POJO RtmpCaptionInfoDestinationSettings
 */
class RtmpCaptionInfoDestinationSettingsJsonUnmarshaller implements Unmarshaller<RtmpCaptionInfoDestinationSettings, JsonUnmarshallerContext> {
    ...
    public static RtmpCaptionInfoDestinationSettingsJsonUnmarshaller getInstance() {
        if (instance == null) instance = new RtmpCaptionInfoDestinationSettingsJsonUnmarshaller();
        return instance;
    }
}
