...
public interface AmazonCodeGuruReviewer {
     ...
     * ("https://codeguru-reviewer.us-east-1.amazonaws.com"). Callers can use
     * this method to control which AWS region they want to work with.
     * <p>
     * Callers can pass in just the endpoint (ex:
     * "codeguru-reviewer.us-east-1.amazonaws.com") or a full URL, including the
     * protocol (ex: "https://codeguru-reviewer.us-east-1.amazonaws.com"). If
     ...
     *            "codeguru-reviewer.us-east-1.amazonaws.com") or a full URL,
     *            including the protocol (ex:
     *            "https://codeguru-reviewer.us-east-1.amazonaws.com") of the
    ...
    /**
     * An alternative to {@link AmazonCodeGuruReviewer#setEndpoint(String)},
     ...
     */
    AssociateRepositoryResult associateRepository(
            AssociateRepositoryRequest associateRepositoryRequest) throws AmazonClientException,
     ...
     *             in the request, or a server side issue.
     */
    DescribeRepositoryAssociationResult describeRepositoryAssociation(
     ...
     *             in the request, or a server side issue.
     */
    ListRecommendationFeedbackResult listRecommendationFeedback(
    ...
    ListRecommendationsResult listRecommendations(
            ListRecommendationsRequest listRecommendationsRequest) throws AmazonClientException,
            AmazonServiceException;
     ...
     *             in the request, or a server side issue.
     */
    ListRepositoryAssociationsResult listRepositoryAssociations(
     ...
     *             in the request, or a server side issue.
     */
    PutRecommendationFeedbackResult putRecommendationFeedback(
