 ...
 */
public class AssociateRepositoryRequestMarshaller implements
        Marshaller<Request<AssociateRepositoryRequest>, AssociateRepositoryRequest> {

    public Request<AssociateRepositoryRequest> marshall(
            AssociateRepositoryRequest associateRepositoryRequest) {
        if (associateRepositoryRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AssociateRepositoryRequest)");
        }

        Request<AssociateRepositoryRequest> request = new DefaultRequest<AssociateRepositoryRequest>(
                associateRepositoryRequest, "AmazonCodeGuruReviewer");
