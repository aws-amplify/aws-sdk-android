...
/**
 * JSON unmarshaller for response DescribeRecommendationFeedbackResult
 */
public class DescribeRecommendationFeedbackResultJsonUnmarshaller implements
        Unmarshaller<DescribeRecommendationFeedbackResult, JsonUnmarshallerContext> {

    public DescribeRecommendationFeedbackResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RecommendationFeedback")) {
                describeRecommendationFeedbackResult
                        .setRecommendationFeedback(RecommendationFeedbackJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
