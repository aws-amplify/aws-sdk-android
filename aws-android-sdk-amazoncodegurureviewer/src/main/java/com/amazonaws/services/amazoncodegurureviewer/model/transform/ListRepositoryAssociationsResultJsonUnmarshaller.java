...
/**
 * JSON unmarshaller for response ListRepositoryAssociationsResult
 */
public class ListRepositoryAssociationsResultJsonUnmarshaller implements
        Unmarshaller<ListRepositoryAssociationsResult, JsonUnmarshallerContext> {

    public ListRepositoryAssociationsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RepositoryAssociationSummaries")) {
                listRepositoryAssociationsResult
                        .setRepositoryAssociationSummaries(new ListUnmarshaller<RepositoryAssociationSummary>(
                                RepositoryAssociationSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                listRepositoryAssociationsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
