...
public class DescribeRepositoryAssociationRequestMarshaller
    ...
    public Request<DescribeRepositoryAssociationRequest> marshall(
        ...
        if (describeRepositoryAssociationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeRepositoryAssociationRequest)");
        }

        Request<DescribeRepositoryAssociationRequest> request = new DefaultRequest<DescribeRepositoryAssociationRequest>(
                describeRepositoryAssociationRequest, "AmazonCodeGuruReviewer");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/associations/{AssociationArn}";
        uriResourcePath = uriResourcePath.replace(
                "{AssociationArn}",
                (describeRepositoryAssociationRequest.getAssociationArn() == null) ? ""
                        : StringUtils.fromString(describeRepositoryAssociationRequest
                                .getAssociationArn()));
