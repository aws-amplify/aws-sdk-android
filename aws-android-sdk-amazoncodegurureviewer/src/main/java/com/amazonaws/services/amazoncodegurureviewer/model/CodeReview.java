...
public class CodeReview implements Serializable {
    ...
    public String toString() {
        ...
        if (getSourceCodeType() != null)
            sb.append("SourceCodeType: " + getSourceCodeType() + ",");
        if (getMetrics() != null)
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getSourceCodeType() == null) ? 0 : getSourceCodeType().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSourceCodeType() == null ^ this.getSourceCodeType() == null)
            return false;
        if (other.getSourceCodeType() != null
                && other.getSourceCodeType().equals(this.getSourceCodeType()) == false)
            return false;
