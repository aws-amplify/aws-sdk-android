 ...
 */
public class ListCodeReviewsResultJsonUnmarshaller implements
        Unmarshaller<ListCodeReviewsResult, JsonUnmarshallerContext> {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("CodeReviewSummaries")) {
                listCodeReviewsResult
                        .setCodeReviewSummaries(new ListUnmarshaller<CodeReviewSummary>(
                                CodeReviewSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
