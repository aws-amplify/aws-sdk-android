 ...
 * </p>
 */
public class PutRecommendationFeedbackRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
    ...
    public String toString() {
        ...
        if (getReactions() != null)
            sb.append("Reactions: " + getReactions());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getReactions() == null ^ this.getReactions() == null)
            return false;
        if (other.getReactions() != null
                && other.getReactions().equals(this.getReactions()) == false)
            return false;
        return true;
    }
}
