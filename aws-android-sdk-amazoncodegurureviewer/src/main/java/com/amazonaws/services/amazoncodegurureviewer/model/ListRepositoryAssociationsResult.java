...
public class ListRepositoryAssociationsResult implements Serializable {
     ...
     * </p>
     *
     * @param repositoryAssociationSummaries <p>
     *            A list of repository associations that meet the criteria of
     *            the request.
     *            </p>
     */
    public void setRepositoryAssociationSummaries(
            java.util.Collection<RepositoryAssociationSummary> repositoryAssociationSummaries) {
        if (repositoryAssociationSummaries == null) {
            this.repositoryAssociationSummaries = null;
            return;
        }

        this.repositoryAssociationSummaries = new java.util.ArrayList<RepositoryAssociationSummary>(
     ...
     *         chained together.
     */
    public ListRepositoryAssociationsResult withRepositoryAssociationSummaries(
            RepositoryAssociationSummary... repositoryAssociationSummaries) {
        if (getRepositoryAssociationSummaries() == null) {
            this.repositoryAssociationSummaries = new java.util.ArrayList<RepositoryAssociationSummary>(
                    repositoryAssociationSummaries.length);
        }
     ...
     * @param nextToken <p>
     *            The <code>nextToken</code> value to include in a future
     *            <code>ListRecommendations</code> request. When the results of
     *            a <code>ListRecommendations</code> request exceed
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getRepositoryAssociationSummaries() != null)
            sb.append("RepositoryAssociationSummaries: " + getRepositoryAssociationSummaries()
                    + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getRepositoryAssociationSummaries() == null) ? 0
                        : getRepositoryAssociationSummaries().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getRepositoryAssociationSummaries() == null
                ^ this.getRepositoryAssociationSummaries() == null)
            return false;
        if (other.getRepositoryAssociationSummaries() != null
                && other.getRepositoryAssociationSummaries().equals(
                        this.getRepositoryAssociationSummaries()) == false)
            return false;
