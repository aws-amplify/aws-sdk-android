...
public class MetricsSummary implements Serializable {
     ...
     * </p>
     *
     * @param meteredLinesOfCodeCount <p>
     *            Lines of code metered in the code review.
     *            </p>
     */
    ...
    public String toString() {
        ...
        if (getMeteredLinesOfCodeCount() != null)
            sb.append("MeteredLinesOfCodeCount: " + getMeteredLinesOfCodeCount() + ",");
        if (getFindingsCount() != null)
            sb.append("FindingsCount: " + getFindingsCount());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getFindingsCount() == null) ? 0 : getFindingsCount().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getMeteredLinesOfCodeCount() == null ^ this.getMeteredLinesOfCodeCount() == null)
            return false;
        if (other.getMeteredLinesOfCodeCount() != null
                && other.getMeteredLinesOfCodeCount().equals(this.getMeteredLinesOfCodeCount()) == false)
            return false;
        if (other.getFindingsCount() == null ^ this.getFindingsCount() == null)
            return false;
        if (other.getFindingsCount() != null
                && other.getFindingsCount().equals(this.getFindingsCount()) == false)
            return false;
        return true;
    }
}
