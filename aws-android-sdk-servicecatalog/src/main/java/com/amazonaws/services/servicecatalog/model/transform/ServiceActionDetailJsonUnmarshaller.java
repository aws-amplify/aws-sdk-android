...
/**
 * JSON unmarshaller for POJO ServiceActionDetail
 */
class ServiceActionDetailJsonUnmarshaller implements
        Unmarshaller<ServiceActionDetail, JsonUnmarshallerContext> {
    ...
    public ServiceActionDetail unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ServiceActionSummary")) {
                serviceActionDetail.setServiceActionSummary(ServiceActionSummaryJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Definition")) {
                serviceActionDetail.setDefinition(new MapUnmarshaller<String>(
