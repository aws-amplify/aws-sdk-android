 ...
 * </p>
 */
public class AssociateProductWithPortfolioRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     * The language code.
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getSourcePortfolioId() == null) ? 0 : getSourcePortfolioId().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSourcePortfolioId() == null ^ this.getSourcePortfolioId() == null)
            return false;
        if (other.getSourcePortfolioId() != null
                && other.getSourcePortfolioId().equals(this.getSourcePortfolioId()) == false)
            return false;
        return true;
    }
}
