...
/**
 * JSON unmarshaller for response ListRecordHistoryResult
 */
public class ListRecordHistoryResultJsonUnmarshaller implements
    ...
    public ListRecordHistoryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RecordDetails")) {
                listRecordHistoryResult.setRecordDetails(new ListUnmarshaller<RecordDetail>(
                        RecordDetailJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextPageToken")) {
                listRecordHistoryResult.setNextPageToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
