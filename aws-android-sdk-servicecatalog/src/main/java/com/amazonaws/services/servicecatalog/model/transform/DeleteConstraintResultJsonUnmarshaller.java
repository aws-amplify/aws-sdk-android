...
/**
 * JSON unmarshaller for response DeleteConstraintResult
 */
public class DeleteConstraintResultJsonUnmarshaller implements
        Unmarshaller<DeleteConstraintResult, JsonUnmarshallerContext> {
