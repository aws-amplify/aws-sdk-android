 ...
 * </p>
 * <p>
 * If the output contains a TagOption key with an empty list of values, there is
 * a TagOption conflict for that key. The end user cannot take action to fix the
 * conflict, and launch is not blocked. In subsequent calls to
 * <a>ProvisionProduct</a>, do not include conflicted TagOption keys as tags, or
 ...
 * </p>
 */
public class DescribeProvisioningParametersRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     * The language code.
