...
/**
 * JSON unmarshaller for response UpdateProvisionedProductPropertiesResult
 */
public class UpdateProvisionedProductPropertiesResultJsonUnmarshaller implements
    ...
    public UpdateProvisionedProductPropertiesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ProvisionedProductId")) {
                updateProvisionedProductPropertiesResult
                        .setProvisionedProductId(StringJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("ProvisionedProductProperties")) {
                updateProvisionedProductPropertiesResult
                        .setProvisionedProductProperties(new MapUnmarshaller<String>(
                                StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("RecordId")) {
                updateProvisionedProductPropertiesResult.setRecordId(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Status")) {
                updateProvisionedProductPropertiesResult.setStatus(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
