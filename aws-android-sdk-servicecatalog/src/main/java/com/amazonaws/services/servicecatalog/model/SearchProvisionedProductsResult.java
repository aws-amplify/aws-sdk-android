...
public class SearchProvisionedProductsResult implements Serializable {
    /**
     * <p>
    ...
    public void setProvisionedProducts(
            java.util.Collection<ProvisionedProductAttribute> provisionedProducts) {
        if (provisionedProducts == null) {
            this.provisionedProducts = null;
            return;
        }

        this.provisionedProducts = new java.util.ArrayList<ProvisionedProductAttribute>(
                provisionedProducts);
    }
     ...
     *         chained together.
     */
    public SearchProvisionedProductsResult withProvisionedProducts(
            ProvisionedProductAttribute... provisionedProducts) {
        if (getProvisionedProducts() == null) {
            this.provisionedProducts = new java.util.ArrayList<ProvisionedProductAttribute>(
                    provisionedProducts.length);
        }
        for (ProvisionedProductAttribute value : provisionedProducts) {
    ...
    public String toString() {
        ...
        if (getTotalResultsCount() != null)
            sb.append("TotalResultsCount: " + getTotalResultsCount() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getTotalResultsCount() == null) ? 0 : getTotalResultsCount().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTotalResultsCount() == null ^ this.getTotalResultsCount() == null)
            return false;
        if (other.getTotalResultsCount() != null
                && other.getTotalResultsCount().equals(this.getTotalResultsCount()) == false)
            return false;
