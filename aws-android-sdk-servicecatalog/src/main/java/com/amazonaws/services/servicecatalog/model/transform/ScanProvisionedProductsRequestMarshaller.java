...
/**
 * JSON request marshaller for ScanProvisionedProductsRequest
 */
public class ScanProvisionedProductsRequestMarshaller implements
    ...
    public Request<ScanProvisionedProductsRequest> marshall(
        ...
        if (scanProvisionedProductsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ScanProvisionedProductsRequest)");
        }
        ...
        try {
            ...
            if (scanProvisionedProductsRequest.getAcceptLanguage() != null) {
                String acceptLanguage = scanProvisionedProductsRequest.getAcceptLanguage();
                jsonWriter.name("AcceptLanguage");
                jsonWriter.value(acceptLanguage);
            }
            if (scanProvisionedProductsRequest.getAccessLevelFilter() != null) {
                AccessLevelFilter accessLevelFilter = scanProvisionedProductsRequest
            ...
            if (scanProvisionedProductsRequest.getPageSize() != null) {
                Integer pageSize = scanProvisionedProductsRequest.getPageSize();
                jsonWriter.name("PageSize");
                jsonWriter.value(pageSize);
            }
            if (scanProvisionedProductsRequest.getPageToken() != null) {
                String pageToken = scanProvisionedProductsRequest.getPageToken();
