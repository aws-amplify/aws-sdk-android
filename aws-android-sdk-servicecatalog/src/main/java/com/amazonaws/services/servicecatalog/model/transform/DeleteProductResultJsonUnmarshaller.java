...
/**
 * JSON unmarshaller for response DeleteProductResult
 */
public class DeleteProductResultJsonUnmarshaller implements
        Unmarshaller<DeleteProductResult, JsonUnmarshallerContext> {
