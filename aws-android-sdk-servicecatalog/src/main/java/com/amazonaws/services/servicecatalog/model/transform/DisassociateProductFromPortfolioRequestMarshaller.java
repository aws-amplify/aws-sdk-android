...
/**
 * JSON request marshaller for DisassociateProductFromPortfolioRequest
 */
public class DisassociateProductFromPortfolioRequestMarshaller
    ...
    public Request<DisassociateProductFromPortfolioRequest> marshall(
        ...
        if (disassociateProductFromPortfolioRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DisassociateProductFromPortfolioRequest)");
        }
        ...
        try {
            ...
            if (disassociateProductFromPortfolioRequest.getAcceptLanguage() != null) {
                String acceptLanguage = disassociateProductFromPortfolioRequest.getAcceptLanguage();
            ...
            if (disassociateProductFromPortfolioRequest.getProductId() != null) {
                String productId = disassociateProductFromPortfolioRequest.getProductId();
                jsonWriter.name("ProductId");
                jsonWriter.value(productId);
            }
            if (disassociateProductFromPortfolioRequest.getPortfolioId() != null) {
                String portfolioId = disassociateProductFromPortfolioRequest.getPortfolioId();
