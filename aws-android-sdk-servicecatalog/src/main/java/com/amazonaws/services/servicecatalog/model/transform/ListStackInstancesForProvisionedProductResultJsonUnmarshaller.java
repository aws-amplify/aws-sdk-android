...
/**
 * JSON unmarshaller for response ListStackInstancesForProvisionedProductResult
 */
public class ListStackInstancesForProvisionedProductResultJsonUnmarshaller implements
    ...
    public ListStackInstancesForProvisionedProductResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("StackInstances")) {
                listStackInstancesForProvisionedProductResult
                        .setStackInstances(new ListUnmarshaller<StackInstance>(
                                StackInstanceJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextPageToken")) {
                listStackInstancesForProvisionedProductResult
                        .setNextPageToken(StringJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
            }
