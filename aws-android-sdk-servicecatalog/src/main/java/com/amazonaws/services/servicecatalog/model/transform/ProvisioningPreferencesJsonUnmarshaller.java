...
/**
 * JSON unmarshaller for POJO ProvisioningPreferences
 */
class ProvisioningPreferencesJsonUnmarshaller implements
        Unmarshaller<ProvisioningPreferences, JsonUnmarshallerContext> {
    ...
    public ProvisioningPreferences unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("StackSetAccounts")) {
                provisioningPreferences.setStackSetAccounts(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("StackSetRegions")) {
                provisioningPreferences.setStackSetRegions(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("StackSetFailureToleranceCount")) {
                provisioningPreferences.setStackSetFailureToleranceCount(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                provisioningPreferences.setStackSetMaxConcurrencyCount(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("StackSetMaxConcurrencyPercentage")) {
                provisioningPreferences.setStackSetMaxConcurrencyPercentage(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
