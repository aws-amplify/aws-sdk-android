...
/**
 * JSON unmarshaller for response RejectPortfolioShareResult
 */
public class RejectPortfolioShareResultJsonUnmarshaller implements
        Unmarshaller<RejectPortfolioShareResult, JsonUnmarshallerContext> {
