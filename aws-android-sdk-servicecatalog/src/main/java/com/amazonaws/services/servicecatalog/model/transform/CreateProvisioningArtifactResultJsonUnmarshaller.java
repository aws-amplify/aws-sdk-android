...
/**
 * JSON unmarshaller for response CreateProvisioningArtifactResult
 */
public class CreateProvisioningArtifactResultJsonUnmarshaller implements
        Unmarshaller<CreateProvisioningArtifactResult, JsonUnmarshallerContext> {

    public CreateProvisioningArtifactResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ProvisioningArtifactDetail")) {
                ...
                createProvisioningArtifactResult.setInfo(new MapUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Status")) {
                createProvisioningArtifactResult.setStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
