...
/**
 * JSON unmarshaller for response UpdateProductResult
 */
public class UpdateProductResultJsonUnmarshaller implements
        Unmarshaller<UpdateProductResult, JsonUnmarshallerContext> {
    ...
    public UpdateProductResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ProductViewDetail")) {
                updateProductResult.setProductViewDetail(ProductViewDetailJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Tags")) {
                updateProductResult.setTags(new ListUnmarshaller<Tag>(TagJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
