...
/**
 * JSON request marshaller for ProvisionProductRequest
 */
    ...
    public Request<ProvisionProductRequest> marshall(ProvisionProductRequest provisionProductRequest) {
        if (provisionProductRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ProvisionProductRequest)");
        }
        ...
        try {
            ...
            if (provisionProductRequest.getAcceptLanguage() != null) {
                String acceptLanguage = provisionProductRequest.getAcceptLanguage();
                jsonWriter.name("AcceptLanguage");
                jsonWriter.value(acceptLanguage);
            }
            if (provisionProductRequest.getProductId() != null) {
                String productId = provisionProductRequest.getProductId();
                jsonWriter.name("ProductId");
                jsonWriter.value(productId);
            }
            if (provisionProductRequest.getProvisioningArtifactId() != null) {
                String provisioningArtifactId = provisionProductRequest.getProvisioningArtifactId();
                jsonWriter.name("ProvisioningArtifactId");
                jsonWriter.value(provisioningArtifactId);
            }
            if (provisionProductRequest.getPathId() != null) {
                String pathId = provisionProductRequest.getPathId();
                jsonWriter.name("PathId");
                jsonWriter.value(pathId);
            }
            if (provisionProductRequest.getProvisionedProductName() != null) {
                String provisionedProductName = provisionProductRequest.getProvisionedProductName();
                jsonWriter.name("ProvisionedProductName");
                jsonWriter.value(provisionedProductName);
            }
            if (provisionProductRequest.getProvisioningParameters() != null) {
                java.util.List<ProvisioningParameter> provisioningParameters = provisionProductRequest
                        .getProvisioningParameters();
                jsonWriter.name("ProvisioningParameters");
                jsonWriter.beginArray();
                for (ProvisioningParameter provisioningParametersItem : provisioningParameters) {
                    if (provisioningParametersItem != null) {
                        ProvisioningParameterJsonMarshaller.getInstance().marshall(
                                provisioningParametersItem, jsonWriter);
                    }
                }
                jsonWriter.endArray();
            }
            if (provisionProductRequest.getProvisioningPreferences() != null) {
                ProvisioningPreferences provisioningPreferences = provisionProductRequest
                        .getProvisioningPreferences();
                jsonWriter.name("ProvisioningPreferences");
                ProvisioningPreferencesJsonMarshaller.getInstance().marshall(
                        provisioningPreferences, jsonWriter);
            }
            if (provisionProductRequest.getTags() != null) {
                java.util.List<Tag> tags = provisionProductRequest.getTags();
            ...
            if (provisionProductRequest.getNotificationArns() != null) {
                java.util.List<String> notificationArns = provisionProductRequest
                        .getNotificationArns();
            ...
            if (provisionProductRequest.getProvisionToken() != null) {
                String provisionToken = provisionProductRequest.getProvisionToken();
                jsonWriter.name("ProvisionToken");
                jsonWriter.value(provisionToken);
            }
