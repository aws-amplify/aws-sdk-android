...
/**
 * JSON request marshaller for DisassociatePrincipalFromPortfolioRequest
 */
public class DisassociatePrincipalFromPortfolioRequestMarshaller
    ...
    public Request<DisassociatePrincipalFromPortfolioRequest> marshall(
        ...
        if (disassociatePrincipalFromPortfolioRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DisassociatePrincipalFromPortfolioRequest)");
        }
        ...
        try {
            ...
            if (disassociatePrincipalFromPortfolioRequest.getAcceptLanguage() != null) {
                String acceptLanguage = disassociatePrincipalFromPortfolioRequest
                        .getAcceptLanguage();
            ...
            if (disassociatePrincipalFromPortfolioRequest.getPortfolioId() != null) {
                String portfolioId = disassociatePrincipalFromPortfolioRequest.getPortfolioId();
                jsonWriter.name("PortfolioId");
                jsonWriter.value(portfolioId);
            }
            if (disassociatePrincipalFromPortfolioRequest.getPrincipalARN() != null) {
                String principalARN = disassociatePrincipalFromPortfolioRequest.getPrincipalARN();
