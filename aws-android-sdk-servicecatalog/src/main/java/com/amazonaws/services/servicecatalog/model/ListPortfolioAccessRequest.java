 ...
 * </p>
 */
public class ListPortfolioAccessRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     * The language code.
     * </p>
     ...
     * <b>Pattern: </b>^[a-zA-Z0-9_\-]*<br/>
     *
     * @param organizationParentId <p>
     *            The ID of an organization node the portfolio is shared with.
     *            All children of this node with an inherited portfolio share
     *            will be returned.
     *            </p>
     */
    ...
    public String toString() {
        ...
        if (getOrganizationParentId() != null)
            sb.append("OrganizationParentId: " + getOrganizationParentId() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getOrganizationParentId() == null) ? 0 : getOrganizationParentId().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getOrganizationParentId() == null ^ this.getOrganizationParentId() == null)
            return false;
        if (other.getOrganizationParentId() != null
                && other.getOrganizationParentId().equals(this.getOrganizationParentId()) == false)
            return false;
