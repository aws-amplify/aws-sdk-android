...
/**
 * JSON unmarshaller for response AssociatePrincipalWithPortfolioResult
 */
public class AssociatePrincipalWithPortfolioResultJsonUnmarshaller implements
        Unmarshaller<AssociatePrincipalWithPortfolioResult, JsonUnmarshallerContext> {

    public AssociatePrincipalWithPortfolioResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
