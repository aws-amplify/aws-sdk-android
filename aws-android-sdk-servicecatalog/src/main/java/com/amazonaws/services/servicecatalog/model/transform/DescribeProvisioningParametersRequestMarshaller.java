...
/**
 * JSON request marshaller for DescribeProvisioningParametersRequest
 */
    ...
    public Request<DescribeProvisioningParametersRequest> marshall(
        ...
        if (describeProvisioningParametersRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeProvisioningParametersRequest)");
        }
        ...
        try {
            ...
            if (describeProvisioningParametersRequest.getPathId() != null) {
                String pathId = describeProvisioningParametersRequest.getPathId();
