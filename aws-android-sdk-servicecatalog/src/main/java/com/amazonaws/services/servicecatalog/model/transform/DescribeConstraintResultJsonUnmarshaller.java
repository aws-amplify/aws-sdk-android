...
/**
 * JSON unmarshaller for response DescribeConstraintResult
 */
public class DescribeConstraintResultJsonUnmarshaller implements
        Unmarshaller<DescribeConstraintResult, JsonUnmarshallerContext> {
    ...
    public DescribeConstraintResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ConstraintDetail")) {
                describeConstraintResult.setConstraintDetail(ConstraintDetailJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("ConstraintParameters")) {
                describeConstraintResult.setConstraintParameters(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Status")) {
                describeConstraintResult.setStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
