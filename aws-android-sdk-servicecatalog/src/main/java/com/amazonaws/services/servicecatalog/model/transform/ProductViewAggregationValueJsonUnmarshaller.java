...
/**
 * JSON unmarshaller for POJO ProductViewAggregationValue
 */
class ProductViewAggregationValueJsonUnmarshaller implements
    ...
    public ProductViewAggregationValue unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Value")) {
                productViewAggregationValue.setValue(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ApproximateCount")) {
                productViewAggregationValue.setApproximateCount(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
