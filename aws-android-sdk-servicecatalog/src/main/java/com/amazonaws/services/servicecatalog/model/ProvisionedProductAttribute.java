 ...
 * </p>
 */
public class ProvisionedProductAttribute implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         The assigned identifier for the resource, such as an EC2 instance
     *         ID or an S3 bucket name.
     *         </p>
     */
     ...
     * </p>
     *
     * @param userArnSession <p>
     *            The ARN of the IAM user in the session. This ARN might contain
     *            a session ID.
     *            </p>
     */
    ...
    public String toString() {
        ...
        if (getPhysicalId() != null)
            sb.append("PhysicalId: " + getPhysicalId() + ",");
        ...
        if (getUserArnSession() != null)
            sb.append("UserArnSession: " + getUserArnSession());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getUserArnSession() == null) ? 0 : getUserArnSession().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getPhysicalId() != null
                && other.getPhysicalId().equals(this.getPhysicalId()) == false)
            return false;
        ...
        if (other.getUserArnSession() == null ^ this.getUserArnSession() == null)
            return false;
        if (other.getUserArnSession() != null
                && other.getUserArnSession().equals(this.getUserArnSession()) == false)
            return false;
        return true;
    }
}
