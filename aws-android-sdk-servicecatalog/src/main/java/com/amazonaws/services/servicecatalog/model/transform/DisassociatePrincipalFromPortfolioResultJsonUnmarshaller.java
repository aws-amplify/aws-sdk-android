...
/**
 * JSON unmarshaller for response DisassociatePrincipalFromPortfolioResult
 */
public class DisassociatePrincipalFromPortfolioResultJsonUnmarshaller implements
    ...
    public DisassociatePrincipalFromPortfolioResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
