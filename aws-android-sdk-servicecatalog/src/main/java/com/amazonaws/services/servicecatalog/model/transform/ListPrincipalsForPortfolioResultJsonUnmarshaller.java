...
/**
 * JSON unmarshaller for response ListPrincipalsForPortfolioResult
 */
public class ListPrincipalsForPortfolioResultJsonUnmarshaller implements
        Unmarshaller<ListPrincipalsForPortfolioResult, JsonUnmarshallerContext> {

    public ListPrincipalsForPortfolioResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Principals")) {
                listPrincipalsForPortfolioResult.setPrincipals(new ListUnmarshaller<Principal>(
                        PrincipalJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextPageToken")) {
                listPrincipalsForPortfolioResult.setNextPageToken(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
