...
/**
 * JSON request marshaller for TerminateProvisionedProductRequest
 */
    ...
    public Request<TerminateProvisionedProductRequest> marshall(
        ...
        if (terminateProvisionedProductRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(TerminateProvisionedProductRequest)");
        }
        ...
        try {
            ...
            if (terminateProvisionedProductRequest.getProvisionedProductName() != null) {
                String provisionedProductName = terminateProvisionedProductRequest
            ...
            if (terminateProvisionedProductRequest.getProvisionedProductId() != null) {
                String provisionedProductId = terminateProvisionedProductRequest
                        .getProvisionedProductId();
                jsonWriter.name("ProvisionedProductId");
                jsonWriter.value(provisionedProductId);
            }
            if (terminateProvisionedProductRequest.getTerminateToken() != null) {
                String terminateToken = terminateProvisionedProductRequest.getTerminateToken();
                jsonWriter.name("TerminateToken");
                jsonWriter.value(terminateToken);
            }
            if (terminateProvisionedProductRequest.getIgnoreErrors() != null) {
                Boolean ignoreErrors = terminateProvisionedProductRequest.getIgnoreErrors();
                jsonWriter.name("IgnoreErrors");
                jsonWriter.value(ignoreErrors);
            }
            if (terminateProvisionedProductRequest.getAcceptLanguage() != null) {
                String acceptLanguage = terminateProvisionedProductRequest.getAcceptLanguage();
