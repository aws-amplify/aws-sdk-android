...
/**
 * JSON unmarshaller for response DescribeProductResult
 */
    ...
    public DescribeProductResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ProductViewSummary")) {
                describeProductResult.setProductViewSummary(ProductViewSummaryJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                describeProductResult.setBudgets(new ListUnmarshaller<BudgetDetail>(
                        BudgetDetailJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("LaunchPaths")) {
                describeProductResult.setLaunchPaths(new ListUnmarshaller<LaunchPath>(
                        LaunchPathJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
