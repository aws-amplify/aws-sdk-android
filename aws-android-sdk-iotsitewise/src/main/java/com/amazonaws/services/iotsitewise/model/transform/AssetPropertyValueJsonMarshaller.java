...
class AssetPropertyValueJsonMarshaller {
    ...
    public void marshall(AssetPropertyValue assetPropertyValue, AwsJsonWriter jsonWriter)
        ...
        if (assetPropertyValue.getValue() != null) {
            Variant value = assetPropertyValue.getValue();
            jsonWriter.name("value");
            VariantJsonMarshaller.getInstance().marshall(value, jsonWriter);
        }
        if (assetPropertyValue.getTimestamp() != null) {
            TimeInNanos timestamp = assetPropertyValue.getTimestamp();
            jsonWriter.name("timestamp");
            TimeInNanosJsonMarshaller.getInstance().marshall(timestamp, jsonWriter);
        }
