...
public class DeleteAssetModelResult implements Serializable {
     ...
     * <code>DELETING</code> after successfully calling this operation) and any
     * error message.
     * </p>
     */
     ...
     * @return <p>
     *         The status of the asset model, which contains a state (
     *         <code>DELETING</code> after successfully calling this operation)
     ...
     *            The status of the asset model, which contains a state (
     *            <code>DELETING</code> after successfully calling this
