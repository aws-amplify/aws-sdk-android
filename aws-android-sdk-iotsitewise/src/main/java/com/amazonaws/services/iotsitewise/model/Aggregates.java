...
public class Aggregates implements Serializable {
    ...
    public String toString() {
        ...
        if (getStandardDeviation() != null)
            sb.append("standardDeviation: " + getStandardDeviation());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getStandardDeviation() == null) ? 0 : getStandardDeviation().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getStandardDeviation() == null ^ this.getStandardDeviation() == null)
            return false;
        if (other.getStandardDeviation() != null
                && other.getStandardDeviation().equals(this.getStandardDeviation()) == false)
            return false;
        return true;
    }
}
