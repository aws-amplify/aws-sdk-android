    ...
    public Request<DeleteProjectRequest> marshall(DeleteProjectRequest deleteProjectRequest) {
        if (deleteProjectRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteProjectRequest)");
        }

        Request<DeleteProjectRequest> request = new DefaultRequest<DeleteProjectRequest>(
                deleteProjectRequest, "AWSIoTSiteWise");
        request.setHttpMethod(HttpMethodName.DELETE);

        String uriResourcePath = "/projects/{projectId}";
        uriResourcePath = uriResourcePath.replace(
                "{projectId}",
                (deleteProjectRequest.getProjectId() == null) ? "" : StringUtils
                        .fromString(deleteProjectRequest.getProjectId()));
        if (deleteProjectRequest.getClientToken() != null) {
            request.addParameter("clientToken",
                    StringUtils.fromString(deleteProjectRequest.getClientToken()));
        }
