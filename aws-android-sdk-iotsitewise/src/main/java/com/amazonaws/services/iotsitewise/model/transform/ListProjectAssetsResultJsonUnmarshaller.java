...
/**
 * JSON unmarshaller for response ListProjectAssetsResult
 */
public class ListProjectAssetsResultJsonUnmarshaller implements
        Unmarshaller<ListProjectAssetsResult, JsonUnmarshallerContext> {
    ...
    public ListProjectAssetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("assetIds")) {
                listProjectAssetsResult.setAssetIds(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                listProjectAssetsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
