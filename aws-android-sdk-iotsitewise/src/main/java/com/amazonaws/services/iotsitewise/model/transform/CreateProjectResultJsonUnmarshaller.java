 ...
 */
public class CreateProjectResultJsonUnmarshaller implements
        Unmarshaller<CreateProjectResult, JsonUnmarshallerContext> {
    ...
    public CreateProjectResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("projectId")) {
                createProjectResult.setProjectId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("projectArn")) {
                createProjectResult.setProjectArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
