...
public class ListDashboardsResult implements Serializable {
    /**
     * <p>
    ...
    public ListDashboardsResult withDashboardSummaries(DashboardSummary... dashboardSummaries) {
        if (getDashboardSummaries() == null) {
            this.dashboardSummaries = new java.util.ArrayList<DashboardSummary>(
                    dashboardSummaries.length);
        }
        for (DashboardSummary value : dashboardSummaries) {
            this.dashboardSummaries.add(value);
        }
        return this;
    }
     ...
     *         chained together.
     */
    public ListDashboardsResult withDashboardSummaries(
            java.util.Collection<DashboardSummary> dashboardSummaries) {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getDashboardSummaries() != null)
            sb.append("dashboardSummaries: " + getDashboardSummaries() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getDashboardSummaries() == null) ? 0 : getDashboardSummaries().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDashboardSummaries() == null ^ this.getDashboardSummaries() == null)
            return false;
        if (other.getDashboardSummaries() != null
                && other.getDashboardSummaries().equals(this.getDashboardSummaries()) == false)
            return false;
