...
public class UpdateAssetModelResult implements Serializable {
    /**
     * <p>
     * The status of the asset model, which contains a state (
     * <code>UPDATING</code> after successfully calling this operation) and any
     * error message.
     * </p>
     */
     ...
     * @return <p>
     *         The status of the asset model, which contains a state (
     *         <code>UPDATING</code> after successfully calling this operation)
     ...
     *            The status of the asset model, which contains a state (
     *            <code>UPDATING</code> after successfully calling this
