...
class AggregatesJsonMarshaller {
    ...
    public void marshall(Aggregates aggregates, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (aggregates.getStandardDeviation() != null) {
            Double standardDeviation = aggregates.getStandardDeviation();
            jsonWriter.name("standardDeviation");
            jsonWriter.value(standardDeviation);
        }
