...
public class UpdatePortalRequestMarshaller implements
    ...
    public Request<UpdatePortalRequest> marshall(UpdatePortalRequest updatePortalRequest) {
        ...
        try {
            ...
            if (updatePortalRequest.getPortalLogoImage() != null) {
                Image portalLogoImage = updatePortalRequest.getPortalLogoImage();
                jsonWriter.name("portalLogoImage");
                ImageJsonMarshaller.getInstance().marshall(portalLogoImage, jsonWriter);
            }
