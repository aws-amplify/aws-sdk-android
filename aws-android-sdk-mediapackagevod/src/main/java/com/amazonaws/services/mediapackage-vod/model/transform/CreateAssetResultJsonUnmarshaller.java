...
.unmarshall(context));
                ...
                createAssetResult.setTags(new MapUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
.unmarshall(context));
            } else {
                reader.skipValue();
    ...
    public static CreateAssetResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CreateAssetResultJsonUnmarshaller();
        return instance;
    }
}
