...
.unmarshall(context));
                ...
                createPackagingConfigurationResult.setCmafPackage(CmafPackageJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("DashPackage")) {
                createPackagingConfigurationResult.setDashPackage(DashPackageJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("HlsPackage")) {
                createPackagingConfigurationResult.setHlsPackage(HlsPackageJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Id")) {
                createPackagingConfigurationResult.setId(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("MssPackage")) {
                createPackagingConfigurationResult.setMssPackage(MssPackageJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("PackagingGroupId")) {
                createPackagingConfigurationResult.setPackagingGroupId(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Tags")) {
                createPackagingConfigurationResult.setTags(new MapUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
)
.unmarshall(context));
            } else {
                reader.skipValue();
    ...
    public static CreatePackagingConfigurationResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CreatePackagingConfigurationResultJsonUnmarshaller();
        return instance;
    }
}
