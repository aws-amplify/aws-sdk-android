...
public class ListPackagingConfigurationsResult implements Serializable {
    ...
    public ListPackagingConfigurationsResult withPackagingConfigurations(PackagingConfiguration... packagingConfigurations) {
        if (getPackagingConfigurations() == null) {
            this.packagingConfigurations = new java.util.ArrayList<PackagingConfiguration>(packagingConfigurations.length);
        }
    ...
    public String toString() {
        ...
        if (getPackagingConfigurations() != null) sb.append("PackagingConfigurations: " + getPackagingConfigurations());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListPackagingConfigurationsResult == false) return false;
        ListPackagingConfigurationsResult other = (ListPackagingConfigurationsResult)obj;

        if (other.getNextToken() == null ^ this.getNextToken() == null) return false;
        if (other.getNextToken() != null && other.getNextToken().equals(this.getNextToken()) == false) return false;
        if (other.getPackagingConfigurations() == null ^ this.getPackagingConfigurations() == null) return false;
        if (other.getPackagingConfigurations() != null && other.getPackagingConfigurations().equals(this.getPackagingConfigurations()) == false) return false;
        return true;
    }
}
