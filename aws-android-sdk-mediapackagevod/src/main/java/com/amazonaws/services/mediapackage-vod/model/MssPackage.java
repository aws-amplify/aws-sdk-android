...
public class MssPackage implements Serializable {
     ...
     * A Microsoft Smooth Streaming (MSS) encryption configuration.
     *
     * @param encryption A Microsoft Smooth Streaming (MSS) encryption configuration.
     */
    ...
    public String toString() {
        ...
        if (getMssManifests() != null) sb.append("MssManifests: " + getMssManifests() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MssPackage == false) return false;
        ...
        if (other.getMssManifests() == null ^ this.getMssManifests() == null) return false;
        if (other.getMssManifests() != null && other.getMssManifests().equals(this.getMssManifests()) == false) return false;
