 ...
 */
package com.amazonaws.services.mediapackage-vod;
...
import com.amazonaws.services.mediapackage-vod.model.transform.*;
 ...
 */
public class AWSElementalMediaPackageVODClient extends AmazonWebServiceClient implements AWSElementalMediaPackageVOD { 
    /** Provider for AWS credentials. */
    private AWSCredentialsProvider awsCredentialsProvider;

    /**
     * List of exception unmarshallers for all AWS Elemental MediaPackage VOD exceptions.
     */
     ...
     *                       client connects to AWSElementalMediaPackageVOD
     ...
     *         AWSElementalMediaPackageVODClient client = new AWSElementalMediaPackageVODClient(AWSMobileClient.getInstance());
     *     }
     * 
     *     &#64;Override
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AWSElementalMediaPackageVODClient(AWSCredentials awsCredentials, ClientConfiguration clientConfiguration) {
        this(new StaticCredentialsProvider(awsCredentials), clientConfiguration);
    }

    /**
     * Constructs a new client to invoke service methods on
     * AWSElementalMediaPackageVOD using the specified AWS account credentials provider.
     * <p>
     * The client requests are authenticated using the {@link AWSCredentials}
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AWSElementalMediaPackageVODClient(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/mediapackage-vod/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/mediapackage-vod/request.handler2s"));
    }
     ...
     * @return createAssetResult The response from the CreateAsset service method, as returned by AWS Elemental MediaPackage VOD.
     ...
     *             If an error response is returned by AWS Elemental MediaPackage VOD indicating
    ...
    public CreateAssetResult createAsset(CreateAssetRequest createAssetRequest)
        ...
        try {
            ...
            JsonResponseHandler<CreateAssetResult> responseHandler = new JsonResponseHandler<CreateAssetResult>(unmarshaller);
     ...
     * @param createPackagingConfigurationRequest A new MediaPackage VOD PackagingConfiguration resource configuration.
     * @return createPackagingConfigurationResult The response from the CreatePackagingConfiguration service method, as returned by AWS Elemental MediaPackage VOD.
     * @throws UnprocessableEntityException 
     * @throws InternalServerErrorException 
     * @throws ForbiddenException 
     * @throws NotFoundException 
    ...
    public CreatePackagingConfigurationResult createPackagingConfiguration(CreatePackagingConfigurationRequest createPackagingConfigurationRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new CreatePackagingConfigurationRequestMarshaller().marshall(createPackagingConfigurationRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<CreatePackagingConfigurationResult> responseHandler = new JsonResponseHandler<CreatePackagingConfigurationResult>(unmarshaller);
     ...
     * @param createPackagingGroupRequest A new MediaPackage VOD PackagingGroup resource configuration.
     * @return createPackagingGroupResult The response from the CreatePackagingGroup service method, as returned by AWS Elemental MediaPackage VOD.
     * @throws UnprocessableEntityException 
     * @throws InternalServerErrorException 
     * @throws ForbiddenException 
     * @throws NotFoundException 
    ...
    public CreatePackagingGroupResult createPackagingGroup(CreatePackagingGroupRequest createPackagingGroupRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new CreatePackagingGroupRequestMarshaller().marshall(createPackagingGroupRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<CreatePackagingGroupResult> responseHandler = new JsonResponseHandler<CreatePackagingGroupResult>(unmarshaller);
     ...
     * @return deleteAssetResult The response from the DeleteAsset service method, as returned by AWS Elemental MediaPackage VOD.
     * @throws UnprocessableEntityException 
     * @throws InternalServerErrorException 
     * @throws ForbiddenException 
     * @throws NotFoundException 
    ...
    public DeleteAssetResult deleteAsset(DeleteAssetRequest deleteAssetRequest)
        ...
        try {
            ...
            JsonResponseHandler<DeleteAssetResult> responseHandler = new JsonResponseHandler<DeleteAssetResult>(unmarshaller);
     ...
     * @return deletePackagingConfigurationResult The response from the DeletePackagingConfiguration service method, as returned by AWS Elemental MediaPackage VOD.
     * @throws UnprocessableEntityException 
     * @throws InternalServerErrorException 
     * @throws ForbiddenException 
     * @throws NotFoundException 
    ...
    public DeletePackagingConfigurationResult deletePackagingConfiguration(DeletePackagingConfigurationRequest deletePackagingConfigurationRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DeletePackagingConfigurationRequestMarshaller().marshall(deletePackagingConfigurationRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DeletePackagingConfigurationResult> responseHandler = new JsonResponseHandler<DeletePackagingConfigurationResult>(unmarshaller);
     ...
     * @return deletePackagingGroupResult The response from the DeletePackagingGroup service method, as returned by AWS Elemental MediaPackage VOD.
     * @throws UnprocessableEntityException 
     * @throws InternalServerErrorException 
     * @throws ForbiddenException 
     * @throws NotFoundException 
    ...
    public DeletePackagingGroupResult deletePackagingGroup(DeletePackagingGroupRequest deletePackagingGroupRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DeletePackagingGroupRequestMarshaller().marshall(deletePackagingGroupRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DeletePackagingGroupResult> responseHandler = new JsonResponseHandler<DeletePackagingGroupResult>(unmarshaller);
     ...
     * @return describeAssetResult The response from the DescribeAsset service method, as returned by AWS Elemental MediaPackage VOD.
     * @throws UnprocessableEntityException 
     * @throws InternalServerErrorException 
     * @throws ForbiddenException 
     * @throws NotFoundException 
    ...
    public DescribeAssetResult describeAsset(DescribeAssetRequest describeAssetRequest)
        ...
        try {
            ...
            JsonResponseHandler<DescribeAssetResult> responseHandler = new JsonResponseHandler<DescribeAssetResult>(unmarshaller);
     ...
     * @return describePackagingConfigurationResult The response from the DescribePackagingConfiguration service method, as returned by AWS Elemental MediaPackage VOD.
     * @throws UnprocessableEntityException 
     * @throws InternalServerErrorException 
     * @throws ForbiddenException 
     * @throws NotFoundException 
    ...
    public DescribePackagingConfigurationResult describePackagingConfiguration(DescribePackagingConfigurationRequest describePackagingConfigurationRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribePackagingConfigurationRequestMarshaller().marshall(describePackagingConfigurationRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribePackagingConfigurationResult> responseHandler = new JsonResponseHandler<DescribePackagingConfigurationResult>(unmarshaller);
     ...
     * @return describePackagingGroupResult The response from the DescribePackagingGroup service method, as returned by AWS Elemental MediaPackage VOD.
     * @throws UnprocessableEntityException 
     * @throws InternalServerErrorException 
     * @throws ForbiddenException 
     * @throws NotFoundException 
    ...
    public DescribePackagingGroupResult describePackagingGroup(DescribePackagingGroupRequest describePackagingGroupRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribePackagingGroupRequestMarshaller().marshall(describePackagingGroupRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribePackagingGroupResult> responseHandler = new JsonResponseHandler<DescribePackagingGroupResult>(unmarshaller);
     ...
     * @return listAssetsResult The response from the ListAssets service method, as returned by AWS Elemental MediaPackage VOD.
     * @throws UnprocessableEntityException 
     * @throws InternalServerErrorException 
     * @throws ForbiddenException 
     * @throws NotFoundException 
    ...
    public ListAssetsResult listAssets(ListAssetsRequest listAssetsRequest)
        ...
        try {
            ...
            JsonResponseHandler<ListAssetsResult> responseHandler = new JsonResponseHandler<ListAssetsResult>(unmarshaller);
     ...
     * @return listPackagingConfigurationsResult The response from the ListPackagingConfigurations service method, as returned by AWS Elemental MediaPackage VOD.
     * @throws UnprocessableEntityException 
     * @throws InternalServerErrorException 
     * @throws ForbiddenException 
     * @throws NotFoundException 
    ...
    public ListPackagingConfigurationsResult listPackagingConfigurations(ListPackagingConfigurationsRequest listPackagingConfigurationsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListPackagingConfigurationsRequestMarshaller().marshall(listPackagingConfigurationsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ListPackagingConfigurationsResult> responseHandler = new JsonResponseHandler<ListPackagingConfigurationsResult>(unmarshaller);
     ...
     * @return listPackagingGroupsResult The response from the ListPackagingGroups service method, as returned by AWS Elemental MediaPackage VOD.
     * @throws UnprocessableEntityException 
     * @throws InternalServerErrorException 
     * @throws ForbiddenException 
     * @throws NotFoundException 
    ...
    public ListPackagingGroupsResult listPackagingGroups(ListPackagingGroupsRequest listPackagingGroupsRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListPackagingGroupsRequestMarshaller().marshall(listPackagingGroupsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<ListPackagingGroupsResult> responseHandler = new JsonResponseHandler<ListPackagingGroupsResult>(unmarshaller);
     ...
     * @return listTagsForResourceResult The response from the ListTagsForResource service method, as returned by AWS Elemental MediaPackage VOD.
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     *             attempting to make the request or handle the response.  For example
     *             if a network connection is not available.
     ...
     * @param updatePackagingGroupRequest A MediaPackage VOD PackagingGroup resource configuration.
     * @return updatePackagingGroupResult The response from the UpdatePackagingGroup service method, as returned by AWS Elemental MediaPackage VOD.
     * @throws UnprocessableEntityException 
     * @throws InternalServerErrorException 
     * @throws ForbiddenException 
     * @throws NotFoundException 
    ...
    public UpdatePackagingGroupResult updatePackagingGroup(UpdatePackagingGroupRequest updatePackagingGroupRequest)
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new UpdatePackagingGroupRequestMarshaller().marshall(updatePackagingGroupRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<UpdatePackagingGroupResult, JsonUnmarshallerContext> unmarshaller = new UpdatePackagingGroupResultJsonUnmarshaller();
            JsonResponseHandler<UpdatePackagingGroupResult> responseHandler = new JsonResponseHandler<UpdatePackagingGroupResult>(unmarshaller);
