...
public class EgressEndpoint implements Serializable {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getPackagingConfigurationId() != null) sb.append("PackagingConfigurationId: " + getPackagingConfigurationId() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EgressEndpoint == false) return false;
        EgressEndpoint other = (EgressEndpoint)obj;

        if (other.getPackagingConfigurationId() == null ^ this.getPackagingConfigurationId() == null) return false;
        if (other.getPackagingConfigurationId() != null && other.getPackagingConfigurationId().equals(this.getPackagingConfigurationId()) == false) return false;
