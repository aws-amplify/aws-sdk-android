 ...
 */
public class CreatePackagingConfigurationRequest extends AmazonWebServiceRequest implements Serializable {
    /**
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getCmafPackage() != null) sb.append("CmafPackage: " + getCmafPackage() + ",");
        if (getDashPackage() != null) sb.append("DashPackage: " + getDashPackage() + ",");
        if (getHlsPackage() != null) sb.append("HlsPackage: " + getHlsPackage() + ",");
        if (getId() != null) sb.append("Id: " + getId() + ",");
        if (getMssPackage() != null) sb.append("MssPackage: " + getMssPackage() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreatePackagingConfigurationRequest == false) return false;
        CreatePackagingConfigurationRequest other = (CreatePackagingConfigurationRequest)obj;

        if (other.getCmafPackage() == null ^ this.getCmafPackage() == null) return false;
        if (other.getCmafPackage() != null && other.getCmafPackage().equals(this.getCmafPackage()) == false) return false;
        if (other.getDashPackage() == null ^ this.getDashPackage() == null) return false;
        if (other.getDashPackage() != null && other.getDashPackage().equals(this.getDashPackage()) == false) return false;
        if (other.getHlsPackage() == null ^ this.getHlsPackage() == null) return false;
        if (other.getHlsPackage() != null && other.getHlsPackage().equals(this.getHlsPackage()) == false) return false;
        if (other.getId() == null ^ this.getId() == null) return false;
        if (other.getId() != null && other.getId().equals(this.getId()) == false) return false;
        if (other.getMssPackage() == null ^ this.getMssPackage() == null) return false;
        if (other.getMssPackage() != null && other.getMssPackage().equals(this.getMssPackage()) == false) return false;
