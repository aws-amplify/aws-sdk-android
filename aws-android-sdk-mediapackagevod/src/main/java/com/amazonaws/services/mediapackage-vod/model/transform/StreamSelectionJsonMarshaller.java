...
class StreamSelectionJsonMarshaller {
    ...
    public void marshall(StreamSelection streamSelection, AwsJsonWriter jsonWriter) throws Exception {
    ...
    public static StreamSelectionJsonMarshaller getInstance() {
        if (instance == null) instance = new StreamSelectionJsonMarshaller();
        return instance;
    }
}
