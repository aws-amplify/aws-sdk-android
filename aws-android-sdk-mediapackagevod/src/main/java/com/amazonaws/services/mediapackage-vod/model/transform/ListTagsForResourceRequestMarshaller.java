...
public class ListTagsForResourceRequestMarshaller implements Marshaller<Request<ListTagsForResourceRequest>, ListTagsForResourceRequest> {
    ...
    public Request<ListTagsForResourceRequest> marshall(ListTagsForResourceRequest listTagsForResourceRequest) {
        ...
        Request<ListTagsForResourceRequest> request = new DefaultRequest<ListTagsForResourceRequest>(listTagsForResourceRequest, "AWSElementalMediaPackageVOD");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/tags/{resource-arn}";
        uriResourcePath = uriResourcePath.replace("{resource-arn}", (listTagsForResourceRequest.getResourceArn() == null) ? "" : StringUtils.fromString(listTagsForResourceRequest.getResourceArn()));
