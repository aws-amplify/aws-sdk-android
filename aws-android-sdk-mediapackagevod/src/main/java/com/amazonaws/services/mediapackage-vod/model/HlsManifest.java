...
it will be passed through to HLS output.
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getAdMarkers() != null) sb.append("AdMarkers: " + getAdMarkers() + ",");
        if (getIncludeIframeOnlyStream() != null) sb.append("IncludeIframeOnlyStream: " + getIncludeIframeOnlyStream() + ",");
        if (getManifestName() != null) sb.append("ManifestName: " + getManifestName() + ",");
        if (getProgramDateTimeIntervalSeconds() != null) sb.append("ProgramDateTimeIntervalSeconds: " + getProgramDateTimeIntervalSeconds() + ",");
        if (getRepeatExtXKey() != null) sb.append("RepeatExtXKey: " + getRepeatExtXKey() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HlsManifest == false) return false;
        HlsManifest other = (HlsManifest)obj;

        if (other.getAdMarkers() == null ^ this.getAdMarkers() == null) return false;
        if (other.getAdMarkers() != null && other.getAdMarkers().equals(this.getAdMarkers()) == false) return false;
        if (other.getIncludeIframeOnlyStream() == null ^ this.getIncludeIframeOnlyStream() == null) return false;
        if (other.getIncludeIframeOnlyStream() != null && other.getIncludeIframeOnlyStream().equals(this.getIncludeIframeOnlyStream()) == false) return false;
        ...
        if (other.getProgramDateTimeIntervalSeconds() == null ^ this.getProgramDateTimeIntervalSeconds() == null) return false;
        if (other.getProgramDateTimeIntervalSeconds() != null && other.getProgramDateTimeIntervalSeconds().equals(this.getProgramDateTimeIntervalSeconds()) == false) return false;
        if (other.getRepeatExtXKey() == null ^ this.getRepeatExtXKey() == null) return false;
        if (other.getRepeatExtXKey() != null && other.getRepeatExtXKey().equals(this.getRepeatExtXKey()) == false) return false;
