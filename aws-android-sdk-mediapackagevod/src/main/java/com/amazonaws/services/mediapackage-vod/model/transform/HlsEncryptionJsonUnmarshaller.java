...
/**
 * JSON unmarshaller for POJO HlsEncryption
 */
class HlsEncryptionJsonUnmarshaller implements Unmarshaller<HlsEncryption, JsonUnmarshallerContext> {
    ...
    public HlsEncryption unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ConstantInitializationVector")) {
                hlsEncryption.setConstantInitializationVector(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("EncryptionMethod")) {
                hlsEncryption.setEncryptionMethod(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("SpekeKeyProvider")) {
                hlsEncryption.setSpekeKeyProvider(SpekeKeyProviderJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static HlsEncryptionJsonUnmarshaller getInstance() {
        if (instance == null) instance = new HlsEncryptionJsonUnmarshaller();
        return instance;
    }
}
