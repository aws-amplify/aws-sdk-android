...
public class TagResourceRequestMarshaller implements Marshaller<Request<TagResourceRequest>, TagResourceRequest> {
    ...
    public Request<TagResourceRequest> marshall(TagResourceRequest tagResourceRequest) {
        ...
        Request<TagResourceRequest> request = new DefaultRequest<TagResourceRequest>(tagResourceRequest, "AWSElementalMediaPackageVOD");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/tags/{resource-arn}";
        uriResourcePath = uriResourcePath.replace("{resource-arn}", (tagResourceRequest.getResourceArn() == null) ? "" : StringUtils.fromString(tagResourceRequest.getResourceArn()));
