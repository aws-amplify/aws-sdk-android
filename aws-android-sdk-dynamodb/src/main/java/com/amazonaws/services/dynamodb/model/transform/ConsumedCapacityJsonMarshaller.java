...
class ConsumedCapacityJsonMarshaller {
    ...
    public void marshall(ConsumedCapacity consumedCapacity, AwsJsonWriter jsonWriter)
        ...
        if (consumedCapacity.getReadCapacityUnits() != null) {
            Double readCapacityUnits = consumedCapacity.getReadCapacityUnits();
            jsonWriter.name("ReadCapacityUnits");
            jsonWriter.value(readCapacityUnits);
        }
        if (consumedCapacity.getWriteCapacityUnits() != null) {
            Double writeCapacityUnits = consumedCapacity.getWriteCapacityUnits();
