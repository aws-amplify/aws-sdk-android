...
public class ReplicaSettingsDescription implements Serializable {
     ...
     * </p>
     *
     * @param replicaBillingModeSummary <p>
     *            The read/write capacity mode of the replica.
     *            </p>
     */
     ...
     *         chained together.
     */
    public ReplicaSettingsDescription withReplicaBillingModeSummary(
    ...
    public String toString() {
        ...
        if (getReplicaBillingModeSummary() != null)
            sb.append("ReplicaBillingModeSummary: " + getReplicaBillingModeSummary() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getReplicaBillingModeSummary() == null) ? 0 : getReplicaBillingModeSummary()
                        .hashCode());
        hashCode = prime
                * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getReplicaStatus() != null
            ...
            return false;
        if (other.getReplicaBillingModeSummary() == null
                ^ this.getReplicaBillingModeSummary() == null)
            return false;
        if (other.getReplicaBillingModeSummary() != null
                && other.getReplicaBillingModeSummary().equals(this.getReplicaBillingModeSummary()) == false)
            return false;
