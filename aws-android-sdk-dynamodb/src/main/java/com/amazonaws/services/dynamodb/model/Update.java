...
public class Update implements Serializable {
     ...
     *         chained together.
     */
    public Update withExpressionAttributeNames(
     ...
     *         chained together.
     */
    public Update withExpressionAttributeValues(
            java.util.Map<String, AttributeValue> expressionAttributeValues) {
        this.expressionAttributeValues = expressionAttributeValues;
        return this;
    }
     ...
     *         item attributes if the <code>Update</code> condition fails. For
     ...
     *            the item attributes if the <code>Update</code> condition
     *            fails. For <code>ReturnValuesOnConditionCheckFailure</code>,
     *            the valid values are: NONE, ALL_OLD, UPDATED_OLD, ALL_NEW,
     *            UPDATED_NEW.
     *            </p>
     * @see ReturnValuesOnConditionCheckFailure
     */
     ...
     * @see ReturnValuesOnConditionCheckFailure
     */
    public Update withReturnValuesOnConditionCheckFailure(
            ReturnValuesOnConditionCheckFailure returnValuesOnConditionCheckFailure) {
        this.returnValuesOnConditionCheckFailure = returnValuesOnConditionCheckFailure.toString();
        return this;
    }
