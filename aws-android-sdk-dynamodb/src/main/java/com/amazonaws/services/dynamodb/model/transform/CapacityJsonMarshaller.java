...
class CapacityJsonMarshaller {
    ...
    public void marshall(Capacity capacity, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (capacity.getReadCapacityUnits() != null) {
            Double readCapacityUnits = capacity.getReadCapacityUnits();
            jsonWriter.name("ReadCapacityUnits");
            jsonWriter.value(readCapacityUnits);
        }
        if (capacity.getWriteCapacityUnits() != null) {
            Double writeCapacityUnits = capacity.getWriteCapacityUnits();
