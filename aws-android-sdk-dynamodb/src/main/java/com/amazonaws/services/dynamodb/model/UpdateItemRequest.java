...
public class UpdateItemRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         item. If any of these attributes already exist, they are replaced
     ...
     *         doesn't have an attribute named <code>itemcount</code>, but you
     *         decide to <code>ADD</code> the number <code>3</code> to this
     *         attribute anyway. DynamoDB will create the <code>itemcount</code>
     *         attribute, set its initial value to <code>0</code>, and finally
     *         add <code>3</code> to it. The result will be a new
     *         <code>itemcount</code> attribute in the item, with a value of
     *         <code>3</code>.
     *         </p>
     *         </note></li>
     ...
     *            updated, the action to be performed on them, and new values
     *            for them.
     *            </p>
     *            <p>
     *            The following action values are available for
     ...
     *            an item. If any of these attributes already exist, they are
     ...
     *            before the update, DynamoDB uses <code>0</code> as the initial
     *            value. For example, suppose that the item you want to update
     *            doesn't have an attribute named <code>itemcount</code>, but
     *            you decide to <code>ADD</code> the number <code>3</code> to
     *            this attribute anyway. DynamoDB will create the
     *            <code>itemcount</code> attribute, set its initial value to
     *            <code>0</code>, and finally add <code>3</code> to it. The
     *            result will be a new <code>itemcount</code> attribute in the
