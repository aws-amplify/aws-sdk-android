...
/**
 * JSON unmarshaller for POJO ConsumedCapacity
 */
class ConsumedCapacityJsonUnmarshaller implements
    ...
    public ConsumedCapacity unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("TableName")) {
                ...
                consumedCapacity.setReadCapacityUnits(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("WriteCapacityUnits")) {
                consumedCapacity.setWriteCapacityUnits(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
