 ...
 * <li>
 * <p>
 * More than one action in the <code>TransactWriteItems</code> operation targets
 * the same item.
 * </p>
 * </li>
 * <li>
 ...
 * requested items, if an item has no error it will have <code>NONE</code> code
 * and <code>Null</code> message.
 * </p>
 * </note>
 * <p>
 ...
 * /latest/developerguide/bp-partition-key-design.html.
 * </p>
 * <note>
 * <p>
 ...
 * <note>
 * <p>
 * This message is returned when when writes get throttled on an On-Demand GSI
 ...
 * </ul>
 */
public class TransactionCanceledException extends AmazonServiceException {
     ...
     * </p>
     *
     * @param cancellationReasons <p>
     *            A list of cancellation reasons.
     *            </p>
     */
    public void setCancellationReasons(java.util.Collection<CancellationReason> cancellationReasons) {
        this.cancellationReasons = cancellationReasons == null ? null
                : new java.util.ArrayList<CancellationReason>(cancellationReasons);
    }
}
