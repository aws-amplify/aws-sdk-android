...
class TableDescriptionJsonMarshaller {
    ...
    public void marshall(TableDescription tableDescription, AwsJsonWriter jsonWriter)
        ...
        if (tableDescription.getBillingModeSummary() != null) {
            BillingModeSummary billingModeSummary = tableDescription.getBillingModeSummary();
            jsonWriter.name("BillingModeSummary");
            BillingModeSummaryJsonMarshaller.getInstance().marshall(billingModeSummary, jsonWriter);
        }
        ...
        if (tableDescription.getGlobalTableVersion() != null) {
            String globalTableVersion = tableDescription.getGlobalTableVersion();
            jsonWriter.name("GlobalTableVersion");
            jsonWriter.value(globalTableVersion);
        }
        if (tableDescription.getReplicas() != null) {
            java.util.List<ReplicaDescription> replicas = tableDescription.getReplicas();
            jsonWriter.name("Replicas");
            jsonWriter.beginArray();
            for (ReplicaDescription replicasItem : replicas) {
                if (replicasItem != null) {
                    ReplicaDescriptionJsonMarshaller.getInstance().marshall(replicasItem,
                            jsonWriter);
                }
            }
            jsonWriter.endArray();
        ...
        if (tableDescription.getArchivalSummary() != null) {
            ArchivalSummary archivalSummary = tableDescription.getArchivalSummary();
            jsonWriter.name("ArchivalSummary");
            ArchivalSummaryJsonMarshaller.getInstance().marshall(archivalSummary, jsonWriter);
        }
