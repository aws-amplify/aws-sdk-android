...
public class SSEDescription implements Serializable {
     ...
     * process when table's AWS KMS key remains inaccessible for more than seven
     * days from this date.
     * </p>
     */
     ...
     *         <li>
     *         <p>
     *         <code>KMS</code> - Server-side encryption that uses AWS Key
     *         Management Service. The key is stored in your account and is
     ...
     *         that the table's AWS KMS key is accessible again. DynamoDB will
     *         initiate the table archival process when table's AWS KMS key
     ...
     * </p>
     *
     * @param inaccessibleEncryptionDateTime <p>
     *            Indicates the time, in UNIX epoch date format, when DynamoDB
     *            detected that the table's AWS KMS key was inaccessible. This
     *            attribute will automatically be cleared when DynamoDB detects
     *            that the table's AWS KMS key is accessible again. DynamoDB
     *            will initiate the table archival process when table's AWS KMS
     *            key remains inaccessible for more than seven days from this
     *            date.
     *            </p>
     */
     ...
     *         chained together.
     */
    public SSEDescription withInaccessibleEncryptionDateTime(
            java.util.Date inaccessibleEncryptionDateTime) {
        this.inaccessibleEncryptionDateTime = inaccessibleEncryptionDateTime;
        return this;
    }
    ...
    public String toString() {
        ...
        if (getInaccessibleEncryptionDateTime() != null)
            sb.append("InaccessibleEncryptionDateTime: " + getInaccessibleEncryptionDateTime());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getInaccessibleEncryptionDateTime() == null) ? 0
                        : getInaccessibleEncryptionDateTime().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getInaccessibleEncryptionDateTime() == null
            ...
            return false;
        if (other.getInaccessibleEncryptionDateTime() != null
                && other.getInaccessibleEncryptionDateTime().equals(
                        this.getInaccessibleEncryptionDateTime()) == false)
            return false;
        return true;
    }
}
