...
public interface AmazonDynamoDB {
     ...
     *             request, or a server side issue.
     */
    DescribeContributorInsightsResult describeContributorInsights(
     ...
     *             request, or a server side issue.
     */
    DescribeTableReplicaAutoScalingResult describeTableReplicaAutoScaling(
     ...
     *             request, or a server side issue.
     */
    ListContributorInsightsResult listContributorInsights(
     ...
     *             request, or a server side issue.
     */
    UpdateContributorInsightsResult updateContributorInsights(
     ...
     *             request, or a server side issue.
     */
    UpdateTableReplicaAutoScalingResult updateTableReplicaAutoScaling(
