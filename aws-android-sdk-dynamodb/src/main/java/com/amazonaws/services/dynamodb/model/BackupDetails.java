...
public class BackupDetails implements Serializable {
     ...
     * <li>
     * <p>
     * <code>USER</code> - You create and manage these using the on-demand
     * backup feature.
     * </p>
     * </li>
     * <li>
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>USER, SYSTEM, AWS_BACKUP
     */
     ...
     *         <li>
     *         <p>
     *         <code>USER</code> - You create and manage these using the
     *         on-demand backup feature.
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     *         <code>SYSTEM</code> - If you delete a table with point-in-time
     *         recovery enabled, a <code>SYSTEM</code> backup is automatically
     *         created and is retained for 35 days (at no additional cost).
     *         System backups allow you to restore the deleted table to the
     *         state it was in just before the point of deletion.
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     *         <code>AWS_BACKUP</code> - On-demand backup created by you from
     *         AWS Backup service.
     *         </p>
     *         </li>
     *         </ul>
     ...
     *            <p>
     *            <code>SYSTEM</code> - If you delete a table with point-in-time
     *            recovery enabled, a <code>SYSTEM</code> backup is
     *            automatically created and is retained for 35 days (at no
     *            additional cost). System backups allow you to restore the
     *            deleted table to the state it was in just before the point of
     *            deletion.
     *            </p>
     *            </li>
     *            <li>
