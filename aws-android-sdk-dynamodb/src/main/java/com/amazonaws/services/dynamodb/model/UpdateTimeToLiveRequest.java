 ...
 * call returns the current <code>TimeToLiveSpecification</code>. It can take up
 * to one hour for the change to fully process. Any additional
 * <code>UpdateTimeToLive</code> calls for the same table during this one hour
 * duration result in a <code>ValidationException</code>.
 * </p>
 * <p>
