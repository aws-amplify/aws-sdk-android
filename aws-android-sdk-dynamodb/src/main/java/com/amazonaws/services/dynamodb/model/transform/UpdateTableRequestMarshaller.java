...
public class UpdateTableRequestMarshaller implements
    ...
    public Request<UpdateTableRequest> marshall(UpdateTableRequest updateTableRequest) {
        ...
        try {
            ...
            if (updateTableRequest.getBillingMode() != null) {
            ...
            if (updateTableRequest.getReplicaUpdates() != null) {
                java.util.List<ReplicationGroupUpdate> replicaUpdates = updateTableRequest
                        .getReplicaUpdates();
                jsonWriter.name("ReplicaUpdates");
                jsonWriter.beginArray();
                for (ReplicationGroupUpdate replicaUpdatesItem : replicaUpdates) {
                    if (replicaUpdatesItem != null) {
                        ReplicationGroupUpdateJsonMarshaller.getInstance().marshall(
