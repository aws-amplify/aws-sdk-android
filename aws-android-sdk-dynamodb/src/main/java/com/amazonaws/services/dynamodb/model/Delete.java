...
public class Delete implements Serializable {
     ...
     *
     * @return <p>
     *         The primary key of the item to be deleted. Each element consists
     ...
     *         chained together.
     */
    public Delete withExpressionAttributeNames(
     ...
     *         chained together.
     */
    public Delete withExpressionAttributeValues(
            java.util.Map<String, AttributeValue> expressionAttributeValues) {
        this.expressionAttributeValues = expressionAttributeValues;
        return this;
    }
     ...
     *         item attributes if the <code>Delete</code> condition fails. For
     ...
     *            the item attributes if the <code>Delete</code> condition
     *            fails. For <code>ReturnValuesOnConditionCheckFailure</code>,
     ...
     * @see ReturnValuesOnConditionCheckFailure
     */
    public Delete withReturnValuesOnConditionCheckFailure(
            ReturnValuesOnConditionCheckFailure returnValuesOnConditionCheckFailure) {
        this.returnValuesOnConditionCheckFailure = returnValuesOnConditionCheckFailure.toString();
        return this;
    }
