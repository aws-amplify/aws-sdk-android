 ...
 * amounts of data, such as from Amazon EMR, or copy data from another database
 ...
 * individual <code>PutItem</code> and <code>DeleteItem</code> calls would. For
 * example, you cannot specify conditions on individual put and delete requests,
...
public class BatchWriteItemRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         are rejected with a <code>ValidationException</code> exception.
     *         </p>
     *         <p>
     ...
     *            contain empty values are rejected with a
     *            <code>ValidationException</code> exception.
     *            </p>
     *            <p>
