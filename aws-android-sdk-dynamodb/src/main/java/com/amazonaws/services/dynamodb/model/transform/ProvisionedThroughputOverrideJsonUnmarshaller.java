...
/**
 * JSON unmarshaller for POJO ProvisionedThroughputOverride
 */
class ProvisionedThroughputOverrideJsonUnmarshaller implements
        Unmarshaller<ProvisionedThroughputOverride, JsonUnmarshallerContext> {
    ...
    public ProvisionedThroughputOverride unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ReadCapacityUnits")) {
                provisionedThroughputOverride.setReadCapacityUnits(LongJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
