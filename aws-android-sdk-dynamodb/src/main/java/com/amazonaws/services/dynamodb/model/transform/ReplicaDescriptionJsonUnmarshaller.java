    ...
    public ReplicaDescription unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RegionName")) {
                ...
                replicaDescription.setReplicaStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ReplicaStatusDescription")) {
                replicaDescription.setReplicaStatusDescription(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ReplicaStatusPercentProgress")) {
                replicaDescription.setReplicaStatusPercentProgress(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("KMSMasterKeyId")) {
                replicaDescription.setKMSMasterKeyId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                replicaDescription
                        .setGlobalSecondaryIndexes(new ListUnmarshaller<ReplicaGlobalSecondaryIndexDescription>(
                                ReplicaGlobalSecondaryIndexDescriptionJsonUnmarshaller
                                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
