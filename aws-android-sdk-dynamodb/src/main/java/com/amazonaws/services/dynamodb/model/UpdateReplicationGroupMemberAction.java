 ...
 * </p>
 */
public class UpdateReplicationGroupMemberAction implements Serializable {
    /**
     * <p>
     ...
     * Name (ARN), alias name, or alias ARN. Note that you should only provide
     ...
     *
     * @return <p>
     *         The AWS KMS customer master key (CMK) of the replica that should
     *         be used for AWS KMS encryption. To specify a CMK, use its key ID,
     *         Amazon Resource Name (ARN), alias name, or alias ARN. Note that
     *         you should only provide this parameter if the key is different
     ...
     *            The AWS KMS customer master key (CMK) of the replica that
     *            should be used for AWS KMS encryption. To specify a CMK, use
     ...
     *         chained together.
     */
    public UpdateReplicationGroupMemberAction withProvisionedThroughputOverride(
            ProvisionedThroughputOverride provisionedThroughputOverride) {
        this.provisionedThroughputOverride = provisionedThroughputOverride;
        return this;
    }
     ...
     *         chained together.
     */
    public UpdateReplicationGroupMemberAction withGlobalSecondaryIndexes(
