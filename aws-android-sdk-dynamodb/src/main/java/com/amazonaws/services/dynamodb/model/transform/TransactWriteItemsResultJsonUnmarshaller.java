...
/**
 * JSON unmarshaller for response TransactWriteItemsResult
 */
public class TransactWriteItemsResultJsonUnmarshaller implements
        Unmarshaller<TransactWriteItemsResult, JsonUnmarshallerContext> {
