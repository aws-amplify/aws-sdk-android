        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AttributeDefinitions")) {
                ...
                tableDescription.setTableId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("BillingModeSummary")) {
                tableDescription.setBillingModeSummary(BillingModeSummaryJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                tableDescription.setLatestStreamArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("GlobalTableVersion")) {
                tableDescription.setGlobalTableVersion(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Replicas")) {
                tableDescription.setReplicas(new ListUnmarshaller<ReplicaDescription>(
                ...
                tableDescription.setSSEDescription(SSEDescriptionJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ArchivalSummary")) {
                tableDescription.setArchivalSummary(ArchivalSummaryJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
