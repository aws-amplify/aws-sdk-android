 ...
 * </p>
 */
public class ReplicaGlobalSecondaryIndex implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         Replica table GSI-specific provisioned throughput. If not
     *         specified, uses the source table GSI's read capacity settings.
     *         </p>
     */
     ...
     *         chained together.
     */
    public ReplicaGlobalSecondaryIndex withProvisionedThroughputOverride(
            ProvisionedThroughputOverride provisionedThroughputOverride) {
        this.provisionedThroughputOverride = provisionedThroughputOverride;
        return this;
    }
