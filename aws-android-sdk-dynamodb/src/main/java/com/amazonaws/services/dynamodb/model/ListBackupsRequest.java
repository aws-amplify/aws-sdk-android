...
public class ListBackupsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * the <code>ExclusiveStartBackupArn</code> of a new
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>USER, SYSTEM, AWS_BACKUP, ALL
     */
     ...
     *
     * @return <p>
     *         <code>LastEvaluatedBackupArn</code> is the Amazon Resource Name
     *         (ARN) of the backup last evaluated when the current page of
     ...
     *            <code>LastEvaluatedBackupArn</code> is the Amazon Resource
     *            Name (ARN) of the backup last evaluated when the current page
     *            of results was returned, inclusive of the current page of
