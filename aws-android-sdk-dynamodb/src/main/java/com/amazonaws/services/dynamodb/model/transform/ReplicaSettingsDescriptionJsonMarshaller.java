...
class ReplicaSettingsDescriptionJsonMarshaller {
    ...
    public void marshall(ReplicaSettingsDescription replicaSettingsDescription,
        ...
        if (replicaSettingsDescription.getReplicaBillingModeSummary() != null) {
            BillingModeSummary replicaBillingModeSummary = replicaSettingsDescription
                    .getReplicaBillingModeSummary();
            jsonWriter.name("ReplicaBillingModeSummary");
            BillingModeSummaryJsonMarshaller.getInstance().marshall(replicaBillingModeSummary,
                    jsonWriter);
        }
