...
public class SSESpecification implements Serializable {
     ...
     * set to <code>KMS</code> and an AWS managed CMK is used (AWS KMS charges
     ...
     * alias name, or alias ARN. Note that you should only provide this
     ...
     *         encryption type is set to <code>KMS</code> and an AWS managed CMK
     *         is used (AWS KMS charges apply). If disabled (false) or not
     ...
     * @param enabled <p>
     *            Indicates whether server-side encryption is done using an AWS
     *            managed CMK or an AWS owned CMK. If enabled (true),
     *            server-side encryption type is set to <code>KMS</code> and an
     *            AWS managed CMK is used (AWS KMS charges apply). If disabled
     *            (false) or not specified, server-side encryption is set to AWS
     *            owned CMK.
     *            </p>
     */
     ...
     *         Resource Name (ARN), alias name, or alias ARN. Note that you
     *         should only provide this parameter if the key is different from
     ...
     *            the AWS KMS encryption. To specify a CMK, use its key ID,
     *            Amazon Resource Name (ARN), alias name, or alias ARN. Note
