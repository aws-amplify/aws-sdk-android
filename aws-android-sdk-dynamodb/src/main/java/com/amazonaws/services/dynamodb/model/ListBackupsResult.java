...
public class ListBackupsResult implements Serializable {
     ...
     *         may not indicate that there is more data to be returned. All
     ...
     *            or may not indicate that there is more data to be returned.
     *            All results are guaranteed to have been returned if and only
     *            if no value for <code>LastEvaluatedBackupArn</code> is
     *            returned.
     *            </p>
     */
