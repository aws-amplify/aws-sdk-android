...
class SSEDescriptionJsonMarshaller {
    ...
    public void marshall(SSEDescription sSEDescription, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (sSEDescription.getInaccessibleEncryptionDateTime() != null) {
            java.util.Date inaccessibleEncryptionDateTime = sSEDescription
                    .getInaccessibleEncryptionDateTime();
            jsonWriter.name("InaccessibleEncryptionDateTime");
            jsonWriter.value(inaccessibleEncryptionDateTime);
        }
