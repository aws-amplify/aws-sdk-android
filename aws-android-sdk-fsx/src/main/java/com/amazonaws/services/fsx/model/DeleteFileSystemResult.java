...
public class DeleteFileSystemResult implements Serializable {
    ...
    public String toString() {
        ...
        if (getLustreResponse() != null)
            sb.append("LustreResponse: " + getLustreResponse());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getLustreResponse() == null) ? 0 : getLustreResponse().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getLustreResponse() == null ^ this.getLustreResponse() == null)
            return false;
        if (other.getLustreResponse() != null
                && other.getLustreResponse().equals(this.getLustreResponse()) == false)
            return false;
        return true;
    }
}
