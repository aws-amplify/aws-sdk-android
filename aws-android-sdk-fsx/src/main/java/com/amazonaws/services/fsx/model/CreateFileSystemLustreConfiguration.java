...
public class CreateFileSystemLustreConfiguration implements Serializable {
     ...
     *
     * @return <p>
     *         Choose <code>SCRATCH_1</code> and <code>SCRATCH_2</code>
     *         deployment types when you need temporary storage and shorter-term
     *         processing of data. The <code>SCRATCH_2</code> deployment type
     *         provides in-transit encryption of data and higher burst
     *         throughput capacity than <code>SCRATCH_1</code>.
     *         </p>
     *         <note>
     *         <p>
     *         This option can only be set for for PERSISTENT_1 deployments
     *         types.
     *         </p>
     *         </note>
     *         <p>
     ...
     *            Choose <code>SCRATCH_1</code> and <code>SCRATCH_2</code>
     *            deployment types when you need temporary storage and
     ...
     *         chained together.
     */
    public CreateFileSystemLustreConfiguration withDailyAutomaticBackupStartTime(
     ...
     *         chained together.
     */
    public CreateFileSystemLustreConfiguration withAutomaticBackupRetentionDays(
