 ...
 * >https://docs.aws.amazon.com/fsx/latest/LustreGuide/lustre-backups.html</a>.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * The <code>CreateBackup</code> operation returns while the backup's lifecycle
 * state is still <code>CREATING</code>. You can check the backup creation
...
public class CreateBackupRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <code>Name</code> tag appears in the console as the backup name. If you
     * have set <code>CopyTagsToBackups</code> to true, and you specify one or
     * more tags using the <code>CreateBackup</code> action, no existing tags on
     * the file system are copied from the file system to the backup.
     * </p>
     */
     ...
     *         name. If you have set <code>CopyTagsToBackups</code> to true, and
     *         you specify one or more tags using the <code>CreateBackup</code>
     *         action, no existing tags on the file system are copied from the
     *         file system to the backup.
     *         </p>
     */
     ...
     *            the backup name. If you have set
     *            <code>CopyTagsToBackups</code> to true, and you specify one or
     *            more tags using the <code>CreateBackup</code> action, no
     *            existing tags on the file system are copied from the file
