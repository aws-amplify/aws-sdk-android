 ...
 * </p>
 */
public class ListImageBuildVersionsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
    ...
    public String toString() {
        ...
        if (getImageVersionArn() != null)
            sb.append("imageVersionArn: " + getImageVersionArn() + ",");
        if (getFilters() != null)
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getImageVersionArn() == null) ? 0 : getImageVersionArn().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getImageVersionArn() == null ^ this.getImageVersionArn() == null)
            return false;
        if (other.getImageVersionArn() != null
                && other.getImageVersionArn().equals(this.getImageVersionArn()) == false)
            return false;
