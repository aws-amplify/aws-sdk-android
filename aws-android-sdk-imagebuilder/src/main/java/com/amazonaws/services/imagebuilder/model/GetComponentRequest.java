 ...
 * </p>
 */
public class GetComponentRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * [a-z0-9-_]+/(?:(?:(\d+|x)\.(\d+|x)\.(\d+|x))|(?:\d+\.\d+\.\d+/\d+))$<br/>
     */
     ...
     *            The Amazon Resource Name (ARN) of the component that you want
