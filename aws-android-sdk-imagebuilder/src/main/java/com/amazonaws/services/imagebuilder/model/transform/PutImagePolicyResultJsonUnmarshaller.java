...
/**
 * JSON unmarshaller for response PutImagePolicyResult
 */
public class PutImagePolicyResultJsonUnmarshaller implements
        Unmarshaller<PutImagePolicyResult, JsonUnmarshallerContext> {
    ...
    public PutImagePolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("requestId")) {
                putImagePolicyResult.setRequestId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("imageArn")) {
                putImagePolicyResult.setImageArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
