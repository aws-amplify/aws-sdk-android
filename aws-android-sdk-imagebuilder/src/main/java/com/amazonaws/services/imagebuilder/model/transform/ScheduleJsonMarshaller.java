...
class ScheduleJsonMarshaller {
    ...
    public void marshall(Schedule schedule, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (schedule.getPipelineExecutionStartCondition() != null) {
            String pipelineExecutionStartCondition = schedule.getPipelineExecutionStartCondition();
            jsonWriter.name("pipelineExecutionStartCondition");
            jsonWriter.value(pipelineExecutionStartCondition);
        }
