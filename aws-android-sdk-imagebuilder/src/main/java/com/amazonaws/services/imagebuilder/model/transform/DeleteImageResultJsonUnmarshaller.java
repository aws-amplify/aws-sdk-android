...
/**
 * JSON unmarshaller for response DeleteImageResult
 */
public class DeleteImageResultJsonUnmarshaller implements
        Unmarshaller<DeleteImageResult, JsonUnmarshallerContext> {
    ...
    public DeleteImageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("requestId")) {
                deleteImageResult.setRequestId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("imageBuildVersionArn")) {
                deleteImageResult.setImageBuildVersionArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
