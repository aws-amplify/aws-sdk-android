...
/**
 * JSON unmarshaller for response GetImageRecipeResult
 */
public class GetImageRecipeResultJsonUnmarshaller implements
        Unmarshaller<GetImageRecipeResult, JsonUnmarshallerContext> {
    ...
    public GetImageRecipeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("requestId")) {
                getImageRecipeResult.setRequestId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("imageRecipe")) {
                getImageRecipeResult.setImageRecipe(ImageRecipeJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
