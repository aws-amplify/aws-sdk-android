...
public class CreateInfrastructureConfigurationRequestMarshaller
    ...
    public Request<CreateInfrastructureConfigurationRequest> marshall(
        ...
        try {
            ...
            if (createInfrastructureConfigurationRequest.getResourceTags() != null) {
                java.util.Map<String, String> resourceTags = createInfrastructureConfigurationRequest
                        .getResourceTags();
                jsonWriter.name("resourceTags");
                jsonWriter.beginObject();
                for (java.util.Map.Entry<String, String> resourceTagsEntry : resourceTags
                        .entrySet()) {
