...
/**
 * JSON unmarshaller for response ImportComponentResult
 */
public class ImportComponentResultJsonUnmarshaller implements
        Unmarshaller<ImportComponentResult, JsonUnmarshallerContext> {
    ...
    public ImportComponentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("requestId")) {
                importComponentResult.setRequestId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("clientToken")) {
                importComponentResult.setClientToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("componentBuildVersionArn")) {
                importComponentResult.setComponentBuildVersionArn(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
