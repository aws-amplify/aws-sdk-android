...
/**
 * JSON unmarshaller for response GetDistributionConfigurationResult
 */
public class GetDistributionConfigurationResultJsonUnmarshaller implements
        Unmarshaller<GetDistributionConfigurationResult, JsonUnmarshallerContext> {

    public GetDistributionConfigurationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("requestId")) {
                getDistributionConfigurationResult.setRequestId(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("distributionConfiguration")) {
                getDistributionConfigurationResult
                        .setDistributionConfiguration(DistributionConfigurationJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
