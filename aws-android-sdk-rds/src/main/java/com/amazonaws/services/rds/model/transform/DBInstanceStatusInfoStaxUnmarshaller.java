...
/**
 * StAX unmarshaller for model DBInstanceStatusInfo
 */
class DBInstanceStatusInfoStaxUnmarshaller implements
        Unmarshaller<DBInstanceStatusInfo, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("StatusType", targetDepth)) {
                    dBInstanceStatusInfo.setStatusType(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Normal", targetDepth)) {
                    dBInstanceStatusInfo.setNormal(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Status", targetDepth)) {
                    dBInstanceStatusInfo.setStatus(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Message", targetDepth)) {
                    dBInstanceStatusInfo.setMessage(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
