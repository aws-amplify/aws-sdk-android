...
/**
 * StAX request marshaller for DescribeDBClusterSnapshotAttributesRequest
 */
    ...
    public Request<DescribeDBClusterSnapshotAttributesRequest> marshall(
        ...
        if (describeDBClusterSnapshotAttributesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeDBClusterSnapshotAttributesRequest)");
        }

        Request<DescribeDBClusterSnapshotAttributesRequest> request = new DefaultRequest<DescribeDBClusterSnapshotAttributesRequest>(
                describeDBClusterSnapshotAttributesRequest, "AmazonRelationalDatabaseService");
        ...
        if (describeDBClusterSnapshotAttributesRequest.getDBClusterSnapshotIdentifier() != null) {
            ...
            String dBClusterSnapshotIdentifier = describeDBClusterSnapshotAttributesRequest
