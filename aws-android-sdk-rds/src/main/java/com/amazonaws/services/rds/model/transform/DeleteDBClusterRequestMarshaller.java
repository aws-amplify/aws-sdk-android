...
/**
 * StAX request marshaller for DeleteDBClusterRequest
 */
    ...
    public Request<DeleteDBClusterRequest> marshall(DeleteDBClusterRequest deleteDBClusterRequest) {
        if (deleteDBClusterRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteDBClusterRequest)");
        }

        Request<DeleteDBClusterRequest> request = new DefaultRequest<DeleteDBClusterRequest>(
                deleteDBClusterRequest, "AmazonRelationalDatabaseService");
        ...
        if (deleteDBClusterRequest.getDBClusterIdentifier() != null) {
            ...
            String dBClusterIdentifier = deleteDBClusterRequest.getDBClusterIdentifier();
        ...
        if (deleteDBClusterRequest.getSkipFinalSnapshot() != null) {
            ...
            Boolean skipFinalSnapshot = deleteDBClusterRequest.getSkipFinalSnapshot();
        ...
        if (deleteDBClusterRequest.getFinalDBSnapshotIdentifier() != null) {
            ...
            String finalDBSnapshotIdentifier = deleteDBClusterRequest
