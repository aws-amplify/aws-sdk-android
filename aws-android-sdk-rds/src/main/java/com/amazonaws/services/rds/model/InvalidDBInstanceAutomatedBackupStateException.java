 ...
 * </p>
 */
public class InvalidDBInstanceAutomatedBackupStateException extends AmazonServiceException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new InvalidDBInstanceAutomatedBackupStateException with the
