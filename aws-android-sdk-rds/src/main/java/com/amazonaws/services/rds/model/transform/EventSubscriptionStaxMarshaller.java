...
class EventSubscriptionStaxMarshaller {
    ...
    public void marshall(EventSubscription _eventSubscription, Request<?> request, String _prefix) {
        ...
        if (_eventSubscription.getSubscriptionCreationTime() != null) {
            ...
            String subscriptionCreationTime = _eventSubscription.getSubscriptionCreationTime();
            request.addParameter(prefix, StringUtils.fromString(subscriptionCreationTime));
        }
        ...
        if (_eventSubscription.getEventSubscriptionArn() != null) {
            prefix = _prefix + "EventSubscriptionArn";
            String eventSubscriptionArn = _eventSubscription.getEventSubscriptionArn();
            request.addParameter(prefix, StringUtils.fromString(eventSubscriptionArn));
        }
    }
