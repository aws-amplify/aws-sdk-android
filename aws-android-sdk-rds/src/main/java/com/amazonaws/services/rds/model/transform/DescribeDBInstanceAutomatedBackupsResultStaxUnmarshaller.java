...
/**
 * StAX unmarshaller for response DescribeDBInstanceAutomatedBackupsResult
 */
public class DescribeDBInstanceAutomatedBackupsResultStaxUnmarshaller implements
    ...
    public DescribeDBInstanceAutomatedBackupsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeDBInstanceAutomatedBackupsResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("DBInstanceAutomatedBackups", targetDepth)) {
                    describeDBInstanceAutomatedBackupsResult
                            .withDBInstanceAutomatedBackups(DBInstanceAutomatedBackupStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
