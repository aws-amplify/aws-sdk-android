...
/**
 * StAX unmarshaller for model DBClusterParameterGroup
 */
class DBClusterParameterGroupStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DBClusterParameterGroupName", targetDepth)) {
                    dBClusterParameterGroup.setDBClusterParameterGroupName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("DBParameterGroupFamily", targetDepth)) {
                    dBClusterParameterGroup.setDBParameterGroupFamily(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Description", targetDepth)) {
                    dBClusterParameterGroup.setDescription(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("DBClusterParameterGroupArn", targetDepth)) {
                    dBClusterParameterGroup.setDBClusterParameterGroupArn(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
