 ...
 * that it can be copied or restored by all AWS accounts.
 * </p>
 * <note>
 * <p>
 * Don't add the <code>all</code> value for any manual DB cluster snapshots that
 ...
 * the <a>DescribeDBClusterSnapshotAttributes</a> API action. The accounts are
