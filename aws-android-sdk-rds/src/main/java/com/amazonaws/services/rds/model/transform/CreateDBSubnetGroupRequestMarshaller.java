...
/**
 * StAX request marshaller for CreateDBSubnetGroupRequest
 */
public class CreateDBSubnetGroupRequestMarshaller implements
        Marshaller<Request<CreateDBSubnetGroupRequest>, CreateDBSubnetGroupRequest> {

    public Request<CreateDBSubnetGroupRequest> marshall(
            CreateDBSubnetGroupRequest createDBSubnetGroupRequest) {
        if (createDBSubnetGroupRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateDBSubnetGroupRequest)");
        }

        Request<CreateDBSubnetGroupRequest> request = new DefaultRequest<CreateDBSubnetGroupRequest>(
                createDBSubnetGroupRequest, "AmazonRelationalDatabaseService");
        ...
        if (createDBSubnetGroupRequest.getDBSubnetGroupName() != null) {
            ...
            String dBSubnetGroupName = createDBSubnetGroupRequest.getDBSubnetGroupName();
        ...
        if (createDBSubnetGroupRequest.getDBSubnetGroupDescription() != null) {
            ...
            String dBSubnetGroupDescription = createDBSubnetGroupRequest
        ...
        if (createDBSubnetGroupRequest.getSubnetIds() != null) {
            prefix = "SubnetIds";
            java.util.List<String> subnetIds = createDBSubnetGroupRequest.getSubnetIds();
        ...
        if (createDBSubnetGroupRequest.getTags() != null) {
            prefix = "Tags";
            java.util.List<Tag> tags = createDBSubnetGroupRequest.getTags();
            int tagsIndex = 1;
