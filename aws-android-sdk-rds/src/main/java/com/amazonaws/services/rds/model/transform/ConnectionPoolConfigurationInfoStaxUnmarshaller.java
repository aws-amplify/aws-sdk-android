...
/**
 * StAX unmarshaller for model ConnectionPoolConfigurationInfo
 */
class ConnectionPoolConfigurationInfoStaxUnmarshaller implements
        Unmarshaller<ConnectionPoolConfigurationInfo, StaxUnmarshallerContext> {

    public ConnectionPoolConfigurationInfo unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("MaxConnectionsPercent", targetDepth)) {
                    connectionPoolConfigurationInfo
                            .setMaxConnectionsPercent(IntegerStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("MaxIdleConnectionsPercent", targetDepth)) {
                    connectionPoolConfigurationInfo
                            .setMaxIdleConnectionsPercent(IntegerStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ConnectionBorrowTimeout", targetDepth)) {
                    connectionPoolConfigurationInfo
                            .setConnectionBorrowTimeout(IntegerStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("SessionPinningFilters/member", targetDepth)) {
                    connectionPoolConfigurationInfo
                            .withSessionPinningFilters(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("InitQuery", targetDepth)) {
                    connectionPoolConfigurationInfo.setInitQuery(StringStaxUnmarshaller
