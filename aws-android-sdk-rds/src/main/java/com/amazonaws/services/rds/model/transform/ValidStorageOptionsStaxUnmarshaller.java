...
/**
 * StAX unmarshaller for model ValidStorageOptions
 */
class ValidStorageOptionsStaxUnmarshaller implements
        Unmarshaller<ValidStorageOptions, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("StorageType", targetDepth)) {
                    validStorageOptions.setStorageType(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("StorageSize", targetDepth)) {
                    validStorageOptions.withStorageSize(RangeStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ProvisionedIops", targetDepth)) {
                    validStorageOptions.withProvisionedIops(RangeStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("IopsToStorageRatio", targetDepth)) {
                    validStorageOptions.withIopsToStorageRatio(DoubleRangeStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("SupportsStorageAutoscaling", targetDepth)) {
                    validStorageOptions.setSupportsStorageAutoscaling(BooleanStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
