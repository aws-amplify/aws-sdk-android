...
/**
 * StAX unmarshaller for response DescribePendingMaintenanceActionsResult
 */
public class DescribePendingMaintenanceActionsResultStaxUnmarshaller implements
        Unmarshaller<DescribePendingMaintenanceActionsResult, StaxUnmarshallerContext> {

    public DescribePendingMaintenanceActionsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("Marker", targetDepth)) {
                    describePendingMaintenanceActionsResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
