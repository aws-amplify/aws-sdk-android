...
/**
 * StAX unmarshaller for model CloudwatchLogsExportConfiguration
 */
class CloudwatchLogsExportConfigurationStaxUnmarshaller implements
        Unmarshaller<CloudwatchLogsExportConfiguration, StaxUnmarshallerContext> {

    public CloudwatchLogsExportConfiguration unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("EnableLogTypes/member", targetDepth)) {
                    cloudwatchLogsExportConfiguration.withEnableLogTypes(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("DisableLogTypes/member", targetDepth)) {
                    cloudwatchLogsExportConfiguration.withDisableLogTypes(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
