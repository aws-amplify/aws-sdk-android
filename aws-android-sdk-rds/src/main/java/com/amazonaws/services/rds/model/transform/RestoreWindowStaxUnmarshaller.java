...
/**
 * StAX unmarshaller for model RestoreWindow
 */
class RestoreWindowStaxUnmarshaller implements Unmarshaller<RestoreWindow, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("EarliestTime", targetDepth)) {
                    restoreWindow.setEarliestTime(DateStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("LatestTime", targetDepth)) {
                    restoreWindow.setLatestTime(DateStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
