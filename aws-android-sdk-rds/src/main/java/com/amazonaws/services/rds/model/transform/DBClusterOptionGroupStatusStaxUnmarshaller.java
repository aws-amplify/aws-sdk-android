...
/**
 * StAX unmarshaller for model DBClusterOptionGroupStatus
 */
class DBClusterOptionGroupStatusStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DBClusterOptionGroupName", targetDepth)) {
                    dBClusterOptionGroupStatus.setDBClusterOptionGroupName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Status", targetDepth)) {
                    dBClusterOptionGroupStatus.setStatus(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
