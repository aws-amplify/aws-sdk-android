...
/**
 * StAX unmarshaller for model ConnectionPoolConfiguration
 */
class ConnectionPoolConfigurationStaxUnmarshaller implements
        Unmarshaller<ConnectionPoolConfiguration, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("MaxConnectionsPercent", targetDepth)) {
                    connectionPoolConfiguration.setMaxConnectionsPercent(IntegerStaxUnmarshaller
                ...
                if (context.testExpression("ConnectionBorrowTimeout", targetDepth)) {
                    connectionPoolConfiguration.setConnectionBorrowTimeout(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("SessionPinningFilters/member", targetDepth)) {
                    connectionPoolConfiguration.withSessionPinningFilters(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("InitQuery", targetDepth)) {
                    connectionPoolConfiguration.setInitQuery(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
