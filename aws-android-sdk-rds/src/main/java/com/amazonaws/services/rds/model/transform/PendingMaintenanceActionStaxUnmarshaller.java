...
/**
 * StAX unmarshaller for model PendingMaintenanceAction
 */
class PendingMaintenanceActionStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Action", targetDepth)) {
                    pendingMaintenanceAction.setAction(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("AutoAppliedAfterDate", targetDepth)) {
                    pendingMaintenanceAction.setAutoAppliedAfterDate(DateStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ForcedApplyDate", targetDepth)) {
                    pendingMaintenanceAction.setForcedApplyDate(DateStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("OptInStatus", targetDepth)) {
                    pendingMaintenanceAction.setOptInStatus(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("CurrentApplyDate", targetDepth)) {
                    pendingMaintenanceAction.setCurrentApplyDate(DateStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Description", targetDepth)) {
                    pendingMaintenanceAction.setDescription(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
