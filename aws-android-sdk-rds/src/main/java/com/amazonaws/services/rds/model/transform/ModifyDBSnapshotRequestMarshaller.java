...
/**
 * StAX request marshaller for ModifyDBSnapshotRequest
 */
public class ModifyDBSnapshotRequestMarshaller implements
        Marshaller<Request<ModifyDBSnapshotRequest>, ModifyDBSnapshotRequest> {
    ...
    public Request<ModifyDBSnapshotRequest> marshall(ModifyDBSnapshotRequest modifyDBSnapshotRequest) {
        if (modifyDBSnapshotRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ModifyDBSnapshotRequest)");
        }

        Request<ModifyDBSnapshotRequest> request = new DefaultRequest<ModifyDBSnapshotRequest>(
                modifyDBSnapshotRequest, "AmazonRelationalDatabaseService");
        ...
        if (modifyDBSnapshotRequest.getDBSnapshotIdentifier() != null) {
            ...
            String dBSnapshotIdentifier = modifyDBSnapshotRequest.getDBSnapshotIdentifier();
        ...
        if (modifyDBSnapshotRequest.getEngineVersion() != null) {
            ...
            String engineVersion = modifyDBSnapshotRequest.getEngineVersion();
        ...
        if (modifyDBSnapshotRequest.getOptionGroupName() != null) {
            ...
            String optionGroupName = modifyDBSnapshotRequest.getOptionGroupName();
