...
/**
 * StAX unmarshaller for model VpnDetails
 */
class VpnDetailsStaxUnmarshaller implements Unmarshaller<VpnDetails, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("VpnTunnelOriginatorIP", targetDepth)) {
                    vpnDetails.setVpnTunnelOriginatorIP(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("VpnGatewayIp", targetDepth)) {
                    vpnDetails.setVpnGatewayIp(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                ...
                if (context.testExpression("VpnState", targetDepth)) {
                    vpnDetails
                            .setVpnState(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
