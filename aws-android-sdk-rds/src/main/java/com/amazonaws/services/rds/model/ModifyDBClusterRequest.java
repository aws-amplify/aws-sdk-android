...
public class ModifyDBClusterRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * from this cluster to the primary cluster in an Aurora global database.
     * The resulting changes are replicated back to this cluster. This parameter
     * only applies to DB clusters that are secondary clusters in an Aurora
     * global database. By default, Aurora disallows write operations for
     * secondary clusters.
     * </p>
     */
     ...
     *         <note>
     *         <p>
     *         Currently, Backtrack is only supported for Aurora MySQL DB
     *         clusters.
     *         </p>
     *         </note>
     *         <p>
     ...
     *         global database. The resulting changes are replicated back to
     *         this cluster. This parameter only applies to DB clusters that are
     *         secondary clusters in an Aurora global database. By default,
     ...
     * </p>
     *
     * @param enableGlobalWriteForwarding <p>
     *            A value that indicates whether to enable write operations to
     *            be forwarded from this cluster to the primary cluster in an
     *            Aurora global database. The resulting changes are replicated
     *            back to this cluster. This parameter only applies to DB
     *            clusters that are secondary clusters in an Aurora global
     *            database. By default, Aurora disallows write operations for
     *            secondary clusters.
     *            </p>
     */
     ...
     *         chained together.
     */
    public ModifyDBClusterRequest withEnableGlobalWriteForwarding(
    ...
    public String toString() {
        ...
        if (getEnableGlobalWriteForwarding() != null)
            sb.append("EnableGlobalWriteForwarding: " + getEnableGlobalWriteForwarding());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getEnableGlobalWriteForwarding() == null) ? 0
                        : getEnableGlobalWriteForwarding().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCopyTagsToSnapshot() != null
            ...
            return false;
        if (other.getEnableGlobalWriteForwarding() == null
                ^ this.getEnableGlobalWriteForwarding() == null)
            return false;
        if (other.getEnableGlobalWriteForwarding() != null
                && other.getEnableGlobalWriteForwarding().equals(
                        this.getEnableGlobalWriteForwarding()) == false)
            return false;
        return true;
    }
}
