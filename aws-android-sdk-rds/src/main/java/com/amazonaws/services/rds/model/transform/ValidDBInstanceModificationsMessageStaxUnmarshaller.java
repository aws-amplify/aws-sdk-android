...
/**
 * StAX unmarshaller for model ValidDBInstanceModificationsMessage
 */
class ValidDBInstanceModificationsMessageStaxUnmarshaller implements
        Unmarshaller<ValidDBInstanceModificationsMessage, StaxUnmarshallerContext> {

    public ValidDBInstanceModificationsMessage unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Storage", targetDepth)) {
                    validDBInstanceModificationsMessage
                            .withStorage(ValidStorageOptionsStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ValidProcessorFeatures", targetDepth)) {
                    validDBInstanceModificationsMessage
                            .withValidProcessorFeatures(AvailableProcessorFeatureStaxUnmarshaller
