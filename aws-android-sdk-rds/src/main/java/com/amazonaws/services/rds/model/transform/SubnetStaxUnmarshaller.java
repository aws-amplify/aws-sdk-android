...
/**
 * StAX unmarshaller for model Subnet
 */
class SubnetStaxUnmarshaller implements Unmarshaller<Subnet, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("SubnetIdentifier", targetDepth)) {
                    subnet.setSubnetIdentifier(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("SubnetAvailabilityZone", targetDepth)) {
                    subnet.setSubnetAvailabilityZone(AvailabilityZoneStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
