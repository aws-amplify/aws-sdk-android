...
/**
 * StAX unmarshaller for model PendingCloudwatchLogsExports
 */
class PendingCloudwatchLogsExportsStaxUnmarshaller implements
        Unmarshaller<PendingCloudwatchLogsExports, StaxUnmarshallerContext> {

    public PendingCloudwatchLogsExports unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("LogTypesToEnable/member", targetDepth)) {
                    pendingCloudwatchLogsExports.withLogTypesToEnable(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("LogTypesToDisable/member", targetDepth)) {
                    pendingCloudwatchLogsExports.withLogTypesToDisable(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
