...
/**
 * StAX unmarshaller for model AccountQuota
 */
class AccountQuotaStaxUnmarshaller implements Unmarshaller<AccountQuota, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("AccountQuotaName", targetDepth)) {
                    accountQuota.setAccountQuotaName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
