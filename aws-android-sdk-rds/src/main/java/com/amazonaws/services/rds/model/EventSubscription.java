...
public class EventSubscription implements Serializable {
     ...
     *            A list of source IDs for the RDS event notification
     *            subscription.
     *            </p>
     */
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getEventSubscriptionArn() == null) ? 0 : getEventSubscriptionArn().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getEventSubscriptionArn() != null
                && other.getEventSubscriptionArn().equals(this.getEventSubscriptionArn()) == false)
            return false;
        return true;
    }
}
