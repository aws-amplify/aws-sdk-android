...
/**
 * StAX unmarshaller for model ScalingConfigurationInfo
 */
class ScalingConfigurationInfoStaxUnmarshaller implements
        Unmarshaller<ScalingConfigurationInfo, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("MinCapacity", targetDepth)) {
                    scalingConfigurationInfo.setMinCapacity(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("MaxCapacity", targetDepth)) {
                    scalingConfigurationInfo.setMaxCapacity(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("AutoPause", targetDepth)) {
                    scalingConfigurationInfo.setAutoPause(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("SecondsUntilAutoPause", targetDepth)) {
                    scalingConfigurationInfo.setSecondsUntilAutoPause(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("TimeoutAction", targetDepth)) {
                    scalingConfigurationInfo.setTimeoutAction(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
