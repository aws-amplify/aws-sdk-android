...
/**
 * StAX unmarshaller for response DescribeDBClusterBacktracksResult
 */
public class DescribeDBClusterBacktracksResultStaxUnmarshaller implements
        Unmarshaller<DescribeDBClusterBacktracksResult, StaxUnmarshallerContext> {

    public DescribeDBClusterBacktracksResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeDBClusterBacktracksResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("DBClusterBacktracks", targetDepth)) {
                    describeDBClusterBacktracksResult
                            .withDBClusterBacktracks(DBClusterBacktrackStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
