...
/**
 * StAX unmarshaller for response DescribeOrderableDBInstanceOptionsResult
 */
public class DescribeOrderableDBInstanceOptionsResultStaxUnmarshaller implements
    ...
    public DescribeOrderableDBInstanceOptionsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("OrderableDBInstanceOptions", targetDepth)) {
                    describeOrderableDBInstanceOptionsResult
                            .withOrderableDBInstanceOptions(OrderableDBInstanceOptionStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Marker", targetDepth)) {
                    describeOrderableDBInstanceOptionsResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
