...
/**
 * StAX request marshaller for PromoteReadReplicaRequest
 */
public class PromoteReadReplicaRequestMarshaller implements
    ...
    public Request<PromoteReadReplicaRequest> marshall(
        ...
        if (promoteReadReplicaRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(PromoteReadReplicaRequest)");
        }

        Request<PromoteReadReplicaRequest> request = new DefaultRequest<PromoteReadReplicaRequest>(
                promoteReadReplicaRequest, "AmazonRelationalDatabaseService");
        ...
        if (promoteReadReplicaRequest.getDBInstanceIdentifier() != null) {
            ...
            String dBInstanceIdentifier = promoteReadReplicaRequest.getDBInstanceIdentifier();
        ...
        if (promoteReadReplicaRequest.getBackupRetentionPeriod() != null) {
            ...
            Integer backupRetentionPeriod = promoteReadReplicaRequest.getBackupRetentionPeriod();
        ...
        if (promoteReadReplicaRequest.getPreferredBackupWindow() != null) {
            ...
            String preferredBackupWindow = promoteReadReplicaRequest.getPreferredBackupWindow();
