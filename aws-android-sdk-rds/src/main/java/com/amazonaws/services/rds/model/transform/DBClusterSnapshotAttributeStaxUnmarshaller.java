...
/**
 * StAX unmarshaller for model DBClusterSnapshotAttribute
 */
class DBClusterSnapshotAttributeStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("AttributeName", targetDepth)) {
                    dBClusterSnapshotAttribute.setAttributeName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("AttributeValues", targetDepth)) {
                    dBClusterSnapshotAttribute.withAttributeValues(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
