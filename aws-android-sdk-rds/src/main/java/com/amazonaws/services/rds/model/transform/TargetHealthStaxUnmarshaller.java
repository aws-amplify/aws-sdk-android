...
/**
 * StAX unmarshaller for model TargetHealth
 */
class TargetHealthStaxUnmarshaller implements Unmarshaller<TargetHealth, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("Reason", targetDepth)) {
                    targetHealth
                            .setReason(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Description", targetDepth)) {
                    targetHealth.setDescription(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
