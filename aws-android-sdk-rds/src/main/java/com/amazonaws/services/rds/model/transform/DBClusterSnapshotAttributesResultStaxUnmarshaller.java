...
/**
 * StAX unmarshaller for model DBClusterSnapshotAttributesResult
 */
class DBClusterSnapshotAttributesResultStaxUnmarshaller implements
        Unmarshaller<DBClusterSnapshotAttributesResult, StaxUnmarshallerContext> {

    public DBClusterSnapshotAttributesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DBClusterSnapshotIdentifier", targetDepth)) {
                    dBClusterSnapshotAttributesResult
                            .setDBClusterSnapshotIdentifier(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("DBClusterSnapshotAttributes", targetDepth)) {
                    dBClusterSnapshotAttributesResult
                            .withDBClusterSnapshotAttributes(DBClusterSnapshotAttributeStaxUnmarshaller
