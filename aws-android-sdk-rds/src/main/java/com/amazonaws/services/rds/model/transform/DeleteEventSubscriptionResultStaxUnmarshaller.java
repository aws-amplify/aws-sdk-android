...
/**
 * StAX unmarshaller for response DeleteEventSubscriptionResult
 */
public class DeleteEventSubscriptionResultStaxUnmarshaller implements
        Unmarshaller<DeleteEventSubscriptionResult, StaxUnmarshallerContext> {

    public DeleteEventSubscriptionResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
