...
/**
 * StAX unmarshaller for model GlobalClusterMember
 */
class GlobalClusterMemberStaxUnmarshaller implements
        Unmarshaller<GlobalClusterMember, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DBClusterArn", targetDepth)) {
                    globalClusterMember.setDBClusterArn(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Readers/member", targetDepth)) {
                    globalClusterMember.withReaders(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("IsWriter", targetDepth)) {
                    globalClusterMember.setIsWriter(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("GlobalWriteForwardingStatus", targetDepth)) {
                    globalClusterMember.setGlobalWriteForwardingStatus(StringStaxUnmarshaller
