...
public class ListServicesRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @param nextToken <p>
     *            For the first <code>ListServices</code> request, omit this
     *            value.
     *            </p>
     *            <p>
     ...
     *
     * @return <p>
     *         The maximum number of services that you want AWS Cloud Map to
     *         return in the response to a <code>ListServices</code> request. If
     *         you don't specify a value for <code>MaxResults</code>, AWS Cloud
     ...
     * @param maxResults <p>
     *            The maximum number of services that you want AWS Cloud Map to
     *            return in the response to a <code>ListServices</code> request.
     ...
     *         filters to be returned by <code>ListServices</code>.
     *         </p>
     */
     ...
     *            all filters to be returned by <code>ListServices</code>.
     *            </p>
     */
    ...
    public ListServicesRequest withFilters(ServiceFilter... filters) {
        if (getFilters() == null) {
            this.filters = new java.util.ArrayList<ServiceFilter>(filters.length);
        }
        for (ServiceFilter value : filters) {
