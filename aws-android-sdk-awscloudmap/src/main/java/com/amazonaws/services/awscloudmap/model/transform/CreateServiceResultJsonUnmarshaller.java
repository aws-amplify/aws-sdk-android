...
/**
 * JSON unmarshaller for response CreateServiceResult
 */
public class CreateServiceResultJsonUnmarshaller implements
        Unmarshaller<CreateServiceResult, JsonUnmarshallerContext> {
    ...
    public CreateServiceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Service")) {
                createServiceResult.setService(ServiceJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
