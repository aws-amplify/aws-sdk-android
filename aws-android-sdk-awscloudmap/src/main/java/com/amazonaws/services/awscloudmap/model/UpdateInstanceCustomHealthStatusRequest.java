 ...
 * <code>HealthCheckCustomConfig</code> when you create a service. You can't use
 ...
 * </p>
 */
public class UpdateInstanceCustomHealthStatusRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         The ID of the service that includes the configuration for the
     ...
     *
     * @param instanceId <p>
     *            The ID of the instance that you want to change the health
     *            status for.
     *            </p>
     */
