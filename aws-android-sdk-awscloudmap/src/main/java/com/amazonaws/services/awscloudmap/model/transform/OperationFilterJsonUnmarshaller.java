...
/**
 * JSON unmarshaller for POJO OperationFilter
 */
class OperationFilterJsonUnmarshaller implements
        Unmarshaller<OperationFilter, JsonUnmarshallerContext> {
    ...
    public OperationFilter unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                operationFilter.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Values")) {
                operationFilter.setValues(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Condition")) {
                operationFilter.setCondition(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
