...
public class ListOperationsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         For the first <code>ListOperations</code> request, omit this
     *         value.
     *         </p>
     *         <p>
     *         If the response contains <code>NextToken</code>, submit another
     *         <code>ListOperations</code> request to get the next group of
     *         results. Specify the value of <code>NextToken</code> from the
     *         previous response in the next request.
     *         </p>
     *         <note>
     *         <p>
     *         AWS Cloud Map gets <code>MaxResults</code> operations and then
     *         filters them based on the specified criteria. It's possible that
     *         no operations in the first <code>MaxResults</code> operations
     *         matched the specified criteria but that subsequent groups of
     *         <code>MaxResults</code> operations do contain operations that
     *         match the criteria.
     *         </p>
     *         </note>
     */
     ...
     *            another <code>ListOperations</code> request to get the next
     ...
     *            that no operations in the first <code>MaxResults</code>
     *            operations matched the specified criteria but that subsequent
     *            groups of <code>MaxResults</code> operations do contain
     ...
     *
     * @return <p>
     *         The maximum number of items that you want AWS Cloud Map to return
     *         in the response to a <code>ListOperations</code> request. If you
     *         don't specify a value for <code>MaxResults</code>, AWS Cloud Map
     ...
     *
     * @param maxResults <p>
     *            The maximum number of items that you want AWS Cloud Map to
     *            return in the response to a <code>ListOperations</code>
     ...
     *
     * @return <p>
     *         A complex type that contains specifications for the operations
     *         that you want to list, for example, operations that you started
     *         between a specified start date and end date.
     *         </p>
     *         <p>
     *         If you specify more than one filter, an operation must match all
     *         filters to be returned by <code>ListOperations</code>.
     *         </p>
     */
     ...
     * @param filters <p>
     *            A complex type that contains specifications for the operations
     *            that you want to list, for example, operations that you
     *            started between a specified start date and end date.
     *            </p>
     *            <p>
     *            If you specify more than one filter, an operation must match
     *            all filters to be returned by <code>ListOperations</code>.
     *            </p>
     */
    ...
    public ListOperationsRequest withFilters(OperationFilter... filters) {
        if (getFilters() == null) {
            this.filters = new java.util.ArrayList<OperationFilter>(filters.length);
        }
        for (OperationFilter value : filters) {
