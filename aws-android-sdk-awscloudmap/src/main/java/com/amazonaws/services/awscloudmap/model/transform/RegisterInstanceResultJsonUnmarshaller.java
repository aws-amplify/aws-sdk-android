...
/**
 * JSON unmarshaller for response RegisterInstanceResult
 */
public class RegisterInstanceResultJsonUnmarshaller implements
        Unmarshaller<RegisterInstanceResult, JsonUnmarshallerContext> {
    ...
    public RegisterInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("OperationId")) {
                registerInstanceResult.setOperationId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
