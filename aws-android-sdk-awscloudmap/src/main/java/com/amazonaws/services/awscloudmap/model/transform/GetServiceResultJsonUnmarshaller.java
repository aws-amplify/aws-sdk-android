...
/**
 * JSON unmarshaller for response GetServiceResult
 */
public class GetServiceResultJsonUnmarshaller implements
        Unmarshaller<GetServiceResult, JsonUnmarshallerContext> {
    ...
    public GetServiceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Service")) {
                getServiceResult.setService(ServiceJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
