...
package com.amazonaws.services.awscloudmap;
...
import com.amazonaws.services.awscloudmap.model.transform.*;
...
public class AWSCloudMapClient extends AmazonWebServiceClient implements AWSCloudMap {
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/awscloudmap/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/awscloudmap/request.handler2s"));
    }
