 ...
 * </p>
 */
public class CreatePrivateDnsNamespaceRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         The name that you want to assign to this namespace. When you
     *         create a private DNS namespace, AWS Cloud Map automatically
     *         creates an Amazon Route 53 private hosted zone that has the same
     ...
     *         failed <code>CreatePrivateDnsNamespace</code> requests to be
     ...
     *
     * @param vpc <p>
     *            The ID of the Amazon VPC that you want to associate the
     *            namespace with.
     *            </p>
     */
