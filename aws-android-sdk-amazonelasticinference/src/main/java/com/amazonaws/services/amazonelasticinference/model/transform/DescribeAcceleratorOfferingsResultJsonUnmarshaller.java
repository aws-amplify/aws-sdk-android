...
/**
 * JSON unmarshaller for response DescribeAcceleratorOfferingsResult
 */
public class DescribeAcceleratorOfferingsResultJsonUnmarshaller implements
        Unmarshaller<DescribeAcceleratorOfferingsResult, JsonUnmarshallerContext> {

    public DescribeAcceleratorOfferingsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("acceleratorTypeOfferings")) {
                describeAcceleratorOfferingsResult
                        .setAcceleratorTypeOfferings(new ListUnmarshaller<AcceleratorTypeOffering>(
