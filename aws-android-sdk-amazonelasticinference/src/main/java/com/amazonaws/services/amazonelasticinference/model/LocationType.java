...
public enum LocationType {
    ...
    private static final Map<String, LocationType> enumMap;
    static {
        enumMap = new HashMap<String, LocationType>();
        enumMap.put("region", Region);
        enumMap.put("availability-zone", AvailabilityZone);
        enumMap.put("availability-zone-id", AvailabilityZoneId);
    }
