...
/**
 * JSON request marshaller for DescribeChangeSetRequest
 */
public class DescribeChangeSetRequestMarshaller implements
    ...
    public Request<DescribeChangeSetRequest> marshall(
        ...
        Request<DescribeChangeSetRequest> request = new DefaultRequest<DescribeChangeSetRequest>(
                describeChangeSetRequest, "AWSMarketplaceCatalogService");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/DescribeChangeSet";
        if (describeChangeSetRequest.getCatalog() != null) {
            request.addParameter("catalog",
                    StringUtils.fromString(describeChangeSetRequest.getCatalog()));
        }
        if (describeChangeSetRequest.getChangeSetId() != null) {
            request.addParameter("changeSetId",
                    StringUtils.fromString(describeChangeSetRequest.getChangeSetId()));
        }
