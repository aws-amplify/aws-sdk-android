...
/**
 * JSON unmarshaller for POJO Change
 */
class ChangeJsonUnmarshaller implements Unmarshaller<Change, JsonUnmarshallerContext> {
    ...
    public Change unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ChangeType")) {
                change.setChangeType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Entity")) {
                change.setEntity(EntityJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Details")) {
                change.setDetails(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
