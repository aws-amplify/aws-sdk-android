...
/**
 * StAX unmarshaller for model Export
 */
class ExportStaxUnmarshaller implements Unmarshaller<Export, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ExportingStackId", targetDepth)) {
                    export.setExportingStackId(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
