...
/**
 * StAX unmarshaller for response EstimateTemplateCostResult
 */
public class EstimateTemplateCostResultStaxUnmarshaller implements
        Unmarshaller<EstimateTemplateCostResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Url", targetDepth)) {
                    estimateTemplateCostResult.setUrl(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
