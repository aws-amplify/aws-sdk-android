...
/**
 * StAX unmarshaller for response CreateStackInstancesResult
 */
public class CreateStackInstancesResultStaxUnmarshaller implements
        Unmarshaller<CreateStackInstancesResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("OperationId", targetDepth)) {
                    createStackInstancesResult.setOperationId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
