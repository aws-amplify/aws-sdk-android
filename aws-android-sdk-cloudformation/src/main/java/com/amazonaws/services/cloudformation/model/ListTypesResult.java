...
public class ListTypesResult implements Serializable {
    /**
     * <p>
     * A list of <code>TypeSummary</code> structures that contain information
     * about the specified types.
     * </p>
     */
    private java.util.List<TypeSummary> typeSummaries;
     ...
     *
     * @return <p>
     *         A list of <code>TypeSummary</code> structures that contain
     *         information about the specified types.
     *         </p>
     */
    ...
    public void setTypeSummaries(java.util.Collection<TypeSummary> typeSummaries) {
        ...
        this.typeSummaries = new java.util.ArrayList<TypeSummary>(typeSummaries);
    }
    ...
    public ListTypesResult withTypeSummaries(TypeSummary... typeSummaries) {
        if (getTypeSummaries() == null) {
            this.typeSummaries = new java.util.ArrayList<TypeSummary>(typeSummaries.length);
        }
        for (TypeSummary value : typeSummaries) {
            this.typeSummaries.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getTypeSummaries() != null)
            sb.append("TypeSummaries: " + getTypeSummaries() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getTypeSummaries() == null) ? 0 : getTypeSummaries().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTypeSummaries() == null ^ this.getTypeSummaries() == null)
            return false;
        if (other.getTypeSummaries() != null
                && other.getTypeSummaries().equals(this.getTypeSummaries()) == false)
            return false;
