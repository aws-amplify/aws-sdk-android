...
/**
 * StAX unmarshaller for model ResourceTargetDefinition
 */
class ResourceTargetDefinitionStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Attribute", targetDepth)) {
                    resourceTargetDefinition.setAttribute(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Name", targetDepth)) {
                    resourceTargetDefinition.setName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("RequiresRecreation", targetDepth)) {
                    resourceTargetDefinition.setRequiresRecreation(StringStaxUnmarshaller
