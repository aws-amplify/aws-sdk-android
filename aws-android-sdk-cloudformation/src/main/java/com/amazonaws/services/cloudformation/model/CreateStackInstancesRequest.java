 ...
 * </p>
 */
public class CreateStackInstancesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * the stack set; to add or delete a parameter itself, use <a href=
     ...
     *
     * @return <p>
     *         The name or unique ID of the stack set that you want to create
     *         stack instances from.
     *         </p>
     */
     ...
     *         AWS accounts that you want to create stack instances in the
     ...
     *            more AWS accounts that you want to create stack instances in
     ...
     *         accounts for which to create stack instances in the specified
     *         Regions.
     *         </p>
     *         <p>
     *         You can specify <code>Accounts</code> or
     ...
     *            Organizations accounts for which to create stack instances in
     ...
     *
     * @param regions <p>
     *            The names of one or more Regions where you want to create
     *            stack instances using the specified AWS account(s).
     *            </p>
     */
     ...
     *
     * @return <p>
     *         A list of stack set parameters whose values you want to override
     ...
     *            A list of stack set parameters whose values you want to
     ...
     *         chained together.
     */
    public CreateStackInstancesRequest withParameterOverrides(
     ...
     *         chained together.
     */
    public CreateStackInstancesRequest withOperationPreferences(
