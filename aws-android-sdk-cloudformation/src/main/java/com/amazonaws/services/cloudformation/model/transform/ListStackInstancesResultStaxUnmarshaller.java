...
/**
 * StAX unmarshaller for response ListStackInstancesResult
 */
public class ListStackInstancesResultStaxUnmarshaller implements
        Unmarshaller<ListStackInstancesResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Summaries/member", targetDepth)) {
                    listStackInstancesResult.withSummaries(StackInstanceSummaryStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    listStackInstancesResult.setNextToken(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
