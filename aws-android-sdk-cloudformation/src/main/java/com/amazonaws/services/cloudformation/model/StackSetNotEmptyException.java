 ...
 * stack instances. Delete all stack instances from the stack set before
 * deleting the stack set.
 * </p>
 */
public class StackSetNotEmptyException extends AmazonServiceException {
