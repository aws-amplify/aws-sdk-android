        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ParameterKey", targetDepth)) {
                    parameter.setParameterKey(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                ...
                if (context.testExpression("UsePreviousValue", targetDepth)) {
                    parameter.setUsePreviousValue(BooleanStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("ResolvedValue", targetDepth)) {
                    parameter.setResolvedValue(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
