...
/**
 * StAX unmarshaller for response ListTypesResult
 */
public class ListTypesResultStaxUnmarshaller implements
        Unmarshaller<ListTypesResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("TypeSummaries/member", targetDepth)) {
                    listTypesResult.withTypeSummaries(TypeSummaryStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    listTypesResult.setNextToken(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
