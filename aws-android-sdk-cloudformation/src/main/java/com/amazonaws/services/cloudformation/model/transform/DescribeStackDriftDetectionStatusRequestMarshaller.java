...
/**
 * StAX request marshaller for DescribeStackDriftDetectionStatusRequest
 */
public class DescribeStackDriftDetectionStatusRequestMarshaller
    ...
    public Request<DescribeStackDriftDetectionStatusRequest> marshall(
        ...
        if (describeStackDriftDetectionStatusRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeStackDriftDetectionStatusRequest)");
        }

        Request<DescribeStackDriftDetectionStatusRequest> request = new DefaultRequest<DescribeStackDriftDetectionStatusRequest>(
                describeStackDriftDetectionStatusRequest, "AWSCloudFormation");
        ...
        if (describeStackDriftDetectionStatusRequest.getStackDriftDetectionId() != null) {
            prefix = "StackDriftDetectionId";
            String stackDriftDetectionId = describeStackDriftDetectionStatusRequest
                    .getStackDriftDetectionId();
            request.addParameter(prefix, StringUtils.fromString(stackDriftDetectionId));
        }
