...
/**
 * StAX unmarshaller for response DescribeStackResourcesResult
 */
public class DescribeStackResourcesResultStaxUnmarshaller implements
    ...
    public DescribeStackResourcesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("StackResources/member", targetDepth)) {
                    describeStackResourcesResult.withStackResources(StackResourceStaxUnmarshaller
