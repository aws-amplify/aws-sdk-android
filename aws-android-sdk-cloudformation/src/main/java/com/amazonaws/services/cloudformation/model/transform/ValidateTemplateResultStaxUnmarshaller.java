...
/**
 * StAX unmarshaller for response ValidateTemplateResult
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Parameters/member", targetDepth)) {
                    validateTemplateResult.withParameters(TemplateParameterStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Description", targetDepth)) {
                    validateTemplateResult.setDescription(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Capabilities/member", targetDepth)) {
                    validateTemplateResult.withCapabilities(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("CapabilitiesReason", targetDepth)) {
                    validateTemplateResult.setCapabilitiesReason(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("DeclaredTransforms/member", targetDepth)) {
                    validateTemplateResult.withDeclaredTransforms(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
