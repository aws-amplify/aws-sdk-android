...
/**
 * StAX unmarshaller for model ParameterConstraints
 */
class ParameterConstraintsStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("AllowedValues/member", targetDepth)) {
                    parameterConstraints.withAllowedValues(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
