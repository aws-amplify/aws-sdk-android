...
public class ListStackSetOperationResultsResult implements Serializable {
    /**
     * <p>
     * A list of <code>StackSetOperationResultSummary</code> structures that
     * contain information about the specified operation results, for accounts
     * and Regions that are included in the operation.
     * </p>
     */
    private java.util.List<StackSetOperationResultSummary> summaries;
     ...
     *
     * @return <p>
     *         A list of <code>StackSetOperationResultSummary</code> structures
     *         that contain information about the specified operation results,
     *         for accounts and Regions that are included in the operation.
     *         </p>
     */
     ...
     *
     * @param summaries <p>
     *            A list of <code>StackSetOperationResultSummary</code>
     *            structures that contain information about the specified
     *            operation results, for accounts and Regions that are included
     *            in the operation.
     *            </p>
     */
    public void setSummaries(java.util.Collection<StackSetOperationResultSummary> summaries) {
        ...
        this.summaries = new java.util.ArrayList<StackSetOperationResultSummary>(summaries);
    }
     ...
     *         chained together.
     */
    public ListStackSetOperationResultsResult withSummaries(
            StackSetOperationResultSummary... summaries) {
        if (getSummaries() == null) {
            this.summaries = new java.util.ArrayList<StackSetOperationResultSummary>(
                    summaries.length);
        }
        for (StackSetOperationResultSummary value : summaries) {
     ...
     */
    public ListStackSetOperationResultsResult withSummaries(
            java.util.Collection<StackSetOperationResultSummary> summaries) {
