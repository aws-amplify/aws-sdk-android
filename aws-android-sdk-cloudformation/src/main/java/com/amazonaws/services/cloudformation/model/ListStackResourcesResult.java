...
public class ListStackResourcesResult implements Serializable {
     ...
     * </p>
     *
     * @param stackResourceSummaries <p>
     *            A list of <code>StackResourceSummary</code> structures.
     *            </p>
     */
    public void setStackResourceSummaries(
        ...
        this.stackResourceSummaries = new java.util.ArrayList<StackResourceSummary>(
    ...
    public ListStackResourcesResult withStackResourceSummaries(
        ...
        for (StackResourceSummary value : stackResourceSummaries) {
            this.stackResourceSummaries.add(value);
        }
        return this;
    }
     ...
     * @param nextToken <p>
     *            If the output exceeds 1 MB, a string that identifies the next
     *            page of stack resources. If no additional page exists, this
     *            value is null.
     *            </p>
     */
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getStackResourceSummaries() == null) ? 0 : getStackResourceSummaries()
                        .hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getStackResourceSummaries() != null
                && other.getStackResourceSummaries().equals(this.getStackResourceSummaries()) == false)
            return false;
