...
/**
 * StAX unmarshaller for model ResourceChangeDetail
 */
class ResourceChangeDetailStaxUnmarshaller implements
        Unmarshaller<ResourceChangeDetail, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Target", targetDepth)) {
                    resourceChangeDetail.setTarget(ResourceTargetDefinitionStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Evaluation", targetDepth)) {
                    resourceChangeDetail.setEvaluation(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ChangeSource", targetDepth)) {
                    resourceChangeDetail.setChangeSource(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("CausingEntity", targetDepth)) {
                    resourceChangeDetail.setCausingEntity(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
