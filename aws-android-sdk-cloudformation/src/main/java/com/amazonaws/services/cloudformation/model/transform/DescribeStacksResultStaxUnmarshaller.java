...
/**
 * StAX unmarshaller for response DescribeStacksResult
 */
public class DescribeStacksResultStaxUnmarshaller implements
        Unmarshaller<DescribeStacksResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Stacks/member", targetDepth)) {
                    describeStacksResult.withStacks(StackStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    describeStacksResult.setNextToken(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
