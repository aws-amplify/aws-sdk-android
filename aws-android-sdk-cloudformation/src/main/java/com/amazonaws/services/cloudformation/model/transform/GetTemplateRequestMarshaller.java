...
public class GetTemplateRequestMarshaller implements
    ...
    public Request<GetTemplateRequest> marshall(GetTemplateRequest getTemplateRequest) {
        ...
        Request<GetTemplateRequest> request = new DefaultRequest<GetTemplateRequest>(
                getTemplateRequest, "AWSCloudFormation");
        ...
        if (getTemplateRequest.getStackName() != null) {
            prefix = "StackName";
            String stackName = getTemplateRequest.getStackName();
        ...
        if (getTemplateRequest.getChangeSetName() != null) {
            ...
            String changeSetName = getTemplateRequest.getChangeSetName();
            request.addParameter(prefix, StringUtils.fromString(changeSetName));
        }
        if (getTemplateRequest.getTemplateStage() != null) {
            prefix = "TemplateStage";
            String templateStage = getTemplateRequest.getTemplateStage();
            request.addParameter(prefix, StringUtils.fromString(templateStage));
        }
