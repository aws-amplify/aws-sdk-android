...
/**
 * StAX unmarshaller for response ListStackSetsResult
 */
public class ListStackSetsResultStaxUnmarshaller implements
        Unmarshaller<ListStackSetsResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Summaries/member", targetDepth)) {
                    listStackSetsResult.withSummaries(StackSetSummaryStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    listStackSetsResult.setNextToken(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
