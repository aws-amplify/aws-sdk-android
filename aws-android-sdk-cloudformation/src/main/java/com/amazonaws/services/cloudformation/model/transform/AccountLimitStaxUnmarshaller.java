...
/**
 * StAX unmarshaller for model AccountLimit
 */
class AccountLimitStaxUnmarshaller implements Unmarshaller<AccountLimit, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("Value", targetDepth)) {
                    accountLimit
                            .setValue(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
