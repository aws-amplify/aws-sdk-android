...
/**
 * StAX unmarshaller for response DetectStackResourceDriftResult
 */
public class DetectStackResourceDriftResultStaxUnmarshaller implements
        Unmarshaller<DetectStackResourceDriftResult, StaxUnmarshallerContext> {

    public DetectStackResourceDriftResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("StackResourceDrift", targetDepth)) {
                    detectStackResourceDriftResult
                            .setStackResourceDrift(StackResourceDriftStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
