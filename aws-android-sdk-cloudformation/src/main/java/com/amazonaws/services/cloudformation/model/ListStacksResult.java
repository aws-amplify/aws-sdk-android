...
public class ListStacksResult implements Serializable {
    ...
    public void setStackSummaries(java.util.Collection<StackSummary> stackSummaries) {
        ...
        this.stackSummaries = new java.util.ArrayList<StackSummary>(stackSummaries);
    }
    ...
    public ListStacksResult withStackSummaries(StackSummary... stackSummaries) {
        if (getStackSummaries() == null) {
            this.stackSummaries = new java.util.ArrayList<StackSummary>(stackSummaries.length);
        }
        for (StackSummary value : stackSummaries) {
            this.stackSummaries.add(value);
        }
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getStackSummaries() == null) ? 0 : getStackSummaries().hashCode());
