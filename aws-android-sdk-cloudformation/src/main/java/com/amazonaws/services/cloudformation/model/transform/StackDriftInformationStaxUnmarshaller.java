...
/**
 * StAX unmarshaller for model StackDriftInformation
 */
class StackDriftInformationStaxUnmarshaller implements
        Unmarshaller<StackDriftInformation, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("StackDriftStatus", targetDepth)) {
                    stackDriftInformation.setStackDriftStatus(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("LastCheckTimestamp", targetDepth)) {
                    stackDriftInformation.setLastCheckTimestamp(DateStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
