...
/**
 * StAX unmarshaller for model StackSetOperationPreferences
 */
class StackSetOperationPreferencesStaxUnmarshaller implements
        Unmarshaller<StackSetOperationPreferences, StaxUnmarshallerContext> {

    public StackSetOperationPreferences unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("RegionOrder/member", targetDepth)) {
                    stackSetOperationPreferences.withRegionOrder(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("FailureToleranceCount", targetDepth)) {
                    stackSetOperationPreferences.setFailureToleranceCount(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("FailureTolerancePercentage", targetDepth)) {
                    stackSetOperationPreferences
                            .setFailureTolerancePercentage(IntegerStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("MaxConcurrentCount", targetDepth)) {
                    stackSetOperationPreferences.setMaxConcurrentCount(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("MaxConcurrentPercentage", targetDepth)) {
                    stackSetOperationPreferences.setMaxConcurrentPercentage(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
