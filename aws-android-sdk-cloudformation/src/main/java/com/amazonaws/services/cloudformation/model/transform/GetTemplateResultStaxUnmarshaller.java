...
/**
 * StAX unmarshaller for response GetTemplateResult
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("TemplateBody", targetDepth)) {
                    getTemplateResult.setTemplateBody(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("StagesAvailable/member", targetDepth)) {
                    getTemplateResult.withStagesAvailable(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
