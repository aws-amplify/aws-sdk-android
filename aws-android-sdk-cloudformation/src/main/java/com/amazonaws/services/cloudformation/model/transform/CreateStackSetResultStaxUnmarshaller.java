...
/**
 * StAX unmarshaller for response CreateStackSetResult
 */
public class CreateStackSetResultStaxUnmarshaller implements
        Unmarshaller<CreateStackSetResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("StackSetId", targetDepth)) {
                    createStackSetResult.setStackSetId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
