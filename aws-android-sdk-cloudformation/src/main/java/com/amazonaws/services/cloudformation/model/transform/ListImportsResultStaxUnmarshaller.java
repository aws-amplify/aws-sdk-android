...
/**
 * StAX unmarshaller for response ListImportsResult
 */
public class ListImportsResultStaxUnmarshaller implements
        Unmarshaller<ListImportsResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Imports/member", targetDepth)) {
                    listImportsResult.withImports(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    listImportsResult.setNextToken(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
