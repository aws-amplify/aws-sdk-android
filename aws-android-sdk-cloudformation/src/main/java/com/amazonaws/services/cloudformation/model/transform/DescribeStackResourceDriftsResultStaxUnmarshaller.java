...
/**
 * StAX unmarshaller for response DescribeStackResourceDriftsResult
 */
public class DescribeStackResourceDriftsResultStaxUnmarshaller implements
        Unmarshaller<DescribeStackResourceDriftsResult, StaxUnmarshallerContext> {

    public DescribeStackResourceDriftsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("StackResourceDrifts/member", targetDepth)) {
                    describeStackResourceDriftsResult
                            .withStackResourceDrifts(StackResourceDriftStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    describeStackResourceDriftsResult.setNextToken(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
