...
/**
 * StAX unmarshaller for response RecordHandlerProgressResult
 */
public class RecordHandlerProgressResultStaxUnmarshaller implements
        Unmarshaller<RecordHandlerProgressResult, StaxUnmarshallerContext> {
