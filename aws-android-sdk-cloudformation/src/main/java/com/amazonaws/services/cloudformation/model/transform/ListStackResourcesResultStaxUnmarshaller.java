...
/**
 * StAX unmarshaller for response ListStackResourcesResult
 */
public class ListStackResourcesResultStaxUnmarshaller implements
        Unmarshaller<ListStackResourcesResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("StackResourceSummaries/member", targetDepth)) {
                    listStackResourcesResult
                            .withStackResourceSummaries(StackResourceSummaryStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    listStackResourcesResult.setNextToken(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
