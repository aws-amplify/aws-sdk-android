...
/**
 * StAX unmarshaller for model DeploymentTargets
 */
class DeploymentTargetsStaxUnmarshaller implements
        Unmarshaller<DeploymentTargets, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Accounts/member", targetDepth)) {
                    deploymentTargets.withAccounts(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("OrganizationalUnitIds/member", targetDepth)) {
                    deploymentTargets.withOrganizationalUnitIds(StringStaxUnmarshaller
