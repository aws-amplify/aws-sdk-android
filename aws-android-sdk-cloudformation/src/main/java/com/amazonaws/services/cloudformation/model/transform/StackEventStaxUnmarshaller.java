...
/**
 * StAX unmarshaller for model StackEvent
 */
class StackEventStaxUnmarshaller implements Unmarshaller<StackEvent, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("StackName", targetDepth)) {
                    stackEvent.setStackName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("LogicalResourceId", targetDepth)) {
                    stackEvent.setLogicalResourceId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("PhysicalResourceId", targetDepth)) {
                    stackEvent.setPhysicalResourceId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ResourceType", targetDepth)) {
                    stackEvent.setResourceType(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                ...
                if (context.testExpression("ResourceStatus", targetDepth)) {
                    stackEvent.setResourceStatus(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("ResourceStatusReason", targetDepth)) {
                    stackEvent.setResourceStatusReason(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ResourceProperties", targetDepth)) {
                    stackEvent.setResourceProperties(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ClientRequestToken", targetDepth)) {
                    stackEvent.setClientRequestToken(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
