...
/**
 * JSON unmarshaller for POJO StartSessionResult
 */
class StartSessionResultJsonUnmarshaller implements
    ...
    public StartSessionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SessionToken")) {
                startSessionResult.setSessionToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
