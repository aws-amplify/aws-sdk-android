...
/**
 * Interface for accessing Amazon QLDB Session
 * <p>
...
public interface AmazonQLDBSession {
     ...
     * ("https://session.qldb.us-east-1.amazonaws.com"). Callers can use this
     * method to control which AWS region they want to work with.
     * <p>
     * Callers can pass in just the endpoint (ex:
     * "session.qldb.us-east-1.amazonaws.com") or a full URL, including the
     * protocol (ex: "https://session.qldb.us-east-1.amazonaws.com"). If the
     ...
     *
     * @param endpoint The endpoint (ex: "session.qldb.us-east-1.amazonaws.com")
     *            or a full URL, including the protocol (ex:
     *            "https://session.qldb.us-east-1.amazonaws.com") of the region
    ...
    /**
     * An alternative to {@link AmazonQLDBSession#setEndpoint(String)}, sets the
