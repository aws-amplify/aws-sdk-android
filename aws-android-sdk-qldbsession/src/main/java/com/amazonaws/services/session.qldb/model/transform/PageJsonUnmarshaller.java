...
/**
 * JSON unmarshaller for POJO Page
 */
class PageJsonUnmarshaller implements Unmarshaller<Page, JsonUnmarshallerContext> {
    ...
    public Page unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Values")) {
                page.setValues(new ListUnmarshaller<ValueHolder>(ValueHolderJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextPageToken")) {
                page.setNextPageToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
