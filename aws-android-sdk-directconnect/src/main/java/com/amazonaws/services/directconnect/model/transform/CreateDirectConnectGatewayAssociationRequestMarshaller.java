...
/**
 * JSON request marshaller for CreateDirectConnectGatewayAssociationRequest
 */
    ...
    public Request<CreateDirectConnectGatewayAssociationRequest> marshall(
        ...
        if (createDirectConnectGatewayAssociationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateDirectConnectGatewayAssociationRequest)");
        }

        Request<CreateDirectConnectGatewayAssociationRequest> request = new DefaultRequest<CreateDirectConnectGatewayAssociationRequest>(
                createDirectConnectGatewayAssociationRequest, "AWSDirectConnect");
        ...
        try {
            ...
            if (createDirectConnectGatewayAssociationRequest.getDirectConnectGatewayId() != null) {
                String directConnectGatewayId = createDirectConnectGatewayAssociationRequest
                        .getDirectConnectGatewayId();
                jsonWriter.name("directConnectGatewayId");
                jsonWriter.value(directConnectGatewayId);
            }
            if (createDirectConnectGatewayAssociationRequest.getGatewayId() != null) {
                String gatewayId = createDirectConnectGatewayAssociationRequest.getGatewayId();
                jsonWriter.name("gatewayId");
                jsonWriter.value(gatewayId);
            }
            if (createDirectConnectGatewayAssociationRequest
                    .getAddAllowedPrefixesToDirectConnectGateway() != null) {
                java.util.List<RouteFilterPrefix> addAllowedPrefixesToDirectConnectGateway = createDirectConnectGatewayAssociationRequest
            ...
            if (createDirectConnectGatewayAssociationRequest.getVirtualGatewayId() != null) {
                String virtualGatewayId = createDirectConnectGatewayAssociationRequest
                        .getVirtualGatewayId();
