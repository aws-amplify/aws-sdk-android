...
/**
 * JSON unmarshaller for response DeleteBGPPeerResult
 */
public class DeleteBGPPeerResultJsonUnmarshaller implements
        Unmarshaller<DeleteBGPPeerResult, JsonUnmarshallerContext> {
    ...
    public DeleteBGPPeerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("virtualInterface")) {
                deleteBGPPeerResult.setVirtualInterface(VirtualInterfaceJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
