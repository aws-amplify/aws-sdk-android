...
public enum VirtualInterfaceState {
    ...
    private static final Map<String, VirtualInterfaceState> enumMap;
    static {
        enumMap = new HashMap<String, VirtualInterfaceState>();
        enumMap.put("confirming", Confirming);
        enumMap.put("verifying", Verifying);
