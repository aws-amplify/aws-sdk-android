...
/**
 * JSON request marshaller for CreatePrivateVirtualInterfaceRequest
 */
    ...
    public Request<CreatePrivateVirtualInterfaceRequest> marshall(
        ...
        if (createPrivateVirtualInterfaceRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreatePrivateVirtualInterfaceRequest)");
        }

        Request<CreatePrivateVirtualInterfaceRequest> request = new DefaultRequest<CreatePrivateVirtualInterfaceRequest>(
                createPrivateVirtualInterfaceRequest, "AWSDirectConnect");
        ...
        try {
            ...
            if (createPrivateVirtualInterfaceRequest.getConnectionId() != null) {
                String connectionId = createPrivateVirtualInterfaceRequest.getConnectionId();
            ...
            if (createPrivateVirtualInterfaceRequest.getNewPrivateVirtualInterface() != null) {
                ...
                jsonWriter.name("newPrivateVirtualInterface");
                NewPrivateVirtualInterfaceJsonMarshaller.getInstance().marshall(
                        newPrivateVirtualInterface, jsonWriter);
            }
