 ...
 * </note>
 */
public class AssociateHostedConnectionRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
    ...
    public String toString() {
        ...
        if (getParentConnectionId() != null)
            sb.append("parentConnectionId: " + getParentConnectionId());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getParentConnectionId() == null) ? 0 : getParentConnectionId().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getParentConnectionId() == null ^ this.getParentConnectionId() == null)
            return false;
        if (other.getParentConnectionId() != null
                && other.getParentConnectionId().equals(this.getParentConnectionId()) == false)
            return false;
        return true;
    }
}
