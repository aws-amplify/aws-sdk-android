...
/**
 * JSON unmarshaller for response DescribeLagsResult
 */
public class DescribeLagsResultJsonUnmarshaller implements
        Unmarshaller<DescribeLagsResult, JsonUnmarshallerContext> {
    ...
    public DescribeLagsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("lags")) {
                describeLagsResult.setLags(new ListUnmarshaller<Lag>(LagJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
