...
/**
 * JSON request marshaller for DescribeConnectionsOnInterconnectRequest
 */
    ...
    public Request<DescribeConnectionsOnInterconnectRequest> marshall(
        ...
        if (describeConnectionsOnInterconnectRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeConnectionsOnInterconnectRequest)");
        }

        Request<DescribeConnectionsOnInterconnectRequest> request = new DefaultRequest<DescribeConnectionsOnInterconnectRequest>(
                describeConnectionsOnInterconnectRequest, "AWSDirectConnect");
        ...
        try {
            ...
            if (describeConnectionsOnInterconnectRequest.getInterconnectId() != null) {
                String interconnectId = describeConnectionsOnInterconnectRequest
                        .getInterconnectId();
