...
/**
 * JSON request marshaller for DescribeVirtualInterfacesRequest
 */
public class DescribeVirtualInterfacesRequestMarshaller implements
    ...
    public Request<DescribeVirtualInterfacesRequest> marshall(
        ...
        if (describeVirtualInterfacesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeVirtualInterfacesRequest)");
        }

        Request<DescribeVirtualInterfacesRequest> request = new DefaultRequest<DescribeVirtualInterfacesRequest>(
                describeVirtualInterfacesRequest, "AWSDirectConnect");
        ...
        try {
            ...
            if (describeVirtualInterfacesRequest.getConnectionId() != null) {
                String connectionId = describeVirtualInterfacesRequest.getConnectionId();
                jsonWriter.name("connectionId");
                jsonWriter.value(connectionId);
            }
            if (describeVirtualInterfacesRequest.getVirtualInterfaceId() != null) {
                String virtualInterfaceId = describeVirtualInterfacesRequest
