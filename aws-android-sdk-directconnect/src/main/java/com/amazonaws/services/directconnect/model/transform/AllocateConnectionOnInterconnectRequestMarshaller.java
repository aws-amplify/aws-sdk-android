...
/**
 * JSON request marshaller for AllocateConnectionOnInterconnectRequest
 */
    ...
    public Request<AllocateConnectionOnInterconnectRequest> marshall(
        ...
        if (allocateConnectionOnInterconnectRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AllocateConnectionOnInterconnectRequest)");
        }

        Request<AllocateConnectionOnInterconnectRequest> request = new DefaultRequest<AllocateConnectionOnInterconnectRequest>(
                allocateConnectionOnInterconnectRequest, "AWSDirectConnect");
        ...
        try {
            ...
            if (allocateConnectionOnInterconnectRequest.getBandwidth() != null) {
                String bandwidth = allocateConnectionOnInterconnectRequest.getBandwidth();
                jsonWriter.name("bandwidth");
                jsonWriter.value(bandwidth);
            }
            if (allocateConnectionOnInterconnectRequest.getConnectionName() != null) {
                String connectionName = allocateConnectionOnInterconnectRequest.getConnectionName();
            ...
            if (allocateConnectionOnInterconnectRequest.getOwnerAccount() != null) {
                String ownerAccount = allocateConnectionOnInterconnectRequest.getOwnerAccount();
            ...
            if (allocateConnectionOnInterconnectRequest.getInterconnectId() != null) {
                String interconnectId = allocateConnectionOnInterconnectRequest.getInterconnectId();
                jsonWriter.name("interconnectId");
                jsonWriter.value(interconnectId);
            }
            if (allocateConnectionOnInterconnectRequest.getVlan() != null) {
                Integer vlan = allocateConnectionOnInterconnectRequest.getVlan();
