...
/**
 * JSON request marshaller for ConfirmPrivateVirtualInterfaceRequest
 */
    ...
    public Request<ConfirmPrivateVirtualInterfaceRequest> marshall(
        ...
        if (confirmPrivateVirtualInterfaceRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ConfirmPrivateVirtualInterfaceRequest)");
        }

        Request<ConfirmPrivateVirtualInterfaceRequest> request = new DefaultRequest<ConfirmPrivateVirtualInterfaceRequest>(
                confirmPrivateVirtualInterfaceRequest, "AWSDirectConnect");
        ...
        try {
            ...
            if (confirmPrivateVirtualInterfaceRequest.getVirtualInterfaceId() != null) {
                String virtualInterfaceId = confirmPrivateVirtualInterfaceRequest
            ...
            if (confirmPrivateVirtualInterfaceRequest.getVirtualGatewayId() != null) {
                String virtualGatewayId = confirmPrivateVirtualInterfaceRequest
                        .getVirtualGatewayId();
                jsonWriter.name("virtualGatewayId");
                jsonWriter.value(virtualGatewayId);
            }
            if (confirmPrivateVirtualInterfaceRequest.getDirectConnectGatewayId() != null) {
                String directConnectGatewayId = confirmPrivateVirtualInterfaceRequest
