...
/**
 * JSON request marshaller for AllocatePrivateVirtualInterfaceRequest
 */
public class AllocatePrivateVirtualInterfaceRequestMarshaller
    ...
    public Request<AllocatePrivateVirtualInterfaceRequest> marshall(
        ...
        if (allocatePrivateVirtualInterfaceRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AllocatePrivateVirtualInterfaceRequest)");
        }

        Request<AllocatePrivateVirtualInterfaceRequest> request = new DefaultRequest<AllocatePrivateVirtualInterfaceRequest>(
                allocatePrivateVirtualInterfaceRequest, "AWSDirectConnect");
        ...
        try {
            ...
            if (allocatePrivateVirtualInterfaceRequest.getConnectionId() != null) {
                String connectionId = allocatePrivateVirtualInterfaceRequest.getConnectionId();
                jsonWriter.name("connectionId");
                jsonWriter.value(connectionId);
            }
            if (allocatePrivateVirtualInterfaceRequest.getOwnerAccount() != null) {
                String ownerAccount = allocatePrivateVirtualInterfaceRequest.getOwnerAccount();
            ...
            if (allocatePrivateVirtualInterfaceRequest.getNewPrivateVirtualInterfaceAllocation() != null) {
                NewPrivateVirtualInterfaceAllocation newPrivateVirtualInterfaceAllocation = allocatePrivateVirtualInterfaceRequest
                        .getNewPrivateVirtualInterfaceAllocation();
                jsonWriter.name("newPrivateVirtualInterfaceAllocation");
                NewPrivateVirtualInterfaceAllocationJsonMarshaller.getInstance().marshall(
                        newPrivateVirtualInterfaceAllocation, jsonWriter);
            }
