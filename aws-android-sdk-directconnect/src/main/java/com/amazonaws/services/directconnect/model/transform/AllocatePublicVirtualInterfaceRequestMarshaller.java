...
/**
 * JSON request marshaller for AllocatePublicVirtualInterfaceRequest
 */
    ...
    public Request<AllocatePublicVirtualInterfaceRequest> marshall(
        ...
        if (allocatePublicVirtualInterfaceRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AllocatePublicVirtualInterfaceRequest)");
        }

        Request<AllocatePublicVirtualInterfaceRequest> request = new DefaultRequest<AllocatePublicVirtualInterfaceRequest>(
                allocatePublicVirtualInterfaceRequest, "AWSDirectConnect");
        ...
        try {
            ...
            if (allocatePublicVirtualInterfaceRequest.getConnectionId() != null) {
                String connectionId = allocatePublicVirtualInterfaceRequest.getConnectionId();
                jsonWriter.name("connectionId");
                jsonWriter.value(connectionId);
            }
            if (allocatePublicVirtualInterfaceRequest.getOwnerAccount() != null) {
                String ownerAccount = allocatePublicVirtualInterfaceRequest.getOwnerAccount();
            ...
            if (allocatePublicVirtualInterfaceRequest.getNewPublicVirtualInterfaceAllocation() != null) {
                NewPublicVirtualInterfaceAllocation newPublicVirtualInterfaceAllocation = allocatePublicVirtualInterfaceRequest
                        .getNewPublicVirtualInterfaceAllocation();
                jsonWriter.name("newPublicVirtualInterfaceAllocation");
                NewPublicVirtualInterfaceAllocationJsonMarshaller.getInstance().marshall(
                        newPublicVirtualInterfaceAllocation, jsonWriter);
            }
