 ...
 */
public class DescribeDirectConnectGatewayAssociationProposalsResultJsonUnmarshaller
        implements
        Unmarshaller<DescribeDirectConnectGatewayAssociationProposalsResult, JsonUnmarshallerContext> {

    public DescribeDirectConnectGatewayAssociationProposalsResult unmarshall(
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("directConnectGatewayAssociationProposals")) {
                describeDirectConnectGatewayAssociationProposalsResult
                        .setDirectConnectGatewayAssociationProposals(new ListUnmarshaller<DirectConnectGatewayAssociationProposal>(
                                DirectConnectGatewayAssociationProposalJsonUnmarshaller
                                        .getInstance()
                        )
                                .unmarshall(context));
