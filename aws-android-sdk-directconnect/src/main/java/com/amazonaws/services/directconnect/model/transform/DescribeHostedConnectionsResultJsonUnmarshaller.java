...
/**
 * JSON unmarshaller for response DescribeHostedConnectionsResult
 */
public class DescribeHostedConnectionsResultJsonUnmarshaller implements
        Unmarshaller<DescribeHostedConnectionsResult, JsonUnmarshallerContext> {

    public DescribeHostedConnectionsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("connections")) {
                describeHostedConnectionsResult.setConnections(new ListUnmarshaller<Connection>(
