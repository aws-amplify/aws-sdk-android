...
/**
 * JSON unmarshaller for response DescribeConnectionsOnInterconnectResult
 */
public class DescribeConnectionsOnInterconnectResultJsonUnmarshaller implements
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("connections")) {
                describeConnectionsOnInterconnectResult
                        .setConnections(new ListUnmarshaller<Connection>(ConnectionJsonUnmarshaller
                                .getInstance()
                        )
                                .unmarshall(context));
            } else {
