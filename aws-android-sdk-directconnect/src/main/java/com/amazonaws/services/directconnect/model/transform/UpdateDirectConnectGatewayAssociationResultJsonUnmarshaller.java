...
/**
 * JSON unmarshaller for response UpdateDirectConnectGatewayAssociationResult
 */
public class UpdateDirectConnectGatewayAssociationResultJsonUnmarshaller implements
    ...
    public UpdateDirectConnectGatewayAssociationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
