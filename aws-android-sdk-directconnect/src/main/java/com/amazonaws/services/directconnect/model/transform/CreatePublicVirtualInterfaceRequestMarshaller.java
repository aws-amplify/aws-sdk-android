...
/**
 * JSON request marshaller for CreatePublicVirtualInterfaceRequest
 */
    ...
    public Request<CreatePublicVirtualInterfaceRequest> marshall(
        ...
        if (createPublicVirtualInterfaceRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreatePublicVirtualInterfaceRequest)");
        }

        Request<CreatePublicVirtualInterfaceRequest> request = new DefaultRequest<CreatePublicVirtualInterfaceRequest>(
                createPublicVirtualInterfaceRequest, "AWSDirectConnect");
        ...
        try {
            ...
            if (createPublicVirtualInterfaceRequest.getConnectionId() != null) {
                String connectionId = createPublicVirtualInterfaceRequest.getConnectionId();
            ...
            if (createPublicVirtualInterfaceRequest.getNewPublicVirtualInterface() != null) {
                ...
                jsonWriter.name("newPublicVirtualInterface");
                NewPublicVirtualInterfaceJsonMarshaller.getInstance().marshall(
                        newPublicVirtualInterface, jsonWriter);
            }
