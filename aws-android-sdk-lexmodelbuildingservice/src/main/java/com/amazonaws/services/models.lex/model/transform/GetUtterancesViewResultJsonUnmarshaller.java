...
/**
 * JSON unmarshaller for response GetUtterancesViewResult
 */
public class GetUtterancesViewResultJsonUnmarshaller implements
        Unmarshaller<GetUtterancesViewResult, JsonUnmarshallerContext> {
    ...
    public GetUtterancesViewResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("botName")) {
                getUtterancesViewResult.setBotName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("utterances")) {
                getUtterancesViewResult.setUtterances(new ListUnmarshaller<UtteranceList>(
                        UtteranceListJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
