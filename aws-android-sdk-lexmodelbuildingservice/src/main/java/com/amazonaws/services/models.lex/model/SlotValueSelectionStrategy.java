...
public enum SlotValueSelectionStrategy {
    ...
    private static final Map<String, SlotValueSelectionStrategy> enumMap;
    static {
        enumMap = new HashMap<String, SlotValueSelectionStrategy>();
        enumMap.put("ORIGINAL_VALUE", ORIGINAL_VALUE);
        enumMap.put("TOP_RESOLUTION", TOP_RESOLUTION);
    }
