...
public class CreateIntentVersionResult implements Serializable {
    /**
     * <p>
    ...
    /**
     * <p>
     * Configuration information, if any, for connectin an Amazon Kendra index
     ...
     *
     * @param slots <p>
     *            An array of slot types that defines the information required
     ...
     *         chained together.
     */
    public CreateIntentVersionResult withSampleUtterances(
            java.util.Collection<String> sampleUtterances) {
     ...
     *
     * @return <p>
     *         If defined, Amazon Lex uses this prompt to solicit additional
     ...
     * @return <p>
     *         After the Lambda function specified in the
     *         <code>fulfillmentActivity</code> field fulfills the intent,
     ...
     *            If defined, Amazon Lex invokes this Lambda function for each
     *            user input.
     *            </p>
     */
     ...
     *            Configuration information, if any, for connectin an Amazon
