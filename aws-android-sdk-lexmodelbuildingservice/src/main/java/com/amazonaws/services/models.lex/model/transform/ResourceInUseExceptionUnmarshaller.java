...
import com.amazonaws.services.models.lex.model.ResourceInUseException;

import com.amazonaws.services.models.lex.model.ResourceReference;
...
public class ResourceInUseExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        e.setReferenceType(String.valueOf(error.get("referenceType")));

        e.setExampleReference(gson.fromJson(error.get("exampleReference"), ResourceReference.class));
