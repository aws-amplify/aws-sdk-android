 ...
 * </p>
 */
public class GetBotRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
    ...
    public String toString() {
        ...
        if (getVersionOrAlias() != null)
            sb.append("versionOrAlias: " + getVersionOrAlias());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getVersionOrAlias() == null) ? 0 : getVersionOrAlias().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getVersionOrAlias() == null ^ this.getVersionOrAlias() == null)
            return false;
        if (other.getVersionOrAlias() != null
                && other.getVersionOrAlias().equals(this.getVersionOrAlias()) == false)
            return false;
        return true;
    }
}
