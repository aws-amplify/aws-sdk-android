 ...
 * </p>
 */
public class GetBotAliasesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     * The name of the bot.
     * </p>
     ...
     *
     * @param nextToken <p>
     *            A pagination token for fetching the next page of aliases. If
     ...
     *
     * @return <p>
     *         Substring to match in bot alias names. An alias will be returned
     ...
     *            Substring to match in bot alias names. An alias will be
