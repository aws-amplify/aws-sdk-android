 ...
 * about the <code>$LATEST</code> version of all slot types.
 * </p>
 * </li>
 * </ul>
 * <p>
 ...
 * </p>
 */
public class GetSlotTypesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *         pagination token in the response. To fetch next page of slot
     ...
     *            returns a pagination token in the response. To fetch next page
     *            of slot types, specify the pagination token in the next
     *            request.
     *            </p>
     */
     ...
     *
     * @return <p>
     *         Substring to match in slot type names. A slot type will be
     *         returned if any part of its name matches the substring. For
