...
/**
 * JSON unmarshaller for POJO Statement
 */
class StatementJsonUnmarshaller implements Unmarshaller<Statement, JsonUnmarshallerContext> {
    ...
    public Statement unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("messages")) {
                statement.setMessages(new ListUnmarshaller<Message>(MessageJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("responseCard")) {
                statement.setResponseCard(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
