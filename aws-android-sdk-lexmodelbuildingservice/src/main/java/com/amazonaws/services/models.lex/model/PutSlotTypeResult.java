...
public class PutSlotTypeResult implements Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public PutSlotTypeResult withEnumerationValues(
     ...
     *            slot type, the creation date and last update date are the
     *            same.
     *            </p>
     */
     ...
     *
     * @param version <p>
     *            The version of the slot type. For a new slot type, the version
     ...
     *
     * @return <p>
     *         The slot resolution strategy that Amazon Lex uses to determine
     *         the value of the slot. For more information, see
     *         <a>PutSlotType</a>.
     *         </p>
     ...
     * @see SlotValueSelectionStrategy
     */
    public PutSlotTypeResult withValueSelectionStrategy(
     ...
     *
     * @return <p>
     *         <code>True</code> if a new version of the slot type was created.
     *         If the <code>createVersion</code> field was not specified in the
     ...
     *            <code>True</code> if a new version of the slot type was
     *            created. If the <code>createVersion</code> field was not
     *            specified in the request, the <code>createVersion</code> field
     ...
     *         chained together.
     */
    public PutSlotTypeResult withSlotTypeConfigurations(
