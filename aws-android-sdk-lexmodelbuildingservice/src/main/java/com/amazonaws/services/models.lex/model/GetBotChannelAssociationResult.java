...
public class GetBotChannelAssociationResult implements Serializable {
    /**
     * <p>
     ...
     *
     * @param createdDate <p>
     *            The date that the association between the bot and the channel
     *            was created.
     *            </p>
     */
     ...
     *         chained together.
     */
    public GetBotChannelAssociationResult withBotConfiguration(
            java.util.Map<String, String> botConfiguration) {
        this.botConfiguration = botConfiguration;
        return this;
    }
