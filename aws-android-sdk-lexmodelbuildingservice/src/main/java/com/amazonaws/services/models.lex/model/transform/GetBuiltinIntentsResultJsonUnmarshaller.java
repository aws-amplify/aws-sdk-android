...
/**
 * JSON unmarshaller for response GetBuiltinIntentsResult
 */
public class GetBuiltinIntentsResultJsonUnmarshaller implements
        Unmarshaller<GetBuiltinIntentsResult, JsonUnmarshallerContext> {
    ...
    public GetBuiltinIntentsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("intents")) {
                getBuiltinIntentsResult.setIntents(new ListUnmarshaller<BuiltinIntentMetadata>(
                        BuiltinIntentMetadataJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                getBuiltinIntentsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
