...
public class SharingSettings implements Serializable {
    ...
    /**
     * <p>
     * When <code>NotebookOutputOption</code> is <code>Allowed</code>, the
     * Amazon S3 bucket used to save the notebook cell output. If
     * <code>S3OutputPath</code> isn't specified, a default bucket is used.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Length: </b> - 1024<br/>
    ...
    /**
     * <p>
     * When <code>NotebookOutputOption</code> is <code>Allowed</code>, the AWS
     ...
     *         notebook. The default is <code>Disabled</code>.
     *         </p>
     ...
     *
     * @return <p>
     *         When <code>NotebookOutputOption</code> is <code>Allowed</code>,
     *         the Amazon S3 bucket used to save the notebook cell output. If
     *         <code>S3OutputPath</code> isn't specified, a default bucket is
     *         used.
     *         </p>
     */
     ...
     *            If <code>S3OutputPath</code> isn't specified, a default bucket
     *            is used.
     *            </p>
     */
     ...
     * @return <p>
     *         When <code>NotebookOutputOption</code> is <code>Allowed</code>,
     *         the AWS Key Management Service (KMS) encryption key ID used to
     ...
     * @param s3KmsKeyId <p>
     *            When <code>NotebookOutputOption</code> is <code>Allowed</code>
     *            , the AWS Key Management Service (KMS) encryption key ID used
