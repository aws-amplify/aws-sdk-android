...
/**
 * JSON unmarshaller for response UpdateDomainResult
 */
public class UpdateDomainResultJsonUnmarshaller implements
        Unmarshaller<UpdateDomainResult, JsonUnmarshallerContext> {
    ...
    public UpdateDomainResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("DomainArn")) {
                updateDomainResult.setDomainArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
