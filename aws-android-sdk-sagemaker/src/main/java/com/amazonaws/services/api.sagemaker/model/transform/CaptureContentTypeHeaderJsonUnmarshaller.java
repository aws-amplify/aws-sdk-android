...
/**
 * JSON unmarshaller for POJO CaptureContentTypeHeader
 */
class CaptureContentTypeHeaderJsonUnmarshaller implements
        Unmarshaller<CaptureContentTypeHeader, JsonUnmarshallerContext> {
    ...
    public CaptureContentTypeHeader unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("CsvContentTypes")) {
                captureContentTypeHeader.setCsvContentTypes(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("JsonContentTypes")) {
                captureContentTypeHeader.setJsonContentTypes(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
