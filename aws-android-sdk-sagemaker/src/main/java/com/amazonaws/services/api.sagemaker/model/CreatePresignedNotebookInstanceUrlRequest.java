 ...
 * of IP addresses that you specify. Use the <code>NotIpAddress</code> condition
 * operator and the <code>aws:SourceIP</code> condition context key to specify
 * the list of IP addresses that you want to have access to the notebook
