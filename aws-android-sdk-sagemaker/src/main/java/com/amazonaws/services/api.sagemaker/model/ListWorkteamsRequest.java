 ...
 * </p>
 */
public class ListWorkteamsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>Name, CreateDate
     */
     ...
     *            A string in the work team's name. This filter returns only
     ...
     *
     * @return <p>
     *         If the result of the previous <code>ListWorkteams</code> request
     ...
     *
     * @param nextToken <p>
     *            If the result of the previous <code>ListWorkteams</code>
