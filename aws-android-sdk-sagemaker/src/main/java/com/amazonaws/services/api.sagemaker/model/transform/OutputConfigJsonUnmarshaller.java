...
class OutputConfigJsonUnmarshaller implements Unmarshaller<OutputConfig, JsonUnmarshallerContext> {
    ...
    public OutputConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("S3OutputLocation")) {
                outputConfig.setS3OutputLocation(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TargetDevice")) {
                outputConfig.setTargetDevice(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
