...
public class DescribeTransformJobResult implements Serializable {
    /**
     * <p>
     ...
     * is returned in the <code>FailureReason</code> field.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
     ...
     * messages, and stores it as an Amazon S3 object. For more information, see
     * <a href=
     * "https://docs.aws.amazon.com/sagemaker/latest/dg/logging-cloudwatch.html"
     * >Log Amazon SageMaker Events with Amazon CloudWatch</a>.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Length: </b> - 1024<br/>
     ...
     * value of <code>TransformStartTime</code>.
     * </p>
     */
     ...
     *         reason is returned in the <code>FailureReason</code> field.
     *         </p>
     ...
     *            The status of the transform job. If the transform job failed,
     *            the reason is returned in the <code>FailureReason</code>
     *            field.
     *            </p>
     * @see TransformJobStatus
     */
     ...
     *
     * @return <p>
     *         If the transform job failed, <code>FailureReason</code> describes
     *         why it failed. A transform job creates a log file, which includes
     *         error messages, and stores it as an Amazon S3 object. For more
     *         information, see <a href=
     *         "https://docs.aws.amazon.com/sagemaker/latest/dg/logging-cloudwatch.html"
     *         >Log Amazon SageMaker Events with Amazon CloudWatch</a>.
     *         </p>
     ...
     *            If the transform job failed, <code>FailureReason</code>
     *            describes why it failed. A transform job creates a log file,
     *            which includes error messages, and stores it as an Amazon S3
     ...
     *
     * @return <p>
     *         The maximum number of parallel requests on each instance node
     ...
     *            The maximum number of parallel requests on each instance node
     *            that can be launched in a transform job. The default value is
     *            1.
     *            </p>
     */
     ...
     *
     * @return <p>
     *         The timeout and maximum number of retries for processing a
     ...
     *         </p>
     *         <p>
     *         To enable the batch strategy, you must set <code>SplitType</code>
     *         to <code>Line</code>, <code>RecordIO</code>, or
     *         <code>TFRecord</code>.
     *         </p>
     * @see BatchStrategy
     */
     ...
     * </p>
     *
     * @param transformStartTime <p>
     *            Indicates when the transform job starts on ML instances. You
     *            are billed for the time interval between this time and the
     *            value of <code>TransformEndTime</code>.
     *            </p>
     */
     ...
     *
     * @return <p>
     *         Indicates when the transform job has been completed, or has
     *         stopped or failed. You are billed for the time interval between
     *         this time and the value of <code>TransformStartTime</code>.
     *         </p>
     */
     ...
     *            Indicates when the transform job has been completed, or has
     *            stopped or failed. You are billed for the time interval
     *            between this time and the value of
     *            <code>TransformStartTime</code>.
     *            </p>
     */
     ...
     *
     * @return <p>
     *         The Amazon Resource Name (ARN) of the Amazon SageMaker Ground
     *         Truth labeling job that created the transform or training job.
     *         </p>
     */
    ...
    public String toString() {
        ...
        if (getModelClientConfig() != null)
            sb.append("ModelClientConfig: " + getModelClientConfig() + ",");
        ...
        if (getTransformStartTime() != null)
            sb.append("TransformStartTime: " + getTransformStartTime() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getMaxConcurrentTransforms() == null) ? 0 : getMaxConcurrentTransforms()
                        .hashCode());
        hashCode = prime * hashCode
                + ((getModelClientConfig() == null) ? 0 : getModelClientConfig().hashCode());
        hashCode = prime * hashCode
        ...
        hashCode = prime * hashCode
                + ((getTransformStartTime() == null) ? 0 : getTransformStartTime().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getModelClientConfig() == null ^ this.getModelClientConfig() == null)
            return false;
        if (other.getModelClientConfig() != null
                && other.getModelClientConfig().equals(this.getModelClientConfig()) == false)
            return false;
        ...
        if (other.getTransformStartTime() == null ^ this.getTransformStartTime() == null)
            return false;
        if (other.getTransformStartTime() != null
                && other.getTransformStartTime().equals(this.getTransformStartTime()) == false)
            return false;
