 ...
 * </p>
 */
public class ProcessingS3Output implements Serializable {
    /**
     * <p>
     ...
     * save the results of an processing job. <code>LocalPath</code> is an
     ...
     *
     * @param s3Uri <p>
     *            A URI that identifies the Amazon S3 bucket where you want
     *            Amazon SageMaker to save the results of a processing job.
     *            </p>
     */
     ...
     *         SageMaker to save the results of an processing job.
     ...
     *
     * @return <p>
     *         Whether to upload the results of the processing job continuously
