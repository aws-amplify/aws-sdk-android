...
/**
 * JSON request marshaller for SearchRequest
 */
public class SearchRequestMarshaller implements Marshaller<Request<SearchRequest>, SearchRequest> {
    ...
    public Request<SearchRequest> marshall(SearchRequest searchRequest) {
        if (searchRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(SearchRequest)");
        }

        Request<SearchRequest> request = new DefaultRequest<SearchRequest>(searchRequest,
        ...
        try {
            ...
            if (searchRequest.getResource() != null) {
                String resource = searchRequest.getResource();
                jsonWriter.name("Resource");
                jsonWriter.value(resource);
            }
            if (searchRequest.getSearchExpression() != null) {
                SearchExpression searchExpression = searchRequest.getSearchExpression();
                jsonWriter.name("SearchExpression");
                SearchExpressionJsonMarshaller.getInstance().marshall(searchExpression, jsonWriter);
            }
            ...
            if (searchRequest.getNextToken() != null) {
                String nextToken = searchRequest.getNextToken();
