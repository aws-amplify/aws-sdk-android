...
public enum AwsManagedHumanLoopRequestSource {
    ...
    private static final Map<String, AwsManagedHumanLoopRequestSource> enumMap;
    static {
        enumMap = new HashMap<String, AwsManagedHumanLoopRequestSource>();
        enumMap.put("AWS/Rekognition/DetectModerationLabels/Image/V3",
                AWSRekognitionDetectModerationLabelsImageV3);
        enumMap.put("AWS/Textract/AnalyzeDocument/Forms/V1", AWSTextractAnalyzeDocumentFormsV1);
    }
