...
/**
 * JSON unmarshaller for response CreateMonitoringScheduleResult
 */
public class CreateMonitoringScheduleResultJsonUnmarshaller implements
        Unmarshaller<CreateMonitoringScheduleResult, JsonUnmarshallerContext> {

    public CreateMonitoringScheduleResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("MonitoringScheduleArn")) {
                createMonitoringScheduleResult.setMonitoringScheduleArn(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
