...
public enum ListLabelingJobsForWorkteamSortByOptions {
    ...
    private static final Map<String, ListLabelingJobsForWorkteamSortByOptions> enumMap;
    static {
        enumMap = new HashMap<String, ListLabelingJobsForWorkteamSortByOptions>();
     ...
     * @return ListLabelingJobsForWorkteamSortByOptions corresponding to the
     *         value
     */
