...
/**
 * JSON unmarshaller for POJO TrialComponentParameterValue
 */
class TrialComponentParameterValueJsonUnmarshaller implements
        Unmarshaller<TrialComponentParameterValue, JsonUnmarshallerContext> {
    ...
    public TrialComponentParameterValue unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("StringValue")) {
                trialComponentParameterValue.setStringValue(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("NumberValue")) {
                trialComponentParameterValue.setNumberValue(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
