...
/**
 * JSON unmarshaller for POJO LabelingJobS3DataSource
 */
class LabelingJobS3DataSourceJsonUnmarshaller implements
        Unmarshaller<LabelingJobS3DataSource, JsonUnmarshallerContext> {
    ...
    public LabelingJobS3DataSource unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ManifestS3Uri")) {
                labelingJobS3DataSource.setManifestS3Uri(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
