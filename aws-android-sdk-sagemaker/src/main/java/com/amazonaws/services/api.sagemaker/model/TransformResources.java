 ...
 * </p>
 */
public class TransformResources implements Serializable {
    /**
     * <p>
     ...
     *         using built-in algorithms to transform moderately sized datasets,
     *         we recommend using ml.m4.xlarge or <code>ml.m5.large</code>
     *         instance types.
     *         </p>
     ...
     *            datasets, we recommend using ml.m4.xlarge or
     *            <code>ml.m5.large</code> instance types.
     *            </p>
     * @see TransformInstanceType
     */
     ...
     *            The number of ML compute instances to use in the transform
     *            job. For distributed transform jobs, specify a value greater
     *            than 1. The default value is <code>1</code>.
     *            </p>
     */
     ...
     *         SageMaker uses to encrypt model data on the storage volume
     *         attached to the ML compute instance(s) that run the batch
     *         transform job. The <code>VolumeKmsKeyId</code> can be any of the
     *         following formats:
     *         </p>
     *         <ul>
     *         <li>
     ...
     *            SageMaker uses to encrypt model data on the storage volume
     *            attached to the ML compute instance(s) that run the batch
     *            transform job. The <code>VolumeKmsKeyId</code> can be any of
