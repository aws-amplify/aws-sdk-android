 ...
 * </p>
 */
public class ListModelPackagesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * the next set of model packages, use the token in the next request.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Length: </b> - 8192<br/>
     ...
     *
     * @param maxResults <p>
     *            The maximum number of model packages to return in the
     *            response.
     *            </p>
     */
     ...
     *
     * @return <p>
     *         A string in the model package name. This filter returns only
     *         model packages whose name contains the specified string.
     *         </p>
     */
     ...
     *
     * @return <p>
     *         If the response to a previous <code>ListModelPackages</code>
