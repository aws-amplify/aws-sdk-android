...
public class DescribeTrainingJobResult implements Serializable {
    /**
     * <p>
     ...
     * <li>
     * <p>
     * <code>Interrupted</code> - The job stopped because the managed spot
     ...
     * formula
     * <code>(1 - BillableTimeInSeconds / TrainingTimeInSeconds) * 100</code>.
     ...
     *         job. For detailed information on the secondary status of the
     ...
     *         chained together.
     */
    public DescribeTrainingJobResult withHyperParameters(
     ...
     *         chained together.
     */
    public DescribeTrainingJobResult withAlgorithmSpecification(
     ...
     *         chained together.
     */
    public DescribeTrainingJobResult withInputDataConfig(
     ...
     *
     * @return <p>
     *         Specifies a limit to how long a model training job can run. It
     *         also specifies the maximum time to wait for a spot instance. When
     ...
     *            Specifies a limit to how long a model training job can run. It
     *            also specifies the maximum time to wait for a spot instance.
     ...
     *         chained together.
     */
    public DescribeTrainingJobResult withSecondaryStatusTransitions(
     ...
     *
     * @return <p>
     *         A collection of <code>MetricData</code> objects that specify the
     *         names, values, and dates and times that the training algorithm
     ...
     *            A collection of <code>MetricData</code> objects that specify
     *            the names, values, and dates and times that the training
     *            algorithm emitted to Amazon CloudWatch.
     *            </p>
     */
     ...
     *         chained together.
     */
    public DescribeTrainingJobResult withFinalMetricDataList(
            java.util.Collection<MetricData> finalMetricDataList) {
     ...
     *
     * @return <p>
     *         If you want to allow inbound or outbound network calls, except
     *         for calls between peers within a training cluster for distributed
     *         training, choose <code>True</code>. If you enable network
     ...
     *            If you want to allow inbound or outbound network calls, except
     *            for calls between peers within a training cluster for
     *            distributed training, choose <code>True</code>. If you enable
     *            network isolation for training jobs that are configured to use
     ...
     *         deep learning algorithms in distributed training.
     *         </p>
     */
     ...
     *         chained together.
     */
    public DescribeTrainingJobResult withEnableInterContainerTrafficEncryption(
            Boolean enableInterContainerTrafficEncryption) {
        this.enableInterContainerTrafficEncryption = enableInterContainerTrafficEncryption;
        return this;
    }
     ...
     *         </p>
     *         <p>
     *         You can calculate the savings from using managed spot training
     *         using the formula
     *         <code>(1 - BillableTimeInSeconds / TrainingTimeInSeconds) * 100</code>
     *         . For example, if <code>BillableTimeInSeconds</code> is 100 and
     *         <code>TrainingTimeInSeconds</code> is 500, the savings is 80%.
     ...
     *            using the formula
     *            <code>(1 - BillableTimeInSeconds / TrainingTimeInSeconds) * 100</code>
     *            . For example, if <code>BillableTimeInSeconds</code> is 100
     *            and <code>TrainingTimeInSeconds</code> is 500, the savings is
     *            80%.
     *            </p>
     */
     ...
     *         chained together.
     */
    public DescribeTrainingJobResult withDebugRuleConfigurations(
     ...
     *         chained together.
     */
    public DescribeTrainingJobResult withTensorBoardOutputConfig(
     ...
     *         chained together.
     */
    public DescribeTrainingJobResult withDebugRuleEvaluationStatuses(
