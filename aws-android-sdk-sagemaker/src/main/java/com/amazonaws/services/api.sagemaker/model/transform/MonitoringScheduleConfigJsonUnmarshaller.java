...
/**
 * JSON unmarshaller for POJO MonitoringScheduleConfig
 */
class MonitoringScheduleConfigJsonUnmarshaller implements
        Unmarshaller<MonitoringScheduleConfig, JsonUnmarshallerContext> {
    ...
    public MonitoringScheduleConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ScheduleConfig")) {
                monitoringScheduleConfig.setScheduleConfig(ScheduleConfigJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("MonitoringJobDefinition")) {
                monitoringScheduleConfig
                        .setMonitoringJobDefinition(MonitoringJobDefinitionJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
