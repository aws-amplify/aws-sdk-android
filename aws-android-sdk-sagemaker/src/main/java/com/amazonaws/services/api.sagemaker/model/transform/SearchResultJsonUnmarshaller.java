...
/**
 * JSON unmarshaller for response SearchResult
 */
    ...
    public SearchResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Results")) {
                searchResult.setResults(new ListUnmarshaller<SearchRecord>(
                        SearchRecordJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                searchResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
