 ...
 * </p>
 */
public class ListEndpointConfigsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * the next set of endpoint configurations, use the token in the next
     * request.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
     ...
     *
     * @return <p>
     *         If the result of the previous <code>ListEndpointConfig</code>
     *         request was truncated, the response includes a
     *         <code>NextToken</code>. To retrieve the next set of endpoint
     ...
     *            A string in the endpoint configuration name. This filter
     *            returns only endpoint configurations whose name contains the
     *            specified string.
     *            </p>
     */
     ...
     *            A filter that returns only endpoint configurations created
     ...
     *
     * @return <p>
     *         A filter that returns only endpoint configurations with a
