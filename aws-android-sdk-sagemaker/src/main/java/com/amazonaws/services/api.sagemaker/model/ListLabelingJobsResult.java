...
public class ListLabelingJobsResult implements Serializable {
    /**
     * <p>
    ...
    public void setLabelingJobSummaryList(
            java.util.Collection<LabelingJobSummary> labelingJobSummaryList) {
        if (labelingJobSummaryList == null) {
            this.labelingJobSummaryList = null;
            return;
        }

        this.labelingJobSummaryList = new java.util.ArrayList<LabelingJobSummary>(
     ...
     *         chained together.
     */
    public ListLabelingJobsResult withLabelingJobSummaryList(
            LabelingJobSummary... labelingJobSummaryList) {
        if (getLabelingJobSummaryList() == null) {
            this.labelingJobSummaryList = new java.util.ArrayList<LabelingJobSummary>(
                    labelingJobSummaryList.length);
        }
        for (LabelingJobSummary value : labelingJobSummaryList) {
