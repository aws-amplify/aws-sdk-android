...
public class RenderUiTemplateRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         The <code>HumanTaskUiArn</code> of the worker UI that you want to
     *         render. Do not provide a <code>HumanTaskUiArn</code> if you use
     *         the <code>UiTemplate</code> parameter.
     *         </p>
     */
     ...
     *            The <code>HumanTaskUiArn</code> of the worker UI that you want
     *            to render. Do not provide a <code>HumanTaskUiArn</code> if you
     *            use the <code>UiTemplate</code> parameter.
     *            </p>
     */
