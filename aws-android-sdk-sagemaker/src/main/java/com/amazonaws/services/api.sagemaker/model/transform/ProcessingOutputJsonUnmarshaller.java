...
/**
 * JSON unmarshaller for POJO ProcessingOutput
 */
class ProcessingOutputJsonUnmarshaller implements
        Unmarshaller<ProcessingOutput, JsonUnmarshallerContext> {
    ...
    public ProcessingOutput unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("OutputName")) {
                processingOutput.setOutputName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("S3Output")) {
                processingOutput.setS3Output(ProcessingS3OutputJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
