...
public class Filter implements Serializable {
     ...
     * <dd>
     * <p>
     * The value of <code>Name</code> contains the string <code>Value</code>.
     ...
     * </ul>
     * <p>
     * A <code>SearchExpression</code> can include only one
     * <code>Contains</code> operator for all other values of <code>Name</code>.
     * In these cases, if you include multiple <code>Contains</code> operators
     * in the <code>SearchExpression</code>, the result is the following error
     * message: "<code>'CONTAINS' operator usage limit of 1 exceeded.</code>"
     * </p>
     * </dd>
     * </dl>
     * <p>
     ...
     *         </p>
     *         <p>
     *         A <code>SearchExpression</code> can include the
     ...
     *         <p>
     *         A <code>SearchExpression</code> can include only one
     *         <code>Contains</code> operator for all other values of
     *         <code>Name</code>. In these cases, if you include multiple
     *         <code>Contains</code> operators in the
     *         <code>SearchExpression</code>, the result is the following error
     *         message: "
     ...
     *            <p>
     *            A <code>SearchExpression</code> can include the
     *            <code>Contains</code> operator multiple times when the value
     *            of <code>Name</code> is one of the following:
     *            </p>
     *            <ul>
     *            <li>
     *            <p>
     ...
     *            <code>Name</code>. In these cases, if you include multiple
     *            <code>Contains</code> operators in the
     *            <code>SearchExpression</code>, the result is the following
     *            error message: "
     *            <code>'CONTAINS' operator usage limit of 1 exceeded.</code>"
     *            </p>
     *            </dd>
