...
public interface AmazonSageMakerService {
     ...
     * JupyterServer, KernelGateway, and TensorBoard. This operation is
     ...
     * user. A user may have multiple Apps active simultaneously. UserProfiles
    ...
    /**
     * <p>
     * Creates a <code>Domain</code> used by SageMaker Studio. A domain consists
     * of an associated directory, a list of authorized users, and a variety of
     ...
     * the specified subnet IDs. All other traffic goes over the Internet
     * through an Amazon SageMaker system VPC. The EFS traffic uses the NFS/TCP
     * protocol over port 2049.
     * </p>
     * <important>
     * <p>
     ...
     * condition operator and the <code>aws:SourceIP</code> condition context
     * key to specify the list of IP addresses that you want to have access to
     * the notebook instance. For more information, see <a href=
     ...
     * instance type the endpoint is using. The endpoint must be deleted in
     * order to stop incurring charges.
     * </p>
     * </note>
     * 
