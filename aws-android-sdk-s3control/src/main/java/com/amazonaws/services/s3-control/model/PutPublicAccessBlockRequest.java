...
public class PutPublicAccessBlockRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <p>The <code>PublicAccessBlock</code> configuration that you want to apply to the specified Amazon Web Services account.</p>
     *
     * @return <p>The <code>PublicAccessBlock</code> configuration that you want to apply to the specified Amazon Web Services account.</p>
     */
     ...
     * <p>The <code>PublicAccessBlock</code> configuration that you want to apply to the specified Amazon Web Services account.</p>
     *
     * @param publicAccessBlockConfiguration <p>The <code>PublicAccessBlock</code> configuration that you want to apply to the specified Amazon Web Services account.</p>
     */
     ...
     * <b>Pattern: </b>^\d{12}$<br/>
     *
     * @return <p>The account ID for the Amazon Web Services account whose <code>PublicAccessBlock</code> configuration you want to set.</p>
     */
     ...
     * <b>Pattern: </b>^\d{12}$<br/>
     *
     * @param accountId <p>The account ID for the Amazon Web Services account whose <code>PublicAccessBlock</code> configuration you want to set.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutPublicAccessBlockRequest == false) return false;
