...
public class GetPublicAccessBlockResult implements Serializable {
    /**
     ...
     * <p>The <code>PublicAccessBlock</code> configuration currently in effect for this Amazon Web Services account.</p>
     *
     * @return <p>The <code>PublicAccessBlock</code> configuration currently in effect for this Amazon Web Services account.</p>
     */
     ...
     * <p>The <code>PublicAccessBlock</code> configuration currently in effect for this Amazon Web Services account.</p>
     *
     * @param publicAccessBlockConfiguration <p>The <code>PublicAccessBlock</code> configuration currently in effect for this Amazon Web Services account.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPublicAccessBlockResult == false) return false;
