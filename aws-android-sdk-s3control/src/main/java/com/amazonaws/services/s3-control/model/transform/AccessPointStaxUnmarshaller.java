...
/**
 * StAX unmarshaller for model AccessPoint
 */
class AccessPointStaxUnmarshaller implements Unmarshaller<AccessPoint, StaxUnmarshallerContext> {
    ...
    public static AccessPointStaxUnmarshaller getInstance() {
        if (instance == null) instance = new AccessPointStaxUnmarshaller();
        return instance;
    }
}
