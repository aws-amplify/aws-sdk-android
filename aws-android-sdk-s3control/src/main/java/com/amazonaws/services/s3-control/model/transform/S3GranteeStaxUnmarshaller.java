...
/**
 * StAX unmarshaller for model S3Grantee
 */
class S3GranteeStaxUnmarshaller implements Unmarshaller<S3Grantee, StaxUnmarshallerContext> {
    ...
    public static S3GranteeStaxUnmarshaller getInstance() {
        if (instance == null) instance = new S3GranteeStaxUnmarshaller();
        return instance;
    }
}
