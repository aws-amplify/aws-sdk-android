...
/**
 * StAX unmarshaller for model S3Tag
 */
class S3TagStaxUnmarshaller implements Unmarshaller<S3Tag, StaxUnmarshallerContext> {
    ...
    public static S3TagStaxUnmarshaller getInstance() {
        if (instance == null) instance = new S3TagStaxUnmarshaller();
        return instance;
    }
}
