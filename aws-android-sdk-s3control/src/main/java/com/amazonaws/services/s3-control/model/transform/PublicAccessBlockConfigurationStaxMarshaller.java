...
class PublicAccessBlockConfigurationStaxMarshaller {
    ...
    public void marshall(PublicAccessBlockConfiguration _publicAccessBlockConfiguration, Request<?> request, String _prefix) {
        String prefix;
        ...
        if (_publicAccessBlockConfiguration.getRestrictPublicBuckets() != null) {
            ...
            Boolean restrictPublicBuckets = _publicAccessBlockConfiguration.getRestrictPublicBuckets();
    ...
    public static PublicAccessBlockConfigurationStaxMarshaller getInstance() {
        if (instance == null) instance = new PublicAccessBlockConfigurationStaxMarshaller();
        return instance;
    }
}
