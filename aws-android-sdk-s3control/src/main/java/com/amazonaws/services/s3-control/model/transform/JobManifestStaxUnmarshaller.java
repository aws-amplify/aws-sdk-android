...
/**
 * StAX unmarshaller for model JobManifest
 */
class JobManifestStaxUnmarshaller implements Unmarshaller<JobManifest, StaxUnmarshallerContext> {
    ...
    public static JobManifestStaxUnmarshaller getInstance() {
        if (instance == null) instance = new JobManifestStaxUnmarshaller();
        return instance;
    }
}
