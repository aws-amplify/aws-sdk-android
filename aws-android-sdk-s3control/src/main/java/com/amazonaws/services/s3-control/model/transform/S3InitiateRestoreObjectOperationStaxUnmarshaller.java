...
/**
 * StAX unmarshaller for model S3InitiateRestoreObjectOperation
 */
class S3InitiateRestoreObjectOperationStaxUnmarshaller implements Unmarshaller<S3InitiateRestoreObjectOperation, StaxUnmarshallerContext> {
    ...
    public static S3InitiateRestoreObjectOperationStaxUnmarshaller getInstance() {
        if (instance == null) instance = new S3InitiateRestoreObjectOperationStaxUnmarshaller();
        return instance;
    }
}
