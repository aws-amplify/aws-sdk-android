...
/**
 * StAX unmarshaller for model JobListDescriptor
 */
class JobListDescriptorStaxUnmarshaller implements Unmarshaller<JobListDescriptor, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("CreationTime", targetDepth)) {
                    jobListDescriptor.setCreationTime(DateStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("TerminationDate", targetDepth)) {
                    jobListDescriptor.setTerminationDate(DateStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static JobListDescriptorStaxUnmarshaller getInstance() {
        if (instance == null) instance = new JobListDescriptorStaxUnmarshaller();
        return instance;
    }
}
