...
/**
 * StAX unmarshaller for model S3SetObjectAclOperation
 */
class S3SetObjectAclOperationStaxUnmarshaller implements Unmarshaller<S3SetObjectAclOperation, StaxUnmarshallerContext> {
    ...
    public static S3SetObjectAclOperationStaxUnmarshaller getInstance() {
        if (instance == null) instance = new S3SetObjectAclOperationStaxUnmarshaller();
        return instance;
    }
}
