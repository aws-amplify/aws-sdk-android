 ...
 */
class PublicAccessBlockConfigurationStaxUnmarshaller implements Unmarshaller<PublicAccessBlockConfiguration, StaxUnmarshallerContext> {
    ...
    public static PublicAccessBlockConfigurationStaxUnmarshaller getInstance() {
        if (instance == null) instance = new PublicAccessBlockConfigurationStaxUnmarshaller();
        return instance;
    }
}
