...
/**
 * StAX unmarshaller for model LambdaInvokeOperation
 */
class LambdaInvokeOperationStaxUnmarshaller implements Unmarshaller<LambdaInvokeOperation, StaxUnmarshallerContext> {
    ...
    public static LambdaInvokeOperationStaxUnmarshaller getInstance() {
        if (instance == null) instance = new LambdaInvokeOperationStaxUnmarshaller();
        return instance;
    }
}
