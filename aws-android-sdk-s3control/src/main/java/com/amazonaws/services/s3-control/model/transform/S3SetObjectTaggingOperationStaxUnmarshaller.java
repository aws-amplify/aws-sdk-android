...
/**
 * StAX unmarshaller for model S3SetObjectTaggingOperation
 */
class S3SetObjectTaggingOperationStaxUnmarshaller implements Unmarshaller<S3SetObjectTaggingOperation, StaxUnmarshallerContext> {
    ...
    public static S3SetObjectTaggingOperationStaxUnmarshaller getInstance() {
        if (instance == null) instance = new S3SetObjectTaggingOperationStaxUnmarshaller();
        return instance;
    }
}
