...
public class DeletePublicAccessBlockRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Pattern: </b>^\d{12}$<br/>
     *
     * @return <p>The account ID for the Amazon Web Services account whose <code>PublicAccessBlock</code> configuration you want to remove.</p>
     */
     ...
     * <b>Pattern: </b>^\d{12}$<br/>
     *
     * @param accountId <p>The account ID for the Amazon Web Services account whose <code>PublicAccessBlock</code> configuration you want to remove.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeletePublicAccessBlockRequest == false) return false;
