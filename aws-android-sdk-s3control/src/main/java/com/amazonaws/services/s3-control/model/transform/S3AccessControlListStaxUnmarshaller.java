...
/**
 * StAX unmarshaller for model S3AccessControlList
 */
class S3AccessControlListStaxUnmarshaller implements Unmarshaller<S3AccessControlList, StaxUnmarshallerContext> {
    ...
    public static S3AccessControlListStaxUnmarshaller getInstance() {
        if (instance == null) instance = new S3AccessControlListStaxUnmarshaller();
        return instance;
    }
}
