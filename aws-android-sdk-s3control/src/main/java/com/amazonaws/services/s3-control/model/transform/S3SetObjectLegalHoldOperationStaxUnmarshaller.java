...
/**
 * StAX unmarshaller for model S3SetObjectLegalHoldOperation
 */
class S3SetObjectLegalHoldOperationStaxUnmarshaller implements Unmarshaller<S3SetObjectLegalHoldOperation, StaxUnmarshallerContext> {
    ...
    public static S3SetObjectLegalHoldOperationStaxUnmarshaller getInstance() {
        if (instance == null) instance = new S3SetObjectLegalHoldOperationStaxUnmarshaller();
        return instance;
    }
}
