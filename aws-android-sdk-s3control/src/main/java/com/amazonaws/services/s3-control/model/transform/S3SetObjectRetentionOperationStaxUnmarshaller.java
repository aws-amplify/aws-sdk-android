...
/**
 * StAX unmarshaller for model S3SetObjectRetentionOperation
 */
class S3SetObjectRetentionOperationStaxUnmarshaller implements Unmarshaller<S3SetObjectRetentionOperation, StaxUnmarshallerContext> {
    ...
    public static S3SetObjectRetentionOperationStaxUnmarshaller getInstance() {
        if (instance == null) instance = new S3SetObjectRetentionOperationStaxUnmarshaller();
        return instance;
    }
}
