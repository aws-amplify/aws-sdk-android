...
/**
 * StAX unmarshaller for response GetPublicAccessBlockResult
 */
public class GetPublicAccessBlockResultStaxUnmarshaller implements Unmarshaller<GetPublicAccessBlockResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PublicAccessBlockConfiguration", targetDepth)) {
                    getPublicAccessBlockResult.setPublicAccessBlockConfiguration(PublicAccessBlockConfigurationStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static GetPublicAccessBlockResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new GetPublicAccessBlockResultStaxUnmarshaller();
        return instance;
    }
}
