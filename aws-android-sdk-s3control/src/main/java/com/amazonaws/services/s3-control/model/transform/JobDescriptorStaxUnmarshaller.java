...
/**
 * StAX unmarshaller for model JobDescriptor
 */
class JobDescriptorStaxUnmarshaller implements Unmarshaller<JobDescriptor, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("CreationTime", targetDepth)) {
                    jobDescriptor.setCreationTime(DateStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("TerminationDate", targetDepth)) {
                    jobDescriptor.setTerminationDate(DateStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("SuspendedDate", targetDepth)) {
                    jobDescriptor.setSuspendedDate(DateStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static JobDescriptorStaxUnmarshaller getInstance() {
        if (instance == null) instance = new JobDescriptorStaxUnmarshaller();
        return instance;
    }
}
