...
public class GetAccessPointPolicyResult implements Serializable {
    /**
     ...
     * <p>The access point policy associated with the specified access point.</p>
     *
     * @return <p>The access point policy associated with the specified access point.</p>
     */
     ...
     * <p>The access point policy associated with the specified access point.</p>
     *
     * @param policy <p>The access point policy associated with the specified access point.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAccessPointPolicyResult == false) return false;
