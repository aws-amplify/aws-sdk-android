...
/**
 * StAX unmarshaller for model VpcConfiguration
 */
class VpcConfigurationStaxUnmarshaller implements Unmarshaller<VpcConfiguration, StaxUnmarshallerContext> {
    ...
    public static VpcConfigurationStaxUnmarshaller getInstance() {
        if (instance == null) instance = new VpcConfigurationStaxUnmarshaller();
        return instance;
    }
}
