...
/**
 * JSON unmarshaller for POJO LifecyclePolicySummary
 */
class LifecyclePolicySummaryJsonUnmarshaller implements
        Unmarshaller<LifecyclePolicySummary, JsonUnmarshallerContext> {
    ...
    public LifecyclePolicySummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PolicyId")) {
                lifecyclePolicySummary.setPolicyId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Description")) {
                lifecyclePolicySummary.setDescription(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("State")) {
                lifecyclePolicySummary.setState(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Tags")) {
                lifecyclePolicySummary.setTags(new MapUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
