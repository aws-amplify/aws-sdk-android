...
/**
 * StAX unmarshaller for response ListTrafficPolicyInstancesByPolicyResult
 */
public class ListTrafficPolicyInstancesByPolicyResultStaxUnmarshaller implements
    ...
    public ListTrafficPolicyInstancesByPolicyResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("HostedZoneIdMarker", targetDepth)) {
                    listTrafficPolicyInstancesByPolicyResult
                            .setHostedZoneIdMarker(StringStaxUnmarshaller.getInstance().unmarshall(
                                    context));
                    continue;
                }
                ...
                if (context.testExpression("IsTruncated", targetDepth)) {
                    listTrafficPolicyInstancesByPolicyResult.setIsTruncated(BooleanStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("MaxItems", targetDepth)) {
                    listTrafficPolicyInstancesByPolicyResult.setMaxItems(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
