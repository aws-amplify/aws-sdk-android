...
/**
 * StAX request marshaller for CreateReusableDelegationSetRequest
 */
    ...
    public Request<CreateReusableDelegationSetRequest> marshall(
        ...
        if (createReusableDelegationSetRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateReusableDelegationSetRequest)");
        }
        ...
        request.addParameter("Action", "CreateReusableDelegationSet");
        ...
        if (createReusableDelegationSetRequest.getCallerReference() != null) {
            ...
            String callerReference = createReusableDelegationSetRequest.getCallerReference();
        ...
        if (createReusableDelegationSetRequest.getHostedZoneId() != null) {
            prefix = "HostedZoneId";
            String hostedZoneId = createReusableDelegationSetRequest.getHostedZoneId();
