...
public class ListTrafficPolicyInstancesResult implements Serializable {
     ...
     *         the first traffic policy instance that Route 53 will return if
     *         you submit another <code>ListTrafficPolicyInstances</code>
     *         request.
     *         </p>
     */
     ...
     *            If <code>IsTruncated</code> is <code>true</code>,
     *            <code>HostedZoneIdMarker</code> is the ID of the hosted zone
     *            of the first traffic policy instance that Route 53 will return
     *            if you submit another <code>ListTrafficPolicyInstances</code>
     *            request.
     *            </p>
     */
     ...
     *         first traffic policy instance that Route 53 will return if you
     ...
     *            traffic policy instance that Amazon Route 53 will return if
     *            you submit another <code>ListTrafficPolicyInstances</code>
     *            request.
     *            </p>
     * @see RRType
     ...
     *         get more traffic policy instances by calling
     ...
     *            instances to be listed. If the response was truncated, you can
     *            get more traffic policy instances by calling
     *            <code>ListTrafficPolicyInstances</code> again and specifying
     ...
     *            <code>ListTrafficPolicyInstances</code> that produced the
     *            current response.
     *            </p>
     */
