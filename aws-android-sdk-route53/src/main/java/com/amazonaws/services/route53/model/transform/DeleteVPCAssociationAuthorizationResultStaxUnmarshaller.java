...
/**
 * StAX unmarshaller for response DeleteVPCAssociationAuthorizationResult
 */
public class DeleteVPCAssociationAuthorizationResultStaxUnmarshaller implements
        Unmarshaller<DeleteVPCAssociationAuthorizationResult, StaxUnmarshallerContext> {

    public DeleteVPCAssociationAuthorizationResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
