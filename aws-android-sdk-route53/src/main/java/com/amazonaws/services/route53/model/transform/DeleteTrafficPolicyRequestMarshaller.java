...
/**
 * StAX request marshaller for DeleteTrafficPolicyRequest
 */
public class DeleteTrafficPolicyRequestMarshaller implements
    ...
    public Request<DeleteTrafficPolicyRequest> marshall(
        ...
        if (deleteTrafficPolicyRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteTrafficPolicyRequest)");
        }
        ...
        request.addParameter("Action", "DeleteTrafficPolicy");
        request.addParameter("Version", "2013-04-01");

        String prefix;
        if (deleteTrafficPolicyRequest.getId() != null) {
            prefix = "Id";
            String id = deleteTrafficPolicyRequest.getId();
            request.addParameter(prefix, StringUtils.fromString(id));
        }
        if (deleteTrafficPolicyRequest.getVersion() != null) {
            prefix = "Version";
            Integer version = deleteTrafficPolicyRequest.getVersion();
