...
/**
 * StAX request marshaller for DeleteHealthCheckRequest
 */
    ...
    public Request<DeleteHealthCheckRequest> marshall(
        ...
        if (deleteHealthCheckRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteHealthCheckRequest)");
        }

        Request<DeleteHealthCheckRequest> request = new DefaultRequest<DeleteHealthCheckRequest>(
                deleteHealthCheckRequest, "AmazonRoute53");
        request.addParameter("Action", "DeleteHealthCheck");
        request.addParameter("Version", "2013-04-01");

        String prefix;
        if (deleteHealthCheckRequest.getHealthCheckId() != null) {
            prefix = "HealthCheckId";
            String healthCheckId = deleteHealthCheckRequest.getHealthCheckId();
