...
/**
 * StAX unmarshaller for response ListResourceRecordSetsResult
 */
public class ListResourceRecordSetsResultStaxUnmarshaller implements
    ...
    public ListResourceRecordSetsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ResourceRecordSets", targetDepth)) {
                    listResourceRecordSetsResult
                            .withResourceRecordSets(ResourceRecordSetStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                if (context.testExpression("IsTruncated", targetDepth)) {
                    listResourceRecordSetsResult.setIsTruncated(BooleanStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextRecordName", targetDepth)) {
                    listResourceRecordSetsResult.setNextRecordName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextRecordType", targetDepth)) {
                    listResourceRecordSetsResult.setNextRecordType(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextRecordIdentifier", targetDepth)) {
                    listResourceRecordSetsResult.setNextRecordIdentifier(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("MaxItems", targetDepth)) {
                    listResourceRecordSetsResult.setMaxItems(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
