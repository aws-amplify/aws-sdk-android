...
/**
 * StAX request marshaller for AssociateVPCWithHostedZoneRequest
 */
public class AssociateVPCWithHostedZoneRequestMarshaller implements
    ...
    public Request<AssociateVPCWithHostedZoneRequest> marshall(
        ...
        if (associateVPCWithHostedZoneRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AssociateVPCWithHostedZoneRequest)");
        }
        ...
        request.addParameter("Action", "AssociateVPCWithHostedZone");
        request.addParameter("Version", "2013-04-01");

        String prefix;
        if (associateVPCWithHostedZoneRequest.getHostedZoneId() != null) {
            prefix = "Id";
            String hostedZoneId = associateVPCWithHostedZoneRequest.getHostedZoneId();
            request.addParameter(prefix, StringUtils.fromString(hostedZoneId));
        }
        if (associateVPCWithHostedZoneRequest.getVPC() != null) {
            prefix = "VPC";
        ...
        if (associateVPCWithHostedZoneRequest.getComment() != null) {
            prefix = "Comment";
            String comment = associateVPCWithHostedZoneRequest.getComment();
