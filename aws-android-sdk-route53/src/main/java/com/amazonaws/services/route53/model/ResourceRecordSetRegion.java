...
public enum ResourceRecordSetRegion {
    ...
    private static final Map<String, ResourceRecordSetRegion> enumMap;
    static {
        enumMap = new HashMap<String, ResourceRecordSetRegion>();
        ...
        enumMap.put("cn-northwest-1", CnNorthwest1);
