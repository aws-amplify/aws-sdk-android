...
public class AliasTarget implements Serializable {
     ...
     * using the AWS CLI command <a href=
     ...
     * value of <code>HostedZoneId</code> using the AWS CLI command <a href=
     ...
     * environment in. The environment must have a regionalized subdomain. For a
     ...
     * >AWS Elastic Beanstalk</a> in the "AWS Service Endpoints" chapter of the
     ...
     * Balancers</b> in the navigation pane, select the load balancer, and get
     * the value of the <b>Hosted zone</b> field on the <b>Description</b> tab.
     * </p>
     * </li>
     * <li>
     * <p>
     * <b>Elastic Load Balancing API</b>: Use <code>DescribeLoadBalancers</code>
     ...
     * >DescribeLoadBalancers</a> to get the value of
     * <code>CanonicalHostedZoneNameId</code>.
     * </p>
     * </li>
     * <li>
     * <p>
     ...
     * >DescribeLoadBalancers</a> to get the value of
     * <code>CanonicalHostedZoneId</code>.
     * </p>
     * </li>
     * </ul>
     * </li>
     ...
     * >describe-load-balancers</a> to get the value of
     * <code>CanonicalHostedZoneNameId</code>.
     * </p>
     * </li>
     * <li>
     ...
     * applicable value using the AWS CLI command <a href=
     * "https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-domain-names.html"
     * >get-domain-names</a>:
     * </p>
     * <ul>
     ...
     * name for your API, such as <code>api.example.com</code>.
     * </p>
     * </note></dd>
     * <dt>Amazon Virtual Private Cloud interface VPC endpoint</dt>
     * <dd>
     ...
     * name <code>my-environment.<i>us-west-2</i>.elasticbeanstalk.com</code> is
     ...
     * <li>
     * <p>
     * <i>AWS Management Console</i>: For information about how to get the value
     * by using the console, see <a href=
     * "https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/customdomains.html"
     * >Using Custom Domains with AWS Elastic Beanstalk</a> in the <i>AWS
     ...
     * Balancers</b> in the navigation pane, choose the load balancer, choose
     * the <b>Description</b> tab, and get the value of the <b>DNS name</b>
     * field.
     * </p>
     * <p>
     * If you're routing traffic to a Classic Load Balancer, get the value that
     * begins with <b>dualstack</b>. If you're routing traffic to another type
     ...
     * <p>
     * <b>Elastic Load Balancing API</b>: Use <code>DescribeLoadBalancers</code>
     * to get the value of <code>DNSName</code>. For more information, see the
     * applicable guide:
     * </p>
     * <ul>
     * <li>
     ...
     * <li>
     * <p>
     * <b>AWS CLI</b>: Use <code>describe-load-balancers</code> to get the value
     * of <code>DNSName</code>. For more information, see the applicable guide:
     * </p>
     * <ul>
     * <li>
     * <p>
     ...
     * <li>
     * <p>
     * <b>Global Accelerator API:</b> To get the DNS name, use <a href=
     ...
     * <li>
     * <p>
     * <b>AWS CLI:</b> To get the DNS name, use <a href=
     ...
     * <code>s3-website.us-east-2.amazonaws.com</code>. For more information
     ...
     * <dd>
     * <p>
     * Specify the value of the <code>Name</code> element for a resource record
     ...
     * record for which the value of <code>Type</code> is <code>CNAME</code>.
     * This is because the alias record must have the same type as the record
     * that you're routing traffic to, and creating a CNAME record for the zone
     ...
     * alias, and weighted alias resource record sets:</i> When
     ...
     * <dd>
     * <p>
     * If you specify an Elastic Beanstalk environment in <code>DNSName</code>
     ...
     * registered with the load balancer. (An environment automatically contains
     * an ELB load balancer if it includes more than one Amazon EC2 instance.)
     * If you set <code>EvaluateTargetHealth</code> to <code>true</code> and
     * either no Amazon EC2 instances are healthy or the load balancer itself is
     ...
     * <li>
     * <p>
     * <b>Classic Load Balancers</b>: If you specify an ELB Classic Load
     * Balancer in <code>DNSName</code>, Elastic Load Balancing routes queries
     ...
     * <code>true</code> and either no EC2 instances are healthy or the load
     ...
     * queries to the load balancer based on the health of the target groups
     ...
     * healthy target. If any target group contains only unhealthy targets, the
     * load balancer is considered unhealthy, and Route 53 routes queries to
     * other resources.
     * </p>
     * </li>
     * <li>
     ...
     * <dd>
     * <p>
     * If the AWS resource that you specify in <code>DNSName</code> is a record
     * or a group of records (for example, a group of weighted records) but is
     * not another alias record, we recommend that you associate a health check
     * with all of the records in the alias target. For more information, see <a
     * href=
     ...
     *
     * @return <p>
     *         <i>Alias resource records sets only</i>: The value used depends
     *         on where you want to route traffic:
     *         </p>
     *         <dl>
     ...
     *         <code>regionalHostedZoneId</code>.
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     ...
     *         get the value of <code>HostedZoneId</code> using the AWS CLI
     *         command <a href=
     *         "https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-vpc-endpoints.html"
     *         >describe-vpc-endpoints</a>.
     *         </p>
     ...
     *         zone IDs, see <a href=
     *         "https://docs.aws.amazon.com/general/latest/gr/rande.html#elasticbeanstalk_region"
     *         >AWS Elastic Beanstalk</a> in the "AWS Service Endpoints" chapter
     ...
     *         <li>
     *         <p>
     *         <a href="https://docs.aws.amazon.com/general/latest/gr/elb.html">
     *         Service Endpoints</a> table in the
     *         "Elastic Load Balancing Endpoints and Quotas" topic in the
     *         <i>Amazon Web Services General Reference</i>: Use the value that
     ...
     *         <b>Load Balancers</b> in the navigation pane, select the load
     *         balancer, and get the value of the <b>Hosted zone</b> field on
     *         the <b>Description</b> tab.
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     ...
     *         <li>
     *         <p>
     *         <b>AWS CLI</b>: Use <code>describe-load-balancers</code> to get
     *         the applicable value. For more information, see the applicable
     *         guide:
     *         </p>
     *         <ul>
     *         <li>
     ...
     *         <a href=
     *         "https://docs.aws.amazon.com/general/latest/gr/s3.html#s3_website_region_endpoints"
     *         >Amazon S3 Website Endpoints</a> in the <i>Amazon Web Services
     *         General Reference</i>.
     *         </p>
     *         </dd>
     *         <dt>Another Route 53 resource record set in your hosted zone</dt>
     ...
     *         resource record set can't reference a resource record set in a
     ...
     *            <i>Alias resource records sets only</i>: The value used
     ...
     *            can get the value of <code>HostedZoneId</code> using the AWS
     *            CLI command <a href=
     *            "https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-vpc-endpoints.html"
     *            >describe-vpc-endpoints</a>.
     *            </p>
     ...
     *            <note>
     *            <p>
     *            Alias resource record sets for CloudFront can't be created in
     *            a private zone.
     *            </p>
     *            </note></dd>
     *            <dt>Elastic Beanstalk environment</dt>
     ...
     *            zone IDs, see <a href=
     *            "https://docs.aws.amazon.com/general/latest/gr/rande.html#elasticbeanstalk_region"
     *            >AWS Elastic Beanstalk</a> in the "AWS Service Endpoints"
     ...
     *            >Service Endpoints</a> table in the
     *            "Elastic Load Balancing Endpoints and Quotas" topic in the
     *            <i>Amazon Web Services General Reference</i>: Use the value
     *            that corresponds with the region that you created your load
     *            balancer in. Note that there are separate columns for
     ...
     *            <li>
     *            <p>
     *            <b>AWS Management Console</b>: Go to the Amazon EC2 page,
     *            choose <b>Load Balancers</b> in the navigation pane, select
     *            the load balancer, and get the value of the <b>Hosted zone</b>
     *            field on the <b>Description</b> tab.
     *            </p>
     *            </li>
     *            <li>
     *            <p>
     *            <b>Elastic Load Balancing API</b>: Use
     *            <code>DescribeLoadBalancers</code> to get the applicable
     ...
     *            <li>
     *            <p>
     *            <b>AWS CLI</b>: Use <code>describe-load-balancers</code> to
     ...
     *
     * @return <p>
     *         <i>Alias resource record sets only:</i> The value that you
     ...
     *         <code>da1b2c3d4e5.cloudfront.net</code>.
     *         </p>
     *         </li>
     *         </ul>
     *         <note>
     ...
     *         domain name for your API, such as <code>api.example.com</code>.
     *         </p>
     *         </note></dd>
     *         <dt>Amazon Virtual Private Cloud interface VPC endpoint</dt>
     *         <dd>
     ...
     *         <code>DnsName</code> using the AWS CLI command <a href=
     *         "https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-vpc-endpoints.html"
     *         >describe-vpc-endpoints</a>.
     *         </p>
     *         </dd>
     ...
     *         the name of the record. However, the primary and secondary
     *         records have the same name, and you can't include the same
     ...
     *         <dd>
     *         <p>
     *         If the domain name for your Elastic Beanstalk environment
     *         includes the region that you deployed the environment in, you can
     *         create an alias record that routes traffic to the environment.
     ...
     *         subdomains, specify the <code>CNAME</code> attribute for the
     *         environment. You can use the following methods to get the value
     *         of the CNAME attribute:
     *         </p>
     *         <ul>
     *         <li>
     *         <p>
     *         <i>AWS Management Console</i>: For information about how to get
     *         the value by using the console, see <a href=
     *         "https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/customdomains.html"
     *         >Using Custom Domains with AWS Elastic Beanstalk</a> in the
     ...
     *         <li>
     *         <p>
     *         <i>AWS CLI</i>: Use the <code>describe-environments</code>
     *         command to get the value of the <code>CNAME</code> attribute. For
     *         more information, see <a href=
     *         "https://docs.aws.amazon.com/cli/latest/reference/elasticbeanstalk/describe-environments.html"
     *         >describe-environments</a> in the <i>AWS CLI Command
     *         Reference</i>.
     *         </p>
     *         </li>
     *         </ul>
     ...
     *         Get the DNS name by using the AWS Management Console, the ELB
     *         API, or the AWS CLI.
     *         </p>
     *         <ul>
     *         <li>
     *         <p>
     *         <b>AWS Management Console</b>: Go to the EC2 page, choose <b>Load
     *         Balancers</b> in the navigation pane, choose the load balancer,
     *         choose the <b>Description</b> tab, and get the value of the
     *         <b>DNS name</b> field.
     *         </p>
     *         <p>
     *         If you're routing traffic to a Classic Load Balancer, get the
     *         value that begins with <b>dualstack</b>. If you're routing
     *         traffic to another type of load balancer, get the value that
     ...
     *         <p>
     *         <b>AWS CLI</b>: Use <code>describe-load-balancers</code> to get
     *         the value of <code>DNSName</code>. For more information, see the
     *         applicable guide:
     *         </p>
     *         <ul>
     *         <li>
     ...
     *         <dd>
     *         <p>
     *         Specify the domain name of the Amazon S3 website endpoint that
     *         you created the bucket in, for example,
     *         <code>s3-website.us-east-2.amazonaws.com</code>. For more
     *         information about valid values, see the table <a href=
     *         "https://docs.aws.amazon.com/general/latest/gr/s3.html#s3_website_region_endpoints"
     *         >Amazon S3 Website Endpoints</a> in the <i>Amazon Web Services
     *         General Reference</i>. For more information about using S3
     *         buckets for websites, see <a href=
     *         "https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/getting-started.html"
     *         >Getting Started with Amazon Route 53</a> in the <i>Amazon Route
     ...
     *         <dd>
     *         <p>
     *         Specify the value of the <code>Name</code> element for a resource
     ...
     *         domain name for a record for which the value of <code>Type</code>
     *         is <code>CNAME</code>. This is because the alias record must have
     *         the same type as the record that you're routing traffic to, and
     ...
     *            <dd>
     *            <p>
     *            Specify the applicable domain name for your API. You can get
     *            the applicable value using the AWS CLI command <a href=
     *            "https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-domain-names.html"
     *            >get-domain-names</a>:
     *            </p>
     *            <ul>
     ...
     *            <note>
     *            <p>
     *            The name of the record that you're creating must match a
     ...
     *            of <code>DnsName</code> using the AWS CLI command <a href=
     *            "https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-vpc-endpoints.html"
     *            >describe-vpc-endpoints</a>.
     *            </p>
     *            </dd>
     ...
     *            <dd>
     *            <p>
     *            Specify the domain name that CloudFront assigned when you
     ...
     *            </p>
     *            <p>
     *            You can't create a resource record set in a private hosted
     ...
     *            For failover alias records, you can't specify a CloudFront
     *            distribution for both the primary and secondary records. A
     *            distribution must include an alternate domain name that
     *            matches the name of the record. However, the primary and
     *            secondary records have the same name, and you can't include
     ...
     *            <p>
     *            If the domain name for your Elastic Beanstalk environment
     *            includes the region that you deployed the environment in, you
     *            can create an alias record that routes traffic to the
     ...
     *            <important>
     *            <p>
     *            For environments that were created before early 2016, the
     *            domain name doesn't include the region. To route traffic to
     *            these environments, you must create a CNAME record instead of
     *            an alias record. Note that you can't create a CNAME record for
     *            the root domain name. For example, if your domain name is
     *            example.com, you can create a record that routes traffic for
     *            acme.example.com to your Elastic Beanstalk environment, but
     *            you can't create a record that routes traffic for example.com
     ...
     *            <li>
     *            <p>
     *            <i>AWS Management Console</i>: For information about how to
     *            get the value by using the console, see <a href=
     *            "https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/customdomains.html"
     *            >Using Custom Domains with AWS Elastic Beanstalk</a> in the
     *            <i>AWS Elastic Beanstalk Developer Guide</i>.
     *            </p>
     ...
     *            <p>
     *            <i>Elastic Beanstalk API</i>: Use the
     *            <code>DescribeEnvironments</code> action to get the value of
     ...
     *            balancer. Get the DNS name by using the AWS Management
     *            Console, the ELB API, or the AWS CLI.
     *            </p>
     *            <ul>
     *            <li>
     *            <p>
     *            <b>AWS Management Console</b>: Go to the EC2 page, choose
     *            <b>Load Balancers</b> in the navigation pane, choose the load
     *            balancer, choose the <b>Description</b> tab, and get the value
     *            of the <b>DNS name</b> field.
     *            </p>
     *            <p>
     *            If you're routing traffic to a Classic Load Balancer, get the
     *            value that begins with <b>dualstack</b>. If you're routing
     ...
     *            <p>
     *            <b>AWS CLI</b>: Use <code>describe-load-balancers</code> to
     *            get the value of <code>DNSName</code>. For more information,
     ...
     *            buckets for websites, see <a href=
     *            "https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/getting-started.html"
     *            >Getting Started with Amazon Route 53</a> in the <i>Amazon
     *            Route 53 Developer Guide.</i>
     *            </p>
     *            </dd>
     *            <dt>Another Route 53 resource record set</dt>
     *            <dd>
     *            <p>
     *            Specify the value of the <code>Name</code> element for a
     ...
     *            the domain name for a record for which the value of
     *            <code>Type</code> is <code>CNAME</code>. This is because the
     *            alias record must have the same type as the record that you're
     ...
     *
     * @return <p>
     *         <i>Applies only to alias, failover alias, geolocation alias,
     *         latency alias, and weighted alias resource record sets:</i> When
     *         <code>EvaluateTargetHealth</code> is <code>true</code>, an alias
     *         resource record set inherits the health of the referenced AWS
     *         resource, such as an ELB load balancer or another resource record
     ...
     *         <dd>
     *         <p>
     *         You can't set <code>EvaluateTargetHealth</code> to
     *         <code>true</code> when the alias target is a CloudFront
     *         distribution.
     *         </p>
     *         </dd>
     *         <dt>Elastic Beanstalk environments that have regionalized
     *         subdomains</dt>
     *         <dd>
     *         <p>
     *         If you specify an Elastic Beanstalk environment in
     *         <code>DNSName</code> and the environment contains an ELB load
     ...
     *         balancer if it includes more than one Amazon EC2 instance.) If
     ...
     *         <p>
     *         <b>Classic Load Balancers</b>: If you specify an ELB Classic Load
     *         Balancer in <code>DNSName</code>, Elastic Load Balancing routes
     *         queries only to the healthy Amazon EC2 instances that are
     *         registered with the load balancer. If you set
     *         <code>EvaluateTargetHealth</code> to <code>true</code> and either
     *         no EC2 instances are healthy or the load balancer itself is
     *         unhealthy, Route 53 routes queries to other resources.
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     *         <b>Application and Network Load Balancers</b>: If you specify an
     *         ELB Application or Network Load Balancer and you set
     *         <code>EvaluateTargetHealth</code> to <code>true</code>, Route 53
     *         routes queries to the load balancer based on the health of the
     ...
     *         least one healthy target. If any target group contains only
     ...
     *         <dd>
     *         <p>
     *         If the AWS resource that you specify in <code>DNSName</code> is a
     *         record or a group of records (for example, a group of weighted
     ...
     * </p>
     *
     * @param evaluateTargetHealth <p>
     *            <i>Applies only to alias, failover alias, geolocation alias,
     *            latency alias, and weighted alias resource record sets:</i>
     *            When <code>EvaluateTargetHealth</code> is <code>true</code>,
     *            an alias resource record set inherits the health of the
     *            referenced AWS resource, such as an ELB load balancer or
     ...
     *            </p>
     *            <p>
     *            If the environment contains a single Amazon EC2 instance,
     ...
     *            <li>
     *            <p>
     *            <b>Classic Load Balancers</b>: If you specify an ELB Classic
     *            Load Balancer in <code>DNSName</code>, Elastic Load Balancing
     *            routes queries only to the healthy Amazon EC2 instances that
     ...
     *            itself is unhealthy, Route 53 routes queries to other
     *            resources.
     *            </p>
     *            </li>
     *            <li>
     *            <p>
     *            <b>Application and Network Load Balancers</b>: If you specify
     *            an ELB Application or Network Load Balancer and you set
     *            <code>EvaluateTargetHealth</code> to <code>true</code>, Route
     *            53 routes queries to the load balancer based on the health of
     *            the target groups that are associated with the load balancer:
     *            </p>
     *            <ul>
     *            <li>
     *            <p>
     ...
     *            <p>
     *            When you create a load balancer, you configure settings for
     *            Elastic Load Balancing health checks; they're not Route 53
     *            health checks, but they perform a similar function. Do not
     *            create Route 53 health checks for the EC2 instances that you
     ...
     *            <p>
     *            There are no special requirements for setting
     *            <code>EvaluateTargetHealth</code> to <code>true</code> when
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getEvaluateTargetHealth() == null) ? 0 : getEvaluateTargetHealth().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getEvaluateTargetHealth() != null
                && other.getEvaluateTargetHealth().equals(this.getEvaluateTargetHealth()) == false)
            return false;
        return true;
    }
}
