...
/**
 * StAX unmarshaller for model Change
 */
class ChangeStaxUnmarshaller implements Unmarshaller<Change, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("ResourceRecordSet", targetDepth)) {
                    change.setResourceRecordSet(ResourceRecordSetStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
