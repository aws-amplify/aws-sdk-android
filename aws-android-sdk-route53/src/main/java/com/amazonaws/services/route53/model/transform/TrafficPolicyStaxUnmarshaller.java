...
/**
 * StAX unmarshaller for model TrafficPolicy
 */
class TrafficPolicyStaxUnmarshaller implements Unmarshaller<TrafficPolicy, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("Version", targetDepth)) {
                    trafficPolicy.setVersion(IntegerStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                ...
                if (context.testExpression("Document", targetDepth)) {
                    trafficPolicy.setDocument(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Comment", targetDepth)) {
                    trafficPolicy.setComment(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
