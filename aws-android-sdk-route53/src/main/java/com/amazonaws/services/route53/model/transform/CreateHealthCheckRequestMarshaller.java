...
/**
 * StAX request marshaller for CreateHealthCheckRequest
 */
    ...
    public Request<CreateHealthCheckRequest> marshall(
        ...
        if (createHealthCheckRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateHealthCheckRequest)");
        }
        ...
        request.addParameter("Action", "CreateHealthCheck");
        request.addParameter("Version", "2013-04-01");

        String prefix;
        if (createHealthCheckRequest.getCallerReference() != null) {
            prefix = "CallerReference";
            String callerReference = createHealthCheckRequest.getCallerReference();
            request.addParameter(prefix, StringUtils.fromString(callerReference));
        }
        if (createHealthCheckRequest.getHealthCheckConfig() != null) {
            prefix = "HealthCheckConfig";
