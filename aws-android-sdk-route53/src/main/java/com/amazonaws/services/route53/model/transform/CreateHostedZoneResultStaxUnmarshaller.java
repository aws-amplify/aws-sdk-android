...
/**
 * StAX unmarshaller for response CreateHostedZoneResult
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("HostedZone", targetDepth)) {
                    createHostedZoneResult.setHostedZone(HostedZoneStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ChangeInfo", targetDepth)) {
                    createHostedZoneResult.setChangeInfo(ChangeInfoStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("DelegationSet", targetDepth)) {
                    createHostedZoneResult.setDelegationSet(DelegationSetStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("VPC", targetDepth)) {
                    createHostedZoneResult.setVPC(VPCStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Location", targetDepth)) {
                    createHostedZoneResult.setLocation(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
