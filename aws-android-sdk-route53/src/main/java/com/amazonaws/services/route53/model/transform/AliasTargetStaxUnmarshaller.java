...
/**
 * StAX unmarshaller for model AliasTarget
 */
class AliasTargetStaxUnmarshaller implements Unmarshaller<AliasTarget, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("HostedZoneId", targetDepth)) {
                    aliasTarget.setHostedZoneId(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("DNSName", targetDepth)) {
                    aliasTarget
                            .setDNSName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("EvaluateTargetHealth", targetDepth)) {
                    aliasTarget.setEvaluateTargetHealth(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
