...
/**
 * StAX unmarshaller for model LinkedService
 */
class LinkedServiceStaxUnmarshaller implements Unmarshaller<LinkedService, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ServicePrincipal", targetDepth)) {
                    linkedService.setServicePrincipal(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Description", targetDepth)) {
                    linkedService.setDescription(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
