...
/**
 * JSON unmarshaller for POJO CdnConfiguration
 */
class CdnConfigurationJsonUnmarshaller implements
        Unmarshaller<CdnConfiguration, JsonUnmarshallerContext> {
    ...
    public CdnConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AdSegmentUrlPrefix")) {
                cdnConfiguration.setAdSegmentUrlPrefix(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ContentSegmentUrlPrefix")) {
                cdnConfiguration.setContentSegmentUrlPrefix(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
