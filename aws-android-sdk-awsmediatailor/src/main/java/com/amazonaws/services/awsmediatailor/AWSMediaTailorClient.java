...
import com.amazonaws.services.awsmediatailor.model.transform.*;
...
public class AWSMediaTailorClient extends AmazonWebServiceClient implements AWSMediaTailor {
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/awsmediatailor/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/awsmediatailor/request.handler2s"));
    }
