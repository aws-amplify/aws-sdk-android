...
/**
 * Tests that the CreateTableRequest generated by
 * DynamoDBMapper.generateCreateTableRequest correctly creates the expected
 * table.
 */
public class GenerateCreateTableRequestIntegrationTest extends DynamoDBTestBase {
    ...
    public void testParseIndexRangeKeyClass() {
        ...
        TableDescription createdTableDescription = dynamo.createTable(request)
                .getTableDescription();
        ...
        Tables.waitForTableToBecomeActive(dynamo, createdTableName);
    }

    @Test
    public void testComplexIndexedHashRangeClass() {
        CreateTableRequest request = mapper
                .generateCreateTableRequest(MapperQueryExpressionTest.HashRangeClass.class);
        String createdTableName = appendCurrentTimeToTableName(request);
        testedTableName.add(createdTableName);
        setProvisionedThroughput(request, DEFAULT_CAPACITY);
    ...
    private static void setProvisionedThroughput(CreateTableRequest request,
    ...
    private static boolean equalLsi(Collection<LocalSecondaryIndex> a,
            Collection<LocalSecondaryIndexDescription> b) {
        return UnorderedCollectionComparator.equalUnorderedCollections(a, b,
                new LocalSecondaryIndexDefinitionComparator());
    }

    private static boolean equalGsi(Collection<GlobalSecondaryIndex> a,
            Collection<GlobalSecondaryIndexDescription> b) {
        return UnorderedCollectionComparator.equalUnorderedCollections(a, b,
                new GlobalSecondaryIndexDefinitionComparator());
    }
    ...
    private static String appendCurrentTimeToTableName(CreateTableRequest request) {
        String appendedName = String.format("%s-%d", request.getTableName(),
