...
public class ListRecordsResult implements Serializable {
     ...
     */
    private java.util.List<String> mergedDatasetNames;
    ...
    public void setMergedDatasetNames(java.util.Collection<String> mergedDatasetNames) {
        ...
        this.mergedDatasetNames = new java.util.ArrayList<String>(mergedDatasetNames);
    }
    ...
    public ListRecordsResult withMergedDatasetNames(String... mergedDatasetNames) {
        if (getMergedDatasetNames() == null) {
            this.mergedDatasetNames = new java.util.ArrayList<String>(mergedDatasetNames.length);
        }
        for (String value : mergedDatasetNames) {
            this.mergedDatasetNames.add(value);
        }
        return this;
    }
     ...
     * A boolean value specifying whether to delete the dataset locally.
     *
     * @param datasetDeletedAfterRequestedSyncCount A boolean value specifying
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getDatasetSyncCount() == null) ? 0 : getDatasetSyncCount().hashCode());
        hashCode = prime * hashCode
                + ((getLastModifiedBy() == null) ? 0 : getLastModifiedBy().hashCode());
        hashCode = prime * hashCode
                + ((getMergedDatasetNames() == null) ? 0 : getMergedDatasetNames().hashCode());
        hashCode = prime * hashCode
                + ((getDatasetExists() == null) ? 0 : getDatasetExists().hashCode());
        hashCode = prime
                * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDatasetSyncCount() != null
                && other.getDatasetSyncCount().equals(this.getDatasetSyncCount()) == false)
            return false;
        ...
        if (other.getMergedDatasetNames() != null
                && other.getMergedDatasetNames().equals(this.getMergedDatasetNames()) == false)
            return false;
