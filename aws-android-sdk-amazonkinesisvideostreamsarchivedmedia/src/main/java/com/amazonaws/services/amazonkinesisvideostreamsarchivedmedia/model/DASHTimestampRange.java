 ...
 * </note>
 */
public class DASHTimestampRange implements Serializable {
    /**
     * <p>
     ...
     * be within 3 hours of the specified <code>StartTimestamp</code>, and it
     ...
     *         <p>
     *         This value is inclusive. Fragments that start before the
     *         <code>StartTimestamp</code> and continue past it are included in
     *         the session. If <code>FragmentSelectorType</code> is
     ...
     *            <p>
     *            This value is inclusive. Fragments that start before the
     *            <code>StartTimestamp</code> and continue past it are included
     *            in the session. If <code>FragmentSelectorType</code> is
     *            <code>SERVER_TIMESTAMP</code>, the <code>StartTimestamp</code>
     *            must be later than the stream head.
     *            </p>
     *            </note>
     ...
     *         value must be within 3 hours of the specified
