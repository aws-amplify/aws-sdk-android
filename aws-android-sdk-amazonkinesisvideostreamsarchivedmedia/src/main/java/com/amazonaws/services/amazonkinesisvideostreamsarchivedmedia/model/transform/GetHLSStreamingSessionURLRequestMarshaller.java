...
public class GetHLSStreamingSessionURLRequestMarshaller implements
    ...
    public Request<GetHLSStreamingSessionURLRequest> marshall(
        ...
        Request<GetHLSStreamingSessionURLRequest> request = new DefaultRequest<GetHLSStreamingSessionURLRequest>(
                getHLSStreamingSessionURLRequest, "AmazonKinesisVideoStreamsArchivedMedia");
        ...
        try {
            ...
            if (getHLSStreamingSessionURLRequest.getContainerFormat() != null) {
                String containerFormat = getHLSStreamingSessionURLRequest.getContainerFormat();
            ...
            if (getHLSStreamingSessionURLRequest.getDisplayFragmentTimestamp() != null) {
                String displayFragmentTimestamp = getHLSStreamingSessionURLRequest
