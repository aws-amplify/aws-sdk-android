 ...
 * </p>
 */
public class AssociateDiscoveredResourceRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public AssociateDiscoveredResourceRequest withDiscoveredResource(
    ...
    public String toString() {
        ...
        if (getDiscoveredResource() != null)
            sb.append("DiscoveredResource: " + getDiscoveredResource() + ",");
        if (getDryRun() != null)
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getDiscoveredResource() == null) ? 0 : getDiscoveredResource().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDiscoveredResource() == null ^ this.getDiscoveredResource() == null)
            return false;
        if (other.getDiscoveredResource() != null
                && other.getDiscoveredResource().equals(this.getDiscoveredResource()) == false)
            return false;
