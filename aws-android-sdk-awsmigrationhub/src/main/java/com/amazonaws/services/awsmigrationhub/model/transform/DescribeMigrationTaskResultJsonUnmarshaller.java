...
/**
 * JSON unmarshaller for response DescribeMigrationTaskResult
 */
public class DescribeMigrationTaskResultJsonUnmarshaller implements
        Unmarshaller<DescribeMigrationTaskResult, JsonUnmarshallerContext> {
    ...
    public DescribeMigrationTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("MigrationTask")) {
                describeMigrationTaskResult.setMigrationTask(MigrationTaskJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
