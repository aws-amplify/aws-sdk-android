...
/**
 * JSON unmarshaller for response DisassociateDiscoveredResourceResult
 */
public class DisassociateDiscoveredResourceResultJsonUnmarshaller implements
        Unmarshaller<DisassociateDiscoveredResourceResult, JsonUnmarshallerContext> {

    public DisassociateDiscoveredResourceResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
