...
/**
 * JSON unmarshaller for response CreateProgressUpdateStreamResult
 */
public class CreateProgressUpdateStreamResultJsonUnmarshaller implements
        Unmarshaller<CreateProgressUpdateStreamResult, JsonUnmarshallerContext> {

    public CreateProgressUpdateStreamResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
