...
/**
 * JSON unmarshaller for POJO DiscoveredResource
 */
class DiscoveredResourceJsonUnmarshaller implements
        Unmarshaller<DiscoveredResource, JsonUnmarshallerContext> {
    ...
    public DiscoveredResource unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ConfigurationId")) {
                discoveredResource.setConfigurationId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Description")) {
                discoveredResource.setDescription(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
