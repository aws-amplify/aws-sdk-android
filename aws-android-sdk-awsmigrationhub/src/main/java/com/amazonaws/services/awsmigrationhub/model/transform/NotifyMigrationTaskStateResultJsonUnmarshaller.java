...
/**
 * JSON unmarshaller for response NotifyMigrationTaskStateResult
 */
public class NotifyMigrationTaskStateResultJsonUnmarshaller implements
        Unmarshaller<NotifyMigrationTaskStateResult, JsonUnmarshallerContext> {

    public NotifyMigrationTaskStateResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
