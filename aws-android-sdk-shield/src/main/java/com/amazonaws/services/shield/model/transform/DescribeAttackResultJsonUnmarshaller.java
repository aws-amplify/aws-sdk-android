...
/**
 * JSON unmarshaller for response DescribeAttackResult
 */
public class DescribeAttackResultJsonUnmarshaller implements
        Unmarshaller<DescribeAttackResult, JsonUnmarshallerContext> {
    ...
    public DescribeAttackResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Attack")) {
                describeAttackResult.setAttack(AttackDetailJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
