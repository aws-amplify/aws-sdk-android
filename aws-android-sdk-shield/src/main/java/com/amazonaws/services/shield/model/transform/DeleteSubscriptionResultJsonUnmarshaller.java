...
/**
 * JSON unmarshaller for response DeleteSubscriptionResult
 */
public class DeleteSubscriptionResultJsonUnmarshaller implements
        Unmarshaller<DeleteSubscriptionResult, JsonUnmarshallerContext> {
