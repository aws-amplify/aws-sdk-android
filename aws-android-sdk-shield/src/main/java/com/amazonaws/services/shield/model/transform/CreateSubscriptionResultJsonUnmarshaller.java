...
/**
 * JSON unmarshaller for response CreateSubscriptionResult
 */
public class CreateSubscriptionResultJsonUnmarshaller implements
        Unmarshaller<CreateSubscriptionResult, JsonUnmarshallerContext> {
