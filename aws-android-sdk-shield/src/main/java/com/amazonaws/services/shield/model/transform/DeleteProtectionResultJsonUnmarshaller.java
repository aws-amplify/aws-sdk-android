...
/**
 * JSON unmarshaller for response DeleteProtectionResult
 */
public class DeleteProtectionResultJsonUnmarshaller implements
        Unmarshaller<DeleteProtectionResult, JsonUnmarshallerContext> {
