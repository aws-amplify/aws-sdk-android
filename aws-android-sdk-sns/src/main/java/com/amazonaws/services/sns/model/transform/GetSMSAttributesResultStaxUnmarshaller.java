...
/**
 * StAX unmarshaller for response GetSMSAttributesResult
 */
public class GetSMSAttributesResultStaxUnmarshaller implements
        Unmarshaller<GetSMSAttributesResult, StaxUnmarshallerContext> {
