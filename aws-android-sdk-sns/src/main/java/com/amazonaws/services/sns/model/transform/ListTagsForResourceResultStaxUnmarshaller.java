...
public class ListTagsForResourceResultStaxUnmarshaller implements Unmarshaller<ListTagsForResourceResult, StaxUnmarshallerContext> {
    ...
    public ListTagsForResourceResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return listTagsForResourceResult;

            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Tags/member", targetDepth)) {
                    listTagsForResourceResult.getTags().add(TagStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    listTagsForResourceResult.setNextToken(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
