...
/**
 * StAX unmarshaller for response ListEndpointsByPlatformApplicationResult
 */
public class ListEndpointsByPlatformApplicationResultStaxUnmarshaller implements
    ...
    public ListEndpointsByPlatformApplicationResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    listEndpointsByPlatformApplicationResult.setNextToken(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
