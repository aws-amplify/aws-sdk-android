...
/**
 * StAX marshaller for POJO Topic
 */
class TopicStaxMarshaller {

    public void marshall(Topic _topic, Request<?> request, String _prefix) {
        String prefix;
        if (_topic.getTopicArn() != null) {
            prefix = _prefix + "TopicArn";
            String topicArn = _topic.getTopicArn();
