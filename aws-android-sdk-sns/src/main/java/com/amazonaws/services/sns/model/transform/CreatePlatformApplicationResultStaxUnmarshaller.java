...
/**
 * StAX unmarshaller for response CreatePlatformApplicationResult
 */
public class CreatePlatformApplicationResultStaxUnmarshaller implements
        Unmarshaller<CreatePlatformApplicationResult, StaxUnmarshallerContext> {

    public CreatePlatformApplicationResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("PlatformApplicationArn", targetDepth)) {
                    createPlatformApplicationResult
                            .setPlatformApplicationArn(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
