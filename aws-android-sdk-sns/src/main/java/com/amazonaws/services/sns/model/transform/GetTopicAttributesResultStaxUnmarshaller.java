...
/**
 * StAX unmarshaller for response GetTopicAttributesResult
 */
public class GetTopicAttributesResultStaxUnmarshaller implements
        Unmarshaller<GetTopicAttributesResult, StaxUnmarshallerContext> {
