...
/**
 * StAX unmarshaller for response CreateSMSSandboxPhoneNumberResult
 */
public class CreateSMSSandboxPhoneNumberResultStaxUnmarshaller implements
        Unmarshaller<CreateSMSSandboxPhoneNumberResult, StaxUnmarshallerContext> {

    public CreateSMSSandboxPhoneNumberResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
