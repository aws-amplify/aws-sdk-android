...
/**
 * StAX unmarshaller for response ListPhoneNumbersOptedOutResult
 */
public class ListPhoneNumbersOptedOutResultStaxUnmarshaller implements
    ...
    public ListPhoneNumbersOptedOutResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    listPhoneNumbersOptedOutResult.setNextToken(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
