...
/**
 * StAX unmarshaller for response ConfirmSubscriptionResult
 */
public class ConfirmSubscriptionResultStaxUnmarshaller implements
        Unmarshaller<ConfirmSubscriptionResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("SubscriptionArn", targetDepth)) {
                    confirmSubscriptionResult.setSubscriptionArn(StringStaxUnmarshaller
