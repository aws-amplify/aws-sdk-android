...
/**
 * StAX unmarshaller for response ListTopicsResult
 */
public class ListTopicsResultStaxUnmarshaller implements
        Unmarshaller<ListTopicsResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    listTopicsResult.setNextToken(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
