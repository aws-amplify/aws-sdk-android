...
/**
 * StAX unmarshaller for response GetDataProtectionPolicyResult
 */
public class GetDataProtectionPolicyResultStaxUnmarshaller implements
        Unmarshaller<GetDataProtectionPolicyResult, StaxUnmarshallerContext> {

    public GetDataProtectionPolicyResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DataProtectionPolicy", targetDepth)) {
                    getDataProtectionPolicyResult.setDataProtectionPolicy(StringStaxUnmarshaller
