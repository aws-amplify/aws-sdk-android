...
/**
 * StAX unmarshaller for model Endpoint
 */
class EndpointStaxUnmarshaller implements Unmarshaller<Endpoint, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("HostedZoneId", targetDepth)) {
                    endpoint.setHostedZoneId(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
