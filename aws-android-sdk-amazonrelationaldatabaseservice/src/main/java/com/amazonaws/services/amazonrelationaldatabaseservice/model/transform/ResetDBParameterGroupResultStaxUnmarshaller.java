...
/**
 * StAX unmarshaller for response ResetDBParameterGroupResult
 */
public class ResetDBParameterGroupResultStaxUnmarshaller implements
        Unmarshaller<ResetDBParameterGroupResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DBParameterGroupName", targetDepth)) {
                    resetDBParameterGroupResult.setDBParameterGroupName(StringStaxUnmarshaller
