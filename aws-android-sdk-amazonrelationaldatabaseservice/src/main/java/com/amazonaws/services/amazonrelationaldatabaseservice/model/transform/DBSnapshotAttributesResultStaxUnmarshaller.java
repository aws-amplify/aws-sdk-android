...
/**
 * StAX unmarshaller for model DBSnapshotAttributesResult
 */
class DBSnapshotAttributesResultStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DBSnapshotIdentifier", targetDepth)) {
                    dBSnapshotAttributesResult.setDBSnapshotIdentifier(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("DBSnapshotAttributes", targetDepth)) {
                    dBSnapshotAttributesResult
                            .withDBSnapshotAttributes(DBSnapshotAttributeStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
