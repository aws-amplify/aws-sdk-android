...
/**
 * StAX unmarshaller for response DescribeCustomAvailabilityZonesResult
 */
public class DescribeCustomAvailabilityZonesResultStaxUnmarshaller implements
        Unmarshaller<DescribeCustomAvailabilityZonesResult, StaxUnmarshallerContext> {

    public DescribeCustomAvailabilityZonesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeCustomAvailabilityZonesResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("CustomAvailabilityZones", targetDepth)) {
                    describeCustomAvailabilityZonesResult
                            .withCustomAvailabilityZones(CustomAvailabilityZoneStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
