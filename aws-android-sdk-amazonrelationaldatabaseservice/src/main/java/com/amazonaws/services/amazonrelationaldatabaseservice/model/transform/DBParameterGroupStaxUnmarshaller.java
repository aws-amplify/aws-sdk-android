...
/**
 * StAX unmarshaller for model DBParameterGroup
 */
class DBParameterGroupStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DBParameterGroupName", targetDepth)) {
                    dBParameterGroup.setDBParameterGroupName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("DBParameterGroupFamily", targetDepth)) {
                    dBParameterGroup.setDBParameterGroupFamily(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Description", targetDepth)) {
                    dBParameterGroup.setDescription(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("DBParameterGroupArn", targetDepth)) {
                    dBParameterGroup.setDBParameterGroupArn(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
