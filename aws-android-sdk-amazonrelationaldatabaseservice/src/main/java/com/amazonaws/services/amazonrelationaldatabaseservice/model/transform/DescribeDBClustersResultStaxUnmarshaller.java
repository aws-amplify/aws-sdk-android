...
/**
 * StAX unmarshaller for response DescribeDBClustersResult
 */
public class DescribeDBClustersResultStaxUnmarshaller implements
        Unmarshaller<DescribeDBClustersResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeDBClustersResult.setMarker(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("DBClusters", targetDepth)) {
                    describeDBClustersResult.withDBClusters(DBClusterStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
