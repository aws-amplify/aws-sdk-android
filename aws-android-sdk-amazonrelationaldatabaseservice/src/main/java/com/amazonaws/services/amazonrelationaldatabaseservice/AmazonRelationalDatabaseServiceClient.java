...
package com.amazonaws.services.amazonrelationaldatabaseservice;
...
import com.amazonaws.services.amazonrelationaldatabaseservice.model.transform.*;
...
public class AmazonRelationalDatabaseServiceClient extends AmazonWebServiceClient implements
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/amazonrelationaldatabaseservice/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/amazonrelationaldatabaseservice/request.handler2s"));
    }
     ...
     * for the <code>ValuesToAdd</code> parameter. You can't use
