...
/**
 * StAX unmarshaller for model VpcSecurityGroupMembership
 */
class VpcSecurityGroupMembershipStaxUnmarshaller implements
        Unmarshaller<VpcSecurityGroupMembership, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("VpcSecurityGroupId", targetDepth)) {
                    vpcSecurityGroupMembership.setVpcSecurityGroupId(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Status", targetDepth)) {
                    vpcSecurityGroupMembership.setStatus(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
