...
/**
 * StAX unmarshaller for model DBSecurityGroupMembership
 */
class DBSecurityGroupMembershipStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DBSecurityGroupName", targetDepth)) {
                    dBSecurityGroupMembership.setDBSecurityGroupName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Status", targetDepth)) {
                    dBSecurityGroupMembership.setStatus(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
