...
/**
 * StAX unmarshaller for response DescribeReservedDBInstancesOfferingsResult
 */
public class DescribeReservedDBInstancesOfferingsResultStaxUnmarshaller implements
    ...
    public DescribeReservedDBInstancesOfferingsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeReservedDBInstancesOfferingsResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ReservedDBInstancesOfferings", targetDepth)) {
                    describeReservedDBInstancesOfferingsResult
                            .withReservedDBInstancesOfferings(ReservedDBInstancesOfferingStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
