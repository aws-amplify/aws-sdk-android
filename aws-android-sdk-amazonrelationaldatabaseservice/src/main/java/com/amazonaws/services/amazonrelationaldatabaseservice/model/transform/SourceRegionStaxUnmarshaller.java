...
/**
 * StAX unmarshaller for model SourceRegion
 */
class SourceRegionStaxUnmarshaller implements Unmarshaller<SourceRegion, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("RegionName", targetDepth)) {
                    sourceRegion.setRegionName(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
                if (context.testExpression("Endpoint", targetDepth)) {
                    sourceRegion.setEndpoint(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
