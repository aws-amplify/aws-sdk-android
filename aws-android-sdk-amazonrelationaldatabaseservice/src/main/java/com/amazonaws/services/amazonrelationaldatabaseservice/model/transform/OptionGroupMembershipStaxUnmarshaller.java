...
/**
 * StAX unmarshaller for model OptionGroupMembership
 */
class OptionGroupMembershipStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("OptionGroupName", targetDepth)) {
                    optionGroupMembership.setOptionGroupName(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("Status", targetDepth)) {
                    optionGroupMembership.setStatus(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
