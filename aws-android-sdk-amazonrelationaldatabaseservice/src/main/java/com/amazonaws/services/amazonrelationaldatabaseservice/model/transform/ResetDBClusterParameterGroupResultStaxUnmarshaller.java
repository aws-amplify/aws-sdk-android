...
/**
 * StAX unmarshaller for response ResetDBClusterParameterGroupResult
 */
public class ResetDBClusterParameterGroupResultStaxUnmarshaller implements
        Unmarshaller<ResetDBClusterParameterGroupResult, StaxUnmarshallerContext> {

    public ResetDBClusterParameterGroupResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
