...
/**
 * StAX unmarshaller for model ScalingConfiguration
 */
class ScalingConfigurationStaxUnmarshaller implements
        Unmarshaller<ScalingConfiguration, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("MinCapacity", targetDepth)) {
                    scalingConfiguration.setMinCapacity(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("MaxCapacity", targetDepth)) {
                    scalingConfiguration.setMaxCapacity(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("AutoPause", targetDepth)) {
                    scalingConfiguration.setAutoPause(BooleanStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("SecondsUntilAutoPause", targetDepth)) {
                    scalingConfiguration.setSecondsUntilAutoPause(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("TimeoutAction", targetDepth)) {
                    scalingConfiguration.setTimeoutAction(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
