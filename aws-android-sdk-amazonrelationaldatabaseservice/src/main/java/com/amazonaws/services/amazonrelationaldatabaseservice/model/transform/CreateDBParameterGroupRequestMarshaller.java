...
/**
 * StAX request marshaller for CreateDBParameterGroupRequest
 */
public class CreateDBParameterGroupRequestMarshaller implements
    ...
    public Request<CreateDBParameterGroupRequest> marshall(
        ...
        if (createDBParameterGroupRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateDBParameterGroupRequest)");
        }

        Request<CreateDBParameterGroupRequest> request = new DefaultRequest<CreateDBParameterGroupRequest>(
                createDBParameterGroupRequest, "AmazonRelationalDatabaseService");
        ...
        if (createDBParameterGroupRequest.getDBParameterGroupName() != null) {
            ...
            String dBParameterGroupName = createDBParameterGroupRequest.getDBParameterGroupName();
        ...
        if (createDBParameterGroupRequest.getDBParameterGroupFamily() != null) {
            ...
            String dBParameterGroupFamily = createDBParameterGroupRequest
        ...
        if (createDBParameterGroupRequest.getDescription() != null) {
            prefix = "Description";
            String description = createDBParameterGroupRequest.getDescription();
            request.addParameter(prefix, StringUtils.fromString(description));
        }
        if (createDBParameterGroupRequest.getTags() != null) {
            prefix = "Tags";
            java.util.List<Tag> tags = createDBParameterGroupRequest.getTags();
            int tagsIndex = 1;
