...
/**
 * StAX unmarshaller for response DescribeAccountAttributesResult
 */
public class DescribeAccountAttributesResultStaxUnmarshaller implements
    ...
    public DescribeAccountAttributesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("AccountQuotas", targetDepth)) {
                    describeAccountAttributesResult.withAccountQuotas(AccountQuotaStaxUnmarshaller
