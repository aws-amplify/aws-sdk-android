...
/**
 * StAX unmarshaller for model EventCategoriesMap
 */
class EventCategoriesMapStaxUnmarshaller implements
        Unmarshaller<EventCategoriesMap, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("SourceType", targetDepth)) {
                    eventCategoriesMap.setSourceType(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("EventCategories", targetDepth)) {
                    eventCategoriesMap.withEventCategories(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
