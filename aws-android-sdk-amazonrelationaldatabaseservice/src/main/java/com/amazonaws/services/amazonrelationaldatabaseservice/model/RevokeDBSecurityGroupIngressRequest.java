 ...
 * </p>
 */
public class RevokeDBSecurityGroupIngressRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     ...
     *
     * @param cIDRIP <p>
     *            The IP range to revoke access from. Must be a valid CIDR
     *            range. If <code>CIDRIP</code> is specified,
     *            <code>EC2SecurityGroupName</code>,
     *            <code>EC2SecurityGroupId</code> and
     *            <code>EC2SecurityGroupOwnerId</code> can't be provided.
     *            </p>
     ...
     *            The name of the EC2 security group to revoke access from. For
     *            VPC DB security groups, <code>EC2SecurityGroupId</code> must
     ...
     *            The id of the EC2 security group to revoke access from. For
     *            VPC DB security groups, <code>EC2SecurityGroupId</code> must
     *            be provided. Otherwise, EC2SecurityGroupOwnerId and either
     *            <code>EC2SecurityGroupName</code> or
     *            <code>EC2SecurityGroupId</code> must be provided.
