...
/**
 * StAX unmarshaller for response DescribeDBClusterParameterGroupsResult
 */
public class DescribeDBClusterParameterGroupsResultStaxUnmarshaller implements
        Unmarshaller<DescribeDBClusterParameterGroupsResult, StaxUnmarshallerContext> {

    public DescribeDBClusterParameterGroupsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeDBClusterParameterGroupsResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("DBClusterParameterGroups", targetDepth)) {
                    describeDBClusterParameterGroupsResult
                            .withDBClusterParameterGroups(DBClusterParameterGroupStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
