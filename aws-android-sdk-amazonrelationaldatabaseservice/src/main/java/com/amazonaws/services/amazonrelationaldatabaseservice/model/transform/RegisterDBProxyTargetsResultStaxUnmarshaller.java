...
/**
 * StAX unmarshaller for response RegisterDBProxyTargetsResult
 */
public class RegisterDBProxyTargetsResultStaxUnmarshaller implements
        Unmarshaller<RegisterDBProxyTargetsResult, StaxUnmarshallerContext> {

    public RegisterDBProxyTargetsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("DBProxyTargets/member", targetDepth)) {
                    registerDBProxyTargetsResult.withDBProxyTargets(DBProxyTargetStaxUnmarshaller
