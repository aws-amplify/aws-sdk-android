...
/**
 * StAX unmarshaller for response DescribeSourceRegionsResult
 */
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeSourceRegionsResult.setMarker(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("SourceRegions", targetDepth)) {
                    describeSourceRegionsResult.withSourceRegions(SourceRegionStaxUnmarshaller
