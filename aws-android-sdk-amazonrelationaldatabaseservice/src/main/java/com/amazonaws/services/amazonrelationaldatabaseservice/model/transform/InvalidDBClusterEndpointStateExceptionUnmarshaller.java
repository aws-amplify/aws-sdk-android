...
import com.amazonaws.services.amazonrelationaldatabaseservice.model.InvalidDBClusterEndpointStateException;
...
public class InvalidDBClusterEndpointStateExceptionUnmarshaller extends StandardErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        InvalidDBClusterEndpointStateException e = (InvalidDBClusterEndpointStateException) super
                .unmarshall(node);
