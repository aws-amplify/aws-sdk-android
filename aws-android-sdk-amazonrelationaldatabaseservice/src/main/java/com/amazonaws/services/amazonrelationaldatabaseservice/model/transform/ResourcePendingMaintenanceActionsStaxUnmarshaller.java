...
/**
 * StAX unmarshaller for model ResourcePendingMaintenanceActions
 */
class ResourcePendingMaintenanceActionsStaxUnmarshaller implements
        Unmarshaller<ResourcePendingMaintenanceActions, StaxUnmarshallerContext> {

    public ResourcePendingMaintenanceActions unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("ResourceIdentifier", targetDepth)) {
                    resourcePendingMaintenanceActions.setResourceIdentifier(StringStaxUnmarshaller
