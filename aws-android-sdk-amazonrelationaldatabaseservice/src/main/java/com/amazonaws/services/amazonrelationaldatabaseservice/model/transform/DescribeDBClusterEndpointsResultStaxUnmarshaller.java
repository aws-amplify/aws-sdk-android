...
/**
 * StAX unmarshaller for response DescribeDBClusterEndpointsResult
 */
public class DescribeDBClusterEndpointsResultStaxUnmarshaller implements
        Unmarshaller<DescribeDBClusterEndpointsResult, StaxUnmarshallerContext> {

    public DescribeDBClusterEndpointsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeDBClusterEndpointsResult.setMarker(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("DBClusterEndpoints", targetDepth)) {
                    describeDBClusterEndpointsResult
                            .withDBClusterEndpoints(DBClusterEndpointStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
