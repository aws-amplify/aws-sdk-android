...
/**
 * StAX unmarshaller for model RecurringCharge
 */
class RecurringChargeStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("RecurringChargeAmount", targetDepth)) {
                    recurringCharge.setRecurringChargeAmount(DoubleStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("RecurringChargeFrequency", targetDepth)) {
                    recurringCharge.setRecurringChargeFrequency(StringStaxUnmarshaller
