...
public class CreateMedicalVocabularyResult implements Serializable {
     ...
     * Medical. If the state is <code>READY</code> you can use the vocabulary in
     ...
     *            AWS account. It is also case-sensitive.
     *            </p>
     */
     ...
     *
     * @return <p>
     *         The language code you chose to describe the entries in your
     *         custom vocabulary. US English (en-US) is the only valid language
     ...
     *            The language code you chose to describe the entries in your
     *            custom vocabulary. US English (en-US) is the only valid
