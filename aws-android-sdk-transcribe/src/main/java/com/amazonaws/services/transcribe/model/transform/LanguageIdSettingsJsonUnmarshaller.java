...
/**
 * JSON unmarshaller for POJO LanguageIdSettings
 */
class LanguageIdSettingsJsonUnmarshaller implements
        Unmarshaller<LanguageIdSettings, JsonUnmarshallerContext> {
    ...
    public LanguageIdSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("VocabularyName")) {
                languageIdSettings.setVocabularyName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("VocabularyFilterName")) {
                languageIdSettings.setVocabularyFilterName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("LanguageModelName")) {
                languageIdSettings.setLanguageModelName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
