...
/**
 * JSON marshaller for POJO JobExecutionSettings
 */
class JobExecutionSettingsJsonMarshaller {

    public void marshall(JobExecutionSettings jobExecutionSettings, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (jobExecutionSettings.getAllowDeferredExecution() != null) {
            ...
            jsonWriter.name("AllowDeferredExecution");
            jsonWriter.value(allowDeferredExecution);
        }
