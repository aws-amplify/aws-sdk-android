...
public class CreateVocabularyRequestMarshaller implements
    ...
    public Request<CreateVocabularyRequest> marshall(CreateVocabularyRequest createVocabularyRequest) {
        ...
        Request<CreateVocabularyRequest> request = new DefaultRequest<CreateVocabularyRequest>(
                createVocabularyRequest, "AmazonTranscribe");
        ...
        try {
            ...
            if (createVocabularyRequest.getPhrases() != null) {
                java.util.List<String> phrases = createVocabularyRequest.getPhrases();
            ...
            if (createVocabularyRequest.getDataAccessRoleArn() != null) {
                String dataAccessRoleArn = createVocabularyRequest.getDataAccessRoleArn();
