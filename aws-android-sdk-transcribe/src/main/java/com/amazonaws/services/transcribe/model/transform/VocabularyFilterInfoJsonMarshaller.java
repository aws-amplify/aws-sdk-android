...
/**
 * JSON marshaller for POJO VocabularyFilterInfo
 */
class VocabularyFilterInfoJsonMarshaller {

    public void marshall(VocabularyFilterInfo vocabularyFilterInfo, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (vocabularyFilterInfo.getLastModifiedTime() != null) {
            java.util.Date lastModifiedTime = vocabularyFilterInfo.getLastModifiedTime();
