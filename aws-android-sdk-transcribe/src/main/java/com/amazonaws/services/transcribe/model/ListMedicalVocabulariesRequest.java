...
public class ListMedicalVocabulariesRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <code>ListMedicalVocabularies</code> returns both "vocabularyname" and
     ...
     *
     * @return <p>
     *         Returns vocabularies in the list whose name contains the
     *         specified string. The search is case-insensitive,
