...
/**
 * JSON request marshaller for ListVocabulariesRequest
 */
public class ListVocabulariesRequestMarshaller implements
        Marshaller<Request<ListVocabulariesRequest>, ListVocabulariesRequest> {
    ...
    public Request<ListVocabulariesRequest> marshall(ListVocabulariesRequest listVocabulariesRequest) {
        if (listVocabulariesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListVocabulariesRequest)");
        }

        Request<ListVocabulariesRequest> request = new DefaultRequest<ListVocabulariesRequest>(
                listVocabulariesRequest, "AmazonTranscribe");
