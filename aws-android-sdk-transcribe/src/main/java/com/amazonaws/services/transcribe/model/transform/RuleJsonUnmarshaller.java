    ...
    public Rule unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NonTalkTimeFilter")) {
                rule.setNonTalkTimeFilter(NonTalkTimeFilterJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("InterruptionFilter")) {
                rule.setInterruptionFilter(InterruptionFilterJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TranscriptFilter")) {
                rule.setTranscriptFilter(TranscriptFilterJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("SentimentFilter")) {
                rule.setSentimentFilter(SentimentFilterJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
