...
public class UpdateVocabularyFilterRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         a vocabulary filter with the same name as a previous vocabulary
     ...
     *            update a vocabulary filter with the same name as a previous
     *            vocabulary filter you will receive a
