...
public class GetMedicalVocabularyResult implements Serializable {
    ...
    /**
     * <p>
     * The Amazon S3 location where the vocabulary is stored. Use this URI to
     ...
     *
     * @return <p>
     *         The date and time the vocabulary was last modified with a text
     *         file different from what was previously used.
     *         </p>
     */
     ...
     *
     * @return <p>
     *         The Amazon S3 location where the vocabulary is stored. Use this
     ...
     *
     * @param downloadUri <p>
     *            The Amazon S3 location where the vocabulary is stored. Use
