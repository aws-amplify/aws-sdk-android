...
/**
 * JSON unmarshaller for POJO Subtitles
 */
class SubtitlesJsonUnmarshaller implements Unmarshaller<Subtitles, JsonUnmarshallerContext> {
    ...
    public Subtitles unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Formats")) {
                subtitles.setFormats(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
