 ...
 * no criteria are specified, all Medical Scribe jobs are returned.
 * </p>
 * <p>
...
public class ListMedicalScribeJobsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * include <code>Status</code>, all Medical Scribe jobs are returned.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
     ...
     *         do not include <code>Status</code>, all Medical Scribe jobs are
     *         returned.
     *         </p>
     ...
     *            If you do not include <code>Status</code>, all Medical Scribe
     *            jobs are returned.
     *            </p>
     * @see MedicalScribeJobStatus
     */
     ...
     *            Returns only the Medical Scribe jobs that contain the
     ...
     *
     * @return <p>
     *         If your <code>ListMedicalScribeJobs</code> request returns more
     ...
     *
     * @param nextToken <p>
     *            If your <code>ListMedicalScribeJobs</code> request returns
     ...
     *
     * @return <p>
     *         The maximum number of Medical Scribe jobs to return in each page
     ...
     *
     * @param maxResults <p>
     *            The maximum number of Medical Scribe jobs to return in each
