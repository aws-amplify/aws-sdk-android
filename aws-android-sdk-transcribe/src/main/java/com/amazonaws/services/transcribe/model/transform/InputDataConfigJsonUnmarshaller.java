        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("S3Uri")) {
                inputDataConfig.setS3Uri(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("TuningDataS3Uri")) {
                inputDataConfig.setTuningDataS3Uri(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("DataAccessRoleArn")) {
                inputDataConfig.setDataAccessRoleArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
