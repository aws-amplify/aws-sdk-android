...
/**
 * JSON unmarshaller for POJO JobExecutionSettings
 */
class JobExecutionSettingsJsonUnmarshaller implements
        Unmarshaller<JobExecutionSettings, JsonUnmarshallerContext> {
    ...
    public JobExecutionSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AllowDeferredExecution")) {
                jobExecutionSettings.setAllowDeferredExecution(BooleanJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("DataAccessRoleArn")) {
                jobExecutionSettings.setDataAccessRoleArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
