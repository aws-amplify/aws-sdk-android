...
public class UpdateMedicalVocabularyResult implements Serializable {
     ...
     * US English (en-US) is the only language supported in Amazon Transcribe
     * Medical.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
     ...
     *            The language code for the text file used to update the custom
     *            vocabulary. US English (en-US) is the only language supported
     *            in Amazon Transcribe Medical.
     *            </p>
     * @see LanguageCode
     */
