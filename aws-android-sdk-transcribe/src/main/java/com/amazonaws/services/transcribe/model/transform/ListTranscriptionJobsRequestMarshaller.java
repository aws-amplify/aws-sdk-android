...
/**
 * JSON request marshaller for ListTranscriptionJobsRequest
 */
public class ListTranscriptionJobsRequestMarshaller implements
        Marshaller<Request<ListTranscriptionJobsRequest>, ListTranscriptionJobsRequest> {

    public Request<ListTranscriptionJobsRequest> marshall(
            ListTranscriptionJobsRequest listTranscriptionJobsRequest) {
        if (listTranscriptionJobsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListTranscriptionJobsRequest)");
        }

        Request<ListTranscriptionJobsRequest> request = new DefaultRequest<ListTranscriptionJobsRequest>(
                listTranscriptionJobsRequest, "AmazonTranscribe");
