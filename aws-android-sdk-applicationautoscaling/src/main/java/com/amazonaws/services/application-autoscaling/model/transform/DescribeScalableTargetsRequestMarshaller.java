...
public class DescribeScalableTargetsRequestMarshaller implements Marshaller<Request<DescribeScalableTargetsRequest>, DescribeScalableTargetsRequest> {
    ...
    public Request<DescribeScalableTargetsRequest> marshall(DescribeScalableTargetsRequest describeScalableTargetsRequest) {
        if (describeScalableTargetsRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(DescribeScalableTargetsRequest)");
        }

        Request<DescribeScalableTargetsRequest> request = new DefaultRequest<DescribeScalableTargetsRequest>(describeScalableTargetsRequest, "ApplicationAutoScaling");
        ...
        try {
            ...
            if (describeScalableTargetsRequest.getResourceIds() != null) {
                java.util.List<String> resourceIds = describeScalableTargetsRequest.getResourceIds();
