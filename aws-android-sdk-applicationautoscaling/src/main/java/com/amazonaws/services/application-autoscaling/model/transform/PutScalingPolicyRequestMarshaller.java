...
public class PutScalingPolicyRequestMarshaller implements Marshaller<Request<PutScalingPolicyRequest>, PutScalingPolicyRequest> {
    ...
    public Request<PutScalingPolicyRequest> marshall(PutScalingPolicyRequest putScalingPolicyRequest) {
        ...
        Request<PutScalingPolicyRequest> request = new DefaultRequest<PutScalingPolicyRequest>(putScalingPolicyRequest, "ApplicationAutoScaling");
        ...
        try {
            ...
            if (putScalingPolicyRequest.getStepScalingPolicyConfiguration() != null) {
                StepScalingPolicyConfiguration stepScalingPolicyConfiguration = putScalingPolicyRequest.getStepScalingPolicyConfiguration();
            ...
            if (putScalingPolicyRequest.getTargetTrackingScalingPolicyConfiguration() != null) {
                TargetTrackingScalingPolicyConfiguration targetTrackingScalingPolicyConfiguration = putScalingPolicyRequest.getTargetTrackingScalingPolicyConfiguration();
