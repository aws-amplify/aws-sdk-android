...
/**
 * JSON unmarshaller for POJO PredefinedMetricSpecification
 */
class PredefinedMetricSpecificationJsonUnmarshaller implements Unmarshaller<PredefinedMetricSpecification, JsonUnmarshallerContext> {
    ...
    public PredefinedMetricSpecification unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PredefinedMetricType")) {
                predefinedMetricSpecification.setPredefinedMetricType(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("ResourceLabel")) {
                predefinedMetricSpecification.setResourceLabel(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static PredefinedMetricSpecificationJsonUnmarshaller getInstance() {
        if (instance == null) instance = new PredefinedMetricSpecificationJsonUnmarshaller();
        return instance;
    }
}
