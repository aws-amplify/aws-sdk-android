...
public class CustomizedMetricSpecification implements Serializable {
     ...
     * <p>The name of the metric. </p>
     *
     * @return <p>The name of the metric. </p>
     */
     ...
     * <p>The name of the metric. </p>
     *
     * @param metricName <p>The name of the metric. </p>
     */
     ...
     * <p>The namespace of the metric.</p>
     *
     * @return <p>The namespace of the metric.</p>
     */
     ...
     * <p>The namespace of the metric.</p>
     *
     * @param namespace <p>The namespace of the metric.</p>
     */
     ...
     * <p>The dimensions of the metric. </p> <p>Conditional: If you published your metric with dimensions, you must specify the same dimensions in your scaling policy.</p>
     *
     * @return <p>The dimensions of the metric. </p> <p>Conditional: If you published your metric with dimensions, you must specify the same dimensions in your scaling policy.</p>
     */
     ...
     * <p>The dimensions of the metric. </p> <p>Conditional: If you published your metric with dimensions, you must specify the same dimensions in your scaling policy.</p>
     *
     * @param dimensions <p>The dimensions of the metric. </p> <p>Conditional: If you published your metric with dimensions, you must specify the same dimensions in your scaling policy.</p>
     */
     ...
     * <b>Allowed Values: </b>Average, Minimum, Maximum, SampleCount, Sum
     *
     * @return <p>The statistic of the metric.</p>
     *
     * @see MetricStatistic
     */
     ...
     * <b>Allowed Values: </b>Average, Minimum, Maximum, SampleCount, Sum
     *
     * @param statistic <p>The statistic of the metric.</p>
     *
     * @see MetricStatistic
     */
     ...
     * <p>The unit of the metric.</p>
     *
     * @return <p>The unit of the metric.</p>
     */
     ...
     * <p>The unit of the metric.</p>
     *
     * @param unit <p>The unit of the metric.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CustomizedMetricSpecification == false) return false;
