...
.unmarshall(context));
                ...
                scalingPolicy.setStepScalingPolicyConfiguration(StepScalingPolicyConfigurationJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
    ...
    public static ScalingPolicyJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ScalingPolicyJsonUnmarshaller();
        return instance;
    }
}
