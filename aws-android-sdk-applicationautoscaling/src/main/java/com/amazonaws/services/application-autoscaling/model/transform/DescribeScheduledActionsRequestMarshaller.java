...
/**
 * JSON request marshaller for DescribeScheduledActionsRequest
 */
public class DescribeScheduledActionsRequestMarshaller implements Marshaller<Request<DescribeScheduledActionsRequest>, DescribeScheduledActionsRequest> {
    ...
    public Request<DescribeScheduledActionsRequest> marshall(DescribeScheduledActionsRequest describeScheduledActionsRequest) {
        ...
        Request<DescribeScheduledActionsRequest> request = new DefaultRequest<DescribeScheduledActionsRequest>(describeScheduledActionsRequest, "ApplicationAutoScaling");
        ...
        try {
            ...
            if (describeScheduledActionsRequest.getScheduledActionNames() != null) {
                java.util.List<String> scheduledActionNames = describeScheduledActionsRequest.getScheduledActionNames();
                jsonWriter.name("ScheduledActionNames");
            jsonWriter.beginArray();
            for (String scheduledActionNamesItem : scheduledActionNames) {
                if (scheduledActionNamesItem != null) {
            jsonWriter.value(scheduledActionNamesItem);
                    }
            }
            jsonWriter.endArray();
            }
            if (describeScheduledActionsRequest.getServiceNamespace() != null) {
                String serviceNamespace = describeScheduledActionsRequest.getServiceNamespace();
                jsonWriter.name("ServiceNamespace");
            jsonWriter.value(serviceNamespace);
            }
            if (describeScheduledActionsRequest.getResourceId() != null) {
                String resourceId = describeScheduledActionsRequest.getResourceId();
                jsonWriter.name("ResourceId");
            jsonWriter.value(resourceId);
            }
            if (describeScheduledActionsRequest.getScalableDimension() != null) {
                String scalableDimension = describeScheduledActionsRequest.getScalableDimension();
                jsonWriter.name("ScalableDimension");
            jsonWriter.value(scalableDimension);
            }
            if (describeScheduledActionsRequest.getMaxResults() != null) {
                Integer maxResults = describeScheduledActionsRequest.getMaxResults();
