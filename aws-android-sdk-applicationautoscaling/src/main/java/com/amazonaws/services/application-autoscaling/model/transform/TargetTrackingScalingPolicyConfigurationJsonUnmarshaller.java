 ...
 */
class TargetTrackingScalingPolicyConfigurationJsonUnmarshaller implements Unmarshaller<TargetTrackingScalingPolicyConfiguration, JsonUnmarshallerContext> {
    ...
    public TargetTrackingScalingPolicyConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("TargetValue")) {
                targetTrackingScalingPolicyConfiguration.setTargetValue(DoubleJsonUnmarshaller.getInstance()
.unmarshall(context));
...
.unmarshall(context));
                ...
                targetTrackingScalingPolicyConfiguration.setScaleOutCooldown(IntegerJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("ScaleInCooldown")) {
                targetTrackingScalingPolicyConfiguration.setScaleInCooldown(IntegerJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("DisableScaleIn")) {
                targetTrackingScalingPolicyConfiguration.setDisableScaleIn(BooleanJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static TargetTrackingScalingPolicyConfigurationJsonUnmarshaller getInstance() {
        if (instance == null) instance = new TargetTrackingScalingPolicyConfigurationJsonUnmarshaller();
        return instance;
    }
}
