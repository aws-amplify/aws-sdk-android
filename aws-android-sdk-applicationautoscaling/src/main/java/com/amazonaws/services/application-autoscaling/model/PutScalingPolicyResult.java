...
public class PutScalingPolicyResult implements Serializable {
     ...
     * <b>Pattern: </b>[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*<br/>
     *
     * @return <p>The Amazon Resource Name (ARN) of the resulting scaling policy.</p>
     */
     ...
     * <b>Pattern: </b>[\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\r\n\t]*<br/>
     *
     * @param policyARN <p>The Amazon Resource Name (ARN) of the resulting scaling policy.</p>
     */
     ...
     * <p>The CloudWatch alarms created for the target tracking scaling policy.</p>
     *
     * @return <p>The CloudWatch alarms created for the target tracking scaling policy.</p>
     */
     ...
     * <p>The CloudWatch alarms created for the target tracking scaling policy.</p>
     *
     * @param alarms <p>The CloudWatch alarms created for the target tracking scaling policy.</p>
     */
