    ...
    public Alarm unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AlarmName")) {
                alarm.setAlarmName(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("AlarmARN")) {
                alarm.setAlarmARN(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static AlarmJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AlarmJsonUnmarshaller();
        return instance;
    }
}
