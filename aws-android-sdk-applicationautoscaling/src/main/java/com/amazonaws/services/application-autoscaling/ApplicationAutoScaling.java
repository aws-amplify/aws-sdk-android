...
public interface ApplicationAutoScaling {
     ...
     * <p>
     * Callers can pass in just the endpoint (ex: "application-autoscaling.us-east-1.amazonaws.com") or a full
     * URL, including the protocol (ex: "https://application-autoscaling.us-east-1.amazonaws.com"). If the
     ...
     *
     * @param endpoint
     *            The endpoint (ex: "application-autoscaling.us-east-1.amazonaws.com") or a full URL,
     *            including the protocol (ex: "https://application-autoscaling.us-east-1.amazonaws.com") of
    ...
    /**
     * An alternative to {@link ApplicationAutoScaling#setEndpoint(String)}, sets the
     ...
     */
    DeleteScalingPolicyResult deleteScalingPolicy(DeleteScalingPolicyRequest deleteScalingPolicyRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DeleteScheduledActionResult deleteScheduledAction(DeleteScheduledActionRequest deleteScheduledActionRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DeregisterScalableTargetResult deregisterScalableTarget(DeregisterScalableTargetRequest deregisterScalableTargetRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DescribeScalableTargetsResult describeScalableTargets(DescribeScalableTargetsRequest describeScalableTargetsRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DescribeScalingActivitiesResult describeScalingActivities(DescribeScalingActivitiesRequest describeScalingActivitiesRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DescribeScalingPoliciesResult describeScalingPolicies(DescribeScalingPoliciesRequest describeScalingPoliciesRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DescribeScheduledActionsResult describeScheduledActions(DescribeScheduledActionsRequest describeScheduledActionsRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    PutScalingPolicyResult putScalingPolicy(PutScalingPolicyRequest putScalingPolicyRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    PutScheduledActionResult putScheduledAction(PutScheduledActionRequest putScheduledActionRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    RegisterScalableTargetResult registerScalableTarget(RegisterScalableTargetRequest registerScalableTargetRequest) throws AmazonClientException, AmazonServiceException;
