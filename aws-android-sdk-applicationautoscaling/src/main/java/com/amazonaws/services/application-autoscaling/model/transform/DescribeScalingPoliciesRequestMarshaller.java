...
/**
 * JSON request marshaller for DescribeScalingPoliciesRequest
 */
public class DescribeScalingPoliciesRequestMarshaller implements Marshaller<Request<DescribeScalingPoliciesRequest>, DescribeScalingPoliciesRequest> {
    ...
    public Request<DescribeScalingPoliciesRequest> marshall(DescribeScalingPoliciesRequest describeScalingPoliciesRequest) {
        if (describeScalingPoliciesRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(DescribeScalingPoliciesRequest)");
        }

        Request<DescribeScalingPoliciesRequest> request = new DefaultRequest<DescribeScalingPoliciesRequest>(describeScalingPoliciesRequest, "ApplicationAutoScaling");
