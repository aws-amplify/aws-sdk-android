...
import com.amazonaws.services.application-autoscaling.model.InternalServiceException;
...
public class InternalServiceExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InternalServiceException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
   		
        InternalServiceException e = (InternalServiceException)super.unmarshall(error);
