...
class MetricDimensionJsonUnmarshaller implements Unmarshaller<MetricDimension, JsonUnmarshallerContext> {
    ...
    public MetricDimension unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                metricDimension.setName(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Value")) {
                metricDimension.setValue(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static MetricDimensionJsonUnmarshaller getInstance() {
        if (instance == null) instance = new MetricDimensionJsonUnmarshaller();
        return instance;
    }
}
