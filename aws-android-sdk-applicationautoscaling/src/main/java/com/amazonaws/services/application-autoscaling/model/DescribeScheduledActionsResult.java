...
public class DescribeScheduledActionsResult implements Serializable {
     ...
     * <p>Information about the scheduled actions.</p>
     *
     * @return <p>Information about the scheduled actions.</p>
     */
     ...
     * <p>Information about the scheduled actions.</p>
     *
     * @param scheduledActions <p>Information about the scheduled actions.</p>
     */
    ...
    public DescribeScheduledActionsResult withScheduledActions(ScheduledAction... scheduledActions) {
        if (getScheduledActions() == null) {
            this.scheduledActions = new java.util.ArrayList<ScheduledAction>(scheduledActions.length);
        }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getScheduledActions() != null) sb.append("ScheduledActions: " + getScheduledActions() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getScheduledActions() == null ^ this.getScheduledActions() == null) return false;
        if (other.getScheduledActions() != null && other.getScheduledActions().equals(this.getScheduledActions()) == false) return false;
