...
/**
 * JSON request marshaller for DeleteScheduledActionRequest
 */
public class DeleteScheduledActionRequestMarshaller implements Marshaller<Request<DeleteScheduledActionRequest>, DeleteScheduledActionRequest> {
    ...
    public Request<DeleteScheduledActionRequest> marshall(DeleteScheduledActionRequest deleteScheduledActionRequest) {
        ...
        Request<DeleteScheduledActionRequest> request = new DefaultRequest<DeleteScheduledActionRequest>(deleteScheduledActionRequest, "ApplicationAutoScaling");
        ...
        try {
            ...
            if (deleteScheduledActionRequest.getServiceNamespace() != null) {
                String serviceNamespace = deleteScheduledActionRequest.getServiceNamespace();
            ...
            if (deleteScheduledActionRequest.getResourceId() != null) {
                String resourceId = deleteScheduledActionRequest.getResourceId();
                jsonWriter.name("ResourceId");
            jsonWriter.value(resourceId);
            }
            if (deleteScheduledActionRequest.getScalableDimension() != null) {
                String scalableDimension = deleteScheduledActionRequest.getScalableDimension();
