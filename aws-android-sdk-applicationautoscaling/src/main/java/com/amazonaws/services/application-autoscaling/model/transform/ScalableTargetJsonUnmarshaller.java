 ...
 */
class ScalableTargetJsonUnmarshaller implements Unmarshaller<ScalableTarget, JsonUnmarshallerContext> {
...
.unmarshall(context));
    ...
    public static ScalableTargetJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ScalableTargetJsonUnmarshaller();
        return instance;
    }
}
