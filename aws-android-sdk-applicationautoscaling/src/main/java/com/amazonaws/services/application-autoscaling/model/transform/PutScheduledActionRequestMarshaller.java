 ...
 */
public class PutScheduledActionRequestMarshaller implements Marshaller<Request<PutScheduledActionRequest>, PutScheduledActionRequest> {
    ...
    public Request<PutScheduledActionRequest> marshall(PutScheduledActionRequest putScheduledActionRequest) {
        if (putScheduledActionRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(PutScheduledActionRequest)");
        }

        Request<PutScheduledActionRequest> request = new DefaultRequest<PutScheduledActionRequest>(putScheduledActionRequest, "ApplicationAutoScaling");
        ...
        try {
            ...
            if (putScheduledActionRequest.getScalableTargetAction() != null) {
                ScalableTargetAction scalableTargetAction = putScheduledActionRequest.getScalableTargetAction();
