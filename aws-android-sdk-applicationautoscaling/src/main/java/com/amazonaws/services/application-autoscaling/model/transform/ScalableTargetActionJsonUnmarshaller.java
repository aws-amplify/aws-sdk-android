 ...
 */
class ScalableTargetActionJsonUnmarshaller implements Unmarshaller<ScalableTargetAction, JsonUnmarshallerContext> {
...
.unmarshall(context));
    ...
    public static ScalableTargetActionJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ScalableTargetActionJsonUnmarshaller();
        return instance;
    }
}
