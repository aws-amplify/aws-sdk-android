...
public class DescribeScheduledActionsResult implements Serializable {
    ...
    public DescribeScheduledActionsResult withScheduledActions(ScheduledAction... scheduledActions) {
        if (getScheduledActions() == null) {
            this.scheduledActions = new java.util.ArrayList<ScheduledAction>(
                    scheduledActions.length);
        }
        for (ScheduledAction value : scheduledActions) {
            this.scheduledActions.add(value);
        }
        return this;
    }
     ...
     *         chained together.
     */
    public DescribeScheduledActionsResult withScheduledActions(
            java.util.Collection<ScheduledAction> scheduledActions) {
     ...
     *
     * @param nextToken <p>
     *            The token required to get the next set of results. This value
     *            is <code>null</code> if there are no more results to return.
     *            </p>
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getScheduledActions() != null)
            sb.append("ScheduledActions: " + getScheduledActions() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getScheduledActions() == null) ? 0 : getScheduledActions().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getScheduledActions() == null ^ this.getScheduledActions() == null)
            return false;
        if (other.getScheduledActions() != null
                && other.getScheduledActions().equals(this.getScheduledActions()) == false)
            return false;
