...
class CustomizedMetricSpecificationJsonMarshaller {
    ...
    public void marshall(CustomizedMetricSpecification customizedMetricSpecification,
        ...
        if (customizedMetricSpecification.getDimensions() != null) {
            java.util.List<MetricDimension> dimensions = customizedMetricSpecification
                    .getDimensions();
    ...
    public static CustomizedMetricSpecificationJsonMarshaller getInstance() {
        if (instance == null)
            instance = new CustomizedMetricSpecificationJsonMarshaller();
        return instance;
    }
}
