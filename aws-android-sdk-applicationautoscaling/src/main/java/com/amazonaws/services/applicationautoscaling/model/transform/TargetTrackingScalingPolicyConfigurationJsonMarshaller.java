...
class TargetTrackingScalingPolicyConfigurationJsonMarshaller {
    ...
    public void marshall(
        ...
        if (targetTrackingScalingPolicyConfiguration.getPredefinedMetricSpecification() != null) {
            PredefinedMetricSpecification predefinedMetricSpecification = targetTrackingScalingPolicyConfiguration
                    .getPredefinedMetricSpecification();
            jsonWriter.name("PredefinedMetricSpecification");
            PredefinedMetricSpecificationJsonMarshaller.getInstance().marshall(
                    predefinedMetricSpecification, jsonWriter);
        }
        if (targetTrackingScalingPolicyConfiguration.getCustomizedMetricSpecification() != null) {
            CustomizedMetricSpecification customizedMetricSpecification = targetTrackingScalingPolicyConfiguration
                    .getCustomizedMetricSpecification();
            jsonWriter.name("CustomizedMetricSpecification");
            CustomizedMetricSpecificationJsonMarshaller.getInstance().marshall(
                    customizedMetricSpecification, jsonWriter);
        }
        if (targetTrackingScalingPolicyConfiguration.getScaleOutCooldown() != null) {
            Integer scaleOutCooldown = targetTrackingScalingPolicyConfiguration
                    .getScaleOutCooldown();
    ...
    public static TargetTrackingScalingPolicyConfigurationJsonMarshaller getInstance() {
        if (instance == null)
            instance = new TargetTrackingScalingPolicyConfigurationJsonMarshaller();
        return instance;
    }
}
