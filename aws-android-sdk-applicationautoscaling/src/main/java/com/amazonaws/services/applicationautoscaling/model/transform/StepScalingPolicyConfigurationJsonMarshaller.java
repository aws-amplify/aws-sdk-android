...
class StepScalingPolicyConfigurationJsonMarshaller {
    ...
    public void marshall(StepScalingPolicyConfiguration stepScalingPolicyConfiguration,
        ...
        if (stepScalingPolicyConfiguration.getStepAdjustments() != null) {
            java.util.List<StepAdjustment> stepAdjustments = stepScalingPolicyConfiguration
                    .getStepAdjustments();
            jsonWriter.name("StepAdjustments");
            jsonWriter.beginArray();
            for (StepAdjustment stepAdjustmentsItem : stepAdjustments) {
                if (stepAdjustmentsItem != null) {
                    StepAdjustmentJsonMarshaller.getInstance().marshall(stepAdjustmentsItem,
                            jsonWriter);
                }
            }
            jsonWriter.endArray();
        ...
        if (stepScalingPolicyConfiguration.getMinAdjustmentMagnitude() != null) {
            Integer minAdjustmentMagnitude = stepScalingPolicyConfiguration
        ...
        if (stepScalingPolicyConfiguration.getMetricAggregationType() != null) {
            String metricAggregationType = stepScalingPolicyConfiguration
