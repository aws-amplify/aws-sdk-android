 ...
 */
class StepScalingPolicyConfigurationJsonUnmarshaller implements
    ...
    public StepScalingPolicyConfiguration unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AdjustmentType")) {
                stepScalingPolicyConfiguration.setAdjustmentType(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("StepAdjustments")) {
                stepScalingPolicyConfiguration
                        .setStepAdjustments(new ListUnmarshaller<StepAdjustment>(
                                StepAdjustmentJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("MinAdjustmentMagnitude")) {
                stepScalingPolicyConfiguration.setMinAdjustmentMagnitude(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                stepScalingPolicyConfiguration.setMetricAggregationType(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
