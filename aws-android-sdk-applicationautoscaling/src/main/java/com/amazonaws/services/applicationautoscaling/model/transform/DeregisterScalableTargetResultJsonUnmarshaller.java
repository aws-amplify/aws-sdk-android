 ...
 */
public class DeregisterScalableTargetResultJsonUnmarshaller implements
        Unmarshaller<DeregisterScalableTargetResult, JsonUnmarshallerContext> {

    public DeregisterScalableTargetResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
