 ...
 */
class ScheduledActionJsonUnmarshaller implements
        Unmarshaller<ScheduledAction, JsonUnmarshallerContext> {
    ...
    public ScheduledAction unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ScheduledActionName")) {
                ...
                scheduledAction.setScalableTargetAction(ScalableTargetActionJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
