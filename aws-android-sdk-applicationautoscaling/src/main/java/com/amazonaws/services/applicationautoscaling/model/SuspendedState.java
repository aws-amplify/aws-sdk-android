...
public class SuspendedState implements Serializable {
     ...
     * <code>true</code> if you don't want Application Auto Scaling to add or
     * remove capacity by initiating scheduled actions. The default is
     * <code>false</code>.
     * </p>
     */
     ...
     *         scaling policy is suspended. Set the value to <code>true</code>
     *         if you don't want Application Auto Scaling to remove capacity
     *         when a scaling policy is triggered. The default is
     *         <code>false</code>.
     *         </p>
     */
     ...
     * </p>
     *
     * @param dynamicScalingInSuspended <p>
     *            Whether scale in by a target tracking scaling policy or a step
     *            scaling policy is suspended. Set the value to
     *            <code>true</code> if you don't want Application Auto Scaling
     *            to remove capacity when a scaling policy is triggered. The
     ...
     *         scaling policy is suspended. Set the value to <code>true</code>
     *         if you don't want Application Auto Scaling to add capacity when a
     ...
     * </p>
     *
     * @param dynamicScalingOutSuspended <p>
     *            Whether scale out by a target tracking scaling policy or a
     *            step scaling policy is suspended. Set the value to
     *            <code>true</code> if you don't want Application Auto Scaling
     *            to add capacity when a scaling policy is triggered. The
     *            default is <code>false</code>.
     *            </p>
     */
     ...
     * @return <p>
     *         Whether scheduled scaling is suspended. Set the value to
     *         <code>true</code> if you don't want Application Auto Scaling to
     *         add or remove capacity by initiating scheduled actions. The
     *         default is <code>false</code>.
     *         </p>
     */
     ...
     * </p>
     *
     * @param scheduledScalingSuspended <p>
     *            Whether scheduled scaling is suspended. Set the value to
     *            <code>true</code> if you don't want Application Auto Scaling
     *            to add or remove capacity by initiating scheduled actions. The
     *            default is <code>false</code>.
     *            </p>
     */
    ...
    public String toString() {
        ...
        if (getDynamicScalingInSuspended() != null)
            sb.append("DynamicScalingInSuspended: " + getDynamicScalingInSuspended() + ",");
        if (getDynamicScalingOutSuspended() != null)
            sb.append("DynamicScalingOutSuspended: " + getDynamicScalingOutSuspended() + ",");
        if (getScheduledScalingSuspended() != null)
            sb.append("ScheduledScalingSuspended: " + getScheduledScalingSuspended());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getDynamicScalingInSuspended() == null) ? 0 : getDynamicScalingInSuspended()
                        .hashCode());
        hashCode = prime
                * hashCode
                + ((getDynamicScalingOutSuspended() == null) ? 0 : getDynamicScalingOutSuspended()
                        .hashCode());
        hashCode = prime
                * hashCode
                + ((getScheduledScalingSuspended() == null) ? 0 : getScheduledScalingSuspended()
                        .hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDynamicScalingInSuspended() == null
                ^ this.getDynamicScalingInSuspended() == null)
            return false;
        if (other.getDynamicScalingInSuspended() != null
                && other.getDynamicScalingInSuspended().equals(this.getDynamicScalingInSuspended()) == false)
            return false;
        if (other.getDynamicScalingOutSuspended() == null
                ^ this.getDynamicScalingOutSuspended() == null)
            return false;
        if (other.getDynamicScalingOutSuspended() != null
                && other.getDynamicScalingOutSuspended().equals(
                        this.getDynamicScalingOutSuspended()) == false)
            return false;
        if (other.getScheduledScalingSuspended() == null
                ^ this.getScheduledScalingSuspended() == null)
            return false;
        if (other.getScheduledScalingSuspended() != null
                && other.getScheduledScalingSuspended().equals(this.getScheduledScalingSuspended()) == false)
            return false;
        return true;
    }
}
