 ...
 * </p>
 */
public class ApplicationAutoScalingClient extends AmazonWebServiceClient implements
        ApplicationAutoScaling {
    /** Provider for AWS credentials. */
    private AWSCredentialsProvider awsCredentialsProvider;

    /**
     * List of exception unmarshallers for all Application Auto Scaling
     * exceptions.
     */
     ...
     * ApplicationAutoScaling. A credentials provider chain will be used that
     ...
     *            how this client connects to ApplicationAutoScaling (ex: proxy
     ...
     *         ApplicationAutoScalingClient client = new ApplicationAutoScalingClient(AWSMobileClient
     *                 .getInstance());
     *     }
     * 
     *     &#064;Override
    ...
    /**
     * Constructs a new client to invoke service methods on
     * ApplicationAutoScaling using the specified AWS account credentials and
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/applicationautoscaling/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/applicationautoscaling/request.handler2s"));
    }
        ...
        try {
            ...
            try {
                request = new DeleteScalingPolicyRequestMarshaller()
                        .marshall(deleteScalingPolicyRequest);
            ...
            JsonResponseHandler<DeleteScalingPolicyResult> responseHandler = new JsonResponseHandler<DeleteScalingPolicyResult>(
                    unmarshaller);
    ...
    public DeleteScheduledActionResult deleteScheduledAction(
        ...
        try {
            ...
            JsonResponseHandler<DeleteScheduledActionResult> responseHandler = new JsonResponseHandler<DeleteScheduledActionResult>(
                    unmarshaller);
        ...
        try {
            ...
            try {
                request = new DeregisterScalableTargetRequestMarshaller()
                        .marshall(deregisterScalableTargetRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DeregisterScalableTargetResult> responseHandler = new JsonResponseHandler<DeregisterScalableTargetResult>(
                    unmarshaller);
        ...
        try {
            ...
            try {
                request = new DescribeScalableTargetsRequestMarshaller()
                        .marshall(describeScalableTargetsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<DescribeScalableTargetsResult> responseHandler = new JsonResponseHandler<DescribeScalableTargetsResult>(
                    unmarshaller);
    ...
    public DescribeScalingActivitiesResult describeScalingActivities(
        ...
        try {
            ...
            JsonResponseHandler<DescribeScalingActivitiesResult> responseHandler = new JsonResponseHandler<DescribeScalingActivitiesResult>(
                    unmarshaller);
        ...
        try {
            ...
            try {
                request = new DescribeScalingPoliciesRequestMarshaller()
                        .marshall(describeScalingPoliciesRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
    ...
    public DescribeScheduledActionsResult describeScheduledActions(
        ...
        try {
            ...
            JsonResponseHandler<DescribeScheduledActionsResult> responseHandler = new JsonResponseHandler<DescribeScheduledActionsResult>(
                    unmarshaller);
     ...
     *             data in the request, or a server side issue.
     */
    public PutScheduledActionResult putScheduledAction(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new PutScheduledActionRequestMarshaller()
                        .marshall(putScheduledActionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<PutScheduledActionResult> responseHandler = new JsonResponseHandler<PutScheduledActionResult>(
                    unmarshaller);
        ...
        try {
            ...
            try {
                request = new RegisterScalableTargetRequestMarshaller()
                        .marshall(registerScalableTargetRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            JsonResponseHandler<RegisterScalableTargetResult> responseHandler = new JsonResponseHandler<RegisterScalableTargetResult>(
                    unmarshaller);
