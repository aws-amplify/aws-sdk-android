 ...
 */
class PredefinedMetricSpecificationJsonUnmarshaller implements
        Unmarshaller<PredefinedMetricSpecification, JsonUnmarshallerContext> {
    ...
    public PredefinedMetricSpecification unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PredefinedMetricType")) {
                predefinedMetricSpecification.setPredefinedMetricType(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
