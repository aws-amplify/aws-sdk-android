 ...
 * </p>
 * <p>
 * Only the AWS services that you're using send metrics to Amazon CloudWatch. To
 * determine whether a desired metric already exists by looking up its namespace
 * and dimension using the CloudWatch metrics dashboard in the console, follow
 * the procedure in <a href=
 * "https://docs.aws.amazon.com/autoscaling/application/userguide/monitoring-cloudwatch.html"
 * >Building Dashboards with CloudWatch</a> in the <i>Application Auto Scaling
 * User Guide</i>.
 * </p>
 */
public class PredefinedMetricSpecification implements Serializable {
     ...
     * ECSServiceAverageMemoryUtilization, AppStreamAverageCapacityUtilization,
     * ComprehendInferenceUtilization, LambdaProvisionedConcurrencyUtilization,
     ...
     * <p>
     * The format is
     * app/&lt;load-balancer-name&gt;/&lt;load-balancer-id&gt;/targetgroup
     * /&lt;target-group-name&gt;/&lt;target-group-id&gt;, where:
     * </p>
     * <ul>
     * <li>
     * <p>
     ...
     *
     * @return <p>
     *         The metric type. The <code>ALBRequestCountPerTarget</code> metric
     ...
     *            The metric type. The <code>ALBRequestCountPerTarget</code>
     *            metric type applies only to Spot Fleet requests and ECS
     *            services.
     *            </p>
     * @see MetricType
     */
