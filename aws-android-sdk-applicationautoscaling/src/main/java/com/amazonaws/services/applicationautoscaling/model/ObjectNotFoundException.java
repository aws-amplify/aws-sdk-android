 ...
 * target with the specified service namespace, resource ID, and scalable
 * dimension does not exist. For any operation that deletes or deregisters a
 * resource, this exception is thrown if the resource cannot be found.
 * </p>
 */
