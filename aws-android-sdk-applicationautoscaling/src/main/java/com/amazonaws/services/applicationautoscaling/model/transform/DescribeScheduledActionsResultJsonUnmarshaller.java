 ...
 */
public class DescribeScheduledActionsResultJsonUnmarshaller implements
        Unmarshaller<DescribeScheduledActionsResult, JsonUnmarshallerContext> {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ScheduledActions")) {
                describeScheduledActionsResult
                        .setScheduledActions(new ListUnmarshaller<ScheduledAction>(
                                ScheduledActionJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
