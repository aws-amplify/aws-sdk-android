 ...
 * </p>
 */
public class DescribeScalableTargetsRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *         identifier. If you specify a scalable dimension, you must also
     ...
     *         scaling property. If you specify a scalable dimension, you must
     ...
     *            and scaling property. If you specify a scalable dimension, you
     ...
     *
     * @return <p>
     *         The maximum number of scalable targets. This value can be between
     *         1 and 50. The default value is 50.
     *         </p>
     *         <p>
     *         If this parameter is used, the operation returns up to
     *         <code>MaxResults</code> results at a time, along with a
     *         <code>NextToken</code> value. To get the next set of results,
     *         include the <code>NextToken</code> value in a subsequent call. If
     *         this parameter is not used, the operation returns up to 50
     ...
     *
     * @param maxResults <p>
     *            The maximum number of scalable targets. This value can be
     ...
     *            <code>MaxResults</code> results at a time, along with a
     *            <code>NextToken</code> value. To get the next set of results,
     *            include the <code>NextToken</code> value in a subsequent call.
