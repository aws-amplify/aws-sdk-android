...
/**
 * JSON unmarshaller for response GetOnPremisesInstanceResult
 */
public class GetOnPremisesInstanceResultJsonUnmarshaller implements
        Unmarshaller<GetOnPremisesInstanceResult, JsonUnmarshallerContext> {
    ...
    public GetOnPremisesInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("instanceInfo")) {
                getOnPremisesInstanceResult.setInstanceInfo(InstanceInfoJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
