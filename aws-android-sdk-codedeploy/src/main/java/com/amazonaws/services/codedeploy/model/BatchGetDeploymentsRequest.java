...
public class BatchGetDeploymentsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         A list of deployment IDs, separated by spaces. The maximum number
     *         of deployment IDs you can specify is 25.
     *         </p>
     */
     ...
     * </p>
     *
     * @param deploymentIds <p>
     *            A list of deployment IDs, separated by spaces. The maximum
     *            number of deployment IDs you can specify is 25.
     *            </p>
     */
    ...
    public BatchGetDeploymentsRequest withDeploymentIds(String... deploymentIds) {
        if (getDeploymentIds() == null) {
            this.deploymentIds = new java.util.ArrayList<String>(deploymentIds.length);
        }
        for (String value : deploymentIds) {
            this.deploymentIds.add(value);
        }
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getDeploymentIds() == null) ? 0 : getDeploymentIds().hashCode());
        return hashCode;
    }
