...
/**
 * JSON unmarshaller for POJO AppSpecContent
 */
class AppSpecContentJsonUnmarshaller implements
        Unmarshaller<AppSpecContent, JsonUnmarshallerContext> {
    ...
    public AppSpecContent unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("content")) {
                appSpecContent.setContent(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("sha256")) {
                appSpecContent.setSha256(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
