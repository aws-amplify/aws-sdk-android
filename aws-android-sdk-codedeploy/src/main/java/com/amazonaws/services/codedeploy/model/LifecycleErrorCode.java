...
public enum LifecycleErrorCode {
    ...
    private static final Map<String, LifecycleErrorCode> enumMap;
    static {
        enumMap = new HashMap<String, LifecycleErrorCode>();
        enumMap.put("Success", Success);
        enumMap.put("ScriptMissing", ScriptMissing);
        enumMap.put("ScriptNotExecutable", ScriptNotExecutable);
        enumMap.put("ScriptTimedOut", ScriptTimedOut);
        enumMap.put("ScriptFailed", ScriptFailed);
        enumMap.put("UnknownError", UnknownError);
    }
