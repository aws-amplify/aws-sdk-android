...
/**
 * JSON request marshaller for UpdateApplicationRequest
 */
public class UpdateApplicationRequestMarshaller implements
    ...
    public Request<UpdateApplicationRequest> marshall(
        ...
        Request<UpdateApplicationRequest> request = new DefaultRequest<UpdateApplicationRequest>(
                updateApplicationRequest, "AWSCodeDeploy");
        ...
        try {
            ...
            if (updateApplicationRequest.getNewApplicationName() != null) {
                String newApplicationName = updateApplicationRequest.getNewApplicationName();
                jsonWriter.name("newApplicationName");
                jsonWriter.value(newApplicationName);
            }
