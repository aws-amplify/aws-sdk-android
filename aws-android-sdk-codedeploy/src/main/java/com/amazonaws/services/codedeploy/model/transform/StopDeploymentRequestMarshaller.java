...
public class StopDeploymentRequestMarshaller implements
    ...
    public Request<StopDeploymentRequest> marshall(StopDeploymentRequest stopDeploymentRequest) {
        ...
        Request<StopDeploymentRequest> request = new DefaultRequest<StopDeploymentRequest>(
                stopDeploymentRequest, "AWSCodeDeploy");
        ...
        try {
            ...
            if (stopDeploymentRequest.getDeploymentId() != null) {
                String deploymentId = stopDeploymentRequest.getDeploymentId();
                jsonWriter.name("deploymentId");
                jsonWriter.value(deploymentId);
            }
            if (stopDeploymentRequest.getAutoRollbackEnabled() != null) {
                Boolean autoRollbackEnabled = stopDeploymentRequest.getAutoRollbackEnabled();
                jsonWriter.name("autoRollbackEnabled");
                jsonWriter.value(autoRollbackEnabled);
            }
