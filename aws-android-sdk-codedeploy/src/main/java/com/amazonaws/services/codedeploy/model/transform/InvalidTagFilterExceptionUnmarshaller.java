...
public class InvalidTagFilterExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InvalidTagFilterException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        InvalidTagFilterException e = (InvalidTagFilterException) super.unmarshall(error);
        e.setErrorCode("InvalidTagFilterException");
