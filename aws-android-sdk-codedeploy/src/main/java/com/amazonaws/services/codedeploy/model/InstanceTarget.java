 ...
 * </p>
 */
public class InstanceTarget implements Serializable {
    /**
     * <p>
     ...
     * @see TargetLabel
     */
    public void setInstanceLabel(TargetLabel instanceLabel) {
    ...
    public String toString() {
        ...
        if (getInstanceLabel() != null)
            sb.append("instanceLabel: " + getInstanceLabel());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getInstanceLabel() == null) ? 0 : getInstanceLabel().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getInstanceLabel() != null
                && other.getInstanceLabel().equals(this.getInstanceLabel()) == false)
            return false;
        return true;
    }
}
