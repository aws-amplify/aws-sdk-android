...
/**
 * JSON marshaller for POJO ErrorInformation
 */
class ErrorInformationJsonMarshaller {

    public void marshall(ErrorInformation errorInformation, AwsJsonWriter jsonWriter)
            throws Exception {
        jsonWriter.beginObject();
        if (errorInformation.getCode() != null) {
            String code = errorInformation.getCode();
