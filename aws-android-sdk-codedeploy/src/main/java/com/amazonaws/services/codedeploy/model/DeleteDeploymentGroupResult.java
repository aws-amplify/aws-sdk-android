...
public class DeleteDeploymentGroupResult implements Serializable {
     ...
     *         remove some Auto Scaling lifecycle event hooks from the Amazon
     ...
     *            Scaling lifecycle event hooks from the Amazon EC2 instances in
     *            the Auto Scaling group. If the output contains data, AWS
     *            CodeDeploy could not remove some Auto Scaling lifecycle event
     *            hooks from the Amazon EC2 instances in the Auto Scaling group.
     *            </p>
     */
