...
public class ListDeploymentConfigsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <code>ListDeploymentConfigs</code> call. It can be used to return the
     ...
     * @return <p>
     *         An identifier returned from the previous
     *         <code>ListDeploymentConfigs</code> call. It can be used to return
     ...
     * @param nextToken <p>
     *            An identifier returned from the previous
     *            <code>ListDeploymentConfigs</code> call. It can be used to
