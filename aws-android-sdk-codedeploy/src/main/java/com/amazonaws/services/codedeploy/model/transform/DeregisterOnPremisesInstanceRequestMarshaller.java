...
/**
 * JSON request marshaller for DeregisterOnPremisesInstanceRequest
 */
public class DeregisterOnPremisesInstanceRequestMarshaller
    ...
    public Request<DeregisterOnPremisesInstanceRequest> marshall(
            DeregisterOnPremisesInstanceRequest deregisterOnPremisesInstanceRequest) {
        if (deregisterOnPremisesInstanceRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeregisterOnPremisesInstanceRequest)");
        }

        Request<DeregisterOnPremisesInstanceRequest> request = new DefaultRequest<DeregisterOnPremisesInstanceRequest>(
                deregisterOnPremisesInstanceRequest, "AWSCodeDeploy");
        ...
        try {
            ...
            if (deregisterOnPremisesInstanceRequest.getInstanceName() != null) {
                String instanceName = deregisterOnPremisesInstanceRequest.getInstanceName();
