...
/**
 * JSON request marshaller for CreateDeploymentConfigRequest
 */
public class CreateDeploymentConfigRequestMarshaller implements
    ...
    public Request<CreateDeploymentConfigRequest> marshall(
        ...
        if (createDeploymentConfigRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateDeploymentConfigRequest)");
        }

        Request<CreateDeploymentConfigRequest> request = new DefaultRequest<CreateDeploymentConfigRequest>(
                createDeploymentConfigRequest, "AWSCodeDeploy");
        ...
        try {
            ...
            if (createDeploymentConfigRequest.getDeploymentConfigName() != null) {
                String deploymentConfigName = createDeploymentConfigRequest
            ...
            if (createDeploymentConfigRequest.getMinimumHealthyHosts() != null) {
                MinimumHealthyHosts minimumHealthyHosts = createDeploymentConfigRequest
            ...
            if (createDeploymentConfigRequest.getTrafficRoutingConfig() != null) {
                TrafficRoutingConfig trafficRoutingConfig = createDeploymentConfigRequest
            ...
            if (createDeploymentConfigRequest.getComputePlatform() != null) {
                String computePlatform = createDeploymentConfigRequest.getComputePlatform();
