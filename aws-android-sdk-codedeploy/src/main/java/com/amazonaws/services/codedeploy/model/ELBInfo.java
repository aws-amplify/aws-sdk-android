 ...
 * </p>
 */
public class ELBInfo implements Serializable {
    /**
     * <p>
     ...
     *         instances in a blue/green deployment. For in-place deployments,
     *         the name of the load balancer that instances are deregistered
     *         from so they are not serving traffic during a deployment, and
     ...
     *
     * @param name <p>
     *            For blue/green deployments, the name of the load balancer that
     *            is used to route traffic from original instances to
     *            replacement instances in a blue/green deployment. For in-place
     *            deployments, the name of the load balancer that instances are
