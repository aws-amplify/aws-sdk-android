...
public class DeploymentConfigAlreadyExistsExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("DeploymentConfigAlreadyExistsException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        DeploymentConfigAlreadyExistsException e = (DeploymentConfigAlreadyExistsException) super
                .unmarshall(error);
        e.setErrorCode("DeploymentConfigAlreadyExistsException");
