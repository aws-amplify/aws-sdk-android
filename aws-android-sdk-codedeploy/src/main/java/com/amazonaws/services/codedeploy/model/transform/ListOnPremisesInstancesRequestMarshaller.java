...
/**
 * JSON request marshaller for ListOnPremisesInstancesRequest
 */
public class ListOnPremisesInstancesRequestMarshaller implements
    ...
    public Request<ListOnPremisesInstancesRequest> marshall(
        ...
        if (listOnPremisesInstancesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListOnPremisesInstancesRequest)");
        }

        Request<ListOnPremisesInstancesRequest> request = new DefaultRequest<ListOnPremisesInstancesRequest>(
                listOnPremisesInstancesRequest, "AWSCodeDeploy");
        ...
        try {
            ...
            if (listOnPremisesInstancesRequest.getRegistrationStatus() != null) {
                String registrationStatus = listOnPremisesInstancesRequest.getRegistrationStatus();
                jsonWriter.name("registrationStatus");
                jsonWriter.value(registrationStatus);
            }
            if (listOnPremisesInstancesRequest.getTagFilters() != null) {
                java.util.List<TagFilter> tagFilters = listOnPremisesInstancesRequest
                        .getTagFilters();
            ...
            if (listOnPremisesInstancesRequest.getNextToken() != null) {
                String nextToken = listOnPremisesInstancesRequest.getNextToken();
