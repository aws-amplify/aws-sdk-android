...
public class ListTagsForResourceResult implements Serializable {
     ...
     *
     * @return <p>
     *         A list of tags returned by <code>ListTagsForResource</code>. The
     *         tags are associated with the resource identified by the input
     *         <code>ResourceArn</code> parameter.
     *         </p>
     */
     ...
     *
     * @param tags <p>
     *            A list of tags returned by <code>ListTagsForResource</code>.
     *            The tags are associated with the resource identified by the
     *            input <code>ResourceArn</code> parameter.
     *            </p>
     */
     ...
     *         also returned. It can be used in a subsequent list application
     ...
     *            If a large amount of information is returned, an identifier is
     *            also returned. It can be used in a subsequent list application
     *            revisions call to return the next set of application revisions
     *            in the list.
     *            </p>
     */
