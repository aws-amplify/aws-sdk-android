...
/**
 * JSON unmarshaller for POJO ECSService
 */
class ECSServiceJsonUnmarshaller implements Unmarshaller<ECSService, JsonUnmarshallerContext> {
    ...
    public ECSService unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("serviceName")) {
                eCSService.setServiceName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("clusterName")) {
                eCSService.setClusterName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
