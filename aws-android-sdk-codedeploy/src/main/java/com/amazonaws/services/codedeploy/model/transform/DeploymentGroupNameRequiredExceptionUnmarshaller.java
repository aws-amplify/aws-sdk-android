...
public class DeploymentGroupNameRequiredExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("DeploymentGroupNameRequiredException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        DeploymentGroupNameRequiredException e = (DeploymentGroupNameRequiredException) super
                .unmarshall(error);
        e.setErrorCode("DeploymentGroupNameRequiredException");
