...
/**
 * JSON request marshaller for RemoveTagsFromOnPremisesInstancesRequest
 */
    ...
    public Request<RemoveTagsFromOnPremisesInstancesRequest> marshall(
        ...
        if (removeTagsFromOnPremisesInstancesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RemoveTagsFromOnPremisesInstancesRequest)");
        }

        Request<RemoveTagsFromOnPremisesInstancesRequest> request = new DefaultRequest<RemoveTagsFromOnPremisesInstancesRequest>(
                removeTagsFromOnPremisesInstancesRequest, "AWSCodeDeploy");
        ...
        try {
            ...
            if (removeTagsFromOnPremisesInstancesRequest.getTags() != null) {
                java.util.List<Tag> tags = removeTagsFromOnPremisesInstancesRequest.getTags();
            ...
            if (removeTagsFromOnPremisesInstancesRequest.getInstanceNames() != null) {
                java.util.List<String> instanceNames = removeTagsFromOnPremisesInstancesRequest
                        .getInstanceNames();
