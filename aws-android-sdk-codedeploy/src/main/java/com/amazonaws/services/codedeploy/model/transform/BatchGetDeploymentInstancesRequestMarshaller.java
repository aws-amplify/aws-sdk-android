...
/**
 * JSON request marshaller for BatchGetDeploymentInstancesRequest
 */
    ...
    public Request<BatchGetDeploymentInstancesRequest> marshall(
        ...
        if (batchGetDeploymentInstancesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(BatchGetDeploymentInstancesRequest)");
        }

        Request<BatchGetDeploymentInstancesRequest> request = new DefaultRequest<BatchGetDeploymentInstancesRequest>(
                batchGetDeploymentInstancesRequest, "AWSCodeDeploy");
        ...
        try {
            ...
            if (batchGetDeploymentInstancesRequest.getDeploymentId() != null) {
                String deploymentId = batchGetDeploymentInstancesRequest.getDeploymentId();
                jsonWriter.name("deploymentId");
                jsonWriter.value(deploymentId);
            }
            if (batchGetDeploymentInstancesRequest.getInstanceIds() != null) {
                java.util.List<String> instanceIds = batchGetDeploymentInstancesRequest
                        .getInstanceIds();
