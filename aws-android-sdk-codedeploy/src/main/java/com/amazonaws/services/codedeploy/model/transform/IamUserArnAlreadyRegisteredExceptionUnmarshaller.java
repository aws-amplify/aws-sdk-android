...
public class IamUserArnAlreadyRegisteredExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("IamUserArnAlreadyRegisteredException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        IamUserArnAlreadyRegisteredException e = (IamUserArnAlreadyRegisteredException) super
                .unmarshall(error);
