...
/**
 * JSON request marshaller for RegisterApplicationRevisionRequest
 */
    ...
    public Request<RegisterApplicationRevisionRequest> marshall(
        ...
        if (registerApplicationRevisionRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(RegisterApplicationRevisionRequest)");
        }

        Request<RegisterApplicationRevisionRequest> request = new DefaultRequest<RegisterApplicationRevisionRequest>(
                registerApplicationRevisionRequest, "AWSCodeDeploy");
        ...
        try {
            ...
            if (registerApplicationRevisionRequest.getApplicationName() != null) {
                String applicationName = registerApplicationRevisionRequest.getApplicationName();
                jsonWriter.name("applicationName");
                jsonWriter.value(applicationName);
            }
            if (registerApplicationRevisionRequest.getDescription() != null) {
                String description = registerApplicationRevisionRequest.getDescription();
