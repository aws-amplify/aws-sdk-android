 ...
 * AWS Lambda deployment was exceeded. The target list of both types of
 * deployments must have exactly one item. This exception does not apply to
 * EC2/On-premises deployments.
 * </p>
 */
public class DeploymentTargetListSizeExceededException extends AmazonServiceException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new DeploymentTargetListSizeExceededException with the
