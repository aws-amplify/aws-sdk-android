...
/**
 * JSON request marshaller for GetDeploymentInstanceRequest
 */
public class GetDeploymentInstanceRequestMarshaller implements
    ...
    public Request<GetDeploymentInstanceRequest> marshall(
        ...
        if (getDeploymentInstanceRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetDeploymentInstanceRequest)");
        }

        Request<GetDeploymentInstanceRequest> request = new DefaultRequest<GetDeploymentInstanceRequest>(
                getDeploymentInstanceRequest, "AWSCodeDeploy");
        ...
        try {
            ...
            if (getDeploymentInstanceRequest.getDeploymentId() != null) {
                String deploymentId = getDeploymentInstanceRequest.getDeploymentId();
                jsonWriter.name("deploymentId");
                jsonWriter.value(deploymentId);
            }
            if (getDeploymentInstanceRequest.getInstanceId() != null) {
                String instanceId = getDeploymentInstanceRequest.getInstanceId();
