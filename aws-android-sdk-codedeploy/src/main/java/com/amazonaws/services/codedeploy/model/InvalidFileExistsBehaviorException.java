 ...
 * Valid values include "DISALLOW," "OVERWRITE," and "RETAIN."
 * </p>
 */
public class InvalidFileExistsBehaviorException extends AmazonServiceException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new InvalidFileExistsBehaviorException with the specified
     * error message.
     *
