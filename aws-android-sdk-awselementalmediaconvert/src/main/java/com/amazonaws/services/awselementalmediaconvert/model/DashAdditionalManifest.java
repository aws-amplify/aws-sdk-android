 ...
 */
public class DashAdditionalManifest implements Serializable {
    /**
     ...
     * manifest for your DASH group is film-name.mpd. If you enter "-no-premium"
     ...
     *         default main manifest for your DASH group is film-name.mpd. If
     ...
     *            For example, say that the default main manifest for your DASH
     *            group is film-name.mpd. If you enter "-no-premium" for this
