...
public class CaptionSourceFramerate implements Serializable {
    ...
    /**
     * Specify the numerator of the fraction that represents the framerate for
     * the setting Caption source framerate (CaptionSourceFramerate). Use this
     ...
     * <b>Range: </b>1 - 1001<br/>
     *
     * @return Specify the denominator of the fraction that represents the
     ...
     *            represents the framerate for the setting Caption source
     *            framerate (CaptionSourceFramerate). Use this setting along
     *            with the setting Framerate numerator (framerateNumerator).
     */
     ...
     * <b>Range: </b>1 - 60000<br/>
     *
     * @return Specify the numerator of the fraction that represents the
     *         framerate for the setting Caption source framerate
     *         (CaptionSourceFramerate). Use this setting along with the setting
     ...
     *            represents the framerate for the setting Caption source
     *            framerate (CaptionSourceFramerate). Use this setting along
     *            with the setting Framerate denominator (framerateDenominator).
     */
