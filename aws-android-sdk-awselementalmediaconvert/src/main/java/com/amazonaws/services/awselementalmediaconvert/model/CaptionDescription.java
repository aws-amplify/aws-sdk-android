...
public class CaptionDescription implements Serializable {
     ...
     * "Caption Selector <N>", which denotes that the Nth Caption Selector will
     ...
     * <b>Length: </b>1 - <br/>
     *
     * @return Specifies which "Caption Selector":#inputs-caption_selector to
     *         use from each input when generating captions. The name should be
     *         of the format "Caption Selector <N>", which denotes that the Nth
     ...
     * <b>Length: </b>1 - <br/>
     *
     * @param captionSelectorName Specifies which
     *            "Caption Selector":#inputs-caption_selector to use from each
     *            input when generating captions. The name should be of the
     *            format "Caption Selector <N>", which denotes that the Nth
     *            Caption Selector will be used from each input.
     */
