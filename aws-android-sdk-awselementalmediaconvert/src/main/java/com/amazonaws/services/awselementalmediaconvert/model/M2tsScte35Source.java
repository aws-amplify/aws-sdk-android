 ...
 * SCTE-35 markers from an ESAM XML document-- Choose None (NONE). Also provide
...
public enum M2tsScte35Source {
    ...
    private static final Map<String, M2tsScte35Source> enumMap;
    static {
        enumMap = new HashMap<String, M2tsScte35Source>();
