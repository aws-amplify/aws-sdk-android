...
/**
 * JSON unmarshaller for response DeleteJobTemplateResult
 */
public class DeleteJobTemplateResultJsonUnmarshaller implements
        Unmarshaller<DeleteJobTemplateResult, JsonUnmarshallerContext> {
