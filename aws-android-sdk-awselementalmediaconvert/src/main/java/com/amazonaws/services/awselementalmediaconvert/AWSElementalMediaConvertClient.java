...
package com.amazonaws.services.awselementalmediaconvert;
...
import com.amazonaws.services.awselementalmediaconvert.model.transform.*;
...
public class AWSElementalMediaConvertClient extends AmazonWebServiceClient implements
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/awselementalmediaconvert/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/awselementalmediaconvert/request.handler2s"));
    }
