...
public class ListJobsRequestMarshaller implements
    ...
    public Request<ListJobsRequest> marshall(ListJobsRequest listJobsRequest) {
        ...
        if (listJobsRequest.getOrder() != null) {
            request.addParameter("order", StringUtils.fromString(listJobsRequest.getOrder()));
        }
        if (listJobsRequest.getQueue() != null) {
            request.addParameter("queue", StringUtils.fromString(listJobsRequest.getQueue()));
        }
