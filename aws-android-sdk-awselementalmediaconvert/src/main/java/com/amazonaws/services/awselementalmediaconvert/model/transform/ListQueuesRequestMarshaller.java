...
public class ListQueuesRequestMarshaller implements
    ...
    public Request<ListQueuesRequest> marshall(ListQueuesRequest listQueuesRequest) {
        ...
        Request<ListQueuesRequest> request = new DefaultRequest<ListQueuesRequest>(
                listQueuesRequest, "AWSElementalMediaConvert");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/2017-08-29/queues";
        if (listQueuesRequest.getListBy() != null) {
            request.addParameter("listBy", StringUtils.fromString(listQueuesRequest.getListBy()));
        }
        ...
        if (listQueuesRequest.getOrder() != null) {
            request.addParameter("order", StringUtils.fromString(listQueuesRequest.getOrder()));
        }
