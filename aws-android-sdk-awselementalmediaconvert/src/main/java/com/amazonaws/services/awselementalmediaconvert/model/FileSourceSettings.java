...
public class FileSourceSettings implements Serializable {
     ...
     * service compensate for differing framerates between your input captions
     * and input video, specify the framerate of the captions file. Specify this
     * value as a fraction, using the settings Framerate numerator
     ...
     *         captions file. Specify this value as a fraction, using the
     ...
     *            SCC. To have the service compensate for differing framerates
     *            between your input captions and input video, specify the
     *            framerate of the captions file. Specify this value as a
     *            fraction, using the settings Framerate numerator
     *            (framerateNumerator) and Framerate denominator
     *            (framerateDenominator). For example, you might specify 24 / 1
     *            for 24 fps, 25 / 1 for 25 fps, 24000 / 1001 for 23.976 fps, or
