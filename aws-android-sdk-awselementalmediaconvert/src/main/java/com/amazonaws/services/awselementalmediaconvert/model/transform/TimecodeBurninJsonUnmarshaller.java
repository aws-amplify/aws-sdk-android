...
/**
 * JSON unmarshaller for POJO TimecodeBurnin
 */
class TimecodeBurninJsonUnmarshaller implements
        Unmarshaller<TimecodeBurnin, JsonUnmarshallerContext> {
    ...
    public TimecodeBurnin unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("FontSize")) {
                timecodeBurnin.setFontSize(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Position")) {
                timecodeBurnin.setPosition(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Prefix")) {
                timecodeBurnin.setPrefix(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
