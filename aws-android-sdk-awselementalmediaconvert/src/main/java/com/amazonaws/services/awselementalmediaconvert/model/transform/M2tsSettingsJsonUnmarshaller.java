...
class M2tsSettingsJsonUnmarshaller implements Unmarshaller<M2tsSettings, JsonUnmarshallerContext> {
    ...
    public M2tsSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AudioBufferModel")) {
                ...
                m2tsSettings.setAudioPids(new ListUnmarshaller<Integer>(IntegerJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
                ...
                m2tsSettings.setDvbSubPids(new ListUnmarshaller<Integer>(IntegerJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
                ...
                m2tsSettings.setDvbTeletextPid(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                m2tsSettings.setEsRateInPes(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ForceTsVideoEbpOrder")) {
                m2tsSettings.setForceTsVideoEbpOrder(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("FragmentTime")) {
                m2tsSettings.setFragmentTime(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("MaxPcrInterval")) {
                m2tsSettings.setMaxPcrInterval(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("MinEbpInterval")) {
                m2tsSettings.setMinEbpInterval(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("NielsenId3")) {
                m2tsSettings.setNielsenId3(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                m2tsSettings.setPcrPid(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("PmtInterval")) {
                m2tsSettings.setPmtInterval(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("PmtPid")) {
                m2tsSettings.setPmtPid(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("PrivateMetadataPid")) {
                m2tsSettings.setPrivateMetadataPid(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ProgramNumber")) {
                m2tsSettings.setProgramNumber(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("RateMode")) {
                m2tsSettings.setRateMode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Scte35Esam")) {
                m2tsSettings.setScte35Esam(M2tsScte35EsamJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Scte35Pid")) {
                m2tsSettings.setScte35Pid(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Scte35Source")) {
                m2tsSettings.setScte35Source(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                m2tsSettings.setTimedMetadataPid(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                m2tsSettings.setVideoPid(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
