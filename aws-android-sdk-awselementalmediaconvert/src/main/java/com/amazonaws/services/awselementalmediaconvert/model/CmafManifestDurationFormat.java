...
public enum CmafManifestDurationFormat {
    ...
    private static final Map<String, CmafManifestDurationFormat> enumMap;
    static {
        enumMap = new HashMap<String, CmafManifestDurationFormat>();
        enumMap.put("FLOATING_POINT", FLOATING_POINT);
