...
/**
 * StAX unmarshaller for model ChangeMessageVisibilityBatchRequestEntry
 */
class ChangeMessageVisibilityBatchRequestEntryStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Id", targetDepth)) {
                    changeMessageVisibilityBatchRequestEntry.setId(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("ReceiptHandle", targetDepth)) {
                    changeMessageVisibilityBatchRequestEntry
                            .setReceiptHandle(StringStaxUnmarshaller.getInstance().unmarshall(
                                    context));
                    continue;
                }
                if (context.testExpression("VisibilityTimeout", targetDepth)) {
                    changeMessageVisibilityBatchRequestEntry
                            .setVisibilityTimeout(IntegerStaxUnmarshaller.getInstance().unmarshall(
                                    context));
                    continue;
                }
