...
/**
 * StAX unmarshaller for model DeleteMessageBatchResultEntry
 */
class DeleteMessageBatchResultEntryStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Id", targetDepth)) {
                    deleteMessageBatchResultEntry.setId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
