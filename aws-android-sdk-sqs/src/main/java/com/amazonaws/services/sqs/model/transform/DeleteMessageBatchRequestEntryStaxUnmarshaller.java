...
/**
 * StAX unmarshaller for model DeleteMessageBatchRequestEntry
 */
class DeleteMessageBatchRequestEntryStaxUnmarshaller implements
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Id", targetDepth)) {
                    deleteMessageBatchRequestEntry.setId(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
                if (context.testExpression("ReceiptHandle", targetDepth)) {
                    deleteMessageBatchRequestEntry.setReceiptHandle(StringStaxUnmarshaller
