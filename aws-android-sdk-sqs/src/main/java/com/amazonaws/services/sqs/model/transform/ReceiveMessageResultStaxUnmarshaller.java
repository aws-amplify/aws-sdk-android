...
/**
 * StAX unmarshaller for response ReceiveMessageResult
 */
public class ReceiveMessageResultStaxUnmarshaller implements
        Unmarshaller<ReceiveMessageResult, StaxUnmarshallerContext> {
