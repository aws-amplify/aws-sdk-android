...
public class ReceiveMessageResultStaxUnmarshaller implements Unmarshaller<ReceiveMessageResult, StaxUnmarshallerContext> {
    ...
    public ReceiveMessageResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.END_DOCUMENT) return receiveMessageResult;

            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("Message", targetDepth)) {
                    receiveMessageResult.getMessages().add(MessageStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static ReceiveMessageResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new ReceiveMessageResultStaxUnmarshaller();
        return instance;
    }
}
