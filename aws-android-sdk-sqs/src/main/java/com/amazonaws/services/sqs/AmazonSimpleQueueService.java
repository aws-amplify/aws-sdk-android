...
/**
 * Interface for accessing Amazon Simple Queue Service
 * <p>
 ...
 * </ul>
 **/
public interface AmazonSimpleQueueService {
    ...
    /**
     * An alternative to {@link AmazonSimpleQueueService#setEndpoint(String)},
     ...
     *             data in the request, or a server side issue.
     */
    void tagQueue(TagQueueRequest tagQueueRequest) throws AmazonClientException,
            AmazonServiceException;
     ...
     *             data in the request, or a server side issue.
     */
    void untagQueue(UntagQueueRequest untagQueueRequest) throws AmazonClientException,
            AmazonServiceException;
