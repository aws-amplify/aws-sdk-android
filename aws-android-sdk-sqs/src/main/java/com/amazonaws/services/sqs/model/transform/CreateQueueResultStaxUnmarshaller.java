...
/**
 * StAX unmarshaller for response CreateQueueResult
 */
public class CreateQueueResultStaxUnmarshaller implements
        Unmarshaller<CreateQueueResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                if (context.testExpression("QueueUrl", targetDepth)) {
                    createQueueResult.setQueueUrl(StringStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
