...
public class TooManyEntriesInBatchRequestExceptionUnmarshaller extends StandardErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null
                || !errorCode.equals("AWS.SimpleQueueService.TooManyEntriesInBatchRequest"))
            return null;

        TooManyEntriesInBatchRequestException e = (TooManyEntriesInBatchRequestException) super
                .unmarshall(node);
