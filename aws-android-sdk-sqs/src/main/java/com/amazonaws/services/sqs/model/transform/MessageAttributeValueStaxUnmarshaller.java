...
/**
 * Message Attribute Value StAX Unmarshaller
 */
public class MessageAttributeValueStaxUnmarshaller implements Unmarshaller<MessageAttributeValue, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent == XmlPullParser.START_TAG) {
                ...
                if (context.testExpression("StringListValue", targetDepth)) {
                    messageAttributeValue.getStringListValues().add(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("BinaryListValue", targetDepth)) {
                    messageAttributeValue.getBinaryListValues().add(ByteBufferStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static MessageAttributeValueStaxUnmarshaller getInstance() {
        if (instance == null) instance = new MessageAttributeValueStaxUnmarshaller();
        return instance;
    }
}
