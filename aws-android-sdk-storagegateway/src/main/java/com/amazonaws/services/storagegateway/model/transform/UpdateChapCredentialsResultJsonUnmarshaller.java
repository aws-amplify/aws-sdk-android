...
/**
 * JSON unmarshaller for response UpdateChapCredentialsResult
 */
    ...
    public UpdateChapCredentialsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("TargetARN")) {
                updateChapCredentialsResult.setTargetARN(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("InitiatorName")) {
                updateChapCredentialsResult.setInitiatorName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
