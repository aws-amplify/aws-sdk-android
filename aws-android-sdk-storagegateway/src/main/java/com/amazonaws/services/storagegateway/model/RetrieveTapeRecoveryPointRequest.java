 ...
 * read-only. The virtual tape can be retrieved to only a tape gateway. There is
 * no charge for retrieving recovery points.
 * </p>
 * </note>
 */
public class RetrieveTapeRecoveryPointRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
