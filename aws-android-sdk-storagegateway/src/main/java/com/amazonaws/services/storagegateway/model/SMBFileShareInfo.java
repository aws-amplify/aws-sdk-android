...
public class SMBFileShareInfo implements Serializable {
     ...
     * </p>
     * <p>
     * Valid Values: <code>CREATING</code> | <code>UPDATING</code> |
    ...
    /**
     * <p>
     * If this value is set to <code>true</code>, it indicates that access
     * control list (ACL) is enabled on the SMB file share. If it is set to
     ...
     *
     * @return <p>
     *         If this value is set to <code>true</code>, it indicates that
     *         access control list (ACL) is enabled on the SMB file share. If it
     *         is set to <code>false</code>, it indicates that file and
     ...
     *            If this value is set to <code>true</code>, it indicates that
     *            access control list (ACL) is enabled on the SMB file share. If
     *            it is set to <code>false</code>, it indicates that file and
     *            directory permissions are mapped to the POSIX permission.
     *            </p>
     *            <p>
     *            For more information, see <a href=
