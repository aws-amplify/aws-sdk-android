...
public class DescribeCachediSCSIVolumesResult implements Serializable {
     ...
     * </p>
     *
     * @param cachediSCSIVolumes <p>
     *            An array of objects where each object contains metadata about
     *            one cached volume.
     *            </p>
     */
    public void setCachediSCSIVolumes(java.util.Collection<CachediSCSIVolume> cachediSCSIVolumes) {
        ...
        this.cachediSCSIVolumes = new java.util.ArrayList<CachediSCSIVolume>(cachediSCSIVolumes);
    }
    ...
    public DescribeCachediSCSIVolumesResult withCachediSCSIVolumes(
        ...
        if (getCachediSCSIVolumes() == null) {
            this.cachediSCSIVolumes = new java.util.ArrayList<CachediSCSIVolume>(
                    cachediSCSIVolumes.length);
        }
        for (CachediSCSIVolume value : cachediSCSIVolumes) {
            this.cachediSCSIVolumes.add(value);
        }
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getCachediSCSIVolumes() == null) ? 0 : getCachediSCSIVolumes().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCachediSCSIVolumes() != null
                && other.getCachediSCSIVolumes().equals(this.getCachediSCSIVolumes()) == false)
            return false;
        return true;
    }
}
