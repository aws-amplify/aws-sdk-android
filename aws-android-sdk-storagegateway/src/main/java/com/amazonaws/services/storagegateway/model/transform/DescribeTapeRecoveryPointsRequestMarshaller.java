...
/**
 * JSON request marshaller for DescribeTapeRecoveryPointsRequest
 */
public class DescribeTapeRecoveryPointsRequestMarshaller implements
    ...
    public Request<DescribeTapeRecoveryPointsRequest> marshall(
        ...
        if (describeTapeRecoveryPointsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeTapeRecoveryPointsRequest)");
        }
