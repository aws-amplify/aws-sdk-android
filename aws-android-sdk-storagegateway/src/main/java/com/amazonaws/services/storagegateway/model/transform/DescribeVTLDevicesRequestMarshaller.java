...
/**
 * JSON request marshaller for DescribeVTLDevicesRequest
 */
public class DescribeVTLDevicesRequestMarshaller implements
    ...
    public Request<DescribeVTLDevicesRequest> marshall(
        ...
        if (describeVTLDevicesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeVTLDevicesRequest)");
        }
        ...
        try {
            ...
            if (describeVTLDevicesRequest.getGatewayARN() != null) {
                String gatewayARN = describeVTLDevicesRequest.getGatewayARN();
                jsonWriter.name("GatewayARN");
                jsonWriter.value(gatewayARN);
            }
            if (describeVTLDevicesRequest.getVTLDeviceARNs() != null) {
                java.util.List<String> vTLDeviceARNs = describeVTLDevicesRequest.getVTLDeviceARNs();
                jsonWriter.name("VTLDeviceARNs");
                jsonWriter.beginArray();
                for (String vTLDeviceARNsItem : vTLDeviceARNs) {
                    if (vTLDeviceARNsItem != null) {
                        jsonWriter.value(vTLDeviceARNsItem);
                    }
                }
                jsonWriter.endArray();
            }
            if (describeVTLDevicesRequest.getMarker() != null) {
                String marker = describeVTLDevicesRequest.getMarker();
                jsonWriter.name("Marker");
                jsonWriter.value(marker);
            }
            if (describeVTLDevicesRequest.getLimit() != null) {
                Integer limit = describeVTLDevicesRequest.getLimit();
