...
class DiskJsonUnmarshaller implements Unmarshaller<Disk, JsonUnmarshallerContext> {
    ...
    public Disk unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("DiskId")) {
                disk.setDiskId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("DiskPath")) {
                disk.setDiskPath(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("DiskNode")) {
                disk.setDiskNode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("DiskStatus")) {
                disk.setDiskStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("DiskSizeInBytes")) {
                disk.setDiskSizeInBytes(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("DiskAllocationType")) {
                disk.setDiskAllocationType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("DiskAllocationResource")) {
                disk.setDiskAllocationResource(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("DiskAttributeList")) {
                disk.setDiskAttributeList(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
