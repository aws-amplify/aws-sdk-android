...
public class CreateStorediSCSIVolumeRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         Set to true <code>true</code> if you want to preserve the data on
     *         the local disk. Otherwise, set to <code>false</code> to create an
     *         empty volume.
     *         </p>
     *         <p>
     *         Valid Values: <code>true</code> | <code>false</code>
     ...
     *            Set to true <code>true</code> if you want to preserve the data
     *            on the local disk. Otherwise, set to <code>false</code> to
