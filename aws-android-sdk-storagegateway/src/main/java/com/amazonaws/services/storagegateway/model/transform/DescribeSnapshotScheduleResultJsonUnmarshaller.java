...
/**
 * JSON unmarshaller for response DescribeSnapshotScheduleResult
 */
    ...
    public DescribeSnapshotScheduleResult unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("VolumeARN")) {
                describeSnapshotScheduleResult.setVolumeARN(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("StartAt")) {
                describeSnapshotScheduleResult.setStartAt(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("RecurrenceInHours")) {
                describeSnapshotScheduleResult.setRecurrenceInHours(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Description")) {
                describeSnapshotScheduleResult.setDescription(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Timezone")) {
                describeSnapshotScheduleResult.setTimezone(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Tags")) {
                describeSnapshotScheduleResult.setTags(new ListUnmarshaller<Tag>(
