...
/**
 * JSON request marshaller for UpdateSnapshotScheduleRequest
 */
public class UpdateSnapshotScheduleRequestMarshaller implements
    ...
    public Request<UpdateSnapshotScheduleRequest> marshall(
        ...
        if (updateSnapshotScheduleRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateSnapshotScheduleRequest)");
        }
        ...
        try {
            ...
            if (updateSnapshotScheduleRequest.getVolumeARN() != null) {
                String volumeARN = updateSnapshotScheduleRequest.getVolumeARN();
                jsonWriter.name("VolumeARN");
                jsonWriter.value(volumeARN);
            }
            if (updateSnapshotScheduleRequest.getStartAt() != null) {
                Integer startAt = updateSnapshotScheduleRequest.getStartAt();
                jsonWriter.name("StartAt");
                jsonWriter.value(startAt);
            }
            if (updateSnapshotScheduleRequest.getRecurrenceInHours() != null) {
                Integer recurrenceInHours = updateSnapshotScheduleRequest.getRecurrenceInHours();
                jsonWriter.name("RecurrenceInHours");
                jsonWriter.value(recurrenceInHours);
            }
            if (updateSnapshotScheduleRequest.getDescription() != null) {
                String description = updateSnapshotScheduleRequest.getDescription();
                jsonWriter.name("Description");
                jsonWriter.value(description);
            }
            if (updateSnapshotScheduleRequest.getTags() != null) {
                java.util.List<Tag> tags = updateSnapshotScheduleRequest.getTags();
