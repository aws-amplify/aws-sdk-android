...
/**
 * JSON unmarshaller for response DescribeTapeArchivesResult
 */
public class DescribeTapeArchivesResultJsonUnmarshaller implements
        Unmarshaller<DescribeTapeArchivesResult, JsonUnmarshallerContext> {
    ...
    public DescribeTapeArchivesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("TapeArchives")) {
                describeTapeArchivesResult.setTapeArchives(new ListUnmarshaller<TapeArchive>(
                        TapeArchiveJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Marker")) {
                describeTapeArchivesResult.setMarker(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
