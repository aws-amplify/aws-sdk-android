...
public class DescribeUploadBufferResult implements Serializable {
     ...
     * </p>
     *
     * @param uploadBufferUsedInBytes <p>
     *            The total number of bytes being used in the gateway's upload
     *            buffer.
     *            </p>
     */
     ...
     * </p>
     *
     * @param uploadBufferAllocatedInBytes <p>
     *            The total number of bytes allocated in the gateway's as upload
     *            buffer.
     *            </p>
     */
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getUploadBufferUsedInBytes() == null) ? 0 : getUploadBufferUsedInBytes()
                        .hashCode());
        hashCode = prime
                * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getUploadBufferUsedInBytes() != null
                && other.getUploadBufferUsedInBytes().equals(this.getUploadBufferUsedInBytes()) == false)
            return false;
