...
/**
 * JSON request marshaller for DescribeMaintenanceStartTimeRequest
 */
    ...
    public Request<DescribeMaintenanceStartTimeRequest> marshall(
        ...
        if (describeMaintenanceStartTimeRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeMaintenanceStartTimeRequest)");
        }

        Request<DescribeMaintenanceStartTimeRequest> request = new DefaultRequest<DescribeMaintenanceStartTimeRequest>(
                describeMaintenanceStartTimeRequest, "AWSStorageGateway");
        ...
        try {
            ...
            if (describeMaintenanceStartTimeRequest.getGatewayARN() != null) {
                String gatewayARN = describeMaintenanceStartTimeRequest.getGatewayARN();
