 ...
 * </p>
 */
public class GetUsageForecastRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *         usage forecast for. The start date is inclusive, but the end date
     ...
     *            retrieve usage forecast for. The start date is inclusive, but
     *            the end date is exclusive. For example, if <code>start</code>
     ...
     *         </p>
     *         <p>
     *         Valid values for a <code>GetUsageForecast</code> call are the
     *         following:
     *         </p>
     *         <ul>
     *         <li>
