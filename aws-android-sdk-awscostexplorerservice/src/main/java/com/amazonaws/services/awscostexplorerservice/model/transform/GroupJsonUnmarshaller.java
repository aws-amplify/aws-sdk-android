...
class GroupJsonUnmarshaller implements Unmarshaller<Group, JsonUnmarshallerContext> {
    ...
    public Group unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Keys")) {
                group.setKeys(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Metrics")) {
                group.setMetrics(new MapUnmarshaller<MetricValue>(MetricValueJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
