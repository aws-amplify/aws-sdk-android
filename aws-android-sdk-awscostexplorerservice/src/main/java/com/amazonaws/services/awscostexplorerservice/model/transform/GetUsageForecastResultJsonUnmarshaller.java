...
/**
 * JSON unmarshaller for response GetUsageForecastResult
 */
public class GetUsageForecastResultJsonUnmarshaller implements
        Unmarshaller<GetUsageForecastResult, JsonUnmarshallerContext> {
    ...
    public GetUsageForecastResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Total")) {
                getUsageForecastResult.setTotal(MetricValueJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ForecastResultsByTime")) {
                getUsageForecastResult
                        .setForecastResultsByTime(new ListUnmarshaller<ForecastResult>(
                                ForecastResultJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
