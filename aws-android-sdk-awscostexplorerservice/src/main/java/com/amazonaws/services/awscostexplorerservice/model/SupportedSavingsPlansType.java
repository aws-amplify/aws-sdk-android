...
public enum SupportedSavingsPlansType {
    ...
    private static final Map<String, SupportedSavingsPlansType> enumMap;
    static {
        enumMap = new HashMap<String, SupportedSavingsPlansType>();
        enumMap.put("COMPUTE_SP", COMPUTE_SP);
        enumMap.put("EC2_INSTANCE_SP", EC2_INSTANCE_SP);
    }
