 ...
 * Organizations have access to all member accounts.
 * </p>
 */
public class GetCostAndUsageRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * <code>OPERATION</code>, <code>PLATFORM</code>, <code>PURCHASE_TYPE</code>, <code>SERVICE</code>, <code>TAGS</code>, <code>TENANCY</code>,
     ...
     *
     * @param timePeriod <p>
     *            Sets the start and end dates for retrieving AWS costs. The
     ...
     *         include the <code>Granularity</code>, either <code>MONTHLY</code>
     *         or <code>DAILY</code>, or <code>HOURLY</code>.
     *         </p>
     * @see Granularity
     */
     ...
     *            doesn't include the <code>Granularity</code>, either
     *            <code>MONTHLY</code> or <code>DAILY</code>, or
     *            <code>HOURLY</code>.
     *            </p>
     * @see Granularity
     */
     ...
     *         specify <code>SERVICE</code> and <code>LINKED_ACCOUNT</code> and
     *         get the costs that are associated with that account's usage of
     *         that service. You can nest <code>Expression</code> objects to
     *         define any combination of dimension filters. For more
     ...
     *
     * @param filter <p>
     *            Filters AWS costs by different dimensions. For example, you
     *            can specify <code>SERVICE</code> and
     ...
     *         <p>
     *         If you return the <code>UsageQuantity</code> metric, the service
     *         aggregates all usage numbers without taking into account the
     *         units. For example, if you aggregate <code>usageQuantity</code>
     ...
     *            service aggregates all usage numbers without taking into
     *            account the units. For example, if you aggregate
     ...
     *            <code>GetCostAndUsage</code> requests.
     *            </p>
     */
     ...
     *         </p>
     *         <p>
     *         When you group by tag key, you get all tag values, including
     *         empty strings.
     *         </p>
     *         <p>
     *         Valid values are <code>AZ</code>, <code>INSTANCE_TYPE</code>,
     ...
     *         <code>PURCHASE_TYPE</code>, <code>SERVICE</code>,
     *         <code>TAGS</code>, <code>TENANCY</code>, <code>RECORD_TYPE</code>
     ...
     *            <code>OPERATION</code>, <code>PLATFORM</code>,
     *            <code>PURCHASE_TYPE</code>, <code>SERVICE</code>,
     *            <code>TAGS</code>, <code>TENANCY</code>,
     *            <code>RECORD_TYPE</code>, and <code>USAGE_TYPE</code>.
     *            </p>
     */
