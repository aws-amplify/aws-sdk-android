...
/**
 * JSON unmarshaller for POJO SavingsPlansPurchaseRecommendationMetadata
 */
class SavingsPlansPurchaseRecommendationMetadataJsonUnmarshaller implements
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RecommendationId")) {
                savingsPlansPurchaseRecommendationMetadata
                        .setRecommendationId(StringJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("GenerationTimestamp")) {
                savingsPlansPurchaseRecommendationMetadata
                        .setGenerationTimestamp(StringJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
            }
