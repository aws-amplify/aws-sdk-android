...
public class GetRightsizingRecommendationRequestMarshaller
    ...
    public Request<GetRightsizingRecommendationRequest> marshall(
        ...
        try {
            ...
            if (getRightsizingRecommendationRequest.getConfiguration() != null) {
                RightsizingRecommendationConfiguration configuration = getRightsizingRecommendationRequest
                        .getConfiguration();
                jsonWriter.name("Configuration");
                RightsizingRecommendationConfigurationJsonMarshaller.getInstance().marshall(
