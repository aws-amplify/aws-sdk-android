...
/**
 * JSON unmarshaller for POJO SavingsPlansUtilizationAggregates
 */
class SavingsPlansUtilizationAggregatesJsonUnmarshaller implements
        Unmarshaller<SavingsPlansUtilizationAggregates, JsonUnmarshallerContext> {
    ...
    public SavingsPlansUtilizationAggregates unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Utilization")) {
                ...
                savingsPlansUtilizationAggregates.setSavings(SavingsPlansSavingsJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
