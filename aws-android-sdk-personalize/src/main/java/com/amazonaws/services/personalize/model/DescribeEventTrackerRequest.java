...
/**
 * <p>
 * Describes an event tracker. The response includes the <code>trackingId</code>
 * and <code>status</code> of the event tracker. For more information on event
 * trackers, see <a>CreateEventTracker</a>.
 * </p>
 */
public class DescribeEventTrackerRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *            The Amazon Resource Name (ARN) of the event tracker to
     *            describe.
     *            </p>
     */
