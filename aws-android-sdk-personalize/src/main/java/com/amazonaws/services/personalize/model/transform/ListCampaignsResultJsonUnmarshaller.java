...
/**
 * JSON unmarshaller for response ListCampaignsResult
 */
public class ListCampaignsResultJsonUnmarshaller implements
        Unmarshaller<ListCampaignsResult, JsonUnmarshallerContext> {
    ...
    public ListCampaignsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("campaigns")) {
                listCampaignsResult.setCampaigns(new ListUnmarshaller<CampaignSummary>(
                        CampaignSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                listCampaignsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
