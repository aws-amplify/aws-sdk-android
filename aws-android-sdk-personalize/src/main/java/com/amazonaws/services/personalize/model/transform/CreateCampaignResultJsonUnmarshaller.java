...
/**
 * JSON unmarshaller for response CreateCampaignResult
 */
public class CreateCampaignResultJsonUnmarshaller implements
        Unmarshaller<CreateCampaignResult, JsonUnmarshallerContext> {
    ...
    public CreateCampaignResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("campaignArn")) {
                createCampaignResult.setCampaignArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
