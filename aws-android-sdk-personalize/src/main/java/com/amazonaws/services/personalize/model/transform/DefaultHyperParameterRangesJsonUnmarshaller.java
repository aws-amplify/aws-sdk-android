...
/**
 * JSON unmarshaller for POJO DefaultHyperParameterRanges
 */
class DefaultHyperParameterRangesJsonUnmarshaller implements
        Unmarshaller<DefaultHyperParameterRanges, JsonUnmarshallerContext> {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("integerHyperParameterRanges")) {
                defaultHyperParameterRanges
                        .setIntegerHyperParameterRanges(new ListUnmarshaller<DefaultIntegerHyperParameterRange>(
                                DefaultIntegerHyperParameterRangeJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("continuousHyperParameterRanges")) {
                defaultHyperParameterRanges
                        .setContinuousHyperParameterRanges(new ListUnmarshaller<DefaultContinuousHyperParameterRange>(
                                DefaultContinuousHyperParameterRangeJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("categoricalHyperParameterRanges")) {
                defaultHyperParameterRanges
                        .setCategoricalHyperParameterRanges(new ListUnmarshaller<DefaultCategoricalHyperParameterRange>(
