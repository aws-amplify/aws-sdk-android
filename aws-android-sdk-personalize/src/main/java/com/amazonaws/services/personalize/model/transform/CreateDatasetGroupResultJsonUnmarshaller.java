...
/**
 * JSON unmarshaller for response CreateDatasetGroupResult
 */
public class CreateDatasetGroupResultJsonUnmarshaller implements
        Unmarshaller<CreateDatasetGroupResult, JsonUnmarshallerContext> {
    ...
    public CreateDatasetGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("datasetGroupArn")) {
                createDatasetGroupResult.setDatasetGroupArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
