...
public class CreateDatasetRequestMarshaller implements
    ...
    public Request<CreateDatasetRequest> marshall(CreateDatasetRequest createDatasetRequest) {
        ...
        Request<CreateDatasetRequest> request = new DefaultRequest<CreateDatasetRequest>(
                createDatasetRequest, "AmazonPersonalize");
        ...
        try {
            ...
            if (createDatasetRequest.getSchemaArn() != null) {
                String schemaArn = createDatasetRequest.getSchemaArn();
                jsonWriter.name("schemaArn");
                jsonWriter.value(schemaArn);
            }
            if (createDatasetRequest.getDatasetGroupArn() != null) {
                String datasetGroupArn = createDatasetRequest.getDatasetGroupArn();
