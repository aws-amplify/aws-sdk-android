...
/**
 * JSON unmarshaller for response DescribeRecipeResult
 */
public class DescribeRecipeResultJsonUnmarshaller implements
        Unmarshaller<DescribeRecipeResult, JsonUnmarshallerContext> {
    ...
    public DescribeRecipeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("recipe")) {
                describeRecipeResult.setRecipe(RecipeJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
