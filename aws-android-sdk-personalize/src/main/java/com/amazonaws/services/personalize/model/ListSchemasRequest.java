 ...
 * (ARN). For more information on schemas, see <a>CreateSchema</a>.
 * </p>
 */
public class ListSchemasRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         <code>ListSchemas</code> for getting the next set of schemas (if
     *         they exist).
     *         </p>
     */
     ...
     * @param nextToken <p>
     *            A token returned from the previous call to
     *            <code>ListSchemas</code> for getting the next set of schemas
     *            (if they exist).
     *            </p>
     */
