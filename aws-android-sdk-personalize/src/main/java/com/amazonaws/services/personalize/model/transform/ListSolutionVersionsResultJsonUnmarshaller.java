...
/**
 * JSON unmarshaller for response ListSolutionVersionsResult
 */
public class ListSolutionVersionsResultJsonUnmarshaller implements
        Unmarshaller<ListSolutionVersionsResult, JsonUnmarshallerContext> {
    ...
    public ListSolutionVersionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("solutionVersions")) {
                listSolutionVersionsResult
                        .setSolutionVersions(new ListUnmarshaller<SolutionVersionSummary>(
                                SolutionVersionSummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                listSolutionVersionsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
