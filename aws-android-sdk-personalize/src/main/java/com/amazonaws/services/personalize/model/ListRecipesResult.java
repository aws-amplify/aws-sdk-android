...
public class ListRecipesResult implements Serializable {
    /**
     * <p>
    ...
    public ListRecipesResult withRecipes(RecipeSummary... recipes) {
        if (getRecipes() == null) {
            this.recipes = new java.util.ArrayList<RecipeSummary>(recipes.length);
        }
        for (RecipeSummary value : recipes) {
