...
/**
 * JSON unmarshaller for response DescribeCampaignResult
 */
public class DescribeCampaignResultJsonUnmarshaller implements
        Unmarshaller<DescribeCampaignResult, JsonUnmarshallerContext> {
    ...
    public DescribeCampaignResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("campaign")) {
                describeCampaignResult.setCampaign(CampaignJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
