...
/**
 * JSON unmarshaller for response DescribeDatasetGroupResult
 */
public class DescribeDatasetGroupResultJsonUnmarshaller implements
        Unmarshaller<DescribeDatasetGroupResult, JsonUnmarshallerContext> {
    ...
    public DescribeDatasetGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("datasetGroup")) {
                describeDatasetGroupResult.setDatasetGroup(DatasetGroupJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
