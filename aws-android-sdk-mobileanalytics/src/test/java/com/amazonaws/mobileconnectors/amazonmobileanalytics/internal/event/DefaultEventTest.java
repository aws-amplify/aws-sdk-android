...
public class DefaultEventTest extends MobileAnalyticsTestBase {
    ...
    public void setup() {
        ...
        target = DefaultEvent.newInstance(mockContext, SESSION_ID, SESSION_START, SESSION_END,
                SESSION_DURATION, TIME_STAMP, EVENT_NAME);

        assertEquals(EVENT_NAME, target.getEventType());
        assertEquals(UNIQUE_ID, target.getUniqueId().getValue());
    ...
    public void copyEvent_initializaer() {
        ...
        DefaultEvent copiedTarget = DefaultEvent.createFromEvent(mockContext, SESSION_ID,
                System.currentTimeMillis(), target);

        assertEquals(EVENT_NAME, copiedTarget.getEventType());
        assertEquals(UNIQUE_ID, copiedTarget.getUniqueId().getValue());
