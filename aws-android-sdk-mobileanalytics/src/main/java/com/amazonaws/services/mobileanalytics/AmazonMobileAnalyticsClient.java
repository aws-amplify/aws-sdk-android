...
import com.amazonaws.services.mobileanalytics.model.transform.*;

/**
 * Client for accessing Amazon Mobile Analytics. All service calls made using
...
public class AmazonMobileAnalyticsClient extends AmazonWebServiceClient implements
    ...
    /**
     * List of exception unmarshallers for all Amazon Mobile Analytics
     * exceptions.
     */
     ...
     * AmazonMobileAnalytics. A credentials provider chain will be used that
     ...
     *            how this client connects to AmazonMobileAnalytics (ex: proxy
    ...
    /**
     * Constructs a new client to invoke service methods on
     * AmazonMobileAnalytics using the specified AWS account credentials and
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/mobileanalytics/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/mobileanalytics/request.handler2s"));
    }
