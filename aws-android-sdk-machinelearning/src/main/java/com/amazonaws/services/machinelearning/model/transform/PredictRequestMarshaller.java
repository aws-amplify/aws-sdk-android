...
/**
 * JSON request marshaller for PredictRequest
 */
public class PredictRequestMarshaller implements
    ...
    public Request<PredictRequest> marshall(PredictRequest predictRequest) {
        ...
        Request<PredictRequest> request = new DefaultRequest<PredictRequest>(predictRequest,
        ...
        try {
            ...
            if (predictRequest.getRecord() != null) {
                java.util.Map<String, String> record = predictRequest.getRecord();
                jsonWriter.name("Record");
                jsonWriter.beginObject();
                for (java.util.Map.Entry<String, String> recordEntry : record.entrySet()) {
