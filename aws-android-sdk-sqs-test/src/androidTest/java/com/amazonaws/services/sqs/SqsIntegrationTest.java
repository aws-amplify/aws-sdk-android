...
public class SqsIntegrationTest extends IntegrationTestBase {
    ...
    private String queueName = "java-sdk-integ-test-queue-" + dateTime;
    private String queueUrl;

    private String deadLetterQueueName = "java-sdk-integ-test-dlq-" + dateTime;
    ...
    public void testCrossRegionQueueCalls() throws Exception {
        ...
        // eu-west-1 queue
        sqs.setEndpoint("sqs.ap-southeast-2.amazonaws.com");
        assertNotNull(getQueueCreationDate(sqs, euQueueURL));
    }
    ...
    public void testSqsOperations() throws Exception {
        ...
        // Get Queue URL
        GetQueueUrlResult getQueueUrlResult = sqs.getQueueUrl(new GetQueueUrlRequest()
        ...
        // AddPermission
        sqs.addPermission(new AddPermissionRequest()
        ...
        // RemovePermission
        Thread.sleep(1000 * 2);
        sqs.removePermission(new RemovePermissionRequest()
                .withLabel("foo-label")
                .withQueueUrl(queueUrl));
        ...
        // SendMessageBatch
        SendMessageBatchResult sendMessageBatchResult = sqs
        ...
        // Configure the DLQ
        sqs.setQueueAttributes(new SetQueueAttributesRequest().withQueueUrl(
        ...
        // Exception handling
        try {
            sqs.deleteMessage(new DeleteMessageRequest().withQueueUrl(queueUrl).withReceiptHandle(
                    "x"));
