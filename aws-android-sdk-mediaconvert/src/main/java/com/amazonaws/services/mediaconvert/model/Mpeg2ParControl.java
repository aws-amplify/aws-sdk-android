 ...
 * than Follow source. When you choose SPECIFIED for this setting, you must also
...
public enum Mpeg2ParControl {
    ...
    private static final Map<String, Mpeg2ParControl> enumMap;
    static {
        enumMap = new HashMap<String, Mpeg2ParControl>();
