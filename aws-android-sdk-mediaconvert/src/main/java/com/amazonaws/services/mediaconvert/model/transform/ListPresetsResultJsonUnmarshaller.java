...
/**
 * JSON unmarshaller for response ListPresetsResult
 */
public class ListPresetsResultJsonUnmarshaller implements
        Unmarshaller<ListPresetsResult, JsonUnmarshallerContext> {
    ...
    public ListPresetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("NextToken")) {
                listPresetsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Presets")) {
                listPresetsResult.setPresets(new ListUnmarshaller<Preset>(PresetJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
