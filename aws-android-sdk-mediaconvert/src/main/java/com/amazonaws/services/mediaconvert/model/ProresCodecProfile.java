...
public enum ProresCodecProfile {
    ...
    private static final Map<String, ProresCodecProfile> enumMap;
    static {
        enumMap = new HashMap<String, ProresCodecProfile>();
        enumMap.put("APPLE_PRORES_422", APPLE_PRORES_422);
        enumMap.put("APPLE_PRORES_422_HQ", APPLE_PRORES_422_HQ);
        enumMap.put("APPLE_PRORES_422_LT", APPLE_PRORES_422_LT);
        enumMap.put("APPLE_PRORES_422_PROXY", APPLE_PRORES_422_PROXY);
    }
