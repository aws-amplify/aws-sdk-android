...
public class ListTagsForResourceResult implements Serializable {
     ...
     * resource.
     *
     * @return The Amazon Resource Name (ARN) and tags for an AWS Elemental
     ...
     * resource.
     *
     * @param resourceTags The Amazon Resource Name (ARN) and tags for an AWS
     *            Elemental MediaConvert resource.
     */
