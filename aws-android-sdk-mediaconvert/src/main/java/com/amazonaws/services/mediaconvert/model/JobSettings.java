...
public class JobSettings implements Serializable {
     ...
     * concantenated together to create the output.
     *
     * @return Use Inputs (inputs) to define source file used in the transcode
     *         job. There can be multiple inputs add in a job. These inputs will
     ...
     * concantenated together to create the output.
     *
     * @param inputs Use Inputs (inputs) to define source file used in the
     *            transcode job. There can be multiple inputs add in a job.
     *            These inputs will be concantenated together to create the
     *            output.
     */
