...
public class UpdateJobTemplateResult implements Serializable {
    /**
     ...
     * use to quickly create a job.
     *
     * @return A job template is a pre-made set of encoding instructions that
     ...
     * use to quickly create a job.
     *
     * @param jobTemplate A job template is a pre-made set of encoding
