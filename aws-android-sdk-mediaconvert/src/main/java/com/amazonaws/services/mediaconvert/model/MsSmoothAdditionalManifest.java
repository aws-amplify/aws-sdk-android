 ...
 */
public class MsSmoothAdditionalManifest implements Serializable {
    /**
     ...
     * "-no-premium" for this setting, then the file name the service generates
     ...
     *         default main manifest for your Microsoft Smooth group is
     *         film-name.ismv. If you enter "-no-premium" for this setting, then
     *         the file name the service generates for this top-level manifest
     ...
     *            For example, say that the default main manifest for your
     *            Microsoft Smooth group is film-name.ismv. If you enter
     *            "-no-premium" for this setting, then the file name the service
     *            generates for this top-level manifest is
     ...
     *         chained together.
     */
    public MsSmoothAdditionalManifest withSelectedOutputs(
            java.util.Collection<String> selectedOutputs) {
