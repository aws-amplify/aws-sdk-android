...
/**
 * JSON unmarshaller for response GetQueueResult
 */
public class GetQueueResultJsonUnmarshaller implements
        Unmarshaller<GetQueueResult, JsonUnmarshallerContext> {
    ...
    public GetQueueResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Queue")) {
                getQueueResult.setQueue(QueueJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
