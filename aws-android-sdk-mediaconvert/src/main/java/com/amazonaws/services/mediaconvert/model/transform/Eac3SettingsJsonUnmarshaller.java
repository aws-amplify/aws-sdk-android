    ...
    public Eac3Settings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AttenuationControl")) {
                ...
                eac3Settings.setBitrate(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                eac3Settings.setDynamicRangeCompressionLine(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("DynamicRangeCompressionRf")) {
                eac3Settings.setDynamicRangeCompressionRf(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                eac3Settings.setSampleRate(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
