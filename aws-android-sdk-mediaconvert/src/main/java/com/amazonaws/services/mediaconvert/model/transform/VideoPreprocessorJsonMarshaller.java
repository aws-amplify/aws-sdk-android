...
class VideoPreprocessorJsonMarshaller {
    ...
    public void marshall(VideoPreprocessor videoPreprocessor, AwsJsonWriter jsonWriter)
        ...
        if (videoPreprocessor.getPartnerWatermarking() != null) {
            PartnerWatermarking partnerWatermarking = videoPreprocessor.getPartnerWatermarking();
            jsonWriter.name("PartnerWatermarking");
            PartnerWatermarkingJsonMarshaller.getInstance().marshall(partnerWatermarking,
                    jsonWriter);
        }
