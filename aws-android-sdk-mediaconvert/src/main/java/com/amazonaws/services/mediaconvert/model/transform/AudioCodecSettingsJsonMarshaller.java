...
class AudioCodecSettingsJsonMarshaller {
    ...
    public void marshall(AudioCodecSettings audioCodecSettings, AwsJsonWriter jsonWriter)
        ...
        if (audioCodecSettings.getOpusSettings() != null) {
            OpusSettings opusSettings = audioCodecSettings.getOpusSettings();
            jsonWriter.name("OpusSettings");
            OpusSettingsJsonMarshaller.getInstance().marshall(opusSettings, jsonWriter);
        }
        if (audioCodecSettings.getVorbisSettings() != null) {
            VorbisSettings vorbisSettings = audioCodecSettings.getVorbisSettings();
            jsonWriter.name("VorbisSettings");
            VorbisSettingsJsonMarshaller.getInstance().marshall(vorbisSettings, jsonWriter);
        }
