...
public enum CmafWriteSegmentTimelineInRepresentation {
    ...
    private static final Map<String, CmafWriteSegmentTimelineInRepresentation> enumMap;
    static {
        enumMap = new HashMap<String, CmafWriteSegmentTimelineInRepresentation>();
     ...
     * @return CmafWriteSegmentTimelineInRepresentation corresponding to the
     *         value
     */
