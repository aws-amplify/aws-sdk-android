 ...
 * the templates themselves, not just a list of them. To retrieve the next
 * twenty templates, use the nextToken string returned with the array
 */
public class ListJobTemplatesRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     ...
     * job templates from that category.
     *
     * @return Optionally, specify a job template category to limit responses to
     ...
     * job templates from that category.
     *
     * @param category Optionally, specify a job template category to limit
     *            responses to only job templates from that category.
     */
     ...
     * <b>Allowed Values: </b>NAME, CREATION_DATE, SYSTEM
     *
     * @return Optional. When you request a list of job templates, you can
     ...
     * <b>Allowed Values: </b>NAME, CREATION_DATE, SYSTEM
     *
     * @param listBy Optional. When you request a list of job templates, you can
     ...
     * @see JobTemplateListBy
     */
    public void setListBy(JobTemplateListBy listBy) {
     ...
     * <b>Range: </b>1 - 20<br/>
     *
     * @return Optional. Number of job templates, up to twenty, that will be
     ...
     * <b>Range: </b>1 - 20<br/>
     *
     * @param maxResults Optional. Number of job templates, up to twenty, that
     ...
     *            previous request, to request the next batch of job templates.
     */
