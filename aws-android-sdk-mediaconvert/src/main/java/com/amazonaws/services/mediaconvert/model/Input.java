...
public class Input implements Serializable {
     ...
     * use AWS Key Management Service (KMS) to encrypt the data key that you use
     ...
     * ]|[mM]3[uU
     * ]8|[wW][eE][bB][mM]|[lL][cC][hH]|[gG][xX][fF]_[mM][pP][eE][gG]2|
     * [mM][xX][fF
     * ]_[mM][pP][eE][gG]2|[mM][xX][fF][hH][dD]|[wW][aA][vV]|[yY]4[mM]
     * |[xX][mM][lL
     * ]))))|(https?://([^\/]+\/+)+([^\/\.]+|(([^\/]*)\.([mM]2[vV]|[mM
     * ][pP][eE][gG
     * ]|[mM][pP]3|[aA][vV][iI]|[mM][pP]4|[fF][lL][vV]|[mM][pP][tT]|[
     * mM][pP][gG]|
     * [mM]4[vV]|[tT][rR][pP]|[fF]4[vV]|[mM]2[tT][sS]|[tT][sS]|264|[hH
     * ]264|[mM][kK
     * ][vV]|[mM][oO][vV]|[mM][tT][sS]|[mM]2[tT]|[wW][mM][vV]|[aA][sS
     * ][fF]|[vV][oO
     * ][bB]|3[gG][pP]|3[gG][pP][pP]|[mM][xX][fF]|[dD][iI][vV][xX]|[
     * xX][vV][iI][dD
     * ]|[rR][aA][wW]|[dD][vV]|[gG][xX][fF]|[mM]1[vV]|3[gG]2|[vV][mM
     * ][fF]|[mM]3[uU
     * ]8|[wW][eE][bB][mM]|[lL][cC][hH]|[gG][xX][fF]_[mM][pP][eE][gG
     * ]2|[mM][xX][fF
     * ]_[mM][pP][eE][gG]2|[mM][xX][fF][hH][dD]|[wW][aA][vV]|[yY]4[
     * mM]|[xX][mM][lL])))(\?([^&=]+=[^&]+&)*[^&=]+=[^&]+)?))$<br/>
     */
     ...
     *         chained together.
     */
    public Input withAudioSelectorGroups(
     ...
     * input.
     *
     * @return Use captions selectors to specify the captions data from your
     *         input that you use in your outputs. You can use up to 20 captions
     *         selectors per input.
     */
     ...
     * input.
     *
     * @param captionSelectors Use captions selectors to specify the captions
     *            data from your input that you use in your outputs. You can use
     *            up to 20 captions selectors per input.
     */
     ...
     * to encrypt your content.
     *
     * @return Settings for decrypting any input files that you encrypt before
     *         you upload them to Amazon S3. MediaConvert can decrypt files only
     *         when you use AWS Key Management Service (KMS) to encrypt the data
     ...
     * to encrypt your content.
     *
     * @param decryptionSettings Settings for decrypting any input files that
     *            you encrypt before you upload them to Amazon S3. MediaConvert
     *            can decrypt files only when you use AWS Key Management Service
     *            (KMS) to encrypt the data key that you use to encrypt your
     *            content.
     */
     ...
     * mM]|[xX][mM][lL])))(\?([^&=]+=[^&]+&)*[^&=]+=[^&]+)?))$<br/>
     *
     * @return Specify the source file for your transcoding job. You can use
     *         multiple inputs in a single job. The service concatenates these
     *         inputs, in the order that you specify them in the job, to create
     *         the outputs. If your input format is IMF, specify your input by
     *         providing the path to your CPL. For example,
     *         "s3://bucket/vf/cpl.xml". If the CPL is in an incomplete IMP,
     *         make sure to use *Supplemental IMPs* (SupplementalImps) to
     *         specify any supplemental IMPs that contain assets referenced by
     *         the CPL.
     */
     ...
     * mM]|[xX][mM][lL])))(\?([^&=]+=[^&]+&)*[^&=]+=[^&]+)?))$<br/>
     *
     * @param fileInput Specify the source file for your transcoding job. You
     *            can use multiple inputs in a single job. The service
     *            concatenates these inputs, in the order that you specify them
     *            in the job, to create the outputs. If your input format is
     *            IMF, specify your input by providing the path to your CPL. For
     *            example, "s3://bucket/vf/cpl.xml". If the CPL is in an
     *            incomplete IMP, make sure to use *Supplemental IMPs*
     *            (SupplementalImps) to specify any supplemental IMPs that
     ...
     * contains your input CPL, because the service automatically detects it.
     *
     * @return Provide a list of any necessary supplemental IMPs. You need
     *         supplemental IMPs if the CPL that you're using for your input is
     *         in an incomplete IMP. Specify either the supplemental IMP
     *         directories with a trailing slash or the ASSETMAP.xml files. For
     *         example ["s3://bucket/ov/", "s3://bucket/vf2/ASSETMAP.xml"]. You
     *         don't need to specify the IMP that contains your input CPL,
     ...
     *            IMPs. You need supplemental IMPs if the CPL that you're using
     *            for your input is in an incomplete IMP. Specify either the
     *            supplemental IMP directories with a trailing slash or the
     *            ASSETMAP.xml files. For example ["s3://bucket/ov/",
     *            "s3://bucket/vf2/ASSETMAP.xml"]. You don't need to specify the
     *            IMP that contains your input CPL, because the service
    ...
    public Input withSupplementalImps(String... supplementalImps) {
        if (getSupplementalImps() == null) {
            this.supplementalImps = new java.util.ArrayList<String>(supplementalImps.length);
        }
        for (String value : supplementalImps) {
            this.supplementalImps.add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        if (getSupplementalImps() != null)
            sb.append("SupplementalImps: " + getSupplementalImps() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getDecryptionSettings() == null) ? 0 : getDecryptionSettings().hashCode());
        hashCode = prime * hashCode
        ...
        hashCode = prime * hashCode
                + ((getSupplementalImps() == null) ? 0 : getSupplementalImps().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDecryptionSettings() == null ^ this.getDecryptionSettings() == null)
            return false;
        if (other.getDecryptionSettings() != null
                && other.getDecryptionSettings().equals(this.getDecryptionSettings()) == false)
            return false;
        ...
        if (other.getFileInput() == null ^ this.getFileInput() == null)
            return false;
        if (other.getFileInput() != null
                && other.getFileInput().equals(this.getFileInput()) == false)
            return false;
        ...
        if (other.getSupplementalImps() == null ^ this.getSupplementalImps() == null)
            return false;
        if (other.getSupplementalImps() != null
                && other.getSupplementalImps().equals(this.getSupplementalImps()) == false)
            return false;
