...
class VideoCodecSettingsJsonMarshaller {
    ...
    public void marshall(VideoCodecSettings videoCodecSettings, AwsJsonWriter jsonWriter)
        ...
        if (videoCodecSettings.getVp8Settings() != null) {
            Vp8Settings vp8Settings = videoCodecSettings.getVp8Settings();
            jsonWriter.name("Vp8Settings");
            Vp8SettingsJsonMarshaller.getInstance().marshall(vp8Settings, jsonWriter);
        }
        if (videoCodecSettings.getVp9Settings() != null) {
            Vp9Settings vp9Settings = videoCodecSettings.getVp9Settings();
            jsonWriter.name("Vp9Settings");
            Vp9SettingsJsonMarshaller.getInstance().marshall(vp9Settings, jsonWriter);
        }
