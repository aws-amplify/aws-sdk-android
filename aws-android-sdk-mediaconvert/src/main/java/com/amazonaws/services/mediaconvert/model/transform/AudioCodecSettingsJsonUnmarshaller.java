        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AacSettings")) {
                ...
                audioCodecSettings.setAc3Settings(Ac3SettingsJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("AiffSettings")) {
                audioCodecSettings.setAiffSettings(AiffSettingsJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Codec")) {
                audioCodecSettings.setCodec(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Eac3AtmosSettings")) {
                audioCodecSettings.setEac3AtmosSettings(Eac3AtmosSettingsJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                audioCodecSettings.setMp2Settings(Mp2SettingsJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Mp3Settings")) {
                audioCodecSettings.setMp3Settings(Mp3SettingsJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("OpusSettings")) {
                audioCodecSettings.setOpusSettings(OpusSettingsJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("VorbisSettings")) {
                audioCodecSettings.setVorbisSettings(VorbisSettingsJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("WavSettings")) {
                audioCodecSettings.setWavSettings(WavSettingsJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
