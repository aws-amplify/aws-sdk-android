...
public enum Eac3AtmosCodingMode {
    ...
    private static final Map<String, Eac3AtmosCodingMode> enumMap;
    static {
        enumMap = new HashMap<String, Eac3AtmosCodingMode>();
        enumMap.put("CODING_MODE_9_1_6", CODING_MODE_9_1_6);
    }
