...
/**
 * JSON unmarshaller for POJO Av1QvbrSettings
 */
class Av1QvbrSettingsJsonUnmarshaller implements
        Unmarshaller<Av1QvbrSettings, JsonUnmarshallerContext> {
    ...
    public Av1QvbrSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("QvbrQualityLevel")) {
                av1QvbrSettings.setQvbrQualityLevel(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("QvbrQualityLevelFineTune")) {
                av1QvbrSettings.setQvbrQualityLevelFineTune(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
