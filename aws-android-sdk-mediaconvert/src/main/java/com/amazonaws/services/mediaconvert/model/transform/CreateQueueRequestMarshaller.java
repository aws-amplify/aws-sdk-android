...
public class CreateQueueRequestMarshaller implements
    ...
    public Request<CreateQueueRequest> marshall(CreateQueueRequest createQueueRequest) {
        ...
        Request<CreateQueueRequest> request = new DefaultRequest<CreateQueueRequest>(
                createQueueRequest, "AWSElementalMediaConvert");
        ...
        try {
            ...
            if (createQueueRequest.getPricingPlan() != null) {
                String pricingPlan = createQueueRequest.getPricingPlan();
                jsonWriter.name("PricingPlan");
                jsonWriter.value(pricingPlan);
            }
            if (createQueueRequest.getReservationPlanSettings() != null) {
                ReservationPlanSettings reservationPlanSettings = createQueueRequest
            ...
            if (createQueueRequest.getStatus() != null) {
                String status = createQueueRequest.getStatus();
