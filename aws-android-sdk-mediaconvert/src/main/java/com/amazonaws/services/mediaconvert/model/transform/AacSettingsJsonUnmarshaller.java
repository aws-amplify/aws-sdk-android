...
class AacSettingsJsonUnmarshaller implements Unmarshaller<AacSettings, JsonUnmarshallerContext> {
    ...
    public AacSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AudioDescriptionBroadcasterMix")) {
                aacSettings.setAudioDescriptionBroadcasterMix(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Bitrate")) {
                aacSettings.setBitrate(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("CodecProfile")) {
                aacSettings.setCodecProfile(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                aacSettings.setSampleRate(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Specification")) {
                aacSettings.setSpecification(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
