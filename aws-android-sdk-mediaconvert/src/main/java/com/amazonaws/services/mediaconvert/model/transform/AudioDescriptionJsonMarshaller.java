...
class AudioDescriptionJsonMarshaller {
    ...
    public void marshall(AudioDescription audioDescription, AwsJsonWriter jsonWriter)
        ...
        if (audioDescription.getAudioSourceName() != null) {
            String audioSourceName = audioDescription.getAudioSourceName();
            jsonWriter.name("AudioSourceName");
            jsonWriter.value(audioSourceName);
        }
        if (audioDescription.getAudioType() != null) {
            Integer audioType = audioDescription.getAudioType();
        ...
        if (audioDescription.getCustomLanguageCode() != null) {
            String customLanguageCode = audioDescription.getCustomLanguageCode();
