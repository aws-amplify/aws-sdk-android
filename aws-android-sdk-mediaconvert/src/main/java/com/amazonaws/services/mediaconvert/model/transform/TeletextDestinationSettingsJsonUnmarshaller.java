 ...
 */
class TeletextDestinationSettingsJsonUnmarshaller implements
        Unmarshaller<TeletextDestinationSettings, JsonUnmarshallerContext> {
    ...
    public TeletextDestinationSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PageNumber")) {
                teletextDestinationSettings.setPageNumber(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("PageTypes")) {
                teletextDestinationSettings.setPageTypes(new ListUnmarshaller<String>(
