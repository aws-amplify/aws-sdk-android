        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Av1Settings")) {
                ...
                videoCodecSettings.setProresSettings(ProresSettingsJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Vp8Settings")) {
                videoCodecSettings.setVp8Settings(Vp8SettingsJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Vp9Settings")) {
                videoCodecSettings.setVp9Settings(Vp9SettingsJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
