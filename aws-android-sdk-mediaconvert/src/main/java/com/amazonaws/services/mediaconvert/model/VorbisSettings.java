 ...
 * value Vorbis.
 */
public class VorbisSettings implements Serializable {
    /**
     ...
     * -1 (lowest quality, ~45 kbit/s) to 10 (highest quality, ~500 kbit/s). The
     * default value is 4 (~128 kbit/s). Values 5 and 6 are approximately 160
     ...
     * <b>Range: </b>1 - 2<br/>
     *
     * @return Optional. Specify the number of channels in this output audio
     *         track. Choosing Mono on the console gives you 1 output channel;
     *         choosing Stereo gives you 2. In the API, valid values are 1 and
     ...
     * <b>Range: </b>1 - 2<br/>
     *
     * @param channels Optional. Specify the number of channels in this output
     *            audio track. Choosing Mono on the console gives you 1 output
     ...
     * <b>Range: </b>22050 - 48000<br/>
     *
     * @return Optional. Specify the audio sample rate in Hz. Valid values are
     ...
     * <b>Range: </b>22050 - 48000<br/>
     *
     * @param sampleRate Optional. Specify the audio sample rate in Hz. Valid
     *            values are 22050, 32000, 44100, and 48000. The default value
     *            is 48000.
     */
     ...
     * <b>Range: </b>-1 - 10<br/>
     *
     * @return Optional. Specify the variable audio quality of this Vorbis
     *         output from -1 (lowest quality, ~45 kbit/s) to 10 (highest
     *         quality, ~500 kbit/s). The default value is 4 (~128 kbit/s).
     *         Values 5 and 6 are approximately 160 and 192 kbit/s,
     *         respectively.
     */
     ...
     * <b>Range: </b>-1 - 10<br/>
     *
     * @param vbrQuality Optional. Specify the variable audio quality of this
     *            Vorbis output from -1 (lowest quality, ~45 kbit/s) to 10
     *            (highest quality, ~500 kbit/s). The default value is 4 (~128
     *            kbit/s). Values 5 and 6 are approximately 160 and 192 kbit/s,
     *            respectively.
     */
