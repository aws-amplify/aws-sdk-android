...
public class DvbNitSettings implements Serializable {
     ...
     * <b>Length: </b>1 - 256<br/>
     *
     * @return The network name text placed in the network_name_descriptor
     *         inside the Network Information Table. Maximum length is 256
     *         characters.
     */
     ...
     * <b>Range: </b>25 - 10000<br/>
     *
     * @param nitInterval The number of milliseconds between instances of this
    ...
    public String toString() {
        ...
        if (getNitInterval() != null)
            sb.append("NitInterval: " + getNitInterval());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getNitInterval() == null) ? 0 : getNitInterval().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getNitInterval() == null ^ this.getNitInterval() == null)
            return false;
        if (other.getNitInterval() != null
                && other.getNitInterval().equals(this.getNitInterval()) == false)
            return false;
        return true;
    }
}
