 ...
 * value VP8.
 */
public class Vp8Settings implements Serializable {
    /**
    ...
    public void setFramerateConversionAlgorithm(
            Vp8FramerateConversionAlgorithm framerateConversionAlgorithm) {
     ...
     * @see Vp8FramerateConversionAlgorithm
     */
    public Vp8Settings withFramerateConversionAlgorithm(
            Vp8FramerateConversionAlgorithm framerateConversionAlgorithm) {
        this.framerateConversionAlgorithm = framerateConversionAlgorithm.toString();
        return this;
    }
     ...
     * <b>Range: </b>0 - 47185920<br/>
     *
     * @return Optional. Size of buffer (HRD buffer model) in bits. For example,
     ...
     * <b>Range: </b>0 - 47185920<br/>
     *
     * @param hrdBufferSize Optional. Size of buffer (HRD buffer model) in bits.
     ...
     * <b>Allowed Values: </b>VBR
     *
     * @return With the VP8 codec, you can use only the variable bitrate (VBR)
     *         rate control mode.
     ...
     * <b>Allowed Values: </b>VBR
     *
     * @param rateControlMode With the VP8 codec, you can use only the variable
