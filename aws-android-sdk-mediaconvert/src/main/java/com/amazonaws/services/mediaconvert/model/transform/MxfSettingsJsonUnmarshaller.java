...
/**
 * JSON unmarshaller for POJO MxfSettings
 */
class MxfSettingsJsonUnmarshaller implements Unmarshaller<MxfSettings, JsonUnmarshallerContext> {
    ...
    public MxfSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AfdSignaling")) {
                mxfSettings.setAfdSignaling(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
