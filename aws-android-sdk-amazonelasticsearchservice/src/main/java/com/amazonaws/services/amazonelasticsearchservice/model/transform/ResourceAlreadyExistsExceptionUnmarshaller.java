...
import com.amazonaws.services.amazonelasticsearchservice.model.ResourceAlreadyExistsException;
...
public class ResourceAlreadyExistsExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("ResourceAlreadyExistsException");
    }
