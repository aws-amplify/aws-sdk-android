...
import com.amazonaws.services.amazonelasticsearchservice.model.InternalException;
...
public class InternalExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        InternalException e = (InternalException) super.unmarshall(error);
        e.setErrorCode("InternalException");
