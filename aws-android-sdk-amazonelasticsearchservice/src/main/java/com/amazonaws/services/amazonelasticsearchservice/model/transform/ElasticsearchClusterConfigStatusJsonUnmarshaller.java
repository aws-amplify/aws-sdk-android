...
/**
 * JSON unmarshaller for POJO ElasticsearchClusterConfigStatus
 */
class ElasticsearchClusterConfigStatusJsonUnmarshaller implements
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Options")) {
                elasticsearchClusterConfigStatus
                        .setOptions(ElasticsearchClusterConfigJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("Status")) {
                elasticsearchClusterConfigStatus.setStatus(OptionStatusJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
