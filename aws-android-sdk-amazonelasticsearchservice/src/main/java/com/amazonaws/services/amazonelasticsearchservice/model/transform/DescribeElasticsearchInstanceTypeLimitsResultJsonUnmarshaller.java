...
/**
 * JSON unmarshaller for response DescribeElasticsearchInstanceTypeLimitsResult
 */
public class DescribeElasticsearchInstanceTypeLimitsResultJsonUnmarshaller implements
    ...
    public DescribeElasticsearchInstanceTypeLimitsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("LimitsByRole")) {
                describeElasticsearchInstanceTypeLimitsResult
                        .setLimitsByRole(new MapUnmarshaller<Limits>(LimitsJsonUnmarshaller
                                .getInstance()
                        )
                                .unmarshall(context));
            } else {
