...
/**
 * JSON request marshaller for GetCompatibleElasticsearchVersionsRequest
 */
public class GetCompatibleElasticsearchVersionsRequestMarshaller
    ...
    public Request<GetCompatibleElasticsearchVersionsRequest> marshall(
        ...
        if (getCompatibleElasticsearchVersionsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetCompatibleElasticsearchVersionsRequest)");
        }

        Request<GetCompatibleElasticsearchVersionsRequest> request = new DefaultRequest<GetCompatibleElasticsearchVersionsRequest>(
                getCompatibleElasticsearchVersionsRequest, "AmazonElasticsearchService");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/2015-01-01/es/compatibleVersions";
        if (getCompatibleElasticsearchVersionsRequest.getDomainName() != null) {
            request.addParameter("domainName", StringUtils
                    .fromString(getCompatibleElasticsearchVersionsRequest.getDomainName()));
        }
