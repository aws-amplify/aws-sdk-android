...
public enum PackageStatus {
    ...
    private static final Map<String, PackageStatus> enumMap;
    static {
        enumMap = new HashMap<String, PackageStatus>();
        enumMap.put("COPYING", COPYING);
        enumMap.put("COPY_FAILED", COPY_FAILED);
