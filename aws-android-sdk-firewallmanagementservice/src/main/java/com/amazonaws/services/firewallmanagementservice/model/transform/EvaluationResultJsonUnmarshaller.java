...
class EvaluationResultJsonUnmarshaller implements
    ...
    public EvaluationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ComplianceStatus")) {
                evaluationResult.setComplianceStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ViolatorCount")) {
                evaluationResult.setViolatorCount(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("EvaluationLimitExceeded")) {
                evaluationResult.setEvaluationLimitExceeded(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
