...
/**
 * JSON unmarshaller for response ListComplianceStatusResult
 */
public class ListComplianceStatusResultJsonUnmarshaller implements
        Unmarshaller<ListComplianceStatusResult, JsonUnmarshallerContext> {
    ...
    public ListComplianceStatusResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PolicyComplianceStatusList")) {
                listComplianceStatusResult
                        .setPolicyComplianceStatusList(new ListUnmarshaller<PolicyComplianceStatus>(
                                PolicyComplianceStatusJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                listComplianceStatusResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
