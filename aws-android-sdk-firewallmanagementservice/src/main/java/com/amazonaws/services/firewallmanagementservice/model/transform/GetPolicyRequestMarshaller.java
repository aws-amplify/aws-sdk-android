...
/**
 * JSON request marshaller for GetPolicyRequest
 */
public class GetPolicyRequestMarshaller implements
    ...
    public Request<GetPolicyRequest> marshall(GetPolicyRequest getPolicyRequest) {
        ...
        Request<GetPolicyRequest> request = new DefaultRequest<GetPolicyRequest>(getPolicyRequest,
        ...
        try {
            ...
            if (getPolicyRequest.getPolicyId() != null) {
                String policyId = getPolicyRequest.getPolicyId();
