...
/**
 * JSON request marshaller for DeletePolicyRequest
 */
public class DeletePolicyRequestMarshaller implements
    ...
    public Request<DeletePolicyRequest> marshall(DeletePolicyRequest deletePolicyRequest) {
        ...
        Request<DeletePolicyRequest> request = new DefaultRequest<DeletePolicyRequest>(
                deletePolicyRequest, "FirewallManagementService");
        ...
        try {
            ...
            if (deletePolicyRequest.getPolicyId() != null) {
                String policyId = deletePolicyRequest.getPolicyId();
                jsonWriter.name("PolicyId");
                jsonWriter.value(policyId);
            }
            if (deletePolicyRequest.getDeleteAllPolicyResources() != null) {
                Boolean deleteAllPolicyResources = deletePolicyRequest
                        .getDeleteAllPolicyResources();
                jsonWriter.name("DeleteAllPolicyResources");
                jsonWriter.value(deleteAllPolicyResources);
            }
