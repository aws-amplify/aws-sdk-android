...
public class UntagResourceRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         The Amazon Resource Name (ARN) of the resource. The Firewall
     *         Manager policy is the only AWS resource that supports tagging, so
     ...
     * @param resourceArn <p>
     *            The Amazon Resource Name (ARN) of the resource. The Firewall
     *            Manager policy is the only AWS resource that supports tagging,
