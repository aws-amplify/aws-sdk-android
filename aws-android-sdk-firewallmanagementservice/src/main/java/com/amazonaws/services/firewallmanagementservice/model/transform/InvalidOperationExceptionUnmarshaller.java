...
import com.amazonaws.services.firewallmanagementservice.model.InvalidOperationException;
...
public class InvalidOperationExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InvalidOperationException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        InvalidOperationException e = (InvalidOperationException) super.unmarshall(error);
