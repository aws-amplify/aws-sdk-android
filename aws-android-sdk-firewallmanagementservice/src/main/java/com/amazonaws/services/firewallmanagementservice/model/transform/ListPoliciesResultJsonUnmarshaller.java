...
public class ListPoliciesResultJsonUnmarshaller implements
    ...
    public ListPoliciesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PolicyList")) {
                listPoliciesResult.setPolicyList(new ListUnmarshaller<PolicySummary>(
                        PolicySummaryJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                listPoliciesResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
