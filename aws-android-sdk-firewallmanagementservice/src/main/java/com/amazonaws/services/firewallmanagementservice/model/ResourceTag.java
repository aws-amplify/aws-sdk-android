 ...
 * optional value. Firewall Manager combines the tags with "AND" so that, if you
 * add more than one tag to a policy scope, a resource must have all the
 * specified tags to be included or excluded. For more information, see <a href=
 * "https://docs.aws.amazon.com/awsconsolehelpdocs/latest/gsg/tag-editor.html"
 * >Working with Tag Editor</a>.
 * </p>
 */
