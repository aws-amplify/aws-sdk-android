...
import com.amazonaws.services.awsdatabasemigrationservice.model.KMSDisabledException;
...
public class KMSDisabledExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("KMSDisabledFault");
    }
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        e.setErrorCode("KMSDisabledFault");
