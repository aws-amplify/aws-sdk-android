...
public enum ReloadOptionValue {
    ...
    private static final Map<String, ReloadOptionValue> enumMap;
    static {
        enumMap = new HashMap<String, ReloadOptionValue>();
        enumMap.put("data-reload", DataReload);
        enumMap.put("validate-only", ValidateOnly);
    }
