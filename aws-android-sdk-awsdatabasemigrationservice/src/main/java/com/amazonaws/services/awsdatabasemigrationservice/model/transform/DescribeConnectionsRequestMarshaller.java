...
/**
 * JSON request marshaller for DescribeConnectionsRequest
 */
public class DescribeConnectionsRequestMarshaller implements
    ...
    public Request<DescribeConnectionsRequest> marshall(
        ...
        if (describeConnectionsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeConnectionsRequest)");
        }
        ...
        try {
            ...
            if (describeConnectionsRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeConnectionsRequest.getFilters();
            ...
            if (describeConnectionsRequest.getMaxRecords() != null) {
                Integer maxRecords = describeConnectionsRequest.getMaxRecords();
                jsonWriter.name("MaxRecords");
                jsonWriter.value(maxRecords);
            }
            if (describeConnectionsRequest.getMarker() != null) {
                String marker = describeConnectionsRequest.getMarker();
