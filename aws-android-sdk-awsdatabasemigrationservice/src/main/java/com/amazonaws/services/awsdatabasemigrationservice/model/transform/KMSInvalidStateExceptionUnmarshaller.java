...
import com.amazonaws.services.awsdatabasemigrationservice.model.KMSInvalidStateException;
...
public class KMSInvalidStateExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("KMSInvalidStateFault");
    }
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        e.setErrorCode("KMSInvalidStateFault");
