...
/**
 * JSON unmarshaller for response DescribeOrderableReplicationInstancesResult
 */
public class DescribeOrderableReplicationInstancesResultJsonUnmarshaller implements
    ...
    public DescribeOrderableReplicationInstancesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("OrderableReplicationInstances")) {
                describeOrderableReplicationInstancesResult
                        .setOrderableReplicationInstances(new ListUnmarshaller<OrderableReplicationInstance>(
                                OrderableReplicationInstanceJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Marker")) {
                describeOrderableReplicationInstancesResult.setMarker(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
