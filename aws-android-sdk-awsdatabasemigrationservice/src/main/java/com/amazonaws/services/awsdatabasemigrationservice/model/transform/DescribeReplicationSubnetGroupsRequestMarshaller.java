...
/**
 * JSON request marshaller for DescribeReplicationSubnetGroupsRequest
 */
    ...
    public Request<DescribeReplicationSubnetGroupsRequest> marshall(
        ...
        if (describeReplicationSubnetGroupsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeReplicationSubnetGroupsRequest)");
        }
        ...
        try {
            ...
            if (describeReplicationSubnetGroupsRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeReplicationSubnetGroupsRequest
                        .getFilters();
            ...
            if (describeReplicationSubnetGroupsRequest.getMaxRecords() != null) {
                Integer maxRecords = describeReplicationSubnetGroupsRequest.getMaxRecords();
                jsonWriter.name("MaxRecords");
                jsonWriter.value(maxRecords);
            }
            if (describeReplicationSubnetGroupsRequest.getMarker() != null) {
                String marker = describeReplicationSubnetGroupsRequest.getMarker();
