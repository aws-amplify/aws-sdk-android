...
import com.amazonaws.services.awsdatabasemigrationservice.model.KMSAccessDeniedException;
...
public class KMSAccessDeniedExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("KMSAccessDeniedFault");
    }
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        e.setErrorCode("KMSAccessDeniedFault");
