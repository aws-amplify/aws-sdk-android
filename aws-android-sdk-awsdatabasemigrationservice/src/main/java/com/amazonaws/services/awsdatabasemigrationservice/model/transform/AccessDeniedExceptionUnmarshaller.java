...
import com.amazonaws.services.awsdatabasemigrationservice.model.AccessDeniedException;
...
public class AccessDeniedExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("AccessDeniedFault");
    }
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        e.setErrorCode("AccessDeniedFault");
