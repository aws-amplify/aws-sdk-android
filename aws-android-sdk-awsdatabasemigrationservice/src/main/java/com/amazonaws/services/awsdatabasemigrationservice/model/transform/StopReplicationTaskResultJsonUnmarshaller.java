...
/**
 * JSON unmarshaller for response StopReplicationTaskResult
 */
public class StopReplicationTaskResultJsonUnmarshaller implements
        Unmarshaller<StopReplicationTaskResult, JsonUnmarshallerContext> {
    ...
    public StopReplicationTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ReplicationTask")) {
                stopReplicationTaskResult.setReplicationTask(ReplicationTaskJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
