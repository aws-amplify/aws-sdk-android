...
/**
 * JSON unmarshaller for response DescribeReplicationInstanceTaskLogsResult
 */
public class DescribeReplicationInstanceTaskLogsResultJsonUnmarshaller implements
    ...
    public DescribeReplicationInstanceTaskLogsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ReplicationInstanceArn")) {
                describeReplicationInstanceTaskLogsResult
                        .setReplicationInstanceArn(StringJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else if (name.equals("ReplicationInstanceTaskLogs")) {
                describeReplicationInstanceTaskLogsResult
                        .setReplicationInstanceTaskLogs(new ListUnmarshaller<ReplicationInstanceTaskLog>(
                                ReplicationInstanceTaskLogJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("Marker")) {
                describeReplicationInstanceTaskLogsResult.setMarker(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
