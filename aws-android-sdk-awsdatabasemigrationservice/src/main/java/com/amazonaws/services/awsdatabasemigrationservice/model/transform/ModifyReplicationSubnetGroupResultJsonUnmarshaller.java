...
/**
 * JSON unmarshaller for response ModifyReplicationSubnetGroupResult
 */
public class ModifyReplicationSubnetGroupResultJsonUnmarshaller implements
        Unmarshaller<ModifyReplicationSubnetGroupResult, JsonUnmarshallerContext> {

    public ModifyReplicationSubnetGroupResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
