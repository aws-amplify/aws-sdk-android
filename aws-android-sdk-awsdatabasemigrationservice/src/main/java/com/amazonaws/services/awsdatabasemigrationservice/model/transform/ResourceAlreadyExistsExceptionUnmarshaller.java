...
import com.amazonaws.services.awsdatabasemigrationservice.model.ResourceAlreadyExistsException;
...
public class ResourceAlreadyExistsExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("ResourceAlreadyExistsFault");
    }
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        e.setErrorCode("ResourceAlreadyExistsFault");
