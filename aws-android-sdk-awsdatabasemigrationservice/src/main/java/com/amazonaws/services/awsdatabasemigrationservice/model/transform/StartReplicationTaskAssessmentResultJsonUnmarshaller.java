...
/**
 * JSON unmarshaller for response StartReplicationTaskAssessmentResult
 */
public class StartReplicationTaskAssessmentResultJsonUnmarshaller implements
        Unmarshaller<StartReplicationTaskAssessmentResult, JsonUnmarshallerContext> {

    public StartReplicationTaskAssessmentResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ReplicationTask")) {
                startReplicationTaskAssessmentResult
                        .setReplicationTask(ReplicationTaskJsonUnmarshaller.getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
            }
