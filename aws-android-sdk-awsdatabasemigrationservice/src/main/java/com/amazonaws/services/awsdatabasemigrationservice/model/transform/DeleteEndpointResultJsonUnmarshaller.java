...
/**
 * JSON unmarshaller for response DeleteEndpointResult
 */
public class DeleteEndpointResultJsonUnmarshaller implements
        Unmarshaller<DeleteEndpointResult, JsonUnmarshallerContext> {
    ...
    public DeleteEndpointResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Endpoint")) {
                deleteEndpointResult.setEndpoint(EndpointJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
