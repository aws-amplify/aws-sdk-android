...
public class MongoDbSettings implements Serializable {
     ...
     * <code>NestingLevel</code> is set to NONE.
     * </p>
     * <p>
     ...
     *         </p>
     *         <p>
     *         When NO is selected, user name and password parameters are not
     ...
     *         </p>
     *         <p>
     *         DEFAULT – For MongoDB version 2.x, use MONGODB_CR. For MongoDB
     *         version 3.x, use SCRAM_SHA_1. This setting isn't used when
     *         authType=No.
     *         </p>
