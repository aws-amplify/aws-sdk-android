...
public class DescribeEndpointsRequestMarshaller implements
    ...
    public Request<DescribeEndpointsRequest> marshall(
        ...
        try {
            ...
            if (describeEndpointsRequest.getFilters() != null) {
                java.util.List<Filter> filters = describeEndpointsRequest.getFilters();
            ...
            if (describeEndpointsRequest.getMaxRecords() != null) {
                Integer maxRecords = describeEndpointsRequest.getMaxRecords();
                jsonWriter.name("MaxRecords");
                jsonWriter.value(maxRecords);
            }
            if (describeEndpointsRequest.getMarker() != null) {
                String marker = describeEndpointsRequest.getMarker();
