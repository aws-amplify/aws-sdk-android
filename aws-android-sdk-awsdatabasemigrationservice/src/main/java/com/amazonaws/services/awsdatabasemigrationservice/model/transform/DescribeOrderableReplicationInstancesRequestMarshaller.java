...
/**
 * JSON request marshaller for DescribeOrderableReplicationInstancesRequest
 */
    ...
    public Request<DescribeOrderableReplicationInstancesRequest> marshall(
        ...
        if (describeOrderableReplicationInstancesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeOrderableReplicationInstancesRequest)");
        }
        ...
        try {
            ...
            if (describeOrderableReplicationInstancesRequest.getMaxRecords() != null) {
                Integer maxRecords = describeOrderableReplicationInstancesRequest.getMaxRecords();
                jsonWriter.name("MaxRecords");
                jsonWriter.value(maxRecords);
            }
            if (describeOrderableReplicationInstancesRequest.getMarker() != null) {
                String marker = describeOrderableReplicationInstancesRequest.getMarker();
