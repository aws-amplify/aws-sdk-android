...
import com.amazonaws.services.awsdatabasemigrationservice.model.KMSNotFoundException;
...
public class KMSNotFoundExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("KMSNotFoundFault");
    }
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        e.setErrorCode("KMSNotFoundFault");
