...
/**
 * JSON unmarshaller for response DescribeReplicationSubnetGroupsResult
 */
public class DescribeReplicationSubnetGroupsResultJsonUnmarshaller implements
        Unmarshaller<DescribeReplicationSubnetGroupsResult, JsonUnmarshallerContext> {

    public DescribeReplicationSubnetGroupsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Marker")) {
                describeReplicationSubnetGroupsResult.setMarker(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("ReplicationSubnetGroups")) {
