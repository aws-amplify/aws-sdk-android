...
/**
 * JSON unmarshaller for response DeleteResourcePolicyResult
 */
public class DeleteResourcePolicyResultJsonUnmarshaller implements Unmarshaller<DeleteResourcePolicyResult, JsonUnmarshallerContext> {
    ...
    public DeleteResourcePolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ARN")) {
                deleteResourcePolicyResult.setARN(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Name")) {
                deleteResourcePolicyResult.setName(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static DeleteResourcePolicyResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DeleteResourcePolicyResultJsonUnmarshaller();
        return instance;
    }
}
