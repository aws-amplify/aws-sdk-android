...
/**
 * JSON unmarshaller for response GetRandomPasswordResult
 */
    ...
    public GetRandomPasswordResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("RandomPassword")) {
                getRandomPasswordResult.setRandomPassword(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static GetRandomPasswordResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new GetRandomPasswordResultJsonUnmarshaller();
        return instance;
    }
}
