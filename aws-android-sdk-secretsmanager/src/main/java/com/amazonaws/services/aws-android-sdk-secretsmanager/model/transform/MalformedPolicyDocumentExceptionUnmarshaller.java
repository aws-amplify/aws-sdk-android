...
import com.amazonaws.services.aws-android-sdk-secretsmanager.model.MalformedPolicyDocumentException;
...
public class MalformedPolicyDocumentExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("MalformedPolicyDocumentException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
   		
        MalformedPolicyDocumentException e = (MalformedPolicyDocumentException)super.unmarshall(error);
