...
public enum FilterNameStringType {
    ...
    private static final Map<String, FilterNameStringType> enumMap;
    static {
        enumMap = new HashMap<String, FilterNameStringType>();
        enumMap.put("description", Description);
        enumMap.put("name", Name);
        enumMap.put("tag-key", TagKey);
        enumMap.put("tag-value", TagValue);
        enumMap.put("all", All);
    }
