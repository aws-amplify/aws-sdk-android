...
public class PutResourcePolicyResultJsonUnmarshaller implements Unmarshaller<PutResourcePolicyResult, JsonUnmarshallerContext> {
    ...
    public PutResourcePolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ARN")) {
                putResourcePolicyResult.setARN(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Name")) {
                putResourcePolicyResult.setName(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static PutResourcePolicyResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new PutResourcePolicyResultJsonUnmarshaller();
        return instance;
    }
}
