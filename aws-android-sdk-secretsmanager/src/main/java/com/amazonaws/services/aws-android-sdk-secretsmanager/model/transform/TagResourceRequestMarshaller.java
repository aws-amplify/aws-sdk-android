...
public class TagResourceRequestMarshaller implements Marshaller<Request<TagResourceRequest>, TagResourceRequest> {
    ...
    public Request<TagResourceRequest> marshall(TagResourceRequest tagResourceRequest) {
        ...
        Request<TagResourceRequest> request = new DefaultRequest<TagResourceRequest>(tagResourceRequest, "AWSSecretsManager");
        ...
        try {
            ...
            if (tagResourceRequest.getSecretId() != null) {
                String secretId = tagResourceRequest.getSecretId();
