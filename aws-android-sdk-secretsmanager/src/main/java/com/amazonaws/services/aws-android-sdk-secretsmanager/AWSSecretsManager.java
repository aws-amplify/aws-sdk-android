...
public interface AWSSecretsManager {
    ...
    /**
     * Overrides the default endpoint for this client ("https://secretsmanager.us-east-1.amazonaws.com").
     * Callers can use this method to control which AWS region they want to work with.
     * <p>
     * Callers can pass in just the endpoint (ex: "secretsmanager.us-east-1.amazonaws.com") or a full
     * URL, including the protocol (ex: "https://secretsmanager.us-east-1.amazonaws.com"). If the
     ...
     *
     * @param endpoint
     *            The endpoint (ex: "secretsmanager.us-east-1.amazonaws.com") or a full URL,
     *            including the protocol (ex: "https://secretsmanager.us-east-1.amazonaws.com") of
    ...
    /**
     * An alternative to {@link AWSSecretsManager#setEndpoint(String)}, sets the
     ...
     */
    CancelRotateSecretResult cancelRotateSecret(CancelRotateSecretRequest cancelRotateSecretRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    CreateSecretResult createSecret(CreateSecretRequest createSecretRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DeleteResourcePolicyResult deleteResourcePolicy(DeleteResourcePolicyRequest deleteResourcePolicyRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DeleteSecretResult deleteSecret(DeleteSecretRequest deleteSecretRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    DescribeSecretResult describeSecret(DescribeSecretRequest describeSecretRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    GetRandomPasswordResult getRandomPassword(GetRandomPasswordRequest getRandomPasswordRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    GetResourcePolicyResult getResourcePolicy(GetResourcePolicyRequest getResourcePolicyRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    GetSecretValueResult getSecretValue(GetSecretValueRequest getSecretValueRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    ListSecretVersionIdsResult listSecretVersionIds(ListSecretVersionIdsRequest listSecretVersionIdsRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    ListSecretsResult listSecrets(ListSecretsRequest listSecretsRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    PutSecretValueResult putSecretValue(PutSecretValueRequest putSecretValueRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    RestoreSecretResult restoreSecret(RestoreSecretRequest restoreSecretRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    RotateSecretResult rotateSecret(RotateSecretRequest rotateSecretRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    UpdateSecretResult updateSecret(UpdateSecretRequest updateSecretRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    UpdateSecretVersionStageResult updateSecretVersionStage(UpdateSecretVersionStageRequest updateSecretVersionStageRequest) throws AmazonClientException, AmazonServiceException;
     ...
     *             either a problem with the data in the request, or a server side issue.
     */
    ValidateResourcePolicyResult validateResourcePolicy(ValidateResourcePolicyRequest validateResourcePolicyRequest) throws AmazonClientException, AmazonServiceException;
