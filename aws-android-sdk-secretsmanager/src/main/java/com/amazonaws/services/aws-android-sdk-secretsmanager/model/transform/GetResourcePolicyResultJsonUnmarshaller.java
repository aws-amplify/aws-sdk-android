...
public class GetResourcePolicyResultJsonUnmarshaller implements Unmarshaller<GetResourcePolicyResult, JsonUnmarshallerContext> {
    ...
    public GetResourcePolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ARN")) {
                getResourcePolicyResult.setARN(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("Name")) {
                getResourcePolicyResult.setName(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else if (name.equals("ResourcePolicy")) {
                getResourcePolicyResult.setResourcePolicy(StringJsonUnmarshaller.getInstance()
.unmarshall(context));
            } else {
                reader.skipValue();
            }
    ...
    public static GetResourcePolicyResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new GetResourcePolicyResultJsonUnmarshaller();
        return instance;
    }
}
