...
public class UntagResourceRequestMarshaller implements Marshaller<Request<UntagResourceRequest>, UntagResourceRequest> {
    ...
    public Request<UntagResourceRequest> marshall(UntagResourceRequest untagResourceRequest) {
        ...
        Request<UntagResourceRequest> request = new DefaultRequest<UntagResourceRequest>(untagResourceRequest, "AWSSecretsManager");
        ...
        try {
            ...
            if (untagResourceRequest.getSecretId() != null) {
                String secretId = untagResourceRequest.getSecretId();
