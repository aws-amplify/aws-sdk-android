...
public class CreateSecretResult implements Serializable {
    /**
     ...
     * <b>Length: </b>20 - 2048<br/>
     *
     * @return <p>The Amazon Resource Name (ARN) of the secret that you just created.</p> <note> <p>Secrets Manager automatically adds several random characters to the name at the end of the ARN when you initially create a secret. This affects only the ARN and not the actual friendly name. This ensures that if you create a new secret with the same name as an old secret that you previously deleted, then users with access to the old secret <i>don't</i> automatically get access to the new secret because the ARNs are different.</p> </note>
     */
     ...
     * <b>Length: </b>20 - 2048<br/>
     *
     * @param aRN <p>The Amazon Resource Name (ARN) of the secret that you just created.</p> <note> <p>Secrets Manager automatically adds several random characters to the name at the end of the ARN when you initially create a secret. This affects only the ARN and not the actual friendly name. This ensures that if you create a new secret with the same name as an old secret that you previously deleted, then users with access to the old secret <i>don't</i> automatically get access to the new secret because the ARNs are different.</p> </note>
     */
     ...
     * <b>Length: </b>1 - 256<br/>
     *
     * @return <p>The friendly name of the secret that you just created.</p>
     */
     ...
     * <b>Length: </b>1 - 256<br/>
     *
     * @param name <p>The friendly name of the secret that you just created.</p>
     */
     ...
     * <b>Length: </b>32 - 64<br/>
     *
     * @return <p>The unique identifier associated with the version of the secret you just created.</p>
     */
     ...
     * <b>Length: </b>32 - 64<br/>
     *
     * @param versionId <p>The unique identifier associated with the version of the secret you just created.</p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSecretResult == false) return false;
