...
public class GetUserAttributeVerificationCodeResult implements Serializable {
     ...
     * user attribute verification code.
     *
     * @return The code delivery details returned by the server response to get the
     *         user attribute verification code.
     */
     ...
     * user attribute verification code.
     *
     * @param codeDeliveryDetails The code delivery details returned by the server response to get the
     *         user attribute verification code.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetUserAttributeVerificationCodeResult == false) return false;
