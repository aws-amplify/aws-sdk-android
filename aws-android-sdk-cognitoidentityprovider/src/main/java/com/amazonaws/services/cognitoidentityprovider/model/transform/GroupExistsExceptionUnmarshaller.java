...
public class GroupExistsExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("GroupExistsException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        GroupExistsException e = (GroupExistsException) super.unmarshall(error);
        e.setErrorCode("GroupExistsException");
