...
/**
 * JSON request marshaller for AdminDeleteUserRequest
 */
    ...
    public Request<AdminDeleteUserRequest> marshall(AdminDeleteUserRequest adminDeleteUserRequest) {
        if (adminDeleteUserRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AdminDeleteUserRequest)");
        }

        Request<AdminDeleteUserRequest> request = new DefaultRequest<AdminDeleteUserRequest>(
                adminDeleteUserRequest, "AmazonCognitoIdentityProvider");
