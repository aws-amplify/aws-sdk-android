...
public class UserPoolTaggingExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("UserPoolTaggingException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        UserPoolTaggingException e = (UserPoolTaggingException) super.unmarshall(error);
        e.setErrorCode("UserPoolTaggingException");
