...
/**
 * JSON request marshaller for CreateUserPoolDomainRequest
 */
public class CreateUserPoolDomainRequestMarshaller implements
        Marshaller<Request<CreateUserPoolDomainRequest>, CreateUserPoolDomainRequest> {

    public Request<CreateUserPoolDomainRequest> marshall(
            CreateUserPoolDomainRequest createUserPoolDomainRequest) {
        if (createUserPoolDomainRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateUserPoolDomainRequest)");
        }

        Request<CreateUserPoolDomainRequest> request = new DefaultRequest<CreateUserPoolDomainRequest>(
                createUserPoolDomainRequest, "AmazonCognitoIdentityProvider");
