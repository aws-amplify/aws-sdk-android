...
public class CreateUserPoolClientRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * add <code>client_credentials</code> as the only allowed OAuth flow.
     * </p>
     * <dl>
     * <dt>code</dt>
     * <dd>
     ...
     *         <code>COGNITO</code>, <code>Facebook</code>, <code>Google</code>,
     *         <code>SignInWithApple</code>, and <code>LoginWithAmazon</code>.
     ...
     *            <code>Google</code>, <code>SignInWithApple</code>, and
     *            <code>LoginWithAmazon</code>. You can also specify the names
     *            that you configured for the SAML and OIDC IdPs in your user
     *            pool, for example <code>MySAMLIdP</code> or
     *            <code>MyOIDCIdP</code>.
     *            </p>
     */
     ...
     *         replaces <code>redirect_uri</code> in authentication requests.
     *         Must be in the <code>CallbackURLs</code> list.
     *         </p>
     *         <p>
     *         A redirect URI must:
     *         </p>
     ...
     *            IdP, replaces <code>redirect_uri</code> in authentication
     *            requests. Must be in the <code>CallbackURLs</code> list.
     *            </p>
     *            <p>
     *            A redirect URI must:
     *            </p>
     ...
     *         you must add <code>client_credentials</code> as the only allowed
     *         OAuth flow.
     *         </p>
     *         <dl>
     *         <dt>code</dt>
     ...
     *            <code>client_credentials</code> as the only allowed OAuth
     *            flow.
     *            </p>
     *            <dl>
     *            <dt>code</dt>
