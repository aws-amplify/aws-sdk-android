...
public class UnsupportedTokenTypeExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("UnsupportedTokenTypeException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        UnsupportedTokenTypeException e = (UnsupportedTokenTypeException) super.unmarshall(error);
        e.setErrorCode("UnsupportedTokenTypeException");
