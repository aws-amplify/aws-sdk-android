...
/**
 * JSON request marshaller for ListResourceServersRequest
 */
public class ListResourceServersRequestMarshaller implements
        Marshaller<Request<ListResourceServersRequest>, ListResourceServersRequest> {

    public Request<ListResourceServersRequest> marshall(
            ListResourceServersRequest listResourceServersRequest) {
        if (listResourceServersRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListResourceServersRequest)");
        }

        Request<ListResourceServersRequest> request = new DefaultRequest<ListResourceServersRequest>(
                listResourceServersRequest, "AmazonCognitoIdentityProvider");
