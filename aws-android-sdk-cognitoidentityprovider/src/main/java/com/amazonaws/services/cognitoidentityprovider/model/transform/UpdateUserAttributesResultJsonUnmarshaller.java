...
/**
 * Update User Attributes Result JSON Unmarshaller
 */
public class UpdateUserAttributesResultJsonUnmarshaller implements Unmarshaller<UpdateUserAttributesResult, JsonUnmarshallerContext> {
    ...
    public UpdateUserAttributesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("CodeDeliveryDetailsList")) {
                updateUserAttributesResult.setCodeDeliveryDetailsList(new ListUnmarshaller<CodeDeliveryDetailsType>(CodeDeliveryDetailsTypeJsonUnmarshaller.getInstance()).unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static UpdateUserAttributesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new UpdateUserAttributesResultJsonUnmarshaller();
        return instance;
    }
}
