...
/**
 * User Pool Description Type JSON Unmarshaller
 */
public class UserPoolDescriptionTypeJsonUnmarshaller implements Unmarshaller<UserPoolDescriptionType, JsonUnmarshallerContext> {
    ...
    public UserPoolDescriptionType unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Id")) {
                userPoolDescriptionType.setId(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("Name")) {
                userPoolDescriptionType.setName(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            ...
            if (name.equals("Status")) {
                userPoolDescriptionType.setStatus(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("LastModifiedDate")) {
                userPoolDescriptionType.setLastModifiedDate(DateJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("CreationDate")) {
                userPoolDescriptionType.setCreationDate(DateJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static UserPoolDescriptionTypeJsonUnmarshaller getInstance() {
        if (instance == null) instance = new UserPoolDescriptionTypeJsonUnmarshaller();
        return instance;
    }
}
