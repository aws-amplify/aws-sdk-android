...
/**
 * JSON request marshaller for UpdateIdentityProviderRequest
 */
public class UpdateIdentityProviderRequestMarshaller implements
        Marshaller<Request<UpdateIdentityProviderRequest>, UpdateIdentityProviderRequest> {

    public Request<UpdateIdentityProviderRequest> marshall(
            UpdateIdentityProviderRequest updateIdentityProviderRequest) {
        if (updateIdentityProviderRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateIdentityProviderRequest)");
        }

        Request<UpdateIdentityProviderRequest> request = new DefaultRequest<UpdateIdentityProviderRequest>(
                updateIdentityProviderRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (updateIdentityProviderRequest.getProviderDetails() != null) {
                java.util.Map<String, String> providerDetails = updateIdentityProviderRequest
                        .getProviderDetails();
            ...
            if (updateIdentityProviderRequest.getAttributeMapping() != null) {
                java.util.Map<String, String> attributeMapping = updateIdentityProviderRequest
                        .getAttributeMapping();
            ...
            if (updateIdentityProviderRequest.getIdpIdentifiers() != null) {
                java.util.List<String> idpIdentifiers = updateIdentityProviderRequest
                        .getIdpIdentifiers();
