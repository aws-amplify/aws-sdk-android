...
/**
 * JSON unmarshaller for response AdminEnableUserResult
 */
public class AdminEnableUserResultJsonUnmarshaller implements
        Unmarshaller<AdminEnableUserResult, JsonUnmarshallerContext> {
