...
/**
 * JSON unmarshaller for response GetUserPoolMfaConfigResult
 */
public class GetUserPoolMfaConfigResultJsonUnmarshaller implements
        Unmarshaller<GetUserPoolMfaConfigResult, JsonUnmarshallerContext> {
    ...
    public GetUserPoolMfaConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SmsMfaConfiguration")) {
                getUserPoolMfaConfigResult.setSmsMfaConfiguration(SmsMfaConfigTypeJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                getUserPoolMfaConfigResult.setMfaConfiguration(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
