...
/**
 * JSON unmarshaller for response AdminSetUserMFAPreferenceResult
 */
public class AdminSetUserMFAPreferenceResultJsonUnmarshaller implements
        Unmarshaller<AdminSetUserMFAPreferenceResult, JsonUnmarshallerContext> {

    public AdminSetUserMFAPreferenceResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
