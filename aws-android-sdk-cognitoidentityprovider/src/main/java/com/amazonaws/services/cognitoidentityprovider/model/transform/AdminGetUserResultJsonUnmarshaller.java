...
/**
 * Admin Get User Result JSON Unmarshaller
 */
public class AdminGetUserResultJsonUnmarshaller implements Unmarshaller<AdminGetUserResult, JsonUnmarshallerContext> {
    ...
    public AdminGetUserResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Username")) {
                adminGetUserResult.setUsername(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("UserAttributes")) {
                adminGetUserResult.setUserAttributes(new ListUnmarshaller<AttributeType>(AttributeTypeJsonUnmarshaller.getInstance()).unmarshall(context));
            } else 
            if (name.equals("UserCreateDate")) {
                adminGetUserResult.setUserCreateDate(DateJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("UserLastModifiedDate")) {
                adminGetUserResult.setUserLastModifiedDate(DateJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("Enabled")) {
                adminGetUserResult.setEnabled(BooleanJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("UserStatus")) {
                adminGetUserResult.setUserStatus(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
    ...
    public static AdminGetUserResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AdminGetUserResultJsonUnmarshaller();
        return instance;
    }
}
