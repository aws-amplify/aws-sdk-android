...
/**
 * JSON unmarshaller for response AdminLinkProviderForUserResult
 */
public class AdminLinkProviderForUserResultJsonUnmarshaller implements
        Unmarshaller<AdminLinkProviderForUserResult, JsonUnmarshallerContext> {

    public AdminLinkProviderForUserResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
