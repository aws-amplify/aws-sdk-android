...
/**
 * Container for the parameters to the {@link com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#adminResetUserPassword(AdminResetUserPasswordRequest) AdminResetUserPassword operation}.
 * <p>
 * Resets the specified user's password in a user pool as an
 * administrator. Works on any user.
 * </p>
 *
 * @see com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#adminResetUserPassword(AdminResetUserPasswordRequest)
 */
public class AdminResetUserPasswordRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Pattern: </b>[\w-]+.[0-9a-zA-Z-]+<br/>
     *
     * @return The user pool ID for the user pool where you want to reset the user's
     *         password.
     */
     ...
     * <b>Pattern: </b>[\w-]+.[0-9a-zA-Z-]+<br/>
     *
     * @param userPoolId The user pool ID for the user pool where you want to reset the user's
     *         password.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AdminResetUserPasswordRequest == false) return false;
