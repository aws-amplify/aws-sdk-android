...
/**
 * Container for the parameters to the {@link com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#describeUserPool(DescribeUserPoolRequest) DescribeUserPool operation}.
 * <p>
 * Returns the configuration information and metadata of the specified
 * user pool.
 * </p>
 *
 * @see com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#describeUserPool(DescribeUserPoolRequest)
 */
public class DescribeUserPoolRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeUserPoolRequest == false) return false;
