...
public class GetUserRequestMarshaller implements Marshaller<Request<GetUserRequest>, GetUserRequest> {
    ...
    if (getUserRequest == null) {
        ...
        Request<GetUserRequest> request = new DefaultRequest<GetUserRequest>(getUserRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (getUserRequest.getAccessToken() != null) {
                jsonWriter.name("AccessToken").value(getUserRequest.getAccessToken());
            }
