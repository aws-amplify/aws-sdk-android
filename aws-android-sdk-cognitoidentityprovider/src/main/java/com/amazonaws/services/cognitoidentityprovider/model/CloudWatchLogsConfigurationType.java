...
public class CloudWatchLogsConfigurationType implements Serializable {
     ...
     * <code>/aws/vendedlogs</code>. For more information, see <a href=
     ...
     *         that starts with <code>/aws/vendedlogs</code>. For more
     ...
     *            path that starts with <code>/aws/vendedlogs</code>. For more
     *            information, see <a href=
     *            "https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/AWS-logs-and-resource-policy.html"
     *            >Enabling logging from certain Amazon Web Services
     *            services</a>.
     *            </p>
     */
