...
/**
 * Update User Pool Client Request Marshaller
 */
public class UpdateUserPoolClientRequestMarshaller implements Marshaller<Request<UpdateUserPoolClientRequest>, UpdateUserPoolClientRequest> {
    ...
    if (updateUserPoolClientRequest == null) {
        ...
        Request<UpdateUserPoolClientRequest> request = new DefaultRequest<UpdateUserPoolClientRequest>(updateUserPoolClientRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (updateUserPoolClientRequest.getUserPoolId() != null) {
                jsonWriter.name("UserPoolId").value(updateUserPoolClientRequest.getUserPoolId());
            }
            if (updateUserPoolClientRequest.getClientId() != null) {
                jsonWriter.name("ClientId").value(updateUserPoolClientRequest.getClientId());
            }
            if (updateUserPoolClientRequest.getClientName() != null) {
                jsonWriter.name("ClientName").value(updateUserPoolClientRequest.getClientName());
            }
