...
/**
 * JSON unmarshaller for response CreateUserPoolDomainResult
 */
public class CreateUserPoolDomainResultJsonUnmarshaller implements
        Unmarshaller<CreateUserPoolDomainResult, JsonUnmarshallerContext> {
