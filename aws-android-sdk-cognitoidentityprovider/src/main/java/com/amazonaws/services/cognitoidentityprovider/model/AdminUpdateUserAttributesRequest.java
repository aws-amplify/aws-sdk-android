...
/**
 * Container for the parameters to the {@link com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#adminUpdateUserAttributes(AdminUpdateUserAttributesRequest) AdminUpdateUserAttributes operation}.
 * <p>
 * Updates the specified user's attributes, including developer
 * attributes, as an administrator. Works on any user.
 * </p>
 *
 * @see com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#adminUpdateUserAttributes(AdminUpdateUserAttributesRequest)
 */
public class AdminUpdateUserAttributesRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Pattern: </b>[\w-]+.[0-9a-zA-Z-]+<br/>
     *
     * @param userPoolId The user pool ID for the user pool where you want to update user
     *         attributes.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AdminUpdateUserAttributesRequest == false) return false;
