...
public class ScopeDoesNotExistExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("ScopeDoesNotExistException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        ScopeDoesNotExistException e = (ScopeDoesNotExistException) super.unmarshall(error);
        e.setErrorCode("ScopeDoesNotExistException");
