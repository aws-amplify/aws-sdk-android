...
/**
 * Sign Up Result JSON Unmarshaller
 */
public class SignUpResultJsonUnmarshaller implements Unmarshaller<SignUpResult, JsonUnmarshallerContext> {
    ...
    public SignUpResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("UserConfirmed")) {
                signUpResult.setUserConfirmed(BooleanJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
    ...
    public static SignUpResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new SignUpResultJsonUnmarshaller();
        return instance;
    }
}
