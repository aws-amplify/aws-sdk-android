...
public class RefreshTokensResult implements Serializable {
     ...
     * tokens.
     *
     * @return The authentication result from the server's response to refresh
     *         tokens.
     */
     ...
     * tokens.
     *
     * @param authenticationResult The authentication result from the server's response to refresh
     *         tokens.
     */
     ...
     *         together.
     */
    public RefreshTokensResult withAuthenticationResult(AuthenticationResultType authenticationResult) {
        this.authenticationResult = authenticationResult;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RefreshTokensResult == false) return false;
