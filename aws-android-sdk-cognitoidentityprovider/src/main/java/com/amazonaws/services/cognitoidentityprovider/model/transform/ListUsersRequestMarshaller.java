...
public class ListUsersRequestMarshaller implements Marshaller<Request<ListUsersRequest>, ListUsersRequest> {
    ...
    if (listUsersRequest == null) {
        ...
        Request<ListUsersRequest> request = new DefaultRequest<ListUsersRequest>(listUsersRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (listUsersRequest.getUserPoolId() != null) {
                jsonWriter.name("UserPoolId").value(listUsersRequest.getUserPoolId());
            }

            com.amazonaws.internal.ListWithAutoConstructFlag<String> attributesToGetList = (com.amazonaws.internal.ListWithAutoConstructFlag<String>)(listUsersRequest.getAttributesToGet());
            ...
            if (listUsersRequest.getLimit() != null) {
                jsonWriter.name("Limit").value(listUsersRequest.getLimit());
            }
            if (listUsersRequest.getPaginationToken() != null) {
                jsonWriter.name("PaginationToken").value(listUsersRequest.getPaginationToken());
            }
            if (listUsersRequest.getUserStatus() != null) {
                jsonWriter.name("UserStatus").value(listUsersRequest.getUserStatus());
            }
