...
/**
 * JSON request marshaller for ListUserPoolsRequest
 */
    ...
    public Request<ListUserPoolsRequest> marshall(ListUserPoolsRequest listUserPoolsRequest) {
        if (listUserPoolsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListUserPoolsRequest)");
        }

        Request<ListUserPoolsRequest> request = new DefaultRequest<ListUserPoolsRequest>(
                listUserPoolsRequest, "AmazonCognitoIdentityProvider");
