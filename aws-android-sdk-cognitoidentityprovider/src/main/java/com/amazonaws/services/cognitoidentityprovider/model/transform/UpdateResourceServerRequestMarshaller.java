...
/**
 * JSON request marshaller for UpdateResourceServerRequest
 */
public class UpdateResourceServerRequestMarshaller implements
        Marshaller<Request<UpdateResourceServerRequest>, UpdateResourceServerRequest> {

    public Request<UpdateResourceServerRequest> marshall(
            UpdateResourceServerRequest updateResourceServerRequest) {
        if (updateResourceServerRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateResourceServerRequest)");
        }

        Request<UpdateResourceServerRequest> request = new DefaultRequest<UpdateResourceServerRequest>(
                updateResourceServerRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (updateResourceServerRequest.getScopes() != null) {
                java.util.List<ResourceServerScopeType> scopes = updateResourceServerRequest
                        .getScopes();
