...
/**
 * JSON marshaller for POJO CloudWatchLogsConfigurationType
 */
class CloudWatchLogsConfigurationTypeJsonMarshaller {

    public void marshall(CloudWatchLogsConfigurationType cloudWatchLogsConfigurationType,
        ...
        if (cloudWatchLogsConfigurationType.getLogGroupArn() != null) {
            ...
            jsonWriter.name("LogGroupArn");
            jsonWriter.value(logGroupArn);
        }
