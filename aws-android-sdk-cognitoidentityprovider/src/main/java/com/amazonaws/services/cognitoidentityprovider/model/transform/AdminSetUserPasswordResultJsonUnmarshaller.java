...
/**
 * JSON unmarshaller for response AdminSetUserPasswordResult
 */
public class AdminSetUserPasswordResultJsonUnmarshaller implements
        Unmarshaller<AdminSetUserPasswordResult, JsonUnmarshallerContext> {
