...
/**
 * JSON unmarshaller for response ListResourceServersResult
 */
public class ListResourceServersResultJsonUnmarshaller implements
        Unmarshaller<ListResourceServersResult, JsonUnmarshallerContext> {
    ...
    public ListResourceServersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ResourceServers")) {
                listResourceServersResult
                        .setResourceServers(new ListUnmarshaller<ResourceServerType>(
                                ResourceServerTypeJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                listResourceServersResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
