...
/**
 * Container for the parameters to the {@link com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#listUserPoolClients(ListUserPoolClientsRequest) ListUserPoolClients operation}.
 * <p>
 * Lists the clients that have been created for the specified user pool.
 * </p>
 *
 * @see com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#listUserPoolClients(ListUserPoolClientsRequest)
 */
public class ListUserPoolClientsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Pattern: </b>[\w-]+.[0-9a-zA-Z-]+<br/>
     *
     * @return The user pool ID for the user pool where you want to list user pool
     *         clients.
     */
     ...
     * <b>Pattern: </b>[\w-]+.[0-9a-zA-Z-]+<br/>
     *
     * @param userPoolId The user pool ID for the user pool where you want to list user pool
     *         clients.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListUserPoolClientsRequest == false) return false;
