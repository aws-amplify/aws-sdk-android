...
/**
 * Container for the parameters to the {@link com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#deleteUserPoolClient(DeleteUserPoolClientRequest) DeleteUserPoolClient operation}.
 * <p>
 * Allows the developer to delete the user pool client.
 * </p>
 *
 * @see com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#deleteUserPoolClient(DeleteUserPoolClientRequest)
 */
public class DeleteUserPoolClientRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Pattern: </b>[\w-]+.[0-9a-zA-Z-]+<br/>
     *
     * @param userPoolId The user pool ID for the user pool where you want to delete the
     *         client.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteUserPoolClientRequest == false) return false;
