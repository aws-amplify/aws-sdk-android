...
public class MFAOptionType implements Serializable {
     ...
     * <b>Allowed Values: </b>SMS, EMAIL
     *
     * @return The delivery medium (email message or SMS message) to send the MFA
     *         code.
     *
     ...
     * <b>Allowed Values: </b>SMS, EMAIL
     *
     * @param deliveryMedium The delivery medium (email message or SMS message) to send the MFA
     *         code.
     *
     * @see DeliveryMediumType
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MFAOptionType == false) return false;
