...
public class DeleteUserRequestMarshaller implements Marshaller<Request<DeleteUserRequest>, DeleteUserRequest> {
    ...
    if (deleteUserRequest == null) {
        ...
        Request<DeleteUserRequest> request = new DefaultRequest<DeleteUserRequest>(deleteUserRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (deleteUserRequest.getAccessToken() != null) {
                jsonWriter.name("AccessToken").value(deleteUserRequest.getAccessToken());
            }
