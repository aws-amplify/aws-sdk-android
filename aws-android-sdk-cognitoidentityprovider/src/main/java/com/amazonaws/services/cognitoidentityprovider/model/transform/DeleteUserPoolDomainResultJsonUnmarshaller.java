...
/**
 * JSON unmarshaller for response DeleteUserPoolDomainResult
 */
public class DeleteUserPoolDomainResultJsonUnmarshaller implements
        Unmarshaller<DeleteUserPoolDomainResult, JsonUnmarshallerContext> {
