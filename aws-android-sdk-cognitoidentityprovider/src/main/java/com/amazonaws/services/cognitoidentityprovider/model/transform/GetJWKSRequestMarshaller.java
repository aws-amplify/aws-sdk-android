...
/**
 * JSON request marshaller for GetJWKSRequest
 */
public class GetJWKSRequestMarshaller implements
    ...
    public Request<GetJWKSRequest> marshall(GetJWKSRequest getJWKSRequest) {
        ...
        Request<GetJWKSRequest> request = new DefaultRequest<GetJWKSRequest>(getJWKSRequest,
        ...
        uriResourcePath = uriResourcePath.replace(
                "{userPoolId}",
                (getJWKSRequest.getUserPoolId() == null) ? "" : StringUtils
                        .fromString(getJWKSRequest.getUserPoolId()));
