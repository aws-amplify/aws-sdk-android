...
/**
 * Get J W K S Request Marshaller
 */
public class GetJWKSRequestMarshaller implements Marshaller<Request<GetJWKSRequest>, GetJWKSRequest> {
    ...
    if (getJWKSRequest == null) {
        ...
        Request<GetJWKSRequest> request = new DefaultRequest<GetJWKSRequest>(getJWKSRequest, "AmazonCognitoIdentityProvider");
        ...
        uriResourcePath = uriResourcePath.replace("{userPoolId}", (getJWKSRequest.getUserPoolId() == null) ? "" : StringUtils.fromString(getJWKSRequest.getUserPoolId())); 
