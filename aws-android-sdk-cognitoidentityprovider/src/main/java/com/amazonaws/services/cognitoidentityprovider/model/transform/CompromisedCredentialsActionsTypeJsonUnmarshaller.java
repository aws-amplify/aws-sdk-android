...
/**
 * JSON unmarshaller for POJO CompromisedCredentialsActionsType
 */
class CompromisedCredentialsActionsTypeJsonUnmarshaller implements
        Unmarshaller<CompromisedCredentialsActionsType, JsonUnmarshallerContext> {
    ...
    public CompromisedCredentialsActionsType unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("EventAction")) {
                compromisedCredentialsActionsType.setEventAction(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
