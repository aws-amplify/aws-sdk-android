...
/**
 * Verify User Attribute Request Marshaller
 */
public class VerifyUserAttributeRequestMarshaller implements Marshaller<Request<VerifyUserAttributeRequest>, VerifyUserAttributeRequest> {
    ...
    if (verifyUserAttributeRequest == null) {
        ...
        Request<VerifyUserAttributeRequest> request = new DefaultRequest<VerifyUserAttributeRequest>(verifyUserAttributeRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (verifyUserAttributeRequest.getAccessToken() != null) {
                jsonWriter.name("AccessToken").value(verifyUserAttributeRequest.getAccessToken());
            }
            if (verifyUserAttributeRequest.getAttributeName() != null) {
                jsonWriter.name("AttributeName").value(verifyUserAttributeRequest.getAttributeName());
            }
            if (verifyUserAttributeRequest.getCode() != null) {
                jsonWriter.name("Code").value(verifyUserAttributeRequest.getCode());
            }
