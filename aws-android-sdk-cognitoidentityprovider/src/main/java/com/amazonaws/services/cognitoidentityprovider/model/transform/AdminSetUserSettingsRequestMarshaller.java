...
/**
 * Admin Set User Settings Request Marshaller
 */
public class AdminSetUserSettingsRequestMarshaller implements Marshaller<Request<AdminSetUserSettingsRequest>, AdminSetUserSettingsRequest> {
    ...
    if (adminSetUserSettingsRequest == null) {
        ...
        Request<AdminSetUserSettingsRequest> request = new DefaultRequest<AdminSetUserSettingsRequest>(adminSetUserSettingsRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            com.amazonaws.internal.ListWithAutoConstructFlag<MFAOptionType> mFAOptionsList = (com.amazonaws.internal.ListWithAutoConstructFlag<MFAOptionType>)(adminSetUserSettingsRequest.getMFAOptions());
