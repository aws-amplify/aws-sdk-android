...
public class DuplicateProviderExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("DuplicateProviderException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        DuplicateProviderException e = (DuplicateProviderException) super.unmarshall(error);
        e.setErrorCode("DuplicateProviderException");
