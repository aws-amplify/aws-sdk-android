...
public class UpdateUserPoolClientResult implements Serializable {
     ...
     * update user pool client request is made.
     *
     * @return The user pool client value from the response from the server when an
     *         update user pool client request is made.
     */
     ...
     * update user pool client request is made.
     *
     * @param userPoolClient The user pool client value from the response from the server when an
     *         update user pool client request is made.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateUserPoolClientResult == false) return false;
