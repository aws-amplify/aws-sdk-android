...
/**
 * JSON unmarshaller for response AdminDisableProviderForUserResult
 */
public class AdminDisableProviderForUserResultJsonUnmarshaller implements
        Unmarshaller<AdminDisableProviderForUserResult, JsonUnmarshallerContext> {

    public AdminDisableProviderForUserResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
