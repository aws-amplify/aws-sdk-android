...
/**
 * Container for the parameters to the {@link com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#confirmForgotPassword(ConfirmForgotPasswordRequest) ConfirmForgotPassword operation}.
 * <p>
 * Allows a user to enter a code provided when they reset their password
 * to update their password.
 * </p>
 *
 * @see com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#confirmForgotPassword(ConfirmForgotPasswordRequest)
 */
public class ConfirmForgotPasswordRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Pattern: </b>[\p{L}\p{M}\p{S}\p{N}\p{P}]+<br/>
     *
     * @param username The user name of the user for whom you want to enter a code to
     *         retrieve a forgotten password.
     */
     ...
     * <b>Pattern: </b>[\S]+<br/>
     *
     * @return The confirmation code sent by a user's request to retrieve a forgotten
     *         password.
     */
     ...
     * <b>Pattern: </b>[\S]+<br/>
     *
     * @param confirmationCode The confirmation code sent by a user's request to retrieve a forgotten
     *         password.
     */
     ...
     * <b>Pattern: </b>[\S]+<br/>
     *
     * @return The password sent by sent by a user's request to retrieve a forgotten
     *         password.
     */
     ...
     * <b>Pattern: </b>[\S]+<br/>
     *
     * @param password The password sent by sent by a user's request to retrieve a forgotten
     *         password.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConfirmForgotPasswordRequest == false) return false;
