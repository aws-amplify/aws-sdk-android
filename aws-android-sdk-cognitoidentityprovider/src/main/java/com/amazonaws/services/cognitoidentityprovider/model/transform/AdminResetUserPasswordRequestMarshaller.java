...
/**
 * Admin Reset User Password Request Marshaller
 */
public class AdminResetUserPasswordRequestMarshaller implements Marshaller<Request<AdminResetUserPasswordRequest>, AdminResetUserPasswordRequest> {
    ...
    if (adminResetUserPasswordRequest == null) {
        ...
        Request<AdminResetUserPasswordRequest> request = new DefaultRequest<AdminResetUserPasswordRequest>(adminResetUserPasswordRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (adminResetUserPasswordRequest.getUserPoolId() != null) {
                jsonWriter.name("UserPoolId").value(adminResetUserPasswordRequest.getUserPoolId());
            }
            if (adminResetUserPasswordRequest.getUsername() != null) {
                jsonWriter.name("Username").value(adminResetUserPasswordRequest.getUsername());
            }
