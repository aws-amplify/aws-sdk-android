...
/**
 * JSON unmarshaller for response GetJWKSResult
 */
public class GetJWKSResultJsonUnmarshaller implements
        Unmarshaller<GetJWKSResult, JsonUnmarshallerContext> {
    ...
    public GetJWKSResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("keys")) {
                getJWKSResult.setKeys(new ListUnmarshaller<KeyType>(KeyTypeJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
