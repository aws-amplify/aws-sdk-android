...
/**
 * JSON unmarshaller for response DescribeIdentityProviderResult
 */
public class DescribeIdentityProviderResultJsonUnmarshaller implements
        Unmarshaller<DescribeIdentityProviderResult, JsonUnmarshallerContext> {

    public DescribeIdentityProviderResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
