...
/**
 * JSON unmarshaller for response AdminUpdateUserAttributesResult
 */
public class AdminUpdateUserAttributesResultJsonUnmarshaller implements
        Unmarshaller<AdminUpdateUserAttributesResult, JsonUnmarshallerContext> {

    public AdminUpdateUserAttributesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
