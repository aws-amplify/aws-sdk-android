...
public class InvalidOAuthFlowExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InvalidOAuthFlowException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        InvalidOAuthFlowException e = (InvalidOAuthFlowException) super.unmarshall(error);
        e.setErrorCode("InvalidOAuthFlowException");
