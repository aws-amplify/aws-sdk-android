...
/**
 * JSON unmarshaller for response RefreshTokensResult
 */
public class RefreshTokensResultJsonUnmarshaller implements
        Unmarshaller<RefreshTokensResult, JsonUnmarshallerContext> {
