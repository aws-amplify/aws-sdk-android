...
/**
 * Refresh Tokens Result JSON Unmarshaller
 */
public class RefreshTokensResultJsonUnmarshaller implements Unmarshaller<RefreshTokensResult, JsonUnmarshallerContext> {

    public RefreshTokensResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AuthenticationResult")) {
                refreshTokensResult.setAuthenticationResult(AuthenticationResultTypeJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static RefreshTokensResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new RefreshTokensResultJsonUnmarshaller();
        return instance;
    }
}
