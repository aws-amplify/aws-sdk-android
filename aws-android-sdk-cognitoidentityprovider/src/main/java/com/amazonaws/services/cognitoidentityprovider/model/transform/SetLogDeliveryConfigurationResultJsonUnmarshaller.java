...
/**
 * JSON unmarshaller for response SetLogDeliveryConfigurationResult
 */
public class SetLogDeliveryConfigurationResultJsonUnmarshaller implements
        Unmarshaller<SetLogDeliveryConfigurationResult, JsonUnmarshallerContext> {

    public SetLogDeliveryConfigurationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
