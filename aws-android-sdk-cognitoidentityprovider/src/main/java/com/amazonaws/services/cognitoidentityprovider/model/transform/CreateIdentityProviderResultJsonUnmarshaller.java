...
/**
 * JSON unmarshaller for response CreateIdentityProviderResult
 */
public class CreateIdentityProviderResultJsonUnmarshaller implements
        Unmarshaller<CreateIdentityProviderResult, JsonUnmarshallerContext> {

    public CreateIdentityProviderResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
