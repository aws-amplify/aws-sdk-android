...
public class DescribeUserPoolClientResult implements Serializable {
     ...
     * client.
     *
     * @return The user pool client from a server response to describe the user pool
     *         client.
     */
     ...
     * client.
     *
     * @param userPoolClient The user pool client from a server response to describe the user pool
     *         client.
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getUserPoolClient() != null) sb.append("UserPoolClient: " + getUserPoolClient() );
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeUserPoolClientResult == false) return false;
        DescribeUserPoolClientResult other = (DescribeUserPoolClientResult)obj;
        
        if (other.getUserPoolClient() == null ^ this.getUserPoolClient() == null) return false;
        if (other.getUserPoolClient() != null && other.getUserPoolClient().equals(this.getUserPoolClient()) == false) return false; 
        return true;
    }
