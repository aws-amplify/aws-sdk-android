...
/**
 * JSON unmarshaller for POJO CloudWatchLogsConfigurationType
 */
class CloudWatchLogsConfigurationTypeJsonUnmarshaller implements
        Unmarshaller<CloudWatchLogsConfigurationType, JsonUnmarshallerContext> {
    ...
    public CloudWatchLogsConfigurationType unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("LogGroupArn")) {
                cloudWatchLogsConfigurationType.setLogGroupArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
