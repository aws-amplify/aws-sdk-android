...
/**
 * JSON unmarshaller for response UpdateIdentityProviderResult
 */
public class UpdateIdentityProviderResultJsonUnmarshaller implements
        Unmarshaller<UpdateIdentityProviderResult, JsonUnmarshallerContext> {

    public UpdateIdentityProviderResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
