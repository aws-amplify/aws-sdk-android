...
public class UnsupportedIdentityProviderExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("UnsupportedIdentityProviderException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        UnsupportedIdentityProviderException e = (UnsupportedIdentityProviderException) super
                .unmarshall(error);
        e.setErrorCode("UnsupportedIdentityProviderException");
