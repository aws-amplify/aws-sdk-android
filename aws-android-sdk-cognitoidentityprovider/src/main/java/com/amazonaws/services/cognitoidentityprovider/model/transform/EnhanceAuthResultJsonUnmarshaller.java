...
/**
 * Enhance Auth Result JSON Unmarshaller
 */
public class EnhanceAuthResultJsonUnmarshaller implements Unmarshaller<EnhanceAuthResult, JsonUnmarshallerContext> {
    ...
    public EnhanceAuthResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AuthenticationResult")) {
                enhanceAuthResult.setAuthenticationResult(AuthenticationResultTypeJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static EnhanceAuthResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new EnhanceAuthResultJsonUnmarshaller();
        return instance;
    }
}
