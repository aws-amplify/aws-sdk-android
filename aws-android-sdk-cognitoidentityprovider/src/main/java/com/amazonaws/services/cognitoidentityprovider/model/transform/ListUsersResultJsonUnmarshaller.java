...
/**
 * List Users Result JSON Unmarshaller
 */
public class ListUsersResultJsonUnmarshaller implements Unmarshaller<ListUsersResult, JsonUnmarshallerContext> {
    ...
    public ListUsersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PaginationToken")) {
                listUsersResult.setPaginationToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static ListUsersResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListUsersResultJsonUnmarshaller();
        return instance;
    }
}
