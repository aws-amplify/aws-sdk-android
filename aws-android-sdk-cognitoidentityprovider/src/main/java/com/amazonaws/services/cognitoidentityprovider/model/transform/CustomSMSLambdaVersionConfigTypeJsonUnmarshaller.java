...
/**
 * JSON unmarshaller for POJO CustomSMSLambdaVersionConfigType
 */
class CustomSMSLambdaVersionConfigTypeJsonUnmarshaller implements
        Unmarshaller<CustomSMSLambdaVersionConfigType, JsonUnmarshallerContext> {
    ...
    public CustomSMSLambdaVersionConfigType unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("LambdaVersion")) {
                customSMSLambdaVersionConfigType.setLambdaVersion(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("LambdaArn")) {
                customSMSLambdaVersionConfigType.setLambdaArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
