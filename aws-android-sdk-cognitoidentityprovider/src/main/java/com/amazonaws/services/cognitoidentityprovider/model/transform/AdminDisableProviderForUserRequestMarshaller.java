...
/**
 * JSON request marshaller for AdminDisableProviderForUserRequest
 */
public class AdminDisableProviderForUserRequestMarshaller implements
        Marshaller<Request<AdminDisableProviderForUserRequest>, AdminDisableProviderForUserRequest> {

    public Request<AdminDisableProviderForUserRequest> marshall(
            AdminDisableProviderForUserRequest adminDisableProviderForUserRequest) {
        if (adminDisableProviderForUserRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AdminDisableProviderForUserRequest)");
        }

        Request<AdminDisableProviderForUserRequest> request = new DefaultRequest<AdminDisableProviderForUserRequest>(
                adminDisableProviderForUserRequest, "AmazonCognitoIdentityProvider");
