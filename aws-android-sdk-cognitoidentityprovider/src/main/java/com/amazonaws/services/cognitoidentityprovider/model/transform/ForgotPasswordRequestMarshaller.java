...
/**
 * Forgot Password Request Marshaller
 */
public class ForgotPasswordRequestMarshaller implements Marshaller<Request<ForgotPasswordRequest>, ForgotPasswordRequest> {
    ...
    if (forgotPasswordRequest == null) {
        ...
        Request<ForgotPasswordRequest> request = new DefaultRequest<ForgotPasswordRequest>(forgotPasswordRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (forgotPasswordRequest.getClientId() != null) {
                jsonWriter.name("ClientId").value(forgotPasswordRequest.getClientId());
            }
            if (forgotPasswordRequest.getSecretHash() != null) {
                jsonWriter.name("SecretHash").value(forgotPasswordRequest.getSecretHash());
            }
            if (forgotPasswordRequest.getUsername() != null) {
                jsonWriter.name("Username").value(forgotPasswordRequest.getUsername());
            }
