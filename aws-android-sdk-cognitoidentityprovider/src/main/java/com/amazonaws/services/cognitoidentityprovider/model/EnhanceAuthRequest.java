...
/**
 * <p>
 * Grants the ability to supply a multi-factor authentication (MFA) token for an
 * MFA-enabled user to get the ID, access, and refresh tokens.
 * </p>
 */
public class EnhanceAuthRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         The user name of the user for whom you wish to enhance
     *         authentication.
     *         </p>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnhanceAuthRequest == false)
            return false;
