...
/**
 * Container for the parameters to the {@link com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#adminConfirmSignUp(AdminConfirmSignUpRequest) AdminConfirmSignUp operation}.
 * <p>
 * Confirms user registration as an admin without using a confirmation
 * code. Works on any user.
 * </p>
 *
 * @see com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#adminConfirmSignUp(AdminConfirmSignUpRequest)
 */
public class AdminConfirmSignUpRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AdminConfirmSignUpRequest == false) return false;
