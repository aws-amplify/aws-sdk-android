...
/**
 * Container for the parameters to the {@link com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#adminGetUser(AdminGetUserRequest) AdminGetUser operation}.
 * <p>
 * Gets the specified user by user name in a user pool as an
 * administrator. Works on any user.
 * </p>
 *
 * @see com.amazonaws.services.cognitoidentityprovider.AmazonCognitoIdentityProvider#adminGetUser(AdminGetUserRequest)
 */
public class AdminGetUserRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Pattern: </b>[\w-]+.[0-9a-zA-Z-]+<br/>
     *
     * @return The user pool ID for the user pool where you want to get information
     *         about the user.
     */
     ...
     * <b>Pattern: </b>[\w-]+.[0-9a-zA-Z-]+<br/>
     *
     * @param userPoolId The user pool ID for the user pool where you want to get information
     *         about the user.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AdminGetUserRequest == false) return false;
