...
/**
 * Resend Confirmation Code Request Marshaller
 */
public class ResendConfirmationCodeRequestMarshaller implements Marshaller<Request<ResendConfirmationCodeRequest>, ResendConfirmationCodeRequest> {
    ...
    if (resendConfirmationCodeRequest == null) {
        ...
        Request<ResendConfirmationCodeRequest> request = new DefaultRequest<ResendConfirmationCodeRequest>(resendConfirmationCodeRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (resendConfirmationCodeRequest.getClientId() != null) {
                jsonWriter.name("ClientId").value(resendConfirmationCodeRequest.getClientId());
            }
            if (resendConfirmationCodeRequest.getSecretHash() != null) {
                jsonWriter.name("SecretHash").value(resendConfirmationCodeRequest.getSecretHash());
            }
            if (resendConfirmationCodeRequest.getUsername() != null) {
                jsonWriter.name("Username").value(resendConfirmationCodeRequest.getUsername());
            }
