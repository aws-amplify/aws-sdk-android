...
public class EnhanceAuthResult implements Serializable {
     ...
     * The authentication result from the enhanced authentication response.
     *
     * @return The authentication result from the enhanced authentication response.
     */
     ...
     * The authentication result from the enhanced authentication response.
     *
     * @param authenticationResult The authentication result from the enhanced authentication response.
     */
     ...
     *         together.
     */
    public EnhanceAuthResult withAuthenticationResult(AuthenticationResultType authenticationResult) {
        this.authenticationResult = authenticationResult;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnhanceAuthResult == false) return false;
        EnhanceAuthResult other = (EnhanceAuthResult)obj;
