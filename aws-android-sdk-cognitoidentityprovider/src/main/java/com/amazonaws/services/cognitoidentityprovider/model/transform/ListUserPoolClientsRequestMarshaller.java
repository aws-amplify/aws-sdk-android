...
/**
 * List User Pool Clients Request Marshaller
 */
public class ListUserPoolClientsRequestMarshaller implements Marshaller<Request<ListUserPoolClientsRequest>, ListUserPoolClientsRequest> {
    ...
    if (listUserPoolClientsRequest == null) {
        ...
        Request<ListUserPoolClientsRequest> request = new DefaultRequest<ListUserPoolClientsRequest>(listUserPoolClientsRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (listUserPoolClientsRequest.getUserPoolId() != null) {
                jsonWriter.name("UserPoolId").value(listUserPoolClientsRequest.getUserPoolId());
            }
            if (listUserPoolClientsRequest.getMaxResults() != null) {
                jsonWriter.name("MaxResults").value(listUserPoolClientsRequest.getMaxResults());
            }
            if (listUserPoolClientsRequest.getNextToken() != null) {
                jsonWriter.name("NextToken").value(listUserPoolClientsRequest.getNextToken());
            }
