...
/**
 * JSON request marshaller for AdminUpdateUserAttributesRequest
 */
public class AdminUpdateUserAttributesRequestMarshaller implements
        Marshaller<Request<AdminUpdateUserAttributesRequest>, AdminUpdateUserAttributesRequest> {

    public Request<AdminUpdateUserAttributesRequest> marshall(
            AdminUpdateUserAttributesRequest adminUpdateUserAttributesRequest) {
        if (adminUpdateUserAttributesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AdminUpdateUserAttributesRequest)");
        }

        Request<AdminUpdateUserAttributesRequest> request = new DefaultRequest<AdminUpdateUserAttributesRequest>(
                adminUpdateUserAttributesRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (adminUpdateUserAttributesRequest.getUserAttributes() != null) {
                java.util.List<AttributeType> userAttributes = adminUpdateUserAttributesRequest
                        .getUserAttributes();
