 ...
 * email address or phone number that has already been supplied as an alias from
 * a different account. This exception indicates that an account with this email
