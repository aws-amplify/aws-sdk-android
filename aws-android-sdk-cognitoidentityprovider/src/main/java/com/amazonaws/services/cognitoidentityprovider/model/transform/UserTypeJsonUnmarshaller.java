...
public class UserTypeJsonUnmarshaller implements Unmarshaller<UserType, JsonUnmarshallerContext> {
    ...
    public UserType unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Username")) {
                userType.setUsername(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            ...
            if (name.equals("UserCreateDate")) {
                userType.setUserCreateDate(DateJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("UserLastModifiedDate")) {
                userType.setUserLastModifiedDate(DateJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("Enabled")) {
                userType.setEnabled(BooleanJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            if (name.equals("UserStatus")) {
                userType.setUserStatus(StringJsonUnmarshaller.getInstance().unmarshall(context));
            } else 
            {
                reader.skipValue();
            }
    ...
    public static UserTypeJsonUnmarshaller getInstance() {
        if (instance == null) instance = new UserTypeJsonUnmarshaller();
        return instance;
    }
}
