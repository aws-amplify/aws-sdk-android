...
/**
 * Get User Attribute Verification Code Request Marshaller
 */
public class GetUserAttributeVerificationCodeRequestMarshaller implements Marshaller<Request<GetUserAttributeVerificationCodeRequest>, GetUserAttributeVerificationCodeRequest> {
    ...
    if (getUserAttributeVerificationCodeRequest == null) {
        ...
        Request<GetUserAttributeVerificationCodeRequest> request = new DefaultRequest<GetUserAttributeVerificationCodeRequest>(getUserAttributeVerificationCodeRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (getUserAttributeVerificationCodeRequest.getAccessToken() != null) {
                jsonWriter.name("AccessToken").value(getUserAttributeVerificationCodeRequest.getAccessToken());
            }
            if (getUserAttributeVerificationCodeRequest.getAttributeName() != null) {
                jsonWriter.name("AttributeName").value(getUserAttributeVerificationCodeRequest.getAttributeName());
            }
