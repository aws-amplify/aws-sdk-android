...
/**
 * JSON request marshaller for ListUsersInGroupRequest
 */
public class ListUsersInGroupRequestMarshaller implements
        Marshaller<Request<ListUsersInGroupRequest>, ListUsersInGroupRequest> {
    ...
    public Request<ListUsersInGroupRequest> marshall(ListUsersInGroupRequest listUsersInGroupRequest) {
        if (listUsersInGroupRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListUsersInGroupRequest)");
        }

        Request<ListUsersInGroupRequest> request = new DefaultRequest<ListUsersInGroupRequest>(
                listUsersInGroupRequest, "AmazonCognitoIdentityProvider");
