...
/**
 * JSON request marshaller for UpdateAuthEventFeedbackRequest
 */
public class UpdateAuthEventFeedbackRequestMarshaller implements
        Marshaller<Request<UpdateAuthEventFeedbackRequest>, UpdateAuthEventFeedbackRequest> {

    public Request<UpdateAuthEventFeedbackRequest> marshall(
            UpdateAuthEventFeedbackRequest updateAuthEventFeedbackRequest) {
        if (updateAuthEventFeedbackRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateAuthEventFeedbackRequest)");
        }

        Request<UpdateAuthEventFeedbackRequest> request = new DefaultRequest<UpdateAuthEventFeedbackRequest>(
                updateAuthEventFeedbackRequest, "AmazonCognitoIdentityProvider");
