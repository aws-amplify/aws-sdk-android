...
/**
 * JSON request marshaller for CreateResourceServerRequest
 */
public class CreateResourceServerRequestMarshaller implements
        Marshaller<Request<CreateResourceServerRequest>, CreateResourceServerRequest> {

    public Request<CreateResourceServerRequest> marshall(
            CreateResourceServerRequest createResourceServerRequest) {
        if (createResourceServerRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateResourceServerRequest)");
        }

        Request<CreateResourceServerRequest> request = new DefaultRequest<CreateResourceServerRequest>(
                createResourceServerRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (createResourceServerRequest.getScopes() != null) {
                java.util.List<ResourceServerScopeType> scopes = createResourceServerRequest
                        .getScopes();
