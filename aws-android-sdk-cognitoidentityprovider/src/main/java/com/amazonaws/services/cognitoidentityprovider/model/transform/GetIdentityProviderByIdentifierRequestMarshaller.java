...
/**
 * JSON request marshaller for GetIdentityProviderByIdentifierRequest
 */
public class GetIdentityProviderByIdentifierRequestMarshaller
    ...
    public Request<GetIdentityProviderByIdentifierRequest> marshall(
        ...
        if (getIdentityProviderByIdentifierRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetIdentityProviderByIdentifierRequest)");
        }

        Request<GetIdentityProviderByIdentifierRequest> request = new DefaultRequest<GetIdentityProviderByIdentifierRequest>(
                getIdentityProviderByIdentifierRequest, "AmazonCognitoIdentityProvider");
