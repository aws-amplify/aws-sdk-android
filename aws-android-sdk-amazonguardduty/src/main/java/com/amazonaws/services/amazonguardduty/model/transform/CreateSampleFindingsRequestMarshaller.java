...
public class CreateSampleFindingsRequestMarshaller implements
    ...
    public Request<CreateSampleFindingsRequest> marshall(
        ...
        Request<CreateSampleFindingsRequest> request = new DefaultRequest<CreateSampleFindingsRequest>(
                createSampleFindingsRequest, "AmazonGuardDuty");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/detector/{detectorId}/findings/create";
        uriResourcePath = uriResourcePath.replace(
                "{detectorId}",
                (createSampleFindingsRequest.getDetectorId() == null) ? "" : StringUtils
                        .fromString(createSampleFindingsRequest.getDetectorId()));
