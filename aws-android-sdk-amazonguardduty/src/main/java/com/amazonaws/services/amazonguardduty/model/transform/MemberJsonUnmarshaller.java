    ...
    public Member unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AccountId")) {
                ...
                member.setDetectorId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                member.setInvitedAt(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("UpdatedAt")) {
                member.setUpdatedAt(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
