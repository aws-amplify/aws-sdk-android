...
public class CreateMembersResult implements Serializable {
     ...
     * @return <p>
     *         A list of objects that include the <code>accountIds</code> of the
     *         unprocessed accounts and a result string that explains why each
     *         was unprocessed.
     *         </p>
     */
     ...
     *            A list of objects that include the <code>accountIds</code> of
     *            the unprocessed accounts and a result string that explains why
     *            each was unprocessed.
     *            </p>
     */
