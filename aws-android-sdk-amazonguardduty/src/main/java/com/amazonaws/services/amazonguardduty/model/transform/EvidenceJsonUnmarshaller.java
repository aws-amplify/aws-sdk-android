...
/**
 * JSON unmarshaller for POJO Evidence
 */
class EvidenceJsonUnmarshaller implements Unmarshaller<Evidence, JsonUnmarshallerContext> {
    ...
    public Evidence unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ThreatIntelligenceDetails")) {
                evidence.setThreatIntelligenceDetails(new ListUnmarshaller<ThreatIntelligenceDetail>(
                        ThreatIntelligenceDetailJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
