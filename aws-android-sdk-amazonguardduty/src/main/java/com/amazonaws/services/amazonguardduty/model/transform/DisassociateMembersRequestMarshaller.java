...
public class DisassociateMembersRequestMarshaller implements
    ...
    public Request<DisassociateMembersRequest> marshall(
        ...
        Request<DisassociateMembersRequest> request = new DefaultRequest<DisassociateMembersRequest>(
                disassociateMembersRequest, "AmazonGuardDuty");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/detector/{detectorId}/member/disassociate";
        uriResourcePath = uriResourcePath.replace(
                "{detectorId}",
                (disassociateMembersRequest.getDetectorId() == null) ? "" : StringUtils
                        .fromString(disassociateMembersRequest.getDetectorId()));
