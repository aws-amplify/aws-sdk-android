...
public class DisassociateFromMasterAccountRequestMarshaller
    ...
    public Request<DisassociateFromMasterAccountRequest> marshall(
        ...
        Request<DisassociateFromMasterAccountRequest> request = new DefaultRequest<DisassociateFromMasterAccountRequest>(
                disassociateFromMasterAccountRequest, "AmazonGuardDuty");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/detector/{detectorId}/master/disassociate";
        uriResourcePath = uriResourcePath.replace(
                "{detectorId}",
                (disassociateFromMasterAccountRequest.getDetectorId() == null) ? "" : StringUtils
                        .fromString(disassociateFromMasterAccountRequest.getDetectorId()));
