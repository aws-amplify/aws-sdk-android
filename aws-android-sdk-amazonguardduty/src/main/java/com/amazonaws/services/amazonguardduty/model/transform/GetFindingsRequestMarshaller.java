...
public class GetFindingsRequestMarshaller implements
    ...
    public Request<GetFindingsRequest> marshall(GetFindingsRequest getFindingsRequest) {
        ...
        Request<GetFindingsRequest> request = new DefaultRequest<GetFindingsRequest>(
                getFindingsRequest, "AmazonGuardDuty");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/detector/{detectorId}/findings/get";
        uriResourcePath = uriResourcePath.replace(
                "{detectorId}",
                (getFindingsRequest.getDetectorId() == null) ? "" : StringUtils
                        .fromString(getFindingsRequest.getDetectorId()));
        ...
        try {
            ...
            if (getFindingsRequest.getFindingIds() != null) {
                java.util.List<String> findingIds = getFindingsRequest.getFindingIds();
            ...
            if (getFindingsRequest.getSortCriteria() != null) {
                SortCriteria sortCriteria = getFindingsRequest.getSortCriteria();
