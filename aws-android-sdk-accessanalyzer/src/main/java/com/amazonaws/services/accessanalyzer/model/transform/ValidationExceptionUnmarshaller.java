...
import com.amazonaws.services.accessanalyzer.model.java.util.List&lt;ValidationExceptionField&gt;;
...
public class ValidationExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        e.setFieldList(gson.fromJson(error.get("fieldList"),java.util.List&lt;ValidationExceptionField&gt;.class));
