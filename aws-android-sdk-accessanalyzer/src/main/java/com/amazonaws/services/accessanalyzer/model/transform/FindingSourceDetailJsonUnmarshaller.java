...
/**
 * JSON unmarshaller for POJO FindingSourceDetail
 */
class FindingSourceDetailJsonUnmarshaller implements
        Unmarshaller<FindingSourceDetail, JsonUnmarshallerContext> {
    ...
    public FindingSourceDetail unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("accessPointArn")) {
                findingSourceDetail.setAccessPointArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
