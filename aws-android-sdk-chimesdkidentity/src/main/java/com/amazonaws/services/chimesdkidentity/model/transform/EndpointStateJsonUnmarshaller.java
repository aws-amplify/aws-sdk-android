...
/**
 * JSON unmarshaller for POJO EndpointState
 */
class EndpointStateJsonUnmarshaller implements Unmarshaller<EndpointState, JsonUnmarshallerContext> {
    ...
    public EndpointState unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Status")) {
                endpointState.setStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("StatusReason")) {
                endpointState.setStatusReason(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
