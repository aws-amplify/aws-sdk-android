...
public class ListAppInstanceUsersResult implements Serializable {
    /**
     * <p>
     ...
     *         chained together.
     */
    public ListAppInstanceUsersResult withAppInstanceUsers(
            AppInstanceUserSummary... appInstanceUsers) {
        if (getAppInstanceUsers() == null) {
            this.appInstanceUsers = new java.util.ArrayList<AppInstanceUserSummary>(
                    appInstanceUsers.length);
        }
        for (AppInstanceUserSummary value : appInstanceUsers) {
            this.appInstanceUsers.add(value);
        }
        return this;
    }
     ...
     */
    public ListAppInstanceUsersResult withAppInstanceUsers(
            java.util.Collection<AppInstanceUserSummary> appInstanceUsers) {
    ...
    public String toString() {
        ...
        if (getAppInstanceUsers() != null)
            sb.append("AppInstanceUsers: " + getAppInstanceUsers() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getAppInstanceUsers() == null) ? 0 : getAppInstanceUsers().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAppInstanceUsers() == null ^ this.getAppInstanceUsers() == null)
            return false;
        if (other.getAppInstanceUsers() != null
                && other.getAppInstanceUsers().equals(this.getAppInstanceUsers()) == false)
            return false;
