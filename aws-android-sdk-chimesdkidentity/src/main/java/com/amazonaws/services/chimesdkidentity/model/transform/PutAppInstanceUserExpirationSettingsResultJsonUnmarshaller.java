...
/**
 * JSON unmarshaller for response PutAppInstanceUserExpirationSettingsResult
 */
public class PutAppInstanceUserExpirationSettingsResultJsonUnmarshaller implements
    ...
    public PutAppInstanceUserExpirationSettingsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AppInstanceUserArn")) {
                putAppInstanceUserExpirationSettingsResult
                        .setAppInstanceUserArn(StringJsonUnmarshaller.getInstance()
                                .unmarshall(context));
