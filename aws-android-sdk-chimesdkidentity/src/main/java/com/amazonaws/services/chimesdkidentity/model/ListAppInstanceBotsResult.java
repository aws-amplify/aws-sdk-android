...
public class ListAppInstanceBotsResult implements Serializable {
    /**
     * <p>
    ...
    public ListAppInstanceBotsResult withAppInstanceBots(AppInstanceBotSummary... appInstanceBots) {
        if (getAppInstanceBots() == null) {
            this.appInstanceBots = new java.util.ArrayList<AppInstanceBotSummary>(
                    appInstanceBots.length);
        }
        for (AppInstanceBotSummary value : appInstanceBots) {
            this.appInstanceBots.add(value);
        }
        return this;
    }
     ...
     *         chained together.
     */
    public ListAppInstanceBotsResult withAppInstanceBots(
            java.util.Collection<AppInstanceBotSummary> appInstanceBots) {
     ...
     *
     * @return <p>
     *         The token passed by previous API calls until all requested bots
     *         are returned.
     *         </p>
     */
    ...
    public String toString() {
        ...
        if (getAppInstanceBots() != null)
            sb.append("AppInstanceBots: " + getAppInstanceBots() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getAppInstanceBots() == null) ? 0 : getAppInstanceBots().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAppInstanceBots() == null ^ this.getAppInstanceBots() == null)
            return false;
        if (other.getAppInstanceBots() != null
                && other.getAppInstanceBots().equals(this.getAppInstanceBots()) == false)
            return false;
