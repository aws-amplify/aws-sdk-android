...
/**
 * JSON unmarshaller for POJO S3Logs
 */
class S3LogsJsonUnmarshaller implements Unmarshaller<S3Logs, JsonUnmarshallerContext> {
    ...
    public S3Logs unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("s3BucketName")) {
                s3Logs.setS3BucketName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("s3KeyPrefix")) {
                s3Logs.setS3KeyPrefix(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
