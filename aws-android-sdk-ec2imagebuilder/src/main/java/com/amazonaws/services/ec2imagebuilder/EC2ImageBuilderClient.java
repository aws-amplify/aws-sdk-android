...
package com.amazonaws.services.ec2imagebuilder;
...
import com.amazonaws.services.ec2imagebuilder.model.transform.*;
...
public class EC2ImageBuilderClient extends AmazonWebServiceClient implements EC2ImageBuilder {
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/ec2imagebuilder/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/ec2imagebuilder/request.handler2s"));
    }
