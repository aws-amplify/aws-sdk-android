    ...
    public Schedule unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("scheduleExpression")) {
                schedule.setScheduleExpression(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("pipelineExecutionStartCondition")) {
                schedule.setPipelineExecutionStartCondition(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
