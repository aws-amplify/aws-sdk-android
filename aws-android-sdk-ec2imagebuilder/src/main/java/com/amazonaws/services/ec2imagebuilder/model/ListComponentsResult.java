...
public class ListComponentsResult implements Serializable {
    /**
     * <p>
    ...
    public ListComponentsResult withComponentVersionList(ComponentVersion... componentVersionList) {
        if (getComponentVersionList() == null) {
            this.componentVersionList = new java.util.ArrayList<ComponentVersion>(
                    componentVersionList.length);
        }
        for (ComponentVersion value : componentVersionList) {
            this.componentVersionList.add(value);
        }
        return this;
    }
     ...
     *         chained together.
     */
    public ListComponentsResult withComponentVersionList(
            java.util.Collection<ComponentVersion> componentVersionList) {
    ...
    public String toString() {
        ...
        if (getComponentVersionList() != null)
            sb.append("componentVersionList: " + getComponentVersionList() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getComponentVersionList() == null) ? 0 : getComponentVersionList().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getComponentVersionList() == null ^ this.getComponentVersionList() == null)
            return false;
        if (other.getComponentVersionList() != null
                && other.getComponentVersionList().equals(this.getComponentVersionList()) == false)
            return false;
