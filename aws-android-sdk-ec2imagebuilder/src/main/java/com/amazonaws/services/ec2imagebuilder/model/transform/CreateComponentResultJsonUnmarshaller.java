...
/**
 * JSON unmarshaller for response CreateComponentResult
 */
public class CreateComponentResultJsonUnmarshaller implements
        Unmarshaller<CreateComponentResult, JsonUnmarshallerContext> {
    ...
    public CreateComponentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("requestId")) {
                createComponentResult.setRequestId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("clientToken")) {
                createComponentResult.setClientToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("componentBuildVersionArn")) {
                createComponentResult.setComponentBuildVersionArn(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
