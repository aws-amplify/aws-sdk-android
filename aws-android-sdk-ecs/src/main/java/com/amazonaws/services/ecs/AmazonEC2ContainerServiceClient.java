...
public class AmazonEC2ContainerServiceClient extends AmazonWebServiceClient implements
     ...
     * @return deleteCapacityProviderResult The response from the
     *         DeleteCapacityProvider service method, as returned by Amazon EC2
     *         Container Service.
     * @throws ServerException
     * @throws ClientException
     * @throws InvalidParameterException
     ...
     *             data in the request, or a server side issue.
     */
    public DeleteCapacityProviderResult deleteCapacityProvider(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DeleteCapacityProviderRequestMarshaller()
                        .marshall(deleteCapacityProviderRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<DeleteCapacityProviderResult, JsonUnmarshallerContext> unmarshaller = new DeleteCapacityProviderResultJsonUnmarshaller();
            JsonResponseHandler<DeleteCapacityProviderResult> responseHandler = new JsonResponseHandler<DeleteCapacityProviderResult>(
                    unmarshaller);
