...
public class ListTaskDefinitionsResult implements Serializable {
    /**
     * <p>
     ...
     * </p>
     */
    private java.util.List<String> taskDefinitionArns;
    ...
    public void setTaskDefinitionArns(java.util.Collection<String> taskDefinitionArns) {
        ...
        this.taskDefinitionArns = new java.util.ArrayList<String>(taskDefinitionArns);
    }
    ...
    public ListTaskDefinitionsResult withTaskDefinitionArns(String... taskDefinitionArns) {
        if (getTaskDefinitionArns() == null) {
            this.taskDefinitionArns = new java.util.ArrayList<String>(taskDefinitionArns.length);
        }
        for (String value : taskDefinitionArns) {
            this.taskDefinitionArns.add(value);
        }
        return this;
    }
     ...
     * @param nextToken <p>
     *            The <code>nextToken</code> value to include in a future
     *            <code>ListTaskDefinitions</code> request. When the results of
     *            a <code>ListTaskDefinitions</code> request exceed
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getTaskDefinitionArns() == null) ? 0 : getTaskDefinitionArns().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTaskDefinitionArns() != null
                && other.getTaskDefinitionArns().equals(this.getTaskDefinitionArns()) == false)
            return false;
