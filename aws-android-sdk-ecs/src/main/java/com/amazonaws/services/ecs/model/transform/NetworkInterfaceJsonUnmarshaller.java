    ...
    public NetworkInterface unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("attachmentId")) {
                networkInterface.setAttachmentId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("privateIpv4Address")) {
                networkInterface.setPrivateIpv4Address(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
