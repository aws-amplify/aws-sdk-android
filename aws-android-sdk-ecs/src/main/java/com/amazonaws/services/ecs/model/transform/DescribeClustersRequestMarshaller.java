...
/**
 * JSON request marshaller for DescribeClustersRequest
 */
public class DescribeClustersRequestMarshaller implements
    ...
    public Request<DescribeClustersRequest> marshall(DescribeClustersRequest describeClustersRequest) {
        ...
        Request<DescribeClustersRequest> request = new DefaultRequest<DescribeClustersRequest>(
                describeClustersRequest, "AmazonEC2ContainerService");
        ...
        try {
            ...
            if (describeClustersRequest.getClusters() != null) {
                java.util.List<String> clusters = describeClustersRequest.getClusters();
                jsonWriter.name("clusters");
                jsonWriter.beginArray();
                for (String clustersItem : clusters) {
                    if (clustersItem != null) {
                        jsonWriter.value(clustersItem);
                    }
                }
                jsonWriter.endArray();
            }
            if (describeClustersRequest.getInclude() != null) {
                java.util.List<String> include = describeClustersRequest.getInclude();
