...
public class DeleteAttributesRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *            cluster that contains the resource to delete attributes. If
     ...
     *         attribute name and target ID, but do not specify the value. If
     *         you specify the target ID using the short form, you must also
     ...
     *
     * @param attributes <p>
     *            The attributes to delete from your resource. You can specify
     *            up to 10 attributes per request. For custom attributes,
     *            specify the attribute name and target ID, but do not specify
     *            the value. If you specify the target ID using the short form,
