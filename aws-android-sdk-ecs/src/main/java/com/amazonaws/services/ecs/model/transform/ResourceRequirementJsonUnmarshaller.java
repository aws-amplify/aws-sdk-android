...
/**
 * JSON unmarshaller for POJO ResourceRequirement
 */
class ResourceRequirementJsonUnmarshaller implements
        Unmarshaller<ResourceRequirement, JsonUnmarshallerContext> {
    ...
    public ResourceRequirement unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("value")) {
                resourceRequirement.setValue(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("type")) {
                resourceRequirement.setType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
