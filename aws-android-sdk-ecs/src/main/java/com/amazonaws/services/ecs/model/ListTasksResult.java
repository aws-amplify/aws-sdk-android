...
public class ListTasksResult implements Serializable {
     ...
     * </p>
     */
    private java.util.List<String> taskArns;

    /**
     * <p>
     * The <code>nextToken</code> value to include in a future
     * <code>ListTasks</code> request. When the results of a
     * <code>ListTasks</code> request exceed <code>maxResults</code>, this value
     ...
     *
     * @return <p>
     *         The list of task ARN entries for the <code>ListTasks</code>
     *         request.
     *         </p>
     */
    ...
    public void setTaskArns(java.util.Collection<String> taskArns) {
        ...
        this.taskArns = new java.util.ArrayList<String>(taskArns);
    }
    ...
    public ListTasksResult withTaskArns(String... taskArns) {
        if (getTaskArns() == null) {
            this.taskArns = new java.util.ArrayList<String>(taskArns.length);
        }
        for (String value : taskArns) {
            this.taskArns.add(value);
        }
        return this;
    }
     ...
     *         The <code>nextToken</code> value to include in a future
     *         <code>ListTasks</code> request. When the results of a
     *         <code>ListTasks</code> request exceed <code>maxResults</code>,
