...
public class ContainerDefinition implements Serializable {
    ...
    /**
     * <p>
     * A list of <code>ulimits</code> to set in the container. If a ulimit value
     * is specified in a task definition, it will override the default values
     * set by Docker. This parameter maps to <code>Ulimits</code> in the <a
     * href=
     * "https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate"
     * >Create a container</a> section of the <a
     * href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a>
     ...
     *         ulimit value is specified in a task definition, it will override
     *         the default values set by Docker. This parameter maps to
     *         <code>Ulimits</code> in the <a href=
     *         "https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate"
     *         >Create a container</a> section of the <a
     *         href="https://docs.docker.com/engine/api/v1.35/">Docker Remote
     ...
     * @param ulimits <p>
     *            A list of <code>ulimits</code> to set in the container. If a
     *            ulimit value is specified in a task definition, it will
     *            override the default values set by Docker. This parameter maps
     *            to <code>Ulimits</code> in the <a href=
     *            "https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate"
     *            >Create a container</a> section of the <a
     *            href="https://docs.docker.com/engine/api/v1.35/">Docker Remote
     *            API</a> and the <code>--ulimit</code> option to <a
