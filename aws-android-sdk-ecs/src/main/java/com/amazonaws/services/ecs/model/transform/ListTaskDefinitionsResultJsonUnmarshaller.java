...
/**
 * JSON unmarshaller for response ListTaskDefinitionsResult
 */
public class ListTaskDefinitionsResultJsonUnmarshaller implements
    ...
    public ListTaskDefinitionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("taskDefinitionArns")) {
                listTaskDefinitionsResult.setTaskDefinitionArns(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                listTaskDefinitionsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
