...
/**
 * JSON unmarshaller for response DescribeClustersResult
 */
public class DescribeClustersResultJsonUnmarshaller implements
        Unmarshaller<DescribeClustersResult, JsonUnmarshallerContext> {
    ...
    public DescribeClustersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("clusters")) {
                describeClustersResult.setClusters(new ListUnmarshaller<Cluster>(
                        ClusterJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("failures")) {
                describeClustersResult.setFailures(new ListUnmarshaller<Failure>(
