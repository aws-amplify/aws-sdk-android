...
/**
 * JSON unmarshaller for POJO Ulimit
 */
class UlimitJsonUnmarshaller implements Unmarshaller<Ulimit, JsonUnmarshallerContext> {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("name")) {
                ulimit.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("softLimit")) {
                ulimit.setSoftLimit(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("hardLimit")) {
