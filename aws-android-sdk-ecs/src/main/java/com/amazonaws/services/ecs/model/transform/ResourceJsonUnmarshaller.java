    ...
    public Resource unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("name")) {
                ...
                resource.setDoubleValue(DoubleJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("longValue")) {
                resource.setLongValue(LongJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("integerValue")) {
                resource.setIntegerValue(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("stringSetValue")) {
                resource.setStringSetValue(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
