...
public class PlacementConstraint implements Serializable {
     ...
     * instance. Use <code>memberOf</code> to restrict the selection to a group
     * of valid candidates.
     * </p>
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>distinctInstance, memberOf
     */
    private String type;
     ...
     * <code>distinctInstance</code>. For more information, see <a href=
     ...
     *
     * @return <p>
     *         The type of constraint. Use <code>distinctInstance</code> to
     *         ensure that each task in a particular group is running on a
     *         different container instance. Use <code>memberOf</code> to
     ...
     *            constraint. You cannot specify an expression if the constraint
     *            type is <code>distinctInstance</code>. For more information,
     *            see <a href=
     *            "https://docs.aws.amazon.com/AmazonECS/latest/developerguide/cluster-query-language.html"
     *            >Cluster Query Language</a> in the <i>Amazon Elastic Container
     *            Service Developer Guide</i>.
