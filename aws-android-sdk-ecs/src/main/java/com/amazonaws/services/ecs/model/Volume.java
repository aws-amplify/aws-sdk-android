...
public class Volume implements Serializable {
     ...
     * or Fargate launch types. The contents of the <code>host</code> parameter
     * determine whether your bind mount host volume persists on the host
     * container instance and where it is stored. If the <code>host</code>
     ...
     * <important>
     * <p>
     * <code>EFSVolumeConfiguration</code> remains in preview and is a Beta
     * Service as defined by and subject to the Beta Service Participation
     * Service Terms located at <a
     * href="https://aws.amazon.com/service-terms">https
     * ://aws.amazon.com/service-terms</a> ("Beta Terms"). These Beta Terms
     ...
     *         either the EC2 or Fargate launch types. The contents of the
     *         <code>host</code> parameter determine whether your bind mount
     *         host volume persists on the host container instance and where it
     *         is stored. If the <code>host</code> parameter is empty, then the
     *         Docker daemon assigns a host path for your data volume. However,
     ...
     * @param host <p>
     *            This parameter is specified when you are using bind mount host
     *            volumes. Bind mount host volumes are supported when you are
     *            using either the EC2 or Fargate launch types. The contents of
     *            the <code>host</code> parameter determine whether your bind
     *            mount host volume persists on the host container instance and
     *            where it is stored. If the <code>host</code> parameter is
     ...
     *         File System (Amazon EFS) file storage. Amazon EFS file systems
     *         are only supported when you are using the EC2 launch type.
     *         </p>
     *         <important>
     *         <p>
     *         <code>EFSVolumeConfiguration</code> remains in preview and is a
     *         Beta Service as defined by and subject to the Beta Service
     *         Participation Service Terms located at <a
     *         href="https://aws.amazon.com/service-terms"
     *         >https://aws.amazon.com/service-terms</a> ("Beta Terms"). These
     *         Beta Terms apply to your participation in this preview of
     *         <code>EFSVolumeConfiguration</code>.
     *         </p>
     *         </important>
     */
     ...
     *            Elastic File System (Amazon EFS) file storage. Amazon EFS file
     *            systems are only supported when you are using the EC2 launch
     *            type.
     *            </p>
     *            <important>
     *            <p>
     *            <code>EFSVolumeConfiguration</code> remains in preview and is
     *            a Beta Service as defined by and subject to the Beta Service
     *            Participation Service Terms located at <a
     *            href="https://aws.amazon.com/service-terms"
     *            >https://aws.amazon.com/service-terms</a> ("Beta Terms").
