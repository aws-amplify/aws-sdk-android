...
/**
 * JSON unmarshaller for POJO HostVolumeProperties
 */
class HostVolumePropertiesJsonUnmarshaller implements
    ...
    public HostVolumeProperties unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("sourcePath")) {
                hostVolumeProperties.setSourcePath(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
