...
public enum AgentUpdateStatus {
    ...
    private static final Map<String, AgentUpdateStatus> enumMap;
    static {
        enumMap = new HashMap<String, AgentUpdateStatus>();
        enumMap.put("PENDING", PENDING);
        enumMap.put("STAGING", STAGING);
        enumMap.put("STAGED", STAGED);
        enumMap.put("UPDATING", UPDATING);
        enumMap.put("UPDATED", UPDATED);
