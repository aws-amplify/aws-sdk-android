...
/**
 * JSON request marshaller for ListTaskDefinitionsRequest
 */
public class ListTaskDefinitionsRequestMarshaller implements
    ...
    public Request<ListTaskDefinitionsRequest> marshall(
        ...
        if (listTaskDefinitionsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ListTaskDefinitionsRequest)");
        }

        Request<ListTaskDefinitionsRequest> request = new DefaultRequest<ListTaskDefinitionsRequest>(
                listTaskDefinitionsRequest, "AmazonEC2ContainerService");
