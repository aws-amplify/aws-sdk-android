...
/**
 * JSON request marshaller for DescribeServicesRequest
 */
    ...
    public Request<DescribeServicesRequest> marshall(DescribeServicesRequest describeServicesRequest) {
        if (describeServicesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DescribeServicesRequest)");
        }

        Request<DescribeServicesRequest> request = new DefaultRequest<DescribeServicesRequest>(
                describeServicesRequest, "AmazonEC2ContainerService");
        ...
        try {
            ...
            if (describeServicesRequest.getCluster() != null) {
                String cluster = describeServicesRequest.getCluster();
                jsonWriter.name("cluster");
                jsonWriter.value(cluster);
            }
            if (describeServicesRequest.getServices() != null) {
                java.util.List<String> services = describeServicesRequest.getServices();
            ...
            if (describeServicesRequest.getInclude() != null) {
                java.util.List<String> include = describeServicesRequest.getInclude();
