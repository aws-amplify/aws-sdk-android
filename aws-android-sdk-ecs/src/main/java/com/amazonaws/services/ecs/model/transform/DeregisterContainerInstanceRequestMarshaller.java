...
/**
 * JSON request marshaller for DeregisterContainerInstanceRequest
 */
    ...
    public Request<DeregisterContainerInstanceRequest> marshall(
        ...
        if (deregisterContainerInstanceRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeregisterContainerInstanceRequest)");
        }

        Request<DeregisterContainerInstanceRequest> request = new DefaultRequest<DeregisterContainerInstanceRequest>(
                deregisterContainerInstanceRequest, "AmazonEC2ContainerService");
        ...
        try {
            ...
            if (deregisterContainerInstanceRequest.getCluster() != null) {
                String cluster = deregisterContainerInstanceRequest.getCluster();
                jsonWriter.name("cluster");
                jsonWriter.value(cluster);
            }
            if (deregisterContainerInstanceRequest.getContainerInstance() != null) {
                String containerInstance = deregisterContainerInstanceRequest
            ...
            if (deregisterContainerInstanceRequest.getForce() != null) {
                Boolean force = deregisterContainerInstanceRequest.getForce();
