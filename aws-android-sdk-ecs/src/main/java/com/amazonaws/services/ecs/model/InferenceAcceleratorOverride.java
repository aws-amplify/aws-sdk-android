 ...
 * definition. For more information, see <a href=
 ...
 * </p>
 */
public class InferenceAcceleratorOverride implements Serializable {
    /**
     * <p>
     * The Elastic Inference accelerator device name to override for the task.
     * This parameter must match a <code>deviceName</code> specified in the task
     * definition.
     * </p>
     */
     ...
     *         task. This parameter must match a <code>deviceName</code>
     ...
     *
     * @param deviceName <p>
     *            The Elastic Inference accelerator device name to override for
     *            the task. This parameter must match a <code>deviceName</code>
     *            specified in the task definition.
     *            </p>
     */
