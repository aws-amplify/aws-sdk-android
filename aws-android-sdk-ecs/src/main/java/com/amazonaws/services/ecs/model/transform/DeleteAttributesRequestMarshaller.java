...
/**
 * JSON request marshaller for DeleteAttributesRequest
 */
    ...
    public Request<DeleteAttributesRequest> marshall(DeleteAttributesRequest deleteAttributesRequest) {
        if (deleteAttributesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(DeleteAttributesRequest)");
        }

        Request<DeleteAttributesRequest> request = new DefaultRequest<DeleteAttributesRequest>(
                deleteAttributesRequest, "AmazonEC2ContainerService");
        ...
        try {
            ...
            if (deleteAttributesRequest.getCluster() != null) {
                String cluster = deleteAttributesRequest.getCluster();
                jsonWriter.name("cluster");
                jsonWriter.value(cluster);
            }
            if (deleteAttributesRequest.getAttributes() != null) {
                java.util.List<Attribute> attributes = deleteAttributesRequest.getAttributes();
