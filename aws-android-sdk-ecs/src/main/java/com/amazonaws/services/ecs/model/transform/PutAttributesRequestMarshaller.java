...
/**
 * JSON request marshaller for PutAttributesRequest
 */
    ...
    public Request<PutAttributesRequest> marshall(PutAttributesRequest putAttributesRequest) {
        if (putAttributesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(PutAttributesRequest)");
        }

        Request<PutAttributesRequest> request = new DefaultRequest<PutAttributesRequest>(
                putAttributesRequest, "AmazonEC2ContainerService");
        ...
        try {
            ...
            if (putAttributesRequest.getCluster() != null) {
                String cluster = putAttributesRequest.getCluster();
                jsonWriter.name("cluster");
                jsonWriter.value(cluster);
            }
            if (putAttributesRequest.getAttributes() != null) {
                java.util.List<Attribute> attributes = putAttributesRequest.getAttributes();
