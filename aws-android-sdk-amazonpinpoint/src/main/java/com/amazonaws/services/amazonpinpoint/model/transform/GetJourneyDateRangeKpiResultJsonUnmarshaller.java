...
/**
 * JSON unmarshaller for response GetJourneyDateRangeKpiResult
 */
public class GetJourneyDateRangeKpiResultJsonUnmarshaller implements
        Unmarshaller<GetJourneyDateRangeKpiResult, JsonUnmarshallerContext> {

    public GetJourneyDateRangeKpiResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
