    ...
    public EmailTemplateResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Arn")) {
                ...
                emailTemplateResponse.setDefaultSubstitutions(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                emailTemplateResponse.setRecommenderId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                emailTemplateResponse.setTemplateDescription(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                emailTemplateResponse.setVersion(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
