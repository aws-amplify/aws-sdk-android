...
/**
 * JSON unmarshaller for POJO MultiConditionalSplitActivity
 */
class MultiConditionalSplitActivityJsonUnmarshaller implements
        Unmarshaller<MultiConditionalSplitActivity, JsonUnmarshallerContext> {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Branches")) {
                multiConditionalSplitActivity
                        .setBranches(new ListUnmarshaller<MultiConditionalBranch>(
                                MultiConditionalBranchJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("DefaultActivity")) {
                multiConditionalSplitActivity.setDefaultActivity(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("EvaluationWaitTime")) {
                multiConditionalSplitActivity.setEvaluationWaitTime(WaitTimeJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
