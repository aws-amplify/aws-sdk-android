...
class TemplateResponseJsonMarshaller {
    ...
    public void marshall(TemplateResponse templateResponse, AwsJsonWriter jsonWriter)
        ...
        if (templateResponse.getDefaultSubstitutions() != null) {
            String defaultSubstitutions = templateResponse.getDefaultSubstitutions();
        ...
        if (templateResponse.getTemplateDescription() != null) {
            String templateDescription = templateResponse.getTemplateDescription();
        ...
        if (templateResponse.getVersion() != null) {
            String version = templateResponse.getVersion();
