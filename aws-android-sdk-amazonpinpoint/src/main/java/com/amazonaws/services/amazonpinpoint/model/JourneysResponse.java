 ...
 * </p>
 */
public class JourneysResponse implements Serializable {
    /**
     * <p>
     ...
     *
     * @return <p>
     *         An array of responses, one for each journey that's associated
    ...
    public JourneysResponse withItem(JourneyResponse... item) {
        if (getItem() == null) {
            this.item = new java.util.ArrayList<JourneyResponse>(item.length);
        }
        for (JourneyResponse value : item) {
            this.item.add(value);
        }
        return this;
    }
