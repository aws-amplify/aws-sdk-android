 ...
 * </p>
 */
public class UpdateEmailTemplateRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     * </p>
     *
     * @param emailTemplateRequest <p>
     *            Specifies the content and settings for a message template that
     *            can be used in messages that are sent through the email
     *            channel.
     *            </p>
     */
     ...
     *         chained together.
     */
    public UpdateEmailTemplateRequest withEmailTemplateRequest(
    ...
    public String toString() {
        ...
        if (getEmailTemplateRequest() != null)
            sb.append("EmailTemplateRequest: " + getEmailTemplateRequest() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getEmailTemplateRequest() == null) ? 0 : getEmailTemplateRequest().hashCode());
        hashCode = prime * hashCode
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getEmailTemplateRequest() == null ^ this.getEmailTemplateRequest() == null)
            return false;
        if (other.getEmailTemplateRequest() != null
                && other.getEmailTemplateRequest().equals(this.getEmailTemplateRequest()) == false)
            return false;
