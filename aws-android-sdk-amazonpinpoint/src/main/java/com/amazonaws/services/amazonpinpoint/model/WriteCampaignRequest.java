...
public class WriteCampaignRequest implements Serializable {
     ...
     *         chained together.
     */
    public WriteCampaignRequest withCustomDeliveryConfiguration(
            CustomDeliveryConfiguration customDeliveryConfiguration) {
        this.customDeliveryConfiguration = customDeliveryConfiguration;
        return this;
    }
     ...
     *            A custom description of the default treatment for the
     *            campaign.
     *            </p>
     */
     ...
     *            A custom name of the default treatment for the campaign, if
