...
public class UntagResourceRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *
     * @return <p>
     *         The key of the tag to remove from the resource. To remove
     *         multiple tags, append the tagKeys parameter and argument for each
     ...
     * @param tagKeys <p>
     *            The key of the tag to remove from the resource. To remove
     *            multiple tags, append the tagKeys parameter and argument for
