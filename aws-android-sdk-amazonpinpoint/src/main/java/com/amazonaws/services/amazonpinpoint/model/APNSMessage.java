...
public class APNSMessage implements Serializable {
     ...
     * when it sends the notification message to APNs. If you don't specify a
     * value for this property, Amazon Pinpoint sets the value to alert or
     * background automatically, based on the value that you specify for the
     * SilentPush or RawContent property of the message.
     * </p>
     * <p>
     * For more information about the apns-push-type request header, see <a
     * href=
     * "https://developer.apple.com/documentation/usernotifications/setting_up_a_remote_notification_server/sending_notification_requests_to_apns"
     * >Sending Notification Requests to APNs</a> on the Apple Developer
     * website.
     * </p>
     */
     ...
     *         <li>
     *         <p>
     *         mdm - For a notification that tells managed devices to contact
     *         the MDM server.
     *         </p>
     *         </li>
     *         <li>
     ...
     *         request header when it sends the notification message to APNs. If
     *         you don't specify a value for this property, Amazon Pinpoint sets
     *         the value to alert or background automatically, based on the
     *         value that you specify for the SilentPush or RawContent property
     *         of the message.
     *         </p>
     *         <p>
     ...
     *            <p>
     *            alert - For a standard notification that's displayed on
     *            recipients' devices and prompts a recipient to interact with
     *            the notification.
     *            </p>
     *            </li>
     *            <li>
     *            <p>
     *            background - For a silent notification that delivers content
     *            in the background and isn't displayed on recipients' devices.
     *            </p>
     *            </li>
     *            <li>
     *            <p>
     ...
     *            Pinpoint sets the value to alert or background automatically,
     *            based on the value that you specify for the SilentPush or
     *            RawContent property of the message.
     *            </p>
     *            <p>
     *            For more information about the apns-push-type request header,
     *            see <a href=
     *            "https://developer.apple.com/documentation/usernotifications/setting_up_a_remote_notification_server/sending_notification_requests_to_apns"
     *            >Sending Notification Requests to APNs</a> on the Apple
     *            Developer website.
     *            </p>
     */
     ...
     *         when authenticating with APNs, CERTIFICATE or TOKEN.
     *         </p>
     */
    ...
    public String toString() {
        ...
        if (getAPNSPushType() != null)
            sb.append("APNSPushType: " + getAPNSPushType() + ",");
        if (getAction() != null)
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getAPNSPushType() == null) ? 0 : getAPNSPushType().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAPNSPushType() == null ^ this.getAPNSPushType() == null)
            return false;
        if (other.getAPNSPushType() != null
                && other.getAPNSPushType().equals(this.getAPNSPushType()) == false)
            return false;
