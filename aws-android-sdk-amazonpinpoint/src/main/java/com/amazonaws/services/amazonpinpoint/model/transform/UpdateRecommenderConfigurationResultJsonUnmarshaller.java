...
/**
 * JSON unmarshaller for response UpdateRecommenderConfigurationResult
 */
public class UpdateRecommenderConfigurationResultJsonUnmarshaller implements
        Unmarshaller<UpdateRecommenderConfigurationResult, JsonUnmarshallerContext> {

    public UpdateRecommenderConfigurationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
