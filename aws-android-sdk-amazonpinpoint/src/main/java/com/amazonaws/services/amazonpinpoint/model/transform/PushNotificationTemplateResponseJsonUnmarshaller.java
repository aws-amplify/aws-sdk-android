    ...
    public PushNotificationTemplateResponse unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ADM")) {
                ...
                pushNotificationTemplateResponse.setDefaultSubstitutions(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                pushNotificationTemplateResponse.setRecommenderId(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                pushNotificationTemplateResponse.setTemplateDescription(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
                ...
                pushNotificationTemplateResponse.setVersion(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
