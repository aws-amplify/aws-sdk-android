...
/**
 * JSON unmarshaller for response DeleteRecommenderConfigurationResult
 */
public class DeleteRecommenderConfigurationResultJsonUnmarshaller implements
        Unmarshaller<DeleteRecommenderConfigurationResult, JsonUnmarshallerContext> {

    public DeleteRecommenderConfigurationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
