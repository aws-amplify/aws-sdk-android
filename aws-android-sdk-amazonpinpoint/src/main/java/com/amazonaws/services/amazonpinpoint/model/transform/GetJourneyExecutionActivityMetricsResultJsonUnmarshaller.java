...
/**
 * JSON unmarshaller for response GetJourneyExecutionActivityMetricsResult
 */
public class GetJourneyExecutionActivityMetricsResultJsonUnmarshaller implements
    ...
    public GetJourneyExecutionActivityMetricsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
