...
public class MessageConfiguration implements Serializable {
     ...
     * Cloud Messaging (FCM), formerly Google Cloud Messaging (GCM), service. If
     * specified, this message overrides the default message.
     * </p>
     */
     ...
     *         Device Messaging) channel. If specified, this message overrides
     *         the default message.
     *         </p>
     */
     ...
     * @param aDMMessage <p>
     *            The message that the campaign sends through the ADM (Amazon
     *            Device Messaging) channel. If specified, this message
     ...
     * @return <p>
     *         The message that the campaign sends through the APNs (Apple Push
     *         Notification service) channel. If specified, this message
     *         overrides the default message.
     *         </p>
     */
     ...
     *            Push Notification service) channel. If specified, this message
     *            overrides the default message.
     *            </p>
     */
     ...
     *            as specified by the delivery configuration
     *            (CustomDeliveryConfiguration) settings for the campaign. If
     *            specified, this message overrides the default message.
     *            </p>
     */
     ...
     *         Messaging (GCM), service. If specified, this message overrides
     *         the default message.
     *         </p>
     */
