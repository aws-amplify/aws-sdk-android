...
public class UpdateRevisionResult implements Serializable {
    /**
     * <p>
     ...
     *         Exchange that changes to the assets in the revision are complete.
     *         After it's in this read-only state, you can publish the revision
     *         to your products.
     *         </p>
     *         <p>
     ...
     *            To publish a revision to a data set in a product, the revision
     *            must first be finalized. Finalizing a revision tells AWS Data
     *            Exchange that changes to the assets in the revision are
