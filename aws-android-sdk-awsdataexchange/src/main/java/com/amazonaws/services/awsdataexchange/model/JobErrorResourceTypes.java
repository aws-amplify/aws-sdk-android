...
public enum JobErrorResourceTypes {
    ...
    private static final Map<String, JobErrorResourceTypes> enumMap;
    static {
        enumMap = new HashMap<String, JobErrorResourceTypes>();
        enumMap.put("REVISION", REVISION);
        enumMap.put("ASSET", ASSET);
    }
