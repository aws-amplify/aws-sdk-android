...
public class CreateJobRequestMarshaller implements
    ...
    public Request<CreateJobRequest> marshall(CreateJobRequest createJobRequest) {
        ...
        try {
            ...
            if (createJobRequest.getDetails() != null) {
                RequestDetails details = createJobRequest.getDetails();
                jsonWriter.name("Details");
                RequestDetailsJsonMarshaller.getInstance().marshall(details, jsonWriter);
            }
            if (createJobRequest.getType() != null) {
                String type = createJobRequest.getType();
