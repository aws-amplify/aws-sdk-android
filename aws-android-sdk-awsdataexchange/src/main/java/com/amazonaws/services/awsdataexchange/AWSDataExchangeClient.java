...
package com.amazonaws.services.awsdataexchange;
...
import com.amazonaws.services.awsdataexchange.model.transform.*;
...
public class AWSDataExchangeClient extends AmazonWebServiceClient implements AWSDataExchange {
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/awsdataexchange/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/awsdataexchange/request.handler2s"));
    }
