...
/**
 * JSON request marshaller for DeleteApplicationRequest
 */
public class DeleteApplicationRequestMarshaller implements
    ...
    public Request<DeleteApplicationRequest> marshall(
        ...
        Request<DeleteApplicationRequest> request = new DefaultRequest<DeleteApplicationRequest>(
                deleteApplicationRequest, "AmazonAppConfig");
        request.setHttpMethod(HttpMethodName.DELETE);

        String uriResourcePath = "/applications/{ApplicationId}";
        uriResourcePath = uriResourcePath.replace(
                "{ApplicationId}",
                (deleteApplicationRequest.getApplicationId() == null) ? "" : StringUtils
                        .fromString(deleteApplicationRequest.getApplicationId()));
