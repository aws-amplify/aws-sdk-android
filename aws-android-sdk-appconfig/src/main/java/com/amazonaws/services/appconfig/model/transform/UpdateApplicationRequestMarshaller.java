...
public class UpdateApplicationRequestMarshaller implements
    ...
    public Request<UpdateApplicationRequest> marshall(
        ...
        Request<UpdateApplicationRequest> request = new DefaultRequest<UpdateApplicationRequest>(
                updateApplicationRequest, "AmazonAppConfig");
        request.setHttpMethod(HttpMethodName.PATCH);

        String uriResourcePath = "/applications/{ApplicationId}";
        uriResourcePath = uriResourcePath.replace(
                "{ApplicationId}",
                (updateApplicationRequest.getApplicationId() == null) ? "" : StringUtils
                        .fromString(updateApplicationRequest.getApplicationId()));
