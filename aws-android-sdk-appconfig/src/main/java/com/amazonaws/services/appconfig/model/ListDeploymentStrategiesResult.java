...
public class ListDeploymentStrategiesResult implements Serializable {
    /**
     * <p>
    ...
    public ListDeploymentStrategiesResult withItems(DeploymentStrategy... items) {
        if (getItems() == null) {
            this.items = new java.util.ArrayList<DeploymentStrategy>(items.length);
        }
        for (DeploymentStrategy value : items) {
