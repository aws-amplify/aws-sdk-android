...
public class AmazonAppConfigClient extends AmazonWebServiceClient implements AmazonAppConfig {
     ...
     * @return createHostedConfigurationVersionResult The response from the
     *         CreateHostedConfigurationVersion service method, as returned by
     *         Amazon AppConfig.
     * @throws BadRequestException
     ...
     *             request, or a server side issue.
     */
    public CreateHostedConfigurationVersionResult createHostedConfigurationVersion(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new CreateHostedConfigurationVersionRequestMarshaller()
                        .marshall(createHostedConfigurationVersionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<CreateHostedConfigurationVersionResult, JsonUnmarshallerContext> unmarshaller = new CreateHostedConfigurationVersionResultJsonUnmarshaller();
            JsonResponseHandler<CreateHostedConfigurationVersionResult> responseHandler = new JsonResponseHandler<CreateHostedConfigurationVersionResult>(
                    unmarshaller);
     ...
     *             request, or a server side issue.
     */
    public void deleteHostedConfigurationVersion(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DeleteHostedConfigurationVersionRequestMarshaller()
                        .marshall(deleteHostedConfigurationVersionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
     ...
     * @return getHostedConfigurationVersionResult The response from the
     *         GetHostedConfigurationVersion service method, as returned by
     *         Amazon AppConfig.
     * @throws BadRequestException
     * @throws ResourceNotFoundException
     * @throws InternalServerException
     ...
     *             request, or a server side issue.
     */
    public GetHostedConfigurationVersionResult getHostedConfigurationVersion(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetHostedConfigurationVersionRequestMarshaller()
                        .marshall(getHostedConfigurationVersionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<GetHostedConfigurationVersionResult, JsonUnmarshallerContext> unmarshaller = new GetHostedConfigurationVersionResultJsonUnmarshaller();
            JsonResponseHandler<GetHostedConfigurationVersionResult> responseHandler = new JsonResponseHandler<GetHostedConfigurationVersionResult>(
                    unmarshaller);
     ...
     * @return listHostedConfigurationVersionsResult The response from the
     *         ListHostedConfigurationVersions service method, as returned by
     *         Amazon AppConfig.
     * @throws BadRequestException
     * @throws ResourceNotFoundException
     * @throws InternalServerException
     ...
     *             request, or a server side issue.
     */
    public ListHostedConfigurationVersionsResult listHostedConfigurationVersions(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new ListHostedConfigurationVersionsRequestMarshaller()
                        .marshall(listHostedConfigurationVersionsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<ListHostedConfigurationVersionsResult, JsonUnmarshallerContext> unmarshaller = new ListHostedConfigurationVersionsResultJsonUnmarshaller();
            JsonResponseHandler<ListHostedConfigurationVersionsResult> responseHandler = new JsonResponseHandler<ListHostedConfigurationVersionsResult>(
                    unmarshaller);
