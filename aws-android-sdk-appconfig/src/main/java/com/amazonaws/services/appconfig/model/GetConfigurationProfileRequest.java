 ...
 * </p>
 */
public class GetConfigurationProfileRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *            The ID of the application that includes the configuration
