...
/**
 * JSON request marshaller for GetApplicationRequest
 */
    ...
    public Request<GetApplicationRequest> marshall(GetApplicationRequest getApplicationRequest) {
        if (getApplicationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetApplicationRequest)");
        }

        Request<GetApplicationRequest> request = new DefaultRequest<GetApplicationRequest>(
                getApplicationRequest, "AmazonAppConfig");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/applications/{ApplicationId}";
        uriResourcePath = uriResourcePath.replace(
                "{ApplicationId}",
                (getApplicationRequest.getApplicationId() == null) ? "" : StringUtils
                        .fromString(getApplicationRequest.getApplicationId()));
