...
/**
 * JSON unmarshaller for response GetTriggersResult
 */
public class GetTriggersResultJsonUnmarshaller implements
        Unmarshaller<GetTriggersResult, JsonUnmarshallerContext> {
    ...
    public GetTriggersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Triggers")) {
                getTriggersResult.setTriggers(new ListUnmarshaller<Trigger>(TriggerJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                getTriggersResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
