...
/**
 * JSON unmarshaller for POJO DataLakePrincipal
 */
class DataLakePrincipalJsonUnmarshaller implements
        Unmarshaller<DataLakePrincipal, JsonUnmarshallerContext> {
    ...
    public DataLakePrincipal unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("DataLakePrincipalIdentifier")) {
                dataLakePrincipal.setDataLakePrincipalIdentifier(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
