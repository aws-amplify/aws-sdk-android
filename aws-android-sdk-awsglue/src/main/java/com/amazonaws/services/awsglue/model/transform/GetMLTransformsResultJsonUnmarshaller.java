...
/**
 * JSON unmarshaller for response GetMLTransformsResult
 */
public class GetMLTransformsResultJsonUnmarshaller implements
        Unmarshaller<GetMLTransformsResult, JsonUnmarshallerContext> {
    ...
    public GetMLTransformsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Transforms")) {
                getMLTransformsResult.setTransforms(new ListUnmarshaller<MLTransform>(
                        MLTransformJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                getMLTransformsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
