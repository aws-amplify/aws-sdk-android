 ...
 * </p>
 */
public class GetCatalogImportStatusRequest extends AmazonWebServiceRequest implements Serializable {
    /**
     * <p>
     ...
     *
     * @param catalogId <p>
     *            The ID of the catalog to migrate. Currently, this should be
     *            the AWS account ID.
     *            </p>
     */
