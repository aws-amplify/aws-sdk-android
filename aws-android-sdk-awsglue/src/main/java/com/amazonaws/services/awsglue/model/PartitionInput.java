...
public class PartitionInput implements Serializable {
     ...
     * keys appearing in the Amazon S3 prefix. Otherwise AWS Glue will add the
     * values to the wrong keys.
     * </p>
     */
     ...
     *         an array of String objects that must be ordered in the same order
     *         as the partition keys appearing in the Amazon S3 prefix.
     ...
     *            as an array of String objects that must be ordered in the same
