...
/**
 * JSON unmarshaller for response GetCrawlerResult
 */
public class GetCrawlerResultJsonUnmarshaller implements
        Unmarshaller<GetCrawlerResult, JsonUnmarshallerContext> {
    ...
    public GetCrawlerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Crawler")) {
                getCrawlerResult.setCrawler(CrawlerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
