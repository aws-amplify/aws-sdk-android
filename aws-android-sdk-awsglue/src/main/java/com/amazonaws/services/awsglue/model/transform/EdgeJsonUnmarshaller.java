...
/**
 * JSON unmarshaller for POJO Edge
 */
class EdgeJsonUnmarshaller implements Unmarshaller<Edge, JsonUnmarshallerContext> {
    ...
    public Edge unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SourceId")) {
                edge.setSourceId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("DestinationId")) {
                edge.setDestinationId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
