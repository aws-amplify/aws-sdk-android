...
/**
 * JSON unmarshaller for response CreatePartitionResult
 */
public class CreatePartitionResultJsonUnmarshaller implements
        Unmarshaller<CreatePartitionResult, JsonUnmarshallerContext> {
