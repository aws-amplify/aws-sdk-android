...
class ConditionJsonUnmarshaller implements Unmarshaller<Condition, JsonUnmarshallerContext> {
    ...
    public Condition unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("LogicalOperator")) {
                condition.setLogicalOperator(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("JobName")) {
                condition.setJobName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("State")) {
                condition.setState(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("CrawlerName")) {
                condition.setCrawlerName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("CrawlState")) {
                condition.setCrawlState(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
