...
/**
 * JSON unmarshaller for response CreateDatabaseResult
 */
public class CreateDatabaseResultJsonUnmarshaller implements
        Unmarshaller<CreateDatabaseResult, JsonUnmarshallerContext> {
