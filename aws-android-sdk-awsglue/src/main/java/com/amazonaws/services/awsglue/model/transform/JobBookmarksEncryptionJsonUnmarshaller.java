...
/**
 * JSON unmarshaller for POJO JobBookmarksEncryption
 */
class JobBookmarksEncryptionJsonUnmarshaller implements
        Unmarshaller<JobBookmarksEncryption, JsonUnmarshallerContext> {
    ...
    public JobBookmarksEncryption unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("JobBookmarksEncryptionMode")) {
                jobBookmarksEncryption.setJobBookmarksEncryptionMode(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("KmsKeyArn")) {
                jobBookmarksEncryption.setKmsKeyArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
