...
public enum TriggerState {
    ...
    private static final Map<String, TriggerState> enumMap;
    static {
        enumMap = new HashMap<String, TriggerState>();
        enumMap.put("CREATING", CREATING);
        enumMap.put("CREATED", CREATED);
        enumMap.put("ACTIVATING", ACTIVATING);
        enumMap.put("ACTIVATED", ACTIVATED);
        enumMap.put("DEACTIVATING", DEACTIVATING);
        enumMap.put("DEACTIVATED", DEACTIVATED);
