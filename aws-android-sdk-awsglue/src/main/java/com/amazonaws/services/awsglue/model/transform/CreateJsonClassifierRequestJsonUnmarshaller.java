...
/**
 * JSON unmarshaller for POJO CreateJsonClassifierRequest
 */
class CreateJsonClassifierRequestJsonUnmarshaller implements
        Unmarshaller<CreateJsonClassifierRequest, JsonUnmarshallerContext> {
    ...
    public CreateJsonClassifierRequest unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                createJsonClassifierRequest.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("JsonPath")) {
                createJsonClassifierRequest.setJsonPath(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
