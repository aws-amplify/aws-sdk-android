...
/**
 * JSON unmarshaller for POJO Predicate
 */
class PredicateJsonUnmarshaller implements Unmarshaller<Predicate, JsonUnmarshallerContext> {
    ...
    public Predicate unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Logical")) {
                predicate.setLogical(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Conditions")) {
                predicate.setConditions(new ListUnmarshaller<Condition>(ConditionJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
