...
/**
 * JSON unmarshaller for response DeleteWorkflowResult
 */
public class DeleteWorkflowResultJsonUnmarshaller implements
        Unmarshaller<DeleteWorkflowResult, JsonUnmarshallerContext> {
    ...
    public DeleteWorkflowResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                deleteWorkflowResult.setName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
