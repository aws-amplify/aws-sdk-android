...
class EncryptionAtRestJsonMarshaller {
    ...
    public void marshall(EncryptionAtRest encryptionAtRest, AwsJsonWriter jsonWriter)
        ...
        if (encryptionAtRest.getDataVolumeKMSKeyId() != null) {
            String dataVolumeKMSKeyId = encryptionAtRest.getDataVolumeKMSKeyId();
            jsonWriter.name("DataVolumeKMSKeyId");
            jsonWriter.value(dataVolumeKMSKeyId);
        }
