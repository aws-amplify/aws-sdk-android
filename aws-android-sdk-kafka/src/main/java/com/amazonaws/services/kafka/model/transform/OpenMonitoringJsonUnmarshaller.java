...
/**
 * JSON unmarshaller for POJO OpenMonitoring
 */
class OpenMonitoringJsonUnmarshaller implements
        Unmarshaller<OpenMonitoring, JsonUnmarshallerContext> {
    ...
    public OpenMonitoring unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Prometheus")) {
                openMonitoring.setPrometheus(PrometheusJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
