...
public class FilterLogEventsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     *         and <code>logStreamNames</code>, the action returns an
     *         <code>InvalidParameterException</code> error.
     *         </p>
     */
     ...
     *         </p>
     *         <p>
     *         <b>IMPORTANT:</b> Starting on June 17, 2019, this parameter will
     *         be ignored and the value will be assumed to be true. The response
     *         from this operation will always interleave events from multiple
     ...
     *            will be ignored and the value will be assumed to be true. The
     *            response from this operation will always interleave events
