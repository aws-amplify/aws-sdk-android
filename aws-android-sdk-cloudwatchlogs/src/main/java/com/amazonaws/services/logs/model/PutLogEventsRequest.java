 ...
 * <li>
 * <p>
 * None of the log events in the batch can be older than 14 days or older than
...
public class PutLogEventsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * >DescribeLogStreams</a>. If you call <code>PutLogEvents</code> twice
     ...
     *         sequence token using <a href=
     *         "https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_DescribeLogStreams.html"
     *         >DescribeLogStreams</a>. If you call <code>PutLogEvents</code>
     *         twice within a narrow time period using the same value for
     *         <code>sequenceToken</code>, both calls may be successful, or one
     *         may be rejected.
     *         </p>
     */
     ...
     *            the sequence token using <a href=
     *            "https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_DescribeLogStreams.html"
     *            >DescribeLogStreams</a>. If you call <code>PutLogEvents</code>
     *            twice within a narrow time period using the same value for
     *            <code>sequenceToken</code>, both calls may be successful, or
     *            one may be rejected.
     *            </p>
     */
