...
public class DescribeQueriesResult implements Serializable {
    /**
     * <p>
     * The list of queries that match the request.
     * </p>
     */
    private java.util.List<QueryInfo> queries;
    ...
    public void setQueries(java.util.Collection<QueryInfo> queries) {
        ...
        this.queries = new java.util.ArrayList<QueryInfo>(queries);
    }
    ...
    public DescribeQueriesResult withQueries(QueryInfo... queries) {
        if (getQueries() == null) {
            this.queries = new java.util.ArrayList<QueryInfo>(queries.length);
        }
        for (QueryInfo value : queries) {
