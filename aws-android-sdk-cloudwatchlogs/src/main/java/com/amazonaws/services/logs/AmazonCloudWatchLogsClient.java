...
public class AmazonCloudWatchLogsClient extends AmazonWebServiceClient implements
     ...
     *         AmazonCloudWatchLogsClient client = new AmazonCloudWatchLogsClient(AWSMobileClient
     *                 .getInstance());
     *     }
     * 
     *     &#064;Override
    ...
    private void init() {
        ...
        jsonErrorUnmarshallers.add(new MalformedQueryExceptionUnmarshaller());
     ...
     *             the request, or a server side issue.
     */
    public DeleteQueryDefinitionResult deleteQueryDefinition(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DeleteQueryDefinitionRequestMarshaller()
                        .marshall(deleteQueryDefinitionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<DeleteQueryDefinitionResult, JsonUnmarshallerContext> unmarshaller = new DeleteQueryDefinitionResultJsonUnmarshaller();
            JsonResponseHandler<DeleteQueryDefinitionResult> responseHandler = new JsonResponseHandler<DeleteQueryDefinitionResult>(
                    unmarshaller);
     ...
     *             the request, or a server side issue.
     */
    public DescribeQueriesResult describeQueries(DescribeQueriesRequest describeQueriesRequest)
            throws AmazonServiceException, AmazonClientException {
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeQueriesRequestMarshaller().marshall(describeQueriesRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<DescribeQueriesResult, JsonUnmarshallerContext> unmarshaller = new DescribeQueriesResultJsonUnmarshaller();
            JsonResponseHandler<DescribeQueriesResult> responseHandler = new JsonResponseHandler<DescribeQueriesResult>(
                    unmarshaller);
     ...
     *             the request, or a server side issue.
     */
    public DescribeQueryDefinitionsResult describeQueryDefinitions(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DescribeQueryDefinitionsRequestMarshaller()
                        .marshall(describeQueryDefinitionsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<DescribeQueryDefinitionsResult, JsonUnmarshallerContext> unmarshaller = new DescribeQueryDefinitionsResultJsonUnmarshaller();
            JsonResponseHandler<DescribeQueryDefinitionsResult> responseHandler = new JsonResponseHandler<DescribeQueryDefinitionsResult>(
                    unmarshaller);
     ...
     *             the request, or a server side issue.
     */
    public GetLogGroupFieldsResult getLogGroupFields(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetLogGroupFieldsRequestMarshaller()
                        .marshall(getLogGroupFieldsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<GetLogGroupFieldsResult, JsonUnmarshallerContext> unmarshaller = new GetLogGroupFieldsResultJsonUnmarshaller();
            JsonResponseHandler<GetLogGroupFieldsResult> responseHandler = new JsonResponseHandler<GetLogGroupFieldsResult>(
                    unmarshaller);
     ...
     *             the request, or a server side issue.
     */
    public GetLogRecordResult getLogRecord(GetLogRecordRequest getLogRecordRequest)
            throws AmazonServiceException, AmazonClientException {
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new GetLogRecordRequestMarshaller().marshall(getLogRecordRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<GetLogRecordResult, JsonUnmarshallerContext> unmarshaller = new GetLogRecordResultJsonUnmarshaller();
            JsonResponseHandler<GetLogRecordResult> responseHandler = new JsonResponseHandler<GetLogRecordResult>(
                    unmarshaller);
     ...
     *             the request, or a server side issue.
     */
    public PutQueryDefinitionResult putQueryDefinition(
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new PutQueryDefinitionRequestMarshaller()
                        .marshall(putQueryDefinitionRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<PutQueryDefinitionResult, JsonUnmarshallerContext> unmarshaller = new PutQueryDefinitionResultJsonUnmarshaller();
            JsonResponseHandler<PutQueryDefinitionResult> responseHandler = new JsonResponseHandler<PutQueryDefinitionResult>(
                    unmarshaller);
     ...
     *             the request, or a server side issue.
     */
    public StartQueryResult startQuery(StartQueryRequest startQueryRequest)
            throws AmazonServiceException, AmazonClientException {
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new StartQueryRequestMarshaller().marshall(startQueryRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<StartQueryResult, JsonUnmarshallerContext> unmarshaller = new StartQueryResultJsonUnmarshaller();
            JsonResponseHandler<StartQueryResult> responseHandler = new JsonResponseHandler<StartQueryResult>(
                    unmarshaller);
     ...
     *             the request, or a server side issue.
     */
    public StopQueryResult stopQuery(StopQueryRequest stopQueryRequest)
            throws AmazonServiceException, AmazonClientException {
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new StopQueryRequestMarshaller().marshall(stopQueryRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            }
            Unmarshaller<StopQueryResult, JsonUnmarshallerContext> unmarshaller = new StopQueryResultJsonUnmarshaller();
            JsonResponseHandler<StopQueryResult> responseHandler = new JsonResponseHandler<StopQueryResult>(
                    unmarshaller);
