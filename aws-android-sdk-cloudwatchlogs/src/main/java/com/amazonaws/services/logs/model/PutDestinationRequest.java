 ...
 * stream) and enables you to subscribe to a real-time stream of log events for
 * a different account, ingested using <a href=
 ...
 * destination, which means a cross-account user cannot call <a href=
