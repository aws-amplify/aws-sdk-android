...
/**
 * JSON unmarshaller for response GetResourcePoliciesResult
 */
public class GetResourcePoliciesResultJsonUnmarshaller implements
        Unmarshaller<GetResourcePoliciesResult, JsonUnmarshallerContext> {
    ...
    public GetResourcePoliciesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("policies")) {
                getResourcePoliciesResult.setPolicies(new ListUnmarshaller<String>(
                        StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("nextToken")) {
                getResourcePoliciesResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
