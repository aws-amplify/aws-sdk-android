...
/**
 * JSON request marshaller for EnableSharingWithAwsOrganizationRequest
 */
public class EnableSharingWithAwsOrganizationRequestMarshaller
    ...
    public Request<EnableSharingWithAwsOrganizationRequest> marshall(
        ...
        if (enableSharingWithAwsOrganizationRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(EnableSharingWithAwsOrganizationRequest)");
        }

        Request<EnableSharingWithAwsOrganizationRequest> request = new DefaultRequest<EnableSharingWithAwsOrganizationRequest>(
                enableSharingWithAwsOrganizationRequest, "AWSResourceAccessManager");
