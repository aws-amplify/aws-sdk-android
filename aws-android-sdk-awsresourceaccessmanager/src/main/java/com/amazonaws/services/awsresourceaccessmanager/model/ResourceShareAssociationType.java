...
public enum ResourceShareAssociationType {
    ...
    private static final Map<String, ResourceShareAssociationType> enumMap;
    static {
        enumMap = new HashMap<String, ResourceShareAssociationType>();
        enumMap.put("PRINCIPAL", PRINCIPAL);
