...
/**
 * JSON unmarshaller for response DisassociateResourceShareResult
 */
public class DisassociateResourceShareResultJsonUnmarshaller implements
        Unmarshaller<DisassociateResourceShareResult, JsonUnmarshallerContext> {

    public DisassociateResourceShareResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("resourceShareAssociations")) {
                ...
                disassociateResourceShareResult.setClientToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
