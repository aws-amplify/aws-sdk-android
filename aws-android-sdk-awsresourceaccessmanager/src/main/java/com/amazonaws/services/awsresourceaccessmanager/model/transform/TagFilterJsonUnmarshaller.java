...
/**
 * JSON unmarshaller for POJO TagFilter
 */
class TagFilterJsonUnmarshaller implements Unmarshaller<TagFilter, JsonUnmarshallerContext> {
    ...
    public TagFilter unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("tagKey")) {
                tagFilter.setTagKey(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("tagValues")) {
                tagFilter.setTagValues(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
