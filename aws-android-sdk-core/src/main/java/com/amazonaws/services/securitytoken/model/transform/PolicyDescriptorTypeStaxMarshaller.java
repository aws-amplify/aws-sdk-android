...
/**
 * StAX marshaller for POJO PolicyDescriptorType
 */
class PolicyDescriptorTypeStaxMarshaller {

    public void marshall(PolicyDescriptorType _policyDescriptorType, Request<?> request,
            String _prefix) {
        String prefix;
        if (_policyDescriptorType.getArn() != null) {
            prefix = _prefix + "arn";
            String arn = _policyDescriptorType.getArn();
