...
/**
 * Interface for accessing AWS Security Token Service <fullname>Security Token
 * Service</fullname>
 * <p>
 ...
 * the STS API. For more information about using this service, see <a href=
...
public interface AWSSecurityTokenService {
     ...
     * operation returns new temporary credentials. The resulting session's
     ...
     * that is being assumed. For more information, see <a href=
     * "https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html#policies_session"
     ...
     * "https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-identity.html"
     * >Amazon Cognito identity pools</a> in <i>Amazon Cognito Developer
     * Guide</i>.
     * </p>
     * </note>
     * <p>
     ...
     * access to the <code>sts:GetCallerIdentity</code> action, you can still
     ...
     * we do not recommend it. For more information, see <a href=
     ...
     * Amazon EC2 <code>StopInstances</code>.
     * </p>
     * <p>
     * MFA-enabled IAM users must call <code>GetSessionToken</code> and submit
     ...
     * root user permissions. For more information, see <a href=
     * "https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html#lock-away-credentials"
     * >Safeguard your root user credentials and don't use them for everyday
     * tasks</a> in the <i>IAM User Guide</i>
     * </p>
