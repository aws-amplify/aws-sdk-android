...
public class VersionInfoUtils {
    /** SDK version info */
    private static volatile String version = "unknown-version"; //this will be changed build logic

    /** SDK platform info */
    private static volatile String platform = "android"; //this will be changed build logic
