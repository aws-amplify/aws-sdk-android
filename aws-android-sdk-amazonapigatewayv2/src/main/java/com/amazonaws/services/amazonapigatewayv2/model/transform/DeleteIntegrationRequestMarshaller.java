...
public class DeleteIntegrationRequestMarshaller implements
    ...
    public Request<DeleteIntegrationRequest> marshall(
        ...
        Request<DeleteIntegrationRequest> request = new DefaultRequest<DeleteIntegrationRequest>(
                deleteIntegrationRequest, "AmazonApiGatewayV2");
        request.setHttpMethod(HttpMethodName.DELETE);

        String uriResourcePath = "/v2/apis/{apiId}/integrations/{integrationId}";
        uriResourcePath = uriResourcePath.replace(
                "{apiId}",
                (deleteIntegrationRequest.getApiId() == null) ? "" : StringUtils
                        .fromString(deleteIntegrationRequest.getApiId()));
        uriResourcePath = uriResourcePath.replace(
                "{integrationId}",
                (deleteIntegrationRequest.getIntegrationId() == null) ? "" : StringUtils
                        .fromString(deleteIntegrationRequest.getIntegrationId()));
