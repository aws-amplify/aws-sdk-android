    ...
    public Authorizer unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AuthorizerCredentialsArn")) {
                authorizer.setAuthorizerCredentialsArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("AuthorizerId")) {
                authorizer.setAuthorizerId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                authorizer.setAuthorizerType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                authorizer.setIdentitySource(new ListUnmarshaller<String>(StringJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
                ...
                authorizer.setJwtConfiguration(JWTConfigurationJsonUnmarshaller.getInstance()
                        .unmarshall(context));
