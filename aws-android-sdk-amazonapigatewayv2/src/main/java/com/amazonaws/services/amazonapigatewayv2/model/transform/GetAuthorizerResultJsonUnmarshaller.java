    ...
    public GetAuthorizerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AuthorizerCredentialsArn")) {
                getAuthorizerResult.setAuthorizerCredentialsArn(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("AuthorizerId")) {
                getAuthorizerResult.setAuthorizerId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                getAuthorizerResult.setAuthorizerType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                getAuthorizerResult.setIdentitySource(new ListUnmarshaller<String>(
                ...
                getAuthorizerResult.setJwtConfiguration(JWTConfigurationJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
