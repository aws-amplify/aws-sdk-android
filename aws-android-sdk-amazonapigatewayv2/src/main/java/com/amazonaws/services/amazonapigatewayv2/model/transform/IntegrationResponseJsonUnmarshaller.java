    ...
    public IntegrationResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ContentHandlingStrategy")) {
                integrationResponse.setContentHandlingStrategy(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("IntegrationResponseId")) {
                integrationResponse.setIntegrationResponseId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("IntegrationResponseKey")) {
                integrationResponse.setIntegrationResponseKey(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                integrationResponse.setTemplateSelectionExpression(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
