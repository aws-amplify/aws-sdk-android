...
public class DeleteRouteRequestMarshaller implements
    ...
    public Request<DeleteRouteRequest> marshall(DeleteRouteRequest deleteRouteRequest) {
        ...
        Request<DeleteRouteRequest> request = new DefaultRequest<DeleteRouteRequest>(
                deleteRouteRequest, "AmazonApiGatewayV2");
        request.setHttpMethod(HttpMethodName.DELETE);

        String uriResourcePath = "/v2/apis/{apiId}/routes/{routeId}";
        uriResourcePath = uriResourcePath.replace(
                "{apiId}",
                (deleteRouteRequest.getApiId() == null) ? "" : StringUtils
                        .fromString(deleteRouteRequest.getApiId()));
        uriResourcePath = uriResourcePath.replace(
                "{routeId}",
                (deleteRouteRequest.getRouteId() == null) ? "" : StringUtils
                        .fromString(deleteRouteRequest.getRouteId()));
