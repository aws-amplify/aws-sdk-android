...
/**
 * JSON unmarshaller for response DeleteVpcLinkResult
 */
public class DeleteVpcLinkResultJsonUnmarshaller implements
        Unmarshaller<DeleteVpcLinkResult, JsonUnmarshallerContext> {
