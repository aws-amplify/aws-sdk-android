...
public class UpdateRouteResult implements Serializable {
     ...
     * API using quick create, the $default route is managed by API Gateway. You
     * can't modify the $default route key.
     * </p>
     */
     ...
     * with a JWT authorizer to authorize the method invocation. The
     ...
     *         created an API using quick create, the $default route is managed
     ...
     *            Specifies whether a route is managed by API Gateway. If you
     *            created an API using quick create, the $default route is
     *            managed by API Gateway. You can't modify the $default route
     *            key.
     *            </p>
     */
     ...
     *
     * @return <p>
     *         A list of authorization scopes configured on a route. The scopes
     *         are used with a JWT authorizer to authorize the method
     ...
     *         the client must provide an access token instead of an identity
     ...
     *            route scope matches a claimed scope in the access token.
     *            Otherwise, the invocation is not authorized. When the route
     ...
     *         chained together.
     */
    public UpdateRouteResult withAuthorizationScopes(
     ...
     *         chained together.
     */
    public UpdateRouteResult withRequestParameters(
     ...
     *         chained together.
     */
    public UpdateRouteResult withRouteResponseSelectionExpression(
