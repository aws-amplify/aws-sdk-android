...
public class GetModelsRequestMarshaller implements
    ...
    public Request<GetModelsRequest> marshall(GetModelsRequest getModelsRequest) {
        ...
        uriResourcePath = uriResourcePath.replace(
                "{apiId}",
                (getModelsRequest.getApiId() == null) ? "" : StringUtils
                        .fromString(getModelsRequest.getApiId()));
        if (getModelsRequest.getMaxResults() != null) {
            request.addParameter("maxResults",
                    StringUtils.fromString(getModelsRequest.getMaxResults()));
        }
        if (getModelsRequest.getNextToken() != null) {
            request.addParameter("nextToken",
                    StringUtils.fromString(getModelsRequest.getNextToken()));
        }
