...
/**
 * JSON request marshaller for GetStageRequest
 */
public class GetStageRequestMarshaller implements
    ...
    public Request<GetStageRequest> marshall(GetStageRequest getStageRequest) {
        if (getStageRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(GetStageRequest)");
        }

        Request<GetStageRequest> request = new DefaultRequest<GetStageRequest>(getStageRequest,
                "AmazonApiGatewayV2");
        ...
        uriResourcePath = uriResourcePath.replace(
                "{apiId}",
                (getStageRequest.getApiId() == null) ? "" : StringUtils.fromString(getStageRequest
                        .getApiId()));
        uriResourcePath = uriResourcePath.replace(
                "{stageName}",
