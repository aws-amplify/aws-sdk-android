...
/**
 * JSON unmarshaller for response CreateRouteResponseResult
 */
public class CreateRouteResponseResultJsonUnmarshaller implements
        Unmarshaller<CreateRouteResponseResult, JsonUnmarshallerContext> {
    ...
    public CreateRouteResponseResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ModelSelectionExpression")) {
                createRouteResponseResult.setModelSelectionExpression(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("ResponseModels")) {
                createRouteResponseResult.setResponseModels(new MapUnmarshaller<String>(
                ...
                createRouteResponseResult.setRouteResponseId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("RouteResponseKey")) {
                createRouteResponseResult.setRouteResponseKey(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
