...
/**
 * JSON request marshaller for UpdateDeploymentRequest
 */
    ...
    public Request<UpdateDeploymentRequest> marshall(UpdateDeploymentRequest updateDeploymentRequest) {
        if (updateDeploymentRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(UpdateDeploymentRequest)");
        }

        Request<UpdateDeploymentRequest> request = new DefaultRequest<UpdateDeploymentRequest>(
                updateDeploymentRequest, "AmazonApiGatewayV2");
        request.setHttpMethod(HttpMethodName.PATCH);

        String uriResourcePath = "/v2/apis/{apiId}/deployments/{deploymentId}";
        uriResourcePath = uriResourcePath.replace(
                "{apiId}",
                (updateDeploymentRequest.getApiId() == null) ? "" : StringUtils
                        .fromString(updateDeploymentRequest.getApiId()));
        uriResourcePath = uriResourcePath.replace(
                "{deploymentId}",
                (updateDeploymentRequest.getDeploymentId() == null) ? "" : StringUtils
                        .fromString(updateDeploymentRequest.getDeploymentId()));
        ...
        try {
            ...
            if (updateDeploymentRequest.getDescription() != null) {
                String description = updateDeploymentRequest.getDescription();
