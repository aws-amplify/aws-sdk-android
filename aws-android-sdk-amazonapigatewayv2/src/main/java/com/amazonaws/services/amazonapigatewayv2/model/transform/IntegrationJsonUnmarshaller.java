    ...
    public Integration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ApiGatewayManaged")) {
                integration.setApiGatewayManaged(BooleanJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                integration.setContentHandlingStrategy(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("CredentialsArn")) {
                integration.setCredentialsArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Description")) {
                integration.setDescription(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("IntegrationId")) {
                integration.setIntegrationId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("IntegrationMethod")) {
                integration.setIntegrationMethod(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("IntegrationResponseSelectionExpression")) {
                integration.setIntegrationResponseSelectionExpression(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("IntegrationType")) {
                integration.setIntegrationType(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("IntegrationUri")) {
                integration.setIntegrationUri(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                integration.setPayloadFormatVersion(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
                ...
                integration.setTemplateSelectionExpression(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
