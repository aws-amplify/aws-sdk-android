 ...
 * </p>
 */
public class CreateIntegrationResponseRequest extends AmazonWebServiceRequest implements
        Serializable {
    /**
     * <p>
     * The API identifier.
     ...
     * @see ContentHandlingStrategy
     */
    public CreateIntegrationResponseRequest withContentHandlingStrategy(
     ...
     *            integration.response.body.{JSON-expression}, where {name} is a
     *            valid and unique response header name and {JSON-expression} is
     ...
     *         chained together.
     */
    public CreateIntegrationResponseRequest withResponseTemplates(
     ...
     *         chained together.
     */
    public CreateIntegrationResponseRequest withTemplateSelectionExpression(
