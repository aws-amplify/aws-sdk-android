...
public class GetIntegrationRequestMarshaller implements
    ...
    public Request<GetIntegrationRequest> marshall(GetIntegrationRequest getIntegrationRequest) {
        ...
        Request<GetIntegrationRequest> request = new DefaultRequest<GetIntegrationRequest>(
                getIntegrationRequest, "AmazonApiGatewayV2");
        request.setHttpMethod(HttpMethodName.GET);

        String uriResourcePath = "/v2/apis/{apiId}/integrations/{integrationId}";
        uriResourcePath = uriResourcePath.replace(
                "{apiId}",
                (getIntegrationRequest.getApiId() == null) ? "" : StringUtils
                        .fromString(getIntegrationRequest.getApiId()));
        uriResourcePath = uriResourcePath.replace(
                "{integrationId}",
                (getIntegrationRequest.getIntegrationId() == null) ? "" : StringUtils
                        .fromString(getIntegrationRequest.getIntegrationId()));
