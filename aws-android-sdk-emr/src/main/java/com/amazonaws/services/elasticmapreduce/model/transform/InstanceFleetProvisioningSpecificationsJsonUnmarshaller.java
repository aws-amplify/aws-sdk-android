...
/**
 * JSON unmarshaller for POJO InstanceFleetProvisioningSpecifications
 */
class InstanceFleetProvisioningSpecificationsJsonUnmarshaller implements
        Unmarshaller<InstanceFleetProvisioningSpecifications, JsonUnmarshallerContext> {
    ...
    public InstanceFleetProvisioningSpecifications unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("SpotSpecification")) {
                instanceFleetProvisioningSpecifications
                        .setSpotSpecification(SpotProvisioningSpecificationJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else if (name.equals("OnDemandSpecification")) {
                instanceFleetProvisioningSpecifications
                        .setOnDemandSpecification(OnDemandProvisioningSpecificationJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
