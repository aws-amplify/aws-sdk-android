...
/**
 * JSON request marshaller for ModifyInstanceGroupsRequest
 */
public class ModifyInstanceGroupsRequestMarshaller implements
    ...
    public Request<ModifyInstanceGroupsRequest> marshall(
        ...
        if (modifyInstanceGroupsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ModifyInstanceGroupsRequest)");
        }
        ...
        try {
            ...
            if (modifyInstanceGroupsRequest.getClusterId() != null) {
                String clusterId = modifyInstanceGroupsRequest.getClusterId();
                jsonWriter.name("ClusterId");
                jsonWriter.value(clusterId);
            }
            if (modifyInstanceGroupsRequest.getInstanceGroups() != null) {
                java.util.List<InstanceGroupModifyConfig> instanceGroups = modifyInstanceGroupsRequest
                        .getInstanceGroups();
                jsonWriter.name("InstanceGroups");
                jsonWriter.beginArray();
                for (InstanceGroupModifyConfig instanceGroupsItem : instanceGroups) {
                    if (instanceGroupsItem != null) {
                        InstanceGroupModifyConfigJsonMarshaller.getInstance().marshall(
                                instanceGroupsItem, jsonWriter);
                    }
                }
                jsonWriter.endArray();
            }
