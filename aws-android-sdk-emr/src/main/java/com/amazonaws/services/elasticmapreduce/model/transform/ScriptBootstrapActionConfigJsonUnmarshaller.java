...
/**
 * JSON unmarshaller for POJO ScriptBootstrapActionConfig
 */
class ScriptBootstrapActionConfigJsonUnmarshaller implements
    ...
    public ScriptBootstrapActionConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Path")) {
                scriptBootstrapActionConfig.setPath(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Args")) {
                scriptBootstrapActionConfig.setArgs(new ListUnmarshaller<String>(
