    ...
    public AutoScalingPolicyDescription unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Status")) {
                autoScalingPolicyDescription.setStatus(AutoScalingPolicyStatusJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Constraints")) {
                autoScalingPolicyDescription.setConstraints(ScalingConstraintsJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Rules")) {
                autoScalingPolicyDescription.setRules(new ListUnmarshaller<ScalingRule>(
