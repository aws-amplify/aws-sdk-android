...
/**
 * JSON unmarshaller for POJO EbsVolume
 */
class EbsVolumeJsonUnmarshaller implements Unmarshaller<EbsVolume, JsonUnmarshallerContext> {
    ...
    public EbsVolume unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Device")) {
                ebsVolume.setDevice(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("VolumeId")) {
                ebsVolume.setVolumeId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
