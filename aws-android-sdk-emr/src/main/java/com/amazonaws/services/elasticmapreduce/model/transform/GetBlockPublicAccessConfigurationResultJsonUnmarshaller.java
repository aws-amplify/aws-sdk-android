...
/**
 * JSON unmarshaller for response GetBlockPublicAccessConfigurationResult
 */
public class GetBlockPublicAccessConfigurationResultJsonUnmarshaller implements
        Unmarshaller<GetBlockPublicAccessConfigurationResult, JsonUnmarshallerContext> {
    ...
    public GetBlockPublicAccessConfigurationResult unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("BlockPublicAccessConfiguration")) {
                getBlockPublicAccessConfigurationResult
                        .setBlockPublicAccessConfiguration(BlockPublicAccessConfigurationJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else if (name.equals("BlockPublicAccessConfigurationMetadata")) {
                getBlockPublicAccessConfigurationResult
                        .setBlockPublicAccessConfigurationMetadata(BlockPublicAccessConfigurationMetadataJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
