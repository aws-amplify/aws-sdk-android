    ...
    public InstanceStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("State")) {
                instanceStatus.setState(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("StateChangeReason")) {
                instanceStatus.setStateChangeReason(InstanceStateChangeReasonJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Timeline")) {
                instanceStatus.setTimeline(InstanceTimelineJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
