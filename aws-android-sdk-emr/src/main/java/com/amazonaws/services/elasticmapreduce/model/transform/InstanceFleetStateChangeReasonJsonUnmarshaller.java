...
/**
 * JSON unmarshaller for POJO InstanceFleetStateChangeReason
 */
class InstanceFleetStateChangeReasonJsonUnmarshaller implements
    ...
    public InstanceFleetStateChangeReason unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Code")) {
                instanceFleetStateChangeReason.setCode(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Message")) {
                instanceFleetStateChangeReason.setMessage(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
