...
class InstanceFleetProvisioningSpecificationsJsonMarshaller {
    ...
    public void marshall(
        ...
        if (instanceFleetProvisioningSpecifications.getOnDemandSpecification() != null) {
            OnDemandProvisioningSpecification onDemandSpecification = instanceFleetProvisioningSpecifications
                    .getOnDemandSpecification();
            jsonWriter.name("OnDemandSpecification");
            OnDemandProvisioningSpecificationJsonMarshaller.getInstance().marshall(
                    onDemandSpecification, jsonWriter);
        }
