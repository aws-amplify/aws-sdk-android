...
public class SpotProvisioningSpecification implements Serializable {
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>capacity-optimized
     */
     ...
     *            fleets. Currently, the only option is capacity-optimized (the
     *            default), which launches instances from Spot instance pools
     *            with optimal capacity for the number of instances that are
     *            launching.
     *            </p>
     * @see SpotProvisioningAllocationStrategy
     */
     ...
     * @see SpotProvisioningAllocationStrategy
     */
    public SpotProvisioningSpecification withAllocationStrategy(
            SpotProvisioningAllocationStrategy allocationStrategy) {
        this.allocationStrategy = allocationStrategy.toString();
        return this;
    }
