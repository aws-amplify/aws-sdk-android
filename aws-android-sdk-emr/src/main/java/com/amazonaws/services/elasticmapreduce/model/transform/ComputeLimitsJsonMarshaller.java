...
class ComputeLimitsJsonMarshaller {
    ...
    public void marshall(ComputeLimits computeLimits, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (computeLimits.getMaximumCoreCapacityUnits() != null) {
            Integer maximumCoreCapacityUnits = computeLimits.getMaximumCoreCapacityUnits();
            jsonWriter.name("MaximumCoreCapacityUnits");
            jsonWriter.value(maximumCoreCapacityUnits);
        }
