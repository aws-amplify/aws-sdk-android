...
public class BootstrapActionConfig implements Serializable {
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getScriptBootstrapAction() == null) ? 0 : getScriptBootstrapAction().hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getScriptBootstrapAction() != null
                && other.getScriptBootstrapAction().equals(this.getScriptBootstrapAction()) == false)
            return false;
        return true;
    }
}
