...
/**
 * JSON unmarshaller for POJO SimpleScalingPolicyConfiguration
 */
class SimpleScalingPolicyConfigurationJsonUnmarshaller implements
    ...
    public SimpleScalingPolicyConfiguration unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("AdjustmentType")) {
                simpleScalingPolicyConfiguration.setAdjustmentType(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("ScalingAdjustment")) {
                simpleScalingPolicyConfiguration.setScalingAdjustment(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("CoolDown")) {
                simpleScalingPolicyConfiguration.setCoolDown(IntegerJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
