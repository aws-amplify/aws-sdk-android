...
/**
 * JSON request marshaller for AddInstanceGroupsRequest
 */
    ...
    public Request<AddInstanceGroupsRequest> marshall(
        ...
        if (addInstanceGroupsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AddInstanceGroupsRequest)");
        }
        ...
        try {
            ...
            if (addInstanceGroupsRequest.getInstanceGroups() != null) {
                java.util.List<InstanceGroupConfig> instanceGroups = addInstanceGroupsRequest
                        .getInstanceGroups();
                jsonWriter.name("InstanceGroups");
                jsonWriter.beginArray();
                for (InstanceGroupConfig instanceGroupsItem : instanceGroups) {
                    if (instanceGroupsItem != null) {
                        InstanceGroupConfigJsonMarshaller.getInstance().marshall(
            ...
            if (addInstanceGroupsRequest.getJobFlowId() != null) {
                String jobFlowId = addInstanceGroupsRequest.getJobFlowId();
