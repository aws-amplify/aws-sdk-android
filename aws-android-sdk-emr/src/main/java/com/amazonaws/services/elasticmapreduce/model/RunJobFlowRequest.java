...
public class RunJobFlowRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * value is not provided, the logs will remain encrypted by AES-256. This
     ...
     *
     * @return <p>
     *         The AWS KMS customer master key (CMK) used for encrypting log
     *         files. If a value is not provided, the logs will remain encrypted
     *         by AES-256. This attribute is only available with EMR version
     *         5.30.0 and later, excluding EMR 6.0.0.
     *         </p>
     */
     ...
     * <br/>
     *
     * @param logEncryptionKmsKeyId <p>
     *            The AWS KMS customer master key (CMK) used for encrypting log
     *            files. If a value is not provided, the logs will remain
     *            encrypted by AES-256. This attribute is only available with
    ...
    public String toString() {
        ...
        if (getLogEncryptionKmsKeyId() != null)
            sb.append("LogEncryptionKmsKeyId: " + getLogEncryptionKmsKeyId() + ",");
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getLogEncryptionKmsKeyId() == null) ? 0 : getLogEncryptionKmsKeyId().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getLogEncryptionKmsKeyId() == null ^ this.getLogEncryptionKmsKeyId() == null)
            return false;
        if (other.getLogEncryptionKmsKeyId() != null
                && other.getLogEncryptionKmsKeyId().equals(this.getLogEncryptionKmsKeyId()) == false)
            return false;
