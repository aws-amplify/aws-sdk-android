...
/**
 * JSON unmarshaller for response RunJobFlowResult
 */
    ...
    public RunJobFlowResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("JobFlowId")) {
                runJobFlowResult.setJobFlowId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ClusterArn")) {
                runJobFlowResult.setClusterArn(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
