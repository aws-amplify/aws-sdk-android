...
public class ComputeLimits implements Serializable {
     ...
     * through units for instance fleets. The core units are not allowed to
     ...
     *         scale beyond this boundary. The parameter is used to split
     ...
     *            units are not allowed to scale beyond this boundary. The
     *            parameter is used to split capacity allocation between
     *            On-Demand and Spot instances.
     *            </p>
     */
     ...
     *         It is measured through VCPU cores or instances for instance
     *         groups and measured through units for instance fleets. The core
     *         units are not allowed to scale beyond this boundary. The
     *         parameter is used to split capacity allocation between core and
     *         task nodes.
     *         </p>
     */
     ...
     * </p>
     *
     * @param maximumCoreCapacityUnits <p>
     *            The upper boundary of EC2 units for core node type in a
     *            cluster. It is measured through VCPU cores or instances for
    ...
    public String toString() {
        ...
        if (getMaximumCoreCapacityUnits() != null)
            sb.append("MaximumCoreCapacityUnits: " + getMaximumCoreCapacityUnits());
        sb.append("}");
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getMaximumCoreCapacityUnits() == null) ? 0 : getMaximumCoreCapacityUnits()
                        .hashCode());
        return hashCode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getMaximumOnDemandCapacityUnits() != null
            ...
            return false;
        if (other.getMaximumCoreCapacityUnits() == null
                ^ this.getMaximumCoreCapacityUnits() == null)
            return false;
        if (other.getMaximumCoreCapacityUnits() != null
                && other.getMaximumCoreCapacityUnits().equals(this.getMaximumCoreCapacityUnits()) == false)
            return false;
        return true;
    }
}
