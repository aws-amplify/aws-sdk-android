...
/**
 * JSON unmarshaller for POJO ScalingTrigger
 */
class ScalingTriggerJsonUnmarshaller implements
    ...
    public ScalingTrigger unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("CloudWatchAlarmDefinition")) {
                scalingTrigger
                        .setCloudWatchAlarmDefinition(CloudWatchAlarmDefinitionJsonUnmarshaller
                                .getInstance()
                                .unmarshall(context));
            } else {
                reader.skipValue();
